...
Функция ЕстьОшибки()
	...
	Для Каждого Элемент Из Список Цикл
		...
		Иначе
			ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Дата %1 уже была введена ранее.';
																						|en = 'Date %1 has already been entered.'"), Формат(Элемент.Значение, "ДЛФ=Д"));
