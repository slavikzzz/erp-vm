...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПервичныйДокументДоступенЕслиОплачен = Параметры.ПервичныйДокументДоступенЕслиОплачен;
...
Процедура ОплаченПриИзменении(Элемент)
	НастроитьЗависимыеЭлементыФормы(ЭтотОбъект, "Оплачен");
КонецПроцедуры
...
Процедура ПроверитьЗаполнениеРеквизитов(Отказ)
	...
	ПроверятьЗаполнениеПервичногоДокумента = Не ПервичныйДокументДоступенЕслиОплачен
		Или (ПервичныйДокументДоступенЕслиОплачен И Оплачен);
		
	Если ПроверятьЗаполнениеПервичногоДокумента И Не ЗначениеЗаполнено(ВидПервичногоДокумента) Тогда
	...
	Если ПроверятьЗаполнениеПервичногоДокумента И Не ЗначениеЗаполнено(НомерПервичногоДокумента) Тогда
	...
	Если ПроверятьЗаполнениеПервичногоДокумента И Не ЗначениеЗаполнено(ДатаПервичногоДокумента) Тогда
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	ДоступностьПервичногоДокумента = Не Форма.ПервичныйДокументДоступенЕслиОплачен
		Или (Форма.ПервичныйДокументДоступенЕслиОплачен И Форма.Оплачен);
	
	Элементы.ВидПервичногоДокумента.Доступность   = ДоступностьПервичногоДокумента;
	Элементы.НомерПервичногоДокумента.Доступность = ДоступностьПервичногоДокумента;
	Элементы.ПервичныйДокумент.Доступность        = ДоступностьПервичногоДокумента;
	Элементы.ДатаПервичногоДокумента.Доступность  = ДоступностьПервичногоДокумента;
КонецПроцедуры
