...
Процедура ЗагрузитьКлассификатор()
	...
	КлассификаторОКВЭД2 = Справочники.КлассификаторОКВЭД2.КлассификаторОКВЭД2(Истина);
...
Процедура ОтобразитьНайденные()
	...
	Если ОтобразитьНайденные Тогда
		...
		Если КлассификаторЗагруженПоОтбору <> СтрокаПоиска Тогда
			...
			КлассификаторСОтбором = Справочники.КлассификаторОКВЭД2.НайтиВКлассификатореОКВЭД2(
