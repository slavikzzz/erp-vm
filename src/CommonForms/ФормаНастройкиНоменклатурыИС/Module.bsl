		...
		ОбщегоНазначения.СообщитьПользователю(
			СтрШаблон(
				НСтр("ru = 'Поле ""%1"" должно быть больше 1';
					|en = 'Поле ""%1"" должно быть больше 1'"),
				...
				ОбщегоНазначения.СообщитьПользователю(
					СтрШаблон(
						НСтр("ru = 'В строке %1 не заполнено поле Характеристика';
							|en = 'В строке %1 не заполнено поле Характеристика'"),
					...
					ОбщегоНазначения.СообщитьПользователю(
						СтрШаблон(
							НСтр("ru = 'В строке %1 не заполнено поле Номенклатура';
								|en = 'В строке %1 не заполнено поле Номенклатура'"),
								СтрокаТаблицы.НомерСтроки),,
						ОбщегоНазначенияКлиентСервер.ПутьКТабличнойЧасти(
							"НастройкиНоменклатуры",
							НастройкиНоменклатуры.Индекс(СтрокаТаблицы) + 1,
				...
				Если ЗначениеЗаполнено(СтрокаТаблицы.Номенклатура)
					...
					ОбщегоНазначения.СообщитьПользователю(
						НСтр("ru = 'Номенклатура для продажи должна отличаться от основной номенклатуры';
							|en = 'Номенклатура для продажи должна отличаться от основной номенклатуры'"),,
						ОбщегоНазначенияКлиентСервер.ПутьКТабличнойЧасти(
							"НастройкиНоменклатуры",
							НастройкиНоменклатуры.Индекс(СтрокаТаблицы) + 1,
							"НоменклатураЧастичногоВыбытия"),,
					...
					ОбщегоНазначения.СообщитьПользователю(
						СтрШаблон(
							НСтр("ru = 'В строке %1 дублируется номенклатура %2';
								|en = 'В строке %1 дублируется номенклатура %2'"),
		...
		Если ВариантИспользованияЕдиницыХранения = Перечисления.ВариантыИспользованияЕдиницыХраненияИС.ГрупповаяЛогистическаяУпаковка Тогда
			Если ПолеКоличествоКороб = 0 Тогда
				ВызватьИсключение НСтр("ru = 'Внутренняя ошибка. Не предусмотрено сохранение нулевого количества в потребительской упаковке.';
										|en = 'Внутренняя ошибка. Не предусмотрено сохранение нулевого количества в потребительской упаковке.'");
			Иначе
	...
	Исключение
		...
		ТекстСообщения = СтрШаблон(
				НСтр("ru = 'Не удалось записать настройки номенклатуры ИС МП по причине: %1';
					|en = 'Не удалось записать настройки номенклатуры ИС МП по причине: %1'"),
			ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		
		ЗаписьЖурналаРегистрации(
				НСтр("ru = 'ГосИС: Запись настройки номенклатуры';
					|en = 'ГосИС: Запись настройки номенклатуры'", ОбщегоНазначения.КодОсновногоЯзыка()),
...
Процедура НастроитьЭлементыФормыНаСервере()
	...
	Тексты.Вставить("ВариантЕдиницыПотребительская",          НСтр("ru = 'Соответствует единице хранения%1';
																	|en = 'Соответствует единице хранения%1'"));
	...
	Тексты.Вставить("ВариантЕдиницыКоробБлок",                НСтр("ru = 'Входит в состав короба%1 в количестве:';
																	|en = 'Входит в состав короба%1 в количестве:'"));
	...
	Тексты.Вставить(
		...
		НСтр("ru = 'Продукция, фасованная в заводских условиях, например:
			       ...
			       |en = 'Продукция, фасованная в заводских условиях, например:
			       |Бутылка молока объемом 950 мл., сыр фасованный по 200 грамм.'"));
	...
	Если ВидПродукции = Перечисления.ВидыПродукцииИС.Духи Тогда
		...
		Тексты.ТекущаяНоменклатураПодсказка = НСтр("ru = 'Духи (туалетная вода) могут продаваться маркированными флаконами или на разлив. Единица хранения остатков %1соответствует одному миллилитру духов (туалетной воды).';
													|en = 'Духи (туалетная вода) могут продаваться маркированными флаконами или на разлив. Единица хранения остатков %1соответствует одному миллилитру духов (туалетной воды).'");
		Тексты.Подвал                       = НСтр("ru = 'При продаже флакона на ККТ тэг <1292> не заполняется, код маркирови выбывает из оборота.';
													|en = 'При продаже флакона на ККТ тэг <1292> не заполняется, код маркирови выбывает из оборота.'");
		...
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'Для учета духов (туалетной воды), продаваемых на разлив используется отдельная номенклатура';
				|en = 'Для учета духов (туалетной воды), продаваемых на разлив используется отдельная номенклатура'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(" ");
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'с единицей хранения остатков соответствующей одному миллилитру.';
				|en = 'с единицей хранения остатков соответствующей одному миллилитру.'"));
		...
		Если ВариантЧастичногоВыбытия = ПредопределенноеЗначение("Перечисление.ВариантыУчетаЧастичногоВыбытияИС.НастроеннаяНоменклатура")
			...
			ДанныеПодвала.Добавить(НСтр("ru = 'При продаже духов (туалетной воды) на разлив на ККТ заполняется Тэг <1292>, который в печатной форме чека отображается как: <объем тары>/';
										|en = 'При продаже духов (туалетной воды) на разлив на ККТ заполняется Тэг <1292>, который в печатной форме чека отображается как: <объем тары>/'"));
			...
			ДанныеПодвала.Добавить(НСтр("ru = 'Код маркировки флакона выбывает из оборота при продаже последнего миллилитра.';
										|en = 'Код маркировки флакона выбывает из оборота при продаже последнего миллилитра.'"));
		...
		Если ПредставленияДокументовСборкаРазборка.Количество() = 0 Тогда
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				НСтр("ru = 'Для пересчета флаконов в миллилитры необходимо выполнять отдельную операцию.';
					|en = 'Для пересчета флаконов в миллилитры необходимо выполнять отдельную операцию.'"));
			...
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				СтрШаблон(
					НСтр("ru = 'При передаче в торговый зал используется документ ""%1"" для пересчета флаконов в миллилитры.';
						|en = 'При передаче в торговый зал используется документ ""%1"" для пересчета флаконов в миллилитры.'"),
			...
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				СтрШаблон(
					НСтр("ru = 'При передаче в торговый зал используются документы ""%1"" для пересчета флаконов в миллилитры.';
						|en = 'При передаче в торговый зал используются документы ""%1"" для пересчета флаконов в миллилитры.'"),
					СтрСоединить(ПредставленияДокументовСборкаРазборка, ", ")));
		КонецЕсли;
		...
		Тексты.ЗаголовокГруппыЧастичноеВыбытие = НСтр("ru = 'Продажа духов (туалетной воды) на разлив';
														|en = 'Продажа духов (туалетной воды) на разлив'");
		...
		Тексты.ВариантЕдиницыПотребительскаяПодсказка  = НСтр("ru = 'Рекомендуемый вариант ведения учета для оптовых продаж, если минимальной единицей закупки является флакон.
		                                                            ...
		                                                            |en = 'Рекомендуемый вариант ведения учета для оптовых продаж, если минимальной единицей закупки является флакон.
		                                                            |Розничная продажа духов (туалетной воды) на разлив оформляется отдельной номенклатурой после разупаковки и передачи в торговый зал.'");
		Тексты.ВариантЕдиницыКоробБлокПодсказка        = НСтр("ru = 'Может использоваться для оптовых закупок и продаж, если минимальной единицей закупки и продажи является коробка.
		                                                            ...
		                                                            |en = 'Может использоваться для оптовых закупок и продаж, если минимальной единицей закупки и продажи является коробка.
		                                                            |Розничная продажа духов (туалетной воды) на разлив не поддерживается.'");
		...
		Тексты.ВариантЕдиницыЧастьУпаковкиПодсказка    = НСтр("ru = 'Рекомендуемый вариант ведения учета для розничных продаж духов (туалетной воды) на разлив.';
																|en = 'Рекомендуемый вариант ведения учета для розничных продаж духов (туалетной воды) на разлив.'");
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.АльтернативныйТабак Тогда 
		...
		Тексты.ТекущаяНоменклатураПодсказка = НСтр("ru = 'Сигары могут продаваться пачками или поштучно. Единица хранения остатков %1соответствует одной сигаре.';
													|en = 'Сигары могут продаваться пачками или поштучно. Единица хранения остатков %1соответствует одной сигаре.'");
		Тексты.Подвал                       = НСтр("ru = 'При продаже пачки на ККТ тэг <1292> не заполняется, пачка выбывает из оборота.';
													|en = 'При продаже пачки на ККТ тэг <1292> не заполняется, пачка выбывает из оборота.'");
		
		ДанныеПодсказкиНастроеннаяНоменклатура = Новый Массив();
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'Для поштучного учета сигар (сигарилл, ...) используется отдельная номенклатура';
				|en = 'Для поштучного учета сигар (сигарилл, ...) используется отдельная номенклатура'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(" ");
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'с единицей хранения остатков соответствующей одной сигаре (сигарилле, ...).';
				|en = 'с единицей хранения остатков соответствующей одной сигаре (сигарилле, ...).'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(Символы.ПС);
		...
		Если ВариантЧастичногоВыбытия = Перечисления.ВариантыУчетаЧастичногоВыбытияИС.НастроеннаяНоменклатура
			...
			ДанныеПодвала.Добавить(НСтр("ru = 'При поштучной продаже сигар (сигарилл, ...) на ККТ в чеке заполняется Тэг <1292>, который в печатной форме чека отображается как: <количество штук>/';
										|en = 'При поштучной продаже сигар (сигарилл, ...) на ККТ в чеке заполняется Тэг <1292>, который в печатной форме чека отображается как: <количество штук>/'"));
			...
			ДанныеПодвала.Добавить(НСтр("ru = 'Пачка выбывает из оборота при продаже последней сигары (сигариллы, ...) из пачки.';
										|en = 'Пачка выбывает из оборота при продаже последней сигары (сигариллы, ...) из пачки.'"));
		...
		Если ПредставленияДокументовСборкаРазборка.Количество() = 0 Тогда
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(НСтр("ru = 'Для пересчета пачек в сигары (сигариллы, ...) необходимо выполнять отдельную операцию.';
																|en = 'Для пересчета пачек в сигары (сигариллы, ...) необходимо выполнять отдельную операцию.'"));
		ИначеЕсли ПредставленияДокументовСборкаРазборка.Количество() = 1 Тогда
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				СтрШаблон(
					НСтр("ru = 'При передаче в торговый зал используется документ ""%1"" для пересчета пачек в сигары (сигариллы, ...).';
						|en = 'При передаче в торговый зал используется документ ""%1"" для пересчета пачек в сигары (сигариллы, ...).'"),
					СтрСоединить(ПредставленияДокументовСборкаРазборка)));
		Иначе
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				СтрШаблон(
					НСтр("ru = 'При передаче в торговый зал используются документы ""%1"" для пересчета пачек в сигары (сигариллы, ...).';
						|en = 'При передаче в торговый зал используются документы ""%1"" для пересчета пачек в сигары (сигариллы, ...).'"),
					СтрСоединить(ПредставленияДокументовСборкаРазборка, ", ")));
		КонецЕсли;
		...
		Тексты.ЗаголовокГруппыЧастичноеВыбытие = НСтр("ru = 'Поштучная продажа сигар (сигарилл ...) из пачки';
														|en = 'Поштучная продажа сигар (сигарилл ...) из пачки'");
		...
		Тексты.ВариантЕдиницыПотребительскаяПодсказка  = НСтр("ru = 'Рекомендуемый вариант ведения учета для оптовых продаж, если минимальной единицей закупки является пачка.
		                                                            ...
		                                                            |en = 'Рекомендуемый вариант ведения учета для оптовых продаж, если минимальной единицей закупки является пачка.
		                                                            |Поштучная продажа сигар (сигарилл ...) из пачки оформляется отдельной номенклатурой после разупаковки и передачи в торговый зал.'");
		...
		Тексты.ВариантЕдиницыКоробБлокПодсказка        = НСтр("ru = 'Может использоваться для оптовых закупок и продаж, если минимальной единицей закупки и продажи является блок / коробка.
		                                                            ...
		                                                            |en = 'Может использоваться для оптовых закупок и продаж, если минимальной единицей закупки и продажи является блок / коробка.
		                                                            |Поштучная продажа сигар (сигарилл ...) из пачки не используется.'");
		...
		Тексты.ВариантЕдиницыЧастьУпаковкиПодсказка    = НСтр("ru = 'Рекомендуемый вариант ведения учета для поштучной продажи в розницу сигар (сигарилл ...) из пачки.';
																|en = 'Рекомендуемый вариант ведения учета для поштучной продажи в розницу сигар (сигарилл ...) из пачки.'");
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.НикотиносодержащаяПродукция Тогда
		...
		Тексты.ТекущаяНоменклатураПодсказка = НСтр("ru = 'Никотиносодерщая продукция может продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.';
													|en = 'Никотиносодерщая продукция может продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.'");
		Тексты.Подвал                       = НСтр("ru = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.';
													|en = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.'");

		ДанныеПодсказкиНастроеннаяНоменклатура = Новый Массив();
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'Для поштучного учета никотиносодержащей продукции используется отдельная номенклатура';
				|en = 'Для поштучного учета никотиносодержащей продукции используется отдельная номенклатура'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(" ");
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'с единицей хранения остатков соответствующей одной единице продукции из вскрытой маркируемой потребительской упаковки.';
				|en = 'с единицей хранения остатков соответствующей одной единице продукции из вскрытой маркируемой потребительской упаковки.'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(Символы.ПС);
		...
		Если ВариантЧастичногоВыбытия = Перечисления.ВариантыУчетаЧастичногоВыбытияИС.НастроеннаяНоменклатура
			...
			ДанныеПодвала.Добавить(НСтр("ru = 'При поштучной продаже единиц продукции из вскрытой маркируемой потребительской упаковки на ККТ в чеке заполняется Тэг <1292>, который в печатной форме чека отображается как: <количество единиц>/';
										|en = 'При поштучной продаже единиц продукции из вскрытой маркируемой потребительской упаковки на ККТ в чеке заполняется Тэг <1292>, который в печатной форме чека отображается как: <количество единиц>/'"));
			ДанныеПодвала.Добавить(НСтр("ru = '<емкость потребительской упаковки>.';
										|en = '<емкость потребительской упаковки>.'"));
			ДанныеПодвала.Добавить(Символы.ПС);
			ДанныеПодвала.Добавить(НСтр("ru = 'Потребительская упаковка выбывает из оборота при продаже последней единицы продукции из вскрытой маркируемой потребительской упаковки.';
										|en = 'Потребительская упаковка выбывает из оборота при продаже последней единицы продукции из вскрытой маркируемой потребительской упаковки.'"));
		...
		Если ПредставленияДокументовСборкаРазборка.Количество() = 0 Тогда
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(НСтр("ru = 'Для пересчета потребительской упаковки в единицы продукциии необходимо выполнять отдельную операцию.';
																|en = 'Для пересчета потребительской упаковки в единицы продукциии необходимо выполнять отдельную операцию.'"));
		ИначеЕсли ПредставленияДокументовСборкаРазборка.Количество() = 1 Тогда
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				СтрШаблон(
					НСтр("ru = 'При передаче в торговый зал используется документ ""%1"" для пересчета потребительской упаковки в единицы продукции.';
						|en = 'При передаче в торговый зал используется документ ""%1"" для пересчета потребительской упаковки в единицы продукции.'"),
					СтрСоединить(ПредставленияДокументовСборкаРазборка)));
		Иначе
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				СтрШаблон(
					НСтр("ru = 'При передаче в торговый зал используются документы ""%1"" для пересчета потребительской упаковки в единицы продукции.';
						|en = 'При передаче в торговый зал используются документы ""%1"" для пересчета потребительской упаковки в единицы продукции.'"),
					СтрСоединить(ПредставленияДокументовСборкаРазборка, ", ")));
		КонецЕсли;
		...
		Тексты.ВариантЕдиницыПотребительскаяПодсказка  = НСтр("ru = 'Рекомендуемый вариант ведения учета для оптовых продаж, если минимальной единицей закупки является потребительская упаковка.
		                                                            ...
		                                                            |en = 'Рекомендуемый вариант ведения учета для оптовых продаж, если минимальной единицей закупки является потребительская упаковка.
		                                                            |Поштучная продажа единиц продукции из вскрытой маркируемой потребительской упаковки оформляется отдельной номенклатурой после разупаковки и передачи в торговый зал.'");
		Тексты.ВариантЕдиницыКоробБлок                 = НСтр("ru = 'Входит в состав короба%1 в количестве:';
																|en = 'Входит в состав короба%1 в количестве:'");
		Тексты.ВариантЕдиницыКоробБлокПодсказка        = НСтр("ru = 'Может использоваться для оптовых закупок и продаж, если минимальной единицей закупки и продажи является блок / коробка.
		...
		Тексты.ВариантЕдиницыЧастьУпаковкиПодсказка    = НСтр("ru = 'Рекомендуемый вариант ведения учета для поштучной продажи в розницу единиц продукции из вскрытой маркируемой потребительской упаковки.';
																|en = 'Рекомендуемый вариант ведения учета для поштучной продажи в розницу единиц продукции из вскрытой маркируемой потребительской упаковки.'");
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.Табак Тогда
		...
		Тексты.ВариантЕдиницыКоробБлокПодсказка = НСтр("ru = 'Может использоваться для оптовых закупок и продаж, если минимальной единицей закупки и продажи является блок или коробка.';
														|en = 'Может использоваться для оптовых закупок и продаж, если минимальной единицей закупки и продажи является блок или коробка.'");
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.Пиво
		...
		Тексты.ГруппаБазоваяЕдиницаИмеетФиксированныйВесПодсказка = НСтр(
			...
			|en = 'Продукция, фасованная в заводских условиях, например: Кег пива объемом 25 л.'");
		...
		Тексты.ТекущаяНоменклатураПодсказка = НСтр("ru = 'Пиво может продаваться потребительскими упаковками или на разлив. Единица хранения остатков %1соответствует одному литру пива.';
													|en = 'Пиво может продаваться потребительскими упаковками или на разлив. Единица хранения остатков %1соответствует одному литру пива.'");
		Тексты.Подвал                       = НСтр("ru = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, код маркирови выбывает из оборота.';
													|en = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, код маркирови выбывает из оборота.'");
		
		ДанныеПодсказкиНастроеннаяНоменклатура = Новый Массив();
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'Для учета пива, продаваемого на разлив используется отдельная номенклатура';
				|en = 'Для учета пива, продаваемого на разлив используется отдельная номенклатура'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(" ");
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'с единицей хранения остатков соответствующей одному литру.';
				|en = 'с единицей хранения остатков соответствующей одному литру.'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(Символы.ПС);
		...
		Если ВариантЧастичногоВыбытия = ПредопределенноеЗначение("Перечисление.ВариантыУчетаЧастичногоВыбытияИС.НастроеннаяНоменклатура")
			...
			ДанныеПодвала.Добавить(НСтр("ru = 'При продаже пива на разлив с использованием ККТ тэг <1023> заполняется количеством продаваемого пива в литрах.';
										|en = 'При продаже пива на разлив с использованием ККТ тэг <1023> заполняется количеством продаваемого пива в литрах.'"));
			ДанныеПодвала.Добавить(Символы.ПС);
			ДанныеПодвала.Добавить(НСтр("ru = 'Код маркировки кега выбывает из оборота при продаже последнего литра.';
										|en = 'Код маркировки кега выбывает из оборота при продаже последнего литра.'"));
		...
		Если ПредставленияДокументовСборкаРазборка.Количество() = 0 Тогда
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				НСтр("ru = 'Для пересчета кега в литры необходимо выполнять отдельную операцию.';
					|en = 'Для пересчета кега в литры необходимо выполнять отдельную операцию.'"));
		ИначеЕсли ПредставленияДокументовСборкаРазборка.Количество() = 1 Тогда
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				СтрШаблон(
					НСтр("ru = 'При передаче в торговый зал используется документ ""%1"" для пересчета кега в литры.';
						|en = 'При передаче в торговый зал используется документ ""%1"" для пересчета кега в литры.'"),
					СтрСоединить(ПредставленияДокументовСборкаРазборка)));
		Иначе
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				СтрШаблон(
					НСтр("ru = 'При передаче в торговый зал используются документы ""%1"" для пересчета кега в литры.';
						|en = 'При передаче в торговый зал используются документы ""%1"" для пересчета кега в литры.'"),
					СтрСоединить(ПредставленияДокументовСборкаРазборка, ", ")));
		КонецЕсли;
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.Алкогольная Тогда
		...
		Тексты.ТекущаяНоменклатураПодсказка = НСтр("ru = 'Алкогольная продукция может продаваться бутылками или на разлив. Единица хранения остатков %1 соответствует одному миллилитру продукции.';
													|en = 'Алкогольная продукция может продаваться бутылками или на разлив. Единица хранения остатков %1 соответствует одному миллилитру продукции.'");
		Тексты.Подвал                       = НСтр("ru = 'При продаже не вскрытой бутылки количество миллилитров не указывается, акцизная марка выбывает из оборота.';
													|en = 'При продаже не вскрытой бутылки количество миллилитров не указывается, акцизная марка выбывает из оборота.'");

		ДанныеПодсказкиНастроеннаяНоменклатура = Новый Массив();
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'Для учета алкогольной продукции, продаваемой на разлив используется отдельная номенклатура';
				|en = 'Для учета алкогольной продукции, продаваемой на разлив используется отдельная номенклатура'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(" ");
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'с единицей хранения остатков соответствующей одному миллилитру.';
				|en = 'с единицей хранения остатков соответствующей одному миллилитру.'"));
		...
		Если ПредставленияДокументовСборкаРазборка.Количество() = 0 Тогда
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				НСтр("ru = 'Для пересчета бутылок в миллилитры необходимо выполнять отдельную операцию.';
					|en = 'Для пересчета бутылок в миллилитры необходимо выполнять отдельную операцию.'"));
		ИначеЕсли ПредставленияДокументовСборкаРазборка.Количество() = 1 Тогда
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				СтрШаблон(
					НСтр("ru = 'При передаче в торговый зал используется документ ""%1"" для пересчета бутылок в миллилитры.';
						|en = 'При передаче в торговый зал используется документ ""%1"" для пересчета бутылок в миллилитры.'"),
					СтрСоединить(ПредставленияДокументовСборкаРазборка)));
		Иначе
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				СтрШаблон(
					НСтр("ru = 'При передаче в торговый зал используются документы ""%1"" для пересчета бутылок в миллилитры.';
						|en = 'При передаче в торговый зал используются документы ""%1"" для пересчета бутылок в миллилитры.'"),
					СтрСоединить(ПредставленияДокументовСборкаРазборка, ", ")));
		КонецЕсли;
		...
		Тексты.ЗаголовокГруппыЧастичноеВыбытие = НСтр("ru = 'Продажа алкогольной продукции на разлив';
														|en = 'Продажа алкогольной продукции на разлив'");
		...
		Тексты.ВариантЕдиницыПотребительскаяПодсказка  = НСтр("ru = 'Рекомендуемый вариант ведения учета для оптовых продаж, если минимальной единицей закупки является бутылка.
		                                                            ...
		                                                            |en = 'Рекомендуемый вариант ведения учета для оптовых продаж, если минимальной единицей закупки является бутылка.
		                                                            |Розничная продажа алкогольной продукции на разлив оформляется отдельной номенклатурой после разупаковки и передачи в торговый зал.'");
		Тексты.ВариантЕдиницыКоробБлокПодсказка        = НСтр("ru = 'Может использоваться для оптовых закупок и продаж, если минимальной единицей закупки и продажи является коробка.
		...
		Тексты.ВариантЕдиницыЧастьУпаковкиПодсказка    = НСтр("ru = 'Рекомендуемый вариант ведения учета для розничных продаж алкогольной продукции на разлив.';
																|en = 'Рекомендуемый вариант ведения учета для розничных продаж алкогольной продукции на разлив.'");
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.БАДы
		...
		Тексты.ТекущаяНоменклатураПодсказка = НСтр("ru = 'Биологически активные добавки могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.';
													|en = 'Биологически активные добавки могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.'");
		Тексты.Подвал                       = НСтр("ru = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.';
													|en = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.'");
		...
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'Для поштучного учета биологически активных добавок используется отдельная номенклатура';
				|en = 'Для поштучного учета биологически активных добавок используется отдельная номенклатура'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(" ");
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'с единицей хранения остатков соответствующей одной единице продукции из вскрытой маркируемой потребительской упаковки.';
				|en = 'с единицей хранения остатков соответствующей одной единице продукции из вскрытой маркируемой потребительской упаковки.'"));
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.КреслаКоляски
		...
		Тексты.ТекущаяНоменклатураПодсказка = НСтр("ru = 'Медицинские изделия могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.';
													|en = 'Медицинские изделия могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.'");
		Тексты.Подвал                       = НСтр("ru = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.';
													|en = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.'");
		...
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'Для поштучного учета медицинских изделий используется отдельная номенклатура';
				|en = 'Для поштучного учета медицинских изделий используется отдельная номенклатура'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(" ");
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'с единицей хранения остатков соответствующей одной единице продукции из вскрытой маркируемой потребительской упаковки.';
				|en = 'с единицей хранения остатков соответствующей одной единице продукции из вскрытой маркируемой потребительской упаковки.'"));
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.ТехническиеСредстваРеабилитации Тогда 
		...
		Тексты.ТекущаяНоменклатураПодсказка = НСтр("ru = 'Технические средства реабилитации могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.';
													|en = 'Технические средства реабилитации могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.'");
		Тексты.Подвал                       = НСтр("ru = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.';
													|en = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.'");
		...
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'Для поштучного учета технических средства реабилитации используется отдельная номенклатура';
				|en = 'Для поштучного учета технических средства реабилитации используется отдельная номенклатура'"));
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(" ");
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'с единицей хранения остатков соответствующей одной единице продукции из вскрытой маркируемой потребительской упаковки.';
				|en = 'с единицей хранения остатков соответствующей одной единице продукции из вскрытой маркируемой потребительской упаковки.'"));
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.Антисептики
		...
		Если ВидПродукции = Перечисления.ВидыПродукцииИС.Антисептики Тогда
			Тексты.ТекущаяНоменклатураПодсказка = НСтр("ru = 'Антисептики могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.';
														|en = 'Антисептики могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.'");
		Иначе
			Тексты.ТекущаяНоменклатураПодсказка = НСтр("ru = 'Дезинфицирующие средства могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.';
														|en = 'Дезинфицирующие средства могут продаваться потребительскими упаковками или частями. Единица хранения остатков %1соответствует одной потребительской упаковке.'");
		КонецЕсли;
		Тексты.Подвал = НСтр("ru = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.';
							|en = 'При продаже потребительской упаковки на ККТ тэг <1292> не заполняется, потребительская упаковка выбывает из оборота.'");
		...
		Если ВидПродукции = Перечисления.ВидыПродукцииИС.Антисептики Тогда
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				НСтр("ru = 'Для поштучного учета антисептиков используется отдельная номенклатура';
					|en = 'Для поштучного учета антисептиков используется отдельная номенклатура'"));
		Иначе
			ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
				НСтр("ru = 'Для поштучного учета дезинфицирующих средств используется отдельная номенклатура';
					|en = 'Для поштучного учета дезинфицирующих средств используется отдельная номенклатура'"));
		КонецЕсли;
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(" ");
		ДанныеПодсказкиНастроеннаяНоменклатура.Добавить(
			НСтр("ru = 'с единицей хранения остатков соответствующей одной единице продукции из вскрытой маркируемой потребительской упаковки.';
	...
	Если ОбщегоНазначенияИС.ПустоеЗначениеОпределяемогоТипа("Упаковка") = "" Тогда
		Тексты.ВариантЕдиницыЧастьУпаковкиПодсказка = СтрШаблон(
			...
			НСтр("ru = 'Для оптовых закупок и продаж используется отдельная номенклатура.';
				|en = 'Для оптовых закупок и продаж используется отдельная номенклатура.'"));
	Иначе
		Тексты.ВариантЕдиницыЧастьУпаковкиПодсказка = СтрШаблон(
			"%1%2%3",
			Тексты.ВариантЕдиницыЧастьУпаковкиПодсказка,
			...
			НСтр("ru = 'Для оптовых закупок и продаж используются упаковки номенклатуры.';
				|en = 'Для оптовых закупок и продаж используются упаковки номенклатуры.'"));
	КонецЕсли;
	...
	Если (ДопустимоИспользованиеУпаковок И Не УпаковкиВключены) Тогда
		...
		Элементы.ПотребительскаяУпаковка.РасширеннаяПодсказка.Заголовок = Новый ФорматированнаяСтрока(
			НСтр("ru = 'Для настройки необходимо использовать упаковки.';
				|en = 'Для настройки необходимо использовать упаковки.'"),,
...
Процедура ЗаполнитьПараметрыФормыПриСоздании()
	...
	Если Не ЗначениеЗаполнено(Номенклатура) Тогда
		ВызватьИсключение НСтр("ru = 'Внутренняя ошибка. В форму настройки не передана ссылка на номенклатуру.';
								|en = 'Внутренняя ошибка. В форму настройки не передана ссылка на номенклатуру.'");
