...
Процедура НадписьЗавершениеОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	Если НавигационнаяСсылкаФорматированнойСтроки = "ЖурналРегистрации" Тогда
		...
		СобытияЖурнала.Добавить(НСтр("ru = 'Включение онлайн взаиморасчетов с партнерами.';
									|en = 'Enable online mutual settlements with partners.'", КодОсновногоЯзыка));
		СобытияЖурнала.Добавить(НСтр("ru = 'Включение онлайн взаиморасчетов с партнерами. Не удалось заполнить регистр перехода.';
									|en = 'Enabling online settlements with partners. Cannot fill in transfer register.'", КодОсновногоЯзыка));
		СобытияЖурнала.Добавить(НСтр("ru = 'Включение онлайн взаиморасчетов с партнерами. Работа потока.';
									|en = 'Enable online settlements with partners. Flow work.'", КодОсновногоЯзыка));
		СобытияЖурнала.Добавить(НСтр("ru = 'Включение онлайн взаиморасчетов с партнерами. Этап 2.';
									|en = 'Enabling online settlements with partners. Stage 2.'", КодОсновногоЯзыка));
...
Процедура ЗапуститьПереходНаСервере()
	...
	Наименование = НСтр("ru = 'Автоматический переход на онлайн взаиморасчеты';
						|en = 'Automatic switching to online settlements'");
...
Процедура ЗаполнитьРегистрыЗавершениеНаСервере()
	...
	Если НЕ Константы.НоваяАрхитектураВзаиморасчетов.Получить() Тогда
		...
		|en = 'Errors occurred during switching.
		|Contact support 
		|to investigate and troubleshoot errors.'") + Символы.ПС);
