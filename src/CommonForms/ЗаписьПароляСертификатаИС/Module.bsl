...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИспользоватьВводитьПарольВПрограммеЭлектроннойПодписи = Ложь;
	Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(
		Метаданные.Справочники.СертификатыКлючейЭлектроннойПодписиИШифрования.Реквизиты, "ВводитьПарольВПрограммеЭлектроннойПодписи") Тогда
		ИспользоватьВводитьПарольВПрограммеЭлектроннойПодписи = Истина;
	...
	Если ИспользоватьВводитьПарольВПрограммеЭлектроннойПодписи Тогда
		УсиленнаяЗащитаЗакрытогоКлюча = Свойства.ВводитьПарольВПрограммеЭлектроннойПодписи;
	КонецЕсли;
