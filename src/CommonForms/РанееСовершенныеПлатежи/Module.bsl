...
Процедура БанковскийСчетПриИзмененииНаСервере()
	...
	Если ЗначениеЗаполнено(БанковскийСчет) Тогда
		...
		ЭтаФорма.Заголовок = НСтр("ru = 'Налоги, перечисленные ранее организацией';
									|en = 'Taxes transferred earlier by the company'") + " " + Организация;
	Иначе
		Организация = Неопределено;
		ЭтаФорма.Заголовок = НСтр("ru = 'Налоги, перечисленные ранее';
									|en = 'Taxes listed earlier'");
	КонецЕсли;
...
Функция ТекстЗапросаТаблицаПлатежей()
	...
	//++ НЕ УТ
	|	СписаниеБДСРасшифровка.Ссылка.НастройкаСчетовУчета.СчетУчета КАК СчетУчета,
	|	СписаниеБДСРасшифровка.Ссылка.НастройкаСчетовУчета.Субконто1 КАК Субконто1,
	|	СписаниеБДСРасшифровка.Ссылка.НастройкаСчетовУчета.Субконто2 КАК Субконто2,
	|	СписаниеБДСРасшифровка.Ссылка.НастройкаСчетовУчета.Субконто3 КАК Субконто3,
	//-- НЕ УТ
