...
Процедура ДеревоОбъектовМетаданныхЗаполнить()
	...
	НоваяСтрокаКоллекции("Подсистемы",                   НСтр("ru = 'Подсистемы';
																|en = 'Subsystems'"),                     БиблиотекаКартинок.МетаданныеПодсистемы,                   Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ОбщиеМодули",                  НСтр("ru = 'Общие модули';
																|en = 'Common modules'"),                   БиблиотекаКартинок.МетаданныеОбщиеМодули,                  Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПараметрыСеанса",              НСтр("ru = 'Параметры сеанса';
																|en = 'Session parameters'"),               БиблиотекаКартинок.МетаданныеПараметрыСеанса,              Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Роли",                         НСтр("ru = 'Роли';
																|en = 'Roles'"),                           БиблиотекаКартинок.МетаданныеРоли,                         Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ОбщиеРеквизиты",               НСтр("ru = 'Общие реквизиты';
																|en = 'Common attributes'"),                БиблиотекаКартинок.МетаданныеОбщиеРеквизиты,               Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПланыОбмена",                  НСтр("ru = 'Планы обмена';
																|en = 'Exchange plans'"),                   БиблиотекаКартинок.МетаданныеПланыОбмена,                  Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("КритерииОтбора",               НСтр("ru = 'Критерии отбора';
																|en = 'Filter criteria'"),                БиблиотекаКартинок.МетаданныеКритерииОтбора,               Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПодпискиНаСобытия",            НСтр("ru = 'Подписки на события';
																|en = 'Event subscriptions'"),            БиблиотекаКартинок.МетаданныеПодпискиНаСобытия,            Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("РегламентныеЗадания",          НСтр("ru = 'Регламентные задания';
																|en = 'Scheduled jobs'"),           БиблиотекаКартинок.МетаданныеРегламентныеЗадания,          Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ФункциональныеОпции",          НСтр("ru = 'Функциональные опции';
																|en = 'Functional options'"),           БиблиотекаКартинок.МетаданныеФункциональныеОпции,          Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПараметрыФункциональныхОпций", НСтр("ru = 'Параметры функциональных опций';
																|en = 'Functional option parameters'"), БиблиотекаКартинок.МетаданныеПараметрыФункциональныхОпций, Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ХранилищаНастроек",            НСтр("ru = 'Хранилища настроек';
																|en = 'Settings storages'"),             БиблиотекаКартинок.МетаданныеХранилищаНастроек,            Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ОбщиеФормы",                   НСтр("ru = 'Общие формы';
																|en = 'Common forms'"),                    БиблиотекаКартинок.МетаданныеОбщиеФормы,                   Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ОбщиеКоманды",                 НСтр("ru = 'Общие команды';
																|en = 'Common commands'"),                  БиблиотекаКартинок.МетаданныеОбщиеКоманды,                 Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ГруппыКоманд",                 НСтр("ru = 'Группы команд';
																|en = 'Command groups'"),                  БиблиотекаКартинок.МетаданныеГруппыКоманд,                 Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Интерфейсы",                   НСтр("ru = 'Интерфейсы';
																|en = 'Interfaces'"),                     Неопределено,                                              Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ОбщиеМакеты",                  НСтр("ru = 'Общие макеты';
																|en = 'Common templates'"),                   БиблиотекаКартинок.МетаданныеОбщиеМакеты,                  Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ОбщиеКартинки",                НСтр("ru = 'Общие картинки';
																|en = 'Common pictures'"),                 БиблиотекаКартинок.МетаданныеОбщиеКартинки,                Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПакетыXDTO",                   НСтр("ru = 'XDTO-пакеты';
																|en = 'XDTO packages'"),                    БиблиотекаКартинок.МетаданныеПакетыXDTO,                   Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("WebСервисы",                   НСтр("ru = 'Web-сервисы';
																|en = 'Web services'"),                    БиблиотекаКартинок.МетаданныеWebСервисы,                   Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("HTTPСервисы",                  НСтр("ru = 'HTTP-сервисы';
																|en = 'HTTP services'"),                   БиблиотекаКартинок.МетаданныеHTTPСервисы,                  Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("WSСсылки",                     НСтр("ru = 'WS-ссылки';
																|en = 'WS references'"),                      БиблиотекаКартинок.МетаданныеWSСсылки,                     Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Стили",                        НСтр("ru = 'Стили';
																|en = 'Styles'"),                          БиблиотекаКартинок.МетаданныеСтили,                        Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Языки",                        НСтр("ru = 'Языки';
																|en = 'Languages'"),                          БиблиотекаКартинок.МетаданныеЯзыки,                        Истина, ОбъектыМетаданных);
	
	НоваяСтрокаКоллекции("Константы",                    НСтр("ru = 'Константы';
																|en = 'Constants'"),                      БиблиотекаКартинок.МетаданныеКонстанты,               Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Справочники",                  НСтр("ru = 'Справочники';
																|en = 'Catalogs'"),                    БиблиотекаКартинок.МетаданныеСправочники,             Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Документы",                    НСтр("ru = 'Документы';
																|en = 'Documents'"),                      БиблиотекаКартинок.МетаданныеДокументы,               Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ЖурналыДокументов",            НСтр("ru = 'Журналы документов';
																|en = 'Document journals'"),             БиблиотекаКартинок.МетаданныеЖурналыДокументов,       Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Перечисления",                 НСтр("ru = 'Перечисления';
																|en = 'Enumerations'"),                   БиблиотекаКартинок.МетаданныеПеречисления,            Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Отчеты",                       НСтр("ru = 'Отчеты';
																|en = 'Reports'"),                         БиблиотекаКартинок.МетаданныеОтчеты,                  Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Обработки",                    НСтр("ru = 'Обработки';
																|en = 'Data processors'"),                      БиблиотекаКартинок.МетаданныеОбработки,               Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПланыВидовХарактеристик",      НСтр("ru = 'Планы видов характеристик';
																|en = 'Charts of characteristic types'"),      БиблиотекаКартинок.МетаданныеПланыВидовХарактеристик, Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПланыСчетов",                  НСтр("ru = 'Планы счетов';
																|en = 'Charts of accounts'"),                   БиблиотекаКартинок.МетаданныеПланыСчетов,             Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПланыВидовРасчета",            НСтр("ru = 'Планы видов расчета';
																|en = 'Charts of calculation types'"),            БиблиотекаКартинок.МетаданныеПланыВидовРасчета,       Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("РегистрыСведений",             НСтр("ru = 'Регистры сведений';
																|en = 'Information registers'"),              БиблиотекаКартинок.МетаданныеРегистрыСведений,        Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("РегистрыНакопления",           НСтр("ru = 'Регистры накопления';
																|en = 'Accumulation registers'"),            БиблиотекаКартинок.МетаданныеРегистрыНакопления,      Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("РегистрыБухгалтерии",          НСтр("ru = 'Регистры бухгалтерии';
																|en = 'Accounting registers'"),           БиблиотекаКартинок.МетаданныеРегистрыБухгалтерии,     Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("РегистрыРасчета",              НСтр("ru = 'Регистры расчета';
																|en = 'Calculation registers'"),               БиблиотекаКартинок.МетаданныеРегистрыРасчета,         Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("БизнесПроцессы",               НСтр("ru = 'Бизнес-процессы';
																|en = 'Business processes'"),                БиблиотекаКартинок.МетаданныеБизнесПроцессы,          Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Задачи",                       НСтр("ru = 'Задачи';
																|en = 'Tasks'"),                         БиблиотекаКартинок.МетаданныеЗадачи,                  Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ВнешниеИсточникиДанных",       НСтр("ru = 'Внешние источники данных';
																|en = 'External data sources'"),       БиблиотекаКартинок.МетаданныеВнешниеИсточникиДанных,  Ложь, ОбъектыМетаданных);
	...
	Для Каждого Элемент Из Ветка.ПолучитьЭлементы() Цикл
		Если СпособГруппировкиОбъектов = "ПоВидам"
		   ...
		   И (Элемент.ЭтоКоллекцияОбъектов
			...
			Иначе
				ВыбранныеОбъектыМетаданных.Добавить("Конфигурация", НСтр("ru = 'Конфигурация';
																		|en = 'Configuration'"), Истина);
			КонецЕсли;
			Продолжить;
		КонецЕсли;
