...
Функция ЗаголовокНастройки(ЭлементНастроек, ОписаниеНастройки, ТипНастройки, ЭлементПользовательскихНастроек)
	...
	Если ЗначениеЗаполнено(ЗначениеНастройки)
		...
		Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = '%1 (%2)';
				|en = '%1 (%2)'"), ЗначениеНастройки, ПредставлениеНастройки);
...
Процедура ОбновитьЗаголовок()
	...
	Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Быстрые настройки (%1 из %2)';
			|en = 'Quick settings (%1 of %2)'"), КоличествоБыстрыхНастроек, БыстрыеНастройки.Количество());
