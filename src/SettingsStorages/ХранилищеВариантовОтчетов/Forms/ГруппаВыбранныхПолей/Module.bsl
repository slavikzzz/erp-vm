...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Некорректное значение параметра ""Расположение"": ""%1"".';
																						|en = 'Location parameter contains invalid value: %1.'"), Строка(Расположение));
	КонецЕсли;
КонецПроцедуры
