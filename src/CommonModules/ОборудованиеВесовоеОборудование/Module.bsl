...
Процедура ОбновитьПоставляемыеДрайвера(ДрайвераОборудования) Экспорт
	...
	Драйвер.Наименование = НСтр("ru = '1С:Электронные весы (Native Api)';
								|en = '1C:Electronic Scales (NativeApi)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'CAS:Электронные весы';
								|en = 'CAS:Digital retail scales'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'CAS:Электронные весы 2.х';
								|en = 'CAS:Digital retail scales 2.х'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'АТОЛ:Электронные весы 8.Х';
								|en = 'ATOL:Digital retail scales 8.X'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Масса-К:Электронные весы';
								|en = 'MASSA-K:Digital retail scales'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ШТРИХ-М:Электронные весы POS2';
								|en = 'SHTRIH-M:Digital retail scales POS2'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "DrvSM1C"; 
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ЭлектронныеВесы;
	Драйвер.ИмяДрайвера  = "ДрайверСервисПлюсЭлектронныеВесы";
	Драйвер.Наименование = НСтр("ru = 'Сервис-Плюс:Электронные весы';
								|en = 'ServicePlus:Digital retail scales'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'МАС:Электронные весы';
								|en = 'МАS:Digital retail scales'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "ScaleMAS"; 
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ЭлектронныеВесы;
	Драйвер.ИмяДрайвера  = "ДрайверМертехЭлектронныеВесы";
	Драйвер.Наименование = НСтр("ru = 'Мертех:Электронные весы';
								|en = 'Mertech:Digital retail scales'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "ScalePos2M";
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ЭлектронныеВесы;
	Драйвер.ИмяДрайвера  = "ДрайверНАИСЭлектронныеВесы";
	Драйвер.Наименование = НСтр("ru = 'НАИС:Весовые терминалы ВТ';
								|en = 'NAIS:Weighing terminals WT'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'CAS:Весы с печатью этикеток';
								|en = 'CAS:Label printing scales'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'CAS:Весы с печатью этикеток 2.х';
								|en = 'CAS:Label printing scales 2.x'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Масса-К:Весы с печатью этикеток';
								|en = 'Massa-K: Label printing scales'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "MassaKDriverR1C"; 
	Драйвер.ИмяМакетаДрайвера = "ДрайверМассаКЭлектронныеВесыИСПечатьюЭтикеток";
	...
	Драйвер.Наименование = НСтр("ru = 'АТОЛ:Весы c печатью этикеток 8.X';
								|en = 'ATOL:Label printing scales 8.X'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "ATOL_ScaleLP_1CInt"; 
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ВесыСПечатьюЭтикеток;
	Драйвер.ИмяДрайвера  = "ДрайверРБСВесыCПечатьюЭтикеток";
	Драйвер.Наименование = НСтр("ru = 'РБС:Весы c печатью этикеток KS';
								|en = 'RBS:KS label printing scales'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ШТРИХ-М:Весы с печатью этикеток ШТРИХ-ПРИНТ';
								|en = 'SHTRIH-M:Label printing scales SHTRIH-PRINT'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ШТРИХ-М:Весы с печатью этикеток ШТРИХ-ПРИНТ NG';
								|en = 'SHTRIH-M:Label printing scales SHTRIH-PRINT NG'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Bizerba:Драйвер весов с печатью этикеток';
								|en = 'Bizerba:Label printing scales driver'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "BizerbaNative"; 
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ВесыСПечатьюЭтикеток;
	Драйвер.ИмяДрайвера  = "ДрайверСервисПлюсВесыСПечатьюЭтикеток";
	Драйвер.Наименование = НСтр("ru = 'Сервис-Плюс:Весы с печатью этикеток';
								|en = 'ServicePlus:Label printing scales'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "Sm320Driver"; 
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ЭлектронныеВесы;
	Драйвер.ИмяДрайвера  = "ДрайверМертехЭлектронныеВесыУстройствоРаспознавания";
	Драйвер.Наименование = НСтр("ru = 'Мертех:Электронные весы (Распознаватель)';
								|en = 'Mertech:Digital retail scales (Recognizer)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Мертех:Весы с печатью этикеток (Распознаватель)';
								|en = 'Mertech:Label printing scales (Recognizer)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "Mertech";        
	Драйвер.ИмяМакетаДрайвера = "ДрайверМертехВесыСПечатьюЭтикетокРаспознаватель";    
	Драйвер.РекомендуемоеИспользование = Истина;                                  
	...
	Драйвер.Наименование = НСтр("ru = 'РБС:Весы c печатью этикеток Venus';
								|en = 'RBS:Venus label printing scales'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
...
// 
// Параметры:
//  ТаблицаИзображений - Массив из Структура - Данные для выгрузки.
//  РазмерПакета - Число
//  РевизияИнтерфейса - Число
// 
// Возвращаемое значение:
//  Массив из см. СформироватьТаблицуИзображенийВесыСПечатьюЭтикеток - 
//     пакеты для загрузки изображений в весы с печатью этикеток
//
