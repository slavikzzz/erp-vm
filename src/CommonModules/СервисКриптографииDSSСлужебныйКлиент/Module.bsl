...
Процедура АутентификацияПоЛогину(НастройкиПользователя, ОповещениеОЗавершении, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыВызова.Вставить("ВидОперации", НСтр("ru = 'Авторизация по логину';
												|en = 'Username authorization'", КодЯзыка()));
...
Процедура АутентификацияПоСертификату(НастройкиПользователя, ОповещениеОЗавершении, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыВызова			= Новый Структура();
	ПараметрыВызова.Вставить("ВидОперации", НСтр("ru = 'Авторизация по сертификату';
												|en = 'Certificate authorization'", КодЯзыка()));
	ПараметрыВызова.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыВызова.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыВызова.Вставить("ПараметрыОперации", ВходящиеПараметры);
	ПараметрыВызова.Вставить("Сохранить", Ложь);
...
Процедура АутентификацияДвухФакторная(НастройкиПользователя, ОповещениеОЗавершении, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыВызова			= Новый Структура();
	ПараметрыВызова.Вставить("ВидОперации", НСтр("ru = 'Авторизация двух-факторная';
												|en = 'Two-factor authorization'", КодЯзыка()));
	ПараметрыВызова.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыВызова.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыВызова.Вставить("ПараметрыОперации", ВходящиеПараметры);
	ПараметрыВызова.Вставить("Сохранить", Ложь);
...
Процедура АутентификацияДвухФакторнаяЗапросПароля(РезультатВызова, ВходящийКонтекст) Экспорт
	...
	Если Не ЗначениеЗаполнено(ПояснениеОперации) Тогда
		ПояснениеОперации	= НСтр("ru = 'Введите пароль для авторизации.';
									|en = 'Enter the password for authorization.'", КодЯзыка());
	КонецЕсли;
...
Процедура АутентификацияДвухФакторнаяПолучениеПароля(РезультатВызова, ВходящийКонтекст) Экспорт
	...
	Если РезультатВызова.Выполнено Тогда
		...
		ПараметрыПодтверждения.Вставить("ЗаголовокФормы", НСтр("ru = 'Подтвердите аутентификацию';
																|en = 'Confirm authentication'", КодЯзыка()));
...
Процедура АутентификацияЧерезВебФорму(НастройкиПользователя, ОповещениеОЗавершении, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыВызова			= Новый Структура();
	ПараметрыВызова.Вставить("ВидОперации", НСтр("ru = 'Авторизация интерактивная';
												|en = 'Interactive authorization'", КодЯзыка()));
	ПараметрыВызова.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыВызова.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
...
Процедура ПроверкаВыбранногоПользователя(ОповещениеОЗавершении, НастройкиПользователя, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Проверка выбранного пользователя';
												|en = 'Check the selected user'", КодЯзыка()));
...
Процедура ПроверкаАутентификацииПользователя(ОповещениеОЗавершении, ВходящийКонтекст, ЭтоОшибка = Ложь, Принудительно = Ложь) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Проверка авторизации пользователя';
												|en = 'User authorization check'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
...
Процедура ПодтверждениеПроизвольнойОперации(НастройкиПользователя, ОповещениеОЗавершении, СодержаниеОперации = "", СпособПодтверждения = Неопределено, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла		= Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Подтверждение произвольной операции';
												|en = 'Arbitrary operation confirmation'", КодЯзыка()));
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
...
Процедура Зашифровать(НастройкиПользователя, 
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Зашифрование данных';
												|en = 'Data encryption'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
...
Процедура Расшифровать(НастройкиПользователя, 
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Расшифрование данных';
												|en = 'Data decryption'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ДанныеДокумента", ДанныеДокумента);
	ПараметрыЦикла.Вставить("ТипШифрования", ТипШифрования);
	...
	Если РезультатВыполнения.Выполнено Тогда
		...
		ИначеЕсли ПодтверждатьОперацию Тогда
			...
			СоздатьТранзакцию(НастройкиПользователя,
					...
					НСтр("ru = 'Подтвердите расшифровку документа.';
						|en = 'Confirm document decryption.'", КодЯзыка()),
					ВходящийКонтекст.ДанныеДокумента,
					ВходящийКонтекст.ПараметрыОперации);
		Иначе
...
Процедура РасшифроватьАсинхронноПодтверждение(ДлительнаяОперация, ВходящийКонтекст) Экспорт
	...
	Если РезультатВыполнения.Выполнено Тогда
		...
		ПараметрыПодтверждения.Вставить("ЗаголовокФормы", НСтр("ru = 'Подтвердите расшифровку документа.';
																|en = 'Confirm document decryption.'", КодЯзыка()));
...
Процедура РасшифроватьВЦикле(ОповещениеОЗавершении, 
	...
	ПараметрыЦикла 	= Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Расшифрование данных по учетным записям';
												|en = 'Account data decryption'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
...
Процедура ХешированиеДанных(НастройкиПользователя, 
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Вычисление значение хеша';
												|en = 'Calculate hash value'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ДанныеДокумента", ДанныеДокумента);
...
Процедура Подписать(НастройкиПользователя,
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Подписание данных';
												|en = 'Data signing'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ДанныеДокумента", ДанныеДокумента);
		...
		Иначе
			...
			Если НЕ ЗначениеЗаполнено(ТекущийСертификат.Отпечаток) Тогда
				...
				ПолучитьОписаниеОшибки(РезультатОтвета,
									...
									НСтр("ru = 'При подписании';
										|en = 'On signing'", КодЯзыка()));
	...
	Если РезультатВыполнения.Выполнено Тогда
		...
		ИначеЕсли ПодтверждатьОперацию Тогда
			...
			СоздатьТранзакцию(НастройкиПользователя,
					...
					СвойствоПодписи, 
					КлючДействия.КодОперации,
					НСтр("ru = 'Подтвердите подписание данных';
						|en = 'Confirm data signing'", КодЯзыка()),
					ВходящийКонтекст.ДанныеДокумента,
					ПараметрыОперации);
		Иначе
...
Процедура ПодписатьАсинхронноПодтверждение(ДлительнаяОперация, ВходящийКонтекст) Экспорт
	...
	Если РезультатВыполнения.Выполнено Тогда
		...
		ПараметрыПодтверждения = Новый Структура();
		ПараметрыПодтверждения.Вставить("ИдентификаторОперации", ВходящийКонтекст.ИдентификаторТранзакции);
		ПараметрыПодтверждения.Вставить("ЗаголовокФормы", НСтр("ru = 'Подтвердите подписание данных';
																|en = 'Confirm data signing'", КодЯзыка()));
		ПараметрыПодтверждения.Вставить("ТипПодтверждения", "Транзакция");
...
Процедура УсовершенствоватьПодпись(НастройкиПользователя, 
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Усовершенствовать подпись';
												|en = 'Enhance signature'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
...
Процедура УсовершенствоватьПодписьФоновымЗаданием(РезультатВыполнения, ВходящийКонтекст) Экспорт
	...
	Если РезультатВыполнения.Выполнено Тогда
		...
		Если СписокСерверов.Количество() = 0 Тогда
			...
			ПолучитьОписаниеОшибки(РезультатВыполнения,
								"ТипПодписи", 
								НСтр("ru = 'Не обнаружены зарегистрированные сервисы штампов времени.';
									|en = 'Registered timestamp services are not found.'", КодЯзыка()));
...
Процедура ПодготовитьТранзакцию(ОповещениеОЗавершении, ПараметрыВыполнения, ПараметрыОперации) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Подготовка транзакции';
												|en = 'Prepare transaction'", КодЯзыка()));
...
Процедура СоздатьТранзакцию(НастройкиПользователя, 
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Создание транзакции:';
												|en = 'Creating a transaction:'", КодЯзыка()) + " " + КодОперации);
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ДанныеДокумента", ДанныеДокумента);
...
Процедура ПодтвердитьОперацию(НастройкиПользователя, ОповещениеОЗавершении, ПараметрыПодтверждения, ПараметрыОперации = Неопределено)
	...
	Заголовок = СвойствоСтруктуры(ПараметрыПодтверждения, "ЗаголовокФормы", 
					НСтр("ru = 'Подтверждение криптографической операции';
						|en = 'Cryptographic operation confirmation'", КодЯзыка()));
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Подтверждение операции';
												|en = 'Operation confirmation'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
...
Процедура ПроверитьПинКодСертификата(
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Проверка пин-кода сертификата';
												|en = 'Check certificate PIN'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
...
Процедура ПинКодСертификата(
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Ввод пин-кода сертификата';
												|en = 'Enter certificate PIN'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ИдентификаторСертификата", ИдентификаторСертификата);
...
Процедура ПолучитьДанныеСертификата(НастройкиПользователя, 
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Получение данных сертификата';
												|en = 'Get certificate data'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ИдентификаторСертификата", ИдентификаторСертификата);
	ПараметрыЦикла.Вставить("ПараметрыОперации", ПроверитьПараметрыОперации(ПараметрыОперации));
...
Процедура ПолучитьСвойстваСертификата(НастройкиПользователя, 
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Получение сведений сертификата';
												|en = 'Get certificate information'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ИдентификаторСертификата", ИдентификаторСертификата);
	ПараметрыЦикла.Вставить("ПараметрыОперации", ПроверитьПараметрыОперации(ПараметрыОперации));
...
Процедура ОбновитьДанныеСертификатов(НастройкиПользователя, 
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Обновление кеша сертификатов';
												|en = 'Update certificate cache'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ПараметрыОперации", ПроверитьПараметрыОперации(ПараметрыОперации));
...
Процедура СоздатьЗапросНаСертификат(НастройкиПользователя,
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Создание запроса на сертификат';
												|en = 'Create request for certificate issuance'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ПараметрыОперации", ПроверитьПараметрыОперации(ПараметрыОперации));
		...
		Если КлючДействия.Подтверждать ИЛИ ПодтверждатьПринудительно Тогда
			...
			Иначе
				...
				СоздатьТранзакцию(НастройкиПользователя,
						...
						ПараметрыОперации, 
						КлючДействия.КодОперации,
						НСтр("ru = 'Подтвердите создание запроса на сертификат.';
							|en = 'Confirm creation of the request for certificate issuance.'", КодЯзыка()),
						, 
						ВходящийКонтекст.ПараметрыОперации);
			КонецЕсли;
...
Процедура СоздатьЗапросНаСертификатПодтверждение(ДлительнаяОперация, ВходящийКонтекст) Экспорт
	...
	Если РезультатВыполнения.Выполнено Тогда
		...
		ПараметрыПодтверждения.Вставить("ЗаголовокФормы", НСтр("ru = 'Подтвердите создание запроса на сертификат';
																|en = 'Confirm creation of the request for certificate issuance'", КодЯзыка()));
		ПараметрыПодтверждения.Вставить("ТипПодтверждения", "Транзакция");
...
Процедура СоздатьЗапросНаСертификатОшибка(РезультатВыполнения, ВходящийКонтекст)
	...
	ИначеЕсли СервисКриптографииDSSКлиентСервер.ЭтоОшибкаНеобработанныеЗапросы(РезультатВыполнения.СтатусОшибки) Тогда
		...
		СписокКоманд.Добавить("Просмотреть", НСтр("ru = 'Открыть список';
													|en = 'Open list'"), Истина);
		...
		ВывестиВопрос(ОповещениеСледующее, 
			...
			|en = 'Cannot create a new request for certificate issuance because there are pending requests. 
			|Open the list of pending requests?'"),
			СписокКоманд,
			30,
			НСтр("ru = 'Обнаружены необработанные запросы';
				|en = 'Unprocessed requests are found'"),
			ВходящийКонтекст.ПараметрыОперации);
	Иначе
		СоздатьЗапросНаСертификатРезультат(РезультатВыполнения, ВходящийКонтекст);
	КонецЕсли;
...
Процедура УправлениеЗапросамиНаСертификат(НастройкиПользователя, 
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Выбор запроса на сертификат';
												|en = 'Select request for certificate issuance'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ПараметрыОперации", ПроверитьПараметрыОперации(ПараметрыОперации));
...
Процедура ОбработатьЗапросыНаСертификат(НастройкиПользователя,
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Обработка запроса на сертификат';
												|en = 'Process request for certificate issuance'", КодЯзыка()) + ": " + ВыполняемоеДействие);
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
...
Процедура ПолучитьИнформациюУдостоверяющихЦентров(НастройкиПользователя,
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Получение информации об УЦ';
												|en = 'Get certification authority information'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ПараметрыОперации", ПроверитьПараметрыОперации(ПараметрыОперации));
...
Процедура УстановитьСертификат(НастройкиПользователя, 
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Установка сертификата';
												|en = 'Install certificate'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
...
Процедура НазначитьОсновнымСертификат(НастройкиПользователя, 
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Установка основного сертификата';
												|en = 'Install main certificate'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("Сертификат", Сертификат);
...
Процедура СменитьПинКодСертификата(НастройкиПользователя, 
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Смена пин-кода сертификата';
												|en = 'Change certificate PIN'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	...
	Если РезультатВыполнения.Выполнено Тогда
		...
		ИначеЕсли НастройкиПользователя.Политика.РежимПинКода = "Запрещено" Тогда
			...
			ПолучитьОписаниеОшибки(ОтветСервиса, "ОшибкаВыполнения", НСтр("ru = 'Настройки сервера DSS запрещают использование пин-кодов.';
																			|en = 'The DSS server settings do not allow using PIN codes.'"));
			СменитьПинКодСертификатаРезультат(ОтветСервиса, ВходящийКонтекст);
		Иначе
			ВходящийКонтекст.Вставить("ОписаниеСертификата", ТекущийСертификат);
		...
		Если КлючДействия.Подтверждать Тогда
			...
			Иначе
				...
				СоздатьТранзакцию(НастройкиПользователя,
						...
						ПараметрыТранзакции, 
						КлючДействия.КодОперации,
						НСтр("ru = 'Подтвердите смену пин-кода.';
							|en = 'Confirm the PIN change.'", КодЯзыка()),
						,
						ВходящийКонтекст.ПараметрыОперации);
...
Процедура СменитьПинКодСертификатаПодтверждение(ДлительнаяОперация, ВходящийКонтекст) Экспорт
	...
	Если РезультатВыполнения.Выполнено Тогда
		...
		ПараметрыПодтверждения = Новый Структура();
		ПараметрыПодтверждения.Вставить("ИдентификаторОперации", РезультатВыполнения.Результат.ИдентификаторОперации);
		ПараметрыПодтверждения.Вставить("ЗаголовокФормы", НСтр("ru = 'Подтвердите смену пин-код';
																|en = 'Confirm PIN change'", КодЯзыка()));
		ПараметрыПодтверждения.Вставить("ТипПодтверждения", "Транзакция");
...
Процедура ПроверитьСертификат(НастройкиПользователя, ОповещениеОЗавершении, ДанныеСертификата, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Проверка сертификата';
												|en = 'Checking a certificate'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ДанныеСертификата", ДанныеСертификата);
	ПараметрыЦикла.Вставить("ПараметрыОперации", ПроверитьПараметрыОперации(ПараметрыОперации));
...
Процедура ПолучитьСведенияОПодписантах(НастройкиПользователя, ОповещениеОЗавершении, ДанныеДокумента, ТипПодписи, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Получение сведений о подписантах';
												|en = 'Get signer information'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ДанныеДокумента", ДанныеДокумента);
...
Процедура ПроверитьПодпись(НастройкиПользователя, 
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Проверка подписи';
												|en = 'Check signature'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ДанныеДокумента", ДанныеДокумента);
	ПараметрыЦикла.Вставить("ТипПодписи", ТипПодписи);
...
Процедура ПолучитьЗаписиАудита(НастройкиПользователя, 
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Получений выборки записей аудита';
												|en = 'Get audit record selection'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
...
Процедура ОбработатьДокумент(
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Обработка документов';
												|en = 'Process documents'", КодЯзыка()) + ": " + ВыполняемаяОперация);
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
...
Процедура ОперацияСЗакрытомКлючом(НастройкиПользователя,
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Операция с закрытым ключом';
												|en = 'Private key operation'", КодЯзыка()) + ": " + ВыполняемаяОперация);
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ПараметрыОперации", ПроверитьПараметрыОперации(ПараметрыОперации));
	ПараметрыЦикла.Вставить("ВыполняемоеДействие", ВыполняемаяОперация);
	...
	Если РезультатВыполнения.Выполнено Тогда
		...
		Иначе
			...
			Если НЕ ЗначениеЗаполнено(ТекущийСертификат.Отпечаток) Тогда
				...
				ПолучитьОписаниеОшибки(РезультатОтвета,
									"certificate_not_found", 
									НСтр("ru = 'При установке параметра закрытого ключа';
										|en = 'On setting the private key parameter'", КодЯзыка()));
...
Процедура ДанныеОпераций(
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Данные операций';
												|en = 'Operation data'", КодЯзыка()) + ": " + ВыполняемаяОперация);
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
...
Процедура ВыборСертификата(НастройкиПользователя, ОповещениеОЗавершении, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Выбор сертификата';
												|en = 'Select certificate'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ПараметрыОперации", ПроверитьПараметрыОперации(ПараметрыОперации));
...
Процедура ПоказатьСертификат(НастройкиПользователя, ОповещениеОЗавершении, Сертификат, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Показать сведения сертификата';
												|en = 'Show certificate information'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении",ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя",НастройкиПользователя);
	ПараметрыЦикла.Вставить("Сертификат", 			Сертификат);
	ПараметрыЦикла.Вставить("ПараметрыОперации", 	ВходящиеПараметры);
...
Процедура ПоказатьЗапросНаСертификат(НастройкиПользователя, ОповещениеОЗавершении, ЗапросНаСертификат, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Показать сведения запроса на сертификат';
												|en = 'Show request for certificate issuance information'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении",ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя",НастройкиПользователя);
...
Процедура СохранитьДанныеВФайл(ОповещениеОЗавершении, ДанныеФайла, ИмяФайла, ВыборФайла = Ложь, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла.Вставить("ВидОперации", 			НСтр("ru = 'При записи файла';
															|en = 'On saving file'", КодЯзыка()) + ": " + ИмяФайла);
	ПараметрыЦикла.Вставить("ПараметрыОперации",	ПроверитьПараметрыОперации(ПараметрыОперации));
...
Процедура СохранитьДанныеВФайлПроверитьРасширение(РезультатВыполнения, ВходящийКонтекст)
	...
	ТекстСообщения = НСтр("ru = 'Для продолжения работы требуется установить расширение для работы с 1С:Предприятием.';
							|en = 'To continue, install 1C:Enterprise Extension.'", КодЯзыка());
...
Процедура ЗагрузитьДанныеИзФайла(ОповещениеОЗавершении, ИмяФайла, АдресХранилища, ВыборФайла = Ложь, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла.Вставить("НуженВыборФайла",		ВыборФайла);
	ПараметрыЦикла.Вставить("ПараметрыОперации",	ПроверитьПараметрыОперации(ПараметрыОперации));
	ПараметрыЦикла.Вставить("ВидОперации", 			НСтр("ru = 'При загрузке файла';
															|en = 'On importing file'", КодЯзыка()) + ": " + ИмяФайла);
...
Процедура ПоказатьСостояниеУчетнойЗаписи(НастройкиПользователя, ОповещениеОЗавершении, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Показать состояние учетной записи';
												|en = 'Show account state'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
	ПараметрыЦикла.Вставить("ПараметрыОперации", ПроверитьПараметрыОперации(ПараметрыОперации));
...
Процедура ОбновитьПолитикуПользователя(НастройкиПользователя, ОповещениеОЗавершении, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Обновить политику пользователя';
												|en = 'Update user policy'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении",ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя",НастройкиПользователя);
	ПараметрыЦикла.Вставить("ПараметрыОперации", 	ПроверитьПараметрыОперации(ПараметрыОперации));
...
Процедура ОткрытьСведенияУчетнойЗаписи(ОповещениеОЗавершении, СсылкаУчетнойЗаписи, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Открыть сведения учетной записи';
												|en = 'Open account information'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
...
Процедура ВывестиОшибку(ОповещениеОЗавершении, ТекстОшибки = "", ЭтоКодОшибки = Ложь, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Вывести ошибку сервиса';
												|en = 'Display service error'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
...
Процедура ВывестиИнформацию(ОповещениеОЗавершении, ТекстСообщения, ТаймАут = Неопределено, Заголовок = "", ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Вывести информацию пользователю';
												|en = 'Show information to user'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
...
Процедура ВывестиВопрос(ОповещениеОЗавершении, ТекстСообщения, СписокКоманд, ТаймАут = Неопределено, Заголовок = "", ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Вопрос пользователю';
												|en = 'Question to user'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("ТекстСообщения", ТекстСообщения);
...
Процедура ПолучитьОписаниеСервиса(ОповещениеОЗавершении, АдресСервиса = "", ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Получение описание сервиса';
												|en = 'Get service details'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
...
Процедура ВыбратьНастройкиСервиса(ОповещениеОЗавершении, АдресСервиса = "", ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Выбор настроек из описания сервиса';
												|en = 'Select settings from service details'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("АдресСервиса", АдресСервиса);
	ПараметрыЦикла.Вставить("ПараметрыОперации", ПроверитьПараметрыОперации(ПараметрыОперации));
...
Процедура ПроверитьРаботоспособностьСервиса(НастройкиПользователя, ОповещениеОЗавершении, СписокОпераций = Неопределено, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Проверка работоспособности сервиса';
												|en = 'Check service performance'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("НастройкиПользователя", НастройкиПользователя);
...
Процедура ОткрытьСведенияСервера(ОповещениеОЗавершении, СсылкаСервера, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Открыть сведения сервера';
												|en = 'Open server information'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
...
Процедура ВыборЭкземпляраСервера(ОповещениеОЗавершении, ПараметрыОперации = Неопределено) Экспорт
	...
	ПараметрыЦикла = Новый Структура();
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Выбор экземпляра сервера';
												|en = 'Select server instance'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	ПараметрыЦикла.Вставить("ПараметрыОперации", ПроверитьПараметрыОперации(ПараметрыОперации));
...
Функция ПолучитьРезультатВыполненияВФоне(ДлительнаяОперация, ВходящийКонтекст = Неопределено) Экспорт
	...
	Если ДлительнаяОперация = Неопределено Тогда
		Ответ.СтатусОшибки.Представление = НСтр("ru = 'Работа сервиса DSS завершилась с ошибкой.';
												|en = 'DSS cryptography service failed.'", КодЯзыка());
	...
	Иначе
		Ответ.СтатусОшибки.Представление = НСтр("ru = 'Вызов API сервиса DSS завершился с ошибкой при выполнении.';
												|en = 'Failed to call DSS cryptography service API.'", КодЯзыка()) 
...
Процедура ОшибкаПриРаботеСервиса(ИнформацияОбОшибке, СтандартнаяОбработка, ВходящийКонтекст) Экспорт
	...
	Если ЗначениеЗаполнено(ВидОперации) Тогда
		ТекстПользователя	= ТекстПользователя + Символы.ПС + НСтр("ru = 'Вид операции:';
																	|en = 'Operation type:'", КодЯзыка()) + " " + ВидОперации;
	КонецЕсли;	
...
Процедура ПолучитьПодтверждениеПользователя(
	...
	СписокКоманд = Новый СписокЗначений;
	СписокКоманд.Добавить("КодВозвратаДиалога.ОК", НСтр("ru = 'Продолжить';
														|en = 'Continue'"), Истина);
...
Процедура АктивироватьИУстановитьСертификатПослеПроверкиАвторизация(ОтветСервиса, ВходящийКонтекст) Экспорт
	...
	Если НЕ ОтветСервиса.Выполнено Тогда
		...
		ПолучитьОписаниеОшибки(РезультатВыполнения,
							...
							НСтр("ru = 'Ошибка авторизации при установке сертификата в контейнер ключа и хранилище сертификатов сервиса DSS';
								|en = 'Authentication error when trying to install the certificate into the key container and the DSS server certificate storage'", КодЯзыка()));
	...
	Иначе
		...
		ИначеЕсли Расшифровывать Тогда
			ТекстОшибки = НСтр("ru = 'Блок конфиденциальных не заполнен';
								|en = 'Confidential data block is empty'");
			РезультатВыполнения = ОтветСервисаПоУмолчанию(Истина);
	...
	Если ОтветСервиса.Выполнено Тогда
		...
		Если НЕ РезультатВызова.Выполнено Тогда
			ТекстОшибки = НСтр("ru = 'Блок конфиденциальных данных поврежден';
								|en = 'Confidential data block is corrupted'");
		Иначе
...
Процедура АктивироватьИУстановитьСертификатПодтверждениеПользователя(ВходящийКонтекст)
	...
	Если ВходящийКонтекст.ДействиеАктивироватьПароль И ВходящийКонтекст.ДействиеАктивироватьКлючПриложения Тогда
		...
		ЗаголовокПодтверждения = НСтр("ru = 'Подтверждаю получение пароля и QR-кода, содержащий вектора аутентификации.';
										|en = 'I confirm the receipt of the password and QR code containing authentication vectors.'");
		ОписаниеДействия = НСтр("ru = 'Необходимо завершить настройки для подключения к серверу DSS';
								|en = 'Complete the settings to connect to the DSS server'")
							+ НСтр("ru = 'и мобильного приложения.';
									|en = 'and mobile application server.'") + ПС 
							+ " - " + НСтр("ru = 'запомните или сохраните полученный пароль для подключения';
											|en = 'memorize or save the received password for connection'") + ПС
							+ " - " + НСтр("ru = 'отсканируйте в мобильном приложении полученный QR-код';
											|en = 'scan the received QR code in the mobile application'") + ПС
							+ " - " + НСтр("ru = 'подтвердите получение пароля и QR-кода';
											|en = 'confirm the receipt of the password and QR code'") + ПС
							+ " - " + НСтр("ru = 'введите в мобильном приложении высланный в SMS или по почте код активации';
											|en = 'in the mobile application, type the activation code that your received via a text message or an email'") + ПС
							+ " - " + НСтр("ru = 'подключитесь к серверу DSS с новым паролем';
											|en = 'connect to the DSS server using your new password'") + ПС
							+ " - " + НСтр("ru = 'с помощью мобильного приложения выполните операцию контрольной подписи';
											|en = 'use the mobile application to perform the verification signature operation'");
	ИначеЕсли ВходящийКонтекст.ДействиеАктивироватьПароль Тогда
		ПараметрыДляПечати.Вставить("Пароль", ДанныеБлока.Пароль);
		ЗаголовокПодтверждения = НСтр("ru = 'Подтверждаю получение пароля.';
										|en = 'I confirm the receipt of the password.'");
		ОписаниеДействия = НСтр("ru = 'Необходимо завершить настройки для подключения к серверу DSS.';
								|en = 'Complete the settings to connect to the DSS server.'") + ПС 
							+ " - " + НСтр("ru = 'запомните или сохраните полученный пароль для подключения';
											|en = 'memorize or save the received password for connection'") + ПС
							+ " - " + НСтр("ru = 'подтвердите получение пароля';
											|en = 'confirm the receipt of the password'") + ПС
							+ " - " + НСтр("ru = 'с помощью мобильного приложения выполните операцию контрольной подписи';
											|en = 'use the mobile application to perform the verification signature operation'") + ПС
							+ " - " + НСтр("ru = 'подключитесь к серверу DSS с новым паролем';
											|en = 'connect to the DSS server using your new password'");
	ИначеЕсли ВходящийКонтекст.ДействиеАктивироватьКлючПриложения Тогда
		...
		ЗаголовокПодтверждения = НСтр("ru = 'Подтверждаю получение QR-кода, содержащий вектор аутентификации.';
										|en = 'I confirm the receipt of the QR code containing the authentication vector.'");
		ОписаниеДействия = НСтр("ru = 'Необходимо завершить настройки для подключения мобильного приложения.';
								|en = 'Complete the settings to connect the mobile application.'") + ПС 
							+ " - " + НСтр("ru = 'отсканируйте в мобильном приложении полученный QR-код';
											|en = 'scan the received QR code in the mobile application'") + ПС
							+ " - " + НСтр("ru = 'подтвердите получение QR-кода';
											|en = 'confirm the receipt of the QR code'") + ПС
							+ " - " + НСтр("ru = 'введите в мобильном приложении высланный в SMS или по почте код активации';
											|en = 'in the mobile application, type the activation code that your received via a text message or an email'");
	ИначеЕсли ВходящийКонтекст.ДействиеПовторныйКлючПриложения Тогда
		...
		ЗаголовокПодтверждения = НСтр("ru = 'Подтверждаю получение QR-кода, содержащий вектора аутентификации.';
										|en = 'I confirm the receipt of the QR code containing authentication vectors.'");
		ОписаниеДействия = НСтр("ru = 'Необходимо повторно настроить подключение мобильного приложения.';
								|en = 'Reconfigure the mobile application connection.'") + ПС 
							+ " - " + НСтр("ru = 'отсканируйте в мобильном приложении полученный QR-код';
											|en = 'scan the received QR code in the mobile application'") + ПС
							+ " - " + НСтр("ru = 'подтвердите получение QR-кода';
											|en = 'confirm the receipt of the QR code'") + ПС
	...
	Если ЗначениеЗаполнено(ОписаниеДействия) Тогда
		ПолучитьПодтверждениеПользователя(ОповещениеСледующее,
					НСтр("ru = 'Параметры подключения к серверу DSS';
						|en = 'DSS server connection parameters'"),
					ОписаниеДействия,
					ПараметрыДляПечати, 
					ЗаголовокПодтверждения,
					ПараметрыОперации);
	...
	Иначе
		...
		ПолучитьОписаниеОшибки(РезультатВыполнения,
							...
							НСтр("ru = 'Пользователь отказался от продолжения настроек заявления';
								|en = 'The user refused to continue the application settings'"));
		АктивироватьИУстановитьСертификатРезультат(РезультатВыполнения, ВходящийКонтекст); 
	...
	Если НЕ РезультатВыполнения.Выполнено Тогда
		...
		ПолучитьОписаниеОшибки(РезультатВыполнения,
							...
							НСтр("ru = 'Не удалось выполнить контрольную подпись';
								|en = 'Cannot perform the verification signature operation'"));
		АктивироватьИУстановитьСертификатРезультат(РезультатВыполнения, ВходящийКонтекст); 
...
Процедура АктивироватьИУстановитьСертификатАктивироватьПарольУчетнойЗаписи(ОтветСервиса, ВходящийКонтекст) Экспорт
	...
	Если ОтветСервиса.Выполнено Тогда
		Если ВходящийКонтекст.ДействиеАктивироватьПароль Тогда
			...
			СервисКриптографииDSSКлиентСервер.ПолучитьИнформациюДокументаДляПодписи(СвойстваПодписи, НСтр("ru = 'Контрольная подпись';
																											|en = 'Verification signature'"), "txt");
...
Процедура АктивироватьИУстановитьСертификатПослеАктивированияПароля(ОтветСервиса, ВходящийКонтекст) Экспорт
	...
	Если РезультатВыполнения.Выполнено Тогда
		...
		ПараметрыОперации.Вставить("ПояснениеОперации", НСтр("ru = 'Авторизуйтесь на сервере DSS с помощью пароля, полученного ранее.';
															|en = 'Authorize on the DSS server using the password you received earlier.'"));
	...
	Иначе
		...
		ПолучитьОписаниеОшибки(РезультатВыполнения,
							...
							НСтр("ru = 'Ошибка при активировании учетной записи';
								|en = 'An error occurred while activating the account'"));
		АктивироватьИУстановитьСертификатРезультат(РезультатВыполнения, ВходящийКонтекст); 
	КонецЕсли;
	...
	Иначе
		...
		ПолучитьОписаниеОшибки(РезультатВыполнения,
							...
							НСтр("ru = 'Неудачная авторизация с новым паролем';
								|en = 'Failed authorization with a new password'"));
		АктивироватьИУстановитьСертификатРезультат(РезультатВыполнения, ВходящийКонтекст); 
	КонецЕсли;
...
Процедура АктивироватьИУстановитьСертификатПроверитьСертификат(РезультатВыполнения, ВходящийКонтекст)
	...
	Иначе
		...
		ПолучитьОписаниеОшибки(РезультатВыполнения,
							ВходящийКонтекст.ТипОшибки,
							НСтр("ru = 'Обновление списка сертификатов из хранилища сертификатов сервера DSS';
								|en = 'Update the list of certificates from the DSS server certificate storage'", КодЯзыка()));
		АктивироватьИУстановитьСертификатРезультат(РезультатВыполнения, ВходящийКонтекст); 
...
Процедура ВосстановитьУчетнуюЗапись(ОповещениеОЗавершении, ДанныеСервера, Логин, Пароль, ПараметрыОперации) Экспорт
	...
	ПараметрыЦикла = Новый Структура;
	ПараметрыЦикла.Вставить("ВидОперации", НСтр("ru = 'Восстановление учетной записи';
												|en = 'Restore account'", КодЯзыка()));
	ПараметрыЦикла.Вставить("ОповещениеОЗавершении", ОповещениеОЗавершении);
	...
	Если РезультатВыполнения.Выполнено Тогда
		...
		Иначе
			...
			ЗаголовокОшибки = НСтр("ru = 'Не удалось создать учетную запись DSS';
									|en = 'Cannot create a DSS account'");
