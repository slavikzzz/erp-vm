...
Процедура ОбновлениеИндексаППД() Экспорт
	...
	ОбновитьИндекс(НСтр("ru = 'Обновление индекса ППД';
						|en = 'Update full-text search index'"), Ложь, Истина);
...
Процедура СлияниеИндексаППД() Экспорт
	...
	ОбновитьИндекс(НСтр("ru = 'Слияние индекса ППД';
						|en = 'Merge full-text search index'"), Истина);
...
Процедура ЗаписьЖурнала(УровеньЖурнала, КомментарийСПараметрами, ИнформацияОбОшибке = Неопределено,
	...
	ЗаписьЖурналаРегистрации(НСтр("ru = 'Полнотекстовое индексирование';
									|en = 'Full-text indexing'", ОбщегоНазначения.КодОсновногоЯзыка()), 
