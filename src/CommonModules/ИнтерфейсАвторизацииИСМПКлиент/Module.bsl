...
// 	ДополнительныеПараметры - (См. ДополнительныеПараметрыЗапросаКлючаСессии).
Процедура ЗапроситьКлючСессии(ПараметрыЗапроса, ОповещениеПриЗавершении = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
...
// Запросить новый ключ сессии для авторизации в ИС МП с учетом разделения на токен ИС МП и токен ИС МП (розница)
// 
// Параметры:
//  ПараметрыСканирования   - см. ШтрихкодированиеОбщегоНазначенияИСКлиент.ПараметрыСканирования
//  ВидПродукции            - ПеречислениеСсылка.ВидыПродукцииИС - вид продукции для проверки наступления разрешительного режима
//  ОповещениеПриЗавершении - ОписаниеОповещения - Описание оповещения после получения результата.
Процедура ЗапроситьКлючСессииСУчетомВидаТокена(ПараметрыСканирования, ВидПродукции, ОповещениеПриЗавершении = Неопределено) Экспорт
	...
	ДополнительныеПараметры           = ДополнительныеПараметрыЗапросаКлючаСессии();
	...
	ЗапроситьКлючСессии(ПараметрыЗапроса, ОповещениеПриЗавершении, ДополнительныеПараметры);
...
// Функция возвращает структуру дополнительных параметров для запроса
// ключа сессии. 
// 
// Возвращаемое значение:
//  Структура - Дополнительные параметры запроса ключа сессии:
// * ПоказыватьОшибкиНапрямую - Булево - если Истина, то сообщения выводятся в виде предупреждений, а не в форме ошибок авторизации
// * РежимБРМК                - Булево - если Истина, то отсутствует форма ошибок авторизации
Функция ДополнительныеПараметрыЗапросаКлючаСессии() Экспорт
	
	Параметры = Новый Структура();
	
	Параметры.Вставить("ПоказыватьОшибкиНапрямую", Ложь);
	Параметры.Вставить("РежимБРМК",                Ложь);
