...
Функция ТекстЗапросаТаблицаОперацииСПрослеживаемымиТоварамиРасширенный(Запрос, ТекстыЗапроса, Регистры)
	...
	|		КОГДА втТоварыОрганизаций.СтавкаНДС = ЗНАЧЕНИЕ(Справочник.СтавкиНДС.БезНДС)
...
Процедура ЗаполнитьДокументНаОснованииЧекаККМ(Объект, Знач ДокументОснование)
	...
	Если Объект.Товары.Количество() = 0 Тогда
		ТекстОшибки = НСтр("ru = 'По данному чеку ККМ нет товаров для возврата или все товары уже возвращены.';
							|en = 'For this cash register receipt, there are no goods to return or all goods have already been returned.'");
...
Процедура ПроверитьВозможностьВводаНаОснованииЧекККМ(Объект, ЧекККМ, Отказ = Неопределено)
	...
	ИначеЕсли Документы.ЧекККМКоррекции.ЕстьКоррекцияПоЧекуККМ(ДанныеЧекККМ.Ссылка) Тогда
		ТекстОшибки =  НСтр("ru = 'По Чеку ККМ введен Чек ККМ коррекции. Ввод на основании чека документа ""Возврат товаров от клиента"" запрещен.';
							|en = 'Cash register adjustment voucher is entered for the cash register receipt. You cannot enter based on the ""Goods return from customer"" document receipt.'");
	ИначеЕсли Документы.ЧекККМВозврат.ЕстьВозвратПоЧекуККМ(ДанныеЧекККМ.Ссылка) Тогда
		ТекстОшибки =  НСтр("ru = 'По Чеку ККМ введен Чек ККМ на возврат. Ввод на основании чека документа ""Возврат товаров от клиента"" запрещен.';
							|en = 'Return receipt is entered for this cash receipt. You cannot generate the ""Goods return from customer"" document from the receipt.'");
	КонецЕсли;
