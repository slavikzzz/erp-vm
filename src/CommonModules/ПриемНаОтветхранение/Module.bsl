...
Процедура СообщитьОРезультатахКонтроляИзменений(РезультатыКонтроля, Документ, Отказ) Экспорт
	...
	Если ПроведениеДокументов.ЕстьЗаписиВТаблице(Документ, "ДвиженияПринятаяВозвратнаяТараИзменение") Тогда
		...
		ШаблонСообщенияСДокументомСЗалогом = НСтр("ru = 'Номенклатура %1. Возвращается (выкупается) больше, чем принято по документу %2 под залог на %3 %4';
													|en = 'Items %1. Number of returned (purchased) items exceeds the number of received ones under the document%2 against security by %3 %4'");
		ШаблонСообщенияСДокументомБезЗалога = НСтр("ru = 'Номенклатура %1. Возвращается (выкупается) больше, чем принято по документу %2 на %3 %4';
													|en = 'Items %1. Number of returned (purchased) items exceeds the number of received ones under the document%2 by %3 %4'");
		
		ШаблонСообщенияБезДокументаСЗалогом = НСтр("ru = 'Номенклатура %1. Возвращается (выкупается) больше, чем принято под залог на %3 %4';
													|en = 'Items %1. Number of returned (purchased) items exceeds the number of received ones against security by %3 %4'");
		ШаблонСообщенияБезДокументаБезЗалога = НСтр("ru = 'Номенклатура %1. Возвращается (выкупается) больше, чем принято на %3 %4';
													|en = 'Items %1. Number of returned (purchased) items exceeds the number of received ones by %3 %4'");
