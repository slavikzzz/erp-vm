...
Функция СформироватьОбособленноеПодразделениеАЛКО(СведенияОбОП, ЭтоПБОЮЛ,
		ОрганизацияИНН, НуженВидПродажи = Ложь) Экспорт
	...
	Если НуженВидПродажи Тогда
		...
		Если НаименованиеОП <> "Заполнить" И ВидРозничнойПродажи <> 0 Тогда
			...
			НаименованиеОП = "Вид розничной продажи " + Строка(ВидРозничнойПродажи) + ", " +
							?(ОтсутствуетИнтернет, "Интернет отсутствует,", "") + Символы.ПС +
							НаименованиеОП;
