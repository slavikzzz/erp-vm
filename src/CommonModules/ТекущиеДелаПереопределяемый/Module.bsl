...
Процедура ПриОпределенииПорядкаРазделовКомандногоИнтерфейса(Разделы) Экспорт
	...
	Если Метаданные.Подсистемы.Найти("Зарплата") <> Неопределено Тогда
		Разделы.Добавить(Метаданные.Подсистемы["Зарплата"]);
	КонецЕсли;
	Если Метаданные.Подсистемы.Найти("Кадры") <> Неопределено Тогда
	...
	КонецЕсли;
	//++ НЕ УТ
	Если Метаданные.Подсистемы.Найти("РегламентированныйУчет") <> Неопределено Тогда
		Разделы.Добавить(Метаданные.Подсистемы["РегламентированныйУчет"]);
	КонецЕсли;
	//-- НЕ УТ

	//++ НЕ УТКА
	Если Метаданные.Подсистемы.Найти("МеждународныйФинансовыйУчет") <> Неопределено Тогда
