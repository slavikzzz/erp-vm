...
Функция ОформленныеДокументыПоМаркировкеТоваровИСМП()
	...
	//++ НЕ УТ
	ДобавитьОснование(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "ВыходныеИзделия", Истина);
	ДобавитьОснование(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "ВыходныеИзделияСерии");
	ДобавитьОснование(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "ПобочныеИзделия", Истина);
	ДобавитьОснование(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "ПобочныеИзделияСерии");
	//-- НЕ УТ

	//++ НЕ УТКА
	ДобавитьОснование(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "ВыходныеИзделия", Истина);
	ДобавитьОснование(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "ВыходныеИзделияСерии");
	ДобавитьОснование(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "ПобочныеИзделия", Истина);
	ДобавитьОснование(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "ПобочныеИзделияСерии");
	//-- НЕ УТКА
	Текст = СтрСоединить(МассивТекстовЗапросов, "
	|
	|ОБЪЕДИНИТЬ ВСЕ
...
Функция ОформленныеДокументыПоПроизводственнойОперацииВЕТИС()
	...
	ДобавитьОснование(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "ПобочныеИзделия", Истина);
	ДобавитьОснование(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "ПобочныеИзделияСерии");
	ДобавитьОснование(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "МатериалыИРаботы",, "-");
	//-- НЕ УТ
	...
	ДобавитьОснование(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "ПобочныеИзделия", Истина);
	ДобавитьОснование(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "ПобочныеИзделияСерии");
	ДобавитьОснование(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "РасходМатериаловИРабот",, "-");
	//-- НЕ УТКА
	Текст = СтрСоединить(МассивТекстовЗапросов, "
	|
	|ОБЪЕДИНИТЬ ВСЕ
...
Функция ОформленныеДокументыПоОтгрузкеПродукцииВЕТИС()
	...
	//++ НЕ УТ
	ДобавитьОснование(МассивТекстовЗапросов, "ОтгрузкаТоваровСХранения", "Товары", Истина);
	ДобавитьОснование(МассивТекстовЗапросов, "ОтгрузкаТоваровСХранения", "Серии");
	//++ Устарело_Переработка24
	ДобавитьОснование(МассивТекстовЗапросов, "ПередачаСырьяПереработчику", "Товары", Истина);
	ДобавитьОснование(МассивТекстовЗапросов, "ПередачаСырьяПереработчику", "Серии");
	//-- Устарело_Переработка24
	ДобавитьОснование(МассивТекстовЗапросов, "ДвижениеПродукцииИМатериалов", "Товары", Истина);
	ДобавитьОснование(МассивТекстовЗапросов, "ДвижениеПродукцииИМатериалов", "Серии");
	//-- НЕ УТ

	//++ НЕ УТКА

	//++ Устарело_Переработка24
	ДобавитьОснование(МассивТекстовЗапросов, "ПередачаДавальцу", "Товары", Истина);
	ДобавитьОснование(МассивТекстовЗапросов, "ПередачаДавальцу", "Серии");
	ДобавитьОснование(МассивТекстовЗапросов, "ВозвратСырьяДавальцу", "Товары", Истина);
	ДобавитьОснование(МассивТекстовЗапросов, "ВозвратСырьяДавальцу", "Серии");
	//-- Устарело_Переработка24
...
Функция ОформленныеДокументыПоПоступлениюПродукцииВЕТИС()
	...
	ДобавитьОснование(МассивТекстовЗапросов,"ПередачаТоваровМеждуОрганизациями", "Товары");
	//++ НЕ УТ
	ДобавитьОснование(МассивТекстовЗапросов,"ПриемкаТоваровНаХранение", "Товары", Истина);
	ДобавитьОснование(МассивТекстовЗапросов,"ПриемкаТоваровНаХранение", "Серии");
	ДобавитьОснование(МассивТекстовЗапросов,"ВыкупПринятыхНаХранениеТоваров", "Товары");
	//++ Устарело_Переработка24
	ДобавитьОснование(МассивТекстовЗапросов,"ВозвратСырьяОтПереработчика", "Товары", Истина);
	ДобавитьОснование(МассивТекстовЗапросов,"ВозвратСырьяОтПереработчика", "Серии");
	ДобавитьОснование(МассивТекстовЗапросов,"ПоступлениеОтПереработчика", "Товары", Истина);
	ДобавитьОснование(МассивТекстовЗапросов,"ПоступлениеОтПереработчика", "ТоварыСерии");
	ДобавитьОснование(МассивТекстовЗапросов,"ПоступлениеОтПереработчика", "ВозвратныеОтходы", Истина);
	ДобавитьОснование(МассивТекстовЗапросов,"ПоступлениеОтПереработчика", "ВозвратныеОтходыСерии");
	//-- Устарело_Переработка24
	ДобавитьОснование(МассивТекстовЗапросов,"ДвижениеПродукцииИМатериалов", "Товары", Истина);
	ДобавитьОснование(МассивТекстовЗапросов,"ДвижениеПродукцииИМатериалов", "Серии");
	//-- НЕ УТ
	...
	//++ Устарело_Переработка24
	ДобавитьОснование(МассивТекстовЗапросов,"ПоступлениеСырьяОтДавальца", "Товары",Истина);
	ДобавитьОснование(МассивТекстовЗапросов,"ПоступлениеСырьяОтДавальца", "Серии");
	ДобавитьОснование(МассивТекстовЗапросов,"ВозвратСырьяДавальцу", "Товары", Истина);
	ДобавитьОснование(МассивТекстовЗапросов,"ВозвратСырьяДавальцу", "Серии");
	//-- Устарело_Переработка24
...
Функция ОформленныеДокументыПоДвижениюАлкогольнойПродукции()
	...
	//++ НЕ УТ
	ДобавитьОснованиеСУсловиемОтбора(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "ВыходныеИзделия", Истина,,, "ТаблицаТовары.НаправлениеВыпуска = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВыпускПродукцииНаСклад)");
	ДобавитьОснование(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "ВыходныеИзделияСерии");
	ДобавитьОснованиеСУсловиемОтбора(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "ПобочныеИзделия", Истина,,, "ТаблицаТовары.НаправлениеВыпуска = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВыпускПродукцииНаСклад)");
	ДобавитьОснование(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "ПобочныеИзделияСерии");
	ДобавитьОснование(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "МатериалыИРаботы",, "-");
	//-- НЕ УТ
	
	//++ НЕ УТКА
	ДобавитьОснованиеСУсловиемОтбора(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "ВыходныеИзделия", Истина,,, "ТаблицаТовары.Получатель ССЫЛКА Справочник.Склады И ТаблицаТовары.Произведено");
	ДобавитьОснованиеСУсловиемОтбора(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "ВыходныеИзделияСерии",,,, "ТаблицаТовары.Произведено");
	ДобавитьОснованиеСУсловиемОтбора(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "ПобочныеИзделия", Истина,,, "ТаблицаТовары.Получатель ССЫЛКА Справочник.Склады И ТаблицаТовары.Произведено");
	ДобавитьОснованиеСУсловиемОтбора(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "ПобочныеИзделияСерии",,,, "ТаблицаТовары.Произведено");
	ДобавитьОснование(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "РасходМатериаловИРабот",, "-");
	//-- НЕ УТКА
...
Функция ОформленныеДокументыПоДвижениюЗЕРНО()
	...
	//++ НЕ УТ
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "ВыходныеИзделия", Истина);
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "ВыходныеИзделияСерии");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "ПобочныеИзделия", Истина);
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "ПобочныеИзделияСерии");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПроизводствоБезЗаказа", "МатериалыИРаботы",, "-");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПриемкаТоваровНаХранение", "Товары", Истина);
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПриемкаТоваровНаХранение", "Серии");
	//++ Устарело_Переработка24
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПередачаСырьяПереработчику", "Товары", Истина, "-");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПередачаСырьяПереработчику", "Серии",, "-");
	
	МассивТекстовЗапросовОтчетПереработчика = Новый Массив;
	ОтчетыПереработчика = "";
	Если ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросовОтчетПереработчика, "ОтчетПереработчика", "Продукция") Тогда
		ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросовОтчетПереработчика, "ОтчетПереработчика", "Материалы",, "-");
		ОтчетыПереработчика = СтрСоединить(МассивТекстовЗапросовОтчетПереработчика, " ОБЪЕДИНИТЬ ВСЕ ");
		ОтчетыПереработчика = СтрЗаменить(ОтчетыПереработчика, "ТаблицаТовары.Серия", "ЗНАЧЕНИЕ(Справочник.СерииНоменклатуры.ПустаяСсылка)");
	КонецЕсли;
	
	Если ЗначениеЗаполнено(ОтчетыПереработчика) Тогда
		МассивТекстовЗапросов.Добавить(ОтчетыПереработчика);
	КонецЕсли;
	
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ВозвратСырьяОтПереработчика", "Товары", Истина, "-");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ВозвратСырьяОтПереработчика", "Серии",, "-");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПоступлениеОтПереработчика", "Товары", Истина, "-");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПоступлениеОтПереработчика", "ТоварыСерии",, "-");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПоступлениеОтПереработчика", "ВозвратныеОтходы", Истина, "-");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПоступлениеОтПереработчика", "ВозвратныеОтходыСерии",, "-");
	//-- Устарело_Переработка24
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ДвижениеПродукцииИМатериалов", "Товары", Истина);
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ДвижениеПродукцииИМатериалов", "Серии");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ДвижениеПродукцииИМатериалов", "Товары", Истина, "-");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ДвижениеПродукцииИМатериалов", "Серии",, "-");
	
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПоступлениеТоваровОтХранителя", "Товары", Истина, "-");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПоступлениеТоваровОтХранителя", "Серии",, "-");
	
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ОтчетПереработчика2_5", "ВыходныеИзделия");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ОтчетПереработчика2_5", "ПобочныеИзделия");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ОтчетПереработчика2_5", "МатериалыИРаботы",, "-");
	//-- НЕ УТ
	
	//++ НЕ УТКА
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "ВыходныеИзделия", Истина,,, "ТаблицаТовары.Произведено");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "ВыходныеИзделияСерии",,,, "ТаблицаТовары.Произведено");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "ПобочныеИзделия", Истина,,, "ТаблицаТовары.Произведено");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "ПобочныеИзделияСерии",,,, "ТаблицаТовары.Произведено");
	//++ Устарело_Переработка24
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПередачаДавальцу", "Товары", Истина);
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ПередачаДавальцу", "Серии");
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ВозвратСырьяДавальцу", "Товары", Истина);
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ВозвратСырьяДавальцу", "Серии");
	//-- Устарело_Переработка24
	ДобавитьОснованиеСВидомДвижения(МассивТекстовЗапросов, "ЭтапПроизводства2_2", "РасходМатериаловИРабот",, "-");
	//-- НЕ УТКА
...
//++ НЕ УТ
Функция ДобавитьОснованиеСУсловиемОтбора(МассивТекстовЗапросов, ИмяДокумента, ИмяТабличнойЧасти, СерииОтдельно = Ложь, Знак = "", Постфикс = "", УсловиеОтбора = "ИСТИНА")
...
Процедура УстановитьПараметрыОтчетаСАТУРН(ОтчетОбъект)
	...
	//++ НЕ УТ
	ТипыДокументаОснованияВходящейНакладной.Добавить(Тип("ДокументСсылка.ДвижениеПродукцииИМатериалов"));
	//-- НЕ УТ
	...
	//++ НЕ УТ
	ТипыДокументаОснованияИсходящейНакладной.Добавить(Тип("ДокументСсылка.ДвижениеПродукцииИМатериалов"));
	ТипыДокументаОснованияИсходящейНакладной.Добавить(Тип("ДокументСсылка.ПроизводствоБезЗаказа"));
	ТипыДокументаОснованияИсходящейНакладной.Добавить(Тип("ДокументСсылка.ОтчетПереработчика2_5"));
	//-- НЕ УТ
	
	//++ НЕ УТКА
	ТипыДокументаОснованияИсходящейНакладной.Добавить(Тип("ДокументСсылка.ЭтапПроизводства2_2"));
	//-- НЕ УТКА
