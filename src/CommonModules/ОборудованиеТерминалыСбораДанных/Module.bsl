...
Процедура ОбновитьПоставляемыеДрайвера(ДрайвераОборудования) Экспорт
	...
	Драйвер.Наименование = НСтр("ru = 'Гексагон:Терминалы сбора данных Goods';
								|en = 'Hexagon:Goods portable data terminals'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "ProtonTSD"; 
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ТерминалСбораДанных;
	Драйвер.ИмяДрайвера  = "ДрайверКлеверенсТерминалыСбораДанных";
	Драйвер.Наименование = НСтр("ru = 'CLEVERENCE:Терминалы сбора данных';
								|en = 'CLEVERENCE:Терминалы сбора данных'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'АТОЛ:Терминалы сбора данных Mobile Logistics 8.Х';
								|en = 'ATOL:Mobile Logistics 8.X portable data terminals'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "PDX1C_Int"; 
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ТерминалСбораДанных;
	Драйвер.ИмяДрайвера  = "ДрайверRightScanТерминалыСбораДанных";
	Драйвер.Наименование = НСтр("ru = 'RightScan:Терминалы сбора данных';
								|en = 'RightScan:Portable data terminal'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Сканкод:Терминалы сбора данных Cipher LAB 8x00 (Native Api)';
								|en = 'Scancode:Cipher LAB 8x00 portable data terminals (Native Api)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Сканкод:Терминалы сбора данных Cipher Lab 8 G2';
								|en = 'Scancode:Cipher Lab 8 G2 portable data terminals'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Скансити:Терминал сбора данных City-Soft Business';
								|en = 'Scancity:City-Soft Business portable data terminal'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Скансити:Терминал сбора данных City-Soft Lite';
								|en = 'Scancity:City-Soft Lite portable data terminal'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Скансити:Терминал сбора данных City-Soft Standart';
								|en = 'Scancity:City-Soft Standart portable data terminal'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Харвестр:Приложение сбора данных';
								|en = 'Harvester:Portable data application'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Сканпорт:Терминал сбора данных';
								|en = 'Scanport:Portable data terminal'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Если НЕ ПустаяСтрока(ДанныеЗагрузки) Тогда
		...
		Исключение   
			РезультатВыполнения.ТекстОшибки = НСтр("ru = 'Загружаемые данные из ТСД имеют неверный формат.';
													|en = 'Data to import from the PDT has an incorrect format.'"); 
