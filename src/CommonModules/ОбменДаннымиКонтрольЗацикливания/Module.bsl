...
Процедура СкрытьПоказатьПредупреждениеЗацикливанияОтПользователя(Направление) Экспорт
	...
	ОписаниеНастроек = НСтр("ru = 'Скрыть подсказку о цикличных настройках синхронизации.';
							|en = 'Скрыть подсказку о цикличных настройках синхронизации.'", ОбщегоНазначения.КодОсновногоЯзыка());
