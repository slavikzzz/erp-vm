	...
	Если Ответ.КодСостояния = 200 Тогда
		...
		Иначе
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Электронный документооброт с контролирующими органами.Получение серийного номер ViPNet CSP';
					|en = 'Электронный документооброт с контролирующими органами.Получение серийного номер ViPNet CSP'", ОбщегоНазначения.КодОсновногоЯзыка()),
			...
			ДлительнаяОтправкаКлиентСервер.ВывестиОшибку(
				НСтр("ru = 'Сервис получения серийных номер для ViPNet CSP временно не доступен. Повторите попытку позже.';
					|en = 'Сервис получения серийных номер для ViPNet CSP временно не доступен. Повторите попытку позже.'"));
		КонецЕсли;
...
Функция ПолучитьДистрибутивCryptoProCSP(Параметры) Экспорт
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru = 'Получение дистрибутива CryptoPro CSP';
															|en = 'Получение дистрибутива CryptoPro CSP'");
...
Функция СкриптСистемнойИнформации(ИмяКаталога) ЭКспорт
