...
//++ НЕ УТКА
	СоответствиеПолей.Вставить("ПередачаДавальцу", Новый Соответствие);
	СоответствиеПолей["ПередачаДавальцу"].Вставить("ГрузоотправительХозяйствующийСубъект", "Организация");
	СоответствиеПолей["ПередачаДавальцу"].Вставить("ГрузоотправительПредприятие", "Склад");
	СоответствиеПолей["ПередачаДавальцу"].Вставить("ГрузополучательХозяйствующийСубъект", "Контрагент");
	СоответствиеПолей["ПередачаДавальцу"].Вставить("ГрузополучательПредприятие", "Партнер");
	
	СоответствиеПолей.Вставить("ВозвратСырьяДавальцу", Новый Соответствие);
	СоответствиеПолей["ВозвратСырьяДавальцу"].Вставить("ГрузоотправительХозяйствующийСубъект", "Организация");
	СоответствиеПолей["ВозвратСырьяДавальцу"].Вставить("ГрузоотправительПредприятие", "Склад");
	СоответствиеПолей["ВозвратСырьяДавальцу"].Вставить("ГрузополучательХозяйствующийСубъект", "Контрагент");
	СоответствиеПолей["ВозвратСырьяДавальцу"].Вставить("ГрузополучательПредприятие", "Партнер");
//-- НЕ УТКА
...
//++ НЕ УТКА
	СоответствиеПолей.Вставить("ПоступлениеСырьяОтДавальца", Новый Соответствие);
	СоответствиеПолей["ПоступлениеСырьяОтДавальца"].Вставить("ГрузоотправительХозяйствующийСубъект", "Контрагент");
	СоответствиеПолей["ПоступлениеСырьяОтДавальца"].Вставить("ГрузоотправительПредприятие", "Партнер");
	СоответствиеПолей["ПоступлениеСырьяОтДавальца"].Вставить("ГрузополучательХозяйствующийСубъект", "Организация");
	СоответствиеПолей["ПоступлениеСырьяОтДавальца"].Вставить("ГрузополучательПредприятие", "Склад");
//-- НЕ УТКА
...
//++ НЕ УТКА
	...
	СоответствиеПолей["ЭтапПроизводства2_2"].Вставить("ХозяйствующийСубъект", "Организация");
	СоответствиеПолей["ЭтапПроизводства2_2"].Вставить("Предприятие", "Подразделение");
//-- НЕ УТКА
...
Процедура ЗаполнитьСвойстваЭлементовПроизводственнойТранзакцииПоДокументуОснованию(Свойства, ДокументОснование) Экспорт
	...
	Если ЗначениеЗаполнено(ДокументОснование)
		И ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ЭтапПроизводства2_2") Тогда
		
		Свойства.Видимость = Истина;
		
		ДоступныеТипы = Новый Массив;
		ДоступныеТипы.Добавить(Тип("ДокументСсылка.ЭтапПроизводства2_2"));
		ДоступныеТипы.Добавить(Тип("СправочникСсылка.ПартииПроизводства"));
		Свойства.ОграничениеТипа = Новый ОписаниеТипов(ДоступныеТипы);
		
		РазрешитьСтроковыйИдентификатор = Ложь;
