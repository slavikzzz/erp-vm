...
Процедура ПараметрыКриптографии(ОповещениеОбратногоВызова, ПараметрыФормы) Экспорт
	...
	ДополнительныеПараметрыФормы.Вставить("ОписаниеОповещение", ОповещениеОбратногоВызова);
	...
	ОткрытьФорму("ОбщаяФорма.ВводПараметровКриптографииОбменаСБанками",
		ПараметрыФормы, ОповещениеОбратногоВызова.Модуль, , , ,
...
Функция ПараметрыПодготовкиТранзакции() Экспорт
	...
	Результат.Вставить("ДобавитьМеткуДоверенногоВремени", Ложь);  // Добавить в подпись метку доверенного времени.
...
// Параметры, используемые при подписании.
// 
// Возвращаемое значение:
//  Структура - Параметры подписать:
// * МенеджерКриптографии - Неопределено - менеджер криптографии для подписания.
// * Сертификат - Неопределено - сертфикат, если не задан, то открывается окно выбора сертификата.
// * Данные - Неопределено - подписываемые данные, ДвоичныеДанные или имя файла.
// * ЭтоОблачныйСертификат - Булево - признак использования облачного сертификата.
// * ВключениеСертификатовВПодпись - Неопределено - режим включения сертификата в подпись см. РежимВключенияСертификатовКриптографии.
// * ДобавитьМеткуДоверенногоВремени - Булево - признак добавления метки доверенного времени в подпись.
// 
Функция ПараметрыПодписать() Экспорт
	...
	Параметры.Вставить("ДобавитьМеткуДоверенногоВремени", Ложь);
...
Процедура ПараметрыКриптографииЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если ТипЗнч(РезультатВыбора) = Тип("Структура") Тогда
		...
		Результат.Доверенность                        = РезультатВыбора.Доверенность;
		Результат.ЭтоЭлектроннаяПодписьВМоделиСервиса = РезультатВыбора.ЭтоОблачныйСертификат;
		Результат.ДобавитьМеткуДоверенногоВремени     = РезультатВыбора.ДобавитьМеткуДоверенногоВремени;
	Иначе
...
Функция ТранзакцииТребующиеРасшифровки(Сервис = Неопределено, Организация = Неопределено, СписокТранзакций = Неопределено,
	...
	Возврат УниверсальныйОбменСБанкамиВызовСервера.ТранзакцииТребующиеРасшифровки(Сервис, Организация, СписокТранзакций, Ответственный);
