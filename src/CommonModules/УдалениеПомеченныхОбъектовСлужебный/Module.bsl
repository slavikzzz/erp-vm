			...
			Исключение
				ЗаписьЖурналаРегистрации(
					НСтр("ru = 'Удаление помеченных';
						|en = 'Marked object deletion'", ОбщегоНазначения.КодОсновногоЯзыка()),
					УровеньЖурналаРегистрации.Ошибка,,, НСтр(
					"ru = 'Не удалось отключить проверку удаляемых объектов по причине:';
					|en = 'Cannot disable check of marked objects due to:'") + Символы.ПС
...
Функция ОбработатьОчередьПометокНаУдаление(ОчередьПометкиКУдалению)
	...
	Если ПредставленияОшибок.Количество() > 0 Тогда
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Удаление помеченных';
				|en = 'Marked object deletion'", ОбщегоНазначения.КодОсновногоЯзыка()), УровеньЖурналаРегистрации.Ошибка,
			,, НСтр("ru = 'Не удалось установить пометку удаления для объектов:';
					|en = 'Couldn''t mark the following objects for deletion:'") + Символы.ПС + СтрСоединить(
