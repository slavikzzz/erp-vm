...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	КадровыйЭДО.НастроитьВариантыОтчетов(Настройки);
...
Функция МакетыВариантовОтчетовПечатныхФорм() Экспорт
	...
	МакетыВариантовОтчетов.Вставить("Отчет.ДокументыКЭДОСотрудников.КарточкаЭлектронногоДокумента",
		"Отчет.ДокументыКЭДОСотрудников.ПФ_MXL_КарточкаЭлектронногоДокумента");
