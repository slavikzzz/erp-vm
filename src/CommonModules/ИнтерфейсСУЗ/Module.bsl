...
Функция ЗапроситьИдентификаторСоединения_V2(ТелоЗапросаJSON, ЭлементОчереди, ПараметрыСУЗ, Подпись = Неопределено) Экспорт
			...
			Если РезультатБИП.КодОшибки = "НеверныйФорматЗапроса"
				...
				ВозвращаемоеЗначение.ТекстОшибки = СтрШаблон(
					НСтр("ru = 'Запрос на получение идентификатора соединения не может быть обработан сервисом интернет-поддержки.
						     |Текст ошибки: %1.';
						     |en = 'Запрос на получение идентификатора соединения не может быть обработан сервисом интернет-поддержки.
						     |Текст ошибки: %1.'"),
					РезультатБИП.СообщениеОбОшибке);
			...
			Иначе
				...
				ВозвращаемоеЗначение.ТекстОшибки = СтрШаблон(
					НСтр("ru = 'Запрос на получение идентификатора соединения не выполнен.
						     |Текст ошибки: %1.';
						     |en = 'Запрос на получение идентификатора соединения не выполнен.
						     |Текст ошибки: %1.'"),
					РезультатБИП.СообщениеОбОшибке);	
	...
	Иначе
		...
		ВозвращаемоеЗначение.ТекстОшибки = НСтр("ru = 'Идентификатор соединения может быть получен только через ЛК СУЗ';
												|en = 'Идентификатор соединения может быть получен только через ЛК СУЗ'");
...
Функция ВидПродукцииСУЗ(ВидПродукцииИС)
	...
	ИначеЕсли ВидПродукцииИС = Перечисления.ВидыПродукцииИС.ЛегкаяПромышленность
		Или ВидПродукцииИС = Перечисления.ВидыПродукцииИС.ЛегкаяПромышленность2025 Тогда
		ВидПродукции = "lp";
	...
	ИначеЕсли ВидПродукцииИС = Перечисления.ВидыПродукцииИС.БАДы
		Или ВидПродукцииИС = Перечисления.ВидыПродукцииИС.БАДы2025 Тогда
		ВидПродукции = "bio";
