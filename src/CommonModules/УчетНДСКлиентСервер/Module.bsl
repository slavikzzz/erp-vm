...
// 
// Параметры:
//  Период - Дата -  дата для проверки применения 176 ФЗ
// 
// Возвращаемое значение:
//  Булево - Применяется 176 ФЗ
...
// 
// Параметры:
//  Период - Дата - Период, на который нужно получить ставку.
// 
// Возвращаемое значение:
//  ПеречислениеСсылка.СтавкиНДС - Общая ставка НДС
...
// Общая расчетная ставка НДС.
// 
// Параметры:
//  Период - Дата - Период, на который нужно получить ставку.
// 
// Возвращаемое значение:
//  ПеречислениеСсылка.СтавкиНДС - Общая расчетная ставка НДС
...
// Общая УСН Ставка НДС.
// 
// Параметры:
//  Период - Дата - Период, на который нужно получить ставку.
// 
// Возвращаемое значение:
//  ПеречислениеСсылка.СтавкиНДС - Общая УСН Ставка НДС
...
// Расчетная УСН Ставка НДС.
// 
// Параметры:
//  Период - Дата - Период, на который нужно получить ставку.
// 
// Возвращаемое значение:
//  ПеречислениеСсылка.СтавкиНДС - Расчетная УСН Ставка НДС
...
// Пониженная УСН Ставка НДС.
// 
// Параметры:
//  Период - Дата - Период, на который нужно получить ставку.
// 
// Возвращаемое значение:
//  ПеречислениеСсылка.СтавкиНДС - Пониженная УСН Ставка НДС
...
// Пониженная расчетная УСН Ставка НДС.
// 
// Параметры:
//  Период - Дата - Период, на который нужно получить ставку.
// 
// Возвращаемое значение:
//  ПеречислениеСсылка.СтавкиНДС - Пониженная расчетная УСН Ставка НДС
