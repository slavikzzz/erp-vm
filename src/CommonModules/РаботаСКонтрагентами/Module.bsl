	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Получение сведений о юридическом лице по ИНН %1';
				|en = 'Receive information on a legal entity by TIN %1'"),
			ИНН),
		"Контрагент",
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Успешно завершено получение сведений о юридическом лице по ИНН %1';
				|en = 'Information on a legal entity is received successfully by TIN %1'"),
			ИНН),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Получение реквизитов предпринимателя для ИНН %1';
				|en = 'Receive entrepreneur details for TIN %1'"),
			ИНН),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Успешно завершено получение реквизитов предпринимателя для ИНН %1';
				|en = 'Entrepreneur attributes for TIN %1 are successfully received'"),
			ИНН),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
...
Функция ЮридическиеЛицаПоНаименованию(Знач Наименование, Знач КодРегиона = "", Знач Адрес = "") Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Асинхронный поиск юридических лиц по наименованию';
			|en = 'Asynchronous search for legal entities by names'"),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
	...
	Если Не ЗначениеЗаполнено(Наименование) Тогда
		Результат.ОписаниеОшибки = НСтр("ru = 'Не указано наименование юридического лица.';
										|en = 'Legal entity name is not specified.'");
		ЗаписатьИнформациюВЖурналРегистрации(
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Успешно завершен асинхронный поиск юридических лиц по наименованию';
			|en = 'Asynchronous search for legal entities by names is completed successfully'"),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
...
Функция ЮридическиеЛицаПоИНН(Знач ИНН, Знач КодРегиона = "", Знач Адрес = "") Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Асинхронный поиск юридических лиц по ИНН';
			|en = 'Asynchronous search for legal entities by TIN'"),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
	...
	Если Не ЗначениеЗаполнено(ИНН) Тогда
		Результат.ОписаниеОшибки = НСтр("ru = 'Не указан ИНН юридического лица.';
										|en = 'Legal entity TIN is not specified.'");
		ЗаписатьИнформациюВЖурналРегистрации(
			Результат.ОписаниеОшибки,
			ИдентификаторСервисаКонтрагент(),
			НСтр("ru = 'Получение данных';
	...
	РезультатВызова = ПроверитьУслугуИВызватьОперациюRESTСервиса(
		...
		НСтр("ru = 'ИНН юридического лица должен состоять из 10 цифр.';
			|en = 'The TIN of a business must contain 10 numbers.'"));
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Успешно завершен асинхронный поиск юридических лиц по ИНН';
			|en = 'Asynchronous search for legal entities by TIN is completed'"),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Получение данных досье юридического лица с ИНН %1';
				|en = 'Receive data of the legal entity profile with TIN %1'"),
			ИНН),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
	...
	Если ТелоОтветаОбъект.Получить("inn") = Неопределено Тогда
		Результат.ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось найти данные для Досье юридического лица с ИНН %1.';
				|en = 'Cannot find data to fill in the legal entity profile with TIN %1.'"),
			Результат.ИНН);
		ЗаписатьИнформациюВЖурналРегистрации(
			Результат.ОписаниеОшибки,
			ИдентификаторСервисаКонтрагент(),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Успешно завершено получение данных досье юридического лица с ИНН %1';
				|en = 'Receiving data of the legal entity profile with TIN %1 is completed successfully'"),
			ИНН),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
...
Функция ИнформацияОСвязяхПредпринимателяПоИНН(Знач ИНН) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Получение данных досье предпринимателя с ИНН %1';
				|en = 'Receive data of the entrepreneur profile with TIN %1'"),
			ИНН),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
	...
	Если Не ЗначениеЗаполнено(ИНН) Тогда
		Результат.ОписаниеОшибки = НСтр("ru = 'Не указан ИНН предпринимателя.';
										|en = 'TIN of an individual entrepreneur is not specified.'");
		ЗаписатьИнформациюВЖурналРегистрации(
			Результат.ОписаниеОшибки,
			ИдентификаторСервисаКонтрагент(),
			НСтр("ru = 'Получение данных';
	...
	РезультатВызова = ПроверитьУслугуИВызватьОперациюRESTСервиса(
		...
		НСтр("ru = 'ИНН предпринимателя должен состоять из 12 цифр.';
			|en = 'TIN of an individual entrepreneur must contain 12 digits.'"));
	ЗаполнитьЗначенияСвойств(Результат, РезультатВызова, "ОжиданиеОтвета, ОписаниеОшибки");
	Если Результат.ОжиданиеОтвета Или ЗначениеЗаполнено(Результат.ОписаниеОшибки) Тогда
		Возврат Результат;
	КонецЕсли;
	...
	Если ТелоОтветаОбъект.Получить("inn") = Неопределено Тогда
		Результат.ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось найти данные для Досье предпринимателя с ИНН %1.';
				|en = 'Cannot find data to fill in Entrepreneur profile with TIN %1.'"),
			Результат.ИНН);
		ЗаписатьИнформациюВЖурналРегистрации(
			Результат.ОписаниеОшибки,
			ИдентификаторСервисаКонтрагент(),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Завершено получение данных досье предпринимателя с ИНН %1';
				|en = 'Receiving data of the entrepreneur profile with TIN %1 is completed'"),
			ИНН),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
...
Функция НаличиеПодразделенийПоИНН(ИНН) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Синхронная проверка наличия подразделений по ИНН.';
			|en = 'Synchronous check for busines unit availability by TIN.'"),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Успешно завершена синхронная проверка наличия подразделений по ИНН.';
			|en = 'Synchronous check for busines unit availability by TIN is completed.'"),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
...
Функция ИнформацияОПодразделенииЮридическогоЛицаПоУникальномуНомеру(УникальныйНомер) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Асинхронное получение сведений о подразделении юридического лица по уникальному номеру %1';
				|en = 'Asynchronous receipt of information about a legal entity busines unit by unique number %1'"),
			УникальныйНомер),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
	...
	Если Не ЗначениеЗаполнено(УникальныйНомер) Тогда
		Результат.ОписаниеОшибки = НСтр("ru = 'Не указан уникальный номер подразделения.';
										|en = 'Unique number of the business unit is not specified.'");
		ЗаписатьИнформациюВЖурналРегистрации(
			Результат.ОписаниеОшибки,
			ИдентификаторСервисаКонтрагент(),
			НСтр("ru = 'Получение данных';
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Успешно завершено получение сведений о подразделении юридического лица по уникальному номеру %1';
				|en = 'Information about a legal entity busines unit by unique number %1 is received'"),
			УникальныйНомер),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
...
Функция ИнформацияОПодразделенииЮридическогоЛицаПоИННКПП(ИНН, КПП) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Асинхронное получение сведений о подразделении юридического лица по ИНН/КПП %1/%2';
				|en = 'Asynchronous receipt of information about a legal entity busines unit by TIN/KPP %1/%2'"),
			ИНН,
			КПП),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
	...
	Если Не ЗначениеЗаполнено(ИНН) Тогда
		Результат.ОписаниеОшибки = НСтр("ru = 'Не указан ИНН подразделения юридического лица.';
										|en = 'Legal entity business unit TIN is not specified.'");
		ЗаписатьИнформациюВЖурналРегистрации(
			Результат.ОписаниеОшибки,
			ИдентификаторСервисаКонтрагент(),
			НСтр("ru = 'Получение данных';
	...
	ИначеЕсли Не ЗначениеЗаполнено(КПП) Тогда
		Результат.ОписаниеОшибки = НСтр("ru = 'Не указан КПП подразделения юридического лица.';
										|en = 'Legal entity business unit KPP is not specified.'");
		ЗаписатьИнформациюВЖурналРегистрации(
			Результат.ОписаниеОшибки,
			ИдентификаторСервисаКонтрагент(),
			НСтр("ru = 'Получение данных';
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Успешно завершено получение сведений о подразделении по по ИНН/КПП %1/%2';
				|en = 'Information about the business unit by TIN/KPP %1/%2 is received'"),
			ИНН,
			КПП),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Получение реквизитов налогового органа по коду %1';
				|en = 'Receive tax authority attributes by code %1'"),
			КодНалоговогоОргана),
		"ГосОрганы",
		ДополнительноеСобытиеПолучениеДанных());
	...
	Если ПустаяСтрока(ОписаниеОшибки) Тогда
		...
		Исключение
			...
			ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Код налогового органа %1:';
					|en = 'Tax authority code %1:'"), Результат.Код)
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Успешно завершено получение реквизитов налогового органа по коду %1';
				|en = 'Tax authority attributes are successfully received by code %1'"),
			КодНалоговогоОргана),
		"ГосОрганы",
		ДополнительноеСобытиеПолучениеДанных());
...
Функция РеквизитыОтделенияФССПоКоду(Знач КодОтделенияФСС) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Получение реквизитов ФСС по коду %1';
				|en = 'Receive SSF attributes by code %1'"),
			КодОтделенияФСС),
		"ГосОрганы",
		ДополнительноеСобытиеПолучениеДанных());
	...
	Если ПустаяСтрока(ОписаниеОшибки) Тогда
		...
		Исключение
			ИнформацияОбОшибке = ИнформацияОбОшибке();
			ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Код отделения ФСС %1:';
					|en = 'SSF business unit code %1:'"), Результат.Код)
				+ Символы.ПС + ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке);
		КонецПопытки;
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Успешно завершено получение реквизитов ФСС по коду %1';
				|en = 'SSF attributes successfully received by code %1'"),
			КодОтделенияФСС),
		"ГосОрганы",
		ДополнительноеСобытиеПолучениеДанных());
...
Функция РеквизитыОтделенияПФРПоКоду(Знач КодОтделенияПФР) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Получение реквизитов ПФР по коду %1';
				|en = 'Receive PF attributes by code %1'"),
			КодОтделенияПФР),
		"ГосОрганы",
		ДополнительноеСобытиеПолучениеДанных());
	...
	Если ПустаяСтрока(ОписаниеОшибки) Тогда
		...
		Исключение
			ИнформацияОбОшибке = ИнформацияОбОшибке();
			ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Код отделения ПФР %1:';
					|en = 'PF business unit code %1:'"), Результат.Код)
				+ Символы.ПС + ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке);
		КонецПопытки;
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Успешно завершено получение реквизитов ПФР по коду %1';
				|en = 'PF attributes by code %1 have been successfully received'"),
			КодОтделенияПФР),
		"ГосОрганы",
		ДополнительноеСобытиеПолучениеДанных());
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Получение данных для сертификата юридического лица по ИНН %1';
				|en = 'Get data for a legal entity certificate by TIN %1'"),
			ИНН),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Успешно завершено получение данных для сертификата юридического лица по ИНН %1';
				|en = 'Data for a legal entity certificate is successfully received by TIN %1'"),
			ИНН),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Получение данных для сертификата предпринимателя по ИНН %1';
				|en = 'Get data for an entrepreneur certificate by TIN %1'"),
			ИНН),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Успешно завершено получение данных для сертификата предпринимателя по ИНН %1';
				|en = 'Data for an entrepreneur certificate is successfully received by TIN %1'"),
			ИНН),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
...
Процедура ПриЗаполненииХостовСервисовИнтернетПоддержки(ХостыСервисовИнтернетПоддержки) Экспорт
	...
	ХостыСервисовИнтернетПоддержки.Вставить(
		...
		НСтр("ru = 'Проверка контрагентов по данным ФНС';
			|en = 'Check counterparties by FTS data'"));
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Проверяет существование контрагентов по базе ФНС.
		...
		|en = 'Checks whether counterparty exists in the FTS base.
		|The existence may be checked not for all counterparties until the process completes.'");
...
Процедура ПриЗаполненииРазрешенийНаДоступКВнешнимРесурсам(ЗапросыРазрешений) Экспорт
	...
	Разрешение = МодульРаботаВБезопасномРежиме.РазрешениеНаИспользованиеИнтернетРесурса(
		...
		НСтр("ru = 'Сервис ФНС для проверки контрагентов';
			|en = 'FTS service to check counterparties'"));
	НовыеРазрешения.Добавить(Разрешение);
...
Процедура ПриФормированииСпискаУслуг(Услуги) Экспорт
	...
	НоваяУслуга.Вставить("Наименование" , НСтр("ru = 'Автозаполнение реквизитов контрагентов';
												|en = 'Counterparty attribute autopopulation'"));
	...
	НоваяУслуга.Вставить("Наименование" , НСтр("ru = 'Автозаполнение и проверка реквизитов ФНС, ФСС, ПФР';
												|en = 'Autopopulation and check of FTS, SSF, PF attributes'"));
	НоваяУслуга.Вставить("ТипУслуги"    , ТипУслугиБезлимитная);
	Услуги.Добавить(НоваяУслуга);
	...
	НоваяУслуга.Вставить("Наименование" , НСтр("ru = 'Информация о плановых и внеплановых проверках организации';
												|en = 'Information on scheduled and unannounced company inspections'"));
	НоваяУслуга.Вставить("ТипУслуги"    , ТипУслугиБезлимитная);
	Услуги.Добавить(НоваяУслуга);
...
Процедура ПриДобавленииОписанийСервисовСопровождения(СервисыСопровождения) Экспорт
	...
	ОписательСервиса.Описание        = НСтр("ru = 'Быстрая проверка информации о контрагентах,
		...
		|en = 'Quick check of information on counterparties,
		| automatic filling of counterparty details in different documents and other useful functions.'");
	...
	Исключение
		ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось проверить доступность сервиса. Не удалось получить описание сервиса. %1';
				|en = 'Cannot check service availability. Cannot receive service description. %1'"),
	...
	Исключение
		ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось проверить доступность сервиса. Ошибка при вызове операции ping(). %1';
				|en = 'Cannot check service availability. An error occurred when calling ping() operation. %1'"),
			ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
	КонецПопытки;
	
КонецПроцедуры

Процедура ПроверитьДоступностьRESTСервисаКонтрагент(ОписаниеОшибки) Экспорт
...
Функция ИнформацияОПроверкахКонтролирующимиОрганамиПоСпискуИННСлужебная(
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Получение информации о проверках контрагентов. Количество ИНН: %1';
				|en = 'Receiving information on counterparty checks. TIN quantity: %1'"),
	...
	Если СписокИНН.Количество() > МаксимальноеКоличествоИНН Тогда
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Недопустимое значение параметра ""СписокИНН"". Количество ИНН превышает %1.';
				|en = 'Invalid value of the СписокИНН parameter. VAT quantity exceeds %1.'"),
	...
	Если Результат.ОжиданиеОтвета Тогда
		ЗаписатьИнформациюВЖурналРегистрации(
			НСтр("ru = 'Ожидание ответа получение информации о проверках контрагентов';
				|en = 'Awaiting response receiving information on counterparty checks'"),
			"Контрагент",
			ДополнительноеСобытиеПолучениеДанных());
		Возврат Результат;
	КонецЕсли;
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Успешно завершено получение информации о проверках контрагентов.';
			|en = 'Information on counterparty checks is received successfully.'"),
		"Контрагент",
		ДополнительноеСобытиеПолучениеДанных());
...
Функция СвойстваСправочниковКонтрагентов() Экспорт
	...
	Если Результат.Количество() = 0 Тогда
		ВызватьИсключение НСтр("ru = 'Не удалось определить свойства справочника Контрагенты.
			...
			|en = 'Cannot determine the Counterparties catalog properties.
			|The ПриОпределенииСвойствСправочниковКонтрагентов()
			|method implementation of the РаботаСКонтрагентамиПереопределяемый common module is required.'");
	КонецЕсли;
...
Функция ИмяСобытияЖурналаРегистрации(ИдентификаторСервиса)
	...
	Если ИдентификаторСервиса = "Контрагент" Тогда
		Возврат НСтр("ru = 'Сервис данных единых гос_реестров';
					|en = 'United state_register data service'", ОбщегоНазначения.КодОсновногоЯзыка());
	ИначеЕсли ИдентификаторСервиса = "РАФП" Тогда
		Возврат НСтр("ru = 'Сервис данных аккредитованных филиалов представительств иностранных юр. лиц';
					|en = 'Data service of accredited branches of foreign representative offices of legal entities'", ОбщегоНазначения.КодОсновногоЯзыка());
	ИначеЕсли ИдентификаторСервиса = "ГосОрганы" Тогда
		Возврат НСтр("ru = 'Сервис данных гос_органов';
					|en = 'Public_authority data service'", ОбщегоНазначения.КодОсновногоЯзыка());
	ИначеЕсли ИдентификаторСервиса = "ПроверкаКонтрагентов" Тогда
		Возврат НСтр("ru = 'Проверка контрагентов';
					|en = 'Counterparty check'", ОбщегоНазначения.КодОсновногоЯзыка());
	Иначе
		Возврат НСтр("ru = 'Работа с контрагентами';
					|en = 'Work with counterparties'", ОбщегоНазначения.КодОсновногоЯзыка());
	КонецЕсли;
	...
	Если СтрОписаниеСправочника = Неопределено И ИсключениеПриОтсутствииОписания Тогда
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Отсутствует описание справочника с именем ""%1"" в методе ПриОпределенииСвойствСправочниковКонтрагентов()
				...
				|en = 'Description of a catalog with the ""%1"" name is missing in the ПриОпределенииСвойствСправочниковКонтрагентов()
				|method of the ИнтернетПоддержкаПользователейПереопределяемый common module.'"),
				...
				ЗаписатьИнформациюВЖурналРегистрации(
					СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru = 'Не удалось получить тикет аутентификации для создания описания сервиса %1.
							...
							|en = 'Cannot get authentication ticket to create description of the %1 service.
							|Error code: %2.
							|The ""fresh"" login was used to authenticate.'"),
						URLМестоположенияWSDL,
		...
		ЗаписатьИнформациюВЖурналРегистрации(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось получить тикет аутентификации для вызова операции %1 сервиса %2.
					|Код ошибки: %3.
					|Для аутентификации использован логин ""fresh"".';
					|en = 'Cannot get authentication ticket to call the %1 operation of the %2 service.
					|Error code: %3.
					|The ""fresh"" login was used to authenticate.'"),
				ИмяМетода,
				АдресСервиса,
			...
			ЗаписатьИнформациюВЖурналРегистрации(
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Не удалось получить тикет аутентификации для вызова операции %1.
						|Код ошибки: %2.
						|Для аутентификации использован логин ""fresh"".';
						|en = 'Cannot receive an authentication ticket to call the %1 operation.
						|Error code: %2.
						|The ""fresh"" login was used to authenticate.'"),
					URLОперации,
					РезультатПолученияТикета.КодОшибки),
...
Процедура ОбработатьОшибкуСервиса(ОбъектXDTO, ОписаниеОшибки, Сервис, ИмяМетода, ИдентификаторУслуги, Результат)
	...
	Если ОписаниеОшибкиВРег = ВРег("НеУказаныПараметрыАутентификации")
		...
		ЗаписатьИнформациюВЖурналРегистрации(
			НСтр("ru = 'Интернет-поддержка пользователей не подключена.';
				|en = 'Online user support is not connected.'"),
			Сервис,
			НСтр("ru = 'Аутентификация';
				|en = 'Authentication'", КодОсновногоЯзыка));
	...
	ИначеЕсли СтрНайти(ОписаниеОшибкиВРег, """STATUS"":401") > 0
		...
		Если ОбщегоНазначения.РазделениеВключено() Тогда
			Результат.ОписаниеОшибки = НСтр("ru = 'Ошибка аутентификации в сервисе. Обратитесь к администратору.';
											|en = 'Authentication error in the service. Contact administrator.'");
			ЗаписатьОшибкуВЖурналРегистрации(
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		...
		ЗаписатьИнформациюВЖурналРегистрации(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Услуга с идентификатором ""%1"" не подключена.';
					|en = 'Service with the ""%1"" ID is not activated.'"),
				ИдентификаторУслуги),
			Сервис,
			НСтр("ru = 'Доступ';
				|en = 'Access'", КодОсновногоЯзыка));
		...
		ЗаписатьИнформациюВЖурналРегистрации(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Сервис 1С:Контрагент не подключен.
					|%1';
					|en = '1C:Counterparty service is not connected.
					|%1'"),
					ОписаниеОшибки),
			Сервис,
			НСтр("ru = 'Доступ';
	...
	ИначеЕсли СтрНайти(ОписаниеОшибкиВРег, "SERVER-1:") > 0 Тогда
		...
		ИначеЕсли ИмяМетода = "findInspectionsByInnList" Тогда
			Результат.ОписаниеОшибки = НСтр("ru = 'Не указан ИНН проверяемого лица.';
											|en = 'TIN of a verified person is not specified.'");
		ИначеЕсли ИмяМетода = "findPfrByCode"
			...
			Результат.ОписаниеОшибки  = НСтр("ru = 'Не указан код государственного органа.';
											|en = 'Public authority code is not specified.'");
		Иначе
	...
	ИначеЕсли СтрНайти(ОписаниеОшибкиВРег, "SERVER-2:") > 0 Тогда
		...
		ИначеЕсли ИмяМетода = "findInspectionsByInnList" Тогда
			Результат.ОписаниеОшибки = НСтр("ru = 'ИНН проверяемого лица должен состоять из 10 или 12 цифр.';
											|en = 'TIN of a verified person must contain 10 or 12 digits.'");
		Иначе
			Результат.ОписаниеОшибки = ОписаниеОшибки;
		КонецЕсли;
	...
	ИначеЕсли СтрНайти(ОписаниеОшибкиВРег, "SERVER-4:") > 0 Тогда
		...
		Результат.ОписаниеОшибки = НСтр("ru = 'Превышено количество попыток. Повторите попытку позже.';
										|en = 'Number of attempts is exceeded. Try again later.'");
		ЗаписатьОшибкуВЖурналРегистрации(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Превышено количество попыток. Повторите попытку позже.
					...
					ОписаниеОшибки),
			Сервис,
			НСтр("ru = 'Вызов операций';
				|en = 'Call operations'", КодОсновногоЯзыка));
	...
	ИначеЕсли СтрНайти(ОписаниеОшибки, "SERVER-7:") > 0 Тогда
		...
		Результат.ОписаниеОшибки = НСтр("ru = 'Превышен лимит количества вызовов сервиса за один день';
										|en = 'The maximum number of service calls per day has been exceeded'");
		ЗаписатьОшибкуВЖурналРегистрации(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = '%1
					|%2';
		...
		ЗаписатьИнформациюВЖурналРегистрации(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = '%1
					...
					|en = '%1
					|Empty service response is received.'"),
				Результат.ОписаниеОшибки,
				ОписаниеОшибки),
			Сервис,
			НСтр("ru = 'Получение данных';
		...
		ЗаписатьОшибкуВЖурналРегистрации(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Ошибка при работе с сервисом.
					|%1.';
					|en = 'An error occurred when operating with the service.
					|%1.'"),
				ОписаниеОшибки),
			Сервис,
			НСтр("ru = 'Ошибка';
...
Функция ДополнительноеСобытиеПолучениеДанных()
	...
	Возврат НСтр("ru = 'Получение данных';
				|en = 'Get data'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция ПроверитьУслугуИВызватьОперациюRESTСервиса(
	...
	Если Не УслугаПодключена(ИдентификаторУслуги) Тогда
		...
		ЗаписатьИнформациюВЖурналРегистрации(
			...
			ИдентификаторСервисаКонтрагент(),
			НСтр("ru = 'Доступ';
				|en = 'Access'", ОбщегоНазначения.КодОсновногоЯзыка()));
		Возврат Результат;
	КонецЕсли;
	...
	Если Не ПустаяСтрока(Результат.ОписаниеОшибки) Тогда
		ЗаписатьИнформациюВЖурналРегистрации(
			...
			ИдентификаторСервисаКонтрагент(),
			НСтр("ru = 'Аутентификация';
				|en = 'Authentication'", ОбщегоНазначения.КодОсновногоЯзыка()));
		Возврат Результат;
	КонецЕсли;
			...
			ЗаписатьОшибкуВЖурналРегистрации(
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Ошибка при обработке тела ответа операции %1 %2.
						...
						|
						|%4';
						|en = 'An error occurred while processing the %1 %2 operation response.
						|%3
						|
						|%4'"),
	...
	Если РезультатОперации.КодСостояния = 400 Тогда
		...
		Если ТипОшибки = "VALIDATION_ERROR_INN" Тогда
			Если ОписаниеОшибки400 = Неопределено Тогда
				...
				ТекстОшибки    = НСтр("ru = 'Поле ИНН должно иметь длину 10 или 12 цифр';
										|en = 'The TIN field must have 10 or 12 digits'");
			Иначе
		...
		ИначеЕсли ТипОшибки = "VALIDATION_ERROR_REGION_CODE" Тогда
			...
			ТекстОшибки     = НСтр("ru = 'Поле Код региона должно состоять из двух цифр.';
									|en = 'The Region code field must have two digits.'");
		ИначеЕсли ТипОшибки = "VALIDATION_ERROR_KPP" Тогда
			...
			ТекстОшибки     = НСтр("ru = 'Поле КПП должно иметь длину 9 цифр.';
									|en = 'The KPP field must have 9 digits.'");
		ИначеЕсли ТипОшибки = "VALIDATION_ERROR_ID" Тогда
			...
			ТекстОшибки     = НСтр("ru = 'Уникальный номер передан некорректно.';
									|en = 'Unique number is passed incorrectly.'");
		Иначе
			...
			ТекстОшибки     = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось вызвать операцию %1 %2 сервиса.
					...
					|Код состояния: 400';
					|en = 'Cannot call the %1 %2 service operation. 
		...
		Если ОбщегоНазначения.РазделениеВключено() Тогда
			...
			ЗаписатьОшибкуВЖурналРегистрации(
				НСтр("ru = 'Ошибка аутентификации в сервисе. Обратитесь к администратору.';
					|en = 'Service authentication error. Contact the administrator.'"),
				ИдентификаторСервисаКонтрагент(),
				НСтр("ru = 'Аутентификация';
					|en = 'Authentication'", ОбщегоНазначения.КодОсновногоЯзыка()));
		Иначе
			...
			ЗаписатьИнформациюВЖурналРегистрации(
				НСтр("ru = 'Интернет-поддержка пользователей не подключена (401).';
					|en = 'Online user support is disabled (401).'"),
				ИдентификаторСервисаКонтрагент(),
				НСтр("ru = 'Аутентификация';
					|en = 'Authentication'", ОбщегоНазначения.КодОсновногоЯзыка()));
		КонецЕсли;
	...
	ИначеЕсли РезультатОперации.КодСостояния = 402 Тогда
		...
		ЗаписатьИнформациюВЖурналРегистрации(
			НСтр("ru = 'Сервис 1С:Контрагент не подключен (402)';
				|en = '1C:Counterparty service is not connected (402)'"),
			ИдентификаторСервисаКонтрагент(),
			НСтр("ru = 'Доступ';
				|en = 'Access'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	ИначеЕсли РезультатОперации.КодСостояния = 403
		...
		ЗаписатьИнформациюВЖурналРегистрации(
			НСтр("ru = 'Сервис 1С:Контрагент не подключен (403)';
				|en = '1C:Counterparty service is not connected (403)'"),
			ИдентификаторСервисаКонтрагент(),
			НСтр("ru = 'Доступ';
				|en = 'Access'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	ИначеЕсли РезультатОперации.КодСостояния = 429
		...
		ЗаписатьОшибкуВЖурналРегистрации(
			НСтр("ru = 'Превышено количество попыток. Повторите попытку позже.';
				|en = 'Number of attempts is exceeded. Try again later.'"),
			ИдентификаторСервисаКонтрагент(),
			НСтр("ru = 'Вызов операций сервиса';
				|en = 'Call service operations'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	Если ТелоОтветаОбъект.Получить("inn") = Неопределено Тогда
		Результат.ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось найти данные для заполнения реквизитов предпринимателя по ИНН %1.';
				|en = 'Cannot find data to fill in entrepreneur details by TIN %1.'"),
			Результат.ИНН);
		ЗаписатьИнформациюВЖурналРегистрации(
			Результат.ОписаниеОшибки,
			ИдентификаторСервисаКонтрагент(),
	...
	Иначе
		Реквизиты.НаименованиеПолное = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Индивидуальный предприниматель %1 %2';
				|en = 'Individual entrepreneur %1 %2'"),
			ВидИП,
			Реквизиты.Наименование);
		Реквизиты.НаименованиеСокращенное = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'ИП %1 %2';
						...
						Иначе
							...
							НоваяСтрока.Результат = СтроковыеФункцииКлиентСервер.СтрокаСЧисломДляЛюбогоЯзыка(
								НСтр("ru = ';Выявлено %1 нарушение;;Выявлено %1 нарушения;Выявлено %1 нарушений;';
									|en = ';%1 violation is detected;; %1 violations are detected;%1 violations are detected;'"),
								КоличествоНарушений);
						КонецЕсли;
				...
				Для каждого СтрокаПроверки Из ПроверкиЗаМесяц.InspectionRegular294 Цикл
					...
					Если ЗначениеЗаполнено(СтрокаПроверки.DURATION_SEC_II) Тогда
						Длительность = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
							НСтр("ru = '%1 рабочих дней';
								|en = '%1 workdays'"), СтрокаПроверки.DURATION_SEC_II);
					ИначеЕсли ЗначениеЗаполнено(СтрокаПроверки.DURATION_SEC_I) Тогда
						Длительность = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
							НСтр("ru = '%1 рабочих часов';
								|en = '%1 working hours'"), СтрокаПроверки.DURATION_SEC_I);
					Иначе
						Длительность = "";
					КонецЕсли;
					НоваяСтрока.ДатаПроверки = ДатаНачала;
					Если ЗначениеЗаполнено(Длительность) Тогда
						НоваяСтрока.Длительность = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
							НСтр("ru = 'с %1, %2';
								|en = 'from %1, %2'"), Формат(ДатаНачала, "ДЛФ=D"), Длительность);
					Иначе
						НоваяСтрока.Длительность = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
							НСтр("ru = 'с %1';
	...
	Иначе
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Некорректное значение параметра ""ВидГосударственногоОргана"" (%1).';
				|en = 'Incorrect value of the ""ВидГосударственногоОргана"" parameter (%1).'"),
...
Функция ТекстУведомленияЗавершаетсяСрокДействияСервиса(ДополнительныеПараметры)
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Срок действия 1С:Контрагент заканчивается %1 года.';
			|en = '1C:Counterparty expires in %1.'"),
...
Функция ТекстУведомленияЗаканчиваютсяСчетныеОпции(ДополнительныеПараметры)
	...
	Если ДополнительныеПараметры.ИдентификаторОпции = ИдентификаторУслугиЗаполнениеРеквизитовКонтрагентов() Тогда
		Возврат НСтр("ru = 'Скоро будет превышен лимит автозаполнений контрагентов в сервисе 1С:Контрагент.';
					|en = 'The counterparty autofill limit will soon be exceeded in the 1C:Counterparty service.'");
	ИначеЕсли ДополнительныеПараметры.ИдентификаторОпции = ИдентификаторУслугиИнформацияОСвязяхКонтрагентов() Тогда
		Возврат НСтр("ru = 'Скоро будет превышен лимит на получение отчетов ""Досье контрагента"" в сервисе 1С:Контрагент.';
					|en = 'The limit for receiving the ""Counterparty profile"" reports will soon be exceeded in the 1C:Counterparty service.'");
	Иначе
		Возврат НСтр("ru = 'Скоро будет превышен лимит в сервисе 1С:Контрагент.';
					|en = 'The limit will soon be exceeded in the 1C:Counterparty service.'");
	КонецЕсли;
...
Функция ПодробныйТекстУведомленияЗавершаетсяСрокДействияСервиса(ДополнительныеПараметры)
	...
	Возврат СтроковыеФункции.ФорматированнаяСтрока(
		НСтр("ru = '1С:Контрагент действует <b>до %1</b>. Для продления доступа обратитесь к своему обслуживающему партнеру 1С или к любому партнеру в <a href = ""https://its.1c.ru/zakaz"">вашем регионе</a>.';
			|en = '1C:Counterparty is valid <b>until %1</b>. To renew access, contact the 1C partner which serves you or any other partner in <a href = ""https://its.1c.ru/zakaz"">your region</a>.'"),
		Формат(ДополнительныеПараметры.ДатаОкончания, "ДЛФ=D"));
	...
	Если ДополнительныеПараметры.ИдентификаторОпции = ИдентификаторУслугиЗаполнениеРеквизитовКонтрагентов() Тогда
		Возврат СтроковыеФункции.ФорматированнаяСтрока(
			НСтр("ru = 'Заканчивается доступное количество автозаполнений по ИНН или наименованию в сервисе 1С:Контрагент. Для увеличения количества обратитесь к своему обслуживающему партнеру 1С или к любому партнеру в <a href = ""https://its.1c.ru/zakaz"">вашем регионе</a>.';
				|en = 'You are running out of the available autofills by TIN or name in the 1C:Counterparty service. To increase the number of autofills, contact the 1C partner which serves you or any partner in <a href = ""https://its.1c.ru/zakaz"">your region</a>.'"));
	ИначеЕсли ДополнительныеПараметры.ИдентификаторОпции = ИдентификаторУслугиИнформацияОСвязяхКонтрагентов() Тогда
		Возврат СтроковыеФункции.ФорматированнаяСтрока(
			НСтр("ru = 'Заканчивается доступное количество отчетов ""Досье контрагента"" в сервисе 1С:Контрагент. Для увеличения количества обратитесь к своему обслуживающему партнеру 1С или к любому партнеру в <a href = ""https://its.1c.ru/zakaz"">вашем регионе</a>.';
				|en = 'You are running out of the available ""Counterparty profile"" reports in the 1C:Counterparty service. To increase the number of autofills, contact the 1C partner which serves you or any partner in <a href = ""https://its.1c.ru/zakaz"">your region</a>.'"));
	Иначе
		Возврат СтроковыеФункции.ФорматированнаяСтрока(
			НСтр("ru = 'Заканчивается доступное количество в сервисе 1С:Контрагент. Для увеличения количества обратитесь к своему обслуживающему партнеру 1С или к любому партнеру в <a href = ""https://its.1c.ru/zakaz"">вашем регионе</a>.';
				|en = 'You are running out of the available quantity in the 1C:Counterparty service. To increase the quantity, contact the 1C partner which serves you or any partner in <a href = ""https://its.1c.ru/zakaz"">your region</a>.'"));
	КонецЕсли;
