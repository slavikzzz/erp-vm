...
Процедура ПриПолученииНаименованийВидовКонтактнойИнформации(Наименования, КодЯзыка) Экспорт
	...
	Наименования["СправочникКонтактныеЛицаПартнеров"] = НСтр("ru = 'Контактная информация справочника ""Контактные лица партнеров""';
															|en = 'Contact information in the ""Partner contacts"" catalog'", КодЯзыка);
	...
	Наименования["СправочникКонтрагенты"] = НСтр("ru = 'Контактная информация справочника ""Контрагенты""';
												|en = 'Contact details in the ""Counterparties"" catalog'", КодЯзыка);
	Наименования["ДругаяИнформацияКонтрагенты"] = НСтр("ru = 'Другое (любая другая контактная информация)';
														|en = 'Other (any other contact details )'", КодЯзыка);
	...
	Наименования["СправочникОрганизации"] = НСтр("ru = 'Контактная информация справочника ""Организации""';
												|en = 'Contact details in the ""Companies"" catalog'", КодЯзыка);
	...
	Наименования["СправочникПартнеры"] = НСтр("ru = 'Контактная информация справочника ""Партнеры""';
												|en = 'Contact details in the ""Partners"" catalog'", КодЯзыка);
	...
	Наименования["СправочникПользователи"] = НСтр("ru = 'Контактная информация справочника ""Пользователи""';
													|en = 'Contact details in ""Users"" catalog'", КодЯзыка);
	...
	Наименования["СправочникРегистрацииВНалоговомОргане"] = НСтр("ru = 'Контактная информация справочника ""Регистрации в налоговом органе""';
																|en = 'Contact details in the ""Registrations with tax authority"" catalog'", КодЯзыка);
	...
	Наименования["ФактАдресОбособленногоПодразделения"] = НСтр("ru = 'Фактический адрес обособленного подразделения';
																|en = 'Branch office business address'", КодЯзыка);
	Наименования["СправочникСклады"] = НСтр("ru = 'Контактная информация справочника ""Склады""';
											|en = 'Contact details in the ""Warehouses"" catalog'", КодЯзыка);
	...
	Наименования["СправочникТорговыеТочки"] = НСтр("ru = 'Контактная информация справочника ""Торговые точки""';
													|en = 'Contact details in the ""Sales outlets"" catalog'", КодЯзыка);
...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Адрес';
																					|en = 'Address'", КодыЯзыков); // @НСтр-2
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Мобильный телефон';
																					|en = 'Cell phone'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВводаИДиалог";
	...
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникКонтактныеЛицаПартнеров;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Телефон';
																					|en = 'Телефон'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВводаИДиалог";
	...
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникКонтактныеЛицаПартнеров;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Электронная почта';
																					|en = 'Email'", КодыЯзыков); // @НСтр-2
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Другое (любая другая контактная информация)';
																					|en = 'Other (any other contact details )'", КодыЯзыков); // @НСтр-2
	...
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникКонтрагенты;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Международный адрес для платежей (англ.)';
																					|en = 'International address for payments (eng.)'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВводаИДиалог";
	...
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникКонтрагенты;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Почтовый адрес';
																					|en = 'Postal address'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВводаИДиалог";
	...
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникКонтрагенты;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Факс';
																					|en = 'Факс'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВводаИДиалог";
	...
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникКонтрагенты;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Фактический адрес';
																					|en = 'Business address'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВводаИДиалог";
	...
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникКонтрагенты;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Юридический адрес';
																					|en = 'Registered address'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВводаИДиалог";
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Адрес налогового органа';
																					|en = 'Tax authority address'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВводаИДиалог";
	...
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникРегистрацииВНалоговомОргане;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Телефон налогового органа';
																					|en = 'Tax authority phone'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВводаИДиалог";
	...
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникРегистрацииВНалоговомОргане;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Фактический адрес обособленного подразделения';
																					|en = 'Branch office business address'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВводаИДиалог";
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Адрес склада';
																					|en = 'Warehouse address'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВводаИДиалог";
	...
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникСклады;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Телефон склада';
																					|en = 'Warehouse phone'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВводаИДиалог";
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Адрес для информирования';
																					|en = 'Notice address'", КодыЯзыков); // @НСтр-2
	...
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникФизическиеЛица;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Адрес места проживания';
																					|en = 'Residential address'", КодыЯзыков); // @НСтр-2
	Элемент.ВключатьСтрануВПредставление = Истина;
	Элемент.ВидРедактирования = "Диалог";
	...
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникФизическиеЛица;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Адрес по прописке';
																					|en = 'Registration address'", КодыЯзыков); // @НСтр-2
	Элемент.ВключатьСтрануВПредставление = Истина;
	Элемент.ВидРедактирования = "Диалог";
	...
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникФизическиеЛица;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Домашний телефон';
																					|en = 'Home phone'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВводаИДиалог";
	...
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникФизическиеЛица;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Иностранный адрес';
																					|en = 'Foreign address'", КодыЯзыков); // @НСтр-2
	Элемент.ВключатьСтрануВПредставление = Истина;
	Элемент.ВидРедактирования = "Диалог";
	...
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникФизическиеЛица;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Рабочий телефон';
																					|en = 'Work phone'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВводаИДиалог";
