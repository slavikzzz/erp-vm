...
Процедура ДополнитьПрофиль(ОписаниеПрофиля, ИмяПрофиля) Экспорт
	...
	ИначеЕсли ИмяПрофиля = "БухгалтерПоВнеоборотнымАктивам" Тогда
		...
		//++ НЕ УТКА
	ИначеЕсли ИмяПрофиля = "МенеджерПроизводства" Тогда
		ДополнитьПрофильМенеджерПроизводства(ОписаниеПрофиля);
	ИначеЕсли ИмяПрофиля = "МенеджерПоПереработкеДавальческогоСырья" Тогда
		ДополнитьПрофильМенеджерПоПереработкеДавальческогоСырья(ОписаниеПрофиля);
		//-- НЕ УТКА
...
Процедура ДополнитьПрофильМенеджерПроизводства(ОписаниеПрофиля)
...
Процедура ДополнитьПрофильМенеджерПоПереработкеДавальческогоСырья(ОписаниеПрофиля)
