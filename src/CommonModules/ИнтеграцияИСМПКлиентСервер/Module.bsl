...
Функция ШаблоныГрупповыхУпаковок() Экспорт
	...
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.БезалкогольноеПивоГрупповаяУпаковка"));
	...
	Если ОбщегоНазначенияИСМПКлиентСервер.МоторныеМаслаИспользуетГрупповуюУпаковку() Тогда
		...
		КонецЕсли;
	КонецЕсли;
	Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетГрупповуюУпаковку() Тогда
		Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетУкороченныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубыГрупповаяУпаковка"));
		КонецЕсли;
		Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетСтандартныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубыГрупповаяУпаковкаСтандартныйКМ"));
		КонецЕсли;
	КонецЕсли;
	Если ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетГрупповуюУпаковку() Тогда
		Если ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетУкороченныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделияГрупповаяУпаковка"));
		КонецЕсли;
		Если ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетСтандартныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделияГрупповаяУпаковкаСтандартныйКМ"));
		КонецЕсли;
	КонецЕсли;
...
Функция ШаблоныИндивидуальныхУпаковокВСоставеГрупповых() Экспорт
	...
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.БезалкогольноеПиво"));
	...
	Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетГрупповуюУпаковку() Тогда
		Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетУкороченныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубы"));
		КонецЕсли;
		Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетСтандартныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубыСтандартныйКМ"));
		КонецЕсли;
	КонецЕсли;
	Если ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетГрупповуюУпаковку() Тогда
		Если ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетУкороченныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделия"));
		КонецЕсли;
		Если ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетСтандартныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделияСтандартныйКМ"));
		КонецЕсли;
	КонецЕсли;
...
Функция ШаблоныНаборов() Экспорт
	...
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.БезалкогольноеПивоНабор"));
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.МорепродуктыНабор"));
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.МорепродуктыНаборСтандартныйКМ"));
	...
	Если ОбщегоНазначенияИСМПКлиентСервер.МоторныеМаслаИспользуетНабор() Тогда
		...
		КонецЕсли;
	КонецЕсли;
	Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетНабор() Тогда
		Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетУкороченныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубыНабор"));
		КонецЕсли;
		Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетСтандартныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубыНаборСтандартныйКМ"));
		КонецЕсли;
	КонецЕсли;
	Если ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетНабор() Тогда
		Если ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетУкороченныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделияНабор"));
		КонецЕсли;
		Если ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетСтандартныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделияНаборСтандартныйКМ"));
		КонецЕсли;
	КонецЕсли;
...
Функция ШаблоныКодовПоВидуПродукции(ВидПродукции, РежимВключенияУпаковокИНаборов = 1) Экспорт
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.МолочнаяПродукцияБезВЕТИС") Тогда
		...
		КонецЕсли;
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ЛегкаяПромышленность")
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.Антисептики")
		Или ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ДезинфицирующиеСредства") Тогда
		Если ВключатьИндивидуальныеУпаковки Тогда
		...
		КонецЕсли;
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.БАДы")
		Или ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.БАДы2025") Тогда
		Если ВключатьИндивидуальныеУпаковки Тогда
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.БезалкогольноеПиво") Тогда
		...
		КонецЕсли;
		Если ВключатьГрупповыеУпаковки Тогда
			СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.БезалкогольноеПивоГрупповаяУпаковка"));
		КонецЕсли;
		Если ВключатьНаборы Тогда
			СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.БезалкогольноеПивоНабор"));
		КонецЕсли;
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.МорепродуктыПодконтрольныеВЕТИС") Тогда
		...
		КонецЕсли;
		Если ВключатьНаборы Тогда
			СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.МорепродуктыНаборСтандартныйКМ"));
			СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.МорепродуктыНабор"));
		КонецЕсли;
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.Бакалея") Тогда
		...
		Если ВключатьНаборы
			...
			КонецЕсли;
			Если ОбщегоНазначенияИСМПКлиентСервер.БакалеяИспользуетСтандартныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.БакалеяНаборСтандартныйКМ"));
			КонецЕсли;
		КонецЕсли;
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПолимерныеТрубы") Тогда
		Если ВключатьИндивидуальныеУпаковки Тогда
			Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетУкороченныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубы"));
			КонецЕсли;
			Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетСтандартныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубыСтандартныйКМ"));
			КонецЕсли;
		КонецЕсли;
		Если ВключатьГрупповыеУпаковки
			И ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетГрупповуюУпаковку() Тогда
			Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетУкороченныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубыГрупповаяУпаковка"));
			КонецЕсли;
			Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетСтандартныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубыГрупповаяУпаковкаСтандартныйКМ"));
			КонецЕсли;
		КонецЕсли;
		Если ВключатьНаборы
			И ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетНабор() Тогда
			Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетУкороченныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубыНабор"));
			КонецЕсли;
			Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетСтандартныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубыНаборСтандартныйКМ"));
			КонецЕсли;
		КонецЕсли;
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.СладостиИКондитерскиеИзделия") Тогда
		Если ВключатьИндивидуальныеУпаковки Тогда
			Если ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетУкороченныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделия"));
			КонецЕсли;
			Если ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетСтандартныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделияСтандартныйКМ"));
			КонецЕсли;
		КонецЕсли;
		Если ВключатьГрупповыеУпаковки
			И ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетГрупповуюУпаковку() Тогда
			Если ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетУкороченныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделияГрупповаяУпаковка"));
			КонецЕсли;
			Если ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетСтандартныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделияГрупповаяУпаковкаСтандартныйКМ"));
			КонецЕсли;
		КонецЕсли;
		Если ВключатьНаборы
			И ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетНабор() Тогда
			Если ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетУкороченныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделияНабор"));
			КонецЕсли;
			Если ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетСтандартныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделияНаборСтандартныйКМ"));
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
...
Функция ЭтоВидПродукцииСоСрокамиГодностиБезОбязательногоЗаполнения(ВидПродукции) Экспорт
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПолимерныеТрубы") Тогда
		Возврат ПолимерныеТрубыИспользуетСрокГодностиБезОбязательногоЗаполнения();
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.СладостиИКондитерскиеИзделия") Тогда
		Возврат СладостиИКондитерскиеИзделияИспользуетСрокГодностиБезОбязательногоЗаполнения();
	КонецЕсли;
...
Функция ДляВидаПродукцииИспользуетсяДатаПроизводства(ВидПродукции) Экспорт
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПолимерныеТрубы") Тогда
		Возврат ПолимерныеТрубыИспользуетДатуПроизводства();
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.СладостиИКондитерскиеИзделия") Тогда
		Возврат СладостиИКондитерскиеИзделияИспользуетДатуПроизводства();
	КонецЕсли;
...
Процедура УстановитьКартинкуСканированияКодаПоВидуПродукции(ЭлементФормыКартинка, ВидМаркируемойПродукции) Экспорт
	...
	ИначеЕсли ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.КреслаКоляски")
		...
		Или ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.МедицинскиеИзделия")
		Или ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.МедицинскиеИзделия20") Тогда
	...
	ИначеЕсли ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.КормаДляЖивотныхПодконтрольныеВЕТИС")
		Или ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.КормаДляЖивотныхБезВЕТИС")
		Или ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.КормаДляЖивотныхВлажныеПодконтрольныеВЕТИС")
		Или ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.КормаДляЖивотныхВлажныеБезВЕТИС") Тогда
	...
	ИначеЕсли ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПолимерныеТрубы") Тогда
		КартинкаСканированияКода = БиблиотекаКартинок.СканированиеКодаМаркировкиПолимерныхТрубИСМП;
	ИначеЕсли ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.СладостиИКондитерскиеИзделия") Тогда
		КартинкаСканированияКода = БиблиотекаКартинок.СканированиеКодаМаркировкиСладостейИКондитерскихИзделийИСМП;
	ИначеЕсли ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПечатныеПлаты") Тогда
		КартинкаСканированияКода = БиблиотекаКартинок.СканированиеКодаМаркировкиПечатныхПлатИСМП;
	ИначеЕсли ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ДезинфицирующиеСредства") Тогда
		КартинкаСканированияКода = БиблиотекаКартинок.СканированиеКодаМаркировкиДезинфицирующихСредствИСМП;
	ИначеЕсли ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.БАДы2025") Тогда
		КартинкаСканированияКода = БиблиотекаКартинок.СканированиеКодаМаркировкиБАДовИСМП;
	Иначе
...
Функция ПредставленияШаблоновКодаМаркировки() Экспорт
	...
	СписокВидовПродукции.Добавить(
		...
		НСтр("ru = 'Со сроком годности (до часов)';
			|en = 'Со сроком годности (до часов)'"));
	СписокВидовПродукции.Добавить(
	...
	СписокВидовПродукции.Добавить(
		...
		НСтр("ru = 'Единица товара (Укороченный КМ)';
			|en = 'Единица товара (Укороченный КМ)'"));
	...
	СписокВидовПродукции.Добавить(
		...
		НСтр("ru = 'Единица товара (Стандартный КМ)';
			|en = 'Единица товара (Стандартный КМ)'"));
	...
	СписокВидовПродукции.Добавить(
		ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.БезалкогольноеПивоНабор"),
		НСтр("ru = 'Набор';
			|en = 'Набор'"));
		
	СписокВидовПродукции.Добавить(
		ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.МорепродуктыНабор"),
		НСтр("ru = 'Набор (Укороченный КМ)';
			|en = 'Набор (Укороченный КМ)'"));
		
	СписокВидовПродукции.Добавить(
		ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.МорепродуктыНаборСтандартныйКМ"),
		НСтр("ru = 'Набор (Стандартный КМ)';
			|en = 'Набор (Стандартный КМ)'"));
	...
	СписокВидовПродукции.Добавить(
		...
		НСтр("ru = 'Групповая упаковка (Укороченный КМ)';
			|en = 'Групповая упаковка (Укороченный КМ)'"));
	...
	СписокВидовПродукции.Добавить(
		...
		НСтр("ru = 'Групповая упаковка (Стандартный КМ)';
			|en = 'Групповая упаковка (Стандартный КМ)'"));
	...
	СписокВидовПродукции.Добавить(
		ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.БезалкогольноеПивоГрупповаяУпаковка"),
		НСтр("ru = 'Групповая упаковка';
			|en = 'Групповая упаковка'"));
	...
	ПродукцияИспользуетСтандартныйКМ     = ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетСтандартныйКМ();
	ПродукцияИспользуетУкороченныйКМ     = ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетУкороченныйКМ();
	ПродукцияИспользуетГрупповуюУпаковку = ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетГрупповуюУпаковку();
	ПродукцияИспользуетНабор             = ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетНабор();
	Если ПродукцияИспользуетСтандартныйКМ И ПродукцияИспользуетУкороченныйКМ Тогда
		СписокВидовПродукции.Добавить(
			ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубы"),
			НСтр("ru = 'Единица товара (Укороченный КМ)';
				|en = 'Единица товара (Укороченный КМ)'"));
		СписокВидовПродукции.Добавить(
			ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубыСтандартныйКМ"),
			НСтр("ru = 'Единица товара (Стандартный КМ)';
				|en = 'Единица товара (Стандартный КМ)'"));
		Если ПродукцияИспользуетГрупповуюУпаковку Тогда
			СписокВидовПродукции.Добавить(
				ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубыГрупповаяУпаковка"),
				НСтр("ru = 'Групповая упаковка (Укороченный КМ)';
					|en = 'Групповая упаковка (Укороченный КМ)'"));
			СписокВидовПродукции.Добавить(
				ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубыГрупповаяУпаковкаСтандартныйКМ"),
				НСтр("ru = 'Групповая упаковка (Стандартный КМ)';
					|en = 'Групповая упаковка (Стандартный КМ)'"));
		КонецЕсли;
		Если ПродукцияИспользуетНабор Тогда
			СписокВидовПродукции.Добавить(
				ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубыНабор"),
				НСтр("ru = 'Набор (Укороченный КМ)';
					|en = 'Набор (Укороченный КМ)'"));
			СписокВидовПродукции.Добавить(
				ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ПолимерныеТрубыНаборСтандартныйКМ"),
				НСтр("ru = 'Набор (Стандартный КМ)';
					|en = 'Набор (Стандартный КМ)'"));
		КонецЕсли;
	ИначеЕсли ПродукцияИспользуетСтандартныйКМ Тогда
	...
	ПродукцияИспользуетСтандартныйКМ     = ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетСтандартныйКМ();
	ПродукцияИспользуетУкороченныйКМ     = ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетУкороченныйКМ();
	ПродукцияИспользуетГрупповуюУпаковку = ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетГрупповуюУпаковку();
	ПродукцияИспользуетНабор             = ОбщегоНазначенияИСМПКлиентСервер.СладостиИКондитерскиеИзделияИспользуетНабор();
	Если ПродукцияИспользуетСтандартныйКМ И ПродукцияИспользуетУкороченныйКМ Тогда
		СписокВидовПродукции.Добавить(
			ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделия"),
			НСтр("ru = 'Единица товара (Укороченный КМ)';
				|en = 'Единица товара (Укороченный КМ)'"));
		СписокВидовПродукции.Добавить(
			ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделияСтандартныйКМ"),
			НСтр("ru = 'Единица товара (Стандартный КМ)';
				|en = 'Единица товара (Стандартный КМ)'"));
		Если ПродукцияИспользуетГрупповуюУпаковку Тогда
			СписокВидовПродукции.Добавить(
				ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделияГрупповаяУпаковка"),
				НСтр("ru = 'Групповая упаковка (Укороченный КМ)';
					|en = 'Групповая упаковка (Укороченный КМ)'"));
			СписокВидовПродукции.Добавить(
				ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделияГрупповаяУпаковкаСтандартныйКМ"),
				НСтр("ru = 'Групповая упаковка (Стандартный КМ)';
					|en = 'Групповая упаковка (Стандартный КМ)'"));
		КонецЕсли;
		Если ПродукцияИспользуетНабор Тогда
			СписокВидовПродукции.Добавить(
				ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделияНабор"),
				НСтр("ru = 'Набор (Укороченный КМ)';
					|en = 'Набор (Укороченный КМ)'"));
			СписокВидовПродукции.Добавить(
				ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.СладостиИКондитерскиеИзделияНаборСтандартныйКМ"),
				НСтр("ru = 'Набор (Стандартный КМ)';
					|en = 'Набор (Стандартный КМ)'"));
		КонецЕсли;
	ИначеЕсли ПродукцияИспользуетСтандартныйКМ Тогда
...
Функция ИспользуетсяВладелецGTINВЗаказеНаЭмиссию(СпособВводаВОборот, ВидПродукции) Экспорт
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПолимерныеТрубы") Тогда
		Возврат ПолимерныеТрубыИспользуетВладельцаGTINВЗаказеНаЭмиссию(СпособВводаВОборот);
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.СладостиИКондитерскиеИзделия") Тогда
		Возврат СладостиИКондитерскиеИзделияИспользуетВладельцаGTINВЗаказеНаЭмиссию(СпособВводаВОборот);
	КонецЕсли;
...
Функция ИспользуетсяОграниченныйСписокПричинПеремаркировки(ВидПродукции) Экспорт
...
Функция ПолимерныеТрубыИспользуетСрокГодностиБезОбязательногоЗаполнения()
	Возврат Истина;
КонецФункции

Функция СладостиИКондитерскиеИзделияИспользуетСрокГодностиБезОбязательногоЗаполнения()
	Возврат Истина;
КонецФункции
...
Функция ПолимерныеТрубыИспользуетДатуПроизводства()
	Возврат Истина;
КонецФункции

Функция СладостиИКондитерскиеИзделияИспользуетДатуПроизводства()
	Возврат Истина;
КонецФункции
...
Функция ПолимерныеТрубыИспользуетВладельцаGTINВЗаказеНаЭмиссию(СпособВводаВОборот)
	Возврат Ложь;
КонецФункции

Функция СладостиИКондитерскиеИзделияИспользуетВладельцаGTINВЗаказеНаЭмиссию(СпособВводаВОборот)
	Возврат Ложь;
КонецФункции
