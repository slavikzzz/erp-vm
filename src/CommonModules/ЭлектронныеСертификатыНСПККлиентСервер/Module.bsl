...
Функция ПараметрыОперацииНСПК() Экспорт
	...
	Параметры.Вставить("ПротоколОбмена", ПредопределенноеЗначение("Перечисление.ПротоколОбменаФЭСНСПК.ВерсияV1")); // Перечисление.ПротоколОбменаФЭСНСПК, Обязательно - Протокол обмена ФЭС НСПК. 
