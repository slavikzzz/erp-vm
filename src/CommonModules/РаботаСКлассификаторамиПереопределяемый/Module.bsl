				...
				Если Описатель.Идентификатор = Идентификатор Тогда
					Сообщение = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru = 'Загрузка классификатора ""%1"" при отключенной функциональной опции ""%2"" недоступна.';
							|en = 'You cannot import the ""%1"" classifier if the ""%2"" functional option is disabled.'"),
						Описатель.Наименование,
						Метаданные.ФункциональныеОпции.ИспользоватьРеглУчет.Синоним);
					
					ЗаписьЖурналаРегистрации(
						НСтр("ru = 'Загрузка классификаторов.';
							|en = 'Import classifiers.'", ОбщегоНазначения.КодОсновногоЯзыка()),
