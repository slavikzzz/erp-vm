...
Функция ПрименяетсяПБУ18(ВариантУчета) Экспорт
	...
	Результат = ЗначениеЗаполнено(ВариантУчета) И ВариантУчета <> ПредопределенноеЗначение("Перечисление.ВариантыУчетаОтложенногоНалога.Нет");
...
Функция ВедетсяУчетПостоянныхИВременныхРазниц(ВариантУчета) Экспорт
	...
	Результат = ВариантУчета = ПредопределенноеЗначение("Перечисление.ВариантыУчетаОтложенногоНалога.ЗатратныйМетод")
	          ИЛИ ВариантУчета = ПредопределенноеЗначение("Перечисление.ВариантыУчетаОтложенногоНалога.БалансовыйМетодПостоянныеРазницы");
...
Функция ЭтоБалансовыйМетод(ВариантУчета) Экспорт
	...
	Результат = ВариантУчета = ПредопределенноеЗначение("Перечисление.ВариантыУчетаОтложенногоНалога.БалансовыйМетод")
	          ИЛИ ВариантУчета = ПредопределенноеЗначение("Перечисление.ВариантыУчетаОтложенногоНалога.БалансовыйМетодПостоянныеРазницы");
