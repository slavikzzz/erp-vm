...
Процедура ДобавитьРеквизитыФормыНастройки(Форма) Экспорт
	...
	РеквизитОнлайнОплаты = Новый РеквизитФормы("ОнлайнОплаты", ТипБулево,,НСтр("ru = 'Загружать онлайн-оплаты';
																				|en = 'Import online payments'"),Истина); 
	РеквизитВыгружатьПрочиеФайлы = Новый РеквизитФормы("ВыгружатьФайлы", ТипБулево,,НСтр("ru = 'Прочие файлы';
																						|en = 'Other files'"),Истина);
	РеквизитДатаНаСайте = Новый РеквизитФормы("ДополнительныйРеквизитЗаказаКлиентаДатаЗаказаНаСайте",
		ТипСведения,,НСтр("ru = 'Дата заказа на сайте';
							|en = 'Order date on site'"),Истина);
	РеквизитНомерНаСайте = Новый РеквизитФормы("ДополнительныйРеквизитЗаказаКлиентаНомерЗаказаНаСайте",
		ТипСведения,,НСтр("ru = 'Номер заказа на сайте';
							|en = 'Number of the site order'"),Истина);
	...
	РеквизитМенеджер = Новый РеквизитФормы("Менеджер", ТипПользователи,,НСтр("ru = 'Менеджер';
																			|en = 'Manager'"),Истина);
	РеквизитПричинаОтмены = Новый РеквизитФормы("ПричинаОтменыЗаказа", ТипПричина,,НСтр("ru = 'Причина отмены заказа';
																						|en = 'Cancellation reason'"),Истина);
	РеквизитСпособИдентификации = Новый РеквизитФормы("СпособИдентификацииКонтрагентов", ТипСпособИдентификации,,,Истина);
	РеквизитВидНоменклатурыТовар = Новый РеквизитФормы("ВидНоменклатурыТовар", ТипВидНоменклатуры,,НСтр("ru = 'Вид номенклатуры товар';
																										|en = 'Product kind goods'"),Истина);
	РеквизитВидНоменклатурыУслуга = Новый РеквизитФормы("ВидНоменклатурыУслуга", ТипВидНоменклатуры,,НСтр("ru = 'Вид номенклатуры услуга';
																											|en = 'Product kind service'"),Истина);
	РеквизитЕдиницаИзмерения = Новый РеквизитФормы("ЕдиницаИзмеренияНовойНоменклатуры", ТипЕдиницаИзмерения,,НСтр("ru = 'Единица измерения';
																													|en = 'Unit of measure'"),Истина);
	РеквизитГруппаНоменклатуры = Новый РеквизитФормы("ГруппаДляНовойНоменклатуры", ТипГруппаНоменклатуры,,НСтр("ru = 'Группа номенклатуры';
																												|en = 'Items group'"),Истина);
	
	РеквизитСоздаватьПартнеровДляНовыхКонтрагентов = Новый РеквизитФормы("СоздаватьПартнеровДляНовыхКонтрагентов",
		ТипБулево, ,НСтр("ru = 'Создавать партнеров для новых контрагентов';
						|en = 'Create partners for new counterparties'"),Истина);
	РеквизитГруппаДоступа = Новый РеквизитФормы("ГруппаДоступаПартнеров", ТипГруппаДоступа,, НСтр("ru = 'Группа доступа партнеров';
																									|en = 'Partner access group '"), Истина);
	...
	РеквизитСоответствиеСтатусов = Новый РеквизитФормы("СоответствиеСтатусовЗаказов", ТипТаблицаЗначений, ,
		НСтр("ru = 'Соответствие статусов заказов';
			|en = 'Correspondence of order states'"), Истина);
	РеквизитСоответствиеФормОплат = Новый РеквизитФормы("СоответствиеФормОплат", ТипТаблицаЗначений, ,
		НСтр("ru = 'Соответствие видов оплат';
			|en = 'Correspondence of payment kinds'"), Истина);
	РеквизитСоответствиеОнлайнОплат = Новый РеквизитФормы("СоответствиеОнлайнОплат", ТипТаблицаЗначений, ,
		НСтр("ru = 'Соответствие онлайн-оплат';
			|en = 'Correspondence of online payments'"), Истина);
	...
	РеквизитСтатусЗаказаВБазе = Новый РеквизитФормы("СтатусЗаказаВБазе", ТипСтатусЗаказаВБазе,
		"СоответствиеСтатусовЗаказов", НСтр("ru = 'Статус заказа в базе';
											|en = 'Order status in the infobase'"), Истина);
	РеквизитСтатусЗаказаНаСайте = Новый РеквизитФормы("СтатусЗаказаНаСайте", ТипСтрока,
		"СоответствиеСтатусовЗаказов", НСтр("ru = 'Статус заказа на сайте';
											|en = 'Order status on the website'"), Истина);

	РеквизитЗагружатьФормыОплаты = Новый РеквизитФормы("ЗагружатьФормыОплаты", ТипБулево,, НСтр("ru = 'Загружать формы оплат';
																								|en = 'Import payment forms'"), Истина);
	РеквизитВидОплатыНаСайте = Новый РеквизитФормы("ВидОплатыНаСайте", ТипСтрока,
		"СоответствиеФормОплат", НСтр("ru = 'Вид оплаты на сайте';
										|en = 'Payment kind on website'"), Истина);
	РеквизитКодОплатыНаСайте = Новый РеквизитФормы("КодОплатыНаСайте", ТипСтрока,
		"СоответствиеФормОплат", НСтр("ru = 'Код оплаты на сайте';
										|en = 'Payment code on website'"), Истина);
	РеквизитФормаОплаты = Новый РеквизитФормы("ФормаОплаты", ТипФормаОплаты,
		"СоответствиеФормОплат", НСтр("ru = 'Форма оплаты';
										|en = 'Payment method'"), Истина);

	РеквизитВидОплатыНаСайтеОнлайн = Новый РеквизитФормы("ВидОплатыНаСайте", ТипСтрока,
		"СоответствиеОнлайнОплат", НСтр("ru = 'Вид оплаты на сайте';
										|en = 'Payment kind on website'"), Истина);
	РеквизитКодОплатыНаСайтеОнлайн = Новый РеквизитФормы("КодОплатыНаСайте", ТипСтрока,
		"СоответствиеОнлайнОплат", НСтр("ru = 'Код оплаты на сайте';
										|en = 'Payment code on website'"), Истина);
	РеквизитЭквайер = Новый РеквизитФормы("Эквайер", ТипКонтрагент,
		"СоответствиеОнлайнОплат", НСтр("ru = 'Эквайер';
										|en = 'Acquirer'"), Истина);
	РеквизитДоговорЭквайринга = Новый РеквизитФормы("ДоговорЭквайринга", ТипДоговорЭквайринга,
		"СоответствиеОнлайнОплат", НСтр("ru = 'Договор подключения к платежной системе';
										|en = 'Payment system contract'"), Истина);
	РеквизитФискализироватьОплату = Новый РеквизитФормы("ФискализироватьОплату", ТипБулево,
		"СоответствиеОнлайнОплат", НСтр("ru = 'Фискализировать оплату';
										|en = 'Fiscalize payment'"), Истина);
	...
	ЗаголовокШаблон = НСтр("ru = 'Дополнительные реквизиты для поиска документов ""%1""';
							|en = 'Additional attributes to search for the ""%1"" documents'");
	...
	ЗаголовокШаблон = НСтр("ru = 'Реквизиты для создания документов ""%1""';
							|en = 'Attributes for creating the ""%1"" documents'");
	ЗаголовокГруппы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ЗаголовокШаблон, НСтр("ru = 'Заказ клиент';
																									|en = 'Order customer'"));
	...
	ЭлементСоглашениеРасширеннаяПодсказкаЗаголовок = НСтр("ru = 'Разрешается указывать типовое действующее соглашение с клиентами с установленным флагом ""Доступно внешним пользователям и для обмена с сайтом"" и пустым сегментом клиентов';
															|en = 'Specifying a standard valid agreement with customers with the set ""Available to external users and to exchange with website"" check mark and an empty customer segment is permitted '");
	...
	ЗаголовокШаблон = НСтр("ru = 'Способ поиска существующих элементов справочника ""%1""';
							|en = 'Search method of the ""%1"" catalog existing items'");
	...
	ТекстПодсказки = Новый ФорматированнаяСтрока(НСтр("ru = 'При получении информации о новых контрагентах также будут создаваться новые партнеры.';
														|en = 'New partners will be created on receiving information on new counterparties.'")
	...
	ЗаголовокШаблон = НСтр("ru = 'Реквизиты для создания новых элементов справочника ""%1""';
							|en = 'Attributes for creating new items of the ""%1"" catalog'");
	...
	ГруппаРежимВыгрузкиРасширеннаяПодсказкаЗаголовок = НСтр("ru = 'Необходимо типовое действующее соглашение с клиентами с установленным флагом ""Доступно внешним пользователям и для обмена с сайтом"" и пустым сегментом клиентов';
															|en = 'A standard valid agreement with customers with the set ""Available to external users and to exchange with website"" check mark and an empty customer segment is required'");
	...
	ТекстПодсказки = Новый ФорматированнаяСтрока(НСтр("ru = 'В заказе будет указана форма оплаты с сайта.';
														|en = 'The order will indicate the payment form from the website.'")
	, ,ЦветаСтиля.ПоясняющийТекст);
...
Функция СоздатьКонтрагента(ДанныеКонтрагента, ПрикладныеПараметры, ОписаниеОшибки, СтруктураСвойстваЗаказа) Экспорт
	...
	Для Каждого СтрокаИнформации Из ДанныеКонтрагента.ИнформацияПоКонтрагенту Цикл
		...
		Если ВРег(СтрокаИнформации.Вид) = ВРег(НСтр("ru = 'Фактический адрес';
													|en = 'Business address'")) Тогда
		...
		ИначеЕсли ВРег(СтрокаИнформации.Вид) =  ВРег(НСтр("ru = 'Юридический адрес';
															|en = 'Legal address'")) Тогда
		...
		ИначеЕсли ВРег(СтрокаИнформации.Вид) =  ВРег(НСтр("ru = 'ТелефонРабочий';
															|en = 'PhoneWork'")) Тогда
		...
		ИначеЕсли ВРег(СтрокаИнформации.Вид) =  ВРег(НСтр("ru = 'Почта';
															|en = 'Mail'")) Тогда
...
Функция ВновьСозданныйПартнер(ДанныеКонтрагента , Параметры)
	...
	ПартнерОбъект.Комментарий        = НСтр("ru = 'Создан автоматически при импорте заказов с сайта';
											|en = 'Created automatically while importing orders from the website'");
...
Процедура ДозаполнитьРеквизитыЗаказа(РеквизитыЗаказа, СвойстваЗаказа, ПрикладныеПараметры)
	...
	Если НЕ СвойстваЗаказа.Получить(МетодОплаты) = Неопределено 
		И СвойстваЗаказа.Получить(МетодОплаты) =  НСтр("ru = 'Оплачен платежной картой';
														|en = 'Paid by card'")  Тогда
