...
Функция ТребуетсяДоверенностьДляИспользованияСертификата(Сертификат, Организация) Экспорт
	...
	ДанныеОрганизации = РаботаСКонтрагентамиИСВызовСервера.ИННКПППоОрганизацииКонтрагенту(Организация);
...
Процедура ПриЗагрузкеКлассификатораИС(Идентификатор, Версия, Адрес, Обработан, ДополнительныеПараметры)
	...
	Исключение
		...
		ОбщегоНазначенияИСВызовСервера.ЗаписатьОшибкуВЖурналРегистрации(
			ТекстОшибки,
			НСтр("ru = 'Работа с классификаторами ИС';
