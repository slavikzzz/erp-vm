...
#Область ВнеоборотныеАктивы
	Если УчитыватьФО И ПолучитьФункциональнуюОпцию("ИспользоватьВнеоборотныеАктивы2_4") Тогда
		ОписаниеРаздела = ОписаниеРазделаВводаОстатковВНА(УчитыватьФО);
		ДобавитьОписаниеРазделаВводаОстатков(ОписаниеРазделовВводаОстатков, ОписаниеРаздела);
	КонецЕсли;
#КонецОбласти
...
Функция ИнициализироватьЗначенияЗаполненияДокументаВводОстатков() Экспорт
	...
	//++ Локализация
	ОтражатьВУУ = ПолучитьФункциональнуюОпцию("ВестиУУНаПланеСчетовХозрасчетный");
	//-- Локализация
...
Функция ИнициализироватьОписаниеРазделовВводаОстатков()
	...
	ОписаниеРазделовВводаОстатков.Колонки.Добавить("ПояснениеРазделаУчета",     ОбщегоНазначения.ОписаниеТипаСтрока(250), НСтр("ru = 'Пояснение раздела учета';
																																|en = 'Explanation of accounting section'"));
...
Функция ОписаниеРазделаВводаОстатковДенежныхСредств()
	...
	ОписаниеРаздела.ПояснениеРазделаУчета = НСтр("ru = 'Вводятся остатки наличных и безналичных денежных средств организаций';
												|en = 'Balance of companies'' cash accounts and bank accounts is entered'");
...
Функция ОписаниеХозяйственныхОперацийВводаОстатковДенежныхСредств()
	...
	Иначе
		ШаблонЗаголовка = НСтр("ru = 'Ввод начальных остатков на банковском счете %1';
								|en = 'Enter opening balance of account %1'");
	КонецЕсли;
	...
	Иначе
		ШаблонЗаголовка = НСтр("ru = 'Ввод начальных остатков в кассе %1';
								|en = 'Enter opening balance of cash account %1'");
	КонецЕсли;
...
Функция ОписаниеРазделаВводаОстатковПоЭквайрингу()
	...
	ОписаниеРаздела.ПояснениеРазделаУчета = НСтр("ru = 'Вводятся остатки по операциям эквайринга организаций';
												|en = 'The balances of transaction of acquiring of companies are entered'");
...
Функция ОписаниеРазделаВводаОстатковРасчетовСПодотчетниками()
	...
	ОписаниеРаздела.ПояснениеРазделаУчета = НСтр("ru = 'Вводятся остатки по взаиморасчетов с подотчетными лицами';
												|en = 'The balances of settlements with advance holders are entered'");
...
Функция ОписаниеРазделаВводаОстатковОстаткиВзаиморасчетовСПартнерами()
	...
	ОписаниеРаздела.ПояснениеРазделаУчета = НСтр("ru = 'Вводятся остатки взаиморасчетов между организациями и партнерами компании (клиентами и поставщиками)';
												|en = 'Balance of mutual intercompany AR/AP open items and company''s partners (customers and vendors) is entered'");
...
Функция ОписаниеРазделаВводаОстатковТоваров()
	...
	ОписаниеРаздела.ПояснениеРазделаУчета = НСтр("ru = 'Вводятся остатки товаров организаций';
												|en = 'Company stock balance are entered'");
...
Функция ОписаниеХозяйственныхОперацийВводаОстатковТоваров()
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьКомиссиюПриПродажах")
		...
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента            = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Ввод начальных остатков переданных на комиссию товаров %1 %2';
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьПередачуНаОтветственноеХранениеСПравомПродажи") Тогда
		...
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента            = НСтр("ru = 'Ввод начальных остатков переданных на хранение товаров %1';
																				|en = 'OB entry: cost of owned inventory in VMI warehouses %1'");
	...
	ФункциональнаяОпцияИспользоватьПроизводствоНаСтороне    = ПолучитьФункциональнуюОпцию("ИспользоватьПроизводствоНаСтороне");
	//-- Устарело_Переработка24
	ФункциональнаяОпцияИспользоватьПроизводствоНаСтороне2_5 = ПолучитьФункциональнуюОпцию("ИспользоватьПроизводствоНаСтороне2_5");
	//-- НЕ УТ
	
	//++ НЕ УТКА
	ФункциональнаяОпцияИспользоватьПроизводствоИзДавальческогоСырья2_5 = ПолучитьФункциональнуюОпцию("ИспользоватьПроизводствоИзДавальческогоСырья2_5");
	//-- НЕ УТКА
	
	//++ НЕ УТ
	
	//++ Устарело_Переработка24
	Если Не ПолучитьФункциональнуюОпцию("УправлениеТорговлей")
		И ФункциональнаяОпцияИспользоватьПроизводствоНаСтороне Тогда
		ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатковТоваров.Добавить();
		ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковМатериаловПереданныхПереработчикам;
		ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ИмяДокументаВводаНачальныхОстатков;
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков переданных переработчику материалов (2.4) %1';
																		|en = 'Enter opening balance of materials transferred to subcontractor (2.4) %1'");
		ОписаниеХозяйственнойОперации.ПорядокВДереве           = 5;
	КонецЕсли;
	//-- Устарело_Переработка24
	
	Если ФункциональнаяОпцияИспользоватьПроизводствоНаСтороне2_5 Тогда
		ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатковТоваров.Добавить();
		ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковМатериаловПереданныхПереработчикам2_5;
		ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ИмяДокументаВводаНачальныхОстатков;
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков переданных переработчику материалов %1';
	...
	//++ НЕ УТКА
	Если ФункциональнаяОпцияИспользоватьПроизводствоИзДавальческогоСырья2_5 Тогда
		
		ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатковТоваров.Добавить();
		ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковМатериаловПринятыхВПереработку2_5;
		ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ИмяДокументаВводаНачальныхОстатков;
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод остатков материалов, принятых в переработку %1';
																		|en = 'Enter remaining materials received for subcontracting %1'");
		ОписаниеХозяйственнойОперации.ПорядокВДереве           = 6;
		
		ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатковТоваров.Добавить();
		ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковПолуфабрикатовДавальца2_5;
		ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ИмяДокументаВводаНачальныхОстатков;
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод остатков полуфабрикатов давальца %1';
																		|en = 'Enter remaining semi-finished products of the provider %1'");
		ОписаниеХозяйственнойОперации.ПорядокВДереве           = 7;
		
		ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатковТоваров.Добавить();
		ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковПродукцииДавальца2_5;
		ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ИмяДокументаВводаНачальныхОстатков;
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод остатков продукции давальца %1';
																		|en = 'Enter remaining manufactured products of the provider %1'");
		ОписаниеХозяйственнойОперации.ПорядокВДереве           = 10;
...
Функция ОписаниеРазделаВводаОстатковПрочиеРасходы()
	...
	ОписаниеРаздела.ПояснениеРазделаУчета = НСтр("ru = 'Вводятся остатки по прочим операциям';
												|en = 'Balance of other transactions is entered'");
...
Функция ОписаниеРазделаВводаОстатковТМЦВЭксплуатации()
	...
	ОписаниеРаздела.ПояснениеРазделаУчета = НСтр("ru = 'Вводятся остатки ТМЦ в эксплуатации';
												|en = 'Balance of inventory in operation is entered'");
...
Функция ОписаниеРазделаВводаОстатковВНА(УчитыватьФО)
	
	ОписаниеРаздела = ИнициализироватьОписаниеРазделаУчета();
	
	ОписаниеРаздела.РазделУчета           = НСтр("ru = 'Внеоборотные активы';
												|en = 'Fixed assets'");
	ОписаниеРаздела.ПояснениеРазделаУчета = НСтр("ru = 'Вводятся остатки внеоборотных активов';
												|en = 'Fixed assets balance is entered'");
	ОписаниеРаздела.ПорядокВДереве        = 6;
	ОписаниеРаздела.ХозяйственныеОперации = ОписаниеХозяйственныхОперацийВводаОстатковВНА(УчитыватьФО);
	
	Возврат ОписаниеРаздела;
	
КонецФункции

Функция ОписаниеХозяйственныхОперацийВводаОстатковВНА(УчитыватьФО)
	
	ОписаниеХозяйственныхОперацийВводаОстатков = ИнициализироватьОписаниеХозяйственнойОперацииВводаОстатков();
	ИмяДокументаВводаНачальныхОстатков         = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Документы.ВводОстатковВнеоборотныхАктивов2_4);
	
	ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатков.Добавить();
	ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковОсновныхСредств;
	ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ИмяДокументаВводаНачальныхОстатков;
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков основных средств %1';
																	|en = 'OB entry: cost of owned fixed assets %1'");
	ОписаниеХозяйственнойОперации.ПорядокВДереве           = 6;
	
	ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатков.Добавить();
	ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковНМАиРасходовНаНИОКР;
	ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ИмяДокументаВводаНачальныхОстатков;
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод остатков нематериальных активов и расходов на НИОКР %1';
																	|en = 'Enter balance of intangible assets and R&D expenses%1'");
	ОписаниеХозяйственнойОперации.ПорядокВДереве           = 5;
	
	ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатков.Добавить();
	ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковВложенийВоВнеоборотныеАктивы;
	ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ИмяДокументаВводаНачальныхОстатков;
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков вложений во внеоборотные активы %1';
																	|en = 'OB entry: cost of assets under construction %1'");
	ОписаниеХозяйственнойОперации.ПорядокВДереве           = 4;
	
	//
	ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатков.Добавить();
	ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковПереданныхВАрендуОС;
	ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ИмяДокументаВводаНачальныхОстатков;
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков переданных в аренду основных средств %1';
																	|en = 'OB entry: leased out %1 fixed assets'");
	ОписаниеХозяйственнойОперации.ПорядокВДереве           = 7;
	
	//
	ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатков.Добавить();
	ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковАрендованныхОСЗаБалансом;
	ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ИмяДокументаВводаНачальныхОстатков;
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков арендованных основных средств (за балансом) %1';
																	|en = 'OB entry: leased fixed assets (off-balance) %1'");
	ОписаниеХозяйственнойОперации.ПорядокВДереве           = 1;
	
	ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатков.Добавить();
	ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковВзаиморасчетовПоДоговорамАренды;
	ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Документы.ВводОстатковВзаиморасчетовПоАренде);
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков взаиморасчетов по договорам аренды %1';
																	|en = 'OB entry: AR/AP under rental contracts %1'");
	ОписаниеХозяйственнойОперации.ПорядокВДереве           = 3;
	
	//
	ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатков.Добавить();
	ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковАрендованныхОСНаБалансе;
	ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ИмяДокументаВводаНачальныхОстатков;
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков арендованных основных средств (на балансе) %1';
																	|en = 'OB entry: leased fixed assets (on balance sheet) %1'");
	ОписаниеХозяйственнойОперации.ПорядокВДереве           = 2;
	
	//
	ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатков.Добавить();
	ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковПереданныхВАрендуПредметовЛизингаНаБалансе;
	ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ИмяДокументаВводаНачальныхОстатков;
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков переданных в аренду предметов лизинга на балансе %1';
																	|en = 'OB entry: financial lease assets provided to lessee (on balance sheet) %1'");
	ОписаниеХозяйственнойОперации.ПорядокВДереве           = 8;
	
	//
	ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатков.Добавить();
	ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковПредметовЛизингаЗаБалансом;
	ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ИмяДокументаВводаНачальныхОстатков;
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков предметов лизинга за балансом %1';
																	|en = 'OB entry: financial lease assets (off balance sheet) %1'");
	ОписаниеХозяйственнойОперации.ПорядокВДереве           = 9;
	
	Если УчитыватьФО И ПолучитьФункциональнуюОпцию("ИспользуетсяПередачаВАрендуСубарендуПоФСБУ25") Тогда
		ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатков.Добавить();
		ОписаниеХозяйственнойОперации.ХозяйственнаяОперация    = Перечисления.ХозяйственныеОперации.ВводОстатковИнвестицииВАренду;
		ОписаниеХозяйственнойОперации.ДокументВводаОстатков    = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Документы.ВводОстатковИнвестицииВАренду);
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков инвестиции в аренду %1';
																		|en = 'Enter opening rental investment balance %1'");
		ОписаниеХозяйственнойОперации.ПорядокВДереве           = 10;
	КонецЕсли;
		
	ВводОстатковЛокализация.ДополнитьОписаниеХозяйственныхОперацийВводаОстатковВНА(ОписаниеХозяйственныхОперацийВводаОстатков, УчитыватьФО);
	
	Возврат ОписаниеХозяйственныхОперацийВводаОстатков;
