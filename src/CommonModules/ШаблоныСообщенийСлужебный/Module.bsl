...
Функция КомментарийПоНаименованиюШаблона(НаименованиеШаблона)
	...
	Возврат НСтр("ru = 'Создано и отправлено по шаблону';
				|en = 'Created from template and sent'") + " - " + НаименованиеШаблона;
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.РаботаСФайлами") Тогда
		...
		Если ПустаяСтрока(ИмяБезРасширения) Тогда
			...
			ИмяБезРасширения = НСтр("ru = 'Вложение без имени';
									|en = 'Untitled attachment'") + ?(КоличествоПустыхИменВоВложениях = 0, ""," " + Строка(КоличествоПустыхИменВоВложениях + 1));
				...
				Исключение
					...
					ЗаписьЖурналаРегистрации(
						...
						УровеньЖурналаРегистрации.Ошибка,,, НСтр("ru = 'Ошибка при создании внешней печатной формы. По причине:';
																|en = 'Error creating external print form due to:'") + Символы.ПС
...
Функция ОпределитьОбщиеРеквизиты() Экспорт
	...
	ДобавитьОбщийРеквизит(ОбщиеРеквизитыСтроки, "ТекущаяДата", НСтр("ru = 'Текущая дата';
																	|en = 'Current date'"), Новый ОписаниеТипов("Дата"));
	ДобавитьОбщийРеквизит(ОбщиеРеквизитыСтроки, "ЗаголовокСистемы", НСтр("ru = 'Заголовок системы';
																		|en = 'Application title'"));
	ДобавитьОбщийРеквизит(ОбщиеРеквизитыСтроки, "АдресБазыВИнтернете", НСтр("ru = 'Адрес базы в Интернете';
																			|en = 'Infobase web address'"), Новый ОписаниеТипов("Строка"));
	ДобавитьОбщийРеквизит(ОбщиеРеквизитыСтроки, "АдресБазыВЛокальнойСети", НСтр("ru = 'Адрес базы в локальной сети';
																				|en = 'Infobase LAN address'"), Новый ОписаниеТипов("Строка"));
	ДобавитьОбщийРеквизит(ОбщиеРеквизитыСтроки, "ТекущийПользователь", НСтр("ru = 'Текущий пользователь';
																			|en = 'Current user'"), Новый ОписаниеТипов("СправочникСсылка.Пользователи"));
...
Функция ИмяСобытияЖурналаРегистрации()
	...
	Возврат НСтр("ru = 'Формирование шаблона сообщений';
				|en = 'Create message template'", ОбщегоНазначения.КодОсновногоЯзыка());
