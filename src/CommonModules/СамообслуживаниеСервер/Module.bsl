...
Функция ТекстВалютаЦенаВключаетНДС(Валюта, ЦенаВключаетНДС)
	...
	КонецЕсли;
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Валюта: %1 %2';
																		|en = 'Currency: %1 %2'"), Валюта, ТекстЦенаВключаетНДС);
	
КонецФункции

Функция ТекстОперация(Операция)

	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Операция: %1';
																		|en = 'Operation: %1'"), Операция);

КонецФункции

Функция ТекстНалогообложениеНДС(НалогообложениеНДС)

	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Налогообложение НДС: %1';
																		|en = 'VAT taxation: %1'"), НалогообложениеНДС);
