...
Функция СоответствиеИменПартнеровИКлиентов() Экспорт
	...
	ЛокальноеИмя = НСтр("ru = 'Контактная информация справочника ""Контактные лица партнеров""';
						|en = '""Partner contacts"" catalog contact information'", КодОсновногоЯзыка);
	...
	ЛокальноеИмя = НСтр("ru = 'Контактная информация справочника ""Партнеры""';
						|en = '""Partners"" catalog contact information'", КодОсновногоЯзыка);
