...
Процедура ПриИзмененииОтбораТипВзаимодействий(Форма,ТипВзаимодействия) Экспорт
	...
	ГруппаОтбора = ОбщегоНазначенияКлиентСервер.СоздатьГруппуЭлементовОтбора(
		Отбор.Элементы, НСтр("ru = 'Отбор по типу взаимодействий';
							|en = 'Filter by interaction category'"), ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИ);
...
Функция ТемаВзаимодействия(Тема) Экспорт
	...
	Возврат ?(ПустаяСтрока(Тема), НСтр("ru = '<Без темы>';
										|en = '<No Subject>'"), Тема);
