...
Процедура ОткрытьФормуОтправкиСообщенияВСлужбуПоддержки(СоздаватьОбращение, 
	ИдентификаторОбращения = Неопределено, КодПользователя = Неопределено, ПараметрыОбращения = Неопределено) Экспорт
	...
	Если ПараметрыОбращения <> Неопределено Тогда
		ПараметрыФормы.Вставить("Тема", ПараметрыОбращения.Тема);
		ПараметрыФормы.Вставить("Текст", ПараметрыОбращения.Текст);
		ПараметрыФормы.Вставить("ИспользоватьСтандартныйШаблон", ПараметрыОбращения.ИспользоватьСтандартныйШаблон);
		ПараметрыФормы.Вставить("Вложения", ПараметрыОбращения.Вложения);
		ПараметрыФормы.Вставить("ДополнительныеДанные", ПараметрыОбращения.ДополнительныеДанные);
		ОповещениеОЗакрытии = ПараметрыОбращения.ОбработчикЗавершения;
	КонецЕсли;
	...
	ОткрытьФорму("Обработка.ИнформационныйЦентр.Форма.ОтправкаСообщенияВСлужбуПоддержки",
...
Процедура ОткрытьФормуНовогоОбращенияВСлужбуПоддержки(ПараметрыОбращения = Неопределено) Экспорт
	...
	ОткрытьФормуОтправкиСообщенияВСлужбуПоддержки(Истина, Неопределено, Неопределено, ПараметрыОбращения);
...
//  Интерактивно - Булево - признак интерактивного получения
// 
// Возвращаемое значение:
//  Булево, Неопределено - признак получения файла из хранилища
