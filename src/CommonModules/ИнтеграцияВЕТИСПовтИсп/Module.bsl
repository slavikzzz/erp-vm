		...
		ВызватьИсключение
			СтрШаблон(
				НСтр("ru = 'Неизвестная роль предприятия с кодом: %1';
					|en = 'Неизвестная роль предприятия с кодом: %1'"),
				ЗначениеПоиска);
		...
		ВызватьИсключение
			СтрШаблон(
				НСтр("ru = 'Неизвестная роль предприятия: %1';
					|en = 'Неизвестная роль предприятия: %1'"),
				ЗначениеПоиска);
		...
		ВызватьИсключение
			СтрШаблон(
				НСтр("ru = 'Неизвестный статус предприятия в реестре Цербер: %1';
					|en = 'Неизвестный статус предприятия в реестре Цербер: %1'"),
				ЗначениеПоиска);
		...
		ВызватьИсключение
			СтрШаблон(
				НСтр("ru = 'Неизвестный статус предприятия: %1';
					|en = 'Неизвестный статус предприятия: %1'"),
				ЗначениеПоиска);
		...
		ВызватьИсключение
			СтрШаблон(
				НСтр("ru = 'Неизвестный тип предприятия с кодом: %1';
					|en = 'Неизвестный тип предприятия с кодом: %1'"),
				Код);
	КонецЕсли;
		...
		ВызватьИсключение
			СтрШаблон(
				НСтр("ru = 'Неизвестный тип документа: %1';
					|en = 'Неизвестный тип документа: %1'"),
				Код);
	КонецЕсли;
...
Функция КодДокумента(ТипДокумента) Экспорт
	...
	ИначеЕсли ТипДокумента = Перечисления.ТипыДокументовВЕТИС.УПД Тогда
		Код = 23;
	Иначе
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Неизвестный тип документа: %1';
										|en = 'Неизвестный тип документа: %1'"), ТипДокумента);
	КонецЕсли;
		...
		ВызватьИсключение
			СтрШаблон(
				НСтр("ru = 'Неизвестный статус ветеринарно-сопроводительного документа: %1';
					|en = 'Неизвестный статус ветеринарно-сопроводительного документа: %1'"),
				КодИлиЗначение);
	КонецЕсли;
		...
		ВызватьИсключение
			СтрШаблон(
				НСтр("ru = 'Неизвестный тип ветеринарно-сопроводительного документа: %1';
					|en = 'Неизвестный тип ветеринарно-сопроводительного документа: %1'"),
				КодИлиЗначение);
	КонецЕсли;
		...
		ВызватьИсключение
			СтрШаблон(
				НСтр("ru = 'Неизвестная форма ветеринарно-сопроводительного документа: %1';
					|en = 'Неизвестная форма ветеринарно-сопроводительного документа: %1'"),
				Код);
	КонецЕсли;
		...
		ВызватьИсключение
			СтрШаблон(
				НСтр("ru = 'Неизвестный период нахождения животных на территории ТС: %1';
					|en = 'Неизвестный период нахождения животных на территории ТС: %1'"),
				КодИлиЗначение);
	КонецЕсли;
		...
		ВызватьИсключение
			СтрШаблон(
				НСтр("ru = 'Неизвестный результат лабораторных исследований: %1';
					|en = 'Неизвестный результат лабораторных исследований: %1'"),
				КодИлиЗначение);
	КонецЕсли;
		...
		ВызватьИсключение
			СтрШаблон(
				НСтр("ru = 'Неизвестный тип ветеринарного мероприятия: %1';
					|en = 'Неизвестный тип ветеринарного мероприятия: %1'"),
				КодИлиЗначение);
	КонецЕсли;
		...
		ВызватьИсключение
			СтрШаблон(
				НСтр("ru = 'Неизвестный уровень упаковки: %1';
					|en = 'Неизвестный уровень упаковки: %1'"),
				КодИлиЗначение);
	КонецЕсли;
		...
		ВызватьИсключение
			СтрШаблон(
				НСтр("ru = 'Неизвестный результат проверки правил регионализации: %1';
					|en = 'Неизвестный результат проверки правил регионализации: %1'"),
				Код);
	КонецЕсли;
...
Функция ПредставленияНастроекОптимизации() Экспорт
	...
	ВозвращаемоеЗначение.Вставить(
		...
		НСтр("ru = 'Выполнять синхронизации только в регламентном задании';
			|en = 'Выполнять синхронизации только в регламентном задании'"));
	ВозвращаемоеЗначение.Вставить(
		"ЗагружатьДокументыСозданныеЧерезWeb",
		НСтр("ru = 'Загружать документы созданные через WEB';
			|en = 'Загружать документы созданные через WEB'"));
