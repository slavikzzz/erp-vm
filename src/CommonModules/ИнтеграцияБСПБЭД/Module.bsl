...
Функция ПользовательНедействителен(КонтекстДиагностики = Неопределено) Экспорт
	...
	Если ПользовательНедействителен И КонтекстДиагностики <> Неопределено Тогда
		...
		ТекстСообщения = НСтр("ru = 'Выполнение операции недоступно для недействительного пользователя';
								|en = 'The operation is unavailable for an invalid user'");
	...
	Исключение
		Если КонтекстДиагностики <> Неопределено Тогда
			КраткоеПредставлениеОшибки = НСтр("ru = 'Невозможно получить данные присоединенного файла. Файл не найден.';
												|en = 'Cannot get the attached file data. The file is not found.'");
			МассивСтрок = Новый Массив;
			МассивСтрок.Добавить(НСтр("ru = 'Файл не найден по указанному пути:.';
										|en = 'The file is not found using path:.'"));
			МассивСтрок.Добавить(СтрШаблон(НСтр("ru = 'Путь: %1';
												|en = 'Path: %1'"), ПолноеИмя));
			МассивСтрок.Добавить(СтрШаблон(НСтр("ru = 'Владелец: %1';
												|en = 'Owner: %1'"), СвойстваФайла.ВладелецФайла));
