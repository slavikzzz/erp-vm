...
#Область ОбновлениеИнформационнойБазыЕГАИС_ЗаполнитьДокументОснованиеВПротоколеОбмена
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновление данных в протоколе обмена.';
									|en = 'Обновление данных в протоколе обмена.'");
...
#Область ОбновлениеИнформационнойБазыЕГАИС_ЗаполнитьИдентификаторАктаПостановкиНаБаланс
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение идентификатора акта постановки на баланс.';
									|en = 'Заполнение идентификатора акта постановки на баланс.'");
...
#Область ОбновлениеИнформационнойБазыЕГАИС_ЗаполнитьПричинуПостановкиНаБаланс
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение причины постановки на баланс.';
									|en = 'Заполнение причины постановки на баланс.'");
...
#Область ОбновлениеИнформационнойБазыЕГАИС_ЗаполнитьТипОрганизацииЕГАИС
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение типа организации.';
									|en = 'Заполнение типа организации.'");
...
#Область ОбновлениеИнформационнойБазыЕГАИС_СоздатьСправкиВТТН
	...
	Обработчик.Комментарий = НСтр("ru = 'Создание справок 1 и 2 в ТТН.';
									|en = 'Создание справок 1 и 2 в ТТН.'");
...
#Область ОбновлениеИнформационнойБазыЕГАИС_УдалитьДвиженияПоТорговомуЗалу
	...
	Обработчик.Комментарий = НСтр("ru = 'Удаление движений по торговому залу.';
									|en = 'Удаление движений по торговому залу.'");
...
#Область ОбновлениеИнформационнойБазыЕГАИС_УстановитьПризнакИспользованияОбработкиОтветов
	...
	Обработчик.Комментарий = НСтр("ru = 'Включение регламентного задания ""Обработка ответов ЕГАИС"".';
									|en = 'Включение регламентного задания ""Обработка ответов ЕГАИС"".'");
...
#Область ОбновлениеИнформационнойБазыЕГАИС_УстановитьПризнакПроведенияТТН
	...
	Обработчик.Комментарий = НСтр("ru = 'Установка признака проведения для входящих ТТН.';
									|en = 'Установка признака проведения для входящих ТТН.'");

#КонецОбласти

#Область ОбновлениеИнформационнойБазыЕГАИС_ЗаполнитьЕдиницуИзмеренияЛитр
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "10.1.23.1";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыЕГАИС.ЗаполнитьЕдиницуИзмеренияЛитр";
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Комментарий = НСтр("ru = 'Заполнение единицы измерения ""Литр"".';
									|en = 'Заполнение единицы измерения ""Литр"".'");
...
#Область ОбновлениеИнформационнойБазыЕГАИС_УдалитьОбработчикОбновленияАктаСписания
	...
	Обработчик.Комментарий = НСтр("ru = 'Удаление неиспользуемого обработчика обновления';
									|en = 'Удаление неиспользуемого обработчика обновления'");
...
#Область Документы_АктПостановкиНаБалансЕГАИС_ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет табличную часть документа ""Акцизные марки"" ссылками на справочник ""Штрихкоды упаковок и товаров"". Данные ссылки используются вместо реквизита строкового типа ""Код акцизной марки"".';
									|en = 'Заполняет табличную часть документа ""Акцизные марки"" ссылками на справочник ""Штрихкоды упаковок и товаров"". Данные ссылки используются вместо реквизита строкового типа ""Код акцизной марки"".'");
...
#Область Документы_АктПостановкиНаБалансЕГАИС_ОбработатьДанныеДляПереходаНаНовуюВерсиюГенерацияАкцизныхМарок
	...
	Обработчик.Комментарий = НСтр("ru = 'Генерирует элементы справочника ""Штрихкоды упаковок и товаров"" по табличной части ""Акцизные марки"" документа ""Акт постановки на баланс ЕГАИС"".';
									|en = 'Генерирует элементы справочника ""Штрихкоды упаковок и товаров"" по табличной части ""Акцизные марки"" документа ""Акт постановки на баланс ЕГАИС"".'");
	Обработчик.ПриоритетыВыполнения = ОбновлениеИнформационнойБазы.ПриоритетыВыполненияОбработчика();
...
#Область Документы_АктСписанияЕГАИС_ОбработатьДанныеДляПереходаНаНовуюВерсиюГенерацияАкцизныхМарок
	...
	Обработчик.Комментарий = НСтр("ru = 'Генерирует элементы справочника ""Штрихкоды упаковок и товаров"" по табличной части ""Акцизные марки"" документа ""Акт списания ЕГАИС"".';
									|en = 'Генерирует элементы справочника ""Штрихкоды упаковок и товаров"" по табличной части ""Акцизные марки"" документа ""Акт списания ЕГАИС"".'");
	Обработчик.ПриоритетыВыполнения = ОбновлениеИнформационнойБазы.ПриоритетыВыполненияОбработчика();
...
#Область Документы_ТТНВходящаяЕГАИС_ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет пустые ссылки на номенклатуру в табличной части Товары документа ""ТТН (входящая)""';
									|en = 'Заполняет пустые ссылки на номенклатуру в табличной части Товары документа ""ТТН (входящая)""'");
	Обработчик.ПриоритетыВыполнения = ОбновлениеИнформационнойБазы.ПриоритетыВыполненияОбработчика();
...
#Область Документы_ЧекЕГАИС_ОбработатьДанныеДляПереходаНаНовуюВерсиюГенерацияАкцизныхМарок
	...
	Обработчик.Комментарий = НСтр("ru = 'Генерирует элементы справочника ""Штрихкоды упаковок и товаров"" по табличной части ""Акцизные марки"" документа ""Чек ЕГАИС на возврат"".';
									|en = 'Генерирует элементы справочника ""Штрихкоды упаковок и товаров"" по табличной части ""Акцизные марки"" документа ""Чек ЕГАИС на возврат"".'");
	Обработчик.ПриоритетыВыполнения = ОбновлениеИнформационнойБазы.ПриоритетыВыполненияОбработчика();
...
#Область РегистрыНакопления_ОстаткиАлкогольнойПродукцииЕГАИС_ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	Обработчик.Комментарий = НСтр("ru = 'Формирует движения по регистру ""Остатки алкогольной продукции ЕГАИС"".';
									|en = 'Формирует движения по регистру ""Остатки алкогольной продукции ЕГАИС"".'");
...
#Область РегистрыСведений_НастройкиОбменаЕГАИС_ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновляет записи регистра сведений ""НастройкиОбменаЕГАИС"": устанавливает таймаут соединения с УТМ 60 секунд.';
									|en = 'Обновляет записи регистра сведений ""НастройкиОбменаЕГАИС"": устанавливает таймаут соединения с УТМ 60 секунд.'");
...
#Область РегистрыСведений_СоответствиеНоменклатурыЕГАИС_ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет в регистре ""Соответствие номенклатуры ЕГАИС"" измерение Алкогольная продукция';
									|en = 'Заполняет в регистре ""Соответствие номенклатуры ЕГАИС"" измерение Алкогольная продукция'");
	Обработчик.ПриоритетыВыполнения = ОбновлениеИнформационнойБазы.ПриоритетыВыполненияОбработчика();
...
#Область РегистрыСведений_СоответствиеНоменклатурыЕГАИС_ОбработатьДанныеДляПереходаНаНовуюВерсиюЗаполнениеСправок2
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет в регистре ""Соответствие номенклатуры ЕГАИС"" измерение Справка2';
									|en = 'Заполняет в регистре ""Соответствие номенклатуры ЕГАИС"" измерение Справка2'");
...
#Область РегистрыСведений_СтатусыДокументовЕГАИС_ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет регистр сведений ""СтатусыДокументовЕГАИС"" на основании записей протокола обмена и данных документов ЕГАИС.';
									|en = 'Заполняет регистр сведений ""СтатусыДокументовЕГАИС"" на основании записей протокола обмена и данных документов ЕГАИС.'");
	Обработчик.ПриоритетыВыполнения = ОбновлениеИнформационнойБазы.ПриоритетыВыполненияОбработчика();
...
#Область РегистрыСведений_УдалитьПротоколОбменаЕГАИС_ОбработатьДанныеДляПереходаНаНовуюВерсиюВходящиеСообщения
	...
	Обработчик.Комментарий = НСтр("ru = 'Переносит входящие сообщения протокола обмена с ЕГАИС из регистра ""УдалитьПротоколОбменаЕГАИС"" в справочник ""ЕГАИСПрисоединенныеФайлы"".';
									|en = 'Переносит входящие сообщения протокола обмена с ЕГАИС из регистра ""УдалитьПротоколОбменаЕГАИС"" в справочник ""ЕГАИСПрисоединенныеФайлы"".'");
	Обработчик.ПриоритетыВыполнения = ОбновлениеИнформационнойБазы.ПриоритетыВыполненияОбработчика();
...
#Область РегистрыСведений_УдалитьПротоколОбменаЕГАИС_ОбработатьДанныеДляПереходаНаНовуюВерсиюИсходящиеСообщения
	...
	Обработчик.Комментарий = НСтр("ru = 'Переносит исходящие сообщения протокола обмена с ЕГАИС из регистра ""УдалитьПротоколОбменаЕГАИС"" в справочник ""ЕГАИСПрисоединенныеФайлы"".';
									|en = 'Переносит исходящие сообщения протокола обмена с ЕГАИС из регистра ""УдалитьПротоколОбменаЕГАИС"" в справочник ""ЕГАИСПрисоединенныеФайлы"".'");
	Обработчик.ПриоритетыВыполнения = ОбновлениеИнформационнойБазы.ПриоритетыВыполненияОбработчика();
...
#Область Справочники_ЕГАИСПрисоединенныеФайлы_ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	Обработчик.Комментарий = НСтр("ru = 'Пересчитывает статус обработки в справочнике ""ЕГАИСПрисоединенныеФайлы"".';
									|en = 'Пересчитывает статус обработки в справочнике ""ЕГАИСПрисоединенныеФайлы"".'");
	Обработчик.ПриоритетыВыполнения = ОбновлениеИнформационнойБазы.ПриоритетыВыполненияОбработчика();
...
#Область Справочники_КлассификаторОрганизацийЕГАИС_ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновляет формат обмена с УТМ для собственных организаций.';
									|en = 'Обновляет формат обмена с УТМ для собственных организаций.'");
	Обработчик.ПриоритетыВыполнения = ОбновлениеИнформационнойБазы.ПриоритетыВыполненияОбработчика();
...
#Область Справочники_КлассификаторОрганизацийЕГАИС_УстановитьФорматОбмена3
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновляет формат обмена с УТМ для организаций до версии 3.';
									|en = 'Обновляет формат обмена с УТМ для организаций до версии 3.'");
	Обработчик.ПриоритетыВыполнения = ОбновлениеИнформационнойБазы.ПриоритетыВыполненияОбработчика();
...
Функция РегистраторыДляПерепроведения(РезультатАдаптацииЗапроса,
	...
	Иначе
		ТекстИсключения = НСтр("ru = 'Функция не поддерживает работу с регистрами типа %ТипРегистра%.';
								|en = 'Функция не поддерживает работу с регистрами типа %ТипРегистра%.'");
			...
			Пока ВыборкаПоРегистраторам.Следующий() Цикл
				...
				Исключение
					...
					ТекстСообщения = НСтр("ru = 'Не удалось перезаписать движения в регистр %ИмяРегистра% по документу %Ссылка% по причине: %Причина%';
											|en = 'Не удалось перезаписать движения в регистр %ИмяРегистра% по документу %Ссылка% по причине: %Причина%'");
...
Процедура УстановитьПризнакИспользованияОбработкиОтветов() Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("ВестиСведенияДляДекларацийПоАлкогольнойПродукцииРМК") Тогда
		Задание = Задания[0];
...
Процедура ЗаполнитьФорматОбмена() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		ОрганизацияЕГАИС = Выборка.Ссылка.ПолучитьОбъект();
		ОрганизацияЕГАИС.ФорматОбмена = ОбменДаннымиЕГАИСКлиентСервер.ФорматОбмена();
