...
Процедура ОткрытьФормуИнформации(ПараметрыФормы, ОповещениеОЗавершении = Неопределено) Экспорт
	...
	ПутьКФорме = "РегистрСведений.НастройкиОбменаЕИС.Форма.ФормаИнформация";
	ОткрытьФорму(ПутьКФорме, ПараметрыФормы, , , , , ОповещениеОЗавершении);
