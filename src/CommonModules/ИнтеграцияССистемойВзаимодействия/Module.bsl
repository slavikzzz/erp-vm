...
Функция ЗапросВСервис(АдресПубликацииСервисаУправления, КодУправления, ИмяМетода, ПараметрыЗапроса = Неопределено)
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			СтрШаблон("%1.%2", ИмяСобытияЖурналаРегистрации(), НСтр("ru = 'Регистрация базы через сервис';
																	|en = 'Base registration via the service'", ОбщегоНазначения.КодОсновногоЯзыка())),
...
Функция ИмяСобытияЖурналаРегистрации()
	...
	Возврат НСтр("ru = 'Система взаимодействия';
				|en = 'Collaboration system'", ОбщегоНазначения.КодОсновногоЯзыка());
