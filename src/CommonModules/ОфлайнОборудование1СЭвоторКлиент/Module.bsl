...
Процедура ЗаполнитьТовар(СтруктураТовара, Товар)
	...
	ИначеЕсли Товар.Свойство("ЭтоМаркированнаяПродукция") Тогда
		...
		Если Товар.ЭтоМаркированнаяПродукция Тогда 
			...
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.РазливноеПиво")
				ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.РазливноеПиво") Тогда
				СтруктураТовара.type = "BEER_MARKED_KEG";
				СтруктураТовара.alcoholByVolume        = Товар.АлкогольныеРеквизиты.Крепость;
				СтруктураТовара.alcoholProductKindCode = Товар.АлкогольныеРеквизиты.КодВидаАлкогольнойПродукции;
				СтруктураТовара.tareVolume             = Товар.АлкогольныеРеквизиты.ЕмкостьТары;
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.Пиво") 
				ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.Пиво") Тогда
				СтруктураТовара.type = "BEER_MARKED";
				СтруктураТовара.alcoholByVolume        = Товар.АлкогольныеРеквизиты.Крепость;
				СтруктураТовара.alcoholProductKindCode = Товар.АлкогольныеРеквизиты.КодВидаАлкогольнойПродукции;
				СтруктураТовара.tareVolume             = Товар.АлкогольныеРеквизиты.ЕмкостьТары;
	...
	ИначеЕсли Строка(Товар.СтавкаНДС) = "5" Тогда
		СтруктураТовара.tax                    = "VAT_5";
	ИначеЕсли Строка(Товар.СтавкаНДС) = "105" Тогда
		СтруктураТовара.tax                    = "VAT_5_105";
	ИначеЕсли Строка(Товар.СтавкаНДС) = "7" Тогда
		СтруктураТовара.tax                    = "VAT_7";
	ИначеЕсли Строка(Товар.СтавкаНДС) = "107" Тогда
		СтруктураТовара.tax                    = "VAT_7_107";
	Иначе
			...
			Для Каждого Транзакция Из Документ.transactions Цикл
				...
				ИначеЕсли Транзакция.type = "POSITION_TAX" Тогда
					...
					Если ЗначениеЗаполнено(Товар) Тогда
						...
						ИначеЕсли Транзакция.tax = "VAT_5" Тогда
							Товар.СтавкаНДС = "5"
						ИначеЕсли Транзакция.tax = "VAT_5_105" Тогда
							Товар.СтавкаНДС = "5/105"
						ИначеЕсли Транзакция.tax = "VAT_7" Тогда
							Товар.СтавкаНДС = "7"
						ИначеЕсли Транзакция.tax = "VAT_7_107" Тогда
							Товар.СтавкаНДС = "7/107"
						КонецЕсли;
