...
Процедура ОткрытьФормуВыбораСпециальныхОбстоятельствФНС(ПараметрыОткрытия, Владелец, ОповещениеОЗавершении) Экспорт
	...
	ОткрытьФорму("РегистрСведений.ПереченьСпециальныхОбстоятельствДокументаЭДО.ФормаСписка", 
		ПараметрыОткрытия, Владелец, , , , ОповещениеОЗавершении, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура ОткрытьФормуПросмотраСпециальногоОбстоятельстваФНС(КодСпециальногоОбстоятельства, Владелец) Экспорт
	Если Не ЗначениеЗаполнено(КодСпециальногоОбстоятельства) Тогда
		Возврат;
	КонецЕсли;
	ПараметрыОткрытия = Новый Структура("КодСпециальногоОбстоятельства", КодСпециальногоОбстоятельства);
	ОткрытьФорму("РегистрСведений.ПереченьСпециальныхОбстоятельствДокументаЭДО.ФормаЗаписи", 
		ПараметрыОткрытия, Владелец, , , , , РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
КонецПроцедуры
#КонецОбласти
