		...
		ДанныеТекстаИсключения.Добавить(
			СтрШаблон(
				НСтр("ru = 'zerno-001. Не удалось создать элемент классификатора ""%1"" по идентификатору ""%2"".';
					|en = 'zerno-001. Не удалось создать элемент классификатора ""%1"" по идентификатору ""%2"".'"),
		...
		ДанныеТекстаИсключения.Добавить(
			СтрШаблон(
				НСтр("ru = 'zerno-002. Не удалось создать элемент классификатора ""%1"" по идентификатору ""%2"".';
					|en = 'zerno-002. Не удалось создать элемент классификатора ""%1"" по идентификатору ""%2"".'"),
				ПредставлениеВидаДанных,
				Идентификатор));
	КонецЕсли;
		...
		ДанныеТекстаИсключения.Добавить(
			СтрШаблон(
				НСтр("ru = 'Обратитесь в службу поддержки для обновления поставляемых данных классификатора %1';
					|en = 'Обратитесь в службу поддержки для обновления поставляемых данных классификатора %1'"),
				ПредставлениеВидаДанных));
	Иначе
		Если ЛогированиеЗапросовИС.ВыполняетсяЛогированиеЗапросов(ПараметрыЛогирования) Тогда
			ДанныеТекстаИсключения.Добавить(
				НСтр("ru = 'Предоставьте записанный лог запросов из панели обмена ФГИС ""Зерно"" в службу поддержки.';
					|en = 'Предоставьте записанный лог запросов из панели обмена ФГИС ""Зерно"" в службу поддержки.'"));
		Иначе
			ДанныеТекстаИсключения.Добавить(
				НСтр("ru = 'Включите запись логов запросов в панели обмена ФГИС ""Зерно"" и повторите операцию.';
					|en = 'Включите запись логов запросов в панели обмена ФГИС ""Зерно"" и повторите операцию.'"));
		КонецЕсли;
	КонецЕсли;
	...
	Попытка
		...
		Если УзлыПоИмени.Количество() = 0 Тогда
			ВызватьИсключение НСтр("ru = 'Ошибка разбора конверта SOAP. Не найден узел Body';
									|en = 'Ошибка разбора конверта SOAP. Не найден узел Body'");
		КонецЕсли;
		...
		Если УзелDOM.ПервыйДочерний = Неопределено Тогда
			ВызватьИсключение НСтр("ru = 'Ошибка разбора конверта SOAP. Не найден узел дочерний узел Body';
									|en = 'Ошибка разбора конверта SOAP. Не найден узел дочерний узел Body'");
		КонецЕсли;
	...
	Исключение
		ОбработатьОшибку(
			НСтр("ru = 'При разборе XML ответа возникла ошибка:
				       ...
				       |en = 'При разборе XML ответа возникла ошибка:
				       |Текст ошибки: %ТекстОшибки%'"),
...
Функция ТипЗначенияПотребительскогоСвойства(Значение) Экспорт
	...
	Иначе
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Внутренняя ошибка. Неизвестный тип органичения допустимого значения потребительского свойства ""%1""';
										|en = 'Внутренняя ошибка. Неизвестный тип органичения допустимого значения потребительского свойства ""%1""'"), Значение);
	КонецЕсли;
...
Функция ТипКлассификатораXDTO(Значение) Экспорт
	...
	Иначе
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Внутренняя ошибка. Неизвестный тип классификатора ""%1""';
										|en = 'Внутренняя ошибка. Неизвестный тип классификатора ""%1""'"), Значение);
	КонецЕсли;
		...
		Иначе
			ОбщегоНазначенияИСКлиентСервер.ДобавитьТекстОшибки(
				...
				НСтр("ru = 'не заполнен юридический адрес.';
					|en = 'не заполнен юридический адрес.'"));
		КонецЕсли;
		...
		ОбщегоНазначенияИСКлиентСервер.ДобавитьТекстОшибки(
			...
			СтрШаблон(
				НСтр("ru = 'Внутренняя ошибка. Не определен тип организации %1.';
					|en = 'Внутренняя ошибка. Не определен тип организации %1.'"),
...
Процедура ДополнитьТекстОшибки(СообщениеXML, КешОшибок, ПредставлениеРевизита)
	...
	Если КешОшибок.Ошибки.Количество() Тогда
		Для Каждого ЭлементКоллекции Из КешОшибок.Ошибки Цикл
			ТекстОшибки = СтрШаблон(НСтр("ru = '%1: %2';
										|en = '%1: %2'"), ПредставлениеРевизита, ЭлементКоллекции.Ключ);
			...
			ОбщегоНазначенияИСКлиентСервер.ДобавитьТекстОшибки(СообщениеXML,
				СтрШаблон(
					НСтр("ru = 'Не удалось получить OBJECTGUID или OKTMO при разборе адреса %1';
						|en = 'Не удалось получить OBJECTGUID или OKTMO при разборе адреса %1'"),
					АдресСтрокой));
		КонецЕсли;
		...
		ДлительныеОперации.СообщитьПрогресс(,
			СтрШаблон(
				НСтр("ru = 'Выполняется обмен с ФГИС ""Зерно""
				           ...
				           |en = 'Выполняется обмен с ФГИС ""Зерно""
				           |Пожалуйста, подождите...
				           |Сообщений в очереди: %1'"),
			...
			Иначе
				ТекстОшибки = СтрШаблон(
					НСтр("ru = 'Внутренняя ошибка. Для %1 не определена операция отложенной загрузки';
						|en = 'Внутренняя ошибка. Для %1 не определена операция отложенной загрузки'"),
					ИмяТаблицы);
				...
				Если ЗначениеЗаполнено(ЭлементОчереди.СсылкаНаОбъект) Тогда
					РезультатыПередачиСообщения.РезультатОбработкиОтвета.ТекстОшибки = СтрШаблон(
						НСтр("ru = 'Сообщение по объекту %1 не принято ФГИС ""Зерно"":
						           |Текст ошибки: %2';
						           |en = 'Сообщение по объекту %1 не принято ФГИС ""Зерно"":
						           |Текст ошибки: %2'"),
						ЭлементОчереди.СсылкаНаОбъект,
				...
				Иначе
					РезультатыПередачиСообщения.РезультатОбработкиОтвета.ТекстОшибки = СтрШаблон(
						НСтр("ru = 'Сообщение не принято ФГИС ""Зерно"":
						           |Текст ошибки: %1';
						           |en = 'Сообщение не принято ФГИС ""Зерно"":
						           |Текст ошибки: %1'"),
						ДанныеОбработки.ТекстОшибки);
				КонецЕсли;
			КонецЕсли;
			...
			Если ЗначениеЗаполнено(ЭлементОчереди.СсылкаНаОбъект) Тогда
				РезультатыПередачиСообщения.РезультатОбработкиОтвета.ТекстОшибки = СтрШаблон(
					НСтр("ru = 'Сообщение по %1 не принято ФГИС ""Зерно"":
					           |Текст ошибки: %2';
					           |en = 'Сообщение по %1 не принято ФГИС ""Зерно"":
					           |Текст ошибки: %2'"),
					ЭлементОчереди.СсылкаНаОбъект,
					ДанныеОбработки.ТекстОшибки);
			Иначе
	...
	Исключение
		...
		ТекстОшибки = СтрШаблон(
			НСтр("ru = 'При запросе результата возникла ошибка:
			           |Текст ошибки: %1';
			           |en = 'При запросе результата возникла ошибка:
			           |Текст ошибки: %1'"),
			ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
				...
				Если ЗначениеЗаполнено(ЭлементОчереди.СсылкаНаОбъект) Тогда
					РезультатыПередачиСообщения.РезультатОбработкиОтвета.ТекстОшибки = СтрШаблон(
						НСтр("ru = 'Ошибка получения результата по объекту %1 из ФГИС ""Зерно"":
						           |Текст ошибки: %2';
						           |en = 'Ошибка получения результата по объекту %1 из ФГИС ""Зерно"":
						           |Текст ошибки: %2'"),
						ЭлементОчереди.СсылкаНаОбъект,
						ДанныеОбработки.ТекстОшибки);
				Иначе
					РезультатыПередачиСообщения.РезультатОбработкиОтвета.ТекстОшибки = СтрШаблон(
						НСтр("ru = 'Ошибка получения результата из ФГИС ""Зерно"":
						           |Текст ошибки: %1';
						           |en = 'Ошибка получения результата из ФГИС ""Зерно"":
						           |Текст ошибки: %1'"),
						ДанныеОбработки.ТекстОшибки);
				КонецЕсли;
			КонецЕсли;
				...
				Если ЗначениеЗаполнено(ЭлементОчереди.СсылкаНаОбъект) Тогда
					РезультатыПередачиСообщения.РезультатОбработкиОтвета.ТекстОшибки = СтрШаблон(
						НСтр("ru = 'Ошибка подтверждения получения по объекту %1 ФГИС ""Зерно"":
						           |Текст ошибки: %2';
						           |en = 'Ошибка подтверждения получения по объекту %1 ФГИС ""Зерно"":
						           |Текст ошибки: %2'"),
						ЭлементОчереди.СсылкаНаОбъект,
						ДанныеОбработки.ТекстОшибки);
				Иначе
					РезультатыПередачиСообщения.РезультатОбработкиОтвета.ТекстОшибки = СтрШаблон(
						НСтр("ru = 'Ошибка подтверждения получения ФГИС ""Зерно"":
						           |Текст ошибки: %1';
						           |en = 'Ошибка подтверждения получения ФГИС ""Зерно"":
						           |Текст ошибки: %1'"),
						ДанныеОбработки.ТекстОшибки);
				КонецЕсли;
			КонецЕсли;
		...
		Иначе
			...
			ТекстОшибки = СтрШаблон(
				НСтр("ru = 'Сообщение ""%1"" не подготовлено к отправке в ФГИС ""Зерно"":
				           |%2';
				           |en = 'Сообщение ""%1"" не подготовлено к отправке в ФГИС ""Зерно"":
				           |%2'"),
	...
	Исключение
		...
		ТекстОшибки = СтрШаблон(
			НСтр("ru = 'При подготовке к передаче сообщения по объекту %1 возникла ошибка:
			           |Текст ошибки: %2';
			           |en = 'При подготовке к передаче сообщения по объекту %1 возникла ошибка:
			           |Текст ошибки: %2'"),
...
Процедура ЗаписатьОшибкуВЖурналРегистрации(ТекстОшибки, ОбъектМетаданных = Неопределено, Данные = Неопределено) Экспорт
	...
	ОбщегоНазначенияИСВызовСервера.ЗаписатьОшибкуВЖурналРегистрации(
		ТекстОшибки,
		НСтр("ru = 'ЗЕРНО';
			|en = 'ЗЕРНО'", ОбщегоНазначения.КодОсновногоЯзыка()),
		ОбъектМетаданных,
		Данные);
	...
	Если РезультатОбработки.СтатусОбработки = Перечисления.СтатусыОбработкиСообщенийЗЕРНО.Ошибка Тогда
		РезультатыПередачиСообщения.РезультатОбработкиОтвета.ТекстОшибки = СтрШаблон(
			НСтр("ru = 'Ошибка обработки сообщения по операции %1:
			           |Текст ошибки: %2';
			           |en = 'Ошибка обработки сообщения по операции %1:
			           |Текст ошибки: %2'"),
	...
	Иначе
		...
		Если ЗначениеЗаполнено(ВозвращаемоеЗначение.КодСостояния) Тогда
			ЗаголовокОшибки = СтрШаблон(НСтр("ru = 'Код состояния HTTP: %1.';
											|en = 'Код состояния HTTP: %1.'"), ВозвращаемоеЗначение.КодСостояния);
			ВозвращаемоеЗначение.ОтветПолучен    = Истина;
			ВозвращаемоеЗначение.ЗапросОтправлен = Истина;
		Иначе
...
Функция ИмяСвойстваТипаКлассификатораПоВидуКлассификатора(Значение)
	...
	ИначеЕсли Значение = Перечисления.ВидыКлассификаторовЗЕРНО.ТипХранения Тогда
		Возврат "StorageType";
	Иначе
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Внутренняя ошибка. Не определен тип поля идентификатора классификатора %1';
										|en = 'Внутренняя ошибка. Не определен тип поля идентификатора классификатора %1'"), Значение);
	КонецЕсли;
...
Функция СтатусОбработкиСообщения(Значение)
	...
	Иначе
		Возврат СтрШаблон(НСтр("ru = 'Внутренняя ошибка. Неизвестный статус обработки сообщения %1';
								|en = 'Внутренняя ошибка. Неизвестный статус обработки сообщения %1'"), Значение);
	КонецЕсли;
...
Функция СтатусПартииЗерна(Значение) Экспорт
	...
	Иначе
		Возврат СтрШаблон(НСтр("ru = 'Внутренняя ошибка. Неизвестный статус партии зерна %1';
								|en = 'Внутренняя ошибка. Неизвестный статус партии зерна %1'"), Значение);
	КонецЕсли;
...
Функция СтатусСДИЗ(Значение) Экспорт
	...
	Иначе
		Возврат СтрШаблон(НСтр("ru = 'Внутренняя ошибка. Неизвестный статус СДИЗ %1';
								|en = 'Внутренняя ошибка. Неизвестный статус СДИЗ %1'"), Значение);
	КонецЕсли;
...
Функция ВидСДИЗ(Значение) Экспорт
	...
	Иначе
		Возврат СтрШаблон(НСтр("ru = 'Внутренняя ошибка. Неизвестный вид СДИЗ %1';
								|en = 'Внутренняя ошибка. Неизвестный вид СДИЗ %1'"), Значение);
	КонецЕсли;
...
Функция СтатусРезультатаИсследований(Значение) Экспорт
	...
	Иначе
		Возврат СтрШаблон(НСтр("ru = 'Внутренняя ошибка. Неизвестный статус результата исследований %1';
								|en = 'Внутренняя ошибка. Неизвестный статус результата исследований %1'"), Значение);
	КонецЕсли;
...
Функция СтатусАктаОтбораПроб(Значение) Экспорт
	...
	Иначе
		Возврат СтрШаблон(НСтр("ru = 'Внутренняя ошибка. Неизвестный статус акта отбора проб %1';
								|en = 'Внутренняя ошибка. Неизвестный статус акта отбора проб %1'"), Значение);
	КонецЕсли;
...
Функция СтатусЗаписи(Значение) Экспорт
	...
	Иначе
		Возврат СтрШаблон(НСтр("ru = 'Внутренняя ошибка. Неизвестный статус записи %1';
								|en = 'Внутренняя ошибка. Неизвестный статус записи %1'"), Значение);
	КонецЕсли;
...
Функция ОперацияСДИЗ(Значение) Экспорт
	...
	Иначе
		Возврат СтрШаблон(НСтр("ru = 'Внутренняя ошибка. Неизвестная операция СДЗИ %1';
								|en = 'Внутренняя ошибка. Неизвестная операция СДЗИ %1'"), Значение);
	КонецЕсли;
...
Функция СтатусМестаФормированияПартии(Значение) Экспорт
	...
	ИначеЕсли Значение = Перечисления.СтатусыМестФормированияПартийЗЕРНО.ИспользованоДляСозданияПартии Тогда
		Возврат "USED_IN_LOT";
	Иначе
		Возврат СтрШаблон(НСтр("ru = 'Внутренняя ошибка. Неизвестный статус %1';
								|en = 'Внутренняя ошибка. Неизвестный статус %1'"), Значение);
	КонецЕсли;
...
Функция НаименованиеОрганизации(Знач Наименование)
	...
	Если УбратьИзНаименованияОрганизационнуюФорму(Наименование, НСтр("ru = 'ООО';
		...
		ОрганизационноПравоваяФорма           = НСтр("ru = 'Общество с ограниченной ответственностью';
													|en = 'Общество с ограниченной ответственностью'");
	...
	ИначеЕсли УбратьИзНаименованияОрганизационнуюФорму(Наименование, НСтр("ru = 'ОАО';
		...
		ОрганизационноПравоваяФорма           = НСтр("ru = 'Открытое акционерное общество';
													|en = 'Открытое акционерное общество'");
	...
	ИначеЕсли УбратьИзНаименованияОрганизационнуюФорму(Наименование, НСтр("ru = 'ЗАО';
		...
		ОрганизационноПравоваяФорма           = НСтр("ru = 'Закрытое акционерное общество';
													|en = 'Закрытое акционерное общество'");
		...
		ЗаписьЖурналаРегистрации(
			...
			СтрШаблон(
				НСтр("ru = 'Ошибка при выполнении запроса POST %1 в %2 %3';
					|en = 'Ошибка при выполнении запроса POST %1 в %2 %3'"),
		...
		ЗаписьЖурналаРегистрации(
			...
			СтрШаблон(
				НСтр("ru = 'Ошибка при выполнении запроса GET %1 в %2 %3';
					|en = 'Ошибка при выполнении запроса GET %1 в %2 %3'"),
				ПараметрыЗапросаВСервис.URLЗапроса,
				ПараметрыОтправкиHTTPЗапросов.ПредставлениеСервиса,
				ИнтеграцияЗЕРНОСлужебныйКлиентСервер.АдресСервера()) + Символы.ПС +
			ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
