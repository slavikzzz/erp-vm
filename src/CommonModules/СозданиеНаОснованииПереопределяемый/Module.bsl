...
Процедура ПриОпределенииОбъектовСКомандамиСозданияНаОсновании(Объекты) Экспорт
	...
	//++ НЕ УТКА
	УправлениеРемонтами.ПриОпределенииОбъектовСКомандамиСозданияНаОсновании(Объекты);
	//-- НЕ УТКА
	...
	Объекты.Добавить(Метаданные.Справочники.МаршрутныеКарты);
	Объекты.Добавить(Метаданные.Справочники.ТехнологическиеПроцессы);
	...
	Объекты.Добавить(Метаданные.Документы.СменноеЗадание);
	Объекты.Добавить(Метаданные.Документы.НачальныеОстаткиНЗППоПартиямПроизводства);
	// Конец СлужебныеПодсистемы.ОбъектыУП
