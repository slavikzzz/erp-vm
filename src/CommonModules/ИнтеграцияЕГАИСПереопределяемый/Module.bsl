...
Процедура ТекстЗапросаОтчетОПроизводствеЕГАИСОформите(ТекстЗапроса) Экспорт
	...
	ПравоДоступаПроизводствоБезЗаказа      = ПравоДоступа("Чтение", Метаданные.Документы.ПроизводствоБезЗаказа);
	...
	ПравоДоступаЭтапПроизводства2_2        = ПравоДоступа("Чтение", Метаданные.Документы.ЭтапПроизводства2_2);
	...
	Если ПравоДоступаПроизводствоБезЗаказа Тогда
		ЛевоеСоединение = ЛевоеСоединение + "
		|ЛЕВОЕ СОЕДИНЕНИЕ
		|	Документ.ПроизводствоБезЗаказа КАК ПроизводствоБезЗаказа
		|ПО
		|	СтатусыОформленияДокументовЕГАИС.Основание = ПроизводствоБезЗаказа.Ссылка
		|";
		УсловияСсылка.Добавить("ПроизводствоБезЗаказа.Ссылка ЕСТЬ НЕ NULL");
		УсловияОрганизация.Добавить("ПроизводствоБезЗаказа.Организация = КлассификаторОрганизацийЕГАИС.Контрагент");
	КонецЕсли;
	...
	Если ПравоДоступаЭтапПроизводства2_2 Тогда
		ЛевоеСоединение = ЛевоеСоединение + "
		|ЛЕВОЕ СОЕДИНЕНИЕ
		|	Документ.ЭтапПроизводства2_2 КАК ЭтапПроизводства2_2
		|ПО
		|	СтатусыОформленияДокументовЕГАИС.Основание = ЭтапПроизводства2_2.Ссылка
		|";
		УсловияСсылка.Добавить("ЭтапПроизводства2_2.Ссылка ЕСТЬ НЕ NULL");
		УсловияОрганизация.Добавить("ЭтапПроизводства2_2.Организация = КлассификаторОрганизацийЕГАИС.Контрагент");
	КонецЕсли;
