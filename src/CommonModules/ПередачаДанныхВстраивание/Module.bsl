...
Процедура ОшибкаПриПолученииДанных(Ответ) Экспорт
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru = 'Передача данных.Получение';
			|en = 'Data Transfer.Receiving'", ОбщегоНазначения.КодОсновногоЯзыка()),
		УровеньЖурналаРегистрации.Ошибка,
		,
		,
		СтрШаблон(
			НСтр("ru = 'Код состояния: %1 %2';
				|en = 'Status code: %1 %2'", ОбщегоНазначения.КодОсновногоЯзыка()),
			Ответ.КодСостояния,
...
Процедура ОшибкаПриОтправкеДанных(Ответ) Экспорт
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru = 'Передача данных.Отправка';
			|en = 'Data Transfer.Sending'", ОбщегоНазначения.КодОсновногоЯзыка()),
		УровеньЖурналаРегистрации.Ошибка,
		,
		,
		СтрШаблон(
