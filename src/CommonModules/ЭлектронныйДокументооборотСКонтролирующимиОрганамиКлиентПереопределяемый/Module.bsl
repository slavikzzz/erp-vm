...
Процедура ОткрытьАктуальныйЭД(ДокументИБСсылка) Экспорт
	...
	ОбменСКонтрагентамиКлиент.ОткрытьАктуальныйЭлектронныйДокумент(ДокументИБСсылка);
...
Процедура ОткрытьФормуПредложениеОформитьЗаявлениеНаПодключениеОблачной1СО(ПарметрыОткрытия, ОписаниеОповещения, БлокироватьОкноВладельца) Экспорт
