...
Функция ТекстЗапросаРеквизитаОбъектаРасчетов(
	...
	Для Каждого ТипОбъектаРасчета Из ТипыОбъектовРасчета Цикл
		...
		Иначе
			...
			//++ НЕ УТКА
			ИначеЕсли ПолноеИмяМетаданныхРеквизита = "ОпределяемыеТипы.ОбъектРасчетовСПоставщиками"
				И РеквизитДляПодстановки = "ГруппаФинансовогоУчета"
				И ПолноеИмяТипа = "Документ.ОтчетДавальцуМеждуОрганизациями" Тогда
				РеквизитДляПодстановки = "ГруппаФинансовогоУчетаДавальца";
			//-- НЕ УТКА
			КонецЕсли;
