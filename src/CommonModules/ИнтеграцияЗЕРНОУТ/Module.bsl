...
Процедура ОбработкаЗаполненияДокументаФормированиеПартийЗЕРНО(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	ИначеЕсли ТипОснования = Тип("ДокументСсылка.ЭтапПроизводства2_2")Тогда 
		ЗаполнитьФормированиеПартийЗЕРНОНаОснованииЭтапПроизводства2_2(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
	...
	ИначеЕсли ТипОснования = Тип("ДокументСсылка.ПроизводствоБезЗаказа")Тогда 
		ЗаполнитьФормированиеПартийЗЕРНОНаОснованииПроизводствоБезЗаказа(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
...
Процедура ЗаполнитьФормированиеПартийЗЕРНОНаОснованииЭтапПроизводства2_2(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	|	ТабличнаяЧасть.Получатель        КАК СкладКонтрагент,
	...
	|		ПО ТабличнаяЧасть.Ссылка = ТаблицаСерии.Ссылка
	...
	|		И ТаблицаСерии.Подразделение = ТабличнаяЧасть.Подразделение
	|ГДЕ
	...
	|		И ТаблицаСерии.ДатаПроизводства = ТабличнаяЧасть.ДатаПроизводства
	|		И ТаблицаСерии.Подразделение = ТабличнаяЧасть.Подразделение
	|		И ТаблицаСерии.ВладелецИзделия = ТабличнаяЧасть.ВладелецИзделия
	|ГДЕ
	|	ТабличнаяЧасть.Ссылка = &ДокументОснование
	|	И (СправочникНоменклатура.ОсобенностьУчета = ЗНАЧЕНИЕ(Перечисление.ОсобенностиУчетаНоменклатуры.Зерно)
	|	ИЛИ СправочникНоменклатура.ОсобенностьУчета = ЗНАЧЕНИЕ(Перечисление.ОсобенностиУчетаНоменклатуры.ЗерноВЕТИС))
...
Процедура ЗаполнитьФормированиеПартийЗЕРНОНаОснованииПроизводствоБезЗаказа(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	|		И ТаблицаСерии.Назначение = ТабличнаяЧасть.Назначение
	|		И ТаблицаСерии.Получатель = ТабличнаяЧасть.Получатель
	|		И ТаблицаСерии.НомерГруппыЗатрат = ТабличнаяЧасть.НомерГруппыЗатрат
	|ГДЕ
	|	ТабличнаяЧасть.Ссылка = &ДокументОснование
	|	И (СправочникНоменклатура.ОсобенностьУчета = ЗНАЧЕНИЕ(Перечисление.ОсобенностиУчетаНоменклатуры.Зерно)
	|	ИЛИ СправочникНоменклатура.ОсобенностьУчета = ЗНАЧЕНИЕ(Перечисление.ОсобенностиУчетаНоменклатуры.ЗерноВЕТИС))
...
Процедура ЗаполнитьТабличныеЧастиПрикладногоДокументаНаОснованииФормированияПартийЗЕРНО(ДокументОбъект, ДанныеЗаполнения, ДокументОснование)
	...
	Если ДанныеСкладов.Количество() > 1 Тогда
		...
		ТекстОшибки = НСтр("ru = 'Документ %1 содержит несколько различных складов табличной части ""Товары"". Ввод на основании документа ""%2"" невозможен.';
							|en = 'The %1 document contains several different warehouses of the Goods table. Generation from the %2 document is unavailable.'");
...
Процедура ОбработкаЗаполненияДокументаФормированиеПартийПриПроизводствеЗЕРНО(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	ИначеЕсли ТипОснования = Тип("ДокументСсылка.ЭтапПроизводства2_2")Тогда 
		ЗаполнитьФормированиеПартийПриПроизводствеЗЕРНОНаОснованииЭтапПроизводства2_2(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
	...
	ИначеЕсли ТипОснования = Тип("ДокументСсылка.ПроизводствоБезЗаказа")Тогда 
		ЗаполнитьФормированиеПартийПриПроизводствеЗЕРНОНаОснованииПроизводствоБезЗаказа(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);	
	ИначеЕсли ТипОснования = Тип("ДокументСсылка.ОтчетПереработчика")Тогда 
		ЗаполнитьФормированиеПартийПриПроизводствеЗЕРНОНаОснованииОтчетаПереработчика(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
	ИначеЕсли ТипОснования = Тип("ДокументСсылка.ОтчетПереработчика2_5")Тогда 
		ЗаполнитьФормированиеПартийПриПроизводствеЗЕРНОНаОснованииОтчетаПереработчика2_5(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
...
Процедура ЗаполнитьФормированиеПартийПриПроизводствеЗЕРНОНаОснованииЭтапПроизводства2_2(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	|	ТабличнаяЧасть.Характеристика    КАК Характеристика,
	|	ТабличнаяЧасть.Серия             КАК Серия,
	|	ТабличнаяЧасть.ДатаПроизводства  КАК ДатаИзготовления,
	|	ТабличнаяЧасть.Получатель        КАК СкладКонтрагент,
	|	СУММА(ТабличнаяЧасть.Количество) КАК Количество
	|ПОМЕСТИТЬ Товары
	|ИЗ
	...
	|	ОформленныеТовары.Характеристика   КАК Характеристика,
	|	ОформленныеТовары.Серия            КАК Серия,
	|	ОформленныеТовары.ДатаИзготовления КАК ДатаИзготовления,
	|	ОформленныеТовары.СкладКонтрагент  КАК СкладКонтрагент,
	|	-ОформленныеТовары.Количество      КАК Количество
	|ИЗ
	...
	|	ДанныеДокументов.СкладКонтрагент    КАК СкладКонтрагент,
	|	ДанныеДокументов.Серия              КАК Серия,
	|	СправочникНоменклатура.Ссылка       КАК Номенклатура,
	|	СправочникНоменклатура.КодТНВЭД.Код КАК ТНВЭД,
	|	СправочникНоменклатура.КодОКПД2.Код КАК ОКПД2,
	|	ДанныеДокументов.ДатаИзготовления   КАК ДатаИзготовления,
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ЭтапПроизводства2_2 КАК ДокументСсылка
	...
	ТаблицаСырье = ТаблицаСырьеИзПродукции(ДокументОбъект, ДанныеЗаполнения, "ЭтапПроизводства2_2", "РасходМатериаловИРабот");
		
	ДополнительныеПараметры = Новый Структура();
	ДополнительныеПараметры.Вставить("ТаблицаСырье", ТаблицаСырье);
	
	ДополнитьПараметрыТекстомЗапроса(ДополнительныеПараметры);
	
	ЗаполнитьТабличнуюЧастьФормированиеПартийПриПроизводствеЗЕРНО(ДокументОбъект,
		ДанныеЗаполнения, ДополнительныеПараметры.ТекстТоварыДокумента, -1, ДополнительныеПараметры);
...
Процедура ЗаполнитьФормированиеПартийПриПроизводствеЗЕРНОНаОснованииПроизводствоБезЗаказа(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Номенклатура КАК СправочникНоменклатура
	|		ПО ДанныеДокументов.Номенклатура = СправочникНоменклатура.Ссылка
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПроизводствоБезЗаказа КАК ДокументСсылка
	|		ПО ДанныеДокументов.ДокументОснование = ДокументСсылка.Ссылка
	|ГДЕ
	|	ДанныеДокументов.Количество > 0");
	...
	ТаблицаСырье = ТаблицаСырьеИзПродукции(ДокументОбъект, ДанныеЗаполнения, "ПроизводствоБезЗаказа","МатериалыИРаботы");
...
Процедура ЗаполнитьФормированиеПартийПриПроизводствеЗЕРНОНаОснованииОтчетаПереработчика(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	|	Поместить Товары
	|ИЗ
	|	Документ.ОтчетПереработчика.Продукция КАК ТабличнаяЧасть
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Номенклатура КАК СправочникНоменклатура
	|		ПО ТабличнаяЧасть.Номенклатура = СправочникНоменклатура.Ссылка
	|ГДЕ
	|	ТабличнаяЧасть.Ссылка = &ДокументОснование
	...
	|	ДанныеДокументов.Характеристика     КАК Характеристика,
	|	СУММА(ДанныеДокументов.Количество)  КАК Количество
	|ПОМЕСТИТЬ ОбщиеДанныеДокументов
	|ИЗ
	|	ДанныеДокументов КАК ДанныеДокументов
	|СГРУППИРОВАТЬ ПО
	|	ДанныеДокументов.ДокументОснование,
	|	ДанныеДокументов.Номенклатура,
	|	ДанныеДокументов.Характеристика
	|
	|ИМЕЮЩИЕ 
	...
	|	ДокументСсылка.Подразделение                        КАК Подразделение,
	|	ДокументСсылка.Контрагент                           КАК СкладКонтрагент,
	|	ДокументСсылка.Контрагент                           КАК ТовароПроизводитель,
	...
	|	ДанныеДокументов.Количество                         КАК Количество
	|ИЗ
	|	ОбщиеДанныеДокументов КАК ДанныеДокументов
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Номенклатура КАК СправочникНоменклатура
	|		ПО ДанныеДокументов.Номенклатура = СправочникНоменклатура.Ссылка
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ОтчетПереработчика КАК ДокументСсылка
	|		ПО ДанныеДокументов.ДокументОснование = ДокументСсылка.Ссылка
	|ГДЕ
	|	ДанныеДокументов.Количество > 0");
	...
	ТаблицаСырье = ТаблицаСырьеИзПродукции(ДокументОбъект, ДанныеЗаполнения, "ОтчетПереработчика", "Материалы");
...
Процедура ЗаполнитьФормированиеПартийПриПроизводствеЗЕРНОНаОснованииОтчетаПереработчика2_5(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Номенклатура КАК СправочникНоменклатура
	|		ПО ДанныеДокументов.Номенклатура = СправочникНоменклатура.Ссылка
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ОтчетПереработчика2_5 КАК ДокументСсылка
	|		ПО ДанныеДокументов.ДокументОснование = ДокументСсылка.Ссылка
	|ГДЕ
	|	ДанныеДокументов.Количество > 0");
	...
	ТаблицаСырье = ТаблицаСырьеИзПродукции(ДокументОбъект, ДанныеЗаполнения, "ОтчетПереработчика2_5", "МатериалыИРаботы");
...
Функция ТаблицаСырьеИзПродукции(ДокументОбъект, ДанныеЗаполнения, ИмяТаблицы, ИмяТаблицыМатериалы)
	...
	ЗаполнитьЗначенияСвойств(ДанныеОбИзделии, ДокументОбъект);
	МассивДанных.Добавить(ДанныеОбИзделии);
	
	НоваяСтрока = СписокНоменклатуры.Добавить();
	ЗаполнитьЗначенияСвойств(НоваяСтрока, ДокументОбъект);
	
	МатериалыПоСпецификациям = ДокументОбъект.Сырье.Выгрузить();
	УправлениеДаннымиОбИзделиях.ЗаполнитьСпецификациюВСтроках(СписокНоменклатуры, МассивДанных, ПараметрыВыбораСпецификаций);
	
	ДанныеСпецификаций = Справочники.РесурсныеСпецификации.ДанныеСпецификацииПоСпискуНоменклатуры(
		СписокНоменклатуры,
		Справочники.РесурсныеСпецификации.ПараметрыВыборкиДанных("МатериалыИУслуги"));
	
	Для Каждого ДанныеСпецификации Из ДанныеСпецификаций Цикл
		Если ДанныеСпецификации <> Неопределено И ДанныеСпецификации.Свойство("МатериалыИУслуги") Тогда
			Для Каждого СтрокаМатериала Из ДанныеСпецификации.МатериалыИУслуги Цикл
				Строка = МатериалыПоСпецификациям.Добавить();
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	МатериалыПоСпецификациям.Номенклатура,
	|	МатериалыПоСпецификациям.Характеристика,
	|	МатериалыПоСпецификациям.Количество
	|Поместить МатериалыПоСпецификациям
	|ИЗ
	|	&МатериалыПоСпецификациям КАК МатериалыПоСпецификациям
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ТаблицаДокументы.Серия КАК Серия
	|ПОМЕСТИТЬ СерииИсключения
	|ИЗ
	|	Документ.ФормированиеПартийПриПроизводствеЗЕРНО.Сырье КАК ТаблицаДокументы
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ФормированиеПартийПриПроизводствеЗЕРНО КАК Документ
	|		ПО ТаблицаДокументы.Ссылка = Документ.Ссылка
	|ГДЕ
	|	Документ.ДокументОснование = &ДокументОснование
	|	И Документ.Ссылка <> &ЭтаСсылка
	|	И Документ.Проведен
	|	И ТаблицаДокументы.Серия <> Значение(Справочник.СерииНоменклатуры.ПустаяСсылка)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	ТабличнаяЧасть.Серия КАК Серия,
	|	СУММА(ТабличнаяЧасть.Количество) КАК Количество,
	|	МИНИМУМ(МатериалыПоСпецификациям.Количество) КАК КоличествоПодобрать
	|ИЗ
	|	Документ.%1.%2 КАК ТабличнаяЧасть
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Номенклатура КАК СправочникНоменклатура
	|		ПО ТабличнаяЧасть.Номенклатура = СправочникНоменклатура.Ссылка
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ МатериалыПоСпецификациям КАК МатериалыПоСпецификациям
	|		ПО ТабличнаяЧасть.Номенклатура = МатериалыПоСпецификациям.Номенклатура
	|		И ТабличнаяЧасть.Характеристика = МатериалыПоСпецификациям.Характеристика
	|ГДЕ
	|	ТабличнаяЧасть.Ссылка = &ДокументОснование
	|	И НЕ ТабличнаяЧасть.Серия В
	|		(ВЫБРАТЬ
	|			Т.Серия
	|		ИЗ
	|			СерииИсключения КАК Т)
	|СГРУППИРОВАТЬ ПО
	|	ТабличнаяЧасть.Номенклатура,
	|	ТабличнаяЧасть.Серия,
	|	ТабличнаяЧасть.Характеристика
	...
	|ИТОГИ
	|	СУММА(Количество),
	|	МИНИМУМ(КоличествоПодобрать) КАК КоличествоПодобрать
	|ПО
	|	Номенклатура,
	|	Характеристика";
	
	Запрос.Текст = СтрШаблон(Запрос.Текст, ИмяТаблицы, ИмяТаблицыМатериалы);
	
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ОтчетПереработчика") Тогда
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "ТабличнаяЧасть.Серия", "Значение(Справочник.СерииНоменклатуры.ПустаяСсылка)");
	КонецЕсли;
	
	Запрос.УстановитьПараметр("ДокументОснование", ДанныеЗаполнения);
	Запрос.УстановитьПараметр("ЭтаСсылка", ДокументОбъект.Ссылка);
	Запрос.УстановитьПараметр("МатериалыПоСпецификациям", МатериалыПоСпецификациям);
	
	РезультатЗапроса = Запрос.Выполнить();
	
	ТаблицаСырье = Новый ТаблицаЗначений;
	ТаблицаСырье.Колонки.Добавить("Номенклатура", Новый ОписаниеТипов("СправочникСсылка.Номенклатура"));
	ТаблицаСырье.Колонки.Добавить("Характеристика", Новый ОписаниеТипов("СправочникСсылка.ХарактеристикиНоменклатуры"));
	ТаблицаСырье.Колонки.Добавить("Серия", Новый ОписаниеТипов("СправочникСсылка.СерииНоменклатуры"));

	ТаблицаСырье.Колонки.Добавить("Количество", ОбщегоНазначения.ОписаниеТипаЧисло(15, 2));
	...
	Пока ВыборкаНоменклатура.Следующий() Цикл
		...
		Пока ВыборкаХарактеристика.Следующий() Цикл
			...
			Осталось = ВыборкаХарактеристика.КоличествоПодобрать;
			
			ВыборкаДетальныеЗаписи = ВыборкаХарактеристика.Выбрать();
			
			Пока ВыборкаДетальныеЗаписи.Следующий() И Осталось > 0 Цикл
				
				НоваяСтрока = ТаблицаСырье.Добавить();
				ЗаполнитьЗначенияСвойств(НоваяСтрока, ВыборкаДетальныеЗаписи);
				Количество = Мин(ВыборкаДетальныеЗаписи.Количество, Осталось);
				НоваяСтрока.Количество = ВыборкаДетальныеЗаписи.КоличествоПодобрать;
				
				Осталось = Осталось - НоваяСтрока.Количество;
	...
	Возврат ТаблицаСырье;
	
КонецФункции

Процедура ДополнитьПараметрыТекстомЗапроса(ДополнительныеПараметры)
	...
	ДополнительныеПараметры.Вставить("ТекстТоварыДокумента", ТекстТоварыДокумента);
...
Процедура ЗаполнитьТабличнуюЧастьВнесениеСведенийОСобранномУрожаеЗЕРНО(ДокументОбъект, ДанныеЗаполнения, ТекстТоварыДокумента, ДопустимыйЗнак)
	...
	Если ТипЗнч(Основание) = Тип("ДокументСсылка.ЭтапПроизводства2_2") Тогда
		ДополнительныеПараметры.Вставить("ДокументОбъект", ДокументОбъект);
		ДополнительныеПараметры.Вставить("ЗаполнитьСкладВШапке", Истина);
		ДополнительныеПараметры.Вставить("ИмяПоляСклад", "СкладКонтрагент");
	КонецЕсли;
	...
	Если ТипЗнч(Основание) = Тип("ДокументСсылка.ПроизводствоБезЗаказа") Тогда
		ДополнительныеПараметры.Вставить("ДокументОбъект", ДокументОбъект);
		ДополнительныеПараметры.Вставить("ЗаполнитьСкладВШапке", Истина);
		ДополнительныеПараметры.Вставить("ИмяПоляСклад", "СкладКонтрагент");
	КонецЕсли;
...
Процедура ОбработкаЗаполненияДокументаВнесениеСведенийОСобранномУрожаеЗЕРНО(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	ИначеЕсли ТипОснования = Тип("ДокументСсылка.ЭтапПроизводства2_2") Тогда
		ЗаполнитьВнесениеСведенийОСобранномУрожаеЗЕРНОНаОснованииЭтапПроизводства2_2(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
	...
	ИначеЕсли ТипОснования = Тип("ДокументСсылка.ПроизводствоБезЗаказа") Тогда
		ЗаполнитьВнесениеСведенийОСобранномУрожаеЗЕРНОНаОснованииПроизводствоБезЗаказа(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
...
Процедура ЗаполнитьВнесениеСведенийОСобранномУрожаеЗЕРНОНаОснованииЭтапПроизводства2_2(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
...
Процедура ЗаполнитьВнесениеСведенийОСобранномУрожаеЗЕРНОНаОснованииПроизводствоБезЗаказа(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	ЗаполнитьТабличнуюЧастьВнесениеСведенийОСобранномУрожаеЗЕРНО(ДокументОбъект, ДанныеЗаполнения, ТекстТоварыДокумента, 0);
	
КонецПроцедуры

Функция ДанныеПрикладныхДокументовИзВнесенияСведенийОСобранномУрожае(ДокументСсылка, ПолучитьШапку = Истина, ПолучитьТовары = Истина)
	...
	Если ПолучитьШапку Тогда
		...
		|	ВнесениеСведенийОСобранномУрожаеЗЕРНО.СкладКонтрагент КАК Склад,
		|	ВнесениеСведенийОСобранномУрожаеЗЕРНО.Дата            КАК Дата,
		|	ВнесениеСведенийОСобранномУрожаеЗЕРНО.Комментарий     КАК Комментарий
		|ИЗ
		|	Документ.ВнесениеСведенийОСобранномУрожаеЗЕРНО КАК ВнесениеСведенийОСобранномУрожаеЗЕРНО
		|ГДЕ
		|	ВнесениеСведенийОСобранномУрожаеЗЕРНО.Ссылка = &Ссылка
		|", "Шапка");
	...
	Если ПолучитьТовары Тогда
		...
		|				ПО ВнесениеСведенийОСобранномУрожаеЗЕРНОТовары.Ссылка = ВнесениеСведенийОСобранномУрожаеЗЕРНО.Ссылка
		|			ПО СтавкиНДСНоменклатуры.Номенклатура = ВнесениеСведенийОСобранномУрожаеЗЕРНОТовары.Номенклатура
		|				И (СтавкиНДСНоменклатуры.Страна = &СтранаРегистрации
		|					ИЛИ СтавкиНДСНоменклатуры.Страна = ЗНАЧЕНИЕ(Справочник.СтраныМира.ПустаяСсылка))
		|				И СтавкиНДСНоменклатуры.Период <= ВнесениеСведенийОСобранномУрожаеЗЕРНО.Дата
		|	ГДЕ
		...
		|			ПО (ОсновныеСтавкиНДС.Страна = &СтранаРегистрации
		|					ИЛИ ОсновныеСтавкиНДС.Страна = ЗНАЧЕНИЕ(Справочник.СтраныМира.ПустаяСсылка))
		|				И ОсновныеСтавкиНДС.Период <= ВнесениеСведенийОСобранномУрожаеЗЕРНО.Дата
		|	ГДЕ
		|		ВнесениеСведенийОСобранномУрожаеЗЕРНО.Ссылка = &Ссылка
		|	СГРУППИРОВАТЬ ПО
		|		ОсновныеСтавкиНДС.Страна) КАК АктуальныеСтавкиНДС
		...
		|	ТаблицаДокумента.СкладКонтрагент КАК Склад,
		|	ВнесениеСведенийОСобранномУрожаеЗЕРНОТовары.Количество КАК Количество,
		|	ВнесениеСведенийОСобранномУрожаеЗЕРНОТовары.Количество КАК КоличествоУпаковок
		|ИЗ
		|	Документ.ВнесениеСведенийОСобранномУрожаеЗЕРНО.Товары КАК ВнесениеСведенийОСобранномУрожаеЗЕРНОТовары
		|		ЛЕВОЕ СОЕДИНЕНИЕ СтавкиНДСНоменклатуры КАК СтавкиНДСНоменклатуры
		|		ПО ВнесениеСведенийОСобранномУрожаеЗЕРНОТовары.Номенклатура = СтавкиНДСНоменклатуры.Номенклатура
		|		ЛЕВОЕ СОЕДИНЕНИЕ ОсновныеСтавкиНДС КАК ОсновныеСтавкиНДС
		|		ПО (ИСТИНА)
		|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ВнесениеСведенийОСобранномУрожаеЗЕРНО КАК ТаблицаДокумента
		|		ПО ВнесениеСведенийОСобранномУрожаеЗЕРНОТовары.Ссылка = ТаблицаДокумента.Ссылка
		|ГДЕ
		|	ВнесениеСведенийОСобранномУрожаеЗЕРНОТовары.Ссылка = &Ссылка
		|", "Товары");
...
Процедура ЗаполнитьШапкуПрикладногоДокументаНаОснованииВнесенияСведенийОСобранномУрожае(ДокументОбъект, ДанныеЗаполнения)
...
Функция СтруктураЗаполненияТабличныхЧастейПоВнесениюСведенийОСобранномУрожае(ДанныеЗаполнения, ЕстьСерии = Ложь, ЕстьСкладВТабличнойЧасти = Ложь, ИмяТабличнойЧастиСерии = Неопределено, ИмяПоляСкладВТабличнойЧасти = Неопределено)
	
	Результат = Новый Структура;
	Результат.Вставить("Товары", ДанныеЗаполнения.Выгрузить());
	Если ЕстьСерии Тогда
		Результат.Вставить("ЕстьСерии", ИмяТабличнойЧастиСерии);
	КонецЕсли;
	Если ЕстьСкладВТабличнойЧасти Тогда
		Результат.Вставить("ЕстьСкладВТабличнойЧасти", ИмяПоляСкладВТабличнойЧасти);
	КонецЕсли;
...
Процедура ЗаполнитьТабличныеЧастиПрикладногоДокументаНаОснованииВнесенияСведенийОСобранномУрожае(ДокументОбъект, ДанныеЗаполнения, ИмяТабличнойЧастиЗаполнения = "Товары")
	
	ЕстьСкладВТабличнойЧасти = ДанныеЗаполнения.Свойство("ЕстьСкладВТабличнойЧасти");
	
	ДокументОбъект[ИмяТабличнойЧастиЗаполнения].Очистить();
	Для Каждого СтрокаТовары Из ДанныеЗаполнения.Товары Цикл
		
		НоваяСтрокаТовары = ДокументОбъект[ИмяТабличнойЧастиЗаполнения].Добавить();
		ЗаполнитьЗначенияСвойств(НоваяСтрокаТовары, СтрокаТовары);
		
		НоваяСтрокаТовары.НаправлениеВыпуска = Перечисления.ХозяйственныеОперации.ВыпускПродукцииНаСклад;
		
		Если ЕстьСкладВТабличнойЧасти Тогда
			
			ИмяПоляСкладВТабличнойЧасти = ДанныеЗаполнения.ЕстьСкладВТабличнойЧасти;
			Если ИмяПоляСкладВТабличнойЧасти = Неопределено Тогда 
				ИмяПоляСкладВТабличнойЧасти = "Склад";
			КонецЕсли;
			
			НоваяСтрокаТовары[ИмяПоляСкладВТабличнойЧасти] = СтрокаТовары.Склад;
	...
	Если ДанныеЗаполнения.Свойство("ЕстьСерии") Тогда
		...
		ДокументОбъект[ИмяТЧСерии].Очистить();
		Для Каждого СтрокаТовары Из ДокументОбъект[ИмяТабличнойЧастиЗаполнения] Цикл
			Если ЗначениеЗаполнено(СтрокаТовары.Серия) Тогда
				НоваяСтрокаСерия = ДокументОбъект[ИмяТЧСерии].Добавить();
				ЗаполнитьЗначенияСвойств(НоваяСтрокаСерия, СтрокаТовары);
			КонецЕсли;
	...
	Если Не ЭтоПерезаполнение
		...
		Если ДокументОбъект.Перевозка Тогда
			...
			Если НЕ ЗначениеЗаполнено(ДокументОбъект.ПунктНазначенияСтрокой) 
				...
				ДанныеДляЗаполненияПунктаНазначения = ИнтеграцияИСВызовСервера.ДанныеАдресаОбъекта(ДокументОбъект.ПунктНазначенияСопоставленныйОбъект);
			...
			ИначеЕсли ЗначениеЗаполнено(ДокументОбъект.ПунктНазначенияСтрокой) И Не ЗначениеЗаполнено(ДокументОбъект.ПунктНазначения) Тогда
				...
				ДокументОбъект.ПунктНазначения = ИнтеграцияИСВызовСервера.ЗначенияПолейКонтактнойИнформации(ДокументОбъект.ПунктНазначенияСтрокой, ВидКонтактнойИнформации);
...
Процедура ОбработкаЗаполненияДокументаОформлениеСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	ИначеЕсли ТипОснования = Тип("ДокументСсылка.ДвижениеПродукцииИМатериалов") Тогда
		ЗаполнитьОформлениеСДИЗЗЕРНОНаОснованииДвиженияПродукцииИМатериалов(
			ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
	ИначеЕсли ТипОснования = Тип("ДокументСсылка.ПередачаСырьяПереработчику") Тогда
		ЗаполнитьОформлениеСДИЗЗЕРНОНаОснованииПередачиСырьяПереработчику(
			ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
	ИначеЕсли ТипОснования = Тип("ДокументСсылка.ВозвратСырьяОтПереработчика") Тогда
		ЗаполнитьОформлениеСДИЗЗЕРНОНаОснованииВозвратаСырьяОтПереработчика(
			ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
	ИначеЕсли ТипОснования = Тип("ДокументСсылка.ПоступлениеОтПереработчика") Тогда
		ЗаполнитьОформлениеСДИЗЗЕРНОНаОснованииПоступленияОтПереработчика(
			ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
...
Процедура ЗаполнитьОформлениеСДИЗЗЕРНОНаОснованииДвиженияПродукцииИМатериалов(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	|	""""                                         КАК ПунктНазначения,
	|	""""                                         КАК ПунктНазначенияСтрокой,
	|	ДокументСсылка.Получатель                    КАК ПунктНазначенияСопоставленныйОбъект,
	|	ДокументСсылка.Отправитель                   КАК ПунктОтправления,
	|	ДокументСсылка.Дата                          КАК ДатаДокумента,
	|	ДокументСсылка.Номер                         КАК НомерДокумента,
	|	ДАТАВРЕМЯ(1, 1, 1)                           КАК ДатаГПД,
	|	""""                                         КАК НомерГПД,
	...
	ОписаниеТабличнойЧасти = ОписаниеТабличнойЧасти();
	ЗаполнитьТабличнуюЧастьОформлениеСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения, "ДвижениеПродукцииИМатериалов", ОписаниеТабличнойЧасти);
	
КонецПроцедуры

Процедура ЗаполнитьОформлениеСДИЗЗЕРНОНаОснованииПередачиСырьяПереработчику(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	|	РеестрЭлеваторовЗЕРНО.Ссылка              КАК ЭлеваторПолучатель
	|ИЗ
	|	Документ.ПередачаСырьяПереработчику КАК ДокументСсылка
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Контрагенты КАК Контрагенты
	|		ПО ДокументСсылка.Контрагент = Контрагенты.Ссылка
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.РеестрЭлеваторовЗЕРНО КАК РеестрЭлеваторовЗЕРНО
	...
	ЗаполнитьТабличнуюЧастьОформлениеСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения, "ПередачаСырьяПереработчику", ОписаниеТабличнойЧасти);
	
КонецПроцедуры

Процедура ЗаполнитьОформлениеСДИЗЗЕРНОНаОснованииВозвратаСырьяОтПереработчика(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	|	ИСТИНА                                        КАК Перевозка,
	|	ЛОЖЬ                                          КАК Отгрузка,
	|	ДоговорыСКонтрагентом.Дата                    КАК ДатаГПД,
	|	ДоговорыСКонтрагентом.Номер                   КАК НомерГПД,
	|	ДоговорыСКонтрагентом.ГосударственныйКонтракт КАК ГосударственныйКонтракт
	|ИЗ
	|	Документ.ВозвратСырьяОтПереработчика КАК ДокументСсылка
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Контрагенты КАК Контрагенты
	|		ПО ДокументСсылка.Контрагент = Контрагенты.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ДоговорыКонтрагентов КАК ДоговорыСКонтрагентом
	|		ПО ДокументСсылка.Договор = ДоговорыСКонтрагентом.Ссылка
	|ГДЕ
	|	ДокументСсылка.Ссылка = &ДокументОснование");
	...
	ЗаполнитьТабличнуюЧастьОформлениеСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения, "ВозвратСырьяОтПереработчика", ОписаниеТабличнойЧасти);
	
КонецПроцедуры

Процедура ЗаполнитьОформлениеСДИЗЗЕРНОНаОснованииПоступленияОтПереработчика(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	ОписаниеТабличнойЧасти = ОписаниеТабличнойЧасти("ТоварыСерии");
	
	ЗаполнитьТабличнуюЧастьОформлениеСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения, "ПоступлениеОтПереработчика", ОписаниеТабличнойЧасти);
...
Процедура ЗаполнитьШапкуПрикладногоДокументаНаОснованииОформленияСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения)
	...
	КонецЕсли;
	//++ НЕ УТ
	Если ТипЗнч(ДокументОбъект) = Тип("ДокументОбъект.ДвижениеПродукцииИМатериалов") Тогда
		Если ЗначениеЗаполнено(Выборка.ПунктОтправления) Тогда
			Реквизиты.Вставить("Отправитель", Выборка.ПунктОтправления);
		КонецЕсли;
	КонецЕсли;
	//-- НЕ УТ
	ЗаполнитьЗначенияСвойств(ДокументОбъект, Реквизиты);
...
Процедура ОбработкаЗаполненияДокументаСписаниеПартийЗЕРНО(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	ИначеЕсли ТипОснования = Тип("ДокументСсылка.ПроизводствоБезЗаказа") Тогда
		ЗаполнитьСписаниеПартийЗЕРНОНаОснованииПроизводстваБезЗаказа(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
	...
	ИначеЕсли ТипОснования = Тип("ДокументСсылка.ЭтапПроизводства2_2") Тогда
		ЗаполнитьСписаниеПартийЗЕРНОНаОснованииЭтапаПроизводства2_2(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
...
Процедура ЗаполнитьСписаниеПартийЗЕРНОНаОснованииПроизводстваБезЗаказа(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	|ПОМЕСТИТЬ ТоварыСерии
	|ИЗ
	|	Документ.ПроизводствоБезЗаказа.МатериалыИРаботы КАК Товары
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Номенклатура КАК СправочникНоменклатура
	|		ПО Товары.Номенклатура = СправочникНоменклатура.Ссылка
	|ГДЕ
	|	Товары.Ссылка = &ДокументОснование
...
Процедура ЗаполнитьСписаниеПартийЗЕРНОНаОснованииЭтапаПроизводства2_2(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	|ПОМЕСТИТЬ Товары
	|ИЗ
	|	Документ.ЭтапПроизводства2_2.РасходМатериаловИРабот КАК Товары
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Номенклатура КАК СправочникНоменклатура
	|		ПО Товары.Номенклатура = СправочникНоменклатура.Ссылка
	|ГДЕ
	|	Товары.Ссылка = &ДокументОснование
	...
	|	Товары.Серия                                                       КАК Серия,
	|	Товары.Количество                                                  КАК Количество,
	|	МАКСИМУМ(ЭтапПроизводства2_2ОбеспечениеМатериаламиИРаботами.Склад) КАК Склад
	|ПОМЕСТИТЬ ТоварыСерии
	|ИЗ
	|	Товары КАК Товары
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ЭтапПроизводства2_2.ОбеспечениеМатериаламиИРаботами КАК
	|			ЭтапПроизводства2_2ОбеспечениеМатериаламиИРаботами
	|		ПО ЭтапПроизводства2_2ОбеспечениеМатериаламиИРаботами.Номенклатура = Товары.Номенклатура
	|		И ЭтапПроизводства2_2ОбеспечениеМатериаламиИРаботами.Характеристика = Товары.Характеристика
	|		И ЭтапПроизводства2_2ОбеспечениеМатериаламиИРаботами.Серия = Товары.Серия
	|СГРУППИРОВАТЬ ПО
	|	Товары.Номенклатура,
	|	Товары.Характеристика,
	|	Товары.Серия,
...
Процедура ЗаполнитьТабличнуюЧастьСписаниеПартийЗЕРНО(ДокументОбъект, ДанныеЗаполнения, ТекстТоварыДокумента, ДопустимыйЗнак)
	...
	Если ТипЗнч(Основание) = Тип("ДокументСсылка.ЭтапПроизводства2_2") Тогда
		ДополнительныеПараметры.Вставить("ДокументОбъект", ДокументОбъект);
		ДополнительныеПараметры.Вставить("ЗаполнитьСкладВШапке", Истина);
		ДополнительныеПараметры.Вставить("ИмяПоляСклад", "Склад");
	КонецЕсли;
...
Процедура ОбработкаЗаполненияДокументаПогашениеСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	Если ТипДокументаОснования = Тип("ДокументСсылка.ПриобретениеТоваровУслуг")
		...
		//++ НЕ УТ
		Или ТипДокументаОснования = Тип("ДокументСсылка.ДвижениеПродукцииИМатериалов")
		Или ТипДокументаОснования = Тип("ДокументСсылка.ВозвратСырьяОтПереработчика")
		Или ТипДокументаОснования = Тип("ДокументСсылка.ПередачаСырьяПереработчику")
		//-- НЕ УТ
		
		//++ НЕ УТКА
		
		Или ТипДокументаОснования = Тип("ДокументСсылка.ПоступлениеСырьяОтДавальца")
		...
		//++ НЕ УТ
	ИначеЕсли ТипДокументаОснования = Тип("ДокументСсылка.ПоступлениеОтПереработчика") Тогда
		ИмяТаблицыСерий = "ТоварыСерии";
		//-- НЕ УТ
...
Процедура ЗаполнитьПередачуТоваровХранителюНаОснованииОформленияСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения) Экспорт
	...
	Если ЗаполнятьШапку Тогда
		...
		Если ПолучитьФункциональнуюОпцию("ИспользоватьПроизводствоНаСтороне2_5") Тогда
			ДокументОбъект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПередачаПереработчику2_5;
		КонецЕсли;
...
Процедура ЗаполнитьВыкупПринятыхНаХранениеТоваровНаОснованииПогашенияСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения) Экспорт
	...
	Если ЗаполнятьШапку Тогда
		...
		//++ НЕ УТКА
		Если ДокументОбъект.ХозяйственнаяОперация <> Перечисления.ХозяйственныеОперации.ВыкупТоваровДавальца Тогда
		//-- НЕ УТКА
...
Процедура ЗаполнитьДвижениеПродукцииИМатериаловНаОснованииОформленияСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения) Экспорт
...
Процедура ЗаполнитьПоступлениеОтПереработчикаНаОснованииПогашенияСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения) Экспорт
	...
	СтруктураЗаполненияТЧ = СтруктураЗаполненияТабличныхЧастейПоПогашениюСДИЗЗЕРНО(РезультатЗапроса.Товары, Истина, Истина);
	СтруктураЗаполненияТЧ.ЕстьСерии = "ТоварыСерии";
	ЗаполнитьТабличныеЧастиПрикладногоДокументаНаОснованииПогашенияСДИЗЗЕРНО(ДокументОбъект, СтруктураЗаполненияТЧ);
	
	ДокументОбъект.ЗаполнитьУсловияЗакупокПоУмолчанию();
	
КонецПроцедуры

Процедура ЗаполнитьПоступлениеОтПереработчикаНаОснованииОформленияСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения) Экспорт
...
Процедура ЗаполнитьВозвратСырьяОтПереработчикаНаОснованииПогашенияСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения) Экспорт
...
Процедура ЗаполнитьВозвратСырьяОтПереработчикаНаОснованииОформленияСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения) Экспорт
...
Процедура ЗаполнитьПередачуСырьяПереработчикуНаОснованииПогашенияСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения) Экспорт
...
Процедура ЗаполнитьПередачуСырьяПереработчикуНаОснованииОформленияСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения) Экспорт
...
Процедура ЗаполнитьПоступлениеСырьяОтДавальцаНаОснованииПогашенияСДИЗЗЕРНО(ДокументОбъект, ДанныеЗаполнения) Экспорт
...
Процедура ЗаполнитьПроизводствоБезЗаказаНаОснованииВнесениеСведенийОСобранномУрожаеЗЕРНО(ДокументОбъект, ДанныеЗаполнения) Экспорт
	...
	РезультатЗапроса = ДанныеПрикладныхДокументовИзВнесенияСведенийОСобранномУрожае(ДокументОснование, ЗаполнятьШапку);
	
	Если ЗаполнятьШапку Тогда
		ЗаполнитьШапкуПрикладногоДокументаНаОснованииВнесенияСведенийОСобранномУрожае(ДокументОбъект, РезультатЗапроса.Шапка);
	КонецЕсли;
	
	СтруктураЗаполненияТабличныхЧастей = СтруктураЗаполненияТабличныхЧастейПоВнесениюСведенийОСобранномУрожае(
		РезультатЗапроса.Товары, Истина, Истина, "ВыходныеИзделияСерии", "Получатель");
	
	ЗаполнитьТабличныеЧастиПрикладногоДокументаНаОснованииВнесенияСведенийОСобранномУрожае(
		ДокументОбъект,
		СтруктураЗаполненияТабличныхЧастей,
		"ВыходныеИзделия");
