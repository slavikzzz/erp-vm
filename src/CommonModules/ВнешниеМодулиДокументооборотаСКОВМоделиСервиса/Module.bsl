		...
		Исключение
			...
			ТекстОшибки = СтрШаблон(
				НСтр("ru = 'Получение архива внешнего модуля документооборота с контролирующими органами.
						   |Описание:
						   |""%1""';
						   |en = 'Получение архива внешнего модуля документооборота с контролирующими органами.
						   |Описание:
						   |""%1""'"),
				ПредставлениеОшибки);
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Поставляемые данные. Загрузка внешнего модуля документооборота с контролирующими органами.';
					|en = 'Поставляемые данные. Загрузка внешнего модуля документооборота с контролирующими органами.'"),
		...
		Попытка
			...
			Если РезультатПоиска.Количество() = 0 Тогда
				ПредставлениеОшибки = НСтр("ru = 'Ошибка при извлечении файла из архива.';
											|en = 'Ошибка при извлечении файла из архива.'");
		...
		Если ПредставлениеОшибки <> Неопределено Тогда
			ТекстОшибки = СтрШаблон(
				НСтр("ru = 'Распаковка внешнего модуля документооборота с контролирующими органами.
						   |Описание:
						   |""%1""';
						   |en = 'Распаковка внешнего модуля документооборота с контролирующими органами.
						   |Описание:
						   |""%1""'"),
				ПредставлениеОшибки);
		...
		Исключение
			...
			ТекстОшибки = СтрШаблон(
				НСтр("ru = 'Запись внешнего модуля документооборота с контролирующими органами.
						   |Описание:
						   |""%1""';
						   |en = 'Запись внешнего модуля документооборота с контролирующими органами.
						   |Описание:
						   |""%1""'"),
				ПредставлениеОшибки);
