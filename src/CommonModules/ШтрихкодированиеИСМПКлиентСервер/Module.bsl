...
// Возвращаемое значение:
//   Булево - параметры сканирования дополнены спецификой ИС МП.
Функция ЗаполнитьПараметрыСканированияДокументаОптовойОтгрузки(ПараметрыСканирования, ВидПродукции, Контекст = Неопределено) Экспорт
	...
	Если ВключенаПоддержкаИСМП Или ВключенаПоддержкаМОТП Тогда
		...
		Если Не ЗначениеЗаполнено(ПараметрыСканирования.ДатаДокумента) Тогда
			ПараметрыСканирования.ДатаДокумента = ТекущаяДата();
		КонецЕсли;
...
// Возвращаемое значение:
//   Булево - параметры сканирования дополнены спецификой ИС МП.
Функция ЗаполнитьПараметрыСканированияДокументаВнутреннегоПеремещения(ПараметрыСканирования, ВидПродукции) Экспорт
...
Процедура ЗаполнитьПараметрыСканированияПеремещениеМеждуМОД_ИСМП(Контекст, ПараметрыСканирования) Экспорт
	...
	ПараметрыСканирования.ПоддерживаетсяОбъемноСортовойУчет  = Истина;
	ПараметрыСканирования.ДопустимыеВидыПродукции            = ОбщегоНазначенияИСМПКлиентСерверПовтИсп.ВидыПродукцииВнутреннегоПеремещенияМеждуМОД();
