...
Процедура АктОРасхожденияхСписокОбработатьПараметрОснования(Форма, ЭтоАктыОРасхожденияПослеОтгрузки) Экспорт
	...
	Если Не ЗначениеЗаполнено(Форма.ТипОснованияАктаОРасхождении) Тогда
		...
		ВызватьИсключение(НСтр("ru = 'Форма списка документов ""Акты о расхождениях"" не предназначена для открытия без переданного параметра ""Тип основания""';
								|en = 'You cannot open the list form of the ""Discrepancy reports"" documents without the passed ""Base document type"" parameter'"));
	...
	ИначеЕсли Форма.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ВозвратПоставщику Тогда
		...
		Форма.Заголовок = НСтр("ru = 'Акты о расхождениях после возвратов поставщикам';
								|en = 'Discrepancy reports following returns to vendors'");
	...
	ИначеЕсли Форма.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ОтгрузкаТоваровСХранения Тогда
		...
		Форма.Заголовок = НСтр("ru = 'Акты о расхождениях после отгрузки товаров с хранения';
								|en = 'VMI pick-up discrepancy reports'");
		ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Форма.Элементы, "Партнер", "Заголовок", НСтр("ru = 'Поставщик';
																													|en = 'Vendor'"));
	...
	ИначеЕсли Форма.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПередачаНаКомиссию Тогда
		...
		Форма.Заголовок = НСтр("ru = 'Акты о расхождениях после передачи товаров комиссионеру';
								|en = 'Discrepancy reports after goods transfer to consignee'");
	...
	ИначеЕсли Форма.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПриемкаТоваровНаХранение Тогда
		...
		Форма.Заголовок = НСтр("ru = 'Акты о расхождениях после приемки товаров с хранения';
								|en = 'Discrepancy reports following goods receipt from storage'");
		ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Форма.Элементы, "Партнер", "Заголовок", НСтр("ru = 'Поставщик';
																													|en = 'Vendor'"));
	...
	//++ НЕ УТКА
	ИначеЕсли Форма.ТипОснованияАктаОРасхождении =
						Перечисления.ТипыОснованияАктаОРасхождении.ПоступлениеОтДавальца Тогда
		
		Форма.Заголовок = НСтр("ru = 'Акты о расхождениях после приемки сырья давальцев';
								|en = 'Discrepancy reports following receipt of raw materials from providers'");
		
		ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Форма.Элементы, "Партнер", "Заголовок", НСтр("ru = 'Давалец';
														|en = 'Material provider'"));
			
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
			Форма.Список, "СтатусИзменение", НСтр("ru = 'Изменение приемки';
													|en = 'Receiving change'"));
		
	ИначеЕсли Форма.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПередачаДавальцу Тогда
		
		Форма.Заголовок = ДавальческаяСхемаКлиентСервер.СинонимДокументаАктОРасхожденияхПередачаДавальцу();
		...
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
			Форма.Список, "СтатусИзменение", НСтр("ru = 'Изменение передачи';
													|en = 'Change transfers'"));
		
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Форма.Элементы,"СпособОтраженияРасхождений", "Видимость", Ложь);
		
	ИначеЕсли Форма.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ВозвратДавальцу Тогда
		
		Форма.Заголовок = ДавальческаяСхемаКлиентСервер.СинонимДокументаАктОРасхожденияхВозвратСырьяДавальцу();
		...
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
			Форма.Список, "СтатусИзменение", НСтр("ru = 'Изменение возврата';
													|en = 'Change return'"));
	...
	Иначе
		...
		Форма.Заголовок = НСтр("ru = 'Акты о расхождениях после возвратов от клиентов';
								|en = 'Discrepancy reports following returns from customers'");
		ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Форма.Элементы, "Партнер", "Заголовок", НСтр("ru = 'Клиент';
																													|en = 'Client'"));
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Форма.Список, "СтатусИзменение", НСтр("ru = 'Изменение возврата';
																												|en = 'Change return'"));
	...
	Если ЭтоАктыОРасхожденияПослеОтгрузки Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		      ...
		      НСтр("ru = 'Оформление корректировок (реализация перепоставленного/возврат недопоставленного товара)';
					|en = 'Register notes (sales of overdelivered goods/return of underdelivered goods)'"));
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		      Форма.Список, 
		      "СтатусКорректировкаКакИсправление", 
		      НСтр("ru = 'Оформление корректировки (исправление ошибок)';
					|en = 'Register adjustment (error correction)'"));
	Иначе
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		      Форма.Список, 
		      "СтатусКорректировкаКакИсправление", 
		      НСтр("ru = 'Оформление корректировки поступления';
					|en = 'Register receipt adjustment'"));
	КонецЕсли;
...
Функция ФормированиеНадписиДокументыОснованиеПеремещение(Элемент, КоличествоДокументовОснований, КоличествоТоваров, ПредставлениеДокументаОснования = "") Экспорт
	...
	Иначе
		...
		Иначе
			ДокументыОснованиеПредставление = НСтр("ru = 'Всего перемещений';
													|en = 'Total transfers'") + ": " + Строка(КоличествоДокументовОснований);
			Элемент.Ширина = 14;
			Элемент.Гиперссылка = Истина;
		КонецЕсли;
...
Процедура ПроверитьТипОснованияАктаПриСоздании(ДокументАктОбъект) Экспорт
	...
	Если Не ЗначениеЗаполнено(ДокументАктОбъект.ТипОснованияАктаОРасхождении) Тогда
		...
		ВызватьИсключение НСтр("ru = 'При создании документа не определен тип основания акта о расходжениях.';
								|en = 'A type of base documents for the discrepancy report is not specified when creating the document.'");
	...
	Иначе
		...
		ИначеЕсли Форма.Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПриемкаТоваровНаХранение
			  ...
			  Или Форма.Объект.ТипОснованияАктаОРасхождении =
			  						Перечисления.ТипыОснованияАктаОРасхождении.ПоступлениеОтДавальца
			  //-- НЕ УТКА
			Тогда
		...
		ИначеЕсли РасхожденияКлиентСервер.ТипОснованияОтгрузкаТоваровСХранения(Форма.Объект.ТипОснованияАктаОРасхождении)
			  //++ НЕ УТКА
			  Или Форма.Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПередачаДавальцу
			  Или Форма.Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ВозвратДавальцу
			  //-- НЕ УТКА
			Тогда
...
Процедура СформироватьНадписьСпособаОтраженияРасхождений(Форма, Товары, НадписьРасхождения, НадписьОформитьДокументы, ТипАкта, ТипОперации = "") Экспорт
	...
	Если КоличествоСтрокРасхождений > 0 Тогда
		...
		НСтр("ru = 'строке';
			|en = 'line'"), НСтр("ru = 'строках';
									|en = 'lines'"), НСтр("ru = 'строках';
														|en = 'lines'"), НСтр("ru = 'ж';
																				|en = 'f'"));

		ТекстРасхождений = НСтр("ru = 'Оформление расхождений в %КоличествоСтрокРасхождений% акта';
								|en = 'Registration of discrepancies in %КоличествоСтрокРасхождений% of the statement'");
	...
	Иначе
		...
		ТекстРасхождений = НСтр("ru = 'В акте отсутствуют строки с расхождениями, по которым требуется оформление документов';
								|en = 'There are no lines with discrepancies in the report for which document registration is required'");
...
Процедура ЗаполнитьДоговорПоУмолчанию(Объект, ХозяйственнаяОперацияДоговора) Экспорт
	...
	ИначеЕсли Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПередачаДавальцу
		  Или Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ВозвратДавальцу Тогда
		
		Объект.Договор = ЗакупкиСервер.ПолучитьДоговорПоУмолчанию(Объект, ХозяйственнаяОперацияДоговора);
...
Процедура УстановитьЗначенияКешируемыхРеквизитовФормыАкта(Форма) Экспорт
	...
	Если РасхожденияКлиентСервер.ТипОснованияПоступлениеТоваровОтХранителя(Объект.ТипОснованияАктаОРасхождении) Тогда
		...
		Обработчик = Документы.ПоступлениеТоваровОтХранителя.ОбработчикДействийПоТипуОснованияАкта(
						Объект.ТипОснованияАктаОРасхождении);
		
		Форма.ИспользоватьСоглашенияСКлиентами =
			Форма.ИспользоватьСоглашенияСКлиентами И Обработчик.СоглашенияСКлиентамиПрименимы();
		
		Форма.ИспользоватьСоглашенияСПоставщиками =
			Форма.ИспользоватьСоглашенияСПоставщиками И Обработчик.СоглашенияСПоставщикамиПрименимы();
		
	ИначеЕсли РасхожденияКлиентСервер.ТипОснованияПередачаТоваровХранителю(Объект.ТипОснованияАктаОРасхождении) Тогда
		
		Обработчик = Документы.ПередачаТоваровХранителю.ОбработчикДействийПоТипуОснованияАкта(
						Объект.ТипОснованияАктаОРасхождении);
	...
	//++ НЕ УТКА
	ИначеЕсли Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПоступлениеОтДавальца
		  Или Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПередачаДавальцу
		  Или Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ВозвратДавальцу Тогда
		
		Форма.ИспользоватьСоглашенияСКлиентами    = Ложь;
		Форма.ИспользоватьСоглашенияСПоставщиками = Ложь;
	...
	Иначе
		...
		Иначе
			...
			ИначеЕсли РасхожденияКлиентСервер.ТипОснованияВозвратПоставщику(Форма.Объект.ТипОснованияАктаОРасхождении)
				//++ НЕ УТ
				Или Форма.Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ВозвратТоваровОтПереработчика
				//-- НЕ УТ
			...
			ИначеЕсли Форма.Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПриобретениеТоваровУслуг
				...
				//++ НЕ УТ
				Или Форма.Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПоступлениеТоваровОтПереработчика
				//-- НЕ УТ
...
Процедура ИзменитьОснованиеАкта(АктОРасхождениях, Основание, ТаблицаИзменяемыхСтрок, ТаблицаИзменяемыхСерий)
	...
	Исключение
		...
		ТекстОшибки = НСтр("ru = 'Не удалось заблокировать для изменения %Элемент%. %ОписаниеОшибки%';
							|en = 'Cannot lock for changing %Элемент%. %ОписаниеОшибки%'");
	...
	Если ДокументОснование.Товары.Количество() = 0 Тогда
		ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'После изменения в документе %1 будут отсутствовать товары. Документ переоформлен не будет.';
				|en = 'After changing the document %1, there will be no goods available. The document will not be reregistered.'"), 
...
Процедура ДополнитьСтруктуруДействийПоТЧТоварыПриемкиТоваровНаХранение(СтруктураДействий, Объект)
	...
	//++ НЕ УТКА
	ХозяйственнаяОперация = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект, "ХозяйственнаяОперация");
...
Функция  ШапкаАктаИОснованиеСоответствуют(РезультатЗапросаПоШапке, АктОРасхождениях, Основание) 
	...
	Если ТипЗнч(АктОРасхождениях) = Тип("ДокументСсылка.АктОРасхожденияхПослеОтгрузки")
		...
		ИначеЕсли ТипЗнч(Основание) = Тип("ДокументСсылка.ОтгрузкаТоваровСХранения") Тогда
			...
			//++ НЕ УТКА
			   И ВыборкаАкт.ТипОснованияАктаОРасхождении <> Перечисления.ТипыОснованияАктаОРасхождении.ПередачаДавальцу
			   И ВыборкаАкт.ТипОснованияАктаОРасхождении <> Перечисления.ТипыОснованияАктаОРасхождении.ВозвратДавальцу
			//-- НЕ УТКА
			Тогда
				Возврат Ложь;
			КонецЕсли;
		...
		ИначеЕсли ТипЗнч(Основание) = Тип("ДокументСсылка.ПриемкаТоваровНаХранение") Тогда
			...
			//++ НЕ УТКА
			ТипыОснованияАктаПриемка.Добавить(Перечисления.ТипыОснованияАктаОРасхождении.ПоступлениеОтДавальца);
			//-- НЕ УТКА
...
Функция ТекстЗапросаПоШапкеАктаОРасхожденияхПослеПриемки(АктОРасхождениях)
	...
	//++ НЕ УТКА
	|			ИЛИ АктОРасхожденияхПослеПриемки.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПоступлениеОтДавальца2_5)
	//-- НЕ УТКА
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.ТипыНалогообложенияНДС.ПустаяСсылка)
...
Функция ТекстЗапросаПоШапкеАктаОРасхожденияхПослеОтгрузки(АктОРасхождениях)
	...
	//++ НЕ УТКА
	|			ИЛИ АктОРасхожденияхПослеОтгрузки.ХозяйственнаяОперация В (ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВозвратДавальцу2_5),
...
//++ НЕ УТКА
	...
	|			ИЛИ АктОРасхожденияхПослеПриемкиТовары.ЗаказПоставщику = ЗНАЧЕНИЕ(Документ.ЗаказДавальца2_5.ПустаяСсылка)
	|			ИЛИ АктОРасхожденияхПослеПриемкиТовары.ЗаказПоставщику = НЕОПРЕДЕЛЕНО
	|			ТОГДА НЕОПРЕДЕЛЕНО
//-- НЕ УТКА
	|		КОГДА АктОРасхожденияхПослеПриемкиТовары.ЗаказПоставщику = НЕОПРЕДЕЛЕНО
	|			ТОГДА ЗНАЧЕНИЕ(Документ.ЗаказПоставщику.ПустаяСсылка)
...
Процедура СообщитьОшибкиДобавленияИзлишкаВНакладную(Акт, СтрокиСОшибками, ИмяПоляЗаказ, ИменаПолейУникальности, Отказ)
	...
	Для Каждого Строка Из СтрокиСОшибками Цикл
		...
		|en = 'Item %НоменклатураХарактеристика%
		|Registered product quantity exceeds the quantity specified in reference for registration in line %НомерСтроки% by %Количество% %Единица%. Split the line to register surplus ""Exceeding the order""'");
