...
Процедура ПриОпределенииРегистрационныхДанныхОрганизации(Организация, Поля, Дата, РегистрационныеДанные, КодЯзыка) Экспорт
	...
	Если ЗначениеЗаполнено(Поля) Тогда
		МассивПоказателей = СтрРазделить(Поля, ",");	
	КонецЕсли;
	
	РегистрационныеДанные = РегламентированнаяОтчетностьУП.УстаревшаяПолучитьСведенияОбОрганизации(Организация, Дата, МассивПоказателей);
	//-- НЕ УТ
