...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	//++ НЕ УТ
	Если НастройкиФормы.ИмяФормы = "Справочник.ПартииПроизводства.Форма.ФормаСписка"
		или НастройкиФормы.ИмяФормы = "Справочник.ПартииПроизводства.Форма.ФормаЭлемента" Тогда
		Справочники.ПартииПроизводства.ПриОпределенииКомандПодключенныхКОбъекту(Команды);
	КонецЕсли;
	//-- НЕ УТ
