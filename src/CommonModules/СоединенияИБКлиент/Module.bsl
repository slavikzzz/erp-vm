...
Процедура ПоказатьПредупреждениеПриЗавершенииРаботы(ТекстСообщения, ВремяНачалаБлокировки)
	...
	Если Не ПараметрыИнформирования.ОповещениеПоказано Тогда
		ПоказатьОповещениеПользователя(НСтр("ru = 'Работа приложения будет завершена';
											|en = 'App will be closed'"),, ТекстСообщения,, 
...
Функция СобытиеЖурналаРегистрации() Экспорт
	...
	Возврат НСтр("ru = 'Завершение работы пользователей';
				|en = 'User sessions'", ОбщегоНазначенияКлиент.КодОсновногоЯзыка());
