...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Блокировка недействительных пользователей в системе взаимодействия.';
									|en = 'Lock invalid users in the collaboration system.'");
...
Функция ЗаблокироватьПользователяСистемыВзаимодействия(Пользователь) Экспорт
	...
	Попытка
		...
		ЗаписьЖурналаРегистрации(
			СобытиеЖурналаРегистрации(НСтр("ru = 'Блокировка недействительных пользователей';
											|en = 'Lock invalid users'", ОбщегоНазначения.КодОсновногоЯзыка())),
	...
	Если ОбъектыСОшибками > 0 Тогда
		...
		ОшибкаЖурналаРегистрации = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось заблокировать пользователей в системе взаимодействия: %1.
					...
					|en = 'Cannot lock users in the collaboration system: %1.
					|The collaboration system might be temporarily unavailable.
					|To lock users, click ""Lock invalid users in the collaboration system"" from the ""More actions"" submenu in the user list.'") + Символы.ПС,
			ОбъектыСОшибками);
