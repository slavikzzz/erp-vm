...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|ВЫБРАТЬ //// Списание задолженности покупателя (Дт <91.2> :: Кт <62.1>)
	...
	|	ЗНАЧЕНИЕ(ПланВидовХарактеристик.СтатьиРасходов.НачисленныйНДСПриВыкупеМногооборотнойТары) КАК СубконтоДт1,
