...
#КонецЕсли
	...
	ПодключитьРасширениеДляРаботыСФайлами(Оповещение, 
		НСтр("ru = 'Для создания временной папки необходимо установить расширение для работы с 1С:Предприятием.';
			|en = 'To create a temporary folder, install 1C:Enterprise Extension.'"), Ложь);
...
Процедура СоздатьВременныйКаталог(Знач Оповещение, Расширение = "") Экспорт 
	...
	Оповещение = Новый ОписаниеОповещения("СоздатьВременныйКаталогПослеПроверкиРасширенияРаботыСФайлами",
		ФайловаяСистемаСлужебныйКлиент, Контекст);
	ПодключитьРасширениеДляРаботыСФайлами(Оповещение, 
		НСтр("ru = 'Для создания временной папки установите расширение для работы с 1С:Предприятием.';
			|en = 'To create a temporary folder, install 1C:Enterprise extension.'"), Ложь);
...
Процедура ПолучитьПолноеИмяВременногоФайла(Знач Оповещение, Расширение = "")
	...
	Оповещение = Новый ОписаниеОповещения("ПолучитьИмяВременногоФайлаПослеПроверкиРасширенияРаботыСФайлами",
		ЭтотОбъект, Контекст);
	ПодключитьРасширениеДляРаботыСФайлами(Оповещение, 
		НСтр("ru = 'Для получения имени временного файла установите расширение для работы с 1С:Предприятием.';
			|en = 'To get a temporary file name, install 1C:Enterprise Extension.'"), Ложь);
