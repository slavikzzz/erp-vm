...
// Открывает форму формирования уведомления об использовании ПЭП и УНЭП
// 
// Параметры:
// 	Организация - ОпределяемыйТип.Организация
//  СписокПользователей - Массив из ОпределяемыйТип.Пользователь, ОпределяемыйТип.ФизическоеЛицо
...
Процедура ОткрытьФормуФормированияУведомленияОбИспользованииПЭП_УНЭП(Организация, СписокПользователей,
	...
	НастройкиВнутреннегоЭДОСлужебныйКлиент.ОткрытьФормуФормированияУведомленияОбИспользованииПЭП_УНЭП(Организация,
		СписокПользователей, ВладелецФормы);
	
КонецПроцедуры

// Открывает форму формирования положения об использовании ПЭП и УНЭП.
// 
// Параметры:
//  Организация - ОпределяемыйТип.Организация
//  ВладелецФормы - ФормаКлиентскогоПриложения  
