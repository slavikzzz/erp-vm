			...
			Иначе
				...
				Исключение
					Шаблон = НСтр("ru = 'Не удалось разобрать данные адреса: %1.';
									|en = 'Cannot parse the address data: %1.'");
...
Функция НоваяИнформацияОЗаменнойПозицииТРУ() Экспорт
	...
	Описание = НСтр("ru = 'GUID позиции ТРУ в составе принимаемого документа электронного актирования';
					|en = 'GUID of the item of goods, works, services in the electronic certification document to accept'");
	...
	Описание = НСтр("ru = 'GUID товара, работы, услуги из сведений о контракте';
					|en = 'GUID of goods, works, services from the contract information'");
...
Функция НовыеБанковскиеРеквизитыДляПриложения() Экспорт
	...
	Описание = НСтр("ru = 'Идентификатор платежных реквизитов поставщика из сведений о контракте.';
					|en = 'The vendor''s billing information ID from the contract information.'");
	...
	Описание = НСтр("ru = 'Лицевой счет для казначейского сопровождения.';
					|en = 'Personal account for treasury monitoring.'");
	...
	Описание = НСтр("ru = 'Наименование банка, ТОФК.';
					|en = 'Bank name, Federal treasury territorial authorities.'");
	...
	Описание = НСтр("ru = 'Наименование контрагента для платежного поручения.';
					|en = 'Counterparty name for payment order.'");
...
Функция НовоеЗначениеОКЕИ() Экспорт
	...
	Описание = НСтр("ru = 'Национальное условное обозначение (поле localSymbol в справочнике ОКЕИ (nsiOKEI)).';
					|en = 'National designation (field localSymbol in RNCMU catlog (nsiOKEI)).'");
...
Функция НовыеСведенияОСтроительствеДляПриложенияУПД() Экспорт
	...
	Описание = НСтр("ru = 'Сумма, не облагаемая налогом (по ставке Без НДС и 0%)';
					|en = 'Amount not subject to tax (at the rate VAT exclusive and 0%)'");
	...
	Описание =  НСтр("ru = 'Производить расчет НДС в итоговых строках';
					|en = 'Calculate VAT in total lines'");
	...
	Описание = НСтр("ru = 'Применяется накопительный итог';
					|en = 'Cumulative total is applied'");
	...
	Описание = НСтр("ru = 'Последний документ по контракту';
					|en = 'The last document under the contract'");
...
Функция НовыеСведенияОСтроительствеДляПриложенияУКД() Экспорт
	...
	Описание = Нстр(
		...
		|en = 'Final increase in the tax amount at rate 10%'");
	...
	Описание = Нстр(
		...
		|en = 'Final increase in the tax amount at rate 20%'");
	...
	Описание = Нстр("ru = 'Итоговое уменьшение суммы налога по ставке 10%';
					|en = 'Final decrease in the tax amount at rate 10%'");
	...
	Описание = Нстр("ru = 'Итоговое уменьшение суммы налога по ставке 20%';
					|en = 'Final decrease in the tax amount at rate 20%'");
...
Функция НовыеСведенияОбИнвестореСтроительства() Экспорт
	...
	Описание =  НСтр("ru = 'Наименования или ФИО инвестора';
					|en = 'Names or full name of the investor'");
	Поле = НовоеПолеСтруктуры("Наименование", "",
		Тип,
		Описание,
		Истина,
...
Функция НовыеСведенияОбОбжалованииОтказаОПриемке() Экспорт
	...
	Описание = Нстр(
		...
		|en = 'ID of the document that is a subject of the appeal'");
	...
	Описание = Нстр("ru = 'Игнорируется при приеме, заполняется при передаче реквизитами документа,';
					|en = 'Ignored when receiving, filled when transferring with details of the document'")
		+ " "
		+ Нстр("ru = 'являющегося предметом обжалования';
				|en = 'that is a subject of the appeal'");
	...
	Описание = Нстр(
		...
		|en = 'Kind of the document confirming an agreement between the parties/court decision'");
	...
	Описание = Нстр(
		...
		|en = 'Details of the document confirming an agreement between the parties/court decision'");
...
Функция НовыеДанныеПриложенияКТитулуЗаказчикаУПД() Экспорт
	...
	Описание = НСтр("ru = 'Идентификатор файла, к которому сформировано приложение';
					|en = 'ID of the file for which the attachment is created'"); 
	...
	Описание = НСтр("ru = 'Итого, фактически принято заказчиком';
					|en = 'Total, actually received by the customer'"); 
	...
	Описание = НСтр("ru = 'Информация о расхождениях / причинах отказа в приемке';
					|en = 'Information on discrepancies / reasons for refusal of receipt'");
	...
	Описание = НСтр("ru = 'Дата начала приемки товаров, дата в формате dd-mm-YYYY';
					|en = 'Goods receipt start date, date in the format: mm-dd-YYYY'");
	ТехническоеОписание = НСтр("ru = 'Устарело, оставлено для обратной совместимости.';
								|en = 'Obsolete, kept for backward compatibility.'");
...
// BSLLS:Typo-on
	...
	Описание = НСтр("ru = 'Хэш файла, к которому сформировано приложение';
					|en = 'Hash of the file for which the attachment is created'");
	...
	Описание = НСтр("ru = 'Корректировка информации заказчика';
					|en = 'Customer details adjustment'");
	ПризнакОбязательности = Ложь;
	...
	Описание = НСтр("ru = 'Сведения о принятии товаров, работ, услуг (ТРУ)';
					|en = 'Information on goods, works, services receipt'"); 
	...
	Описание = НСтр("ru = 'Информация о решении приемочной комиссии';
					|en = 'Inspection board decision information'"); 
...
Функция НовыеДанныеПриложенияКТитулуЗаказчикаУКД() Экспорт
	...
	Описание = НСтр("ru = 'Порядковый номер подписанта, согласившегося изменить стоимость';
					|en = 'Sequence number of the signer who agreed to change the cost'"); 
...
Функция НовыеДанныеПриложенияКТитулуПродавцаУПД() Экспорт
	...
	Результат.Вставить("Подписант", Новый Структура);
	...
	Описание = НСтр("ru = 'Реквизиты сформированного в ЕИС неструктурированного документа о приемке, подтверждающего передачу';
					|en = 'Details of the unstructured receipt document that is generated in the UIS and confirms the transfer'");
	...
	Для Каждого Приложение Из ПриложенныеФайлыДляЭлектронногоАктированияЕИС Цикл
		...
		Если ДопустимыеРасширения.Найти(Расширение) = Неопределено Тогда
			Шаблон = НСтр("ru = 'Недопустимое расширение файла вложения %1.';
							|en = 'Invalid extension of the %1 attachment.'");
...
Функция НовыеНедетализированныеСведенияОТРУ() Экспорт
	...
	Описание = НСтр("ru = 'Актирование по позиции завершено.';
					|en = 'Certification by item is completed.'");
	...
	Описание =
		НСтр("ru = 'Остаточная стоимость по позиции (разница между стоимостью из контракта и заактированной стоимостью)';
			|en = 'Net book value by item (difference between cost in the contract and certified cost)'");
...
Функция НовыеСведенияОТРУДляУКД() Экспорт
	...
	Описание = НСтр("ru = 'GUID ТРУ, идентифицирующий позицию в составе документа электронного актирования.';
					|en = 'GUID of goods, works, services that identifies an item in the electronic certification document.'");
...
Функция ИспользоватьЭлектронноеАктированиеВЕИС() Экспорт
	...
	Если НЕ ЕстьПравоИзмененияНастроекОбменаДляПоставщиков() Тогда
		Возврат Ложь;
	КонецЕсли;
...
Функция ДанныеОПолномочияхПодписантаЗаказчика(Подписант, ТипДокумента) Экспорт
	...
	Если ТипДокументаЕИС = Неопределено Тогда
		ОписаниеОшибки = НСтр("ru = 'Не определен тип документа ЕИС на основании строки %1.';
								|en = 'UIS document type is not identified by line %1.'");
...
Функция ДанныеГосударственногоКонтракта(СсылкаНаКонтракт, ВозвратитьКонтрактВВидеСтроки=Ложь) Экспорт
	...
	Если ПрисоединенныйФайл = Неопределено Тогда
		ОписаниеОшибки = НСтр("ru = 'В присоединенных файлах не найдены данные контракта.';
								|en = 'Contract data is not found in the attachments.'");
		ВызватьИсключение(ОписаниеОшибки);
	КонецЕсли;
...
Функция ОпределитьВидТРУДляУПД(ТипОбъектаЗакупки) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(ТипОбъектаЗакупки) Тогда
		ТекстОшибки = НСтр("ru = 'Не заполнен тип объекта закупки госконтракта.';
							|en = 'The state contract purchasing object type is not filled.'");
	...
	Если НЕ ЗначениеЗаполнено(ВидТРУ) Тогда
		Шаблон = НСтр("ru = 'Не удалось определить вид ТРУ для приложения ЕИС по типу объекта закупки %1.';
						|en = 'Cannot identify the goods/works/services kind for the UIS attachment by the %1 purchasing object.'");
...
Функция НовыеСведенияОМестеПоставкиТовара() Экспорт
	...
	// Идентификатор адреса по ГАР
	// ИдНом, Строка 36.
	Результат.Вставить("КодГАР");
	// Код страны из адреса
...
Функция НовыеСведенияТРУУПДЗаказчика(ДетализированныеСведения = Ложь) Экспорт
	...
	Если ДетализированныеСведения Тогда
		...
		Описание =	НСтр("ru = 'Сведения о детализированных позициях ТРУ';
							|en = 'Information on drilled down goods/works/services items'"); 
	...
	Иначе
		...
		Описание =	НСтр("ru = 'Сведения о позиции ТРУ';
							|en = 'Information on goods/works/services item'"); 
...
Функция НовыеСведенияИнформацииОРешенииПриемочнойКомиссииЗаказчика() Экспорт
	...
	Описание = НСтр("ru = 'Основание создания приемочной комиссии';
					|en = 'Reason for the inspection board creation'"); 
	...
	Описание = НСтр("ru = 'Код решения приемочной комиссии';
					|en = 'Inspection board decision code'"); 
	...
	Описание =	НСтр("ru = 'Сведения о члене приемочной комиссии';
						|en = 'Inspection board member information'"); 
...
Функция НовыеСведенияОЧленеПриемочнойКомиссииЗаказчика() Экспорт
	...
	Описание = НСтр("ru = 'Основание полномочий члена приемочной комиссии';
					|en = 'Source of the inspection board member authority'"); 
	...
	Описание = НСтр("ru = 'Информация о решении члена приемочной комиссии';
					|en = 'Information on the inspection board member decision'"); 
	...
	Описание = НСтр("ru = 'Код решения члена приемочной комиссии. 1 - нет замечаний, 2 - выявлены замечания.';
					|en = 'Code of the inspection board member decision. 1 - no comments, 2 - there are comments.'"); 
	...
	Описание = НСтр("ru = 'Решение члена приемочной комиссии';
					|en = 'Inspection board member decision'"); 
...
Функция НовыеСведенияОИныхУполномоченныхЛицахЗаказчика() Экспорт
	...
	ТехническоеОписание =
		НСтр("ru = 'Контролируется, что в УПД (титул покупателя) присутствует подписант с указанным номером';
			|en = 'It is controled that UTD (customer title) contains the signer with the specified number'");
	...
	Описание = НСтр("ru = 'Вид уполномоченного лица';
					|en = 'Authorized person kind'");
	ТехническоеОписание =
		НСтр("ru = 'Игнорируется при приеме, заполняется при передаче значением вида уполномоченного лица';
			|en = 'Ignored when receiving, filled when transferring with the authorized person kind value'");
...
Функция НовыеСведенияОПрочихНачисленияхЗаказчика() Экспорт
	...
	Описание = НСтр("ru = 'Информация о начисленной неустойке (штрафе, пени) и уменьшении суммы оплаты';
					|en = 'Information on accrued forfeit (fine, penalty) and payment amount reduction'");
	...
	Описание = НСтр("ru = 'Информация о налогах и взносах, уплачиваемых заказчиком за физическое лицо';
					|en = 'Information on taxes and contributions paid by the customer for the person'");
...
Функция НовыеСведенияОНачисленныхНеустойкахЗаказчика() Экспорт
	...
	Описание = НСтр("ru = 'Требование заказчика об уплате неустойки (штрафа, пени)';
					|en = 'Forfeit (fine, penalty) payment request from the customer'");
...
Функция НовыеСведенияОПрикрепленныхДокументахЗаказчика() Экспорт
	...
	Описание = НСтр("ru = 'Хэш файла в hex представлении';
					|en = 'File hash in hex presentation'"); 
	Поле = НовоеПолеСтруктуры("ХэшФайла", "",
		Тип,
		Описание,
		Ложь,
	...
	Описание =	НСтр("ru = 'Описание прикрепляемого документа';
						|en = 'Attached document description'"); 
	...
	Описание =	НСтр("ru = 'Дата/время прикрепления документа';
						|en = 'Document attachment date/time'"); 
	...
	Описание =	НСтр("ru = 'Ссылка для скачивания прикрепленного документа';
						|en = 'Link to download the attached document'"); 
	...
	Описание =	НСтр("ru = 'Ссылка на справочник видов документов';
						|en = 'Link to the document kind directory'"); 
...
Процедура ПроверитьОснованиеОтгрузкиТоваров_5_02(ДеревоДанных) Экспорт
	
	ПолныйПутьДоОснованияОтгрузкиПередачи = "СведенияОПередаче.Операция.ОснованиеОтгрузкиПередачи";
	ПолныйПутьДоДокументаОснования = ПолныйПутьДоОснованияОтгрузкиПередачи + ".ДокументыОснования.НомерСтроки.ДокументОснование";
	
	ДокументОснование = ДеревоДанных.Строки.Найти(
		ПолныйПутьДоДокументаОснования,
		"ПолныйПуть",
		Истина);
	...
	// ДокументНаименование, атрибут РеквНаимДок.
	РеквНаимДок = ДокументОснование.Строки.Найти("РеквНаимДок");
	РеквНаимДок.Значение = НСтр("ru = 'Контракт';
								|en = 'Контракт'");
	// ДокументНомер, атрибут РеквНомерДок.
	РеквНомерДок = ДокументОснование.Строки.Найти("РеквНомерДок");
	РеквНомерДок.Значение = ДанныеКонтракта.Номер;
	// ДокументДата, атрибут РеквДатаДок
	РеквДатаДок = ДокументОснование.Строки.Найти("РеквДатаДок");
	РеквДатаДок.Значение = ДанныеКонтракта.ДатаЗаключенияКонтракта;
	// ДокументДопСведения, атрибут РеквДопСведДок.
	РеквДопСведДок = ДокументОснование.Строки.Найти("РеквДопСведДок");
	РеквДопСведДок.Значение = ДополнительныеСведенияОснованияПоДаннымКонтракта(ДанныеКонтракта);
...
Процедура ПроверитьГрузополучателей_5_02(ДеревоДанных) Экспорт

	// Если ИНН и КПП покупателя и грузополучателя совпадают, то возникает ошибка РДИК_0507.
	// При дублировании грузополучатель удаляется, а его место поставки заменяется на покупателя.
	ТаблицаПокупателей = ДеревоДанных.Строки.Найти("СведенияОСчетеФактуре.СведенияОПокупателях", "ПолныйПуть", Истина);
	ВидУчастника = "СведенияОСчетеФактуре.СведенияОПокупателях.НомерСтроки.Покупатель";
	Покупатели = Новый Массив;
	Для каждого СтрокаПокупателя Из ТаблицаПокупателей.Строки Цикл
	...
	СтрокиКУдалению = Новый Массив;
	ИдентификаторыКЗамене = Новый Массив;
	ТаблицаГрузополучателей = ДеревоДанных.Строки.Найти("СведенияОСчетеФактуре.СведенияОГрузополучателях", "ПолныйПуть", Истина);
	ВидУчастника = "СведенияОСчетеФактуре.СведенияОГрузополучателях.НомерСтроки.Грузополучатель";
	Если ЗначениеЗаполнено(ТаблицаГрузополучателей.Значение) Тогда
		Для каждого СтрокаГрузополучателя Из ТаблицаГрузополучателей.Строки Цикл
...
Функция ПередФормированиемЭлектронногоДокумента(ДеревоДанных, ПространствоИмен) Экспорт
	...
	Если СтрНайти(ПространствоИмен, ПространствоИменУПД) > 0 Тогда
		Если ПространствоИмен = "ON_NSCHFDOPPR_1_997_01_05_03_01" Тогда
			ПроверитьГрузополучателей_5_02(ДеревоДанных);
			ПроверитьОснованиеОтгрузкиТоваров_5_02(ДеревоДанных);
		Иначе
...
Функция СформироватьДанныеПриложенияУПДЗаказчикаДляЕИС(
	...
	Если НЕ ПустаяСтрока(РезультатПроверки) Тогда
		ОписаниеОшибки = НСтр("ru = 'Ошибка проверки приложения к УПД покупателя для ЕИС:';
								|en = 'An error occurred when checking the attachment to UTD for UIS:'")
...
Функция СформироватьДанныеПриложенияУКДДляЕИС(
	...
	Если Таблица.Количество() = 0 Тогда
		Результат.ОписаниеОшибки = НСтр("ru = 'Не заполнены данные для электронного актирования.';
										|en = 'Electronic certification data is not filled.'");
		Возврат Результат;
	КонецЕсли;
	ДанныеКонтракта = Таблица[0];
	...
	Если НЕ ЗначениеЗаполнено(ДанныеПриложения.ДокументОснование) Тогда
		Результат.ОписаниеОшибки =
			НСтр("ru = 'Не указан документ основание при формировании приложения к УКД для ЕИС.';
				|en = 'Base document is not specified when generating the attachment to UAD for UIS.'");
		Возврат Результат;
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ДанныеПриложения.ИдентификаторИсходногоФайла) Тогда
		Результат.ОписаниеОшибки =
			НСтр("ru = 'Не найден идентификатор исходного эл.документа, возможно документ-основание не был отправлен в ЕИС.';
				|en = 'The source electronic document ID is not found, the base document might not have been sent to the UIS.'");
		Возврат Результат;
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ДанныеКонтракта.ИдентификаторЭтапаКонтракта) Тогда
		Результат.ОписаниеОшибки = НСтр("ru = 'Не заполнен идентификатор этапа контракта.';
										|en = 'Contract step ID is not filled.'");
		Возврат Результат;
	КонецЕсли;
	...
	Если НЕ ПустаяСтрока(РезультатПроверки) Тогда
		ОписаниеОшибки = НСтр("ru = 'Ошибка проверки приложения к УКД для ЕИС:';
								|en = 'An error occurred when checking the attachment to UAD for UIS:'")
			+ Символы.ПС + РезультатПроверки;
		Результат.ОписаниеОшибки = ОписаниеОшибки;
		Возврат Результат;
	КонецЕсли;
...
Функция СформироватьДанныеПриложенияУПДДляЕИС(
	...
	Если ДанныеГосконтракта.ЕстьЛекарственныеПрепараты
		...
		ТекстОшибки = НСтр("ru = 'Отправка в ЕИС актов по медицинской специализации не поддерживается.';
							|en = 'Cannot send the medical specialization certificates to UIS.'");
	...
	Если ДанныеГосконтракта.ПредметОтноситсяКРаботамПоСтроительству
		...
		ТекстОшибки = НСтр("ru = 'Отправка в ЕИС актов по строительной специализации не поддерживается.';
							|en = 'Cannot send construction specialization certificates to UIS.'");
		Результат.ОписаниеОшибки = ТекстОшибки;
		Возврат Результат;
	КонецЕсли;
	...
	ДанныеПриложения.Свойство("Подписант", Подписант);
	Если НЕ Подписант = Неопределено И Подписант.Свойство("ЛогинПрод") Тогда
		ТекстПриложения = ТекстПриложенияКТитулуПродавцаУПД_5_03(ДанныеПриложения);
	Иначе
...
Функция СформироватьДанныеПриложенияУКДЗаказчикаДляЕИС(
	...
	Если НЕ ПустаяСтрока(РезультатПроверки) Тогда
		ОписаниеОшибки = НСтр("ru = 'Ошибка проверки приложения к УКД покупателя для ЕИС:';
								|en = 'An error occurred when checking the attachment to the UAD customer for UIS:'")
			+ Символы.ПС + РезультатПроверки;
		Результат.ОписаниеОшибки = ОписаниеОшибки;
		Возврат Результат;
	КонецЕсли;
					...
					Если ДанныеПриложения.ОшибкиЗаполнения.Количество() > 0 Тогда
						Для Каждого ТекстОшибки Из ДанныеПриложения.ОшибкиЗаполнения Цикл
							ПредставлениеРеквизита = НСтр("ru = 'Электронное актирование в ЕИС';
															|en = 'Electronic certification in UIS'");
...
// При формировании данные отбора настройки отправки получения дополняет данными учетных записей ЕИС.
// 
// Параметры:
//  ДеревоНастроек - Соответствие из КлючИЗначение - Данные отбора настройки отправки получения:
...
//
Процедура ПриФормированииДанныхОтбораНастройкиОтправкиПолучения(ДеревоНастроек) Экспорт
	...
	Для Каждого Строка Из НастройкиПоставщиков Цикл
		Если НЕ ПустаяСтрока(Строка.ИдентификаторУчастникаДокументооборота)
			...
			И СтрДлина(Строка.ТокенАвторизации) = ДлинаИдентификатора Тогда
				...
				ЗначениеОтбора.Вставить("Наименование", СтрШаблон(НСтр("ru = 'ИД ЕИС: %1';
																		|en = 'Unified Information System ID: %1'"),
					Строка.ИдентификаторУчастникаДокументооборота));
				ЗначениеОтбора.Вставить("ИдентификаторЭДО", Строка.ИдентификаторУчастникаДокументооборота);
				ЗначениеОтбора.Вставить("Сертификаты", Новый Массив);
				ИдентификаторыЭДО = ДеревоНастроек.Получить(Строка.Организация);
				Если ИдентификаторыЭДО = Неопределено Тогда
					ИдентификаторыЭДО = Новый Массив;
				КонецЕсли;
				ИдентификаторыЭДО.Добавить(ЗначениеОтбора);
				ДеревоНастроек.Вставить(Строка.Организация, ИдентификаторыЭДО);
		КонецЕсли;
	КонецЦикла;
...
Функция СформироватьТранспортныйПакетДляЕИС(ТранспортныйКонтейнер, ДанныеОбъекта) Экспорт
	...
	Если ДвоичныеДанныеПриложения = Неопределено Тогда
		Результат.ОписаниеОшибки = НСтр("ru = 'Не найдено приложение для ЕИС.';
										|en = 'Attachment for UIS is not found.'");
		Возврат Результат;
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ТипДокумента) Тогда
		Шаблон = НСтр("ru = 'Не удалось определить тип приложения для ЕИС по типу документа %1.';
						|en = 'Cannot identify the UIS attachment type for the %1 document type.'");
	...
	Если НЕ ПустаяСтрока(РезультатПроверки) Тогда
		ОписаниеОшибки = НСтр("ru = 'Ошибка проверки транспортного пакета для ЕИС:';
								|en = 'An error occurred when checking the transport package for UIS:'")
			+ Символы.ПС + РезультатПроверки; 
		ВызватьИсключение(ОписаниеОшибки);
	КонецЕсли;
...
Функция СоздатьСообщениеПриложенияДляЕИС(ОписаниеСообщения, ЭлектронныйДокумент, НастройкиДокумента) Экспорт
	...
	Если ОписаниеСообщения.Данные.ДополнительныйДокумент.ДвоичныеДанные = Неопределено Тогда
		ОписаниеОшибки = НСтр("ru = 'Не заполнены данные приложения для личного кабинета ЕИС.';
								|en = 'Attachment data for the personal UIS account is not filled.'");
		ВызватьИсключение(ОписаниеОшибки);
	КонецЕсли;
	...
	Иначе
		Шаблон = НСтр("ru = 'Не удалось определить вид сообщения приложения для ЕИС для типа документа %1';
						|en = 'Cannot identify the UIS attachment message kind for the %1 document type'");
	...
	Если НЕ СообщениеОбъектПриложениеЕИС.ПроверитьЗаполнение() Тогда
		ОписаниеОшибки = НСтр("ru = 'Ошибка заполнения сообщения с приложением для ЕИС';
								|en = 'An error occurred when filling the message with the attachment for UIS'");
		ВызватьИсключение(ОписаниеОшибки);
	КонецЕсли;
...
Функция ИспользоватьЭлектронноеАктированиеЗаказчикаВЕИС() Экспорт
	...
	Если НЕ ЕстьПравоИзмененияНастроекОбменаДляЗаказчиков() Тогда
		Возврат Ложь;
	КонецЕсли;
...
Процедура ЗаполнитьСведенияОПодписантах(ДеревоДанных,
	...
	Если ПространствоИменСхемы = "ON_NSCHFDOPPOK_1_997_02_05_03_01"
		ИЛИ ПространствоИменСхемы = "ON_NSCHFDOPPR_1_997_01_05_03_01" Тогда
		
		Если ЭтоТитулПокупателя Тогда
			ПрефиксТипа = "{ON_NSCHFDOPPOK_1_997_02_05_03_01}.Файл.Документ";
		Иначе
			ПрефиксТипа = "{ON_NSCHFDOPPR_1_997_01_05_03_01}.Файл.Документ";
		КонецЕсли;
		
		НомерСтроки = 1;
		Для каждого ДанныеПодписанта Из Подписанты Цикл
			
			Если НЕ ЗначениеЗаполнено(ДанныеПодписанта.Фамилия)
				ИЛИ НЕ ЗначениеЗаполнено(ДанныеПодписанта.Имя) Тогда
			...
			ФИО = РаботаСФайламиБЭД.ПолучитьОбъектТипаCML(ПрефиксТипа + ".Подписант.ФИО", ПространствоИменСхемы);
			РаботаСФайламиБЭД.ЗаполнитьСвойствоXDTO(ФИО, "Фамилия", ДанныеПодписанта.Фамилия, , Ошибки);
			РаботаСФайламиБЭД.ЗаполнитьСвойствоXDTO(ФИО, "Имя", ДанныеПодписанта.Имя, , Ошибки);
			РаботаСФайламиБЭД.ЗаполнитьСвойствоXDTO(ФИО, "Отчество", ДанныеПодписанта.Отчество, , Ошибки);
			...
			РаботаСФайламиБЭД.ЗаполнитьСвойствоXDTO(Подписант, "ДопСведПодп", НомерСтроки, Истина, Ошибки);
			
			Если ЗначениеЗаполнено(ДанныеПодписанта.ТипПодписанта)
				И ДанныеПодписанта.ТипПодписанта = Перечисления.ТипыПодписантовЕИС.ИндивидуальныйПредприниматель Тогда
				
					ДанныеПодписанта.Должность = "Индивидуальный предприниматель";
				
			КонецЕсли;
			
			Если ЗначениеЗаполнено(ДанныеПодписанта.Должность) Тогда
				
				РаботаСФайламиБЭД.ЗаполнитьСвойствоXDTO(Подписант, "Должн", ДанныеПодписанта.Должность, Истина, Ошибки);
				
			Иначе
				
				ТекстСообщения =
					НСтр("ru = 'ЭлектронноеАктированиеЕИС.ПриФормированияДанныхФайлаЭД: Не указана должность подписанта в справочнике подписантов ЕИС.';
						|en = 'ЭлектронноеАктированиеЕИС.ПриФормированияДанныхФайлаЭД: Не указана должность подписанта в справочнике подписантов ЕИС.'");
				ОбщегоНазначенияБЭД.ДобавитьОшибку(Ошибки, ТекстСообщения);
				
				ОбщегоНазначенияБЭД.ЗаписатьВЖурналРегистрации(ТекстСообщения, "ЭлектронноеАктированиеЕИС");
...
Функция ПриФормированияДанныхФайлаЭД(
	...
	ВерсияФормата = ДокументDOM.ЭлементДокумента.Атрибуты.ПолучитьИменованныйЭлемент("ВерсФорм").Значение;
	ПространствоИменЕИС = ПространствоИменЕИСПоИмениФайла(ИмяФайла, ВерсияФормата);
	...
	Исключение
		...
		|%1';
		|en = 'An error occurred while reading data from the file:
		|%1'", КодОсновногоЯзыка);
		...
		ИмяСобытия = НСтр("ru = 'ЭлектронноеАктированиеЕИС.ПриФормированияДанныхФайлаЭД';
							|en = 'ЭлектронноеАктированиеЕИС.ПриФормированияДанныхФайлаЭД'",
			КодОсновногоЯзыка);
...
Процедура ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам) Экспорт
	...
	// Настройки для ГИС НР
	ЭлектронноеАктированиеЕИСГИСНР.ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам);
...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	// Настройки для ГИС НР
	ЭлектронноеАктированиеЕИСГИСНР.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Если ИмяСправочникаГосударственныеКонтракты() = ИмяСправочникаГосударственныеКонтрактыПоУмолчанию() Тогда
		...
		Обработчик.Комментарий = НСтр("ru = 'Электронное актирование в ЕИС. Обновление ставок НДС объектов закупки.';
										|en = 'Electronic certification in UIS. Update purchasing object VAT rates.'");
	КонецЕсли;
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(Контекст, Источники, ПодключенныеОбъекты, Команды) Экспорт
	...
	Команда.Представление = НСтр("ru = 'Изменение параметров электронного актирования ЕИС';
								|en = 'Change electronic UIS certification parameters'");
	...
	// Настройки для ГИС НР
	ЭлектронноеАктированиеЕИСГИСНР.ПриОпределенииКомандПодключенныхКОбъекту(
		Контекст,
		Источники,
		ПодключенныеОбъекты,
		Команды);
...
Процедура ПриЗаполненииРазрешенийНаДоступКВнешнимРесурсам(ЗапросыРазрешений) Экспорт
	...
	Описание = НСтр("ru = 'Сервис личных кабинетов единой информационной системы в сфере закупок';
					|en = 'Service of personal accounts of the unified information system in procurement'");
	...
	// Настройки для ГИС НР
	ЭлектронноеАктированиеЕИСГИСНР.ПриЗаполненииРазрешенийНаДоступКВнешнимРесурсам(ЗапросыРазрешений);
...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	// Настройки ограничений для ГИС НР
	ЭлектронноеАктированиеЕИСГИСНР.ПриЗаполненииСписковСОграничениемДоступа(Списки);
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	...
	// Настройки ограничений для ГИС НР
	ЭлектронноеАктированиеЕИСГИСНР.ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание);
...
Функция СведенияОКонтрактеПоставщика(Организация, НомерКонтракта) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(НомерКонтракта) Тогда
		Результат.ОписаниеОшибки = НСтр("ru = 'Не указан регистрационный номер контракта поставщика.';
										|en = 'Vendor contract registration number is not specified.'");
		Возврат Результат;
	КонецЕсли;
...
Функция СведенияОПоставщикеИЕгоПодписантах(Организация, Настройки = Неопределено) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(Настройки) Тогда
		...
		Если Настройки = Неопределено Тогда
			Шаблон = НСтр("ru = 'Не определены настройки обмена с ЕИС для организации %1.';
							|en = 'UIS exchange settings are not determined for the %1 company.'");
	...
	Если ПустаяСтрока(Настройки.РегистрационныйНомерЕРУЗ) Тогда
		Шаблон = НСтр("ru = 'Не указан регистрационный номер ЕРУЗ для организации %1.';
						|en = 'Registration number of the unified register of procurement participants is not specified for the %1 company.'");
		Результат.ОписаниеОшибки = СтрШаблон(Шаблон, Организация);
		Возврат Результат;
	КонецЕсли;
	...
	Исключение
		Шаблон = НСтр("ru = 'Ошибка при разборе ответа сервера ЕИС с данными подписантов:';
						|en = 'An error occurred when parsing the response of the Unified Information System server with signer data:'")
		...
		Шаблон = Шаблон + Символы.ПС + НСтр("ru = 'Текст ответа:';
											|en = 'Response text:'") + Символы.ПС + "%2";
...
Функция СписокОбъектовПоставщикаПоВнешнемуИДДокумента(Организация,
	...
	Если НЕ ЗначениеЗаполнено(ВнешнийИдентификатор) Тогда
		...
		Результат.ОписаниеОшибки = НСтр("ru = 'Не задан внешний идентификатор документа.';
										|en = 'External document ID is not set.'");
		Возврат Результат;
	КонецЕсли;
...
Функция СведенияОбОбъектеПоставщика(Организация,
	...
	Если НЕ ЗначениеЗаполнено(ВидДокумента) Тогда
		...
		Результат.ОписаниеОшибки = НСтр("ru = 'Не задан вид документа.';
										|en = 'Document kind not specified.'");
		Возврат Результат;
	КонецЕсли;
	...
	Если НЕ ПустаяСтрока(ДанныеОбъекта.ОписаниеОшибки) Тогда
		...
		ИмяСобытияДляЖурналаРегистрации = НСтр("ru = 'Электронный документооборот с ЕИС.Шлюз поставщика';
												|en = 'Electronic data interchange with UIS.Vendor gateway'",
			КодОсновногоЯзыка);
		ОписаниеОшибки = НСтр("ru = 'Ошибка при получении данных объекта.';
								|en = 'An error occurred when receiving the object data.'");
		ОписаниеОшибкиДляЖурнала = ОписаниеОшибки + Символы.ПС
			+ НСтр("ru = 'Запрос:';
					|en = 'Request:'") + Символы.ПС
			+ ТекстЗапроса + Символы.ПС
			+ НСтр("ru = 'Ответ сервера:';
					|en = 'Server response:'") + Символы.ПС
			+ Ответ;
...
Функция СведенияОбОбъектеЗаказчика(Организация,
	...
	Если Настройки = Неопределено Тогда
		Шаблон = НСтр("ru = 'Не определены настройки обмена с ЕИС для организации заказчика %1.';
						|en = 'UIS exchange settings are not determined for the %1 customer company.'");
		Результат.ОписаниеОшибки = СтрШаблон(Шаблон, Организация);
		Возврат Результат;
	КонецЕсли;
	...
	Если НЕ ПустаяСтрока(ДанныеОбъекта.ОписаниеОшибки) Тогда
		...
		ИмяСобытияДляЖурналаРегистрации = НСтр("ru = 'Электронный документооборот с ЕИС.Шлюз заказчика';
												|en = 'Electronic data interchange with UIS.Customer gateway'",
			КодОсновногоЯзыка);
		ОписаниеОшибки = НСтр("ru = 'Ошибка при получении данных объекта.';
								|en = 'An error occurred when receiving the object data.'");
		ОписаниеОшибкиДляЖурнала = ОписаниеОшибки + Символы.ПС
...
Функция РезультатОбработкиТранспортногоПакета(Организация,
		...
		ЭтоПакетЗаказчика = Ложь,
		ТранспортныйКонтейнер = Неопределено) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(ИдентификаторПакета) Тогда
		Результат.ОписаниеОшибки = НСтр("ru = 'Не задан идентификатор транспортного пакета ЕИС.';
										|en = 'UIS transport package ID is not set.'");
		Возврат Результат;
	КонецЕсли;
	...
	Если СтрДлина(ИдентификаторПакета) <> 36 Тогда
		Результат.ОписаниеОшибки = НСтр("ru = 'Длина идентификатора пакета ЕИС отличается от 36 символов.';
										|en = 'The UIS package ID length is different from 36 characters.'");
		Возврат Результат;
	КонецЕсли;
	...
	Если Настройки = Неопределено Тогда
		...
		Иначе
			Шаблон = НСтр("ru = 'Не определены настройки обмена с ЕИС для организации поставщика %1.';
							|en = 'UIS exchange settings are not determined for vendor company %1.'");
		КонецЕсли;
		Результат.ОписаниеОшибки = СтрШаблон(Шаблон, Организация);
		Возврат Результат;
	КонецЕсли;
	...
	Если НЕ ЕстьСвойство(Результат.РезультатОбработки.Body, "ФайлРезул") Тогда
		Результат.ОписаниеОшибки = НСтр("ru = 'Неверный формат ответа от сервера ЕИС.';
										|en = 'Incorrect UIS server response format.'");
		
		Если НЕ ЭтоПакетЗаказчика Тогда
			ТекДата = ТекущаяДатаСеанса();
			ЭлектронноеАктированиеЕИСГИСНР.ОтправитьЛогОДоставкеДокументаВЕИС(Организация,
				ТекДата,
				ИдентификаторПакета,
	...
	Если НЕ Результат.ДанныеОбрабатываются Тогда
		...
		Если РезультатРазбора.ОшибкаВЗапросе Тогда
			...
			ВариантСобытия = НСтр("ru = 'Ошибка в запросе к сервису ЕИС или ошибка сервера ЕИС';
									|en = 'An error in the UIS service request or a UIS server error'",
				ОбщегоНазначения.КодОсновногоЯзыка());
			Шаблон = НСтр("ru = 'Ошибка при получении статуса пакета %1 организации %2:';
							|en = 'An error occurred when receiving the %1 package status of the company %2:'");
			ОписаниеОшибки = СтрШаблон(Шаблон, ИдентификаторПакета, Организация) + Символы.ПС
				+ Результат.ОписаниеОшибки + Символы.ПС
				+ НСтр("ru = 'Запрос к серверу ЕИС:';
						|en = 'Request to the UIS server:'") + Символы.ПС
				+ ТекстЗапроса + Символы.ПС
				+ НСтр("ru = 'Ответ сервера ЕИС:';
						|en = 'UIS server response:'") + Символы.ПС
				+ Ответ;
...
// Параметры:
//  Свойство - Строка
//  Значение - Число, Строка, УникальныйИдентификатор, Null
//  ДополнительныеПараметрыФункцииПреобразования - Структура
//  Отказ - Булево
// 
// Возвращаемое значение:
//  Строка - Адаптация полей контактной информации
...
Функция ОтправитьКонтейнерЧерезСерверЕИС(ПараметрыОтправки, КонтекстОперации) Экспорт
	...
	Иначе
		...
		ТекДата = ТекущаяДатаСеанса();
		ЭлектронноеАктированиеЕИСГИСНР.ОтправитьЛогПоДокументуОПриемке(Организация,
			ТранспортныйКонтейнер,
			ТекДата,
			СодержимоеПакета,
			РезультатОтправки.Выполнено,
...
Функция СтавкаНДСОбъектаЗакупки(Знач ОбъектЗакупки) Экспорт
	...
	Если СтавкаНДС = Неопределено Тогда
		Шаблон = НСтр("ru = 'Неизвестная ставка НДС объекта закупки ""%1"".';
						|en = 'Unknown VAT rate of the ""%1"" purchasing object.'");
...
Функция ПроверитьВозможностьВыполненияОперации() Экспорт
	...
	Если НЕ Результат.Выполнено Тогда
		Результат.ОписаниеОшибки = НСтр("ru = 'Условия сопровождения не выполнены.';
										|en = 'Maintenance terms are not fulfilled.'");
		ШаблонОписаниеОшибки = НСтр("ru = '%1 Статус поддержки %2.';
									|en = '%1 Support status %2.'");
...
Функция СтартоваяДатаПолученияДокументовПоУмолчанию() Экспорт
	...
	Результат = ТекущаяДатаСеанса();
	Результат = ДобавитьМесяц(Результат, -3);
	Возврат НачалоДня(Результат);
...
// Возвращает ОбъектXDTO на основе двоичных данных xml файла.
// 
// Параметры:
//  ДвоичныеДанныеДокумента - ДвоичныеДанные
//  ПроверятьКодировку - Булево
// 
// Возвращаемое значение:
//  ОбъектXDTO
Функция ОбъектXDTOИзДвоичныхДанных(ДвоичныеДанныеДокумента, ПроверятьКодировку = Ложь) Экспорт
	...
	Если ПроверятьКодировку Тогда
		...
		ТекстДокумента = ПолучитьСтрокуИзДвоичныхДанных(ДвоичныеДанныеДокумента,
			 Кодировка);
...
Функция РазобратьФайлКонтракта(ПутьККонтрактуИлиДвоичныеДанныеИлиОбъектXDTO,
	...
	Если ТипЗнч(ДанныеКонтракта) = Тип("СписокXDTO") Тогда
		ОписаниеОшибки = НСтр("ru = 'В файле обнаружено несколько контрактов, будет загружен только первый контракт.';
								|en = 'Several contracts are found in the file. Only the first contract will be imported.'");
		ОбщегоНазначения.СообщитьПользователю(ОписаниеОшибки);
	...
	Результат.ДатаФормированияЗакупки= ЗначениеНеобязательногоСвойства(ДанныеКонтракта, "purchaseFromDate", "Дата");
...
Процедура НачатьПолучениеПодписантов(Форма) Экспорт 
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru = 'Получение списка подписантов с сервера ЕИС в сфере закупок.';
															|en = 'Receive a list of signers from the UIS server in procurement.'");
...
Процедура ПолучитьПодписантовОрганизации(Параметры, АдресХранилища) Экспорт
	...
	Исключение
		...
		ИмяСобытия = НСтр("ru = 'ЭлектронноеАктированиеЕИС.ПолучитьПодписантовОрганизации';
							|en = 'ЭлектронноеАктированиеЕИС.ПолучитьПодписантовОрганизации'",
			КодОсновногоЯзыка);
		ПодробноеПредставлениеОшибки = ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке);
		ЗаписьЖурналаРегистрации(ИмяСобытия,
			УровеньЖурналаРегистрации.Ошибка, , ,
...
Функция ВерсияФорматаТипаДокумента(ТипДокумента)
	...
	ВерсияФорматаУПДПродавца = "ON_NSCHFDOPPR_1_997_01_05_03_01";
	ВерсияФорматаУКДПродавца = "ON_NKORSCHFDOPPR_1_996_03_05_01";
	
	ВерсияФорматаУПДПокупателя = "ON_NSCHFDOPPOK_1_997_02_05_03_01";
...
Процедура ЗаполнитьДанныеУчетнойЗаписи(ДанныеУчетнойЗаписи, НастройкиОбменаЕИС)
	...
	ДанныеУчетнойЗаписи.НаименованиеУчетнойЗаписи = НСтр("ru = 'Электронное актирование ЕИС в сфере закупок';
														|en = 'Electronic UIS certification in procurement'");
...
Процедура ЗаполнитьБанковскиеРеквизитыПоставщика(
	...
	ДанныеКонтракта = ДанныеГосударственногоКонтракта(ДанныеПриложения.ГосударственныйКонтракт);
	СведенияОПоставщиках = ДанныеКонтракта.СведенияОПоставщиках;
	
	ИдентификаторПлатежныхРеквизитовИзКонтракта = "";
	Если СведенияОПоставщиках.Количество() > 0 Тогда
		Если НЕ СведенияОПоставщиках[0].РеквизитыСчетаПоставщика = Неопределено
			И СведенияОПоставщиках[0].РеквизитыСчетаПоставщика.Количество() > 0 Тогда
			
			БанковскиеРеквизитыПоставщика = СведенияОПоставщиках[0].РеквизитыСчетаПоставщика[0];
			ИдентификаторПлатежныхРеквизитовИзКонтракта = БанковскиеРеквизитыПоставщика.Идентификатор;
		КонецЕсли;
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ДанныеПриложения.БанковскиеРеквизиты)
		...
		КонецЕсли;
		ДанныеПриложения.БанковскиеРеквизиты.ИдентификаторПлатежныхРеквизитовИзКонтракта
			= ИдентификаторПлатежныхРеквизитовИзКонтракта;
		Возврат;
	КонецЕсли;
	...
	Иначе
		ТаблицаПродавцов = ДеревоДанных.Строки.Найти("СведенияОПродавце", "ПолныйПуть");
		Если ТаблицаПродавцов = Неопределено Тогда
			ТаблицаПродавцов = ДеревоДанных.Строки.Найти("СведенияОСчетеФактуре.СведенияОПродавцах", "ПолныйПуть", Истина);
			СтрокаДереваДанных = ТаблицаПродавцов.Строки[0];
			ВидУчастника = "СведенияОСчетеФактуре.СведенияОПродавцах.НомерСтроки.Продавец";
		Иначе
			СтрокаДереваДанных = ТаблицаПродавцов.Строки[0];
			ВидУчастника = "СведенияОПродавце.НомерСтроки";
		КонецЕсли;
	...
	Если ЗначениеЗаполнено(БанкРеквизитыВДереве) Тогда
		...
		БанковскиеРеквизиты.ИдентификаторПлатежныхРеквизитовИзКонтракта = ИдентификаторПлатежныхРеквизитовИзКонтракта;
...
// Имя узла данных закрытого контракта.
// 
// Возвращаемое значение:
//  Строка
...
//
// Возвращаемое значение:
//  ЗащищенноеСоединениеOpenSSL - Новое защищенное соединение
Функция НовоеЗащищенноеСоединение(СертификатКлиента = Неопределено, СертификатыУдостоверяющихЦентров = Неопределено)
	
	Возврат ОбщегоНазначенияКлиентСервер.НовоеЗащищенноеСоединение(СертификатКлиента, СертификатыУдостоверяющихЦентров);
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Электронный документооборот с ЕИС.Установление соединения с сервером интернета';
				|en = 'Electronic data interchange with UIS.Connect to the online server'",
				ОбщегоНазначения.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Ошибка, , ,
			ПодробноеПредставлениеОшибки);
...
Функция ОпределитьТипОбъектаЗакупкиПоСтрокеИзКонтракта(СтрокаТипа)
	...
	Если Результат = Неопределено Тогда
		Шаблон = НСтр("ru = 'Неизвестный тип объекта закупки - %1.';
						|en = 'Unknown purchasing object type - %1.'");
...
Функция НовыеДанныеКонтракта()
	...
	// Дата формирования закупки.
	// purchaseFromDate, Дата.
	Результат.Вставить("ДатаФормированияЗакупки");
...
Функция НовыеПлатежныеРеквизитыКонтракта()
	...
	Описание = НСтр("ru = 'Номер банковского (казначейского) счета';
					|en = 'Bank (treasury) account number'");
	...
	Описание = НСтр("ru = 'БИК банка, ТОФК';
					|en = 'Bank BIC, Federal treasury territorial authorities'");
	...
	Описание = НСтр("ru = 'Корреспондентский счет банка, единый казначейский счет';
					|en = 'Bank''s correspondent account, unified treasury account'");
...
Функция РазобратьСписокОбъектов(Данные)
	...
	ТаблицаОбъектов.Колонки.Добавить("Дата");
	...
	Для каждого ДанныеОбъекта Из ДанныеОбъектов Цикл
		...
		Если (Объект.ВидДокумента = ВидУПД
			...
			Шаблон = НСтр("ru = 'Не удалось определить статус документа по статусу ЕИС %1.';
							|en = 'Cannot identify the document status by UIS status %1.'");
		...
		Если НужнаСортировкаПоДате Тогда
			Строка = ТаблицаОбъектов.Добавить();
			Строка.Дата = Объект.ДатаДокумента;
	...
	Если НужнаСортировкаПоДате Тогда
		...
		Для Каждого Строка Из ТаблицаОбъектов Цикл
			Объекты.Добавить(Строка.Объект);
		КонецЦикла;
	КонецЕсли;
	...
	Для каждого ДанныеКонтракта Из ДанныеКонтрактов Цикл
		...
		Если НЕ РезультатСкачивания.Статус Тогда
			...
			ВариантСобытия = НСтр("ru = 'Загрузка данных контракта с сервера ЕИС';
									|en = 'Import contract data from the UIS server'");
...
Функция ПроверитьДоступностьСервераSOAP(АдресСервера, АдресРесурса)
	...
	Если СоединениеHTTP = Неопределено Тогда
		Шаблон = НСтр("ru = 'Не удалось установить соединение с сервером ЕИС %2:';
						|en = 'Cannot connect to UIS server %2:'") 
			+ Символы.ПС +"%1";
	...
	Исключение
		...
		Шаблон = НСтр("ru = 'Не удалось получить данные с сервера ЕИС %2:';
						|en = 'Cannot receive data from UIS server %2:'")
			+ Символы.ПС + "%1"; 
		ТекстОшибки = СтрШаблон(
			Шаблон,
	...
	Если НЕ РезультатАнализа.Выполнено Тогда
		Шаблон = НСтр("ru = 'Ошибка при подключении к серверу ЕИС %2, сервер вернул ошибку:';
						|en = 'The server returned an error when connecting to UIS server %2:'")
			+ Символы.ПС + "%1";
...
Функция ОтправитьЗапросСервисуЕИС(
	...
	Если ОбщегоНазначенияКлиентСервер.
		...
		Результат.ОписаниеОшибки = НСтр("ru = 'Не определены настройки серверов обмена с ЕИС';
										|en = 'UIS exchange server settings are not determined'");
		Возврат Результат;
	КонецЕсли;
	...
	Если СоединениеHTTP = Неопределено Тогда
		ТекстОшибки = НСтр("ru = 'Не удалось установить соединение с сервером:';
							|en = 'Cannot connect to the server:'") + Символы.ПС
			+ ОписаниеОшибкиУстановкиСоединения;
	...
	Если РегистрацияСобытия
		И ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(Настройки, "ОбменСГИСНРВключен", Ложь) = Истина Тогда
		HTTPЗапрос.Заголовки.Вставить("isGISNR", "true");
	КонецЕсли;
	...
	Если НЕ РезультатАнализа.Выполнено Тогда
		Шаблон = НСтр("ru = 'При выполнении запроса к ресурсу %1 сервера %2 сервер вернул ошибку:';
						|en = 'The server returned an error when executing the query to the %1 resource of the %2 server:'") + Символы.ПС
			+ "%3";
...
Функция ОшибкаСервисаЗагрузкиПакетов(ТекстОтвета)
	...
	Если Результат.ОшибкаВЗапросе Тогда
		...
		ВариантСобытия = НСтр("ru = 'Ошибка в запросе к сервису ЕИС или ошибка сервера';
								|en = 'An error in the UIS service request or a server error'",
			ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция АнализВыполненияHTTPЗапроса(Ответ, АдресРесурса, Операция = "", ТекстОтвета = "")
	...
	Если НЕ ПустаяСтрока(Операция)
		...
		Дополнение = НСтр("ru = '. Подробности см. в журнале регистрации.';
			...
			+ НСтр("ru = 'Повторите запрос позднее или обратитесь в службу поддержки ЕИС.';
					|en = 'Please try again later or contact the UIS technical support.'");
	...
	ВариантСобытия = НСтр("ru = 'Анализ выполнения запроса к серверу ЕИС';
							|en = 'Analyze UIS server request execution'",
		ОбщегоНазначения.КодОсновногоЯзыка());
	...
	Если НЕ ПустаяСтрока(Операция)
		...
		Если ДанныеОшибки.ТолькоПредупреждения Тогда
			ТекстПредупреждения = НСтр("ru = 'Предупреждение сервера ЕИС:';
										|en = 'UIS server warning:'") + Символы.ПС + ДанныеОшибки.ОписаниеОшибки;
...
Функция ЗагрузитьСтрокуXMLВДеревоЗначений(СтрокаXML,
	...
	Исключение
		ОписаниеОшибки = НСтр("ru = 'Ошибка разбора XML:';
								|en = 'XML parse error:'") + " " + ИнформацияОбОшибке().Описание + ".";
		Возврат Неопределено;
	КонецПопытки;
...
Функция ВладелецПрисоединенныхФайлов(Знач ОбъектыУчетаЭД)
	...
	Если НЕ ЗначениеЗаполнено(Владелец) Тогда
		ОписаниеОшибки = НСтр("ru = 'Не определен владелец присоединенных файлов документа.';
								|en = 'Document attachment owner is not determined.'");
		ВызватьИсключение(ОписаниеОшибки);
	КонецЕсли;
...
Функция ЗаписатьПолеВДерево(Знач Узел, Структура, Имя)
	...
	Если НЕ ЗначениеЗаполнено(Путь) Тогда
		Шаблон = НСтр("ru = 'Не заполнен путь записи поля %1.';
						|en = 'The %1 field record path is not filled.'");
	...
	Если Обязательный = Неопределено Тогда
		Шаблон = НСтр("ru = 'Не заполнен признак обязательности поля %1.';
						|en = 'The required %1 field flag is not filled.'");
		ТекстОшибки = СтрШаблон(Шаблон, Имя);
		ВызватьИсключение(ТекстОшибки);
	КонецЕсли;
...
Функция НовыеРеквизитыНеструктурированногоДокументаОПриемке()
	...
	Описание = НСтр("ru = 'Идентификатор неструктурированного документа о приемке, сформированного в ЕИС.';
					|en = 'ID of the unstructured receipt document generated in the UIS.'");
...
Процедура ПроверитьОбщиеДанныеПриложенияУПДиУКД(ДанныеПриложения, Ошибки)
	...
	Если НЕ ЗначениеЗаполнено(ДанныеПриложения.ИдентификаторФайла) Тогда
		ОписаниеОшибки = НСтр("ru = 'Не заполнен идентификатор файла электронного документа.';
								|en = 'Electronic document file ID is not filled.'");
	...
	Если НЕ ЗначениеЗаполнено(ДанныеПриложения.ИдентификаторПриложения) Тогда
		ОписаниеОшибки = НСтр("ru = 'Не заполнен идентификатор приложения для ЕИС.';
								|en = 'UIS attachment ID is not filled.'");
		Ошибки.Добавить(ОписаниеОшибки);
	КонецЕсли;
	...
	Если ДанныеПриложения.СведенияОТоварах.ТоварыРаботыУслуги.Количество() = 0 Тогда
		ОписаниеОшибки = НСтр("ru = 'Не заполнены сведения о товарах, работах, услугах в приложения для ЕИС.';
								|en = 'Goods, works, services information is not filled in the UIS attachment.'");
		Ошибки.Добавить(ОписаниеОшибки);
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ДанныеПриложения.ПорядковыйНомерРуководителяОрганизации) Тогда
		ОписаниеОшибки =
			НСтр("ru = 'Не заполнен порядковый номер руководителя организации в приложения к УПД для ЕИС.';
				|en = 'Company manager sequence number is not filled in the attachment to UTD for UIS.'");
		Ошибки.Добавить(ОписаниеОшибки);
	КонецЕсли;
	...
	Если ДанныеПриложения.МестаПоставки.Количество() = 0 Тогда
		ОписаниеОшибки =
			НСтр("ru = 'Не заполнены места поставки в приложения к УПД для ЕИС.';
				|en = 'Delivery locations are not filled in the attachment to UTD for UIS.'");
		Ошибки.Добавить(ОписаниеОшибки);
	КонецЕсли;
...
Функция ПроверитьДанныеПриложенияУКДДляЕИС(ДанныеПриложения)
	...
	Если НЕ ЗначениеЗаполнено(ДанныеПриложения.ИдентификаторИсходногоФайла) Тогда
		ОписаниеОшибки = НСтр("ru = 'Не заполнен идентификатор исходного документа в приложении для ЕИС.';
								|en = 'The source document ID in the attachment for UIS is not filled.'");
		Ошибки.Добавить(ОписаниеОшибки);
	КонецЕсли;
...
Процедура ДобавитьОбщиеСвойстваПозицииТРУ(Результат)
	...
	Описание = НСтр("ru = 'Выполнено с начала выполнения работ (без учета отчетного периода).';
					|en = 'Performed from the work execution start (excluding the accounting period).'");
	...
	Описание = НСтр("ru = 'Количество или объем работы по смете.';
					|en = 'Work quantity or volume by estimate.'");
	...
	Описание = НСтр("ru = 'Информация о заменной позиции ТРУ.';
					|en = 'Information on the replaced item of goods, works, services.'");
...
Функция НовыеСведенияОТоварахРаботахУслугахДляТитулаПродавцаУПД()
	...
	Описание = НСтр("ru = 'Сведения о товарах, работах, услугах (ТРУ) в соответствии со сметой контракта.';
					|en = 'Information on goods, works, services in accordance with contract estimate.'");
...
Функция НовыеСведенияОКорректировкеИнформацииЗаказчика()
	...
	Описание = " " + НСтр("ru = 'Номер документа корректировки титула заказчика';
							|en = 'Number of the customer title adjustment document'");
...
Процедура ДобавитьОбщиеПоляПриложенияКТитулуПродавца(Результат)
	...
	Поле = НовоеПолеСтруктуры("ПризнакИспользованияКППКрупнейшегоНалогоплательщика", Ложь,
		...
		НСтр("ru = 'Признак использования КПП крупнейшего налогоплательщика';
			|en = 'Indicates that the major taxpayer KPP is used'"),
		Ложь,
	...
	Описание = НСтр("ru = 'Банковские реквизиты казначейского сопровождения.';
					|en = 'Treasury monitoring bank details.'");
	Значение = Неопределено;
	...
	Описание = НСтр("ru = 'Код СВР поставщика';
					|en = 'Summary vendor registry code'");
	Значение = "";
	ПризнакОбязательности = Ложь;
	...
	Описание = НСтр("ru = 'Код СВР заказчика';
					|en = 'Summary customer registry code'");
	Значение = "";
	ПризнакОбязательности = Ложь;
	...
	Описание = НСтр("ru = 'Заказчик включен в список грузополучателей.';
					|en = 'The customer is included in the recipient list.'");
		...
		Если ТРУ.ЭтоЛекарственныйПрепарат Тогда
			...
			Если НЕ ЗначениеЗаполнено(СведенияОЛекарстве.СрокГодности) Тогда
				ОписаниеОшибки = НСтр("ru = 'Не указан срок годности лекарственного препарата.';
										|en = 'Medicine expiration date is required.'");
				ВызватьИсключение(ОписаниеОшибки);
			КонецЕсли;
...
Процедура ДобавитьДанныеОМестахПоставкиВПриложенияКТитулуПродавца(ДеревоДанных, ДанныеПриложения)
	...
	Если ДанныеПриложения.МестаПоставки.Количество() > 0 Тогда
		...
		Для каждого Место Из ДанныеПриложения.МестаПоставки Цикл
			...
			ГосударственныйКонтракт = ДанныеПриложения.ГосударственныйКонтракт;
			...
			Если ЗначениеЗаполнено(ДанныеГосударственногоКонтракта.ДатаФормированияЗакупки)
				И ДанныеГосударственногоКонтракта.ДатаФормированияЗакупки >= Дата(2025, 01, 01) Тогда
				
				УзелГАР = ДобавитьУзелXML(УзелМестоПоставки, "ПоГАР", Ложь);
				
				УзелКлассификатора = ДобавитьУзелXML(УзелГАР, "Страна", Ложь);
				ДобавитьУзелXML(УзелКлассификатора, "Код", Истина, Место.КодСтраны, , , , 0);
				
				УзелАдрГАР = ДобавитьУзелXML(УзелГАР, "АдрГАР", Ложь);
				ДобавитьУзелXML(УзелАдрГАР, "ИдНом", Истина, Место.КодГАР, Ложь);
...
Функция ТекстПриложенияКТитулуПродавцаУПД(ДанныеПриложения)
	...
	Если НЕ ЗначениеЗаполнено(ДанныеПриложения.ИдентификаторПриложения) Тогда
		ТекстОшибки = НСтр("ru = 'Не заполнено значение идентификатора приложения.';
							|en = 'The attachment ID value is not filled.'");
		ВызватьИсключение(ТекстОшибки);
	КонецЕсли;
	
	Если НЕ ЗначениеЗаполнено(ДанныеПриложения.ИдентификаторФайла) Тогда
		ТекстОшибки = НСтр("ru = 'Не заполнено значение идентификатора файла.';
							|en = 'The file ID value is required.'");
		ВызватьИсключение(ТекстОшибки);
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(СведенияОКонтракте.РеестровыйНомерКонтракта) Тогда
		ТекстОшибки = НСтр("ru = 'Не заполнено значение реестрового номера контракта.';
							|en = 'The contract registry number value is required.'");
		ВызватьИсключение(ТекстОшибки);
	КонецЕсли;
...
Функция ТекстПриложенияКТитулуПродавцаУПД_5_03(ДанныеПриложения)
	
	Если НЕ ЗначениеЗаполнено(ДанныеПриложения.ИдентификаторПриложения) Тогда
		ТекстОшибки = НСтр("ru = 'Не заполнено значение идентификатора приложения.';
							|en = 'Не заполнено значение идентификатора приложения.'");
		ВызватьИсключение(ТекстОшибки);
	КонецЕсли;
	
	Если НЕ ЗначениеЗаполнено(ДанныеПриложения.ИдентификаторФайла) Тогда
		ТекстОшибки = НСтр("ru = 'Не заполнено значение идентификатора файла.';
							|en = 'Не заполнено значение идентификатора файла.'");
		ВызватьИсключение(ТекстОшибки);
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(СведенияОКонтракте.РеестровыйНомерКонтракта) Тогда
		ТекстОшибки = НСтр("ru = 'Не заполнено значение реестрового номера контракта.';
							|en = 'Не заполнено значение реестрового номера контракта.'");
		ВызватьИсключение(ТекстОшибки);
	КонецЕсли;
	...
	// Подписант.
	ДобавитьДанныеОПодписантеВПриложенияКТитулуПродавца(ДеревоДанных, ДанныеПриложения);
...
Процедура ДобавитьДанныеОПодписантеВПриложенияКТитулуПродавца(ДеревоДанных, ДанныеПриложения)
	
	Если ДанныеПриложения.Подписант.Свойство("ЛогинПрод") Тогда
		
		Подписант = ДанныеПриложения.Подписант;
		
		УзелПодписанта = ДобавитьУзелXML(ДеревоДанных, "Подписант", Ложь);
		
		ДобавитьУзелXML(УзелПодписанта, "ЛогинПрод", Истина, Подписант.ЛогинПрод);
		ДобавитьУзелXML(УзелПодписанта, "ПорядНом", Истина, Подписант.ПорядНом);
...
Функция ТекстПриложенияКТитулуПродавцаУКД(ДанныеПриложения)
	...
	Если НЕ ЗначениеЗаполнено(СведенияОКонтракте.ИдентификаторВерсииКонтракта) Тогда
		ТекстОшибки = НСтр("ru = 'Не заполнено значение идентификатора версии контракта.';
							|en = 'The contract version ID value is required.'");
		ВызватьИсключение(ТекстОшибки);
	КонецЕсли;
...
Функция НовыеДетализированныеСведенияТРУУПДЗаказчика()
	...
	Описание =	НСтр("ru = 'Сведения о родительском товаре, работе, услуги (ТРУ), на основании которого детализированы ТРУ';
						|en = 'Information on the parent goods, work, service based on which goods, works, services are drilled down'"); 
	...
	Описание = НСтр("ru = 'Технический идентификатор позиции ТРУ';
					|en = 'Technical ID of the goods/works/services item'"); 
	...
	Описание =	НСтр("ru = 'Внешний технический идентификатор позиции ТРУ';
						|en = 'External technical ID of the goods/works/services item'"); 
	...
	Описание =	НСтр("ru = 'Количество ТРУ, фактически принятое заказчиком';
						|en = 'Quantity of goods/works/services actually received by the customer'");
	...
	Описание =	НСтр("ru = 'Объем работы, услуги, фактически принятый заказчиком, в текстовом выражении';
						|en = 'Scope of work, service actually received by the customer, as text'"); 
	...
	Описание =	НСтр("ru = 'Стоимость с налогом, всего, фактически принято заказчиком';
						|en = 'Cost tax inclusive, total, actually received by the customer'"); 
	...
	Описание = НСтр("ru = 'Сведения о детализированном товаре, работе, услуге';
					|en = 'Information on the drilled down goods, work, service'");
...
Функция НовыеНедетализированныеСведенияТРУУПДЗаказчика()
	...
	Описание = НСтр("ru = 'GUID ТРУ, для которого заказчик указывает информацию о принятом количестве товара';
					|en = 'GUID of goods/works/services for which the customer specifies information about the received quantity of goods'"); 
	...
	Тип = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(17, 2));
	Описание = НСтр("ru = 'Технический идентификатор позиции ТРУ,';
					|en = 'Technical ID of the item of goods, works, services'")
		+ " " + НСтр("ru = 'для которого заказчик указывает информацию о принятом количестве товара';
					|en = 'for which the customer specifies information on the received quantity of goods'");
	Поле = НовоеПолеСтруктуры("ТехническийИдентификаторПозицииТРУ", 0,
		Тип,
		Описание,
		Ложь,
	...
	Тип = Новый ОписаниеТипов("Строка"); 
	Описание = НСтр("ru = 'Внешний технический идентификатор позиции ТРУ,';
					|en = 'External technical ID of the item of goods, works, services'")
		+ " " + НСтр("ru = 'для которого заказчик указывает информацию о принятом количестве товара';
					|en = 'for which the customer specifies information on the received quantity of goods'");
	Поле = НовоеПолеСтруктуры("ВнешнийТехническийИдентификаторПозицииТРУ", "",
		Тип,
	...
	Описание = НСтр("ru = 'Идентификатор позиции ТРУ позицию в составе принимаемого документа электронного актирования.';
					|en = 'ID of the item of goods, works, services in the electronic certification document to accept.'");
	Поле = НовоеПолеСтруктуры("ИдентификаторПозиции", "",
		Тип,
		Описание,
		Ложь,
	...
	Описание = НСтр("ru = 'Признак принятия ТРУ';
					|en = 'Goods/works/services receipt flag'"); 
	...
	Описание = НСтр("ru = 'Количество в потребительских единицах измерения, фактически принятое заказчиком';
					|en = 'Quantity in consumer units actually received by the customer'");
	...
	Описание = НСтр("ru = 'Идентификатор лекарственного препарата, для которого заказчик указывает информацию о принятом количестве товара';
					|en = 'ID of the medicine for which the customer specifies information about the received quantity of goods'");
	...
	Описание = НСтр("ru = 'Поля ТРУ, относящиеся к отраслевой специализации';
					|en = 'Goods/works/services fields related to industry specialization'");
...
Процедура ПроверитьИННКПП(ИНН, КПП)
	...
	Если СтрДлина(СокрЛП(ИНН)) > МаксимальнаяДлинаИНН Тогда
		ВызватьИсключение(НСтр("ru = 'Длина ИНН превышает 10 символов.';
								|en = 'The TIN length exceeds 10 characters.'"));
	КонецЕсли;
	...
	Если НЕ СтроковыеФункцииКлиентСервер.ТолькоЦифрыВСтроке(ИНН) Тогда
		ВызватьИсключение(НСтр("ru = 'В ИНН содержатся недопустимые символы.';
								|en = 'The TIN contains invalid characters.'"));
	КонецЕсли;
	...
	Если СтрДлина(СокрЛП(КПП)) > МаксимальнаяДлинаКПП Тогда
		ВызватьИсключение(НСтр("ru = 'Длина КПП превышает 9 символов.';
								|en = 'The KPP length exceeds 9 characters.'"));
	КонецЕсли;
	...
	Если НЕ СтроковыеФункцииКлиентСервер.ТолькоЦифрыВСтроке(КПП) Тогда
		ВызватьИсключение(НСтр("ru = 'В КПП содержатся недопустимые символы.';
								|en = 'The KPP contains invalid characters.'"));
	КонецЕсли;
...
Процедура ПроверитьКодСПЗ(КодСПЗ)
	...
	Если ДлинаКода <> МаксимальнаяДлинаСПЗ Тогда
		Шаблон = НСтр("ru = 'Длина кода СПЗ не равна 11 символам. Передан код СПЗ %1.';
						|en = 'The summary customer list code is not 11 characters long. Summary customer list code %1 is passed.'");
	...
	Если НЕ СтроковыеФункцииКлиентСервер.ТолькоЦифрыВСтроке(КодСПЗ) Тогда
		Шаблон = НСтр("ru = 'В коде СПЗ содержатся недопустимые символы. Передан код СПЗ %1.';
						|en = 'The summary customer list code contains invalid characters. Summary customer list code %1 is passed.'");
		ОписаниеОшибки = СтрШаблон(Шаблон, КодСПЗ);
		ВызватьИсключение(ОписаниеОшибки);
	КонецЕсли;
		...
		ИЛИ НЕ ЗначениеЗаполнено(КодПоСПЗ) Тогда
			Если НЕ ЗначениеЗаполнено(ДанныеОрганизации.КодПоСводномуРеестру) Тогда
				ВызватьИсключение(НСтр("ru = 'Не заполнен код организации по сводному реестру.';
										|en = 'Summary list company code is not filled.'"));
			КонецЕсли;
			Шаблон =
...
Функция ВерсияПриложения()
	...
	Если НЕ ЗначениеЗаполнено(Версия) Тогда
		ОписаниеОшибки = НСтр("ru = 'Не указана версия приложения для электронного актирования в ЕИС.';
								|en = 'The attachment version for electronic UIS certification is not filled.'");
		ВызватьИсключение(ОписаниеОшибки);
	КонецЕсли;
	Возврат Версия;
...
Функция ТекстЗапросаПолученияСпискаКонтрактовПоставщика(ПараметрыЗапроса)
	...
	Если НЕ ЗначениеЗаполнено(РегистрационныйНомерЕРУЗ) Тогда
		ВызватьИсключение(НСтр("ru = 'Не заполнен регистрационный номер поставщика в ЕРУЗ.';
								|en = 'The vendor registration number in the unified register of procurement participants is not filled.'"));
	КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ДатаНачала)
			ИЛИ НЕ ЗначениеЗаполнено(ДатаОкончания) Тогда
				ВызватьИсключение(НСтр("ru = 'Не заполнены даты, задающие интервал поиска контрактов.';
										|en = 'The contract search period dates are not filled.'"));
		КонецЕсли;
...
Функция ТекстЗапросаОтправкиТранспортногоПакета(ДанныеДляОтправки)
	...
	Если НЕ ЗначениеЗаполнено(ДанныеДляОтправки.ИдентификаторПакета) Тогда
		ВызватьИсключение(НСтр("ru = 'Не задан идентификатор транспортного пакета.';
								|en = 'Transport package ID is not set.'"));
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ДанныеДляОтправки.ДатаФормирования) Тогда
		ВызватьИсключение(НСтр("ru = 'Не указана дата формирования транспортного пакета.';
								|en = 'Transport package generation date is required.'"));
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ДанныеДляОтправки.ТипПриложенногоДокумента) Тогда
		ВызватьИсключение(НСтр("ru = 'Не указан тип приложенного документа.';
								|en = 'Attachment type is required.'"));
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ДанныеДляОтправки.ИдентификаторОтправителя) Тогда
		ВызватьИсключение(НСтр("ru = 'Не указан идентификатор отправителя документа.';
								|en = 'The document sender ID is required.'"));
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ДанныеДляОтправки.ИдентификаторПолучателя) Тогда
		ВызватьИсключение(НСтр("ru = 'Не указан идентификатор получателя документа.';
								|en = 'The document recipient ID is required.'"));
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ДанныеДляОтправки.ИдентификаторФайла) Тогда
		ВызватьИсключение(НСтр("ru = 'Не указан идентификатор файла, к которому сформировано приложение.';
								|en = 'ID of the file the attachment is generated for is required.'"));
	КонецЕсли;
	...
	Для каждого Вложение Из ДанныеДляОтправки.Вложения Цикл
		Если НЕ ЗначениеЗаполнено(Вложение.ИмяФайла) Тогда
			ТекстОшибки = НСтр("ru = 'Не указано имя файла вложения.';
								|en = 'The attachment file name is required.'");
			ВызватьИсключение(ТекстОшибки);
		КонецЕсли;
...
Функция ОтправитьТранспортныйПакет(Организация, ДанныеДляОтправкиИлиСтрока, Настройки, КлючСервера,
	...
	Исключение
		ИнформацияОбОшибке = ИнформацияОбОшибке();
		ВариантСобытия = НСтр("ru = 'Отправка контейнера';
								|en = 'Send container'", ОбщегоНазначения.КодОсновногоЯзыка());
		ПодробноеПредставлениеОшибки = ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке);
...
Функция ОтправитьТранспортныйПакетПоставщика(Организация, ДанныеДляОтправкиИлиСтрока)
	...
	Результат = ОтправитьТранспортныйПакет(Организация,
		ДанныеДляОтправкиИлиСтрока, Настройки, КлючСервераЗагрузкиДляПоставщика(), Истина);
...
Функция ПространствоИменВерсииСхем()
	...
	Если НЕ ЗначениеЗаполнено(Пространство) Тогда
		Шаблон = НСтр("ru = 'Не удалось определить пространство имен версии схем %1 для актирования в ЕИС.';
						|en = 'Cannot determine the namespace of scheme version %1 for UIS certification.'");
...
Функция ДополнительныеСведенияОснованияПоДаннымКонтракта(ДанныеКонтракта)
	...
	Возврат НСтр("ru = 'Реестровый номер в реестре контрактов:';
				|en = 'Registry number in the contract registry:'")
		+ " " + ДанныеКонтракта.Код;
...
Функция ПространствоИменЕИСПоИмениФайла(Знач ИмяФайла, ВерсияФормата = Неопределено)
	
	СтруктураИмен = Новый Структура;
	СтруктураИмен.Вставить("ON_AKTREZRABP", "ON_AKTREZRABP_1_971_01_01_00_02_EIS");
	
	Если ВерсияФормата = "5.01" ИЛИ ВерсияФормата = Неопределено Тогда
		СтруктураИмен.Вставить("ON_NSCHFDOPPR", "ON_NSCHFDOPPR_1_997_01_05_01_04_EIS");
	Иначе
		СтруктураИмен.Вставить("ON_NSCHFDOPPR", "ON_NSCHFDOPPR_1_997_01_05_03_01_EIS");
	КонецЕсли;
...
Функция ЕстьПравоИзмененияНастроекОбменаДляЗаказчиков()
	
	Возврат ПравоДоступа("Изменение", Метаданные.РегистрыСведений.НастройкиОбменаЕИСДляЗаказчиков);
	
КонецФункции

Функция ЕстьПравоИзмененияНастроекОбменаДляПоставщиков()
	
	Возврат ПравоДоступа("Изменение", Метаданные.РегистрыСведений.НастройкиОбменаЕИС);
...
//
Функция ОпределитьКодировку(Знач ДвоичныеДанныеИлиАдрес)
	...
	Если ИндексXML > 0 И ИндексXML < 15 Тогда // xml declaration должно быть в самом начале файла
		...
		Иначе
			Открывающая = СтрНайти(XMLpfx, "22", , Индекс); // символ "
			Закрывающая = СтрНайти(XMLpfx, "22", , Открывающая + 2); // символ "
	...
	Пока СтрДлина(Стр) > 2 Цикл
		...
		Иначе
			Если НЕ ((Код16 = "D0" И (ДесСлед>=144 И ДесСлед <=191))
					ИЛИ (Код16 = "D1" И (ДесСлед >= 128 И ДесСлед <=143))) Тогда 
				...
				КонецЕсли;
				Если (Дес<32 И Дес <> 10 И Дес <> 13) Тогда // Контрольные символы
	...
	Если (ПроцентСлужебных > 15
		И ПроцентСлужебных > Процент8
		И ПроцентСлужебных > Процент16
		И ПроцентСлужебных > ПроцентAnsi
		И ПроцентСлужебных > ПроцентOem) Тогда
