...
Процедура ДобавитьГруппуОператоровЛогическиеОператорыИКонстанты(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "И", НСтр("ru = 'И';
												|en = 'AND'"), Тип);
	ДобавитьОператорВГруппу(Группа, "Или", НСтр("ru = 'Или';
												|en = 'OR'"), Тип);
	ДобавитьОператорВГруппу(Группа, "Не", НСтр("ru = 'Не';
												|en = 'NOT'"), Тип);
	ДобавитьОператорВГруппу(Группа, "Истина", НСтр("ru = 'Истина';
													|en = 'True'"), Тип);
	ДобавитьОператорВГруппу(Группа, "Ложь", НСтр("ru = 'Ложь';
												|en = 'False'"), Тип);
...
Процедура ДобавитьГруппуОператоровЧисловыеФункции(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "Макс", НСтр("ru = 'Максимум';
												|en = 'Max'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "Мин", НСтр("ru = 'Минимум';
												|en = 'Min'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "Окр", НСтр("ru = 'Округлить';
												|en = 'Round off'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "Цел", НСтр("ru = 'Целая часть';
												|en = 'Integral part'"), Тип, Истина);
...
Процедура ДобавитьГруппуОператоровСтроковыеФункции(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "Строка", НСтр("ru = 'Преобразовать в строку';
													|en = 'Convert into a string'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "ВРег", НСтр("ru = 'Все прописные';
												|en = 'Uppercase'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "НРег", НСтр("ru = 'Все строчные';
												|en = 'Lowercase'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "ТРег", НСтр("ru = 'Каждое слово с прописной';
												|en = 'Each word is uppercase'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "Лев", НСтр("ru = 'Символы слева';
												|en = 'Left characters'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "Прав", НСтр("ru = 'Символы справа';
												|en = 'Right characters'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "СокрЛ", НСтр("ru = 'Убрать пробелы слева';
													|en = 'Remove spaces on the left'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "СокрЛП", НСтр("ru = 'Убрать пробелы слева и справа';
													|en = 'Remove spaces on the left and right'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "СокрП", НСтр("ru = 'Убрать пробелы справа';
													|en = 'Remove spaces on the right'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "СтрЗаменить", НСтр("ru = 'Заменить символы в строке';
														|en = 'Replace characters in the string'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "СтрДлина", НСтр("ru = 'Длина строки';
													|en = 'String length'"), Новый ОписаниеТипов("Число"), Истина);
...
Процедура ДобавитьГруппуОператоровПрочиеФункции(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "?", НСтр("ru = 'Условие';
												|en = 'Condition'"), Новый ОписаниеТипов("Булево"), Истина);
	ДобавитьОператорВГруппу(Группа, "ЗначениеЗаполнено", НСтр("ru = 'Значение заполнено';
																|en = 'Value filled'"), Новый ОписаниеТипов("Булево"), Истина);
	ДобавитьОператорВГруппу(Группа, "Формат", НСтр("ru = 'Формат';
													|en = 'Format'"), Новый ОписаниеТипов("Строка"), Истина);
...
Процедура ДобавитьГруппуОператоровОперацииНадСтроками(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "ПОДОБНО", НСтр("ru = 'ПОДОБНО';
													|en = 'LIKE'"), Тип);
...
Процедура ДобавитьГруппуОператоровРаботаСДатами(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "ГОД", НСтр("ru = 'ГОД';
												|en = 'YEAR'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "МЕСЯЦ", НСтр("ru = 'МЕСЯЦ';
													|en = 'MONTH'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "ЧИСЛО", НСтр("ru = 'ЧИСЛО';
													|en = 'NUMBER'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "ДЕНЬГОДА", НСтр("ru = 'День года';
													|en = 'Day of the year'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "ДЕНЬ", НСтр("ru = 'ДЕНЬ';
												|en = 'DAY'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "НЕДЕЛЯ", НСтр("ru = 'НЕДЕЛЯ';
													|en = 'WEEK'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "ДЕНЬНЕДЕЛИ", НСтр("ru = 'День недели';
														|en = 'Week day'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "ЧАС", НСтр("ru = 'ЧАС';
												|en = 'HOUR'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "МИНУТА", НСтр("ru = 'МИНУТА';
													|en = 'MINUTE'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "СЕКУНДА", НСтр("ru = 'СЕКУНДА';
													|en = 'SECOND'"), Тип, Истина);

	ДобавитьОператорВГруппу(Группа, "НАЧАЛОПЕРИОДА", НСтр("ru = 'Начало периода';
															|en = 'Period start'"), Новый ОписаниеТипов, Истина);
	ДобавитьОператорВГруппу(Группа, "КОНЕЦПЕРИОДА", НСтр("ru = 'Конец периода';
														|en = 'Period end'"), Новый ОписаниеТипов, Истина);
	ДобавитьОператорВГруппу(Группа, "ДОБАВИТЬКДАТЕ", НСтр("ru = 'Добавить к дате';
															|en = 'Add to the date'"), Новый ОписаниеТипов, Истина);
	
	ДобавитьОператорВГруппу(Группа, "РАЗНОСТЬДАТ", НСтр("ru = 'Разность дат';
														|en = 'Difference between dates'"), Тип, Истина);
	
	ДобавитьОператорВГруппу(Группа, "ТЕКУЩАЯДАТА", НСтр("ru = 'Текущая дата';
														|en = 'Current date'"), Новый ОписаниеТипов, Истина);
...
Процедура ДобавитьГруппуОператоровОперацииСравнения(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "В", НСтр("ru = 'В';
												|en = 'IN'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "ЗначениеЗаполнено", НСтр("ru = 'Значение заполнено';
																|en = 'Value filled'"), Тип, Истина);
...
Процедура ДобавитьГруппуОператоровЛогическиеОперации(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "ВЫБОР", НСтр("ru = 'ВЫБОР';
													|en = 'CASE'"), , , Истина); // @query-part
	ДобавитьОператорВГруппу(Группа, "КОГДА", НСтр("ru = 'КОГДА';
													|en = 'WHEN'"), , , Истина);
	ДобавитьОператорВГруппу(Группа, "ТОГДА", НСтр("ru = 'ТОГДА';
													|en = 'THEN'"), , , Истина);
	ДобавитьОператорВГруппу(Группа, "ИНАЧЕ", НСтр("ru = 'ИНАЧЕ';
													|en = 'ELSE'"), , , Истина);
	ДобавитьОператорВГруппу(Группа, "КОНЕЦ", НСтр("ru = 'КОНЕЦ';
													|en = 'END'"), , , Истина);
	ДобавитьОператорВГруппу(Группа, "ИСТИНА", НСтр("ru = 'ИСТИНА';
													|en = 'TRUE'"), , , Истина);
	ДобавитьОператорВГруппу(Группа, "ЛОЖЬ", НСтр("ru = 'ЛОЖЬ';
...
Процедура ДобавитьГруппуОператоровАгрегатныеФункции(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "СУММА", НСтр("ru = 'СУММА';
													|en = 'SUM'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "КОЛИЧЕСТВО", НСтр("ru = 'КОЛИЧЕСТВО';
														|en = 'COUNT'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "МАКСИМУМ", НСтр("ru = 'МАКСИМУМ';
													|en = 'MAX'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "МИНИМУМ", НСтр("ru = 'МИНИМУМ';
													|en = 'MIN'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "СРЕДНЕЕ", НСтр("ru = 'СРЕДНЕЕ';
													|en = 'AVG'"), Тип, Истина);
...
Процедура ДобавитьГруппуОператоровПрочиеФункцииСКД(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "СТРОКА", НСтр("ru = 'СТРОКА';
													|en = 'STRING'"), Новый ОписаниеТипов("Строка"), Истина);
	ДобавитьОператорВГруппу(Группа, "ЗНАЧЕНИЕ", НСтр("ru = 'ЗНАЧЕНИЕ';
													|en = 'VALUE'"), Новый ОписаниеТипов, Истина);
