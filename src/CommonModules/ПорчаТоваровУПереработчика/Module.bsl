...
// связанные с хозяйственной операцией "Порча товаров у переработчика".
// 
//////////////////////////////////////////////////////////////////////////
...
// Возвращает параметры заполнения видов запасов для документа "Порча товаров у хранителя".
//
// Параметры:
...
Функция ПредставлениеОбъекта() Экспорт
	...
	Возврат НСтр("ru = 'Порча товаров у переработчика';
