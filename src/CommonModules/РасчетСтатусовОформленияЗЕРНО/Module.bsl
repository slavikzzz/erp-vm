...
Функция ОпределитьСтатусыОформленияДокументов(МассивДокументов, МетаданныеДокументаЗЕРНО, МенеджерВТ) Экспорт
	...
	ИначеЕсли МетаданныеДокументаЗЕРНО = Метаданные.Документы.ОформлениеСДИЗЗЕРНО Тогда
		...
		Запрос.УстановитьПараметр("ОперацииУвеличенияКоличества", Документы.ОформлениеСДИЗЗЕРНО.ОперацииКорректировкиСУвеличениемИсходногоКоличества());
		Запрос.УстановитьПараметр("ОперацииУменьшенияКоличества", Документы.ОформлениеСДИЗЗЕРНО.ОперацииКорректировкиСУменьшениемИсходногоКоличества());
