...
Функция ВидПродукцииПодлежитМаркировкеОстатков(ВидПродукции) Экспорт
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПолимерныеТрубы") Тогда
		Возврат ПолимерныеТрубыПодлежитМаркировкеОстатков();
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.СладостиИКондитерскиеИзделия") Тогда
		Возврат СладостиИКондитерскиеИзделияПодлежитМаркировкеОстатков();
	КонецЕсли;
...
Функция ВидПродукцииПодлежитПеремаркировке(ВидПродукции) Экспорт
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПолимерныеТрубы") Тогда
		Возврат ПолимерныеТрубыПодлежитПеремаркировке();
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.СладостиИКондитерскиеИзделия") Тогда
		Возврат СладостиИКондитерскиеИзделияПодлежитПеремаркировке();
	КонецЕсли;
...
Функция ВидПродукцииПодлежитВозвратуВОборот(ВидПродукции = Неопределено) Экспорт
	...
	ИначеЕсли ПолимерныеТрубыПодлежитВозвратуВОборот() Тогда
		Результат.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПолимерныеТрубы"));
	ИначеЕсли СладостиИКондитерскиеИзделияПодлежитВозвратуВОборот() Тогда
...
Функция ПолимерныеТрубыПодлежитМаркировкеОстатков()
	Возврат Ложь;
КонецФункции

Функция СладостиИКондитерскиеИзделияПодлежитМаркировкеОстатков()
	Возврат Ложь;
КонецФункции
...
Функция ПолимерныеТрубыПодлежитПеремаркировке()
	Возврат Ложь;
КонецФункции

Функция СладостиИКондитерскиеИзделияПодлежитПеремаркировке()
	Возврат Ложь;
КонецФункции
