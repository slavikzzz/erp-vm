...
Функция МассивПустыхСсылокСторнируемогоДокумента() Экспорт
	
	Возврат МассивПустыхСсылокОпределяемогоТипа(Метаданные.ОпределяемыеТипы.СторнируемыйДокумент);
...
// Устарела. Следует использовать МаксимальноеКоличествоОтображаемыхПоказателей.
...
// Устарела. Следует использовать МаксимальноеКоличествоПоказателейИспользуемыхПриРасчете.
...
Функция МассивПустыхСсылокОпределяемогоТипа(ЗаданныйТип)
	
	МассивПустыхСсылок = Новый Массив;
	Для Каждого ТипЗначения Из ЗаданныйТип.Тип.Типы() Цикл
