...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения1(КонтекстВыполнения) Экспорт
	...
	ЗаголовкиГраф.Вставить("10", "Изменения за период - Переоценка - Первоначальная стоимость");
	ЗаголовкиГраф.Вставить("11", "Изменения за период - Переоценка - Накопленная амортизация");
	ЗаголовкиГраф.Вставить("12", "Первоначальная стоимость на конец периода");
	ЗаголовкиГраф.Вставить("13", "Накопленная амортизация и убытки от обесценения на конец периода");
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения1Строки5100и5110(КонтекстВыполнения)
	...
	ПереопределяемыеПараметрыЗаполнения = ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ИнициализироватьПереопределяемыеПараметрыЗаполнения(КонтекстВыполнения, ИмяРаздела, "", ,ДатаКонцаПериодаОтчета);
	...
	МОП_ОБ = Неопределено;
	Если ДатаКонцаПериодаОтчета = КонецГода(КонтекстВыполнения.КонецОтчетногоПериода) Тогда
		МежотчетныйПериод = ДатаКонцаПериодаОтчета;
		
		МОП_ОБ = Новый Структура("Настройки, Обороты");
		
		МОП_ОБ.Настройки = Новый Структура;
		МОП_ОБ.Настройки.Вставить("Организация", Организация);
		...
		МОП_ОБ.Вставить("ОБ_84__05", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("84", "05", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_05__84", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("05", "84", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_84__04_01", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("84", "04.01", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_84__04_02", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("84", "04.02", МОП_ОБ.Обороты));
		
		ПереопределяемыеПараметрыЗаполнения.ДанныеДляЗаполнения.Вставить("МОП_ОБ", МОП_ОБ);
	...
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, ЗаголовокРасшифровки, "+", "!СНД " + Счет("04.01").Код, СНД_04_01, ИмяРаздела, НастройкиОСВПоСчету(ОбщиеПараметрыРасшифровки, Счет("04.01")));
	...
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, ЗаголовокРасшифровки, "+", "!СНК " + Счет("05").Код, СНК_05, ИмяРаздела, НастройкиОСВПоСчету(ОбщиеПараметрыРасшифровки, Счет("05")));
	...
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, ЗаголовокРасшифровки, "+", "!ОБ " + Счет("04.01").Код + " " + Счет("08.05").Код, ОБ_04_01__08_05, ИмяРаздела, НастройкиАнализаСчета(ОбщиеПараметрыРасшифровки, Счет("04.01"), Счет("08.05")));
	...
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, ЗаголовокРасшифровки, "+", "!КО " + Счет("04.01").Код, КО_04_01, ИмяРаздела, НастройкиОСВПоСчету(ОбщиеПараметрыРасшифровки, Счет("04.01")));
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, "", "-", "!ОБ " + Счет("04.01").Код + " " + Счет("08.05").Код, -ОБ_04_01__08_05, ИмяРаздела, НастройкиАнализаСчета(ОбщиеПараметрыРасшифровки, Счет("04.01"), Счет("08.05")));
	// Исключение оборотов межотчетного периода: начало
	Если МОП_ОБ <> Неопределено Тогда
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "-", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("84").Код, Счет("04.01").Код), -МОП_ОБ.ОБ_84__04_01, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "84", "04.01"));
	КонецЕсли;
	// Исключение оборотов межотчетного периода: конец 
	...
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, ЗаголовокРасшифровки, "+", "!ОБ " + Счет("05").Код + " " + Счет("04.01").Код, ОБ_05__04_01, ИмяРаздела, НастройкиАнализаСчета(ОбщиеПараметрыРасшифровки, Счет("05"), Счет("04.01")));
	...
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, ЗаголовокРасшифровки, "+", "!КО " + Счет("05").Код, КО_05, ИмяРаздела, НастройкиОСВПоСчету(ОбщиеПараметрыРасшифровки, Счет("05")));
	...
	// Исключение оборотов межотчетного периода: начало
	Если МОП_ОБ <> Неопределено Тогда
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "-", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("84").Код, Счет("05").Код), -МОП_ОБ.ОБ_84__05, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "84", "05"));
	КонецЕсли;
	// Исключение оборотов межотчетного периода: конец 
	
	ИмяВПДР = "ПереоценкаВнеоборотныхАктивов";
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, "", "+", "Оборот по кредиту счета 91.01 " + ОписаниеОбъектовВПДР(ИмяВПДР) + " в корреспонденции со счетом 05", ОБ_05__91_01_ДоходыРасходыСвязанныеСПереоценкойВнеоборотныхАктивов, ИмяРаздела, НастройкиАнализаСчетаВПДР(ОбщиеПараметрыРасшифровки, "91.01", "05", ИмяВПДР));
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, "", "-", "Оборот по дебету счета 91.02 " + ОписаниеОбъектовВПДР(ИмяВПДР) + " в корреспонденции со счетом 05", -ОБ_91_02__05_ДоходыРасходыСвязанныеСПереоценкойВнеоборотныхАктивов, ИмяРаздела, НастройкиАнализаСчетаВПДР(ОбщиеПараметрыРасшифровки, "91.02", "05", ИмяВПДР));
	...
	Если ИспользоватьАлгоритм2011Года Тогда
		...
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, ЗаголовокРасшифровки, "+", "!ОБ " + Счет("04.01").Код + " " + Счет("83.01.2").Код, ОБ_04_01__83_01_2, ИмяРаздела, НастройкиАнализаСчета(ОбщиеПараметрыРасшифровки, "04.01", "83.01.2"));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, "", "-", "!ОБ " + Счет("83.01.2").Код + " " + Счет("04.01").Код, -ОБ_83_01_2__04_01, ИмяРаздела, НастройкиАнализаСчета(ОбщиеПараметрыРасшифровки, "83.01.2", "04.01"));
		
		ИмяВПДР = "ПереоценкаВнеоборотныхАктивов";
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, "", "-", "Оборот по дебету счета 91.02 " + ОписаниеОбъектовВПДР(ИмяВПДР) + " в корреспонденции со счетом 04.01", -ОБ_91_02__04_01_ДоходыРасходыСвязанныеСПереоценкойВнеоборотныхАктивов, ИмяРаздела, НастройкиАнализаСчетаВПДР(ОбщиеПараметрыРасшифровки, "91.02", "04.01", ИмяВПДР));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, "", "+", "Оборот по кредиту счета 91.01 " + ОписаниеОбъектовВПДР(ИмяВПДР) + " в корреспонденции со счетом 04.01", ОБ_04_01__91_01_ДоходыРасходыСвязанныеСПереоценкойВнеоборотныхАктивов, ИмяРаздела, НастройкиАнализаСчетаВПДР(ОбщиеПараметрыРасшифровки, "91.01", "04.01", ИмяВПДР));
	Иначе
		...
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, ЗаголовокРасшифровки, "+", "!ОБ " + Счет("04.01").Код + " " + Счет("83.01.2").Код, ОБ_04_01__83_01_2, ИмяРаздела, НастройкиАнализаСчета(ОбщиеПараметрыРасшифровки, "04.01", "83.01.2"));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, "", "-", "!ОБ " + Счет("83.01.2").Код + " " + Счет("04.01").Код, -ОБ_83_01_2__04_01, ИмяРаздела, НастройкиАнализаСчета(ОбщиеПараметрыРасшифровки, "83.01.2", "04.01"));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, "", "-", "!ОБ " + Счет("84").Код + " " + Счет("04.01").Код, -ОБ_84__04_01, ИмяРаздела, НастройкиАнализаСчета(ОбщиеПараметрыРасшифровки, "84", "04.01"));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, "", "+", "!ОБ " + Счет("04.01").Код + " " + Счет("84").Код, ОБ_04_01__84, ИмяРаздела, НастройкиАнализаСчета(ОбщиеПараметрыРасшифровки, "04.01", "84"));
	КонецЕсли;
	...
	Если ИспользоватьАлгоритм2011Года Тогда
		...
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, ЗаголовокРасшифровки, "+", "!ОБ " + Счет("83.01.2").Код + " " + Счет("05").Код, ОБ_83_01_2__05, ИмяРаздела, НастройкиАнализаСчета(ОбщиеПараметрыРасшифровки, "83.01.2", "05"));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, "", "-", "!ОБ " + Счет("05").Код + " " + Счет("83.01.2").Код, -ОБ_05__83_01_2, ИмяРаздела, НастройкиАнализаСчета(ОбщиеПараметрыРасшифровки, "05", "83.01.2"));
	...
	Иначе
		...
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, ЗаголовокРасшифровки, "+", "!ОБ " + Счет("83.01.2").Код + " " + Счет("05").Код, ОБ_83_01_2__05, ИмяРаздела, НастройкиАнализаСчета(ОбщиеПараметрыРасшифровки, "83.01.2", "05"));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, "", "-", "!ОБ " + Счет("05").Код + " " + Счет("83.01.2"), -ОБ_05__83_01_2, ИмяРаздела, НастройкиАнализаСчета(ОбщиеПараметрыРасшифровки, "05", "83.01.2"));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, "", "-", "!ОБ " + Счет("05").Код + " " + Счет("84").Код, -ОБ_05__84, ИмяРаздела, НастройкиАнализаСчета(ОбщиеПараметрыРасшифровки, "05", "84"));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, "", "+", "!ОБ " + Счет("84").Код + " " + Счет("05").Код, ОБ_84__05, ИмяРаздела, НастройкиАнализаСчета(ОбщиеПараметрыРасшифровки, "84", "05"));
	КонецЕсли;
	...
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, ЗаголовокРасшифровки, "+", "!СКД " + Счет("04.01"), СКД_04_01, ИмяРаздела, НастройкиОСВПоСчету(ОбщиеПараметрыРасшифровки, "04.01"));
	...
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, ЗаголовокРасшифровки, "+", "!СКК " + Счет("05").Код, СКК_05, ИмяРаздела, НастройкиОСВПоСчету(ОбщиеПараметрыРасшифровки, "05"));
	// Исключение оборотов межотчетного периода: начало
	Если МОП_ОБ <> Неопределено Тогда
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("05").Код, Счет("84").Код), +МОП_ОБ.ОБ_05__84, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "05", "84"));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "-", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("84").Код, Счет("05").Код), -МОП_ОБ.ОБ_84__05, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "84", "05"));
	КонецЕсли;
	// Исключение оборотов межотчетного периода: конец 

	ЗаполнитьФормаОтчета2011Кв4_Пояснения1СведенияДопСтрок5100и5110КромеГраф11и12(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета, ТаблицаДополнительныхСтрок);
	ЗаполнитьФормаОтчета2011Кв4_Пояснения1СведенияДопСтрок5100и5110ПоГрафе11(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета, ТаблицаДополнительныхСтрок);
	ЗаполнитьФормаОтчета2011Кв4_Пояснения1СведенияДопСтрок5100и5110ПоГрафе12(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета, ТаблицаДополнительныхСтрок);
	
КонецПроцедуры

Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения1СведенияДопСтрок5100и5110КромеГраф11и12(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета, ТаблицаДополнительныхСтрок)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |ИЗ
	               |	РегистрБухгалтерии.Хозрасчетный.ОстаткиИОбороты(&НачПериода, &КонПериода, Период, Движения, Счет = &Счет_04_01, &СубконтоНМА, Организация = &Организация) КАК ХозрасчетныйОстаткиИОбороты
	               |
	               |ОБЪЕДИНИТЬ ВСЕ
	               |
	               |ВЫБРАТЬ
	               ...
	               |ИЗ
	               |	РегистрБухгалтерии.Хозрасчетный.ОстаткиИОбороты(&НачПериода, &КонПериода, Период, Движения, Счет = &Счет_05, &СубконтоНМА, Организация = &Организация) КАК ХозрасчетныйОстаткиИОбороты
	               |
	               |ОБЪЕДИНИТЬ ВСЕ
	               |
	               |ВЫБРАТЬ
	               ...
	               |	0
	               |ИЗ
	               |	РегистрБухгалтерии.Хозрасчетный.ОборотыДтКт(&НачПериода, &КонПериода, Период, СчетДт = &Счет_04_01, &СубконтоНМА, СчетКт = &Счет_08_05, , Организация = &Организация) КАК ХозрасчетныйОборотыДтКт
	               |
	               |ОБЪЕДИНИТЬ ВСЕ
	               |
	               |ВЫБРАТЬ
	               ...
	               |	0
	               |ИЗ
	               |	РегистрБухгалтерии.Хозрасчетный.Обороты(&НачПериода, &КонПериода, Период, Счет = &Счет_04_01, &СубконтоНМА, Организация = &Организация, , ) КАК ХозрасчетныйОбороты
	               |
	               |ОБЪЕДИНИТЬ ВСЕ
	               |
	               |ВЫБРАТЬ
	               ...
	               |	0
	               |ИЗ
	               |	РегистрБухгалтерии.Хозрасчетный.ОборотыДтКт(&НачПериода, &КонПериода, Период, СчетДт = &Счет_05, , СчетКт = &Счет_04_01, &СубконтоНМА, Организация = &Организация) КАК ХозрасчетныйОборотыДтКт
	               |
	               |ОБЪЕДИНИТЬ ВСЕ
	               |
	               |ВЫБРАТЬ
	               ...
	               |	0
	               |ИЗ
	               |	РегистрБухгалтерии.Хозрасчетный.Обороты(&НачПериода, &КонПериода, Период, Счет = &Счет_05, &СубконтоНМА, Организация = &Организация, , ) КАК ХозрасчетныйОбороты
	               |ИТОГИ
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения1СведенияДопСтрок5100и5110ПоГрафе11(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета, ТаблицаДополнительныхСтрок)
	...
	Если ИспользоватьАлгоритм2011Года Тогда
		...
		|ИЗ
		|	РегистрБухгалтерии.Хозрасчетный.ОборотыДтКт(&НачПериода, &КонПериода, Период, СчетДт = &Счет_04_01, &СубконтоНМА, СчетКт = &Счет_83_01_2, , Организация = &Организация) КАК ХозрасчетныйОборотыДтКт
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
		...
		|	-ХозрасчетныйОборотыДтКт.СуммаОборот
		|ИЗ
		|	РегистрБухгалтерии.Хозрасчетный.ОборотыДтКт(&НачПериода, &КонПериода, Период, СчетДт = &Счет_83_01_2, , СчетКт = &Счет_04_01, &СубконтоНМА, Организация = &Организация) КАК ХозрасчетныйОборотыДтКт
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
		...
		|				И СубконтоДт1 В (ВЫБРАТЬ Т.Ссылка ИЗ ТаблицаПрочиеДоходыИРасходыПереопределяемый КАК Т ГДЕ Т.ВидПрочихДоходовИРасходов = &ПереоценкаВнеоборотныхАктивов)
		...
		|			&СубконтоПрочиеДоходыИРасходы,
		|			Организация = &Организация
		|				И СубконтоКт1 В (ВЫБРАТЬ Т.Ссылка ИЗ ТаблицаПрочиеДоходыИРасходыПереопределяемый КАК Т ГДЕ Т.ВидПрочихДоходовИРасходов = &ПереоценкаВнеоборотныхАктивов)
		|			) КАК ХозрасчетныйОборотыДтКт
		|ИТОГИ
		|	СУММА(ЗначениеПоказателя)
		|ПО
		|	ВидНМА";
		УстановитьПолныйТекстЗапроса(Запрос);
	Иначе
		Запрос.Текст = 
		"ВЫБРАТЬ
		...
		|	-ХозрасчетныйОборотыДтКт.СуммаОборот
		|ИЗ
		|	РегистрБухгалтерии.Хозрасчетный.ОборотыДтКт(&НачПериода, &КонПериода, Период, СчетДт В (&Счета_84), , СчетКт = &Счет_04_01, &СубконтоНМА, Организация = &Организация) КАК ХозрасчетныйОборотыДтКт
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
		...
		|	ХозрасчетныйОборотыДтКт.СуммаОборот
		|ИЗ
		|	РегистрБухгалтерии.Хозрасчетный.ОборотыДтКт(&НачПериода, &КонПериода, Период, СчетДт = &Счет_04_01, &СубконтоНМА, СчетКт В (&Счета_84), , Организация = &Организация) КАК ХозрасчетныйОборотыДтКт
		|ИТОГИ
		|	СУММА(ЗначениеПоказателя)
		|ПО
		|	ВидНМА";
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения1СведенияДопСтрок5100и5110ПоГрафе12(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета, ТаблицаДополнительныхСтрок)
	...
	Если ИспользоватьАлгоритм2011Года Тогда
		...
		|	ХозрасчетныйОборотыДтКт.СуммаОборот КАК ЗначениеПоказателя
		|ИЗ
		|	РегистрБухгалтерии.Хозрасчетный.ОборотыДтКт(&НачПериода, &КонПериода, Период, СчетДт = &Счет_83_01_2, , СчетКт = &Счет_05, &СубконтоНМА, Организация = &Организация) КАК ХозрасчетныйОборотыДтКт
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
		...
		|	-ХозрасчетныйОборотыДтКт.СуммаОборот
		|ИЗ
		|	РегистрБухгалтерии.Хозрасчетный.ОборотыДтКт(&НачПериода, &КонПериода, Период, СчетДт = &Счет_05, &СубконтоНМА, СчетКт = &Счет_83_01_2, , Организация = &Организация) КАК ХозрасчетныйОборотыДтКт
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
	...
	Иначе
		...
		|	-ХозрасчетныйОборотыДтКт.СуммаОборот
		|ИЗ
		|	РегистрБухгалтерии.Хозрасчетный.ОборотыДтКт(&НачПериода, &КонПериода, Период, СчетДт = &Счет_05, &СубконтоНМА, СчетКт В (&Счета_84), , Организация = &Организация) КАК ХозрасчетныйОборотыДтКт
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
		...
		|	ХозрасчетныйОборотыДтКт.СуммаОборот
		|ИЗ
		|	РегистрБухгалтерии.Хозрасчетный.ОборотыДтКт(&НачПериода, &КонПериода, Период, СчетДт В (&Счета_84), , СчетКт = &Счет_05, &СубконтоНМА, Организация = &Организация) КАК ХозрасчетныйОборотыДтКт
		|ИТОГИ
		|	СУММА(ЗначениеПоказателя)
		|ПО
		|	ВидНМА";
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения2Строки5200и5210(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета, ТаблицаДополнительныхСтрок)
	...
	ПереопределяемыеПараметрыЗаполнения.ДанныеДляЗаполнения.Вставить("СальдоИОборотыПоСчетам", СальдоИОборотыПоСчетам);
	ПереопределяемыеПараметрыЗаполнения.ДанныеДляЗаполнения.Вставить("ОборотыМеждуСчетами", ОборотыМеждуСчетами);
	...
	Если ДатаКонцаПериодаОтчета = КонецГода(КонтекстВыполнения.КонецОтчетногоПериода) Тогда
		...
		МОП_ОБ.Вставить("ОБ_84__01_03", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("84", "01.03", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_01_03__84", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("01.03", "84", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_84__02_01", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("84", "02.01", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_02_01__84", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("02.01", "84", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_84__02_03", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("84", "02.03", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_02_03__84", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("02.03", "84", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_02_03__01_03", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("02.03", "01.03", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_01_03__08_04_2", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("01.03", "08.04.2", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_08_04_2__76_07_1", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("08.04.2", "76.07.1", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_01_09__01_01", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("01.09", "01.01", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_01_09__01_03", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("01.09", "01.03", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_02_01__01_09", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("02.01", "01.09", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_02_03__01_09", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("02.03", "01.09", МОП_ОБ.Обороты));
	...
	Обороты91ПоПереоценкеВнеоборотныхАктивов = ЗаполнениеБухгалтерскойОтчетностиИтоги.Обороты91ПоПереоценкеВнеоборотныхАктивов(НастройкиПолученияБухитогов);
	ПереопределяемыеПараметрыЗаполнения.ДанныеДляЗаполнения.Вставить("Обороты91ПоПереоценкеВнеоборотныхАктивов", Обороты91ПоПереоценкеВнеоборотныхАктивов);
	...
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДополнитьЗначениеПоказателяПереопределяемымиПараметрами(ПереопределяемыеПараметрыЗаполнения, ЗначениеПоказателя, "П000100" + НомерСтроки + Графа);
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, "П000100" + НомерСтроки + Графа, ЗначениеПоказателя);
	...
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСтрокуРасшифровкиПереопределяемогоПараметра(ПереопределяемыеПараметрыЗаполнения, "П000100" + НомерСтроки + Графа, "П000100" + НомерСтроки + Графа);
	...
	Если МОП_ОБ <> Неопределено Тогда
		ЗначениеПоказателя = ЗначениеПоказателя 
			- МОП_ОБ.ОБ_01_09__01_01
			- МОП_ОБ.ОБ_01_09__01_03
	КонецЕсли;
	// Исключение оборотов межотчетного периода: конец
	...
	// Исключение оборотов межотчетного периода: начало
	Если МОП_ОБ <> Неопределено Тогда
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "-", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("01.09").Код, Счет("01.01").Код), -МОП_ОБ.ОБ_01_09__01_01, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "01.09", "01.01"));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "-", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("01.09").Код, Счет("01.03").Код), -МОП_ОБ.ОБ_01_09__01_03, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "01.09", "01.03"));
	КонецЕсли;
	// Исключение оборотов межотчетного периода: конец
	...
	Если МОП_ОБ <> Неопределено Тогда
		ЗначениеПоказателя = ЗначениеПоказателя 
			- МОП_ОБ.ОБ_02_01__01_09
			- МОП_ОБ.ОБ_02_03__01_09;
	КонецЕсли;
	// Исключение оборотов межотчетного периода: конец
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, "П000100" + НомерСтроки + Графа, ЗначениеПоказателя);
	...
	// Исключение оборотов межотчетного периода: начало
	Если МОП_ОБ <> Неопределено Тогда
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "-", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("02.01").Код, Счет("01.09").Код), -МОП_ОБ.ОБ_02_01__01_09, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "02.01", "01.09"));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "-", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("02.03").Код, Счет("01.09").Код), -МОП_ОБ.ОБ_02_03__01_09, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "02.03", "01.09"));
	КонецЕсли;
	// Исключение оборотов межотчетного периода: конец
	...
	Если ИспользоватьАлгоритм2011Года Тогда
		...
		// Исключение оборотов межотчетного периода: начало
		Если МОП_ОБ <> Неопределено Тогда
			ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("02.01").Код, Счет("84").Код), +МОП_ОБ.ОБ_02_01__84, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "02.01", "84"));
			ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "-", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("84").Код, Счет("02.01").Код), -МОП_ОБ.ОБ_84__02_01, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "84", "02.01"));
			ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("02.03").Код, Счет("84").Код), +МОП_ОБ.ОБ_02_03__84, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "02.03", "84"));
			ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "-", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("84").Код, Счет("02.03").Код), -МОП_ОБ.ОБ_84__02_03, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "84", "02.03"));
		КонецЕсли;
		// Исключение оборотов межотчетного периода: конец
	Иначе
		ЗначениеПоказателя = КО_02_01 + КО_02_03
	...
	Если ИспользоватьАлгоритм2011Года Тогда
		...
		ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСтрокуРасшифровкиПереопределяемогоПараметра(ПереопределяемыеПараметрыЗаполнения, "П000100" + НомерСтроки + Графа, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """");
	...
	Если МОП_ОБ <> Неопределено Тогда
		ЗначениеПоказателя = ЗначениеПоказателя
			+ МОП_ОБ.ОБ_84__01_03
			- МОП_ОБ.ОБ_01_03__84
			- Мин(МОП_ОБ.ОБ_01_03__08_04_2, МОП_ОБ.ОБ_08_04_2__76_07_1)

			+ МОП_ОБ.ОБ_02_03__01_03
			+ МОП_ОБ.ОБ_01_09__01_01
			+ МОП_ОБ.ОБ_01_09__01_03;
	КонецЕсли;
	// Исключение оборотов межотчетного периода: конец
	...
	// Исключение оборотов межотчетного периода: начало
	Если МОП_ОБ <> Неопределено Тогда
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("84").Код, Счет("01.03").Код), +МОП_ОБ.ОБ_84__01_03, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "84", "01.03"));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "-", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("01.03").Код, Счет("84").Код), -МОП_ОБ.ОБ_01_03__84, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "01.03", "84"));
		Если МОП_ОБ.ОБ_01_03__08_04_2 <= МОП_ОБ.ОБ_08_04_2__76_07_1 Тогда
			ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "-", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("01.03").Код, Счет("08.04.2").Код), -МОП_ОБ.ОБ_01_03__08_04_2, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "01.03", "08.04.2"));
		Иначе
			ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "-", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("08.04.2").Код, Счет("76.07.1").Код), -МОП_ОБ.ОБ_08_04_2__76_07_1, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "08.04.2", "76.07.1"));
		КонецЕсли;
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("02.03").Код, Счет("01.03").Код), +МОП_ОБ.ОБ_02_03__01_03, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "02.03", "01.03"));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("01.09").Код, Счет("01.01").Код), +МОП_ОБ.ОБ_01_09__01_01, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "01.09", "01.01"));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("01.09").Код, Счет("01.03").Код), +МОП_ОБ.ОБ_01_09__01_03, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "01.09", "01.03"));
	КонецЕсли;
	// Исключение оборотов межотчетного периода: конец
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения2СведенияДопСтрок5200и5210КромеГраф10и11(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета, ТаблицаДополнительныхСтрок)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	СУММА(ХозрасчетныйОбороты.СуммаОборот) КАК Значение
	               ...
	               |			&КонПериода,
	               |			Период,
	               |			Счет В (&СчетаУчетаАмортизацииОС),
	               |			&ВидСубконтоОС,
	               |			Организация = &Организация
	               |				И &КонПериода = КОНЕЦПЕРИОДА(&КонецОтчетногоПериода, ГОД),
	               |			КорСчет В (&Счет84),
	               ...
	               |	ХозрасчетныйОбороты.Субконто1.ГруппаОС КАК ГруппаОС,
	               |	СУММА(ХозрасчетныйОбороты.СуммаОборот) КАК Значение
	               |ПОМЕСТИТЬ ВТ_КорректировкаАмортизации0203_0103
	               |ИЗ
	               |	РегистрБухгалтерии.Хозрасчетный.Обороты(
	               |			&КонПериода,
	               |			&КонПериода,
	               ...
	               |ПОМЕСТИТЬ ВТ_Корректировка0103
	               |ИЗ
	               |	(ВЫБРАТЬ
	               |		ХозрасчетныйОбороты.Субконто1.ГруппаОС КАК ГруппаОС,
	               |		-1 * ХозрасчетныйОбороты.СуммаОборот КАК Значение
	               |	ИЗ
	               |		РегистрБухгалтерии.Хозрасчетный.Обороты(
	               |				&КонПериода,
	               |				&КонПериода,
	               ...
	               |	ВЫБРАТЬ
	               |		ХозрасчетныйОбороты.Субконто1.ГруппаОС,
	               |		-1 * ХозрасчетныйОбороты.СуммаОборот
	               |	ИЗ
	               |		РегистрБухгалтерии.Хозрасчетный.Обороты(
	               |				&КонПериода,
	               |				&КонПериода,
	               ...
	               |				Организация = &Организация
	               |					И &КонПериода = КОНЕЦПЕРИОДА(&КонецОтчетногоПериода, ГОД),
	               |				КорСчет В (&Счета76х71),
	               |				) КАК ХозрасчетныйОбороты) КАК ОбъединениеДанных
	               |
	               |СГРУППИРОВАТЬ ПО
	               ...
	               |	СУММА(ХозрасчетныйОборотыДтКт.СуммаОборот) КАК Значение
	               |ПОМЕСТИТЬ ВТ_КорректировкаВыбытияАмортизации
	               |ИЗ
	               |	РегистрБухгалтерии.Хозрасчетный.ОборотыДтКт(
	               |			&КонПериода,
	               |			&КонПериода,
	               ...
	               |			,
	               |			Организация = &Организация
	               |				И &КонПериода = КОНЕЦПЕРИОДА(&КонецОтчетногоПериода, ГОД)) КАК ХозрасчетныйОборотыДтКт
	               |
	               |СГРУППИРОВАТЬ ПО
	               ...
	               |	ХозрасчетныйОборотыДтКт.СубконтоДт1.ГруппаОС КАК ГруппаОС,
	               |	СУММА(ХозрасчетныйОборотыДтКт.СуммаОборот) КАК Значение
	               |ПОМЕСТИТЬ ВТ_КорректировкаВыбытияПервоначальнойСтоимости
	               |ИЗ
	               |	РегистрБухгалтерии.Хозрасчетный.ОборотыДтКт(
	               |			&КонПериода,
	               |			&КонПериода,
	               ...
	               |	ИЗ
	               |		РегистрБухгалтерии.Хозрасчетный.ОборотыДтКт(&НачПериода, &КонПериода, Период, СчетДт В (&СчетаУчетаАмортизацииОС), &ВидСубконтоОС, СчетКт В (&Счет02), , Организация = &Организация) КАК ХозрасчетныйОборотыДтКт
	               |	
	               |	ОБЪЕДИНИТЬ ВСЕ
	               |	
	               |	ВЫБРАТЬ
	               |		ВТ_КорректировкаАмортизации.ГруппаОС,
	               |		ВТ_КорректировкаАмортизации.Значение
	               |	ИЗ
	               |		ВТ_КорректировкаАмортизации КАК ВТ_КорректировкаАмортизации) КАК ОбъединениеДанных
	               |
	               |СГРУППИРОВАТЬ ПО
	               |	ОбъединениеДанных.ГруппаОС
	               |;
	               ...
	               |	0,
	               |	0,
	               |	ВТ_Корректировка0103.Значение,
	               |	0
	               |ИЗ
	               |	ВТ_Корректировка0103 КАК ВТ_Корректировка0103
	               |
	               |ОБЪЕДИНИТЬ ВСЕ
	               |
	               |ВЫБРАТЬ
	               ...
	               |
	               |ВЫБРАТЬ
	               |	ВТ_КорректировкаАмортизации0203_0103.ГруппаОС,
	               |	0,
	               |	0,
	               |	0,
	               |	0,
	               ...
	               |	0,
	               |	0,
	               |	ВТ_КорректировкаАмортизации0203_0103.Значение
	               |ИЗ
	               |	ВТ_КорректировкаАмортизации0203_0103 КАК ВТ_КорректировкаАмортизации0203_0103
	               |
	               |ОБЪЕДИНИТЬ ВСЕ
	               |
	               |ВЫБРАТЬ
	               ...
	               |
	               |ВЫБРАТЬ
	               |	ВТ_КорректировкаВыбытияПервоначальнойСтоимости.ГруппаОС,
	               |	0,
	               |	0,
	               |	0,
	               |	-1 * ВТ_КорректировкаВыбытияПервоначальнойСтоимости.Значение,
	               |	0,
	               |	0,
	               |	ВТ_КорректировкаВыбытияПервоначальнойСтоимости.Значение,
	               |	0
	               |ИЗ
	               |	ВТ_КорректировкаВыбытияПервоначальнойСтоимости КАК ВТ_КорректировкаВыбытияПервоначальнойСтоимости
	               |
	               |ОБЪЕДИНИТЬ ВСЕ
	               |
	               |ВЫБРАТЬ
	               ...
	               |
	               |ВЫБРАТЬ
	               |	ВТ_КорректировкаВыбытияАмортизации.ГруппаОС,
	               |	0,
	               |	0,
	               |	0,
	               |	0,
	               |	-1 * ВТ_КорректировкаВыбытияАмортизации.Значение,
	               |	0,
	               |	0,
	               |	ВТ_КорректировкаВыбытияАмортизации.Значение
	               |ИЗ
	               |	ВТ_КорректировкаВыбытияАмортизации КАК ВТ_КорректировкаВыбытияАмортизации
	               |
	               |ОБЪЕДИНИТЬ ВСЕ
	               |
	               |ВЫБРАТЬ
	...
	Запрос.УстановитьПараметр("Организация", Организация);
	// Исключение оборотов межотчетного периода: начало
	Запрос.УстановитьПараметр("КонецОтчетногоПериода", КонтекстВыполнения.КонецОтчетногоПериода);
	// Исключение оборотов межотчетного периода: конец
	
	СчетаСтрокой = "01.01, 01.03";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаСтрокой, "ОС");
	СчетаУчетаОС_0103 = МассивСчетовВИерархииИзСписка(СчетаСтрокой);
	СчетаСтрокой = СчетаСтрокой + ", 01.08";
	СчетаУчетаОС_010308 = МассивСчетовВИерархииИзСписка(СчетаСтрокой);
	СчетаСтрокой = "02.01, 02.03";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаСтрокой, "АмортизацияОС");
	СчетаУчетаАмортизацииОС = МассивСчетовВИерархииИзСписка(СчетаСтрокой);
	Счет02 = МассивСчетовВИерархииИзСписка("02");
	// Исключение оборотов межотчетного периода: начало
	Счет0103 = МассивСчетовВИерархииИзСписка("01.03");
	Счет0203 = МассивСчетовВИерархииИзСписка("02.03");
	Счет84 = МассивСчетовВИерархииИзСписка("84");
	Счета76х71 = МассивСчетовВИерархииИзСписка("76.07.1");
	// Исключение оборотов межотчетного периода: конец
	...
	// Исключение оборотов межотчетного периода: начало
	Запрос.УстановитьПараметр("Счет0103", Счет0103);
	Запрос.УстановитьПараметр("Счет0203", Счет0203);
	Запрос.УстановитьПараметр("Счет84", Счет84);
	Запрос.УстановитьПараметр("Счета76х71", Счета76х71);
	// Исключение оборотов межотчетного периода: конец
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения2СведенияДопСтрок5200и5210ПоГрафе10(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета, ТаблицаДополнительныхСтрок);
	...
	СчетаСтрокой = "01.01, 01.03";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаСтрокой, "ОС");
	СчетаУчетаОС = МассивСчетовВИерархииИзСписка(СчетаСтрокой);
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения2Строки5220и5230(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета, ТаблицаДополнительныхСтрок)
	...
	Если ДатаКонцаПериодаОтчета = КонецГода(КонтекстВыполнения.КонецОтчетногоПериода) Тогда
		...
		МОП_ОБ.Вставить("ОБ_84__02_02", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("84", "02.02", МОП_ОБ.Обороты));
		МОП_ОБ.Вставить("ОБ_02_02__84", ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("02.02", "84", МОП_ОБ.Обороты));
	КонецЕсли;
	// Исключение оборотов межотчетного периода: конец
	...
	// Исключение оборотов межотчетного периода: начало
	Если МОП_ОБ <> Неопределено Тогда
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("02.02").Код, Счет("84").Код), +МОП_ОБ.ОБ_02_02__84, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "02.02", "84"));
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "-", ЗаполнениеБухгалтерскойОтчетностиОсновная.ПредставлениеМОП_ОБ(Счет("84").Код, Счет("02.02").Код), -МОП_ОБ.ОБ_84__02_02, ИмяРаздела, НастройкиАнализаСчета(МОП_ОБ.Настройки, "84", "02.02"));
	КонецЕсли;
	// Исключение оборотов межотчетного периода: конец
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения2Строка5260(КонтекстВыполнения, Графа, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета, ТаблицаДополнительныхСтрок)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	ВНУТРЕННЕЕ СОЕДИНЕНИЕ ТаблицаДокументыМодернизацииПереопределяемый КАК МодернизацияОС
	               |		ПО ХозрасчетныйОборотыДтКт.Регистратор = МодернизацияОС.Ссылка
	               |
	               |СГРУППИРОВАТЬ ПО
	               |	ХозрасчетныйОборотыДтКт.СубконтоДт1,
	...
	СодержаниеРасшифровки = "Оборот с кредита счета " + Счет("08.03").Код + " в дебет счета " + Счет("01.01").Код + " по документам ""Модернизация ОС"" с видом события с ОС ""Модернизация""";
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", СодержаниеРасшифровки, ОБ_01_01__08_03, ИмяРаздела, ДополнительныеПараметрыРасшифровки);
	
	СодержаниеРасшифровки = "Оборот с кредита счета " + Счет("08.04").Код + " в дебет счета " + Счет("01.01").Код + " по документам ""Модернизация ОС"" с видом события с ОС ""Модернизация""";
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", СодержаниеРасшифровки, ОБ_01_01__08_04, ИмяРаздела, ДополнительныеПараметрыРасшифровки);
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения4ЗаПериод(КонтекстВыполнения, ТипПериода, НачалоПериода, КонецПериода)
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения4ЗаПериодСтрока5401и5421(КонтекстСтроки)
	...
	УчестьСоставляющую(ПроцессорПоказателя, "+ ОБ 14.01, 91.01");
	...
	УчестьСоставляющую(ПроцессорПоказателя, "+ ОБ 91.02, 14.01");
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения4ЗаПериодСтрока5402и5422(КонтекстСтроки)
	...
	УчестьСоставляющую(ПроцессорПоказателя, "+ ОБ 14.03, 91.01");
	...
	УчестьСоставляющую(ПроцессорПоказателя, "+ ОБ 91.02, 14.03");
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения4ЗаПериодСтрока5403и5423(КонтекстСтроки)
	...
	УчестьСоставляющую(ПроцессорПоказателя, "+ ОБ 14.02, 91.01");
	...
	УчестьСоставляющую(ПроцессорПоказателя, "+ ОБ 91.02, 14.02");
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5504и5524(КонтекстВыполнения, НомерСтроки)
	...
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПрочие, "Лизинг, НДСПоАренде, Факторинг");
	СчетаРезервов = "63";
	СчетаПеревода = "76.05, 76.25, 76.35, 76.09, 76.29, 76.39, 76.07.2";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПеревода, "Лизинг");
	
	СчетаГрафы04 = СчетаПрочие;
	СчетаГрафы05 = СчетаРезервов;
	СчетаГрафы06 = СчетаПрочие;
	СчетаГрафы08 = СчетаПрочие;
	СчетаГрафы09 = СчетаПеревода;
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы09, "Факторинг");
	СчетаГрафы10 = СчетаРезервов;
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения51_Долгосрочная(КонтекстВыполнения)
	...
	Запрос.Текст = ТекстЗапросаПояснения51_Долгосрочная();
	УстановитьПолныйТекстЗапроса(Запрос);
	Запрос.Выполнить();
	...
	Пока Выборка.Следующий() Цикл
		...
		ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, НаименованиеСтрокиРасшифровки, "+", НаименованиеСоставляющей, ЗначениеСоставляющей, ИмяРаздела, ДополнительныеПараметрыРасшифровки);
...
Функция ТекстЗапросаПояснения51_Долгосрочная() Экспорт
	...
	ТекстЗапроса = "ВЫБРАТЬ
	               ...
	               |ИЗ
	               |	ТаблицаДоговорыКонтрагентовПереопределяемый КАК ДоговорыКонтрагентов
	               |ГДЕ
	               ...
	               |ИЗ
	               |	ВТ_ДолгосрочныеДоговоры КАК ВТ_ДолгосрочныеДоговоры
	               |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТ_ВсеСФПолученныеПереопределяемый КАК ВТ_ВсеСФПолученные
	               ...
	               |			Организация = &Организация
	               |				И СубконтоДт1 В (ВЫБРАТЬ Т.Ссылка ИЗ ТаблицаПрочиеДоходыИРасходыПереопределяемый КАК Т ГДЕ Т.ВидПрочихДоходовИРасходов = &ВидПДРСписание)
				   |			) КАК ХозрасчетныйОборотыДтКт
	               |
	               |ИНДЕКСИРОВАТЬ ПО
	               |	Контрагент,
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5510и5530(КонтекстВыполнения, НомерСтроки)
	...
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаАвансов, "АвансыВыданные");
	СчетаНДСАвансов = "76.ВА";
	СчетаПрочие   = "68.01.1, 68.01.2, 68.02, 68.03, 68.04.1, 68.06, 68.07, 68.08, 68.09, 68.10, 68.11, 68.12, 68.13, 68.15, 68.22, 68.90,
	                ...
	                |76.41, 76.НА, 76.ОТ, 76.07.2, 76.07.9, 76.14";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПрочие, "Лизинг, НДСПоАренде, Факторинг, Билеты, РаботникиОрганизаций");
	СчетаРезервов = "63";
	...
	СчетаПеревода = "76.01.1, 76.06, 76.21, 76.26, 76.36, 68.01.1, 68.01.2, 68.02, 68.03, 68.04.1, 68.06, 68.07, 68.08, 68.09, 68.10, 68.11, 68.12, 68.13,
	                |68.15, 68.90, 69.01, 69.02.1, 69.02.2, 69.02.3, 69.02.4, 69.02.5, 69.02.6, 69.02.7, 69.03.1, 69.03.2, 69.04, 69.05.1, 69.05.2,
	                |69.06.1, 69.06.2, 69.06.3, 69.06.4, 69.06.5, 69.09, 69.11, 69.12, 69.13.1, 69.13.2, 70, 71.01, 71.21, 73.03, 76.03, 76.05, 76.25, 76.35,
	                |76.09, 76.29, 76.39, 76.49, 76.41, 76.НА, 76.07.2";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПеревода, "Лизинг, РаботникиОрганизаций");
	...
	Если УчитыватьСчетаИП2015 Тогда
		СчетаПрочие = СтрЗаменить(СчетаПрочие, "68.01.2", "68.01.2, 68.21");
		ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПрочие, "ВидыПлатежейВГосБюджет");
		СчетаПеревода = СтрЗаменить(СчетаПеревода, "68.01.2", "68.01.2, 68.21");
		ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПеревода, "ВидыПлатежейВГосБюджет");
	КонецЕсли;
	...
	СчетаГрафы07 = "62.01, 62.21, 62.31, 62.03, 76.06, 76.26, 76.36, 60.02, 60.22, 60.32, 73.01, 73.02, 73.03,
	               |76.01.1, 76.01.2, 76.01.9, 76.21, 76.02, 76.22, 76.32, 76.03, 76.05, 76.25, 76.35, 76.09, 76.29, 76.39, 76.14";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы07, "Факторинг, Билеты, АвансыВыданные");
	...
	СчетаГрафы09 = "62.01, 62.21, 62.31, 62.03, 76.06, 76.26, 76.36, 60.02, 60.22, 60.32, 71.01, 71.21, 73.01, 73.02, 73.03,
	               |76.02, 76.22, 76.32, 76.03, 76.05, 76.25, 76.35, 76.09, 76.29, 76.39, 76.07.2, 76.14";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы09, "Лизинг, Факторинг, Билеты, АвансыВыданные, РаботникиОрганизаций");
	СчетаГрафы10 = СчетаРезервов;
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5513и5533(КонтекстВыполнения, НомерСтроки)
	...
	СчетаПрочие   = "68.01.1, 68.01.2, 68.02, 68.03, 68.04.1, 68.06, 68.07, 68.08, 68.09, 68.10, 68.11, 68.12, 68.13, 68.15, 68.22, 68.90,
	                ...
	                |75.01, 76.01.1, 76.01.2, 76.01.9, 76.21, 76.02, 76.22, 76.32, 76.03, 76.05, 76.25, 76.35, 76.09, 76.29, 76.39, 76.49,
	                |76.41, 76.НА, 76.ОТ, 76.07.2, 76.07.9, 76.14";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПрочие, "Лизинг, НДСПоАренде, Факторинг, Билеты, РаботникиОрганизаций, ТоварыКОформлениюОтчетовКомитенту");
	СчетаРезервов = "63";
	
	СчетаПеревода = "68.01.1, 68.01.2, 68.02, 68.03, 68.04.1, 68.06, 68.07, 68.08, 68.09, 68.10, 68.11, 68.12, 68.13, 68.15, 68.90,
	                |69.01, 69.02.1, 69.02.2, 69.02.3, 69.02.4, 69.02.5, 69.02.6, 69.02.7, 69.03.1, 69.03.2, 69.04, 69.05.1, 69.05.2,
	                |69.06.1, 69.06.2, 69.06.3, 69.06.4, 69.06.5, 69.09, 69.11, 69.12, 69.13.1, 69.13.2,
	...
	СчетаГрафы07 = "73.01, 73.02, 73.03, 76.01.1, 76.01.2, 76.01.9, 76.21, 76.02, 76.22, 76.32, 76.03, 76.05, 76.25, 76.35,
	               |76.09, 76.29, 76.39, 76.14";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы07, "Факторинг, Билеты");
	СчетаГрафы08 = СчетаПрочие;
	СчетаГрафы09 = "71.01, 71.21, 73.01, 73.02, 73.03, 76.02, 76.22, 76.32, 76.03, 76.05, 76.25, 76.35,
	               |76.09, 76.29, 76.39, 76.07.2, 76.14";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы09, "Лизинг, Факторинг, Билеты, РаботникиОрганизаций");
	СчетаГрафы10 = СчетаРезервов;
	СчетаГрафы12 = СчетаПрочие;
	СчетаГрафы13 = СчетаРезервов;
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения51_Краткосрочная(КонтекстВыполнения)
	...
	Запрос.Текст = ТекстЗапросаПояснения51_Краткосрочная();
	УстановитьПолныйТекстЗапроса(Запрос);
	Запрос.Выполнить();
	...
	Пока Выборка.Следующий() Цикл
		...
		НаименованиеСоставляющей = "Сальдо на начало периода по кредиту счета " + СчетСоставляющей.Код + " по контрагентам и счетам-фактурам полученным по договорам со сроком оплаты не превышающим 365 дней";
...
Функция ТекстЗапросаПояснения51_Краткосрочная() Экспорт
	...
	ТекстЗапроса = "ВЫБРАТЬ
	               ...
	               |		КОНЕЦ
	               |	ИЗ
	               |		РегистрБухгалтерии.Хозрасчетный.ОстаткиИОбороты(&НачалоПериода, &КонецПериода, Период, , Счет В (&АПСчетаБезРазвертки), , Организация = &Организация) КАК ХозрасчетныйОстаткиИОбороты) КАК ОбъединениеДанных
	               |
	               |СГРУППИРОВАТЬ ПО
	               |	ОбъединениеДанных.Счет
	               |;
	               ...
	               |			Организация = &Организация
	               |				И Субконто1 В (ВЫБРАТЬ Т.Ссылка ИЗ ТаблицаРасходыБудущихПериодовПереопределяемый КАК Т ГДЕ Т.ВидАктива = ЗНАЧЕНИЕ(Перечисление.ВидыАктивовДляРБП.ДебиторскаяЗадолженность))) КАК ХозрасчетныйОстаткиИОбороты
	               |;
	               |
	               |////////////////////////////////////////////////////////////////////////////////
	               |ВЫБРАТЬ
	               ...
	               |ПОМЕСТИТЬ ВТ_СФПолученные
	               |ИЗ
	               |	ВТ_ВсеСФПолученныеПереопределяемый КАК ВТ_ВсеСФПолученные
	               ...
	               |			&СубконтоПрочиеДоходыРасходы,
	               |			Организация = &Организация
	               |				И СубконтоКт1 В (ВЫБРАТЬ Т.Ссылка ИЗ ТаблицаПрочиеДоходыИРасходыПереопределяемый КАК Т ГДЕ Т.ВидПрочихДоходовИРасходов = &ВидПДРНачисление)
				   |			) КАК ХозрасчетныйОборотыДтКт
	               |
	               |ИНДЕКСИРОВАТЬ ПО
	               |	Контрагент,
	               ...
	               |			,
	               |			Организация = &Организация
	               |				И СубконтоДт1 В (ВЫБРАТЬ Т.Ссылка ИЗ ТаблицаРасходыБудущихПериодовПереопределяемый КАК Т ГДЕ Т.ВидАктива = ЗНАЧЕНИЕ(Перечисление.ВидыАктивовДляРБП.ДебиторскаяЗадолженность))) КАК ХозрасчетныйОборотыДтКт
	               |;
	               |
	               |////////////////////////////////////////////////////////////////////////////////
	               |ВЫБРАТЬ
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5553и5573(КонтекстВыполнения, НомерСтроки)
	...
	СчетаЦенныхБумаг = "";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаЦенныхБумаг, "ДолгосрочныеЦенныеБумаги");
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5554и5574(КонтекстВыполнения, НомерСтроки)
	...
	СчетаПрочие = "60.01, 60.21, 60.31, 60.03, 62.02, 62.22, 62.32, 76.05, 76.25, 76.35, 76.06, 76.26, 76.36, 76.09, 76.29, 76.39, 76.07.2, 76.07.1";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПрочие, "РасчетыВСчетОтгрузки, Лизинг, Аренда, НеотфактурованныеПоставки");
	СчетаНДСАвансов = "76.АВ";
	
	СчетаПеревода = "76.05, 76.25, 76.35, 76.06, 76.26, 76.36, 76.09, 76.29, 76.39, 76.07.2";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПеревода, "Лизинг");
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения53_Долгосрочная(КонтекстВыполнения)
	...
	Запрос.Текст = ТекстЗапросаПояснения53_Долгосрочная();
	УстановитьПолныйТекстЗапроса(Запрос);
	Запрос.Выполнить();
...
Функция ТекстЗапросаПояснения53_Долгосрочная()
	...
	ТекстЗапроса = "ВЫБРАТЬ
	               ...
	               |			&СубконтоПрочиеДоходыРасходы,
	               |			Организация = &Организация
	               |				И СубконтоКт1 В (ВЫБРАТЬ Т.Ссылка ИЗ ТаблицаПрочиеДоходыИРасходыПереопределяемый КАК Т ГДЕ Т.ВидПрочихДоходовИРасходов = &ВидПДРСписание)
				   |			) КАК ХозрасчетныйОборотыДтКт
	               |
	               |ИНДЕКСИРОВАТЬ ПО
	               |	Контрагент,
	               ...
	               |ИЗ
	               |	ВТ_ВсеСФВыданныеПереопределяемый КАК ВТ_ВсеСФВыданные
	               |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТ_ДолгосрочныеДоговоры КАК ВТ_ДолгосрочныеДоговоры
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5560и5580(КонтекстВыполнения, НомерСтроки)
	...
	СчетаАвансов  = "62.02, 62.22, 62.32";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаАвансов, "РасчетыВСчетОтгрузки");
	СчетаНДСАвансов = "76.АВ";
	СчетаРасчетовПоНалогам = "68.01.1, 68.01.2, 68.02, 68.03, 68.04.1, 68.06, 68.07, 68.08, 68.09, 68.10, 68.11, 68.12, 68.13, 68.15, 68.32, 68.42, 68.52, 68.90,
	                         |69.01, 69.02.1, 69.02.2, 69.02.3, 69.02.4, 69.02.5, 69.02.6, 69.02.7, 69.03.1, 69.03.2,
	                         |69.04, 69.05.1, 69.05.2, 69.06.1, 69.06.2, 69.06.3, 69.06.4, 69.06.5, 69.09, 69.11, 69.12, 69.13.1, 69.13.2";
	СчетаШтрафыПени = "68.01.1, 68.01.2, 68.02, 68.03, 68.04.1, 68.06, 68.07, 68.08, 68.09, 68.10, 68.11, 68.12, 68.13, 68.15, 68.32, 68.42, 68.52, 68.90,
	                  |69.01, 69.02.1, 69.02.2, 69.02.3, 69.02.4, 69.02.5, 69.02.6, 69.02.7, 69.03.1, 69.03.2, 69.04,
	                  |69.05.1, 69.05.2, 69.06.1, 69.06.2, 69.06.3, 69.06.4, 69.06.5, 69.09, 69.11, 69.12";
	СчетаКредитов = "66.01, 66.02, 66.21, 66.22, 67.01, 67.02, 67.21, 67.22";
	СчетаЗаймов = "66.03, 66.23, 66.04, 66.24, 67.03, 67.04, 67.23, 67.24";
	СчетаЦенныхБумаг = "";
	ВидыСубконто = "ДолгосрочныеЦенныеБумаги, КраткосрочныеЦенныеБумаги, ДолгосрочныеЦенныеБумагиПроценты, КраткосрочныеЦенныеБумагиПроценты";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаЦенныхБумаг, ВидыСубконто);
	СчетаПрочие = "70, 71.01, 71.21, 73.03, 75.02, 76.01.1, 76.21, 76.03, 76.04, 76.09, 76.29, 76.39, 76.49, 76.41, 76.НА, 76.07.2";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПрочие, "Лизинг, РаботникиОрганизаций");
	...
	СчетаПеревода = "76.01.1, 76.03, 76.21, 76.05, 76.25, 76.35, 76.06, 76.26, 76.36, 68.01.1, 68.01.2, 68.02, 68.03, 68.04.1, 68.06, 68.07, 68.08, 68.09, 68.10, 68.11, 68.12, 68.13,
	                |68.15, 68.90, 69.01, 69.02.1, 69.02.2, 69.02.3, 69.02.4, 69.02.5, 69.02.6, 69.02.7, 69.03.1, 69.03.2, 69.04, 69.05.1, 69.05.2,
	                |69.06.1, 69.06.2, 69.06.3, 69.06.4, 69.06.5, 69.09, 69.11, 69.12, 69.13.1, 69.13.2,
	                |70, 71.01, 71.21, 73.03, 76.09, 76.29, 76.39, 76.49, 76.41, 76.НА, 76.07.2";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПеревода, "Лизинг, РаботникиОрганизаций");
	...
	Если УчитыватьСчетаИП2015 Тогда
		СчетаРасчетовПоНалогам = СтрЗаменить(СчетаРасчетовПоНалогам, "68.01.2", "68.01.2, 68.21");
		ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаРасчетовПоНалогам, "ВидыПлатежейВГосБюджет");
		СчетаШтрафыПени = СтрЗаменить(СчетаШтрафыПени, "68.01.2", "68.01.2, 68.21");
		ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаШтрафыПени, "ВидыПлатежейВГосБюджет");
		СчетаПеревода = СтрЗаменить(СчетаПеревода, "68.01.2", "68.01.2, 68.21");
		ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПеревода, "ВидыПлатежейВГосБюджет");
	КонецЕсли;
	...
	СчетаГрафы05 = СчетаРасчетов + ", "
	             ...
	             + СчетаПрочие;
	Если КонтекстВыполнения.КонтекстРаздела.ДатаНачалаПериодаОтчета >= '2015-10-01' Тогда
		ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы05, "КраткосрочныеЦенныеБумаги");
	КонецЕсли;
	СчетаГрафы06 = СчетаРасчетов + ", "
	             + СчетаАвансов + ", "
	             + СчетаШтрафыПени + ", "
	             ...
	             + "70, 76.09, 76.29, 76.39, 76.07.2";
	Если КонтекстВыполнения.КонтекстРаздела.ДатаНачалаПериодаОтчета >= '2015-10-01' Тогда
		ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы06, "ДолгосрочныеЦенныеБумагиПроценты, КраткосрочныеЦенныеБумагиПроценты");
	КонецЕсли;
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы06, "РаботникиОрганизаций, Лизинг");
	...
	СчетаГрафы08 = СчетаРасчетов + ", "
	             ...
	             + "70, 71.01, 71.21, 73.03, 75.02, 76.01.1, 76.21, 76.04, 76.09, 76.29, 76.39, 76.07.2";
	Если КонтекстВыполнения.КонтекстРаздела.ДатаНачалаПериодаОтчета >= '2015-10-01' Тогда
		ВидыСубконто = "КраткосрочныеЦенныеБумаги, КраткосрочныеЦенныеБумагиПроценты, ДолгосрочныеЦенныеБумагиПроценты";
		ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы08, ВидыСубконто);
	КонецЕсли;
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы08, "РаботникиОрганизаций, Лизинг");
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5561и5581(КонтекстВыполнения, НомерСтроки)
	...
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаРасчетов, "НеотфактурованныеПоставки");
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5562и5582(КонтекстВыполнения, НомерСтроки)
	...
	СчетаАвансов  = "62.02, 62.22, 62.32, 76.06, 76.26, 76.36";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаАвансов, "РасчетыВСчетОтгрузки");
	СчетаНДСАвансов = "76.АВ";
	СчетаПеревода = "76.06, 76.26, 76.36";
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5565и5585(КонтекстВыполнения, НомерСтроки)
	...
	СчетаЗаймов = "66.03, 66.23, 66.04, 66.24, 67.03, 67.04, 67.23, 67.24";
	СчетаЦенныхБумаг = "";
	ВидыСубконто = "КраткосрочныеЦенныеБумаги, ДолгосрочныеЦенныеБумаги, КраткосрочныеЦенныеБумагиПроценты, ДолгосрочныеЦенныеБумагиПроценты";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаЦенныхБумаг, ВидыСубконто);
	...
	Если КонтекстВыполнения.КонтекстРаздела.ДатаНачалаПериодаОтчета >= '2015-10-01' Тогда
		...
		ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы06, "ДолгосрочныеЦенныеБумагиПроценты, КраткосрочныеЦенныеБумагиПроценты");
		СчетаГрафы07 = СчетаГрафы07 + ", " + СчетаЦенныхБумаг;
		ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы08, "КраткосрочныеЦенныеБумаги, ДолгосрочныеЦенныеБумагиПроценты, КраткосрочныеЦенныеБумагиПроценты");
		СчетаГрафы10 = СчетаГрафы10 + ", " + СчетаЦенныхБумаг;
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5566и5586(КонтекстВыполнения, НомерСтроки)
	...
	СчетаПрочие = "70, 71.01, 71.21, 73.03, 75.02, 76.01.1, 76.21, 76.03, 76.04, 76.09, 76.29, 76.39, 76.49, 76.41, 76.НА, 76.07.2";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПрочие, "РаботникиОрганизаций, Лизинг, ТоварыКОформлениюОтчетовКомитенту");
	
	СчетаПеревода = "70, 71.01, 71.21, 73.03, 76.01.1, 76.03, 76.21, 76.09, 76.29, 76.39, 76.49, 76.41, 76.НА, 76.07.2";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПеревода, "РаботникиОрганизаций, Лизинг");
	
	СчетаГрафы04 = СчетаПрочие;
	СчетаГрафы05 = СчетаПрочие;
	СчетаГрафы06 = "70, 76.09, 76.29, 76.39, 76.07.2";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы06, "РаботникиОрганизаций, Лизинг");
	СчетаГрафы07 = СчетаПрочие;
	СчетаГрафы08 = "70, 71.01, 71.21, 73.03, 75.02, 76.01.1, 76.21, 76.04, 76.09, 76.29, 76.39, 76.07.2";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы08, "РаботникиОрганизаций, Лизинг");
	СчетаГрафы10 = СчетаПрочие;
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения53_Краткосрочная(КонтекстВыполнения)
	...
	СчетаЦенныхБумаг = "";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаЦенныхБумаг, "ДолгосрочныеЦенныеБумаги, КраткосрочныеЦенныеБумаги");
	Для каждого Счет Из ЗаполнениеБухгалтерскойОтчетности.СчетаИзСписка(СчетаЦенныхБумаг) Цикл
		Запрос.УстановитьПараметр("Счет_"+СтрЗаменить(Счет, ".", "_"), Счет(Счет));
	КонецЦикла;
	...
	Запрос.Текст = ТекстЗапросаПояснения53_Краткосрочная();
	УстановитьПолныйТекстЗапроса(Запрос);
	Запрос.Выполнить();
	...
	СчетаИсключенияСтрокой = "66.02, 66.22, 67.02, 67.22, 66.04, 66.24, 67.04, 67.24";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаИсключенияСтрокой, "КраткосрочныеЦенныеБумагиПроценты, ДолгосрочныеЦенныеБумагиПроценты");
	СчетаИсключения = СчетаИзСписка(СчетаИсключенияСтрокой);
...
Функция ТекстЗапросаПояснения53_Краткосрочная()
	...
	ТекстЗапроса = "ВЫБРАТЬ
	               ...
	               |ИЗ
	               |	ВТ_ПереводыВКраткосрочныеПереопределяемый КАК ПереводыВКраткосрочные
	               |
	               |СГРУППИРОВАТЬ ПО
	               |	ПереводыВКраткосрочные.Контрагент,
	               |	ПереводыВКраткосрочные.Счет,
	               ...
	               |			&СубконтоКонтрагентыДоговоры,
	               |			Организация = &Организация
	               |				И СубконтоДт1 В (ВЫБРАТЬ Т.Ссылка ИЗ ТаблицаПрочиеДоходыИРасходыПереопределяемый КАК Т ГДЕ Т.ВидПрочихДоходовИРасходов = &ВидПДРНачисление)
				   |			) КАК ХозрасчетныйОборотыДтКт
	               |
	               |ИНДЕКСИРОВАТЬ ПО
	               |	Контрагент,
...
Функция СпособыОбработкиСчетовПояснений5()
	...
	СчетаСтрокой = "";
	ВидыСубконто = "РасчетыВСчетОтгрузки, НДСПоАренде, Факторинг, АвансыВыданные";
	...
	СчетаСтрокой = "";
	ВидыСубконто = "НеотфактурованныеПоставки";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаСтрокой, ВидыСубконто);
	СтруктураДополнительныхСписковСчетов.Вставить("ОсобыеСчетаПоСрочности", СчетаСтрокой);
	...
	СчетаСтрокой = "";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаСтрокой, "Аренда");
	СтруктураДополнительныхСписковСчетов.Вставить("СчетаПоКонтрагентамДоговорам", СчетаСтрокой);
	...
	СчетаСтрокой = "";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаСтрокой, "Билеты, ТоварыКОформлениюОтчетовКомитенту");
	СтруктураДополнительныхСписковСчетов.Вставить("СчетаБезОбработки", СчетаСтрокой);
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения6ПоГрафе(КонтекстВыполнения, Графа, ЗаголовокГрафы, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета)
	...
	Если ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.РасходыУчитываютсяПоЭлементамЗатрат(ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета, Организация) Тогда
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения6ПоЭЗ(КонтекстВыполнения, Графа, ЗаголовокГрафы, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета)
	...
	СчетаУчетаЗатрат = ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ПредопределенныеСчетаРасходов();
	...
	Для Каждого ЭлементЗатрат Из ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ПредопределенныйЭлемент("Перечисление.ЭлементыЗатрат") Цикл
		СтруктураОборотов.Вставить(ЭлементЗатрат, 0);
	КонецЦикла;
	ПустойЭлементЗатрат = ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ПредопределенныйЭлемент("Перечисление.ЭлементыЗатрат.ПустаяСсылка");
	СтруктураОборотов.Вставить(ПустойЭлементЗатрат, 0);
	...
	ВидСубконтоЭлементыЗатрат = ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ПредопределенныйЭлемент("ПланВидовХарактеристик.ВидыСубконтоХозрасчетные.ЭлементыЗатрат");
	...
	ЭлементЗатрат = ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ПредопределенныйЭлемент("Перечисление.ЭлементыЗатрат.МатериальныеЗатраты");
	...
	ЭлементЗатрат = ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ПредопределенныйЭлемент("Перечисление.ЭлементыЗатрат.ОплатаТруда");
	ЗначениеПоказателя = СтруктураОборотов[ЭлементЗатрат];
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, ИмяОбластиПоказателя, ЗначениеПоказателя);
	...
	ЭлементЗатрат = ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ПредопределенныйЭлемент("Перечисление.ЭлементыЗатрат.ОтчисленияНаСоциальныеНужды");
	ЗначениеПоказателя = СтруктураОборотов[ЭлементЗатрат];
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, ИмяОбластиПоказателя, ЗначениеПоказателя);
	...
	ЭлементЗатрат = ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ПредопределенныйЭлемент("Перечисление.ЭлементыЗатрат.Амортизация");
	ЗначениеПоказателя = СтруктураОборотов[ЭлементЗатрат];
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, ИмяОбластиПоказателя, ЗначениеПоказателя);
	...
	ЭлементЗатрат = ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ПредопределенныйЭлемент("Перечисление.ЭлементыЗатрат.ПрочиеЗатраты");
	ЗначениеПоказателя = СтруктураОборотов[ЭлементЗатрат];
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, ИмяОбластиПоказателя, ЗначениеПоказателя);
	...
	Если КонтекстВыполнения.ПрисутствуетСтрока5665 Тогда
		...
		ЭлементЗатрат = ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ПредопределенныйЭлемент("Перечисление.ЭлементыЗатрат.ПустаяСсылка");
		ЗначениеПоказателя = СтруктураОборотов[ЭлементЗатрат];
		УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, ИмяОбластиПоказателя, ЗначениеПоказателя);
...
Функция НастройкиАнализаСубконтоЭлементыЗатрат(ОбщиеНастройки, Субконто, Счета = Неопределено)
	...
	СписокВидовСубконто.Добавить(ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ПредопределенныйЭлемент("ПланВидовХарактеристик.ВидыСубконтоХозрасчетные.ЭлементыЗатрат"));
...
Процедура УстановитьПолныйТекстЗапроса(ИсходныйЗапрос)
...
// Конструктор контекста заполнения разделов.
// 
