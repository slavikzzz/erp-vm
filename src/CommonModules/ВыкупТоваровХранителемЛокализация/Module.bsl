...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	ТекстыОтражения.Добавить(ТекстСебестоимостьРеализованногоТовара()); // Себестоимость реализованного товара (Дт 90.02.1 :: Кт 45.01)
	ТекстыОтражения.Добавить(ТекстВыручкаОтРеализацииСобственногоТовара()); // Выручка от реализации собственного товара (Дт 62.01 :: Кт 90.01.1)
	ТекстыОтражения.Добавить(ТекстНДССРеализации()); // НДС с реализации (Дт 90.03 :: Кт 68.02)
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	|	ПО
	|		ВыручкаИСебестоимость.Ссылка = Строки.Ссылка
	|		И ВыручкаИСебестоимость.ИдентификаторФинЗаписи = Строки.ИдентификаторФинЗаписи
	|		И ВыручкаИСебестоимость.НастройкаХозОперации = Строки.НастройкаХозяйственнойОперации
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ 
	|		УчетнаяПолитикаОрганизаций КАК УчетнаяПолитикаОрганизаций
	|	ПО 
...
Функция ТекстСебестоимостьРеализованногоТовара()
	...
	|	ВыручкаИСебестоимость.ГруппаФинансовогоУчета КАК ГруппаФинансовогоУчетаДт,
	...
	|	ВыручкаИСебестоимость.Номенклатура КАК СубконтоДт3,
	|
