...
Процедура ПриДобавленииОписанийСервисовСопровождения(СервисыСопровождения) Экспорт
	...
	ОписательСервиса.Описание        = НСтр("ru = 'Оценка надежности и мониторинг контрагентов в программах 1С
		...
		|en = 'Reliability evaluation and monitoring of counterparties in 1C applications
		|help you make a better decision on the matter of cooperation and minimize tax risks.'");
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий         = НСтр("ru = '1СПАРК Риски. Начальное заполнение.';
											|en = '1C-SPARK Risks. Initial filling'");
	...
	Обработчик.Комментарий         = НСтр("ru = '1СПАРК Риски. Переход на версию 2.1.7.11';
											|en = '1C-SPARK Risks. Migration to version 2.1.7.11'");
	Обработчик.РежимВыполнения     = "Оперативно";
	...
	Обработчик.Комментарий         = НСтр("ru = '1СПАРК Риски. Переход на версию 2.1.8.15';
											|en = '1C-SPARK Risks. Migration to version 2.1.8.15'");
	Обработчик.РежимВыполнения     = "Оперативно";
	...
	Обработчик.Комментарий         = НСтр("ru = '1СПАРК Риски. Актуализировать описание типов событий';
											|en = '1C-SPARK Risks. Update event type description'");
	Обработчик.РежимВыполнения     = "Оперативно";
	...
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		...
		Обработчик.Комментарий         = НСтр("ru = '1СПАРК Риски. Заполнение разделенных обработчиков';
												|en = '1CSPARK Risks. Fill in separated handlers'");
	Иначе
		Обработчик = Обработчики.Добавить();
		Обработчик.Версия              = "*";
		Обработчик.Процедура           = "СПАРКРиски.НачальноеЗаполнениеДанныхСПАРКРиски";
		...
		Обработчик.Комментарий         = НСтр("ru = '1СПАРК Риски. Переход на новую версию';
												|en = '1C-SPARK Risks. Migration to a new version'");
		Обработчик.РежимВыполнения     = "Оперативно";
	КонецЕсли;
	...
	Обработчик.Комментарий         = НСтр("ru = '1СПАРК Риски. Переход на версию 2.1.7.10';
											|en = '1C-SPARK Risks. Migration to version 2.1.7.10'");
	Обработчик.РежимВыполнения     = "Оперативно";
	...
	Обработчик.Комментарий         = НСтр("ru = '1СПАРК Риски. Переход на версию 2.1.9.2';
											|en = '1C-SPARK Risks. Migration to version 2.1.9.2'");
	Обработчик.РежимВыполнения     = "Оперативно";
	...
	Обработчик.Комментарий         = НСтр("ru = '1СПАРК Риски. Заполнение новых ресурсов регистра ИндексыСПАРКРиски';
											|en = '1C-SPARK Risks. Fill in new resources of the ИндексыСПАРКРиски register'");
	...
	Обработчик.Комментарий         = НСтр("ru = '1СПАРК Риски. Заполнение данных индивидуальных предпринимателей';
											|en = '1C-SPARK Risks. Fill in data of individual entrepreneurs'");
	Обработчик.РежимВыполнения     = "Отложенно";
	...
	Если Не ОбщегоНазначения.РазделениеВключено() Тогда
		...
		Обработчик.Комментарий         = НСтр("ru = '1СПАРК Риски. Заполнение новых полей типов событий';
												|en = '1C-SPARK Risks. Fill in new event type fields'");
		Обработчик.РежимВыполнения     = "Отложенно";
	...
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		...
		Обработчик.Комментарий         = НСтр("ru = '1СПАРК Риски. Установка свойств для типа события Действующее';
												|en = '1C-SPARK Risks. Set properties for the Active event type'");
		Обработчик.РежимВыполнения     = "Оперативно";
	КонецЕсли;
...
Процедура ПриЗаполненииРазрешенийНаДоступКВнешнимРесурсам(ЗапросыРазрешений) Экспорт
	...
	Разрешение = МодульРаботаВБезопасномРежиме.РазрешениеНаИспользованиеИнтернетРесурса(
		...
		НСтр("ru = 'Сервис 1СПАРК Риски (зона ru)';
			|en = '1C-SPARK Risks service (ru zone)'"));
				...
				НаименованиеДела =
					СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru = '1СПАРК Риски. Критичных событий мониторинга %1';
							|en = '1C-SPARK Risks. Critical events of %1 monitoring '"),
						КоличествоСобытий);
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	НастройкиВарианта.Описание =
		НСтр("ru = 'Просмотр событий мониторинга 1СПАРК Риски по контрагентам за последние 15 дней.';
			|en = 'View 1C-SPARK Risks monitoring events for the last 15 days.'");
	...
	Если ОтчетНадежностьВходящегоНДС <> Неопределено Тогда
		...
		НастройкиВарианта.Описание = НСтр("ru = 'Данные входящего НДС с индексами 1СПАРК Риски по контрагентам.';
											|en = 'VAT input data with 1C-SPARK Risks indexes by counterparties.'");
	КонецЕсли;
	...
	Если ОтчетНадежностьДебиторов <> Неопределено Тогда
		...
		НастройкиВарианта.Описание =
			НСтр("ru = 'Данные дебиторской задолженности с индексами 1СПАРК Риски по контрагентам.';
				|en = 'Accounts receivable data with 1C-SPARK Risks indexes by counterparties.'");
	КонецЕсли;
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Обработка поставляемых данных не выполнена.
				|Поставляемые данные:
				|%1';
				|en = 'Supplied data is not processed.
				|Supplied data:
				|%1'"),
...
Процедура ПриФормированииСпискаУслуг(Услуги) Экспорт
	...
	НоваяУслуга.Вставить("Наименование" , НСтр("ru = 'Индикаторы риска для компаний';
												|en = 'Indicators of risk for companies'"));
...
Функция СвойстваСправочниковКонтрагентов() Экспорт
	...
	Если Результат.Количество() = 0 Тогда
		ВызватьИсключение НСтр("ru = 'Не удалось определить свойства справочника Контрагенты.
			...
			|method implementation of the СПАРКРискиПереопределяемый common module is required.'");
	КонецЕсли;
			...
			Если ОписаниеСправочника = Неопределено Тогда
				ТекстИсключения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Неизвестный тип справочника контрагентов (%1). Описание справочника отсутствует в методе
						...
						|en = 'Unknown counterparty catalog type (%1).
						|Catalog description is missing in the ПриОпределенииСвойствСправочниковКонтрагентов() method of the СПАРКРискиПереопределяемый common module.'"),
					Строка(ТипЭлемента));
...
Функция ИмяСобытияЖурналаРегистрации() Экспорт
	...
	Возврат НСтр("ru = '1СПАРК Риски';
				|en = '1C-SPARK Risks'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ДобавитьОтключенноеДело(ТекущиеДела, ИдентификаторДела, Раздел, ПараметрыФормы)
	...
	Дело.Представление  = НСтр("ru = '1СПАРК Риски. Критичные события мониторинга';
								|en = '1C-SPARK Risks. Critical monitoring events'");
...
Функция ТекстСтатусаПрекратилДеятельность() Экспорт
	...
	Возврат НСтр("ru = 'Контрагент прекратил деятельность';
				|en = 'Counterparty ceased activity'");
...
Процедура ЗапуститьФоновоеЗаданиеИндексыСПАРК(
	...
	Результат.АдресХранилищаФоновогоЗадания = АдресХранилищаФоновогоЗадания;
	...
	Если ОбщегоНазначения.ИнформационнаяБазаФайловая() Тогда
		...
		ТекущиеФоновыеЗаданияПоКлючу = ФоновыеЗадания.ПолучитьФоновыеЗадания(Отбор);
		Если ТекущиеФоновыеЗаданияПоКлючу.Количество() > 0 Тогда
			ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Загрузка индексов СПАРК Риски для контрагента с ИНН %1 отменена.
					|Предыдущее фоновое задание для получения индексов СПАРК Риски по ИНН %1 еще выполняется.';
					|en = 'Importing 1C-SPARK Risks indexes for the counterparty with TIN %1 is canceled.
					|The previous background job for obtaining C-SPARK Risks indexes for TIN %1 is still in progress.'"),
				КонтрагентИНН);
			ЗаписатьИнформациюВЖурналРегистрации(
				ТекстОшибки);
			Результат.ТекстОшибки = ТекстОшибки;
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания =
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Загрузка индексов СПАРК Риски для контрагента %1 с ИНН %2';
				|en = 'Import indexes of 1C-SPARK Risks for the %1 counterparty with TIN %2'"),
			Контрагент,
			КонтрагентИНН);
	
	ПараметрыВыполнения.КлючФоновогоЗадания = КлючФоновогоЗадания;
	ПараметрыВыполнения.АдресРезультата     = АдресХранилищаФоновогоЗадания;
	...
	Если РезультатЗапускаФоновогоЗадания.Статус = "Выполняется" Тогда
		...
		Результат.СостояниеЗагрузкиДанных = Перечисления.СостоянияЗагрузкиИндексовСПАРКРиски.ЗапущеноФоновоеЗадание;
	...
	ИначеЕсли РезультатЗапускаФоновогоЗадания.Статус = "Выполнено" Тогда
		...
		Если РезультатВыполненияФоновогоЗадания <> Неопределено Тогда
			...
			ВидыОшибокСПАРКРиски = Перечисления.ВидыОшибокСПАРКРиски;
			Если Результат.ВидОшибки = ВидыОшибокСПАРКРиски.ПустаяСсылка() Тогда
				Результат.ВидОшибки = ВидОшибкиФоновогоЗадания;
			Иначе
				// Некоторые виды общих ошибок приоритетнее локальных ошибок по каждому ИНН.
				Если (ВидОшибкиФоновогоЗадания = ВидыОшибокСПАРКРиски.ВнутренняяОшибкаСервиса)
						ИЛИ (ВидОшибкиФоновогоЗадания = ВидыОшибокСПАРКРиски.ИнтернетПоддержкаНеПодключена)
						ИЛИ (ВидОшибкиФоновогоЗадания = ВидыОшибокСПАРКРиски.ИспользованиеЗапрещено)
						ИЛИ (ВидОшибкиФоновогоЗадания = ВидыОшибокСПАРКРиски.ИспользованиеОтключено)
						ИЛИ (ВидОшибкиФоновогоЗадания = ВидыОшибокСПАРКРиски.ОшибкаАутентификации)
						ИЛИ (ВидОшибкиФоновогоЗадания = ВидыОшибокСПАРКРиски.ОшибкаПодключения)
						ИЛИ (ВидОшибкиФоновогоЗадания = ВидыОшибокСПАРКРиски.ПревышеноКоличествоПопытокАутентификации)
						ИЛИ (ВидОшибкиФоновогоЗадания = ВидыОшибокСПАРКРиски.ТребуетсяОплатаИлиПревышенЛимит) Тогда
					Результат.Вставить("ВидОшибки", ВидОшибкиФоновогоЗадания);
				КонецЕсли;
			КонецЕсли;
			Результат.ТекстОшибки           = РезультатВыполненияФоновогоЗадания.СообщениеОбОшибке;
			Результат.СостояниеВыводаДанных = Перечисления.СостоянияВыводаИндексовСПАРКРиски.ПолученоИзФоновогоЗадания;
		Иначе
			Результат.ВидОшибки               = Перечисления.ВидыОшибокСПАРКРиски.НеизвестнаяОшибка;
			Результат.ТекстОшибки             = НСтр("ru = 'Ошибка получения индексов СПАРК Риски';
													|en = 'An error occurred while receiving 1C-SPARK Risks indexes'");
			Результат.ДатаОбновления          = ТекущаяДатаСеанса();
			Результат.СостояниеЗагрузкиДанных = Перечисления.СостоянияЗагрузкиИндексовСПАРКРиски.ОшибкаФоновогоЗадания;
		КонецЕсли;
	ИначеЕсли РезультатЗапускаФоновогоЗадания.Статус = "Ошибка" Тогда
		Результат.ТекстОшибки             = РезультатЗапускаФоновогоЗадания.ПодробноеПредставлениеОшибки;
		Результат.СостояниеЗагрузкиДанных = Перечисления.СостоянияЗагрузкиИндексовСПАРКРиски.ОшибкаФоновогоЗадания;
	ИначеЕсли РезультатЗапускаФоновогоЗадания.Статус = "Отменено" Тогда
		...
		Результат.СостояниеЗагрузкиДанных = Перечисления.СостоянияЗагрузкиИндексовСПАРКРиски.ОтменаФоновогоЗадания;
	КонецЕсли;
	...
	Если Не ИспользованиеСПАРКРискиВключено() Тогда
		ЗаписатьИнформациюВЖурналРегистрации(
			НСтр("ru = 'Проверка надежности контрагентов в сервисе 1СПАРК Риски отключена.
				...
				|en = 'Counterpary reliability check in 1C-SPARK Risks service is disabled.
		...
		ЗаписатьИнформациюВЖурналРегистрации(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Проверка надежности контрагентов в сервисе 1СПАРК Риски отключена.
					...
					|en = 'Counterparty reliability check in 1C-SPARK Risks is disabled.
					|Information sheet readiness check job canceled.
					|Information sheet ID %1'"),
...
Процедура ОбновлениеИнформационнойБазы_ОчиститьРезультатыПостановкиНаМониторинг_2_1_9_2() Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Очистка результатов постановки на мониторинг в области данных при переходе на версию 2.1.9.2.';
			|en = 'Clear monitoring results in the data area while migrating to version 2.1.9.2.'"));
	СПАРКРискиМониторингСобытий.ОчиститьРезультатыПостановкиНаМониторинг();
...
Процедура ЗаполнитьНовыеРесурсыИндексыСПАРКРиски(Параметры) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало заполнения ресурсов регистра сведений ИндексыСПАРКРиски.';
			|en = 'Start filling in resources of the ИндексыСПАРКРиски information register.'"));
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено заполнение ресурсов регистра сведений ИндексыСПАРКРиски.';
			|en = 'Filling of resources of the ИндексыСПАРКРиски information register complete.'"));
...
Процедура ОбновлениеИнформационнойБазы_АктуализироватьОписаниеТиповСобытий() Экспорт
	...
	НаименованиеТипаСобытия1  = НСтр("ru = 'Отменено дело о банкротстве';
									|en = 'Bankruptcy case is canceled'");
	...
	НаименованиеТипаСобытия2  = НСтр("ru = 'Прекращено дело о банкротстве';
									|en = 'Bankruptcy case is terminated'");
...
Процедура ЗаполнитьДанныеИндивидуальныхПредпринимателей(Параметры) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало заполнения данных ИП в подсистеме.';
			|en = 'Start filling in IE data in the subsystem.'"));
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено заполнение ИП в подсистеме.';
			|en = 'IE data in the subsystem has been filled in.'"));
...
Процедура ЗаполнитьНовыеПоляТиповСобытий(Параметры) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало обновления данных типов событий.';
			|en = 'Start updating event type data.'"));
	...
	Если Не РезультатВызова.ВидОшибки.Пустая() Тогда
		ЗаписатьОшибкуВЖурналРегистрации(
			НСтр("ru = 'Не удалось обновить типы событий.';
				|en = 'Cannot update event types.'") + Символы.ПС
...
Процедура ЗаполнениеДанныхСПАРКРискиЮридическихЛиц()
	...
	Если ПараметрыЗаполнения.ЗапросСвойствКонтрагентов = Неопределено Тогда
		...
		ВызватьИсключение НСтр("ru = 'Не заполнена реализация переопределяемого метода
			...
			|en = 'Implementation of overridable method
			|СПАРКРискиПереопределяемый.ПараметрыНачальногоЗаполненияДанных1СПАРКРискиЮридическихЛиц() is required.
			|The ПараметрыЗаполнения.ЗапросСвойствКонтрагентов field value is not defined.'");
...
Процедура ЗаполнениеДанныхСПАРКРискиИндивидуальныхПредпринимателей()
	...
	Если ПараметрыЗаполнения.ЗапросСвойствКонтрагентов = Неопределено Тогда
		...
		ВызватьИсключение НСтр("ru = 'Не заполнена реализация переопределяемого метода
			...
			|Не определено значение поля ПараметрыЗаполнения.ЗапросСвойствКонтрагентов.';
			|en = 'Implementation of overridable method
			|СПАРКРискиПереопределяемый.ПараметрыНачальногоЗаполненияДанных1СПАРКРискиИндивидуальныхПредпринимателей() is required.
			|The ПараметрыЗаполнения.ЗапросСвойствКонтрагентов field value is not defined.'");
...
Функция ТекстУведомленияЗавершаетсяСрокДействияСервиса(ДополнительныеПараметры)
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Срок действия 1СПАРК Риски заканчивается %1 года.';
				|en = '1C-SPARK Risks expires in %1.'"),
...
Функция ТекстУведомленияЗаканчиваютсяСчетныеОпции(ДополнительныеПараметры)
	...
	Если ДополнительныеПараметры.ИдентификаторОпции = ИдентификаторУслугиСправкиПоКомпаниям() Тогда
		Возврат НСтр("ru = 'Скоро будет превышен лимит на получение бизнес-справок по контрагентам.';
					|en = 'The limit for receiving business information sheets by counterparty will soon be exceeded.'");
	ИначеЕсли ДополнительныеПараметры.ИдентификаторОпции = ИдентификаторУслугиВебКарточкиПоКомпаниям() Тогда
		Возврат НСтр("ru = 'Скоро будет превышен лимит переходов в веб-карточки СПАРК по контрагентам.';
					|en = 'The limit for going to SPARK web profiles by counterparty will soon be exceeded.'");
	Иначе
		Возврат НСтр("ru = 'Скоро будет превышен лимит в сервисе 1СПАРК Риски.';
					|en = 'The limit in the 1C-SPARK Risks service will soon be exceeded.'");
	КонецЕсли;
...
Функция ПодробныйТекстУведомленияЗавершаетсяСрокДействияСервиса(ДополнительныеПараметры)
	...
	Возврат СтроковыеФункции.ФорматированнаяСтрока(
			НСтр("ru = '1СПАРК Риски действует <b>до %1</b>. Для продления доступа обратитесь к своему обслуживающему партнеру 1С или к любому партнеру в <a href = ""https://its.1c.ru/zakaz"">вашем регионе</a>.';
				|en = '1C-SPARK Risks is valid <b>until %1</b>. To renew access, contact the 1C partner which serves you or any other partner in <a href = ""https://its.1c.ru/zakaz"">your region</a>.'"),
			Формат(ДополнительныеПараметры.ДатаОкончания, "ДЛФ=D"));
	...
	Если ДополнительныеПараметры.ИдентификаторОпции = ИдентификаторУслугиСправкиПоКомпаниям() Тогда
		Возврат СтроковыеФункции.ФорматированнаяСтрока(
			НСтр("ru = 'Заканчивается доступное количество контрагентов, по которым можно получать бизнес-справки в сервисе 1СПАРК Риски. Для увеличения количества доступных бизнес-справок по контрагентам обратитесь к своему обслуживающему партнеру 1С или к любому партнеру в <a href = ""https://its.1c.ru/zakaz"">вашем регионе</a>.';
				|en = 'You are running out of available counterparties for which you can receive business information sheets in the 1C-SPARK Risks service. To increase the number of available number of business information sheets by counterparties, contact the 1C partner which serves you or any partner in <a href = ""https://its.1c.ru/zakaz"">your region</a>.'"));
	ИначеЕсли ДополнительныеПараметры.ИдентификаторОпции = ИдентификаторУслугиВебКарточкиПоКомпаниям() Тогда
		Возврат СтроковыеФункции.ФорматированнаяСтрока(
			НСтр("ru = 'Заканчивается доступное количество контрагентов, по которым можно переходить в веб-карточки в сервисе 1СПАРК Риски. Для увеличения количества доступных веб-карточек по контрагентам обратитесь к своему обслуживающему партнеру 1С или к любому партнеру в <a href = ""https://its.1c.ru/zakaz"">вашем регионе</a>.';
				|en = 'You are running out of available counterparties you can use to go to web profiles in the 1C-SPARK Risks service. To increase the number of available counterparty web profiles, contact the 1C partner which serves you or any partner in <a href = ""https://its.1c.ru/zakaz"">your region</a>.'"));
	КонецЕсли;
...
Функция ОднострочныйТекстУведомленияЗавершаетсяСрокДействияСервиса(ДополнительныеПараметры)
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = '1СПАРК Риски заканчивается %1.';
			|en = '1C-SPARK Risks expires on %1.'"),
