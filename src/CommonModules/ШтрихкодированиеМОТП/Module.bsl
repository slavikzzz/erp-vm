...
Процедура ДополнитьДанныеПоШтрихкодамСпецификой(ДанныеПоШтрихкодам, ПараметрыСканирования, ПараметрыДополнения = Неопределено) Экспорт
	...
	Если МассивСтрокБезЗапросаСтатусовМОТП.Количество() Тогда
		ДополнитьДанныеПоШтрихкодамСпецификойБезЗапросаСтатусовМОТП(ДанныеПоШтрихкодам, ПараметрыСканирования, МассивСтрокБезЗапросаСтатусовМОТП);
	КонецЕсли;
...
Процедура ЗаполнитьДанныеНеизвестныхУпаковок(ДанныеПоШтрихкодам, ПараметрыСканирования) Экспорт
	...
	Если МассивСтрокТаблицыСЗапросомИСМП.Количество() Тогда
		...
		Результат = ДеревоУпаковокПоДаннымМОТП(МассивСтрокТаблицыСЗапросомИСМП, ПараметрыСканирования);
...
Процедура ДополнитьДанныеПоШтрихкодамСпецификойБезЗапросаСтатусовМОТП(ДанныеПоШтрихкодам, ПараметрыСканирования, МассивСтрок = Неопределено)
