...
Процедура ЗаполнитьСведенияОПерсональныхДанных(ТаблицаСведений) Экспорт
	...
	НовыеСведения.ПоляРегистрации	= "НачисленнаяЗарплатаИВзносыПоФизлицам.ФизическоеЛицо,НачисленныйНДФЛ.ФизическоеЛицо,УдержаннаяЗарплата.ФизическоеЛицо";
	НовыеСведения.ПоляДоступа		= "НачисленнаяЗарплатаИВзносыПоФизлицам.Сумма,НачисленныйНДФЛ.Сумма,УдержаннаяЗарплата.Сумма";
...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	Раздел.Представление = НСтр("ru = 'Финансовый учет зарплаты';
								|en = 'Financial accounting of salary'");
