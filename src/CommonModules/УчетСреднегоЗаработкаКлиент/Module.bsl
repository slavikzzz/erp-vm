...
Процедура РасшифровкаЗначенияПоказателяСреднегоЗаработкаЗавершение(РезультатРедактирования, ДополнительныеПараметры) Экспорт
	...
	Если РезультатРедактирования <> Неопределено Тогда
		...
		Если РезультатРедактирования.Свойство("ЧастичнаяИндексация") Тогда 	
			Если Показатель = ПоказателиСреднегоЗаработка["СреднийЗаработокИндексируемый"] Тогда 
				СреднийЗаработок = РезультатРедактирования.ЧастичнаяИндексация.ИндексируемыйЗаработок;
			ИначеЕсли Показатель = ПоказателиСреднегоЗаработка["СреднийЗаработокНеиндексируемый"] Тогда
				СреднийЗаработок = РезультатРедактирования.ЧастичнаяИндексация.НеиндексируемыйЗаработок;
			ИначеЕсли Показатель = ПоказателиСреднегоЗаработка["СреднийЗаработокИндексируемыйРК"] Тогда 
				СреднийЗаработок = РезультатРедактирования.ЧастичнаяИндексация.ИндексируемыйЗаработокРК;
			ИначеЕсли Показатель = ПоказателиСреднегоЗаработка["СреднийЗаработокНеиндексируемыйРК"] Тогда
				СреднийЗаработок = РезультатРедактирования.ЧастичнаяИндексация.НеиндексируемыйЗаработокРК;
			ИначеЕсли Показатель = ПоказателиСреднегоЗаработка["СреднийЗаработокИндексируемыйСН"] Тогда 
				СреднийЗаработок = РезультатРедактирования.ЧастичнаяИндексация.ИндексируемыйЗаработокСН;
			ИначеЕсли Показатель = ПоказателиСреднегоЗаработка["СреднийЗаработокНеиндексируемыйСН"] Тогда
				СреднийЗаработок = РезультатРедактирования.ЧастичнаяИндексация.НеиндексируемыйЗаработокСН;
			ИначеЕсли Показатель = ПоказателиСреднегоЗаработка["СреднийЗаработокРК"] Тогда
				СреднийЗаработок = РезультатРедактирования.СреднийЗаработокРК;
			ИначеЕсли Показатель = ПоказателиСреднегоЗаработка["СреднийЗаработокСН"] Тогда
				СреднийЗаработок = РезультатРедактирования.СреднийЗаработокСН;	
			Иначе 
