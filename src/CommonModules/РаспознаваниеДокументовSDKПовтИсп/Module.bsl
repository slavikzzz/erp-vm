	...
	Если Не ЗначениеЗаполнено(Результат) Тогда
		Результат = СтрШаблон(
			НСтр("ru = 'Произошла неизвестная ошибка. Код %1.';
				|en = 'An unknown error occurred. Code %1.'"),
			КодОшибки
		);
	КонецЕсли;
...
Функция СоответствиеКодовОшибокТексту()
	...
	Результат.Вставить(
		...
		НСтр("ru = 'Не поддерживаемый формат файла или поврежденное изображение.
		         ...
		         |en = 'Unsupported file format or corrupted image.
		         | Supported formats: tif, jpeg, png, bmp, zip, rar, 7z, pdf, xls, and xlsx.'")
	);
	Результат.Вставить(
		10,
	...
	Результат.Вставить(
		...
		НСтр("ru = 'Ошибка многостраничного документа:
		         ...
		         |en = 'Multipage document error:
		         |Cannot determine the page order.'")
	);
	Результат.Вставить(
		21,
		НСтр("ru = 'Ошибка многостраничного документа:
	...
	Результат.Вставить(
		...
		НСтр("ru = 'Ошибка многостраничного документа:
		         ...
		         |en = 'Multipage document error:
		         |The page does not belong to any of the found documents.'")
	);
	Результат.Вставить(
		50,
	...
	Результат.Вставить(
		...
		НСтр("ru = 'Ошибка нетипового документа:
		         ...
		         |en = 'Non-standard document error:
		         |Cannot process the document as a non-standard document.'")
	);
	Результат.Вставить(
		61,
		НСтр("ru = 'Ошибка нетипового документа:
		         ...
		         |en = 'Non-standard document error:
		         |Cannot define the type of the document under recognition.'")
	);
	Результат.Вставить(
		62,
		НСтр("ru = 'Ошибка нетипового документа:
	...
	Результат.Вставить(
		...
		НСтр("ru = 'Ошибка нетипового документа:
		         ...
		         |en = 'Non-standard document error:
		         |Cannot process the non-standard document without the correct non-standard configuration.'")
	);
	Результат.Вставить(
		71,
		НСтр("ru = 'Недостаточно средств для выполнения распознавания.
		         ...
		         |Log in to your account on 1C:ITS Portal and top up your balance.'")
	);
