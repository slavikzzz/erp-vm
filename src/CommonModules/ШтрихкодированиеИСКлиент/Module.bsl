...
Процедура УточненияДанныхЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли ПоддерживаетсяЧастичноеВыбытие
		...
		И Не ТребуетсяПроверкаРазрешительногоРежимаНаЛокальномМодулеЧЗ Тогда
...
Функция ТекстОшибкиНеПоддерживаетсяВидПродукции(ПараметрыСканирования, ВидПродукции)
	...
	Фрагмент1 = СтрШаблон(НСтр("ru = 'Вид продукции штрихкода: %1.';
								|en = 'Вид продукции штрихкода: %1.'"), ВидПродукции);
	Фрагмент2 = СтрШаблон(НСтр("ru = 'Ожидаемые виды продукции: %1.';
