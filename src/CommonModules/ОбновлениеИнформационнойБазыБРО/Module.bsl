...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Выполняет очистку справочников статистических отчетов.
		...
		|en = 'Выполняет очистку справочников статистических отчетов.
		|До завершения выполнения работа со справочниками может быть затруднена.'");
	...
	Если Не ОбщегоНазначения.ДоступноИспользованиеРазделенныхДанных() Тогда
		...
		Обработчик.Комментарий = НСтр("ru = 'Выполняет заполнение неразделенного регистра справочниками статистических отчетов.
			|До завершения выполнения работа со справочниками может быть затруднена.';
			|en = 'Выполняет заполнение неразделенного регистра справочниками статистических отчетов.
			|До завершения выполнения работа со справочниками может быть затруднена.'");
	КонецЕсли;
	...
	Обработчик.Комментарий = НСтр("ru = 'Выполняет обновление информации в форме 1С-Отчетность в разделе Отчеты. До завершения выполнения данные в форме 1С-Отчетность могут отображаться некорректно';
									|en = 'Выполняет обновление информации в форме 1С-Отчетность в разделе Отчеты. До завершения выполнения данные в форме 1С-Отчетность могут отображаться некорректно'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Выполняет изменение наименований бухгалтерских регламентированных отчетов.';
									|en = 'Выполняет изменение наименований бухгалтерских регламентированных отчетов.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Выполняет изменение представлений отчетного периода.';
									|en = 'Выполняет изменение представлений отчетного периода.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Выполняет изменение наименований деклараций по алкоголю.';
									|en = 'Выполняет изменение наименований деклараций по алкоголю.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Выполняет изменение наименований реестров по НДС.';
									|en = 'Выполняет изменение наименований реестров по НДС.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Выполняет заполнение индекса картинки регламентированных отчетов.';
									|en = 'Выполняет заполнение индекса картинки регламентированных отчетов.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Выполняет изменение реквизитов отправки справок о рублевых и валютных счетах.';
									|en = 'Выполняет изменение реквизитов отправки справок о рублевых и валютных счетах.'");
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("РегламентированнаяОтчетность.ОтчетностьПоАлкогольнойПродукции") Тогда
		...
		Обработчик.Комментарий = НСтр("ru = 'Выполняет заполнение измерения Организация в регистрах сведений алкогольной отчетности.';
										|en = 'Выполняет заполнение измерения Организация в регистрах сведений алкогольной отчетности.'");
	КонецЕсли;
	...
	Обработчик.Комментарий = НСтр("ru = 'Выполняет изменение наименований деклараций по фармакопейному алкоголю.';
									|en = 'Выполняет изменение наименований деклараций по фармакопейному алкоголю.'");
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("РегламентированнаяОтчетность.ОтчетностьВБанки") Тогда
		...
		Обработчик.Комментарий = НСтр("ru = 'Выполняет изменение расписания автоматической отправки финансовой отчетности в Сбербанк';
										|en = 'Выполняет изменение расписания автоматической отправки финансовой отчетности в Сбербанк'");
	КонецЕсли;
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("РегламентированнаяОтчетность.БухгалтерскаяОтчетность") Тогда
		...
		Обработчик.Комментарий = НСтр("ru = 'Выполняет изменение наименования бухгалтерской отчетности.';
										|en = 'Выполняет изменение наименования бухгалтерской отчетности.'");
	...
	Обработчик.Комментарий = НСтр(
		...
		|en = 'Выполняет изменение наименований реестров для налоговых вычетов по акцизам и реестров счетов-фактур.'");
