...
Функция КонтрольИсключенияРазделенныхОбъектовВКонтролирующихПодписках(ВызыватьИсключение = Истина) Экспорт
	...
	Если Не ПустаяСтрока(РезультирующееИсключение) Тогда
		...
		РезультирующееИсключение = НСтр("ru = 'Обнаружены ошибки в структуре метаданных конфигурации:';
										|en = 'The following errors are found in the applied solution metadata structure:'") + Символы.ПС + Символы.ВК + РезультирующееИсключение;
