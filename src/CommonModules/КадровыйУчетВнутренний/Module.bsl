...
Процедура ИнициализироватьОтчетТ2(ОтчетОбъект) Экспорт
	...
	КадровыйУчетРасширенный.ИнициализироватьОтчетТ2(ОтчетОбъект);
...
//			- ДатаСмерти					- Дата.
//
//			Сведения о подключении к КЭДО
//			- ПодключенККЭДО - Булево, Истина когда все согласия приняты и подписаны, Null - согласия не создавались
//
...
//
//			Сведения о действующих согласиях на присоединение к КЭДО
//			- СогласиеНаПрисоединениеККЭДО				- ДокументСсылка.СогласиеНаПрисоединениеККЭДО
//			- СогласиеНаПрисоединениеККЭДОСостояние		- ПеречислениеСсылка.СостоянияСогласийНаПрисоединениеККЭДО
//			- СогласиеНаПрисоединениеККЭДОПодтвержден	- Булево
//			- СогласиеНаПрисоединениеККЭДОДатаНачала	- Дата
//			- СогласиеНаПрисоединениеККЭДОДатаОкончания	- Дата
//
...
Функция НеобходимыСведенияЗависящиеОтФункциональныхОпцийОрганизации(Знач ИмяПоля) Экспорт
	...
	Возврат КадровыйУчетРасширенный.НеобходимыСведенияЗависящиеОтФункциональныхОпцийОрганизации(ИмяПоля);
...
Процедура ДобавитьТекстыЗапросовВТСведенийЗависящихОтФункциональныхОпцийОрганизаций(Запрос, ТолькоРазрешенные, ОписательВременнойТаблицыОтборов, ПоляОтбораПериодическихДанных, ФормироватьСПериодичностьДень, ИсточникиДанных) Экспорт
	...
	КадровыйУчетРасширенный.ДобавитьТекстыЗапросовВТСведенийЗависящихОтФункциональныхОпцийОрганизаций(Запрос, ТолькоРазрешенные, ОписательВременнойТаблицыОтборов, ПоляОтбораПериодическихДанных, ФормироватьСПериодичностьДень, ИсточникиДанных);
...
Функция ПутьКДаннымСведенийОКлассахУсловийТруда(ИмяПоля) Экспорт
	...
	Возврат КадровыйУчетРасширенный.ПутьКДаннымСведенийОКлассахУсловийТруда(ИмяПоля);
	
КонецФункции

Процедура ПриПолученииЗапросаВТСведенияОКлассахУсловийТруда(Запрос, ТолькоРазрешенные, ИмяСоздаваемойТаблицы) Экспорт
	
	КадровыйУчетРасширенный.ПриПолученииЗапросаВТСведенияОКлассахУсловийТруда(Запрос, ТолькоРазрешенные, ИмяСоздаваемойТаблицы);
...
Процедура ДополнитьПоляЗапросаВТКадровыхДанных(Организация, Запрос) Экспорт
	...
	КадровыйУчетРасширенный.ДополнитьПоляЗапросаВТКадровыхДанных(Организация, Запрос);
...
Функция ДанныеОтсутствийСотрудникаДляПособияПоБезработице(КадровыеДанныеСотрудников) Экспорт
	...
	Возврат КадровыйУчетРасширенный.ДанныеОтсутствийСотрудникаДляПособияПоБезработице(КадровыеДанныеСотрудников);
...
Процедура ЗаполнитьПоляПредставленийКадровыхДанныхФизическихЛиц(ДополнительныеПоляПредставлений, ПутьКПолямЛичныхДанных, ИсключаемыеПоля) Экспорт
	...
	КадровыйУчетРасширенный.ЗаполнитьПоляПредставленийКадровыхДанныхФизическихЛиц(ДополнительныеПоляПредставлений, ПутьКПолямЛичныхДанных, ИсключаемыеПоля);
...
Процедура ЗаполнитьПоляПредставленийКадровыхДанныхСотрудников(ДополнительныеПоляПредставлений, ПутьКПолямСотрудника, ПутьКПолямЛичныхДанных, ИсключаемыеПоля) Экспорт
	...
	КадровыйУчетРасширенный.ЗаполнитьПоляПредставленийКадровыхДанныхСотрудников(ДополнительныеПоляПредставлений, ПутьКПолямСотрудника, ПутьКПолямЛичныхДанных, ИсключаемыеПоля);
...
Функция ЗаполнитьДанныеДокументовПоИностраннымГражданам(ДанныеДляЗаполнения, СсылкаНаДокумент) Экспорт
	...
	Возврат КадровыйУчетРасширенный.ЗаполнитьДанныеДокументовПоИностраннымГражданам(ДанныеДляЗаполнения, СсылкаНаДокумент);
	
КонецФункции

Функция СведенияОСреднемЗаработкеДляСправкиДетямСиротам(КадровыеДанныеСотрудников, ДатаСправки) Экспорт
	
	Возврат КадровыйУчетРасширенный.СведенияОСреднемЗаработкеДляСправкиДетямСиротам(КадровыеДанныеСотрудников, ДатаСправки);
	
КонецФункции

Процедура СоздатьВТОбложениеДоговоровГПХНСПЗ(МенеджерВременныхТаблиц) Экспорт
	
	КадровыйУчетРасширенный.СоздатьВТОбложениеДоговоровГПХНСПЗ(МенеджерВременныхТаблиц);
