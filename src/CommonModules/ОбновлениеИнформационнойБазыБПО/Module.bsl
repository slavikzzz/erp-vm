...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновление поставляемых драйверов подключаемого оборудования.';
									|en = 'Update the supplied drivers of peripherals.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновление оборудования ККМ-офлайн.';
									|en = 'Update the offline cash register equipment.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Создание предопределенных шаблонов печати.';
									|en = 'Create predefined print templates.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Обработка параметров регистрации подключаемого оборудования.';
									|en = 'Process peripheral registration parameters.'"); 
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновление макетов этикеток и ценников на новый формат.';
									|en = 'Update templates of labels and price tags to the new format.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Установка срока хранения операций.';
									|en = 'Set an operation retention period.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Перенос драйверов из макетов в справочник Внешние копоненты.';
									|en = 'Transfer drivers from templates to the ""Add-ins"" catalog.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Отключение регламентного задания отправки электронных сообщений в разделенном режиме.';
									|en = 'Отключение регламентного задания отправки электронных сообщений в разделенном режиме.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Установка срока хранений операций с оборудованием.';
									|en = 'Установка срока хранений операций с оборудованием.'");
	// -- НеМобильноеПриложение
...
Процедура ОбновитьПодключаемоеОборудование(Параметры = Неопределено) Экспорт
	...
	ШаблонТекстаОшибки = НСтр("ru = 'Не удалось обработать обновление подключаемого оборудования по причине: %1';
								|en = 'Cannot process the peripherals update due to: %1'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
		...
		Исключение
			...
			ОбщегоНазначенияБПО.ЗаписатьОшибкуВЖурналРегистрации(
				НСтр("ru = 'Обновление информационной базы';
					|en = 'Infobase update'", ОбщегоНазначенияБПО.КодОсновногоЯзыка()),
				ТекстОшибки);
		КонецПопытки;
	КонецЦикла;
...
Процедура ОбновитьПараметрыРегистрацииОборудования(Параметры = Неопределено) Экспорт    
	...
	Исключение
		...
		ШаблонТекстаОшибки = НСтр("ru = 'Не удалось преобразовать параметры регистрации подключаемого оборудования по причине:
			|%1';
			|en = 'Cannot convert the peripheral registration parameters. Reason:
