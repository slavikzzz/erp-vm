	...
	Если Не ИсточникДанных.ОтчетПроизводственнойЛинии Тогда
		Если Не ЗначениеЗаполнено(ИсточникДанных.Номенклатура) Тогда
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru = 'Поле ""Номенклатура"" не заполнено.';
															|en = 'Поле ""Номенклатура"" не заполнено.'"),, "Номенклатура",, Отказ);
		КонецЕсли;
		Если ИсточникДанных.ХарактеристикиИспользуются И Не ЗначениеЗаполнено(ИсточникДанных.Характеристика) Тогда
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru = 'Поле ""Характеристика"" не заполнено.';
															|en = 'Поле ""Характеристика"" не заполнено.'"),, "Характеристика",, Отказ);
		КонецЕсли;
		Если ИсточникДанных.ТребуетсяУказаниеСерии И ЗначениеЗаполнено(ИсточникДанных.Склад) И Не ЗначениеЗаполнено(ИсточникДанных.Серия) Тогда
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru = 'Поле ""Серия"" не заполнено.';
															|en = 'Поле ""Серия"" не заполнено.'"),, "Серия",, Отказ);
		КонецЕсли;
	КонецЕсли;
			...
			ОбщегоНазначенияКлиент.СообщитьПользователю(
				СтрШаблон(
					НСтр("ru = 'Не найдено сопоставленной продукции ВетИС для позиции номенклатуры %1';
						|en = 'Не найдено сопоставленной продукции ВетИС для позиции номенклатуры %1'"),
