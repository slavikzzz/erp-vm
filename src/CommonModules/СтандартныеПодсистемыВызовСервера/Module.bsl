...
Процедура ЗаписатьПоказателиПроизводительности(Знач ПриЗапуске, Знач Показатели, Знач СтекВызова) Экспорт
	...
	ИмяСобытия = ?(ПриЗапуске,
		НСтр("ru = 'Параметры работы клиента при запуске.Показатели производительности';
			|en = 'Параметры работы клиента при запуске.Показатели производительности'",
			ОбщегоНазначения.КодОсновногоЯзыка()),
		НСтр("ru = 'Параметры работы клиента.Показатели производительности';
			|en = 'Параметры работы клиента.Показатели производительности'",
			ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ТехнологияСервиса") Тогда
		ИмяСобытияСтек = ?(ПриЗапуске,
			НСтр("ru = 'Параметры работы клиента при запуске.Стек вызова';
				|en = 'Параметры работы клиента при запуске.Стек вызова'",
				ОбщегоНазначения.КодОсновногоЯзыка()),
			НСтр("ru = 'Параметры работы клиента.Стек вызова';
				|en = 'Параметры работы клиента.Стек вызова'",
				ОбщегоНазначения.КодОсновногоЯзыка()));
...
Процедура ЗаписатьОшибкуВЖурналРегистрацииПриЗапускеИлиЗавершении(ПрекратитьРаботу, Знач Событие, Знач ТекстОшибки) Экспорт
	...
	Если Событие = "Запуск" Тогда
		ИмяСобытия = НСтр("ru = 'Запуск приложения';
							|en = 'Startup'", ОбщегоНазначения.КодОсновногоЯзыка());
		...
		КонецЕсли;
	Иначе
		ИмяСобытия = НСтр("ru = 'Завершение приложения';
							|en = 'Exit'", ОбщегоНазначения.КодОсновногоЯзыка());
