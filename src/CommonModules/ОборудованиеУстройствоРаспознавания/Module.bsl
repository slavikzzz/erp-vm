...
Процедура ОбновитьПоставляемыеДрайвера(ДрайвераОборудования) Экспорт
	...
	Драйвер.Наименование = НСтр("ru = 'Мертех:Устройство распознавания';
								|en = 'Mertech:Recognition device'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Если Команда = "Recognize" Тогда
		...
		Иначе
			...
			РезультатВыполнения.ОписаниеОшибки = НСтр("ru = 'Нет распознанных товаров.';
														|en = 'There are no recognized items.'");
