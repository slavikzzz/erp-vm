	...
	Иначе
		...
		ВызватьИсключение СтрШаблон(
			НСтр("ru = 'Объект метаданных %1 не может быть обработан обработчиком
				...
				| ВыгрузкаЗагрузкаУзловПлановОбменов.ПослеВыгрузкиОбъекта() handler'", Метаданные.ОсновнойЯзык.КодЯзыка),
...
Процедура ЗавершитьЗаписьФайла(Контейнер, ОбъектМетаданных,  ПотокЗаписи)
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru = 'ВыгрузкаЗагрузкаДанных.ВыгрузкаИзмененийОбъектаМетаданных';
			|en = 'ВыгрузкаЗагрузкаДанных.ВыгрузкаИзмененийОбъектаМетаданных'", ОбщегоНазначения.КодОсновногоЯзыка()),
		...
		|Objects exported: %2'", ОбщегоНазначения.КодОсновногоЯзыка()),
