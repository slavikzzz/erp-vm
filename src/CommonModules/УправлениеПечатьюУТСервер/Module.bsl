...
Процедура ОпределитьОбъектыСКомандамиПечати(СписокОбъектов) Экспорт
	...
	//++ НЕ УТКА
	УправлениеРемонтами.ОпределитьОбъектыСКомандамиПечати(СписокОбъектов);
	//-- НЕ УТКА
	
	//++ НЕ УТКА
	СписокОбъектов.Добавить(Справочники.МаршрутныеКарты);
	СписокОбъектов.Добавить(Справочники.ТехнологическиеПроцессы);
	СписокОбъектов.Добавить(Справочники.РабочиеЦентры);
	СписокОбъектов.Добавить(Документы.ЗаказДавальца2_5);
	//++ Устарело_Производство21
	СписокОбъектов.Добавить(Документы.ЗаказНаПроизводство);
	//-- Устарело_Производство21
	СписокОбъектов.Добавить(Документы.НачальныеОстаткиНЗППоПартиямПроизводства);
	СписокОбъектов.Добавить(Документы.НачальныеОстаткиНЗППоПодразделениям);
	СписокОбъектов.Добавить(Документы.ОтчетДавальцу2_5);
	СписокОбъектов.Добавить(Документы.ОтчетДавальцуМеждуОрганизациями);
	...
	//-- Устарело_Переработка24
	СписокОбъектов.Добавить(Документы.ЗаказПереработчику2_5);
	//++ Устарело_Переработка24
	СписокОбъектов.Добавить(Документы.ОтчетПереработчика);
	//-- Устарело_Переработка24
	СписокОбъектов.Добавить(Документы.ОтчетПереработчика2_5);
	//++ Устарело_Производство21
	...
	СписокОбъектов.Добавить(Документы.РасчетРезервовПодОбесценениеЗапасов);
	СписокОбъектов.Добавить(Документы.РаспределениеВозвратныхОтходов);
	СписокОбъектов.Добавить(Документы.РаспределениеПроизводственныхЗатрат);
