...
Процедура ПриОпределенииНастроек(Параметры) Экспорт
	...
	Параметры.Вставить("ПоясненияДляРезультатовОбновления", НСтр("ru = 'Сведения о результатах обновления версии программы можно также открыть из раздела ""НСИ и администрирование"" - ""Интернет-поддержка пользователей"".';
																|en = 'Information on results of application version update can be viewed from section ""Master data and settings"" - ""Online user support"".'"));
	...
	Объекты.Добавить(Метаданные.Справочники.ПланыСчетовМеждународногоУчета);
	Объекты.Добавить(Метаданные.ПланыВидовХарактеристик.ВидыСубконтоМеждународные);
	Объекты.Добавить(Метаданные.ПланыВидовХарактеристик.РеквизитыЭлементовФинансовыхОтчетов);
	//-- НЕ УТКА
	Объекты.Добавить(Метаданные.Справочники.ВидыРасчетовССотрудниками);
	Объекты.Добавить(Метаданные.Справочники.ВидыНачисленийУдержаний);
	//-- НЕ УТ
...
Процедура ПередОбновлениемИнформационнойБазы() Экспорт
	...
	//++ НЕ УТ
		...
		Если ВерсииПодсистем.Найти("КомплекснаяАвтоматизация", "ИмяПодсистемы") = Неопределено И Метаданные.Имя = "УправлениеПредприятием" Тогда
			...
			ОбновлениеИнформационнойБазыКА.ПриДобавленииПодсистемы(ОписаниеПодсистемы);
			
			ОбновлениеИнформационнойБазы.ЗарегистрироватьНовуюПодсистему(ОписаниеПодсистемы.Имя, ОписаниеПодсистемы.Версия);
...
Процедура ПриЗаполненииПриоритетовТиповМетаданных(ПриоритетыТиповМетаданных) Экспорт
	...
	ПриоритетыТиповМетаданных.Вставить("РегистрСведений.РеестрДокументов", 120);
	//++ НЕ УТ
	ПриоритетыТиповМетаданных.Вставить("РегистрСведений.ДокументыПоНМА", 120);
	ПриоритетыТиповМетаданных.Вставить("РегистрСведений.ДокументыПоОС", 120);
	//-- НЕ УТ
...
Процедура ПриЗаполненииОбъектовПланируемыхКУдалению(Объекты) Экспорт
	...
	ОбновлениеИнформационнойБазы.ДобавитьОбъектПланируемыйКУдалению(Объекты,
		"Перечисление.ВидыОперацийВзаимозачетаЗадолженности.УдалитьКлиента");
	ОбновлениеИнформационнойБазы.ДобавитьОбъектПланируемыйКУдалению(Объекты,
		"Перечисление.ВидыОперацийВзаимозачетаЗадолженности.УдалитьПоставщика");
	ОбновлениеИнформационнойБазы.ДобавитьОбъектПланируемыйКУдалению(Объекты,
		"Перечисление.ВидыОперацийВзаимозачетаЗадолженности.УдалитьМеждуКлиентами");
	ОбновлениеИнформационнойБазы.ДобавитьОбъектПланируемыйКУдалению(Объекты,
		"Перечисление.ВидыОперацийВзаимозачетаЗадолженности.УдалитьМеждуПоставщиками");
	ОбновлениеИнформационнойБазы.ДобавитьОбъектПланируемыйКУдалению(Объекты,
		"Перечисление.ВидыОперацийВзаимозачетаЗадолженности.УдалитьКлиентаМеждуОрганизациями");
	ОбновлениеИнформационнойБазы.ДобавитьОбъектПланируемыйКУдалению(Объекты,
		"Перечисление.ВидыОперацийВзаимозачетаЗадолженности.УдалитьПоставщикаМеждуОрганизациями");
