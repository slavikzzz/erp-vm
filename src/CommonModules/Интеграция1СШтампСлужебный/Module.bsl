...
Функция ЗапросКСервисуДобавитьШтампыВДокумент(Знач ТелоЗапроса)
	...
	ЗапросСервиса.Наименование =
		НСтр("ru = 'Добавление штампов в документ в сервисе 1С:Штамп';
			|en = 'Adding stamps to the document in 1C:Stamp'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция ЗапросКСервисуПолучитьСтатусВыполнения(Знач АдресОбращения)
	...
	ЗапросСервиса.Наименование =
		НСтр("ru = 'Получение статуса добавления штампов в документ в сервисе 1С:Штамп';
			|en = 'Receiving the status of adding stamps to the document in 1C:Stamp'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция ЗапросКСервисуПолучитьРезультатВыполнения(Знач АдресОбращения)
	...
	ЗапросСервиса.Наименование =
		НСтр("ru = 'Получение результата добавления штампов в документ в сервисе 1С:Штамп';
			|en = 'Receiving the results of adding stamps to the document in 1C:Stamp'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция ДвоичныеДанныеФайлаВАрхиве(ДвоичныеДанные, РасширениеФайла)
	...
	Если ПустаяСтрока(РасширениеФайла) Тогда
		...
		ПодробноеОписаниеОшибки = НСтр("ru = 'Не указано расширение файла.';
										|en = 'The file extension is not specified.'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	Если Не ЗначениеЗаполнено(ДвоичныеДанные) Тогда
		...
		ПодробноеОписаниеОшибки = НСтр("ru = 'Не указаны двоичные данные файла.';
										|en = 'Binary file data is not specified.'", ОбщегоНазначения.КодОсновногоЯзыка());
