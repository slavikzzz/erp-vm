...
Процедура ПередВыгрузкойДанных(Контейнер) Экспорт
	...
	ВыгружаемыеТипыОбщихДанных = Новый Массив(ПараметрыВыгрузки.ВыгружаемыеТипыОбщихДанных);
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(ВыгружаемыеТипыОбщихДанных, ДополнительноВыгружаемые, Истина);
	ПараметрыВыгрузки.ВыгружаемыеТипыОбщихДанных = Новый ФиксированныйМассив(ВыгружаемыеТипыОбщихДанных);
