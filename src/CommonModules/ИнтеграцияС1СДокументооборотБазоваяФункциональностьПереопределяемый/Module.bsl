...
Процедура ПередДобавлениемКомандПечати(ИмяФормы, КомандыПечати, СтандартнаяОбработка) Экспорт
	...
	Если ИмяФормы = Метаданные.Справочники.СоглашенияСКлиентами.Формы.ФормаЭлемента.ПолноеИмя()
			...
			//++ НЕ УТ
			Или ИмяФормы = Метаданные.Справочники.ДоговорыАренды.Формы.ФормаЭлемента.ПолноеИмя()
			Или ИмяФормы = Метаданные.Справочники.ДоговорыАренды.Формы.ФормаСписка.ПолноеИмя()
			//-- НЕ УТ
			...
			//++ НЕ УТКА
			Или ИмяФормы = Метаданные.Документы.ЗаказДавальца2_5.Формы.ФормаДокумента.ПолноеИмя()
			Или ИмяФормы = Метаданные.Документы.ЗаказДавальца2_5.Формы.ФормаСписка.ПолноеИмя()
			//-- НЕ УТКА
			
			//++ НЕ УТ
			Или ИмяФормы = Метаданные.Документы.ЗаказПереработчику2_5.Формы.ФормаДокумента.ПолноеИмя()
			Или ИмяФормы = Метаданные.Документы.ЗаказПереработчику2_5.Формы.ФормаСписка.ПолноеИмя()
			//-- НЕ УТ
			...
			//++ НЕ УТ
			Или ИмяФормы = Метаданные.Документы.ПланПроизводства.Формы.ФормаДокумента.ПолноеИмя()
			Или ИмяФормы = Метаданные.Документы.ПланПроизводства.Формы.ФормаСписка.ПолноеИмя()
			//-- НЕ УТ
			...
			//++ НЕ УТКА
			Или ИмяФормы = Метаданные.Документы.РазрешениеНаЗаменуМатериалов.Формы.ФормаДокумента.ПолноеИмя()
			Или ИмяФормы = Метаданные.Документы.РазрешениеНаЗаменуМатериалов.Формы.ФормаСписка.ПолноеИмя()
			//-- НЕ УТКА
			...
			//++ НЕ УТ
			Или ИмяФормы = Метаданные.Документы.ЭкземплярБюджета.Формы.ФормаДокумента.ПолноеИмя()
			Или ИмяФормы = Метаданные.Документы.ЭкземплярБюджета.Формы.ФормаСписка.ПолноеИмя()
			//-- НЕ УТ
		...
		Если Настройки.ИспользоватьИнтеграциюДО2
			...
			КомандаПечати.Представление = НСтр("ru = 'Документооборот: Лист согласования';
												|en = 'Document management: Approval sheet'");
			КомандаПечати.ПроверкаПроведенияПередПечатью = Ложь;
			КомандаПечати.Порядок = 1;
		...
		Если Настройки.ИспользоватьИнтеграциюДО3
			...
			КомандаПечати.Идентификатор = "ExaminationSheet";
			КомандаПечати.Представление = НСтр("ru = 'Документооборот: Лист ознакомления';
												|en = 'Document management: Preview sheet'");
			КомандаПечати.ПроверкаПроведенияПередПечатью = Ложь;
			КомандаПечати.Порядок = 2;
...
Процедура ПриОпределенииОбъектовПоддерживающихАвтонастройку(Объекты) Экспорт
	...
	Строка.ОписаниеВыполняемыхДействий =
		НСтр("ru = 'Будут созданы правила интеграции и вид внутренних документов для справочника ""Соглашения об условиях продаж"".';
			|en = 'Integration rules and a kind of internal transfer documents for the ""Sales terms and conditions"" catalog will be created.'");
	...
	Строка.ОписаниеВыполняемыхДействий =
		НСтр("ru = 'Будут созданы правила интеграции и вид внутренних документов для справочника ""Договоры с контрагентами"".';
			|en = 'Integration rules and a kind of internal transfer documents for the ""Contracts with counterparties"" catalog will be created.'");
	...
	Строка.ОписаниеВыполняемыхДействий =
		НСтр("ru = 'Будут созданы правила интеграции и вид внутренних документов для документа ""Коммерческое предложение клиенту"".';
			|en = 'Integration rules and a kind of internal transfer documents for the ""Sales quotation"" catalog will be created.'");
	...
	Строка.ОписаниеВыполняемыхДействий =
		НСтр("ru = 'Будут созданы правила интеграции и вид внутренних документов для документа ""Заказ клиента"".';
			|en = 'Integration rules and a kind of internal transfer documents for the ""Sales order"" document will be created.'");
	...
	Строка.ОписаниеВыполняемыхДействий =
		НСтр("ru = 'Будут созданы правила интеграции и вид внутренних документов для документа ""Заказ поставщику"".';
			|en = 'Integration rules and a kind of internal transfer documents for the ""Purchase order"" document will be created.'");
	...
	Строка.ОписаниеВыполняемыхДействий =
		НСтр("ru = 'Будут созданы правила интеграции и вид внутренних документов для документа ""Заявка на возврат товаров от клиента"".';
			|en = 'Integration rules and a kind of internal transfer documents for the ""Sales return request"" document will be created.'");
	...
	Строка.ОписаниеВыполняемыхДействий =
		НСтр("ru = 'Будут созданы правила интеграции и вид внутренних документов для документа ""Заявка на расходование денежных средств"".';
			|en = 'Integration rules and a kind of internal transfer documents for the ""Payment demand"" document will be created.'");
