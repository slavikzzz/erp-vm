...
Процедура УстановитьСлужебногоПользователяРегламентногоЗадания(РегламентноеЗадание, СлужебныйПользовательИБ = Неопределено) Экспорт
	...
	Текст = НСтр("ru = 'Это регламентное задание должно выполняться от имени служебного пользователя.
	                   ...
	                   |en = 'Это регламентное задание должно выполняться от имени служебного пользователя.
	                   |Выполнение прервано. Установлен служебный пользователь для запуска.
	                   |Дополнительных действий не требуется. Следующий запуск будет выполнен от имени служебного пользователя.'")
	                   + Символы.ПС;
...
Процедура ОтменитьВыполнениеЗадания(Знач РегламентноеЗадание, ТекстДляЖурнала) Экспорт
	...
	ИмяСобытия = НСтр("ru = 'Отмена фонового задания';
	...
	Исключение
		...
		ЗаголовокОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось создать служебного пользователя ""%1""
			           ...
			           |en = 'Не удалось создать служебного пользователя ""%1""
			           |для установки в регламентное задание ""%2"" по причине:'"),
