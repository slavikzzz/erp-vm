...
Функция ДанныеОДоходахНалогахВычетах(Сотрудники, НалоговыйПериод, Организация, РегистрацияВНалоговомОргане, ДатаАктуальности, КППОтправки, ВРазрезеРегистраторов, ДополнительныйОтбор) Экспорт
	...
	Иначе
		...
		|		ВЫБОР
		|			КОГДА СтрокиНалогов.Сумма = 0
		|					И СтрокиНалогов.СуммаСПревышения > 0
		|				ТОГДА СтрокиНалогов.СуммаДоходаСКоторогоНеУдержанНалог
		|			ИНАЧЕ 0
		|		КОНЕЦ,
		|		ВЫБОР
		|			КОГДА СтрокиНалогов.Статус = ЗНАЧЕНИЕ(Справочник.СтатусыНалогоплательщиковПоНДФЛ.Нерезидент)
		...
		|			КОГДА СтрокиНалогов.Сумма = 0
		|					И СтрокиНалогов.СуммаСПревышения = 0
		|					И СтрокиНалогов.СуммаСПревышенияПоСтавке18 > 0
		|				ТОГДА СтрокиНалогов.СуммаДоходаСКоторогоНеУдержанНалог
		|			ИНАЧЕ 0
		|		КОНЕЦ,
		|		ВЫБОР
		...
		|					И СтрокиНалогов.СуммаСПревышения = 0
		|					И СтрокиНалогов.СуммаСПревышенияПоСтавке18 = 0
		|					И СтрокиНалогов.СуммаСПревышенияПоСтавке20 > 0
		|				ТОГДА СтрокиНалогов.СуммаДоходаСКоторогоНеУдержанНалог
		|			ИНАЧЕ 0
		|		КОНЕЦ,
		|		ВЫБОР
		...
		|					И СтрокиНалогов.СуммаСПревышенияПоСтавке18 = 0
		|					И СтрокиНалогов.СуммаСПревышенияПоСтавке20 = 0
		|					И СтрокиНалогов.СуммаСПревышенияПоСтавке22 > 0
		|				ТОГДА СтрокиНалогов.СуммаДоходаСКоторогоНеУдержанНалог
		|			ИНАЧЕ 0
		|		КОНЕЦ,
		|		ВЫБОР
