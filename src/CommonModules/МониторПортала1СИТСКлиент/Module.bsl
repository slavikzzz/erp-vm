...
Процедура ОткрытьМониторСПодключениемИнтернетПоддержки() Экспорт
	...
	ТекстСообщения =
		НСтр("ru = 'Для работы с Монитором Портала 1С:ИТС необходимо подключить Интернет-поддержку пользователей.';
			|en = 'To use 1C:ITS Portal Dashboard, connect to online user support.'");
	...
	Если Результат = "Ошибка" Тогда
		...
		ПоказатьОповещениеПользователя(
			...
			НСтр("ru = 'Не удалось проверить наличие новой информации.
				...
				|en = 'Cannot check new information availability.
	...
	ИначеЕсли Результат = "ДанныеИзменены" Тогда
		...
		ПоказатьОповещениеПользователя(
			...
			НСтр("ru = 'Новая информация в Мониторе Портала 1С:ИТС.
				...
				|en = 'New information in 1C:ITS Portal Dashboard.
				|Click to view.'"),
	...
	ИначеЕсли Результат = "ЕстьПредупреждения" Тогда
		...
		ПоказатьОповещениеПользователя(
			...
			НСтр("ru = 'Есть предупреждения в Мониторе Портала 1С:ИТС.
				|Нажмите для просмотра.';
				|en = 'There are warnings in 1C:ITS Portal Dashboard.
				|Click to view.'"),
			БиблиотекаКартинок.ИнтернетПоддержкаПользователей,
			СтатусОповещенияПользователя.Важное,
			"МониторПортала1СИТС");
