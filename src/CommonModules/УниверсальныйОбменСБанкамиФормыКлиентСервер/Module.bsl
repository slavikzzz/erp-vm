...
Функция ПараметрыДиалогаВыбораФайла() Экспорт
	...
	ПараметрыДиалога.Вставить("ФильтрДиалогаВыбора",
		НСтр("ru = 'Книга Excel (*.xls; *.xlsx)|*.xls; *.xlsx|Документ Adobe PDF (*.pdf)|*.pdf|
				...
				|en = 'Microsoft Excel Workbook (*.xls; *.xlsx)|*.xls; *.xlsx|Adobe PDF document (*.pdf)|*.pdf|
				|Microsoft Word document (*.doc; *.docx)|*.doc; *.docx|Text in RTF format (*.rtf)|*.rtf|
				|JPEG format (*.jpg; *.jpeg)|*.jpg; *.jpeg|PNG format (*.png)|*.png|
				|Text document (*.txt)|*.txt|Web page (*.htm;*.html)|*.htm;*.html|
