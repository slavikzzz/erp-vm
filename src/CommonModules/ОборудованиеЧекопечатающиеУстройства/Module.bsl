	...
	Для Каждого ПараметрРегистрации Из ПараметрыРегистрации Цикл
		...
		ИначеЕсли НаименованиеПараметра = "ПризнакАвтоматическогоТорговогоАвтомата" Тогда
			НаименованиеПараметра = НСтр("ru = 'Применение в автоматическом торговом автомате';
										|en = 'Used in automatic vending machine'")
		...
		ИначеЕсли НаименованиеПараметра = "ПризнакОптовойТорговлиСОрганизациями" Тогда
			НаименованиеПараметра = НСтр("ru = 'Оптовая торговля с организациями и ИП';
										|en = 'Wholesale with companies and individual entrepreneurs'")
		КонецЕсли;
...
Процедура ОбновитьПоставляемыеДрайвера(ДрайвераОборудования) Экспорт
	...
	Драйвер.Наименование = НСтр("ru = '1С:Принтер чеков';
								|en = '1C:Receipt printer'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'RightScan:Устройство печати ТСД Urovo';
								|en = 'RightScan:Urovo PDT print device'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'RightScan:ККТ с передачей данных в ОФД (54-ФЗ)';
								|en = 'RightScan:Cash register with data transfer to FDO (54-FZ)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "FNCore"; 
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ККТ;
	Драйвер.ИмяДрайвера  = "ДрайверАЗУРККТ54ФЗФФД12";
	Драйвер.Наименование = НСтр("ru = 'АЗУР:ККТ с передачей данных в ОФД (ФФД 1.2)';
								|en = 'AZUR:Cash register with data transfer to FDO (FDF 1.2)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Версия-Т:ККТ с передачей данных в ОФД (54-ФЗ)';
								|en = 'Version-T:Cash register with data transfer to FDO (54-FZ)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'АТОЛ:ККТ с передачей данных в ОФД 10.Х (ФФД 1.2)';
								|en = 'ATOL:Cash register with data transfer to FDO 10.X (FDF 1.2)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'АТОЛ:ККТ с передачей данных в ОФД 10.x (ФФД 1.2) УСН НДС';
								|en = 'АТОЛ:ККТ с передачей данных в ОФД 10.x (ФФД 1.2) УСН НДС'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'АТОЛ:ККТ с передачей данных в ОФД (54-ФЗ) 10.x';
								|en = 'ATOL:Cash register with data transfer to FDO (54-FZ) 10.x'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ПОСЦентр:ККТ с передачей данных в ОФД (ФФД 1.2) NG УСН НДС';
								|en = 'ПОСЦентр:ККТ с передачей данных в ОФД (ФФД 1.2) NG УСН НДС'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ПОСЦентр:ККТ с передачей данных в ОФД (ФФД 1.2) УСН НДС';
								|en = 'ПОСЦентр:ККТ с передачей данных в ОФД (ФФД 1.2) УСН НДС'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'АТОЛ:ККТ с передачей данных в ОФД (54-ФЗ)';
								|en = 'ATOL:Cash register with data transfer to FDO (54-FZ)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'АТОЛ:ККТ с передачей данных в ОФД (54-ФЗ) 9.x';
								|en = 'ATOL:Cash register with data transfer to FDO (54-FZ) 9.x'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ШТРИХ-М:ККТ с передачей данных в ОФД (54-ФЗ) 4.14';
								|en = 'SHTRIH-M:Cash register with data transfer to FDO (54-FZ) 4.14'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ШТРИХ-М:ККТ с передачей данных в ОФД (54-ФЗ) 4.15';
								|en = 'SHTRIH-M:Cash register with data transfer to FDO (54-FZ) 4.15'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ШТРИХ-М:ККТ с передачей данных в ОФД (ФФД 1.2)';
								|en = 'SHTRIH-M:Cash register with data transfer to FDO (FDF 1.2)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ШТРИХ-М:ККТ с передачей данных в ОФД (ФФД 1.2) 5.17';
								|en = 'SHTRIH-M:Cash register with data transfer to FDO (FDF 1.2) 5.17'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "SMDrvFR1C4"; 
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ККТ;
	Драйвер.ИмяДрайвера  = "ДрайверИскраККТ54ФЗ";
	Драйвер.Наименование = НСтр("ru = 'ИСКРА:ККТ с передачей данных в ОФД (ФФД 1.2)';
								|en = 'ISKRA:Cash register with data transfer to FDO (FDF 1.2)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ККС:ККТ с передачей данных в ОФД (54-ФЗ)';
								|en = 'KKS:Cash register with data transfer to FDO (54-FZ)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ККС:ККТ с передачей данных в ОФД (ФФД 1.2)';
								|en = 'KKS:Cash register with data transfer to FDO (FDF 1.2)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'MSTAR:ККТ с передачей данных в ОФД (54-ФЗ)';
								|en = 'MSTAR:CRE with data transfer to FDO (54-FZ)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Счетмаш:ККТ с передачей данных в ОФД (54-ФЗ)';
								|en = 'Schetmash:Cash register with data transfer to FDO (54-FZ)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'NEWTON:ККТ с передачей данных в ОФД (54-ФЗ)';
								|en = 'NEWTON:Cash register with data transfer to FDO (54-FZ)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ars:ККТ с передачей данных в ОФД (54-ФЗ)';
								|en = 'ars:Cash register with data transfer to FDO (54-FZ)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Дримкас:ККТ с передачей данных в ОФД Вики Принт (ФФД 1.2)';
								|en = 'Dreamkas:Cash register with data transfer to FDO (FDF 1.2)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Дримкас:ККТ с передачей данных в ОФД (ФФД 1.2) УСН НДС';
								|en = 'Дримкас:ККТ с передачей данных в ОФД (ФФД 1.2) УСН НДС'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Инитпро:ККТ с передачей данных в ОФД (54-ФЗ)';
								|en = 'Initpro:Cash register with data transfer to FDO (54-FZ)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Инитпро:ККТ с передачей данных в ОФД (ФФД 1.2)';
								|en = 'Initpro:Cash register with data transfer to FDO (54-FZ)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'FIT:ККТ с передачей данных в ОФД (54-ФЗ)';
								|en = 'FIT:Cash register with data transfer to FDO (54-FZ)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Инкотекс:ККТ с передачей данных в ОФД (54-ФЗ)';
								|en = 'Incotex:Cash register with data transfer to FDO (54-FZ)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'МЕБИУС:ККТ с передачей данных в ОФД (54-ФЗ)';
								|en = 'Mobius:Cash register with data transfer to FDO (54-FZ)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'WNJI:ККТ с передачей данных в ОФД (54-ФЗ)';
								|en = 'WNJI:Cash register with data transfer to FDO (54-FZ)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'КАСТОМ:ККТ с передачей данных в ОФД (54-ФЗ)';
								|en = 'CUSTOM:Cash register with data transfer to FDO (54-FZ)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Эвотор:ККТ с передачей данных в ОФД (ФФД 1.2)';
								|en = 'Evotor:Cash register with data transfer to FDO (FDF 1.2)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "EvoKKMExtension36"; 
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ККТ;
	Драйвер.ИмяДрайвера  = "ДрайверИнкотексККТ54ФЗФФ12";
	Драйвер.Наименование = НСтр("ru = 'Инкотекс:ККТ с передачей данных в ОФД (ФФД 1.2)';
								|en = 'Incotex:Cash register with data transfer to FDO (FDF 1.2)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "INCOTEX_KKT_FFD12";   
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ККТ;
	Драйвер.ИмяДрайвера  = "ДрайверНЕВА54ФЗ4ФФД12";
	Драйвер.Наименование = НСтр("ru = 'НЕВА:ККТ с передачей данных в ОФД (ФФД 1.2) УСН НДС';
								|en = 'НЕВА:ККТ с передачей данных в ОФД (ФФД 1.2) УСН НДС'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "NevaFiscalCoreCEL";      
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ККТ;
	Драйвер.ИмяДрайвера  = "ДрайверMitsu54ФЗ4ФФД12";
	Драйвер.Наименование = НСтр("ru = 'Mitsu:ККТ с передачей данных в ОФД (ФФД 1.2)';
								|en = 'Mitsu:ККТ с передачей данных в ОФД (ФФД 1.2)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
...
Функция ПодготовитьДанныеОперации(ПараметрыПодключения, Команда, ПараметрыОперации) Экспорт
	...
	Если Команда = "CheckFiscalization" Тогда
		...
		ИначеЕсли ПараметрыПодключения.ТипыОборудования.Свойство("ПринтерЧеков") И ПараметрыПодключения.ТипыОборудования.ПринтерЧеков Тогда
		...
		Если ЗначениеЗаполнено(ПараметрыОперации.УстройствоПечати) 
			И (ПараметрыПодключения.ТипыОборудования.Свойство("ПринтерЧеков") И НЕ ПараметрыПодключения.ТипыОборудования.ПринтерЧеков) Тогда
	...
	ИначеЕсли Команда = "PrintReceiptCorrection" Тогда
		...
		Если (ПараметрыПодключения.РевизияИнтерфейса < 3000 И ПараметрыОперации.НеприменениеККТ) 
			...
			ПараметрыФискализации.ТекстОшибки = НСтр("ru = 'Для данного типа расчета нельзя сформировать чек коррекции для данного ККТ.';
													|en = 'For this type of calculation, it is impossible to form an adjustment voucher for this cash register.'");
			Возврат ПараметрыФискализации;
		КонецЕсли;    
		...
		Если НЕ ПараметрыФискализации.СформироватьЧекКоррекцииСторно Тогда 
			...
			Если ПараметрыОперации.НеприменениеККТ И ЗначениеЗаполнено(ПараметрыОперации.КорректируемыйДокумент) Тогда
				...
				ПараметрыФискализации.ТекстОшибки = НСтр("ru = 'Чек коррекции «неприменение ККТ» нельзя сформировать для фискализированного ранее чека.';
														|en = 'An adjustment voucher “non-use of cash register” cannot be formed for a receipt that was previously fiscalized.'");
				Возврат ПараметрыФискализации;
			КонецЕсли;                        
		...
		Иначе
			...
			Если ПустаяСтрока(ПараметрыОперации.КорректируемыйДокумент) Тогда
				...
				ПараметрыФискализации.ТекстОшибки = НСтр("ru = 'Корректируемый документ не указан для формирования чека коррекции.';
														|en = 'The adjusted document is not specified for the adjustment voucher.'");
				Возврат ПараметрыФискализации;
			КонецЕсли;       
			...
			Если КорректируемыйДокументОперация = Неопределено Тогда
				...
				ПараметрыФискализации.ТекстОшибки = НСтр("ru = 'Не найден ранее фискализированный кассовый чек для формирования чека коррекции.';
														|en = 'Previously fiscalized sales slip to generate a cash register adjustment voucher is not found.'");
				Возврат ПараметрыФискализации;
			КонецЕсли;            
		...
		Если Не Аппаратно Тогда 
			...
			Если НЕ ЗначениеЗаполнено(ДокументСсылка) И ПустаяСтрока(ФискальныйПризнак) Тогда
				ТекстОшибки = НСтр("ru = 'Не указаны параметры печати копии документа.';
									|en = 'Document copy print parameters are not specified.'");
				ДанныеОперации.Результат = Ложь;
			...
			Если ФискальнаяОперация = Неопределено Тогда
				ТекстОшибки = НСтр("ru = 'Фискальный документ для печати копии не найден.';
									|en = 'Fiscal document for printing the copy is not found.'");
				ДанныеОперации.Результат = Ложь;
				ДанныеОперации.ТекстОшибки = ТекстОшибки;
				Возврат ДанныеОперации;
			КонецЕсли;
			...
			ТекстЧека = ТекстЧека  + Символы.ПС + ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ВыстроитьПоля(НСтр("ru = 'РН ККТ:';
																														|en = 'Cash register registration number:'"), ФискальнаяОперация.РегистрационныйНомерККТ, ШиринаСтроки);
			ТекстЧека = ТекстЧека  + Символы.ПС + ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ВыстроитьПоля(НСтр("ru = 'ФН №:';
																														|en = 'Fiscal memory device N.:'")  , ФискальнаяОперация.ЗаводскойНомерФН, ШиринаСтроки);
			ТекстЧека = ТекстЧека  + Символы.ПС + ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ВыстроитьПоля(НСтр("ru = 'ФД №:';
																														|en = 'Fiscal document No:'")  , Формат(ФискальнаяОперация.НомерЧекаККМ,"ЧГ="), ШиринаСтроки);
			ТекстЧека = ТекстЧека  + Символы.ПС + ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ВыстроитьПоля(НСтр("ru = 'ФП:';
																														|en = 'Fiscal flag:'")    , ФискальнаяОперация.ФискальныйПризнак, ШиринаСтроки);
	...
	ИначеЕсли Команда = "CheckKM" Тогда
		...
		Если ОбщегоНазначенияБПО.ИспользуетсяМаркировка() Тогда
			...
			Для Каждого Операция Из ДанныеОперации.ЗапросыКМ Цикл
				...
				Операция.Вставить("ПараметрыXML", МодульМенеджерОборудованияМаркировка.СформироватьXMLДляЗапросаКМ(Операция, ПараметрыПодключения.РевизияИнтерфейса));
		...
		Если ДанныеОперации.Свойство("ПараметрыККТ") И Не ПустаяСтрока(ДанныеОперации.ПараметрыККТ)  Тогда 
			...
			Если ПараметрыККТ.Свойство("ВерсияФФДККТ") И ПараметрыККТ.ВерсияФФДККТ <> "1.2" Тогда
				...
				Если ВедетсяУчетПродукцииИСМП Тогда
					ТекстСообщения = НСтр("ru = 'При осуществлении расчетов за маркированные товары необходимо перейти на ККТ с ФФД версии 1.2 в срок до 01.02.2022.';
											|en = 'When making payments for marked goods, switch to the cash register with FDF of version 1.2 before 02/01/2022.'") + Символы.ПС 
					+ НСтр("ru = 'Письмо ФНС от 28 октября 2021 г. № ПА-4-20/15207@ «О переходе ККТ на ФФД 1.2»';
							|en = 'Letter of the Federal Tax Service dated October 28, 2021 No. PA-4-20/15207@ ""On migrating the cash register to FDF 1.2""'"); 
			...
			ИначеЕсли ПараметрыККТ.Свойство("ВерсияФФДККТ") И ПараметрыККТ.ВерсияФФДККТ = "1.2" И ВедетсяУчетПродукцииИСМП Тогда
				Если НЕ ПараметрыККТ.ПродажаМаркированныхТоваров Тогда
					ТекстСообщения = НСтр("ru = 'ККТ не зарегистрирована для работы с маркированной продукцией.';
											|en = 'ККТ не зарегистрирована для работы с маркированной продукцией.'") + Символы.ПС 
					+ НСтр("ru = 'Необходимо провести перерегистрацию ККТ.';
							|en = 'Необходимо провести перерегистрацию ККТ.'"); 
					ОбщегоНазначенияБПО.СообщитьПользователю(ТекстСообщения);
				КонецЕсли;
			КонецЕсли;
		Иначе
			...
			Исключение
				...
				ОбщегоНазначенияБПО.ЗаписатьОшибкуВЖурналРегистрации(
					НСтр("ru = 'Ошибка записи в журнал проверки кода маркировки.';
						|en = 'An error occurred when recording the marking code check to the log.'"),
	...
	Если ИспользуетсяКассовыеСмены() Тогда
		...
		Если ОписаниеКассовойСмены <> Неопределено И ОписаниеКассовойСмены.Статус = Перечисления.СтатусыКассовойСмены.Открыта Тогда
			...
			ДанныеОперации.ТекстОшибки = НСтр("ru = 'Кассовая смена уже открыта.';
												|en = 'POS shift is already opened.'");
		КонецЕсли;
	КонецЕсли;
	...
	Если ИспользуетсяКассовыеСмены() Тогда
		...
		Иначе
			...
			ДанныеОперации.ТекстОшибки = НСтр("ru = 'Кассовая смена уже закрыта.';
												|en = 'POS shift is already closed.'");
		КонецЕсли;
	КонецЕсли;
