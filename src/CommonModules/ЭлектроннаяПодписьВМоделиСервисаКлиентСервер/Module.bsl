...
Функция ПолучитьОписаниеСпособовПодтвержденияКриптоопераций() Экспорт
	...
	|en = 'A sign of confirming operations with a user key stored in the application.
	|To confirm, a temporary password is entered sent via a text message or an email.'");
