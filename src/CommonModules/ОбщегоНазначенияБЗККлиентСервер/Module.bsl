	...
	ОбщегоНазначенияКлиентСервер.Проверить(
		...
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Недопустимое значение свойства ""Вид"" поля %3, переданного в параметре %2 в процедуру %1. Ожидается поле ввода.';
				|en = 'Invalid value of the Kind property of the %3 field transferred in the %2 parameter to the %1 procedure. Awaiting input field.'"),
...
Функция НаименованиеПериода(НачалоПериода, ОкончаниеПериода) Экспорт
	...
	Возврат СтрШаблон(НСтр("ru = 'с %1 по %2';
							|en = 'from %1 to %2'"), НачалоПериодаПредставление, ОкончаниеПериодаПредставление);
КонецФункции
