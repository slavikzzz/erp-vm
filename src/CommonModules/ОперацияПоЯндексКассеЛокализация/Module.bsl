...
Функция ДанныеПоОбъектамРасчетовПоДокументу(ДокументСсылка, ИмяКомандыПробитияЧека, ВзаиморасчетыОбновлены) Экспорт
	...
	ИскомыеРеквизиты = "ОбъектРасчетов, ОснованиеПлатежа, СуммаНДС10, СуммаНДС20, СуммаНДС7, СуммаНДС5, СуммаДокумента";
	...
	НоваяСтрока.СуммаНДС = РеквизитыДокумента.СуммаНДС10 + РеквизитыДокумента.СуммаНДС20 + РеквизитыДокумента.СуммаНДС7 + РеквизитыДокумента.СуммаНДС5;
