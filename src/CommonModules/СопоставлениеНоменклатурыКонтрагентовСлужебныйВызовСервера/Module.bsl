...
Функция ЗапуститьПерезаполнениеСловаряСопоставленияНоменклатурыВФоне(Знач УникальныйИдентификатор = Неопределено) Экспорт
	
	НаименованиеЗадания = НСтр("ru = 'Сопоставление номенклатуры контрагентов.
								|Перезаполнение словаря сопоставления номенклатуры.';
								|en = 'Map partner items.
								|Refill item mapping dictionary.'");
