...
Функция СформироватьТекстЗаставки(Знач ШаблонТекста)
	...
	ПараметрыТекста["[ЗаголовокЗаставки]"] = НСтр("ru = 'Обновление конфигурации ""1С:Предприятие""...';
													|en = 'Updating 1C:Enterprise application…'");
	...
	ПараметрыТекста["[Шаг11ОтключениеПатчей]"] = НСтр("ru = 'Временное отключение исправлений (патчей)';
														|en = 'Временное отключение исправлений (патчей)'");
	...
	ПараметрыТекста["[Шаг42ВключениеПатчей]"] = НСтр("ru = 'Включение исправлений (патчей)';
													|en = 'Включение исправлений (патчей)'");
		...
		Исключение
			...
			ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось удалить исправление ""%1"" по причине:
				           |
				           |%2';
				           |en = 'Cannot delete patch ""%1"" due to:
				           |
...
Процедура ОтключитьИсправленияИзСкрипта() Экспорт
	...
	ТекстСообщения = НСтр("ru = 'Начато временное отключение исправлений до запуска обновления приложения.';
							|en = 'Начато временное отключение исправлений до запуска обновления приложения.'");
	ЗаписьЖурналаРегистрации(ОбновлениеКонфигурации.СобытиеЖурналаРегистрации(), УровеньЖурналаРегистрации.Информация,,, ТекстСообщения);
		...
		Исключение
			...
			ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось отключить исправление ""%1"" по причине:
				           |
				           |%2';
				           |en = 'Не удалось отключить исправление ""%1"" по причине:
				           |
				           |%2'"), Расширение.Имя, ОбработкаОшибок.КраткоеПредставлениеОшибки(ИнформацияОбОшибке));
			ЗаписьЖурналаРегистрации(НСтр("ru = 'Исправления.Отключение';
											|en = 'Исправления.Отключение'", ОбщегоНазначения.КодОсновногоЯзыка())
				, УровеньЖурналаРегистрации.Ошибка,,, ТекстОшибки);
		КонецПопытки;
	КонецЦикла;
	
	ТекстСообщения = НСтр("ru = 'Временное Отключение исправлений завершено.';
							|en = 'Временное Отключение исправлений завершено.'");
	ЗаписьЖурналаРегистрации(ОбновлениеКонфигурации.СобытиеЖурналаРегистрации(), УровеньЖурналаРегистрации.Информация,,, ТекстСообщения);
...
Функция СообщенияСкриптов()
	...
	Сообщения["[СообщениеДеталиИсключения]"] = НСтр("ru = 'Исключение при запуске приложения: {0}, {1}';
													|en = 'Exception when starting the application: {0}, {1}'");
	...
	Сообщения["[СообщениеОтказВызоваОтключитьИсправленияИзСкрипта]"] = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Исключение при вызове %1: {0}, {1}.';
			|en = 'Exception when calling %1: {0}, {1}.'"), "ОбновлениеКонфигурацииВызовСервера.ОтключитьИсправленияИзСкрипта");
	...
	Сообщения["[СообщениеОтказОтключенияИсправлений]"] = НСтр("ru = 'Не удалось отключить исправления конфигурации. Подробности см. в предыдущей записи.';
																|en = 'Не удалось отключить исправления конфигурации. Подробности см. в предыдущей записи.'");
	...
	Сообщения["[СообщениеОтказВключенияИсправлений]"] = НСтр("ru = 'Не удалось Включить исправления конфигурации. Подробности см. в предыдущей записи.';
															|en = 'Не удалось Включить исправления конфигурации. Подробности см. в предыдущей записи.'");
