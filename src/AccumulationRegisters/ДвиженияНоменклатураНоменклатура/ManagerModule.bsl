...
Функция ИсточникиПодразделений() Экспорт
	...
	ИсточникиПодразделений.Вставить(Перечисления.ИсточникиПодразделенийАналитическихРегистров.КорАналитикаУчетаНоменклатуры, "КорСкладПодразделение");
...
Функция ИсточникиСубконто() Экспорт
	...
	МассивСубконтоКт.Добавить("Хранитель");
	...
	МассивСубконтоДт.Добавить("КорХранитель");
...
Функция ПоказателиКоличества() Экспорт
	...
	ПоказателиКоличества.Вставить(Перечисления.ПоказателиАналитическихРегистров.КорКоличество, 	"КорКоличество");
