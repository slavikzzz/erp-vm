...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Шаблон = НСтр("ru = 'Изменение личных данных %1 от %2';
					|en = 'Изменение личных данных %1 от %2'");
...
Функция ОписаниеДокументаДляЗаявки(СписокОбщихПолей) Экспорт
	...
	СтрокаСвойств = "ИзменитьФИО,Фамилия,Имя,Отчество,
	|ИзменитьДокумент,ДокументВид,ДокументСерия,ДокументНомер,ДокументДатаВыдачи,ДокументКемВыдан,ДокументКодПодразделения,
	|ИзменитьНомерТелефона,НомерМобильногоТелефона,ИзменитьАдрес,АдресРегистрации,АдресМестаПроживания,
	|ИзменитьEmail,Email,ИзменитьИНН,ИНН,ИзменитьСНИЛС,СНИЛС,ИзменитьФотографию,Фотография";
...
Функция НаименованиеЗадачи(ДокументОбъект) Экспорт
	...
	ШаблонНаименования = НСтр("ru = 'Изменение личных данных';
								|en = 'Изменение личных данных'");
...
Функция СодержаниеЗадачи(ДокументОбъект) Экспорт
	...
	ШаблонНаименования = НСтр("ru = 'Обработать заявление на изменение личных данных';
								|en = 'Обработать заявление на изменение личных данных'");
...
Функция РольИсполнителяЗаявки() Экспорт
	...
	Возврат Справочники.РолиИсполнителей.ОтветственныйЗаИзменениеЛичныхДанных;
