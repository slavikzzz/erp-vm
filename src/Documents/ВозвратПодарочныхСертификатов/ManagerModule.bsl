...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	|	ВозвратПодарочныхСертификатов.НалогообложениеНДС КАК НалогообложениеНДС,
...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	Возврат ВозвратПодарочныхСертификатовЛокализация.ТекстОтраженияВРеглУчете();
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	Возврат ВозвратПодарочныхСертификатовЛокализация.ТекстЗапросаВТОтраженияВРеглУчете();
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	ШаблонКомментарияОбработчика = НСтр("ru = 'Заполнение в документе ""%1"" нового реквизита шапки ""%2"" на основании данных регистра сведений ""%3""';
										|en = 'Fill the new ""%2"" header attribute in the ""%1"" document based on the ""%3"" information register data'");
