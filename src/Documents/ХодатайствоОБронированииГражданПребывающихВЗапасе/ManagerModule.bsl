...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru = 'Ходатайство о бронировании в соответствии с перечнем (форма № 8)';
										|en = 'Reservation request according to the list (form No. 8)'");
	...
	КомандаПечати.Представление = НСтр("ru = 'Ходатайство об индивидуальном бронировании (форма № 2)';
										|en = 'Individual reservation request (form No. 2)'");
...
Функция ПечатнаяФормаХодатайстваОБронированииВСоответствииСПеречнем(МассивОбъектов, ОбъектыПечати)
	...
	Пока ВыборкаПоДокументам.Следующий() Цикл
		...
		Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ХодатайствоОБронированииГражданПребывающихВЗапасе.ПФ_MXL_ХодатайствоОБронированииВСоответствииСПеречнем2023");
		
		ИспользоватьФорму2017 = Ложь;
		ИспользоватьФорму2023 = Ложь;
		Если ВыборкаПоДокументам.ДатаДок >= '20231102' Тогда
			ИспользоватьФорму2023 = Истина;
		ИначеЕсли ВыборкаПоДокументам.ДатаДок >= '20170801' Тогда 
			ИспользоватьФорму2017 = Истина;
		...
		Пока ВыборкаПоСтрокам.НайтиСледующий(СтруктураПоиска) Цикл 
			...
			Если ИспользоватьФорму2017 Или ИспользоватьФорму2023 Тогда 
			...
			Если ИспользоватьФорму2023 Тогда 
				Должность = Строка(ВыборкаПоСтрокам.Должность) 
					+ Символы.ПС + ВыборкаПоДокументам.ПолноеНаименованиеОрганизации 
					+ Символы.ПС + ВыборкаПоДокументам.ИНН;
				СтрокаТаблицы.Параметры.Должность = Должность;
			КонецЕсли;
...
Функция ДанныеДляПечатиДокументаХодатайствоОБронировании(МассивСсылок)
	...
	|	ХодатайствоОБронировании.Организация.ИНН КАК ИНН,
