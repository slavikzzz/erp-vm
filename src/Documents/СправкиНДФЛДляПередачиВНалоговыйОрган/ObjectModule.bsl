...
Функция СформироватьЗапросПоСтрокамДокументаДляПроверки(Сотрудники)
	...
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ОбщаяСуммаДоходаПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ОблагаемаяСуммаДоходаПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ИсчисленоПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.УдержаноПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ЗадолженностьПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ИзлишнеУдержаноПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ПеречисленоПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ОбщаяСуммаДоходаПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ОблагаемаяСуммаДоходаПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ИсчисленоПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.УдержаноПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ЗадолженностьПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ИзлишнеУдержаноПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ПеречисленоПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ОбщаяСуммаДоходаПоСтавке22,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ОблагаемаяСуммаДоходаПоСтавке22,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ИсчисленоПоСтавке22,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.УдержаноПоСтавке22,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ЗадолженностьПоСтавке22,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ИзлишнеУдержаноПоСтавке22,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ПеречисленоПоСтавке22,
	...
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ЗачтеноАвансовыхПлатежейПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ЗачтеноАвансовыхПлатежейПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ЗачтеноАвансовыхПлатежейПоСтавке22
	|ПОМЕСТИТЬ ВТСотрудники
	|ИЗ
	...
	|	Сотрудники.ОбщаяСуммаДоходаПоСтавке18,
	|	Сотрудники.ОблагаемаяСуммаДоходаПоСтавке18,
	|	Сотрудники.ИсчисленоПоСтавке18,
	|	Сотрудники.УдержаноПоСтавке18,
	|	Сотрудники.ЗадолженностьПоСтавке18,
	|	Сотрудники.ИзлишнеУдержаноПоСтавке18,
	|	Сотрудники.ПеречисленоПоСтавке18,
	|	Сотрудники.ОбщаяСуммаДоходаПоСтавке20,
	|	Сотрудники.ОблагаемаяСуммаДоходаПоСтавке20,
	|	Сотрудники.ИсчисленоПоСтавке20,
	|	Сотрудники.УдержаноПоСтавке20,
	|	Сотрудники.ЗадолженностьПоСтавке20,
	|	Сотрудники.ИзлишнеУдержаноПоСтавке20,
	|	Сотрудники.ПеречисленоПоСтавке20,
	|	Сотрудники.ОбщаяСуммаДоходаПоСтавке22,
	|	Сотрудники.ОблагаемаяСуммаДоходаПоСтавке22,
	|	Сотрудники.ИсчисленоПоСтавке22,
	|	Сотрудники.УдержаноПоСтавке22,
	|	Сотрудники.ЗадолженностьПоСтавке22,
	|	Сотрудники.ИзлишнеУдержаноПоСтавке22,
	|	Сотрудники.ПеречисленоПоСтавке22,
	...
	|	Сотрудники.ЗачтеноАвансовыхПлатежейПоСтавке18,
	|	Сотрудники.ЗачтеноАвансовыхПлатежейПоСтавке20,
	|	Сотрудники.ЗачтеноАвансовыхПлатежейПоСтавке22
	|ИЗ
	|	ВТСотрудники КАК Сотрудники
	...
	Если ОснованиеДляПредставленияСправок 
		...
		Если Не ЗначениеЗаполнено(ФормаРеорганизации) Тогда
			ТекстСообщения = НСтр("ru = 'Не указан код формы реорганизации.';
									|en = 'Reorganization form code is not specified.'");
		...
		Если Не ЗначениеЗаполнено(НаименованиеРеорганизованнойОрганизации) Тогда
			ТекстСообщения = НСтр("ru = 'Не указано наименование реорганизованной организации.';
									|en = 'Reorganized company name is not specified.'");
				ОбщегоНазначенияБЗК.ДобавитьОшибкуЗаполненияДокумента(
				Ошибки, 
				ТекстСообщения, 
				ЭтотОбъект, 
		...
		Если ФормаРеорганизации <> "0" Тогда
			Если Не ЗначениеЗаполнено(ИННРеорганизованнойОрганизации) Тогда
				ТекстСообщения = НСтр("ru = 'Не указан ИНН реорганизованной организации.';
										|en = 'Reorganized company TIN is not specified.'");
				ОбщегоНазначенияБЗК.ДобавитьОшибкуЗаполненияДокумента(
				Ошибки, 
				ТекстСообщения, 
				ЭтотОбъект, 
			...
			Если Не ЗначениеЗаполнено(КППРеорганизованнойОрганизации) Тогда
				ТекстСообщения = НСтр("ru = 'Не указан КПП реорганизованной организации.';
										|en = 'Reorganized company KPP is not specified.'");
				ОбщегоНазначенияБЗК.ДобавитьОшибкуЗаполненияДокумента(
				Ошибки, 
				ТекстСообщения, 
				ЭтотОбъект, 
	...
	Пока ВыборкаСотрудниковДляПроверки.СледующийПоЗначениюПоля("НомерСтроки") Цикл
		...
		Если ВыборкаСотрудниковДляПроверки.ЕстьПовторяющиесяНомераСправок Тогда
			...
			ТекстСообщения = НСтр("ru = 'Номер справки был введен в документе ранее';
									|en = 'Certificate number has been entered in the document earlier'");
			ОбщегоНазначенияБЗК.ДобавитьОшибкуЗаполненияДокумента(
			Ошибки, 
			ТекстСообщения, 
			ЭтотОбъект, 
		...
		НачалоСообщения = СтрШаблон(
			НСтр("ru = 'Сотрудник %1, справка № %2:';
				|en = 'Employee %1, certificate No. %2:'"), 
