...
Функция ПолучитьТаблицыДанныхДокументовДляПечати(Ссылки)
	...
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ОбщаяСуммаДоходаПоСтавке18 КАК ОбщаяСуммаДоходаПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ОблагаемаяСуммаДоходаПоСтавке18 КАК ОблагаемаяСуммаДоходаПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ИсчисленоПоСтавке18 КАК ИсчисленоПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.УдержаноПоСтавке18 КАК УдержаноПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ЗадолженностьПоСтавке18 КАК ЗадолженностьПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ИзлишнеУдержаноПоСтавке18 КАК ИзлишнеУдержаноПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ПеречисленоПоСтавке18 КАК ПеречисленоПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ОбщаяСуммаДоходаПоСтавке20 КАК ОбщаяСуммаДоходаПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ОблагаемаяСуммаДоходаПоСтавке20 КАК ОблагаемаяСуммаДоходаПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ИсчисленоПоСтавке20 КАК ИсчисленоПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.УдержаноПоСтавке20 КАК УдержаноПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ЗадолженностьПоСтавке20 КАК ЗадолженностьПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ИзлишнеУдержаноПоСтавке20 КАК ИзлишнеУдержаноПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ПеречисленоПоСтавке20 КАК ПеречисленоПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ОбщаяСуммаДоходаПоСтавке22 КАК ОбщаяСуммаДоходаПоСтавке22,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ОблагаемаяСуммаДоходаПоСтавке22 КАК ОблагаемаяСуммаДоходаПоСтавке22,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ИсчисленоПоСтавке22 КАК ИсчисленоПоСтавке22,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.УдержаноПоСтавке22 КАК УдержаноПоСтавке22,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ЗадолженностьПоСтавке22 КАК ЗадолженностьПоСтавке22,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ИзлишнеУдержаноПоСтавке22 КАК ИзлишнеУдержаноПоСтавке22,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ПеречисленоПоСтавке22 КАК ПеречисленоПоСтавке22,
	...
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ЗачтеноАвансовыхПлатежейПоСтавке18 КАК ЗачтеноАвансовыхПлатежейПоСтавке18,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ЗачтеноАвансовыхПлатежейПоСтавке20 КАК ЗачтеноАвансовыхПлатежейПоСтавке20,
	|	СправкиНДФЛДляПередачиВНалоговыйОрганСотрудники.ЗачтеноАвансовыхПлатежейПоСтавке22 КАК ЗачтеноАвансовыхПлатежейПоСтавке22,
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru = 'Справка о доходах (2-НДФЛ) со штрихкодом PDF417';
										|en = 'Income statement (2-NDFL) with barcode PDF417'");
	...
	КомандаПечати.Представление = НСтр("ru = 'Справка о доходах для сотрудников(2-НДФЛ)';
										|en = 'Income statement for employees (2-NDFL)'");
	...
	КомандаПечати.Представление = НСтр("ru = 'Реестр (дополнительный с 2014 г.)';
										|en = 'Registry (additional since 2014)'");
	...
	КомандаПечати.Представление = НСтр("ru = 'Реестр (дополнительный с 2011 г.)';
										|en = 'Registry (additional since 2011)'");
	...
	Если Документы2019Года.Количество() <> 0 Тогда 
		Если ТаблицыДокумента.Сотрудники.Количество() > ОграничениеНаКоличествоСотрудниковВМашиночитаемомБланке() Тогда
			Если БольшоеКоличествоСотрудниковВМашиночитаемомБланке(Документы2019Года, ТаблицыДокумента.Сотрудники) Тогда
				...
				|en = 'The machine-readable form is intended for a small number of employees. 
				| Use the 2-NDFL printed form for an employee'", );
