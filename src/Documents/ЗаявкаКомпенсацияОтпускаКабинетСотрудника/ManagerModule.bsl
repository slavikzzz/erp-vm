...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Шаблон = НСтр("ru = 'Заявка компенсация отпуска %1 от %2';
					|en = 'Заявка компенсация отпуска %1 от %2'");
...
Функция ОписаниеДокументаДляЗаявки(СписокОбщихПолей) Экспорт
	...
	СтрокаСвойств = "КоличествоДнейКомпенсацииОтпуска,ДанныеПоВидамОтпусков";
...
Функция НаименованиеЗадачи(ДокументОбъект) Экспорт
	...
	ШаблонНаименования = НСтр("ru = 'Компенсация отпуска';
								|en = 'Компенсация отпуска'");
...
Функция СодержаниеЗадачи(ДокументОбъект) Экспорт
	...
	Шаблон = НСтр("ru = 'Обработать заявление на компенсацию отпуск
	|Организация: %1
	|Сотрудник: %2';
	|en = 'Обработать заявление на компенсацию отпуск
	|Организация: %1
	|Сотрудник: %2'");
	
	Возврат СтрШаблон(Шаблон, Строка(ДокументОбъект.Организация), Строка(ДокументОбъект.Сотрудник));
