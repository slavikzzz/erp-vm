...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("Структура") Тогда
		...
		КонецЕсли;
		Для каждого ДанныеПоВидуОтпуска Из ДанныеЗаполнения.ДанныеПоВидамОтпусков Цикл
			НоваяСтрока = ДанныеПоВидамОтпусков.Добавить();
			ЗаполнитьЗначенияСвойств(НоваяСтрока, ДанныеПоВидуОтпуска);
			КоличествоДнейКомпенсацииОтпуска = КоличествоДнейКомпенсацииОтпуска + НоваяСтрока.КоличествоДнейКомпенсацииОтпуска;
		КонецЦикла;
	КонецЕсли;
