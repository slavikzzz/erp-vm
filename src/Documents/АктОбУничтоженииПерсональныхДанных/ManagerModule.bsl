...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru = 'Акт об уничтожении персональных данных';
										|en = 'Certificate of personal data destruction'");
...
Процедура ПроверитьВозможностьОформленияАкта(Субъект) Экспорт
	...
	Если ЗащитаПерсональныхДанных.ЭтоОбъектСУничтоженнымиПерсональнымиДанными(Субъект) Тогда
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Оформление акта невозможно, персональные данные субъекта %1 уже уничтожены.';
				|en = 'The certificate cannot be created. The personal data of subject %1 has already been destroyed.'"), Строка(Субъект));
	КонецЕсли;
