...
Процедура СтатусПредставлениеОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	Если (Не ЗначениеЗаполнено(Объект.Ссылка)) Или (Не Объект.Проведен) Тогда
		...
		ТекстВопроса = НСтр("ru = '""Вывод из оборота ИС МП"" не проведен. Провести?';
							|en = '""Вывод из оборота ИС МП"" не проведен. Провести?'");
	...
	ИначеЕсли Модифицированность Тогда
		...
		ТекстВопроса = НСтр("ru = '""Вывод из оборота ИС МП"" был изменен. Провести?';
							|en = '""Вывод из оборота ИС МП"" был изменен. Провести?'");
		ПоказатьВопрос(ОписаниеОповещенияВопрос, ТекстВопроса, РежимДиалогаВопрос.ДаНет);
...
Процедура ВидУчетаОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если Объект.ШтрихкодыУпаковок.Количество() > 0 И ВыбранноеЗначение <> Объект.ОбъемноСортовойУчет Тогда
		...
		ТекстВопроса = НСтр("ru = 'При изменении вида учета штрихкоды упаковок будут очищены. Продолжить?';
							|en = 'При изменении вида учета штрихкоды упаковок будут очищены. Продолжить?'");
