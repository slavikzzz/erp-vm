...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	Возврат ПрочиеДоходыРасходыЛокализация.ТекстОтраженияВРеглУчете();
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	Возврат ПрочиеДоходыРасходыЛокализация.ТекстЗапросаВТОтраженияВРеглУчете();
...
Функция ПараметрыНастройкиСчетовУчета(ХозяйственнаяОперация) Экспорт
	...
	#Область НастройкаКорСчетаОтраженияПрочихРасходов
	...
	ПараметрыНастройки.ЭлементыФормы.Добавить("РасходыПредставлениеОтраженияВРеглУчетеБезРазбиения");
	...
	#Область НастройкаКорСчетаОтраженияПрочихДоходов
	ПараметрыНастройки = НастройкаСчетовУчетаСервер.ПараметрыНастройки();
	ПараметрыНастройки.ПутьКДанным = "Объект.ПрочиеДоходы";
	ПараметрыНастройки.СтатьяАктивовПассивов = "СтатьяАктивовПассивов";
	ПараметрыНастройки.ВерсияНастройкиСчетовУчета = "ВерсияНастройкиСчетовУчета";
	ПараметрыНастройки.Представление = "ПредставлениеОтраженияВРеглУчете";
	ПараметрыНастройки.ДоступностьПоОперации = 
	...
	ПараметрыНастройки.Организация = "Объект.Организация";
	ПараметрыНастройки.ЭлементыФормы.Добавить("ДоходыПредставлениеОтраженияВРеглУчете");
	ПараметрыНастройки.ЭлементыФормы.Добавить("ДоходыПредставлениеОтраженияВРеглУчетеБезРазбиения");
	ПараметрыНастройки.ЭлементыФормы.Добавить("ПрочиеДоходыПредставлениеОтраженияВРеглУчете");
	МассивПараметров.Добавить(ПараметрыНастройки);
	#КонецОбласти
...
Функция ТекстЗапросаВтДанныеРасходы(Запрос, ТекстыЗапроса) Экспорт
	...
	//++ НЕ УТ
	|	ДанныеДокументаРасходы.НастройкаСчетовУчета                 КАК НастройкаСчетовУчета,
	//-- НЕ УТ
	|
...
Функция ТекстЗапросаВтДанныеДоходы(Запрос, ТекстыЗапроса) Экспорт
	...
	//++ НЕ УТ
	|	ДанныеДокументаДоходы.НастройкаСчетовУчета       КАК НастройкаСчетовУчета,
	//-- НЕ УТ
	|
	|	ВЫБОР
	|		КОГДА &ХозяйственнаяОперация В (
...
Функция ТекстЗапросаТаблицаДвиженияПоПрочимАктивамПассивам(Запрос, ТекстыЗапроса, Регистры)
	...
	|	ВтДанныеДоходы.АналитикаАктивовПассивов КАК Аналитика,
	//++ НЕ УТ
	|	ВтДанныеДоходы.НастройкаСчетовУчета КАК НастройкаСчетовУчета,
	//-- НЕ УТ
	...
	|	ВтДанныеРасходы.АналитикаАктивовПассивов КАК Аналитика,
	//++ НЕ УТ
	|	ВтДанныеРасходы.НастройкаСчетовУчета КАК НастройкаСчетовУчета,
	//-- НЕ УТ
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение реквизита ""Международный фин. учет"" табличной части ""Прочие расходы""';
									|en = 'Fill the ""Financial accounting"" attribute in the ""Other expenses"" table'");
