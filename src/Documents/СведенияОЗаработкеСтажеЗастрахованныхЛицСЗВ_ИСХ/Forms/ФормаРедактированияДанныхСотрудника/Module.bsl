...
Процедура УстановитьСвойстваЭлементовФормы()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СведенияОЗаработкеОблагаетсяВзносамиГруппа",  
		"Заголовок", ?(ОтчетныйГод > 2009, НСтр("ru = 'Облагается взносами до пред. величины';
												|en = 'Subject to contributions up to limit value'"), НСтр("ru = 'Облагается взносами';
																										|en = 'Subject to contributions'")));
