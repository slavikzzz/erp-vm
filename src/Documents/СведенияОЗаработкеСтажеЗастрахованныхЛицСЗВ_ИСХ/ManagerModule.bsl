...
Процедура ВписатьСтавкуВНаборДанныхТеррУсловий(ТерриториальныеУсловия, Ставка, НаборДанных) Экспорт
	...
	Если (ТерриториальныеУсловия = Справочники.ТерриториальныеУсловияПФР.МКС
		...
		Или ТерриториальныеУсловия = Справочники.ТерриториальныеУсловияПФР.МКСР
		Или ТерриториальныеУсловия = Справочники.ТерриториальныеУсловияПФР.ОКУ) И ЗначениеЗаполнено(Ставка) Тогда
