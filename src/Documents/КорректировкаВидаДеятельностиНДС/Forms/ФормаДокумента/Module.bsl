...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ НЕ УТ
	СписокВыбораНалогообложенияНДС.Добавить(Перечисления.ТипыНалогообложенияНДС.ВводОСВЭксплуатацию, НСтр("ru = 'Определяется использованием ОС/НМА';
																											|en = 'Determined by fixed assets/intangible assets usage'"));
	СписокВыбораНалогообложенияНДС.Добавить(Перечисления.ТипыНалогообложенияНДС.ПроизводствоСДЦ,     НСтр("ru = 'Производство с длит. циклом';
