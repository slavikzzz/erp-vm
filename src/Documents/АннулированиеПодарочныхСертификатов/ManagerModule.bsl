...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	Возврат АннулированиеПодарочныхСертификатовЛокализация.ТекстОтраженияВРеглУчете();
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	Возврат АннулированиеПодарочныхСертификатовЛокализация.ТекстЗапросаВТОтраженияВРеглУчете();
...
Функция ПросроченныеПодарочныеСертификатыНаДату(Организация, Знач ПериодАннулирования, КоллекцияПС = Неопределено,
	...
	Запрос.Параметры.Вставить("ДатаАннулирования", Новый Граница(ПериодАннулирования, ВидГраницы.Исключая));
	...
	|ИЗ
	|	РегистрСведений.ИсторияПодарочныхСертификатов.СрезПоследних(&ДатаАннулирования, &ОтборОбъектовРасчетаПодмена) КАК
...
Процедура СоздатьДокументАннулирования(Параметры)
	...
	Исключение
		...
		ПараметрыЖурнала.ГруппаСобытий = НСтр("ru = 'Автоматическое аннулирование подарочных сертификатов. Ошибка аннулирования ПС';
												|en = 'Automatically void gift cards. Error voiding gift cards'");
