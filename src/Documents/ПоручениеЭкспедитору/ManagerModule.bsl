...
Процедура ЗаполнитьТабличныйДокументПоручениеЭкспедитору(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати)
	...
	ЗаголовокДокумента = ОбщегоНазначенияУТКлиентСервер.СформироватьЗаголовокДокумента(РеквизитыДокумента,
		НСтр("ru = 'Поручение экспедитору';
			|en = 'Delivery request'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	Если ДанныеДляПечатиСтрока.СпособДоставки = Перечисления.СпособыДоставки.ПоручениеЭкспедиторуСоСклада
		...
		СтруктураДанныхОткуда.Вставить("Направление", НСтр("ru = 'Откуда';
															|en = 'From'", ОбщегоНазначения.КодОсновногоЯзыка()));
		...
		СтруктураДанныхКуда.Вставить("Направление", НСтр("ru = 'Куда';
														|en = 'To'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	Иначе
		...
		СтруктураДанныхНаправление.Вставить("Направление", НСтр("ru = 'Где';
																|en = 'Where'", ОбщегоНазначения.КодОсновногоЯзыка()));
