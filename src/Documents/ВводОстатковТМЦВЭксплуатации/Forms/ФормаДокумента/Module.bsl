...
Процедура УстановитьУсловноеОформление()
	...
	ТМЦВЭксплуатацииСервер.УстановитьУсловноеОформлениеИнвентарногоНомера(
		ЭтотОбъект,
		Элементы.ТМЦВЭксплуатацииИнвентарныйНомер.Имя,
	...
	ТМЦВЭксплуатацииСервер.УстановитьУсловноеОформлениеФизЛица(
		ЭтотОбъект,
		Элементы.ТМЦВЭксплуатацииФизическоеЛицо.Имя,
		"Объект.ТМЦВЭксплуатации.УчетПоФизЛицам",
		"Объект.ТМЦВЭксплуатации.КатегорияЭксплуатации");
	
	#Область ТМЦВЭксплуатацииОсновноеСредство
	
	ЭлементУсловногоОформления = УсловноеОформление.Элементы.Добавить();
	
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(
		ЭлементУсловногоОформления.Поля, Элементы.ТМЦВЭксплуатацииОсновноеСредство.Имя);
	
	КомпоновкаДанныхКлиентСервер.ДобавитьОтбор(
		ЭлементУсловногоОформления.Отбор, 
		"Объект.ТМЦВЭксплуатации.УчитыватьВВидеГрупповогоОС", 
		Ложь);
	...
	#Область Сумма_СуммаВР_СуммаПР_ДоФСБУ5
	...
	ГруппаОтбора = КомпоновкаДанныхКлиентСервер.ДобавитьГруппуОтбора(ЭлементУсловногоОформления.Отбор.Элементы, ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИ);
	КомпоновкаДанныхКлиентСервер.ДобавитьОтбор(ГруппаОтбора, "Объект.ТМЦВЭксплуатации.СпособПогашенияСтоимостиБУ", Перечисления.СпособыПогашенияСтоимостиТМЦ.ПриПередаче);
	КомпоновкаДанныхКлиентСервер.ДобавитьОтбор(
		ГруппаОтбора, 
		"Объект.ТМЦВЭксплуатации.ДатаНачалаЭксплуатации", 
		Новый ПолеКомпоновкиДанных("НачалоПримененияФСБУ5"),
	...
	#Область Сумма_СуммаВР_СуммаПР_ПослеФСБУ5
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУсловногоОформления.Поля, Элементы.ТМЦВЭксплуатацииСуммаПР.Имя);
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУсловногоОформления.Поля, Элементы.ТМЦВЭксплуатацииСуммаВР.Имя);
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУсловногоОформления.Поля, Элементы.ТМЦВЭксплуатацииСтатьяРасходов.Имя);
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУсловногоОформления.Поля, Элементы.ТМЦВЭксплуатацииАналитикаРасходов.Имя);
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(Элемент.Поля, Элементы.ТМЦВЭксплуатацииДатаНачалаЭксплуатации.Имя);
...
Функция СтоимостьСписана(Организация, Дата)
	...
	//++ Локализация
	СтоимостьСписана = ТМЦВЭксплуатацииПовтИсп.СтоимостьТМЦВЭксплуатацииСписана(Организация, Дата);
	//-- Локализация
