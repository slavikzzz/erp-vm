...
Процедура ЗагрузитьДанныеЕНВД(Форма, ЗначениеКопирования = Неопределено) Экспорт 
	...
	ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("РазрешитьВыгружатьСОшибками", Новый ОписаниеТипов("Булево")));
...
Процедура СохранитьДанныеЕНВД(Форма, ВидУведомления) Экспорт 
	...
	УведомлениеОСпецрежимахНалогообложения.СохранитьДанные(Форма, СтруктураПараметров);
КонецПроцедуры
