...
Процедура СтатусПредставлениеОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	Если (Не ЗначениеЗаполнено(Объект.Ссылка)) Или (Не Объект.Проведен) Тогда
		...
		ТекстВопроса = НСтр("ru = '""Акт применения"" не проведен. Провести?';
							|en = '""Акт применения"" не проведен. Провести?'");
	...
	ИначеЕсли Модифицированность Тогда
		...
		ТекстВопроса = НСтр("ru = '""Акт применения"" был изменен. Провести?';
							|en = '""Акт применения"" был изменен. Провести?'");
		ПоказатьВопрос(ОписаниеОповещенияВопрос, ТекстВопроса, РежимДиалогаВопрос.ДаНет);
		...
		Если КоличествоМестПрименения > 1 Тогда
			...
			ТекстВопроса = СтрШаблон(
				НСтр("ru = 'Перенести места применения (%1) из таблицы Препараты в отдельную таблицу?';
					|en = 'Перенести места применения (%1) из таблицы Препараты в отдельную таблицу?'"),
	...
	ИначеЕсли КоличествоОбщихМест > 0 Тогда
		...
		ТекстВопроса = СтрШаблон(
			НСтр("ru = 'Будут очищены места применения (%1), продолжить?';
				|en = 'Будут очищены места применения (%1), продолжить?'"),
			КоличествоОбщихМест);
...
Процедура АннулироватьОперацию(Команда)
	...
	Если Модифицированность Тогда
		...
		ТекстВопроса = НСтр("ru = 'Документ ""Акт применения ФГИС ""Сатурн"""" был изменен. Провести?';
							|en = 'Документ ""Акт применения ФГИС ""Сатурн"""" был изменен. Провести?'");
...
Процедура УстановитьУсловноеОформление()
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заполните описание, если в списке нет подходящего участка или требуется дополнительное пояснение.';
																					|en = 'Заполните описание, если в списке нет подходящего участка или требуется дополнительное пояснение.'"));
