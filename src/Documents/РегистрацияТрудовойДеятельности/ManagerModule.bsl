...
Функция ДанныеДляПроведенияДокумента(СсылкаНаДокумент) Экспорт
	...
	Запрос.Текст =
		...
		|	РегистрацияТрудовойДеятельностиМероприятия.СрочностьТрудовогоДоговора КАК СрочностьТрудовогоДоговора,
		|	РегистрацияТрудовойДеятельностиМероприятия.УдаленностьРаботы КАК УдаленностьРаботы,
		|	РегистрацияТрудовойДеятельностиМероприятия.СокращенностьГрафика КАК СокращенностьГрафика,
	...
	Для Каждого Регистратор Из ОбрабатываемыеДокументы Цикл
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Электронные трудовые книжки';
					|en = 'Electronic employment record books'", ОбщегоНазначения.КодОсновногоЯзыка()),
