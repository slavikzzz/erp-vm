...
Функция ДанныеВедомостиНаВыплатуЗарплатыВБанк(МассивДокументов, ДатаПолученияДанных = Неопределено, ПлатежныйДокумент = Неопределено, ТолькоПроведенные = Истина) Экспорт
	...
	|	ВЫБОР
	|		КОГДА ВедомостьНаВыплатуЗарплатыВБанк.ВидЗачисления = """"
	|			ТОГДА ""01""
	|		ИНАЧЕ ВедомостьНаВыплатуЗарплатыВБанк.ВидЗачисления
	|	КОНЕЦ КАК ВидЗачисления
	...
	Пока ВыборкаДокументов.Следующий() Цикл
		...
		Если ПлатежныйДокумент <> Неопределено Тогда
			...
			ДанныеДокумента.ДатаДокумента = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ПлатежныйДокумент, "Дата");
