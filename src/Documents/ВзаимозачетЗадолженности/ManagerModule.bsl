...
Функция ПредставлениеРеквизитовПоВидуОперации(ВидОперации) Экспорт
	...
	ИначеЕсли ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.ПереносДолгаПоставщикуМеждуОрганизациями Тогда
		...
		СтруктураПредставлений.Вставить("Организация",         НСтр("ru = 'Организация, оформившая поступление';
																	|en = 'Company which registered receipt'"));
		СтруктураПредставлений.Вставить("ОрганизацияКредитор", НСтр("ru = 'Организация для передачи долга';
																	|en = 'Company for debt transfer'"));
...
Процедура ИнициализироватьВтДебиторскаяКредиторскаяЗадолженность(Запрос) Экспорт
	...
	ЗапросВременныхТаблиц.Текст = ТекстЗапросаВтДебиторскаяЗадолженность() + ОбщегоНазначения.РазделительПакетаЗапросов()
								...
								+ ТекстЗапросаВтИсточники() + ОбщегоНазначения.РазделительПакетаЗапросов();
...
Функция ТекстЗапросаВтДебиторскаяЗадолженность()
	...
	|	ОбъектыРасчетов.Подразделение                   КАК Подразделение,
	|
	|	ВЫБОР КОГДА ДанныеДокумента.ПереносЗадолженностиКонтрагентаМеждуОрганизациями
	|		ТОГДА НЕОПРЕДЕЛЕНО
	|		ИНАЧЕ Долги.ОбъектРасчетов
	|	КОНЕЦ КАК                                        КорОбъектРасчетов,
	|	ВЫБОР КОГДА ДанныеДокумента.ПереносЗадолженностиКонтрагентаМеждуОрганизациями
	|		ТОГДА НЕОПРЕДЕЛЕНО
	|		ИНАЧЕ Долги.ОбъектРасчетовЗеркальный
	|	КОНЕЦ                                            КАК КорОбъектРасчетовЗеркальный,
...
Функция ТекстЗапросаВтИсточники()
	
	ТекстЗапроса = "
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	РасчетыСКлиентами.ОбъектРасчетовПриемник КАК ОбъектРасчетовПриемник,
	|	РасчетыСКлиентами.ОбъектРасчетовПриемник.ТипРасчетов КАК ТипРасчетовПриемник,
	|	РасчетыСКлиентами.ОбъектРасчетовПриемникЗеркальный КАК ОбъектРасчетовПриемникЗеркальный,
	|	РасчетыСКлиентами.ОбъектРасчетовПриемникЗеркальный.ТипРасчетов КАК ТипРасчетовПриемникЗеркальный,
	|	РасчетыСКлиентами.ОбъектРасчетов КАК ОбъектРасчетов,
	|	РасчетыСКлиентами.ОбъектРасчетовЗеркальный КАК ОбъектРасчетовЗеркальный,
	|	РасчетыСКлиентами.ИдентификаторСтроки КАК ИдентификаторСтроки,
	|	РасчетыСКлиентами.ИдентификаторСтрокиТЧ КАК ИдентификаторСтрокиТЧ,
	...
	|	РасчетыСПоставщиками.ОбъектРасчетовПриемник.ТипРасчетов КАК ТипРасчетовПриемник,
	|	РасчетыСПоставщиками.ОбъектРасчетовПриемникЗеркальный КАК ОбъектРасчетовПриемникЗеркальный,
	|	РасчетыСПоставщиками.ОбъектРасчетовПриемникЗеркальный.ТипРасчетов КАК ТипРасчетовПриемникЗеркальный,
	|	РасчетыСПоставщиками.ОбъектРасчетов КАК ОбъектРасчетов,
	|	РасчетыСПоставщиками.ОбъектРасчетовЗеркальный КАК ОбъектРасчетовЗеркальный,
	|	РасчетыСПоставщиками.ИдентификаторСтроки КАК ИдентификаторСтроки,
	|	РасчетыСПоставщиками.ИдентификаторСтрокиТЧ КАК ИдентификаторСтрокиТЧ,
...
Функция ТекстЗапросаВтРасчетыСКлиентами()
	...
	|
	|	КорОбъектыРасчетов.Ссылка                                                    КАК КорОбъектРасчетов,
	|	КорОбъектыРасчетов.Партнер                                                   КАК КорПартнер,
	|	КорОбъектыРасчетов.Организация                                               КАК КорОрганизация,
	|	КорОбъектыРасчетов.Договор                                                   КАК КорДоговор,
	|	КорОбъектыРасчетов.Контрагент                                                КАК КорКонтрагент,
	...
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ОбъектыРасчетов КАК КорОбъектыРасчетов
	|			ПО КорОбъектыРасчетов.Ссылка = ЗадолженностьПоставщикам.КорОбъектРасчетов
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.НаправленияДеятельности КАК КорНаправления
	|			ПО КорНаправления.Ссылка = КорОбъектыРасчетов.НаправлениеДеятельности
	|
	|ГДЕ
	|	ТИПЗНАЧЕНИЯ(ЗадолженностьПоставщикам.Контрагент) = ТИП(Справочник.Организации)
	|	И НЕ ЗадолженностьПоставщикам.ПереносЗадолженностиКонтрагентаМеждуОрганизациями
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|		ИНАЧЕ ЗНАЧЕНИЕ(Справочник.НаправленияДеятельности.ПустаяСсылка) 
	|	КОНЕЦ                                                                        КАК НаправлениеДеятельностиПриемник,
	|	Источники.ИдентификаторСтроки ЕСТЬ НЕ NULL                                   КАК ПоДаннымОбъектаРасчетовИсточника,
	|	ЗадолженностьПоставщикам.ИдентификаторСтроки                                 КАК ИдентификаторСтроки,
	|	ЗадолженностьПоставщикам.ПереносЗадолженностиКонтрагентаМеждуОрганизациями   КАК ПереносЗадолженностиКонтрагентаМеждуОрганизациями
	|
	|ИЗ
	...
	|			ПО НаправленияПриемникЗеркальный.Ссылка = ОбъектыРасчетовПриемникЗеркальный.НаправлениеДеятельности
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ втИсточники КАК Источники
	|			ПО ЗадолженностьПоставщикам.ОбъектРасчетовЗеркальный = Источники.ОбъектРасчетовПриемник
	|				И ЗадолженностьПоставщикам.ИдентификаторСтроки = Источники.ИдентификаторСтроки
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ОбъектыРасчетов КАК КорОбъектыРасчетов
	|			ПО Источники.ОбъектРасчетов = КорОбъектыРасчетов.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.НаправленияДеятельности КАК КорНаправления
	|			ПО КорНаправления.Ссылка = КорОбъектыРасчетов.НаправлениеДеятельности
	|
	|ГДЕ
	|	ТИПЗНАЧЕНИЯ(ЗадолженностьПоставщикам.Контрагент) = ТИП(Справочник.Организации)
	|	И ЗадолженностьПоставщикам.ПереносЗадолженностиКонтрагентаМеждуОрганизациями
	|";
...
Функция ТекстЗапросаВтРасчетыСПоставщиками()
	...
	|			ПО НаправленияПриемник.Ссылка = ОбъектыРасчетовПриемник.НаправлениеДеятельности
	|ГДЕ
	|	НЕ (ЗадолженностьПредварительная.ПереносЗадолженностиКонтрагентаМеждуОрганизациями
	|			И ЗадолженностьПредварительная.ЗаполнитьИсточник)
	|	ИЛИ НЕ ЗадолженностьПредварительная.ПереносЗадолженностиКонтрагентаМеждуОрганизациями
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	//КорОбъекты расчетов для записей приемников при расчетах между организациями
	|ВЫБРАТЬ
	|	ЗадолженностьПредварительная.Ссылка                  КАК Ссылка,
	|	ЗадолженностьПредварительная.ВидДвижения             КАК ВидДвижения,
	|	ЗадолженностьПредварительная.Организация             КАК Организация,
	...
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ втИсточники КАК Источники
	|			ПО ЗадолженностьПредварительная.ОбъектРасчетов = Источники.ОбъектРасчетовПриемник
	|				И ЗадолженностьПредварительная.ИдентификаторСтроки = Источники.ИдентификаторСтроки
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ОбъектыРасчетов КАК КорОбъектыРасчетов
	|			ПО Источники.ОбъектРасчетов = КорОбъектыРасчетов.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.НаправленияДеятельности КАК КорНаправления
	...
	|			ПО НаправленияПриемник.Ссылка = ОбъектыРасчетовПриемник.НаправлениеДеятельности
	|ГДЕ
	|	ЗадолженностьПредварительная.ПереносЗадолженностиКонтрагентаМеждуОрганизациями
	|	И ЗадолженностьПредварительная.ЗаполнитьИсточник
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	...
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ОбъектыРасчетов КАК КорОбъектыРасчетов
	|			ПО КорОбъектыРасчетов.Ссылка = ЗадолженностьКлиентов.КорОбъектРасчетовЗеркальный
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.НаправленияДеятельности КАК КорНаправления
	|			ПО КорНаправления.Ссылка = КорОбъектыРасчетов.НаправлениеДеятельности
	|ГДЕ
...
Функция ТекстЗапросаРасчетыСКлиентами()
	...
	|	ТабличнаяЧасть.ПоДаннымОбъектаРасчетовИсточника                       КАК ПоДаннымОбъектаРасчетовИсточника,
	|
...
Процедура РаспределитьТабличныеЧасти(Запрос)
	...
	|	ДанныеДокумента.КонтрагентДебитор КАК Контрагент,
	|	ВЫБОР
	|		КОГДА КурсыВалют.ВариантКурсаДоговора <> ЗНАЧЕНИЕ(Перечисление.ВариантыКурсаДоговора.Переменный)
	|				ИЛИ ДебиторскаяЗадолженность.СуммаУпр = 0
	|			ТОГДА ВЫРАЗИТЬ(ДебиторскаяЗадолженность.СуммаВзаиморасчетов * (КурсыВалют.КурсЧислительРегл / КурсыВалют.КурсЗнаменательРегл) / (КурсыВалют.КурсЧислительУпр / КурсыВалют.КурсЗнаменательУпр) КАК ЧИСЛО(31,2))
	...
	|		ИНАЧЕ
	|			ДебиторскаяЗадолженность.СуммаУпр
	|	КОНЕЦ КАК СуммаУпр,
	|	ВЫБОР
	|		КОГДА КурсыВалют.ВариантКурсаДоговора <> ЗНАЧЕНИЕ(Перечисление.ВариантыКурсаДоговора.Переменный)
	|				ИЛИ ДебиторскаяЗадолженность.СуммаРегл = 0
	|			ТОГДА ВЫРАЗИТЬ(ДебиторскаяЗадолженность.СуммаВзаиморасчетов * КурсыВалют.КурсЧислительРегл / КурсыВалют.КурсЗнаменательРегл КАК ЧИСЛО(31,2))
	|		КОГДА ДебиторскаяЗадолженность.ВалютаВзаиморасчетов = &ВалютаРегламентированногоУчета
	|			ТОГДА ДебиторскаяЗадолженность.СуммаВзаиморасчетов
	|		ИНАЧЕ
	|			ДебиторскаяЗадолженность.СуммаРегл
	|	КОНЕЦ КАК СуммаРегл,
	...
	|	ВЫБОР 
	|		КОГДА КурсыВалют.ВариантКурсаДоговора <> ЗНАЧЕНИЕ(Перечисление.ВариантыКурсаДоговора.Переменный)
	|				ИЛИ КредиторскаяЗадолженность.СуммаУпр = 0
	|			ТОГДА ВЫРАЗИТЬ(КредиторскаяЗадолженность.СуммаВзаиморасчетов * (КурсыВалют.КурсЧислительРегл / КурсыВалют.КурсЗнаменательРегл) / (КурсыВалют.КурсЧислительУпр / КурсыВалют.КурсЗнаменательУпр) КАК ЧИСЛО(31,2))
	...
	|		ИНАЧЕ
	|			КредиторскаяЗадолженность.СуммаУпр
	|	КОНЕЦ КАК СуммаУпр,
	|	ВЫБОР 
	|		КОГДА КурсыВалют.ВариантКурсаДоговора <> ЗНАЧЕНИЕ(Перечисление.ВариантыКурсаДоговора.Переменный)
	|				ИЛИ КредиторскаяЗадолженность.СуммаРегл = 0
	|			ТОГДА ВЫРАЗИТЬ(КредиторскаяЗадолженность.СуммаВзаиморасчетов * КурсыВалют.КурсЧислительРегл / КурсыВалют.КурсЗнаменательРегл КАК ЧИСЛО(31,2))
	...
	Для Каждого Отправитель Из ОтправительЗадолженности Цикл
		...
		Для Каждого Получатель Из ПолучательЗадолженности Цикл
			...
			Если НЕ СуммыРеглУпрУказаныВДокументе Тогда
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ПустаяСтрока(ТекстДокумент) Тогда
			ТекстДокумент = НСтр("ru = 'Без документа';
								|en = 'Without document'", ОбщегоНазначения.КодОсновногоЯзыка());
		КонецЕсли;
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Корректирует операцию взаимозачета задолженности';
									|en = 'Corrects the AR/AP offset transaction'");
	...
	Для Каждого ДанныеДокумента Из ОбновляемыеДанные Цикл
		...
		Попытка
			...
			Если ДокументОбъект.ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.Произвольный
				...
				ОперацияПереноса = ОперацияПереноса(ДокументОбъект.ВидОперации);
				Если ЗначениеЗаполнено(ОперацияПереноса) Тогда
					ЗаменитьОперациюВРегистрахНакопления(ДокументОбъект, НоваяАрхитектураВзаиморасчетов);
				КонецЕсли;
...
#Область ЗаменаХозяйственнойОперацииВДвижениях

Процедура ЗаменитьОперациюВРегистрахНакопления(ДокументОбъект, НоваяАрхитектураВзаиморасчетов)
	
	ПроблемныйРегистратор = ДокументОбъект.Ссылка;
	...
	Если НоваяАрхитектураВзаиморасчетов Тогда
		...
		РегистраторыРасчетов = РегистраторыРасчетов(ПроблемныйРегистратор);
	...
	ЗаменитьВОперативномРегистре(ДокументОбъект, Истина);
	ЗаменитьВОперативномРегистре(ДокументОбъект, Ложь);
	Если НоваяАрхитектураВзаиморасчетов Тогда
		ЗаменитьВРегистреПоСрокам(ДокументОбъект, РегистраторыРасчетов);
	КонецЕсли;
	
КонецПроцедуры

Функция РегистраторыРасчетов(Ссылка)
...
Процедура ЗаменитьВОперативномРегистре(ДокументОбъект, ЭтоРасчетыСКлиентами)
	...
	Для Каждого Запись Из Набор Цикл
		Если Запись.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВзаимозачетЗадолженности
				ИЛИ Запись.НастройкаХозяйственнойОперации = Справочники.НастройкиХозяйственныхОпераций.ВзаимозачетЗадолженности Тогда
			Запись.ХозяйственнаяОперация = ОперацияПереноса.Ссылка;
			Запись.НастройкаХозяйственнойОперации = ОперацияПереноса.Настройка;
		КонецЕсли;
	КонецЦикла;
	Набор.Записать();
...
Процедура ЗаменитьВРегистреПоСрокам(ДокументОбъект, РегистраторыРасчетов)
	
	ОперацияПереноса = ОперацияПереноса(ДокументОбъект.ВидОперации);
	Для Каждого РегистраторРасчета Из РегистраторыРасчетов Цикл
	
		Если РегистраторРасчета.ЭтоРасчетыСКлиентами Тогда
		...
		КонецЕсли;
		Набор.Отбор.Регистратор.Установить(РегистраторРасчета.Ссылка);
		Набор.Прочитать();
		...
		Для Каждого Запись Из Набор Цикл
			Если Запись.ДокументРегистратор = ДокументОбъект.Ссылка
...
Функция ОперацияПереноса(ВидОперации)
	
	Результат = Новый Структура;
	
	Если ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.ПереносАвансаКлиентаМеждуДвумяОрганизациями
			ИЛИ ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.ПереносАвансаКлиентаМеждуКонтрагентами
			ИЛИ ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.ПереносАвансаКлиентаМеждуОрганизациями
			...
			ИЛИ ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.ПереносАвансаПоставщикуМеждуКонтрагентами
			ИЛИ ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.ПереносАвансаПоставщикуМеждуОрганизациями
			ИЛИ ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.ПереносАвансаПоставщикуОрганизацияКонтрагент Тогда
			
		Результат.Вставить("Ссылка",Перечисления.ХозяйственныеОперации.ПереносАванса);
		Результат.Вставить("Настройка",Справочники.НастройкиХозяйственныхОпераций.ПереносАванса);
		
	ИначеЕсли ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.ПереносДолгаКлиентаМеждуДвумяОрганизациями
			ИЛИ ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.ПереносДолгаКлиентаМеждуОрганизациями
			ИЛИ ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.ПереносДолгаКлиентаМеждуКонтрагентами
			ИЛИ ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.ПереносДолгаКлиентаОрганизацияКонтрагент
			ИЛИ ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.ПереносДолгаПоставщикуМеждуДвумяОрганизациями
			ИЛИ ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.ПереносДолгаПоставщикуМеждуКонтрагентами
			ИЛИ ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.ПереносДолгаПоставщикуМеждуОрганизациями
			ИЛИ ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.ПереносДолгаПоставщикуОрганизацияКонтрагент Тогда
		Результат.Вставить("Ссылка",Перечисления.ХозяйственныеОперации.ПереносДолга);
		Результат.Вставить("Настройка",Справочники.НастройкиХозяйственныхОпераций.ПереносДолга);
	КонецЕсли;
