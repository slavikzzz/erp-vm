...
Функция ОписаниеРазделовДанных() Экспорт
	...
	ОписаниеРаздела.СообщениеДокументНеУтвержден = НСтр("ru = '%1 - данные не включены в расчет зарплаты.';
														|en = '%1 - data is not included in payroll.'");
...
Функция ТекстСообщенияНеЗаполненВидРасчета(ВнутрисменнаяНеявка) Экспорт
	ТекстСообщения = НСтр("ru = 'Не найдено ни одного начисления для регистрации %1прогулов и прочих неявок';
							|en = 'No accruals to register %1 absenteeism and other non-attendances are found'");
...
Функция РеквизитыДляПроведения(ДокументСсылка)
	...
	|	ПрогулНеявка.ПланируемаяДатаВыплаты КАК ПланируемаяДатаВыплаты,
