	...
	Иначе
		...
		Если Основание.Количество() = 0 Тогда
			...
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр( "ru = 'Нет данных для заполнения';
																|en = 'Нет данных для заполнения'"),, "СписокПоТоварнымНакладным");
			Возврат;
...
Функция ВозможностьВводаПогашенияИмпортаПродукции(Знач ВыделенныеСтроки)
	...
	Если Не ПогашениеИмпортаВозможно Тогда
		...
		ОбщегоНазначенияКлиент.СообщитьПользователю(
			НСтр("ru = 'Различаются ключевые реквизиты импортируемых партий. Выделенные строки должны быть включены в различные документы Импорта продукции';
				|en = 'Различаются ключевые реквизиты импортируемых партий. Выделенные строки должны быть включены в различные документы Импорта продукции'"),, "СписокКОформлению");
			Возврат Ложь;
