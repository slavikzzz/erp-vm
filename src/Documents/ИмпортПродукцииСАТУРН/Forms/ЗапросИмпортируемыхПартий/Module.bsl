...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если ВариантЗагрузки = 0
		...
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Укажите начало периода отбора.';
													|en = 'Укажите начало периода отбора.'"),, "НачалоПериодаОтбора",, Отказ);
	...
	Если ВариантЗагрузки = 1
		...
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Укажите идентификатор документа.';
													|en = 'Укажите идентификатор документа.'"),, "ИдентификаторОтбора",, Отказ);
