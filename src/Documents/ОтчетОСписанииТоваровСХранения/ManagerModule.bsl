...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСозданияНаОсновании, Параметры) Экспорт
	...
	//++ НЕ УТКА
	Документы.ОтчетОСписанииТоваровУХранителя.ДобавитьКомандуСоздатьНаОснованииОтчетаОСписанииТоваровДавальца(КомандыСозданияНаОсновании);
	//-- НЕ УТКА
...
Функция ТекстЗапросаЗаполненияСтатусовУказанияСерий(ПараметрыУказанияСерий) Экспорт
	...
	|								ИЛИ ВидНоменклатуры.ПолитикаУчетаСерий.УчетСерийПереданныхПереработчикуТоваров
...
Функция МакетФормыВыбораНазначений() Экспорт
	...
	ШаблонНазначения.УсловиеИспользования     =
		"Объект.ХозяйственнаяОперация <> ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.СписаниеТоваровДавальцаЗаСчетДавальца)
		|И Объект.ХозяйственнаяОперация <> ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.СписаниеТоваровДавальцаНаРасходы)";
	//-- НЕ УТКА
	...
	ШаблонНазначения.УсловиеИспользования    =
		"Объект.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.СписаниеТоваровДавальцаЗаСчетДавальца)
		|ИЛИ Объект.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.СписаниеТоваровДавальцаНаРасходы)";
	ШаблонНазначения.НаправлениеДеятельности = "Объект.НаправлениеДеятельности";
	...
	ШаблонНазначения.ВидимыеОтборыНаФорме.Вставить(
		"НаправлениеДеятельности", НСтр("ru = 'Только назначения направления деятельности ""%1""';
...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	Возврат ОтчетОСписанииТоваровСХраненияЛокализация.ТекстОтраженияВРеглУчете();
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	Возврат ОтчетОСписанииТоваровСХраненияЛокализация.ТекстЗапросаВТОтраженияВРеглУчете();
...
Процедура ЗаполнитьИменаРеквизитовПоХозяйственнойОперации(ХозяйственнаяОперация, МассивВсехРеквизитов, МассивРеквизитовОперации) Экспорт
	...
	//++ НЕ УТКА
	ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.СписаниеТоваровДавальцаНаРасходы Тогда
		МассивРеквизитовОперации = ОбщегоНазначения.СкопироватьРекурсивно(МассивВсехРеквизитов);
	//-- НЕ УТКА
	КонецЕсли;
...
Функция СформироватьГиперссылкуКОформлению(Параметры) Экспорт
	...
	//++ НЕ УТКА
	ТоварыДавальца =
		Не Параметры.ХозяйственныеОперацииИДокументы.НайтиСтроки(
			Новый Структура(
					"ПолноеИмяДокумента, ХозяйственнаяОперация",
					ПолноеИмяОбъекта(),
					Перечисления.ХозяйственныеОперации.СписаниеТоваровДавальцаЗаСчетДавальца)).Количество() = 0
		Или Не Параметры.ХозяйственныеОперацииИДокументы.НайтиСтроки(
				Новый Структура(
						"ПолноеИмяДокумента, ХозяйственнаяОперация",
						ПолноеИмяОбъекта(),
						Перечисления.ХозяйственныеОперации.СписаниеТоваровДавальцаНаРасходы)).Количество() = 0;
	
	Если ТоварыДавальца Тогда
		
		ТипыЗапасов.Добавить(Перечисления.ТипыЗапасов.МатериалДавальца);
		ТипыЗапасов.Добавить(Перечисления.ТипыЗапасов.ПолуфабрикатДавальца);
		ТипыЗапасов.Добавить(Перечисления.ТипыЗапасов.ПродукцияДавальца);
		
		ТекстГиперссылки = НСтр("ru = 'Списания';
								|en = 'Adjustments'");
...
// 
// Возвращаемое значение:
//  см. НастройкаСчетовУчетаСервер.ПараметрыНастройкиСчетовУчета
//
...
Функция ПараметрыВзаиморасчеты(ДанныеЗаполнения = Неопределено) Экспорт
	...
	НеПоказыватьРасчеты =
		...
		//++ НЕ УТКА
		Или ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.СписаниеТоваровДавальцаЗаСчетДавальца
		//-- НЕ УТКА
		Или Ложь;
...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Если Данные.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.СписаниеТоваровДавальцаЗаСчетДавальца
		Или Данные.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.СписаниеТоваровДавальцаНаРасходы Тогда
		СинонимДокумента = ДавальческаяСхемаКлиентСервер.СинонимДокументаОтчетОСписанииТоваровСХранения();
	Иначе
		СинонимДокумента = НСтр("ru = 'Отчет о списании товаров с хранения';
								|en = 'VMI adjustment report'");
	КонецЕсли;
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление                  = НСтр("ru = 'Акт о списании принятых на хранение товаров';
														|en = 'Retirement certificate of goods received for storage'");
	КомандаПечати.ПроверкаПроведенияПередПечатью = Истина;
	//++ НЕ УТКА
	СписокОпераций = Новый СписокЗначений;
	СписокОпераций.Добавить(Перечисления.ХозяйственныеОперации.СписаниеТоваровДавальцаЗаСчетДавальца);
	СписокОпераций.Добавить(Перечисления.ХозяйственныеОперации.СписаниеТоваровДавальцаНаРасходы);
	...
	КомандаПечати = КомандыПечати.Добавить();
	КомандаПечати.Идентификатор                  = "АктСписанияТоваровДавальца";
	КомандаПечати.Представление                  = НСтр("ru = 'Акт о списании товаров давальца';
														|en = 'Provider stock shortage recognition'");
	КомандаПечати.ПроверкаПроведенияПередПечатью = Истина;
	УправлениеПечатью.ДобавитьУсловиеВидимостиКоманды(КомандаПечати,
													  "ХозяйственнаяОперация",
													  СписокОпераций,
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	//++ НЕ УТКА
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "АктСписанияТоваровДавальца") Тогда
		
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			КоллекцияПечатныхФорм,
			"АктСписанияТоваровДавальца",
			НСтр("ru = 'Акт о списании товаров давальца';
				|en = 'Provider stock shortage recognition'"),
			СформироватьПечатнуюФормуАктСписанияПринятыхНаХранениеТоваров(МассивОбъектов, ОбъектыПечати));
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ОтчетОПродукцииИМатериалах") Тогда
		...
		ТабличныйДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_ОтчетОСписанииТоваровСХранения_ОтчетОПродукцииИМатериалах";
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			НСтр("ru = 'Отчет о продукции и материалах';
				|en = 'Report on manufactured products and materials'"),
			Документы.ОтчетДавальцу2_5.СформироватьПечатнуюФормуОтчетОПродукцииИМатериалах(
...
Функция СформироватьПечатнуюФормуАктСписанияПринятыхНаХранениеТоваров(МассивОбъектов, ОбъектыПечати)
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		//++ НЕ УТКА
		Если ДанныеПечати.ХозяйственнаяОперация <> Перечисления.ХозяйственныеОперации.СписаниеТоваровДавальцаЗаСчетДавальца
			И ДанныеПечати.ХозяйственнаяОперация <> Перечисления.ХозяйственныеОперации.СписаниеТоваровДавальцаНаРасходы Тогда
		//-- НЕ УТКА
			ПредставлениеЗаголовка =
				НСтр("ru = 'Акт о списании принятых на хранение товаров';
					|en = 'Retirement certificate of goods received for storage'", ОбщегоНазначения.КодОсновногоЯзыка());
		//++ НЕ УТКА
		Иначе
			ПредставлениеЗаголовка = НСтр("ru = 'Акт о списании товаров давальца';
											|en = 'Provider stock shortage recognition'", ОбщегоНазначения.КодОсновногоЯзыка());
		КонецЕсли;
		//-- НЕ УТКА
		...
		СписаниеЗаНашСчет =
			...
			//++ НЕ УТКА
			Или ДанныеПечати.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.СписаниеТоваровДавальцаНаРасходы
			//-- НЕ УТКА
			Или Ложь;
		...
		Если СписаниеЗаНашСчет Тогда
			...
			ИтоговаяСтрока = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
								НСтр("ru = 'Всего наименований: %1, на сумму %2';
									|en = 'Total items: %1, to the amount %2'", ОбщегоНазначения.КодОсновногоЯзыка()),
								НомерСтроки,
...
Функция ПолучитьДанныеДляПечати(МассивОбъектов, ПараметрыПечати) Экспорт
	...
	|	ВидыЗапасов.Ссылка.Организация.СтранаРегистрации                         КАК СтранаРегистрации,
	|	ВидыЗапасов.НомерСтроки                                                  КАК НомерСтроки,
	|	ВидыЗапасов.АналитикаУчетаНоменклатуры.Номенклатура                      КАК Номенклатура,
	|	ВидыЗапасов.АналитикаУчетаНоменклатуры.Номенклатура.НаименованиеПолное   КАК НоменклатураНаименованиеПолное,
	|	ВидыЗапасов.АналитикаУчетаНоменклатуры.Номенклатура.Код                  КАК Код,
	|	ВидыЗапасов.АналитикаУчетаНоменклатуры.Номенклатура.Артикул              КАК Артикул,
	|	ВидыЗапасов.АналитикаУчетаНоменклатуры.Характеристика                    КАК Характеристика,
	|	ВидыЗапасов.АналитикаУчетаНоменклатуры.Характеристика.НаименованиеПолное КАК ХарактеристикаНаименованиеПолное,
	|	ВидыЗапасов.КоличествоУпаковок                                           КАК Количество,
	|	ВЫБОР
	|		КОГДА ВидыЗапасов.Упаковка <> ЗНАЧЕНИЕ(Справочник.УпаковкиЕдиницыИзмерения.ПустаяСсылка)
	|			ТОГДА ВидыЗапасов.Упаковка.НаименованиеПолное
	|		ИНАЧЕ ВидыЗапасов.АналитикаУчетаНоменклатуры.Номенклатура.ЕдиницаИзмерения.НаименованиеПолное
	|	КОНЕЦ                                                                    КАК ЕдиницаИзмерения,
	|	0                                                                        КАК Цена,
	|	0                                                                        КАК Сумма,
	|	0                                                                        КАК СуммаНДС,
	...
	|	И ВидыЗапасов.ВидЗапасов.ТипЗапасов = ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.ПолуфабрикатДавальца)
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	СтранаРегистрации,
	|	Дата,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ВидыЗапасов.Дата              КАК Дата,
	|	ВидыЗапасов.СтранаРегистрации КАК СтранаРегистрации,
	|	ВидыЗапасов.Номенклатура      КАК Номенклатура
	|ПОМЕСТИТЬ СтавкиНДСНоменклатурыДанныеСвязи
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	СтавкиНДСНоменклатурыДанныеСвязи.Дата              КАК Дата,
	|	СтавкиНДСНоменклатурыДанныеСвязи.СтранаРегистрации КАК СтранаРегистрации,
	|	СтавкиНДСНоменклатурыДанныеСвязи.Номенклатура      КАК Номенклатура,
	|	МАКСИМУМ(СтавкиНДСНоменклатуры.Период)             КАК Период
	|ПОМЕСТИТЬ СтавкиНДСНоменклатурыПериод
	|ИЗ
	|	СтавкиНДСНоменклатурыДанныеСвязи КАК СтавкиНДСНоменклатурыДанныеСвязи
	|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.СтавкиНДСНоменклатуры КАК СтавкиНДСНоменклатуры
	|	ПО СтавкиНДСНоменклатурыДанныеСвязи.СтранаРегистрации = СтавкиНДСНоменклатуры.Страна
	|	 И СтавкиНДСНоменклатурыДанныеСвязи.Номенклатура      = СтавкиНДСНоменклатуры.Номенклатура
	|	 И СтавкиНДСНоменклатурыДанныеСвязи.Дата             >= СтавкиНДСНоменклатуры.Период
	|
	|СГРУППИРОВАТЬ ПО
	|	СтавкиНДСНоменклатурыДанныеСвязи.Дата,
	|	СтавкиНДСНоменклатурыДанныеСвязи.СтранаРегистрации,
	|	СтавкиНДСНоменклатурыДанныеСвязи.Номенклатура
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	СтранаРегистрации,
	|	Номенклатура,
	...
	|	ВидыЗапасов.Дата              КАК Дата,
	|	ВидыЗапасов.СтранаРегистрации КАК СтранаРегистрации
	|ПОМЕСТИТЬ ОсновныеСтавкиНДСДанныеСвязи
	|ИЗ
	|	ВидыЗапасов КАК ВидыЗапасов
	|	
	|ИНДЕКСИРОВАТЬ ПО
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ОсновныеСтавкиНДСДанныеСвязи.Дата              КАК Дата,
	|	ОсновныеСтавкиНДСДанныеСвязи.СтранаРегистрации КАК СтранаРегистрации,
	|	МАКСИМУМ(ОсновныеСтавкиНДС.Период)             КАК Период
	|ПОМЕСТИТЬ ОсновныеСтавкиНДСПериод
	|ИЗ
	|	ОсновныеСтавкиНДСДанныеСвязи КАК ОсновныеСтавкиНДСДанныеСвязи
	|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ОсновныеСтавкиНДС КАК ОсновныеСтавкиНДС
	|	ПО ОсновныеСтавкиНДСДанныеСвязи.СтранаРегистрации = ОсновныеСтавкиНДС.Страна
	|	 И ОсновныеСтавкиНДСДанныеСвязи.Дата             >= ОсновныеСтавкиНДС.Период
	|
	|СГРУППИРОВАТЬ ПО
	|	ОсновныеСтавкиНДСДанныеСвязи.Дата,
	|	ОсновныеСтавкиНДСДанныеСвязи.СтранаРегистрации
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	СтранаРегистрации,
	|	Дата,
	...
	|	ВидыЗапасов.НомерСтроки                                         КАК НомерСтроки,
	|	ВидыЗапасов.Номенклатура                                        КАК Номенклатура,
	|	ВидыЗапасов.НоменклатураНаименованиеПолное                      КАК НоменклатураНаименованиеПолное,
	|	ВидыЗапасов.Код                                                 КАК Код,
	|	ВидыЗапасов.Артикул                                             КАК Артикул,
	|	ВидыЗапасов.Характеристика                                      КАК Характеристика,
	|	ВидыЗапасов.ХарактеристикаНаименованиеПолное                    КАК ХарактеристикаНаименованиеПолное,
	|	ВидыЗапасов.Количество                                          КАК Количество,
	...
	|	ЕСТЬNULL(СтавкиНДСНоменклатуры.СтавкаНДС,
	|	         ЕСТЬNULL(ОсновныеСтавкиНДС.СтавкаНДС,
	|	                  ЗНАЧЕНИЕ(Справочник.СтавкиНДС.ПустаяСсылка))) КАК СтавкаНДС
	|ИЗ
	|	ВидыЗапасов КАК ВидыЗапасов
	|		
	|		ЛЕВОЕ СОЕДИНЕНИЕ СтавкиНДСНоменклатурыПериод КАК СтавкиНДСНоменклатурыПериод
	|		ПО ВидыЗапасов.СтранаРегистрации = СтавкиНДСНоменклатурыПериод.СтранаРегистрации
	|		 И ВидыЗапасов.Номенклатура      = СтавкиНДСНоменклатурыПериод.Номенклатура
	|		 И ВидыЗапасов.Дата              = СтавкиНДСНоменклатурыПериод.Дата
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.СтавкиНДСНоменклатуры КАК СтавкиНДСНоменклатуры
	|		ПО СтавкиНДСНоменклатурыПериод.СтранаРегистрации = СтавкиНДСНоменклатуры.Страна
	|		 И СтавкиНДСНоменклатурыПериод.Номенклатура      = СтавкиНДСНоменклатуры.Номенклатура
	|		 И СтавкиНДСНоменклатурыПериод.Период            = СтавкиНДСНоменклатуры.Период
	|		
	|		ЛЕВОЕ СОЕДИНЕНИЕ ОсновныеСтавкиНДСПериод КАК ОсновныеСтавкиНДСПериод
	|		ПО ВидыЗапасов.СтранаРегистрации = ОсновныеСтавкиНДСПериод.СтранаРегистрации
	|		 И ВидыЗапасов.Дата              = ОсновныеСтавкиНДСПериод.Дата
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ОсновныеСтавкиНДС КАК ОсновныеСтавкиНДС
	|		ПО ОсновныеСтавкиНДСПериод.СтранаРегистрации = ОсновныеСтавкиНДС.Страна
	|		 И ОсновныеСтавкиНДСПериод.Период            = ОсновныеСтавкиНДС.Период
	|
	|УПОРЯДОЧИТЬ ПО
	|	ВидыЗапасов.Ссылка,
	...
	|	&УслугаПоПереработке                          КАК УслугаПоПереработке
	|ИЗ
	|	Документ.ОтчетОСписанииТоваровСХранения КАК ДанныеДокумента
	|ГДЕ
	...
	Запрос.УстановитьПараметр("УслугаПоПереработке", НСтр("ru = 'Переработка давальческих материалов';
															|en = 'Sales orders — Subcontracting'"));
	...
	СтруктураДанныхДляПечати.Вставить("РезультатПоШапке",          МассивРезультатов[ВГраница]);
	СтруктураДанныхДляПечати.Вставить("РезультатПоТабличнойЧасти", МассивРезультатов[ВГраница - 1]);
