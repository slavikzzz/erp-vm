...
//   * НовыйСтатус - ПеречислениеСсылка.СтатусыОбработкиОтчетаЕГАИС - Новый статус.
...
//  ДокументСсылка - ДокументСсылка.ОтчетЕГАИС - Ссылка на документ
//  Операция - ПеречислениеСсылка.ВидыДокументовЕГАИС - Операция ЕГАИС
//  ДополнительныеПараметры - Неопределено, Структура - Дополнительные параметры для обновления статуса
// 
// Возвращаемое значение:
//  ПеречислениеСсылка.СтатусыОбработкиОтчетаЕГАИС - Новый статус.
//
...
//
// Параметры:
//  ДокументСсылка - ДокументСсылка.ОтчетЕГАИС - Документ ЕГАИС.
...
Функция ПоследовательностьОпераций(ДокументСсылка) Экспорт
	...
	Если Операция = Перечисления.ВидыДокументовЕГАИС.ЗапросОтчетаОстаткиВРегистре2 Тогда
		...
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Исходящий, Операция, ДокументСсылка, Ложь, Ложь);
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Входящий,  Перечисления.ВидыДокументовЕГАИС.ОтветНаЗапросОтчетаОстаткиВРегистре2);
		
	ИначеЕсли Операция = Перечисления.ВидыДокументовЕГАИС.ЗапросОтчетаОстаткиВРегистре1 Тогда
		
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Исходящий, Операция, ДокументСсылка, Ложь, Ложь);
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Входящий,  Перечисления.ВидыДокументовЕГАИС.ОтветНаЗапросОтчетаОстаткиВРегистре1);
		
	ИначеЕсли Операция = Перечисления.ВидыДокументовЕГАИС.ЗапросОтчетаОбработанныеЧеки Тогда
		
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Исходящий, Операция, ДокументСсылка, Ложь, Ложь);
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Входящий,  Перечисления.ВидыДокументовЕГАИС.ОтветНаЗапросОтчетаОбработанныеЧеки);
		
	ИначеЕсли Операция = Перечисления.ВидыДокументовЕГАИС.ЗапросОтчетаНеобработанныеТТН Тогда
		
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Исходящий, Операция, ДокументСсылка, Ложь, Ложь);
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Входящий,  Перечисления.ВидыДокументовЕГАИС.ОтветНаЗапросОтчетаНеобработанныеТТН);
		
	ИначеЕсли Операция = Перечисления.ВидыДокументовЕГАИС.ЗапросОтчетаИнформацияОбОрганизации Тогда
		
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Исходящий, Операция, ДокументСсылка, Ложь, Ложь);
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Входящий,  Перечисления.ВидыДокументовЕГАИС.ОтветНаЗапросОтчетаИнформацияОбОрганизации);
		
	ИначеЕсли Операция = Перечисления.ВидыДокументовЕГАИС.ЗапросОтчетаДвиженияПоСправке2 Тогда
		
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Исходящий, Операция, ДокументСсылка, Ложь, Ложь);
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Входящий,  Перечисления.ВидыДокументовЕГАИС.ОтветНаЗапросОтчетаДвиженияПоСправке2);
		
	ИначеЕсли Операция = Перечисления.ВидыДокументовЕГАИС.ЗапросОтчетаДвиженияМеждуРегистрами Тогда
		
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Исходящий, Операция, ДокументСсылка, Ложь, Ложь);
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Входящий,  Перечисления.ВидыДокументовЕГАИС.ОтветНаЗапросОтчетаДвиженияМеждуРегистрами);
		
	ИначеЕсли Операция = Перечисления.ВидыДокументовЕГАИС.ЗапросОтчетаОстаткиВРегистре3 Тогда
		
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Исходящий, Операция, ДокументСсылка, Ложь, Ложь);
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Входящий,  Перечисления.ВидыДокументовЕГАИС.ОтветНаЗапросОтчетаОстаткиВРегистре3);
		
	ИначеЕсли Операция = Перечисления.ВидыДокументовЕГАИС.ЗапросОтчетаИсторияСправок2 Тогда
		
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Исходящий, Операция, ДокументСсылка, Ложь, Ложь);
		ОбменДаннымиЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Входящий,  Перечисления.ВидыДокументовЕГАИС.ОтветНаЗапросОтчетаИсторияСправок2);
...
//
// Параметры:
//  ДокументСсылка - ДокументСсылка.ОтчетЕГАИС - Документ.
...
// 
// Возвращаемое значение:
//  ПеречислениеСсылка.СтатусыОбработкиОтчетаЕГАИС - Статус по-умолчанию.
//
...
// 
// Параметры:
//  ВидДокумента   - ПеречислениеСсылка.ВидыДокументовЕГАИС - вид отчета ЕГАИС
//  ДокументСсылка - ДокументСсылка.ОтчетЕГАИС - ссылка на документ
// Возвращаемое значение:
//  Булево - есть арсхождения
//
Функция ЕстьРасхожденияВПолученныхДанных(ВидДокумента, ДокументСсылка) Экспорт
	...
	Иначе
		...
		ВызватьИсключение ОбщегоНазначенияИС.ТекстИсключенияОбработкиСтатуса(ДокументСсылка, ВидДокумента);
...
Функция ОтработатьРасхожденияЗапросОтчетаОстаткиВРегистре3(ДокументСсылка, ОбработатьРасхождения = Неопределено, ПринятьЕГАИС = Истина) Экспорт
	...
	Если МассивНезаписанныхАкцизныхМарок.Количество() Тогда
		...
		Если Не Выборка.Следующий() Тогда
			...
			|en = 'Нет сопоставления номенклатуры и алкогольной продукции. 
			|Автоматическое добавление марок невозможно.'")
		КонецЕсли;
		
		Для Каждого НоваяМарка Из МассивНезаписанныхАкцизныхМарок Цикл
			НоваяМаркаСсылка = ШтрихкодированиеЕГАИС.ПолучитьСгенерироватьАкцизнуюМарку(НоваяМарка, Выборка.Номенклатура, Выборка.Характеристика, Выборка.Серия);
...
Функция ЗапросОтчетЕГАИСXML(ДокументСсылка)
	...
	РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Name",  "АЛККОД",                      СообщениеXML);
	РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Value", Шапка.КодАлкогольнойПродукции, СообщениеXML);
	Parameters.Parameter.Добавить(Parameter);
	
	Parameter  = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Parameters, "Parameter");
	РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Name",  "МЕСЯЦ",                       СообщениеXML);
	РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Value", Формат(Шапка.Период, "ДФ=MM"), СообщениеXML);
	Parameters.Parameter.Добавить(Parameter);
	
	Parameter  = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Parameters, "Parameter");
	РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Name",  "ГОД",                           СообщениеXML);
	РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Value", Формат(Шапка.Период, "ДФ=гггг"), СообщениеXML);
	Parameters.Parameter.Добавить(Parameter);
	...
	Parameter  = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Parameters, "Parameter");
	РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Name",  "RFB",               СообщениеXML);
	РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Value", Шапка.НомерСправки2, СообщениеXML);
	Parameters.Parameter.Добавить(Parameter);
	...
	РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Value", Шапка.КодФСРАР, СообщениеXML);
	Parameters.Parameter.Добавить(Parameter);
	
	Parameter  = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Parameters, "Parameter");
	РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Name",  "ДАТА",       СообщениеXML);
	РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Value", Шапка.Период, СообщениеXML);
	Parameters.Parameter.Добавить(Parameter);
	...
	Parameter  = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Parameters, "Parameter");
	РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Name",  "КОД",                    СообщениеXML);
	РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Value", Шапка.ИдентификаторФСРАР, СообщениеXML);
	Parameters.Parameter.Добавить(Parameter);
	...
	Если ЗначениеЗаполнено(Шапка.НомерСправки2) Тогда
		Parameter  = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Parameters, "Parameter");
		РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Name",  "ФОРМА2",            СообщениеXML);
		РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Value", Шапка.НомерСправки2, СообщениеXML);
		Parameters.Parameter.Добавить(Parameter);
	Иначе
		Parameter  = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Parameters, "Parameter");
	...
	Parameter  = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Parameters, "Parameter");
	РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Name",  "PF2",               СообщениеXML);
	РаботаСXMLЕГАИС.ЗаполнитьСвойствоXDTO(Parameter, "Value", Шапка.НомерСправки2, СообщениеXML);
	Parameters.Parameter.Добавить(Parameter);
