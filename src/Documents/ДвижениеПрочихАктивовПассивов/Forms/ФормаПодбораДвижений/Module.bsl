...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если НЕ ЗавершениеРаботы
		...
		ОбщегоНазначенияКлиент.ПоказатьПодтверждениеЗакрытияФормы(Оповещение, Отказ, ЗавершениеРаботы, НСтр("ru = 'Некоторые строки были выбраны. Добавить их в документ?';
																											|en = 'You have selected several lines. Add them to the document?'"));
	КонецЕсли;
...
Процедура УстановитьВидимостьЭлементов()
	...
	Заголовок = ?(Актив, НСтр("ru = 'активов';
								|en = 'assets'"), ?(Пассив, НСтр("ru = 'пассивов';
																|en = 'liabilities'"), ?(Доход, НСтр("ru = 'доходов';
																									|en = 'income'"), НСтр("ru = 'расходов';
																															|en = 'expenses'"))));
