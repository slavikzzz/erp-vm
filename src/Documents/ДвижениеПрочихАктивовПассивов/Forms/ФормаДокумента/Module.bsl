...
Функция ДанныеСтороныТипаДвижений(ТипСтатьи, Постфикс = "")
	...
	ИначеЕсли ТипСтатьи = Перечисления.ТипыСтатейАктивовПассивов.СтатьяРасходов Тогда
		...
		Данные.Имя = НСтр("ru = 'расходов';
							|en = 'expenses'") + Постфикс;
	...
	ИначеЕсли ТипСтатьи = Перечисления.ТипыСтатейАктивовПассивов.СтатьяПассивов Тогда
		...
		Данные.Имя = НСтр("ru = 'пассивов';
							|en = 'liabilities'") + Постфикс;
...
Процедура УправлениеЭлементамиФормы()
	...
	Если Объект.Источник = Объект.Получатель Тогда
		ПостфиксИсточника  = " " + ?(Объект.Увеличение, НСтр("ru = '(Расход)';
															|en = '(Outflow)'"), НСтр("ru = '(Приход)';
																						|en = '(Inflow)'"));
		ПостфиксПолучателя = " " + ?(Объект.Увеличение, НСтр("ru = '(Приход)';
															|en = '(Inflow)'"), НСтр("ru = '(Расход)';
																						|en = '(Outflow)'"));
	КонецЕсли;
	...
	// Получатель
	Элементы.ДанныеОтраженияПодборОстатковПолучателя.Заголовок	= НСтр("ru = 'Подбор';
																		|en = 'Pick'") + " " + ДанныеПолучателя.Имя;
	Элементы.ДанныеОтраженияПодборОстатковПолучателя.Видимость	= Не Объект.Увеличение;
	Элементы.ДанныеОтраженияСтатьяПолучатель.Заголовок			= НСтр("ru = 'Статья';
																		|en = 'Item'") +" " +  ДанныеПолучателя.Имя;
	Элементы.ДанныеОтраженияЗаполнитьСтатьюПолучатель.Заголовок	= НСтр("ru = 'Статью';
																			|en = 'Item'") + " " + ДанныеПолучателя.Имя;
	Элементы.ДанныеОтраженияПодразделениеПолучатель.Заголовок	= НСтр("ru = 'Подразделение';
																		|en = 'Business unit'") + " " + ДанныеПолучателя.Имя;
	Элементы.ДанныеОтраженияНаправлениеПолучатель.Заголовок	= НСтр("ru = 'Направление деятельности';
																		|en = 'Line of business'") + " " + ДанныеПолучателя.Имя;
	...
	// Источник
	Элементы.ДанныеОтраженияПодборОстатковИсточника.Заголовок	= НСтр("ru = 'Подбор';
																		|en = 'Pick'") + " " + ДанныеИсточника.Имя;
	Элементы.ДанныеОтраженияПодборОстатковИсточника.Видимость	= Объект.Увеличение;
	Элементы.ДанныеОтраженияСтатьяИсточник.Заголовок			= НСтр("ru = 'Статья';
																		|en = 'Item'") + " " + ДанныеИсточника.Имя;
	Элементы.ДанныеОтраженияЗаполнитьСтатьюИсточник.Заголовок	= НСтр("ru = 'Статью';
																		|en = 'Item'") + " " + ДанныеИсточника.Имя;
	Элементы.ДанныеОтраженияПодразделениеИсточник.Заголовок		= НСтр("ru = 'Подразделение';
																			|en = 'Business unit'") + " " + ДанныеИсточника.Имя;
	Элементы.ДанныеОтраженияНаправлениеИсточник.Заголовок	= НСтр("ru = 'Направление деятельности';
																	|en = 'Line of business'") + " " + ДанныеИсточника.Имя;
