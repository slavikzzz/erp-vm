...
Процедура ДополнительныеПараметрыДляРасчетаПоФормуле(Параметры, ДопПараметры) Экспорт
	...
	ЭтоПланыРасхода = ЭтоПланПродаж
		...
		//++ НЕ УТ
		Или (ЭтоПланПроизводства И Параметры.ТипПроизводственногоПроцесса = Перечисления.ТипыПроизводственныхПроцессов.Разборка)
		//-- НЕ УТ
...
#Область НакопленныйПланируемыйКонечныйДефицит
	...
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru = 'Накопленный планируемый конечный дефицит';
														|en = 'Accumulated planned closing shortage'"));
	ДопПараметр.Вставить("СоздаватьРеквизит", 	ИспользоватьПланыОстатков);
	ДопПараметр.Вставить("УдалятьРеквизитыТаблицы", Истина);
...
Функция ДоступныеТипыАналитикБюджетирования(ДокументСсылка, ИмяТаблицы = "") Экспорт
	...
	|ИЗ
	|	Документ.ПланОстатков.ДополнительныеРеквизиты КАК ДополнительныеРеквизиты
	|ГДЕ
...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	|	ДанныеДокумента.СценарийБюджетирования.Валюта КАК Валюта,
...
Функция ТекстЗапросаТаблицаОборотыБюджетов(Запрос, ТекстыЗапроса, Регистры)
	...
	|ИЗ
	|	Документ.ПланОстатков.Товары КАК Товары
	|ГДЕ
