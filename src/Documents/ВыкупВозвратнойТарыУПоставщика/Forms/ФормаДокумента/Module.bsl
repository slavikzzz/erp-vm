...
Процедура ЗаполнитьЦеныПоСоглашению(Команда)
	...
	Если ЦеныПартнеровЗаполнениеКлиент.НеобходимоЗаполнениеЦенПоСоглашению(Объект, "Товары", НСтр("ru = 'Многооборотная тара';
																									|en = 'Reusable packaging'")) Тогда
...
Процедура ЗаполнитьЦеныВыделенныхСтрокПоВидуЦенПоставщика(Команда)
	...
	Если ЦеныПартнеровЗаполнениеКлиент.НеобходимоЗаполнениеЦенПоВидуЦенПоставщика(Объект, "Товары", НСтр("ru = 'Многооборотная тара';
																										|en = 'Reusable packaging'")) Тогда
