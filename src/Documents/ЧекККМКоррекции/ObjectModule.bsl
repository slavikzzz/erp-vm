	...
	Иначе
		...
		Если Не ЗначениеЗаполнено(ЧекККМ) Тогда
			ВызватьИсключение НСтр("ru = 'Чек ККМ коррекции необходимо вводить на основании чека ККМ';
									|en = 'Cash register adjustment voucher must be entered on the basis of CR receipt'");
		КонецЕсли;
...
Процедура ЗаполнитьДокументПоЧекуККМ(ДокументОснование)
	...
	Если Документы.ЧекККМВозврат.ЕстьВозвратПоЧекуККМ(ДокументОснование) Тогда
		ВызватьИсключение НСтр("ru = 'По Чеку ККМ введен Чек ККМ на возврат. Ввод Чека ККМ коррекции запрещен!';
								|en = 'Return receipt is entered on this receipt. Entering an adjustment receipt is not allowed!'");
	КонецЕсли;
	...
	Если Документы.ЧекККМКоррекции.ЕстьКоррекцияПоЧекуККМ(ДокументОснование) Тогда
		ВызватьИсключение НСтр("ru = 'По Чеку ККМ введен Чек ККМ коррекции. Ввод нового Чека ККМ коррекции запрещен!';
								|en = 'Cash register adjustment voucher is entered on this receipt. Entering a new cash register adjustment voucher is not allowed!'");
	КонецЕсли;
	...
	Если Документы.ВозвратТоваровОтКлиента.ЕстьВозвратТоваровОтКлиентаПоЧекуККМ(ДокументОснование) Тогда
		ВызватьИсключение НСтр("ru = 'По Чеку ККМ введен Возврат товаров от клиента. Ввод нового Чека ККМ коррекции запрещен!';
								|en = 'Goods return from customer is entered for the Cash register adjustment voucher. You cannot enter new Cash register adjustment voucher.'");
	КонецЕсли;
