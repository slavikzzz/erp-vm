...
Процедура Архивировать(Команда)
	...
	ИнтеграцияИСКлиент.АрхивироватьРаспоряжения(ЭтотОбъект, Элементы.СписокКОформлению, ИнтеграцияИСМПКлиент,
		ПредопределенноеЗначение("Документ.РазрешениеНаОтгрузкуИСМП.ПустаяСсылка"));
...
Процедура УстановитьУсловноеОформление()
	...
	СписокСтатусов.ЗагрузитьЗначения(Документы.РазрешениеНаОтгрузкуИСМП.СтатусыОшибок());
	...
	СписокДействий.ЗагрузитьЗначения(Документы.РазрешениеНаОтгрузкуИСМП.ВсеТребующиеОжидания()); 
...
Функция ВсеТребующиеДействия()
	...
	Возврат Документы.РазрешениеНаОтгрузкуИСМП.ВсеТребующиеДействия();
...
Функция ВсеТребующиеОжидания()
	...
	Возврат Документы.РазрешениеНаОтгрузкуИСМП.ВсеТребующиеОжидания();
...
Процедура НастроитьВидимостьДоступностьЭлементовСервер()
	...
	Если НЕ ПравоДоступа("Добавление", Метаданные.Документы.РазрешениеНаОтгрузкуИСМП) Тогда
