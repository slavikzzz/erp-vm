...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	Возврат КорректировкаЗадолженностиЛокализация.ТекстОтраженияВРеглУчете();
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	Возврат КорректировкаЗадолженностиЛокализация.ТекстЗапросаВТОтраженияВРеглУчете();
...
Функция ПараметрыНастройкиСчетовУчета(ХозяйственнаяОперация) Экспорт
	...
	ПараметрыНастройки.ПутьКДанным = "Объект.ДоходыРасходыАктивыПассивы";
	...
	ПараметрыНастройки.ЭлементыФормы.Добавить("РасходыАктивыПассивыПредставлениеОтраженияВРеглУчете");
	ПараметрыНастройки.ЭлементыФормы.Добавить("ПредставлениеОтраженияДоходовВРеглУчете");
	ПараметрыНастройки.ЭлементыФормы.Добавить("ДоходыАктивыПассивыПредставлениеОтраженияВРеглУчете");
...
Функция ИнициализироватьХозяйственныеОперацииИДокументы(ХозяйственныеОперацииИДокументы) Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("ФормироватьРезервыПоСомнительнымДолгам") Тогда
		Строка = ХозяйственныеОперацииИДокументы.Добавить();
...
Функция ТекстЗапросаТаблицаДвиженияПоПрочимАктивамПассивам(Запрос, ТекстыЗапроса, Регистры)
	...
	//++ НЕ УТ
	|	Задолженность.НастройкаСчетовУчета     КАК НастройкаСчетовУчета,
	//-- НЕ УТ
	...
	Если Не ТаблицаОстаткиРезервов.Количество() = 0 Тогда
		...
		Для Каждого СтрокаРасчетныеДокументы Из ТаблицаРасчетныеДокументы Цикл
			...
			Для Каждого СтрокаОстаткиРезервов Из НайденныеСтроки Цикл
				...
				СуммаНУ = СтрокаОстаткиРезервов.СуммаРегл - СтрокаОстаткиРезервов.ВременнаяРазница - СтрокаОстаткиРезервов.ПостояннаяРазница;
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет реквизит ""Старый вариант формирования проводок"".';
									|en = 'Fills the ""Previous entry generation option"" attribute.'");
