...
Процедура РаспределенныеМатериалыНоменклатураПриИзменении(Элемент)
	...
	СтруктураДействий.Вставить("НоменклатураПриИзмененииПереопределяемый", Новый Структура("ИмяФормы, ИмяТабличнойЧасти",
		ИмяФормы, "РаспределенныеМатериалы"));
...
Процедура УстановитьУсловноеОформление()
	...
	НоменклатураСервер.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(
		ЭтаФорма, "РаспределенныеМатериалыХарактеристика", "РаспределенныеМатериалы.ХарактеристикиИспользуются");
...
Процедура ЗаполнитьТаблицыДанных()
	...
	Документы.ЗаказДавальца2_5.МатериалыПоСпецификациям(ПараметрыСпецификаций, МатериалыПоСпецификации);
	...
	|		ПОЛНОЕ СОЕДИНЕНИЕ ВтСпецификации КАК МатериалыСпец
	|		ПО МатериалыДок.Спецификация   = МатериалыСпец.Спецификация
	|		 И МатериалыДок.Номенклатура   = МатериалыСпец.Номенклатура
	|		 И МатериалыДок.Характеристика = МатериалыСпец.Характеристика
	|ГДЕ
	|	МатериалыСпец.ТипНоменклатуры = ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Товар)
	|";

	ТаблицаМатериалов = ПолучитьИзВременногоХранилища(Параметры.АдресВоВременномХранилище.Материалы);
	ТаблицаМатериалов.Свернуть(
		"Номенклатура, Характеристика, Упаковка, ТипНоменклатуры, Спецификация", 
		"КоличествоУпаковок, Количество");
		
	НайденныеСтроки = ТаблицаМатериалов.НайтиСтроки(
							Новый Структура("Спецификация", Справочники.РесурсныеСпецификации.ПустаяСсылка()));
