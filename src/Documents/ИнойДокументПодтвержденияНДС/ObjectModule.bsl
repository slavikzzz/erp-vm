	...
	Если РежимЗаписи = РежимЗаписиДокумента.Проведение Тогда
		...
		Если РучнаяКорректировкаЖурналаСФ И Не Отказ Тогда
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Движения документа %1 по журналу СФ отредактированы вручную и не могут быть автоматически актуализированы';
					|en = 'The %1 document records in tax invoice register have been edited manually and cannot be updated automatically'"), Ссылка);
