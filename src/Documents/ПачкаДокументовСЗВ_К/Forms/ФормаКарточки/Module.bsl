...
&НаКлиенте
Процедура ФактПроживанияДНРЛНРПриИзменении(Элемент)
...
&НаКлиенте
Процедура ФактПроживанияЗОХОПриИзменении(Элемент)
...
&НаКлиенте
Процедура ФактПроживанияДНРЛНРЗОХОПриИзменении(Элемент)
...
Процедура УстановитьЗаголовокФормы()
	Если ТипЗнч(РедактируемыйДокументСсылка) = Тип("ДокументСсылка.ПачкаДокументовСЗВ_6_1") Тогда
		Заголовок = НСтр("ru = 'Сведения о страховых взносах и стаже ЗЛ (СВЗ-6-1)';
						|en = 'Information about insurance contributions and IP length of service (SVZ-6-1) '");
	ИначеЕсли ТипЗнч(РедактируемыйДокументСсылка) = Тип("ДокументСсылка.РеестрСЗВ_6_2") Тогда
		Заголовок = НСтр("ru = 'Сведения о страховых взносах и стаже ЗЛ (СВЗ-6-2)';
						|en = 'Information about insurance contributions and IP length of service (SVZ-6-2) '");
	ИначеЕсли ТипЗнч(РедактируемыйДокументСсылка) = Тип("ДокументСсылка.ПачкаДокументовСЗВ_6_3") Тогда
		Заголовок = НСтр("ru = 'Сведения о сумме выплат и вознаграждений (СВЗ-6-3)';
						|en = 'Information about amount of payments and other remunerations (SVZ-6-3) '");	
	ИначеЕсли ТипЗнч(РедактируемыйДокументСсылка) = Тип("ДокументСсылка.ПачкаДокументовСЗВ_6_4") Тогда
		Заголовок = НСтр("ru = 'Сведения о сумме выплат, страховых взносах и стаже ЗЛ (СЗВ-6-4)';
						|en = 'Information about amount of payments, insurance contributions and IP length of service (SZV-6-4)'");	
	КонецЕсли;	
...
Процедура УстановитьСвойстваЭлементовФормы()
	...
	ИспользоватьФорму2023 = ДатаПостановленияАДВ2023 <= ДатаДокумента;
	
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФактПроживанияДНРЛНРЗОХО", "Видимость", ИспользоватьФорму2023);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФактПроживанияДНРЛНР", "Видимость", ИспользоватьФорму2023);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФактПроживанияЗОХО", "Видимость", ИспользоватьФорму2023);
...
Процедура УстановитьПараметрыВыбораВидаДеятельности()
	...
	Если Не ФактПроживанияВКрыму Тогда 
		ИсключаемыеВидыДеятельности.Добавить(ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ВидыОбщественноПолезнойДеятельностиСЗВК.ДОГКРЫМ"));
		ИсключаемыеВидыДеятельности.Добавить(ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ВидыОбщественноПолезнойДеятельностиСЗВК.ИПКРЫМ"));
		ИсключаемыеВидыДеятельности.Добавить(ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ВидыОбщественноПолезнойДеятельностиСЗВК.ТДКРЫМ"));
	КонецЕсли;
	
	Если Не ФактПроживанияДНРЛНР И Не ФактПроживанияДНРЛНРЗОХО И Не ФактПроживанияЗОХО Тогда 
		ИсключаемыеВидыДеятельности.Добавить(ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ВидыОбщественноПолезнойДеятельностиСЗВК.ДОГИП"));
		ИсключаемыеВидыДеятельности.Добавить(ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ВидыОбщественноПолезнойДеятельностиСЗВК.РАБОТАКОМИС"));
		ИсключаемыеВидыДеятельности.Добавить(ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ВидыОбщественноПолезнойДеятельностиСЗВК.ТДДЛ"));
		ИсключаемыеВидыДеятельности.Добавить(ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ВидыОбщественноПолезнойДеятельностиСЗВК.ТДДЛКОМИС"));
		ИсключаемыеВидыДеятельности.Добавить(ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ВидыОбщественноПолезнойДеятельностиСЗВК.ТДУЗХ"));
		ИсключаемыеВидыДеятельности.Добавить(ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ВидыОбщественноПолезнойДеятельностиСЗВК.ТДУЗХКОМИС"));
	КонецЕсли;
	
	Запрос = Новый Запрос;
	
	Запрос.УстановитьПараметр("ИсключаемыеВидыДеятельности", ИсключаемыеВидыДеятельности);
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |ГДЕ
	               |	НЕ ВидыОбщественноПолезнойДеятельностиСЗВК.Ссылка В (&ИсключаемыеВидыДеятельности)";
...
Процедура ДанныеИзВременногоХранилищаВДанныеФормы(АдресВоВременномХранилище)
	...
	ФактПроживанияДНРЛНРЗОХО = ДанныеДокументаПоСотруднику.ФактПроживанияДНРЛНРЗОХО;
	ФактПроживанияДНРЛНР = ДанныеДокументаПоСотруднику.ФактПроживанияДНРЛНР;
	ФактПроживанияЗОХО = ДанныеДокументаПоСотруднику.ФактПроживанияЗОХО;
	ДатаДокумента = ДанныеДокументаПоСотруднику.ДатаДокумента;
...
Функция ДанныеСотрудникаВоВременноеХранилище()		
	...
	ДанныеСотрудника.Вставить("ФактПроживанияДНРЛНРЗОХО", ФактПроживанияДНРЛНРЗОХО);
	ДанныеСотрудника.Вставить("ФактПроживанияДНРЛНР", ФактПроживанияДНРЛНР);
	ДанныеСотрудника.Вставить("ФактПроживанияЗОХО", ФактПроживанияЗОХО);
