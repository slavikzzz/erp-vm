		...
		Пока Выборка.Следующий() Цикл
			...
			Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Для периода %1 по документу %2 уже введена сводная справка %3';
					|en = 'The consolidated certificate %3 by the document %2 is already entered for the period %1'"),
				ПредставлениеПериода,
				ПервичныйДокумент,
				Выборка.Ссылка);
		...
		Пока Выборка.Следующий() Цикл
			...
			Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Для периода %1 по организации %2 уже введена сводная справка %3';
					|en = 'The consolidated certificate %3 by the company %2 is already entered for the period %1'"),
				ПредставлениеПериода,
				Организация,
				Выборка.Ссылка);
			ОбщегоНазначения.СообщитьПользователю(
