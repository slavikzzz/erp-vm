...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("КассоваяСмена") Тогда
		...
		ФДОЗакрытииСмены = Результат.ФДОЗакрытииСмены; // ХранилищеЗначения
		XMLСтрока = ФДОЗакрытииСмены.Получить(); 
	...
	Иначе
		ТекстПредупреждения = НСтр("ru = 'Форма фискальных данных предназначена для открытия из элемента Кассовой смены';
									|en = 'Fiscal data form is opened from the POS shift item'");
