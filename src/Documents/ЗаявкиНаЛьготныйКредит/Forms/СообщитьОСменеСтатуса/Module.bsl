...
Процедура ИзменитьОформлениеФормы(Заявки)
	...
	Если Количество = 1 Тогда
		Подстрока2 = Новый ФорматированнаяСтрока(НСтр("ru = 'заявку';
														|en = 'заявку'"),,,,"e1cib/command/ОбщаяКоманда.ЛьготныеКредиты");
	Иначе
	...
	Подстрока1 = НСтр("ru = 'Обратите внимание, в заявке был ошибочно указан статус рассмотрения.';
						|en = 'Обратите внимание, в заявке был ошибочно указан статус рассмотрения.'");
	Подстрока2 = НСтр("ru = 'Правильный статус - ';
						|en = 'Правильный статус - '");
	
	Если ЭтоСменаОдобренныхНаОтклоненные Тогда
		Подстрока3 = Новый ФорматированнаяСтрока(НСтр("ru = 'Отклонено банком';
														|en = 'Отклонено банком'"), Новый Шрифт(,,Истина));
	Иначе
		Подстрока3 = Новый ФорматированнаяСтрока(НСтр("ru = 'Отправлено в ФНС';
														|en = 'Отправлено в ФНС'"), Новый Шрифт(,,Истина));
	КонецЕсли;
