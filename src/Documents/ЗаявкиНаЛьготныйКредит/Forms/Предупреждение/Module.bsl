...
Процедура ОбработатьЗаявки(Заявки)
	...
	Для каждого Заявка Из Заявки Цикл
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(НСтр("ru = 'Заявки на льготный кредит';
											|en = 'Заявки на льготный кредит'", КодОсновногоЯзыка),УровеньЖурналаРегистрации.Ошибка,,,ИнформацияОбОшибке);
...
Процедура ИзменитьОформлениеФормы(Заявки)
	...
	Подстрока1 = НСтр("ru = 'Ранее вы отправили ';
						|en = 'Ранее вы отправили '");
	Если Количество = 1 Тогда
		Ссылка = ПолучитьНавигационнуюСсылку(Заявки[0]);
		Подстрока2 = Новый ФорматированнаяСтрока(НСтр("ru = 'заявку';
														|en = 'заявку'"),,,,Ссылка);
	Иначе
		Подстрока2 = Новый ФорматированнаяСтрока(НСтр("ru = 'заявки';
														|en = 'заявки'"),,,,"e1cib/command/ОбщаяКоманда.ЛьготныеКредиты");
	КонецЕсли;
	
	Подстрока3 = НСтр("ru = ' на льготный кредит.';
						|en = ' на льготный кредит.'");
	Подстрока4 = НСтр("ru = 'Обратите внимание, в ответе был указан некорректный телефон банка.';
						|en = 'Обратите внимание, в ответе был указан некорректный телефон банка.'");
	Подстрока5 = НСтр("ru = 'Правильный номер телефона: ';
						|en = 'Правильный номер телефона: '");
	Подстрока6 = Новый ФорматированнаяСтрока(НСтр("ru = '8(800)200-7799';
													|en = '8(800)200-7799'"), Новый Шрифт(,,Истина));
	Подстрока7 = НСтр("ru = 'Если вы ранее не дозвонились до банка, пожалуйста, позвоните по указанному номеру и назовите номер заявки.';
						|en = 'Если вы ранее не дозвонились до банка, пожалуйста, позвоните по указанному номеру и назовите номер заявки.'");
