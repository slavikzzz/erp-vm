...
Процедура СоздатьФайлСправкиНаСервере()
	...
	ИмяФайла = НСтр("ru = 'Справка об остатках отпусков';
					|en = 'Справка об остатках отпусков'");
	...
	Попытка
		...
		ЗаявкиСотрудников.СоздатьДокументКЭДОСправкаСотруднику(Объект.Организация, Объект.ФизическоеЛицо, Объект.Ссылка, ПрисоединенныйФайл, Ложь);
