	...
	ИначеЕсли ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ПересчетТоваров") Тогда
		...
		Если СтруктураРезультат.Статус <> Перечисления.СтатусыПересчетовТоваров.Выполнено Тогда 
			ТекстСообщения = НСтр("ru = 'Документ ""%ДокументПересчет%"" находится в статусе ""%СтатусПересчета%"". Ввод документа ""%ДокументАкт%"" на основании разрешен только в статусе ""%СтатусВыполнено%"".';
									|en = 'Document ""%ДокументПересчет%"" is in status ""%СтатусПересчета%"".  ""%ДокументАкт%"" can only be generated from base documents in status ""%СтатусВыполнено%"".'");
	...
	Для Каждого СтрокаТоваров Из Товары Цикл
		...
		Для Каждого СтрокаЗапасов Из ВидыЗапасов.НайтиСтроки(СтруктураПоиска) Цикл
			...
			Если ТекущийТипЗапасов = Перечисления.ТипыЗапасов.ТоварНаХраненииСПравомПродажи
				...
				Или ТекущийТипЗапасов = Перечисления.ТипыЗапасов.ПолуфабрикатДавальца
			...
			Если Не ПриходоватьТоварыПоСебестоимостиСписания Тогда
				...
				Если Не ЗначениеЗаполнено(НоваяСтрока.СуммаЗабаланс)
					...
					И (ТекущийТипЗапасовОприходования = Перечисления.ТипыЗапасов.ТоварНаХраненииСПравомПродажи
						//++ НЕ УТКА
						Или ТекущийТипЗапасовОприходования = Перечисления.ТипыЗапасов.МатериалДавальца
						Или ТекущийТипЗапасовОприходования = Перечисления.ТипыЗапасов.ПродукцияДавальца
						//-- НЕ УТКА
						Или Ложь) Тогда
				...
				//++ НЕ УТКА
				Если ТекущийТипЗапасовОприходования = Перечисления.ТипыЗапасов.ПолуфабрикатДавальца
					И Не ЗначениеЗаполнено(НоваяСтрока.Сумма)
				...
				Если Не ЗначениеЗаполнено(НоваяСтрока.Сумма)
					...
					//++ НЕ УТКА
					И Не ТекущийТипЗапасовОприходования = Перечисления.ТипыЗапасов.МатериалДавальца
					И Не ТекущийТипЗапасовОприходования = Перечисления.ТипыЗапасов.ПолуфабрикатДавальца
					И Не ТекущийТипЗапасовОприходования = Перечисления.ТипыЗапасов.ПродукцияДавальца
					//-- НЕ УТКА
...
Функция ПараметрыЗаполненияВидовЗапасов()
	...
	//++ НЕ УТКА
	ПараметрыЗаполнения.ПодбиратьВТЧТоварыПринятыеНаОтветственноеХранение.Вставить(Перечисления.ТипыЗапасов.МатериалДавальца,     "Всегда");
	ПараметрыЗаполнения.ПодбиратьВТЧТоварыПринятыеНаОтветственноеХранение.Вставить(Перечисления.ТипыЗапасов.ПолуфабрикатДавальца, "Всегда");
	ПараметрыЗаполнения.ПодбиратьВТЧТоварыПринятыеНаОтветственноеХранение.Вставить(Перечисления.ТипыЗапасов.ПродукцияДавальца,    "Всегда");
	//-- НЕ УТКА
