...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	НастройкаСчетовУчетаСервер.ПередЗаписью(ЭтотОбъект,
		Документы.КорректировкаЗадолженностиПоФинансовымИнструментам.ПараметрыНастройкиСчетовУчета(ХозяйственнаяОперация));
		
	ОчиститьРасчетныйДокумент();
	//-- НЕ УТ
...
Процедура ИнициализироватьДокумент(ДанныеЗаполнения = Неопределено)
	...
	//++ НЕ УТ
	ИначеЕсли ВнеоборотныеАктивы.ИспользуетсяУправлениеВНА() Тогда
...
//++ НЕ УТ
Процедура ОчиститьРасчетныйДокумент()
	
	Для Каждого СтрокаТабличнойЧасти Из Задолженность Цикл
		
		Если ЗначениеЗаполнено(СтрокаТабличнойЧасти.РасчетныйДокумент)
			И СтрокаТабличнойЧасти.ТипСуммы <> Перечисления.ТипыПлатежейПоАренде.ОбеспечительныйПлатеж
			И СтрокаТабличнойЧасти.ТипСуммы <> Перечисления.ТипыПлатежейПоАренде.УслугаПоАрендеАванс Тогда
