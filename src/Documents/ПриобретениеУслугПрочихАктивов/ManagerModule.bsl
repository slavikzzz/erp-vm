...
Процедура ТекстЗапросаДанныеДокументаТаблицаРасходы(СписокЗапросов)
	...
	|	ТаблицаДокумента.НастройкаСчетовУчета.СчетУчета КАК НастройкаСчетовУчетаСчетУчета,
	//-- НЕ УТ
...
Функция ТекстЗапросаТаблицаВтПрочиеАктивыПассивы(Запрос, ТекстыЗапроса)
	...
	|	ТаблицаРасходы.НастройкаСчетовУчетаСчетУчета КАК СчетУчета,
	//-- НЕ УТ
	|	ТаблицаРасходы.ИдентификаторСтроки КАК ИдентификаторСтроки,
	|	ДанныеДокумента.ОбъектРасчетов КАК ОбъектРасчетов,
...
Функция ТекстЗапросаТаблицаВтИсходныеДвиженияПоПрочимАктивамПассивам(Запрос, ТекстыЗапроса)
	...
	//++ НЕ УТ
	|	ПрочиеАктивыПассивы.НастройкаСчетовУчета КАК НастройкаСчетовУчета,
	//-- НЕ УТ
...
Функция ТекстЗапросаТаблицаДокументыПоОС(ТекстыЗапроса, Регистры, ДокументОбъект)
	...
	|ИЗ
	|	ДанныеДокументаТаблицаРасходы КАК ТаблицаОС
	|ГДЕ
	...
	Если ДокументОбъект = Неопределено Тогда
		...
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "ДанныеДокументаТаблицаРасходы", "Документ.ПриобретениеУслугПрочихАктивов.Расходы");
