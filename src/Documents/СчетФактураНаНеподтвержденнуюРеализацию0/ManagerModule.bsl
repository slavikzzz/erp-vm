...
Функция ТоварыПоДокументыОснованию(ДокументОснование, ДатаСчетаФактуры) Экспорт
	...
	ПараметрыУчетаОрганизации = УчетНДСУП.ПараметрыУчетаПоОрганизации(Организация, ДатаСчетаФактуры);
	ПараметрыЗаполненияСтавкиНДС.Вставить("НалогообложениеНДС", ПараметрыУчетаОрганизации.ОсновноеНалогообложениеНДСПродажи);
