...
Процедура УстановитьДоступностьКнопокСозданияНовыхДокументов(Форма)
	...
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Форма.Элементы, "ОтчетыОРозничныхПродажахСоздать", "Доступность", ДоступноСозданиеНовыхДокументов);
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Форма.Элементы, "ОтчетыОРозничныхПродажахСкопировать", "Доступность", ДоступноСозданиеНовыхДокументов);
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Форма.Элементы, "КонтекстноеМенюОтчетыОРозничныхПродажахСоздать", "Доступность", ДоступноСозданиеНовыхДокументов);
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Форма.Элементы, "КонтекстноеМенюОтчетыОРозничныхПродажахСкопировать", "Доступность", ДоступноСозданиеНовыхДокументов);
