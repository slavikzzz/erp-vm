...
Процедура ИзменитьКодировку(Команда)
	...
	СписокКодировок.ПоказатьВыборЭлемента(ОбработчикОповещенияОЗакрытии,
		НСтр("ru = 'Выберите кодировку';
			|en = 'Select encoding'"), СписокКодировок.НайтиПоЗначению(НРег(Объект.Кодировка)));
...
Процедура ЗаполнитьДополнительнуюИнформацию()
	...
	ДополнительнаяИнформацияОПисьме = НСтр("ru = 'Создано:';
											|en = 'Created on:'") + "   " + Объект.Дата 
	+ Символы.ПС + НСтр("ru = 'Получено';
						|en = 'Received'") + ":  " + Объект.ДатаПолучения 
	+ Символы.ПС + НСтр("ru = 'Важность';
						|en = 'Importance'") + ":  " + Объект.Важность
	+ Символы.ПС + НСтр("ru = 'Кодировка';
						|en = 'Encoding'") + ": " + Объект.Кодировка;
