...
Процедура ЗаполнитьТаблицуРаспоряженийНаСервере(Результат)
	...
	ИначеЕсли Результат.Статус = "Ошибка" Тогда
		...
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Не удалось заполнить список распоряжений для начисления реверсивного НДС';
										|en = 'Cannot fill the list of orders to accrue the reverse VAT charge'", ОбщегоНазначения.КодОсновногоЯзыка()),
...
Функция ДанныеДляЖР()
	...
	Возврат НСтр("ru = 'Заполнение списка распоряжений для начисления реверсивного НДС';
				|en = 'Fill the list of orders to accrue the reverse VAT charge'");
