...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Шаблон = НСтр("ru = 'Заявка учебный отпуск %1 от %2';
					|en = 'Заявка учебный отпуск %1 от %2'");
...
Функция НаименованиеЗадачи(ДокументОбъект) Экспорт
	...
	ШаблонНаименования = НСтр("ru = 'Учебный отпуск';
								|en = 'Учебный отпуск'");
...
Функция СодержаниеЗадачи(ДокументОбъект) Экспорт
	...
	Шаблон = НСтр("ru = 'Обработать заявление на учебный отпуск
	|Организация: %1
	|Сотрудник: %2';
	|en = 'Обработать заявление на учебный отпуск
	|Организация: %1
	|Сотрудник: %2'");
