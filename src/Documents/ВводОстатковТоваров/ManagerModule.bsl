...
Функция ИнициализироватьХозяйственнуюОперациюТовародвижения(ДанныеОбъекта) Экспорт
	...
	//++ НЕ УТКА
	ХозяйственнаяОперацияТовародвижения.Вставить("ЭтоОстаткиПринятыхВПереработкуМатериалов2_5",  ДанныеОбъекта.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковМатериаловПринятыхВПереработку2_5);
	ХозяйственнаяОперацияТовародвижения.Вставить("ЭтоОстаткиПолуфабрикатовДавальца2_5",          ДанныеОбъекта.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковПолуфабрикатовДавальца2_5);
	ХозяйственнаяОперацияТовародвижения.Вставить("ЭтоОстаткиПродукцииДавальца2_5",               ДанныеОбъекта.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковПродукцииДавальца2_5);
	//-- НЕ УТКА
...
Процедура ЗаполнитьВидДеятельностиНДС(ДанныеОбъекта, ЗаполняемаяФорма, Перезаполнять = Ложь) Экспорт
	...
	//++ НЕ УТКА
	ИначеЕсли ТипыОперацийТовародвижения.ЭтоОстаткиПолуфабрикатовДавальца2_5 Тогда
		ЭлементФормыЗаполнения = ЗаполняемаяФорма.Элементы.ПолуфабрикатыДавальцаВидДеятельностиНДС;
	ИначеЕсли ТипыОперацийТовародвижения.ЭтоОстаткиПродукцииДавальца2_5 Тогда
		ЭлементФормыЗаполнения = ЗаполняемаяФорма.Элементы.ПродукцияДавальцаВидДеятельностиНДС;
	//-- НЕ УТКА
	КонецЕсли;
...
Процедура ОбработкаПолученияФормы(ВидФормы, Параметры, ВыбраннаяФорма, ДополнительнаяИнформация, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(ВыбраннаяОперация) Тогда
		...
		//++ НЕ УТКА
		СоответствиеТиповОперацийФормам.Вставить(ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ВводОстатковМатериаловПринятыхВПереработку2_5"), "ФормаТовары");
		СоответствиеТиповОперацийФормам.Вставить(ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ВводОстатковПолуфабрикатовДавальца2_5"),         "ФормаТовары");
		СоответствиеТиповОперацийФормам.Вставить(ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ВводОстатковПродукцииДавальца2_5"),              "ФормаТовары");
		//-- НЕ УТКА
...
Функция ТекстЗапросаТаблицаТоварыНаСкладах(Запрос, ТекстыЗапроса, Регистры)
	...
	//++ НЕ УТКА
	|			ИЛИ &ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковМатериаловПринятыхВПереработку2_5)
	|			ИЛИ &ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковПолуфабрикатовДавальца2_5)
	|			ИЛИ &ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковПродукцииДавальца2_5)
	//-- НЕ УТКА
...
Функция ТекстЗапросаТаблицаМатериалыИРаботыВПроизводстве(Запрос, ТекстыЗапроса, Регистры)
	...
	|	ПО КлючиПроизводства.Номенклатура = ТаблицаТовары.Номенклатура
	|	И КлючиПроизводства.Характеристика = ТаблицаТовары.Характеристика
	|	И КлючиПроизводства.Назначение = ТаблицаТовары.Назначение
	|	И КлючиПроизводства.СтатьяКалькуляции = ЗНАЧЕНИЕ(Справочник.СтатьиКалькуляции.ПустаяСсылка)
	|	И КлючиПроизводства.Серия = ЗНАЧЕНИЕ(Справочник.СерииНоменклатуры.ПустаяСсылка)
	|	И КлючиПроизводства.МестоХранения = &Подразделение
	|ГДЕ
	|	&ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковПолуфабрикатовДавальца2_5)
	|	И &ОтражатьВОперативномУчете
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	//++ НЕ УТКА
	ОперацииДокумента.Добавить(Перечисления.ХозяйственныеОперации.ВводОстатковМатериаловПринятыхВПереработку2_5);
	ОперацииДокумента.Добавить(Перечисления.ХозяйственныеОперации.ВводОстатковПолуфабрикатовДавальца2_5);
	ОперацииДокумента.Добавить(Перечисления.ХозяйственныеОперации.ВводОстатковПродукцииДавальца2_5);
	//-- НЕ УТКА
...
Функция ОстаткиПоТоварам(ДатаОстатков, ХозяйственнаяОперация, МассивОрганизаций, ДопОтбор, ПараметрыЗаполненияОстатков)
	...
	Если ЗаполнятьПоСебестоимости Тогда
		...
		|			ТОГДА ОстаткиТоваров.СтоимостьЗабалансоваяОстаток
		|		КОГДА &ХозяйственнаяОперация В
		|				(ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковМатериаловПринятыхВПереработку2_5),
		|				ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковПродукцииДавальца2_5))
		|			ТОГДА ОстаткиТоваров.СтоимостьЗабалансоваяОстаток / ОстаткиТоваров.КоличествоОстаток
		//-- НЕ УТКА
		...
		|				(ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковМатериаловПринятыхВПереработку2_5),
		|				ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковПродукцииДавальца2_5))
		|			ТОГДА ОстаткиТоваров.СтоимостьЗабалансоваяРеглОстаток
		//-- НЕ УТКА
		|		КОГДА ИСТИНА
		...
		//++ НЕ УТКА
		|	ВЫБОР
		|		КОГДА &ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковПолуфабрикатовДавальца2_5)
		|			И ОстаткиТоваров.КоличествоОстаток = 0
		|			ТОГДА ОстаткиТоваров.СтоимостьЗабалансоваяОстаток
		|		КОГДА &ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковПолуфабрикатовДавальца2_5)
		|			ТОГДА ОстаткиТоваров.СтоимостьЗабалансоваяОстаток / ОстаткиТоваров.КоличествоОстаток
		...
		|			ТОГДА ОстаткиТоваров.СтоимостьЗабалансоваяОстаток
		|		ИНАЧЕ 0
		|	КОНЕЦ                                                 КАК СуммаЗабаланс,
		|	ВЫБОР
		|		КОГДА &ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковПолуфабрикатовДавальца2_5)
		|			ТОГДА ОстаткиТоваров.СтоимостьЗабалансоваяРеглОстаток
		|		ИНАЧЕ 0
		|	КОНЕЦ                                                 КАК СуммаРеглЗабаланс,
		//-- НЕ УТКА
		|	ВЫБОР
		//++ НЕ УТКА
		|		КОГДА &ХозяйственнаяОперация В
	...
	Если ЗначениеЗаполнено(ДопОтбор) Тогда
		...
		Если ДопОтбор.Свойство("Партнер") Тогда
			...
			Если ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковМатериаловПринятыхВПереработку2_5
				...
				УсловиеПартнер = "ОстаткиТоваров.ВидЗапасов.ВладелецТовара = &Партнер";
			Иначе
			//-- НЕ УТКА
		...
		Если ДопОтбор.Свойство("Договор") Тогда
			...
			Если ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковМатериаловПринятыхВПереработку2_5
				Или ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковПолуфабрикатовДавальца2_5
				Или ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковПродукцииДавальца2_5 Тогда
				УсловиеДоговор = "ОстаткиТоваров.ВидЗапасов.Договор = &Договор";
			Иначе
			//-- НЕ УТКА
	...
	//++ НЕ УТКА
	Если ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковМатериаловПринятыхВПереработку2_5 Тогда
		УсловиеТипЗапасов = "ОстаткиТоваров.ВидЗапасов.ТипЗапасов = ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.МатериалДавальца)";
	КонецЕсли;
	
	Если ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковПолуфабрикатовДавальца2_5 Тогда
		УсловиеТипЗапасов = "ОстаткиТоваров.ВидЗапасов.ТипЗапасов = ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.ПолуфабрикатДавальца)";
	КонецЕсли;
	
	Если ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковПродукцииДавальца2_5 Тогда
		УсловиеТипЗапасов = "ОстаткиТоваров.ВидЗапасов.ТипЗапасов = ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.ПродукцияДавальца)";
	КонецЕсли;
	//-- НЕ УТКА
	...
	//++ НЕ УТКА
	Запрос.Текст = СтрЗаменить(Запрос.Текст , "&УсловиеТипЗапасов",         УсловиеТипЗапасов);
	//-- НЕ УТКА
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет реквизит ""Формировать НДС предъявленный"".';
									|en = 'Fills the ""Generate VAT charged"" attribute.'");
