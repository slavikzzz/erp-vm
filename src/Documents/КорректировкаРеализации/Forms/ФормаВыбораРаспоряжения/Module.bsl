...
Функция ТекстЗапросаСписок()
	...
	|		ИЗ
	|			РегистрНакопления.ЗаказыКлиентов.Остатки(, ЗаказКлиента ССЫЛКА Документ.ЗаказКлиента
	...
	|			И ВЫРАЗИТЬ(ЗаказКлиента КАК Документ.ЗаказКлиента).НалогообложениеНДС В (&НалогообложениеНДС)
	...
	|			ЗаказыОстатки.КОформлениюОстаток КАК КОформлению
	|		ИЗ
	|			РегистрНакопления.ЗаказыКлиентов.Остатки(, ЗаказКлиента ССЫЛКА Документ.ЗаявкаНаВозвратТоваровОтКлиента
	...
	|			И ВЫРАЗИТЬ(ЗаказКлиента КАК Документ.ЗаявкаНаВозвратТоваровОтКлиента).НалогообложениеНДС В (&НалогообложениеНДС)
	...
	|			ЗаказыОстатки.КОформлениюОстаток КАК КОформлению
	|		ИЗ
	|			РегистрНакопления.ЗаказыКлиентов.Остатки(, ЗаказКлиента ССЫЛКА Документ.ЗаказДавальца2_5
	|			И ВЫРАЗИТЬ(ЗаказКлиента КАК Документ.ЗаказДавальца2_5).Организация = &Организация
	|			И ВЫРАЗИТЬ(ЗаказКлиента КАК Документ.ЗаказДавальца2_5).Валюта = &Валюта
	|			И ВЫРАЗИТЬ(ЗаказКлиента КАК Документ.ЗаказДавальца2_5).Контрагент = &Контрагент
	|			И ВЫРАЗИТЬ(ЗаказКлиента КАК Документ.ЗаказДавальца2_5).Договор = &Договор
	|			И ВЫРАЗИТЬ(ЗаказКлиента КАК Документ.ЗаказДавальца2_5).НалогообложениеНДС В (&НалогообложениеНДС)
	|			И ВЫРАЗИТЬ(ЗаказКлиента КАК Документ.ЗаказДавальца2_5).Партнер = &Партнер
	|			И ВЫРАЗИТЬ(ЗаказКлиента КАК Документ.ЗаказДавальца2_5).ЦенаВключаетНДС = &ЦенаВключаетНДС
	|			И (Склад = &Склад
	|			ИЛИ Склад В ИЕРАРХИИ (&Склад)
	|			ИЛИ Склад = ЗНАЧЕНИЕ(Справочник.Склады.ПустаяСсылка))) КАК ЗаказыОстатки
	|
	...
	//++ НЕ УТКА
	|				ИЛИ ЗаказыДвижения.ЗаказКлиента ССЫЛКА Документ.ЗаказДавальца2_5
	//-- НЕ УТКА
	|				ИЛИ ЗаказыДвижения.ЗаказКлиента ССЫЛКА Документ.ЗаявкаНаВозвратТоваровОтКлиента)) КАК ТаблицаЗаказы
	|	СГРУППИРОВАТЬ ПО
