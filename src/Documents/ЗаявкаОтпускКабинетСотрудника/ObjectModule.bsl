...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("Структура") Тогда
		...
		КонецЕсли;
		Если ЗначениеЗаполнено(ДанныеЗаполнения.ДанныеПоВидамОтпусков) Тогда
			ЗаявкиСотрудниковВнутренний.ЗаполнитьДанныеПоВидамОтпусков(ЭтотОбъект, ДанныеЗаполнения.ДанныеПоВидамОтпусков);
		Иначе
			ДнейОтпуска = ЗаявкиСотрудниковВнутренний.КоличествоДнейОтпуска(Сотрудник, ДатаНачала, ДатаОкончания);
		КонецЕсли;
	КонецЕсли;
