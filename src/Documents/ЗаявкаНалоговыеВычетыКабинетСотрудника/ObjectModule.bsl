...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("Структура") Тогда
		...
		КонецЕсли;
		Если ЗначениеЗаполнено(ДанныеЗаполнения.ДанныеВычетовНаДетей) Тогда
			Для каждого СтрокаТЗ Из ДанныеЗаполнения.ДанныеВычетовНаДетей Цикл
				ЗаполнитьЗначенияСвойств(ДанныеВычетовНаДетей.Добавить(), СтрокаТЗ);
			КонецЦикла;
		КонецЕсли;
	КонецЕсли;
