	...
	Если Не КроссТаблица
		...
		Для Каждого СтрокаОшибки Из ТаблицаОшибок Цикл
			...
			ТекстСообщения = НСтр("ru = 'Для строк плана с товарной категорией %ТоварнаяКатегория%%РейтингПродаж%%Назначение% не запланировано количество ни в одном периоде планирования.';
									|en = 'Quantity is not planned in any planning period for lines of plan with the %ТоварнаяКатегория%%РейтингПродаж%%Назначение% product category.'");
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ТоварнаяКатегория%", СтрокаОшибки.ТоварнаяКатегория);
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%РейтингПродаж%", ?(ЗначениеЗаполнено(СтрокаОшибки.РейтингПродаж), НСтр("ru = ', рейтингом продаж';
																																	|en = ', sales rank'") + СтрокаОшибки.РейтингПродаж, НСтр("ru = ', без рейтинга продаж';
