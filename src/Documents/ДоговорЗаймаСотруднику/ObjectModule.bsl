		...
		Для Каждого ДанныеТранша Из ТраншиЗайма Цикл
			Если МесяцыПредоставления[ДанныеТранша.ДатаПредоставления] <> Неопределено Тогда 
				...
				ТекстСообщения = НСтр("ru = 'На %1 запланировано более одного транша.';
										|en = 'More than one tranche is planned for %1.'");
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	// Условия договора
	ПериодЗаписи = ?(ЗаемПоДоговоруВыданПолностью = Истина, ДатаВыдачи, ДатаПредоставления);
	ЗаймыСотрудникам.ЗаписатьУсловияДоговораЗайма(Движения, Ссылка, ПериодЗаписи, Ссылка);
