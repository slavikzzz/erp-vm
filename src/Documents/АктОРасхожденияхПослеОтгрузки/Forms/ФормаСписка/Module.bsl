...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ НЕ УТКА
	ТекущийТипОснованияАкта = Неопределено;
	Параметры.Свойство("ТипОснованияАктаОРасхождении", ТекущийТипОснованияАкта);
	Если Не ЗначениеЗаполнено(ТекущийТипОснованияАкта) Тогда
		Параметры.Отбор.Свойство("ТипОснованияАктаОРасхождении", ТекущийТипОснованияАкта);
	КонецЕсли;
	
	Если Не ЗначениеЗаполнено(ТекущийТипОснованияАкта) И ЗначениеЗаполнено(Параметры.ТекущаяСтрока) Тогда
		
		ТекущийТипОснованияАкта =
			ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Параметры.ТекущаяСтрока, "ТипОснованияАктаОРасхождении");
		
		Если ТекущийТипОснованияАкта = Перечисления.ТипыОснованияАктаОРасхождении.ПередачаДавальцу
		 Или ТекущийТипОснованияАкта = Перечисления.ТипыОснованияАктаОРасхождении.ВозвратДавальцу Тогда
			ТипОснованияАктаОРасхождении = ТекущийТипОснованияАкта;
		КонецЕсли;
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_АктОРасхожденияхПослеОтгрузки" Тогда
		// СтандартныеПодсистемы.ПодключаемыеКоманды
