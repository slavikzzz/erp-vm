...
Функция ТекстОтраженияВРеглУчете() Экспорт
	Возврат ВводОстатковЛокализация.ВводОстатковДенежныхСредствТекстОтраженияВРеглУчете();
КонецФункции
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	Возврат ВводОстатковЛокализация.ДенежныхСредствТекстЗапросаВТОтраженияВРеглУчете();
КонецФункции
...
Функция ОстаткиПоКассам(ДатаОстатков, Организации)
	...
	Запрос.Текст = "ВЫБРАТЬ
		...
		|ИЗ
		|	РегистрНакопления.ДенежныеСредстваНаличные.Остатки(&Дата, Организация В (&Организации)) КАК ДенежныеСредстваНаличныеОстатки
		|
		|СГРУППИРОВАТЬ ПО
...
Функция ОстаткиПоБанковскимСчетам(ДатаОстатков, Организации)
	...
	Запрос.Текст = "ВЫБРАТЬ
		...
		|ИЗ
		|	РегистрНакопления.ДенежныеСредстваБезналичные.Остатки(&Дата, Организация В (&Организации)) КАК ДенежныеСредстваБезналичныеОстатки
		|
		|СГРУППИРОВАТЬ ПО
