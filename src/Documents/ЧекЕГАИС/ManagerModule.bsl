		...
		Для Каждого СтрокаТЧ Из ТаблицаТовары Цикл
			...
			Иначе
				...
				ОбменДаннымиЕГАИСКлиентСервер.ДобавитьТекстОшибки(
					СообщениеXML,
						СтрШаблон(
							НСтр("ru = 'Указано недостаточное количество акцизных марок в строке %1 табличной части ""Товары""';
								|en = 'Указано недостаточное количество акцизных марок в строке %1 табличной части ""Товары""'"), СтрокаТЧ.НомерСтроки));
