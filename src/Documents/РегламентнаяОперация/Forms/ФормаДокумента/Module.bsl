	...
	Если ЗначениеЗаполнено(Объект.Организация) 
		...
		Если Объект.ТипОперации = Перечисления.ТипыРегламентныхОпераций.РасчетДолейСписанияКосвенныхРасходов Тогда
			ТекстСообщения = НСтр("ru = 'Для обособленного подразделения используется расчет долей косвенных расходов головной организации';
									|en = 'Calculation of shares of indirect expenses of the parent company is used for the branch office.'");
		...
		Если Объект.ТипОперации = Перечисления.ТипыРегламентныхОпераций.ФормированиеФинансовогоРезультата
			...
			ШаблонСообщения = НСтр("ru = 'Регламентная операция ""%1"" проводится только для головной организации';
									|en = 'Period-end operation ""%1"" is posted only for parent company'");
