...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСозданияНаОсновании, Параметры) Экспорт
	...
	//++ НЕ УТ
	Документы.ДвижениеПродукцииИМатериалов.ДобавитьКомандуСоздатьОбеспечивающийЗаказ(КомандыСозданияНаОсновании);
	...
	Документы.ЗаказПереработчику.ДобавитьКомандуСоздатьОбеспечивающийЗаказ(КомандыСозданияНаОсновании);
	//-- Устарело_Переработка24
	
	Документы.ЗаказПереработчику2_5.ДобавитьКомандуСоздатьОбеспечивающийЗаказ(КомандыСозданияНаОсновании);
	//-- НЕ УТ
...
Функция ПроверкаПередСменойСтатуса(ВыборкаПроверки, НовыйСтатус, ДополнительныеПараметры) Экспорт
	...
	Если ВыборкаПроверки.ЭтоЗаказКакСчет Тогда
		...
		ТекстОшибки = НСтр("ru = 'У документа %Документ% статус ""%Статус%"" не установлен, т.к. для заказов клиентов, созданных в режиме ""Заказ как счет"" статусы не применимы';
							|en = 'The %Документ% document is not set to ""%Статус%"" as you cannot set statuses for sales orders created in the ""Order as a commercial invoice"" mode'");
