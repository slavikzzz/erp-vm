...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьВидимостьНовыхКолонок();
...
&НаКлиенте
Процедура КнигаПродажСуммаНДС7ПриИзменении(Элемент)
	СкопироватьЗначениеВРасхождение("КнигаПродаж", "СуммаНДС7");
КонецПроцедуры

&НаКлиенте
Процедура КнигаПродажСуммаНДС5ПриИзменении(Элемент)
	СкопироватьЗначениеВРасхождение("КнигаПродаж", "СуммаНДС5");
КонецПроцедуры

&НаКлиенте
Процедура КнигаПродажСуммаНДС7РасхождениеПриИзменении(Элемент)
	УправлениеФормой(ЭтотОбъект);
КонецПроцедуры

&НаКлиенте
Процедура КнигаПродажСуммаНДС5РасхождениеПриИзменении(Элемент)
	УправлениеФормой(ЭтотОбъект);
КонецПроцедуры

&НаКлиенте
Процедура КнигаПродажСтоимость7ПриИзменении(Элемент)
	СкопироватьЗначениеВРасхождение("КнигаПродаж", "Стоимость7");
КонецПроцедуры

&НаКлиенте
Процедура КнигаПродажСтоимость5ПриИзменении(Элемент)
	СкопироватьЗначениеВРасхождение("КнигаПродаж", "Стоимость5");
КонецПроцедуры
...
&НаКлиенте
Процедура КнигаПродажСтоимостьРубВсегоПриИзменении(Элемент)
	
	СкопироватьЗначениеВРасхождение("КнигаПродаж", "СтоимостьРубВсего");
...
&НаКлиенте
Процедура КнигаПродажДлСтоимость7ПриИзменении(Элемент)
	СкопироватьЗначениеВРасхождение("КнигаПродажДл", "Стоимость7");
КонецПроцедуры

&НаКлиенте
Процедура КнигаПродажДлСтоимость5ПриИзменении(Элемент)
	СкопироватьЗначениеВРасхождение("КнигаПродажДл", "Стоимость5");
КонецПроцедуры

&НаКлиенте
Процедура КнигаПродажДлСуммаНДС7ПриИзменении(Элемент)
	СкопироватьЗначениеВРасхождение("КнигаПродажДл", "СуммаНДС7");
КонецПроцедуры

&НаКлиенте
Процедура КнигаПродажДлСуммаНДС5ПриИзменении(Элемент)
	СкопироватьЗначениеВРасхождение("КнигаПродажДл", "СуммаНДС5");
КонецПроцедуры

&НаКлиенте
Процедура КнигаПродажДлСуммаНДС7РасхождениеПриИзменении(Элемент)
	УправлениеФормой(ЭтотОбъект);
КонецПроцедуры

&НаКлиенте
Процедура КнигаПродажДлСуммаНДС5РасхождениеПриИзменении(Элемент)
	УправлениеФормой(ЭтотОбъект);
КонецПроцедуры
...
&НаКлиенте
Процедура КнигаПродажДлСтоимостьРубВсегоПриИзменении(Элемент)
	
	СкопироватьЗначениеВРасхождение("КнигаПродажДл", "СтоимостьРубВсего");
...
&НаКлиенте
Процедура ВыставленныеСчетаФактурыНеплательщиковНДСКодВидаОперацииПриИзменении(Элемент)
	СкопироватьЗначениеВРасхождение("ВыставленныеСчетаФактурыНеплательщиковНДС", "КодВидаОперации");
КонецПроцедуры
...
Процедура ПечатьТребование(ТолькоТекущийРаздел = Ложь)
	...
	Если НаложенОтбор(ТолькоТекущийРаздел) Тогда
		...
		Если ТолькоТекущийРаздел Тогда
			Текст = НСтр("ru = 'В табличной части установлены отборы. 
	                      ...
	                      |en = 'В табличной части установлены отборы. 
	                      |Распечатать все строки или только отобранные?'");
		Иначе
			Текст = НСтр("ru = 'В табличный частях установлены отборы. 
	                      |Распечатать все строки или только отобранные?';
	                      |en = 'В табличный частях установлены отборы. 
	                      |Распечатать все строки или только отобранные?'");
		КонецЕсли;
	...
	Иначе
		...
		ПечатьТребования_ПослеВопроса(НСтр("ru = 'Все строки';
											|en = 'Все строки'"), ДополнительныеПараметры);
...
Процедура ПерезаполнитьПоТребованию(Команда)
	...
	ТекстВопроса = НСтр("ru = 'Перезаполнить пояснение без учета ранее отправленных пояснений?
						...
						|en = 'Перезаполнить пояснение без учета ранее отправленных пояснений?
						|Изменения данного документа будут потеряны.'");
		...
		ИнформацияОбОшибке = ПодробноеПредставлениеОшибки(ИнформацияОбОшибке());
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Электронный документооборот с контролирующими органами.ОчисткаНастроекПользователяВПояснении';
					|en = 'Электронный документооборот с контролирующими органами.ОчисткаНастроекПользователяВПояснении'"), 
...
Процедура УстановитьУсловноеОформлениеКнигаПродаж()
	...
	#Область ВидимостьСтрокиРасхождений
		...
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажСтоимость7Расхождение");
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажСуммаНДС7Расхождение");
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажСтоимость5Расхождение");
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажСуммаНДС5Расхождение");
		...
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажСтоимостьРубВсегоРасхождение");
...
Процедура УстановитьУсловноеОформлениеКнигаПродажДл()
	...
	#Область ВидимостьСтрокиРасхождений
		...
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажДлСтоимость7Расхождение");
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажДлСуммаНДС7Расхождение");
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажДлСтоимость5Расхождение");
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажДлСуммаНДС5Расхождение");
		...
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажДлСтоимостьРубВсегоРасхождение");
...
Процедура УстановитьУсловноеОформлениеВыставленныеСчетаФактуры()
	...
	#Область ВидимостьСтрокиРасхождений
		...
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "ВыставленныеСчетаФактурыНеплательщиковНДСКодВидаОперацииРасхождение");
...
Процедура УстановитьСвойстваКолонокТабличныхЧастей()
	...
	Элементы.КнигаПродажСтоимость7.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	Элементы.КнигаПродажСуммаНДС7.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	Элементы.КнигаПродажСтоимость5.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	Элементы.КнигаПродажСуммаНДС5.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	...
	Элементы.КнигаПродажСтоимостьРубВсего.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	...
	Элементы.КнигаПродажДлСтоимость7.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	Элементы.КнигаПродажДлСуммаНДС7.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	Элементы.КнигаПродажДлСтоимость5.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	Элементы.КнигаПродажДлСуммаНДС5.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	...
	Элементы.КнигаПродажДлСтоимостьРубВсего.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	...
	Элементы.ВыставленныеСчетаФактурыНеплательщиковНДСКодВидаОперации.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
...
Процедура УстановитьДанныеКонтрагента(СтрокаТаблицы, ПолеИНН, ТаблицаКонтрагентов, ПолеКПП = "")
	...
	ЕстьРазделитель = СтрНайти(СведенияОКонтрагенте.ИНН, "/");
	
	Если ЗначениеЗаполнено(ПолеКПП) ИЛИ ЕстьРазделитель Тогда
		
		Если ЕстьРазделитель Тогда
			Части = СтрРазделить(СведенияОКонтрагенте.ИНН, "/");
			СведенияОКонтрагенте.ИНН = Части[0];
			СведенияОКонтрагенте.КПП = Части[1];
		Иначе
...
Процедура УстановитьСведенияОКонтрагентеСписка(ДанныеСтроки, ИмяРеквизита, Сведения, РеквизитыКонтрагентов)
	...
	Если СокрЛП(Сведения.ИНН) <> "" Тогда
		...
		ДанныеСтроки[ИмяРеквизита+"Данные"][0].Значение.КПП = Сведения.КПП;
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьСведенияОКонтрагентеРеквизита(ДанныеСтроки, ИмяРеквизита, Сведения)
	
	ДанныеСтроки[ИмяРеквизита] = ИННиКПП(Сведения);
...
&НаКлиентеНаСервереБезКонтекста
Процедура СкопироватьСведенияОКонтрагентеРеквизитаВРасхождение(ДанныеСтроки, ИмяРеквизита, Сведения)
	...
	Если СтрНайти(ИмяРеквизита, "Расхождение") = 0 Тогда
		...
		Если НЕ ЗначениеЗаполнено(ДанныеСтроки[ИмяРеквизитаРасхождение])
			...
			ДанныеСтроки[ИмяРеквизитаРасхождение]                 = ИННиКПП(Сведения);
...
Процедура ОтработатьВыборКонтрагентаВНетКнигаПрод(ДанныеСтроки, Сведения, ИмяРеквизита) Экспорт
	...
	УстановитьСведенияОКонтрагентеРеквизитаПоКлючу(ДанныеСтроки, ИмяРеквизитаИНН, Сведения, "ИНН");
	УстановитьСведенияОКонтрагентеРеквизитаПоКлючу(ДанныеСтроки, ИмяРеквизитаКПП, Сведения, "КПП");
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьСведенияОКонтрагентеРеквизитаПоКлючу(ДанныеСтроки, ИмяРеквизита, Сведения, КлючЗначения = "ИНН")
...
Функция НеобходимаУточненнаяДекларация(Объект)
	Возврат Объект.КнигаПокупок.Итог("СуммаНДСРасхождение") <> Объект.КнигаПокупок.Итог("СуммаНДС")
		...
		ИЛИ Объект.КнигаПродаж.Итог("СуммаНДС7Расхождение") <> Объект.КнигаПродаж.Итог("СуммаНДС7")
		ИЛИ Объект.КнигаПродаж.Итог("СуммаНДС5Расхождение") <> Объект.КнигаПродаж.Итог("СуммаНДС5")
		...
		ИЛИ Объект.КнигаПродажДл.Итог("СуммаНДС7Расхождение") <> Объект.КнигаПродажДл.Итог("СуммаНДС7")
		ИЛИ Объект.КнигаПродажДл.Итог("СуммаНДС5Расхождение") <> Объект.КнигаПродажДл.Итог("СуммаНДС5")
...
Функция ПоляПроверкиРасхожденийВыставленныхСчетовФактурНеплательщиковНДС()
	...
	СвойстваПолей = Новый Структура();
	СвойстваПолей.Вставить("Поле",            "КодВидаОперации");
	СвойстваПолей.Вставить("ПолеРасхождение", "КодВидаОперацииРасхождение");
	СвойстваПолей.Вставить("Элементы",        "КодВидаОперацииРасхождение");
...
Функция ПоляПроверкиРасхожденийКнигиПродаж()
	...
	ПоляПроверки = Новый Структура();
	ПоляПроверки.Вставить("Поле",            "Стоимость7");
	ПоляПроверки.Вставить("ПолеРасхождение", "Стоимость7Расхождение");
	ПоляПроверки.Вставить("Элементы",        "Стоимость7Расхождение");
	
	ПоляПроверкиРасхождений.Добавить(ПоляПроверки);
	
	ПоляПроверки = Новый Структура();
	ПоляПроверки.Вставить("Поле",            "Стоимость5");
	ПоляПроверки.Вставить("ПолеРасхождение", "Стоимость5Расхождение");
	ПоляПроверки.Вставить("Элементы",        "Стоимость5Расхождение");
	...
	ПоляПроверки = Новый Структура();
	ПоляПроверки.Вставить("Поле",            "СуммаНДС7");
	ПоляПроверки.Вставить("ПолеРасхождение", "СуммаНДС7Расхождение");
	ПоляПроверки.Вставить("Элементы",        "СуммаНДС7Расхождение");
	ПоляПроверки.Вставить("Важно",           Истина);
	 
	ПоляПроверкиРасхождений.Добавить(ПоляПроверки);
	
	ПоляПроверки = Новый Структура();
	ПоляПроверки.Вставить("Поле",            "СуммаНДС5");
	ПоляПроверки.Вставить("ПолеРасхождение", "СуммаНДС5Расхождение");
	ПоляПроверки.Вставить("Элементы",        "СуммаНДС5Расхождение");
	ПоляПроверки.Вставить("Важно",           Истина);
...
Процедура ПроверитьЗаполнениеТабличныхЧастейПередОтправкой(Отказ)
	...
	Если Объект.КнигаПокупок.Количество() = 0
		...
		И Объект.ВыставленныеСчетаФактурыНеплательщиковНДС.Количество() = 0
		...
		ТекстСообщения = НСтр("ru = 'Пояснение не заполнено. Отправка невозможна.';
								|en = 'Пояснение не заполнено. Отправка невозможна.'");
...
Процедура ПроверитьНетКнигаПрод(Отказ)
	...
	Для Каждого СтрокаТабличнойЧасти Из Объект.НетКнигаПрод Цикл
		...
		Если ДоступноРедактированиеДанныхФНС Тогда
			ПроверитьИНН(СтрокаТабличнойЧасти, "ПокупательИНН", НСтр("ru = 'ИНН покупателя (по данным ФНС)';
																	|en = 'ИНН покупателя (по данным ФНС)'"), Отказ);
			ПроверитьКПП(СтрокаТабличнойЧасти, "ПокупательКПП", НСтр("ru = 'КПП покупателя (по данным ФНС)';
																	|en = 'КПП покупателя (по данным ФНС)'"), Отказ);
		КонецЕсли;
		
		Если СтрокаТабличнойЧасти.РезультатПроверки = Перечисления.РезультатПроверкиСтрокиДекларации.ВыявленыРасхождения Тогда
			
			ПроверитьИНН(СтрокаТабличнойЧасти, "ПокупательИННРасхождение", НСтр("ru = 'ИНН покупателя (уточненные данные)';
																				|en = 'ИНН покупателя (уточненные данные)'"), Отказ);
			ПроверитьКПП(СтрокаТабличнойЧасти, "ПокупательКППРасхождение", НСтр("ru = 'КПП покупателя (уточненные данные)';
																				|en = 'КПП покупателя (уточненные данные)'"), Отказ);
			
			Если ДоступноРедактированиеДанныхФНС Тогда
				ПроверитьИНН(СтрокаТабличнойЧасти, "ПосредникИНН", НСтр("ru = 'ИНН посредника (по данным ФНС)';
																		|en = 'ИНН посредника (по данным ФНС)'"), Отказ);
				ПроверитьКПП(СтрокаТабличнойЧасти, "ПосредникКПП", НСтр("ru = 'КПП посредника (по данным ФНС)';
																		|en = 'КПП посредника (по данным ФНС)'"), Отказ);
			КонецЕсли;
			
			ПроверитьИНН(СтрокаТабличнойЧасти, "ПосредникИННРасхождение", НСтр("ru = 'ИНН посредника (уточненные данные)';
																				|en = 'ИНН посредника (уточненные данные)'"), Отказ);
			ПроверитьКПП(СтрокаТабличнойЧасти, "ПосредникКППРасхождение", НСтр("ru = 'КПП посредника (уточненные данные)';
																				|en = 'КПП посредника (уточненные данные)'"), Отказ);
	...
	Если ЗначениеЗаполнено(ИНН) Тогда
		...
		Если ЕстьОшибка Тогда
			...
			ТекстСообщения = НСтр("ru = 'В строке %1 раздела ""Нет в книге продаж"" %2 заполнен некорректно:';
									|en = 'В строке %1 раздела ""Нет в книге продаж"" %2 заполнен некорректно:'");
	...
	Если ЗначениеЗаполнено(ИНН) Тогда
		...
		Если НЕ ЭтоЮридическоеЛицо И ЗначениеЗаполнено(КПП) Тогда
			...
			ТекстСообщения = НСтр("ru = 'В строке %1 раздела ""Нет в книге продаж"" обнаружена ошибка: у ИП не может быть заполнен КПП';
									|en = 'В строке %1 раздела ""Нет в книге продаж"" обнаружена ошибка: у ИП не может быть заполнен КПП'");
	...
	Если ЗначениеЗаполнено(КПП) Тогда
		...
		Если ЕстьОшибка Тогда
			...
			ТекстСообщения = НСтр("ru = 'В строке %1 раздела ""Нет в книге продаж"" %2 заполнено некорректно:';
									|en = 'В строке %1 раздела ""Нет в книге продаж"" %2 заполнено некорректно:'");
			...
			Если СтрокаТабличнойЧасти.Свойство("НомерСтрокиДекларации")
				И НЕ ЗначениеЗаполнено(СтрокаТабличнойЧасти.НомерСтрокиДекларации) Тогда
					СообщитьОНезаполненномПоле(ИмяТабличнойЧасти, ПредставлениеТабличнойЧасти, СтрокаТабличнойЧасти.НомерСтроки,
						"НомерСтрокиДекларации", НСтр("ru = 'Строка';
														|en = 'Строка'"), Отказ);
			КонецЕсли;
		...
		Если СтрокаТабличнойЧасти.РезультатПроверки = Перечисления.РезультатПроверкиСтрокиДекларации.ВыявленыРасхождения Тогда
			...
			Если РасхожденийНеНайдено Тогда
				ТекстСообщения = НСтр("ru = 'В строке %1 %2 указан ответ ""Найдены расхождения"", но уточненные сведения соответствуют данным ФНС';
										|en = 'В строке %1 %2 указан ответ ""Найдены расхождения"", но уточненные сведения соответствуют данным ФНС'");
...
Процедура СообщитьОНезаполненномПоле(ИмяТабличнойЧасти, ПредставлениеТабличнойЧасти, НомерСтроки, Поле, ОписаниеПоля, Отказ)
	...
	ТекстСообщения = НСтр("ru = 'В строке %1 %2 не заполнено обязательное поле ""%3""';
							|en = 'В строке %1 %2 не заполнено обязательное поле ""%3""'");
		...
		Для Каждого СтрокаТабличнойЧасти Из Объект.СведКС Цикл 
			...
			Если НЕ ЗначениеЗаполнено(НомерКС) Тогда
				...
				ТекстСообщения = НСтр("ru = 'В строке %1 раздела ""Контрольные соотношения"" не заполнен номер контрольного соотношения';
										|en = 'В строке %1 раздела ""Контрольные соотношения"" не заполнен номер контрольного соотношения'");
				ТекстСообщения = СтрШаблон(ТекстСообщения, СтрокаТабличнойЧасти.НомерСтроки);
			...
			ИначеЕсли НЕ ЗначениеЗаполнено(ПоясненКС) Тогда
				...
				ТекстСообщения = НСтр("ru = 'В строке %1 раздела ""Контрольные соотношения"" не заполнено пояснение расхождений';
										|en = 'В строке %1 раздела ""Контрольные соотношения"" не заполнено пояснение расхождений'");
				ТекстСообщения = СтрШаблон(ТекстСообщения, СтрокаТабличнойЧасти.НомерСтроки);
			...
			ИначеЕсли НомерКСПослеЗамены <> "X.X" 
				...
				И НомерКСПослеЗамены <> "X.XX.X"
				И НомерКСПослеЗамены <> "X.XX.XX" Тогда
				
				ЕстьОшибка = Истина;
				
				ТекстСообщения = НСтр("ru = 'В строке %1 раздела ""Контрольные соотношения"" номер контрольного соотношения
					|не соответствует ни одному из шаблонов X.X, X.XX, X.X.X, X.XX.X, X.XX.XX';
					|en = 'В строке %1 раздела ""Контрольные соотношения"" номер контрольного соотношения
					|не соответствует ни одному из шаблонов X.X, X.XX, X.X.X, X.XX.X, X.XX.XX'");
				ТекстСообщения = СтрШаблон(ТекстСообщения, СтрокаТабличнойЧасти.НомерСтроки);
	...
	Если КонтекстЭДОСервер.ЭтоФайлВыгрузкиДекларацияНДС(СвойстваФайла.Имя) Тогда
		...
		Если НРег(СвойстваФайла.Расширение) = НРег(".xml") Тогда
			...
			Исключение
				ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Файл ""%1"" не является файлом выгрузки декларации по НДС в формате XML.';
						|en = 'Файл ""%1"" не является файлом выгрузки декларации по НДС в формате XML.'"), СвойстваФайла.Имя);
			...
			Если КНД = Неопределено ИЛИ КНД = "" ИЛИ КНД <> "1151001" Тогда
				ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Выбранный файл не является файлом декларации по НДС';
															|en = 'Выбранный файл не является файлом декларации по НДС'"));
				Возврат Неопределено;
			КонецЕсли;
			...
			Если НЕ ДокументооборотСКОВызовСервера.ИспользуетсяРежимТестирования() Тогда
				...
				Если ОрганизацияВФайле <> Объект.Организация Тогда
					ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Организация в выбранном файле декларации по НДС не совпадает с организацией, указанной в требовании';
																|en = 'Организация в выбранном файле декларации по НДС не совпадает с организацией, указанной в требовании'"));
					Возврат Неопределено;
				КонецЕсли;
				...
				Если ВТребованииЕстьXMLФайл Тогда
					...
					Если НомКорр <> СвойстваДекларации.ТребованиеНомКорр Тогда
						ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Номер корректировки в выбранном файле декларации по НДС не совпадает с номером корректировки, указанном в требовании';
																	|en = 'Номер корректировки в выбранном файле декларации по НДС не совпадает с номером корректировки, указанном в требовании'"));
						Возврат Неопределено;
					КонецЕсли;
					...
					Если Период <> СвойстваДекларации.ТребованиеПериод Тогда
						ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Период в выбранном файле декларации по НДС не совпадает с периодом, указанном в требовании';
																	|en = 'Период в выбранном файле декларации по НДС не совпадает с периодом, указанном в требовании'"));
						Возврат Неопределено;
					КонецЕсли;
					...
					Если ОтчетГод <> СвойстваДекларации.ТребованиеОтчетГод Тогда
						ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Год в выбранном файле декларации по НДС не совпадает с годом, указанном в требовании';
																	|en = 'Год в выбранном файле декларации по НДС не совпадает с годом, указанном в требовании'"));
						Возврат Неопределено;
					КонецЕсли;
		...
		Иначе
			ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Файл декларации по НДС должен иметь расширение xml';
														|en = 'Файл декларации по НДС должен иметь расширение xml'"));
			Возврат Неопределено;
		КонецЕсли;
...
Функция ПоясненКС_1_25()
	...
	Возврат НСтр("ru = 'Несоответствие по КС 1.25 связано с особенностями заполнения налоговой декларации по НДС в связи с выполнением обязанностей налогового агента в соответствии с п. 8 ст. 161 НК РФ  и отражением в разделах 8 и 9 налоговой декларации по НДС регистрационных записей по счетам-фактурам продавцов с КВО 41, 42, 43, 44 согласно письму ФНС России от 16.01.2018 № СД-4-3/480@.';
				|en = 'Несоответствие по КС 1.25 связано с особенностями заполнения налоговой декларации по НДС в связи с выполнением обязанностей налогового агента в соответствии с п. 8 ст. 161 НК РФ  и отражением в разделах 8 и 9 налоговой декларации по НДС регистрационных записей по счетам-фактурам продавцов с КВО 41, 42, 43, 44 согласно письму ФНС России от 16.01.2018 № СД-4-3/480@.'");
...
Функция ПоясненКС_1_26()
	...
	Возврат НСтр("ru = 'Несоответствие по КС 1.26 связано с особенностями заполнения налоговой декларации по НДС в связи с выполнением обязанностей налогового агента в соответствии с п. 8 ст. 161 НК РФ  и отражением в раздел 9 налоговой декларации по НДС регистрационных записей по счетам-фактурам продавцов с КВО 41, 42, 43, 44 согласно письму ФНС России от 16.01.2018 № СД-4-3/480@.';
				|en = 'Несоответствие по КС 1.26 связано с особенностями заполнения налоговой декларации по НДС в связи с выполнением обязанностей налогового агента в соответствии с п. 8 ст. 161 НК РФ  и отражением в раздел 9 налоговой декларации по НДС регистрационных записей по счетам-фактурам продавцов с КВО 41, 42, 43, 44 согласно письму ФНС России от 16.01.2018 № СД-4-3/480@.'");
...
Функция ПоясненКС_1_27()
	...
	Возврат НСтр("ru = 'Несоответствие по КС 1.27 связано с особенностями заполнения налоговой декларации по НДС в связи с выполнением обязанностей налогового агента в соответствии с п. 8 ст. 161 НК РФ  и отражением в разделе 9 налоговой декларации по НДС регистрационных записей по счетам-фактурам продавцов с КВО 41, 42, 43, 44 согласно письму ФНС России от 16.01.2018 № СД-4-3/480@.';
				|en = 'Несоответствие по КС 1.27 связано с особенностями заполнения налоговой декларации по НДС в связи с выполнением обязанностей налогового агента в соответствии с п. 8 ст. 161 НК РФ  и отражением в разделе 9 налоговой декларации по НДС регистрационных записей по счетам-фактурам продавцов с КВО 41, 42, 43, 44 согласно письму ФНС России от 16.01.2018 № СД-4-3/480@.'");
...
Функция ПоясненКС_1_28()
	...
	Возврат НСтр("ru = 'Несоответствие по КС 1.28 связано с особенностями заполнения налоговой декларации по НДС в связи с выполнением обязанностей налогового агента в соответствии с п. 8 ст. 161 НК РФ  и отражением в разделе 8 налоговой декларации по НДС регистрационных записей по счетам-фактурам продавцов с КВО 41, 42, 43, 44 согласно письму ФНС России от 16.01.2018 № СД-4-3/480@.';
				|en = 'Несоответствие по КС 1.28 связано с особенностями заполнения налоговой декларации по НДС в связи с выполнением обязанностей налогового агента в соответствии с п. 8 ст. 161 НК РФ  и отражением в разделе 8 налоговой декларации по НДС регистрационных записей по счетам-фактурам продавцов с КВО 41, 42, 43, 44 согласно письму ФНС России от 16.01.2018 № СД-4-3/480@.'");
...
Процедура ПоказатьОшибкуСодержимого(ПоляСОшибками, ОповещениеОЗавершении)
	...
	ТекстСообщения = НСтр("ru = 'Обнаружены недопустимые символы в полях: %1. Удалить эти символы автоматически?';
							|en = 'Обнаружены недопустимые символы в полях: %1. Удалить эти символы автоматически?'");
...
&НаСервере
Процедура УстановитьВидимостьНовыхКолонок()

	Элементы.КнигаПродажГруппаСтоимость7.Видимость = Наступило;
	Элементы.КнигаПродажГруппаСуммаНДС7.Видимость = Наступило;
	Элементы.КнигаПродажГруппаСтоимость5.Видимость = Наступило;
	Элементы.КнигаПродажГруппаСуммаНДС5.Видимость = Наступило;
	Элементы.КнигаПродажГруппаСтоимостьРубВсего.Видимость = Наступило;
	
	Элементы.КнигаПродажДлГруппаСтоимость7.Видимость = Наступило;
	Элементы.КнигаПродажДлГруппаСуммаНДС7.Видимость = Наступило;
	Элементы.КнигаПродажДлГруппаСтоимость5.Видимость = Наступило;
	Элементы.КнигаПродажДлГруппаСуммаНДС5.Видимость = Наступило;
	Элементы.КнигаПродажДлГруппаСтоимостьРубВсего.Видимость = Наступило;
	
	Элементы.ВыставленныеСчетаФактурыНеплательщиковНДСГруппаКодВидаОперации.Видимость = Наступило;

КонецПроцедуры

&НаКлиенте
Процедура ВыставленныеСчетаФактурыНеплательщиковНДСКодВидаОперацииРасхождениеНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	
	ДанныеВыбора = КодыВидовОперацийРаздел12();

КонецПроцедуры

&НаКлиенте
Функция КодыВидовОперацийРаздел12()
	
	Возврат ДокументооборотСКОКлиент.КодыВидовОперацийРаздел12();
