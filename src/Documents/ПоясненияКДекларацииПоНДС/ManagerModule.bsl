...
Функция ПредставлениеКонтрагента(Строка, Представление) Экспорт
	...
	Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(Строка, "КПП") И ЗначениеЗаполнено(Строка.КПП) Тогда
		ИННКПП = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = '%1/%2';
																				|en = '%1/%2'"), Строка.ИНН, Строка.КПП);
	Иначе
		ИННКПП = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = '%1';
																				|en = '%1'"), Строка.ИНН);
	КонецЕсли;
	
	Если ЗначениеЗаполнено(Представление) Тогда
		Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = '%1 (%2)';
																			|en = '%1 (%2)'"), ИННКПП, Представление);
	Иначе
		Возврат ИННКПП;
	КонецЕсли;
...
Функция КонтрагентыПоСпискуИННиКПП(ТаблицаИННиКПП) Экспорт
...
Функция СведенияОКонтрагентеПоИНН(ИНН, КПП = "") Экспорт
	...
	ТаблицаКонтрагентов = КонтрагентыПоСпискуИННиКПП(ТаблицаИННиКПП);
...
Функция ПредставлениеДокументаОплаты(Строка) Экспорт
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
											НСтр("ru = '%1 от %2';
												|en = '%1 от %2'"), Строка.Номер, Формат(Строка.Дата, "ДЛФ=D"));
КонецФункции
...
Функция НаименованиеОтветаПоТребованию(Требование) Экспорт
	...
	Наименование 			= НСтр("ru = 'Пояснения к декларации по НДС %ПредставлениеДекларации%';
									|en = 'Пояснения к декларации по НДС %ПредставлениеДекларации%'");
...
Функция ДанныеПоясненияКДекларацииПоНДС(Пояснение) Экспорт
	...
	Запрос.Текст =
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ПоясненияКДекларацииПоНДСКонтрагенты.ИдентификаторЗначения КАК ИдентификаторЗначения,
	|	ПоясненияКДекларацииПоНДСКонтрагенты.ИНН КАК ИНН,
	|	ПоясненияКДекларацииПоНДСКонтрагенты.КПП КАК КПП
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ПоясненияКДекларацииПоНДСДокументыОплаты.ИдентификаторЗначения КАК ИдентификаторЗначения,
	|	ПоясненияКДекларацииПоНДСДокументыОплаты.Номер КАК Номер,
	|	ПоясненияКДекларацииПоНДСДокументыОплаты.Дата КАК Дата
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ПоясненияКДекларацииПоНДСДатыПринятияНаУчет.ИдентификаторЗначения КАК ИдентификаторЗначения,
	|	ПоясненияКДекларацииПоНДСДатыПринятияНаУчет.ДатаПринятияНаУчет КАК ДатаПринятияНаУчет
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ПоясненияКДекларацииПоНДСПосредническаяДеятельность.ИдентификаторЗначения КАК ИдентификаторЗначения,
	|	ПоясненияКДекларацииПоНДСПосредническаяДеятельность.НомерСчетаФактуры КАК НомерСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСПосредническаяДеятельность.ДатаСчетаФактуры КАК ДатаСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСПосредническаяДеятельность.КодВалюты КАК КодВалюты,
	|	ПоясненияКДекларацииПоНДСПосредническаяДеятельность.Стоимость КАК Стоимость,
	|	ПоясненияКДекларацииПоНДСПосредническаяДеятельность.СуммаНДС КАК СуммаНДС,
	|	ПоясненияКДекларацииПоНДСПосредническаяДеятельность.РазницаСтоимостиУменьшение КАК РазницаСтоимостиУменьшение,
	|	ПоясненияКДекларацииПоНДСПосредническаяДеятельность.РазницаСтоимостиУвеличение КАК РазницаСтоимостиУвеличение,
	|	ПоясненияКДекларацииПоНДСПосредническаяДеятельность.РазницаСуммыНДСУменьшение КАК РазницаСуммыНДСУменьшение,
	|	ПоясненияКДекларацииПоНДСПосредническаяДеятельность.РазницаСуммыНДСУвеличение КАК РазницаСуммыНДСУвеличение,
	|	ПоясненияКДекларацииПоНДСПосредническаяДеятельность.ПродавецИНН КАК ПродавецИНН
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.РезультатПроверки КАК РезультатПроверки,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.НомерСтрокиДекларации КАК НомерСтрокиДекларации,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.НомерСчетаФактуры КАК НомерСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.ДатаСчетаФактуры КАК ДатаСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.НомерИсправленияСчетаФактуры КАК НомерИсправленияСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.ДатаИсправленияСчетаФактуры КАК ДатаИсправленияСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.НомерКорректировочногоСчетаФактуры КАК НомерКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.ДатаКорректировочногоСчетаФактуры КАК ДатаКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.НомерИсправленияКорректировочногоСчетаФактуры КАК НомерИсправленияКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.ДатаИсправленияКорректировочногоСчетаФактуры КАК ДатаИсправленияКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.НомерТаможеннойДекларации КАК НомерТаможеннойДекларации,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.КодВалюты КАК КодВалюты,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.Стоимость КАК Стоимость,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.СуммаНДС КАК СуммаНДС,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.КодВидаОперации КАК КодВидаОперации,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.ДокументОплаты КАК ДокументОплаты,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.ДатаПринятияНаУчет КАК ДатаПринятияНаУчет,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.Продавец КАК Продавец,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.ПосредникИНН КАК ПосредникИНН,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.НомерСчетаФактурыРасхождение КАК НомерСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.ДатаСчетаФактурыРасхождение КАК ДатаСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.НомерИсправленияСчетаФактурыРасхождение КАК НомерИсправленияСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.ДатаИсправленияСчетаФактурыРасхождение КАК ДатаИсправленияСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.НомерКорректировочногоСчетаФактурыРасхождение КАК НомерКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.ДатаКорректировочногоСчетаФактурыРасхождение КАК ДатаКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.НомерИсправленияКорректировочногоСчетаФактурыРасхождение КАК НомерИсправленияКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.ДатаИсправленияКорректировочногоСчетаФактурыРасхождение КАК ДатаИсправленияКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.НомерТаможеннойДекларацииРасхождение КАК НомерТаможеннойДекларацииРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.КодВалютыРасхождение КАК КодВалютыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.СтоимостьРасхождение КАК СтоимостьРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.СуммаНДСРасхождение КАК СуммаНДСРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.КодВидаОперацииРасхождение КАК КодВидаОперацииРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.ДокументОплатыРасхождение КАК ДокументОплатыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.ДатаПринятияНаУчетРасхождение КАК ДатаПринятияНаУчетРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.ПродавецРасхождение КАК ПродавецРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупок.ПосредникИННРасхождение КАК ПосредникИННРасхождение
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.РезультатПроверки КАК РезультатПроверки,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.НомерСтрокиДекларации КАК НомерСтрокиДекларации,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.НомерСчетаФактуры КАК НомерСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.ДатаСчетаФактуры КАК ДатаСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.НомерИсправленияСчетаФактуры КАК НомерИсправленияСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.ДатаИсправленияСчетаФактуры КАК ДатаИсправленияСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.НомерКорректировочногоСчетаФактуры КАК НомерКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.ДатаКорректировочногоСчетаФактуры КАК ДатаКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.НомерИсправленияКорректировочногоСчетаФактуры КАК НомерИсправленияКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.ДатаИсправленияКорректировочногоСчетаФактуры КАК ДатаИсправленияКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.НомерТаможеннойДекларации КАК НомерТаможеннойДекларации,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.КодВалюты КАК КодВалюты,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.Стоимость КАК Стоимость,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.СуммаНДС КАК СуммаНДС,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.КодВидаОперации КАК КодВидаОперации,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.ДокументОплаты КАК ДокументОплаты,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.ДатаПринятияНаУчет КАК ДатаПринятияНаУчет,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.Продавец КАК Продавец,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.ПосредникИНН КАК ПосредникИНН,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.НомерСчетаФактурыРасхождение КАК НомерСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.ДатаСчетаФактурыРасхождение КАК ДатаСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.НомерИсправленияСчетаФактурыРасхождение КАК НомерИсправленияСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.ДатаИсправленияСчетаФактурыРасхождение КАК ДатаИсправленияСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.НомерКорректировочногоСчетаФактурыРасхождение КАК НомерКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.ДатаКорректировочногоСчетаФактурыРасхождение КАК ДатаКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.НомерИсправленияКорректировочногоСчетаФактурыРасхождение КАК НомерИсправленияКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.ДатаИсправленияКорректировочногоСчетаФактурыРасхождение КАК ДатаИсправленияКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.НомерТаможеннойДекларацииРасхождение КАК НомерТаможеннойДекларацииРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.КодВалютыРасхождение КАК КодВалютыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.СтоимостьРасхождение КАК СтоимостьРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.СуммаНДСРасхождение КАК СуммаНДСРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.КодВидаОперацииРасхождение КАК КодВидаОперацииРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.ДокументОплатыРасхождение КАК ДокументОплатыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.ДатаПринятияНаУчетРасхождение КАК ДатаПринятияНаУчетРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.ПродавецРасхождение КАК ПродавецРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПокупокДл.ПосредникИННРасхождение КАК ПосредникИННРасхождение
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.РезультатПроверки КАК РезультатПроверки,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.НомерСтрокиДекларации КАК НомерСтрокиДекларации,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.НомерСчетаФактуры КАК НомерСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.ДатаСчетаФактуры КАК ДатаСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.НомерИсправленияСчетаФактуры КАК НомерИсправленияСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.ДатаИсправленияСчетаФактуры КАК ДатаИсправленияСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.НомерКорректировочногоСчетаФактуры КАК НомерКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.ДатаКорректировочногоСчетаФактуры КАК ДатаКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.НомерИсправленияКорректировочногоСчетаФактуры КАК НомерИсправленияКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.ДатаИсправленияКорректировочногоСчетаФактуры КАК ДатаИсправленияКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.КодВалюты КАК КодВалюты,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СтоимостьВсего КАК СтоимостьВсего,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СтоимостьРубВсего КАК СтоимостьРубВсего,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.Стоимость20 КАК Стоимость20,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.Стоимость18 КАК Стоимость18,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.Стоимость10 КАК Стоимость10,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.Стоимость7 КАК Стоимость7,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.Стоимость5 КАК Стоимость5,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.Стоимость0 КАК Стоимость0,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СуммаНДС20 КАК СуммаНДС20,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СуммаНДС18 КАК СуммаНДС18,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СуммаНДС10 КАК СуммаНДС10,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СуммаНДС7 КАК СуммаНДС7,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СуммаНДС5 КАК СуммаНДС5,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СтоимостьОсвобождаемая КАК СтоимостьОсвобождаемая,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.КодВидаОперации КАК КодВидаОперации,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.ДокументОплаты КАК ДокументОплаты,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.Покупатель КАК Покупатель,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.ПосредникИНН КАК ПосредникИНН,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.НомерСчетаФактурыРасхождение КАК НомерСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.ДатаСчетаФактурыРасхождение КАК ДатаСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.НомерИсправленияСчетаФактурыРасхождение КАК НомерИсправленияСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.ДатаИсправленияСчетаФактурыРасхождение КАК ДатаИсправленияСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.НомерКорректировочногоСчетаФактурыРасхождение КАК НомерКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.ДатаКорректировочногоСчетаФактурыРасхождение КАК ДатаКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.НомерИсправленияКорректировочногоСчетаФактурыРасхождение КАК НомерИсправленияКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.ДатаИсправленияКорректировочногоСчетаФактурыРасхождение КАК ДатаИсправленияКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.КодВалютыРасхождение КАК КодВалютыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СтоимостьВсегоРасхождение КАК СтоимостьВсегоРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СтоимостьРубВсегоРасхождение КАК СтоимостьРубВсегоРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.Стоимость20Расхождение КАК Стоимость20Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.Стоимость18Расхождение КАК Стоимость18Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.Стоимость10Расхождение КАК Стоимость10Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.Стоимость7Расхождение КАК Стоимость7Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.Стоимость5Расхождение КАК Стоимость5Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.Стоимость0Расхождение КАК Стоимость0Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СуммаНДС20Расхождение КАК СуммаНДС20Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СуммаНДС18Расхождение КАК СуммаНДС18Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СуммаНДС10Расхождение КАК СуммаНДС10Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СуммаНДС7Расхождение КАК СуммаНДС7Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СуммаНДС5Расхождение КАК СуммаНДС5Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.СтоимостьОсвобождаемаяРасхождение КАК СтоимостьОсвобождаемаяРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.КодВидаОперацииРасхождение КАК КодВидаОперацииРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.ДокументОплатыРасхождение КАК ДокументОплатыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.ПокупательРасхождение КАК ПокупательРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродаж.ПосредникИННРасхождение КАК ПосредникИННРасхождение
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.РезультатПроверки КАК РезультатПроверки,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.НомерСтрокиДекларации КАК НомерСтрокиДекларации,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.НомерСчетаФактуры КАК НомерСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.ДатаСчетаФактуры КАК ДатаСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.НомерИсправленияСчетаФактуры КАК НомерИсправленияСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.ДатаИсправленияСчетаФактуры КАК ДатаИсправленияСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.НомерКорректировочногоСчетаФактуры КАК НомерКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.ДатаКорректировочногоСчетаФактуры КАК ДатаКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.НомерИсправленияКорректировочногоСчетаФактуры КАК НомерИсправленияКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.ДатаИсправленияКорректировочногоСчетаФактуры КАК ДатаИсправленияКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.КодВалюты КАК КодВалюты,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СтоимостьВсего КАК СтоимостьВсего,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СтоимостьРубВсего КАК СтоимостьРубВсего,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.Стоимость20 КАК Стоимость20,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.Стоимость18 КАК Стоимость18,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.Стоимость10 КАК Стоимость10,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.Стоимость7 КАК Стоимость7,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.Стоимость5 КАК Стоимость5,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.Стоимость0 КАК Стоимость0,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СуммаНДС20 КАК СуммаНДС20,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СуммаНДС18 КАК СуммаНДС18,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СуммаНДС10 КАК СуммаНДС10,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СуммаНДС7 КАК СуммаНДС7,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СуммаНДС5 КАК СуммаНДС5,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СтоимостьОсвобождаемая КАК СтоимостьОсвобождаемая,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.КодВидаОперации КАК КодВидаОперации,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.ДокументОплаты КАК ДокументОплаты,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.Покупатель КАК Покупатель,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.ПосредникИНН КАК ПосредникИНН,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.НомерСчетаФактурыРасхождение КАК НомерСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.ДатаСчетаФактурыРасхождение КАК ДатаСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.НомерИсправленияСчетаФактурыРасхождение КАК НомерИсправленияСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.ДатаИсправленияСчетаФактурыРасхождение КАК ДатаИсправленияСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.НомерКорректировочногоСчетаФактурыРасхождение КАК НомерКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.ДатаКорректировочногоСчетаФактурыРасхождение КАК ДатаКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.НомерИсправленияКорректировочногоСчетаФактурыРасхождение КАК НомерИсправленияКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.ДатаИсправленияКорректировочногоСчетаФактурыРасхождение КАК ДатаИсправленияКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.КодВалютыРасхождение КАК КодВалютыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СтоимостьВсегоРасхождение КАК СтоимостьВсегоРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СтоимостьРубВсегоРасхождение КАК СтоимостьРубВсегоРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.Стоимость20Расхождение КАК Стоимость20Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.Стоимость18Расхождение КАК Стоимость18Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.Стоимость10Расхождение КАК Стоимость10Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.Стоимость7Расхождение КАК Стоимость7Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.Стоимость5Расхождение КАК Стоимость5Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.Стоимость0Расхождение КАК Стоимость0Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СуммаНДС20Расхождение КАК СуммаНДС20Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СуммаНДС18Расхождение КАК СуммаНДС18Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СуммаНДС10Расхождение КАК СуммаНДС10Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СуммаНДС7Расхождение КАК СуммаНДС7Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СуммаНДС5Расхождение КАК СуммаНДС5Расхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.СтоимостьОсвобождаемаяРасхождение КАК СтоимостьОсвобождаемаяРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.КодВидаОперацииРасхождение КАК КодВидаОперацииРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.ДокументОплатыРасхождение КАК ДокументОплатыРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.ПокупательРасхождение КАК ПокупательРасхождение,
	|	ПоясненияКДекларацииПоНДСКнигаПродажДл.ПосредникИННРасхождение КАК ПосредникИННРасхождение
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.РезультатПроверки КАК РезультатПроверки,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.НомерСтрокиДекларации КАК НомерСтрокиДекларации,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.НомерСчетаФактуры КАК НомерСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.ДатаСчетаФактуры КАК ДатаСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.НомерИсправленияСчетаФактуры КАК НомерИсправленияСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.ДатаИсправленияСчетаФактуры КАК ДатаИсправленияСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.НомерКорректировочногоСчетаФактуры КАК НомерКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.ДатаКорректировочногоСчетаФактуры КАК ДатаКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.НомерИсправленияКорректировочногоСчетаФактуры КАК НомерИсправленияКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.ДатаИсправленияКорректировочногоСчетаФактуры КАК ДатаИсправленияКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.КодВидаОперации КАК КодВидаОперации,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.ПокупательИНН КАК ПокупательИНН,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.ПосредническаяДеятельность КАК ПосредническаяДеятельность,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.НомерСчетаФактурыРасхождение КАК НомерСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.ДатаСчетаФактурыРасхождение КАК ДатаСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.НомерИсправленияСчетаФактурыРасхождение КАК НомерИсправленияСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.ДатаИсправленияСчетаФактурыРасхождение КАК ДатаИсправленияСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.НомерКорректировочногоСчетаФактурыРасхождение КАК НомерКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.ДатаКорректировочногоСчетаФактурыРасхождение КАК ДатаКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.НомерИсправленияКорректировочногоСчетаФактурыРасхождение КАК НомерИсправленияКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.ДатаИсправленияКорректировочногоСчетаФактурыРасхождение КАК ДатаИсправленияКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.КодВидаОперацииРасхождение КАК КодВидаОперацииРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.ПокупательИННРасхождение КАК ПокупательИННРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаВыставленныхСчетовФактур.ПосредническаяДеятельностьРасхождение КАК ПосредническаяДеятельностьРасхождение
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.НомерСтрокиДекларации КАК НомерСтрокиДекларации,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.РезультатПроверки КАК РезультатПроверки,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.НомерСчетаФактуры КАК НомерСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.ДатаСчетаФактуры КАК ДатаСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.НомерИсправленияСчетаФактуры КАК НомерИсправленияСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.ДатаИсправленияСчетаФактуры КАК ДатаИсправленияСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.НомерКорректировочногоСчетаФактуры КАК НомерКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.ДатаКорректировочногоСчетаФактуры КАК ДатаКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.НомерИсправленияКорректировочногоСчетаФактуры КАК НомерИсправленияКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.ДатаИсправленияКорректировочногоСчетаФактуры КАК ДатаИсправленияКорректировочногоСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.КодВидаСделки КАК КодВидаСделки,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.КодВалюты КАК КодВалюты,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.КодВидаОперации КАК КодВидаОперации,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.ПродавецИНН КАК ПродавецИНН,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.СубкомиссионерИНН КАК СубкомиссионерИНН,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.Стоимость КАК Стоимость,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.СуммаНДС КАК СуммаНДС,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.РазницаСтоимостиУменьшение КАК РазницаСтоимостиУменьшение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.РазницаСтоимостиУвеличение КАК РазницаСтоимостиУвеличение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.РазницаСуммыНДСУменьшение КАК РазницаСуммыНДСУменьшение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.РазницаСуммыНДСУвеличение КАК РазницаСуммыНДСУвеличение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.НомерСчетаФактурыРасхождение КАК НомерСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.ДатаСчетаФактурыРасхождение КАК ДатаСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.НомерИсправленияСчетаФактурыРасхождение КАК НомерИсправленияСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.ДатаИсправленияСчетаФактурыРасхождение КАК ДатаИсправленияСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.НомерКорректировочногоСчетаФактурыРасхождение КАК НомерКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.ДатаКорректировочногоСчетаФактурыРасхождение КАК ДатаКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.НомерИсправленияКорректировочногоСчетаФактурыРасхождение КАК НомерИсправленияКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.КодВидаСделкиРасхождение КАК КодВидаСделкиРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.КодВалютыРасхождение КАК КодВалютыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.КодВидаОперацииРасхождение КАК КодВидаОперацииРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.ДатаИсправленияКорректировочногоСчетаФактурыРасхождение КАК ДатаИсправленияКорректировочногоСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.ПродавецИННРасхождение КАК ПродавецИННРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.СтоимостьРасхождение КАК СтоимостьРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.СубкомиссионерИННРасхождение КАК СубкомиссионерИННРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.СуммаНДСРасхождение КАК СуммаНДСРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.РазницаСтоимостиУменьшениеРасхождение КАК РазницаСтоимостиУменьшениеРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.РазницаСтоимостиУвеличениеРасхождение КАК РазницаСтоимостиУвеличениеРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.РазницаСуммыНДСУменьшениеРасхождение КАК РазницаСуммыНДСУменьшениеРасхождение,
	|	ПоясненияКДекларацииПоНДСЖурналУчетаПолученныхСчетовФактур.РазницаСуммыНДСУвеличениеРасхождение КАК РазницаСуммыНДСУвеличениеРасхождение
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.НомерСтроки КАК НомерСтроки,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.РезультатПроверки КАК РезультатПроверки,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.НомерСчетаФактуры КАК НомерСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.ДатаСчетаФактуры КАК ДатаСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.КодВалюты КАК КодВалюты,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.ПокупательИНН КАК ПокупательИНН,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.СтоимостьБезНДС КАК СтоимостьБезНДС,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.СуммаНДС КАК СуммаНДС,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.Стоимость КАК Стоимость,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.КодВидаОперации КАК КодВидаОперации,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.НомерСчетаФактурыРасхождение КАК НомерСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.ДатаСчетаФактурыРасхождение КАК ДатаСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.КодВалютыРасхождение КАК КодВалютыРасхождение,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.ПокупательИННРасхождение КАК ПокупательИННРасхождение,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.СтоимостьБезНДСРасхождение КАК СтоимостьБезНДСРасхождение,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.СуммаНДСРасхождение КАК СуммаНДСРасхождение,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.СтоимостьРасхождение КАК СтоимостьРасхождение,
	|	ПоясненияКДекларацииПоНДСВыставленныеСчетаФактурыНеплательщиковНДС.КодВидаОперацииРасхождение КАК КодВидаОперацииРасхождение
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПоясненияКДекларацииПоНДССведКС.НомерСтроки КАК НомерСтроки,
	|	ПоясненияКДекларацииПоНДССведКС.НомКС КАК НомКС,
	|	ПоясненияКДекларацииПоНДССведКС.ПоясненКС КАК ПоясненКС,
	|	ПоясненияКДекларацииПоНДССведКС.ФормулировкаНарушения КАК ФормулировкаНарушения,
	|	ПоясненияКДекларацииПоНДССведКС.НормаЗакона КАК НормаЗакона,
	|	ПоясненияКДекларацииПоНДССведКС.КонтрольноеCоотношение КАК КонтрольноеCоотношение,
	|	ПоясненияКДекларацииПоНДССведКС.ДанныеДекларации КАК ДанныеДекларации
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.НомерСтроки КАК НомерСтроки,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.РезультатПроверки КАК РезультатПроверки,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.НомерСчетаФактуры КАК НомерСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.ДатаСчетаФактуры КАК ДатаСчетаФактуры,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.СтоимостьВсего КАК СтоимостьВсего,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.Раздел КАК Раздел,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.ПокупательИНН КАК ПокупательИНН,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.ПокупательИННРасхождение КАК ПокупательИННРасхождение,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.ПосредникИНН КАК ПосредникИНН,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.ПосредникИННРасхождение КАК ПосредникИННРасхождение,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.КодВидаОперации КАК КодВидаОперации,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.КодВидаОперацииРасхождение КАК КодВидаОперацииРасхождение,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.НомерСчетаФактурыРасхождение КАК НомерСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.ДатаСчетаФактурыРасхождение КАК ДатаСчетаФактурыРасхождение,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.СтоимостьВсегоРасхождение КАК СтоимостьВсегоРасхождение,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.РазделРасхождение КАК РазделРасхождение,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.СтоимостьРубВсего КАК СтоимостьРубВсего,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.СтоимостьРубВсегоРасхождение КАК СтоимостьРубВсегоРасхождение,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.ПокупательКПП КАК ПокупательКПП,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.ПокупательКППРасхождение КАК ПокупательКППРасхождение,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.ПосредникКПП КАК ПосредникКПП,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.ПосредникКППРасхождение КАК ПосредникКППРасхождение,
	|	ПоясненияКДекларацииПоНДСНетКнигаПрод.НаименованиеКонтрагента КАК НаименованиеКонтрагента
	|ИЗ
...
Функция ТаблицаРаздела8() Экспорт
	...
	Раздел8.Колонки.Добавить("СвПос", ОбщегоНазначения.ОписаниеТипаСтрока(22)); // ИНН+/+КПП
...
Функция ТаблицаРаздела9() Экспорт
	...
	Раздел9.Колонки.Добавить("СвПос", ОбщегоНазначения.ОписаниеТипаСтрока(22)); // ИНН+/+КПП
...
Функция ТаблицаРаздела10() Экспорт
	...
	Раздел10.Колонки.Добавить("СвПокуп", ОбщегоНазначения.ОписаниеТипаСтрока(22)); // ИНН+/+КПП
...
Функция ТаблицаРаздела11() Экспорт
	...
	Раздел11.Колонки.Добавить("СвПрод", ОбщегоНазначения.ОписаниеТипаСтрока(22)); // ИНН+/+КПП
	Раздел11.Колонки.Добавить("СвКомис", ОбщегоНазначения.ОписаниеТипаСтрока(22)); // ИНН+/+КПП
...
Функция ТаблицаРаздела12() Экспорт
	...
	Раздел12.Колонки.Добавить("СвПокуп",        ОбщегоНазначения.ОписаниеТипаСтрока(22)); // ИНН+/+КПП
...
Функция СтруктураКонтрагент() Экспорт
...
Процедура ЗаполнитьРасхожденияСтрокиРаздела9(ДанныеСтроки) Экспорт
	...
	ДанныеСтроки.Стоимость7Расхождение  = ДанныеСтроки.Стоимость7;
	ДанныеСтроки.Стоимость5Расхождение  = ДанныеСтроки.Стоимость5;
	...
	ДанныеСтроки.СуммаНДС7Расхождение   = ДанныеСтроки.СуммаНДС7;
	ДанныеСтроки.СуммаНДС5Расхождение   = ДанныеСтроки.СуммаНДС5;
...
Процедура ЗаполнитьРаздел8(Объект, ДанныеТребования, ОтправленныеРанееСтроки, ДанныеКопирования) Экспорт
	...
	Для Каждого СтрокаТаблицыРаздела Из ТаблицаРаздела Цикл
		...
		Для Каждого СвПрод ИЗ СтрокаТаблицыРаздела.СвПрод Цикл
			...
			ЗначенияРеквизитов.ИНН = СвПрод.ИНН;
			ЗначенияРеквизитов.КПП = СвПрод.КПП;
...
Процедура ЗаполнитьРаздел9(Объект, ДанныеТребования, ОтправленныеРанееСтроки, ДанныеКопирования) Экспорт
	...
	Для Каждого СтрокаТаблицыРаздела Из ТаблицаРаздела Цикл
		...
		ЗаписьКнигиПродаж.СтоимостьРубВсего         = СтрокаТаблицыРаздела.СтоимПродСФ;
		...
		ЗаписьКнигиПродаж.Стоимость7                = СтрокаТаблицыРаздела.СтоимПродСФ7;
		ЗаписьКнигиПродаж.Стоимость5                = СтрокаТаблицыРаздела.СтоимПродСФ5;
		...
		ЗаписьКнигиПродаж.СуммаНДС7                 = СтрокаТаблицыРаздела.СумНДССФ7;
		ЗаписьКнигиПродаж.СуммаНДС5                 = СтрокаТаблицыРаздела.СумНДССФ5;
		...
		МассивКонтрагентов = Новый Массив();
		Для Каждого СвПокуп ИЗ СтрокаТаблицыРаздела.СвПокуп Цикл
			ЗначенияРеквизитов = Новый Структура(РеквизитыКонтрагентов());
			ЗначенияРеквизитов.ИНН = СвПокуп.ИНН;
			ЗначенияРеквизитов.КПП = СвПокуп.КПП;
			МассивКонтрагентов.Добавить(ЗначенияРеквизитов);
		КонецЦикла;
		...
		Иначе
			ЗаполнитьЗначенияСвойств(ЗаписьКнигиПродаж, ДанныеКопированияСтроки, "РезультатПроверки, НомерСчетаФактурыРасхождение, ДатаСчетаФактурыРасхождение, НомерИсправленияСчетаФактурыРасхождение, ДатаИсправленияСчетаФактурыРасхождение,
					...
					|КодВалютыРасхождение, СтоимостьВсегоРасхождение, СтоимостьРубВсегоРасхождение, Стоимость20Расхождение, Стоимость18Расхождение, Стоимость10Расхождение, Стоимость7Расхождение, Стоимость5Расхождение, Стоимость0Расхождение, СуммаНДС20Расхождение, СуммаНДС18Расхождение, СуммаНДС10Расхождение, СуммаНДС7Расхождение, СуммаНДС5Расхождение, СтоимостьОсвобождаемаяРасхождение, КодВидаОперацииРасхождение, ПосредникИННРасхождение");
	...
	Для Каждого СтрокаТаблицыРаздела Из ТаблицаРаздела Цикл
		...
		Иначе
			ЗаполнитьЗначенияСвойств(ЗаписьЖурнала, ДанныеКопированияСтроки, "РезультатПроверки, НомерСчетаФактурыРасхождение, ДатаСчетаФактурыРасхождение, КодВалютыРасхождение, ПокупательИННРасхождение,
					|СтоимостьБезНДСРасхождение, СуммаНДСРасхождение, СтоимостьРасхождение, КодВидаОперацииРасхождение");
		КонецЕсли;
...
Функция ПолучитьДаннныеДляВыгрузки(ДокументСсылка)
	...
	Для Каждого СтрокаРаздела9 Из ДанныеПояснения.Раздел9 Цикл
		...
		Если СтрокаРаздела9.СуммаНДС20 <> СтрокаРаздела9.СуммаНДС20Расхождение
			...
			ИЛИ СтрокаРаздела9.СуммаНДС10 <> СтрокаРаздела9.СуммаНДС10Расхождение
			ИЛИ СтрокаРаздела9.СуммаНДС7 <> СтрокаРаздела9.СуммаНДС7Расхождение
			ИЛИ СтрокаРаздела9.СуммаНДС5 <> СтрокаРаздела9.СуммаНДС5Расхождение Тогда
	...
	Для Каждого СтрокаРаздела9_1 Из ДанныеПояснения.Раздел9_1 Цикл
		...
		Если СтрокаРаздела9_1.СуммаНДС20 <> СтрокаРаздела9_1.СуммаНДС20Расхождение 
			...
			ИЛИ СтрокаРаздела9_1.СуммаНДС10 <> СтрокаРаздела9_1.СуммаНДС10Расхождение
			ИЛИ СтрокаРаздела9_1.СуммаНДС7 <> СтрокаРаздела9_1.СуммаНДС7Расхождение
			ИЛИ СтрокаРаздела9_1.СуммаНДС5 <> СтрокаРаздела9_1.СуммаНДС5Расхождение Тогда
...
Процедура ЗаполнитьСтрокуРаздела8(СтрокаВыгрузкиРаздела8, ДанныеСтроки, СпискиРеквизитов, ПостфиксРеквизита)
	...
	СтрокаВыгрузкиРаздела8.СвПрод = Реквизиты;
...
Процедура ЗаполнитьСтрокуРаздела9(СтрокаВыгрузкиРаздела9, ДанныеСтроки, СпискиРеквизитов, ПостфиксРеквизита)
	...
	СтрокаВыгрузкиРаздела9.СтоимПродСФ = ДанныеСтроки["СтоимостьРубВсего"+ПостфиксРеквизита];
	...
	СтрокаВыгрузкиРаздела9.СвПокуп = Реквизиты;
...
Процедура ЗаполнитьСтрокуРаздела12(СтрокаВыгрузкиРаздела12, ДанныеСтроки, ПостфиксРеквизита)
	...
	СтрокаВыгрузкиРаздела12.КодВидОпер = ДанныеСтроки["КодВидаОперации"+ПостфиксРеквизита];
...
Функция ТаблицаКнигаПокупок()
	...
	КнигаПокупок.Колонки.Добавить("СвПос", ОбщегоНазначения.ОписаниеТипаСтрока(22)); // ИНН+/+КПП
...
Функция ТаблицаКнигаПродаж()
	...
	КнигаПродаж.Колонки.Добавить("СтоимПродСФ", ОбщегоНазначения.ОписаниеТипаЧисло(19, 2));
	...
	КнигаПродаж.Колонки.Добавить("СвПос", ОбщегоНазначения.ОписаниеТипаСтрока(22)); // ИНН+/+КПП;
...
Функция ТаблицаЖурналУчетаВыставленныхСФ()
	...
	ЖурналУчетаВыставленныхСФ.Колонки.Добавить("СвПокуп", ОбщегоНазначения.ОписаниеТипаСтрока(22)); // ИНН+/+КПП
...
Функция ТаблицаЖурналУчетаПолученныхСФ()
	...
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("СвПрод", ОбщегоНазначения.ОписаниеТипаСтрока(22)); // ИНН+/+КПП
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("СвКомис", ОбщегоНазначения.ОписаниеТипаСтрока(22)); // ИНН+/+КПП
...
Функция ТаблицаВыставленныеСФ_173_5()
	...
	ВыставленныеСФ_173_5.Колонки.Добавить("СвПокуп",        ОбщегоНазначения.ОписаниеТипаСтрока(22)); // ИНН+/+КПП
	ВыставленныеСФ_173_5.Колонки.Добавить("КодВидОпер",     ОбщегоНазначения.ОписаниеТипаСтрока(2));
...
Функция ПредставлениеОбщихКодовОшибок(Ошибка, ГрафаОшибки)
	...
	ИначеЕсли Ошибка = "9" Тогда
		ПредставлениеОшибки = НСтр("ru = 'Сумма НДС, указанная с отрицательным значением, превышает сумму НДС, указанную в записи по счету-фактуре, подлежащей аннулированию, либо отсутствует запись по счету-фактуре, подлежащая аннулированию';
									|en = 'Сумма НДС, указанная с отрицательным значением, превышает сумму НДС, указанную в записи по счету-фактуре, подлежащей аннулированию, либо отсутствует запись по счету-фактуре, подлежащая аннулированию'");
	Иначе
