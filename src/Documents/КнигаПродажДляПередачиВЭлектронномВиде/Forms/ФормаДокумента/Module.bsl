...
Функция ВосстановитьИзХранилищаЗначенияНаСервере()
	...
	НаименованиеЗадания = НСтр("ru = 'Открытие документа ""Книга продаж для передачи в электронном виде""';
								|en = 'Open document ""Sales ledger for electronic filing""'");
	
	Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
	УникальныйИдентификатор,
	"Документы.КнигаПродажДляПередачиВЭлектронномВиде.ВосстановитьДанныеДляОтправки", 
...
Функция ЗаполнитьДокументНаСервере()
	...
	НаименованиеЗадания = НСтр("ru = 'Заполнение документа ""Книга продаж для передачи в электронном виде""';
								|en = 'Fill in document ""Sales ledger for electronic filing""'");
