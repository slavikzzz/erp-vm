...
Процедура СтатусГИСМОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(Объект.Ссылка) Тогда
		...
		ТекстВопроса = НСтр("ru = 'Уведомление о ввозе маркированных товаров ЕАЭС не записано. Записать?';
							|en = 'Уведомление о ввозе маркированных товаров ЕАЭС не записано. Записать?'");
	...
	ИначеЕсли Модифицированность Тогда
		...
		ТекстВопроса = НСтр("ru = 'Уведомление о ввозе маркированных товаров ЕАЭС было изменено. Записать?';
							|en = 'Уведомление о ввозе маркированных товаров ЕАЭС было изменено. Записать?'");
		ПоказатьВопрос(ОписаниеОповещенияВопрос, ТекстВопроса, РежимДиалогаВопрос.ДаНет);
