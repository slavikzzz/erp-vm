...
Функция УведомлениеОВвозеМаркированныхТоваровИзЕАЭСXML2_40(ДокументСсылка)
	...
	Попытка
		УведомлениеОВвозе.sender_gln = РеквизитыОрганизации.GLN;
	Исключение
		...
		Исключение
			ИнтеграцияГИСМКлиентСервер.ДобавитьТекстОшибки(
				...
				СтрШаблон(НСтр("ru = 'В строке %1 указана некорректная стоимость ""%2"".';
								|en = 'В строке %1 указана некорректная стоимость ""%2"".'"),
					СтрокаТЧ.НомерСтроки,
...
Функция УведомлениеОВвозеМаркированныхТоваровИзЕАЭСXML2_41(ДокументСсылка)
	...
	Попытка
		УведомлениеОВвозе.org_name = НаименованиеКонтрагента;
	Исключение
	...
	Исключение
		ИнтеграцияГИСМКлиентСервер.ДобавитьТекстОшибки(
			СообщениеXML,
			СтрШаблон(
				НСтр("ru = 'Не указан или указан неверно номер документа-основания.';
					|en = 'Не указан или указан неверно номер документа-основания.'"), Шапка.Контрагент));
	КонецПопытки;
	...
	Исключение
		ИнтеграцияГИСМКлиентСервер.ДобавитьТекстОшибки(
			СообщениеXML,
			СтрШаблон(
				НСтр("ru = 'Не указана или указана неверно дата документа-основания.';
					|en = 'Не указана или указана неверно дата документа-основания.'"), Шапка.Контрагент));
	КонецПопытки;
	...
	Исключение
		...
		СообщениеXML,
			СтрШаблон(
				НСтр("ru = 'Не удалось определить наименование документа-основания.';
					|en = 'Не удалось определить наименование документа-основания.'"), Шапка.Контрагент));
	КонецПопытки;
