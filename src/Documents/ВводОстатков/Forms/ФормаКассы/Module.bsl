	...
	Если Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковВКассах Тогда
		...
		Если Не ЗначениеЗаполнено(Касса) Тогда
			...
			Если Запрос.Выполнить().Выбрать().Количество() = 2 Тогда
				...
				|en = 'Cannot fill in the ""Cash account"" field. There are several cash accounts entered into the infobase.
				|Enable the ""Use several cash accounts"" functional option.'");
			Иначе
