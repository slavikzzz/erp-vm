...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекстПредупреждения = НСтр("ru = 'Документ ввод остатков необходимо создавать из рабочего места Начальное заполнение';
								|en = 'The balance entry document must be created from the Initial filling computer'");
	...
	//++ НЕ УТ
	СписокТипыОперацийНеОтражаемыеВРеглУчете.ЗагрузитьЗначения(ХозяйственныеОперацииНеОтражаемыеВРеглУчете());
	//-- НЕ УТ
	...
	Если Параметры.Свойство("ОтражатьВБУиНУ") Тогда
		Объект.ОтражатьВБУиНУ = Параметры.ОтражатьВБУиНУ;
	КонецЕсли;
	Если Параметры.Свойство("ОтражатьВУУ") Тогда
		Объект.ОтражатьВУУ = Параметры.ОтражатьВУУ;
	КонецЕсли;
	//-- НЕ УТ
...
&НаСервере
Функция ХозяйственныеОперацииНеОтражаемыеВРеглУчете() 
	
	МассивВозврата = Новый Массив;
	МассивВозврата.Добавить(Перечисления.ХозяйственныеОперации.ВводОстатковРозничныхПродажЗаПрошлыеПериоды);
	МассивВозврата.Добавить(Перечисления.ХозяйственныеОперации.ВводОстатковОптовыхПродажЗаПрошлыеПериоды);
	МассивВозврата.Добавить(Перечисления.ХозяйственныеОперации.ВводОстатковФинансовогоРезультатаЗаПрошлыеПериоды);
	МассивВозврата.Добавить(Перечисления.ХозяйственныеОперации.ВводОстатковПрочихАктивовПассивов);
