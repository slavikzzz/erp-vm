...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Документы.ПереводОсновныхСредствИнвестиционногоИмуществаМеждународныйУчет.ПроверитьБлокировкуВходящихДанныхПриОбновленииИБ(
		НСтр("ru = 'Перевод основных средств и инвестиционного имущества (международный учет)';
...
Процедура ПроверитьВозможностьПроведения(Отказ=Ложь)
	...
	Для Каждого Строка Из ОсновныеСредства Цикл
		...
		Иначе
			Шаблон = НСтр("ru = 'Объект принадлежит виду ""%1"" и принят к учету в организации ""%2""';
							|en = 'The object is of type ""%1"" and it is recognized in company ""%2""'");
			ТекстОшибки = ТекстОшибки
