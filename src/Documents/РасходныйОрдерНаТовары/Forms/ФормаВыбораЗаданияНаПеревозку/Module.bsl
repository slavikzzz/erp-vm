...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭлементВыбора.Представление = СтрЗаменить(НСтр("ru = 'Задания на перевозку по тем же распоряжениям, что и %Ордер%';
													|en = 'Itineraries by the same references as %Ордер%'"), "%Ордер%",
		?(Ордера.Количество() > 1, НСтр("ru = 'ордера';
										|en = 'notes'"), НСтр("ru = 'ордер';
																|en = 'note'")));
	
	ЭлементВыбора = Элементы.ОтборПоРаспоряжениям.СписокВыбора.Добавить("ЗаданияПоПолучателю");
	ЭлементВыбора.Представление = СтрЗаменить(НСтр("ru = 'Все задания по получателю ""%Получатель%""';
													|en = 'All jobs by recipient ""%Получатель%""'"), "%Получатель%", Получатель);
	...
	ЭлементВыбора.Представление = СтрЗаменить(НСтр("ru = 'Все задания по %Зона% доставки ""%ЗонаДоставки%""';
													|en = 'All jobs for the ""%ЗонаДоставки%"" delivery %Зона%'"), "%Зона%",
		?(ЗоныДоставки.Количество() > 1, НСтр("ru = 'зонам';
												|en = 'areas'"), НСтр("ru = 'зоне';
																	|en = 'area'")));
...
Процедура ЗаполнитьСписокЗаданий()
	...
	Если ОтборПоРаспоряжениям = "ЗаданияПоРаспоряжениям" Тогда
		...
		ТекстСообщения = НСтр("ru = 'Нет доступных заданий для выбора, распоряжениями которых являются распоряжения, указанные в %ПредставлениеОрдеров%.';
								|en = 'No available jobs to select that have references specified in %ПредставлениеОрдеров%.'");
	...
	ИначеЕсли ОтборПоРаспоряжениям = "ЗаданияПоПолучателю" Тогда
		...
		ТекстСообщения = НСтр("ru = 'Нет доступных заданий для выбора. В ордерах указаны различные получатели.';
								|en = 'No available jobs to select. Different recipients are specified in the notes.'");
	...
	ИначеЕсли ОтборПоРаспоряжениям = "ЗаданияПоЗонеДоставки" Тогда 
		...
		ТекстСообщения = НСтр("ru = 'Нет доступных заданий для выбора по %Зона% доставки.';
								|en = 'No available jobs to select in delivery %Зона%.'");
