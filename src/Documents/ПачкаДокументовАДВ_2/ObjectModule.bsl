...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если Не ЗначениеЗаполнено(ИмяФайлаДляПФР) Тогда
		ИмяФайлаДляПФР = ПерсонифицированныйУчет.ИмяФайлаАДВ(Организация, Дата, "АДВ-2");
	Иначе		
		...
		КонецЕсли;	
		ИмяФайлаДляПФР = ПерсонифицированныйУчет.ИмяФайлаАДВ(Организация, Дата, "АДВ-2", УИДИзИмениФайла);
	КонецЕсли;
	...
	Пока ВыборкаСотрудникиДляПроверки.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(ВыборкаСотрудникиДляПроверки.Сотрудник) Тогда
			...
			Если Не ЗначениеЗаполнено(ВыборкаСотрудникиДляПроверки.Фамилия) И Не ЗначениеЗаполнено(ВыборкаСотрудникиДляПроверки.Имя) И Не ЗначениеЗаполнено(ВыборкаСотрудникиДляПроверки.Отчество)
				...
				И Не ЗначениеЗаполнено(ВыборкаСотрудникиДляПроверки.НомерАктовойЗаписиПриРождении) И Не ЗначениеЗаполнено(ВыборкаСотрудникиДляПроверки.ИНН) 
