...
Процедура ИнформацияОСостоянииОбменов(Команда)
	...
	Если Элементы.ИнформацияОСостоянииОбменов.Заголовок =НСтр("ru = 'Показать информацию о дате последней загрузки';
																|en = 'Show information on the last import date'") Тогда 
		...
		ТекстЗаголовка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
									?(ЗначениеЗаполнено(ДатаЗагрузки)
										,НСтр("ru = 'Последний раз данные были загружены %1';
												|en = 'Last time the data was imported %1'")
										,НСтр("ru = 'Информация о дате последней загрузки отсутствует';
												|en = 'There is no information about the latest import date'"))
									,ДатаЗагрузки);
	ИначеЕсли КоличествоДоступныхОрганизаций > 1 Тогда 
		ТекстЗаголовка = НСтр("ru = 'Показать информацию о дате последней загрузки';
								|en = 'Show information on the last import date'");
	Иначе		
