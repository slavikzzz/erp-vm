...
Функция ТекстФайла(ИмяФайла)
	...
	ИмяФайла = ИмяФайла(ВыборкаПоШапкеДокумента.Дата, Не ОрганизацияЭтоФизЛицо, ВыборкаПоШапкеДокумента.КодНалоговогоОрганаПолучателя,
						ВыборкаПоШапкеДокумента.КодИФНС, ВыборкаПоШапкеДокумента.ОрганизацияИНН, ВыборкаПоШапкеДокумента.ОрганизацияКПП,
						ИдентификаторФайла);
...
Функция ИмяФайла(ДатаСоставления, ЭтоЮрЛицо, КодНалоговогоОрганаПолучателя, КодНалоговогоОргана, ИНН, КПП, ИдентификаторФайла)
