...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого СтрТаблСообщений Из ВладелецТС.ТаблицаСообщений Цикл
		...
		РегламентированнаяОтчетность.ОбработатьСобытие1СОтчетности(НСтр("ru = 'Регламентированный отчет. Проверка выгрузки';
																		|en = 'Регламентированный отчет. Проверка выгрузки'"), СтрТаблСообщений);
