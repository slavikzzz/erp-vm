...
Функция ДобавитьКомандуСоздатьНаОснованииПоступлениеОтКомиссионера(КомандыСозданияНаОсновании) Экспорт
	...
	Если ПравоДоступа("Добавление", Метаданные.Документы.ПоступлениеТоваровОтХранителя) Тогда
		...
		КомандаСоздатьНаОсновании.Представление       = НСтр("ru = 'Поступление товаров от комиссионера';
															|en = 'Receipt of goods from consignee'");
		КомандаСоздатьНаОсновании.РежимЗаписи         = "Проводить";
...
//  СтрокаТаблицыЗначений
//
Функция ДобавитьКомандуСоздатьНаОснованииВозвратОтПереработчика(КомандыСозданияНаОсновании) Экспорт
	
	Если ПравоДоступа("Добавление", Метаданные.Документы.ПоступлениеТоваровОтХранителя) Тогда
		
		ИмяОбработчика = "ПереработкаНаСторонеКлиент.ПоступлениеТоваровОтХранителяОперацияВозвратОтПереработчикаСоздатьНаОсновании";
		
		КомандаСоздатьНаОсновании = КомандыСозданияНаОсновании.Добавить();
		КомандаСоздатьНаОсновании.Идентификатор       = "СоздатьВозвратОтПереработчика";
		КомандаСоздатьНаОсновании.Обработчик          = ИмяОбработчика;
		КомандаСоздатьНаОсновании.Менеджер            = Метаданные.Документы.ПоступлениеТоваровОтХранителя.ПолноеИмя();
		КомандаСоздатьНаОсновании.Представление       = НСтр("ru = 'Возврат сырья от переработчика';
...
//  СтрокаТаблицыЗначений
//
Функция ДобавитьКомандуСоздатьНаОснованииПоступлениеОтПереработчика(КомандыСозданияНаОсновании) Экспорт
	
	Если ПравоДоступа("Добавление", Метаданные.Документы.ПоступлениеТоваровОтХранителя) Тогда
		
		ИмяОбработчика = "ПереработкаНаСторонеКлиент.ПоступлениеТоваровОтХранителяОперацияПоступлениеОтПереработчикаСоздатьНаОсновании";
		
		КомандаСоздатьНаОсновании = КомандыСозданияНаОсновании.Добавить();
		КомандаСоздатьНаОсновании.Идентификатор       = "СоздатьПоступлениеОтПереработчика";
		КомандаСоздатьНаОсновании.Обработчик          = ИмяОбработчика;
		КомандаСоздатьНаОсновании.Менеджер            = Метаданные.Документы.ПоступлениеТоваровОтХранителя.ПолноеИмя();
		КомандаСоздатьНаОсновании.Представление       = НСтр("ru = 'Поступление от переработчика';
...
// Добавляет команду создания документа "Поступление товаров от хранителя" на основании "Передачи давальцу".
//
// Параметры:
//  КомандыСозданияНаОсновании - см. СозданиеНаОснованииПереопределяемый.ПередДобавлениемКомандСозданияНаОсновании.КомандыСозданияНаОсновании
//
...
//  СтрокаТаблицыЗначений
//
Функция ДобавитьКомандуСоздатьНаОснованииПередачиДавальцу(КомандыСозданияНаОсновании) Экспорт
...
// Добавляет команду создания документа "Поступление товаров от хранителя" на основании "Возврата давальцу".
//
// Параметры:
//  КомандыСозданияНаОсновании - см. СозданиеНаОснованииПереопределяемый.ПередДобавлениемКомандСозданияНаОсновании.КомандыСозданияНаОсновании
//
...
//  СтрокаТаблицыЗначений
//
Функция ДобавитьКомандуСоздатьНаОснованииВозвратаДавальцу(КомандыСозданияНаОсновании) Экспорт
	
	Если ПравоДоступа("Добавление", Метаданные.Документы.ПоступлениеТоваровОтХранителя) Тогда
		
		КомандаСоздатьНаОсновании                     = КомандыСозданияНаОсновании.Добавить();
		КомандаСоздатьНаОсновании.Менеджер            = Метаданные.Документы.ПоступлениеТоваровОтХранителя.ПолноеИмя();
		КомандаСоздатьНаОсновании.Представление       = НСтр("ru = 'Возврат от переработчика';
															|en = 'Pick up materials from subcontractor'");
		КомандаСоздатьНаОсновании.РежимЗаписи         = "Проводить";
		КомандаСоздатьНаОсновании.ФункциональныеОпции = "ИспользоватьНесколькоОрганизацийПроизводствоНаСтороне2_5";
...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСозданияНаОсновании, Параметры) Экспорт
	...
	НастройкиОпераций.Вставить(
		...
		ПолучитьФункциональнуюОпцию("ИспользоватьАктыРасхожденийПослеПриемкиПоПоступлениямОтПереработчика2_5"));
	НастройкиОпераций.Вставить(
	...
	//++ НЕ УТ
	Команда = Документы.ОтчетПереработчика2_5.ДобавитьКомандуСоздатьНаОсновании(КомандыСозданияНаОсновании);
	Если Команда <> Неопределено Тогда
		ПодключаемыеКоманды.ДобавитьУсловиеВидимостиКоманды(
			Команда,
			"ХозяйственнаяОперация",
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Доступность =
		...
		И (ОбщиеПараметрыЗапросов.ЭтоПолноправныйПользователь
			Или (ПравоДоступа("Добавление", Метаданные.Документы.ПоступлениеТоваровОтХранителя)
	...
	ПараметрыФормы.Вставить("ИмяТекущейСтраницы",      "СтраницаПоступления");
	ПараметрыФормы.Вставить("КлючНазначенияФормы",     "ТекущиеДела");
	
	Дело = ТекущиеДела.Добавить();
	Дело.Идентификатор  = "ПоступлениеОтПереработчикаКОформлению2_5";
	Дело.ЕстьДела       = Результат > 0;
	Дело.Представление  = НСтр("ru = 'Поступления от переработчика к оформлению';
								|en = '""Goods receipt — Subcontracting services received"" for registration'");
	Дело.Количество     = Результат;
	Дело.Важное         = Ложь;
...
Процедура ЗаполнитьПоЗаказамОрдерам(Товары, Регистратор, ПараметрыЗаполнения) Экспорт
	...
	//++ НЕ УТ
	Если ЗначениеЗаполнено(ПараметрыЗаполнения.МассивЗаказов)
		И ТипЗнч(ПараметрыЗаполнения.МассивЗаказов[0]) = Тип("ДокументСсылка.ЗаказПереработчику2_5") Тогда
		ЗаполнитьСерииПоОтчетамПереработчика(ТаблицаЗаказы, МенеджерВременныхТаблиц, Регистратор);
	КонецЕсли;
	//-- НЕ УТ
	...
	Если Не Обработчик.ИспользоватьКодСтроки() Тогда
		...
		Если ЗначениеЗаполнено(ПараметрыЗаполнения.КлючевыеПоля) Тогда
			СтруктураПоиска = Новый Структура(ПараметрыЗаполнения.КлючевыеПоля + ", Распределено");
		Иначе
			СтруктураПоиска = Новый Структура(Обработчик.КлючевыеПоляТаблицыТоваровРаспоряжения() + ", Распределено");
		КонецЕсли;
		...
		Для Каждого СтрокаТаблицыЗначений Из ТаблицаЗаказы Цикл
			...
			Для Каждого НайденнаяСтрока Из НайденныеСтроки Цикл
				Если КоличествоКРаспределению = 0 Тогда  
					Если УдаляемыеСтроки.Найти(НайденнаяСтрока) = Неопределено Тогда
		...
		ОбщегоНазначенияУТ.УдалитьСтрокиТаблицыЗначений(ТаблицаЗаказы, УдаляемыеСтроки);
	КонецЕсли;
	...
	Если ПараметрыЗаполнения.МассивЗаказов <> Неопределено
		И (ТипЗнч(ПараметрыЗаполнения.МассивЗаказов[0]) = Тип("ДокументСсылка.ПередачаТоваровХранителю")
			//++ НЕ УТ
			Или ПараметрыЗаполнения.РеквизитыШапки.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВозвратОтПереработчика2_5
			//-- НЕ УТ
		...
		Отбор = Новый Соответствие;
		//++ НЕ УТ
		Если ПараметрыЗаполнения.РеквизитыШапки.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВозвратОтПереработчика2_5
			И ТипЗнч(ПараметрыЗаполнения.МассивЗаказов[0]) = Тип("ДокументСсылка.ЗаказПереработчику2_5") Тогда
			ОбщегоНазначенияУТ.ДобавитьЭлементОтбораВКоллекцию(Отбор, "Таблица.ЗаказКлиента", "&Распоряжения");
		Иначе
		//-- НЕ УТ
			ОбщегоНазначенияУТ.ДобавитьЭлементОтбораВКоллекцию(Отбор, "Таблица.Ссылка", "&Распоряжения");
		//++ НЕ УТ
	...
	Отбор = Новый Соответствие;
	Отбор.Вставить("ДанныеУчета.Распоряжение", "ДокументПоступления");
	...
	Если ЗначениеЗаполнено(ПараметрыЗаполнения.АктОРасхождениях) Тогда
		ТаблицаЗаказы.Очистить();
	КонецЕсли;
	
	//++ НЕ УТ

	// 4. По отчетам переработчика
	
	ТаблицаОтчетыПереработчика = ТаблицаЗаказы.СкопироватьКолонки();
	
	Если ПараметрыЗаполнения.МассивЗаказов <> Неопределено
		И ТипЗнч(ПараметрыЗаполнения.МассивЗаказов[0]) = Тип("ДокументСсылка.ОтчетПереработчика2_5") Тогда
		...
		Запрос.Текст = Документы.ОтчетПереработчика2_5.ТекстЗапросаОстаткиКПоступлениюПоОтчетамПереработчика();
		
		Запрос.УстановитьПараметр("Регистратор",  Регистратор);
		Запрос.УстановитьПараметр("Распоряжения", ПараметрыЗаполнения.МассивЗаказов);
		
		ТаблицаОтчетыПереработчика = Запрос.Выполнить().Выгрузить();
	...
	//++ НЕ УТ
	ОбщегоНазначенияКлиентСервер.ДополнитьТаблицу(ТаблицаОтчетыПереработчика, ТаблицаЗаказы);
	//-- НЕ УТ
	...
	// Заполнить серии по ордерам
	Если СтрНайти(Ключ, "Серия") = 0 Тогда
...
Процедура ОбновитьЗависимыеРеквизитыТабличнойЧасти(Объект, ПараметрыЗаполнения) Экспорт
	...
	Для Каждого Строка Из Объект.Товары Цикл
		...
		//++ НЕ УТ
		Если Не Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПоступлениеОтПереработчика2_5 Тогда
		//-- НЕ УТ
...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Если Данные.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВозвратОтКомиссионера Тогда
		ПредставлениеОбъекта = НСтр("ru = 'Поступление товаров от комиссионера';
									|en = 'Receipt of goods from consignee'");
	//++ НЕ УТ
	ИначеЕсли Данные.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПоступлениеОтПереработчика2_5 Тогда
		ПредставлениеОбъекта = НСтр("ru = 'Поступление от переработчика';
									|en = 'Goods receipt — External subcontracting'");
	ИначеЕсли Данные.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВозвратОтПереработчика2_5 Тогда
		ПредставлениеОбъекта = НСтр("ru = 'Возврат сырья от переработчика';
									|en = 'Goods return — Subcontracting services received'");
	//-- НЕ УТ
	Иначе
...
Функция ТекстЗапросаТаблицаЗаказыПоставщикам(Запрос, ТекстыЗапроса, Регистры)
	...
	|	И &ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПоступлениеОтПереработчика2_5)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
...
Функция СформироватьПечатнуюФормуПоступлениеТоваровОтХранителя(МассивОбъектов, ОбъектыПечати)
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		ТекстЗаголовка = ОбщегоНазначенияУТКлиентСервер.СформироватьЗаголовокДокумента(ДанныеПечати,
																						НСтр("ru = 'Поступление товаров от хранителя';
																							|en = 'VMI return'", ОбщегоНазначения.КодОсновногоЯзыка()));
...
Функция ТекстЗапросаТоварыДокумента(Отбор, ТекстСоединения, ИспользоватьКодСтроки = Ложь)
	...
	|	СУММА(ЕСТЬNULL(Таблица.Количество, 0)) КАК Количество,
	|	МАКСИМУМ(ЕСТЬNULL(ДанныеУчета.КОформлению, 0)) КАК КОформлению,
	|	МАКСИМУМ(ДанныеУчета.Упаковка) КАК Упаковка,
	|	МАКСИМУМ(ДанныеУчета.Цена) КАК Цена,
	|	ДанныеУчета.Склад КАК Склад,
	|	ДанныеУчета.НомерГТД КАК НомерГТД,
	|	&КодСтроки КАК КодСтроки
	|ИЗ
	|	ВтДанныеУчета КАК ДанныеУчета
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ПоступлениеТоваровОтХранителя.Товары КАК Таблица
	|		ПО (&МетодСоединения)
	|ГДЕ
	|	&Отбор
	|
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&КодСтроки", ?(ИспользоватьКодСтроки, "ДанныеУчета.КодСтроки", "0"));
...
Процедура ЗаполнитьСерииПоОтчетамПереработчика(ТаблицаТоваров, МенеджерВременныхТаблиц, Регистратор)
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ИзделияОтчета.АналитикаУчетаНоменклатуры КАК АналитикаУчетаНоменклатуры
	|ПОМЕСТИТЬ ВтИзделияОтчета
	|ИЗ
	|	Документ.ОтчетПереработчика2_5.ВыходныеИзделия КАК ИзделияОтчета
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВтДанныеУчета КАК ДанныеУчета
	|	ПО ИзделияОтчета.ЗаказПереработчику = ДанныеУчета.Распоряжение
	|	И ИзделияОтчета.КодСтроки = ДанныеУчета.КодСтроки
	|
	|ГДЕ
	|	НЕ ИзделияОтчета.Серия = ЗНАЧЕНИЕ(Справочник.СерииНоменклатуры.ПустаяСсылка)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	|	ИзделияОтчета.АналитикаУчетаНоменклатуры КАК АналитикаУчетаНоменклатуры
	|ИЗ
	|	Документ.ОтчетПереработчика2_5.ПобочныеИзделия КАК ИзделияОтчета
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВтДанныеУчета КАК ДанныеУчета
	|	ПО ИзделияОтчета.ЗаказПереработчику = ДанныеУчета.Распоряжение
	|	И ИзделияОтчета.КодСтроки = ДанныеУчета.КодСтроки
	...
	|				(ВЫБРАТЬ
	|					ВтИзделияОтчета.АналитикаУчетаНоменклатуры
	|				ИЗ
	|					ВтИзделияОтчета КАК ВтИзделияОтчета)) КАК ТоварыОрганизацийОстатки
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
	|	
	// Увеличим остаток товаров на количество в расходных движениях текущего поступления
	|	ВЫБРАТЬ
	|		ТоварыОрганизацийОстатки.АналитикаУчетаНоменклатуры.Номенклатура   КАК Номенклатура,
	|		ТоварыОрганизацийОстатки.АналитикаУчетаНоменклатуры.Характеристика КАК Характеристика,
	|		ТоварыОрганизацийОстатки.АналитикаУчетаНоменклатуры.Назначение     КАК Назначение,
	...
	|		И (ТоварыОрганизацийОстатки.АналитикаУчетаНоменклатуры) В
	|			(ВЫБРАТЬ
	|				ВтИзделияОтчета.АналитикаУчетаНоменклатуры
	|			ИЗ
	|				ВтИзделияОтчета КАК ВтИзделияОтчета)
	...
	Для Каждого СтрокаТоваров Из ТаблицаТоваров Цикл
		...
		КоличествоИзделий = СтрокаТоваров.КОформлению;
		...
		Для Каждого СтрокаСерий Из ТаблицаСерий.НайтиСтроки(Отбор) Цикл
			...
			НоваяСтрока.КОформлению = Количество;
			НоваяСтрока.Количество  = Количество;
			
			СтрокаСерий.Количество    = СтрокаСерий.Количество - НоваяСтрока.Количество;
			СтрокаТоваров.КОформлению = СтрокаТоваров.КОформлению - НоваяСтрока.КОформлению;
			СтрокаТоваров.Количество  = СтрокаТоваров.Количество - НоваяСтрока.Количество;
			КоличествоИзделий         = КоличествоИзделий - НоваяСтрока.КОформлению;
	...
	ОтборСтрок = Новый Структура("КОформлению", 0);
	Для Каждого СтрокаТаблицы Из ТаблицаТоваров.НайтиСтроки(ОтборСтрок) Цикл
...
Функция ЗаголовокФормыСозданияАкта() Экспорт
	...
	Возврат НСтр("ru = 'Акт о расхождениях после поступления товаров от хранителя (создание)';
				|en = 'Discrepancy report following the VMI return (create)'");
...
Функция ЗаголовокФормыАкта() Экспорт
	...
	Возврат НСтр("ru = 'Акт о расхождениях после поступления товаров от хранителя';
				|en = 'Discrepancy report following VMI return'");
...
Функция ПодсказкаСоглашенияАкта() Экспорт
	...
	Возврат НСтр("ru = 'Соглашение, по которому был передан товар.';
				|en = 'Agreement under which the goods have been transferred.'");
...
Функция ЗаголовокПоОснованиям(ДополнитьПартнером = Истина) Экспорт
	...
	Если ДополнитьПартнером Тогда
		Возврат НСтр("ru = 'По поступлениям от хранителя';
					|en = 'By receipts from the custodian'");
	Иначе
...
Функция КомментарийПоставщикаПодвал() Экспорт
	...
	Возврат НСтр("ru = 'Комментарии хранителя по расхождениям в строке';
				|en = 'Custodian comments to line discrepancies'");
...
Функция ОбработчикДействий(ХозяйственнаяОперация = Неопределено) Экспорт
	...
	//++ НЕ УТ
	ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПоступлениеОтПереработчика2_5 Тогда
		Обработчик = ПоступлениеОтПереработчика;
	ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВозвратОтПереработчика2_5 Тогда
		Обработчик = ВозвратОтПереработчика;
	//-- НЕ УТ
	Иначе
...
Функция ОбработчикДействийПоТипуОснованияАкта(ТипОснования) Экспорт
	...
	//++ НЕ УТ
	ИначеЕсли ТипОснования = ПоступлениеОтПереработчика.ТипОснованияАкта() Тогда
		ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПоступлениеОтПереработчика2_5;
	ИначеЕсли ТипОснования = ВозвратОтПереработчика.ТипОснованияАкта() Тогда
