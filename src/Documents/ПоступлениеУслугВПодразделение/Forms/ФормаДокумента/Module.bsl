...
Процедура ПоказатьНоменклатуруПоставщика(Команда)
	...
	НоменклатураПартнеровКлиент.ПоказатьНоменклатуруПартнера(Объект.Партнер, Объект.Ссылка, Элементы.Услуги.ТекущиеДанные, НСтр("ru = 'Поставщик';
																																|en = 'Vendor'"),"Услуги");
...
Процедура РазбитьСтрокуФакт(Команда)
	...
	ПараметрыРазбиенияСтроки.Заголовок = НСтр("ru = 'Введите количество услуг в новой строке';
												|en = 'Enter the number of services in a new line'");
...
Процедура ЗагрузитьИзВнешнегоФайла(Команда)
	...
	ПараметрыЗагрузки.Заголовок = НСтр("ru = 'Загрузка услуг и работ из внешних файлов';
										|en = 'Import services and works from external files'");
	...
	Если ВыбранноеЗначение <> Неопределено Тогда
		...
		Если Объект.Услуги.Количество() > 0 Тогда
			ТекстВопроса = НСтр("ru = 'Строки в списке Услуги будут перезаполнены по выбранному распоряжению. Продолжить?';
								|en = 'Lines in the Services list will be refilled according to the selected reference. Continue?'");
...
Процедура УстановитьУсловноеОформлениеДляСтатейИАналитик()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = '<для услуг и работ без назначения>';
																|en = '<for services and works without assignment>'"));
...
Процедура ПоказатьПредставлениеРаспоряжения()
	...
	Иначе
		РаспоряжениеПредставление = СтроковыеФункции.ФорматированнаяСтрока("‹%1›  <a href='ВыбратьРаспоряжение'>%2</a>",НСтр("ru = 'не выбрано';
																															|en = 'not selected'"),НСтр("ru = 'Выбрать';
																																						|en = 'Select'")); 
	КонецЕсли;
