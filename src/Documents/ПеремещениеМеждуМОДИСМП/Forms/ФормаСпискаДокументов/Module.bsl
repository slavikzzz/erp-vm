...
Процедура КОформлениюОрганизацииНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	ОбщегоНазначенияИСМПКлиент.ОткрытьФормуВыбораОрганизаций(ЭтотОбъект, "КОформлению");
...
Процедура Архивировать(Команда)
	...
	ИнтеграцияИСКлиент.АрхивироватьРаспоряжения(ЭтотОбъект, Элементы.СписокКОформлению, ИнтеграцияИСМПКлиент,
		ПредопределенноеЗначение("Документ.ПеремещениеМеждуМОДИСМП.ПустаяСсылка"));
...
&НаКлиенте
Процедура ЗапроситьРазрешениеНаОтгрузку(Команда)
	
	ОбменДаннымиИСМПКлиент.ПодготовитьСообщенияКПередаче(
		Элементы.Список,
		ПредопределенноеЗначение("Перечисление.ДальнейшиеДействияПоВзаимодействиюИСМП.ЗапроситеРазрешениеНаОтгрузкуПродукции"));
...
Процедура ОформитьПеремещение(Команда)
	...
	ОбменДаннымиИСМПКлиент.ПодготовитьСообщенияКПередаче(
		Элементы.Список, ПредопределенноеЗначение("Перечисление.ДальнейшиеДействияПоВзаимодействиюИСМП.ОформитеПеремещение"));
	
КонецПроцедуры

&НаКлиенте
Процедура ОтменитьРазрешениеНаОтгрузку(Команда)
	
	ОбменДаннымиИСМПКлиент.ПодготовитьСообщенияКПередаче(
		Элементы.Список, ПредопределенноеЗначение("Перечисление.ДальнейшиеДействияПоВзаимодействиюИСМП.ОтменитеРазрешениеНаОтгрузкуПродукции"));
...
Процедура УстановитьУсловноеОформление()
	...
	СписокСтатусов.ЗагрузитьЗначения(Документы.ПеремещениеМеждуМОДИСМП.СтатусыОшибок());
	...
	СписокДействий.ЗагрузитьЗначения(Документы.ПеремещениеМеждуМОДИСМП.ВсеТребующиеОжидания()); 
...
Функция ВсеТребующиеДействия()
	...
	Возврат Документы.ПеремещениеМеждуМОДИСМП.ВсеТребующиеДействия();
...
Функция ВсеТребующиеОжидания()
	...
	Возврат Документы.ПеремещениеМеждуМОДИСМП.ВсеТребующиеОжидания();
...
Процедура НастроитьВидимостьДоступностьЭлементовСервер()
	...
	Если НЕ ПравоДоступа("Добавление", Метаданные.Документы.ПеремещениеМеждуМОДИСМП) Тогда
