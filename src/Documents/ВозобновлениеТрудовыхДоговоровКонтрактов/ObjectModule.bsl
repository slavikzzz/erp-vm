...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Для Каждого СтрокаСотрудника Из Сотрудники Цикл
		...
		ЗарплатаКадры.ПроверитьКорректностьДаты(
			Ссылка, СтрокаСотрудника.ДатаВозобновления, ПутьКДате, Отказ, НСтр("ru = 'дата возобновления';
																				|en = 'renewal date'"), '20220901');
				...
				Если ДанныеСотрудника[0].ТрудовойДоговорПриостановлен <> Истина Тогда
					ТекстСообщения = СтрШаблон(
						НСтр("ru = 'Трудовой договор с сотрудником %1 не был приостановлен документом %2';
							|en = 'Employment contract with employee %1 is not terminated by the %2 document'"),
