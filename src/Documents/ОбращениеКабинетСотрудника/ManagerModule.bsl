...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Данные.ШаблонДокумента) Тогда
		Представление = СтрШаблон("%1 %2 %3 %4", Строка(Данные.ШаблонДокумента), Данные.Номер, НСтр("ru = 'от';
																									|en = 'от'"), Данные.Дата);
	Иначе
		Шаблон = НСтр("ru = 'Обращение сотрудника %1 от %2';
						|en = 'Обращение сотрудника %1 от %2'");
...
Функция ОписаниеДокументаДляЗаявки(СписокОбщихПолей) Экспорт
	...
	СтрокаСвойств = "ШаблонДокумента,РеквизитыОбращения";
...
Функция СодержаниеЗадачи(ДокументОбъект) Экспорт
	...
	ШаблонНаименования = НСтр("ru = 'Обработать обращение сотрудника';
								|en = 'Обработать обращение сотрудника'");
