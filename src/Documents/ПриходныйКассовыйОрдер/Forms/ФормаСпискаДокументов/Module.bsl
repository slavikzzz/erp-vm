...
Процедура СоздатьВозвратДенежныхСредствОтАрендодателя(Команда)
	...
	//++ НЕ УТ
	СоздатьПриходныйКассовыйОрдер(ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ВозвратДенежныхСредствОтАрендодателя"));
	//-- НЕ УТ
	Возврат;
...
Процедура УправлениеЭлементамиФормы()
	...
	//++ НЕ УТ
	Элементы.ПриходныеКассовыеОрдераСоздатьПогашениеЗаймаСотрудником.Видимость = Не ПолучитьФункциональнуюОпцию("ИспользоватьНачислениеЗарплаты");
	Элементы.ПриходныеКассовыеОрдераСоздатьВозвратДенежныхСредствОтАрендодателя.Видимость = Истина;
	//-- НЕ УТ

	//++ Локализация

	//++ НЕ УТ
	Элементы.ПриходныеКассовыеОрдераСоздатьПогашениеЗаймаСотрудником.Видимость = Не ПолучитьФункциональнуюОпцию("ИспользоватьНачислениеЗарплаты") Или
