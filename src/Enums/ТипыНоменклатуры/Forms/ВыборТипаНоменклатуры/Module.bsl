...
Функция ИмяЭлементаОсобенностьУчетаПоЗначениюПеречисления(ЗначениеПеречисления)
	...
	ИначеЕсли ЗначениеПеречисления = Перечисления.ОсобенностиУчетаНоменклатуры.ЛегкаяПромышленность2025 Тогда
		Возврат "ОсобенностьУчетаЛегкаяПромышленность2025";
	...
	ИначеЕсли ЗначениеПеречисления = Перечисления.ОсобенностиУчетаНоменклатуры.ДезинфицирующиеСредства Тогда
		Возврат "ОсобенностьУчетаДезинфицирующиеСредства";
	ИначеЕсли ЗначениеПеречисления = Перечисления.ОсобенностиУчетаНоменклатуры.БАДы Тогда
		Возврат "ОсобенностьУчетаБАДы";
	ИначеЕсли ЗначениеПеречисления = Перечисления.ОсобенностиУчетаНоменклатуры.БАДы2025 Тогда
		Возврат "ОсобенностьУчетаБАДы2025";
	...
	ИначеЕсли ЗначениеПеречисления = Перечисления.ОсобенностиУчетаНоменклатуры.КормаДляЖивотныхВлажныеБезВЕТИС Тогда
		Возврат "ОсобенностьУчетаКормаДляЖивотныхВлажныеБезВЕТИС";
	ИначеЕсли ЗначениеПеречисления = Перечисления.ОсобенностиУчетаНоменклатуры.КормаДляЖивотныхВлажныеПодконтрольныеВЕТИС Тогда
		Возврат "ОсобенностьУчетаКормаДляЖивотныхВлажныеПодконтрольныеВЕТИС";
	...
	ИначеЕсли ЗначениеПеречисления = Перечисления.ОсобенностиУчетаНоменклатуры.ПечатныеПлаты Тогда
		Возврат "ОсобенностьУчетаПечатныеПлаты";
	...
	ИначеЕсли ЗначениеПеречисления = Перечисления.ОсобенностиУчетаНоменклатуры.МедицинскиеИзделия20 Тогда
		Возврат "ОсобенностьУчетаМедицинскиеИзделия20";
	ИначеЕсли ЗначениеПеречисления = Перечисления.ОсобенностиУчетаНоменклатуры.ПолимерныеТрубы Тогда
		Возврат "ОсобенностьУчетаПолимерныеТрубы";
	ИначеЕсли ЗначениеПеречисления = Перечисления.ОсобенностиУчетаНоменклатуры.СладостиИКондитерскиеИзделия Тогда
		Возврат "ОсобенностьУчетаСладостиИКондитерскиеИзделия";
	Иначе
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Не определен элемент формы для %1';
										|en = 'No form item is defined for %1'"), ЗначениеПеречисления);
	КонецЕсли;
...
Функция ЭлементТипНоменклатурыПоСуффиксу(Суффикс)
	...
	Иначе
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Не определены элемент формы для типа номенклатуры %1';
										|en = 'No form item defined for item type %1'"), Суффикс);
	КонецЕсли;
