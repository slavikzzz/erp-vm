...
Процедура ПоказатьПериод(Форма)
	...
	ФормаУтратилаСилу = ГодПериода >= 2025;
	...
	Иначе
		...
		Форма.ОписаниеНормативДок = ?(ФормаУтратилаСилу, НСтр(
			"ru='Утратила силу. Основание: приказ ФНС России от 15.11.2024 № ЕД-7-3/1033@. С отчетности за Январь 2025 г."
			+ " применяется новая форма ""Сведения о выданных разрешениях на добычу объектов животного мира""'"),
