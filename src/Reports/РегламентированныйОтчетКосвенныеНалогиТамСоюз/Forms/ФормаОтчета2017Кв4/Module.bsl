...
Процедура СформироватьСпискиВыбора()
	...
	Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20230701' Тогда
		ИмяСекции_КБК_Раздел2 = "КБК_Раздел2_20230701";
	ИначеЕсли СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20220101' Тогда
		ИмяСекции_КБК_Раздел2 = "КБК_Раздел2_20220101";
	ИначеЕсли СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20200401' Тогда
		ИмяСекции_КБК_Раздел2 = "КБК_Раздел2_20200401";
	ИначеЕсли СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20200101' Тогда
		ИмяСекции_КБК_Раздел2 = "КБК_Раздел2_20200101";
	...
	Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20230701' Тогда
		ИмяСекции_КодыВидаПТ_Раздел2 = "КодыВидаПТ_Раздел2_20230701";
	ИначеЕсли СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20200401' Тогда
		ИмяСекции_КодыВидаПТ_Раздел2 = "КодыВидаПТ_Раздел2_20200401";
	ИначеЕсли СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20200101' Тогда
		ИмяСекции_КодыВидаПТ_Раздел2 = "КодыВидаПТ_Раздел2_20200101";
	ИначеЕсли СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20190101' Тогда
	...
	//
	Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20230701' Тогда
		ИмяСекции_КБК_Раздел3 = "КБК_Раздел3_20230701";
	ИначеЕсли СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20220101' Тогда
		ИмяСекции_КБК_Раздел3 = "КБК_Раздел3_20220101";
	Иначе
	...
	Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20230701' Тогда
		ИмяСекции_КодыВидаПП_Раздел3 = "КодыВидаПП_Раздел3_20230701";
	ИначеЕсли СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20200101' Тогда
		ИмяСекции_КодыВидаПП_Раздел3 = "КодыВидаПП_Раздел3_20200101";
	Иначе
		ИмяСекции_КодыВидаПП_Раздел3 = "КодыВидаПП_Раздел3";
	КонецЕсли;
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П00003М300002", 3, ,
	"Выбор кода вида подакцизной продукции", КоллекцияСписковВыбора[ИмяСекции_КодыВидаПП_Раздел3]);
...
Функция ПрефиксСекцииСПодгруппамиКодовВидаПТ(Форма, ИмяРаздела)
	...
	Если ИмяРаздела = "Раздел2" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20230701' Тогда
			Возврат "КБК_Р2_20230701_";
		ИначеЕсли Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20200401' Тогда
			Возврат "КБК_Р2_20200401_";
		ИначеЕсли Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20200101' Тогда
			Возврат "КБК_Р2_20200101_";
		ИначеЕсли Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20190101' Тогда
...
Функция ДополнительныйТекстПриДобавленииУдаленииСтрок(Знач ИмяГруппы)
	...
	ИначеЕсли ИмяГруппы = СтруктураРеквизитовФормы.мИдГруппы2М3 Тогда
		...
		ТекстВопроса = НСтр("ru = 'Удалить выбранный вид подакцизного товара?';
							|en = 'Удалить выбранный вид подакцизного товара?'");
	ИначеЕсли ИмяГруппы = СтруктураРеквизитовФормы.мИдГруппы3М3 Тогда
		...
		ТекстВопроса = НСтр("ru = 'Удалить выбранный вид спирта?';
							|en = 'Удалить выбранный вид спирта?'");
	ИначеЕсли ИмяГруппы = СтруктураРеквизитовФормы.мИдГруппы3М4 Тогда
		...
		ТекстВопроса = НСтр("ru = 'Удалить выбранные строки 050-060?';
							|en = 'Удалить выбранные строки 050-060?'");
	Иначе
		Возврат Неопределено;
	КонецЕсли;
...
Процедура ПроверитьКС_1_01(СтруктураРезультата)
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога, исчисленная к уплате в бюджет (строка 030 Раздела 1) должна быть равна сумме значений ';
			|en = 'Сумма налога, исчисленная к уплате в бюджет (строка 030 Раздела 1) должна быть равна сумме значений '") +
		НСтр("ru = 'по строкам 031, 032, 033, 034, 035 Раздела 1';
			|en = 'по строкам 031, 032, 033, 034, 035 Раздела 1'"));
	...
	Заголовки.Вставить("ШаблонОшибки"		, НСтр("ru = 'Возможно, занижена сумма налога, подлежащая уплате в бюджет';
													|en = 'Возможно, занижена сумма налога, подлежащая уплате в бюджет'"));
	...
	Настройки.Нарушения.Добавить(НСтр("ru = 'Ст. 72 Договора о Евразийском экономическом союзе';
										|en = 'Ст. 72 Договора о Евразийском экономическом союзе'"));
...
Процедура ПроверитьКС_1_02(СтруктураРезультата)
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога, исчисленная к уплате в бюджет (строка 030 Раздела 1) должна быть равна сумме строк ';
			|en = 'Сумма налога, исчисленная к уплате в бюджет (строка 030 Раздела 1) должна быть равна сумме строк '") +
		НСтр("ru = '""Итого"" графы 20 Заявлений о ввозе товаров';
			|en = '""Итого"" графы 20 Заявлений о ввозе товаров'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1';
													|en = 'Страница %1'"));
...
Процедура ПроверитьКС_1_03(СтруктураРезультата)
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма акциза, исчисленная к уплате в бюджет (сумма строк 030 Раздела 2 и Раздела 3) должна быть ';
			|en = 'Сумма акциза, исчисленная к уплате в бюджет (сумма строк 030 Раздела 2 и Раздела 3) должна быть '") +
		НСтр("ru = 'равна сумме строк ""Итого"" графы 19 Заявлений о ввозе товаров';
			|en = 'равна сумме строк ""Итого"" графы 19 Заявлений о ввозе товаров'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1';
													|en = 'Страница %1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ШаблонОшибки"		, 
		НСтр("ru = 'Возможно, занижена сумма налога (акциза), подлежащая уплате в бюджет';
			|en = 'Возможно, занижена сумма налога (акциза), подлежащая уплате в бюджет'"));
	Настройки = ОбработатьНастройки(		, Заголовки, СтруктураРезультата);
	Настройки.Нарушения.Добавить(НСтр("ru = 'Ст. 72 Договора о Евразийском экономическом союзе';
										|en = 'Ст. 72 Договора о Евразийском экономическом союзе'"));
	Настройки.Нарушения.Добавить(НСтр("ru = 'Арифметическая ошибка';
...
Процедура ПроверитьКС_1_04(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка КС 1.4';
													|en = 'Проверка КС 1.4'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога (строка 030 Раздела 1) >= 0';
														|en = 'Сумма налога (строка 030 Раздела 1) >= 0'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1';
													|en = 'Страница %1'"));
	...
	РасшифроватьПоказатели(Показатели, Настройки, "Раздел1", 1);
	Настройки.ЭтоОшибка = Показатели.Р1С030.Значение < 0;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р1С030.Значение);
	ДобавитьЭлементВСтруктуруОшибок(Настройки);
...
Процедура ПроверитьКС_1_05(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка КС 1.5';
													|en = 'Проверка КС 1.5'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога (строка 031 Раздела 1) >= 0';
														|en = 'Сумма налога (строка 031 Раздела 1) >= 0'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1';
													|en = 'Страница %1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	...
	Раздел1 = мДанныеОтчета.Раздел1.Строки[0].Данные;
	Показатели = ЗаполнитьПоказатели("Р1С031", Раздел1);
	ЗарегистрироватьФормулу(Настройки);
	
	РасшифроватьПоказатели(Показатели, Настройки, "Раздел1", 1);
	Настройки.ЭтоОшибка = Показатели.Р1С031.Значение < 0;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р1С031.Значение);
	ДобавитьЭлементВСтруктуруОшибок(Настройки);
...
Процедура ПроверитьКС_1_06(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка КС 1.6';
													|en = 'Проверка КС 1.6'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога (строка 032 Раздела 1) >= 0';
														|en = 'Сумма налога (строка 032 Раздела 1) >= 0'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1';
													|en = 'Страница %1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	...
	Раздел1 = мДанныеОтчета.Раздел1.Строки[0].Данные;
	Показатели = ЗаполнитьПоказатели("Р1С032", Раздел1);
	ЗарегистрироватьФормулу(Настройки);
	
	РасшифроватьПоказатели(Показатели, Настройки, "Раздел1", 1);
	Настройки.ЭтоОшибка = Показатели.Р1С032.Значение < 0;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р1С032.Значение);
	ДобавитьЭлементВСтруктуруОшибок(Настройки);
...
Процедура ПроверитьКС_1_07(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка КС 1.7';
													|en = 'Проверка КС 1.7'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога (строка 033 Раздела 1) >= 0';
														|en = 'Сумма налога (строка 033 Раздела 1) >= 0'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1';
													|en = 'Страница %1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	...
	Раздел1 = мДанныеОтчета.Раздел1.Строки[0].Данные;
	Показатели = ЗаполнитьПоказатели("Р1С033", Раздел1);
	ЗарегистрироватьФормулу(Настройки);
	
	РасшифроватьПоказатели(Показатели, Настройки, "Раздел1", 1);
	Настройки.ЭтоОшибка = Показатели.Р1С033.Значение < 0;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р1С033.Значение);
	ДобавитьЭлементВСтруктуруОшибок(Настройки);
...
Процедура ПроверитьКС_1_08(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка КС 1.8';
													|en = 'Проверка КС 1.8'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога (строка 034 Раздела 1) >= 0';
														|en = 'Сумма налога (строка 034 Раздела 1) >= 0'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1';
													|en = 'Страница %1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	...
	Раздел1 = мДанныеОтчета.Раздел1.Строки[0].Данные;
	Показатели = ЗаполнитьПоказатели("Р1С034", Раздел1);
	ЗарегистрироватьФормулу(Настройки);
	
	РасшифроватьПоказатели(Показатели, Настройки, "Раздел1", 1);
	Настройки.ЭтоОшибка = Показатели.Р1С034.Значение < 0;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р1С034.Значение);
	ДобавитьЭлементВСтруктуруОшибок(Настройки);
...
Процедура ПроверитьКС_1_09(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка КС 1.9';
													|en = 'Проверка КС 1.9'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога (строка 035 Раздела 1) >= 0';
														|en = 'Сумма налога (строка 035 Раздела 1) >= 0'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1';
													|en = 'Страница %1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	...
	Раздел1 = мДанныеОтчета.Раздел1.Строки[0].Данные;
	Показатели = ЗаполнитьПоказатели("Р1С035", Раздел1);
	ЗарегистрироватьФормулу(Настройки);
	
	РасшифроватьПоказатели(Показатели, Настройки, "Раздел1", 1);
	Настройки.ЭтоОшибка = Показатели.Р1С035.Значение < 0;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р1С035.Значение);
	ДобавитьЭлементВСтруктуруОшибок(Настройки);
...
Процедура ПроверитьКС_1_10(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка КС 1.10';
													|en = 'Проверка КС 1.10'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма акциза (строка 030 Раздела 2) >= 0';
														|en = 'Сумма акциза (строка 030 Раздела 2) >= 0'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1';
													|en = 'Страница %1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	...
	Для каждого СтрокаРаздела Из Раздел2 Цикл
		
		НомерСтроки = Раздел2.Индекс(СтрокаРаздела) + 1;
		Показатели = ЗаполнитьПоказатели("Р2С030", СтрокаРаздела.Данные, НомерСтроки);
		ЗарегистрироватьФормулу(Настройки);
		
		РасшифроватьПоказатели(Показатели, Настройки, "Раздел2", 1);
		Настройки.ЭтоОшибка = Показатели.Р2С030.Значение < 0;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
			Показатели.Р2С030.Значение);
		ДобавитьЭлементВСтруктуруОшибок(Настройки);
...
Процедура ПроверитьКС_1_11(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка КС 1.11';
													|en = 'Проверка КС 1.11'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма акциза (строка 030 Раздела 3) >= 0';
														|en = 'Сумма акциза (строка 030 Раздела 3) >= 0'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1';
													|en = 'Страница %1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	...
	Для каждого СтрокаРаздела Из Раздел3 Цикл
		
		НомерСтроки = Раздел3.Индекс(СтрокаРаздела) + 1;
		Показатели = ЗаполнитьПоказатели("Р3С030", СтрокаРаздела.Данные, НомерСтроки);
		ЗарегистрироватьФормулу(Настройки);
		
		РасшифроватьПоказатели(Показатели, Настройки, "Раздел3", 1);
		Настройки.ЭтоОшибка = Показатели.Р3С030.Значение < 0;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
			Показатели.Р3С030.Значение);
		ДобавитьЭлементВСтруктуруОшибок(Настройки);
	...
	Если УсловныйКодПоказателя = "Р1С030" Тогда
		...
		Результат.Вставить("Представление", 
			НСтр("ru = 'Сумма НДС, исчисленная к уплате в бюджет в рублях';
				|en = 'Сумма НДС, исчисленная к уплате в бюджет в рублях'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р1С031" Тогда
		...
		Результат.Вставить("Представление", 
			НСтр("ru = 'Сумма налога, исчисленная к уплате в бюджет в отношении приобретенных товаров в рублях';
				|en = 'Сумма налога, исчисленная к уплате в бюджет в отношении приобретенных товаров в рублях'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р1С032" Тогда
		...
		Результат.Вставить("Представление", 
			НСтр("ru = 'Сумма налога, исчисленная к уплате в бюджет в отношении продуктов переработки в рублях';
				|en = 'Сумма налога, исчисленная к уплате в бюджет в отношении продуктов переработки в рублях'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р1С033" Тогда
		...
		Результат.Вставить("Представление", 
			НСтр("ru = 'Сумма налога, исчисленная к уплате в бюджет в отношении товаров, являющихся результатом выполнения ';
				|en = 'Сумма налога, исчисленная к уплате в бюджет в отношении товаров, являющихся результатом выполнения '") +
	...
	ИначеЕсли УсловныйКодПоказателя = "Р1С034" Тогда
		...
		Результат.Вставить("Представление", 
			НСтр("ru = 'Сумма налога, исчисленная к уплате в бюджет в отношении товаров, полученных по договору (контракту) ';
				|en = 'Сумма налога, исчисленная к уплате в бюджет в отношении товаров, полученных по договору (контракту) '") +
			НСтр("ru = 'товарного кредита (товарного займа, займа в виде вещей), по товарообменному (бартерному) договору ';
				|en = 'товарного кредита (товарного займа, займа в виде вещей), по товарообменному (бартерному) договору '") +
			НСтр("ru = '(контракту) в рублях';
				|en = '(контракту) в рублях'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р1С035" Тогда
		...
		Результат.Вставить("Представление", 
			НСтр("ru = 'Сумма налога, исчисленная к уплате в бюджет в отношении товаров (предметов лизинга), ввозимых по ';
				|en = 'Сумма налога, исчисленная к уплате в бюджет в отношении товаров (предметов лизинга), ввозимых по '") +
			НСтр("ru = 'договору (контракту) лизинга в рублях';
				|en = 'договору (контракту) лизинга в рублях'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "ЗаявлениеАкциз" Тогда
		...
		Результат.Вставить("Представление", 
			НСтр("ru = 'Итоговая сумма акциза в рублях';
				|en = 'Итоговая сумма акциза в рублях'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "ЗаявлениеНДС" Тогда
		...
		Результат.Вставить("Представление", 
			НСтр("ru = 'Итоговая сумма НДС в рублях';
				|en = 'Итоговая сумма НДС в рублях'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "ЗаявлениеДатаКорректировки" Тогда
		...
		Результат.Вставить("Представление", 
			НСтр("ru = 'Дата корректируемого первичного документа';
				|en = 'Дата корректируемого первичного документа'"));
