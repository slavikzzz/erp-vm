...
Функция ТекстЗапроса()
	...
	|		ТОГДА ВЫБОР КОГДА СУММА(Расчеты.ПлановаяОплата) > 0 ИЛИ СУММА(Расчеты.ПлановаяПоставка) > 0
	|				// Для заказов в первую очередь проверяем плановую оплату
	|				ТОГДА ВЫБОР КОГДА СУММА(Расчеты.ПлановаяОплата) = 0 
	|						ТОГДА ВЫБОР КОГДА СУММА(Расчеты.ПлановаяПоставка) > СУММА(Расчеты.Зачтено) И СУММА(Расчеты.ПлановаяПоставка) > 0
	...
	|					КОНЕЦ
	|				КОНЕЦ
	|			ИНАЧЕ ВЫБОР КОГДА СУММА(Расчеты.Зачтено)+СУММА(Расчеты.ПлановаяПоставка) = 0 
