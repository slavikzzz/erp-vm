...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "11/04/2014";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Для Гр = 4 По 16 Цикл
		...
		Области["П02120" + ГрСтр].Значение = Области["П02121" + ГрСтр].Значение + Области["П02122" + ГрСтр].Значение
											+ Области["П02123" + ГрСтр].Значение + Области["П02124" + ГрСтр].Значение;
	КонецЦикла;
	...
	Для Гр = 4 По 16 Цикл
		ГрСтр = Формат(Гр, "ЧЦ=2; ЧВН=; ЧГ=");
		Области["П02320" + ГрСтр].Значение = Области["П02321" + ГрСтр].Значение + Области["П02322" + ГрСтр].Значение
											+ Области["П02323" + ГрСтр].Значение + Области["П02324" + ГрСтр].Значение;
	КонецЦикла;
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	Нарушение = "Приказ Росстата от 18.09.2013 № 374";
	
	СоответствиеБР = Новый Соответствие;
	СоответствиеБР["1"] = "П02116П02117";
	СоответствиеБР["2"] = "П02116П02118";
	СоответствиеБР["3"] = "П02208П02209";
	СоответствиеБР["4"] = "П02208П02210";
	СоответствиеБР["5"] = "П02205П02219";
	СоответствиеБР["6"] = "П02219П02220";
	СоответствиеБР["7"] = "П02221П02222";
	СоответствиеБР["8"] = "П02221П02223";
	СоответствиеБР["9"] = "П02316П02317";
	СоответствиеБР["10"] = "П02316П02318";
	...
	СоответствиеБР = Новый Соответствие;
	СоответствиеБР["1"] = "П02301П02315";
	СоответствиеБР["2"] = "П02309П02315";
	...
	Для Каждого КЗ Из СоответствиеБР Цикл 
		Для Гр = 3 По 16 Цикл 
			...
			Если Показатели.Свойство(ЛевЧасть) И Показатели.Свойство(ПравЧасть)
				И (Показатели[ЛевЧасть] > 0 Или Показатели[ЛевЧасть] > 0) Тогда 
