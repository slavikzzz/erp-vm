...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Объект.ВидУведомления = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.РаботаПоПатенту;
	...
	ПоказатьТекущуюСтраницу("Титульная_2023_РаботаПоПатенту", Неопределено);
КонецПроцедуры
...
Процедура СформироватьДеревоСтраниц() Экспорт
	...
	Стр001.ИмяМакета = "Титульная_2023_РаботаПоПатенту";
...
Процедура ЗаполнитьНачальныеДанные() Экспорт
	...
	Если РегламентированнаяОтчетностьПереопределяемый.ЭтоЮридическоеЛицо(Объект.Организация) Тогда
		СтрокаСведений = "ИННЮЛ,КППЮЛ,НаимЮЛПол,ПолныйАдрЮР,ТелОрганизации,ОКВЭД,ОГРН,ОКТМО";
		...
		ДанныеУведомленияТитульный.Работодатель = СведенияОбОрганизации.НаимЮЛПол + ", " 
			+ СведенияОбОрганизации.ПолныйАдрЮР + ", " + СведенияОбОрганизации.ИННЮЛ + ", "
			+ СведенияОбОрганизации.КППЮЛ + ", " + СведенияОбОрганизации.ОГРН + ", " + СведенияОбОрганизации.ОКТМО;
		ДанныеУведомленияТитульный.ТелефонРаботодатель = СведенияОбОрганизации.ТелОрганизации;
	Иначе 
		...
		ДанныеУведомленияТитульный.ТелефонРаботодатель = СведенияОбОрганизации.ТелДом;
	КонецЕсли;
КонецПроцедуры
