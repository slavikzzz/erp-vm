...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.Новости") Тогда
		...
		МодульОбработкаНовостей.КонтекстныеНовости_ПриСозданииНаСервере(
			ЭтаФорма,
			"БП.Отчет.РО_АлкоПриложение34.ОсновнаяФорма",
			"Отчет.РегламентированныйОтчетАлкоПриложение34",
			,
			НСтр("ru = 'Новости: Декларация об объеме винограда, использованного для производства российской винодельческой продукции защищенных наименований и полного цикла производства дистиллятов (приложение № 1 ""б"")';
				|en = 'Новости: Декларация об объеме винограда, использованного для производства российской винодельческой продукции защищенных наименований и полного цикла производства дистиллятов (приложение № 1 ""б"")'"),
			Ложь,
