...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "20/09/2016";
	
	// Код отчета, равен коду по ОКУД
	СтруктураРеквизитовФормы.мКодОтчета   = "1601313";
...
Процедура ОчиститьТабличноеПолеНаСервере()
	...
	РасчетНаСервере(ПолеТабличногоДокументаФормаОтчета);
...
Процедура Расчет(ТабДок) 
	...
	Области.П010103.Значение = Области.П010203.Значение + Области.П010503.Значение;
	
	Области.П012703.Значение = Области.П012803.Значение + Области.П013103.Значение + Области.П013203.Значение + Области.П013303.Значение
	 + Области.П013403.Значение + Области.П013503.Значение + Области.П013603.Значение + Области.П013703.Значение + Области.П014003.Значение
	 + Области.П014103.Значение + Области.П014203.Значение + Области.П014303.Значение + Области.П014403.Значение + Области.П014503.Значение
	 + Области.П014603.Значение + Области.П014703.Значение + Области.П014803.Значение + Области.П014903.Значение + Области.П015003.Значение
	 + Области.П015203.Значение;
	 
	Области.П015403.Значение = Области.П011103.Значение + Области.П011203.Значение + Области.П011403.Значение + Области.П011703.Значение
	+ Области.П011803.Значение + Области.П011903.Значение + Области.П012003.Значение + Области.П012103.Значение + Области.П012603.Значение
	+ Области.П012703.Значение + Области.П015303.Значение - Области.П011503.Значение - Области.П011603.Значение;
...
Процедура ПолеТабличногоДокументаФормаОтчетаПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	РасчетНаКлиенте(ПолеТабличногоДокументаФормаОтчета);
...
Функция ПечатьНаСервере(ВидПечати)
	...
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма ТЗВ-МП");
