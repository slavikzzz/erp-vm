...
Процедура ПоказатьПериод()
	...
	Период = Формат(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, "ДФ = 'д ММММ гггг'");
	ПериодТитульный = Сред(Период,Найти(Период, " "));
	ПолеТабличногоДокументаФормаОтчета.Области.ПериодОтчета.Значение = "на конец" + ПериодТитульный + " г.";
