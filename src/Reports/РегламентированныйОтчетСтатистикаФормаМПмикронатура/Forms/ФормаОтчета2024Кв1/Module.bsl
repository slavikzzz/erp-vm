...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если СтрНачинаетсяС(Область.Имя, СтруктураРеквизитовФормы.мИдГруппы2) Тогда
	...
	Если СтрНайти(Область.Имя, СтруктураРеквизитовФормы.мИдГруппы2) > 0 Тогда
		...
		Если Сред(Область.Имя, 12, 2) = "01" Или Сред(Область.Имя, 12, 2) = "02" Тогда
			...
			Если ЗначениеЗаполнено(ВыборКод) Тогда
				Если (СтрНайти(Область.Имя, СтруктураРеквизитовФормы.мИдГруппы2) > 0
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Пока Истина Цикл
		...
		Обл = Области.Найти("П002000100217_" + Стр);
		...
		Для Гр = 5 По 16 Цикл
			...
			СуммаПоГр = СуммаПоГр + Области["П0020001002" + НомГр + "_" + Стр].Значение
		КонецЦикла;
		Области["П002000100217_" + Стр].Значение = СуммаПоГр;
	КонецЦикла;
...
Процедура ПеренумерацияСтрокТаблицы(ПолеТабличногоДокументаФормаОтчета)
	ПолеТабличногоДокументаФормаОтчета.Области["П002000100218_1"].Значение = "01";
КонецПроцедуры
