...
Функция НастройкиОтчетаКорректны()
	...
	Если Не Отчет.ВыводитьДокументы И Не Отчет.ВыводитьСправочники Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Не указан ни один из типов данных для вывода';
																|en = 'No data type for displaying is specified'"), ,"ВыводитьСправочники", "Отчет");
