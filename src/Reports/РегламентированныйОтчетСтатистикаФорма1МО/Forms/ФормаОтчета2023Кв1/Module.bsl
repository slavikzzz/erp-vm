...
Функция ПолучитьМассивКатегорий()
	...
	МногострочныеЧасти =
		"П0010010001;П0020010001;П0020020001;П0020030001;П0030010001;П0030020001;
		|П0040010001;П0040020001;П0040030001;П0050010001";
	...
	Для Каждого Стр Из КатегорииКлассификатора Цикл
		...
		Если Стр = "П0010010001" Тогда
			...
			Для Инд = 1 По 5 Цикл
				...
				Иначе
					ТипКолонки = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(10, 1));
				КонецЕсли;
			...
			мСтруктураКолвоКолонокРазделов.Вставить(ИмяДобавляемогоРеквизита, 5);
		...
		ИначеЕсли Стр = "П0020010001" Тогда
			...
			Для Инд = 1 По 12 Цикл
				Если Инд < 5 Тогда
					ТипКолонки = Новый ОписаниеТипов("Строка");
				Иначе
					ТипКолонки = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(8, 0));
				КонецЕсли;
			...
			мСтруктураМногострочныхРазделов.Вставить(ИмяДобавляемогоРеквизита, ИмяДобавляемогоРеквизита);
			мСтруктураИсхКолвоСтрокРазделов.Вставить(ИмяДобавляемогоРеквизита, 1);
			мСтруктураКолвоКолонокРазделов.Вставить(ИмяДобавляемогоРеквизита, 12);
		...
		ИначеЕсли Стр = "П0020020001" Тогда
			...
			мСтруктураМногострочныхРазделов.Вставить(ИмяДобавляемогоРеквизита, ИмяДобавляемогоРеквизита);
			мСтруктураИсхКолвоСтрокРазделов.Вставить(ИмяДобавляемогоРеквизита, 1);
			мСтруктураКолвоКолонокРазделов.Вставить(ИмяДобавляемогоРеквизита, 13);
			СтруктураРеквизитовФормы.мСоответствияМнгЧ.Вставить(ИмяДобавляемогоРеквизита, "МногострочнаяЧасть3");
			
		ИначеЕсли Стр = "П0020030001" Тогда
		...
		ИначеЕсли Стр = "П0030020001" Тогда
			
			Для Инд = 1 По 13 Цикл
				Если Инд < 5 Тогда
					ТипКолонки = Новый ОписаниеТипов("Строка");
				ИначеЕсли Инд = 7 Тогда
					ТипКолонки = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(20, 2));
				Иначе
					ТипКолонки = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(8, 0));
				КонецЕсли;
			...
			ИзменитьРеквизиты(ДобавляемыеРеквизиты);
			СтруктураРеквизитовФормы.Вставить("мИдГруппы6", ИмяДобавляемогоРеквизита);
			мСтруктураМногострочныхРазделов.Вставить(ИмяДобавляемогоРеквизита, ИмяДобавляемогоРеквизита);
			мСтруктураИсхКолвоСтрокРазделов.Вставить(ИмяДобавляемогоРеквизита, 1);
			мСтруктураКолвоКолонокРазделов.Вставить(ИмяДобавляемогоРеквизита, 13);
			СтруктураРеквизитовФормы.мСоответствияМнгЧ.Вставить(ИмяДобавляемогоРеквизита, "МногострочнаяЧасть6");
		...
		ИначеЕсли Стр = "П0040010001" Тогда
			...
			Для Инд = 1 По 14 Цикл
				...
				ИначеЕсли Инд = 6 Тогда
					ТипКолонки = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(13, 4));
				ИначеЕсли Инд = 7 Тогда
					ТипКолонки = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(13, 4));
			...
			ИзменитьРеквизиты(ДобавляемыеРеквизиты);
			СтруктураРеквизитовФормы.Вставить("мИдГруппы7", ИмяДобавляемогоРеквизита);
			мСтруктураМногострочныхРазделов.Вставить(ИмяДобавляемогоРеквизита, ИмяДобавляемогоРеквизита);
			мСтруктураИсхКолвоСтрокРазделов.Вставить(ИмяДобавляемогоРеквизита, 1);
			мСтруктураКолвоКолонокРазделов.Вставить(ИмяДобавляемогоРеквизита, 14);
			СтруктураРеквизитовФормы.мСоответствияМнгЧ.Вставить(ИмяДобавляемогоРеквизита, "МногострочнаяЧасть7");
			
		ИначеЕсли Стр = "П0040020001" Тогда
			...
			ИзменитьРеквизиты(ДобавляемыеРеквизиты);
			СтруктураРеквизитовФормы.Вставить("мИдГруппы8", ИмяДобавляемогоРеквизита);
			мСтруктураМногострочныхРазделов.Вставить(ИмяДобавляемогоРеквизита, ИмяДобавляемогоРеквизита);
			мСтруктураИсхКолвоСтрокРазделов.Вставить(ИмяДобавляемогоРеквизита, 1);
			мСтруктураКолвоКолонокРазделов.Вставить(ИмяДобавляемогоРеквизита, 9);
			СтруктураРеквизитовФормы.мСоответствияМнгЧ.Вставить(ИмяДобавляемогоРеквизита, "МногострочнаяЧасть8");
			
			
		ИначеЕсли Стр = "П0040030001" Тогда
			...
			ИзменитьРеквизиты(ДобавляемыеРеквизиты);
			СтруктураРеквизитовФормы.Вставить("мИдГруппы9", ИмяДобавляемогоРеквизита);
			мСтруктураМногострочныхРазделов.Вставить(ИмяДобавляемогоРеквизита, ИмяДобавляемогоРеквизита);
			мСтруктураИсхКолвоСтрокРазделов.Вставить(ИмяДобавляемогоРеквизита, 1);
			мСтруктураКолвоКолонокРазделов.Вставить(ИмяДобавляемогоРеквизита, 10);
			СтруктураРеквизитовФормы.мСоответствияМнгЧ.Вставить(ИмяДобавляемогоРеквизита, "МногострочнаяЧасть9");
			
			
		ИначеЕсли Стр = "П0050010001" Тогда
			...
			ИзменитьРеквизиты(ДобавляемыеРеквизиты);
			СтруктураРеквизитовФормы.Вставить("мИдГруппы10", ИмяДобавляемогоРеквизита);
			мСтруктураМногострочныхРазделов.Вставить(ИмяДобавляемогоРеквизита, ИмяДобавляемогоРеквизита);
			мСтруктураИсхКолвоСтрокРазделов.Вставить(ИмяДобавляемогоРеквизита, 1);
			мСтруктураКолвоКолонокРазделов.Вставить(ИмяДобавляемогоРеквизита, 5);
			СтруктураРеквизитовФормы.мСоответствияМнгЧ.Вставить(ИмяДобавляемогоРеквизита, "МногострочнаяЧасть10");
...
Процедура ПоказатьПериод()
	...
	ПериодОтчета = НРег("по состоянию на 31 декабря " + Формат(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, "ДФ = 'гггг'") + " года");
...
Процедура ВставитьДополнительнуюСтроку(Форма, ТекущаяСтраница)
	...
	МассивГруппСинхронизацииРаздел2.Добавить("П0020030001");
	
	МассивГруппСинхронизацииРаздел3 = Новый Массив;
	МассивГруппСинхронизацииРаздел3.Добавить("П0030010001");
	МассивГруппСинхронизацииРаздел3.Добавить("П0030020001");
	
	МассивГруппСинхронизацииРаздел4 = Новый Массив;
	МассивГруппСинхронизацииРаздел4.Добавить("П0040010001");
	МассивГруппСинхронизацииРаздел4.Добавить("П0040020001");
	МассивГруппСинхронизацииРаздел4.Добавить("П0040030001");
	...
	ГруппаВМассиве = МассивГруппСинхронизацииРаздел3.Найти(ИмяГруппы);
	Если ГруппаВМассиве <> Неопределено Тогда
		МассивГруппСинхронизацииРаздел3.Удалить(ГруппаВМассиве);
		МассивГруппСинхронизации = МассивГруппСинхронизацииРаздел3;
	КонецЕсли;
	
	ГруппаВМассиве = МассивГруппСинхронизацииРаздел4.Найти(ИмяГруппы);
	Если ГруппаВМассиве <> Неопределено Тогда
		МассивГруппСинхронизацииРаздел4.Удалить(ГруппаВМассиве);
		МассивГруппСинхронизации = МассивГруппСинхронизацииРаздел4;
	КонецЕсли;
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Иначе
		...
		Если Область.Имя = "КодТипаОбразования" Тогда
			ОбластьКод     = Область;
			ИмяСправочника = "1000014489";
		ИначеЕсли Область.Имя = "КодОКТМО" Тогда
			ОбластьКод     = Область;
			ИмяСправочника = "1000017066";
		ИначеЕсли Сред(Область.Имя, 12 , 2) = "03" Тогда
			...
			//Синхронизация
			Если Сред(ОбластьКод.Имя, 4, 1) = "2"
			 Или Сред(ОбластьКод.Имя, 4, 1) = "3"
			 Или Сред(ОбластьКод.Имя, 4, 1) = "4" Тогда
				
				Если Лев(ОбластьКод.Имя, 4) = "П002" Или Лев(ОбластьКод.Имя, 4) = "П004" Тогда
					ГруппаКон = 3;
				ИначеЕсли Лев(ОбластьКод.Имя, 4) = "П003" Тогда
					ГруппаКон = 2;
				КонецЕсли;
				
				Для Н = 1 По ГруппаКон Цикл
					
					СинхОбластьКодИмя = Лев(ОбластьКод.Имя, 6) + Н + Сред(ОбластьКод.Имя, 8);
					
					Стр = 1;
					Пока Истина Цикл
						ОблИмяНП_Наим  = СтрЗаменить(СинхОбластьКодИмя, Сред(СинхОбластьКодИмя, 1, 11) + "03", Сред(СинхОбластьКодИмя, 1, 11) + "01") + "_" + Стр;
						ОблИмяНП_ОКТМО = СтрЗаменить(СинхОбластьКодИмя, Сред(СинхОбластьКодИмя, 1, 11) + "03", Сред(СинхОбластьКодИмя, 1, 11) + "04") + "_" + Стр;
						
						ОблНП_ОКТМО = ПолеТабличногоДокументаФормаОтчета.Области.Найти(ОблИмяНП_ОКТМО);
						Если ОблНП_ОКТМО = Неопределено Тогда
							Прервать;
						Иначе
							МассивОчистки.Добавить(ОблНП_ОКТМО);
							
							ОблНП_Наим = ПолеТабличногоДокументаФормаОтчета.Области.Найти(ОблИмяНП_Наим);
							МассивОчистки.Добавить(ОблНП_Наим);
						КонецЕсли;
						Стр = Стр + 1;
					КонецЦикла;
			...
			Иначе
				Стр = 1;
				Пока Истина Цикл
					ОблИмяНП_Наим  = СтрЗаменить(Область.Имя, Сред(Область.Имя, 1, 11) + "03", Сред(Область.Имя, 1, 11) + "01") + "_" + Стр;
					ОблИмяНП_ОКТМО = СтрЗаменить(Область.Имя, Сред(Область.Имя, 1, 11) + "03", Сред(Область.Имя, 1, 11) + "04") + "_" + Стр;
		...
		ИначеЕсли Сред(Область.Имя, 12 , 2) = "01"
			  Или Сред(Область.Имя, 12 , 2) = "04" Тогда
			
			ИмяСправочника = "1_MO_2_2024";
			
			ОбластьКод = ПолеТабличногоДокументаФормаОтчета.Области.Найти(СтрЗаменить(Область.Имя, Сред(Область.Имя, 1, 11) + "01_", Сред(Область.Имя, 1, 11) + "04_"));
			ОбластьНаим  = ПолеТабличногоДокументаФормаОтчета.Области.Найти(СтрЗаменить(Область.Имя, Сред(Область.Имя, 1, 11) + "04_", Сред(Область.Имя, 1, 11) + "01_"));
			
			ОблИмяМО_ОКТМО = Лев(Область.Имя, 11) + "03";
			Фильтр = ПолеТабличногоДокументаФормаОтчета.Области[ОблИмяМО_ОКТМО].Значение;
		...
		Если ПараметрВводаПоля <> Неопределено Тогда
			ВвестиПоказатель(Элемент, ОбластьКод, ОбластьНаим, ИмяСправочника, Фильтр, ПараметрВводаПоля.ТекстПриВыборе, , ,СтандартнаяОбработка, МассивОчистки);
		КонецЕсли;
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	//Раздел 2 Объекты бытового обслуживания
	//Многострочная часть
	Стр = 1;
	Пока Истина Цикл
		
		ПоказательИмяГрафа5 = "П002001000105_" + Стр;
		ОблГр5 = Области.Найти(ПоказательИмяГрафа5);
		Если ОблГр5 = Неопределено Тогда
			Прервать;
		КонецЕсли;
		
		//Графа 3 = сумме граф 4 – 15
		ОблГр5.Значение
			= Области["П002001000106_" + Стр].Значение
			+ Области["П002001000107_" + Стр].Значение
			+ Области["П002001000108_" + Стр].Значение
			+ Области["П002001000109_" + Стр].Значение
			+ Области["П002001000110_" + Стр].Значение
			+ Области["П002001000111_" + Стр].Значение
			+ Области["П002001000112_" + Стр].Значение
			+ Области["П002002000105_" + Стр].Значение
			+ Области["П002002000106_" + Стр].Значение
			+ Области["П002002000107_" + Стр].Значение
			+ Области["П002002000108_" + Стр].Значение
			+ Области["П002002000109_" + Стр].Значение;
		
		//Графа 16 = сумме граф 17 – 25
		Области["П002002000110_" + Стр].Значение
			= Области["П002002000111_" + Стр].Значение
			+ Области["П002002000112_" + Стр].Значение
			+ Области["П002002000113_" + Стр].Значение
			+ Области["П002003000105_" + Стр].Значение
			+ Области["П002003000106_" + Стр].Значение
			+ Области["П002003000107_" + Стр].Значение
			+ Области["П002003000108_" + Стр].Значение
			+ Области["П002003000109_" + Стр].Значение
			+ Области["П002003000110_" + Стр].Значение;
	...
	//Строка 1
	//Графа 3 = сумме граф 4 – 15
	Области["П002001000105"].Значение
		= Области["П002001000106"].Значение
		+ Области["П002001000107"].Значение
		+ Области["П002001000108"].Значение
		+ Области["П002001000109"].Значение
		+ Области["П002001000110"].Значение
		+ Области["П002001000111"].Значение
		+ Области["П002001000112"].Значение
		+ Области["П002002000105"].Значение
		+ Области["П002002000106"].Значение
		+ Области["П002002000107"].Значение
		+ Области["П002002000108"].Значение
		+ Области["П002002000109"].Значение;
	
	//Графа 16 = сумме граф 17 – 25
	Области["П002002000110"].Значение
		= Области["П002002000111"].Значение
		+ Области["П002002000112"].Значение
		+ Области["П002002000113"].Значение
		+ Области["П002003000105"].Значение
		+ Области["П002003000106"].Значение
		+ Области["П002003000107"].Значение
		+ Области["П002003000108"].Значение
		+ Области["П002003000109"].Значение
		+ Области["П002003000110"].Значение;
...
Процедура УстановитьЗащитуИЦветФонаОбластейАвторассчитываемыхПоказателей()
	...
	Пока Истина Цикл
		...
		ПоказательИмяГрафа5 = "П002001000105_" + Стр;
		ОблГр5 = мФормаОтчета.Области.Найти(ПоказательИмяГрафа5);
		Если ОблГр5 = Неопределено Тогда
			Прервать;
		КонецЕсли;
		
		мФормаОтчета.Области["П002001000105_" + Стр].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П002001000105_" + Стр].Защита   = Не ОтклАвтоРасчетЗначение;
		
		мФормаОтчета.Области["П002002000110_" + Стр].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П002002000110_" + Стр].Защита   = Не ОтклАвтоРасчетЗначение;
		
		Стр = Стр + 1;
		
	КонецЦикла;
	
	мФормаОтчета.Области["П002001000105"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П002001000105"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П002002000110"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П002002000110"].Защита   = Не ОтклАвтоРасчетЗначение;
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "1000014489",
		512, , "Выбор кода типа муниципального образования");
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "1000017066",
		512, , "Выбор кода ОКТМО муниципального образования");
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "1_MO_2_2024",
		512, , "Выбор кода ОКТМО населенного пункта");
	...
	Если Сред(ОбластьКод.Имя, 4, 1) = "2"
	 ...
	 Или Сред(ОбластьКод.Имя, 4, 1) = "4" Тогда
		...
		Для Н = 1 По ГруппаКон Цикл
			...
			Если ОбластьКод.Имя = СинхОбластьКодИмя Тогда
				Продолжить;
			КонецЕсли;
			
			Если ОбластьНаим = Неопределено Тогда
				ПолеТабличногоДокументаФормаОтчета.Области[СинхОбластьКодИмя].Значение = ОбластьКод.Значение;
			Иначе
				ПолеТабличногоДокументаФормаОтчета.Области[СинхОбластьКодИмя].Значение = ОбластьКод.Значение;
				
				СинхОбластьНаимИмя = Лев(ОбластьНаим.Имя, 6) + Н + Сред(ОбластьНаим.Имя, 8, 4) + "01" + Сред(ОбластьНаим.Имя, 14);
				ПолеТабличногоДокументаФормаОтчета.Области[СинхОбластьНаимИмя].Значение = ОбластьНаим.Значение;
			КонецЕсли;
