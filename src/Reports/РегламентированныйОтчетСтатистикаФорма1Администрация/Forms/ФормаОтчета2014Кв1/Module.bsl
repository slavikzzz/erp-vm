...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Для Стр = 1 По 13 Цикл 
		...
		Для Гр = 4 По 10 Цикл 
			Тотал = Тотал + Области["П00000100" + СтрСтр + Формат(Гр, "ЧЦ=2; ЧВН=; ЧГ=")].Значение;
		КонецЦикла;
		Области["П00000100" + СтрСтр + "03"].Значение = Тотал;
	КонецЦикла;
	
	Для Гр = 3 По 10 Цикл
		Области["П0000010014" + Формат(Гр, "ЧЦ=2; ЧВН=; ЧГ=")].Значение = Области["П0000010012" + Формат(Гр, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
																		- Области["П0000010013" + Формат(Гр, "ЧЦ=2; ЧВН=; ЧГ=")].Значение;
	КонецЦикла;
