...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли РегламентированнаяОтчетностьКлиент.ВыбраннаяОбластьРегламентированногоОтчетаНеВерна(ЭтаФорма, Область, СтандартнаяОбработка) Тогда
		Возврат;
	ИначеЕсли Сред(Область.Имя, 1, 1) = "П" Тогда
		
		ОбластьКод     = Неопределено;
		...
		Если Сред(Область.Имя, 12, 2) = "01" Или  Сред(Область.Имя, 12, 2) = "02" Тогда
			...
			Если Сред(Область.Имя, 4, 1) = "1" Тогда
				ИмяСправочника = "1000012838";
				МассивОчистки.Добавить(ПолеТабличногоДокументаФормаОтчета.Области[Сред(Область.Имя, 1, 11) + "05_" + НомСтр]);
			ИначеЕсли Сред(Область.Имя, 4, 1) = "2" Тогда
				ИмяСправочника = "1000013464";
		...
		ИначеЕсли СтрНайти(Область.Имя, "П001001000104_") = 1 Тогда
			ОбластьКод     = Область;
			ИмяСправочника = "1000013463";
		ИначеЕсли ((Сред(Область.Имя, 4, 1) = "1" И Сред(Область.Имя, 12, 2) = "05")
			  Или (Сред(Область.Имя, 4, 1) = "2" И Сред(Область.Имя, 12, 2) = "04")) Тогда
			
			ОбластьКод     = Область;
			ИмяСправочника = "l_priobr_reg_sx_okei";
			
			КодВидаТовараУслуги = СокрЛП(Строка(ПолеТабличногоДокументаФормаОтчета.Области[Сред(Область.Имя, 1, 11) + "03_" + НомСтр].Значение));
			Фильтр              = КодВидаТовараУслуги;
			
		ИначеЕсли СтрНайти(Область.Имя, "П001001000108_") = 1 Или СтрНайти(Область.Имя, "П002001000107_") = 1 Тогда
			ОбластьКод     = Область;
			ИмяСправочника = "1000013976";
		КонецЕсли;
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "1000013976",
		512, , "Выбор причины изменения цены");
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "1000013463",
		512, , "Выбор тип товара");
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "1000012838",
		512, , "Выбор кода ОКПД2");
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "1000013464",
		512, , "Выбор кода ОКПД2");
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "l_okpd2_priobr_reg_sx",
		512, , "Выбор кода вида товара");
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "l_priobr_reg_sx_okei",
...
Процедура ПеренумерацияСтрокТаблицы(ПолеТабличногоДокументаФормаОтчета)
	ПолеТабличногоДокументаФормаОтчета.Области["П001001000111_1"].Значение = "1";
	ПолеТабличногоДокументаФормаОтчета.Области["П002001000110_1"].Значение = "2";
КонецПроцедуры
