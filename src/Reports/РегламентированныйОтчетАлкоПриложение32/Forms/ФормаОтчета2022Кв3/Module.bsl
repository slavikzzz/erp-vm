...
Процедура ПриОткрытии(Отказ)
	...
	Элементы.ГруппаРуководитель.Видимость = ЭтоПБОЮЛ;	
...
&НаКлиенте
Процедура ЭлементТитульногоПриИзменении(Элемент)
	
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, Элемент.Имя, Элемент.Имя);
...
#Область ОбработчикиСобытийЭлементовШапкиФормыДекларации
...
Процедура УстановитьПараметрыДекларации() Экспорт
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "01/09/2022";
