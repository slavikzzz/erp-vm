...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мВерсияФормы = "05/12/2014";
...
Функция ПечатьНаСервере(ВидПечати)
	...
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2014Кв1_Титульный", "ОсновнаяЧасть", СтруктураДанныхТитульный);
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-инновация");
	
	Для Ном = 1 По 3 Цикл
		ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
		ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2014Кв1_Разделы1_3", "Раздел"+Ном, СтруктураДанныхРазделы1_3);
		СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-инновация");
	КонецЦикла;
	
	Для Ном = 1 По 2 Цикл
		ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
		ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2014Кв1_Разделы5_7", "Раздел5_"+Ном, СтруктураДанныхРазделы5_7);
		СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-инновация");
	КонецЦикла;
	
	Для Ном = 6 По 7 Цикл
		ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
		ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2014Кв1_Разделы5_7", "Раздел"+Ном, СтруктураДанныхРазделы5_7);
		СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-инновация");
	КонецЦикла;
	
	Для Ном = 8 По 10 Цикл
		ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
		ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2014Кв1_Разделы8_10", "Раздел"+Ном, СтруктураДанныхРазделы8_10);
		СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-инновация");
	КонецЦикла;
	
	Для Ном = 11 По 12 Цикл
		ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
		ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2014Кв1_Разделы11_12", "Раздел"+Ном, СтруктураДанныхРазделы11_12);
		СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-инновация");
	КонецЦикла;
	
	ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2014Кв1_Разделы11_12", "Раздел12_Доп", СтруктураДанныхРазделы11_12);
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2014Кв1_Подписи", "Подписи", СтруктураДанныхПодписи);
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-инновация");
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если НЕ РегламентированнаяОтчетность.ПроверитьРазделыНаНаличиеИнформации(ЭтаФорма, ДеревоВыгрузки, "ПолеТабличногоДокументаРазделы1_3")
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	ЛеваяЧасть  = ПоказателиОтчета.ПолеТабличногоДокументаРазделы1_3.П010106;
	ПраваяЧасть = ПоказателиОтчета.ПолеТабличногоДокументаРазделы1_3.П010107;
	...
	Для Стр = 1 По 10 Цикл 
		Гр3 = ПоказателиОтчета.ПолеТабличногоДокументаРазделы1_3["П0303" + Формат(Стр, "ЧЦ=2; ЧВН=; ЧГ=;") + "_3"];
		Гр4 = ПоказателиОтчета.ПолеТабличногоДокументаРазделы1_3["П0303" + Формат(Стр, "ЧЦ=2; ЧВН=; ЧГ=;") + "_4"];
		Гр5 = ПоказателиОтчета.ПолеТабличногоДокументаРазделы1_3["П0303" + Формат(Стр, "ЧЦ=2; ЧВН=; ЧГ=;") + "_5"];
		Гр6=0;
		Гр7=0;
		Попытка
			Гр6 = ПоказателиОтчета.ПолеТабличногоДокументаРазделы1_3["П0303" + Формат(Стр, "ЧЦ=2; ЧВН=; ЧГ=;") + "_6"];
			Гр7 = ПоказателиОтчета.ПолеТабличногоДокументаРазделы1_3["П0303" + Формат(Стр, "ЧЦ=2; ЧВН=; ЧГ=;") + "_7"];
		Исключение
		КонецПопытки;
	...
	Для Гр = 3 По 5 Цикл 
		Стр301 = ПоказателиОтчета.ПолеТабличногоДокументаРазделы1_3["П030301_"+Гр];
		Стр302 = ПоказателиОтчета.ПолеТабличногоДокументаРазделы1_3["П030302_"+Гр];
		...
		Стр305 = ПоказателиОтчета.ПолеТабличногоДокументаРазделы1_3["П030305_"+Гр];
		Стр306 = ПоказателиОтчета.ПолеТабличногоДокументаРазделы1_3["П030306_"+Гр];
	...
	Для Гр = 3 По 7 Цикл 
		Стр302 = ПоказателиОтчета.ПолеТабличногоДокументаРазделы1_3["П030302_"+Гр];
		Стр310 = ПоказателиОтчета.ПолеТабличногоДокументаРазделы1_3["П030310_"+Гр];
