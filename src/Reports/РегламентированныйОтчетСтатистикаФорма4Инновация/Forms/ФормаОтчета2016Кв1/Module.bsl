...
Функция ПечатьНаСервере(ВидПечати)
	...
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2016Кв1_Титульный", "ОсновнаяЧасть1_1", СтруктураДанныхТитульный);
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2016Кв1_Титульный", "ОсновнаяЧасть1_2", СтруктураДанныхТитульный);
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-инновация");
	
	Для Ном = 1 По 4 Цикл
		ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
		ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2016Кв1_Разделы1_3", "Раздел"+Ном, СтруктураДанныхРазделы1_3);
		СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-инновация");
	КонецЦикла;
	
	Для Ном = 1 По 4 Цикл
		ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
		ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2016Кв1_Разделы5_7", "Раздел"+Ном, СтруктураДанныхРазделы5_7);
		СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-инновация");
	КонецЦикла;
	
	Для Ном = 8 По 10 Цикл
		ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
		ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2016Кв1_Разделы8_10", "Раздел"+Ном, СтруктураДанныхРазделы8_10);
		СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-инновация");
	КонецЦикла;
	
	ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2016Кв1_Разделы11_12", "Раздел11", СтруктураДанныхРазделы11_12);
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2016Кв1_Подписи", "Подписи", СтруктураДанныхПодписи);
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-инновация");
