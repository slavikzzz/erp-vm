...
//
&НаКлиенте
Процедура ВыполнитьДлительнуюОперацию_НаКлиенте(ВидДлОперации,
		ВидПечати = Неопределено, ФормаВлФормыДлитОперации = Неопределено) Экспорт

	РегламентированнаяОтчетностьАЛКОКлиент.ВыполнитьДлительнуюОперациюАЛКО(ЭтаФорма, ВидДлОперации, ВидПечати, ФормаВлФормыДлитОперации);
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения,
	...
	РегламентированнаяОтчетностьАЛКОКлиент.ПередЗакрытиемАЛКО(ЭтаФорма, Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка);
...
Процедура ПредставляетсяВПриИзменении(Элемент)
	...
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(ЭтаФорма, Элемент, "ОргИМНС", "КудаПредставляется");
...
Процедура КоличествоСтраницПодтверждающихДокументовПриИзменении(Элемент)
	...
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(ЭтаФорма, Элемент, "Прил", "КоличествоСтраницПодтверждающихДокументов");
...
//
&НаКлиенте
Процедура ОрганизацияОткрытие(Элемент = Неопределено,
...
Процедура ЭлектронныйАдресОрганизацииПриИзменении(Элемент)
	...
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(ЭтаФорма, Элемент, "ЭлектроннаяПочта", "ОрганизацияЭлектронныйАдрес");
...
Процедура КомментарийПриИзменении(Элемент)
	...
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(ЭтаФорма, Элемент, "Комментарий", "Комментарий");
...
//
&НаКлиенте
Процедура ДеятельностьПоЛицензииНачалоВыбора(ДанныеВыбора = Неопределено,
		СтандартнаяОбработка = Ложь) Экспорт

	РегламентированнаяОтчетностьАЛКОКлиент.ДеятельностьПоЛицензииНачалоВыбораАЛКО(ЭтаФорма, ДанныеВыбора, СтандартнаяОбработка);
...
// через оповещение, как действие "Нажатие" для элемента. 
// При вызове через ВыполнитьОбработкуОповещения() Дополнительные параметры не передаются,
// в качестве Результата в параметр Элемент передается элемент формы, но это не имеет значения.
//
&НаКлиенте
Процедура ВидДеятельностиНажатие(Элемент = Неопределено,
		СтандартнаяОбработка = Ложь) Экспорт

	РегламентированнаяОтчетностьАЛКОКлиент.ВидДеятельностиПоЛицензииНажатиеАЛКО(ЭтаФорма, Элемент, СтандартнаяОбработка);

КонецПроцедуры

&НаКлиенте
Процедура П000000000101ПриИзменении(Элемент)
...
&НаКлиенте
Процедура П000000000102ПриИзменении(Элемент)
...
&НаКлиенте
Процедура П000000000103ПриИзменении(Элемент)
...
&НаКлиенте
Процедура П000000000104ПриИзменении(Элемент)
...
&НаКлиенте
Процедура ФлагГоловногоОППереключательПриИзменении(Элемент = Неопределено)
...
&НаКлиенте
Процедура ФлагГоловногоОППриИзменении(Элемент = Неопределено)

	РегламентированнаяОтчетностьАЛКОКлиент.ФлагГоловногоОППриИзмененииАЛКО(ЭтаФорма, Элемент);
	 
	Если ФлагГоловногоОПЗначенияПереключателя = 0 Тогда		
		
		СведенияОбОП = РегламентированнаяОтчетностьАЛКОКлиент.ТекущееОбособленноеПодразделение(ЭтаФорма);
		Если НЕ ЗначениеЗаполнено(СведенияОбОП.ВидРозничнойПродажи) Тогда
			ОбособленноеПодразделениеНажатие();
		КонецЕсли;
...
// 
&НаКлиенте
Процедура ОбособленноеПодразделениеНажатие(Элемент = Неопределено,
		СтандартнаяОбработка = Ложь) Экспорт
		
	ПараметрыИзФормы = Новый Структура;
	ПараметрыИзФормы.Вставить("НуженВидПродажи", Истина);
	
	РегламентированнаяОтчетностьАЛКОКлиент.ОбособленноеПодразделениеНажатиеАЛКО(
						ЭтаФорма, Элемент, СтандартнаяОбработка, ПараметрыИзФормы);

КонецПроцедуры

&НаКлиенте
Процедура ДекорацияАвтоРасчетВыключенНажатие(Элемент)
	ИмяКоманды = "ОткрытьФормуНастроек";
...
Процедура ГиперссылкаНаименованиеЭтапаНажатие(Элемент)
	...
	ПараметрыИзменения.Вставить("КонтролирующийОрган", ПредопределенноеЗначение("Перечисление.ТипыКонтролирующихОрганов.ФСРАР"));
...
&НаКлиенте
Процедура Подключаемый_ТаблицаФормыРазделаВыборНаКлиенте(Элемент,
		ВыбраннаяСтрока, Поле, СтандартнаяОбработка)

	РегламентированнаяОтчетностьАЛКОКлиент.ТаблицаФормыРазделаВыборАЛКО(ЭтаФорма, Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка);

КонецПроцедуры


&НаКлиенте
Процедура Подключаемый_ТаблицаФормыРазделаПередУдалениемНаКлиенте(Элемент,
		Отказ = Истина)
...
&НаКлиенте
Процедура Подключаемый_ТаблицаФормыРазделаПередНачаломДобавления(Элемент,
		Отказ, Копирование, Родитель, ЭтоГруппа, Параметр)

	РегламентированнаяОтчетностьАЛКОКлиент.ТаблицаФормыРазделаПередНачаломДобавленияАЛКО(ЭтаФорма, Элемент, Отказ, Копирование, Родитель, ЭтоГруппа, Параметр);
...
&НаКлиенте
Процедура ЗагрузитьИзФайлаОтчетЗавершение(Результат,
...
Функция ЗагрузкаОтчетаИзФайлаНаСервере(ДанныеДляЗагрузки)
	...
	ДеревоДляЗагрузки = РегламентированнаяОтчетностьАЛКО.ИзвлечьСтруктуруXMLАЛКО(ДатаКонцаОтчета, ИмяФормы); 
...
&НаКлиенте
Процедура Подключаемый_ОткрытьПрисоединенныеФайлы(Команда) Экспорт
...
&НаКлиенте
Процедура ПроверитьВИнтернетеЗавершение(Отказ,
		ДополнительныеПараметры) Экспорт
...
&НаКлиенте
Процедура ВыгрузитьОтчетДляПроверкиПослеСохраненияНаКлиенте(Результат,
		ДополнительныеПараметры) Экспорт
...
&НаКлиенте
Процедура ВыгрузитьПакетПослеСохраненияНаКлиенте(Результат,
		ДополнительныеПараметры) Экспорт
...
&НаКлиенте
Процедура ВыгрузитьПакетПослеПолученияКонтекста(Результат,
		ДополнительныеПараметры) Экспорт
...
&НаКлиенте
Процедура ВыгрузитьПакетПослеПолученияКонтекстаЗавершение(Результат,
		ДополнительныеПараметры) Экспорт
...
&НаКлиенте
Процедура ВыгрузитьПакетПослеСохраненияФайлаНаКлиентеЗавершение(Результат,
		ДополнительныеПараметры) Экспорт
...
&НаКлиенте
Процедура ПроверкаВозможностиВыгрузкиРегламентированногоОтчетаПередОтправкой(Отказ,
		ДополнительныеПараметры) Экспорт
...
&НаКлиенте
Процедура ОтправитьВКонтролирующийОрганЗавершение(Отказ,
		ДополнительныеПараметры) Экспорт
...
&НаКлиенте
Процедура ОтправитьВКонтролирующийОрганПослеСохраненияНаКлиенте(Отказ,
		ДополнительныеПараметры) Экспорт
...
&НаСервере
Процедура УстановитьЦветФонаЯчейкиНаСервере(ИмяЯчейки = Неопределено,
		ВариантЗаполнения = Неопределено, ИмяТекущейСтраницыПанели = "") Экспорт
		// Процедура "заглушка". Для совместимости с общими механизмами.
	Возврат;
КонецПроцедуры

&НаКлиенте
Процедура УстановитьЦветФонаЯчейкиНаКлиенте(ИмяЯчейки = Неопределено,
		ВариантЗаполнения = Неопределено, ИмяТекущейСтраницыПанели = "") Экспорт
		// Процедура "заглушка". Для совместимости с общими механизмами.
	Возврат;
КонецПроцедуры
...
&НаСервере
Функция ПолучитьИмяФормыОбъектаЗначенияЭлементаФормы(ИмяЭлементаСсылки,
		ЗначениеСсылки = Неопределено) Экспорт

	Возврат РегламентированнаяОтчетностьАЛКО.ПолучитьИмяФормыОбъектаЗначенияЭлементаФормы(ЭтаФорма, ИмяЭлементаСсылки, ЗначениеСсылки);
...
&НаСервере
Процедура ВводРеквизитовОПЗавершениеНаСервере(РезультатВвода,
		ДополнительныеПараметры) Экспорт

	РегламентированнаяОтчетностьАЛКО.ВводРеквизитовОПЗавершениеАЛКО(ЭтаФорма, РезультатВвода, ДополнительныеПараметры);
...
&НаСервере
Процедура АктивацияДеактивацияНаСервере(ТекущиеДанные, Раздел,
		КоличествоСтрок)

	РегламентированнаяОтчетностьАЛКО.АктивацияДеактивацияАЛКО(ЭтаФорма, ТекущиеДанные, Раздел, КоличествоСтрок);
...
&НаСервере
Функция ПереходНаСтрокуТаблицыФормыНаСервере(ИдГруппы, НомерСтроки,
...
&НаСервере
Процедура ВывестиИтогиТабличногоПоляРазделаНаСервере(ИдГруппы,
...
&НаСервере
Процедура УстановитьДействиеТаблицыРазделыОтчетаНаСервере(Действие,
...
&НаСервере
Процедура ПоказатьСтраницуМногострочногоРазделаНаСервере(Шаг, Раздел,
...
&НаСервере
Процедура УстановитьВидимостьРазделов(НаименованиеРаздела, ИндексСтраницы) Экспорт
...
&НаКлиенте
Процедура РасчетНаКлиенте(ИмяТекущейСтраницыПанели = "",
		ОбластьИмя = "") Экспорт
		// Процедура "заглушка". Для совместимости с общими механизмами работы с многостраничными разделами.
	Возврат;
КонецПроцедуры
...
&НаСервере
Процедура РасчетНаСервере(ИмяТекущейСтраницыПанели = "",
		ОбластьИмя = "") Экспорт
		// Процедура "заглушка". Для совместимости с общими механизмами работы с многостраничными разделами.
	Возврат;
КонецПроцедуры
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "",
		Знач ОбластьИмя = "") Экспорт
		// Процедура "заглушка". Для совместимости с общими механизмами работы с многостраничными разделами.	
	Возврат;
КонецПроцедуры
#КонецОбласти
...
&НаСервере
Процедура УдалитьСтраницуНаСервере(Раздел = Неопределено,
...
&НаСервере
Функция ОбновитьПеременныеМодуляНаСервере(ИмяПоказателя,
		ЗначениеПоказателя) Экспорт
...
&НаКлиенте
Функция ОбновитьПеременныеМодуляНаКлиенте(ИмяПоказателя,
		ЗначениеПоказателя) Экспорт
...
&НаСервере
Процедура ОчисткаРегламентированногоОтчетаНаСервере(ИмяСтраницы,
		ЗапускатьОтдельнуюОбработкуПослеОчисткиЛиста, РежимОчистки,
		Многостраничность, КолВоСтраницВРазделе) Экспорт

	РегламентированнаяОтчетностьАЛКО.ОчисткаРегламентированногоОтчетаАЛКО(ЭтаФорма, ИмяСтраницы, ЗапускатьОтдельнуюОбработкуПослеОчисткиЛиста, РежимОчистки);
КонецПроцедуры
...
&НаКлиенте
Процедура СохранитьНаКлиенте(Автосохранение = Ложь,
...
&НаСервере
Функция СохранитьДанныеОтчетаНаСервере(Автосохранение = Ложь, КодИФНС, КПП,
		Вариант, ВидДокументаНомерКорректировкиИзменен = Неопределено,
		НаимТекРаздела) Экспорт
	...
	СтруктураПараметров.Вставить("ВидДокументаНомерКорректировкиИзменен", ВидДокументаНомерКорректировкиИзменен);
...
&НаКлиенте
Процедура Подключаемый_ОткрытьФормуНавигацииПоОшибкамБезПараметров() Экспорт
...
&НаСервере
Функция ВыполнитьДлительнуюОперацию_НаСервере(ВидДлОперации,
...
&НаСервере
Процедура УдалитьИзВременногоХранилищаАдреса(ОсновнойАдрес,
		ВспомогательныйАдрес, АдресДвоичныхДанных)

	РегламентированнаяОтчетностьАЛКО.УдалитьИзВременногоХранилищаАдресаАЛКО(ЭтаФорма, ОсновнойАдрес, ВспомогательныйАдрес, АдресДвоичныхДанных);
...
&НаСервере
Процедура СформироватьСпискиВыбораНаСервере() Экспорт

	ДатаПериодаОтчета = СтруктураРеквизитовФормы.мДатаКонцапериодаОтчета;

	КоллекцияСписковВыбора = РегламентированнаяОтчетностьАЛКО.СчитатьКоллекциюСписковВыбораАЛКО(ДатаПериодаОтчета, ИмяФормы, ОбъектЭтогоОтчета);
...
Процедура УстановитьПараметрыДекларации() Экспорт
	...
	//
	///////////////////////////////////////////////////////////////////////
	УказываютсяНомераЛицензии = Истина;

	ЕстьСпискиВыбора = Истина;
	...
	СписокИдГруппОтчета.Добавить("П0000000002", "мИдГруппы01"); // Лицензии Таблица 1.	
	СписокИдГруппОтчета.Добавить("П0000100003", "мИдГруппы12"); // Раздел 1 Таблица 2.	
	СписокИдГруппОтчета.Добавить("П0000200003", "мИдГруппы22"); // Раздел 2 Таблица 2.	
	СписокИдГруппОтчета.Добавить("П0000300003", "мИдГруппы32"); // Раздел 3 Таблица 2.
	...
	СписокИдГруппРаздела.Добавить(СтруктураРеквизитовФормы.мИдГруппы12, "Раздел 1 (Обороты)");
	СписокИдГруппРаздела.Добавить(СтруктураРеквизитовФормы.мИдГруппы22, "Раздел 2 (Поступления)");
	СписокИдГруппРаздела.Добавить(СтруктураРеквизитовФормы.мИдГруппы32, "Раздел 3 (Возвраты)");
