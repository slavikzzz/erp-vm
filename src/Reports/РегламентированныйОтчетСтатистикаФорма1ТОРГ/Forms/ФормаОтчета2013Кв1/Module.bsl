...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "07/11/2013";
	// Код отчета, равен коду по ОКУД.
	СтруктураРеквизитовФормы.мКодОтчета = "0614004";
	
	// ОПИСАНИЕ ПАРАМЕТРОВ МНОГОСТРОЧНЫХ ГРУПП
	// Идентификаторы многострочных групп.
	СтруктураРеквизитовФормы.мИдГруппы1 = "П0007010001";
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Область.Имя = "ПечататьОКТМО" Тогда
	...
	Иначе
		...
		Если ПараметрВводаПоля <> Неопределено И ПараметрВводаПоля.ТаблицаЗначений <> Неопределено Тогда
			...
			Состояние(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = '%1. Открывается форма для выбора значения, подождите...';
																					|en = '%1. Открывается форма для выбора значения, подождите...'"), ЭтаФорма.Заголовок));
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	СтруктураГруппы = Форма.П0007010001;
	...
	Для НомКол = 3 По 5 Цикл
		...
		Для НомСтр = 2 По 13 Цикл
			ТекСумма = ТекСумма + мФормаОтчета.Области["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=")
				+ Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение;
		КонецЦикла;
		мФормаОтчета.Области["П0000030001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение = ТекСумма;
	КонецЦикла;
	
	// Раздел 2.
	
	мФормаОтчета.Области["П000102000103"].Значение = мФормаОтчета.Области["П000102000103_1"].Значение
												   + мФормаОтчета.Области["П000102000103_4"].Значение
												   + мФормаОтчета.Области["П000102000103_20"].Значение
												   + мФормаОтчета.Области["П000102000103_28"].Значение
												   + мФормаОтчета.Области["П000102000103_29"].Значение
												   + мФормаОтчета.Области["П000102000103_30"].Значение
												   + мФормаОтчета.Области["П000102000103_31"].Значение
												   + мФормаОтчета.Области["П000102000103_32"].Значение
												   + мФормаОтчета.Области["П000102000103_33"].Значение
												   + мФормаОтчета.Области["П000102000103_36"].Значение
												   + мФормаОтчета.Области["П000102000103_37"].Значение
												   + мФормаОтчета.Области["П000102000103_48"].Значение
												   + мФормаОтчета.Области["П000102000103_60"].Значение
												   + мФормаОтчета.Области["П000102000103_64"].Значение
												   + мФормаОтчета.Области["П000102000103_71"].Значение
												   + мФормаОтчета.Области["П000102000103_72"].Значение
												   + мФормаОтчета.Области["П000102000103_75"].Значение
												   + мФормаОтчета.Области["П000102000103_76"].Значение
												   + мФормаОтчета.Области["П000102000103_79"].Значение;
	
	мФормаОтчета.Области["П000202000103"].Значение = мФормаОтчета.Области["П000202000103_1"].Значение
												   + мФормаОтчета.Области["П000202000103_2"].Значение
												   + мФормаОтчета.Области["П000202000103_3"].Значение
												   + мФормаОтчета.Области["П000202000103_10"].Значение
												   + мФормаОтчета.Области["П000202000103_11"].Значение
												   + мФормаОтчета.Области["П000202000103_12"].Значение
												   + мФормаОтчета.Области["П000202000103_14"].Значение
												   + мФормаОтчета.Области["П000202000103_19"].Значение
												   + мФормаОтчета.Области["П000202000103_20"].Значение
												   + мФормаОтчета.Области["П000202000103_24"].Значение
												   + мФормаОтчета.Области["П000202000103_26"].Значение
												   + мФормаОтчета.Области["П000202000103_28"].Значение
												   + мФормаОтчета.Области["П000202000103_30"].Значение
												   + мФормаОтчета.Области["П000202000103_32"].Значение
												   + мФормаОтчета.Области["П000202000103_34"].Значение
												   + мФормаОтчета.Области["П000202000103_36"].Значение
												   + мФормаОтчета.Области["П000202000103_37"].Значение
												   + мФормаОтчета.Области["П000202000103_43"].Значение
												   + мФормаОтчета.Области["П000202000103_44"].Значение
												   + мФормаОтчета.Области["П000202000103_46"].Значение
												   + мФормаОтчета.Области["П000202000103_48"].Значение
												   + мФормаОтчета.Области["П000202000103_49"].Значение
												   + мФормаОтчета.Области["П000202000103_52"].Значение
												   + мФормаОтчета.Области["П000202000103_53"].Значение
												   + мФормаОтчета.Области["П000202000103_54"].Значение
												   + мФормаОтчета.Области["П000202000103_55"].Значение
												   + мФормаОтчета.Области["П000202000103_62"].Значение
												   + мФормаОтчета.Области["П000202000103_67"].Значение
												   + мФормаОтчета.Области["П000202000103_68"].Значение
												   + мФормаОтчета.Области["П000202000103_69"].Значение
												   + мФормаОтчета.Области["П000202000103_70"].Значение
												   + мФормаОтчета.Области["П000202000103_71"].Значение
												   + мФормаОтчета.Области["П000202000103_72"].Значение
												   + мФормаОтчета.Области["П000202000103_73"].Значение
												   + мФормаОтчета.Области["П000202000103_74"].Значение
												   + мФормаОтчета.Области["П000202000103_75"].Значение
												   + мФормаОтчета.Области["П000202000103_76"].Значение
												   + мФормаОтчета.Области["П000202000103_77"].Значение
												   + мФормаОтчета.Области["П000202000103_78"].Значение
												   + мФормаОтчета.Области["П000202000103_79"].Значение
												   + мФормаОтчета.Области["П000202000103_80"].Значение
												   + мФормаОтчета.Области["П000202000103_84"].Значение
												   + мФормаОтчета.Области["П000202000103_85"].Значение
												   + мФормаОтчета.Области["П000202000103_86"].Значение
												   + мФормаОтчета.Области["П000202000103_87"].Значение
												   + мФормаОтчета.Области["П000202000103_89"].Значение
												   + мФормаОтчета.Области["П000202000103_91"].Значение
												   + мФормаОтчета.Области["П000202000103_92"].Значение
												   + мФормаОтчета.Области["П000202000103_96"].Значение;
	
	мФормаОтчета.Области["П000002000103"].Значение = мФормаОтчета.Области["П000102000103"].Значение
												   + мФормаОтчета.Области["П000202000103"].Значение
												   + мФормаОтчета.Области["П010002000103"].Значение;
	
	// Раздел 1.
	
	ТекСумма = 0;
	Для НомСтр = 1 По СтруктураГруппы.Количество() Цикл
		ТекСумма = ТекСумма + мФормаОтчета.Области["П000701000103_" + Формат(НомСтр, "ЧГ=")].Значение;
	КонецЦикла;
	мФормаОтчета.Области["П000701000103"].Значение = ТекСумма;
	
	мФормаОтчета.Области["П000401000103_19"].Значение = мФормаОтчета.Области["П000401000103_20"].Значение
													  + мФормаОтчета.Области["П000401000103_21"].Значение
													  + мФормаОтчета.Области["П000401000103_22"].Значение;
	
	ТекСумма = 0;
	Для НомСтр = 1 По 3 Цикл
		ТекСумма = ТекСумма + мФормаОтчета.Области["П000101000103_" + Формат(НомСтр, "ЧГ=")].Значение;
	КонецЦикла;
	Для НомСтр = 1 По 9 Цикл
		ТекСумма = ТекСумма + мФормаОтчета.Области["П000201000103_" + Формат(НомСтр, "ЧГ=")].Значение;
	КонецЦикла;
	Для НомСтр = 1 По 25 Цикл
		ТекСумма = ТекСумма + мФормаОтчета.Области["П000301000103_" + Формат(НомСтр, "ЧГ=")].Значение;
	КонецЦикла;
	Для НомСтр = 1 По 29 Цикл
		Если НомСтр >= 20 И НомСтр <= 22 Тогда
			Продолжить;
		КонецЕсли;
		ТекСумма = ТекСумма + мФормаОтчета.Области["П000401000103_" + Формат(НомСтр, "ЧГ=")].Значение;
	КонецЦикла;
	Для НомСтр = 1 По 20 Цикл
		ТекСумма = ТекСумма + мФормаОтчета.Области["П000501000103_" + Формат(НомСтр, "ЧГ=")].Значение;
	КонецЦикла;
	Для НомСтр = 1 По 17 Цикл
		ТекСумма = ТекСумма + мФормаОтчета.Области["П000601000103_" + Формат(НомСтр, "ЧГ=")].Значение;
	КонецЦикла;
	ТекСумма = ТекСумма + мФормаОтчета.Области["П000701000103"].Значение;
	мФормаОтчета.Области["П000001000103"].Значение = ТекСумма;
...
Процедура ОчиститьОтчет(Команда)
	...
	ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Внимание! Отчет будет очищен.%1Продолжить операцию?';
...
функция СтруктураРазделовДляОбработкиЗаголовковИПодвалов()
	...
	СтруктураРаздела.Вставить("Ограничители",              "Ограничители2");     // имя соотв. разделу секции макета
	СтруктураРаздела.Вставить("ПустаяСтрока",              "ПустаяСтрока2");     // имя соотв. разделу секции макета
	СтруктураРаздела.Вставить("УдаляемыйЗаголовок",        "ОсновнаяЧасть13_1"); // имя соотв. разделу секции макета
	СтруктураРаздела.Вставить("ПереносимыйЗаголовок",      "ОсновнаяЧасть13_2"); // имя соотв. разделу секции макета
	...
	// Раздел 1 ("свободные строки" в конце).
	СтруктураРаздела = Новый Структура;
	СтруктураРаздела.Вставить("НомерСтрокиПоказателя",     5);
	СтруктураРаздела.Вставить("НомерКолонкиПоказателя",    2);
	СтруктураРаздела.Вставить("ПодстрокаПоискаПоказателя", "П000701000101");
	СтруктураРаздела.Вставить("Ограничители",              "Ограничители1");
	СтруктураРаздела.Вставить("ПустаяСтрока",              "ПустаяСтрока1");
	СтруктураРаздела.Вставить("УдаляемыйЗаголовок",        "ОсновнаяЧастьБ_2");
	СтруктураРаздела.Вставить("ПереносимыйЗаголовок",      "ОсновнаяЧастьБ_1");
	СтруктураРаздела.Вставить("ОриентацияСтраницы",        ОриентацияСтраницы.Ландшафт);
...
Функция ПечатьНаСервере(ВидПечати)
	...
	СтруктураПараметров.Вставить("НаименованиеЛиста",  "Форма 1-ТОРГ");
	СтруктураПараметров.Вставить("ОриентацияЛиста",    "Ландшафт");
	СтруктураПараметров.Вставить("ИмяСтраницы",        "1ТОРГ");
	...
	// Вывод/невывод на печать Кодов по ОКТМО (Раздел 4, графа 2).
	Если Не ПолеТабличногоДокументаФормаОтчета.Области["ПечататьОКТМО"].Значение Тогда
		Для Каждого ЛистДляПечати Из СтруктураРеквизитовФормы.мПечатныеФормы Цикл
			Для Каждого Показатель Из ЛистДляПечати.Значение.Области Цикл
				Если СтрНайти(Показатель.Имя, "П000004000102_") > 0 Тогда
...
Процедура ВвестиПоказатель(Элемент, Область, КодПоказателя, Знач ЭтоСумма, Знач ТекстВыбора, ТаблицаВыбора, СтандартнаяОбработка, КолонкаПоиска = "Код") Экспорт
	...
	ИсходноеЗначение = ПолеТабличногоДокументаФормаОтчета.Области[СтруктураРеквизитовФормы.мИдГруппы2 + "02" + Суффикс].Значение;
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	ПолеТабличногоДокументаФормаОтчета.Области[СтруктураРеквизитовФормы.мИдГруппы2 + "01" + Суффикс].Значение = ?(ЗначениеЗаполнено(ВыборКод), СокрЛП(ВыборНазвание), "");
	ПолеТабличногоДокументаФормаОтчета.Области[СтруктураРеквизитовФормы.мИдГруппы2 + "02" + Суффикс].Значение = ?(ЗначениеЗаполнено(ВыборКод), Число(СокрЛП(ВыборКод)), 0);
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	// КОНТРОЛЬ показателей формы (из текста "Указаний ФСН по заполнению Формы 1-ТОРГ").
	// Строка 400* раздела 2 ≥ стр. 50.10.2 раздела 2.1.
	Если Не (ПараметрыВыгрузки["ПР00002000103"] >= ПараметрыВыгрузки["ПР10002000103"]) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: данные в стр. 400* раздела 2 должно быть больше или равно данным в стр. 50.10.2 раздела 2.1!",
			ИмяПоляТаблДокумента, "П000002000103");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// Данные по строке 01 графе 3 минус данные по строке 01 графе 4 раздела 3 должны быть равны данным по коду ОКПД 51.001* “Всего” раздела 1.
	Если Не (ПараметрыВыгрузки["ПР00003000103"] - ПараметрыВыгрузки["ПР00003000104"] = ПараметрыВыгрузки["ПР00001000103"]) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: в стр. 01 раздела 3 данные по гр. 3 минус данные по гр. 4 должны быть равны данным по коду ОКПД 51.001* “Всего” раздела 1!",
			ИмяПоляТаблДокумента, "П000003000103");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// Данные по графе 5 строке 01 раздела 3 должны быть равны данным по коду ОКПД 400* “Всего” раздела 2.
	Если Не (ПараметрыВыгрузки["ПР00003000105"] = ПараметрыВыгрузки["ПР00002000103"]) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: данные по гр. 5 в стр. 01 раздела 3 должны быть равны данным по коду ОКПД 400* “Всего” раздела 2!",
			ИмяПоляТаблДокумента, "П000003000105");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// Данные строки 14 раздела 3 меньше или равны строки 01 графы 5 раздела 3.
	Если Не (ПараметрыВыгрузки["ПР00003001405"] <= ПараметрыВыгрузки["ПР00003000105"]) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: данные в стр. 14 раздела 3 должны быть меньше или равны данным в стр. 01 по гр. 5 раздела 3!",
			ИмяПоляТаблДокумента, "П000003001405");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// Данные по строке 14 раздела 3 должны быть больше или равны сумме строк 15 и 16 раздела 3.
	Если Не (ПараметрыВыгрузки["ПР00003001405"] >= ПараметрыВыгрузки["ПР00003001505"] + ПараметрыВыгрузки["ПР00003001605"]) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: данные в стр. 14 раздела 3 должны быть больше или равны сумме данных в стр. 15 и 16 раздела 3!",
			ИмяПоляТаблДокумента, "П000003001405");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// Сумма данных по строкам графы 3 раздела 4 должна быть равна данным по строке “Всего” (код 400*) раздела 2.
	ТекСумма = 0;
	НомСтр = 1;
	Пока РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(ПараметрыВыгрузки, "ПР00004000103_" + Формат(НомСтр, "ЧГ=")) Цикл
		ТекСумма = ТекСумма + ПараметрыВыгрузки["ПР00004000103_" + Формат(НомСтр, "ЧГ=")];
		НомСтр = НомСтр + 1;
	КонецЦикла;
	Если Не (ТекСумма = ПараметрыВыгрузки["ПР00002000103"]) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: сумма данных в строках по гр. 3 раздела 4 должна быть равна данным в стр. “Всего” (код 400*) раздела 2!",
			ИмяПоляТаблДокумента, "П000002000103");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// Сумма данных по строкам графы 4 раздела 4 должна быть равна строке “Пищевые продукты, включая напитки, и табачные изделия” (код ОКПД 52.2) раздела 2.
	ТекСумма = 0;
	НомСтр = 1;
	Пока РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(ПараметрыВыгрузки, "ПР00004000104_" + Формат(НомСтр, "ЧГ=")) Цикл
		ТекСумма = ТекСумма + ПараметрыВыгрузки["ПР00004000104_" + Формат(НомСтр, "ЧГ=")];
		НомСтр = НомСтр + 1;
	КонецЦикла;
	Если Не (ТекСумма = ПараметрыВыгрузки["ПР00102000103"]) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: сумма данных в строках по гр. 4 раздела 4 должна быть равна данным в стр. “Пищевые продукты, включая напитки, и табачные изделия” (код ОКПД 52.2) раздела 2!",
			ИмяПоляТаблДокумента, "П000102000103");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// Сумма данных по строкам графы 5 раздела 4 должна быть равна строке “Табачные изделия” (код ОКПД 52.26.10.000) раздела 2.
	ТекСумма = 0;
	НомСтр = 1;
	Пока РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(ПараметрыВыгрузки, "ПР00004000105_" + Формат(НомСтр, "ЧГ=")) Цикл
		ТекСумма = ТекСумма + ПараметрыВыгрузки["ПР00004000105_" + Формат(НомСтр, "ЧГ=")];
		НомСтр = НомСтр + 1;
	КонецЦикла;
	Если Не (ТекСумма = ПараметрыВыгрузки["ПР00102000103_36"]) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: сумма данных в строках по гр. 5 раздела 4 должна быть равна данным в стр. “Табачные изделия” (код ОКПД 52.26.10.000) раздела 2!",
			ИмяПоляТаблДокумента, "П000102000103_36");
		СтатусПроверки = Ложь;
	КонецЕсли;
...
&НаСервере
Функция ПолучитьЗначениеКодаИзТекста(ТекПоказатель)
	
	ТекТекст = ПолеТабличногоДокументаФормаОтчета.Области[ТекПоказатель].Текст;
	ТекТекст = СтрЗаменить(ТекТекст, "*", "");
	ТекТекст = СтрЗаменить(ТекТекст, " ", "");
...
&НаСервере
Процедура ДополнительныеПараметры1ТОРГ(ТекСтруктура, ТекПоказатель)
	...
	Пока ТекСтруктура.Свойство(ТекПоказатель + "_" + Формат(НомСуффикса, "ЧГ="), ТекЗначение) Цикл
		...
		// Анализируем текст (графа "Код по ОКПД"), получаем строку с Кодом.
		ТекКод = ПолучитьЗначениеКодаИзТекста(Лев(ТекПоказатель, 11) + "02_" + Формат(НомСуффикса, "ЧГ="));
		
		// Части Кодов, имеющихся в печ. форме приказа, нет в шаблоне для выгрузки.
		// В случае отсутствия Кода в шаблоне для выгрузки - предварительно заполняем значение
		// ключа подстрокой, содержащей спец.символ (далее НЕ будем выгружать данные с этим Кодом).
		Если ТекКод = "51.47.21.110" Или ТекКод = "51.47.21.120" Или ТекКод = "51.47.22.110" Тогда
			ТекКод = "#_" + Формат(НомСуффикса, "ЧГ=");
		КонецЕсли;
		
		// Помещаем Код в Параметры для выгрузки.
		ТекСтруктура.Вставить("ПД" + Сред(ТекПоказатель, 3, 9) + "02_" + Формат(НомСуффикса, "ЧГ="), ТекКод);
...
Функция СформироватьСтруктуруПараметров()
	...
	// Для ПОСЛЕДУЮЩЕГО (ПЕРЕД ВЫГРУЗКОЙ) контроля показателей формы (Указания ФСН по заполнению Формы 1-ТОРГ).
	
	ПараметрыВыгрузки.Вставить("ПР00002000103", ТабДокумент["П000002000103"]);
	ПараметрыВыгрузки.Вставить("ПР10002000103", ТабДокумент["П010002000103"]);
	ПараметрыВыгрузки.Вставить("ПР00003000103", ТабДокумент["П000003000103"]);
	ПараметрыВыгрузки.Вставить("ПР00003000104", ТабДокумент["П000003000104"]);
	ПараметрыВыгрузки.Вставить("ПР00001000103", ТабДокумент["П000001000103"]);
	ПараметрыВыгрузки.Вставить("ПР00003000105", ТабДокумент["П000003000105"]);
	ПараметрыВыгрузки.Вставить("ПР00003001405", ТабДокумент["П000003001405"]);
	ПараметрыВыгрузки.Вставить("ПР00003001505", ТабДокумент["П000003001505"]);
	ПараметрыВыгрузки.Вставить("ПР00003001605", ТабДокумент["П000003001605"]);
	ПараметрыВыгрузки.Вставить("ПР00102000103", ТабДокумент["П000102000103"]);
	НомСтр = 1;
	Пока РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(ТабДокумент, "П000004000103_" + Формат(НомСтр, "ЧГ=")) Цикл
		ПараметрыВыгрузки.Вставить("ПР00004000103_" + Формат(НомСтр, "ЧГ="), ТабДокумент["П000004000103_" + Формат(НомСтр, "ЧГ=")]);
		ПараметрыВыгрузки.Вставить("ПР00004000104_" + Формат(НомСтр, "ЧГ="), ТабДокумент["П000004000104_" + Формат(НомСтр, "ЧГ=")]);
		ПараметрыВыгрузки.Вставить("ПР00004000105_" + Формат(НомСтр, "ЧГ="), ТабДокумент["П000004000105_" + Формат(НомСтр, "ЧГ=")]);
		НомСтр = НомСтр + 1;
	КонецЦикла;

	ПараметрыВыгрузки.Вставить("ПР00102000103_36", ТабДокумент["П000102000103_36"]);
	
	// Синтетические параметры (переводим коды из текста в значение).
	
	ДополнительныеПараметры1ТОРГ(ТабДокумент, "П000101000103");
	ДополнительныеПараметры1ТОРГ(ТабДокумент, "П000201000103");
	ДополнительныеПараметры1ТОРГ(ТабДокумент, "П000301000103");
	ДополнительныеПараметры1ТОРГ(ТабДокумент, "П000401000103");
	ДополнительныеПараметры1ТОРГ(ТабДокумент, "П000501000103");
	ДополнительныеПараметры1ТОРГ(ТабДокумент, "П000601000103");
	
	ДополнительныеПараметры1ТОРГ(ТабДокумент, "П000102000103");
	ДополнительныеПараметры1ТОРГ(ТабДокумент, "П000202000103");
