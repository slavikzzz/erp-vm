...
Процедура УстановитьПараметрыДекларации() Экспорт
	...
	СписокИдГруппОтчета.Добавить("П0000100003", "мИдГруппы12"); // Раздел 1 (Декларация) Таблица 2.	
	...
	// генерируется группа "ГруппаТаблицыФормы" + ИмяТаблицыФормы, в которой впоследствии 
