		...
		Если ЗначениеЗаполнено(СтруктураРеквизитовФормы.мСкопированаФорма) Тогда
			...
			Если РазныеСпискиВидовДеятельности Тогда
				...
				Сообщение.Текст = НСтр("ru = 'При копировании были очищены виды деятельности в разделе лицензий.';
										|en = 'При копировании были очищены виды деятельности в разделе лицензий.'");
				Сообщение.Сообщить();
			КонецЕсли;
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000114", "П000010000107;П000010000108;П000010000109;П000010000111;П000010000112");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000118", "П000010000115;П000010000116;П000010000117");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000122", "П000010000115;П000010000116;П000010000117;П000010000119;П000010000120");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000123", "П000010000106;П000010000107;П000010000108;П000010000109;П000010000111;П000010000112;П000010000115;П000010000116;П000010000117;П000010000119;П000010000120");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000214", "П000010000107;П000010000108;П000010000109;П000010000111;П000010000112");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000217", "П000010000117");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000218", "П000010000115;П000010000116;П000010000117");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000219", "П000010000119");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000220", "П000010000120");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000222", "П000010000115;П000010000116;П000010000117;П000010000119;П000010000120");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000223", "П000010000106;П000010000107;П000010000108;П000010000109;П000010000111;П000010000112;П000010000115;П000010000116;П000010000117;П000010000119;П000010000120");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000314", "П000010000307;П000010000308;П000010000309;П000010000311;П000010000312;П000010000313");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000318", "П000010000315;П000010000316;П000010000317");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000322", "П000010000315;П000010000316;П000010000317;П000010000319;П000010000320;П000010000321");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000323", "П000010000306;П000010000307;П000010000308;П000010000309;П000010000311;П000010000312;П000010000313;П000010000315;П000010000316;П000010000317;П000010000319;П000010000320;П000010000321");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000413", "П000010000313");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000414", "П000010000307;П000010000308;П000010000309;П000010000311;П000010000312;П000010000313");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000417", "П000010000317");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000418", "П000010000315;П000010000316;П000010000317");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000419", "П000010000319");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000420", "П000010000320");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000421", "П000010000321");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000422", "П000010000315;П000010000316;П000010000317;П000010000319;П000010000320;П000010000321");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000423", "П000010000306;П000010000307;П000010000308;П000010000309;П000010000311;П000010000312;П000010000313;П000010000315;П000010000316;П000010000317;П000010000319;П000010000320;П000010000321");
...
Процедура УстановитьДоступностьПолейДекларация(Форма)
	...
	Пока Форма.ТабличныйДокумент.Области.Найти("П000010000101_" + Постфикс) <> Неопределено Цикл
		...
		УстановитьЦветФонаЯчейки(Форма, "П000010000110_" + Постфикс, ВариантАвторасчета,  "Декларация");
		...
		УстановитьЦветФонаЯчейки(Форма, "П000010000114_" + Постфикс, ВариантАвторасчета,  "Декларация");
		...
		УстановитьЦветФонаЯчейки(Форма, "П000010000118_" + Постфикс, ВариантАвторасчета,  "Декларация");
		...
		УстановитьЦветФонаЯчейки(Форма, "П000010000122_" + Постфикс, ВариантАвторасчета,  "Декларация");
		УстановитьЦветФонаЯчейки(Форма, "П000010000123_" + Постфикс, ВариантАвторасчета,  "Декларация");
	...
	УстановитьЦветФонаЯчейки(Форма, "П000010000208", ВариантАвторасчета, "Декларация");
	...
	УстановитьЦветФонаЯчейки(Форма, "П000010000219", ВариантАвторасчета, "Декларация");
	УстановитьЦветФонаЯчейки(Форма, "П000010000220", ВариантАвторасчета, "Декларация");
	УстановитьЦветФонаЯчейки(Форма, "П000010000222", ВариантАвторасчета, "Декларация");
	УстановитьЦветФонаЯчейки(Форма, "П000010000223", ВариантАвторасчета, "Декларация");
...
Процедура СформироватьСпискиВыбора()
	...
	КонецЕсли;
	МакетСоставаПоказателей = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет(ИмяМакета);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010000101", 5, , "Выбор вида продукции", КоллекцияСписковВыбора["ВидыПродукции"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010000102", 5, , "Выбор вида продукции", КоллекцияСписковВыбора["ВидыПродукции"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010000301", 5, , "Выбор вида продукции", КоллекцияСписковВыбора["ВидыПродукции"]);
	...
	ИначеЕсли ИмяТекРаздела = "Декларация" Тогда
		...
		Для каждого ТаблицаСтраницы Из ЭтаФорма[НаимТаблицыСтраницы] Цикл
			...
			ИначеЕсли НомерСтраницыРазделаОтчета <> 1 Тогда
				ОбластьТД = ТабличныйДокумент.Область("R" + ТабличныйДокумент.Области.Найти("ДобавитьСтрокуЗначокТ1").Верх);
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", Знач ОбластьИмя = "") Экспорт
	...
	Если ИмяТекущейСтраницыПанели = "Декларация" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) Тогда
			...
			Для Инд = 1 По КоличествоСтрок Цикл
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000110, ОбластьИмя) > 0 Тогда   
					...
					Графа08 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100001" + "08" + ПостфиксСтроки);
					Графа09 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100001" + "09" + ПостфиксСтроки);
					
					ЗначениеГрафы10 = Графа07 + Графа08 + Графа09 ;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100001" + "10" + ПостфиксСтроки, ЗначениеГрафы10);
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000114, ОбластьИмя) > 0 Тогда
					...
					Графа10 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100001" + "10" + ПостфиксСтроки);
					Графа11 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100001" + "11" + ПостфиксСтроки);
					Графа12 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100001" + "12" + ПостфиксСтроки);
					
					ЗначениеГрафы14 = Графа10 + Графа11 + Графа12;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100001" + "14" + ПостфиксСтроки, ЗначениеГрафы14);
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000118, ОбластьИмя) > 0 Тогда
					...
					Графа17 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100001" + "17" + ПостфиксСтроки);
					
					ЗначениеГрафы18 = Графа15 + Графа16 + Графа17;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100001" + "18" + ПостфиксСтроки, ЗначениеГрафы18);

				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000122, ОбластьИмя) > 0 Тогда

					Графа18 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100001" + "18" + ПостфиксСтроки);
					Графа19 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100001" + "19" + ПостфиксСтроки);
					Графа20 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100001" + "20" + ПостфиксСтроки);
					
					ЗначениеГрафы22 = Графа18 + Графа19 + Графа20;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100001" + "22" + ПостфиксСтроки, ЗначениеГрафы22);

				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000123, ОбластьИмя) > 0 Тогда

					Графа06 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100001" + "06" + ПостфиксСтроки);
					Графа14 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100001" + "14" + ПостфиксСтроки);
					Графа22 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100001" + "22" + ПостфиксСтроки);
					
					ЗначениеГрафы23 = Графа06 + Графа14 - Графа22;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100001" + "23" + ПостфиксСтроки, ЗначениеГрафы23);
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000219, ОбластьИмя) > 0 Тогда
			...
			КоличествоСтрок = СтруктураГруппы.Количество();
			Форма.ТабличныйДокумент.Области.П000010000219.Значение = 0;
			Для Инд = 1 По КоличествоСтрок Цикл
				Постфикс = "_" + Формат(Инд, "ЧГ=0");
				Форма.ТабличныйДокумент.Области.П000010000219.Значение = Форма.ТабличныйДокумент.Области.П000010000219.Значение + Форма.ТабличныйДокумент.Области["П000010000119" + Постфикс].Значение;
			КонецЦикла;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000222, ОбластьИмя) > 0 Тогда
			...
			КоличествоСтрок = СтруктураГруппы.Количество();
			Форма.ТабличныйДокумент.Области.П000010000222.Значение = 0;
			Для Инд = 1 По КоличествоСтрок Цикл
				Постфикс = "_" + Формат(Инд, "ЧГ=0");
				Форма.ТабличныйДокумент.Области.П000010000222.Значение = Форма.ТабличныйДокумент.Области.П000010000222.Значение + Форма.ТабличныйДокумент.Области["П000010000122" + Постфикс].Значение;
			КонецЦикла;
		
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000223, ОбластьИмя) > 0 Тогда
			...
			КоличествоСтрок = СтруктураГруппы.Количество();
			Форма.ТабличныйДокумент.Области.П000010000223.Значение = 0;
			Для Инд = 1 По КоличествоСтрок Цикл
				Постфикс = "_" + Формат(Инд, "ЧГ=0");
				Форма.ТабличныйДокумент.Области.П000010000223.Значение = Форма.ТабличныйДокумент.Области.П000010000223.Значение + Форма.ТабличныйДокумент.Области["П000010000123" + Постфикс].Значение;
			КонецЦикла;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) Тогда
			...
			Для Инд = 1 По КоличествоСтрок Цикл
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000310, ОбластьИмя) > 0 Тогда   
					...
					Графа08 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100003" + "08" + ПостфиксСтроки);
					Графа09 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100003" + "09" + ПостфиксСтроки);
					
					ЗначениеГрафы10 = Графа07 + Графа08 + Графа09 ;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100003" + "10" + ПостфиксСтроки, ЗначениеГрафы10);
					
				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000314, ОбластьИмя) > 0 Тогда
					
					Графа10 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100003" + "10" + ПостфиксСтроки);
					Графа11 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100003" + "11" + ПостфиксСтроки);
					...
					ЗначениеГрафы14 = Графа10 + Графа11 + Графа12 + Графа13;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100003" + "14" + ПостфиксСтроки, ЗначениеГрафы14);
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000318, ОбластьИмя) > 0 Тогда
					...
					Графа17 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100003" + "17" + ПостфиксСтроки);
					
					ЗначениеГрафы18 = Графа15 + Графа16 + Графа17;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100003" + "18" + ПостфиксСтроки, ЗначениеГрафы18);

				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000322, ОбластьИмя) > 0 Тогда

					Графа18 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100003" + "18" + ПостфиксСтроки);
					Графа19 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100003" + "19" + ПостфиксСтроки);
					Графа20 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100003" + "20" + ПостфиксСтроки);
					Графа21 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100003" + "21" + ПостфиксСтроки);
					
					ЗначениеГрафы22 = Графа18 + Графа19 + Графа20 + Графа21;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100003" + "22" + ПостфиксСтроки, ЗначениеГрафы22);

				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000323, ОбластьИмя) > 0 Тогда

					Графа06 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100003" + "06" + ПостфиксСтроки);
					Графа14 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100003" + "14" + ПостфиксСтроки);
					Графа22 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100003" + "22" + ПостфиксСтроки);
					
					ЗначениеГрафы23 = Графа06 + Графа14 - Графа22;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100003" + "23" + ПостфиксСтроки, ЗначениеГрафы23);
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000419, ОбластьИмя) > 0 Тогда
			...
			КоличествоСтрок = СтруктураГруппы.Количество();
			Форма.ТабличныйДокумент.Области.П000010000419.Значение = 0;
			Для Инд = 1 По КоличествоСтрок Цикл
				Постфикс = "_" + Формат(Инд, "ЧГ=0");
				Форма.ТабличныйДокумент.Области.П000010000419.Значение = Форма.ТабличныйДокумент.Области.П000010000419.Значение + Форма.ТабличныйДокумент.Области["П000010000319" + Постфикс].Значение;
			КонецЦикла;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000421, ОбластьИмя) > 0 Тогда
			...
			КоличествоСтрок = СтруктураГруппы.Количество();
			Форма.ТабличныйДокумент.Области.П000010000421.Значение = 0;
			Для Инд = 1 По КоличествоСтрок Цикл
				Постфикс = "_" + Формат(Инд, "ЧГ=0");
				Форма.ТабличныйДокумент.Области.П000010000421.Значение = Форма.ТабличныйДокумент.Области.П000010000421.Значение + Форма.ТабличныйДокумент.Области["П000010000321" + Постфикс].Значение;
			КонецЦикла;
		
		КонецЕсли;
				
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000422, ОбластьИмя) > 0 Тогда
			...
			КоличествоСтрок = СтруктураГруппы.Количество();
			Форма.ТабличныйДокумент.Области.П000010000422.Значение = 0;
			Для Инд = 1 По КоличествоСтрок Цикл
				Постфикс = "_" + Формат(Инд, "ЧГ=0");
				Форма.ТабличныйДокумент.Области.П000010000422.Значение = Форма.ТабличныйДокумент.Области.П000010000422.Значение + Форма.ТабличныйДокумент.Области["П000010000322" + Постфикс].Значение;
			КонецЦикла;
		
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000423, ОбластьИмя) > 0 Тогда
			...
			КоличествоСтрок = СтруктураГруппы.Количество();
			Форма.ТабличныйДокумент.Области.П000010000423.Значение = 0;
			Для Инд = 1 По КоличествоСтрок Цикл
				Постфикс = "_" + Формат(Инд, "ЧГ=0");
				Форма.ТабличныйДокумент.Области.П000010000423.Значение = Форма.ТабличныйДокумент.Области.П000010000423.Значение + Форма.ТабличныйДокумент.Области["П000010000323" + Постфикс].Значение;
			КонецЦикла;
			...
			Если Не СталаЛицензируемая 
				...
				ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Выбор этого вида деятельности приведет к очистке сведений о лицензиях организации со всех страниц этого раздела. Если в отчете есть нелицензионный вид деятельности, он должен быть единственным.%1Продолжить?';
						|en = 'Выбор этого вида деятельности приведет к очистке сведений о лицензиях организации со всех страниц этого раздела. Если в отчете есть нелицензионный вид деятельности, он должен быть единственным.%1Продолжить?'"), 
					Символы.ПС);
...
Процедура ВосстановитьСведенияОбОрганизацииИзТитульногоЛистаСтарогоОбразца(ПоказателиОтчета)
	...
	СтруктураРеквизитовФормы.Руководитель   = ?(ПоказателиТаблПоле.Свойство("ОргДиректор"), ПоказателиТаблПоле.ОргДиректор, "");
	СтруктураРеквизитовФормы.Бухгалтер      = ?(ПоказателиТаблПоле.Свойство("ОргБухгалтер"), ПоказателиТаблПоле.ОргБухгалтер, "");
	СтруктураРеквизитовФормы.ТелОрганизации = ?(ПоказателиТаблПоле.Свойство("ТелОрганизации"), ПоказателиТаблПоле.ТелОрганизации, "");
...
Процедура ПроверитьЗаполнениеДекларация(ПараметрыВыгрузки, СтатусПроверки)
	...
	Для Каждого ЛистРаздела Из ДанныеРаздела Цикл
		...
		ДополнительныеДанныеТаблицы = Неопределено;
		...
		Если ТипЗнч(ЛистРаздела.ДополнительныеДанные[0].Значение) = Тип("Структура") Тогда
			ЛистРаздела.ДополнительныеДанные[0].Значение.Свойство(СтруктураРеквизитовФормы.мИдГруппы1, ДополнительныеДанныеТаблицы);
		КонецЕсли;
		ПроверитьЗаполнениеТаблицыДекларации(СтатусПроверки, СтруктураРеквизитовФормы.мИдГруппы1, ДанныеДопСтрок, ДополнительныеДанныеТаблицы, НомерЛиста);
		
		ЛистРаздела.ДанныеДопСтрок[0].Значение.Свойство(СтруктураРеквизитовФормы.мИдГруппы2, ДанныеДопСтрок);
		Если ТипЗнч(ЛистРаздела.ДополнительныеДанные[0].Значение) = Тип("Структура") Тогда
			ЛистРаздела.ДополнительныеДанные[0].Значение.Свойство(СтруктураРеквизитовФормы.мИдГруппы2, ДополнительныеДанныеТаблицы);
		КонецЕсли;
		ПроверитьЗаполнениеТаблицыДекларации(СтатусПроверки, СтруктураРеквизитовФормы.мИдГруппы2, ДанныеДопСтрок, ДополнительныеДанныеТаблицы, НомерЛиста);
...
&НаСервере
Процедура ПроверитьЗаполнениеТаблицыДекларации(СтатусПроверки, ИдГруппы, ДанныеДопСтрок, ДополнительныеДанные, НомерЛиста)
	...
	Для Каждого СтрокаДекларации Из ДанныеДопСтрок Цикл
		...
		СтрокаЗаполнена = ЗначениеЗаполнено(СтрокаДекларации[ПрефиксИмени + "01"])
		              ...
		              ИЛИ (ПрефиксИмени <> "П0000100001" И ЗначениеЗаполнено(СтрокаДекларации[ПрефиксИмени + "13"]))
		              ...
		              ИЛИ (ПрефиксИмени <> "П0000100001" И ЗначениеЗаполнено(СтрокаДекларации[ПрефиксИмени + "21"]))
		...
		ЗначениеГрафы = СокрЛП(СтрокаДекларации[ИмяГрафы]);
		Если ПустаяСтрока(ЗначениеГрафы) Тогда
			ТекстОписанияОшибки = "В строке " + НомерСтрокиСтроковый + " таблицы "+ ИмяТаблицы + " на листе " + НомерЛистаСтроковый + " декларации не задан код вида продукции!";
			СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Декларация", ИмяПоказателя, НомерЛиста);
		ИначеЕсли СтрДлина(ЗначениеГрафы) <> 3 Тогда
			ТекстОписанияОшибки = "В строке " + НомерСтрокиСтроковый + " таблицы "+ ИмяТаблицы + " на листе " + НомерЛистаСтроковый + " декларации неверно задан код вида продукции!";
			СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Декларация", ИмяПоказателя, НомерЛиста);
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ЗначениеГрафы) Тогда
			ТекстОписанияОшибки = "В строке " + НомерСтрокиСтроковый + " таблицы "+ ИмяТаблицы + " на листе " + НомерЛистаСтроковый + " декларации не указано наименование производителя/импортера!";
			СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Декларация", ИмяПоказателя, НомерЛиста);
		КонецЕсли;
		...
		ЭтоРоссийскаяОрганизация = НЕ ПустаяСтрока(КПП);
		Если ПустаяСтрока(ИНН) Тогда
			ТекстОписанияОшибки = "В строке " + НомерСтрокиСтроковый + " таблицы "+ ИмяТаблицы + " на листе " + НомерЛистаСтроковый + " декларации не указан ИНН производителя/импортера!";
			СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Декларация", ИмяПоказателяИНН, НомерЛиста);
		ИначеЕсли ЭтоРоссийскаяОрганизация И СтрДлина(ИНН) <> 10 Тогда
			ТекстОписанияОшибки = "В строке " + НомерСтрокиСтроковый + " таблицы "+ ИмяТаблицы + " на листе " + НомерЛистаСтроковый + " декларации неверно указан ИНН производителя/импортера!";
			СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Декларация", ИмяПоказателяИНН, НомерЛиста);
		КонецЕсли;
		
		Если ЭтоРоссийскаяОрганизация Тогда
			Если ПустаяСтрока(КПП) Тогда
				ТекстОписанияОшибки = "В строке " + НомерСтрокиСтроковый + " таблицы "+ ИмяТаблицы + " на листе " + НомерЛистаСтроковый + " декларации не указан КПП производителя/импортера!";
			...
			ИначеЕсли СтрДлина(КПП) <> 9 Тогда
				ТекстОписанияОшибки = "В строке " + НомерСтрокиСтроковый + " таблицы "+ ИмяТаблицы + " на листе " + НомерЛистаСтроковый + " декларации неверно указан КПП производителя/импортера!";
				СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Декларация", ИмяПоказателяКПП, НомерЛиста);
			КонецЕсли;
	...
	ТаблицаДубликатов.Свернуть(ИмяКодаВидаПродукции + ", " + ИмяНаименованияПроизводителя + ", " + ИмяИННПроизводителя + ", " + ИмяКПППроизводителя, "Счетчик");
	...
	Для Каждого Дубликат Из ТаблицаДубликатов Цикл
		...
		Если НЕ(ЗначениеЗаполнено(Дубликат[ИмяКодаВидаПродукции]) 
			ИЛИ ЗначениеЗаполнено(Дубликат[ИмяНаименованияПроизводителя])
			ИЛИ ЗначениеЗаполнено(Дубликат[ИмяИННПроизводителя])
			ИЛИ ЗначениеЗаполнено(Дубликат[ИмяКПППроизводителя])) Тогда
			Продолжить;
		КонецЕсли;
		
		ОтборДубликатов = Новый Структура;
		ОтборДубликатов.Вставить(ИмяКодаВидаПродукции, Дубликат[ИмяКодаВидаПродукции]);
		ОтборДубликатов.Вставить(ИмяНаименованияПроизводителя, Дубликат[ИмяНаименованияПроизводителя]);
		ОтборДубликатов.Вставить(ИмяИННПроизводителя, Дубликат[ИмяИННПроизводителя]);
		ОтборДубликатов.Вставить(ИмяКПППроизводителя, Дубликат[ИмяКПППроизводителя]);
		...
		Если НЕ ПустаяСтрока(АдресДубликата) Тогда
			ТекстОписанияОшибки = "В таблице "+ ИмяТаблицы + " на листе " + НомерЛистаСтроковый + " декларации повторяются сочетания кода вида продукции и реквизитов производителя/импортера в строках " + ПереченьСтрок + "!";
...
Функция СформироватьИдФайл(ПараметрыВыгрузки)
	...
	ИдентификаторОтправителя = ПараметрыВыгрузки.ИННЮЛ;
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель, КорневойУзел, Параметры)
	...
	Для Каждого Страница Из мДанныеОтчета.Декларация Цикл
		...
		ЗаполнитьСведенияПоСтранице(Страница, Узел_ОбъемОборота);
...
Процедура ЗаполнитьСведенияПоСтранице(Страница, УзелСведений)
	...
	ПрототипУзла_Оборот = ПолучитьПодчиненныйЭлемент(УзелСведений, "Оборот");
	
	ТаблицаОбъемовОборота = ДанныеДопСтрок[СтруктураРеквизитовФормы.мИдГруппы2];
	
	КодыВидовПродукции = ТаблицаОбъемовОборота.Выгрузить();
	...
	Для Каждого КодВидаПродукции Из КодыВидовПродукции Цикл
		...
		НомерПП_Оборот = НомерПП_Оборот + 1;
		УстановитьЗначениеЭлемента(Узел_Оборот, "ПN", НомерПП_Оборот);
		
		УстановитьЗначениеЭлемента(Узел_Оборот, "П000000000003", КодВидаПродукции);
		
		УсловияОтбора = Новый Структура("П000010000302", КодВидаПродукции);
		СтрокиПроизводителей = ТаблицаОбъемовОборота.НайтиСтроки(УсловияОтбора);
		
		ПрототипУзла_СведПроизвИмпорт = ПолучитьПодчиненныйЭлемент(Узел_Оборот, "СведПроизвИмпорт");
		
		НомерПП_СведПроизвИмпорт = 0;
		Для Каждого Производитель Из СтрокиПроизводителей Цикл
			Узел_СведПроизвИмпорт = НовыйУзелИзПрототипа(ПрототипУзла_СведПроизвИмпорт);
			
			НомерПП_СведПроизвИмпорт = НомерПП_СведПроизвИмпорт + 1;
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "ПN", НомерПП_СведПроизвИмпорт);
			
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000004", Производитель.П000010000303);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000005", Производитель.П000010000304);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000006", Производитель.П000010000305);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000007", Производитель.П000010000306);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000008", Производитель.П000010000307);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000009", Производитель.П000010000308);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000010", Производитель.П000010000309);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000011", Производитель.П000010000310);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000012", Производитель.П000010000311);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000013", Производитель.П000010000312);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000014", Производитель.П000010000313);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000015", Производитель.П000010000314);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000016", Производитель.П000010000315);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000017", Производитель.П000010000316);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000018", Производитель.П000010000317);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000019", Производитель.П000010000318);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000020", Производитель.П000010000319);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000021", Производитель.П000010000320);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000022", Производитель.П000010000321);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000023", Производитель.П000010000322);
			УстановитьЗначениеЭлемента(Узел_СведПроизвИмпорт, "П000000000024", Производитель.П000010000323);
...
Функция ПечатьНаСервере(ВидПечати)
	...
	Для Каждого СтрокаУровня1 Из мДеревоВыбранныхСтраниц.ПолучитьЭлементы() Цикл
		...
		ИначеЕсли ИмяСтраницыПанели = "Декларация" Тогда
			// Особая печать раздела "Декларация".
		...
		Если ИмяСтраницы = "Декларация" Тогда // Особая печать раздела "Декларация".
			Для Каждого ОбластьТД Из ТабличныйДокумент.Области Цикл
				Если СтрЧислоВхождений(ОбластьТД.Имя, "УдалитьСтроку") > 0
				 ИЛИ СтрЧислоВхождений(ОбластьТД.Имя, "СобратьДанныеПоОП") > 0 Тогда
					ОбластьТД.Очистить();
					ОбластьТД.Гиперссылка = Ложь;
...
Процедура ВывестиНаПечатьДекларация(СтруктураПараметровСтраницы)
	...
	Если ЭтаФорма[мСтруктураМногостраничныхРазделов.Декларация][0].ДанныеДопСтрок.Количество() > 0 Тогда
		...
		Для Каждого СтрокаДанных Из ДанныеПоОрганизации Цикл
			...
			ПометитьОбластьХ(Область_Строка.Области["П000010000321"]);
			ПечатнаяФорма.Вывести(Область_Строка);
		КонецЦикла;
		
		ДанныеПоОрганизации.Свернуть("П000010000102, П000010000103", "П000010000106, П000010000107, П000010000108, П000010000109, П000010000110,
		|П000010000111, П000010000112, П000010000114, П000010000115, П000010000116, П000010000117, П000010000118, П000010000119, П000010000120,
		|П000010000122, П000010000123");
		Для Каждого СтрокаДанных Из ДанныеПоОрганизации Цикл
			Область_Строка = МакетПечати.ПолучитьОбласть("СтрокаИтого");
			Область_Строка.Области.ОписаниеИтого.Текст = "Итого по производителю " + СтрокаДанных.П000010000103 + " и коду " + СтрокаДанных.П000010000102;
			Для Каждого Колонка Из ДанныеПоОрганизации.Колонки Цикл
				ИмяКолонки = Колонка.Имя;
			...
			ПометитьОбластьХ(Область_Строка.Области["П000010000421"]);
			ПечатнаяФорма.Вывести(Область_Строка);
		КонецЦикла;
		
		Область_Строка = МакетПечати.ПолучитьОбласть("СтрокаИтого");
		Область_Строка.Области.ОписаниеИтого.Текст = "ИТОГО";
		Для Каждого ЭлементДанных Из ЭтаФорма[мСтруктураМногостраничныхРазделов.Декларация][0].Данные[0].Значение Цикл
			ИмяКолонкиМакета = ЭлементДанных.Ключ;
			Если СтрНайти(ИмяКолонкиМакета, "П0000100002") = 1 Тогда
		...
		Для Каждого Лист Из ЭтаФорма[мСтруктураМногостраничныхРазделов.Декларация] Цикл
			...
			+ ?(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20140101', ", складу временного хранения", "");
			...
			ДанныеПоПодразделению.Свернуть("П000010000302, П000010000303", "П000010000306, П000010000307, П000010000308, П000010000309, П000010000310,
			|П000010000311, П000010000312, П000010000313, П000010000314, П000010000315, П000010000316, П000010000317, П000010000318, П000010000319, П000010000320,
			|П000010000321, П000010000322, П000010000323");
			Для Каждого СтрокаДанных Из ДанныеПоПодразделению Цикл
				Область_Строка = МакетПечати.ПолучитьОбласть("СтрокаИтого");
				Область_Строка.Области.ОписаниеИтого.Текст = "Итого по производителю " + СтрокаДанных.П000010000303 + " и коду " + СтрокаДанных.П000010000302;
				Для Каждого Колонка Из ДанныеПоПодразделению.Колонки Цикл
					ИмяКолонки = Колонка.Имя;
			...
			Область_Строка = МакетПечати.ПолучитьОбласть("СтрокаИтого");
			Область_Строка.Области.ОписаниеИтого.Текст = "ИТОГО";
			Для Каждого ЭлементДанных Из Лист.Данные[0].Значение Цикл
				ИмяКолонкиМакета = ЭлементДанных.Ключ;
				Если СтрНайти(ИмяКолонкиМакета, "П0000100004") = 1 Тогда
					Если Область_Строка.Области.Найти(ИмяКолонкиМакета) <> Неопределено Тогда
						Область_Строка.Области[ИмяКолонкиМакета].Значение = ЭлементДанных.Значение;
					КонецЕсли;
				КонецЕсли;
	...
	Иначе
		...
		Область_Строка = МакетПечати.ПолучитьОбласть("СтрокаИтого");
		Область_Строка.Области.ОписаниеИтого.Текст = "Итого по производителю и коду";
		ПометитьОбластьХ(Область_Строка.Области["П000010000413"]);
		ПометитьОбластьХ(Область_Строка.Области["П000010000421"]);
		ПечатнаяФорма.Вывести(Область_Строка);
...
Функция ПолучитьМакетФормыОтчета(ИмяРаздела)
	...
	КонецЕсли;
	Возврат Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)]
...
Процедура ТабличныйДокументПриАктивизации(Элемент)
	...
	Если ТабличныйДокумент.Области.Найти("ДобавитьСтрокуЗначокТ1") <> Неопределено Тогда
		ПерваяСтраница = ТабличныйДокумент.Область("R" + ТабличныйДокумент.Области.Найти("ДобавитьСтрокуЗначокТ1").Верх).ВысотаСтроки <> 1;
	КонецЕсли;
