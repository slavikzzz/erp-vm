...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ОбластьЗаголовокДатаСправки = ДокументРезультат.НайтиТекст(
		НСтр("ru = 'Дата справки с ЭП';
			|en = 'Date of information sheet with DS'"),
		,
		,
		,
		Истина);
	Если ОбластьЗаголовокДатаСправки <> Неопределено Тогда
		...
		ТекстПримечания = НСтр("ru = 'Дата последней по времени аналитической
			...
			|en = 'Date of the latest digitally signed analytical 
			|information sheet on counterparty from 1C-SPARK Risks 
			|. To view the 
			| information sheets on a counterparty, double-click 
			|the corresponding column cell.'");
