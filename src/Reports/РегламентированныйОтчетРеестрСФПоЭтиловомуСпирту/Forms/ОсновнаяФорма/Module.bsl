...
Процедура ПоказатьПериод(Форма)
	...
	ФормаУтратилаСилу = Форма.мДатаКонцаПериодаОтчета > КонецМесяца('20210831');
	...
	Иначе
		...
		НСтр("ru = 'Утратила силу. Основание: приказ ФНС России от 26.04.2021 № ЕД-7-15/418@';
			|en = 'Утратила силу. Основание: приказ ФНС России от 26.04.2021 № ЕД-7-15/418@'"),
