...
Процедура ПоказатьПериод(Форма)
	...
	Форма.НадписьКтоСдаетОтчет = НСтр("ru = 'Иностранные организации (абз.3 п.1 ст.246 НК РФ).';
										|en = 'Иностранные организации (абз.3 п.1 ст.246 НК РФ).'");
...
Процедура ВыбратьФорму(Команда)
	...
	ДопТекстОписания = НСтр("ru = 'Декларацию по налогу на прибыль иностранной организации представляют иностранные организации (абз.3 п.1 ст.246 НК РФ).';
							|en = 'Декларацию по налогу на прибыль иностранной организации представляют иностранные организации (абз.3 п.1 ст.246 НК РФ).'");
...
Функция ДоступныеОрганизацииОтсутствуютТекст()
	...
	|en = 'Декларацию по налогу на прибыль иностранной организации представляют только иностранные организации (абз.3 п.1 ст.246 НК РФ).
	|В справочнике ""Организации"" сведения об организациях отсутствуют.'");
