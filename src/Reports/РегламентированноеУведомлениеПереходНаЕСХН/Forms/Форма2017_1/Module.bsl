...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(Объект.Ссылка) Тогда 
		ЭтотОбъект["ДанныеУведомления"].Титульная.ПрЗаяв = "3";
	КонецЕсли;
...
Процедура ДоступностьПолей()
	...
	Если ПрЗаяв = "2" Или ПрЗаяв = "3" Или ПрЗаяв = "4" Тогда 
		...
		ДоступностьОбласти(ПредставлениеУведомления.Области.КПП, ЭтотОбъект["ЭтоЮЛ"]);
	Иначе
