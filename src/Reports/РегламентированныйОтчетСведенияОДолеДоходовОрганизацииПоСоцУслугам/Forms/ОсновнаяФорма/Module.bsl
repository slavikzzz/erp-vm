...
Функция ПолучитьСрокПредставленияОтчетности(Форма)
	...
	"ДФ=""дд ММММ гггг 'года'""") + " (п.6 ст.284.5 НК РФ)";
...
Процедура ВыбратьФорму(Команда)
	...
	ДопТекстОписания = НСтр("ru = 'Сведения о доле доходов организации по предоставлению социальных услуг представляют организации.';
							|en = 'Сведения о доле доходов организации по предоставлению социальных услуг представляют организации.'");
...
Функция ДоступныеОрганизацииОтсутствуютТекст()
	...
	Возврат НСтр(
	"ru = '""Сведения о доле доходов организации от осуществления деятельности по предоставлению социальных услуг гражданам в общей сумме доходов организации и о численности работников в штате организации"" представляют только организации.
	|В справочнике ""Организации"" сведения об организациях отсутствуют.';
	|en = '""Сведения о доле доходов организации от осуществления деятельности по предоставлению социальных услуг гражданам в общей сумме доходов организации и о численности работников в штате организации"" представляют только организации.
	|В справочнике ""Организации"" сведения об организациях отсутствуют.'");
