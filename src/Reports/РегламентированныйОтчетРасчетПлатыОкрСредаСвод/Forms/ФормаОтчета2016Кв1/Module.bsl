...
Процедура ПечатьНаСервере_Раздел3(МассивДляПроверки, ДП)
	Лист1 = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ПечатнаяФормаОтчета2016Кв1_Раздел3ч1");
	Лист2 = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ПечатнаяФормаОтчета2016Кв1_Раздел3ч2");
...
Процедура ПечатьНаСервере_Раздел3_1(МассивДляПроверки, ДП)
	Лист1 = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ПечатнаяФормаОтчета2016Кв1_Раздел3_1");
	ОблШапка1 = Лист1.ПолучитьОбласть("Шапка");
...
Процедура ПечатьНаСервере_Раздел1_12(МассивДляПроверки, ДП, ИмяРаздела)
	Макет = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ПечатнаяФормаОтчета2016Кв1_" + ИмяРаздела);
...
Процедура ПечатьНаСервере_Расчет(ДП)
	Лист = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ПечатнаяФормаОтчета2016Кв1_Расчет");
...
Процедура ПечатьНаСервере_Титульный(ДП)
	Лист = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ПечатнаяФормаОтчета2016Кв1_Титульный");
...
Процедура ЗагрузитьПоказателиИзМакета(Знач РазделВМакете)	
	...
	МакетСоставаПоказателей = ОбъектОтчета(ИмяФормы).ПолучитьМакет("Списки2016Кв1");
...
Процедура ВывестиМакетПрисоединенныеФайлы()
	ТабличныйДокумент.Очистить();
	ТабличныйДокумент.Вывести(ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_Приложения"));
	Макет = ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_Приложения");
...
Процедура ЗаполнитьАвто()
	...
	ТаблРасчет = ТаблицаСтраницыРасчет;
	ИндексСтраницы = 0;
