...
Процедура ПеренумерацияСтрокТаблицы(ПолеТабличногоДокументаФормаОтчета)
	...
	ПолеТабличногоДокументаФормаОтчета.Области["П001001000110_1"].Значение = "01";
	ПолеТабличногоДокументаФормаОтчета.Области["П002001000120_1"].Значение = "02";
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Сред(Область.Имя, 12, 2) = "03" Тогда
		ИмяСправочника = "s_okpd2_ceni_reg_prom_2024";
	...
	ИначеЕсли Сред(Область.Имя, 12, 2) = "04" Тогда
		ИмяСправочника = "s_ceni_reg_prom_okei_2024";
		НомСтр = Сред(Область.Имя, СтрНайти(Область.Имя, "_") + 1);
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "s_okpd2_ceni_reg_prom_2024",
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "s_ceni_reg_prom_okei_2024",
...
Функция СформироватьТекстПоГрафеА(ОбластьКодИмя)
	...
	Если ЗначениеЗаполнено(Графа2) Тогда
		...
		Если ЗначениеЗаполнено(Графа3) Тогда
			НаборСправочников.Отбор.Справочник.Установить("s_okpd2_ceni_reg_prom_2024");
