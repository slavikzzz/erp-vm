...
Функция СформироватьСтруктуруПараметров() Экспорт 
	...
	ИмяАтрибутов = ?(НачалоМесяца(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = НачалоМесяца(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета), "АтрибВыгрузкиXML2017Кв1_месяц", "АтрибВыгрузкиXML2017Кв1_год");
...
Функция ПолучитьПараметрыИнициализацииУниверсальногоОтчета(НеобходимоЗагрузитьШаблон = Истина, ФормироватьТекстВыгрузки = Истина) Экспорт 
	ИмяШаблона = ?(СтруктураРеквизитовФормы.мПериодичность = Перечисления.Периодичность.Месяц, "ШаблонРосстата2017Кв1_месяц", "ШаблонРосстата2017Кв1_год");
