...
Функция СформироватьСтруктуруПараметров() Экспорт 
	...
	ИмяАтрибутов = ?(НачалоМесяца(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = НачалоМесяца(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета), "АтрибВыгрузкиXML2016Кв1_месяц", "АтрибВыгрузкиXML2016Кв1_год");
...
Функция ПолучитьПараметрыИнициализацииУниверсальногоОтчета(НеобходимоЗагрузитьШаблон = Истина, ФормироватьТекстВыгрузки = Истина) Экспорт 
	ИмяШаблона = ?(СтруктураРеквизитовФормы.мПериодичность = Перечисления.Периодичность.Месяц, "ШаблонРосстата2016Кв1_месяц", "ШаблонРосстата2016Кв1_год");
	ИмяАтрибутов = ?(СтруктураРеквизитовФормы.мПериодичность = Перечисления.Периодичность.Месяц, "АтрибВыгрузкиXML2016Кв1_месяц", "АтрибВыгрузкиXML2016Кв1_год");
	...
	Попытка
		...
		Результат.Вставить("ИмяСхемы", "СхемаВыгрузкиXML2013Кв1");
