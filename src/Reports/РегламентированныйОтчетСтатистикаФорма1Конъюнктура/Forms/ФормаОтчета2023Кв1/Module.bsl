...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мКодОтчета = "0614001";
	...
	Если Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) <> 3 Тогда
		Для Гр = 1 По 2 Цикл
			Для НомСтр = 1 По 5 Цикл
				ПолеТабличногоДокументаФормаОтчета.Области["П000060100" + НомСтр + "0" + Гр].ЦветФона = Новый Цвет();
				ПолеТабличногоДокументаФормаОтчета.Области["П000060100" + НомСтр + "0" + Гр].Защита = Истина;
				ПолеТабличногоДокументаФормаОтчета.Области["П000060100" + НомСтр + "0" + Гр].Значение = "";
				ПолеТабличногоДокументаФормаОтчета.Области["П000060100" + НомСтр + "0" + Гр].Формат = "";
			КонецЦикла;
		КонецЦикла;
		
		Для НомСтр = 1 По 7 Цикл
			ПолеТабличногоДокументаФормаОтчета.Области["П000080100" + НомСтр + "01"].ЦветФона = Новый Цвет();
			ПолеТабличногоДокументаФормаОтчета.Области["П000080100" + НомСтр + "01"].Защита = Истина;
			ПолеТабличногоДокументаФормаОтчета.Области["П000080100" + НомСтр + "01"].Значение = "";
			ПолеТабличногоДокументаФормаОтчета.Области["П000080100" + НомСтр + "01"].Формат = "";
		КонецЦикла;
	КонецЕсли;
	
	Если Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) <> 12 Тогда
		Для НомСтр = 1 По 5 Цикл
			ПолеТабличногоДокументаФормаОтчета.Области["П000140100" + НомСтр + "01"].ЦветФона = Новый Цвет();
			ПолеТабличногоДокументаФормаОтчета.Области["П000140100" + НомСтр + "01"].Защита = Истина;
			ПолеТабличногоДокументаФормаОтчета.Области["П000140100" + НомСтр + "01"].Значение = "";
			ПолеТабличногоДокументаФормаОтчета.Области["П000140100" + НомСтр + "01"].Формат = "";
		КонецЦикла;
	КонецЕсли;
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли РегламентированнаяОтчетностьКлиент.ВыбраннаяОбластьРегламентированногоОтчетаНеВерна(ЭтаФорма, Область, СтандартнаяОбработка) Тогда
		Возврат;
	ИначеЕсли Область.Имя = "П000020100101" Тогда
		ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "СреднийОднодневныйТоварооборот");
	ИначеЕсли Область.Имя = "П000030100101" Тогда
		ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ОбъемСкладскихЗапасов");
	ИначеЕсли ТекГруппа = "П00004" Тогда
		ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ОценкаИзмененияФинансовыхПоказателей");
	ИначеЕсли ТекГруппа = "П00005" Тогда
		ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ОценкаИзмененияЦенРеализации");
	ИначеЕсли ТекГруппа = "П00006" Тогда
		Если Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 3 Тогда
			Если Прав(Область.Имя, 1) = "1" Тогда
				ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "РазмерДоли");
			ИначеЕсли Прав(Область.Имя, 1) = "2" Тогда
				ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "МестонахождениеПоставщиковТовара");
			КонецЕсли;
		КонецЕсли;
	ИначеЕсли ТекГруппа = "П00007" Тогда
		ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ВидРасчетовСПоставщиками");
	ИначеЕсли ТекГруппа = "П00008" Тогда
		Если Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 3 Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "НаправленияОтчисленияСредств");
		КонецЕсли;
	ИначеЕсли ТекГруппа = "П00009" Тогда
		ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ФакторыОграничивающиеДеятельность");
	ИначеЕсли ТекГруппа = "П00010" Тогда
		Если Область.Имя = "П000100100101" Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ОценкаОбщейЭкономическойСитуации");
		ИначеЕсли Область.Имя = "П000100100201" Или Область.Имя = "П000100100202" Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ОценкаТенденцииИзмененияЭкономическойСитуации");
		КонецЕсли;
	ИначеЕсли ТекГруппа = "П00011" Или ТекГруппа = "П00012" Тогда
		ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "СреднийУровеньТорговойНаценки");
	ИначеЕсли ТекГруппа = "П00013" Тогда
		ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "УдельныйВесПроданныхТоваров");
	ИначеЕсли ТекГруппа = "П00014" Тогда
		Если Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 12 Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "СостояниеКонкурентнойСреды");
		КонецЕсли;
	ИначеЕсли ТекГруппа = "П00015" Тогда
		ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ОценкаКонкурентоспособности");
	ИначеЕсли ТекГруппа = "П00016" Или ТекГруппа = "П00017" Тогда
		ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ДоляИмпортнойПродукции");
	КонецЕсли;
	
	Если (ПараметрВводаПоля <> Неопределено И ПараметрВводаПоля.ТаблицаЗначений <> Неопределено) И НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов Тогда
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВыбора = Неопределено Или СтруктураРеквизитовФормы.мАвтоВыборКодов Тогда
		Возврат;
	КонецЕсли;
...
Функция ПечатьНаСервере(ВидПечати)
	...
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "1-Конъюнктура");
	...
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ПустаяСтрока"));
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть1_6"));
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть1_8"));
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "1-Конъюнктура");
	
	ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть1_9"));
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть1_10"));
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть1_11"));
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "1-Конъюнктура");
	
	ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ПустаяСтрока"));
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть1_10"));
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть1_12"));
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть1_13"));
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть1_14"));
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "1-Конъюнктура");
	
	ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ПустаяСтрока"));
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть1_13"));
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть1_15"));
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "1-Конъюнктура");
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "СреднийОднодневныйТоварооборот",
		512, , "Выбор кода", КоллекцияСписковВыбора["СреднийОднодневныйТоварооборот"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ОбъемСкладскихЗапасов",
		512, , "Выбор кода", КоллекцияСписковВыбора["ОбъемСкладскихЗапасов"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ОценкаИзмененияФинансовыхПоказателей",
		512, , "Выбор кода", КоллекцияСписковВыбора["ОценкаИзмененияФинансовыхПоказателей"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ОценкаИзмененияЦенРеализации",
		512, , "Выбор кода", КоллекцияСписковВыбора["ОценкаИзмененияЦенРеализации"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "РазмерДоли",
		512, , "Выбор кода", КоллекцияСписковВыбора["РазмерДоли"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "МестонахождениеПоставщиковТовара",
		512, , "Выбор кода", КоллекцияСписковВыбора["МестонахождениеПоставщиковТовара"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ВидРасчетовСПоставщиками",
		512, , "Выбор кода", КоллекцияСписковВыбора["ВидРасчетовСПоставщиками"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "НаправленияОтчисленияСредств",
		512, , "Выбор кода", КоллекцияСписковВыбора["НаправленияОтчисленияСредств"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ФакторыОграничивающиеДеятельность",
		512, , "Выбор кода", КоллекцияСписковВыбора["ФакторыОграничивающиеДеятельность"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ОценкаОбщейЭкономическойСитуации",
		512, , "Выбор кода", КоллекцияСписковВыбора["ОценкаОбщейЭкономическойСитуации"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ОценкаТенденцииИзмененияЭкономическойСитуации",
		512, , "Выбор кода", КоллекцияСписковВыбора["ОценкаТенденцииИзмененияЭкономическойСитуации"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "СреднийУровеньТорговойНаценки",
		512, , "Выбор кода", КоллекцияСписковВыбора["СреднийУровеньТорговойНаценки"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "УдельныйВесПроданныхТоваров",
		512, , "Выбор кода", КоллекцияСписковВыбора["УдельныйВесПроданныхТоваров"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "СостояниеКонкурентнойСреды",
		512, , "Выбор кода", КоллекцияСписковВыбора["СостояниеКонкурентнойСреды"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ОценкаКонкурентоспособности",
		512, , "Выбор кода", КоллекцияСписковВыбора["ОценкаКонкурентоспособности"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ДоляИмпортнойПродукции",
		512, , "Выбор кода", КоллекцияСписковВыбора["ДоляИмпортнойПродукции"]);
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если Не ЗначениеЗаполнено(мДанныеОтчета.ПолеТабличногоДокументаФормаОтчета.П000010100101) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект,
			"Раздел 1 обязателен для заполнения.!", ИмяПоляТаблДокумента, "П000010100101");
		СтатусПроверки = Ложь;
	КонецЕсли;
