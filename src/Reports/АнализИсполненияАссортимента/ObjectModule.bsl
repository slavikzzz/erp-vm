...
Функция СформироватьОтчет()
	...
	ОбластьЗаголовок.Параметры.ЗаголовокОтчета = НСтр("ru = 'Анализ исполнения ассортимента';
														|en = 'Administration of product mix'")
	...
	ТекстПараметров = НСтр("ru = 'Дата отчета :';
							|en = 'Report date:'") + " " + ПараметрПериод;
	...
	Если ЭлементыОтбора.Количество() > 0 Тогда
		...
		Для Каждого ЭлементОтбора Из ЭлементыОтбора Цикл
			...
			Если ЛевоеЗначение = НСтр("ru = 'Ассортимент исполняется';
										|en = 'Product range is being performed'") Тогда
