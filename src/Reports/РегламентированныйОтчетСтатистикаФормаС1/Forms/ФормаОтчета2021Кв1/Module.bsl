		...
		Если ПараметрВводаПоля <> Неопределено И ПараметрВводаПоля.ТаблицаЗначений <> Неопределено Тогда
			...
			Иначе
				МассивВыбора = ПараметрВводаПоля.ТаблицаЗначений.НайтиСтроки(Новый Структура("ЕдиницаИзмерения",
					ПолеТабличногоДокументаФормаОтчета.Области["П000002001603_" + Сред(Область.Имя, 15)].Значение));
				ТЗВыбора.Очистить();
...
Процедура ВвестиПоказатель(Элемент, Область, КодПоказателя, Знач ЭтоСумма, Знач ТекстВыбора, ТаблицаВыбора, СтандартнаяОбработка, КолонкаПоиска = "Код") Экспорт
	...
	Если СтрНайти(Область.Имя, "П00000200") > 0 И СтрНайти(Область.Имя, "04") = 0  И СтрНайти(Область.Имя, "05") = 0 Тогда
		...
		ПараметрыФормы.Вставить("СтруктураДляПоиска", Новый Структура(
			КолонкаПоиска,
			ЭтаФорма[ТекущийЭлемент.Имя].Области["П000002" + Сред(Область.Имя, 8, 4) + "03" + Сред(Область.Имя, 14)].Значение));
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если СтрНайти(Область.Имя, "П00000200") > 0 Тогда
		Если Сред(Область.Имя, 12, 2) = "01" Тогда
			...
			Если ЭтаФорма[ТекущийЭлемент.Имя].Области[Лев(Область.Имя, 11) + "03" + Сред(Область.Имя, 14)].Значение
				<> Строка(РезультатВыбора["Код"]) Тогда
				ЭтаФорма[ТекущийЭлемент.Имя].Области[Лев(Область.Имя, 11) + "03" + Сред(Область.Имя, 14)].Значение
				= Строка(РезультатВыбора["Код"]);
				ЭтаФорма[ТекущийЭлемент.Имя].Области[Лев(Область.Имя, 11) + "05" + Сред(Область.Имя, 14)].Значение = "";
			КонецЕсли;
		КонецЕсли;
		Если Сред(Область.Имя, 12, 2) = "03" Тогда
			Если ЭтаФорма[ТекущийЭлемент.Имя].Области[Область.Имя].Значение <> Строка(РезультатВыбора["Код"]) Тогда
				ЭтаФорма[ТекущийЭлемент.Имя].Области[Область.Имя].Значение = Строка(РезультатВыбора["Код"]);
				ЭтаФорма[ТекущийЭлемент.Имя].Области[Лев(Область.Имя, 11) + "05" + Сред(Область.Имя, 14)].Значение = "";
			КонецЕсли;
			ЭтаФорма[ТекущийЭлемент.Имя].Области[Лев(Область.Имя, 11) + "01" + Сред(Область.Имя, 14)].Значение
			= ?(ЗначениеЗаполнено(РезультатВыбора["Код"]), Строка(РезультатВыбора["Название"]), "");
		КонецЕсли;
		// колонка 4
		Если Сред(Область.Имя, 12, 2) = "04" Тогда
