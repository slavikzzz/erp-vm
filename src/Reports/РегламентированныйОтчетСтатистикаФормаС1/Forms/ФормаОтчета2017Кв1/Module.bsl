...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "01/11/2016";
...
Процедура ОчиститьТабличноеПолеНаСервере()
	...
	ВыбТабличноеПоле.Вывести(ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет(
		"ФормаОтчета2017Кв1_ФормаОтчета"));
...
Функция СформироватьСтруктуруПараметров() Экспорт 
	...
	ИмяМакета = ?(Месяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета), "АтрибВыгрузкиXML2017Кв1_месяц", "АтрибВыгрузкиXML2017Кв1_год");
...
Функция ПолучитьИмяМакетаДереваВыгрузки()
	Если Месяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) Тогда 
		Возврат "СхемаВыгрузкиXML2017Кв1_месяц";
	Иначе 
		Возврат "СхемаВыгрузкиXML2017Кв1_год";
	КонецЕсли;
КонецФункции
...
Функция ПолучитьПараметрыИнициализацииУниверсальногоОтчета()
	Если Месяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) Тогда 
		ИмяСхемы = "СхемаВыгрузкиXML2017Кв1_месяц";
		ИмяМакета = "АтрибВыгрузкиXML2017Кв1_месяц";
		ИмяШаблона = "ШаблонРосстата2017Кв1_месяц";
	Иначе 
		ИмяСхемы = "СхемаВыгрузкиXML2017Кв1_год";
		ИмяМакета = "АтрибВыгрузкиXML2017Кв1_год";
		ИмяШаблона = "ШаблонРосстата2017Кв1_год";
	КонецЕсли;
