...
Процедура ИзменитьПериод(Форма, Шаг)
	...
	Если Форма.мДатаКонцаПериодаОтчета = КонецГода(Форма.мДатаКонцаПериодаОтчета) 
		И Форма.мДатаНачалаПериодаОтчета = НачалоМесяца(Форма.мДатаКонцаПериодаОтчета) 
		И Шаг = 1
		И Год(Форма.мДатаКонцаПериодаОтчета) <= 2020 Тогда
		
		Форма.мДатаНачалаПериодаОтчета = НачалоГода(Форма.мДатаКонцаПериодаОтчета);
	ИначеЕсли Форма.мДатаКонцаПериодаОтчета = КонецМесяца(Форма.мДатаНачалаПериодаОтчета) 
		И Форма.мДатаНачалаПериодаОтчета = НачалоГода(Форма.мДатаНачалаПериодаОтчета) 
		И Шаг = -1
		И Год(Форма.мДатаКонцаПериодаОтчета) <= 2021 Тогда
		
		Форма.мДатаКонцаПериодаОтчета  = КонецМесяца(ДобавитьМесяц(Форма.мДатаКонцаПериодаОтчета, Шаг));
		Форма.мДатаНачалаПериодаОтчета = НачалоГода(Форма.мДатаКонцаПериодаОтчета);
	ИначеЕсли Форма.мДатаКонцаПериодаОтчета = КонецГода(Форма.мДатаКонцаПериодаОтчета) 
		И Форма.мДатаНачалаПериодаОтчета = НачалоГода(Форма.мДатаНачалаПериодаОтчета) 
		И Шаг = -1
		И Год(Форма.мДатаКонцаПериодаОтчета) <= 2020 Тогда
