...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "14/09/2017";
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если Месяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) Тогда 
		ИмяМакета = "АтрибВыгрузкиXML2018Кв1_месяц";
	Иначе 
		ИмяМакета = "АтрибВыгрузкиXML2018Кв1_год";
	КонецЕсли;
...
Процедура ОчиститьТабличноеПолеНаСервере()
	...
	ВыбТабличноеПоле.Вывести(ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет(
		"ФормаОтчета2018Кв1_ФормаОтчета"));
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей,,,,,КоллекцияСписковВыбора["СправочникХарактерСтроительства"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей,,,,,КоллекцияСписковВыбора["СправочникМощностейРаздел2"]);
КонецПроцедуры
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если СтрНайти(Область.Имя, "П00000100") > 0 Тогда 
		Если Прав(Область.Имя, 2) = "01" Тогда
		...
		КонецЕсли;
		Если Прав(Область.Имя, 2) = "03" Тогда
		...
		КонецЕсли;
		// колонка 4
		Если Прав(Область.Имя, 2) = "04" Тогда
			ЭтаФорма[ТекущийЭлемент.Имя].Области[Область.Имя].Значение = Строка(РезультатВыбора["Код"]);
		КонецЕсли;
		// колонка 5
...
Функция СравнениеОтчетовНаСервере(ДанныеДляСравнения)
	...
	ДеревоДляСравнения = РегламентированнаяОтчетность.ПолучитьДеревоВыгрузки(ЭтаФорма, ПолучитьИмяМакетаДереваВыгрузки());
...
Функция УниверсальнаяВыгрузкаXMLПроверкаДанныхНаСервере(ТекстВыгрузки, ПараметрыВыгрузки) Экспорт
	...
	Если Месяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) Тогда 
		ИмяМакета = "АтрибВыгрузкиXML2018Кв1_месяц";
		ИмяШаблона = "ШаблонРосстата2018Кв1_месяц";
	Иначе 
		ИмяМакета = "АтрибВыгрузкиXML2018Кв1_год";
		ИмяШаблона = "ШаблонРосстата2018Кв1_год";
	КонецЕсли;
...
Функция СформироватьСтруктуруПараметров() Экспорт 
	...
	ИмяМакета = ?(Месяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета), "АтрибВыгрузкиXML2018Кв1_месяц", "АтрибВыгрузкиXML2018Кв1_год");
...
Функция ПолучитьИмяМакетаДереваВыгрузки()
	Если Месяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) Тогда 
		Возврат "СхемаВыгрузкиXML2018Кв1_месяц";
	Иначе 
		Возврат "СхемаВыгрузкиXML2018Кв1_год";
	КонецЕсли;
КонецФункции
...
Функция ПолучитьПараметрыИнициализацииУниверсальногоОтчета()
	Если Месяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) Тогда 
		ИмяСхемы = "СхемаВыгрузкиXML2018Кв1_месяц";
		ИмяМакета = "АтрибВыгрузкиXML2018Кв1_месяц";
		ИмяШаблона = "ШаблонРосстата2018Кв1_месяц";
	Иначе 
		ИмяСхемы = "СхемаВыгрузкиXML2018Кв1_год";
		ИмяМакета = "АтрибВыгрузкиXML2018Кв1_год";
		ИмяШаблона = "ШаблонРосстата2018Кв1_год";
	КонецЕсли;
