...
Процедура ИнициализироватьМногострочныеЧасти()
	...
	// Группа П12100.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П1210027");
	ИменаГраф.Добавить("П1210028");
	ИменаГраф.Добавить("П1210029");
	ИменаГраф.Добавить("П1210030");
	ИменаГраф.Добавить("П1210031");
	ИменаГраф.Добавить("П1210032");
	ИменаГраф.Добавить("П1210033");
	ИменаГраф.Добавить("П1210034");
	ИменаГраф.Добавить("П1210035");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
	...
	Если ТабличныйДокумент.Области.Найти(ИмяПервойГрафы + Координаты + "_1") = Неопределено Тогда
		...
		Для каждого ИмяГрафы Из МассивИменГраф Цикл
			Если ИмяГрафы = "П1000001"
				...
				ИЛИ ИмяГрафы = "П1200019"
				ИЛИ ИмяГрафы = "П1210028" Тогда
				Данные.Вставить(ИмяГрафы, "");
			ИначеЕсли ИмяГрафы = "П1000004"
				ИЛИ ИмяГрафы = "П1100012"
				ИЛИ ИмяГрафы = "П1200020"
				ИЛИ ИмяГрафы = "П1210029" Тогда
