...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "06/09/2013";
...
Процедура ДоступностьРазделов()
	...
	Если Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) <> 12 Тогда
		...
		// По графе 7 Раздела II.I.
		ПолеТабличногоДокументаФормаОтчета.Области["П000102000607"].ЦветФона = Новый Цвет();
		ПолеТабличногоДокументаФормаОтчета.Области["П000102000607"].Защита = Истина;
		ПолеТабличногоДокументаФормаОтчета.Области["П000102000807"].ЦветФона = Новый Цвет();
		ПолеТабличногоДокументаФормаОтчета.Области["П000102000807"].Защита = Истина;
		ПолеТабличногоДокументаФормаОтчета.Области["П000102001007"].ЦветФона = Новый Цвет();
		ПолеТабличногоДокументаФормаОтчета.Области["П000102001007"].Защита = Истина;
		ПолеТабличногоДокументаФормаОтчета.Области["П000102001107"].ЦветФона = Новый Цвет();
		ПолеТабличногоДокументаФормаОтчета.Области["П000102001107"].Защита = Истина;
		
		// По графе 12 Раздела II.I.
		ПолеТабличногоДокументаФормаОтчета.Области["П000102000612"].ЦветФона = Новый Цвет();
		ПолеТабличногоДокументаФормаОтчета.Области["П000102000612"].Защита = Истина;
		ПолеТабличногоДокументаФормаОтчета.Области["П000102001012"].ЦветФона = Новый Цвет();
		ПолеТабличногоДокументаФормаОтчета.Области["П000102001012"].Защита = Истина;
...
Процедура ВосстановитьСохраненныеДанные()
	...
	// Дополнительно, для Формы № 65-автотранс.
	// В случае подачи отчета не за год, если отчет скопирован,
	// очистим соотв. значения , установив исходный формат "ЧН='-'".
	Если СтруктураРеквизитовФормы.мСкопированаФорма <> Неопределено Тогда
		
		Если Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) <> 12 Тогда
			
			// По графе 7 Раздела II.I.
			ПолеТабличногоДокументаФормаОтчета.Области["П000102000607"].Значение = 0;
			ПолеТабличногоДокументаФормаОтчета.Области["П000102000607"].Формат =
				РегламентированнаяОтчетностьКлиентСервер.ЗаменитьПредставлениеНуляВСтрокеФормата(ПолеТабличногоДокументаФормаОтчета.Области["П000102000607"].Формат, "ЧН='-'");
			ПолеТабличногоДокументаФормаОтчета.Области["П000102000807"].Значение = 0;
			ПолеТабличногоДокументаФормаОтчета.Области["П000102000807"].Формат =
				РегламентированнаяОтчетностьКлиентСервер.ЗаменитьПредставлениеНуляВСтрокеФормата(ПолеТабличногоДокументаФормаОтчета.Области["П000102000807"].Формат, "ЧН='-'");
			ПолеТабличногоДокументаФормаОтчета.Области["П000102001007"].Значение = 0;
			ПолеТабличногоДокументаФормаОтчета.Области["П000102001007"].Формат =
				РегламентированнаяОтчетностьКлиентСервер.ЗаменитьПредставлениеНуляВСтрокеФормата(ПолеТабличногоДокументаФормаОтчета.Области["П000102001007"].Формат, "ЧН='-'");
			ПолеТабличногоДокументаФормаОтчета.Области["П000102001107"].Значение = 0;
			ПолеТабличногоДокументаФормаОтчета.Области["П000102001107"].Формат =
				РегламентированнаяОтчетностьКлиентСервер.ЗаменитьПредставлениеНуляВСтрокеФормата(ПолеТабличногоДокументаФормаОтчета.Области["П000102001107"].Формат, "ЧН='-'");
			
			// По графе 12 Раздела II.I.
			ПолеТабличногоДокументаФормаОтчета.Области["П000102000612"].Значение = 0;
			ПолеТабличногоДокументаФормаОтчета.Области["П000102000612"].Формат =
				РегламентированнаяОтчетностьКлиентСервер.ЗаменитьПредставлениеНуляВСтрокеФормата(ПолеТабличногоДокументаФормаОтчета.Области["П000102000612"].Формат, "ЧН='-'");
			ПолеТабличногоДокументаФормаОтчета.Области["П000102001012"].Значение = 0;
			ПолеТабличногоДокументаФормаОтчета.Области["П000102001012"].Формат =
				РегламентированнаяОтчетностьКлиентСервер.ЗаменитьПредставлениеНуляВСтрокеФормата(ПолеТабличногоДокументаФормаОтчета.Области["П000102001012"].Формат, "ЧН='-'");
...
Процедура ПриОткрытии(Отказ)
	...
	// Дополнительно, для Формы № 65-автотранс.
	ПолеТабличногоДокументаФормаОтчета.Области.ГодОтчетаВЗаголовокРазделаVI.Значение =
		"за январь-декабрь "
	  + Формат(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, "ДФ = 'гггг'")
	  + " года";
	ПолеТабличногоДокументаФормаОтчета.Области.ГодОтчетаВЗаголовокРазделаVII.Значение =
		"за январь-декабрь "
	  + Формат(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, "ДФ = 'гггг'")
	  + " года";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	// По разделу I.
	Для НомСтр = 3 По 4 Цикл
		ПолеТД.Области["П000001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "08"].Значение =
			  ПолеТД.Области["П000001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "10"].Значение
			+ ПолеТД.Области["П000001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "11"].Значение
			+ ПолеТД.Области["П000001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "12"].Значение
			+ ПолеТД.Области["П000001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "13"].Значение;
	КонецЦикла;
	Для НомСтр = 1 По 4 Цикл
		Если НомСтр = 2 Тогда
			Продолжить;
		Конецесли;
		ПолеТД.Области["П000001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "05"].Значение =
			  ПолеТД.Области["П000001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "06"].Значение
			+ ПолеТД.Области["П000001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "07"].Значение
			+ ПолеТД.Области["П000001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "08"].Значение;
	КонецЦикла;

	// По разделу II.I.
	Для НомСтр = 1 По 12 Цикл
		Если НомСтр = 1 Или НомСтр = 2 Или НомСтр = 6 Или НомСтр = 7 Или НомСтр = 10 Тогда
			ПолеТД.Области["П000102" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "05"].Значение =
				  ПолеТД.Области["П000102" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "06"].Значение
				+ ПолеТД.Области["П000102" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "08"].Значение
				+ ПолеТД.Области["П000102" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "09"].Значение
				+ ПолеТД.Области["П000102" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "10"].Значение
				+ ПолеТД.Области["П000102" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "11"].Значение;
		Иначе
			ПолеТД.Области["П000102" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "05"].Значение =
				  ПолеТД.Области["П000102" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "06"].Значение
				+ ПолеТД.Области["П000102" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "08"].Значение
	...
	// По разделу III.
	Для НомСтр = 1 По 4 Цикл
		ПолеТД.Области["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "03"].Значение =
			  ПолеТД.Области["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "04"].Значение
			+ ПолеТД.Области["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "05"].Значение
			+ ПолеТД.Области["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "06"].Значение
			+ ПолеТД.Области["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "07"].Значение
			+ ПолеТД.Области["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "08"].Значение
			+ ПолеТД.Области["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "09"].Значение
			+ ПолеТД.Области["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "10"].Значение
			+ ПолеТД.Области["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "11"].Значение;
	КонецЦикла;
	
	// По разделу V.
	// Графа 4.
	ПолеТД.Области["П000005000104"].Значение =
		+ ПолеТД.Области["П000001000105"].Значение
		+ ПолеТД.Области["П000102000105"].Значение
		+ ПолеТД.Области["П000202000105"].Значение
		+ ПолеТД.Области["П000004000105"].Значение
		+ ПолеТД.Области["П000004000106"].Значение;
	ПолеТД.Области["П000005000204"].Значение =
		+ ПолеТД.Области["П000001000205"].Значение
		+ ПолеТД.Области["П000102000405"].Значение
		+ ПолеТД.Области["П000202000305"].Значение
		+ ПолеТД.Области["П000004000205"].Значение
		+ ПолеТД.Области["П000004000206"].Значение;
	// Графа 5.
	Для НомСтр = 1 По 2 Цикл
		ПолеТД.Области["П000005" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "03"].Значение =
			  ПолеТД.Области["П000005" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "04"].Значение
			+ ПолеТД.Области["П000005" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "05"].Значение;
	КонецЦикла;
	
	// Раздел VI.
	Для НомСтр = 1 По 10 Цикл
		Если НомСтр >= 3 И НомСтр <= 5 Тогда
			Продолжить;
		Конецесли;
		ПолеТД.Области["П000006" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "04"].Значение =
			  ПолеТД.Области["П000006" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "07"].Значение
			+ ПолеТД.Области["П000006" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "08"].Значение
			+ ПолеТД.Области["П000006" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "09"].Значение;
	КонецЦикла;
	...
	Для НомСтр = 1 По 3 Цикл
		Если НомСтр = 2 Тогда
			Продолжить;
		Конецесли;
		ПолеТД.Области["П000007" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "05"].Значение =
			  ПолеТД.Области["П000007" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "06"].Значение
			+ ПолеТД.Области["П000007" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "08"].Значение
			+ ПолеТД.Области["П000007" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "09"].Значение
			+ ПолеТД.Области["П000007" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "10"].Значение;
	КонецЦикла;
...
Процедура ОчиститьОтчет(Команда)
	...
	ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Внимание! Все разделы отчета будут очищены.%1Продолжить операцию?';
																				|en = 'Внимание! Все разделы отчета будут очищены.%1Продолжить операцию?'"), Символы.ПС);
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	// Гр. 8 ≥ гр. 9.
	Для НомСтр = 3 По 4 Цикл
		Если ПараметрыВыгрузки["П000001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "08_Ч"]
		   < ПараметрыВыгрузки["П000001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "09_Ч"] Тогда
			СообщитьНомСтр = ?(НомСтр = 3, "120", "130");
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: в стр. " + СообщитьНомСтр
					+ " раздела I значение в по гр. 8 должно быть больше или равно значению по гр. 9!",
				ИмяПоляТаблДокумента, "П000001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "08");
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// По всем графам: если стр. 120  ≠ 0, то стр. 130 ≠ 0.
	Для НомКол = 5 По 13 Цикл
		Если ПараметрыВыгрузки["П0000010003" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] <> 0
		   И ПараметрыВыгрузки["П0000010004" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] = 0 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: если в разделе I по гр. " + Формат(НомКол, "ЧГ=")
					+ " значение в стр. 120 не равно нулю, то значение в стр. 130 тоже должно быть не равно нулю!",
				ИмяПоляТаблДокумента, "П0000010003" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// По гр. 5: если стр. 100 ≠ 0, то стр. 110 ≠ 0.
	Если ПараметрыВыгрузки["П000001000105_Ч"] <> 0 И ПараметрыВыгрузки["П000001000205_Ч"] = 0 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: если в разделе I по гр. 5 значение в стр. 100 не равно нулю, то значение в стр. 110 тоже должно быть не равно нулю!",
			ИмяПоляТаблДокумента, "П000001000105");
		СтатусПроверки = Ложь;
	КонецЕсли;
	//Раздел II.I.
	// По строкам 220, 223, 230, 232: гр. 6 ≥ гр. 7.
	Если ПараметрыВыгрузки["П000102000606_Ч"] < ПараметрыВыгрузки["П000102000607_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: в стр. 220 раздела II.I значение по гр. 6 должно быть больше или равно значению по гр. 7!",
			ИмяПоляТаблДокумента, "П000102000606");
		СтатусПроверки = Ложь;
	КонецЕсли;
	Если ПараметрыВыгрузки["П000102000806_Ч"] < ПараметрыВыгрузки["П000102000807_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: в стр. 223 раздела II.I значение по гр. 6 должно быть больше или равно значению по гр. 7!",
			ИмяПоляТаблДокумента, "П000102000806");
		СтатусПроверки = Ложь;
	КонецЕсли;
	Если ПараметрыВыгрузки["П000102001006_Ч"] < ПараметрыВыгрузки["П000102001007_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: в стр. 230 раздела II.I значение по гр. 6 должно быть больше или равно значению по гр. 7!",
			ИмяПоляТаблДокумента, "П000102001006");
		СтатусПроверки = Ложь;
	КонецЕсли;
	Если ПараметрыВыгрузки["П000102001106_Ч"] < ПараметрыВыгрузки["П000102001107_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: в стр. 232 раздела II.I значение по гр. 6 должно быть больше или равно значению по гр. 7!",
			ИмяПоляТаблДокумента, "П000102001106");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// По строкам 220, 230: гр. 5 ≥ гр. 12.
	Если ПараметрыВыгрузки["П000102000605_Ч"] < ПараметрыВыгрузки["П000102000612_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: в стр. 220 раздела II.I значение по гр. 5 должно быть больше или равно значению по гр. 12!",
			ИмяПоляТаблДокумента, "П000102000605");
		СтатусПроверки = Ложь;
	КонецЕсли;
	Если ПараметрыВыгрузки["П000102001005_Ч"] < ПараметрыВыгрузки["П000102001012_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: в стр. 230 раздела II.I значение по гр. 5 должно быть больше или равно значению по гр. 12!",
			ИмяПоляТаблДокумента, "П000102001005");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// По всем графам: если стр. 220 ≠ 0, то стр. 230 ≠ 0.
	Для НомКол = 5 По 12 Цикл
		Если ПараметрыВыгрузки["П0001020006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] <> 0
		   И ПараметрыВыгрузки["П0001020010" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] = 0 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: если в разделе II.I по гр. " + Формат(НомКол, "ЧГ=")
					+ " значение в стр. 220 не равно нулю, то значение в стр. 230 тоже должно быть не равно нулю!",
				ИмяПоляТаблДокумента, "П0001020006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// По всем графам: если стр. 223 ≠ 0, то стр. 232 ≠ 0.
	Для НомКол = 5 По 9 Цикл
		Если ПараметрыВыгрузки["П0001020008" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] <> 0
		   И ПараметрыВыгрузки["П0001020011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] = 0 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: если в разделе II.I по гр. " + Формат(НомКол, "ЧГ=")
					+ " значение в стр. 223 не равно нулю, то значение в стр. 232 тоже должно быть не равно нулю!",
				ИмяПоляТаблДокумента, "П0001020008" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// По графам 5, 6, 8, 9, 10, 11: стр. 220 ≥ стр. 222.
	Для НомКол = 5 По 11 Цикл
		Если НомКол = 7 Тогда
			Продолжить;
		КонецЕсли;
		Если ПараметрыВыгрузки["П0001020006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
		   < ПараметрыВыгрузки["П0001020007" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: в разделе II.I по гр. " + Формат(НомКол, "ЧГ=")
					+ " значение в стр. 220 должно быть больше или равно значению в стр. 222!",
				ИмяПоляТаблДокумента, "П0001020006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// По графам 5, 6, 8, 9, 10, 11: стр. 200 ≥ стр. 202.
	Для НомКол = 5 По 11 Цикл
		Если НомКол = 7 Тогда
			Продолжить;
		КонецЕсли;
		Если ПараметрыВыгрузки["П0001020001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
		   < ПараметрыВыгрузки["П0001020002" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: в разделе II.I по гр. " + Формат(НомКол, "ЧГ=")
					+ " значение в стр. 200 должно быть больше или равно значению в стр. 202!",
				ИмяПоляТаблДокумента, "П0001020001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// По графам 5, 6, 8, 9: стр. 200 ≥ стр. 203.
	Для НомКол = 5 По 9 Цикл
		Если НомКол = 7 Тогда
			Продолжить;
		КонецЕсли;
		Если ПараметрыВыгрузки["П0001020001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
		   < ПараметрыВыгрузки["П0001020003" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: в разделе II.I по гр. " + Формат(НомКол, "ЧГ=")
					+ " значение в стр. 200 должно быть больше или равно значению в стр. 203!",
				ИмяПоляТаблДокумента, "П0001020001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// Раздел IV.
	// По графе 5: стр. 420 ≥ 421.
	Если ПараметрыВыгрузки["П000004000305_Ч"] < ПараметрыВыгрузки["П000004000405_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: по гр. 5 раздела IV значение в стр. 420 должно быть больше или равно значению в стр. 421!",
			ИмяПоляТаблДокумента, "П000004000305");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// По графам 5, 6: если стр. 420 ≠ 0, то стр. 400, 410 ≠ 0.
	Для НомКол = 5 По 6 Цикл
		Если ПараметрыВыгрузки["П0000040003" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] <> 0
		  И (ПараметрыВыгрузки["П0000040001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] = 0
		 Или ПараметрыВыгрузки["П0000040002" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] = 0) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: если по гр. " + Формат(НомКол, "ЧГ=")
					+ " раздела IV значение в стр. 420 не равно нулю, то значения в стр. 400 и 410 тоже должны быть не равны нулю!",
				ИмяПоляТаблДокумента, "П0000040003" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// Раздел VI.
	// По гр. 3, 4, 5, 6: стр. 610 ≥ стр. 611.
	Для НомКол = 3 По 6 Цикл
		Если ПараметрыВыгрузки["П0000060001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
		   < ПараметрыВыгрузки["П0000060002" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: в разделе VI по гр. " + Формат(НомКол, "ЧГ=")
					+ " значение в стр. 610 должно быть больше или равно значению в стр. 611!",
				ИмяПоляТаблДокумента, "П0000060001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// По гр. 3, 4, 5, 6: стр. 650 ≥ стр. 651.
	Для НомКол = 3 По 6 Цикл
		Если ПараметрыВыгрузки["П0000060006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
		   < ПараметрыВыгрузки["П0000060007" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: в разделе VI по гр. " + Формат(НомКол, "ЧГ=")
					+ " значение в стр. 650 должно быть больше или равно значению в стр. 651!",
				ИмяПоляТаблДокумента, "П0000060006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// По гр. 3, 4, 5, 6: стр. 660 ≥ стр. 661.
	Для НомКол = 3 По 6 Цикл
		Если ПараметрыВыгрузки["П0000060009" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
		   < ПараметрыВыгрузки["П0000060010" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: в разделе VI по гр. " + Формат(НомКол, "ЧГ=")
					+ " значение в стр. 660 должно быть больше или равно значению в стр. 661!",
				ИмяПоляТаблДокумента, "П0000060009" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// Раздел VII.
	// По стр. 670, 672: гр. 6 ≥ гр. 7.
	Если ПараметрыВыгрузки["П000007000106_Ч"] < ПараметрыВыгрузки["П000007000107_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: в стр. 670 раздела VII значение по гр. 6 должно быть больше или равно значению по гр. 7!",
			ИмяПоляТаблДокумента, "П000007000106");
		СтатусПроверки = Ложь;
	КонецЕсли;
	Если ПараметрыВыгрузки["П000007000306_Ч"] < ПараметрыВыгрузки["П000007000307_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: в стр. 672 раздела VII значение по гр. 6 должно быть больше или равно значению по гр. 7!",
			ИмяПоляТаблДокумента, "П000007000306");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// Стр. 670 гр. 5 ≥ стр. 671 гр. 5.
	Если ПараметрыВыгрузки["П000007000105_Ч"] < ПараметрыВыгрузки["П000007000205_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: по гр. 5 раздела VII значение в стр. 670 должно быть больше или равно значению в стр. 671!",
			ИмяПоляТаблДокумента, "П000007000105");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// Стр. 672 гр. 5 ≥ стр. 673 гр. 5.
	Если ПараметрыВыгрузки["П000007000305_Ч"] < ПараметрыВыгрузки["П000007000405_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: по гр. 5 раздела VII значение в стр. 672 должно быть больше или равно значению в стр. 673!",
			ИмяПоляТаблДокумента, "П000007000305");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// Если стр. 671 гр. 5 ≠ 0, то стр. 673 гр. 5 ≠ 0.
	Если ПараметрыВыгрузки["П000007000205_Ч"] <> 0 И ПараметрыВыгрузки["П000007000405_Ч"] = 0 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: если по гр. 5 раздела VII значение в стр. 671 не равно нулю, то значение в стр. 673 тоже должно быть не равно нулю!",
			ИмяПоляТаблДокумента, "П000007000205");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// По всем графам: если стр. 670 ≠ 0, то стр. 672 ≠ 0.
		Для НомКол = 5 По 10 Цикл
		Если ПараметрыВыгрузки["П0000070001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] <> 0
		   И ПараметрыВыгрузки["П0000070003" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] = 0 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: если в разделе VII по гр. " + Формат(НомКол, "ЧГ=")
					+ " значение в стр. 670 не равно нулю, то значение в стр. 672 тоже должно быть не равно нулю!",
				ИмяПоляТаблДокумента, "П0000070001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	
	// Контроль равенств (согласно информации в графе 1 Раздела III).
	Если ПараметрыВыгрузки["П000003000103_Ч"] <> ПараметрыВыгрузки["П000102000405_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: значение в стр. 300 по гр. 3 должно быть равно значению в стр. 210 по гр. 5!",
			ИмяПоляТаблДокумента, "П000003000103");
		СтатусПроверки = Ложь;
	КонецЕсли;
	Если ПараметрыВыгрузки["П000003000203_Ч"] <> ПараметрыВыгрузки["П000102000406_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: значение в стр. 311 по гр. 3 должно быть равно значению в стр. 210 по гр. 6!",
			ИмяПоляТаблДокумента, "П000003000203");
		СтатусПроверки = Ложь;
	КонецЕсли;
	Если ПараметрыВыгрузки["П000003000303_Ч"] <> ПараметрыВыгрузки["П000102000408_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: значение в стр. 312 по гр. 3 должно быть равно значению в стр. 210 по гр. 8!",
			ИмяПоляТаблДокумента, "П000003000303");
		СтатусПроверки = Ложь;
	КонецЕсли;
	Если ПараметрыВыгрузки["П000003000403_Ч"] <> ПараметрыВыгрузки["П000001000205_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: значение в стр. 313 по гр. 3 должно быть равно значению в стр. 110 по гр. 5!",
			ИмяПоляТаблДокумента, "П000003000403");
		СтатусПроверки = Ложь;
	КонецЕсли;
...
Функция СформироватьСтруктуруПараметров()
	...
	// Возможные значения, согласно шаблону Росстата: 3, 6, 9, 12.
	...
	Для НомСтр = 1 По 2 Цикл
		НомКол = 3;
		Пока РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(ТабДокумент, "П000005" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")) Цикл
			ПараметрыВыгрузки.Вставить("П000005" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч",
				   ТабДокумент["П000005" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]);
			НомКол = НомКол + 1;
		КонецЦикла;
	КонецЦикла;
	// Раздел VI.
	Для НомСтр = 1 По 10 Цикл
		...
		Пока РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(ТабДокумент, "П000006" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")) Цикл
			ПараметрыВыгрузки.Вставить("П000006" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч",
				   ТабДокумент["П000006" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]);
			НомКол = НомКол + 1;
		КонецЦикла;
	КонецЦикла;
	// Раздел VII.
	Для НомСтр = 1 По 4 Цикл
		...
		Пока РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(ТабДокумент, "П000007" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")) Цикл
			ПараметрыВыгрузки.Вставить("П000007" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч",
				   ТабДокумент["П000007" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]);
			НомКол = НомКол + 1;
		КонецЦикла;
	КонецЦикла;
