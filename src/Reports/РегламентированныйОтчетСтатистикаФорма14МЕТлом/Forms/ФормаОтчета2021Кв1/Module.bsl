...
Процедура ПоказатьПериод()
	...
	СтрПериод2 = Формат(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета + 1, "ДФ=yyyy");
	...
	ПолеТабличногоДокументаФормаОтчета.Области.ПериодОтчета2.Значение = 
		"Остаток на 01.01." + Символы.ПС + СтрПериод + ", т";
	
	ПолеТабличногоДокументаФормаОтчета.Области.ПериодОтчета3.Значение = 
		"Остаток на 01.01." + Символы.ПС + СтрПериод2;
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Для НомСтр = 201 По 202 Цикл
		Области["П0000210" + НомСтр + "03"].Значение
		= Области["П0000210" + НомСтр + "04"].Значение
		+ Области["П0000210" + НомСтр + "06"].Значение
		+ Области["П0000210" + НомСтр + "08"].Значение;
		
		Области["П0000210" + НомСтр + "09"].Значение
		= Области["П0000110" + НомСтр + "03"].Значение
		+ Области["П0000110" + НомСтр + "04"].Значение
		- Области["П0000210" + НомСтр + "03"].Значение;
	КонецЦикла;
	
	Для НомСтр = 100 По 106 Цикл
		Области["П00002" + НомСтр + "0003"].Значение
		= Области["П00002" + НомСтр + "0004"].Значение
		+ Области["П00002" + НомСтр + "0006"].Значение
		+ Области["П00002" + НомСтр + "0008"].Значение;
		
		Области["П00002" + НомСтр + "0009"].Значение
		= Области["П00001" + НомСтр + "0003"].Значение
		+ Области["П00001" + НомСтр + "0004"].Значение
		- Области["П00002" + НомСтр + "0003"].Значение;
	КонецЦикла;
	
	Для НомСтр = 101 По 103 Цикл
		Области["П0000220" + НомСтр + "03"].Значение
		= Области["П0000220" + НомСтр + "04"].Значение
		+ Области["П0000220" + НомСтр + "06"].Значение
		+ Области["П0000220" + НомСтр + "08"].Значение;
		
		Области["П0000220" + НомСтр + "09"].Значение
		= Области["П0000120" + НомСтр + "03"].Значение
		+ Области["П0000120" + НомСтр + "04"].Значение
		- Области["П0000220" + НомСтр + "03"].Значение;
	КонецЦикла;
	...
	Для Раздел = 1 По 2 Цикл
		НомКолКон = ?(Раздел = 1, 11, 9);
		
		// Данные по строке 10200 должны быть равны сумме данных строк 10201, 10202.
		Для НомКол = 3 По НомКолКон Цикл
			ТекСумма = 0;
			Для НомСтр = 201 По 202 Цикл
				ТекСумма = ТекСумма + Области["П0000" + Раздел + "10" + НомСтр + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение;
			КонецЦикла;
			Области["П0000" + Раздел + "10200" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение = ТекСумма;
		КонецЦикла;
		...
		Для НомКол = 3 По НомКолКон Цикл
			...
			Для НомСтр = 101 По 106 Цикл
				ТекСумма = ТекСумма + Области["П0000" + Раздел + НомСтр + Формат(НомКол, "ЧЦ=4; ЧВН=; ЧГ=")].Значение;
			КонецЦикла;
			Области["П0000" + Раздел + "10000" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение = ТекСумма;
		КонецЦикла;
		
		// Данные по строке 20100 должны быть равны сумме данных строк 20101, 20102, 20103 по соответствующим графам.
		Для НомКол = 3 По НомКолКон Цикл
			Области["П0000" + Раздел + "20100" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение
			= Области["П0000" + Раздел + "20101" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение
			+ Области["П0000" + Раздел + "20102" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение
			+ Области["П0000" + Раздел + "20103" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение;
		КонецЦикла;
		
		// Данные по строке 20200 должны быть равны сумме данных строк 20201 и 20202 по соответствующим графам.
		Для НомКол = 3 По НомКолКон Цикл
			Области["П0000" + Раздел + "20200" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение
			= Области["П0000" + Раздел + "20201" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение
			+ Области["П0000" + Раздел + "20202" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение;
		КонецЦикла;
		
		// Данные по строке 20301 должны быть равны сумме данных строк 20302 и 20303 по соответствующим графам.
		Для НомКол = 3 По НомКолКон Цикл
			Области["П0000" + Раздел + "20301" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение
			= Области["П0000" + Раздел + "20302" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение
			+ Области["П0000" + Раздел + "20303" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение;
		КонецЦикла;
		
		// Данные по строке 20300 должны быть равны сумме данных строк 20301 и 20304 по соответствующим графам.
		Для НомКол = 3 По НомКолКон Цикл
			Области["П0000" + Раздел + "20300" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение
			= Области["П0000" + Раздел + "20301" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение
			+ Области["П0000" + Раздел + "20304" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение;
		КонецЦикла;
		...
		Для НомКол = 3 По НомКолКон Цикл
			...
			Для НомСтр = 201 По 207 Цикл
				ТекСумма = ТекСумма + Области["П0000" + Раздел + НомСтр + Формат(НомКол, "ЧЦ=4; ЧВН=; ЧГ=")].Значение;
			КонецЦикла;
			Области["П0000" + Раздел + "20000" + Формат(НомКол, "ЧЦ=2; ЧВН=")].Значение = ТекСумма;
		КонецЦикла;
	КонецЦикла;
...
Процедура УстановитьЗащитуИЦветФонаОбластейАвторассчитываемыхПоказателей()
	...
	Для Гр = 3 По 11 Цикл
		ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П0000110000" + Формат(Гр, "ЧЦ=2; ЧВН=") + ";";
		ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П0000110200" + Формат(Гр, "ЧЦ=2; ЧВН=") + ";";
		ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П0000120000" + Формат(Гр, "ЧЦ=2; ЧВН=") + ";";
		ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П0000120100" + Формат(Гр, "ЧЦ=2; ЧВН=") + ";";
		ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П0000120200" + Формат(Гр, "ЧЦ=2; ЧВН=") + ";";
		ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П0000120300" + Формат(Гр, "ЧЦ=2; ЧВН=") + ";";
		ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П0000120301" + Формат(Гр, "ЧЦ=2; ЧВН=") + ";";
	КонецЦикла;
	
	Для Стр = 100 По 106 Цикл
		Если Стр = 100 или Стр = 102 Тогда
			Для Гр = 3 По 9 Цикл
				ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П00002" + Стр + Формат(Гр, "ЧЦ=4; ЧВН=; ЧГ=") + ";";
			КонецЦикла;
		Иначе
			ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П00002" + Стр + "0003;";
			ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П00002" + Стр + "0009;";
		КонецЕсли;
	КонецЦикла;
	
	ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П000021020103;";
	ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П000021020109;";
	ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П000021020203;";
	ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П000021020209;";
	
	Для Стр = 200 ПО 207 Цикл
		Если Стр = 200 или Стр = 201 Или Стр = 202 Или Стр = 203 Тогда
			Для Гр = 3 По 9 Цикл
				ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П00002" + Стр + Формат(Гр, "ЧЦ=4; ЧВН=; ЧГ=") + ";";
			КонецЦикла;
			Если Стр = 201 Тогда
				Для Н = 1 По 2 Цикл
					ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П00002201010" + ?(Н = 1, 3, 9) + ";";
					ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П00002201020" + ?(Н = 1, 3, 9) + ";";
					ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П00002201030" + ?(Н = 1, 3, 9) + ";";
				КонецЦикла;
			ИначеЕсли Стр = 202 Тогда
				Для Н = 1 По 2 Цикл
					ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П00002202010" + ?(Н = 1, 3, 9) + ";";
					ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П00002202020" + ?(Н = 1, 3, 9) + ";";
				КонецЦикла;
			ИначеЕсли Стр = 203 Тогда
				Для Гр = 3 По 9 Цикл
					ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П00002203010" + Гр + ";";
				КонецЦикла;
				Для Н = 1 По 2 Цикл
					ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П00002203020" + ?(Н = 1, 3, 9) + ";";
					ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П00002203030" + ?(Н = 1, 3, 9) + ";";
					ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П00002203040" + ?(Н = 1, 3, 9) + ";";
				КонецЦикла;
			КонецЕсли;
		Иначе
			ЯчейкиАвторасчета = ЯчейкиАвторасчета + "П00002" + Стр + "0003;";
...
Процедура ОчиститьТабличноеПолеНаСервере()
	...
	СписокПоказателей.Добавить(ВыбТабПоле.Области["ПериодОтчета2"].Значение,             "ПериодОтчета2");
	СписокПоказателей.Добавить(ВыбТабПоле.Области["ПериодОтчета3"].Значение,             "ПериодОтчета3");
...
Функция ПечатьНаСервере(ВидПечати)
	...
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 14-МЕТ (лом)");
...
Процедура ГиперссылкаНаименованиеЭтапаНажатие(Элемент)
	...
	ПараметрыИзменения.Вставить("Форма", 
								ЭтотОбъект);
	ПараметрыИзменения.Вставить("Организация", 
