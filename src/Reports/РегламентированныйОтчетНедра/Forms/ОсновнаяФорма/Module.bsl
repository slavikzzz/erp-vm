...
Процедура ОткрытьФормуОтчета(Команда)
	...
	Если мСкопированаФорма <> Неопределено Тогда
		...
		ИначеЕсли Год(мДатаКонцаПериодаОтчета) < 2022 И Год(ДатаКонцаПериодаСохраненногоДокумента()) >= 2022 Тогда
			
			ПоказатьПредупреждение(,НСтр("ru = 'Формат отчета изменился, копирование невозможно!';
										|en = 'Формат отчета изменился, копирование невозможно!'"));
			Возврат;
...
&НаСервере
Функция ДатаКонцаПериодаСохраненногоДокумента()
	
	Возврат мСохраненныйДок.ДатаОкончания;
