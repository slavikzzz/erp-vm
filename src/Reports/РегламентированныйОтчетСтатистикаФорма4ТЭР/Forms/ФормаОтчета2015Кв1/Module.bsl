...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Для Стр = 0 По 9 Цикл
		...
		Области["П000003188" + Стр + "01"].Значение = Области["П000003188" + Стр + "02"].Значение + Области["П000003188" + Стр + "03"].Значение + 
														Области["П000003188" + Стр + "04"].Значение + Области["П000003188" + Стр + "05"].Значение;
	КонецЦикла;
