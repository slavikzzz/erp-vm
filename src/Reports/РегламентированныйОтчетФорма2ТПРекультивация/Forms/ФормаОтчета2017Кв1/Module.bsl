...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "25/12/2018";
	// Код отчета, равен коду по ОКУД.
	СтруктураРеквизитовФормы.мКодОтчета = "1825000";
	
	// ОПИСАНИЕ ПАРАМЕТРОВ МНОГОСТРОЧНЫХ ГРУПП
	// Идентификаторы многострочных групп.
	СтруктураРеквизитовФормы.мИдГруппы1 = "П0000020001";
	СтруктураРеквизитовФормы.мИдГруппы2 = "П0000030001";
	...
	мСтруктураКолвоКолонокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы1, 14);
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ВПрограммеИзмененаДатаПодписи = Ложь)
	...
	Если Форма.СтруктураРеквизитовФормы.ЭтоЮрЛицо Тогда 
		ОргСведения.Свойство("КППЮЛ", СвойствоИтер);
		Форма.ПолеТабличногоДокументаФормаОтчета.Области.KPP.Значение = СвойствоИтер;
		ОргСведения.Свойство("ИННЮЛ", СвойствоИтер);
		Форма.ПолеТабличногоДокументаФормаОтчета.Области.INN_ORG.Значение = СвойствоИтер;
		Форма.ПолеТабличногоДокументаФормаОтчета.Области.INN.Значение = СвойствоИтер;
		ОргСведения.Свойство("НаимЮЛПол", СвойствоИтер);
		Форма.ПолеТабличногоДокументаФормаОтчета.Области.FNAME_ORG.Значение = СвойствоИтер;
		Форма.ПолеТабличногоДокументаФормаОтчета.Области.FNAME.Значение = СвойствоИтер;
		ОргСведения.Свойство("НаимЮЛСокр", СвойствоИтер);
		Форма.ПолеТабличногоДокументаФормаОтчета.Области.SNAME_ORG.Значение = СвойствоИтер;
		Форма.ПолеТабличногоДокументаФормаОтчета.Области.SNAME.Значение = СвойствоИтер;
	Иначе
		ОргСведения.Свойство("ИННФЛ", СвойствоИтер);
		Форма.ПолеТабличногоДокументаФормаОтчета.Области.INN_ORG.Значение = СвойствоИтер;
		Форма.ПолеТабличногоДокументаФормаОтчета.Области.INN.Значение = СвойствоИтер;
		ОргСведения.Свойство("ФИО", СвойствоИтер);
		Форма.ПолеТабличногоДокументаФормаОтчета.Области.FNAME_ORG.Значение = СвойствоИтер;
		Форма.ПолеТабличногоДокументаФормаОтчета.Области.FNAME.Значение = СвойствоИтер;
		Форма.ПолеТабличногоДокументаФормаОтчета.Области.SNAME_ORG.Значение = СвойствоИтер;
		Форма.ПолеТабличногоДокументаФормаОтчета.Области.SNAME.Значение = СвойствоИтер;
	КонецЕсли;
	ОргСведения.Свойство("ОГРН", СвойствоИтер);
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.OGRN.Значение = СвойствоИтер;
	ОргСведения.Свойство("ОКПО", СвойствоИтер);
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.OKPO_ORG.Значение = СвойствоИтер;
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.OKPO.Значение = СвойствоИтер;
	ОргСведения.Свойство("ОКВЭД2", СвойствоИтер);
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.П000003000101_1.Значение = СвойствоИтер;
	ОргСведения.Свойство("ОКАТО", СвойствоИтер);
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.ADDJ_OKATO.Значение = СвойствоИтер;
	ОргСведения.Свойство("ОргИндекс", СвойствоИтер);
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.ADDJ_INDEX.Значение = СвойствоИтер;
	
	ОргСведения.Свойство("ФИОРук", СвойствоИтер);
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.CHIEF_ORG.Значение = СвойствоИтер;
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.CHIEF.Значение = СвойствоИтер;
	ОргСведения.Свойство("ДолжнРук", СвойствоИтер);
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.CHIEF_POST.Значение = СвойствоИтер;
	ОргСведения.Свойство("ТелРук", СвойствоИтер);
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.PHONE_CHIEF.Значение = СвойствоИтер;
	ОргСведения.Свойство("ФИОБух", СвойствоИтер);
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.ACNTG.Значение = СвойствоИтер;
	ОргСведения.Свойство("ТелБух", СвойствоИтер);
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.PHONE_ACNTG.Значение = СвойствоИтер;
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.DOC_YEAR.Значение = Год(Форма.ДатаПодписи);
	ОргСведения.Свойство("ДатаРегистрации", СвойствоИтер);
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.REG_DATE.Значение = СвойствоИтер;
...
Процедура ДобавитьСтроку(Команда, ОбластьИмя)
	#Если ВебКлиент Тогда
		ДобавитьСтрокуНаСервере("ФормаОтчета", ОбластьИмя);
	#Иначе
		ДобавитьСтрокуНаКлиенте("ФормаОтчета", ОбластьИмя);
	#КонецЕсли
КонецПроцедуры

&НаСервере
Процедура ДобавитьСтрокуНаСервере(КолонкаРазделыОтчетаСокрНаим, ОбластьИмя)
	ВставитьДополнительнуюСтроку(ЭтаФорма,КолонкаРазделыОтчетаСокрНаим, ОбластьИмя);
КонецПроцедуры

&НаКлиенте
Процедура ДобавитьСтрокуНаКлиенте(КолонкаРазделыОтчетаСокрНаим, ОбластьИмя)
	ВставитьДополнительнуюСтроку(ЭтаФорма, КолонкаРазделыОтчетаСокрНаим, ОбластьИмя);
КонецПроцедуры
...
&НаКлиентеНаСервереБезКонтекста
Процедура ВставитьДополнительнуюСтроку(Форма, ТекущаяСтраница, ОбластьИмя)
	Перем СтруктураГруппы;
	Перем МаксимальноеКоличествоСтрокГруппы;
	
	ИмяГруппы = ?(Прав(ОбластьИмя, 1) = "1", "П0000020001", "П0000030001");
...
Процедура УдалитьСтрокуЗавершение(Ответ, ДополнительныеПараметры) Экспорт
	...
	#Если ВебКлиент Тогда
		УдалитьДополнительнуюСтрокуНаСервере("ФормаОтчета", ДополнительныеПараметры.ИмяГруппы);
	#Иначе
		УдалитьДополнительнуюСтрокуНаКлиенте("ФормаОтчета", ДополнительныеПараметры.ИмяГруппы);
	#КонецЕсли
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли СтрЧислоВхождений(Область.Имя, "УдалитьСтроку") > 0 Тогда
		...
		Модифицированность = Истина;
		СтандартнаяОбработка = Ложь;
	ИначеЕсли Область.Имя = "СгенерироватьИдентификатор" Тогда
		ПолеТабличногоДокументаФормаОтчета.Области.ID_ORG.Значение = Строка(Новый УникальныйИдентификатор);
		СтандартнаяОбработка = Ложь;
		Модифицированность = Истина;
	ИначеЕсли (Не (Область.Защита = Истина)) И СтрНайти(Область.Имя, "_") = 14 И СтруктураРеквизитовФормы.мАвтоВыборКодов = Ложь Тогда 
		Если СтрНайти(Область.Имя, "П000002000101") = 1 Тогда 
			
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "LANDS_DISTURB_TYPE");
	...
	ИначеЕсли Область.Имя = "ORG_SCALE" Тогда
		ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "ORG_SCALE");
		ВвестиПоказатель(Область, ПараметрВводаПоля.Показатель, ПараметрВводаПоля.ТекстПриВыборе,
						ПараметрВводаПоля.ТаблицаЗначений, СтандартнаяОбработка);
	ИначеЕсли Область.Имя = "SEP_DIV" Или Область.Имя = "FINDIVID" Тогда
		Область.Значение = Не Область.Значение;
		СтандартнаяОбработка = Ложь;
	ИначеЕсли Область.Имя = "ROSPRIR" Тогда
		ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "ОрганыРПН");
		ВвестиПоказатель(Область, ПараметрВводаПоля.Показатель, ПараметрВводаПоля.ТекстПриВыборе,
						ПараметрВводаПоля.ТаблицаЗначений, СтандартнаяОбработка, Область);
...
Функция ПечатьНаСервере(ВидПечати)
	ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Печать данного отчета не предусмотрена';
												|en = 'Печать данного отчета не предусмотрена'"));
	Возврат Ложь;
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "LANDS_DISTURB_TYPE", 512, , "Причина нарушения земель", КоллекцияСписковВыбора["LANDS_DISTURB_TYPE"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ORG_SCALE", 512, , "Размер предприятия", КоллекцияСписковВыбора["ORG_SCALE"]);
КонецПроцедуры
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Область.Значение = СокрЛП(РезультатВыбора["Код"]);
	Если Не ОбластьНаименование = Неопределено Тогда 
		Если ЗначениеЗаполнено(Область.Значение) Тогда 
			ОбластьНаименование.Значение = РезультатВыбора["Название"];
		Иначе
			ОбластьНаименование.Значение = Неопределено;
		КонецЕсли;
	КонецЕсли;
	Модифицированность = Истина;
КонецПроцедуры
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "Форма устарела", "ПолеТабличногоДокументаФормаОтчета", "");
	Возврат Ложь;
КонецФункции

&НаСервере
Процедура ДополнитьПараметрыВыгрузки(ПараметрыВыгрузки)
	ПараметрыВыгрузки.Вставить("SEP_DIV_BOOL", ?(ПараметрыВыгрузки.SEP_DIV = Истина, "true", "false"));
	ПараметрыВыгрузки.Вставить("FINDIVID_BOOL", ?(ПараметрыВыгрузки.FINDIVID = Истина, "true", "false"));
	ПараметрыВыгрузки.Вставить("CREATE_DATE_STR", Формат(ПараметрыВыгрузки.CREATE_DATE, "ДФ=yyyy-MM-dd"));
	ПараметрыВыгрузки.Вставить("DOC_DATE_STR", Формат(ПараметрыВыгрузки.DOC_DATE, "ДФ=yyyy-MM-dd"));
...
Функция СформироватьИмяФайла(ПараметрыВыгрузки)
	...
	ИмяФайлаXML = ПараметрыВыгрузки.ОргКодСубъект + "_2тпр_"
...
Функция СформироватьСтруктуруПараметров()
	...
	НаименованиеОрг = ТабДокумент.FNAME_ORG;
	...
	ПараметрыВыгрузки.Вставить("ДатаРегистрации", Формат(ТабДокумент.REG_DATE, "ДФ=yyyy-MM-dd"));
	ПараметрыВыгрузки.Вставить("ОтчетныйГод",      Формат(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, "ДФ=yyyy"));
	ПараметрыВыгрузки.Вставить("ПолнНаименованиеОрг", СокрЛП(НаименованиеОрг));
	ПараметрыВыгрузки.Вставить("ОГРН",         ТабДокумент.OGRN);
	ПараметрыВыгрузки.Вставить("ОКАТО", ТабДокумент.ADDJ_OKATO);
	ПараметрыВыгрузки.Вставить("ИННЮЛ", ТабДокумент.INN_ORG);
	ПараметрыВыгрузки.Вставить("КППЮЛ", ТабДокумент.KPP);
	ПараметрыВыгрузки.Вставить("ОКПО",  ТабДокумент.OKPO_ORG);
	...
	ПараметрыВыгрузки.Вставить("ОргНазв", НаименованиеОрг);
	...
	ПараметрыВыгрузки.Вставить("ИмяКлючевогоУзлаСодержательнойЧасти", "ORG_INFO");
