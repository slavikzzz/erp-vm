...
Функция ПустыеПараметрыКомпоновкиОтчета() Экспорт
	...
	ОтчетОбъект = Отчеты.ОборотноСальдоваяВедомостьПоСчету.Создать();
...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт 
	...
	ТекстЗаголовкаОтчета = НСтр("ru = 'Оборотно-сальдовая ведомость по счету %1 %2';
								|en = 'Trial balance for account %1 %2'");
...
Процедура ПослеКомпоновкиМакета(ПараметрыОтчета, МакетКомпоновки) Экспорт
	...
	МакетШапкиТаблицы = БухгалтерскиеОтчеты.ПолучитьМакетШапки(МакетКомпоновки,
		, ?(МакетКомпоновки.Тело.Количество() > 1, "Подвал", "Заголовок"));
...
Функция ТекстЗапросаДляСчетовБезСубконто()
	...
	|    ПРЕДСТАВЛЕНИЕССЫЛКИ(ХозрасчетныйОстаткиИОбороты.НаправлениеДеятельности) КАК НаправлениеДеятельностиПредставление,
	...
	|    ХозрасчетныйОстаткиИОбороты.СуммаУУНачальныйОстатокДт КАК УУНачальныйОстатокДт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаУУНачальныйОстатокКт КАК УУНачальныйОстатокКт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаУУКонечныйОстатокДт КАК УУКонечныйОстатокДт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаУУКонечныйОстатокКт КАК УУКонечныйОстатокКт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаУУОборотДт КАК УУОборотДт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаУУОборотКт КАК УУОборотКт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаУУНачальныйРазвернутыйОстатокДт КАК УУНачальныйРазвернутыйОстатокДт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаУУНачальныйРазвернутыйОстатокКт КАК УУНачальныйРазвернутыйОстатокКт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаУУКонечныйРазвернутыйОстатокДт КАК УУКонечныйРазвернутыйОстатокДт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаУУКонечныйРазвернутыйОстатокКт КАК УУКонечныйРазвернутыйОстатокКт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаФОНачальныйОстатокДт КАК ФОНачальныйОстатокДт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаФОНачальныйОстатокКт КАК ФОНачальныйОстатокКт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаФОКонечныйОстатокДт КАК ФОКонечныйОстатокДт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаФОКонечныйОстатокКт КАК ФОКонечныйОстатокКт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаФООборотДт КАК ФООборотДт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаФООборотКт КАК ФООборотКт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаФОНачальныйРазвернутыйОстатокДт КАК ФОНачальныйРазвернутыйОстатокДт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаФОНачальныйРазвернутыйОстатокКт КАК ФОНачальныйРазвернутыйОстатокКт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаФОКонечныйРазвернутыйОстатокДт КАК ФОКонечныйРазвернутыйОстатокДт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаФОКонечныйРазвернутыйОстатокКт КАК ФОКонечныйРазвернутыйОстатокКт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаНачальныйОстатокДт - ХозрасчетныйОстаткиИОбороты.СуммаУУНачальныйОстатокДт КАК РазницаБУиУУНачальныйОстатокДт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаНачальныйОстатокКт - ХозрасчетныйОстаткиИОбороты.СуммаУУНачальныйОстатокКт КАК РазницаБУиУУНачальныйОстатокКт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаКонечныйОстатокДт - ХозрасчетныйОстаткиИОбороты.СуммаУУКонечныйОстатокДт КАК РазницаБУиУУКонечныйОстатокДт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаКонечныйОстатокКт - ХозрасчетныйОстаткиИОбороты.СуммаУУКонечныйОстатокКт КАК РазницаБУиУУКонечныйОстатокКт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаОборотДт - ХозрасчетныйОстаткиИОбороты.СуммаУУОборотДт КАК РазницаБУиУУОборотДт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаОборотКт - ХозрасчетныйОстаткиИОбороты.СуммаУУОборотКт КАК РазницаБУиУУОборотКт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаНачальныйРазвернутыйОстатокДт - ХозрасчетныйОстаткиИОбороты.СуммаУУНачальныйРазвернутыйОстатокДт КАК РазницаБУиУУНачальныйРазвернутыйОстатокДт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаНачальныйРазвернутыйОстатокКт - ХозрасчетныйОстаткиИОбороты.СуммаУУНачальныйРазвернутыйОстатокКт КАК РазницаБУиУУНачальныйРазвернутыйОстатокКт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаКонечныйРазвернутыйОстатокДт - ХозрасчетныйОстаткиИОбороты.СуммаУУКонечныйРазвернутыйОстатокДт КАК РазницаБУиУУКонечныйРазвернутыйОстатокДт,
	|    ХозрасчетныйОстаткиИОбороты.СуммаКонечныйРазвернутыйОстатокКт - ХозрасчетныйОстаткиИОбороты.СуммаУУКонечныйРазвернутыйОстатокКт КАК РазницаБУиУУКонечныйРазвернутыйОстатокКт
	|{ВЫБРАТЬ
	|    Счет.*,
	|    Период,
	|    Субконто1.*,
	...
	|    НаправлениеДеятельностиПредставление,
	...
	|    УУНачальныйОстатокДт,
	|    УУНачальныйОстатокКт,
	|    УУКонечныйОстатокДт,
	|    УУКонечныйОстатокКт,
	|    УУОборотДт,
	|    УУОборотКт,
	|    УУНачальныйРазвернутыйОстатокДт,
	|    УУНачальныйРазвернутыйОстатокКт,
	|    УУКонечныйРазвернутыйОстатокДт,
	|    УУКонечныйРазвернутыйОстатокКт,
	|    ФОНачальныйОстатокДт,
	|    ФОНачальныйОстатокКт,
	|    ФОКонечныйОстатокДт,
	|    ФОКонечныйОстатокКт,
	|    ФООборотДт,
	|    ФООборотКт,
	|    ФОНачальныйРазвернутыйОстатокДт,
	|    ФОНачальныйРазвернутыйОстатокКт,
	|    ФОКонечныйРазвернутыйОстатокДт,
	|    ФОКонечныйРазвернутыйОстатокКт,
	|    РазницаБУиУУНачальныйОстатокДт,
	|    РазницаБУиУУНачальныйОстатокКт,
	|    РазницаБУиУУКонечныйОстатокДт,
	|    РазницаБУиУУКонечныйОстатокКт,
	|    РазницаБУиУУОборотДт,
	|    РазницаБУиУУОборотКт,
	|    РазницаБУиУУНачальныйРазвернутыйОстатокДт,
	|    РазницаБУиУУНачальныйРазвернутыйОстатокКт,
	|    РазницаБУиУУКонечныйРазвернутыйОстатокДт,
	|    РазницаБУиУУКонечныйРазвернутыйОстатокКт}
	|ИЗ
	|    РегистрБухгалтерии.Хозрасчетный.ОстаткиИОбороты(&НачалоПериода, &КонецПериода, Месяц {(&Периодичность)}, , Счет В (&СчетаБезСубконто) {(Счет).*}, ,{(Организация).*, (Субконто1).*, (Субконто2).*, (Субконто3).*, (Подразделение).*, (НаправлениеДеятельности).*, (Валюта).*}) КАК ХозрасчетныйОстаткиИОбороты
	|{ГДЕ
...
Функция ШаблонЗапроса(Счетчик)
	...
	Если Счетчик = 1 Тогда
		Возврат "ВЫБРАТЬ
			...
			|    &ВидыСубконто, 
			|    {(Организация).*, (Подразделение).*, (НаправлениеДеятельности).*, (Валюта).* &УсловиеПоСубконто}) КАК ХозрасчетныйОстаткиИОбороты
			|{ГДЕ
			|	ХозрасчетныйОстаткиИОбороты.СуммаНачальныйОстатокДт КАК БУНачальныйОстатокДт,
			|	ХозрасчетныйОстаткиИОбороты.СуммаКонечныйОстатокДт КАК БУКонечныйОстатокДт,
			|	ХозрасчетныйОстаткиИОбороты.СуммаКонечныйОстатокКт КАК БУКонечныйОстатокКт,
