...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000003", 1, ,
		"Выбор кода территории использования предмета договора аренды", КоллекцияСписковВыбора["Территории"]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000007", 1, ,
		"Выбор вида аренды", КоллекцияСписковВыбора["ВидыАренды"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000010", 3, ,
		"Выбор кода валюты стоимости предмета договора аренды", КоллекцияСписковВыбора["КодыВалют"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000013", 3, ,
		"Выбор кода валюты погашения основного долга", КоллекцияСписковВыбора["КодыВалют"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000014", 1, ,
		"Выбор периодичности платежа по договору (основной долг)", КоллекцияСписковВыбора["Периодичность"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000015", 1, ,
		"Выбор периодичности платежа по договору (проценты)", КоллекцияСписковВыбора["Периодичность"]);
	
	//Раздел 2.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000002", 2, ,
		"Выбор кода территории", КоллекцияСписковВыбора["Регионы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000003", 1, ,
		"Выбор кода территории использования предмета договора аренды", КоллекцияСписковВыбора["Территории"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000005", 3, ,
		"Выбор кода страны нерезидента", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000007", 1, ,
		"Выбор вида аренды", КоллекцияСписковВыбора["ВидыАренды"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000010", 3, ,
		"Выбор кода валюты стоимости предмета договора аренды", КоллекцияСписковВыбора["КодыВалют"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000013", 3, ,
		"Выбор кода валюты погашения основного долга", КоллекцияСписковВыбора["КодыВалют"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000014", 1, ,
		"Выбор периодичности платежа по договору (основной долг)", КоллекцияСписковВыбора["Периодичность"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000015", 1, ,
		"Выбор периодичности платежа по договору (проценты)", КоллекцияСписковВыбора["Периодичность"]);
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяСтраницыПанели)
	...
	Если ИмяСтраницыПанели = "Раздел1" ИЛИ ИмяСтраницыПанели = "Раздел2" Тогда
