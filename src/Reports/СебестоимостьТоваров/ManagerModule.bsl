...
Функция ТекстЗапросаВТ_ДетализацияИсходныхЗатрат(РежимОтладкиПоИсточникам)
	...
	|				И 
	//++ НЕ УТ
	|					ЕСТЬNULL(ДетализацияСебестоимости.СтатьяРасходов.ХарактерПроизводственныхЗатрат, ЗНАЧЕНИЕ(Перечисление.ХарактерПроизводственныхЗатрат.ПустаяСсылка)) = ЗНАЧЕНИЕ(Перечисление.ХарактерПроизводственныхЗатрат.Постоянные)
	|					ИЛИ
	//-- НЕ УТ
	|					ЛОЖЬ
	|			ТОГДА ВЫБОР
	...
	|				И 
	//++ НЕ УТ
	|					ЕСТЬNULL(ДетализацияСебестоимости.СтатьяРасходов.ХарактерПроизводственныхЗатрат, ЗНАЧЕНИЕ(Перечисление.ХарактерПроизводственныхЗатрат.ПустаяСсылка)) = ЗНАЧЕНИЕ(Перечисление.ХарактерПроизводственныхЗатрат.Переменные)
	|					ИЛИ
	//-- НЕ УТ
	|					ЛОЖЬ
	|			ТОГДА ВЫБОР
