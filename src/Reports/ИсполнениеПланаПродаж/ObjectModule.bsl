...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Период = КомпоновкаДанныхКлиентСервер.ПолучитьПараметр(КомпоновщикНастроек, "ПериодПродажи").Значение; // СтандартныйПериод - 
	...
	ВложеннаяСхемаПоКлиентам = СхемаКомпоновкиДанных.ВложенныеСхемыКомпоновкиДанных.ПоКлиентам; //ВложеннаяСхемаКомпоновкиДанных - 
	ТекстЗапроса = ВложеннаяСхемаПоКлиентам.Схема.НаборыДанных.НаборДанных1.Запрос;
	...
	ВложеннаяСхемаПоКлиентам.Схема.НаборыДанных.НаборДанных1.Запрос = ОбработатьЗапрос(ТекстЗапроса);
	...
	ВложеннаяСхемаПоМенеджерам = СхемаКомпоновкиДанных.ВложенныеСхемыКомпоновкиДанных.ПоМенеджерам; //ВложеннаяСхемаКомпоновкиДанных - 
	ТекстЗапроса = ВложеннаяСхемаПоМенеджерам.Схема.НаборыДанных.НаборДанных1.Запрос;
	...
	ВложеннаяСхемаПоМенеджерам.Схема.НаборыДанных.НаборДанных1.Запрос = ОбработатьЗапрос(ТекстЗапроса);
	
	ВложеннаяСхемаПоФорматамМагазинов = СхемаКомпоновкиДанных.ВложенныеСхемыКомпоновкиДанных.ПоФорматамМагазинов; //ВложеннаяСхемаКомпоновкиДанных - 
	ТекстЗапроса = ВложеннаяСхемаПоФорматамМагазинов.Схема.НаборыДанных.НаборДанных1.Запрос;
	...
	ВложеннаяСхемаПоФорматамМагазинов.Схема.НаборыДанных.НаборДанных1.Запрос = ОбработатьЗапрос(ТекстЗапроса);
		...
		Если ЭтоАдресВременногоХранилища(Параметры.Расшифровка.Данные) Тогда
			...
			Если ИдентификаторВариантаОтчета = Неопределено Тогда
				...
				ВариантОтчета = КомпоновкаДанныхКлиентСервер.ПолучитьПараметр(
					КомпоновщикНастроек.Настройки.Структура[0].Настройки, "ВариантОтчета");
