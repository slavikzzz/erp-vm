...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ИмяФормы).ПолучитьМакет("Списки2011Кв3");
	...
	Если ПараметрВводаПоля.Количество() > 0 Тогда
		...
		Если СтрДлина(СокрЛП(Область.Значение)) <> 0 И ПараметрВводаПоля.Длина <> 0 И СтрДлина(СокрЛП(Область.Значение)) <> ПараметрВводаПоля.Длина Тогда
			ОбщегоНазначенияКлиент.СообщитьПользователю(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Длина значения показателя должна быть равна %1!';
	...
	Если ИмяРаздела = "Раздел2" И ИмяОбласти = "П000020018003_Числ" Тогда
		Если ЗначениеЗаполнено(ТабличныйДокумент.Области["П000020018003_Знам"].Значение) 
		   И ТабличныйДокумент.Области["П000020018003_Числ"].Значение > ТабличныйДокумент.Области["П000020018003_Знам"].Значение Тогда
			...
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр(
				"ru = 'Числитель дроби показателя в строке 180 не может превышать значение знаменателя.';
				|en = 'Числитель дроби показателя в строке 180 не может превышать значение знаменателя.'"));
		КонецЕсли;
	КонецЕсли;
	...
	Если ИмяРаздела = "Раздел2" И ИмяОбласти = "П000020018003_Знам" Тогда
		Если ЗначениеЗаполнено(ТабличныйДокумент.Области["П000020018003_Числ"].Значение) 
		   И ТабличныйДокумент.Области["П000020018003_Числ"].Значение > ТабличныйДокумент.Области["П000020018003_Знам"].Значение Тогда
			...
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр(
				"ru = 'Знаменатель дроби показателя в строке 180 не может быть меньше значения числителя.';
				|en = 'Знаменатель дроби показателя в строке 180 не может быть меньше значения числителя.'"));
		КонецЕсли;
	КонецЕсли;
	...
	Если ИмяРаздела = "Раздел3" И ИмяОбласти = "П000030005003_Числ" Тогда
		Если ЗначениеЗаполнено(ТабличныйДокумент.Области["П000030005003_Знам"].Значение) 
		   И ТабличныйДокумент.Области["П000030005003_Числ"].Значение > ТабличныйДокумент.Области["П000030005003_Знам"].Значение Тогда
			...
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр(
				"ru = 'Числитель дроби показателя в строке 050 не может превышать значение знаменателя.';
				|en = 'Числитель дроби показателя в строке 050 не может превышать значение знаменателя.'"));
		КонецЕсли;
	КонецЕсли;
	...
	Если ИмяРаздела = "Раздел3" И ИмяОбласти = "П000030005003_Знам" Тогда
		Если ЗначениеЗаполнено(ТабличныйДокумент.Области["П000030005003_Числ"].Значение) 
		   И ТабличныйДокумент.Области["П000030005003_Числ"].Значение > ТабличныйДокумент.Области["П000030005003_Знам"].Значение Тогда
			...
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр(
				"ru = 'Знаменатель дроби показателя в строке 050 не может быть меньше значения числителя.';
				|en = 'Знаменатель дроби показателя в строке 050 не может быть меньше значения числителя.'"));
		КонецЕсли;
	КонецЕсли;
	...
	Если ИмяРаздела = "Раздел3" И ИмяОбласти = "П000030009003_Числ" Тогда
		Если ЗначениеЗаполнено(ТабличныйДокумент.Области["П000030009003_Знам"].Значение) 
		   И ТабличныйДокумент.Области["П000030009003_Числ"].Значение > ТабличныйДокумент.Области["П000030009003_Знам"].Значение Тогда
			...
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр(
				"ru = 'Числитель дроби показателя в строке 090 не может превышать значение знаменателя.';
				|en = 'Числитель дроби показателя в строке 090 не может превышать значение знаменателя.'"));
		КонецЕсли;
	КонецЕсли;
	...
	Если ИмяРаздела = "Раздел3" И ИмяОбласти = "П000030009003_Знам" Тогда
		Если ЗначениеЗаполнено(ТабличныйДокумент.Области["П000030009003_Числ"].Значение) 
		   И ТабличныйДокумент.Области["П000030009003_Числ"].Значение > ТабличныйДокумент.Области["П000030009003_Знам"].Значение Тогда
			...
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр(
				"ru = 'Знаменатель дроби показателя в строке 090 не может быть меньше значения числителя.';
				|en = 'Знаменатель дроби показателя в строке 090 не может быть меньше значения числителя.'"));
		КонецЕсли;
	КонецЕсли;
...
Процедура СформироватьРаздел1()
		...
		Если НЕ ПустаяСтрока(ОКАТО) И НЕ ПустаяСтрока(ВидИмущества) И СтрНайти("1234", ВидИмущества) <> Неопределено Тогда
			...
			Иначе
				Если ВидИмущества = "4" Тогда
					МинЗнач = Мин(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтотОбъект, Стр.Данные[0].Значение.П000020022003) 
					- РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтотОбъект, Стр.Данные[0].Значение.П000020025003), 
	...
	Иначе
		Если ТаблДанных.Количество() > 0 Тогда
			ОбщегоНазначения.СообщитьПользователю(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
				"ru = 'Есть экземпляры раздела 2, заполненные отметкой 4 по строке ""код вида имущества"".%1Данные из раздела 3 не были перенесены!';
				|en = 'Есть экземпляры раздела 2, заполненные отметкой 4 по строке ""код вида имущества"".%1Данные из раздела 3 не были перенесены!'"),
				Символы.ПС));
		КонецЕсли;			
	КонецЕсли;		
...
Процедура ОчисткаИПодготовкаРаздела1()
	...
	ТаблицаСтраницРаздела1 = ЭтотОбъект[ТаблицаСтраницРаздела1];
	...
	РегламентированнаяОтчетностьКлиентСервер.ОчиститьВариантыЗаполнения(ЭтотОбъект, "Раздел1");
...
Функция ИзвлечьСтруктуруXML()
	...
	Макет = ОбъектОтчета(ИмяФормы).ПолучитьМакет("СхемаВыгрузки502");
		...
		Для ИндексБлока = 1 По 6 Цикл
			...
			Если БлокЗаполнен Тогда
				...
				Если ДлинаОКАТО <> 11 Тогда
					РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "В разделе 1 на странице " + НомерЛиста + " не" + ?(ДлинаОКАТО = 0, "", " верно") + " задан код по ОКАТО!", "Раздел1", ИмяОбластиОКАТО, НомерЛиста);
					СтатусПроверки = Ложь;
				КонецЕсли;
				
				ДлинаКБК = СтрДлина(КБК);
				Если ДлинаКБК <> 20 Тогда
					РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "В разделе 1 на странице " + НомерЛиста + " не" + ?(ДлинаКБК = 0, "", " верно") + " задан КБК!", "Раздел1", ИмяОбластиКБК, НомерЛиста);
					СтатусПроверки = Ложь;
				КонецЕсли;
	...
	Для Каждого Лист Из ДанныеРаздела Цикл
		...
		Если КодВидаИмущества <> "1" 
		   ...
		   И КодВидаИмущества <> "5" Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "На странице " + НомерЛиста + " раздела 2 код вида имущества должен быть установлен в значение ""1"", ""2"", ""3"", ""4"" или ""5""!", "Раздел2", "П000020000100", НомерЛиста);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		ДлинаОКАТО = СтрДлина(ОКАТО);
		Если ДлинаОКАТО <> 11 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "На странице " + НомерЛиста + " раздела 2 не" + ?(ДлинаОКАТО = 0, "", "верно") + " задан код по ОКАТО!", "Раздел2", "П000020001000", НомерЛиста);
			ОшибкаОКАТО = Истина;
			СтатусПроверки = Ложь;
		КонецЕсли;
...
Процедура ПроверитьЗаполнение_Раздел3(СочетаниеРазделов, СтатусПроверки)
	...
	Для Каждого Лист Из ДанныеРаздела Цикл
		...
		ДлинаОКАТО = СтрДлина(ОКАТО);
		Если ДлинаОКАТО <> 11 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "На странице " + НомерЛиста + " раздела 3 не" + ?(ДлинаОКАТО = 0, "", "верно") + " задан код по ОКАТО!", "Раздел3", "П000030001000", НомерЛиста);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если ЗначениеЗаполнено(ДанныеЛиста.П000030009003_Числ) ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000030009003_Знам) Тогда
			...
			ИначеЕсли ДанныеЛиста.П000030009003_Знам < ДанныеЛиста.П000030009003_Числ Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "На странице " + НомерЛиста + " раздела 3 числитель больше знаменателя у коэффициента К!", "Раздел3", "П000030009003_Числ", НомерЛиста);
				СтатусПроверки = Ложь;
			КонецЕсли;
		КонецЕсли;
...
Процедура ПроверитьЗаполнение_СочетаниеРазделов(СочетаниеРазделов, СтатусПроверки)
	...
	Если СочетанияРаздела1.Количество() = 0 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "В разделе 1 не заполнен ни один блок с информацией о суммах налога!", "Раздел1", "П000010001000_1", 1);
		СтатусПроверки = Ложь;
	...
	Если СочетанияРаздела2.Количество() = 0 И СочетанияРаздела3.Количество() = 0 Тогда
		...
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, СообщениеОбОшибке, "Раздел2", "П000020001000", 1);
		СтатусПроверки = Ложь;
...
Процедура ПроверитьЗаполнение_ТитульныйЛист(ПараметрыВыгрузки, СтатусПроверки)
	...
	Если ПараметрыВыгрузки.ПериодОтч <> "34" И ПараметрыВыгрузки.ПериодОтч <> "50" Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "Значение кода налогового периода должно быть равно ""34"" или ""50""!", "Титульный", "НаимОрг");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Если ПустаяСтрока(ПараметрыВыгрузки.КодИФНС) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "Не задан код налогового органа!", "Титульный", "КодИМНС1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ПараметрыВыгрузки.ИННЮЛРеорг) ИЛИ ЗначениеЗаполнено(ПараметрыВыгрузки.КППРеорг) ИЛИ ЗначениеЗаполнено(ПараметрыВыгрузки.ФормРеорг) Тогда
		...
		Если ПустаяСтрока(ПараметрыВыгрузки.ФормРеорг) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "Не задан код формы реорганизации!", "Титульный", "КодФормыОрг");
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если НЕ ПустаяСтрока(ПараметрыВыгрузки.ФормРеорг) И ПараметрыВыгрузки.ФормРеорг <> "0" Тогда
			...
			Если ДлинаИННРеорг <> 10 ИЛИ НЕ СтроковыеФункцииКлиентСервер.ТолькоЦифрыВСтроке(ПараметрыВыгрузки.ИННЮЛРеорг) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "Не" + ?(ДлинаИННРеорг = 0, "", "верно") + " задан ИНН реорганизованной организации!", "Титульный", "ИНН_Реорг");
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			ДлинаКППРеорг = СтрДлина(ПараметрыВыгрузки.КППРеорг);
			Если ДлинаКППРеорг <> 9 Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "Не" + ?(ДлинаКППРеорг = 0, "", "верно") + " задан КПП реорганизованной организации!", "Титульный", "КПП_Реорг");
				СтатусПроверки = Ложь;
			КонецЕсли;
...
Функция ЕстьРазделЗаполненныйПоУсловиям(ИмяСтраницы, Условия)
	...
	ТаблицаРаздела = ЭтотОбъект[ТаблицаРаздела];
