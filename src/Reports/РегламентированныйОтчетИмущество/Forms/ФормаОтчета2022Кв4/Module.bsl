		...
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Строки Тогда
			...
			Для НомСтр = ВерхОбласти По НизОбласти Цикл
				...
				Если КодПоказателя <> "###" Тогда
					...
					Если Область.Имя = "ВидыНалоговойЛьготы_Р2Стр160_Р22Стр160_Р3Стр040" И КодПоказателя = "2010344"
					...
					Если Область.Имя = "ВидыНалоговойЛьготы_Р2Стр160_Р22Стр160_Р3Стр040" И КодПоказателя = "2010261"
						И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20240101' Тогда
						
						НовСтрока.Название = "Организации - в отношении имущества, учитываемого на балансе организации - участника"
						+ " свободной экономической зоны на территориях Донецкой Народной Республики, Луганской Народной Республики,"
						+ " Запорожской области и Херсонской области, созданного или приобретенного в целях выполнения договора об"
						+ " условиях деятельности в свободной экономической зоне на территориях Донецкой Народной Республики, Луганской"
						+ " Народной Республики, Запорожской области и Херсонской области и расположенного на территории указанной"
						+ " свободной экономической зоны, в течение десяти лет с месяца, следующего за месяцем принятия на учет"
						+ " указанного имущества (п. 29 ст. 381 НК РФ)";
...
Функция СравнениеОтчетовНаСервере(ДанныеДляСравнения)
	...
	ДеревоДляСравнения = ИзвлечьСтруктуруXML("СхемаВыгрузки511");
...
Функция ЗагрузкаОтчетаИзФайлаНаСервере(ДанныеДляЗагрузки)
	...
	ДеревоДляЗагрузки = ИзвлечьСтруктуруXML("СхемаВыгрузки511");
...
Функция УниверсальнаяВыгрузкаXMLНаСервере(ТекстВыгрузки, ПараметрыВыгрузки)
	...
	ДеревоВыгрузки = ИзвлечьСтруктуруXML("СхемаВыгрузки511");
