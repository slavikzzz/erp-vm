...
Процедура ПоказатьПериод(Форма)
	...
	|en = 'Только организации, если исчисленная как произведение налоговой базы и ставки сумма налога больше нуля (ч.1 ст.6, ч.1,3 ст.8 Федерального закона от 04.08.2023 N 414-ФЗ).'");
...
Процедура ВыбратьФорму(Команда)
	...
	|en = 'Декларацию по налогу на сверхприбыль представляют организации.'");
...
Функция ДоступныеОрганизацииОтсутствуютТекст()
	...
	|en = 'Декларацию по налогу на сверхприбыль представляют только организации.
	|В справочнике ""Организации"" сведения об организациях отсутствуют.'");
