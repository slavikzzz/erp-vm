...
Процедура ДоступностьРазделов()
	...
	Для Гр = 3 По 9 Цикл
		...
		Для Стр = 68 По 79 Цикл
			
			Графа = Формат(Гр, "ЧЦ=2; ЧВН=");
			ПоказательИмя = "П00500100" + Стр + Графа;
			
			Обл = мФормаОтчета.Области.Найти(ПоказательИмя);
			Если Обл = Неопределено Тогда
				Продолжить;
			КонецЕсли;
			
			Обл.ЦветФона = ЦветРазделСправочно;
			Обл.Защита = ЗащитаРазделСправочно;
	...
	Для Гр = 3 По 4 Цикл
		...
		Для Стр = 80 По 85 Цикл
			
			Графа = Формат(Гр, "ЧЦ=2; ЧВН=");
			ПоказательИмя = "П00600100" + Стр + Графа;
	...
	Для Стр = 86 По 88 Цикл
		...
		ПоказательИмя = "П00700100" + Стр + "03";
