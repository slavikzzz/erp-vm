...
Процедура ЗаполнитьДанными_3ТоргПМ(ДеревоВыгрузки, ПараметрыВыгрузки)
	...
	Таблица = ДанныеФормыВЗначение(РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "КодПоНомеруСтроки").ТаблицаЗначений, Тип("ТаблицаЗначений"));
