...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "06/01/2018";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Области.П0243.Значение = Области.П0208.Значение + Области.П0215.Значение + Области.П0218.Значение
							+ Области.П0220.Значение + Области.П0222.Значение + Области.П0226.Значение
							+ Области.П0235.Значение + Области.П0237.Значение + Области.П0238.Значение;
КонецПроцедуры
