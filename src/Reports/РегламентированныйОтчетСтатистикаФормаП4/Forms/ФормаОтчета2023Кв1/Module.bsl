...
Процедура ОчиститьТабличноеПоле(Форма)
	...
	СписокПоказателейНеПодлежащихОчистке.Добавить("РегистрацияРеспондента");
...
Процедура ЗагрузитьПодготовленныеДанные()
	...
	РегламентированнаяОтчетность.ВывестиШапкуРегистрацияРеспондента(ТекТабличноеПоле);
