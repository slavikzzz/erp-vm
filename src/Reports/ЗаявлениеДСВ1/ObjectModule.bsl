...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Макет = ?(ДатаОтчета >= ДатаПостановленияДСВ1_2023(), 
		УправлениеПечатью.МакетПечатнойФормы("Отчет.ЗаявлениеДСВ1.ПФ_MXL_ФормаДСВ_1_2023"),
		УправлениеПечатью.МакетПечатнойФормы("Отчет.ЗаявлениеДСВ1.ПФ_MXL_ФормаДСВ_1"));
...
Функция ДатаПостановленияДСВ1_2023() Экспорт
