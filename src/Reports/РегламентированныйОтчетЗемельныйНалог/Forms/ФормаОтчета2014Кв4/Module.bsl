...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2014Кв4";
	...
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "19/11/2014";
			...
			Если Форма["мСтруктураМногостраничныхРазделов"].Свойство(ЭлементРазделовОтчета.КолонкаРазделыОтчетаСокрНаим, НайденноеЗначение) Тогда
				...
				Если НЕ НайденноеЗначение = Неопределено Тогда
					...
					Для НомерСтраницы = 1 По НайденноеЗначение.Количество() Цикл
						...
						Примечание = "";
						Если ЭлементДереваСтраницОтчета.ИмяСтраницы = "Раздел2" Тогда
							// Дополняем представление страниц раздела 2 кадастровыми номерами.
							Если Форма.ТаблицаСтраницыРаздела2.Количество() > 0 Тогда
								Если Форма.ТаблицаСтраницыРаздела2[НомерСтраницы - 1].Данные.Количество() > 0 Тогда
									ДанныеСтраницыРаздела2 = Форма.ТаблицаСтраницыРаздела2[НомерСтраницы - 1].Данные[0].Значение;
									КадастрНомер = СокрЛП(ДанныеСтраницыРаздела2.П000020000100);
									Если ЗначениеЗаполнено(КадастрНомер) Тогда
										Примечание = " (" + КадастрНомер + ")";
									КонецЕсли;
								КонецЕсли;
							КонецЕсли;
						КонецЕсли;
						
						СтраницаРазделаОтчета.КолонкаРазделыОтчета              = "Стр. " + НомерСтраницы + Примечание;
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("СпискиВыбора2014Кв4");
	...
	Если ДатаПодписи >= '20150101' ИЛИ НЕ ЗначениеЗаполнено(ДатаПодписи) Тогда
		ИмяСекцииКБК = "КБК_2015Кв1";
	...
	ИмяСекцииКодыЛьгот5 = ?(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '2015-01-01', "КодыЛьгот5_2015", "КодыЛьгот5");
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020022003",           7, , "Выбор льготы", КоллекцияСписковВыбора[ИмяСекцииКодыЛьгот5]);
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
			...
			Если П000020006003 > 1 Тогда
				Если П000020006003_Знам = 0 Тогда
					...
					Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Доля налогоплательщика в праве на земельный участок не может превышать единицу.%1По строке 060 не указан знаменатель дроби.';
																									|en = 'Доля налогоплательщика в праве на земельный участок не может превышать единицу.%1По строке 060 не указан знаменатель дроби.'"), Символы.ПС);
			...
			Если П000020012003 > 1 Тогда
				Если П000020012003_Знам = 0 Тогда
					...
					Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Доля не облагаемой площади земельного участка не может превышать единицу.%1По строке 120 не указан знаменатель дроби.';
																									|en = 'Доля не облагаемой площади земельного участка не может превышать единицу.%1По строке 120 не указан знаменатель дроби.'"), Символы.ПС);
			...
			П000020024003_КодЛьготы = Форма.ТабличныйДокумент.Области.П000020024003_КодЛьготы.Значение;
			Если НЕ ПустаяСтрока(П000020024003_КодЛьготы) Тогда
				П000020024003_Процент = Форма.ТабличныйДокумент.Области.П000020024003_Процент.Значение;
				П000020024003_Сумма = Форма.ТабличныйДокумент.Области.П000020024003_Сумма.Значение;
				Если ЗначениеЗаполнено(П000020024003_Процент) Тогда
					П000020025003 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, П000020017003) * П000020024003_Процент / 100;
				ИначеЕсли ЗначениеЗаполнено(П000020024003_Сумма) Тогда
					П000020025003 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, П000020024003_Сумма);
				Иначе
					П000020025003 = 0;
				КонецЕсли;
				П000020025003 = Окр(П000020025003, 2);
			Иначе
				П000020025003 = 0;
			КонецЕсли;
			Форма.ТабличныйДокумент.Области.П000020025003.Значение = П000020025003;
			
			П000020026003_КодЛьготы = Форма.ТабличныйДокумент.Области.П000020026003_КодЛьготы.Значение;
			Если НЕ ПустаяСтрока(П000020026003_КодЛьготы) Тогда
				П000020026003_Ставка = Форма.ТабличныйДокумент.Области.П000020026003_Ставка.Значение;
				П000020027003 = ((РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, П000020013003) * П000020014003)
							   - (РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, П000020013003) * П000020026003_Ставка)) / 100;
				П000020027003 = Макс(0, Окр(П000020027003, 2));
			Иначе
				П000020027003 = 0;
			КонецЕсли;
			Форма.ТабличныйДокумент.Области.П000020027003.Значение = П000020027003;
...
Процедура ПолныйРасчетРаздела2(Форма, ОбластьИмя = "")
	...
	Для Каждого СтраницаРаздела2 Из Форма.ТаблицаСтраницыРаздела2 Цикл
		...
		П000020024003_КодЛьготы = ПолеТабличногоДокументаРаздел2.П000020024003_КодЛьготы;
		Если НЕ ПустаяСтрока(П000020024003_КодЛьготы) Тогда
			П000020024003_Процент = ПолеТабличногоДокументаРаздел2.П000020024003_Процент;
			П000020024003_Сумма = ПолеТабличногоДокументаРаздел2.П000020024003_Сумма;
			Если ЗначениеЗаполнено(П000020024003_Процент) Тогда
				П000020025003 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, П000020017003) * П000020024003_Процент / 100;
			ИначеЕсли ЗначениеЗаполнено(П000020024003_Сумма) Тогда
				П000020025003 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, П000020024003_Сумма);
		...
		Иначе
			П000020025003 = 0;
		КонецЕсли;
		ПолеТабличногоДокументаРаздел2.П000020025003 = П000020025003;
		
		П000020026003_КодЛьготы = ПолеТабличногоДокументаРаздел2.П000020026003_КодЛьготы;
		Если НЕ ПустаяСтрока(П000020026003_КодЛьготы) Тогда
			П000020026003_Ставка = ПолеТабличногоДокументаРаздел2.П000020026003_Ставка;
			П000020027003 = ((РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, П000020013003) * П000020014003)
						   - (РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, П000020013003) * П000020026003_Ставка)) / 100;
			П000020027003 = Макс(0, Окр(П000020027003, 2));
		Иначе
			П000020027003 = 0;
		КонецЕсли;
		ПолеТабличногоДокументаРаздел2.П000020027003 = П000020027003;
...
Процедура ОбработкаИзмененияСодержимогоВПолеТабличногоДокумента(Элемент, Область)
	...
	ИначеЕсли Область.Имя = "П000020000100" Тогда // кадастровый номер
		
		ИзменитьПредставлениеСтраницыРаздела2();
	...
	ИначеЕсли Область.Имя = "П000020024003_Процент" И Область.Значение > 100 Тогда
		
			Область.Значение = 0;
			
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru = 'Процент, уменьшающий исчисленную сумму налога, не может превышать 100';
									|en = 'Процент, уменьшающий исчисленную сумму налога, не может превышать 100'");
			Сообщение.Сообщить();
		
	ИначеЕсли Область.Имя = "П000020024003_Процент" ИЛИ Область.Имя = "П000020024003_Сумма" Тогда
		
		Если ЗначениеЗаполнено(ТабличныйДокумент.Области.П000020024003_Процент.Значение)
		   И ЗначениеЗаполнено(ТабличныйДокумент.Области.П000020024003_Сумма.Значение) Тогда
			Если Область.Имя = "П000020024003_Процент" Тогда
				ЛитераСтроки = "б";
				ТабличныйДокумент.Области.П000020024003_Сумма.Значение = 0;
			Иначе
				ЛитераСтроки = "а";
				ТабличныйДокумент.Области.П000020024003_Процент.Значение = 0;
			КонецЕсли;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
				"ru = 'Строки 240а и 240б не могут заполняться одновременно. Значение в строке 240%1 очищено';
				|en = 'Строки 240а и 240б не могут заполняться одновременно. Значение в строке 240%1 очищено'"), ЛитераСтроки);
			Сообщение.Сообщить();
		КонецЕсли;
		
	ИначеЕсли Область.Имя = "П000020026003_Ставка" Тогда
		...
		Если ПониженнаяНалоговаяСтавка > НалоговаяСтавка Тогда
			...
			Сообщение.Текст = НСтр("ru = 'Пониженная налоговая ставка не может превышать основную налоговую ставку';
									|en = 'Пониженная налоговая ставка не может превышать основную налоговую ставку'");
			Сообщение.Сообщить();
...
&НаКлиенте
Процедура ИзменитьПредставлениеСтраницыРаздела2()
	
	ТекЭлемент = Элементы.РазделыОтчета.ТекущиеДанные;
	Если ТекЭлемент.КолонкаРазделыОтчета = "Раздел 2" Тогда
		ТекЭлемент = ТекЭлемент.ПолучитьЭлементы()[0];
	КонецЕсли;
	
	ТекПредставление = ТекЭлемент.КолонкаРазделыОтчета;
	Если СтрНачинаетсяС(ТекПредставление, "Стр. ") Тогда
		ДлинаТекПредставления = СтрДлина(ТекПредставление);
		ПодстрокаПоиска = "1234567890";
		Для НомПоз = 6 По ДлинаТекПредставления Цикл
			Если СтрНайти(ПодстрокаПоиска, Сред(ТекПредставление, НомПоз, 1)) = 0 Тогда
				НомПоз = НомПоз - 1;
				Прервать;
			КонецЕсли;
		КонецЦикла;
		КадастрНомер = СокрЛП(ТабличныйДокумент.Области.П000020000100.Значение);
		Примечание = "";
		Если ЗначениеЗаполнено(КадастрНомер) Тогда
			Примечание = " (" + КадастрНомер + ")";
		КонецЕсли;
		ТекЭлемент.КолонкаРазделыОтчета = Лев(ТекПредставление, НомПоз) + Примечание;
	КонецЕсли;
...
Процедура УдалитьСтраницуЗавершение(РезультатВопроса, ДополнительныеПараметры) Экспорт
	...
	Для Каждого СтраницаРаздела Из ТекущиеДанные.ПолучитьЭлементы() Цикл
		...
		Примечание = "";
		Если ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел2" Тогда
			// Дополняем представление страниц раздела 2 кадастровыми номерами.
			Если ТаблицаСтраницыРаздела2.Количество() > 0 Тогда
				Если ТаблицаСтраницыРаздела2[НомерСтраницы - 1].Данные.Количество() > 0 Тогда
					ДанныеСтраницыРаздела2 = ТаблицаСтраницыРаздела2[НомерСтраницы - 1].Данные[0].Значение;
					КадастрНомер = СокрЛП(ДанныеСтраницыРаздела2.П000020000100);
					Если ЗначениеЗаполнено(КадастрНомер) Тогда
						Примечание = " (" + КадастрНомер + ")";
					КонецЕсли;
		...
		СтраницаРаздела.КолонкаРазделыОтчета              = "Стр. " + НомерСтраницы + Примечание;
...
Процедура СформироватьРаздел1НаСервере()
			...
			Для Каждого СтрокаТаблицы Из ТаблицаСтраницРаздела1 Цикл
				Если НЕ СтрокаТаблицы.Данные.Количество() = 0 Тогда
					Для Блок = 1 По 2 Цикл
						...
						АвансовыйПлатеж.ОКТМО = СокрЛП(СтрокаТаблицы.Данные[0].Значение["П000010002003" + "_" + Блок]);
						АвансовыйПлатеж.СуммаАвансовыхПлатежей1Кв = СтрокаТаблицы.Данные[0].Значение["П000010002303" + "_" + Блок];
						АвансовыйПлатеж.СуммаАвансовыхПлатежей2Кв = СтрокаТаблицы.Данные[0].Значение["П000010002503" + "_" + Блок];
						АвансовыйПлатеж.СуммаАвансовыхПлатежей3Кв = СтрокаТаблицы.Данные[0].Значение["П000010002703" + "_" + Блок];
					КонецЦикла;
				Иначе
					Возврат;
				КонецЕсли;
	...
	Для Каждого Стр из ТаблДанныхРаздел2 Цикл
		...
		Исключение
			...
			Сообщение.Текст = НСтр("ru = 'Не заполнены страницы Раздела 2!';
									|en = 'Не заполнены страницы Раздела 2!'");
			Сообщение.Сообщить();
		...
		Иначе
			...
			Сообщение.Текст = НСтр("ru = 'Не заполнен код КБК на странице Раздела 2!';
									|en = 'Не заполнен код КБК на странице Раздела 2!'");
			Сообщение.Сообщить();
			УстановитьВидимостьУдалитьСтраницу("ТаблицаСтраницыРаздела1");
			РегламентированнаяОтчетность.ПолучитьСведенияОПоказателяхОтчета(ЭтаФорма);
			Возврат;
	...
	Для Инд = 0 По ДанныеДляЗаполнения.Количество() - 1 Цикл
		...
		Если Инд % КоличествоБлоковНаЛисте = 0 И Инд <> 0 Тогда
			...
			Иначе
				Если ЭтаФорма.Элементы.РазделыОтчета.ТекущаяСтрока = Неопределено
					И ЭтаФорма.Параметры.СформироватьФормуОтчетаАвтоматически Тогда
					РегламентированнаяОтчетность.ВставитьДополнительнуюСтраницуНаСервере(ЭтаФорма, "Раздел1", Ложь);
					СтруктураРеквизитовФормы.ВыводитьСтраницуВТаблДокНаСервере = Ложь;
				Иначе
		...
		Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1" Тогда
			...
			СтруктураОтбора.Вставить("ОКТМО", ТекСтр.ОКАТО);
		...
		Иначе
			...
			Если ТаблицаСтраницыРаздела1[Цел(Инд / КоличествоБлоковНаЛисте)].Данные.Количество() = 0 Тогда
				
				СтруктураДанных = Новый Структура;
				
				Для НомерБлокаНаЛисте = 1 По КоличествоБлоковНаЛисте Цикл
					
					СтруктураДанных.Вставить("П000010000100", "");
					СтруктураДанных.Вставить("П000010001003_" + НомерБлокаНаЛисте, "");
				...
				ТаблицаСтраницыРаздела1[Цел(Инд / КоличествоБлоковНаЛисте)].Данные.Вставить(0, СтруктураДанных);
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	ПрефиксИменМакетов = "ПечатныйБланк2014Кв4_";
...
Процедура ЗаполнитьАвтоНаСервере()
	...
	ОбработатьРезультатЗаполнения();
	
	// Сохранение данных авансовых платежей по ОКТМО и КБК, полученных от потребителя БРО.
	ТаблицаСтраницРаздела1  = Неопределено;
	АвансовыеПлатежи = Неопределено;
	Если мСтруктураМногостраничныхРазделов.Свойство("Раздел1", ТаблицаСтраницРаздела1) Тогда
		ТаблицаСтраницРаздела1 = ЭтаФорма[ТаблицаСтраницРаздела1];
		АвансовыеПлатежи = Новый ТаблицаЗначений;
		АвансовыеПлатежи.Колонки.Добавить("КБК");
		...
		Для Каждого СтрокаТаблицы Из ТаблицаСтраницРаздела1 Цикл
			Для Блок = 1 По 2 Цикл
				...
				КБК   = СокрЛП(СтрокаТаблицы.Данные[0].Значение["П000010001003_" + Блок]);
				ОКТМО = СокрЛП(СтрокаТаблицы.Данные[0].Значение["П000010002003_" + Блок]);
				
				СтруктураОтбора = Новый Структура;
				СтруктураОтбора.Вставить("КБК",   КБК);
				СтруктураОтбора.Вставить("ОКТМО", ОКТМО);
				СтрокиАвансов = АвансовыеПлатежи.НайтиСтроки(СтруктураОтбора);
				
				Если СтрокиАвансов.Количество() = 0 Тогда
					АвансовыйПлатеж = АвансовыеПлатежи.Добавить();
					АвансовыйПлатеж.КБК   = СокрЛП(СтрокаТаблицы.Данные[0].Значение["П000010001003_" + Блок]);
					АвансовыйПлатеж.ОКТМО = СокрЛП(СтрокаТаблицы.Данные[0].Значение["П000010002003_" + Блок]);
					АвансовыйПлатеж.СуммаАвансовыхПлатежей1Кв = СтрокаТаблицы.Данные[0].Значение["П000010002303_" + Блок];
					АвансовыйПлатеж.СуммаАвансовыхПлатежей2Кв = СтрокаТаблицы.Данные[0].Значение["П000010002503_" + Блок];
					АвансовыйПлатеж.СуммаАвансовыхПлатежей3Кв = СтрокаТаблицы.Данные[0].Значение["П000010002703_" + Блок];
				КонецЕсли;
	...
	// Восстановление данных авансовых платежей по ОКТМО и КБК после переформирования раздела 1 в БРО.
	Если АвансовыеПлатежи <> Неопределено Тогда
		ТаблицаСтраницРаздела1 = Неопределено;
		Если мСтруктураМногостраничныхРазделов.Свойство("Раздел1", ТаблицаСтраницРаздела1) Тогда
			ТаблицаСтраницРаздела1 = ЭтаФорма[ТаблицаСтраницРаздела1];
			Для Каждого СтрокаТаблицы Из ТаблицаСтраницРаздела1 Цикл
				Для Блок = 1 По 2 Цикл
					...
					Если СтрокиАвансов.Количество() > 0 Тогда
						СтрокаТаблицы.Данные[0].Значение["П000010002303_" + Блок] = Макс(СтрокиАвансов[0].СуммаАвансовыхПлатежей1Кв, 0);
						СтрокаТаблицы.Данные[0].Значение["П000010002503_" + Блок] = Макс(СтрокиАвансов[0].СуммаАвансовыхПлатежей2Кв, 0);
						СтрокаТаблицы.Данные[0].Значение["П000010002703_" + Блок] = Макс(СтрокиАвансов[0].СуммаАвансовыхПлатежей3Кв, 0);
					Иначе
...
&НаСервере
Процедура ОбработатьРезультатЗаполнения()
	
	Для Каждого Страница Из ТаблицаСтраницыРаздела2 Цикл
		
		ДанныеСтраницы = Страница.Данные[0].Значение;
		
		Если ДанныеСтраницы.П000020024003_Процент > 100 Тогда
			
			ДанныеСтраницы.П000020024003_Процент = 0;
			
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
				"ru = 'Процент, уменьшающий исчисленную сумму налога, не должен превышать 100 (значение в строке 240а на странице %1 раздела 2 очищено)';
				|en = 'Процент, уменьшающий исчисленную сумму налога, не должен превышать 100 (значение в строке 240а на странице %1 раздела 2 очищено)'"),
				ТаблицаСтраницыРаздела2.Индекс(Страница) + 1);
			Сообщение.Сообщить();
			
		КонецЕсли;
		
		Если ДанныеСтраницы.П000020026003_Ставка > ДанныеСтраницы.П000020014003 Тогда
			
			ДанныеСтраницы.П000020026003_Ставка = 0;
			
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
				"ru = 'Пониженная налоговая ставка не может превышать основную налоговую ставку (значение в строке 260а на странице %1 раздела 2 очищено)';
				|en = 'Пониженная налоговая ставка не может превышать основную налоговую ставку (значение в строке 260а на странице %1 раздела 2 очищено)'"),
				ТаблицаСтраницыРаздела2.Индекс(Страница) + 1);
			Сообщение.Сообщить();
...
Процедура УстановитьДоступностьОбластей(Форма, НаимТекущегоРаздела)
	...
	Если НаимТекущегоРаздела = "Раздел2" Тогда
		...
		ОбрабатываемаяОбласть3 = Форма.ТабличныйДокумент.Области.П000020024003_Сумма;
		ОбрабатываемаяОбласть4 = Форма.ТабличныйДокумент.Области.П000020025003;
		Если ОпределяющаяОбласть.Значение = "3022200" Тогда
			
			РазрешитьВводДанныхВОбласть(ОбрабатываемаяОбласть1, Форма.мСтруктураЦветовРаскраски);
			
			ОбрабатываемаяОбласть2.Защита   = ОпределяющаяОбласть.Защита;
			ОбрабатываемаяОбласть2.ЦветФона = ОпределяющаяОбласть.ЦветФона;
			ОбрабатываемаяОбласть3.Защита   = ОпределяющаяОбласть.Защита;
			ОбрабатываемаяОбласть3.ЦветФона = ОпределяющаяОбласть.ЦветФона;
			
			УстановитьОснованиеЛьготыПоУмолчанию(ОбрабатываемаяОбласть1);
			УстановитьПредставлениеНуля(ОбрабатываемаяОбласть2, "0");
			Если Форма.СтруктураРеквизитовФормы.ФлажокОтклАвтоРасчет Тогда
				ОбрабатываемаяОбласть4.Защита   = Ложь;
				ОбрабатываемаяОбласть4.ЦветФона = ЦветОбластиРучногоВвода;
			Иначе
				ОбрабатываемаяОбласть4.Защита   = Истина;
				ОбрабатываемаяОбласть4.ЦветФона = ЦветАвторасчитываемойОбласти;
			КонецЕсли;
		Иначе
			ЗапретитьВводДанныхВОбласть(ОбрабатываемаяОбласть1, Форма.мСтруктураЦветовРаскраски);
			ЗапретитьВводДанныхВОбласть(ОбрабатываемаяОбласть2, Форма.мСтруктураЦветовРаскраски);
			ЗапретитьВводДанныхВОбласть(ОбрабатываемаяОбласть3, Форма.мСтруктураЦветовРаскраски);
			ЗапретитьВводДанныхВОбласть(ОбрабатываемаяОбласть4, Форма.мСтруктураЦветовРаскраски);
	...
	ИначеЕсли НаимТекущегоРаздела = "Раздел1" Тогда
		...
		Если Форма.ТабличныйДокумент.Области.Найти("П000010000100") <> Неопределено Тогда
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	ПроверитьКС_1_35а(СтруктураРезультата);
	
	ПроверитьКС_1_35б(СтруктураРезультата);
...
Процедура ПроверитьКС_1_1(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 021 Раздела 1) должна быть равна сумме всех значений строк 280 Раздела 2 по соответствующим кодам ОТКМО и КБК';
							|en = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 021 Раздела 1) должна быть равна сумме всех значений строк 280 Раздела 2 по соответствующим кодам ОТКМО и КБК'");
...
Процедура ПроверитьКС_1_2(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма налога, подлежащая уплате в бюджет (строка 030 Раздела 1) должна быть равна разнице значения строки 021 Раздела 1 и суммы строк 023, 025, 027 Раздела 1 по соответствующим кодам ОКТМО и КБК, если такая разница больше или равна нулю';
							|en = 'Сумма налога, подлежащая уплате в бюджет (строка 030 Раздела 1) должна быть равна разнице значения строки 021 Раздела 1 и суммы строк 023, 025, 027 Раздела 1 по соответствующим кодам ОКТМО и КБК, если такая разница больше или равна нулю'");
...
Процедура ПроверитьКС_1_3(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма налога, исчисленная к уменьшению (строка 040 Раздела 1) должна быть равна разнице суммы строк 023, 025, 027 Раздела 1 и значения строки 021 Раздела 1 по соответствующим кодам ОКТМО и КБК, если такая разница больше нуля';
							|en = 'Сумма налога, исчисленная к уменьшению (строка 040 Раздела 1) должна быть равна разнице суммы строк 023, 025, 027 Раздела 1 и значения строки 021 Раздела 1 по соответствующим кодам ОКТМО и КБК, если такая разница больше нуля'");
...
Процедура ПроверитьКС_1_5(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Значение строки 080 Раздела 2 (Не облагаемая налогом сумма) должно быть заполнено, если заполнена строка 070 Раздела 2';
							|en = 'Значение строки 080 Раздела 2 (Не облагаемая налогом сумма) должно быть заполнено, если заполнена строка 070 Раздела 2'");
...
Процедура ПроверитьКС_1_7(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Значение строки 100 Раздела 2 (Не облагаемая налогом сумма) должно быть заполнено, если заполнена строка 090 Раздела 2';
							|en = 'Значение строки 100 Раздела 2 (Не облагаемая налогом сумма) должно быть заполнено, если заполнена строка 090 Раздела 2'");
...
Процедура ПроверитьКС_1_8(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Код налоговой льготы (строка 110 Раздела 2) должен быть заполнен, если значение строки 120 больше нуля';
							|en = 'Код налоговой льготы (строка 110 Раздела 2) должен быть заполнен, если значение строки 120 больше нуля'");
...
Процедура ПроверитьКС_1_9(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Доля необлагаемой площади земельного участка (строка 120 Раздела 2) должна быть заполнена, если заполнена строка 110 Раздела 2';
							|en = 'Доля необлагаемой площади земельного участка (строка 120 Раздела 2) должна быть заполнена, если заполнена строка 110 Раздела 2'");
...
Процедура ПроверитьКС_1_11(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Значение строки 210 Раздела 2 (Сумма налоговой льготы) должно быть заполнено, если заполнена строка 200 Раздела 2';
							|en = 'Значение строки 210 Раздела 2 (Сумма налоговой льготы) должно быть заполнено, если заполнена строка 200 Раздела 2'");
...
Процедура ПроверитьКС_1_13(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Значение строки 230 Раздела 2 (Сумма налоговой льготы) должно быть заполнено, если заполнена строка 220 Раздела 2';
							|en = 'Значение строки 230 Раздела 2 (Сумма налоговой льготы) должно быть заполнено, если заполнена строка 220 Раздела 2'");
...
Процедура ПроверитьКС_1_14(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru = 'Проверка раздела 2 (КС 1.14)';
							|en = 'Проверка раздела 2 (КС 1.14)'");
	ОписаниеКС     = НСтр("ru = 'Код налоговой льготы (строка 240 Раздела 2) должен быть заполнен, если значение строки 250 больше нуля';
							|en = 'Код налоговой льготы (строка 240 Раздела 2) должен быть заполнен, если значение строки 250 больше нуля'");
...
Процедура ПроверитьКС_1_15(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Значение строки 250 Раздела 2 (Сумма налоговой льготы) должно быть заполнено, если заполнена строка 240 Раздела 2';
							|en = 'Значение строки 250 Раздела 2 (Сумма налоговой льготы) должно быть заполнено, если заполнена строка 240 Раздела 2'");
...
Процедура ПроверитьКС_1_16(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Код налоговой льготы (строка 260 Раздела 2) должен быть заполнен, если значение строки 270 больше нуля';
							|en = 'Код налоговой льготы (строка 260 Раздела 2) должен быть заполнен, если значение строки 270 больше нуля'");
...
Процедура ПроверитьКС_1_17(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Значение строки 270 Раздела 2 (Сумма налоговой льготы) должно быть заполнено, если заполнена строка 260 Раздела 2';
							|en = 'Значение строки 270 Раздела 2 (Сумма налоговой льготы) должно быть заполнено, если заполнена строка 260 Раздела 2'");
...
Процедура ПроверитьКС_1_18(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Количество полных месяцев использования льготы (строка 180 Раздела 2) должно быть больше нуля, если заполнены строки 200 и 210 Раздела 2 или строки 220 и 230 Раздела 2';
							|en = 'Количество полных месяцев использования льготы (строка 180 Раздела 2) должно быть больше нуля, если заполнены строки 200 и 210 Раздела 2 или строки 220 и 230 Раздела 2'");
...
Процедура ПроверитьКС_1_19(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма налоговой льготы (строка 210 Раздела 2) должна быть равна значение строки 170 Раздела 2 * (1 - строка 190 Раздела 2)';
							|en = 'Сумма налоговой льготы (строка 210 Раздела 2) должна быть равна значение строки 170 Раздела 2 * (1 - строка 190 Раздела 2)'");
...
Процедура ПроверитьКС_1_20(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма налоговой льготы (строка 230 Раздела 2) должна быть равна значение строки 170 Раздела 2 * (1 - строка 190 Раздела 2)';
							|en = 'Сумма налоговой льготы (строка 230 Раздела 2) должна быть равна значение строки 170 Раздела 2 * (1 - строка 190 Раздела 2)'");
...
Процедура ПроверитьКС_1_21а(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru = 'Проверка раздела 2 (КС 1.21а)';
							|en = 'Проверка раздела 2 (КС 1.21а)'");
	ОписаниеКС     = НСтр("ru = 'Налоговая база (строка 130 Раздела 2) должна быть равна разнице значений строк 050 и 080, если такая разница больше нуля и строки 060 и 100 Раздела 2 не заполнены';
							|en = 'Налоговая база (строка 130 Раздела 2) должна быть равна разнице значений строк 050 и 080, если такая разница больше нуля и строки 060 и 100 Раздела 2 не заполнены'");
...
Процедура ПроверитьКС_1_21б(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru = 'Проверка раздела 2 (КС 1.21б)';
							|en = 'Проверка раздела 2 (КС 1.21б)'");
	ОписаниеКС     = НСтр("ru = 'Налоговая база (строка 130 Раздела 2) должна быть равна нулю, если разница значений строк 050 и 080 меньше нуля и строки 060 и 100 Раздела 2 не заполнены';
							|en = 'Налоговая база (строка 130 Раздела 2) должна быть равна нулю, если разница значений строк 050 и 080 меньше нуля и строки 060 и 100 Раздела 2 не заполнены'");
...
Процедура ПроверитьКС_1_22а(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru = 'Проверка раздела 2 (КС 1.22а)';
							|en = 'Проверка раздела 2 (КС 1.22а)'");
	ОписаниеКС     = НСтр("ru = 'Налоговая база (строка 130 Раздела 2) должна быть равна разнице значений строк 050 и 100, если такая разница больше нуля и строки 060 и 080 Раздела 2 не заполнены';
							|en = 'Налоговая база (строка 130 Раздела 2) должна быть равна разнице значений строк 050 и 100, если такая разница больше нуля и строки 060 и 080 Раздела 2 не заполнены'");
...
Процедура ПроверитьКС_1_22б(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru = 'Проверка раздела 2 (КС 1.22б)';
							|en = 'Проверка раздела 2 (КС 1.22б)'");
	ОписаниеКС     = НСтр("ru = 'Налоговая база (строка 130 Раздела 2) должна быть равна нулю, если разница значений строк 050 и 100 меньше нуля и строки 060 ит 080 Раздела 2 не заполнены';
							|en = 'Налоговая база (строка 130 Раздела 2) должна быть равна нулю, если разница значений строк 050 и 100 меньше нуля и строки 060 ит 080 Раздела 2 не заполнены'");
...
Процедура ПроверитьКС_1_23а(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru = 'Проверка раздела 2 (КС 1.23а)';
							|en = 'Проверка раздела 2 (КС 1.23а)'");
	ОписаниеКС     = НСтр("ru = 'Налоговая база (строка 130 Раздела 2) должна быть равна строк 050 - строка 080 - строка 100 Раздела 2, если такая разница больше нуля и строка 060 Раздела 2 не заполнена';
							|en = 'Налоговая база (строка 130 Раздела 2) должна быть равна строк 050 - строка 080 - строка 100 Раздела 2, если такая разница больше нуля и строка 060 Раздела 2 не заполнена'");
	
	Нарушение      = НСтр("ru = 'НК РФ п.5 ст. 391, п.2 ст.387';
							|en = 'НК РФ п.5 ст. 391, п.2 ст.387'");
	ОписаниеОшибки = НСтр("ru = 'Неправильно определена не облагаемая налогом сумма, уменьшающая величину налоговой базы';
							|en = 'Неправильно определена не облагаемая налогом сумма, уменьшающая величину налоговой базы'");
...
Процедура ПроверитьКС_1_23б(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru = 'Проверка раздела 2 (КС 1.23б)';
							|en = 'Проверка раздела 2 (КС 1.23б)'");
	ОписаниеКС     = НСтр("ru = 'Налоговая база (строка 130 Раздела 2) должна быть равна нулю, если строка 050 Раздела 2 - строка 080 Раздела 2 - строка 100 Раздела 2 меньше нуля и строка 060 Раздела 2 не заполнена';
							|en = 'Налоговая база (строка 130 Раздела 2) должна быть равна нулю, если строка 050 Раздела 2 - строка 080 Раздела 2 - строка 100 Раздела 2 меньше нуля и строка 060 Раздела 2 не заполнена'");
...
Процедура ПроверитьКС_1_24(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Налоговая база (строка 130 Раздела 2) должна быть равна строка 050 - (строка 050 * строка 120 Раздела 2 * (1 - строка 190 Раздела 2))';
							|en = 'Налоговая база (строка 130 Раздела 2) должна быть равна строка 050 - (строка 050 * строка 120 Раздела 2 * (1 - строка 190 Раздела 2))'");
...
Процедура ПроверитьКС_1_25(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Налоговая база (строка 130 Раздела 2) должна быть равна (строка 050 Раздела 2 * строка 060 Раздела 2) - строка 080 Раздела 2, если строка 100 Раздела 2 не заполнена';
							|en = 'Налоговая база (строка 130 Раздела 2) должна быть равна (строка 050 Раздела 2 * строка 060 Раздела 2) - строка 080 Раздела 2, если строка 100 Раздела 2 не заполнена'");
...
Процедура ПроверитьКС_1_26(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Налоговая база (строка 130 Раздела 2) должна быть равна (строка 050 раздела 2 * строка 060 Раздела 2) - строка 100 Раздела 2, если такая разница больше нуля и строка 080 Раздела 2 не заполнена';
							|en = 'Налоговая база (строка 130 Раздела 2) должна быть равна (строка 050 раздела 2 * строка 060 Раздела 2) - строка 100 Раздела 2, если такая разница больше нуля и строка 080 Раздела 2 не заполнена'");
...
Процедура ПроверитьКС_1_27(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Налоговая база (строка 130 Раздела 2) должна быть равна (строка 050 Раздела 2 * строка 060 Раздела 2) - (строка 080 Раздела 2 + строка 100 Раздела 2), если такая разница больше нуля';
							|en = 'Налоговая база (строка 130 Раздела 2) должна быть равна (строка 050 Раздела 2 * строка 060 Раздела 2) - (строка 080 Раздела 2 + строка 100 Раздела 2), если такая разница больше нуля'");
...
Процедура ПроверитьКС_1_28(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Налоговая база (строка 130 Раздела 2) должна быть равна (строка 050 Раздела 2 * строка 060 Раздела 2) - (строка 050 раздела 2 * строка 060 Раздела 2) * (строка 120 раздела 2 * (1 - строка 190 Раздела 2), если такая разница больше нуля и строки 060, 120, 190 Раздела 2 заполнены или Налоговая база (строка 130 Раздела 2) должна быть равна нулю, если (строка 050 Раздела 2 * строка 060 Раздела 2) - (строка 050 раздела 2 * строка 060 Раздела 2) * (строка 120 раздела 2 * (1 - строка 190 Раздела 2) меньше или равна нулю и строки 060, 120, 190 Раздела 2 заполнены';
							|en = 'Налоговая база (строка 130 Раздела 2) должна быть равна (строка 050 Раздела 2 * строка 060 Раздела 2) - (строка 050 раздела 2 * строка 060 Раздела 2) * (строка 120 раздела 2 * (1 - строка 190 Раздела 2), если такая разница больше нуля и строки 060, 120, 190 Раздела 2 заполнены или Налоговая база (строка 130 Раздела 2) должна быть равна нулю, если (строка 050 Раздела 2 * строка 060 Раздела 2) - (строка 050 раздела 2 * строка 060 Раздела 2) * (строка 120 раздела 2 * (1 - строка 190 Раздела 2) меньше или равна нулю и строки 060, 120, 190 Раздела 2 заполнены'");
...
Процедура ПроверитьКС_1_29(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Коэффициент Кв (строка 160 раздела 2) должен быть равен ""1"", если значение строки 150 =""12"" (земельный участок использовался в течение всего налогового периода)';
							|en = 'Коэффициент Кв (строка 160 раздела 2) должен быть равен ""1"", если значение строки 150 =""12"" (земельный участок использовался в течение всего налогового периода)'");
...
Процедура ПроверитьКС_1_30(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма исчисленного налога (строка 170 Раздела 2) должна быть равна строка 130 Раздела 2 * строка 140 Раздела 2 * строка 160 Раздела 2) / 100';
							|en = 'Сумма исчисленного налога (строка 170 Раздела 2) должна быть равна строка 130 Раздела 2 * строка 140 Раздела 2 * строка 160 Раздела 2) / 100'");
...
Процедура ПроверитьКС_1_31(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма исчисленного налога (строка 170 Раздела 2) должна быть равна (строка 130 Раздела 2 * строка 140 Раздела 2 * строка 160 Раздела 2) / 100) * 2, если значение строки 040 раздела 2 = ""1""';
							|en = 'Сумма исчисленного налога (строка 170 Раздела 2) должна быть равна (строка 130 Раздела 2 * строка 140 Раздела 2 * строка 160 Раздела 2) / 100) * 2, если значение строки 040 раздела 2 = ""1""'");
...
Процедура ПроверитьКС_1_32(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма исчисленного налога (строка 170 Раздела 2) должна быть равна (строка 130 Раздела 2 * строка 140 Раздела 2 * строка 160 Раздела 2) / 100) * 4, если значение строки 040 раздела 2 = ""2""';
							|en = 'Сумма исчисленного налога (строка 170 Раздела 2) должна быть равна (строка 130 Раздела 2 * строка 140 Раздела 2 * строка 160 Раздела 2) / 100) * 4, если значение строки 040 раздела 2 = ""2""'");
...
&НаСервере
Процедура ПроверитьКС_1_35а(СтруктураРезультата)
	
	ОбщееЧислоОшибок    = СтруктураРезультата.КоличествоНайденныхОшибок;
	ОбщееЧислоБезОшибок = СтруктураРезультата.КоличествоНайденныхБезОшибок;
	СтруктураОшибок     = СтруктураРезультата.СтруктураОшибок;
	
	ТекстФормулы   = НСтр("ru = 'Проверка раздела 2 (КС 1.35а)';
							|en = 'Проверка раздела 2 (КС 1.35а)'");
	ОписаниеКС     = НСтр("ru = 'Сумма налоговой льготы (строка 250 Раздела 2) должна быть равна произведению значения строки 170 Раздела 2 * процент, на который уменьшается исчисленная сумма налога (строка 240а) / 100, если строка 240а заполнена';
							|en = 'Сумма налоговой льготы (строка 250 Раздела 2) должна быть равна произведению значения строки 170 Раздела 2 * процент, на который уменьшается исчисленная сумма налога (строка 240а) / 100, если строка 240а заполнена'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ПроверятьСоотношение = ЗначениеЗаполнено(Р2Стр250.Значение) И ЗначениеЗаполнено(Р2Стр240а.Значение);
		...
		КонтрольноеЗначение = Р2Стр170.Значение * Р2Стр240а.Значение / 100;
		КонтрольноеЗначение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Окр(КонтрольноеЗначение, 2));
		...
		Расшифровка = Р2Стр250.ЗначениеСтр + " = " + Р2Стр170.ЗначениеСтр
		            + " * " + Р2Стр240а.ЗначениеСтр + " / 100"
		            + " Итог [" + КонтрольноеЗначение + "], при условии что "
		            + Р2Стр240а.ЗначениеСтр + " <> 0";
...
&НаСервере
Процедура ПроверитьКС_1_35б(СтруктураРезультата)
	
	ОбщееЧислоОшибок    = СтруктураРезультата.КоличествоНайденныхОшибок;
	ОбщееЧислоБезОшибок = СтруктураРезультата.КоличествоНайденныхБезОшибок;
	СтруктураОшибок     = СтруктураРезультата.СтруктураОшибок;
	
	ТекстФормулы   = НСтр("ru = 'Проверка раздела 2 (КС 1.35б)';
							|en = 'Проверка раздела 2 (КС 1.35б)'");
	ОписаниеКС     = НСтр("ru = 'Сумма налоговой льготы (строка 250 Раздела 2) должна быть равна значению строки 240б, если строка 240б заполнена';
							|en = 'Сумма налоговой льготы (строка 250 Раздела 2) должна быть равна значению строки 240б, если строка 240б заполнена'");
	...
	Р2Стр240б = ПоказательПоСтроке("Р2Стр240б");
	Р2Стр250  = ПоказательПоСтроке("Р2Стр250");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр240б);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр250);
		
		ПроверятьСоотношение = ЗначениеЗаполнено(Р2Стр250.Значение) И ЗначениеЗаполнено(Р2Стр240б.Значение);
		...
		ВнестиПоказательВРасшифровку(Р2Стр250,  "Раздел2", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р2Стр240б, "Раздел2", НомерСтраницыСтр);
		
		КонтрольноеЗначение = Р2Стр240б.Значение;
		...
		Расшифровка = Р2Стр250.ЗначениеСтр + " = " + Р2Стр240б.ЗначениеСтр + " при условии что "
		            + Р2Стр240б.ЗначениеСтр + " <> 0";
...
Процедура ПроверитьКС_1_36(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru = 'Проверка раздела 2 (КС 1.36)';
							|en = 'Проверка раздела 2 (КС 1.36)'");
	ОписаниеКС     = НСтр("ru = 'Сумма налоговой льготы (строка 270 Раздела 2) должна быть равна значение строки 130 Раздела 2 * (налоговая ставка (строка 140) - пониженная ставка (строка 260а)) / 100';
							|en = 'Сумма налоговой льготы (строка 270 Раздела 2) должна быть равна значение строки 130 Раздела 2 * (налоговая ставка (строка 140) - пониженная ставка (строка 260а)) / 100'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		КонтрольноеЗначение = Р2Стр130.Значение * (Р2Стр140.Значение - Р2Стр260а.Значение) / 100;
		КонтрольноеЗначение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Окр(КонтрольноеЗначение, 2));
		...
		Расшифровка = Р2Стр270.ЗначениеСтр + " = " + Р2Стр130.ЗначениеСтр
		            + " * (" + Р2Стр140.ЗначениеСтр + " - " + Р2Стр260а.ЗначениеСтр + ") / 100"
		            + " Итог [" + КонтрольноеЗначение + "]";
...
Процедура ПроверитьКС_1_37(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 280 Раздела 2) должна быть равна разнице значение строк 170 и 250 Раздела 2, если строка 250 Раздела 2 заполнена';
							|en = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 280 Раздела 2) должна быть равна разнице значение строк 170 и 250 Раздела 2, если строка 250 Раздела 2 заполнена'");
	...
	ОписаниеОшибки = НСтр("ru = 'Неправильно определена исчисленная сумма земельного налога, подлежащая уплате в бюджет за налоговый период';
							|en = 'Неправильно определена исчисленная сумма земельного налога, подлежащая уплате в бюджет за налоговый период'");
...
Процедура ПроверитьКС_1_38(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 280 Раздела 2) должна быть равна разнице значение строк 170 и 270 Раздела 2, если строка 270 Раздела 2 заполнена';
							|en = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 280 Раздела 2) должна быть равна разнице значение строк 170 и 270 Раздела 2, если строка 270 Раздела 2 заполнена'");
...
Процедура ПроверитьКС_1_39(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 280 Раздела 2) должна быть равна разнице значение строк 170 и 210 Раздела 2, если строка 210 Раздела 2 заполнена, а строки 230, 250, 270 Раздела 2 не заполнены';
							|en = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 280 Раздела 2) должна быть равна разнице значение строк 170 и 210 Раздела 2, если строка 210 Раздела 2 заполнена, а строки 230, 250, 270 Раздела 2 не заполнены'");
...
Процедура ПроверитьКС_1_40(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 280 Раздела 2) должна быть равна разнице значение строк 170 и 230 Раздела 2, если строка 230 Раздела 2 заполнена, а строки 210, 250, 270 Раздела 2 не заполнены.';
							|en = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 280 Раздела 2) должна быть равна разнице значение строк 170 и 230 Раздела 2, если строка 230 Раздела 2 заполнена, а строки 210, 250, 270 Раздела 2 не заполнены.'");
...
Функция ПоказательПоСтроке(УсловныйКодПоказателя)
	...
	Если УсловныйКодПоказателя = "Р1Стр010" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Код бюджетной классификации (строка 010%1 раздела 1)';
												|en = 'Код бюджетной классификации (строка 010%1 раздела 1)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р1Стр020" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Код по ОКТМО (строка 020%1 раздела 1)';
												|en = 'Код по ОКТМО (строка 020%1 раздела 1)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р1Стр021" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (руб.) (строка 021%1 раздела 1)';
												|en = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (руб.) (строка 021%1 раздела 1)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р1Стр023" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'В т.ч. сумма авансовых платежей, подлежащая уплате в бюджет за первый квартал (руб.) (строка 023%1 раздела 1)';
												|en = 'В т.ч. сумма авансовых платежей, подлежащая уплате в бюджет за первый квартал (руб.) (строка 023%1 раздела 1)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р1Стр025" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'В т.ч. сумма авансовых платежей, подлежащая уплате в бюджет за второй квартал (руб.) (строка 025%1 раздела 1)';
												|en = 'В т.ч. сумма авансовых платежей, подлежащая уплате в бюджет за второй квартал (руб.) (строка 025%1 раздела 1)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р1Стр027" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'В т.ч. сумма авансовых платежей, подлежащая уплате в бюджет за третий квартал (руб.) (строка 027%1 раздела 1)';
												|en = 'В т.ч. сумма авансовых платежей, подлежащая уплате в бюджет за третий квартал (руб.) (строка 027%1 раздела 1)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р1Стр030" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Сумма налога, подлежащая уплате в бюджет (руб.) (строка 030%1 раздела 1)';
												|en = 'Сумма налога, подлежащая уплате в бюджет (руб.) (строка 030%1 раздела 1)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р1Стр040" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Сумма налога, исчисленная к уменьшению (руб.) (строка 040%1 раздела 1)';
												|en = 'Сумма налога, исчисленная к уменьшению (руб.) (строка 040%1 раздела 1)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр001" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Кадастровый номер земельного участка%1 раздела 2';
												|en = 'Кадастровый номер земельного участка%1 раздела 2'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр010" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Код бюджетной классификации (строка 010%1 раздела 2)';
												|en = 'Код бюджетной классификации (строка 010%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр020" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Код по ОКТМО (строка 020%1 раздела 2)';
												|en = 'Код по ОКТМО (строка 020%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр070" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Код налоговой льготы в виде не облагаемой налогом суммы (строка 070%1 раздела 2)';
												|en = 'Код налоговой льготы в виде не облагаемой налогом суммы (строка 070%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр040" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Период строительства (строка 040%1 раздела 2)';
												|en = 'Период строительства (строка 040%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр050" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Кадастровая стоимость (доля кадастровой стоимости) земельного участка (строка 050%1 раздела 2)';
												|en = 'Кадастровая стоимость (доля кадастровой стоимости) земельного участка (строка 050%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр060ч" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Доля налогоплательщика в праве на земельный участок (числитель) (строка 060%1 раздела 2)';
												|en = 'Доля налогоплательщика в праве на земельный участок (числитель) (строка 060%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр060з" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Доля налогоплательщика в праве на земельный участок (знаменатель) (строка 060%1 раздела 2)';
												|en = 'Доля налогоплательщика в праве на земельный участок (знаменатель) (строка 060%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр080" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Не облагаемая налогом сумма (руб.) (п.2 ст .387 Налогового кодекса Российской Федерации) (строка 080%1 раздела 2)';
												|en = 'Не облагаемая налогом сумма (руб.) (п.2 ст .387 Налогового кодекса Российской Федерации) (строка 080%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр090" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Код налоговой льготы в виде не облагаемой налогом суммы (строка 090%1 раздела 2)';
												|en = 'Код налоговой льготы в виде не облагаемой налогом суммы (строка 090%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр100" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Не облагаемая налогом сумма (руб.) (п.5 ст .391 Кодекса) (строка 100%1 раздела 2)';
												|en = 'Не облагаемая налогом сумма (руб.) (п.5 ст .391 Кодекса) (строка 100%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр110" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Код налоговой льготы в виде необлагаемой площади  земельного участка (строка 110%1 раздела 2)';
												|en = 'Код налоговой льготы в виде необлагаемой площади  земельного участка (строка 110%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр120ч" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Доля необлагаемой площади земельного участка (п.2 ст .387 Кодекса) (числитель) (строка 120%1 раздела 2)';
												|en = 'Доля необлагаемой площади земельного участка (п.2 ст .387 Кодекса) (числитель) (строка 120%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр120з" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Доля необлагаемой площади земельного участка (п.2 ст .387 Кодекса) (знаменатель) (строка 120%1 раздела 2)';
												|en = 'Доля необлагаемой площади земельного участка (п.2 ст .387 Кодекса) (знаменатель) (строка 120%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр130" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Налоговая база (руб.) (строка 130%1 раздела 2)';
												|en = 'Налоговая база (руб.) (строка 130%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр140" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Налоговая ставка (%) (строка 140%1 раздела 2)';
												|en = 'Налоговая ставка (%) (строка 140%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр150" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Количество полных месяцев владения земельным участком в течение налогового периода (строка 150%1 раздела 2)';
												|en = 'Количество полных месяцев владения земельным участком в течение налогового периода (строка 150%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр160" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Коэффициент Кв (строка 160%1 раздела 2)';
												|en = 'Коэффициент Кв (строка 160%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр170" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Сумма исчисленного налога (строка 170%1 раздела 2)';
												|en = 'Сумма исчисленного налога (строка 170%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр180" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Количество полных месяцев использования льготы (строка 180%1 раздела 2)';
												|en = 'Количество полных месяцев использования льготы (строка 180%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр190" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Коэффициент Кл (строка 190%1 раздела 2)';
												|en = 'Коэффициент Кл (строка 190%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр200" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Код налоговой льготы в виде освобождения от налогообложения (строка 200%1 раздела 2)';
												|en = 'Код налоговой льготы в виде освобождения от налогообложения (строка 200%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр210" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Сумма налоговой льготы (руб.) (п.2 ст . 387 Кодекса) (строка 210%1 раздела 2)';
												|en = 'Сумма налоговой льготы (руб.) (п.2 ст . 387 Кодекса) (строка 210%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр220" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Код налоговой льготы в виде освобождения от налогообложения (строка 220%1 раздела 2)';
												|en = 'Код налоговой льготы в виде освобождения от налогообложения (строка 220%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр230" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Сумма налоговой льготы (руб.) (ст .395 Кодекса) (строка 230%1 раздела 2)';
												|en = 'Сумма налоговой льготы (руб.) (ст .395 Кодекса) (строка 230%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр240" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Код налоговой льготы в виде уменьшения суммы налога (строка 240%1 раздела 2)';
												|en = 'Код налоговой льготы в виде уменьшения суммы налога (строка 240%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр240а" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Процент, уменьшающий исчисленную сумму налога (строка 240а%1 раздела 2)';
												|en = 'Процент, уменьшающий исчисленную сумму налога (строка 240а%1 раздела 2)'"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр240б" Тогда
		Результат.Вставить("Имя", "П000020024003_Сумма");
		Результат.Вставить("Представление", НСтр("ru = 'Сумма, уменьшающая исчисленную сумму налога (строка 240б%1 раздела 2)';
												|en = 'Сумма, уменьшающая исчисленную сумму налога (строка 240б%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр250" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Сумма налоговой льготы (руб.) (п.2 ст . 387 Кодекса) (строка 250%1 раздела 2)';
												|en = 'Сумма налоговой льготы (руб.) (п.2 ст . 387 Кодекса) (строка 250%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр260" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Код налоговой льготы в виде снижения налоговой ставки (строка 260%1 раздела 2)';
												|en = 'Код налоговой льготы в виде снижения налоговой ставки (строка 260%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр260а" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Пониженная налоговая ставка (строка 260а%1 раздела 2)';
												|en = 'Пониженная налоговая ставка (строка 260а%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр270" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Сумма налоговой льготы (руб.) (п.2 ст . 387 Кодекса) (строка 270%1 раздела 2)';
												|en = 'Сумма налоговой льготы (руб.) (п.2 ст . 387 Кодекса) (строка 270%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр280" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (руб.) (строка 280%1 раздела 2)';
												|en = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (руб.) (строка 280%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
