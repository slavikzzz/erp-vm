...
Процедура ПолучитьСведенияОПоказателяхОтчета()
	...
	РегламентированнаяОтчетностьКлиентСервер.ИмяОтчета(ЭтаФорма.ИмяФормы), РегламентированнаяОтчетностьКлиентСервер.ИмяФормыОтчета(ЭтаФорма.ИмяФормы), ПараметрыОтчета);
...
Процедура	ПроверитьКС_1_37(СтруктураРезультата)
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru = 'должна быть равна (строка 110 Раздела 2 х строка 120 Раздела 2 х строка 140 Раздела 2) / 100, ';
			|en = 'должна быть равна (строка 110 Раздела 2 х строка 120 Раздела 2 х строка 140 Раздела 2) / 100, '") +
		НСтр("ru = 'если строка 240 Раздела 2 заполнена';
			|en = 'если строка 240 Раздела 2 заполнена'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Раздел 2, Страница %1';
													|en = 'Раздел 2, Страница %1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = (%2 х %3 х %4) / 100 Итог [%5]';
													|en = '%1 = (%2 х %3 х %4) / 100 Итог [%5]'"));
