...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "28/10/2013";
	// Код отчета, равен коду по ОКУД.
	СтруктураРеквизитовФормы.мКодОтчета = "0608030";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	// Строка 27 = строке 01 минус строка 23.
	Для НомКол = 2 По 3 Цикл
		мФормаОтчета.Области["П0000010027" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
		= мФормаОтчета.Области["П0000010001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
		- мФормаОтчета.Области["П0000010023" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение;
	КонецЦикла;
	
	// Строка 46 = строка 01 минус строка 28.
	Для НомКол = 2 По 3 Цикл
		мФормаОтчета.Области["П0000010046" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
		= мФормаОтчета.Области["П0000010001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
		- мФормаОтчета.Области["П0000010028" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение;
	КонецЦикла;
...
Процедура УстановитьЗащитуИЦветФонаОбластейАвторассчитываемыхПоказателей()
	...
	мФормаОтчета.Области["П000001002702"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П000001002702"].Защита   = Не ОтклАвтоРасчетЗначение;
	мФормаОтчета.Области["П000001002703"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П000001002703"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П000001004602"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П000001004602"].Защита   = Не ОтклАвтоРасчетЗначение;
	мФормаОтчета.Области["П000001004603"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П000001004603"].Защита   = Не ОтклАвтоРасчетЗначение;
...
Функция ПечатьНаСервере(ВидПечати)
	...
	СтруктураПараметров.Вставить("НаименованиеЛиста",  "Форма 1-МБ");
	СтруктураПараметров.Вставить("ОриентацияЛиста",    "Ландшафт");
	СтруктураПараметров.Вставить("ИмяСтраницы",        "1МБ");
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	// КОНТРОЛЬ показателей формы (Указания по заполнению Формы 1-МБ).
	
	Для НомКол = 2 По 3 Цикл
		// Строка 01 >= сумме строк 02 - 05, 08, 11 - 14, 16, 18, 19.
		Если Не (ПараметрыВыгрузки["ПР000010001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")] >=
			  ПараметрыВыгрузки["ПР000010002" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010003" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010004" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010005" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010008" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010012" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010013" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010014" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010016" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010018" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010019" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: по гр. " + Формат(НомКол, "ЧГ=") + " значение в стр. 01 должно быть больше или равно сумме значений в строках 02 - 05, 08, 11 - 14, 16, 18, 19!",
				ИмяПоляТаблДокумента, "П0000010001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
		// Строка 05 >= сумме строк 06 и 07.
		Если Не (ПараметрыВыгрузки["ПР000010005" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")] >=
			  ПараметрыВыгрузки["ПР000010006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010007" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: по гр. " + Формат(НомКол, "ЧГ=") + " значение в стр. 05 должно быть больше или равно сумме значений в строках 06 и 07!",
				ИмяПоляТаблДокумента, "П0000010005" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
		// Строка 08 >= сумме строк 09 и 10.
		Если Не (ПараметрыВыгрузки["ПР000010008" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")] >=
			  ПараметрыВыгрузки["ПР000010009" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010010" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: по гр. " + Формат(НомКол, "ЧГ=") + " значение в стр. 08 должно быть больше или равно сумме значений в строках 09 и 10!",
		...
		Если Не (ПараметрыВыгрузки["ПР000010014" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")] >=
			...
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: по гр. " + Формат(НомКол, "ЧГ=") + " значение в стр. 14 должно быть больше или равно значению в строке 15!",
		...
		Если Не (ПараметрыВыгрузки["ПР000010016" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")] >=
			...
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: по гр. " + Формат(НомКол, "ЧГ=") + " значение в стр. 16 должно быть больше или равно значению в строке 17!",
				ИмяПоляТаблДокумента, "П0000010016" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
		// Строка 20 >= сумме строк 21 - 24, 26.
		Если Не (ПараметрыВыгрузки["ПР000010020" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")] >=
			  ПараметрыВыгрузки["ПР000010021" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010022" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010023" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010024" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010026" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: по гр. " + Формат(НомКол, "ЧГ=") + " значение в стр. 20 должно быть больше или равно сумме значений в строках 21 - 24, 26!",
				ИмяПоляТаблДокумента, "П0000010020" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
		// Строка 24 >= строке 25.
		Если Не (ПараметрыВыгрузки["ПР000010024" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")] >=
			ПараметрыВыгрузки["ПР000010025" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: по гр. " + Формат(НомКол, "ЧГ=") + " значение в стр. 24 должно быть больше или равно значению в строке 25!",
				ИмяПоляТаблДокумента, "П0000010024" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
		// Строка 28 >= сумме строк 29 - 32,37 - 44.
		Если Не (ПараметрыВыгрузки["ПР000010028" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")] >=
			  ПараметрыВыгрузки["ПР000010029" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010030" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010031" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010032" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010037" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010038" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010039" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010040" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010041" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010042" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010043" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010044" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: по гр. " + Формат(НомКол, "ЧГ=") + " значение в стр. 28 должно быть больше или равно сумме значений в строках 29 - 32, 37 - 44!",
				ИмяПоляТаблДокумента, "П0000010028" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
		// Строка 32 >= сумме строк 33 - 36.
		Если Не (ПараметрыВыгрузки["ПР000010032" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")] >=
			  ПараметрыВыгрузки["ПР000010033" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010034" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010035" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]
			+ ПараметрыВыгрузки["ПР000010036" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: по гр. " + Формат(НомКол, "ЧГ=") + " значение в стр. 32 должно быть больше или равно сумме значений в строках 33 - 36!",
				ИмяПоляТаблДокумента, "П0000010032" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
		// Строка 44 >= строке 45.
		Если Не (ПараметрыВыгрузки["ПР000010044" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")] >=
			ПараметрыВыгрузки["ПР000010045" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: по гр. " + Формат(НомКол, "ЧГ=") + " значение в стр. 44 должно быть больше или равно значению в строке 45!",
				ИмяПоляТаблДокумента, "П0000010044" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
...
Функция СформироватьСтруктуруПараметров()
	...
	// Для ПОСЛЕДУЮЩЕГО (ПЕРЕД ВЫГРУЗКОЙ) контроля показателей формы (Указания ФСН по заполнению Формы 1-МБ).
	Для НомКол = 2 По 3 Цикл
		Для НомСтр = 1 По 46 Цикл
			ПараметрыВыгрузки.Вставить("ПР00001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="), ТабДокумент["П000001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")]);
		КонецЦикла;
	КонецЦикла;
	// "Справочно".
	Для НомСтр = 47 По 49 Цикл
		ПараметрыВыгрузки.Вставить("ПР00001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "03", ТабДокумент["П000001" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "03"]);
	КонецЦикла;
