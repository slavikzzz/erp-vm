...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "10/10/2017";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Области.П0224003.Значение = Области.П0224004.Значение + Области.П0224005.Значение + Области.П0224006.Значение;
	Области.П0224103.Значение = Области.П0224104.Значение + Области.П0224105.Значение + Области.П0224106.Значение;
	Области.П0222003.Значение = Области.П0222004.Значение + Области.П0222005.Значение + Области.П0222006.Значение;
	Области.П0222103.Значение = Области.П0222104.Значение + Области.П0222105.Значение + Области.П0222106.Значение;
	
	Для Гр = 3 По 4 Цикл 
		Сумм = 0;
		Для Стр = 101 По 107 Цикл 
			Сумм = Сумм + Области["П01"+Стр+"0"+Гр].Значение;
		КонецЦикла;
		
		Области["П011000"+Гр].Значение = Сумм;
	КонецЦикла;
	...
	Для Гр = 3 По 7 Цикл 
		...
		Для Стр = 222 По 234 Цикл 
			Сумм = Сумм + Области["П02"+Стр+"0"+Гр].Значение;
		КонецЦикла;
		
		Области["П022210"+Гр].Значение = Сумм;
	КонецЦикла;
КонецПроцедуры
