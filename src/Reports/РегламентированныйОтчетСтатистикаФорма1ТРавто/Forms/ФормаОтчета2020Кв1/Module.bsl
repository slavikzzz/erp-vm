...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Области.П000020022003.Значение = Области.П000020022004.Значение
		+ Области.П000020022005.Значение
		+ Области.П000020022006.Значение;
		
	Области.П000020024003.Значение = Области.П000020024004.Значение
		+ Области.П000020024005.Значение
		+ Области.П000020024006.Значение;
		
	Области.П000020024103.Значение = Области.П000020024104.Значение
		+ Области.П000020024105.Значение
		+ Области.П000020024106.Значение;
	
	Для Гр = 3 По 4 Цикл
		Сумм = 0;
		Для Стр = 101 По 107 Цикл
			Сумм = Сумм + Области["П0000100" + Стр + "0" + Гр].Значение;
		КонецЦикла;
		Области["П00001001000" + Гр].Значение = Сумм;
	КонецЦикла;
	...
	Для Гр = 3 По 7 Цикл 
		...
		КонецЕсли;
		Сумм = 0;
		Для Стр = 222 По 234 Цикл
			Сумм = Сумм + Области["П0000200" + Стр + "0" + Гр].Значение;
		КонецЦикла;
		Области["П00002002210" + Гр].Значение = Сумм;
	КонецЦикла;
	
	Области.П000020022103.Значение = Области.П000020022104.Значение
		+ Области.П000020022105.Значение
		+ Области.П000020022106.Значение;
...
Процедура УстановитьЗащитуИЦветФонаОбластейАвторассчитываемыхПоказателей()
	...
	мФормаОтчета.Области["П000010010003"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П000010010003"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П000010010004"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П000010010004"].Защита   = Не ОтклАвтоРасчетЗначение;

	мФормаОтчета.Области["П000020022003"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П000020022003"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П000020022103"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П000020022103"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П000020022106"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П000020022106"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П000020022107"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П000020022107"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П000020024003"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П000020024003"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П000020024103"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П000020024103"].Защита   = Не ОтклАвтоРасчетЗначение;
