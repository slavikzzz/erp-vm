...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт
	...
	Возврат СтрШаблон(НСтр("ru = 'Справка-расчет транспортного налога%1';
							|en = 'Detailed calculation of vehicle tax%1'"), ПредставлениеПериодаРасчета);
