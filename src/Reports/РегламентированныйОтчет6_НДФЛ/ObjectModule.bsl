...
Процедура ИнициализироватьМногострочныеЧасти(ИмяФормы, СтруктураРеквизитовФормы) Экспорт
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв2") Тогда
		...
		ИменаГраф.Добавить("П000П1М100011");
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв2") Тогда
		...
		Если РасчетЗаПервыйКвартал Тогда
			...
			Для каждого Ветка Из ДеревоДанных.Строки Цикл
				...
				Данные.Вставить("П000020016003", Данные["П000020016103"] + Данные["П000020016203"]
				+ Данные["П000020016303"] + Данные["П000020016403"] + Данные["П000020016503"] + Данные["П000020016603"]);
				
				Данные.Вставить("П000020019003", Данные["П000020019103"] + Данные["П000020019203"]
				+ Данные["П000020019303"] + Данные["П000020019403"] + Данные["П000020019503"] + Данные["П000020019603"]);
	...
	ИначеЕсли ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв1") Тогда
		...
		Если РасчетЗаПервыйКвартал Тогда
			...
			Для каждого Ветка Из ДеревоДанных.Строки Цикл
				...
				Данные.Вставить("П000020016003", Данные["П000020016103"] + Данные["П000020016203"]
				+ Данные["П000020016303"] + Данные["П000020016403"]);
				
				Данные.Вставить("П000020019003", Данные["П000020019103"] + Данные["П000020019203"]
				+ Данные["П000020019303"] + Данные["П000020019403"]);
	...
	Для каждого Ветка Из ДеревоДанных.Строки Цикл
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв2") Тогда
			...
			Если РасчетЗаПервыйКвартал Тогда
				...
				+ Данные["П000010002301"] + Данные["П000010002401"] + Данные["П000010002501"] + Данные["П000010002601"]);
				
				Данные.Вставить("П000010003001", Данные["П000010003101"] + Данные["П000010003201"]
				+ Данные["П000010003301"] + Данные["П000010003401"] + Данные["П000010003501"] + Данные["П000010003601"]);
		...
		ИначеЕсли ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв1") Тогда
			...
			Если РасчетЗаПервыйКвартал Тогда
				...
				Данные.Вставить("П000010003001", Данные["П000010003101"] + Данные["П000010003201"]
				+ Данные["П000010003301"] + Данные["П000010003401"]);
...
Функция ПроверитьВозможностьВыгрузки(ИмяФормы,
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв2")
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв2")
			...
			ВозможныеСтатусыНалогоплательщика = СтрРазделить("1,2,3,4,5,6,7,8", ",", Ложь);
			
		Иначе// "ФормаОтчета2023Кв1", "ФормаОтчета2021Кв4"
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв2")
		...
		ВозможныеКодыВидаДокУдЛичность = СтрРазделить("21,03,07,08,10,11,12,13,14,15,19,22,23,24,27,91", ",", Ложь);
		
	Иначе// "ФормаОтчета2023Кв1", "ФормаОтчета2021Кв4", "ФормаОтчета2021Кв1"
	...
	Для каждого Ветка Из ДеревоРаздела.Строки Цикл
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв2") Тогда
			...
			Если Окр(Данные["П000010002401"]) < 0 Тогда
				...
				СтатусПроверки = Ложь;
			КонецЕсли;
			Если Окр(Данные["П000010002501"]) < 0 Тогда
				СообщитьВТС(ИмяФормы, РезультатВыгрузки, "Раздел 1 -> Страница " + НомерСтраницы
				+ ": значение в строке 025 не должно быть отрицательным", "Раздел1", "П000010002501", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			Если Окр(Данные["П000010002601"]) < 0 Тогда
				СообщитьВТС(ИмяФормы, РезультатВыгрузки, "Раздел 1 -> Страница " + НомерСтраницы
				+ ": значение в строке 026 не должно быть отрицательным", "Раздел1", "П000010002601", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			Если Окр(Данные["П000010003001"]) < 0 Тогда
				СообщитьВТС(ИмяФормы, РезультатВыгрузки, "Раздел 1 -> Страница " + НомерСтраницы
				+ ": значение в строке 030 не должно быть отрицательным", "Раздел1", "П000010003001", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			Если Окр(Данные["П000010003101"]) < 0 Тогда
				СообщитьВТС(ИмяФормы, РезультатВыгрузки, "Раздел 1 -> Страница " + НомерСтраницы
				+ ": значение в строке 031 не должно быть отрицательным", "Раздел1", "П000010003101", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			Если Окр(Данные["П000010003201"]) < 0 Тогда
				СообщитьВТС(ИмяФормы, РезультатВыгрузки, "Раздел 1 -> Страница " + НомерСтраницы
				+ ": значение в строке 032 не должно быть отрицательным", "Раздел1", "П000010003201", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			Если Окр(Данные["П000010003301"]) < 0 Тогда
				СообщитьВТС(ИмяФормы, РезультатВыгрузки, "Раздел 1 -> Страница " + НомерСтраницы
				+ ": значение в строке 033 не должно быть отрицательным", "Раздел1", "П000010003301", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			Если Окр(Данные["П000010003401"]) < 0 Тогда
				СообщитьВТС(ИмяФормы, РезультатВыгрузки, "Раздел 1 -> Страница " + НомерСтраницы
				+ ": значение в строке 034 не должно быть отрицательным", "Раздел1", "П000010003401", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			Если Окр(Данные["П000010003501"]) < 0 Тогда
				СообщитьВТС(ИмяФормы, РезультатВыгрузки, "Раздел 1 -> Страница " + НомерСтраницы
				+ ": значение в строке 035 не должно быть отрицательным", "Раздел1", "П000010003501", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			Если Окр(Данные["П000010003601"]) < 0 Тогда
				СообщитьВТС(ИмяФормы, РезультатВыгрузки, "Раздел 1 -> Страница " + НомерСтраницы
				+ ": значение в строке 036 не должно быть отрицательным", "Раздел1", "П000010003601", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
					...
					ИначеЕсли ЗаполненРаздел2Приложения1 Тогда
						...
						Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
							...
							Если СтрокаМнЧ.Данные["П000П1М100008"] < 0 Тогда
								...
								+ ": сумма налога, излишне удержанная налоговым агентом, не должна быть отрицательной",
							...
							Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв2")
								...
								Если СтрокаМнЧ.Данные["П000П1М100010"] < 0 Тогда
									СообщитьВТС(ИмяФормы, РезультатВыгрузки, "Приложение 1 -> " + ПредстСтраницы + " -> " + ПредстРаздела2
									+ ": сумма налога на прибыль организаций, подлежащая зачету, не должна быть отрицательной",
							...
							Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв2") Тогда
								...
								Если СтрокаМнЧ.Данные["П000П1М100011"] < 0 Тогда
									СообщитьВТС(ИмяФормы, РезультатВыгрузки, "Приложение 1 -> " + ПредстСтраницы + " -> " + ПредстРаздела2
									+ ": сумма налога, исчисленная и уплаченная в иностранном государстве, не должна быть отрицательной",
									"Приложение1", "П000П1М100011_" + НомерСтроки, НомерСтраницы);
									СтатусПроверки = Ложь;
								КонецЕсли;
...
Процедура ОтсечьНезаполненныеНеобязательныеУзлы(ИмяФормы, Узел, ПараметрыВыгрузки)
	...
	Для Инд = 1 По КоличествоСтрок Цикл
		...
		Если Стр.Код = "СправДох"
			И (ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв2")
			ИЛИ ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв1")
			ИЛИ ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2023Кв1")
			ИЛИ ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2021Кв4")) Тогда
	...
	Для каждого Ветка Из ДанныеРазд.Строки Цикл
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв2")
			...
			Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв2")
				...
				Если Окр(Ветка.Данные["П000010003001"] > 0) Тогда
					СведСумНалВоз = ПолучитьПодчиненныйЭлемент(ИмяФормы, ЭкзОбязНА, "СведСумНалВоз");
					СведСумНалВоз.Обязательность = "О";
				КонецЕсли;
					...
					Для каждого Ветка Из ДеревоРаздела.Строки Цикл
						...
						Для каждого СтрокаМнЧ_1 Из ДеревоМнЧ_1.Строки Цикл
							...
							Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв2") Тогда
								...
								ПотокXML.ЗаписатьАтрибут("СумНалИнГос",   СокрЛП(Формат(ДанСтрМнЧ_1["П000П1М100011"], Ч_15_0)));
								ПотокXML.ЗаписатьАтрибут("НалУдерж",      СокрЛП(Формат(ДанСтрМнЧ_1["П000П1М100005"], Ч_15_0)));
								
							Иначе// "ФормаОтчета2024Кв1", "ФормаОтчета2023Кв1", "ФормаОтчета2021Кв4"
	...
	Иначе
		...
		Для Каждого Область Из ТабличныйДокумент.Области Цикл
			Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Прямоугольник
				...
				Если ПараметрыПечати.ИмяСтраницы = "Раздел2" И Область.Значение = 0
					И (((Область.Имя = "П000020012003" ИЛИ Область.Имя = "П000020012103" ИЛИ Область.Имя = "П000020013003"
					ИЛИ Область.Имя = "П000020013103")
					
					И (ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв2") ИЛИ ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв1")))
					
					ИЛИ (Область.Имя = "П000020011003" ИЛИ Область.Имя = "П000020011103" ИЛИ Область.Имя = "П000020011203"
					ИЛИ Область.Имя = "П000020011303" ИЛИ Область.Имя = "П000020013003" ИЛИ (Область.Имя = "П000020011503"
					
					И (ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2023Кв1") ИЛИ ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2021Кв4"))))) Тогда
		...
		Если ПараметрыПечати.ИмяСтраницы = "Раздел2" Тогда
			...
			Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2024Кв2")
				...
				КолФЛ = ТабличныйДокумент.Область("П000020011003").Значение;
				
				Если КолФЛ < 10000000 Тогда // 7 знакомест
				...
				Иначе // 9 знакомест
					...
					НовСтр = Показатели.Добавить();
					НовСтр.Имя = "П200020011003";
					НовСтр.Значение = КолФЛ;
					НовСтр.ЗначениеМЧБ = Формат(КолФЛ, "ЧГ=");
					
				КонецЕсли;
				
				КолКвал = ТабличныйДокумент.Область("П000020011103").Значение;
				
				Если КолКвал < 10000000 Тогда // 7 знакомест
					
					МакетПечатнойФормы.УдалитьОбласть(МакетПечатнойФормы.Область("КолКвал_Длина8"),
					ТипСмещенияТабличногоДокумента.ПоВертикали);
					МакетПечатнойФормы.УдалитьОбласть(МакетПечатнойФормы.Область("КолКвал_Длина9"),
					ТипСмещенияТабличногоДокумента.ПоВертикали);
					
					НовСтр = Показатели.Добавить();
					НовСтр.Имя = "П000020011103";
					НовСтр.Значение = КолКвал;
					НовСтр.ЗначениеМЧБ = Формат(КолКвал, "ЧГ=");
					
				ИначеЕсли КолКвал < 100000000 Тогда // 8 знакомест
					
					МакетПечатнойФормы.УдалитьОбласть(МакетПечатнойФормы.Область("КолКвал_Длина7"),
					ТипСмещенияТабличногоДокумента.ПоВертикали);
					МакетПечатнойФормы.УдалитьОбласть(МакетПечатнойФормы.Область("КолКвал_Длина9"),
					ТипСмещенияТабличногоДокумента.ПоВертикали);
					
					НовСтр = Показатели.Добавить();
					НовСтр.Имя = "П100020011103";
					НовСтр.Значение = КолКвал;
					НовСтр.ЗначениеМЧБ = Формат(КолКвал, "ЧГ=");
...
Функция ПроверитьКонтрольныеСоотношенияДлительнаяОперация(СтруктураПараметров) Экспорт
	...
	Если НЕ СтрНайти(СтруктураПараметров.мВыбраннаяФорма, "2024Кв2") = 0 Тогда
		
		Возврат ПроверитьКонтрольныеСоотношения_2024Кв2(СтруктураПараметров);
	
	ИначеЕсли НЕ СтрНайти(СтруктураПараметров.мВыбраннаяФорма, "2023Кв1") = 0 Тогда
...
Процедура ПроверкаКС_1_01()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Дата представления Расчета должна быть не позднее 1 марта года, следующего за истекшим налоговым ';
			|en = 'Дата представления Расчета должна быть не позднее 1 марта года, следующего за истекшим налоговым '") +
		НСтр("ru = 'периодом (для Расчета за год) и не позднее последнего дня месяца, следующего за отчетным периодом ';
			|en = 'периодом (для Расчета за год) и не позднее последнего дня месяца, следующего за отчетным периодом '") +
		НСтр("ru = '(для Расчетов за 1 квартал, полугодие и 9 месяцев)';
			|en = '(для Расчетов за 1 квартал, полугодие и 9 месяцев)'"));
	...
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможно нарушение срока представления Расчета';
			|en = 'Возможно нарушение срока представления Расчета'"));
...
Процедура ПроверкаКС_1_02()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма дохода в стр.110 Раздела 2 >= стр.130 Раздела 2';
			|en = 'Сумма дохода в стр.110 Раздела 2 >= стр.130 Раздела 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
...
Процедура ПроверкаКС_1_03()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.140 Раздела 2 = (стр.110 - стр.130) х стр.100 Раздела 2 / 100, ';
			|en = 'Сумма налога в стр.140 Раздела 2 = (стр.110 - стр.130) х стр.100 Раздела 2 / 100, '") +
		НСтр("ru = 'с допустимой погрешностью 1 руб. х стр.120 Раздела 2 х количество стр.021 Раздела 1';
			|en = 'с допустимой погрешностью 1 руб. х стр.120 Раздела 2 х количество стр.021 Раздела 1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = (%2 - %3) х %4 / 100 Итог [%5] ± (1 х %6 х %7 Итог [%8])';
													|en = '%1 = (%2 - %3) х %4 / 100 Итог [%5] ± (1 х %6 х %7 Итог [%8])'"));
...
Процедура ПроверкаКС_1_04()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.140 Раздела 2 >= стр.150 Раздела 2';
			|en = 'Сумма налога в стр.140 Раздела 2 >= стр.150 Раздела 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_05()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма дохода в стр.110 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 = ';
			|en = 'Сумма дохода в стр.110 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 = '") +
		НСтр("ru = 'сумме строк ""Общая сумма дохода"" по соответствующей ставке налога Приложения № 1 ';
			|en = 'сумме строк ""Общая сумма дохода"" по соответствующей ставке налога Приложения № 1 '") +
		НСтр("ru = 'к 6-НДФЛ, представленных по всем налогоплательщикам этим налоговым агентом ';
			|en = 'к 6-НДФЛ, представленных по всем налогоплательщикам этим налоговым агентом '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
...
Процедура ПроверкаКС_1_06()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Средняя заработная плата >= МРОТ. Средняя заработная плата определяется по каждому работнику ';
			|en = 'Средняя заработная плата >= МРОТ. Средняя заработная плата определяется по каждому работнику '") +
		НСтр("ru = 'на основании данных Приложений ""Сведения о доходах и соответствующих вычетах по месяцам ';
			|en = 'на основании данных Приложений ""Сведения о доходах и соответствующих вычетах по месяцам '") +
		НСтр("ru = 'налогового периода"" Приложения № 1 к 6-НДФЛ, относящихся к оплате труда, представленных ';
			|en = 'налогового периода"" Приложения № 1 к 6-НДФЛ, относящихся к оплате труда, представленных '") +
		НСтр("ru = 'налоговым агентом по соответствующим ИНН, ОКТМО, КПП за аналогичный период ';
			|en = 'налоговым агентом по соответствующим ИНН, ОКТМО, КПП за аналогичный период '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
...
Процедура ПроверкаКС_1_07()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Средняя заработная плата >= средняя заработная плата в субъекте РФ по соответствующей отрасли ';
			|en = 'Средняя заработная плата >= средняя заработная плата в субъекте РФ по соответствующей отрасли '") +
		НСтр("ru = 'экономики. Средняя заработная плата определяется в целом по налоговому агенту ';
			|en = 'экономики. Средняя заработная плата определяется в целом по налоговому агенту '") +
		НСтр("ru = 'на основании данных Приложений ""Сведения о доходах и соответствующих вычетах по месяцам ';
			|en = 'на основании данных Приложений ""Сведения о доходах и соответствующих вычетах по месяцам '") +
		НСтр("ru = 'налогового периода"" Приложения № 1 к 6-НДФЛ, относящихся к оплате труда, представленных ';
			|en = 'налогового периода"" Приложения № 1 к 6-НДФЛ, относящихся к оплате труда, представленных '") +
...
Процедура ПроверкаКС_1_08()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма дохода в виде дивидендов в стр. 111 Раздела 2 = сумме дохода в виде дивидендов (по ';
			|en = 'Сумма дохода в виде дивидендов в стр. 111 Раздела 2 = сумме дохода в виде дивидендов (по '") +
		НСтр("ru = 'коду доходов 1010) Приложения № 1 к 6-НДФЛ, представленных по всем налогоплательщикам ';
			|en = 'коду доходов 1010) Приложения № 1 к 6-НДФЛ, представленных по всем налогоплательщикам '") +
		НСтр("ru = 'этим налоговым агентом ';
			|en = 'этим налоговым агентом '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
...
Процедура ПроверкаКС_1_09()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.140 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 = ';
			|en = 'Сумма налога в стр.140 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 = '") +
		НСтр("ru = 'сумме строк ""Сумма налога исчисленная"" по соответствующей ставке налога Приложения № 1 ';
			|en = 'сумме строк ""Сумма налога исчисленная"" по соответствующей ставке налога Приложения № 1 '") +
		НСтр("ru = 'к 6-НДФЛ, представленных по всем налогоплательщикам этим налоговым агентом ';
			|en = 'к 6-НДФЛ, представленных по всем налогоплательщикам этим налоговым агентом '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
...
Процедура ПроверкаКС_1_10()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.170 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 = сумме ';
			|en = 'Сумма налога в стр.170 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 = сумме '") +
		НСтр("ru = 'строк ""Сумма налога не удержанная налоговым агентом"" по соответствующей ставке налога ';
			|en = 'строк ""Сумма налога не удержанная налоговым агентом"" по соответствующей ставке налога '") +
		НСтр("ru = 'Приложения № 1 к 6-НДФЛ, представленных по всем налогоплательщикам этим налоговым агентом ';
			|en = 'Приложения № 1 к 6-НДФЛ, представленных по всем налогоплательщикам этим налоговым агентом '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2, ставка %3';
													|en = '%1 = %2, ставка %3'"));
...
Процедура ПроверкаКС_1_11()
	...
	Заголовки.Вставить("Условие"			, НСтр("ru = 'Отчет за год, ставка налога в Разделе 2 Приложения 1 13 или 15%';
													|en = 'Отчет за год, ставка налога в Разделе 2 Приложения 1 13 или 15%'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 1';
														|en = 'Приложение 1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.126.1 НК РФ';
													|en = 'ст.126.1 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Стр. ""Налоговая база"" Раздела 2 Приложения № 1 к 6-НДФЛ (при значении ставки 13%, 15%) = ';
			|en = 'Стр. ""Налоговая база"" Раздела 2 Приложения № 1 к 6-НДФЛ (при значении ставки 13%, 15%) = '") +
		НСтр("ru = 'стр. ""Общая сумма дохода"" Раздела 2 - сумма стр. ""Сумма вычета"" Приложения ""Сведения ';
			|en = 'стр. ""Общая сумма дохода"" Раздела 2 - сумма стр. ""Сумма вычета"" Приложения ""Сведения '") +
		НСтр("ru = 'о доходах и соответствующих вычетах по месяцам налогового периода"" - сумма стр. ""Сумма ';
			|en = 'о доходах и соответствующих вычетах по месяцам налогового периода"" - сумма стр. ""Сумма '") +
		НСтр("ru = 'вычета"" Раздела 3 ';
			|en = 'вычета"" Раздела 3 '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - %3 - %4 Итог [%5], ставка %6';
													|en = '%1 = %2 - %3 - %4 Итог [%5], ставка %6'"));
...
Процедура ПроверкаКС_1_12()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Стр. ""Налоговая база"" Раздела 2 Приложения № 1 к 6-НДФЛ (при значении ставки, отличной от ';
			|en = 'Стр. ""Налоговая база"" Раздела 2 Приложения № 1 к 6-НДФЛ (при значении ставки, отличной от '") +
		НСтр("ru = '13%, 15%) = стр. ""Общая сумма дохода"" Раздела 2 - сумма стр. ""Сумма вычета"" Приложения ';
			|en = '13%, 15%) = стр. ""Общая сумма дохода"" Раздела 2 - сумма стр. ""Сумма вычета"" Приложения '") +
		НСтр("ru = '""Сведения о доходах и соответствующих вычетах по месяцам налогового периода"" ';
			|en = '""Сведения о доходах и соответствующих вычетах по месяцам налогового периода"" '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - %3 Итог [%4], ставка %5';
													|en = '%1 = %2 - %3 Итог [%4], ставка %5'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налоговой базы';
														|en = 'Ошибочная сумма налоговой базы'"));
	Настройки = ОбработатьНастройки(		, Заголовки);
...
Процедура ПроверкаКС_1_13()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Стр. ""Сумма налога исчисленная"" Раздела 2 Приложения № 1 к 6-НДФЛ - стр. ""Налоговая база"" ';
			|en = 'Стр. ""Сумма налога исчисленная"" Раздела 2 Приложения № 1 к 6-НДФЛ - стр. ""Налоговая база"" '") +
		НСтр("ru = 'х стр. ""Ставка налога"" / 100 <= 1 руб. ';
			|en = 'х стр. ""Ставка налога"" / 100 <= 1 руб. '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 - (%2 х %3 / 100 Итог [%4]) Итог [%5]  = 0 ± 1 руб.';
													|en = '%1 - (%2 х %3 / 100 Итог [%4]) Итог [%5]  = 0 ± 1 руб.'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	Настройки = ОбработатьНастройки(		, Заголовки);
...
Процедура ПроверкаКС_1_14()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = '(Сумма стр. ""Сумма дохода"" Приложения ""Сведения о доходах и соответствующих вычетах по месяцам ';
			|en = '(Сумма стр. ""Сумма дохода"" Приложения ""Сведения о доходах и соответствующих вычетах по месяцам '") +
		НСтр("ru = 'налогового периода"" - сумма стр. ""Сумма вычета"" Приложения ""Сведения о доходах и ';
			|en = 'налогового периода"" - сумма стр. ""Сумма вычета"" Приложения ""Сведения о доходах и '") +
		НСтр("ru = 'соответствующих вычетах по месяцам налогового периода"") х стр. ""Ставка налога"" / 100 - стр. ';
			|en = 'соответствующих вычетах по месяцам налогового периода"") х стр. ""Ставка налога"" / 100 - стр. '") +
		НСтр("ru = '""Сумма налога исчисленная"" Раздела 2 Приложения № 1 к 6-НДФЛ <= 1 руб., (при значении ставки, ';
			|en = '""Сумма налога исчисленная"" Раздела 2 Приложения № 1 к 6-НДФЛ <= 1 руб., (при значении ставки, '") +
		НСтр("ru = 'отличной от 13%, 15%), (соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = 'отличной от 13%, 15%), (соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '(%1 - %2) х %3 / 100 - %4 Итог [%5] = 0 ± 1 руб.';
													|en = '(%1 - %2) х %3 / 100 - %4 Итог [%5] = 0 ± 1 руб.'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма дохода';
														|en = 'Ошибочная сумма дохода'"));
	Настройки = ОбработатьНастройки(		, Заголовки);
...
Процедура ПроверкаКС_1_15()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Стр. ""Сумма дохода, с которого не удержан налог налоговым агентом"" Раздела 4 Приложения № 1 ';
			|en = 'Стр. ""Сумма дохода, с которого не удержан налог налоговым агентом"" Раздела 4 Приложения № 1 '") +
		НСтр("ru = 'к 6-НДФЛ х стр. ""Ставка налога"" / 100 - стр. ""Сумма неудержанного налога"" Раздела 4 ';
			|en = 'к 6-НДФЛ х стр. ""Ставка налога"" / 100 - стр. ""Сумма неудержанного налога"" Раздела 4 '") +
		НСтр("ru = 'Приложения № 1 к 6-НДФЛ <= 1 руб. ';
			|en = 'Приложения № 1 к 6-НДФЛ <= 1 руб. '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 х %2 / 100 - %3 Итог [%4] = 0 ± 1 руб.';
													|en = '%1 х %2 / 100 - %3 Итог [%4] = 0 ± 1 руб.'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма дохода';
														|en = 'Ошибочная сумма дохода'"));
	Настройки = ОбработатьНастройки(		, Заголовки);
...
Процедура ПроверкаКС_1_16()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Стр. ""Общая сумма дохода"" Раздела 2 Приложения № 1 к 6-НДФЛ = сумме стр. ""Сумма дохода"" ';
			|en = 'Стр. ""Общая сумма дохода"" Раздела 2 Приложения № 1 к 6-НДФЛ = сумме стр. ""Сумма дохода"" '") +
		НСтр("ru = 'Приложения ""Сведения о доходах и соответствующих вычетах по месяцам налогового периода"" ';
			|en = 'Приложения ""Сведения о доходах и соответствующих вычетах по месяцам налогового периода"" '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
...
Процедура ПроверкаКС_1_17()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru = 'к 6-НДФЛ  <= стр. ""Общая сумма дохода"" Раздела 2 Приложения № 1 к 6-НДФЛ (соотношение ';
			|en = 'к 6-НДФЛ  <= стр. ""Общая сумма дохода"" Раздела 2 Приложения № 1 к 6-НДФЛ (соотношение '") +
		НСтр("ru = 'применяется к 6-НДФЛ за налоговый период)';
			|en = 'применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма дохода';
														|en = 'Ошибочная сумма дохода'"));
...
Процедура ПроверкаКС_1_18()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Количество физических лиц, получивших доход в стр.120 Раздела 2 по соответствующей ставке в стр.100 ';
			|en = 'Количество физических лиц, получивших доход в стр.120 Раздела 2 по соответствующей ставке в стр.100 '") +
		НСтр("ru = 'Раздела 2 = количество Разделов 2 Приложения № 1 к 6-НДФЛ по соответствующей ставке ';
			|en = 'Раздела 2 = количество Разделов 2 Приложения № 1 к 6-НДФЛ по соответствующей ставке '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2, ставка %3';
													|en = '%1 = %2, ставка %3'"));
...
Процедура ПроверкаКС_1_19()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма вычетов в стр.130 Раздела 2 = сумма строк ""Сумма вычета"" Раздела 3 Приложения № 1 ';
			|en = 'Сумма вычетов в стр.130 Раздела 2 = сумма строк ""Сумма вычета"" Раздела 3 Приложения № 1 '") +
		НСтр("ru = 'к 6-НДФЛ + сумма стр. ""Сумма вычета"" Приложения ""Сведения о доходах и соответствующих ';
			|en = 'к 6-НДФЛ + сумма стр. ""Сумма вычета"" Приложения ""Сведения о доходах и соответствующих '") +
		НСтр("ru = 'вычетах по месяцам налогового периода"" Приложения № 1 к 6-НДФЛ ';
			|en = 'вычетах по месяцам налогового периода"" Приложения № 1 к 6-НДФЛ '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 + %3 Итог [%4], ставка %5';
													|en = '%1 = %2 + %3 Итог [%4], ставка %5'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма вычетов';
														|en = 'Ошибочная сумма вычетов'"));
	Настройки = ОбработатьНастройки(		, Заголовки);
...
Процедура ПроверкаКС_1_20()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.150 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 = ';
			|en = 'Сумма авансового платежа в стр.150 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 = '") +
		НСтр("ru = 'сумме строк ""Сумма фиксированных авансовых платежей"" Раздела 2 Приложения № 1 к 6-НДФЛ ';
			|en = 'сумме строк ""Сумма фиксированных авансовых платежей"" Раздела 2 Приложения № 1 к 6-НДФЛ '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2, ставка %3';
													|en = '%1 = %2, ставка %3'"));
...
Процедура ПроверкаКС_1_21_доп()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение КБК в стр.010 Раздела 1 должно соответствовать списку ';
			|en = 'Значение КБК в стр.010 Раздела 1 должно соответствовать списку '") +
...
Процедура ПроверкаКС_1_22_доп()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.020 Раздела 1 = сумме всех строк 022 Раздела 1';
			|en = 'Сумма налога в стр.020 Раздела 1 = сумме всех строк 022 Раздела 1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_23_доп()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.030 Раздела 1 = сумме всех строк 032 Раздела 1';
			|en = 'Сумма налога в стр.030 Раздела 1 = сумме всех строк 032 Раздела 1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_24_доп()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение КБК в стр.105 Раздела 2 должно соответствовать списку ';
			|en = 'Значение КБК в стр.105 Раздела 2 должно соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
...
Процедура ПроверкаКС_1_25_доп()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма дохода в стр.110 Раздела 2 >= (стр.111 + стр.112 + стр.113) Раздела 2';
			|en = 'Сумма дохода в стр.110 Раздела 2 >= (стр.111 + стр.112 + стр.113) Раздела 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма дохода';
														|en = 'Ошибочная сумма дохода'"));
...
#Область Проверки
	...
	ПроверкаКС_7_1_01_к_2021Кв4();
	ПроверкаКС_7_1_02_к_2021Кв4();
	ПроверкаКС_7_1_03_к_2021Кв4();
	ПроверкаКС_7_1_04_к_2021Кв4();
	ПроверкаКС_7_2_к_2021Кв4();
...
Процедура ПроверкаКС_7_1_01_к_2021Кв4()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.1.01.к';
													|en = '7.1.01.к'"));
	...
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога в стр.020 Раздела 1 >= 0';
														|en = 'Сумма налога в стр.020 Раздела 1 >= 0'"));
	...
	ПроверкаКС_7_1_01_к_код_2021Кв4(Настройки);
	
КонецПроцедуры

Процедура ПроверкаКС_7_1_01_к_код_2021Кв4(Настройки)
...
Процедура ПроверкаКС_7_1_02_к_2021Кв4()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.1.02.к';
													|en = '7.1.02.к'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога в стр.022 Раздела 1 >= 0';
														|en = 'Сумма налога в стр.022 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Возможно ошибочная сумма налога';
														|en = 'Возможно ошибочная сумма налога'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р01С001"		, "П00001М102201_");
	СформироватьПоказатели_2021Кв4(Показатели, ИменаПоказателей);
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел1 Цикл
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00001М1 Цикл
			...
			ЗарегистрироватьФормулу_2021Кв4(Настройки);
			ЗаполнитьИРасшифроватьПоказатели_2021Кв4(Показатели, СтраницаРаздела, Счетчик);
...
Процедура ПроверкаКС_7_1_03_к_2021Кв4()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.1.03.к';
													|en = '7.1.03.к'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
...
Процедура ПроверкаКС_7_1_04_к_2021Кв4()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.1.04.к';
													|en = '7.1.04.к'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога в стр.032 Раздела 1 >= 0';
														|en = 'Сумма налога в стр.032 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Возможно ошибочная сумма налога';
														|en = 'Возможно ошибочная сумма налога'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р01С001"		, "П00001М203201_");
	СформироватьПоказатели_2021Кв4(Показатели, ИменаПоказателей);
...
Процедура ПроверкаКС_7_2_к_2021Кв4()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.2.к';
													|en = '7.2.к'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога во всех стр.022 всех Разделов 1 >= сумме всех стр.032 всех Разделов 1';
			|en = 'Сумма налога во всех стр.022 всех Разделов 1 >= сумме всех стр.032 всех Разделов 1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Возможно ошибочная сумма налога';
														|en = 'Возможно ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_05_2021Кв4()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма дохода в стр.110 Раздела 2 по соответствующим ставке в стр.100 Раздела 2 и КБК в стр.105 ';
			|en = 'Сумма дохода в стр.110 Раздела 2 по соответствующим ставке в стр.100 Раздела 2 и КБК в стр.105 '") +
		НСтр("ru = 'Раздела 2 = сумме строк ""Общая сумма дохода"" раздела 2 по соответствующим ставке налога и КБК ';
			|en = 'Раздела 2 = сумме строк ""Общая сумма дохода"" раздела 2 по соответствующим ставке налога и КБК '") +
		НСтр("ru = 'Приложения № 1 к 6-НДФЛ, представленных по всем налогоплательщикам этим налоговым агентом ';
			|en = 'Приложения № 1 к 6-НДФЛ, представленных по всем налогоплательщикам этим налоговым агентом '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2, ставка %3, КБК %4';
													|en = '%1 = %2, ставка %3, КБК %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма дохода';
														|en = 'Ошибочная сумма дохода'"));
	Настройки = ОбработатьНастройки_2021Кв4(		, Заголовки);
...
Процедура ПроверкаКС_1_09_2021Кв4()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.140 Раздела 2 по соответствующим ставке в стр.100 Раздела 2 и КБК в стр.105 ';
			|en = 'Сумма налога в стр.140 Раздела 2 по соответствующим ставке в стр.100 Раздела 2 и КБК в стр.105 '") +
		НСтр("ru = 'Раздела 2 = сумме строк ""Сумма налога исчисленная"" раздела 2 по соответствующим ставке налога ';
			|en = 'Раздела 2 = сумме строк ""Сумма налога исчисленная"" раздела 2 по соответствующим ставке налога '") +
		НСтр("ru = 'и КБК Приложения № 1 к 6-НДФЛ, представленных по всем налогоплательщикам этим налоговым агентом ';
			|en = 'и КБК Приложения № 1 к 6-НДФЛ, представленных по всем налогоплательщикам этим налоговым агентом '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2, ставка %3, КБК %4';
													|en = '%1 = %2, ставка %3, КБК %4'"));
...
Процедура ПроверкаКС_1_10_2021Кв4()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.170 Раздела 2 по соответствующим ставке в стр.100 Раздела 2 и КБК в стр.105 ';
			|en = 'Сумма налога в стр.170 Раздела 2 по соответствующим ставке в стр.100 Раздела 2 и КБК в стр.105 '") +
		НСтр("ru = 'Раздела 2 = сумме строк ""Сумма неудержанного налога"" раздела 4 по соответствующим ';
			|en = 'Раздела 2 = сумме строк ""Сумма неудержанного налога"" раздела 4 по соответствующим '") +
		НСтр("ru = 'ставке налога и КБК Приложения № 1 к 6-НДФЛ, представленных по всем налогоплательщикам этим ';
			|en = 'ставке налога и КБК Приложения № 1 к 6-НДФЛ, представленных по всем налогоплательщикам этим '") +
		НСтр("ru = 'налоговым агентом (соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = 'налоговым агентом (соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2, ставка %3, КБК %4';
													|en = '%1 = %2, ставка %3, КБК %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_14_2021Кв4()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru = 'соответствующих вычетах по месяцам налогового периода"" - сумма стр. ""Сумма вычета"" раздела 3) ';
			|en = 'соответствующих вычетах по месяцам налогового периода"" - сумма стр. ""Сумма вычета"" раздела 3) '") +
		НСтр("ru = 'х стр. ""Ставка налога"" / 100 - стр. ""Сумма налога исчисленная"" раздела 2 Приложения № 1 ';
			|en = 'х стр. ""Ставка налога"" / 100 - стр. ""Сумма налога исчисленная"" раздела 2 Приложения № 1 '") +
		НСтр("ru = 'к 6-НДФЛ <= 1 руб. (соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = 'к 6-НДФЛ <= 1 руб. (соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '(%1 - %2 - %3) х %4 / 100 - %5 Итог [%6] = 0 ± 1 руб.';
													|en = '(%1 - %2 - %3) х %4 / 100 - %5 Итог [%6] = 0 ± 1 руб.'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма дохода';
														|en = 'Ошибочная сумма дохода'"));
	Настройки = ОбработатьНастройки_2021Кв4(		, Заголовки);
...
Процедура ПроверкаКС_1_18_2021Кв4()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Количество физических лиц, получивших доход в стр.120 Раздела 2 по соответствующим ставке в стр.100 ';
			|en = 'Количество физических лиц, получивших доход в стр.120 Раздела 2 по соответствующим ставке в стр.100 '") +
		НСтр("ru = 'Раздела 2 и КБК в стр.105 Раздела 2 = количество разделов 2 Приложения № 1 к 6-НДФЛ по ';
			|en = 'Раздела 2 и КБК в стр.105 Раздела 2 = количество разделов 2 Приложения № 1 к 6-НДФЛ по '") +
		НСтр("ru = 'соответствующим ставке и КБК (соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = 'соответствующим ставке и КБК (соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2, ставка %3, КБК %4';
													|en = '%1 = %2, ставка %3, КБК %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочное количество физических лиц';
														|en = 'Ошибочное количество физических лиц'"));
...
Процедура ПроверкаКС_1_19_2021Кв4()
	...
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 + %3 Итог [%4], ставка %5, КБК %6';
													|en = '%1 = %2 + %3 Итог [%4], ставка %5, КБК %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма вычетов';
														|en = 'Ошибочная сумма вычетов'"));
	Настройки = ОбработатьНастройки_2021Кв4(		, Заголовки);
...
Процедура ПроверкаКС_1_20_2021Кв4()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.150 Раздела 2 по соответствующим ставке в стр.100 Раздела 2 и КБК ';
			|en = 'Сумма авансового платежа в стр.150 Раздела 2 по соответствующим ставке в стр.100 Раздела 2 и КБК '") +
		НСтр("ru = 'в стр.105 Раздела 2 = сумме строк ""Сумма фиксированных авансовых платежей"" раздела 2 ';
			|en = 'в стр.105 Раздела 2 = сумме строк ""Сумма фиксированных авансовых платежей"" раздела 2 '") +
		НСтр("ru = 'Приложения № 1 к 6-НДФЛ (соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = 'Приложения № 1 к 6-НДФЛ (соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2, ставка %3, КБК %4';
													|en = '%1 = %2, ставка %3, КБК %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
...
Процедура ПроверкаКС_1_21_2021Кв4()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма дохода в стр.110 Раздела 2 >= стр.115 Раздела 2';
			|en = 'Сумма дохода в стр.110 Раздела 2 >= стр.115 Раздела 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма дохода';
														|en = 'Ошибочная сумма дохода'"));
...
Процедура ПроверкаКС_1_22_2021Кв4()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.141 Раздела 2 >= стр.155 Раздела 2';
			|en = 'Сумма налога в стр.141 Раздела 2 >= стр.155 Раздела 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_23_2021Кв4()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма дохода в стр.115 Раздела 2 по соответствующим ставке в стр.100 Раздела 2 и КБК в стр.105 ';
			|en = 'Сумма дохода в стр.115 Раздела 2 по соответствующим ставке в стр.100 Раздела 2 и КБК в стр.105 '") +
		НСтр("ru = 'Раздела 2 <= сумме строк ""Общая сумма дохода"" по соответствующим ставке налога и КБК раздела 2 ';
			|en = 'Раздела 2 <= сумме строк ""Общая сумма дохода"" по соответствующим ставке налога и КБК раздела 2 '") +
		НСтр("ru = 'Приложения № 1 к 6-НДФЛ, представленных налоговым агентом ';
			|en = 'Приложения № 1 к 6-НДФЛ, представленных налоговым агентом '") +
		НСтр("ru = 'с указанием в поле ""Статус налогоплательщика"" кода ""3"" и ""7"" ';
			|en = 'с указанием в поле ""Статус налогоплательщика"" кода ""3"" и ""7"" '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2, ставка %3, КБК %4';
													|en = '%1 <= %2, ставка %3, КБК %4'"));
...
Процедура ПроверкаКС_1_24_2021Кв4()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога на прибыль организаций, подлежащая зачету в стр. 155 Раздела 2 = сумме строк ""Сумма ';
			|en = 'Сумма налога на прибыль организаций, подлежащая зачету в стр. 155 Раздела 2 = сумме строк ""Сумма '") +
		НСтр("ru = 'налога на прибыль организаций, подлежащая зачету"" Раздела 2 Приложений № 1 к 6-НДФЛ, представленных ';
			|en = 'налога на прибыль организаций, подлежащая зачету"" Раздела 2 Приложений № 1 к 6-НДФЛ, представленных '") +
		НСтр("ru = 'по всем налогоплательщикам этим налоговым агентом ';
			|en = 'по всем налогоплательщикам этим налоговым агентом '") +
		НСтр("ru = '(соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = '(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
...
Процедура ПроверкаКС_1_25_2021Кв4()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Количество высококвалифицированных специалистов, получивших доход в стр.121 Раздела 2 по ';
			|en = 'Количество высококвалифицированных специалистов, получивших доход в стр.121 Раздела 2 по '") +
		НСтр("ru = 'соответствующим ставке в стр.100 Раздела 2 и КБК в стр.105 Раздела 2 = количество разделов 2 ';
			|en = 'соответствующим ставке в стр.100 Раздела 2 и КБК в стр.105 Раздела 2 = количество разделов 2 '") +
		НСтр("ru = 'Приложений № 1 к 6-НДФЛ по соответствующим ставке и КБК, с указанием в поле ""Статус ';
			|en = 'Приложений № 1 к 6-НДФЛ по соответствующим ставке и КБК, с указанием в поле ""Статус '") +
		НСтр("ru = 'налогоплательщика"" кодов ""3"" и ""7"" (соотношение применяется к 6-НДФЛ за налоговый период)';
			|en = 'налогоплательщика"" кодов ""3"" и ""7"" (соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2, ставка %3, КБК %4';
													|en = '%1 = %2, ставка %3, КБК %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочное количество высококвалифицированных специалистов';
														|en = 'Ошибочное количество высококвалифицированных специалистов'"));
	Настройки = ОбработатьНастройки_2021Кв4(		, Заголовки);
...
#Область Проверки
	...
	// Проверки Раздела 1
	ПроверкаКС_7_3_01_к_2023Кв1();
	ПроверкаКС_7_3_02_к_2023Кв1();
	ПроверкаКС_7_3_03_к_2023Кв1();
	ПроверкаКС_7_3_04_к_2023Кв1();
	ПроверкаКС_7_3_05_к_2023Кв1();
	ПроверкаКС_7_3_06_к_2023Кв1();
	ПроверкаКС_7_3_07_к_2023Кв1();
	ПроверкаКС_7_4_к_2023Кв1();
...
Процедура ПроверкаКС_7_3_01_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.3.01.к';
													|en = '7.3.01.к'"));
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.020 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.020 Раздела 1 >= 0'"));
	...
	ПроверкаКС_7_3_01_к_код_2023Кв1();
	
КонецПроцедуры

Процедура ПроверкаКС_7_3_01_к_код_2023Кв1()
...
Процедура ПроверкаКС_7_3_02_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.3.02.к';
													|en = '7.3.02.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.021 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.021 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.021 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.021 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("Показатель"		, "П000010002101");
	
	ПроверкаКС_7_3_01_к_код_2023Кв1();
	
КонецПроцедуры

Процедура ПроверкаКС_7_3_03_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.3.03.к';
													|en = '7.3.03.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.022 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.022 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.022 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.022 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("Показатель"		, "П000010002201");
	
	ПроверкаКС_7_3_01_к_код_2023Кв1();
	
КонецПроцедуры

Процедура ПроверкаКС_7_3_04_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.3.04.к';
													|en = '7.3.04.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.023 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.023 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.023 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.023 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("Показатель"		, "П000010002301");
	
	ПроверкаКС_7_3_01_к_код_2023Кв1();
	
КонецПроцедуры

Процедура ПроверкаКС_7_3_05_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.3.05.к';
													|en = '7.3.05.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.024 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.024 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.024 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.024 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("Показатель"		, "П000010002401");
	
	ПроверкаКС_7_3_01_к_код_2023Кв1();
	
КонецПроцедуры

Процедура ПроверкаКС_7_3_06_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.3.06.к';
													|en = '7.3.06.к'"));
...
Процедура ПроверкаКС_7_3_07_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.3.07.к';
													|en = '7.3.07.к'"));
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.032 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.032 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Группа строк %1 Страница %2 Раздела 1';
													|en = 'Группа строк %1 Страница %2 Раздела 1'"));
	ПодготовитьНастройки_2023Кв1(Заголовки);
...
Процедура ПроверкаКС_7_4_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.4.к';
													|en = '7.4.к'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в (стр.021 + стр.022 + стр.023 + стр.024) всех Разделов 1 >= сумме всех стр.032 ';
			|en = 'Сумма налога в (стр.021 + стр.022 + стр.023 + стр.024) всех Разделов 1 >= сумме всех стр.032 '") +
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните суммы налога в Разделе 1';
													|en = 'Уточните суммы налога в Разделе 1'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
...
Процедура ПроверкаКС_1_01_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Дата представления отчета должна быть не позднее 1 марта года, следующего за истекшим налоговым ';
			|en = 'Дата представления отчета должна быть не позднее 1 марта года, следующего за истекшим налоговым '") +
		НСтр("ru = 'периодом (для отчета за год) и не позднее последнего дня месяца, следующего за отчетным периодом ';
			|en = 'периодом (для отчета за год) и не позднее последнего дня месяца, следующего за отчетным периодом '") +
		НСтр("ru = '(для отчетов за 1 квартал, полугодие и 9 месяцев)';
			|en = '(для отчетов за 1 квартал, полугодие и 9 месяцев)'"));
...
Процедура ПроверкаКС_1_02_2023Кв1()
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму дохода в стр.110 Раздела 2';
													|en = 'Уточните сумму дохода в стр.110 Раздела 2'"));
...
Процедура ПроверкаКС_1_03_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.140 Раздела 2 = (стр.110 - стр.130) х стр.100 Раздела 2 (при значении ставки ';
			|en = 'Сумма налога в стр.140 Раздела 2 = (стр.110 - стр.130) х стр.100 Раздела 2 (при значении ставки '") +
		НСтр("ru = 'налога 13%) / 100, с допустимой погрешностью 3 руб. х стр.120 Раздела 2 (для отчетов  за ';
			|en = 'налога 13%) / 100, с допустимой погрешностью 3 руб. х стр.120 Раздела 2 (для отчетов  за '") +
		НСтр("ru = '1 квартал, полугодие, 9 месяцев) и 4 руб. х стр.120 Раздела 2 (для отчетов за год)';
			|en = '1 квартал, полугодие, 9 месяцев) и 4 руб. х стр.120 Раздела 2 (для отчетов за год)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %5 ((%2 - %3) х %4 / 100) ± %8 (%6 х %7)';
													|en = '%1 = %5 ((%2 - %3) х %4 / 100) ± %8 (%6 х %7)'"));
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в стр.140 Раздела 2';
													|en = 'Уточните сумму налога в стр.140 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 19.04.2023 N БС-4-11/5042@';
													|en = 'Письмо ФНС России от 19.04.2023 N БС-4-11/5042@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 2';
													|en = 'Страница %1 Раздела 2'"));
	ПодготовитьНастройки_2023Кв1(Заголовки);
...
Процедура ПроверкаКС_1_22_2023Кв1()
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в стр.141 Раздела 2';
													|en = 'Уточните сумму налога в стр.141 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.126.1 НК РФ';
													|en = 'ст.126.1 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 2';
													|en = 'Страница %1 Раздела 2'"));
...
Процедура ПроверкаКС_1_05_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'Раздела 2 = сумме строк ""Общая сумма дохода"" раздела 2 Приложения № 1';
			|en = 'Раздела 2 = сумме строк ""Общая сумма дохода"" раздела 2 Приложения № 1'"));
...
Процедура ПроверкаКС_1_09_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'Раздела 2 = сумме строк ""Сумма налога исчисленная"" раздела 2 Приложения № 1';
			|en = 'Раздела 2 = сумме строк ""Сумма налога исчисленная"" раздела 2 Приложения № 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, ставка %3, КБК %4';
													|en = '%1 = %2, ставка %3, КБК %4'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибочная сумма налога';
													|en = 'Ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_10_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'Раздела 2 = сумме строк ""Сумма неудержанного налога"" раздела 4 Приложения № 1';
			|en = 'Раздела 2 = сумме строк ""Сумма неудержанного налога"" раздела 4 Приложения № 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, ставка %3, КБК %4';
													|en = '%1 = %2, ставка %3, КБК %4'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибочная сумма налога';
													|en = 'Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в стр.170 Раздела 2';
													|en = 'Уточните сумму налога в стр.170 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.126.1 НК РФ';
													|en = 'ст.126.1 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'Отчет за год';
...
Процедура ПроверкаКС_1_18_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'Раздела 2 и КБК в стр.105 Раздела 2 = количество разделов 2 Приложения № 1';
			|en = 'Раздела 2 и КБК в стр.105 Раздела 2 = количество разделов 2 Приложения № 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, ставка %3, КБК %4';
													|en = '%1 = %2, ставка %3, КБК %4'"));
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните количество физических лиц в стр.120 Раздела 2';
													|en = 'Уточните количество физических лиц в стр.120 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.126.1 НК РФ';
													|en = 'ст.126.1 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'Отчет за год';
...
Процедура ПроверкаКС_1_19_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '+ сумма стр. ""Сумма вычета"" Приложения ""Сведения о доходах и соответствующих ';
			|en = '+ сумма стр. ""Сумма вычета"" Приложения ""Сведения о доходах и соответствующих '") +
		НСтр("ru = 'вычетах по месяцам налогового периода"" Приложения № 1';
			|en = 'вычетах по месяцам налогового периода"" Приложения № 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 + %3), ставка %5, КБК %6';
													|en = '%1 = %4 (%2 + %3), ставка %5, КБК %6'"));
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму вычетов в стр.130 Раздела 2';
													|en = 'Уточните сумму вычетов в стр.130 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.126.1 НК РФ';
													|en = 'ст.126.1 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'Отчет за год';
...
Процедура ПроверкаКС_1_20_2023Кв1()
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму авансового платежа в стр.150 Раздела 2';
													|en = 'Уточните сумму авансового платежа в стр.150 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.126.1 НК РФ';
													|en = 'ст.126.1 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'Отчет за год';
...
Процедура ПроверкаКС_1_23_2023Кв1()
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму дохода в стр.115 Раздела 2';
													|en = 'Уточните сумму дохода в стр.115 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.126.1 НК РФ';
													|en = 'ст.126.1 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'Отчет за год';
...
Процедура ПроверкаКС_1_24_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'налога на прибыль организаций, подлежащая зачету"" Раздела 2 Приложений № 1';
			|en = 'налога на прибыль организаций, подлежащая зачету"" Раздела 2 Приложений № 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в стр.155 Раздела 2';
													|en = 'Уточните сумму налога в стр.155 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.126.1 НК РФ';
													|en = 'ст.126.1 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'Отчет за год';
...
Процедура ПроверкаКС_1_25_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'Приложений № 1 с указанием в поле ""Статус налогоплательщика"" кодов ""3"" и ""7""';
			|en = 'Приложений № 1 с указанием в поле ""Статус налогоплательщика"" кодов ""3"" и ""7""'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, ставка %3, КБК %4';
													|en = '%1 = %2, ставка %3, КБК %4'"));
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните количество специалистов в стр.121 Раздела 2';
													|en = 'Уточните количество специалистов в стр.121 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.126.1 НК РФ';
													|en = 'ст.126.1 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'Отчет за год';
...
Процедура ПроверкаКС_1_11_2023Кв1()
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налоговой базы в разделе 2 Приложения 1';
													|en = 'Уточните сумму налоговой базы в разделе 2 Приложения 1'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.126.1 НК РФ';
													|en = 'ст.126.1 НК РФ'"));
...
Процедура ПроверкаКС_1_16_2023Кв1()
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму дохода в разделе 2 Приложения 1';
													|en = 'Уточните сумму дохода в разделе 2 Приложения 1'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.126.1 НК РФ';
													|en = 'ст.126.1 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Приложения 1';
													|en = 'Страница %1 Приложения 1'"));
...
Процедура ПроверкаКС_1_17_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'к 6-НДФЛ  <= стр. ""Общая сумма дохода"" раздела 2 Приложения № 1 к 6-НДФЛ';
			|en = 'к 6-НДФЛ  <= стр. ""Общая сумма дохода"" раздела 2 Приложения № 1 к 6-НДФЛ'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибочная сумма дохода';
													|en = 'Ошибочная сумма дохода'"));
...
Процедура ПроверкаКС_1_26_доп_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Значение КБК в стр.010 Раздела 1 должно быть заполнено';
													|en = 'Значение КБК в стр.010 Раздела 1 должно быть заполнено'"));
...
Процедура ПроверкаКС_1_28_доп_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.020 Раздела 1 = (стр.021 + стр.022 + стр.023 + стр.024) Раздела 1';
			|en = 'Сумма налога в стр.020 Раздела 1 = (стр.021 + стр.022 + стр.023 + стр.024) Раздела 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4 + %5 + %6)';
													|en = '%1 = %2 (%3 + %4 + %5 + %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибочная сумма налога';
													|en = 'Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в стр.020 Раздела 1';
													|en = 'Уточните сумму налога в стр.020 Раздела 1'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 1';
													|en = 'Страница %1 Раздела 1'"));
...
Процедура ПроверкаКС_1_29_доп_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'При составлении отчета за 1 квартал, полугодие или 9 месяцев сумма налога в стр.024 Раздела 1 = 0';
			|en = 'При составлении отчета за 1 квартал, полугодие или 9 месяцев сумма налога в стр.024 Раздела 1 = 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 0';
													|en = '%1 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибочная сумма налога';
													|en = 'Ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_32_доп_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Дата возврата налога в стр.031 Раздела 1 должна быть указана, если указана сумма налога ';
			|en = 'Дата возврата налога в стр.031 Раздела 1 должна быть указана, если указана сумма налога '") +
		НСтр("ru = 'в стр.032 Раздела 1';
			|en = 'в стр.032 Раздела 1'"));
...
Процедура ПроверкаКС_1_33_доп_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Год даты возврата налога в стр.031 Раздела 1 должен соответствовать отчетному году';
			|en = 'Год даты возврата налога в стр.031 Раздела 1 должен соответствовать отчетному году'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибочный год даты возврата налога';
													|en = 'Ошибочный год даты возврата налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите в дате возврата налога в стр.031 Раздела 1 отчетный год';
													|en = 'Укажите в дате возврата налога в стр.031 Раздела 1 отчетный год'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 1, строка %2 группы строк 031-032';
													|en = 'Страница %1 Раздела 1, строка %2 группы строк 031-032'"));
...
Процедура ПроверкаКС_1_34_доп_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Значение налоговой ставки в стр.100 Раздела 2 должно соответствовать списку ';
			|en = 'Значение налоговой ставки в стр.100 Раздела 2 должно соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
...
Процедура ПроверкаКС_1_35_доп_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Значение КБК в стр.105 Раздела 2 должно быть заполнено';
													|en = 'Значение КБК в стр.105 Раздела 2 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Не заполнено значение КБК';
													|en = 'Не заполнено значение КБК'"));
...
Процедура ПроверкаКС_1_38_доп_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма дохода в стр.115 Раздела 2 <= (стр.112 + стр.113) Раздела 2';
			|en = 'Сумма дохода в стр.115 Раздела 2 <= (стр.112 + стр.113) Раздела 2'"));
...
Процедура ПроверкаКС_1_39_доп_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Количество физлиц в стр.120 Раздела 2 > 0, если стр.110 Раздела 2 > 0';
			|en = 'Количество физлиц в стр.120 Раздела 2 > 0, если стр.110 Раздела 2 > 0'"));
...
Процедура ПроверкаКС_1_40_доп_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Количество физлиц в стр.121 Раздела 2 > 0, если стр.115 Раздела 2 > 0';
			|en = 'Количество физлиц в стр.121 Раздела 2 > 0, если стр.115 Раздела 2 > 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 > 0, если %2 > 0';
													|en = '%1 > 0, если %2 > 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибочное количество физлиц';
													|en = 'Ошибочное количество физлиц'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите количество физлиц в стр.121 Раздела 2';
													|en = 'Укажите количество физлиц в стр.121 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 2';
													|en = 'Страница %1 Раздела 2'"));
...
Процедура ПроверкаКС_1_41_доп_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Количество физлиц в стр.120 Раздела 2 >= стр.121 Раздела 2';
			|en = 'Количество физлиц в стр.120 Раздела 2 >= стр.121 Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибочное количество физлиц';
													|en = 'Ошибочное количество физлиц'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните количество физлиц в стр.120 Раздела 2';
													|en = 'Уточните количество физлиц в стр.120 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 2';
													|en = 'Страница %1 Раздела 2'"));
...
Процедура ПроверкаКС_1_42_доп_2023Кв1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.140 Раздела 2 >= (стр.141 + стр.142) Раздела 2';
			|en = 'Сумма налога в стр.140 Раздела 2 >= (стр.141 + стр.142) Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2 (%3 + %4)';
													|en = '%1 >= %2 (%3 + %4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибочная сумма налога';
													|en = 'Ошибочная сумма налога'"));
...
#Область КонтрольныеСоотношения2024Кв2

#Область КС_Управление

Функция ПроверитьКонтрольныеСоотношения_2024Кв2(СтруктураПараметров)
	...
	СформироватьТаблицыДанных_2024Кв2();
	СформироватьСлужебныеДанные_2024Кв2();
	СформироватьДанныеОтчета_2024Кв2();
	СформироватьДанныеОтчетаПОП_2024Кв2();
	
	Если ДанныеКС.МесОтчета = 12 Тогда
		СформироватьДанныеМладшихГодовыхОтчетов_2024Кв2();
	КонецЕсли;
	
	СформироватьВременныеТаблицы_2024Кв2();
...
#Область Проверки
	...
	// Проверки Раздела 1
	ПроверкаКС_7_5_01_к_2024Кв2();
	ПроверкаКС_7_5_02_к_2024Кв2();
	ПроверкаКС_7_5_03_к_2024Кв2();
	ПроверкаКС_7_5_04_к_2024Кв2();
	ПроверкаКС_7_5_05_к_2024Кв2();
	ПроверкаКС_7_5_06_к_2024Кв2();
	ПроверкаКС_7_5_07_к_2024Кв2();
	ПроверкаКС_7_5_08_к_2024Кв2();
	ПроверкаКС_7_5_09_к_2024Кв2();
	ПроверкаКС_7_5_10_к_2024Кв2();
	ПроверкаКС_7_5_11_к_2024Кв2();
	ПроверкаКС_7_5_12_к_2024Кв2();
	ПроверкаКС_7_5_13_к_2024Кв2();
	ПроверкаКС_7_5_14_к_2024Кв2();
	ПроверкаКС_7_6_к_2024Кв2();
	
	// основные проверки
	
	// проверки Раздела 1
	ПроверкаКС_1_02_2024Кв2();
	ПроверкаКС_1_03_2024Кв2();
	ПроверкаКС_1_04_2024Кв2();
	ПроверкаКС_1_05_2024Кв2();
	ПроверкаКС_1_06_2024Кв2();
	ПроверкаКС_1_07_2024Кв2();
	ПроверкаКС_1_08_2024Кв2();
	ПроверкаКС_1_09_2024Кв2();
	ПроверкаКС_1_40_2024Кв2();
	ПроверкаКС_1_41_2024Кв2();
	ПроверкаКС_1_42_2024Кв2();
	ПроверкаКС_1_43_2024Кв2();
	ПроверкаКС_1_44_2024Кв2();
	ПроверкаКС_1_45_2024Кв2();
	
	// проверки Раздела 2
	ПроверкаКС_1_10_2024Кв2();
	ПроверкаКС_1_11_2024Кв2();
	ПроверкаКС_1_12_2024Кв2();
	ПроверкаКС_1_13_2024Кв2();
	ПроверкаКС_1_14_2024Кв2();
	ПроверкаКС_1_15_2024Кв2();
	ПроверкаКС_1_32_2024Кв2();
	ПроверкаКС_1_36_2024Кв2();
	ПроверкаКС_1_37_2024Кв2();
	ПроверкаКС_1_38_2024Кв2();
	ПроверкаКС_1_39_2024Кв2();
	
	Если Документирование ИЛИ ДанныеКС.МесОтчета = 12 Тогда
		
		// годовые проверки Раздела 2
		ПроверкаКС_1_16_2024Кв2();
		ПроверкаКС_1_19_2024Кв2();
		ПроверкаКС_1_20_2024Кв2();
		ПроверкаКС_1_28_2024Кв2();
		ПроверкаКС_1_29_2024Кв2();
		ПроверкаКС_1_30_2024Кв2();
		ПроверкаКС_1_31_2024Кв2();
		ПроверкаКС_1_33_2024Кв2();
		ПроверкаКС_1_34_2024Кв2();
		ПроверкаКС_1_35_2024Кв2();
		
		// годовые проверки Приложения 1
		ПроверкаКС_1_21_2024Кв2();
		ПроверкаКС_1_22_2024Кв2();
		ПроверкаКС_1_23_2024Кв2();
		ПроверкаКС_1_24_1_2024Кв2();
		ПроверкаКС_1_24_2_2024Кв2();
		ПроверкаКС_1_25_1_2024Кв2();
		ПроверкаКС_1_25_2_2024Кв2();
		ПроверкаКС_1_26_1_2024Кв2();
		ПроверкаКС_1_26_2_2024Кв2();
		ПроверкаКС_1_27_2024Кв2();
...
#КонецОбласти
	...
	Возврат ПодготовитьРезультат_2024Кв2();
...
Функция ВыполнитьДокументированиеОбъект_2024Кв2() Экспорт
	
	Документирование	= Истина;	
	СтруктураРезультата	= Новый Структура;
	СтруктураРезультата.Вставить("НаименованиеОтчета"	, "6-НДФЛ (с 2021)");
	СтруктураРезультата.Вставить("НаименованиеФормы"	, "2024Кв2");
	СтруктураРезультата.Вставить("ДатаФормирования"		, Формат(ТекущаяДата(), "ДФ=dd.MM.yyyy"));
	...
	ДанныеКС.Вставить("Счетчик"		, 0);
	ДанныеКС.Вставить("МесОтчета"	, 12);
	СформироватьПриоритетыРазделов_2024Кв2();
...
Процедура СформироватьТаблицыДанных_2024Кв2()
	...
	ТаблицаР02.Колонки.Добавить("Р02С150"		, ТипЧисло);
	ТаблицаР02.Колонки.Добавить("Р02С155"		, ТипЧисло);
	ТаблицаР02.Колонки.Добавить("Р02С156"		, ТипЧисло);
	ТаблицаР02.Колонки.Добавить("Р02С160"		, ТипЧисло);
	ТаблицаР02.Колонки.Добавить("Р02С161"		, ТипЧисло);
	ТаблицаР02.Колонки.Добавить("Р02С162"		, ТипЧисло);
	ТаблицаР02.Колонки.Добавить("Р02С163"		, ТипЧисло);
	ТаблицаР02.Колонки.Добавить("Р02С164"		, ТипЧисло);
	ТаблицаР02.Колонки.Добавить("Р02С165"		, ТипЧисло);
	ТаблицаР02.Колонки.Добавить("Р02С166"		, ТипЧисло);
	ТаблицаР02.Колонки.Добавить("Р02С170"		, ТипЧисло);
	...
	ТаблицаП02.Колонки.Добавить("СуммаФиксПл"	, ТипЧисло);
	ТаблицаП02.Колонки.Добавить("СуммаНалогаПр"	, ТипЧисло);
	ТаблицаП02.Колонки.Добавить("СуммаНалогаИн"	, ТипЧисло);
...
Процедура СформироватьСлужебныеДанные_2024Кв2()
	...
	ПоляПриложения1.Вставить("П01_СуммаФиксПл"	, "Сумма фиксированных авансовых платежей, Раздел 2");
	ПоляПриложения1.Вставить("П01_СуммаНалогаПр", "Сумма налога на прибыль организаций, подлежащая зачету, Раздел 2");
	ПоляПриложения1.Вставить("П01_СуммаНалогаИн", "Сумма налога, уплаченная в иностранном государстве, Раздел 2");
	ПоляПриложения1.Вставить("П01_СуммаВычета3"	, "Сумма вычета, Раздел 3");
	ПоляПриложения1.Вставить("П01_СуммаДохода4"	, "Сумма дохода, с которого не удержан налог, Раздел 4");
	ПоляПриложения1.Вставить("П01_СуммаНалога4"	, "Сумма неудержанного налога, Раздел 4");
	ПоляПриложения1.Вставить("П01_СуммаДохода5"	, "Сумма дохода, Приложение (Сведения по месяцам)");
...
Процедура СформироватьДанныеОтчета_2024Кв2()
	
	//СтруктураДанных = ДанныеКС.Отчет.ДанныеОтчета.Получить();
	
	ДополнительныеПараметры = Новый Структура("ДанныеРегОтчетаСУчетомКонвертации", Истина);
	СтруктураДанных = РегламентированнаяОтчетность.ПолучитьДанныеСохрРегОтчета(ДанныеКС.Отчет, ДополнительныеПараметры);
	
	СтруктураОтчета = ПолучитьСтруктуруОтчета_2024Кв2(СтруктураДанных);
	ОбщегоНазначенияКлиентСервер.ДополнитьСтруктуру(ДанныеКС, СтруктураОтчета, Истина);
	
	ЗаполнитьТаблицуРаздела2_2024Кв2(СтруктураДанных.ДанныеМногоуровневыхРазделов.Раздел2, ДанныеКС.Отчет);
	
	Если ДанныеКС.МесОтчета = 12 Тогда
	
		ЗаполнитьТаблицыПриложения1_2024Кв2(СтруктураДанных.ДанныеМногоуровневыхРазделов.Приложение1, ДанныеКС.Отчет);
		
	КонецЕсли;
	
КонецПроцедуры

Функция ПолучитьСтруктуруОтчета_2024Кв2(СтруктураДанных)
	...
	СтруктураОтчета.Вставить("ОКТМО"	, СокрЛП(СтруктураОтчета.Раздел0.ОКТМО));
	СтруктураОтчета.Вставить("ОтчетВид"	, СтруктураОтчета.Раздел0.НомерКорректировки);
	...
	Для каждого Раздел Из СтруктураДанных.ДанныеМногоуровневыхРазделов Цикл
		...
		Для каждого СтраницаРаздела Из Раздел.Значение.Строки Цикл
			...
			ДанныеСтраницы = Новый Структура;
			ПолучитьДанныеСтраницы_2024Кв2(ДанныеСтраницы, СтраницаРаздела, 
				Новый Структура("КорневойРаздел, Раздел, Уровень", Раздел.Ключ, Раздел.Ключ, 1),
				Новый Структура("Уровень", ""));
			ДанныеСтраницы.Вставить("РазделЗаполнен", РазделЗаполнен_2024Кв2(ДанныеСтраницы)); 
			ДанныеСтраницы.Вставить("НомерСтраницы", XMLСтрока(Раздел.Значение.Строки.Индекс(СтраницаРаздела) + 1));
			МассивСтраниц.Добавить(ДанныеСтраницы);
...
Процедура ПолучитьДанныеСтраницы_2024Кв2(СтруктураПриемник, 
									СтруктураИсточник, 
									Знач ВходящийРаздел, 
									Знач ВходящаяМнЧасть)
	...
	Если НЕ СтруктураИсточник.ДанныеМногострочныхЧастей = Неопределено Тогда
		Для каждого МнЧасть Из СтруктураИсточник.ДанныеМногострочныхЧастей Цикл
			Для каждого СтрокаМнЧасти Из МнЧасть.Значение.Строки Цикл
				...
				Если НЕ СтрокаМнЧасти.ДанныеМногострочныхЧастей = Неопределено Тогда
					Если НЕ СтрокаМнЧасти.ДанныеМногострочныхЧастей.Количество() = 0 Тогда
						ПолучитьДанныеСтраницы_2024Кв2(СтруктураПриемник, СтрокаМнЧасти, ВходящийРаздел,
							Новый Структура("Уровень", "_" +  XMLСтрока(НомерСтроки)));
					КонецЕсли;
				КонецЕсли;
	...
	Если НЕ СтруктураИсточник.Строки.Количество() = 0 Тогда
		...
		Для каждого СтраницаПриложения Из СтруктураИсточник.Строки Цикл
			...
			ДанныеСтраницы.Вставить("НомерСтраницы", СтруктураПриемник.НомерСтраницы + "," +
				XMLСтрока(СтруктураИсточник.Строки.Индекс(СтраницаПриложения) + 1));
			ПолучитьДанныеСтраницы_2024Кв2(ДанныеСтраницы, СтраницаПриложения, 
			Новый Структура("КорневойРаздел, Раздел, Уровень", ВходящийРаздел.КорневойРаздел, КлючПриложения, 
			ВходящийРаздел.Уровень + 1), Новый Структура("Уровень", ""));
			ДанныеСтраницы.Вставить("РазделЗаполнен", РазделЗаполнен_2024Кв2(ДанныеСтраницы));
			МассивСтраниц.Добавить(ДанныеСтраницы);
...
Процедура ЗаполнитьТаблицуРаздела2_2024Кв2(ДанныеРаздела, Отчет)
	...
	Для каждого СтраницаРаздела Из ДанныеРаздела.Строки Цикл
		Если НЕ СтраницаРаздела.Данные = Неопределено Тогда
			...
			НоваяСтрока.Р02С150 		= СтраницаРаздела.Данные.П000020015003;
			НоваяСтрока.Р02С155 		= СтраницаРаздела.Данные.П000020015503;
			НоваяСтрока.Р02С156 		= СтраницаРаздела.Данные.П000020015603;
			НоваяСтрока.Р02С160 		= СтраницаРаздела.Данные.П000020016003;
			НоваяСтрока.Р02С161 		= СтраницаРаздела.Данные.П000020016103;
			НоваяСтрока.Р02С162 		= СтраницаРаздела.Данные.П000020016203;
			НоваяСтрока.Р02С163 		= СтраницаРаздела.Данные.П000020016303;
			НоваяСтрока.Р02С164 		= СтраницаРаздела.Данные.П000020016403;
			НоваяСтрока.Р02С165 		= СтраницаРаздела.Данные.П000020016503;
			НоваяСтрока.Р02С166 		= СтраницаРаздела.Данные.П000020016603;
			НоваяСтрока.Р02С170 		= СтраницаРаздела.Данные.П000020017003;
...
Процедура ЗаполнитьТаблицыПриложения1_2024Кв2(ДанныеРаздела, Отчет)
		...
		Если НЕ СтраницаРаздела.ДанныеМногострочныхЧастей = Неопределено Тогда
			Для каждого Раздел2 Из СтраницаРаздела.ДанныеМногострочныхЧастей.П000П1М1.Строки Цикл
				Если НЕ Раздел2.Данные = Неопределено Тогда
					...
					НоваяСтрока.СуммаФиксПл			= Раздел2.Данные.П000П1М100006;
					НоваяСтрока.СуммаНалогаПр		= Раздел2.Данные.П000П1М100010;
					НоваяСтрока.СуммаНалогаИн		= ?(Раздел2.Данные.Свойство("П000П1М100011"), Раздел2.Данные.П000П1М100011, 0);
...
Процедура СформироватьДанныеОтчетаПОП_2024Кв2() 
	
	ДанныеКС.Вставить("ОтчетПОПНайден"	, Ложь);
	ДанныеКС.Вставить("ОтчетПОП"		, Новый Структура);
	ДанныеКС.Вставить("ОтчетПОПСсылка"	, Неопределено);
	...
	Запрос.УстановитьПараметр("КПП"					, ДанныеКС.Раздел0.КПП);
	Запрос.УстановитьПараметр("ГодОтчета"			, ДанныеКС.ГодОтчета);
	Запрос.УстановитьПараметр("МесОтчета"			, ДанныеКС.МесОтчета - 3);
	Запрос.Текст = 
	...
	Пока Выборка.Следующий() Цикл
		...
		//ДанныеОтчета 	= Выборка.Ссылка.ДанныеОтчета.Получить();
		ОКТМО 			= СокрЛП(ДанныеОтчета.ПоказателиОтчета.ПолеТабличногоДокументаТитульный.ОКТМО);
		
		Если НЕ ОКТМО = ДанныеКС.ОКТМО Тогда
			Продолжить;
		КонецЕсли; 
		
		ДанныеКС.Вставить("ОтчетПОПНайден"	, Истина);
		ДанныеКС.Вставить("ОтчетПОП"		, ПолучитьСтруктуруОтчета_2024Кв2(ДанныеОтчета));
		ДанныеКС.Вставить("ОтчетПОПСсылка"	, Выборка.Ссылка); 
...
Процедура СформироватьДанныеМладшихГодовыхОтчетов_2024Кв2()
	...
	Пока Выборка.Следующий() Цикл
		...
		Приложение1 	= ДанныеОтчета.ДанныеМногоуровневыхРазделов.Приложение1;
		ЗаполнитьТаблицыПриложения1_2024Кв2(Приложение1, Выборка.Ссылка); 
...
Процедура СформироватьВременныеТаблицы_2024Кв2()
...
Процедура СформироватьПриоритетыРазделов_2024Кв2()
...
Функция СформироватьПоказатели_2024Кв2(ИменаПоказателей)
	...
	Для каждого Элемент Из ИменаПоказателей Цикл
		...
		// переменные данные
		Показатели[Элемент.Ключ].Вставить("Отчет"			, ?(ПодстрокаДополнения = "П", ДанныеКС.ОтчетПОПСсылка, ДанныеКС.Отчет));
		Показатели[Элемент.Ключ].Вставить("НомерСтраницы"	, "");
		Показатели[Элемент.Ключ].Вставить("Значение");
		Показатели[Элемент.Ключ].Вставить("ЗначениеСтр"		, "");
		Показатели[Элемент.Ключ].Вставить("Итог"			, 0);
...
Процедура РасшифроватьПоказатель_2024Кв2(Показатель)
...
Процедура ЗаполнитьПоказатель_2024Кв2(Показатель, Источник, НомерСтроки = Неопределено)
	...
	Если ТипЗнч(Источник) = Тип("Структура") Тогда
		...
		Если Источник.Свойство(Показатель.ИмяПоказателя, ЗначениеВИсточнике) Тогда
			...
			ЗаполнитьПоказательЗначениями_2024Кв2(Показатель, ЗначениеВИсточнике);
...
Процедура ЗаполнитьПоказательЗначениями_2024Кв2(Показатель, ЗначениеВИсточнике)
...
Процедура ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатель, Источник, НомерСтроки = Неопределено)
											
	Если Показатель.Заполнять Тогда
		ЗаполнитьПоказатель_2024Кв2(Показатель, Источник, НомерСтроки);
			
		Если Показатель.Расшифровывать Тогда
			РасшифроватьПоказатель_2024Кв2(Показатель);
		КонецЕсли;
	КонецЕсли;
	
КонецПроцедуры

Процедура ЗаполнитьИРасшифроватьПоказатели_2024Кв2(Показатели, Источник, НомерСтроки = Неопределено, Дополнение = "")
	
	Для каждого Элемент Из Показатели Цикл
		
		Элемент.Значение.Дополнение = Дополнение;
		ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Элемент.Значение, Источник, НомерСтроки);
			
	КонецЦикла;
	
КонецПроцедуры

Процедура ЗарегистрироватьПроверку_2024Кв2();

	ДанныеКС.Счетчик = ДанныеКС.Счетчик + 1;
	
КонецПроцедуры

Процедура ДополнитьТаблицуРезультата_2024Кв2()
	
	Если ДанныеКС.ТолькоОшибки И НЕ НастройкиКС.ЭтоОшибка Тогда
		УдалитьСтрокиТаблицыРасшифровки_2024Кв2(ДанныеКС.Счетчик);
		Возврат;
	КонецЕсли;
...
Процедура УдалитьСтрокиТаблицыРасшифровки_2024Кв2(НомерЭлемента)
...
Процедура ПодготовитьНастройки_2024Кв2(Заголовки)
...
Функция ПодготовитьРезультат_2024Кв2();
...
Функция РазделЗаполнен_2024Кв2(Раздел)
	...
	Для каждого Элемент Из Раздел Цикл
		Если СтрНайти(Элемент.Ключ, "П00") = 0
			ИЛИ НЕ СтрНайти(Элемент.Ключ, "Колво") = 0
			Тогда
			Продолжить;
		КонецЕсли; 
...
Функция СуммаПоказателей_2024Кв2(Показатели)
	
	Результат = 0;
	
	Для каждого ЭлементСтруктуры Из Показатели Цикл
		Результат = Результат + ЭлементСтруктуры.Значение.Итог;
	КонецЦикла;
...
Функция Стр_2024Кв2(ЗначениеСтроки)
...
Процедура ПроверкаКС_7_5_01_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.5.01.к';
													|en = '7.5.01.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.020 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.020 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
	...
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 1';
													|en = 'Страница %1 Раздела 1'"));
	ПодготовитьНастройки_2024Кв2(Заголовки);
	...
	ПроверкаКС_7_5_01_к_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_7_5_01_к_код_2024Кв2()
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р01С001", НастройкиКС.Показатель);
	
	Показатели = СформироватьПоказатели_2024Кв2(ИменаПоказателей);
	
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел1 Цикл
		
		ЗарегистрироватьПроверку_2024Кв2();
		ЗаполнитьИРасшифроватьПоказатели_2024Кв2(Показатели, СтраницаРаздела);
		
		НастройкиКС.ЭтоОшибка = Показатели.Р01С001.Значение < 0;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р01С001.Значение);
		НастройкиКС.ДопСведения = СтрЗаменить(НастройкиКС.ШаблонДопСведений, "%1", СтраницаРаздела.НомерСтраницы);
		ДополнитьТаблицуРезультата_2024Кв2();
		
	КонецЦикла;

КонецПроцедуры

Процедура ПроверкаКС_7_5_02_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.5.02.к';
													|en = '7.5.02.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.021 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.021 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
...
Процедура ПроверкаКС_7_5_03_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.5.03.к';
													|en = '7.5.03.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.022 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.022 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
...
Процедура ПроверкаКС_7_5_04_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.5.04.к';
													|en = '7.5.04.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.023 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.023 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
...
Процедура ПроверкаКС_7_5_05_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.5.05.к';
													|en = '7.5.05.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.024 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.024 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
...
Процедура ПроверкаКС_7_5_06_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.5.06.к';
													|en = '7.5.06.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.025 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.025 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.025 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.025 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("Показатель"		, "П000010002501");
	
	ПроверкаКС_7_5_01_к_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_7_5_07_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.5.07.к';
													|en = '7.5.07.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.026 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.026 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.026 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.026 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("Показатель"		, "П000010002601");
	
	ПроверкаКС_7_5_01_к_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_7_5_08_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.5.08.к';
													|en = '7.5.08.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.030 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.030 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
...
Процедура ПроверкаКС_7_5_09_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.5.09.к';
													|en = '7.5.09.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.031 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.031 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.031 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.031 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("Показатель"		, "П000010003101");
	
	ПроверкаКС_7_5_01_к_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_7_5_10_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.5.10.к';
													|en = '7.5.10.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.032 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.032 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
	...
	НастройкиКС.Вставить("Показатель"		, "П000010003201");
	
	ПроверкаКС_7_5_01_к_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_7_5_11_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.5.11.к';
													|en = '7.5.11.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.033 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.033 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.033 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.033 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("Показатель"		, "П000010003301");
	
	ПроверкаКС_7_5_01_к_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_7_5_12_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.5.12.к';
													|en = '7.5.12.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.034 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.034 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.034 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.034 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("Показатель"		, "П000010003401");
	
	ПроверкаКС_7_5_01_к_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_7_5_13_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.5.13.к';
													|en = '7.5.13.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.035 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.035 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.035 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.035 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("Показатель"		, "П000010003501");
	
	ПроверкаКС_7_5_01_к_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_7_5_14_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.5.14.к';
													|en = '7.5.14.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.036 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.036 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.036 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.036 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("Показатель"		, "П000010003601");
	
	ПроверкаКС_7_5_01_к_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_7_6_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '7.6.к';
													|en = '7.6.к'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.(021 + 022 + 023 + 024 + 025 + 026) всех Разделов 1 >= суммы стр.(031 ';
			|en = 'Сумма налога в стр.(021 + 022 + 023 + 024 + 025 + 026) всех Разделов 1 >= суммы стр.(031 '") +
		НСтр("ru = '+ 032 + 033 + 034 + 035 + 036) всех Разделов 1';
			|en = '+ 032 + 033 + 034 + 035 + 036) всех Разделов 1'"));
	...
	НастройкиКС.Вставить("Шаблон2"			, НСтр("ru = '%1 + %2 + %3 + %4 + %5 + %6';
													|en = '%1 + %2 + %3 + %4 + %5 + %6'"));
	...
	ИменаПоказателей.Вставить("Р01С023"		, "П000010002301");
	ИменаПоказателей.Вставить("Р01С024"		, "П000010002401");
	ИменаПоказателей.Вставить("Р01С025"		, "П000010002501");
	ИменаПоказателей.Вставить("Р01С026"		, "П000010002601");
	ИменаПоказателей.Вставить("Р01С031"		, "П000010003101");
	ИменаПоказателей.Вставить("Р01С032"		, "П000010003201");
	ИменаПоказателей.Вставить("Р01С033"		, "П000010003301");
	ИменаПоказателей.Вставить("Р01С034"		, "П000010003401");
	ИменаПоказателей.Вставить("Р01С035"		, "П000010003501");
	ИменаПоказателей.Вставить("Р01С036"		, "П000010003601");
	
	Показатели = СформироватьПоказатели_2024Кв2(ИменаПоказателей);
	ЗарегистрироватьПроверку_2024Кв2();
	
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел1 Цикл
		ЗаполнитьИРасшифроватьПоказатели_2024Кв2(Показатели, СтраницаРаздела,, "страница " + СтраницаРаздела.НомерСтраницы);
	КонецЦикла;
	
	РасчетнаяСумма1 = Показатели.Р01С021.Итог + Показатели.Р01С022.Итог + Показатели.Р01С023.Итог 
		+ Показатели.Р01С024.Итог + Показатели.Р01С025.Итог + Показатели.Р01С026.Итог;
	РасчетнаяСумма2 = Показатели.Р01С031.Итог + Показатели.Р01С032.Итог + Показатели.Р01С033.Итог 
		+ Показатели.Р01С034.Итог + Показатели.Р01С035.Итог + Показатели.Р01С036.Итог;
	НастройкиКС.ЭтоОшибка = РасчетнаяСумма1 < РасчетнаяСумма2;
	Детализация2 = СтрШаблон(НастройкиКС.Шаблон2, 
		Показатели.Р01С031.Итог, Показатели.Р01С032.Итог, Показатели.Р01С033.Итог, Показатели.Р01С034.Итог,
		Показатели.Р01С035.Итог, Показатели.Р01С036.Итог);
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
		РасчетнаяСумма1, Показатели.Р01С021.Итог, Показатели.Р01С022.Итог, Показатели.Р01С023.Итог, 
		Показатели.Р01С024.Итог, Показатели.Р01С025.Итог, Показатели.Р01С026.Итог, РасчетнаяСумма2, Детализация2);
	ДополнитьТаблицуРезультата_2024Кв2();
...
Процедура ПроверкаКС_1_02_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.02';
													|en = '1.02'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.020 Раздела 1 (за 1 квартал) = стр.(021 + 022 + 023 + 024 + 025 + 026) Раздела 1';
			|en = 'Сумма налога в стр.020 Раздела 1 (за 1 квартал) = стр.(021 + 022 + 023 + 024 + 025 + 026) Раздела 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%4 + %5 + %6 + %7 + %8 + %9)';
													|en = '%1 = %2 (%4 + %5 + %6 + %7 + %8 + %9)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в стр.020 Раздела 1';
													|en = 'Уточните сумму налога в стр.020 Раздела 1'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	ПодготовитьНастройки_2024Кв2(Заголовки);
	...
	НастройкиКС.Вставить("ПрефиксСтроки", "02");
	НастройкиКС.Вставить("МесОтчета"	, 3);
	ПроверкаКС_1_02_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_1_02_код_2024Кв2()
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р01С001"		, "П0000100" + НастройкиКС.ПрефиксСтроки + "001");
	ИменаПоказателей.Вставить("Р01С002"		, "П0000100" + НастройкиКС.ПрефиксСтроки + "101");
	ИменаПоказателей.Вставить("Р01С003"		, "П0000100" + НастройкиКС.ПрефиксСтроки + "201");
	ИменаПоказателей.Вставить("Р01С004"		, "П0000100" + НастройкиКС.ПрефиксСтроки + "301");
	ИменаПоказателей.Вставить("Р01С005"		, "П0000100" + НастройкиКС.ПрефиксСтроки + "401");
	ИменаПоказателей.Вставить("Р01С006"		, "П0000100" + НастройкиКС.ПрефиксСтроки + "501");
	ИменаПоказателей.Вставить("Р01С007"		, "П0000100" + НастройкиКС.ПрефиксСтроки + "601");
	
	ИменаПоказателейПОП = Новый Структура;
	ИменаПоказателейПОП	.Вставить("Р01С001П"	, "П0000100" + НастройкиКС.ПрефиксСтроки + "001");
	
	Показатели 		= СформироватьПоказатели_2024Кв2(ИменаПоказателей);
	ПоказателиПОП 	= СформироватьПоказатели_2024Кв2(ИменаПоказателейПОП);
	
	ЗарегистрироватьПроверку_2024Кв2();
	
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел1 Цикл
		Дополнение = "страница " + СтраницаРаздела.НомерСтраницы;
		ЗаполнитьИРасшифроватьПоказатели_2024Кв2(Показатели, СтраницаРаздела,, Дополнение);
	КонецЦикла;
	
	Если ДанныеКС.ОтчетПОПНайден Тогда
		Для каждого СтраницаРаздела Из ДанныеКС.ОтчетПОП.Раздел1 Цикл
			Дополнение = "страница " + СтраницаРаздела.НомерСтраницы;
			ЗаполнитьИРасшифроватьПоказатели_2024Кв2(ПоказателиПОП, СтраницаРаздела,, Дополнение);
		КонецЦикла;
	КонецЕсли;
	
	РасчетнаяСумма = СуммаПоказателей_2024Кв2(Показатели) + ПоказателиПОП.Р01С001П.Итог - Показатели.Р01С001.Итог; 
	НастройкиКС.ЭтоОшибка = ДанныеКС.МесОтчета = НастройкиКС.МесОтчета И НЕ Показатели.Р01С001.Итог = РасчетнаяСумма;
	НастройкиКС.Детализация = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НастройкиКС.ШаблонДетализации, 
		Показатели.Р01С001.Итог, РасчетнаяСумма, ПоказателиПОП.Р01С001П.Итог, Показатели.Р01С002.Итог, Показатели.Р01С003.Итог, 
		Показатели.Р01С004.Итог, Показатели.Р01С005.Итог, Показатели.Р01С006.Итог, Показатели.Р01С007.Итог);
	ДополнитьТаблицуРезультата_2024Кв2();

КонецПроцедуры

Процедура ПроверкаКС_1_03_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.03';
													|en = '1.03'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.020 Раздела 1 (за полугодие) = стр.020 Раздела 1 за 1 квартал ';
			|en = 'Сумма налога в стр.020 Раздела 1 (за полугодие) = стр.020 Раздела 1 за 1 квартал '") +
		НСтр("ru = '+ (за полугодие: стр.(021 + 022 + 023 + 024 + 025 + 026) Раздела 1)';
			|en = '+ (за полугодие: стр.(021 + 022 + 023 + 024 + 025 + 026) Раздела 1)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9)';
													|en = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	...
	НастройкиКС.Вставить("ПрефиксСтроки", "02");
	НастройкиКС.Вставить("МесОтчета"	, 6);
	ПроверкаКС_1_02_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_1_04_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.04';
													|en = '1.04'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.020 Раздела 1 (за 9 месяцев) = стр.020 Раздела 1 за полугодие ';
			|en = 'Сумма налога в стр.020 Раздела 1 (за 9 месяцев) = стр.020 Раздела 1 за полугодие '") +
		НСтр("ru = '+ (за 9 месяцев: стр.(021 + 022 + 023 + 024 + 025 + 026) Раздела 1)';
			|en = '+ (за 9 месяцев: стр.(021 + 022 + 023 + 024 + 025 + 026) Раздела 1)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9)';
													|en = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	...
	НастройкиКС.Вставить("ПрефиксСтроки", "02");
	НастройкиКС.Вставить("МесОтчета"	, 9);
	ПроверкаКС_1_02_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_1_05_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.05';
													|en = '1.05'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.020 Раздела 1 (за год) = стр.020 Раздела 1 за 9 месяцев ';
			|en = 'Сумма налога в стр.020 Раздела 1 (за год) = стр.020 Раздела 1 за 9 месяцев '") +
		НСтр("ru = '+ (за год: стр.(021 + 022 + 023 + 024 + 025 + 026) Раздела 1)';
			|en = '+ (за год: стр.(021 + 022 + 023 + 024 + 025 + 026) Раздела 1)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9)';
													|en = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	...
	НастройкиКС.Вставить("ПрефиксСтроки", "02");
	НастройкиКС.Вставить("МесОтчета"	, 12);
	ПроверкаКС_1_02_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_1_06_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.06';
													|en = '1.06'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.030 Раздела 1 (за 1 квартал) = стр.(031 + 032 + 033 + 034 + 035 + 036) Раздела 1';
			|en = 'Сумма налога в стр.030 Раздела 1 (за 1 квартал) = стр.(031 + 032 + 033 + 034 + 035 + 036) Раздела 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%4 + %5 + %6 + %7 + %8 + %9)';
													|en = '%1 = %2 (%4 + %5 + %6 + %7 + %8 + %9)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	...
	НастройкиКС.Вставить("ПрефиксСтроки", "03");
	НастройкиКС.Вставить("МесОтчета"	, 3);
	ПроверкаКС_1_02_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_1_07_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.07';
													|en = '1.07'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.030 Раздела 1 (за полугодие) = стр.030 Раздела 1 за 1 квартал ';
			|en = 'Сумма налога в стр.030 Раздела 1 (за полугодие) = стр.030 Раздела 1 за 1 квартал '") +
		НСтр("ru = '+ (за полугодие: стр.(031 + 032 + 033 + 034 + 035 + 036) Раздела 1)';
			|en = '+ (за полугодие: стр.(031 + 032 + 033 + 034 + 035 + 036) Раздела 1)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9)';
													|en = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_08_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.08';
													|en = '1.08'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.030 Раздела 1 (за 9 месяцев) = стр.030 Раздела 1 за полугодие ';
			|en = 'Сумма налога в стр.030 Раздела 1 (за 9 месяцев) = стр.030 Раздела 1 за полугодие '") +
		НСтр("ru = '+ (за 9 месяцев: стр.(031 + 032 + 033 + 034 + 035 + 036) Раздела 1)';
			|en = '+ (за 9 месяцев: стр.(031 + 032 + 033 + 034 + 035 + 036) Раздела 1)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9)';
													|en = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_09_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.09';
													|en = '1.09'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.030 Раздела 1 (за год) = стр.030 Раздела 1 за 9 месяцев ';
			|en = 'Сумма налога в стр.030 Раздела 1 (за год) = стр.030 Раздела 1 за 9 месяцев '") +
		НСтр("ru = '+ (за год: стр.(031 + 032 + 033 + 034 + 035 + 036) Раздела 1)';
			|en = '+ (за год: стр.(031 + 032 + 033 + 034 + 035 + 036) Раздела 1)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9)';
													|en = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_40_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.40';
													|en = '1.40'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стр.(021 - 031) Раздела 1 = стр.(161 - 191) Раздела 2';
			|en = 'Стр.(021 - 031) Раздела 1 = стр.(161 - 191) Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 (%2 - %3) = %4 (%5 - %6)';
													|en = '%1 (%2 - %3) = %4 (%5 - %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, 
		НСтр("ru = 'Уточните сумму налога в стр.021, 031 Раздела 1, стр.161, 191 Раздела 2';
			|en = 'Уточните сумму налога в стр.021, 031 Раздела 1, стр.161, 191 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	ПодготовитьНастройки_2024Кв2(Заголовки);
	...
	НастройкиКС.Вставить("ПостфиксСтроки", "1");
	ПроверкаКС_1_40_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_1_40_код_2024Кв2()
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р01С001"		, "П000010002" + НастройкиКС.ПостфиксСтроки + "01");
	ИменаПоказателей.Вставить("Р01С002"		, "П000010003" + НастройкиКС.ПостфиксСтроки + "01");
	ИменаПоказателей.Вставить("Р02С003"		, "П000020016" + НастройкиКС.ПостфиксСтроки + "03");
	ИменаПоказателей.Вставить("Р02С004"		, "П000020019" + НастройкиКС.ПостфиксСтроки + "03");
	
	Показатели = СформироватьПоказатели_2024Кв2(ИменаПоказателей);
	ЗарегистрироватьПроверку_2024Кв2();
	
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел1 Цикл
		Показатели.Р01С001.Дополнение = "страница " + СтраницаРаздела.НомерСтраницы;
		ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р01С001, СтраницаРаздела);
		Показатели.Р01С002.Дополнение = "страница " + СтраницаРаздела.НомерСтраницы;
		ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р01С002, СтраницаРаздела);
	КонецЦикла;
	
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2 Цикл
		Показатели.Р02С003.Дополнение = "страница " + СтраницаРаздела.НомерСтраницы;
		ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С003, СтраницаРаздела);
		Показатели.Р02С004.Дополнение = "страница " + СтраницаРаздела.НомерСтраницы;
		ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С004, СтраницаРаздела);
	КонецЦикла;
	
	РасчетнаяСумма1 = Показатели.Р01С001.Итог - Показатели.Р01С002.Итог;  
	РасчетнаяСумма2 = Показатели.Р02С003.Итог - Показатели.Р02С004.Итог;  
	
	НастройкиКС.ЭтоОшибка = НЕ РасчетнаяСумма1 = РасчетнаяСумма2;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
		РасчетнаяСумма1, Показатели.Р01С001.Итог, Показатели.Р01С002.Итог, РасчетнаяСумма2, 
		Показатели.Р02С003.Итог, Показатели.Р02С004.Итог);
	ДополнитьТаблицуРезультата_2024Кв2();
		
КонецПроцедуры

Процедура ПроверкаКС_1_41_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.41';
													|en = '1.41'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стр.(022 - 032) Раздела 1 = стр.(162 - 192) Раздела 2';
			|en = 'Стр.(022 - 032) Раздела 1 = стр.(162 - 192) Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 (%2 - %3) = %4 (%5 - %6)';
													|en = '%1 (%2 - %3) = %4 (%5 - %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, 
		НСтр("ru = 'Уточните сумму налога в стр.022, 032 Раздела 1, стр.162, 192 Раздела 2';
			|en = 'Уточните сумму налога в стр.022, 032 Раздела 1, стр.162, 192 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	ПодготовитьНастройки_2024Кв2(Заголовки);
	...
	НастройкиКС.Вставить("ПостфиксСтроки", "2");
	ПроверкаКС_1_40_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_1_42_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.42';
													|en = '1.42'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стр.(023 - 033) Раздела 1 = стр.(163 - 193) Раздела 2';
			|en = 'Стр.(023 - 033) Раздела 1 = стр.(163 - 193) Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 (%2 - %3) = %4 (%5 - %6)';
													|en = '%1 (%2 - %3) = %4 (%5 - %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, 
		НСтр("ru = 'Уточните сумму налога в стр.023, 033 Раздела 1, стр.163, 193 Раздела 2';
			|en = 'Уточните сумму налога в стр.023, 033 Раздела 1, стр.163, 193 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	ПодготовитьНастройки_2024Кв2(Заголовки);
	...
	НастройкиКС.Вставить("ПостфиксСтроки", "3");
	ПроверкаКС_1_40_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_1_43_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.43';
													|en = '1.43'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стр.(024 - 034) Раздела 1 = стр.(164 - 194) Раздела 2';
			|en = 'Стр.(024 - 034) Раздела 1 = стр.(164 - 194) Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 (%2 - %3) = %4 (%5 - %6)';
													|en = '%1 (%2 - %3) = %4 (%5 - %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, 
		НСтр("ru = 'Уточните сумму налога в стр.024, 034 Раздела 1, стр.164, 194 Раздела 2';
			|en = 'Уточните сумму налога в стр.024, 034 Раздела 1, стр.164, 194 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	ПодготовитьНастройки_2024Кв2(Заголовки);
	...
	НастройкиКС.Вставить("ПостфиксСтроки", "4");
	ПроверкаКС_1_40_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_1_44_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.44';
													|en = '1.44'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стр.(025 - 035) Раздела 1 = стр.(165 - 195) Раздела 2';
			|en = 'Стр.(025 - 035) Раздела 1 = стр.(165 - 195) Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 (%2 - %3) = %4 (%5 - %6)';
													|en = '%1 (%2 - %3) = %4 (%5 - %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, 
		НСтр("ru = 'Уточните сумму налога в стр.025, 035 Раздела 1, стр.165, 195 Раздела 2';
			|en = 'Уточните сумму налога в стр.025, 035 Раздела 1, стр.165, 195 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	ПодготовитьНастройки_2024Кв2(Заголовки);
	...
	НастройкиКС.Вставить("ПостфиксСтроки", "5");
	ПроверкаКС_1_40_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_1_45_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.45';
													|en = '1.45'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стр.(026 - 036) Раздела 1 = стр.(166 - 196) Раздела 2';
			|en = 'Стр.(026 - 036) Раздела 1 = стр.(166 - 196) Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 (%2 - %3) = %4 (%5 - %6)';
													|en = '%1 (%2 - %3) = %4 (%5 - %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, 
		НСтр("ru = 'Уточните сумму налога в стр.026, 036 Раздела 1, стр.166, 196 Раздела 2';
			|en = 'Уточните сумму налога в стр.026, 036 Раздела 1, стр.166, 196 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	ПодготовитьНастройки_2024Кв2(Заголовки);
	...
	НастройкиКС.Вставить("ПостфиксСтроки", "6");
	ПроверкаКС_1_40_код_2024Кв2();
...
Процедура ПроверкаКС_1_10_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.10';
													|en = '1.10'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма дохода в стр.120 Раздела 2 >= стр.130 Раздела 2';
			|en = 'Сумма дохода в стр.120 Раздела 2 >= стр.130 Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма дохода';
													|en = 'Возможно ошибочная сумма дохода'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму дохода в стр.120 Раздела 2';
													|en = 'Уточните сумму дохода в стр.120 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 2';
													|en = 'Страница %1 Раздела 2'"));
	...
	НастройкиКС.Вставить("Показатель1"		, "П000020012003");
	НастройкиКС.Вставить("Показатель2"		, "П000020013003");
	
	ПроверкаКС_1_10_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_1_10_код_2024Кв2()
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р02С001"		, НастройкиКС.Показатель1);
	ИменаПоказателей.Вставить("Р02С002"		, НастройкиКС.Показатель2);
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = Показатели.Р02С001.Значение < Показатели.Р02С002.Значение;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р02С001.Значение, Показатели.Р02С002.Значение);
		НастройкиКС.ДопСведения = СтрЗаменить(НастройкиКС.ШаблонДопСведений, "%1", СтраницаРаздела.НомерСтраницы);
		ДополнитьТаблицуРезультата_2024Кв2();
...
Процедура ПроверкаКС_1_11_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.11';
													|en = '1.11'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.140 Раздела 2 = стр.(120 - 130) х стр.100 Раздела 2 / 100, с ';
			|en = 'Сумма налога в стр.140 Раздела 2 = стр.(120 - 130) х стр.100 Раздела 2 / 100, с '") +
		НСтр("ru = 'допустимой погрешностью 6 руб. х стр.110 Раздела 2, но не менее стр. 150 Раздела 2';
			|en = 'допустимой погрешностью 6 руб. х стр.110 Раздела 2, но не менее стр. 150 Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %5 ((%2 - %3) х %4 / 100) ± %8 (%6 х %7), %1 >= %9';
													|en = '%1 = %5 ((%2 - %3) х %4 / 100) ± %8 (%6 х %7), %1 >= %9'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в стр.140 Раздела 2';
													|en = 'Уточните сумму налога в стр.140 Раздела 2'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2 Цикл
		...
		ЗарегистрироватьПроверку_2024Кв2();
		ЗаполнитьИРасшифроватьПоказатели_2024Кв2(Показатели, СтраницаРаздела);
		КоэффициентПогрешности = 6;
		Погрешность = КоэффициентПогрешности * Показатели.Р02С110.Значение;
		
		РасчетнаяСумма = Окр(Макс(0, Показатели.Р02С120.Значение - Показатели.Р02С130.Значение) * 
			Показатели.Р02С100.Значение / 100);
		НастройкиКС.ЭтоОшибка = (Показатели.Р02С140.Значение > Показатели.Р02С150.Значение И 
			(Показатели.Р02С140.Значение < РасчетнаяСумма - Погрешность ИЛИ 
			Показатели.Р02С140.Значение > РасчетнаяСумма + Погрешность)) ИЛИ Показатели.Р02С140.Значение < Показатели.Р02С150.Значение;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р02С140.Значение, Показатели.Р02С120.Значение, Показатели.Р02С130.Значение, 
			Показатели.Р02С100.Значение, РасчетнаяСумма, КоэффициентПогрешности, Показатели.Р02С110.Значение,
			Погрешность, Показатели.Р02С150.Значение);
		НастройкиКС.ДопСведения = СтрЗаменить(НастройкиКС.ШаблонДопСведений, "%1", СтраницаРаздела.НомерСтраницы);
		ДополнитьТаблицуРезультата_2024Кв2();
...
Процедура ПроверкаКС_1_12_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.12';
													|en = '1.12'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Налоговая база в стр.131 Раздела 2 = стр.(120 - 130) Раздела 2, но не менее 0';
			|en = 'Налоговая база в стр.131 Раздела 2 = стр.(120 - 130) Раздела 2, но не менее 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 - %4)';
													|en = '%1 = %2 (%3 - %4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налоговой базы';
													|en = 'Возможно ошибочная сумма налоговой базы'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налоговой базы в стр.131 Раздела 2';
													|en = 'Уточните сумму налоговой базы в стр.131 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 2';
													|en = 'Страница %1 Раздела 2'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р02С001"		, "П000020013103");
	ИменаПоказателей.Вставить("Р02С002"		, "П000020012003");
	ИменаПоказателей.Вставить("Р02С003"		, "П000020013003");
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2 Цикл
		...
		РасчетнаяСумма = Макс(0, Показатели.Р02С002.Значение - Показатели.Р02С003.Значение);
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р02С001.Значение = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р02С001.Значение, РасчетнаяСумма, Показатели.Р02С002.Значение, Показатели.Р02С003.Значение);
		НастройкиКС.ДопСведения = СтрЗаменить(НастройкиКС.ШаблонДопСведений, "%1", СтраницаРаздела.НомерСтраницы);
		ДополнитьТаблицуРезультата_2024Кв2();
...
Процедура ПроверкаКС_1_13_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.13';
													|en = '1.13'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.140 Раздела 2 = стр.(160 + 170 - 180 + 150 + 155 + 156) Раздела 2, ';
			|en = 'Сумма налога в стр.140 Раздела 2 = стр.(160 + 170 - 180 + 150 + 155 + 156) Раздела 2, '") +
		НСтр("ru = 'но не менее стр.150 Раздела 2';
			|en = 'но не менее стр.150 Раздела 2'"));
	...
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 2';
													|en = 'Страница %1 Раздела 2'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru = 'Отключено (Письмо ФНС России от 28.02.2024 № БС-4-11/2234@)';
													|en = 'Отключено (Письмо ФНС России от 28.02.2024 № БС-4-11/2234@)'"));
	ПодготовитьНастройки_2024Кв2(Заголовки);
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р02С001"		, "П000020014003");
	ИменаПоказателей.Вставить("Р02С002"		, "П000020016003");
	ИменаПоказателей.Вставить("Р02С003"		, "П000020017003");
	ИменаПоказателей.Вставить("Р02С004"		, "П000020018003");
	ИменаПоказателей.Вставить("Р02С005"		, "П000020015003");
	ИменаПоказателей.Вставить("Р02С006"		, "П000020015503");
	ИменаПоказателей.Вставить("Р02С007"		, "П000020015603");
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2 Цикл
		...
		РасчетнаяСумма = Макс(Показатели.Р02С005.Значение, Показатели.Р02С002.Значение + Показатели.Р02С003.Значение
			- Показатели.Р02С004.Значение + Показатели.Р02С005.Значение + Показатели.Р02С006.Значение
			+ Показатели.Р02С007.Значение);
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р02С001.Значение = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р02С001.Значение, РасчетнаяСумма, Показатели.Р02С002.Значение, Показатели.Р02С003.Значение,
			Показатели.Р02С004.Значение, Показатели.Р02С005.Значение, Показатели.Р02С006.Значение, Показатели.Р02С007.Значение);
		НастройкиКС.ДопСведения = СтрЗаменить(НастройкиКС.ШаблонДопСведений, "%1", СтраницаРаздела.НомерСтраницы);
		ДополнитьТаблицуРезультата_2024Кв2();
...
Процедура ПроверкаКС_1_14_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.14';
													|en = '1.14'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стр.(140 - 150 - 155 - 156) Раздела 2 >= стр.(160 + 170 - 180 - 190) Раздела 2';
			|en = 'Стр.(140 - 150 - 155 - 156) Раздела 2 >= стр.(160 + 170 - 180 - 190) Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 (%2 - %3 - %4 - %5) >= %6 (%7 + %8 - %9)';
													|en = '%1 (%2 - %3 - %4 - %5) >= %6 (%7 + %8 - %9)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочные значения показателей';
													|en = 'Возможно ошибочные значения показателей'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните показатели в стр.140 - 190 Раздела 2';
													|en = 'Уточните показатели в стр.140 - 190 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 05.04.2024 № БС-4-11/4009@';
													|en = 'Письмо ФНС России от 05.04.2024 № БС-4-11/4009@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 2';
													|en = 'Страница %1 Раздела 2'"));
	ПодготовитьНастройки_2024Кв2(Заголовки);
	
	НастройкиКС.Вставить("Шаблон2"			, НСтр("ru = '%1 - %2';
													|en = '%1 - %2'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р02С001"		, "П000020014003");
	ИменаПоказателей.Вставить("Р02С002"		, "П000020015003");
	ИменаПоказателей.Вставить("Р02С003"		, "П000020015503");
	ИменаПоказателей.Вставить("Р02С004"		, "П000020015603");
	ИменаПоказателей.Вставить("Р02С005"		, "П000020016003");
	ИменаПоказателей.Вставить("Р02С006"		, "П000020017003");
	ИменаПоказателей.Вставить("Р02С007"		, "П000020018003");
	ИменаПоказателей.Вставить("Р02С008"		, "П000020019003");
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2 Цикл
		...
		РасчетнаяСумма1 = Показатели.Р02С001.Значение - Показатели.Р02С002.Значение - Показатели.Р02С003.Значение
			- Показатели.Р02С004.Значение; 
		РасчетнаяСумма2 = Показатели.Р02С005.Значение + Показатели.Р02С006.Значение - Показатели.Р02С007.Значение
			- Показатели.Р02С008.Значение; 
		НастройкиКС.ЭтоОшибка = РасчетнаяСумма1 < РасчетнаяСумма2;
		Детализация2 = СтрШаблон(НастройкиКС.Шаблон2, 
			Показатели.Р02С007.Значение, Показатели.Р02С008.Значение);
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			РасчетнаяСумма1, Показатели.Р02С001.Значение, Показатели.Р02С002.Значение, Показатели.Р02С003.Значение,
			Показатели.Р02С004.Значение, РасчетнаяСумма2, Показатели.Р02С005.Значение, Показатели.Р02С006.Значение, 
			Детализация2);
		НастройкиКС.ДопСведения = СтрЗаменить(НастройкиКС.ШаблонДопСведений, "%1", СтраницаРаздела.НомерСтраницы);
		ДополнитьТаблицуРезультата_2024Кв2();
...
Процедура ПроверкаКС_1_15_2024Кв2()
	...
	НастройкиКС.Вставить("Показатель1"		, "П000020014003");
	НастройкиКС.Вставить("Показатель2"		, "П000020015003");
	
	ПроверкаКС_1_10_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_1_32_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.32';
													|en = '1.32'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма дохода в стр.120 Раздела 2 >= стр.121 Раздела 2';
			|en = 'Сумма дохода в стр.120 Раздела 2 >= стр.121 Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма дохода';
													|en = 'Возможно ошибочная сумма дохода'"));
	...
	НастройкиКС.Вставить("Показатель1"		, "П000020012003");
	НастройкиКС.Вставить("Показатель2"		, "П000020012103");
	
	ПроверкаКС_1_10_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_1_36_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.36';
													|en = '1.36'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.160 Раздела 2 (за 1 квартал) по соответствующей ставке (стр.100 Раздела 2) = ';
			|en = 'Сумма налога в стр.160 Раздела 2 (за 1 квартал) по соответствующей ставке (стр.100 Раздела 2) = '") +
		НСтр("ru = 'стр.(161 + 162 + 163 + 164 + 165 + 166) Раздела 2';
			|en = 'стр.(161 + 162 + 163 + 164 + 165 + 166) Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%4 + %5 + %6 + %7 + %8 + %9), ставка ';
													|en = '%1 = %2 (%4 + %5 + %6 + %7 + %8 + %9), ставка '"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в стр.160 Раздела 2';
													|en = 'Уточните сумму налога в стр.160 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 2';
													|en = 'Страница %1 Раздела 2'"));
	...
	НастройкиКС.Вставить("МесОтчета"	, 3);
	ПроверкаКС_1_36_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_1_36_код_2024Кв2()
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р02С100"		, "П000020010001");
	ИменаПоказателей.Вставить("Р02С160"		, "П000020016003");
	ИменаПоказателей.Вставить("Р02С161"		, "П000020016103");
	ИменаПоказателей.Вставить("Р02С162"		, "П000020016203");
	ИменаПоказателей.Вставить("Р02С163"		, "П000020016303");
	ИменаПоказателей.Вставить("Р02С164"		, "П000020016403");
	ИменаПоказателей.Вставить("Р02С165"		, "П000020016503");
	ИменаПоказателей.Вставить("Р02С166"		, "П000020016603");
	
	ИменаПоказателейПОП = Новый Структура;
	ИменаПоказателейПОП.Вставить("Р02С100П"	, "П000020010001");
	ИменаПоказателейПОП.Вставить("Р02С160П"	, "П000020016003");
	...
	|	ВТ_Р02.НомерСтраницы КАК НомерСтраницы,
	|	ВТ_Р02.Р02С100 КАК Р02С100,
	|	ВТ_Р02.Р02С160 КАК Р02С160,
	|	ВТ_Р02.Р02С161 КАК Р02С161,
	|	ВТ_Р02.Р02С162 КАК Р02С162,
	|	ВТ_Р02.Р02С163 КАК Р02С163,
	|	ВТ_Р02.Р02С164 КАК Р02С164,
	|	ВТ_Р02.Р02С165 КАК Р02С165,
	|	ВТ_Р02.Р02С166 КАК Р02С166
	|ИЗ
	|	ВТ_Р02 КАК ВТ_Р02
	|
	|УПОРЯДОЧИТЬ ПО
	...
	Результат = Запрос.Выполнить();
	ВыборкаСтавкаР02 = Результат.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
	...
	Пока ВыборкаСтавкаР02.Следующий() Цикл
		...
		Для каждого Показатель Из Показатели Цикл
			Показатель.Значение.Итог = 0;
		КонецЦикла;
		ПоказателиПОП.Р02С160П.Итог = 0;
		
		Выборка = ВыборкаСтавкаР02.Выбрать();
		Пока Выборка.Следующий() Цикл
			Дополнение = "страница " + Выборка.НомерСтраницы;
			ЗаполнитьИРасшифроватьПоказатели_2024Кв2(Показатели, Выборка,, Дополнение);
		КонецЦикла;
		
		Если ДанныеКС.ОтчетПОПНайден Тогда
			Для каждого СтраницаРаздела Из ДанныеКС.ОтчетПОП.Раздел2 Цикл
				ЗаполнитьПоказатель_2024Кв2(ПоказателиПОП.Р02С100П, СтраницаРаздела);
				Если НЕ Показатели.Р02С100.Значение = ПоказателиПОП.Р02С100П.Значение Тогда
					Продолжить;
				КонецЕсли; 
				ПоказателиПОП.Р02С160П.Дополнение = "страница " + СтраницаРаздела.НомерСтраницы;
				ЗаполнитьИРасшифроватьПоказатель_2024Кв2(ПоказателиПОП.Р02С160П, СтраницаРаздела);
			КонецЦикла;
		КонецЕсли;
		
		РасчетнаяСумма = СуммаПоказателей_2024Кв2(Показатели) + ПоказателиПОП.Р02С160П.Итог - Показатели.Р02С160.Итог
			- Показатели.Р02С100.Итог; 
		НастройкиКС.ЭтоОшибка = ДанныеКС.МесОтчета = НастройкиКС.МесОтчета И НЕ Показатели.Р02С160.Итог = РасчетнаяСумма;
		НастройкиКС.Детализация = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НастройкиКС.ШаблонДетализации, 
			Показатели.Р02С160.Итог, РасчетнаяСумма, ПоказателиПОП.Р02С160П.Итог, Показатели.Р02С161.Итог, Показатели.Р02С162.Итог, 
			Показатели.Р02С163.Итог, Показатели.Р02С164.Итог, Показатели.Р02С165.Итог, Показатели.Р02С166.Итог);
		НастройкиКС.Детализация = НастройкиКС.Детализация + Показатели.Р02С100.Значение;	
		ДополнитьТаблицуРезультата_2024Кв2();
...
Процедура ПроверкаКС_1_37_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.37';
													|en = '1.37'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.160 Раздела 2 (за полугодие) по соответствующей ставке (стр.100 Раздела 2) ';
			|en = 'Сумма налога в стр.160 Раздела 2 (за полугодие) по соответствующей ставке (стр.100 Раздела 2) '") +
		НСтр("ru = '=  стр.160 Раздела 2 за 1 квартал ';
			|en = '=  стр.160 Раздела 2 за 1 квартал '") +
		НСтр("ru = '+ (за полугодие: стр.(161 + 162 + 163 + 164 + 165 + 166) Раздела 2)';
			|en = '+ (за полугодие: стр.(161 + 162 + 163 + 164 + 165 + 166) Раздела 2)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9), ставка ';
													|en = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9), ставка '"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в стр.160 Раздела 2';
													|en = 'Уточните сумму налога в стр.160 Раздела 2'"));
...
Процедура ПроверкаКС_1_38_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.38';
													|en = '1.38'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.160 Раздела 2 (за 9 месяцев) по соответствующей ставке (стр.100 Раздела 2) ';
			|en = 'Сумма налога в стр.160 Раздела 2 (за 9 месяцев) по соответствующей ставке (стр.100 Раздела 2) '") +
		НСтр("ru = '=  стр.160 Раздела 2 за полугодие ';
			|en = '=  стр.160 Раздела 2 за полугодие '") +
		НСтр("ru = '+ (за 9 месяцев: стр.(161 + 162 + 163 + 164 + 165 + 166) Раздела 2)';
			|en = '+ (за 9 месяцев: стр.(161 + 162 + 163 + 164 + 165 + 166) Раздела 2)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9), ставка ';
													|en = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9), ставка '"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_39_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.39';
													|en = '1.39'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.160 Раздела 2 (за год) по соответствующей ставке (стр.100 Раздела 2) ';
			|en = 'Сумма налога в стр.160 Раздела 2 (за год) по соответствующей ставке (стр.100 Раздела 2) '") +
		НСтр("ru = '=  стр.160 Раздела 2 за 9 месяцев ';
			|en = '=  стр.160 Раздела 2 за 9 месяцев '") +
		НСтр("ru = '+ (за год: стр.(161 + 162 + 163 + 164 + 165 + 166) Раздела 2)';
			|en = '+ (за год: стр.(161 + 162 + 163 + 164 + 165 + 166) Раздела 2)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9), ставка ';
													|en = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8 + %9), ставка '"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_16_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.16';
													|en = '1.16'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма дохода в стр.120 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 ';
			|en = 'Сумма дохода в стр.120 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 '") +
		НСтр("ru = '= сумме строк ""Общая сумма дохода"" раздела 2 Приложения № 1';
			|en = '= сумме строк ""Общая сумма дохода"" раздела 2 Приложения № 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, ставка %3';
													|en = '%1 = %2, ставка %3'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма дохода';
													|en = 'Возможно ошибочная сумма дохода'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму дохода в стр.120 Раздела 2';
	...
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru = 'Отчет за год';
													|en = 'Отчет за год'"));
	ПодготовитьНастройки_2024Кв2(Заголовки);
	...
	Пока ВыборкаСтавкаР02.Следующий() Цикл
		...
		ЗарегистрироватьПроверку_2024Кв2();
		ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С100, ВыборкаСтавкаР02);
		Показатели.Р02С120.Итог = 0;
		Показатели.П01_СуммаДохода2.Итог = 0;
		...
		Пока Выборка.Следующий() Цикл
			...
			Показатели.Р02С120.Дополнение = "Страница " + Выборка.НомерСтраницы;
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С120, Выборка);
		КонецЦикла;
		...
		Если ВыборкаСтавкаП01.НайтиСледующий(ВыборкаСтавкаР02.Р02С100, "Ставка") Тогда
			...
			Иначе
				...
				Пока Выборка.Следующий() Цикл
					...
					Дополнение = "Фамилия " + Стр_2024Кв2(Выборка.Фамилия) + " ИНН " + Стр_2024Кв2(Выборка.ИНН);
					Показатели.П01_СуммаДохода2.Дополнение = Дополнение;
					ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_СуммаДохода2, Выборка);
				КонецЦикла; 
			КонецЕсли;  
		КонецЕсли;
		
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р02С120.Итог = Показатели.П01_СуммаДохода2.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р02С120.Итог, Показатели.П01_СуммаДохода2.Итог, Показатели.Р02С100.Значение);
		ДополнитьТаблицуРезультата_2024Кв2();
		ВыборкаСтавкаП01.Сбросить();
...
Процедура ПроверкаКС_1_19_2024Кв2()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.140 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 ';
			|en = 'Сумма налога в стр.140 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 '") +
		НСтр("ru = '= сумме строк ""Сумма налога исчисленная"" раздела 2 Приложения № 1';
			|en = '= сумме строк ""Сумма налога исчисленная"" раздела 2 Приложения № 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, ставка %3';
													|en = '%1 = %2, ставка %3'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	...
	Пока ВыборкаСтавкаР02.Следующий() Цикл
		...
		Пока Выборка.Следующий() Цикл
			...
			Показатели.Р02С140.Дополнение = "Страница " + Выборка.НомерСтраницы;
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С140, Выборка);
		КонецЦикла;
		...
		Если ВыборкаСтавкаП01.НайтиСледующий(ВыборкаСтавкаР02.Р02С100, "Ставка") Тогда
			...
			Иначе
				...
				Пока Выборка.Следующий() Цикл
					...
					Дополнение = "Фамилия " + Стр_2024Кв2(Выборка.Фамилия) + " ИНН " + Стр_2024Кв2(Выборка.ИНН);
					Показатели.П01_СуммаНалога2.Дополнение = Дополнение;
					ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_СуммаНалога2, Выборка);
				КонецЦикла; 
			КонецЕсли;
		КонецЕсли;
...
Процедура ПроверкаКС_1_20_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.20';
													|en = '1.20'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.170 Раздела 2 = сумме строк ""Сумма неудержанного налога"" раздела 4 Приложения № 1';
			|en = 'Сумма налога в стр.170 Раздела 2 = сумме строк ""Сумма неудержанного налога"" раздела 4 Приложения № 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	...
	Пока ВыборкаСтавкаР02.Следующий() Цикл
		...
		Пока Выборка.Следующий() Цикл
			...
			Показатели.Р02С170.Дополнение = "Страница " + Выборка.НомерСтраницы;
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С170, Выборка);
		КонецЦикла;
		
		Если ВыборкаСтавкаП01.Следующий() Тогда
			Если ДанныеКС.Турборежим Тогда
				Показатели.П01_СуммаНалога4.Итог = ВыборкаСтавкаП01.П01_СуммаНалога4;
			Иначе
				Выборка = ВыборкаСтавкаП01.Выбрать();
				Пока Выборка.Следующий() Цикл
					...
					Дополнение = "Фамилия " + Стр_2024Кв2(Выборка.Фамилия) + " ИНН " + Стр_2024Кв2(Выборка.ИНН);
					Показатели.П01_СуммаНалога4.Дополнение = Дополнение;
					ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_СуммаНалога4, Выборка);
				КонецЦикла; 
			КонецЕсли;
		КонецЕсли;
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р02С170.Итог = Показатели.П01_СуммаНалога4.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р02С170.Итог, Показатели.П01_СуммаНалога4.Итог);
		ДополнитьТаблицуРезультата_2024Кв2();
...
Процедура ПроверкаКС_1_28_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.28';
													|en = '1.28'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Количество физических лиц, получивших доход в стр.110 Раздела 2 по соответствующим ставке в стр.100 ';
			|en = 'Количество физических лиц, получивших доход в стр.110 Раздела 2 по соответствующим ставке в стр.100 '") +
		НСтр("ru = 'Раздела 2 и КБК в стр.105 Раздела 2 = количество разделов 2 Приложения № 1';
			|en = 'Раздела 2 и КБК в стр.105 Раздела 2 = количество разделов 2 Приложения № 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, ставка %3, КБК %4';
													|en = '%1 = %2, ставка %3, КБК %4'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное количество физических лиц';
													|en = 'Возможно ошибочное количество физических лиц'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните количество физических лиц в стр.110 Раздела 2';
													|en = 'Уточните количество физических лиц в стр.110 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru = 'Отчет за год';
													|en = 'Отчет за год'"));
	...
	Пока ВыборкаСтавкаР02.Следующий() Цикл
		...
		ЗарегистрироватьПроверку_2024Кв2();
		ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С100, ВыборкаСтавкаР02);
		ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С105, ВыборкаСтавкаР02);
		Показатели.Р02С110.Итог = 0;
		КоличествоРазделов = 0;
		...
		Пока Выборка.Следующий() Цикл
			...
			Показатели.Р02С110.Дополнение = "Страница " + Выборка.НомерСтраницы;
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С110, Выборка);
		КонецЦикла;
		...
		Если ВыборкаСтавкаП01.НайтиСледующий(ВыборкаСтавкаР02.СтавкаКБК, "СтавкаКБК") Тогда
			...
			Если НЕ ДанныеКС.Турборежим Тогда
				Выборка = ВыборкаСтавкаП01.Выбрать();
				Пока Выборка.Следующий() Цикл
					ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_Фамилия, Выборка);
				КонецЦикла;
			КонецЕсли;
		КонецЕсли;
		
		НастройкиКС.ЭтоОшибка = (ЗначениеЗаполнено(Показатели.Р02С110.Итог) ИЛИ КоличествоРазделов > 1
			ИЛИ ЗначениеЗаполнено(Показатели.Р02С100.Значение)) И НЕ Показатели.Р02С110.Итог = КоличествоРазделов;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р02С110.Итог, КоличествоРазделов, Показатели.Р02С100.Значение, Показатели.Р02С105.ЗначениеСтр);
		ДополнитьТаблицуРезультата_2024Кв2();
		ВыборкаСтавкаП01.Сбросить();
...
Процедура ПроверкаКС_1_29_2024Кв2()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 + %3)';
													|en = '%1 = %4 (%2 + %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма вычетов';
													|en = 'Возможно ошибочная сумма вычетов'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму вычетов в стр.130 Раздела 2';
													|en = 'Уточните сумму вычетов в стр.130 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	...
	Пока ВыборкаСтавка.Следующий() Цикл
		...
		Пока Выборка.Следующий() Цикл
			...
			Показатели.Р02С130.Дополнение = "Страница " + Выборка.НомерСтраницы;
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С130, Выборка);
		КонецЦикла;
		
		Если ВыборкаВычет3.Следующий() Тогда
			Если ДанныеКС.Турборежим Тогда
				Показатели.П01_СуммаВычета3.Итог = ВыборкаВычет3.П01_СуммаВычета3;
			Иначе
				Выборка = ВыборкаВычет3.Выбрать();
				Пока Выборка.Следующий() Цикл
					...
					Показатели.П01_СуммаВычета3.Дополнение = "Фамилия " + Стр_2024Кв2(Выборка.Фамилия) + " ИНН " 
						+ Стр_2024Кв2(Выборка.ИНН);
					ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_СуммаВычета3, Выборка);
				КонецЦикла; 
			КонецЕсли; 
		КонецЕсли;
		
		Если ВыборкаВычет6.Следующий() Тогда
			Если ДанныеКС.Турборежим Тогда
				Показатели.П01_СуммаВычета6.Итог = ВыборкаВычет6.П01_СуммаВычета6;
			Иначе
				Выборка = ВыборкаВычет6.Выбрать();
				Пока Выборка.Следующий() Цикл
					...
					Показатели.П01_СуммаВычета6.Дополнение = "Фамилия " + Стр_2024Кв2(Выборка.Фамилия) + " ИНН " 
						+ Стр_2024Кв2(Выборка.ИНН);
					ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_СуммаВычета6, Выборка);
				КонецЦикла; 
			КонецЕсли;
		КонецЕсли;
...
Процедура ПроверкаКС_1_30_2024Кв2()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.150 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 ';
			|en = 'Сумма авансового платежа в стр.150 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 '") +
		НСтр("ru = '= сумме строк ""Сумма фиксированных авансовых платежей"" раздела 2 Приложения № 1';
			|en = '= сумме строк ""Сумма фиксированных авансовых платежей"" раздела 2 Приложения № 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, ставка %3';
													|en = '%1 = %2, ставка %3'"));
	...
	Пока ВыборкаСтавкаР02.Следующий() Цикл
		...
		Пока Выборка.Следующий() Цикл
			...
			Показатели.Р02С150.Дополнение = "Страница " + Выборка.НомерСтраницы;
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С150, Выборка);
		КонецЦикла;
		...
		Если ВыборкаСтавкаП01.НайтиСледующий(ВыборкаСтавкаР02.Р02С100, "Ставка") Тогда
			...
			Иначе
				...
				Пока Выборка.Следующий() Цикл
					...
					Дополнение = "Фамилия " + Стр_2024Кв2(Выборка.Фамилия) + " ИНН " + Стр_2024Кв2(Выборка.ИНН);
					Показатели.П01_СуммаФиксПл.Дополнение = Дополнение;
					ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_СуммаФиксПл, Выборка);
				КонецЦикла; 
			КонецЕсли;
		КонецЕсли;
...
Процедура ПроверкаКС_1_31_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31';
													|en = '1.31'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма дохода в стр.121 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 ';
			|en = 'Сумма дохода в стр.121 Раздела 2 по соответствующей ставке в стр.100 Раздела 2 '") +
		НСтр("ru = '<= сумме строк ""Общая сумма дохода"" раздела 2 Приложения № 1 ';
			|en = '<= сумме строк ""Общая сумма дохода"" раздела 2 Приложения № 1 '") +
		НСтр("ru = 'с указанием в поле ""Статус налогоплательщика"" кода ""3"" и ""7""';
			|en = 'с указанием в поле ""Статус налогоплательщика"" кода ""3"" и ""7""'"));
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма дохода';
													|en = 'Возможно ошибочная сумма дохода'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму дохода в стр.121 Раздела 2';
													|en = 'Уточните сумму дохода в стр.121 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru = 'Отчет за год';
													|en = 'Отчет за год'"));
	...
	Пока ВыборкаСтавкаР02.Следующий() Цикл
		...
		Пока Выборка.Следующий() Цикл
			...
			Показатели.Р02С121.Дополнение = "Страница " + Выборка.НомерСтраницы;
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С121, Выборка);
		КонецЦикла;
		...
		Если ВыборкаСтавкаП01.НайтиСледующий(ВыборкаСтавкаР02.Р02С100, "Ставка") Тогда
			...
			Иначе
				...
				Пока Выборка.Следующий() Цикл
					...
					Дополнение = "Фамилия " + Стр_2024Кв2(Выборка.Фамилия) + " ИНН " + Стр_2024Кв2(Выборка.ИНН) 
						+ " Статус " + Стр_2024Кв2(Выборка.Статус);
					Показатели.П01_СуммаДохода2.Дополнение = Дополнение;
					ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_СуммаДохода2, Выборка);
				КонецЦикла; 
			КонецЕсли;  
		...
		НастройкиКС.ЭтоОшибка = Показатели.Р02С121.Итог > Показатели.П01_СуммаДохода2.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р02С121.Итог, Показатели.П01_СуммаДохода2.Итог, Показатели.Р02С100.Значение);
		ДополнитьТаблицуРезультата_2024Кв2();
		ВыборкаСтавкаП01.Сбросить();
...
Процедура ПроверкаКС_1_33_2024Кв2()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога на прибыль';
													|en = 'Возможно ошибочная сумма налога на прибыль'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в стр.155 Раздела 2';
													|en = 'Уточните сумму налога в стр.155 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	...
	Пока ВыборкаР02.Следующий() Цикл
		...
		Показатели.Р02С155.Дополнение = "Страница " + ВыборкаР02.НомерСтраницы;
		ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С155, ВыборкаР02);
	КонецЦикла;
	...
	Пока ВыборкаП01.Следующий() Цикл
		...
		Иначе
			...
			Пока Выборка.Следующий() Цикл
				...
				Дополнение = "Фамилия " + Стр_2024Кв2(Выборка.Фамилия) + " ИНН " + Стр_2024Кв2(Выборка.ИНН);
				Показатели.П01_СуммаНалогаПр.Дополнение = Дополнение;
				ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_СуммаНалогаПр, Выборка);
			КонецЦикла; 
		КонецЕсли;
	КонецЦикла;
...
Процедура ПроверкаКС_1_34_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.34';
													|en = '1.34'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога, исчисленная в иностранном государстве в стр. 156 Раздела 2 = сумме строк ""Сумма ';
			|en = 'Сумма налога, исчисленная в иностранном государстве в стр. 156 Раздела 2 = сумме строк ""Сумма '") +
		НСтр("ru = 'налога, исчисленная и уплаченная в иностранном государстве"" Раздела 2 Приложений № 1';
			|en = 'налога, исчисленная и уплаченная в иностранном государстве"" Раздела 2 Приложений № 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в стр.156 Раздела 2';
													|en = 'Уточните сумму налога в стр.156 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru = 'Отчет за год';
													|en = 'Отчет за год'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р02С156"				, "П000020015603");
	ИменаПоказателей.Вставить("П01_СуммаНалогаИн"	, "П000П1М100011_");
	...
	|	ВТ_П01.Фамилия КАК Фамилия,
	|	ВТ_П01.ИНН КАК ИНН,
	|	ВТ_П02.СуммаНалогаИн КАК П01_СуммаНалогаИн
	|ИЗ
	|	ВТ_П01 КАК ВТ_П01
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТ_П02 КАК ВТ_П02
	|		ПО ВТ_П01.Ключ = ВТ_П02.Ключ
	|ГДЕ
	|	НЕ ВТ_П02.СуммаНалогаИн = 0
	|
	|УПОРЯДОЧИТЬ ПО
	|	НомерСтраницы,
	|	НомерСтроки1
	|ИТОГИ
	|	СУММА(П01_СуммаНалогаИн)
	|ПО
	|	ОБЩИЕ";
	...
	Пока ВыборкаР02.Следующий() Цикл
		...
		Показатели.Р02С156.Дополнение = "Страница " + ВыборкаР02.НомерСтраницы;
		ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С156, ВыборкаР02);
	КонецЦикла;
		
	Пока ВыборкаП01.Следующий() Цикл
		Если ДанныеКС.Турборежим Тогда
			Показатели.П01_СуммаНалогаИн.Итог = ВыборкаП01.П01_СуммаНалогаИн;
		Иначе
			Выборка = ВыборкаП01.Выбрать();
			Пока Выборка.Следующий() Цикл
				
				Дополнение = "Фамилия " + Стр_2024Кв2(Выборка.Фамилия) + " ИНН " + Стр_2024Кв2(Выборка.ИНН);
				Показатели.П01_СуммаНалогаИн.Дополнение = Дополнение;
				ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_СуммаНалогаИн, Выборка);
			КонецЦикла; 
		КонецЕсли;
	КонецЦикла;
		
	НастройкиКС.ЭтоОшибка = НЕ Показатели.Р02С156.Итог = Показатели.П01_СуммаНалогаИн.Итог;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
		Показатели.Р02С156.Итог, Показатели.П01_СуммаНалогаИн.Итог);
	ДополнитьТаблицуРезультата_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_1_35_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.35';
													|en = '1.35'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Количество высококвалифицированных специалистов, получивших доход в стр.111 Раздела 2 по ';
			|en = 'Количество высококвалифицированных специалистов, получивших доход в стр.111 Раздела 2 по '") +
		НСтр("ru = 'соответствующим ставке в стр.100 Раздела 2 = количество разделов 2 Приложений № 1 с ';
			|en = 'соответствующим ставке в стр.100 Раздела 2 = количество разделов 2 Приложений № 1 с '") +
		НСтр("ru = 'указанием в поле ""Статус налогоплательщика"" кодов ""3"" и ""7""';
			|en = 'указанием в поле ""Статус налогоплательщика"" кодов ""3"" и ""7""'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, ставка %3';
													|en = '%1 = %2, ставка %3'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное количество высококвалифицированных специалистов';
													|en = 'Возможно ошибочное количество высококвалифицированных специалистов'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните количество специалистов в стр.111 Раздела 2';
													|en = 'Уточните количество специалистов в стр.111 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru = 'Отчет за год';
													|en = 'Отчет за год'"));
	...
	Пока ВыборкаСтавкаР02.Следующий() Цикл
		...
		ЗарегистрироватьПроверку_2024Кв2();
		ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С100, ВыборкаСтавкаР02);
		Показатели.Р02С111.Итог = 0;
		КоличествоРазделов = 0;
		
		Выборка = ВыборкаСтавкаР02.Выбрать();
		Пока Выборка.Следующий() Цикл
		
			Показатели.Р02С111.Дополнение = "Страница " + Выборка.НомерСтраницы;
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р02С111, Выборка);
		КонецЦикла;
		...
		НастройкиКС.ЭтоОшибка = (ЗначениеЗаполнено(Показатели.Р02С111.Итог) ИЛИ КоличествоРазделов > 0) 
			И НЕ Показатели.Р02С111.Итог = КоличествоРазделов;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р02С111.Итог, КоличествоРазделов, Показатели.Р02С100.Значение);
		ДополнитьТаблицуРезультата_2024Кв2();
		ВыборкаСтавкаП01.Сбросить();
...
Процедура ПроверкаКС_1_21_2024Кв2()
	...
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Приложения 1';
													|en = 'Страница %1 Приложения 1'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru = 'Отчет за год, ставка налога в Разделе 2 Приложения 1 13% или 15%';
													|en = 'Отчет за год, ставка налога в Разделе 2 Приложения 1 13% или 15%'"));
	ПодготовитьНастройки_2024Кв2(Заголовки);
	...
	Пока ВыборкаСтавка.Следующий() Цикл
		...
		Пока ВыборкаСтавкаДЗ.Следующий() Цикл
			...
			Если ДанныеКС.Турборежим Тогда
				...
				Ошибка = НЕ ВыборкаСтавкаДЗ.П01_НалоговаяБаза = Макс(0, ВыборкаСтавкаДЗ.П01_СуммаДохода2 - Вычет3 - Вычет6);
			...
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_Фамилия			, ВыборкаСтавкаДЗ);
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_ИНН				, ВыборкаСтавкаДЗ);
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_Ставка			, ВыборкаСтавкаДЗ);
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_НалоговаяБаза	, ВыборкаСтавкаДЗ);
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_СуммаДохода2	, ВыборкаСтавкаДЗ);
			...
			РасчетнаяСумма = Макс(0, Показатели.П01_СуммаДохода2.Значение - Показатели.П01_СуммаВычета3.Итог - 
				Показатели.П01_СуммаВычета6.Итог);
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П01_НалоговаяБаза.Значение = РасчетнаяСумма;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
				Показатели.П01_НалоговаяБаза.Значение, Показатели.П01_СуммаДохода2.Значение, Показатели.П01_СуммаВычета6.Итог, 
...
Процедура ПроверкаКС_1_22_2024Кв2()
	...
	Пока ВыборкаСтавка.Следующий() Цикл
		...
		Пока ВыборкаСтавкаДЗ.Следующий() Цикл
			...
			Если ДанныеКС.Турборежим Тогда
				...
				Ошибка = НЕ ВыборкаСтавкаДЗ.П01_НалоговаяБаза = Макс(0, ВыборкаСтавкаДЗ.П01_СуммаДохода2 - Вычет6);
			...
			РасчетнаяСумма = Макс(0, Показатели.П01_СуммаДохода2.Значение - Показатели.П01_СуммаВычета6.Итог);
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П01_НалоговаяБаза.Значение = РасчетнаяСумма;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
				Показатели.П01_НалоговаяБаза.Значение, Показатели.П01_СуммаДохода2.Значение, Показатели.П01_СуммаВычета6.Итог, 
				РасчетнаяСумма, Показатели.П01_Ставка.Значение);
...
Процедура ПроверкаКС_1_23_2024Кв2()
	...
	Пока Выборка.Следующий() Цикл
		...
		ЗарегистрироватьПроверку_2024Кв2();
		ЗаполнитьИРасшифроватьПоказатели_2024Кв2(Показатели, Выборка);
...
Процедура ПроверкаКС_1_24_1_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 1';
														|en = 'Приложение 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.24.1';
													|en = '1.24.1'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = '(Сумма стр. ""Сумма дохода"" Приложения ""Сведения о доходах и соответствующих вычетах по месяцам ';
			|en = '(Сумма стр. ""Сумма дохода"" Приложения ""Сведения о доходах и соответствующих вычетах по месяцам '") +
		...
		Пока ВыборкаСтавкаДЗ.Следующий() Цикл
			...
			Если ВыборкаДоход5.НайтиСледующий(ВыборкаСтавка.Ключ, "Ключ") Тогда
				...
				Если ВыборкаДоход5НС.НайтиСледующий(ВыборкаСтавкаДЗ.НомерСтроки1, "НомерСтроки1") Тогда
					Выборка = ВыборкаДоход5НС.Выбрать();
					Пока Выборка.Следующий() Цикл
						ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_СуммаДохода5, Выборка);
					КонецЦикла; 
				КонецЕсли; 
			    ВыборкаДоход5НС.Сбросить();
			КонецЕсли;
			...
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_Ставка			, ВыборкаСтавкаДЗ);
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_СуммаНалога2	, ВыборкаСтавкаДЗ);
...
Процедура ПроверкаКС_1_24_2_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 1';
														|en = 'Приложение 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.24.2';
													|en = '1.24.2'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стр. ""Сумма налога исчисленная"" раздела 2 Приложения № 1 к 6-НДФЛ >= 0';
			|en = 'Стр. ""Сумма налога исчисленная"" раздела 2 Приложения № 1 к 6-НДФЛ >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	...
	Пока Выборка.Следующий() Цикл
		...
		НастройкиКС.ЭтоОшибка = Показатели.П01_СуммаНалога2.Значение < 0;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.П01_СуммаНалога2.Значение);
		НастройкиКС.ДопСведения = СтрЗаменить(НастройкиКС.ШаблонДопСведений, "%1", Выборка.НомерСтраницы);
		ДополнитьТаблицуРезультата_2024Кв2();
...
Процедура ПроверкаКС_1_25_1_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 1';
														|en = 'Приложение 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.25.1';
													|en = '1.25.1'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стр. ""Сумма дохода, с которого не удержан налог налоговым агентом"" раздела 4 Приложения № 1 ';
			|en = 'Стр. ""Сумма дохода, с которого не удержан налог налоговым агентом"" раздела 4 Приложения № 1 '") +
...
Процедура ПроверкаКС_1_25_2_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 1';
														|en = 'Приложение 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.25.2';
													|en = '1.25.2'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стр. ""Сумма неудержанного налога"" раздела 4 Приложения № 1 к 6-НДФЛ >= 0';
			|en = 'Стр. ""Сумма неудержанного налога"" раздела 4 Приложения № 1 к 6-НДФЛ >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в разделе 4 Приложения 1';
													|en = 'Уточните сумму налога в разделе 4 Приложения 1'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@';
													|en = 'Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Приложения 1';
													|en = 'Страница %1 Приложения 1'"));
	...
	Пока Выборка.Следующий() Цикл
		...
		НастройкиКС.ЭтоОшибка = Показатели.П01_СуммаНалога4.Значение < 0;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.П01_СуммаНалога4.Значение);
		НастройкиКС.ДопСведения = СтрЗаменить(НастройкиКС.ШаблонДопСведений, "%1", Выборка.НомерСтраницы);
		ДополнитьТаблицуРезультата_2024Кв2();
...
Процедура ПроверкаКС_1_26_1_2024Кв2()
	...
	Пока ВыборкаГр.Следующий() Цикл
		...
		Пока ВыборкаНС.Следующий() Цикл
			...
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_Фамилия			, ВыборкаНС);
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_ИНН				, ВыборкаНС);
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.П01_СуммаДохода2	, ВыборкаНС);
...
Процедура ПроверкаКС_1_26_2_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.26.2';
													|en = '1.26.2'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стр. ""Общая сумма дохода"" раздела 2 Приложения № 1 к 6-НДФЛ >= 0';
			|en = 'Стр. ""Общая сумма дохода"" раздела 2 Приложения № 1 к 6-НДФЛ >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма дохода';
													|en = 'Возможно ошибочная сумма дохода'"));
	...
	Пока Выборка.Следующий() Цикл
		...
		НастройкиКС.ЭтоОшибка = Показатели.П01_СуммаДохода2.Значение < 0;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.П01_СуммаДохода2.Значение);
		НастройкиКС.ДопСведения = СтрЗаменить(НастройкиКС.ШаблонДопСведений, "%1", Выборка.НомерСтраницы);
		ДополнитьТаблицуРезультата_2024Кв2();
...
Процедура ПроверкаКС_1_27_2024Кв2()
...
Функция ДанныеРегОтчетаСУчетомКонвертации(СсылкаНаРеглОтчет) Экспорт
	
	ИмяФормы = СокрЛП(СсылкаНаРеглОтчет.ВыбраннаяФорма);
	
	СтруктураРеквизитовФормы = Неопределено;
	
	СформироватьСтруктуруРеквизитовФормы(ИмяФормы, СтруктураРеквизитовФормы);
	
	СтруктураРеквизитовФормы.Вставить("мСохраненныйДок", СсылкаНаРеглОтчет);
	...
	Возврат СохраненныеДанныеОтчета(ИмяФормы, СтруктураРеквизитовФормы, СтруктураМногоуровневыхРазделов);
