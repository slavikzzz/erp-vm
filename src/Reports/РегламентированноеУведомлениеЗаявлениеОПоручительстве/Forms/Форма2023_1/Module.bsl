...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Объект.ВидУведомления = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ЗаявлениеОПоручительстве;
	...
	Если НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.заяв.о поручительст.") Тогда
...
Процедура ВидимостьЭлементов()
	Если РегламентированнаяОтчетностьПереопределяемый.ЭтоЮридическоеЛицо(Объект.Организация) Тогда
		...
		ПоказатьТекущуюСтраницу("Титульная2023_1", Неопределено);
...
Процедура СформироватьДеревоСтраниц() Экспорт
	...
	Стр001.ИмяМакета = "Титульная2023_1";
	Стр001.Многостраничность = Ложь;
	Стр001.Многострочность = Ложь;
	Стр001.УИД = Новый УникальныйИдентификатор;
	Стр001.ИДНаименования = "Титульная";
	Стр001.МакетыПФ = "Печать_Титульная2023_1";
	
	Стр001 = КорневойУровень.Добавить();
	Стр001.Наименование = "Сведения о" + Символы.ПС + "физическом лице";
	Стр001.ИндексКартинки = 1;
	Стр001.ИмяМакета = "УдЛичнФЛ2023_1";
	Стр001.Многостраничность = Ложь;
	Стр001.Многострочность = Ложь;
	Стр001.УИД = Новый УникальныйИдентификатор;
	Стр001.ИДНаименования = "УдЛичнФЛ";
	Стр001.МакетыПФ = "Печать_УдЛичнФЛ2023_1";
КонецПроцедуры
