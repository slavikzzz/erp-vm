...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "08/08/2013";
...
Процедура ОчиститьТабличноеПолеНаСервере()
	...
	СписокПоказателейНеПодлежащихОчистке.Добавить(ВыбТабличноеПоле.Области["ОргВебСайт"].Значение,               "ОргВебСайт");
...
Функция ПечатьНаСервере(ВидПечати)
	...
	// Дополнительно, для Формы 2-наука (краткая):
	// удаление строки с Кодом по ОКАТО (Титульный лист), предназначенным для выгрузки (не выводится на печать).
...
Процедура ВвестиПоказатель(Элемент, Область, КодПоказателя, Знач ЭтоСумма, Знач ТекстВыбора, ТаблицаВыбора, СтандартнаяОбработка, КолонкаПоиска = "Код") Экспорт
	...
	Если Область.Имя = "ОргКодЗнач1" И Не ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["ОргКодЗнач"].Значение) Тогда
		...
		Сообщение.Текст = НСтр("ru = 'Код сектора деятельности не выбран: значение в графе 3 кодовой части формы должно равняться 1, 2, 3 или 4!';
								|en = 'Код сектора деятельности не выбран: значение в графе 3 кодовой части формы должно равняться 1, 2, 3 или 4!'");
		Сообщение.Сообщить();
		Возврат;
	ИначеЕсли Область.Имя = "ОргКодЗнач1" И ПолеТабличногоДокументаФормаОтчета.Области["ОргКодЗнач"].Значение <> "1"
		...
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru = 'Код сектора деятельности указан неверно: значение в графе 3 кодовой части формы должно равняться 1, 2, 3 или 4!';
								|en = 'Код сектора деятельности указан неверно: значение в графе 3 кодовой части формы должно равняться 1, 2, 3 или 4!'");
		Сообщение.Сообщить();
		Возврат;
	КонецЕсли;
