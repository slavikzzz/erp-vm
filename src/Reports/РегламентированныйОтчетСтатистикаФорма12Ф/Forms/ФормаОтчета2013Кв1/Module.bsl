...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мВерсияФормы = "10/11/2013";
	СтруктураРеквизитовФормы.мКодОтчета   = "0608011";
...
Функция ПечатьНаСервере(ВидПечати)
	...
	Для Каждого Обл Из ОбластиСтроки Цикл
		...
		СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 12-Ф");
	КонецЦикла;
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	МассивСтрок.Добавить(293);
	МассивСтрок.Добавить(312);
	МассивСтрок.Добавить(314);
	МассивСтрок.Добавить(316);
	МассивСтрок.Добавить(318);
	МассивСтрок.Добавить(320);
	МассивСтрок.Добавить(322);
	...
	Для Каждого Элт Из МассивСтрок Цикл
		...
		Для НомерКолонки = 3 По 4 Цикл
			...
			ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010" + Стр1 + "0" + НомерКолонки]);
			ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010" + Стр2 + "0" + НомерКолонки]);
	...
	МассивСтрок.Добавить(296);
	МассивСтрок.Добавить(297);
	СоответствиеСтрок[294] = МассивСтрок;
	
	МассивСтрок = Новый Массив;
	МассивСтрок.Добавить(293);
	МассивСтрок.Добавить(303);
	МассивСтрок.Добавить(322);
	МассивСтрок.Добавить(324);
	МассивСтрок.Добавить(325);
	МассивСтрок.Добавить(326);
	МассивСтрок.Добавить(327);
	МассивСтрок.Добавить(328);
	МассивСтрок.Добавить(329);
	СоответствиеСтрок[330] = МассивСтрок;
	
	МассивСтрок = Новый Массив;
	МассивСтрок.Добавить(306);
	МассивСтрок.Добавить(307);
	МассивСтрок.Добавить(308);
	МассивСтрок.Добавить(309);
	МассивСтрок.Добавить(310);
	МассивСтрок.Добавить(311);
	МассивСтрок.Добавить(312);
	МассивСтрок.Добавить(314);
	МассивСтрок.Добавить(316);
	МассивСтрок.Добавить(318);
	МассивСтрок.Добавить(320);
	СоответствиеСтрок[303] = МассивСтрок;
	
	Для Каждого Элемент Из СоответствиеСтрок Цикл 
		МассивСтрок = Элемент.Значение;
		ИсхСтрока = Элемент.Ключ;
		Для НомерКолонки = 3 По 4 Цикл
			ТекстФормулы = "стр." + ИсхСтрока + " гр." + НомерКолонки + " >= (";
			Описание     = "стр." + ИсхСтрока + " гр." + НомерКолонки + " < (";
			
			ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010" + ИсхСтрока + "0" + НомерКолонки]);
			ПраваяЧастьВсего = 0;
			Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " ";
			
			ПервыйЭлт = Истина;
			Для Каждого Элт Из МассивСтрок Цикл
				ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010" + Элт + "0" + НомерКолонки]);
				...
				ТекстФормулы = ТекстФормулы + "стр." + Элт;
				Описание     = Описание + "стр." + Элт;
	...
	// Гр.3 >= гр.4
	Для Элт = 293 По 330 Цикл
		Если Не Показатели.Свойство("П010" + Элт + "03") Тогда 
			Продолжить;
		КонецЕсли;
		
		ТекстФормулы = "стр." + Элт + " гр.3 >= стр." + Элт + " гр.4";
		Описание     = "стр." + Элт + " гр.3 < стр." + Элт + " гр.4";
		
		ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010" + Элт + "03"]);
		ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010" + Элт + "04"]);
		Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " " + Строка(ПраваяЧасть);
