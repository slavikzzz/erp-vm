...
Процедура ВосстановитьСохраненныеДанные()
	...
	Если ВерсияФормы = "02/09/2013" Тогда
		СтруктураРеквизитовФормы.ЕдиницаИзмерения         = ПорядкиОкругленияОтчетности.ПеречислениеПорядкиОкругленияОтчетностиОкр1;
		СтруктураРеквизитовФормы.ТочностьЕдиницыИзмерения = 0;
	КонецЕсли;
...
Процедура Расчет(Форма) Экспорт
	...
	мФормаОтчета.Области.П01000603.Значение = мФормаОтчета.Области.П01000703.Значение
	+ мФормаОтчета.Области.П01000803.Значение
	+ мФормаОтчета.Области.П01000903.Значение
	+ мФормаОтчета.Области.П01001003.Значение
	+ мФормаОтчета.Области.П01001103.Значение
	+ мФормаОтчета.Области.П01001203.Значение;
	
	мФормаОтчета.Области.П01000604.Значение = мФормаОтчета.Области.П01000704.Значение
	+ мФормаОтчета.Области.П01000804.Значение
	+ мФормаОтчета.Области.П01000904.Значение
	+ мФормаОтчета.Области.П01001004.Значение
	+ мФормаОтчета.Области.П01001104.Значение
	+ мФормаОтчета.Области.П01001204.Значение;
	
	мФормаОтчета.Области.П01000605.Значение = мФормаОтчета.Области.П01000705.Значение
	+ мФормаОтчета.Области.П01000805.Значение
	+ мФормаОтчета.Области.П01000905.Значение
	+ мФормаОтчета.Области.П01001005.Значение
	+ мФормаОтчета.Области.П01001105.Значение
	+ мФормаОтчета.Области.П01001205.Значение;
	
	мФормаОтчета.Области.П01000606.Значение = мФормаОтчета.Области.П01000706.Значение
	+ мФормаОтчета.Области.П01000806.Значение
	+ мФормаОтчета.Области.П01000906.Значение
	+ мФормаОтчета.Области.П01001006.Значение
	+ мФормаОтчета.Области.П01001106.Значение
	+ мФормаОтчета.Области.П01001206.Значение;
	...
	+ мФормаОтчета.Области.П01000505.Значение;
	
	мФормаОтчета.Области.П01000306.Значение = мФормаОтчета.Области.П01000406.Значение
	+ мФормаОтчета.Области.П01000506.Значение;
	
	мФормаОтчета.Области.П01000203.Значение = мФормаОтчета.Области.П01000303.Значение
	+ мФормаОтчета.Области.П01000603.Значение;
	
	мФормаОтчета.Области.П01000204.Значение = мФормаОтчета.Области.П01000304.Значение
	+ мФормаОтчета.Области.П01000604.Значение;
	
	мФормаОтчета.Области.П01000205.Значение = мФормаОтчета.Области.П01000305.Значение
	+ мФормаОтчета.Области.П01000605.Значение;
	
	мФормаОтчета.Области.П01000206.Значение = мФормаОтчета.Области.П01000306.Значение
	+ мФормаОтчета.Области.П01000606.Значение;
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	Нарушение = "Приказ Росстата от 23.07.2013 № 291";
