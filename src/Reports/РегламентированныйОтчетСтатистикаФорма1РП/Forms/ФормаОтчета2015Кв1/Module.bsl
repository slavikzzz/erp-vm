...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "21/01/2015";
...
Функция СформироватьСтруктуруПараметров() Экспорт 
	...
	ИмяМакета = ?(Месяц(СтруктураРеквизитовФормы.мСохраненныйДок.ДатаОкончания) = 12, "АтрибВыгрузкиXML2015Кв1_год", "АтрибВыгрузкиXML2015Кв1_квартал");
	...
	ОтчПериод = Месяц(СтруктураРеквизитовФормы.мСохраненныйДок.ДатаОкончания) / МесПериод;
...
Функция ПолучитьПараметрыИнициализацииУниверсальногоОтчета()
	ИмяМакета = ?(Месяц(СтруктураРеквизитовФормы.мСохраненныйДок.ДатаОкончания) = 12, "АтрибВыгрузкиXML2015Кв1_год", "АтрибВыгрузкиXML2015Кв1_квартал");
	ИмяШаблона = ?(Месяц(СтруктураРеквизитовФормы.мСохраненныйДок.ДатаОкончания) = 12, "ШаблонРосстата2015Кв1_год", "ШаблонРосстата2015Кв1_квартал");
	Возврат УниверсальныйОтчетСтатистики.ПолучитьПараметрыИнициализацииУниверсальногоОтчета(ЭтаФорма, ИмяМакета, ИмяШаблона, "СхемаВыгрузкиXML2015Кв1", Ложь, Ложь);
КонецФункции
