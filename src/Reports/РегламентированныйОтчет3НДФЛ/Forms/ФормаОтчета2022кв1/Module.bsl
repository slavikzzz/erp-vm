...
Процедура ОбработкаВыбораВПолеТабличногоДокумента(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли ИмяЯчейки = "П002100001110" Тогда // Приложение к Разделу 1: Haимeнование банка
	...
	ИначеЕсли ИмяЯчейки = "П002100001090" Тогда // Приложение к Разделу 1: КБК налога к возврату
		
		ОбработкаВыбораКБКПереплаты(Элемент, Область, СтандартнаяОбработка);
		
	ИначеЕсли ИмяЯчейки = "П002100001100" Тогда // Приложение к Разделу 1: ОКТМО налога к возврату
...
Функция ТребуетсяРасчетРаздел1Приложение(ИмяПоказателя, ВыбранноеЗначение)
	...
	Если ИмяПоказателя = "П002100001010"
		Или ИмяПоказателя = "П002100001090" Тогда
		// КБК
		Возврат Истина;
		
	ИначеЕсли ИмяПоказателя = "П002100001020"
		Или ИмяПоказателя = "П002100001100" Тогда
		// ОКТМО
	...
	Для Каждого СтраницаРаздела Из ТаблицаСтраницРаздела Цикл
		...
		Если СтраницаРаздела.ДанныеДопСтрок <> Неопределено Тогда
			Для Каждого ДопСтрока Из СтраницаРаздела.ДанныеДопСтрок Цикл
				...
				Если СтрокаЛиста.П000100001050 = 0 Тогда
					Продолжить;
				КонецЕсли;
				
				Если  Не ЗначениеЗаполнено(СтрокаЛиста.П000100001020)
					И Не ЗначениеЗаполнено(СтрокаЛиста.П000100001030) Тогда
					Продолжить;
				КонецЕсли;
...
Процедура РассчитатьИтогиЛиста(Форма, ИмяЛиста = Неопределено)
	...
	Если ИмяЛиста = "Раздел2" Тогда
		...
		Для Каждого СтраницаЛиста Из Форма.ТаблицаСтраницыРаздел2 Цикл
			...
			Если СтраницаЛиста.АктивнаяСтраница
				И Форма.ТабличныйДокумент.Области.Найти("П000200001001") <> Неопределено Тогда
				Форма.ТабличныйДокумент.Области["П000200001030"].Значение = ПоказателиЛиста.П000200001030;
				Форма.ТабличныйДокумент.Области["П000200001060"].Значение = ПоказателиЛиста.П000200001060;
				Форма.ТабличныйДокумент.Области["П000200001061"].Значение = ПоказателиЛиста.П000200001061;
				Форма.ТабличныйДокумент.Области["П000200001062"].Значение = ПоказателиЛиста.П000200001062;
				Форма.ТабличныйДокумент.Области["П000200001063"].Значение = ПоказателиЛиста.П000200001063;
				Форма.ТабличныйДокумент.Области["П000200001070"].Значение = ПоказателиЛиста.П000200001070;
				Форма.ТабличныйДокумент.Области["П000200001100"].Значение = ПоказателиЛиста.П000200001100;
				Форма.ТабличныйДокумент.Области["П000200001140"].Значение = ПоказателиЛиста.П000200001140;
				Форма.ТабличныйДокумент.Области["П000200001150"].Значение = ПоказателиЛиста.П000200001150;
				Форма.ТабличныйДокумент.Области["П000200001160"].Значение = ПоказателиЛиста.П000200001160;
			КонецЕсли;
	...
	ИначеЕсли ИмяЛиста = "Приложение3" Тогда
		...
		Если СтраницаИтоговПриложения3 <> Неопределено Тогда
			...
			Если СтраницаИтоговПриложения3.АктивнаяСтраница
				И Форма.ТабличныйДокумент.Области.Найти("П000500001050") <> Неопределено Тогда
				Форма.ТабличныйДокумент.Области["П000500001050"].Значение = СтрокаЛиста.П000500001050;
				Форма.ТабличныйДокумент.Области["П000500001060"].Значение = СтрокаЛиста.П000500001060;
				Форма.ТабличныйДокумент.Области["П000500001070"].Значение = СтрокаЛиста.П000500001070;
				Форма.ТабличныйДокумент.Области["П000500001080"].Значение = СтрокаЛиста.П000500001080;
				Форма.ТабличныйДокумент.Области["П000500001090"].Значение = СтрокаЛиста.П000500001090;
				Форма.ТабличныйДокумент.Области["П000500001100"].Значение = СтрокаЛиста.П000500001100;
			КонецЕсли;
			
		КонецЕсли;
		
	ИначеЕсли ИмяЛиста = "Приложение3Расчет" Тогда
		...
		Если Форма.ТаблицаСтраницыПриложение3.Количество() <> 0
			И Форма.ТаблицаСтраницыПриложение3Расчет[0].Данные.Количество() <> 0 Тогда
			
			ПоказателиЛиста = Форма.ТаблицаСтраницыПриложение3Расчет[0].Данные[0].Значение;
			...
			Если Форма.ТаблицаСтраницыПриложение3Расчет[0].АктивнаяСтраница Тогда
				
				Если Форма.ТабличныйДокумент.Области.Найти("П002000001200") <> Неопределено Тогда
					Форма.ТабличныйДокумент.Области["П002000001200"].Значение = ПоказателиЛиста.П002000001200;
				КонецЕсли;
				
				Если Форма.ТабличныйДокумент.Области.Найти("П002000001201") <> Неопределено Тогда
					Форма.ТабличныйДокумент.Области["П002000001201"].Значение = ПоказателиЛиста.П002000001201;
				КонецЕсли;
				
				Если Форма.ТабличныйДокумент.Области.Найти("П002000001202") <> Неопределено Тогда
					Форма.ТабличныйДокумент.Области["П002000001202"].Значение = ПоказателиЛиста.П002000001202;
				КонецЕсли;
	...
	ИначеЕсли ИмяЛиста = "Раздел1Приложение" Тогда
		...
		Для Каждого Лист Из Форма.ТаблицаСтраницыРаздел1Приложение Цикл
			...
			КБКвозврат = СокрЛП(СтрокаЛиста.П002100001090);
...
Функция СводДоходов()
	...
	ИнвестиционныйВычетКВосстановлению = СтруктураДанныхПриложение5.П000900001220;
...
Функция СводВычетов()
	...
	СуммаДоходовНеПодлежащаяНалогообложению = СтруктураДанныхПриложение4.П000600001130;
	...
	СуммаСоциальныхВычетовПредоставленныхНалоговымиАгентами = СтруктураДанныхПриложение5.П000900001181;
	...
	ОбщаяСуммаСтандартныхСоциальныхВычетов = СтруктураДанныхПриложение5.П000900001200;
	...
	ИнвестиционныйВычет = СтруктураДанныхПриложение5.П000900001210;
	...
	ИнвестиционныйВычетПредоставленныйВУпрощенномПорядке = СтруктураДанныхПриложение5.П000900001230;
	...
	Для Каждого СтраницаРаздела Из ТаблицаСтраницыРаздел1Приложение Цикл
		...
		Если ЗначениеЗаполнено(КБКзачет) Тогда
			...
			Если СтраницаРаздела.ДанныеДопСтрок <> Неопределено
				...
				Если Не ЗначениеЗаполнено(ДанныеСтраницы.П002100001040_1) Тогда
					НайденныеСтроки = ПереплатаНДФЛ.НайтиСтроки(Новый Структура("КБК, ОКТМО", КБКзачет, ОКТМОзачет));
					Если НайденныеСтроки.Количество() = 1 Тогда
						ДанныеСтраницы.П002100001040_1 = НайденныеСтроки[0].Сумма;
					КонецЕсли;
				КонецЕсли;
			КонецЕсли;
		...
		КБКвозврат = СокрЛП(ДанныеСтраницы.П002100001090);
		Если ЗначениеЗаполнено(КБКвозврат) Тогда
			// ОКТМО
			ОКТМОвозврат = ДанныеСтраницы.П002100001100;
			Если Не ЗначениеЗаполнено(ОКТМОвозврат) Тогда
				...
				Если НайденныеСтроки.Количество() = 1 Тогда
					...
					ДанныеСтраницы.П002100001100 = ОКТМОвозврат;
				КонецЕсли;
			КонецЕсли;
			Если Не ЗначениеЗаполнено(ОКТМОвозврат) Тогда
				Продолжить;
			...
			// Сумма
			Если Не ЗначениеЗаполнено(ДанныеСтраницы.П002100001080) Тогда
				НайденныеСтроки = ПереплатаНДФЛ.НайтиСтроки(Новый Структура("КБК, ОКТМО", КБКвозврат, ОКТМОвозврат));
				Если НайденныеСтроки.Количество() = 1 Тогда
					ДанныеСтраницы.П002100001080 = НайденныеСтроки[0].Сумма;
				КонецЕсли;
			КонецЕсли;
			
			Если Не ЗначениеЗаполнено(ДанныеСтраницы.П002100001110)
				И Не ЗначениеЗаполнено(ДанныеСтраницы.П002100001120)
				И Не ЗначениеЗаполнено(ДанныеСтраницы.П002100001140) Тогда
				...
				Если РеквизитыОсновногоБанковскогоСчета <> Неопределено Тогда
					ДанныеСтраницы.П002100001110 = РеквизитыОсновногоБанковскогоСчета.БанкСчетНаимБанка;
					ДанныеСтраницы.П002100001120 = РеквизитыОсновногоБанковскогоСчета.БанкСчетБИКБанка;
					ДанныеСтраницы.П002100001130 = РеквизитыОсновногоБанковскогоСчета.БанкСчетВид;
					ДанныеСтраницы.П002100001140 = РеквизитыОсновногоБанковскогоСчета.БанкСчетНомер;
				КонецЕсли;
...
Функция КБК(Знач ВидДохода, Знач НалогПодлежитУплате, Знач ПовышеннаяСтавка, Знач ВыбраннаяФорма)
	...
	Если НалогПодлежитУплате Тогда
		...
		ИначеЕсли ВидДохода = ВидыДоходов.БанковскиеПроценты
			Или ВидДохода = ВидыДоходов.БанковскиеПроценты_Нерезидентов Тогда
...
Функция НалоговыеБазыСУчетомДанныхЗаполненныхВручную(РасчетНалоговыхБаз, ДанныеРаздела2)
	...
	НалоговыеБазы.Колонки.Добавить("СуммаНалогаУдержаннаяСМатериальнойВыгоды", ОбщегоНазначения.ОписаниеТипаЧисло(13));
	НалоговыеБазы.Колонки.Добавить("СуммаТорговогоСбора", ОбщегоНазначения.ОписаниеТипаЧисло(13));
	НалоговыеБазы.Колонки.Добавить("СуммаФиксированныхАвансовыхПлатежей", ОбщегоНазначения.ОписаниеТипаЧисло(13));
	НалоговыеБазы.Колонки.Добавить("СуммаНалогаПСН", ОбщегоНазначения.ОписаниеТипаЧисло(13));
	...
	НалоговыеБазы.Свернуть("ВидДохода, ОКТМО",
		...
		+ "УдержаноНалога, УдержаноНалогаПоПовышеннойСтавке, СуммаНалогаУдержаннаяСМатериальнойВыгоды, "
		+ "СуммаФиксированныхАвансовыхПлатежей, СуммаНалогаИностранногоГосударства, СуммаТорговогоСбора, СуммаНалогаПСН");
...
Процедура ДобавитьДанныеПоПредпринимательскойДеятельностиВРаздел1(РасчетНалога)
	...
	Если ТаблицаСтраницыПриложение3.Количество() <> 0
		И ТаблицаСтраницыПриложение3Расчет[0].Данные.Количество() <> 0 Тогда
		
		ПоказателиЛиста = ТаблицаСтраницыПриложение3Расчет[0].Данные[0].Значение;
...
Процедура ПроверитьСтраницуПриложенияКРазделу1(ДанныеСтраницы, НомерСтраницы)
	...
	Для Индекс = 0 По мДанныеОтчета.Раздел1.Количество() - 1 Цикл
		...
		Если ДанныеРаздела1.Свойство("П000100001150") И ЗначениеЗаполнено(ДанныеРаздела1.П000100001150) Тогда
			МассивОКТМОРаздела1.Добавить(ДанныеРаздела1.П000100001150);
		КонецЕсли;
	КонецЦикла;
	...
	КБКВозврат = ДанныеСтраницы["П002100001090"];
	Если ЗначениеЗаполнено(КБКВозврат) Тогда
		
		// Номер заявления
		Если Не ЗначениеЗаполнено(ДанныеСтраницы["П002100001075"]) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект,
				СтрШаблон(НСтр("ru = 'На странице %1 Приложения к Разделу 1 не указан номер заявления!';
								|en = 'На странице %1 Приложения к Разделу 1 не указан номер заявления!'"), НомерСтраницы),
				"Раздел1Приложение",
...
Процедура ПроверитьСтраницуРаздела2(ДанныеСтраницы, НомерСтраницы)
	...
	Если СуммаТорговогоСбора > 0 И ДопустимыеКодыВидовДоходаДляПоказателя100.Найти(КодВидаДохода) = Неопределено Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект,
			НСтр("ru = 'Сумма налога, удержанная c доходов в виде материальной выгоды,
			|заполняется только в отношении кодов вида дохода «06» или «20»';
			|en = 'Сумма налога, удержанная c доходов в виде материальной выгоды,
			|заполняется только в отношении кодов вида дохода «06» или «20»'"),
			"Раздел2",
			"П000200001100",
	...
	ДопустимыеКодыВидовДоходаДляПоказателя120 = СтрРазделить("10,16", ",");
	...
	Если СуммаФиксированныхАвансовыхПлатежей > 0 И ДопустимыеКодыВидовДоходаДляПоказателя120.Найти(КодВидаДохода) = Неопределено Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект,
			...
			|подлежащие зачету, заполняется только в отношении кодов вида дохода «10» или «16»';
...
Процедура ЗаполнитьДаннымиУзелМногостраничногоРаздела_ДоходПредпр(Родитель, Узел)
	...
	Если РасчАвансПлат <> Неопределено Тогда
		...
		ПоказателиРазделаПриложение3Расчет = Отчеты.РегламентированныйОтчет3НДФЛ.ПолучитьПоказателиРаздела(
			УзелПриложение3.Владелец(), РасчАвансПлат.Раздел, СтруктураРеквизитовФормы.мВыбраннаяФорма);
		
		ДанныеРазделаПриложение3Расчет = мДанныеОтчета.Приложение3Расчет;
		
		Если ДанныеРазделаПриложение3Расчет.Количество() <> 0
			И ДанныеРазделаПриложение3Расчет[0].Данные.Количество() <> 0 Тогда
		
			ДанныеСтраницыПриложение3Расчет = ДанныеРазделаПриложение3Расчет[0].Данные[0].Значение;
			
			Если Не Отчеты.РегламентированныйОтчет3НДФЛ.СтраницаПуста(
				ДанныеСтраницыПриложение3Расчет, ПоказателиРазделаПриложение3Расчет, РасчАвансПлат.Многострочность) Тогда
				
				ЭкземплярУзла = СкопироватьУзел(УзелПриложение3, РасчАвансПлат);
				ЗаполнитьДаннымиУзел(ЭкземплярУзла, ДанныеСтраницыПриложение3Расчет);
				...
				ИтогиПоПриложению = ИтоговыеПоказателиПриложения3Расчет(ДанныеСтраницыПриложение3Расчет, АдресКлючейПоказателей);
...
Функция ЗаполнитьАвтоНаСервере()
	...
	Контейнер.Вставить("Приложение3Расчет", СведенияМногостраничногоРазделаВТаблице("ТаблицаСтраницыПриложение3Расчет"));
...
Функция ИтоговыеПоказателиПриложения3Расчет(ДанныеПриложения, АдресКлючейПоказателей)
	...
	Отбор = Новый Структура("ИмяСтраницы", "Приложение3Расчет");
