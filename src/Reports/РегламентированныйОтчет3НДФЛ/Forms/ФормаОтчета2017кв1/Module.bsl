...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры.мВыбраннаяФорма = "ФормаОтчета2017кв1";
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2017Кв1"; // Наименование макета с описанием состава показателей
	СтруктураРеквизитовФормы.мВерсияФормы = "31/10/2016"; // Версия формы
	...
	СтруктураРеквизитовФормы.ВариантыФорматовВыгрузки.Добавить(СтруктураРеквизитовФормы.мСоставПоказателей, "Формат 5.11", Истина);
	...
	мСтруктураМногостраничныхРазделов.Вставить("ЛистЗ",             "ТаблицаСтраницыЛистЗ");
	мСтруктураМногостраничныхРазделов.Вставить("ЛистЗПродолжение",  "ТаблицаСтраницыЛистЗПродолжение");
	мСтруктураМногостраничныхРазделов.Вставить("ЛистЗПродолжение2", "ТаблицаСтраницыЛистЗПродолжение2");
	мСтруктураМногостраничныхРазделов.Вставить("ЛистЗПродолжение3", "ТаблицаСтраницыЛистЗПродолжение3");
	мСтруктураМногостраничныхРазделов.Вставить("ЛистЗПродолжение4", "ТаблицаСтраницыЛистЗПродолжение4");
...
Процедура РазделыОтчетаПриАктивизацииСтроки(Элемент)
	...
	Если СтруктураРеквизитовФормы.ВыводитьСтраницуВТаблДокНаСервере Тогда
		...
		Если Элемент.ТекущиеДанные.РазделМногостраничный И НЕ ЗначениеЗаполнено(Элемент.ТекущиеДанные.КолонкаНомерСтраницыРазделаОтчета) Тогда
			Элемент.ТекущиеДанные.КолонкаНомерСтраницыРазделаОтчета = 1;
		КонецЕсли;
	...
	Если Элемент.ТекущиеДанные.РазделМногострочный Тогда
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если СтруктураРеквизитовФормы.мСохраненныйДок = Неопределено Тогда
		...
		Если ЗначениеЗаполнено(СтруктураРеквизитовФормы.мСкопированаФорма) Тогда // документ скопирован
...
Процедура ИнициализацияМногостраничныхРазделов()
	...
	СтрПерваяСтраница = ЭтаФорма.ТаблицаСтраницыЛистЗ.Добавить();
	СтрПерваяСтраница.Представление               = "Новая страница";
	СтрПерваяСтраница.АктивнаяСтраница            = Истина;
	СтрПерваяСтраница.АвтоматическоеПредставление = Истина;
	...
	#Область ЛистЗПродолжение
	
	СтрПерваяСтраница = ЭтаФорма.ТаблицаСтраницыЛистЗПродолжение.Добавить();
	СтрПерваяСтраница.Представление               = "Новая страница";
	СтрПерваяСтраница.АктивнаяСтраница            = Истина;
	СтрПерваяСтраница.АвтоматическоеПредставление = Истина;
	...
	#Область ЛистЗПродолжение2
	
	СтрПерваяСтраница = ЭтаФорма.ТаблицаСтраницыЛистЗПродолжение2.Добавить();
	СтрПерваяСтраница.Представление               = "Новая страница";
	СтрПерваяСтраница.АктивнаяСтраница            = Истина;
	СтрПерваяСтраница.АвтоматическоеПредставление = Истина;
	...
	#Область ЛистЗПродолжение3
	
	СтрПерваяСтраница = ЭтаФорма.ТаблицаСтраницыЛистЗПродолжение3.Добавить();
	СтрПерваяСтраница.Представление               = "Новая страница";
	СтрПерваяСтраница.АктивнаяСтраница            = Истина;
	СтрПерваяСтраница.АвтоматическоеПредставление = Истина;
	...
	#Область ЛистЗПродолжение4
	
	СтрПерваяСтраница = ЭтаФорма.ТаблицаСтраницыЛистЗПродолжение4.Добавить();
	СтрПерваяСтраница.Представление               = "Новая страница";
	СтрПерваяСтраница.АктивнаяСтраница            = Истина;
	СтрПерваяСтраница.АвтоматическоеПредставление = Истина;
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОтчетОбъект().ПолучитьМакет("Списки2017Кв1");
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000400001073", 1, , "Выбор порядка определения прибыли", КоллекцияСписковВыбора["ПорядокОпределеноияПрибыли"]);
...
#Область Пересчет_ЛистЕ1
		...
		// Пункт 3.6
		ПоказателиЛиста.П000900001180 = Макс(ПоказателиЛиста.П000900001120 + ПоказателиЛиста.П000900001170 - ПоказателиЛиста.П000900001171, 0);
		...
		Если Форма.ТабличныйДокумент.Области.Найти("П000900001080") <> Неопределено Тогда
			...
			Форма.ТабличныйДокумент.Области["П000900001171"].Значение = ПоказателиЛиста.П000900001171;
...
#Область Пересчет_ЛистЕ2
		...
		Если СтраницаИтогов <> Неопределено Тогда
			...
			Форма.СтруктураДанныхЛистЕ1.П000900001160 = ПоказателиЛиста.П001000001100;
...
#КонецОбласти
	...
	ИначеЕсли ИмяЛиста = "ЛистЗ" ИЛИ ИмяЛиста = "ЛистЗПродолжение4" Тогда
		...
		#Область Пересчет_ЛистЗИПродолжения4
		...
		Для Каждого ТаблицаСтраницыЛистЗ Из ПродолженияЛистаЗ Цикл
			...
			Для Каждого СтраницаЛистЗ Из ТаблицаСтраницыЛистЗ Цикл
				...
				Если ПоказателиЛиста.П001200001100 = "1" Тогда
					ЗаполнитьЗначенияСвойств(ОперацииСИнвестиционнымСчетом, ПоказателиЛиста);
				ИначеЕсли ПоказателиЛиста.П001200001100 = "2" Тогда
					ЗаполнитьЗначенияСвойств(ИныеОперации, ПоказателиЛиста);
				КонецЕсли;
		...
		Для Каждого ПоказателиЛистаЗ Из Форма.ТаблицаПоказателейЛистаЗ Цикл
			...
			ПоказателиЛистаЗ.П001200001114 = Макс(ПоказателиЛистаЗ.П001200001108 - ПоказателиЛистаЗ.П001200001112 - ПоказателиЛистаЗ.П001200001113, 0);
			...
			ПоказателиЛистаЗ.П001600001532 = ПоказателиЛистаЗ.П001200001111 
			...
			Если Форма.ТабличныйДокумент.Области.Найти("П001600001533") <> Неопределено
				И Форма.ТабличныйДокумент.Области["П001200001100"].Значение = ПоказателиЛистаЗ.П001200001100
				Тогда
			...
			ИначеЕсли Форма.ТабличныйДокумент.Области.Найти("П001200001114") <> Неопределено
				И Форма.ТабличныйДокумент.Области["П001200001100"].Значение = ПоказателиЛистаЗ.П001200001100 
				Тогда
				...
				Форма.ТабличныйДокумент.Области["П001200001114"].Значение = ПоказателиЛистаЗ.П001200001114;
		...
		Для Каждого ТаблицаСтраницыЛистЗ Из ПродолженияЛистаЗ Цикл
			Для Каждого СтраницаЛистЗ Из Форма.ТаблицаСтраницыЛистЗ Цикл
				...
				Если ПоказателиЛиста.П001200001100 = "1" Тогда
					ЗаполнитьЗначенияСвойств(ПоказателиЛиста, ОперацииСИнвестиционнымСчетом);
				Иначе
					ЗаполнитьЗначенияСвойств(ПоказателиЛиста, ИныеОперации);
				КонецЕсли;
...
Функция ИзвлечьСтруктуруXML()
	...
	Макет = ОтчетОбъект().ПолучитьМакет("СтруктураXML511");
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если НЕ ПроверитьРазделыНаНаличиеИнформации(ДеревоВыгрузки, "Раздел1, Раздел2") Тогда
		...
		ТекстСообщений = НСтр("ru = 'Должны быть заполнены, следующие разделы: ""Раздел 1"", ""Раздел 2"".';
								|en = 'Должны быть заполнены, следующие разделы: ""Раздел 1"", ""Раздел 2"".'");
	...
	Для Каждого Стр Из ДанныеЛистА Цикл
		...
		Если НЕ СтраницаПуста(ДанныеСтраницы, "ЛистА", ДеревоВыгрузки) Тогда
			...
			Пока ДанныеСтраницы.Свойство("П000300001030_" + НомерСтрокиВФормате) Цикл
				...
				ДлинаОКТМО = СтрДлина(СокрЛП(ДанныеСтраницы["П000300001050_" +НомерСтрокиВФормате])); //ОКТМО
				
				Если ДлинаОКТМО <> 8 И ДлинаОКТМО <> 11 И ДлинаИНН = 10 Тогда
					РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, 
						"На странице " + НомерСтраницы + " листа А в строке " + НомерСтрокиВФормате + 
						" указан ОКТМО некорректной длины!", "ЛистА", "П000300001050_" + НомерСтрокиВФормате, НомерСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
	...
	// проверка листа Е2
	ДанныеЛистЕ2 = мДанныеОтчета.ЛистЕ2;
	Для Каждого Стр Из ДанныеЛистЕ2 Цикл
		НомерСтраницы = ДанныеЛистЕ2.Индекс(Стр) + 1;
		ДанныеСтраницы = Стр.Данные[0].Значение;
		Если НЕ СтраницаПуста(ДанныеСтраницы, "ЛистЕ2", ДеревоВыгрузки) И ДанныеСтраницы.П001000001060 <> 0 Тогда
			...
			Если ДлинаИНН <> 10 Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, 
				"На странице " + НомерСтраницы + " листа Е2 указан ИНН некорректной длины!", "ЛистЕ2", "П001000001010", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			Если ДлинаКПП <> 9 Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, 
				"На странице " + НомерСтраницы + " листа Е2 указан КПП некорректной длины!", "ЛистЕ2", "П001000001020", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			Если ДлинаНомераДоговора = 0 Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, 
				"На странице " + НомерСтраницы + " листа Е2 указан номер договора некорректной длины!", "ЛистЕ2", "П001000001050", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
	...
	Для Каждого Стр Из ДанныеРаздела1 Цикл
		НомерСтраницы = ДанныеРаздела1.Индекс(Стр) + 1;
		ДанныеСтраницы = Стр.Данные[0].Значение;
			
		ДлинаОКТМО = СтрДлина(СокрЛП(ДанныеСтраницы.П000100001030)); //ОКТМО
		
		Если ДлинаОКТМО <> 8 И ДлинаОКТМО <> 11 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, 
			"На странице " + НомерСтраницы + " Раздела 1 указан ОКТМО некорректной длины!", "Раздел1", "П000100001030", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
	...
	Для Каждого ПодчиненныйУзел Из Эталон.Строки Цикл
		...
		Если ПодчиненныйУзел.Многостраничность Тогда
			...
			ИначеЕсли ПодчиненныйУзел.Код = "ВычСоцИнв219" Тогда
				...
				Эталон_РасчПенсВзнос = ПолучитьПодчиненныйЭлемент(ПодчиненныйУзел, "РасчПенсВзнос");
			...
			ИначеЕсли ПодчиненныйУзел.Код = "ДохОперЦБ" Тогда
				...
				УзелЛистаЗСПродолжениямиИИС = СкопироватьУзел(УзелРодитель, ПодчиненныйУзел);
				УзелЛистаЗСПродолжениямиИные = СкопироватьУзел(УзелРодитель, ПодчиненныйУзел);
...
Процедура ВывестиНаПечатьЛист(ПараметрыПечати, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	СоответствиеРазделовМакетам.Вставить("Титульный",         "МЧБ_2017Кв1_01_Титульный");
	СоответствиеРазделовМакетам.Вставить("Раздел1",           "МЧБ_2017Кв1_02_Раздел1");
	СоответствиеРазделовМакетам.Вставить("Раздел2",           "МЧБ_2017Кв1_03_Раздел2");
	СоответствиеРазделовМакетам.Вставить("ЛистА",             "МЧБ_2017Кв1_04_ЛистА");
	СоответствиеРазделовМакетам.Вставить("ЛистБ",             "МЧБ_2017Кв1_05_ЛистБ");
	СоответствиеРазделовМакетам.Вставить("ЛистВ",             "МЧБ_2017Кв1_06_ЛистВ");
	СоответствиеРазделовМакетам.Вставить("ЛистГ",             "МЧБ_2017Кв1_07_ЛистГ");
	СоответствиеРазделовМакетам.Вставить("ЛистД1",            "МЧБ_2017Кв1_08_ЛистД1");
	СоответствиеРазделовМакетам.Вставить("ЛистД2",            "МЧБ_2017Кв1_09_ЛистД2");
	СоответствиеРазделовМакетам.Вставить("ЛистЕ1",            "МЧБ_2017Кв1_10_ЛистЕ1");
	СоответствиеРазделовМакетам.Вставить("ЛистЕ2",            "МЧБ_2017Кв1_11_ЛистЕ2");
	СоответствиеРазделовМакетам.Вставить("ЛистЖ",             "МЧБ_2017Кв1_12_ЛистЖ");
	СоответствиеРазделовМакетам.Вставить("ЛистЗ",             "МЧБ_2017Кв1_13_ЛистЗ");
	СоответствиеРазделовМакетам.Вставить("ЛистЗПродолжение",  "МЧБ_2017Кв1_14_ЛистЗПродолжение");
	СоответствиеРазделовМакетам.Вставить("ЛистЗПродолжение2", "МЧБ_2017Кв1_15_ЛистЗПродолжение2");
	СоответствиеРазделовМакетам.Вставить("ЛистЗПродолжение3", "МЧБ_2017Кв1_17_ЛистЗПродолжение3");
	СоответствиеРазделовМакетам.Вставить("ЛистЗПродолжение4", "МЧБ_2017Кв1_17_ЛистЗПродолжение4");
	СоответствиеРазделовМакетам.Вставить("ЛистИ",             "МЧБ_2017Кв1_18_ЛистИ");
	СоответствиеРазделовМакетам.Вставить("ЛистИПродолжение",  "МЧБ_2017Кв1_19_ЛистИПродолжение");
	...
	Если ИдГруппы <> Неопределено Тогда
		...
		Если ПараметрыПечати.ИмяСтраницы = "ЛистА" Тогда
		...
		Если ТекКолвоСтрокБлока > ИсхКолвоСтрокБлока И ИсхКолвоСтрокБлока > 0 Тогда
			...
			Для каждого элЛистМЧБ Из СписокЛистовМЧБ Цикл
				...
				РегламентированнаяОтчетность.ВывестиНаПечатьЛистОбщая(ЭтаФорма.Заголовок, ПараметрыПечати, ТабличныйДокумент, СтруктураРеквизитовФормы.мПечатныеФормы);
	...
	Если ТаблицаЗначенийСДанными <> Неопределено Тогда
		...
		Если ТаблицаЗначенийСДанными.Колонки.Найти("Данные") <> Неопределено Тогда
			...
			Для Каждого СтрокаТаблицыЗначений Из ТаблицаЗначенийСДанными Цикл
				СтрокаТаблицыЗначений.Данные = ЭтаФорма[ИмяСтруктурыДанных][Ном].Данные;
				Ном = Ном + 1;
			КонецЦикла;
		КонецЕсли;
...
Процедура ОтобразитьПоясненияКПериодуОтчета(Форма)
	...
	Если ЗначениеЗаполнено(СтруктураРеквизитовФормы.Организация) И ЗначениеЗаполнено(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) Тогда
		ТекстПояснения = ТекстПоясненияРасширенныйНалоговыйПериод(СтруктураРеквизитовФормы.Организация, СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета);
	КонецЕсли;
