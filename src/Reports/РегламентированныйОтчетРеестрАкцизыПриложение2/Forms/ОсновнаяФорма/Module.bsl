...
Процедура ПоказатьПериод(Форма)
	...
	ФормаУтратилаСилу = ГодПериода >= 2017;
	...
	Иначе
		...
		НСтр("ru = 'Утратила силу с 13.01.2020. Основание: п.2 Приказа ФНС России от 24.07.2019 № ММВ-7-15/375@.';
			|en = 'Утратила силу с 13.01.2020. Основание: п.2 Приказа ФНС России от 24.07.2019 № ММВ-7-15/375@.'"),
