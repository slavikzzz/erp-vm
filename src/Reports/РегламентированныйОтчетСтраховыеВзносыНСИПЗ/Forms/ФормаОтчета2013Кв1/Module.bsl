...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "13/09/2013";
	...
	Если ДатаПодписи > '2014-06-02' Тогда
		ДатаПодписи = '2014-06-02';
	КонецЕсли;
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если Область.Имя = "ДатаПодписи" Тогда
		...
		Если ТабличныйДокумент.Области.ДатаПодписи.Значение > '2014-06-02' Тогда
			
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru = 'Представление отчета по форме приложения 1 к письму ФСС РФ от 25.01.2013 № 15-03-11/07-859 после 02.06.2014 не предусмотрено.';
									|en = 'Представление отчета по форме приложения 1 к письму ФСС РФ от 25.01.2013 № 15-03-11/07-859 после 02.06.2014 не предусмотрено.'");
			Сообщение.Сообщить();
			
			ДатаПодписи = СтруктураРеквизитовФормы.ИсходнаяДатаПодписи;
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Таблица1" Тогда
		...
		Форма.ТабличныйДокумент.Области.П000010000119.Значение = Форма.ТабличныйДокумент.Области.П000010000101.Значение
		...
		Форма.ТабличныйДокумент.Области.П000010000120.Значение = Форма.ТабличныйДокумент.Области.П000010000102.Значение
	...
	Иначе
		...
		Форма.СтруктураДанныхТаблица1.П000010000119 = Форма.СтруктураДанныхТаблица1.П000010000101
		...
		Форма.СтруктураДанныхТаблица1.П000010000120 = Форма.СтруктураДанныхТаблица1.П000010000102
