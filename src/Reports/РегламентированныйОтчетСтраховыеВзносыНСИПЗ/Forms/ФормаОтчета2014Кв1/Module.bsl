...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если Область.Имя = "ДатаПодписи" Тогда
		...
		Если ТабличныйДокумент.Области.ДатаПодписи.Значение < '2014-06-03' Тогда
			
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru = 'Представление отчета по форме приложения 1 к письму ФСС РФ от 02.06.2014 № 17-03-18/05-7094 до 03.06.2014 не предусмотрено.';
									|en = 'Представление отчета по форме приложения 1 к письму ФСС РФ от 02.06.2014 № 17-03-18/05-7094 до 03.06.2014 не предусмотрено.'");
			Сообщение.Сообщить();
