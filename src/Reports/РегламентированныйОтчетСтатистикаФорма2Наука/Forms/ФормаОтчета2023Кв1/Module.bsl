...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Области["П004001040203"].Значение = Области["П006001042313"].Значение + Области["П006001042513"].Значение;
	...
	Области["П006001041513"].Значение = 
		(Области["П006001041503"].Значение + Области["П006001041504"].Значение) - Области["П006001041511"].Значение;
	
	Области["П006001042713"].Значение = Области["П004001040303"].Значение + Области["П004001040403"].Значение;
...
Процедура УстановитьЗащитуИЦветФонаОбластейАвторассчитываемыхПоказателей()
	...
	мФормаОтчета.Области["П006001042713"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П006001042713"].Защита   = Не ОтклАвтоРасчетЗначение;
