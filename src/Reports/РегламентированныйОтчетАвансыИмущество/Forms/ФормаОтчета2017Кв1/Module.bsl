...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если ИмяПоказателя = "П000030008003_Числ" Тогда
		Если ЗначениеЗаполнено(ЗначПоказателя) И СтрНайти("0123", ЗначПоказателя) = 0 Тогда
			...
			|en = 'Введен некорректный числитель коэффициента К. Допустимы значения от 0 до 3. Значение очищено.'");
			Сообщение.Сообщить();
		КонецЕсли;
...
Процедура ПроверитьКС_1_4(СтруктураРезультата)
	...
	ОписаниеОшибки2 = НСтр("ru = 'Занижена средняя соимость имущества за отчетный период (9 месяцев)';
							|en = 'Занижена средняя соимость имущества за отчетный период (9 месяцев)'");
	Р2Ст120Гр03 = ПоказательПоСтроке("Р2Ст120Гр03");
	Р2Ст20Гр03 = ПоказательПоСтроке("Р2Ст20Гр03");
	Р2Ст30Гр03 = ПоказательПоСтроке("Р2Ст30Гр03");
	Р2Ст40Гр03 = ПоказательПоСтроке("Р2Ст40Гр03");
...
Процедура ПроверитьКС_1_8а(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Средняя стоимость необлагаемого налогом имущества за отчетный период (строка 140 Раздела 2) должна быть равна нулю, если значение строки 130 Раздела 2 равно нулю';
							|en = 'Средняя стоимость необлагаемого налогом имущества за отчетный период (строка 140 Раздела 2) должна быть равна нулю, если значение строки 130 Раздела 2 равно нулю'");
	Нарушение      = НСтр("ru = 'НК РФ ст.376 п.4';
							|en = 'НК РФ ст.376 п.4'");
...
Процедура ПроверитьКС_1_8б(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Средняя стоимость необлагаемого налогом имущества за отчетный период (строка 140 Раздела 2) должна быть отличной от нуля, если значение строки 130 Раздела 2 заполнено';
							|en = 'Средняя стоимость необлагаемого налогом имущества за отчетный период (строка 140 Раздела 2) должна быть отличной от нуля, если значение строки 130 Раздела 2 заполнено'");
	Нарушение      = НСтр("ru = 'НК РФ ст.376 п.4';
							|en = 'НК РФ ст.376 п.4'");
	ОписаниеОшибки = НСтр("ru = 'Возможно неправомерное применение льготы по налогу';
							|en = 'Возможно неправомерное применение льготы по налогу'");
...
Процедура ПроверитьКС_1_9(СтруктураРезультата)
	...
	ШаблонРасшифровки	= НСтр("ru = '%1 = 0,25 х (%2 - %3) х %4 / 100 Итог [%5]';
								|en = '%1 = 0,25 х (%2 - %3) х %4 / 100 Итог [%5]'");
...
Процедура ПроверитьКС_1_10(СтруктураРезультата)
	...
	ШаблонРасшифровки	= НСтр("ru = '%1 = 0,25 х (%2 - %3) х (%4/%5) х %6 / 100 Итог [%7]';
								|en = '%1 = 0,25 х (%2 - %3) х (%4/%5) х %6 / 100 Итог [%7]'");
	ОписаниеОшибки1	= НСтр("ru = 'Завышена сумма авансового платежа';
								|en = 'Завышена сумма авансового платежа'");
	ОписаниеОшибки2	= НСтр("ru = 'Занижена сумма авансового платежа';
								|en = 'Занижена сумма авансового платежа'");
...
Процедура ПроверитьКС_1_11(СтруктураРезультата)
	...
	Нарушение		= НСтр("ru = 'НК РФ ст.382, п. 4, ст.385.3';
							|en = 'НК РФ ст.382, п. 4, ст.385.3'");
	ШаблонРасшифровки	= НСтр("ru = '%1 = 0,25 х (%2 - %3) х %4 х %5 / 100 Итог [%6]';
								|en = '%1 = 0,25 х (%2 - %3) х %4 х %5 / 100 Итог [%6]'");
	ОписаниеОшибки1	= НСтр("ru = 'Завышена сумма авансового платежа';
								|en = 'Завышена сумма авансового платежа'");
	ОписаниеОшибки2	= НСтр("ru = 'Занижена сумма авансового платежа';
								|en = 'Занижена сумма авансового платежа'");
...
Процедура ПроверитьКС_1_12(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма льготы по авансовому платежу, уменьшающей сумму авансового платежа по налогу, подлежащую уплате в бюджет (строка 200 Раздела 2) должна быть отлична от нуля, если значение строки 190 Раздела 2 равно ""2012500""';
							|en = 'Сумма льготы по авансовому платежу, уменьшающей сумму авансового платежа по налогу, подлежащую уплате в бюджет (строка 200 Раздела 2) должна быть отлична от нуля, если значение строки 190 Раздела 2 равно ""2012500""'");
...
Процедура ПроверитьКС_1_13(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Код налоговой льготы (первая часть) строки 130 Раздела 2 не должен быть заполнен, если не заполнен код налоговой льготы (первая часть) строки 130 Раздела 2';
							|en = 'Код налоговой льготы (первая часть) строки 130 Раздела 2 не должен быть заполнен, если не заполнен код налоговой льготы (первая часть) строки 130 Раздела 2'");
	Нарушение      = НСтр("ru = 'НК РФ ст. 381; ст. 372, п. 2; ст. 346.35, п. 7';
							|en = 'НК РФ ст. 381; ст. 372, п. 2; ст. 346.35, п. 7'");
...
Процедура ПроверитьКС_1_18(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма авансового платежа по налогу (строка 090 Раздела 3) должна быть равна 1/4 (строка 020 Раздела 3 - строка 025 Раздела 3) х строка 030 Раздела 3 х строка 050 раздела 3 х строка 070 х строка 080 Раздела 3/100, если строки 030 и 080 Раздела 3 заполнены';
							|en = 'Сумма авансового платежа по налогу (строка 090 Раздела 3) должна быть равна 1/4 (строка 020 Раздела 3 - строка 025 Раздела 3) х строка 030 Раздела 3 х строка 050 раздела 3 х строка 070 х строка 080 Раздела 3/100, если строки 030 и 080 Раздела 3 заполнены'");
	Нарушение      = НСтр("ru = 'НК РФ ст.376 п.2, 3; НК РФ ст.375 п.2; НК РФ ст.378.2, НК РФ ст.382, п.5';
							|en = 'НК РФ ст.376 п.2, 3; НК РФ ст.375 п.2; НК РФ ст.378.2, НК РФ ст.382, п.5'");
	ОписаниеОшибки1 = НСтр("ru = 'Завышена сумма авансового платежа';
							|en = 'Завышена сумма авансового платежа'");
	ОписаниеОшибки2 = НСтр("ru = 'Занижена сумма авансового платежа';
							|en = 'Занижена сумма авансового платежа'");
...
Процедура ПроверитьКС_1_19(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма авансового платежа по налогу (строка 090 Раздела 3) должна быть равна 1/4 (строка 020 Раздела 3 - строка 025 Раздела 3) х строка 050 Раздела 3 х строка 070 Раздела 3 / 100, если значения в строках 030 и 080 Раздела 3 отсутствуют';
							|en = 'Сумма авансового платежа по налогу (строка 090 Раздела 3) должна быть равна 1/4 (строка 020 Раздела 3 - строка 025 Раздела 3) х строка 050 Раздела 3 х строка 070 Раздела 3 / 100, если значения в строках 030 и 080 Раздела 3 отсутствуют'");
	Нарушение      = НСтр("ru = 'НК РФ ст.376 п.2, 3; НК РФ ст.375 п.2; НК РФ ст.378.2, НК РФ ст.382, п.5';
							|en = 'НК РФ ст.376 п.2, 3; НК РФ ст.375 п.2; НК РФ ст.378.2, НК РФ ст.382, п.5'");
	ОписаниеОшибки1 = НСтр("ru = 'Завышена сумма авансового платежа';
							|en = 'Завышена сумма авансового платежа'");
...
Процедура ПроверитьКС_1_20(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма авансового платежа по налогу (строка 090 Раздела 3) должна быть равна 1/4 (строка 020 Раздела 3 - строка 025 Раздела 3) х строка 050 Раздела 3 х строка 070 Раздела 3 х строка 080 раздела 3 / 100, если - строка 080 Раздела 3 заполнена - строка 030 Раздела 3 не заполнена';
							|en = 'Сумма авансового платежа по налогу (строка 090 Раздела 3) должна быть равна 1/4 (строка 020 Раздела 3 - строка 025 Раздела 3) х строка 050 Раздела 3 х строка 070 Раздела 3 х строка 080 раздела 3 / 100, если - строка 080 Раздела 3 заполнена - строка 030 Раздела 3 не заполнена'");
	Нарушение      = НСтр("ru = 'НК РФ ст.376 п.2, 3; НК РФ ст.375 п.2; НК РФ ст.378.2, НК РФ ст.382, п.5';
							|en = 'НК РФ ст.376 п.2, 3; НК РФ ст.375 п.2; НК РФ ст.378.2, НК РФ ст.382, п.5'");
	ОписаниеОшибки1 = НСтр("ru = 'Завышена сумма авансового платежа';
							|en = 'Завышена сумма авансового платежа'");
...
Процедура ПроверитьКС_1_21(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'сумма авансового платежа (строка 090 Раздела 3) должна быть равна 1/4(строка 020 Раздела 3 - строка 025 Раздела 3) х строка 030 Раздела 3 х строка 050 Раздела 3 х строка 070 Раздела 3 / 100, если - строка 080 Раздела 3 не заполнена - строка 030 Раздела 3 заполнена';
							|en = 'сумма авансового платежа (строка 090 Раздела 3) должна быть равна 1/4(строка 020 Раздела 3 - строка 025 Раздела 3) х строка 030 Раздела 3 х строка 050 Раздела 3 х строка 070 Раздела 3 / 100, если - строка 080 Раздела 3 не заполнена - строка 030 Раздела 3 заполнена'");
	Нарушение      = НСтр("ru = 'НК РФ ст.376 п.2, 3; НК РФ ст.375 п.2; НК РФ ст.378.2, НК РФ ст.382, п.5';
							|en = 'НК РФ ст.376 п.2, 3; НК РФ ст.375 п.2; НК РФ ст.378.2, НК РФ ст.382, п.5'");
	ОписаниеОшибки1 = НСтр("ru = 'Завышена сумма авансового платежа';
							|en = 'Завышена сумма авансового платежа'");
...
Процедура ПроверитьКС_1_22(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма льготы по авансовому платежу, уменьшающая сумму авансового платежа по налогу, подлежащую уплате в бюджет (строка 110 раздела 3) должна быть отлична от нуля, если значение строки 100 Раздела 3 равно ""2012500""';
							|en = 'Сумма льготы по авансовому платежу, уменьшающая сумму авансового платежа по налогу, подлежащую уплате в бюджет (строка 110 раздела 3) должна быть отлична от нуля, если значение строки 100 Раздела 3 равно ""2012500""'");
	Нарушение      = НСтр("ru = 'НК РФ ст.372 п.2';
							|en = 'НК РФ ст.372 п.2'");
...
Процедура ПроверитьКС_1_23(СтруктураРезультата)
	...
	ОписаниеКС     = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Значение строки 014 раздела 3 не должно содержать буквы и символы %1, если строка 014 раздела 3 заполнена';
																					|en = 'Значение строки 014 раздела 3 не должно содержать буквы и символы %1, если строка 014 раздела 3 заполнена'"), СтрокаЗапрещенныхСимволов);
	...
	Для Каждого СтраницаР3 Из СтраницыРаздела3 Цикл
		...
		Если НЕ УсловиеВыполнено ИЛИ (УсловиеВыполнено И КСВыполнено) Тогда
			...
			Расшифровка = НСтр("ru = 'Строка 014 раздела 3 не содержит недопустмых символов';
								|en = 'Строка 014 раздела 3 не содержит недопустмых символов'");
		Иначе
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
			Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Строка 014 раздела 3 содержит недопустмые символы ""%1""';
																						|en = 'Строка 014 раздела 3 содержит недопустмые символы ""%1""'"), НайденныеСимволы);
		КонецЕсли;
		ДобавитьЭлементВСтруктуруОшибок(СтруктураОшибок, ТекстФормулы, ОписаниеКС, ОбщееЧислоОшибок, ОбщееЧислоБезОшибок,
			Расшифровка, ЭтоОшибка, ОписаниеОшибки, Нарушение);
		СтруктураРезультата.Вставить("КоличествоНайденныхОшибок",    ОбщееЧислоОшибок);
...
Процедура ПроверитьКС_1_24(СтруктураРезультата)
	...
	СтрокаЗапрещенныхСимволов = ". , ; "" / ! @ # $ % ^ & * () _ + | \ - ' ] [ } { ` ~ N ? < > О, З";
	ОписаниеКС     = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Значение строки 015 раздела 3 не должно содержать буквы и символы %1, если строка 015 Раздела 3 заполнена';
																					|en = 'Значение строки 015 раздела 3 не должно содержать буквы и символы %1, если строка 015 Раздела 3 заполнена'"), СтрокаЗапрещенныхСимволов);
	Нарушение      = НСтр("ru = 'НК РФ ст. 375 п. 2';
							|en = 'НК РФ ст. 375 п. 2'");
	ОписаниеОшибки = НСтр("ru = 'Возможно, неправильно указан кадастровый номер';
							|en = 'Возможно, неправильно указан кадастровый номер'");
	...
	Для Каждого СтраницаР3 Из СтраницыРаздела3 Цикл
		...
		Если НЕ УсловиеВыполнено ИЛИ (УсловиеВыполнено И КСВыполнено) Тогда
			...
			Расшифровка = НСтр("ru = 'Строка 015 раздела 3 не содержит недопустмых символов';
								|en = 'Строка 015 раздела 3 не содержит недопустмых символов'");
		Иначе
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
			Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Строка 015 раздела 3 содержит недопустмые символы ""%1""';
																						|en = 'Строка 015 раздела 3 содержит недопустмые символы ""%1""'"), НайденныеСимволы);
		КонецЕсли;
		ДобавитьЭлементВСтруктуруОшибок(СтруктураОшибок, ТекстФормулы, ОписаниеКС, ОбщееЧислоОшибок, ОбщееЧислоБезОшибок,
			Расшифровка, ЭтоОшибка, ОписаниеОшибки, Нарушение);
		СтруктураРезультата.Вставить("КоличествоНайденныхОшибок",    ОбщееЧислоОшибок);
...
Процедура ПроверитьКС_1_25(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Код налоговой льготы (вторая часть) строки 040 Раздела 3 должна быть заполнена, если код налоговой льготы (первая часть) строки 040 Раздела 3 равен ""2012000""';
							|en = 'Код налоговой льготы (вторая часть) строки 040 Раздела 3 должна быть заполнена, если код налоговой льготы (первая часть) строки 040 Раздела 3 равен ""2012000""'");
	Нарушение      = НСтр("ru = 'НК РФ ст. 381';
							|en = 'НК РФ ст. 381'");
	ОписаниеОшибки = НСтр("ru = 'Возможно, неверно указан код льготы';
							|en = 'Возможно, неверно указан код льготы'");
...
Процедура ПроверитьКС_1_26(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Код налоговой льготы (вторая часть) строки 060 Раздела 3 должна быть заполнена, если код налоговой льготы (первая часть) строки 060 Раздела 3 равен ""2012400""';
							|en = 'Код налоговой льготы (вторая часть) строки 060 Раздела 3 должна быть заполнена, если код налоговой льготы (первая часть) строки 060 Раздела 3 равен ""2012400""'");
	Нарушение      = НСтр("ru = 'НК РФ ст. 381';
							|en = 'НК РФ ст. 381'");
	ОписаниеОшибки = НСтр("ru = 'Возможно, неверно указан код льготы';
							|en = 'Возможно, неверно указан код льготы'");
...
Процедура ПроверитьКС_1_27(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Код налоговой льготы (вторая часть) строки 100 Раздела 3 должна быть заполнена, если код налоговой льготы (первая часть) строки 100 Раздела 3 равен ""2012500""';
							|en = 'Код налоговой льготы (вторая часть) строки 100 Раздела 3 должна быть заполнена, если код налоговой льготы (первая часть) строки 100 Раздела 3 равен ""2012500""'");
	Нарушение      = НСтр("ru = 'НК РФ ст. 381';
							|en = 'НК РФ ст. 381'");
	ОписаниеОшибки = НСтр("ru = 'Возможно, неверно указан код льготы';
							|en = 'Возможно, неверно указан код льготы'");
