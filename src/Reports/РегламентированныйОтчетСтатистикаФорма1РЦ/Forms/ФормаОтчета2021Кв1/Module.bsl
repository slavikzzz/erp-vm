...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Если Область.Имя = "ОргАдрес" Тогда
		РегламентированнаяОтчетностьКлиент.ОбработкаАдресаВСтатистическомОтчетеJSON(
			ЭтотОбъект, Область, СтандартнаяОбработка);
	ИначеЕсли Лев(Область.Имя, 11) = "П0000101001" Тогда
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Для Гр = 3 По 8 Цикл
		...
		Области["П0000101003" + Графа].Значение = Области["П0000101004" + Графа].Значение
			+ Области["П0000101005" + Графа].Значение;

		Области["П0000101007" + Графа].Значение = Области["П0000101003" + Графа].Значение
			- Области["П0000101006" + Графа].Значение;

		Стр15 = 0;
		Для Стр = 7 По 15 Цикл
			Стр15 = Стр15 + Области["П00001010" + Формат(Стр, "ЧЦ=2; ЧВН=") + Графа].Значение;
		КонецЦикла;
		Области["П0000101016" + Графа].Значение = Стр15;

		Области["П0000101018" + Графа].Значение = Области["П0000101016" + Графа].Значение
			+ Области["П0000101017" + Графа].Значение;

		Области["П0000101020" + Графа].Значение = Области["П0000101018" + Графа].Значение
			+ Области["П0000101019" + Графа].Значение;

		Области["П0000101022" + Графа].Значение = Области["П0000101020" + Графа].Значение
			+ Области["П0000101021" + Графа].Значение;

		Области["П0000101025" + Графа].Значение = Области["П0000101022" + Графа].Значение
			+ Области["П0000101023" + Графа].Значение
			+ Области["П0000101024" + Графа].Значение;

		Области["П0000101027" + Графа].Значение = Области["П0000101025" + Графа].Значение
...
Процедура УстановитьЗащитуИЦветФонаОбластейАвторассчитываемыхПоказателей()
	...
	Для Гр = 3 по 8 Цикл
		...
		мФормаОтчета.Области["П0000101003" + Графа].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П0000101003" + Графа].Защита   = Не ОтклАвтоРасчетЗначение;
		
		мФормаОтчета.Области["П0000101007" + Графа].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П0000101007" + Графа].Защита   = Не ОтклАвтоРасчетЗначение;
		
		мФормаОтчета.Области["П0000101016" + Графа].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П0000101016" + Графа].Защита   = Не ОтклАвтоРасчетЗначение;
		
		мФормаОтчета.Области["П0000101018" + Графа].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П0000101018" + Графа].Защита   = Не ОтклАвтоРасчетЗначение;
		
		мФормаОтчета.Области["П0000101020" + Графа].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П0000101020" + Графа].Защита   = Не ОтклАвтоРасчетЗначение;
		
		мФормаОтчета.Области["П0000101022" + Графа].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П0000101022" + Графа].Защита   = Не ОтклАвтоРасчетЗначение;
		
		мФормаОтчета.Области["П0000101025" + Графа].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П0000101025" + Графа].Защита   = Не ОтклАвтоРасчетЗначение;
		
		мФормаОтчета.Области["П0000101027" + Графа].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П0000101027" + Графа].Защита   = Не ОтклАвтоРасчетЗначение;
...
Функция ПечатьНаСервере(ВидПечати)
	...
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 1-РЦ");
