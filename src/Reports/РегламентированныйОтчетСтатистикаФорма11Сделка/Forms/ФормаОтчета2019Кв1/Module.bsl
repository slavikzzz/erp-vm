...
Процедура ДопИнициализацияВидовОсновныхФондов()
	...
	ПолеТабличногоДокументаФормаОтчета.Области["П000001000101_14"].Значение = "Транспортные средства" + Символы.НПП;
	ПолеТабличногоДокументаФормаОтчета.Области["П000001000101_18"].Значение = "Информационное, компьютерное и телекоммуника-ционное оборудование" + Символы.НПП;
	ПолеТабличногоДокументаФормаОтчета.Области["П000001000101_22"].Значение = "Прочие машины и оборудование, включая хозяйственный инвентарь, и другие объекты" + Символы.НПП;
	
	ЦФБ = Новый Цвет(255,255,255);
	Для Инд = 9 по 25 Цикл
		Обл = ПолеТабличногоДокументаФормаОтчета.Области["П000001000111_" + Инд];
		Обл.Значение = "Х";
		Обл.Защита = Истина;
		Обл.ЦветФона = ЦФБ;
	КонецЦикла;
