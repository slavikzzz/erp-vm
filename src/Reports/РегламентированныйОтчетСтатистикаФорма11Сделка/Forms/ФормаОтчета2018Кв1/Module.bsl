...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "29/06/2018";
...
Процедура ДопИнициализацияВидовОсновныхФондов()
	...
	ПолеТабличногоДокументаФормаОтчета.Области["П000001000101_28"].Значение = "Рабочий и продуктивный скот" + Символы.НПП;
	...
	ПолеТабличногоДокументаФормаОтчета.Области["П000003000101_5"].Значение  = "Разведка недр и оценка запасов полезных ископаемых, включая  произведенные поисковые активы" + Символы.НПП;
	ПолеТабличногоДокументаФормаОтчета.Области["П000003000101_9"].Значение  = "Программное обеспечение и базы данных" + Символы.НПП;
...
Процедура СформироватьСпискиВыбора()
	...
	Для НомСтр = 1 По 35 Цикл
		РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000001000103_" + Формат(НомСтр, "ЧГ="), 250, , "Выбор кода ОКОФ", КоллекцияСписковВыбора["СправочникКодовОКОФ"]);
	КонецЦикла;
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000001000110", 250, , "Выбор кода использования", КоллекцияСписковВыбора["КодыР1Гр10"]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000002000113", 250, , "Выбор кода, определяющего сторону...", КоллекцияСписковВыбора["СправочникКодовСторон"]);
