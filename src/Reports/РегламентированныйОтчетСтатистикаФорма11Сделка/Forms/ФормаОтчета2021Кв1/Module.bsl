...
Процедура СформироватьСпискиВыбора()
	...
	Для Каждого КЗ Из СпискиВыбораПоКатегориям Цикл 
		РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(
			СвойстваПоказателей, "П0000101" + КЗ.Ключ + "03", , , "Выбор", СпискиВыбораПоКатегориям[КЗ.Ключ]);
		РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(
			СвойстваПоказателей, "П0000201" + КЗ.Ключ + "03", , , "Выбор", СпискиВыбораПоКатегориям[КЗ.Ключ]);
	КонецЦикла;
	...
	Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Строки Тогда
		...
		КонецЦикла;
		Для Каждого КЗ Из СпискиВыбораПоКатегориям Цикл 
			РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "КодыР1Гр10", , , "Выбор", ТаблСписка);
		КонецЦикла;
	КонецЕсли;
	...
	Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Строки Тогда
		...
		КонецЦикла;
		Для Каждого КЗ Из СпискиВыбораПоКатегориям Цикл 
			РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "КодыР2Гр10", , , "Выбор", ТаблСписка);
		КонецЦикла;
	КонецЕсли;
КонецПроцедуры
