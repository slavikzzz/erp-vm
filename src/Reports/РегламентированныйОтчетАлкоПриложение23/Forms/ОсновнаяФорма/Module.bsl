...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.Новости") Тогда
		...
		МодульОбработкаНовостей.КонтекстныеНовости_ПриСозданииНаСервере(
			ЭтаФорма,
			"БП.Отчет.РО_АлкоПриложение23",
			"ОсновнаяФорма",
			,
			НСтр("ru = 'Новости: Декларация об объеме перевозки этилового спирта (в том числе денатурата), алкогольной и спиртосодержащей продукции';
				|en = 'Новости: Декларация об объеме перевозки этилового спирта (в том числе денатурата), алкогольной и спиртосодержащей продукции'"),
			Ложь,
