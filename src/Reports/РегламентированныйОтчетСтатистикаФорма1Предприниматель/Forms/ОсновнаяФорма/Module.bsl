...
Процедура ПоказатьПериод(Форма)
	...
	Иначе
		...
		Если Год(Форма.мДатаКонцаПериодаОтчета) >= 2016 И Год(Форма.мДатаКонцаПериодаОтчета) < 2020 Тогда
			Форма.ОписаниеНормативДок = "Форму утратила силу в соответствии с Приказом Росстата от 11.08.2016 № 414";
		ИначеЕсли Год(Форма.мДатаКонцаПериодаОтчета) >= 2021 Тогда
			Форма.ОписаниеНормативДок = "Форму утратила силу в соответствии с Приказом Росстата от 10.09.2021 N 556";
		Иначе
