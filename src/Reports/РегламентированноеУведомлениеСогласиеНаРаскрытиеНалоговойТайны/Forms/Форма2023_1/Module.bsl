	...
	Иначе
		...
		Если ТипЗнч(Данные) = Тип("Структура") И
			...
			Для Каждого Элт Из СтрРазделить("Титульная,Лист002", ",") Цикл 
				...
				ЭтотОбъект["ДанныеУведомления"].Свойство(Элт, СтраницаУведомления);
...
Процедура ПредставлениеУведомленияВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Если ЭтотОбъект["Подключена1СОтчетность"] И Область.Имя = "ИмФайлСогл" Тогда
		СтандартнаяОбработка = Ложь;
...
Процедура СформироватьДеревоСтраниц() Экспорт
	ЗначениеВРеквизитФормы(Отчеты[Объект.ИмяОтчета].ДеревоСтраниц2023(), "ДеревоСтраниц");
КонецПроцедуры
