...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	Форма.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Справка-расчет ""Пересчет отложенных налоговых активов и обязательств"" %1 %2';
			|en = 'Detailed calculation ""Recalculation of deferred tax assets and liabilities"" %1 %2'"),
