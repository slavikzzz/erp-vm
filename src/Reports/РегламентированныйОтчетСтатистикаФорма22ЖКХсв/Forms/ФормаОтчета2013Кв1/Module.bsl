...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "26/04/2013";
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если Не БезОткрытияФормы Тогда
		// В случае подачи отчета не за год, установим защиту и цвет по умолчанию
		// для таблицы "Справка" из раздела 2 и для раздела "Справочно".
		ДоступностьРазделов();
	КонецЕсли;
...
Процедура ДоступностьРазделов()
	...
	Если Не (НачалоГода(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета
		...
		Для НомСтр = 35 По 36 Цикл
			Для НомКол = 3 По 8 Цикл 
				Если НомСтр = 36 И НомКол = 3 Тогда
					Продолжить;
				КонецЕсли;
				ПолеТабличногоДокументаФормаОтчета.Области["П000002" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=")
					+ Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].ЦветФона = Новый Цвет();
				ПолеТабличногоДокументаФормаОтчета.Области["П000002" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=")
					+ Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Защита = Истина;
			КонецЦикла;
		КонецЦикла;
		Для НомСтр = 59 По 64 Цикл
			Для НомКол = 3 По 5 Цикл 
				Если (НомСтр <> 60 И НомКол = 4) Или (НомСтр = 60 И НомКол = 5) Тогда
					Продолжить;
				КонецЕсли;
				ПолеТабличногоДокументаФормаОтчета.Области["П000004" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=")
					+ Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].ЦветФона = Новый Цвет();
				ПолеТабличногоДокументаФормаОтчета.Области["П000004" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=")
					+ Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Защита = Истина;
			КонецЦикла;
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Для НомКол = 4 По 11 Цикл
		Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000020017" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение =
			  Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000020018" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
			+ Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000020019" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
			+ Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000020020" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение;
	КонецЦикла;
	Для НомКол = 3 По 11 Цикл
		Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000020010" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение =
			  Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000020011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
			+ Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000020017" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение;
	КонецЦикла;
	// По разделу 3.
	Для НомКол = 3 По 9 Цикл
		Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030037" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение =
			  Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030038" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
			+ Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030039" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение;
	КонецЦикла;
	Для НомКол = 3 По 9 Цикл
		Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030044" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение =
			  Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030045" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
			+ Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030046" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
			+ Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030047" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
			+ Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030048" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
			+ Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030049" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
			+ Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030052" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
			+ Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030053" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
			+ Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030055" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
			+ Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030056" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение;
	КонецЦикла;
	Для НомКол = 3 По 9 Цикл
		Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030057" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение =
			  Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030037" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение
			+ Форма.ПолеТабличногоДокументаФормаОтчета.Области["П0000030044" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")].Значение;
	КонецЦикла;
	Для НомСтр = 37 По 57 Цикл
		Форма.ПолеТабличногоДокументаФормаОтчета.Области["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "09"].Значение =
			  Форма.ПолеТабличногоДокументаФормаОтчета.Области["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "04"].Значение
			+ Форма.ПолеТабличногоДокументаФормаОтчета.Области["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "05"].Значение
			+ ?(НомСтр <> 43, Форма.ПолеТабличногоДокументаФормаОтчета.Области["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "06"].Значение, 0);
	КонецЦикла;
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	// КОНТРОЛЬ показателей формы (Указания по заполнению Формы 22-ЖКХ (сводная)).
	// По разделу 1.
	// Стр.01 ≥ стр.02+стр.03 по всем графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000010001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< (ПараметрыВыгрузки["П0000010002" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010003" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.01 ≥ стр.02+стр.03 по всем графам!",
	...
	КонецЦикла;
	// По разделу 2.
	// Стр.05 по всем графам ≥ стр.06 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020005" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.05 по всем графам ≥ стр.06 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000020005" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.06 по всем графам ≥ стр.07+стр.08 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< (ПараметрыВыгрузки["П0000020007" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] 
			+ ПараметрыВыгрузки["П0000020008" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.06 по всем графам ≥ стр.07+стр.08 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000020006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.06 по всем графам ≥ стр.07 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020007" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.06 по всем графам ≥ стр.07 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000020006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.06 по всем графам ≥ стр.08 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020008" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.06 по всем графам ≥ стр.08 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000020006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.06 по всем графам > стр.21 по соотв. графам, если стр.21 > 0.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020021" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] > 0 Тогда// если стр.21 > 0
			Если ПараметрыВыгрузки["П0000020006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
				<= ПараметрыВыгрузки["П0000020021" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.06 по всем графам > стр.21 по соотв. графам, если стр.21 > 0!",
				ИмяПоляТаблДокумента, "П0000020006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
				СтатусПроверки = Ложь;
				Прервать;
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
	// Стр.09 по всем графам ≥ стр.10 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020009" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020010" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.09 по всем графам ≥ стр.10 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000020009" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.10 по всем графам = стр.11+стр.17 по всем графам - обеспечивается расчетом.
	// Стр.10 по всем графам ≥ стр.11 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020010" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.10 по всем графам ≥ стр.11 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000020010" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.10 по всем графам ≥ стр.17 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020010" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020017" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.10 по всем графам ≥ стр.17 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000020010" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.11 по графе 3 ≥ стр.14+стр.15+стр.16 по графе 3.
	Если ПараметрыВыгрузки["П000002001103_Ч"] < (ПараметрыВыгрузки["П000002001403_Ч"]
		+ ПараметрыВыгрузки["П000002001503_Ч"] + ПараметрыВыгрузки["П000002001603_Ч"]) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: стр.11 по графе 3 ≥ стр.14+стр.15+стр.16 по графе 3!",
			ИмяПоляТаблДокумента, "П000002001103");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// Стр.11 по графам 4-11 ≥ стр.12+стр.13+стр.14+стр.15+стр.16 по графам 4-11.
	Для НомКол = 4 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< (ПараметрыВыгрузки["П0000020012" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000020013" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000020014" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000020015" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000020016" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.11 по графам 4-11 ≥ стр.12+стр.13+стр.14+стр.15+стр.16 по графам 4-11!",
				ИмяПоляТаблДокумента, "П0000020011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.11 по графам 4-11 ≥ стр.12 по графам 4-11.
	Для НомКол = 4 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020012" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.11 по графам 4-11 ≥ стр.12 по графам 4-11!",
				ИмяПоляТаблДокумента, "П0000020011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.11 по графам 4-11 ≥ стр.13 по графам 4-11.
	Для НомКол = 4 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020013" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.11 по графам 4-11 ≥ стр.13 по графам 4-11!",
				ИмяПоляТаблДокумента, "П0000020011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.11 по графам 4-11 ≥ стр.14 по графам 4-11.
	Для НомКол = 4 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020014" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.11 по графам 4-11 ≥ стр.14 по графам 4-11!",
				ИмяПоляТаблДокумента, "П0000020011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.11 по графам 4-11 ≥ стр.15 по графам 4-11.
	Для НомКол = 4 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020015" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.11 по графам 4-11 ≥ стр.15 по графам 4-11!",
				ИмяПоляТаблДокумента, "П0000020011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.11 по графам 4-11 ≥ стр.16 по графам 4-11.
	Для НомКол = 4 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020016" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.11 по графам 4-11 ≥ стр.16 по графам 4-11!",
				ИмяПоляТаблДокумента, "П0000020011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.17 по графе 3 ≥ стр.20 по графе 3.
	Если ПараметрыВыгрузки["П000002001703_Ч"] < ПараметрыВыгрузки["П000002002003_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: стр.17 по графе 3 ≥ стр.20 по графе 3!",
			ИмяПоляТаблДокумента, "П000002001703");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// Стр.17 по графам 4-11 ≥ стр.18 по соответствующим графам.
	Для НомКол = 4 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020017" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020018" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.17 по графам 4-11 ≥ стр.18 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000020017" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.17 по графам 4-11 ≥ стр.19 по соответствующим графам.
	Для НомКол = 4 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020017" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020019" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.17 по графам 4-11 ≥ стр.19 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000020017" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.17 по графам 4-11 ≥ стр.20 по соответствующим графам - обеспечивается расчетом.
	Для НомКол = 4 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020017" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020020" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.17 по графам 4-11 ≥ стр.20 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000020017" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.21 по графам 3-9 ≥ стр.22 + стр.23 + стр.24 по соответствующим графам + гр.5, 6 раздела 3
	// по соответствующим строкам (в разделе 2 графе 3 соответствует строка 37 раздела 3,
	// графе 4 - строка 45, графе 5 - строка 46, графе 6 - строки 47, 48, 55, 56,
	// графе 7 - строка 49, графе 8 - строка 52, графе 9 - строка 53).
	Если ПараметрыВыгрузки["П000002002103_Ч"] < (ПараметрыВыгрузки["П000002002203_Ч"] + ПараметрыВыгрузки["П000002002303_Ч"]
		+ ПараметрыВыгрузки["П000002002403_Ч"] + ПараметрыВыгрузки["П000003003705_Ч"] + ПараметрыВыгрузки["П000003003706_Ч"])
		Или ПараметрыВыгрузки["П000002002104_Ч"] < (ПараметрыВыгрузки["П000002002204_Ч"] + ПараметрыВыгрузки["П000002002304_Ч"]
		+ ПараметрыВыгрузки["П000002002404_Ч"] + ПараметрыВыгрузки["П000003004505_Ч"] + ПараметрыВыгрузки["П000003004506_Ч"])
		Или ПараметрыВыгрузки["П000002002105_Ч"] < (ПараметрыВыгрузки["П000002002205_Ч"] + ПараметрыВыгрузки["П000002002305_Ч"]
		+ ПараметрыВыгрузки["П000002002405_Ч"] + ПараметрыВыгрузки["П000003004605_Ч"] + ПараметрыВыгрузки["П000003004606_Ч"])
		Или ПараметрыВыгрузки["П000002002106_Ч"] < (ПараметрыВыгрузки["П000002002206_Ч"] + ПараметрыВыгрузки["П000002002306_Ч"]
		+ ПараметрыВыгрузки["П000002002406_Ч"] + ПараметрыВыгрузки["П000003004705_Ч"] + ПараметрыВыгрузки["П000003004706_Ч"]
		+ ПараметрыВыгрузки["П000003004805_Ч"] + ПараметрыВыгрузки["П000003004806_Ч"] + ПараметрыВыгрузки["П000003005505_Ч"]
		+ ПараметрыВыгрузки["П000003005506_Ч"] + ПараметрыВыгрузки["П000003005605_Ч"] + ПараметрыВыгрузки["П000003005606_Ч"])
		Или ПараметрыВыгрузки["П000002002107_Ч"] < (ПараметрыВыгрузки["П000002002207_Ч"] + ПараметрыВыгрузки["П000002002307_Ч"]
		+ ПараметрыВыгрузки["П000002002407_Ч"] + ПараметрыВыгрузки["П000003004905_Ч"] + ПараметрыВыгрузки["П000003004906_Ч"])
		Или ПараметрыВыгрузки["П000002002108_Ч"] < (ПараметрыВыгрузки["П000002002208_Ч"] + ПараметрыВыгрузки["П000002002308_Ч"]
		+ ПараметрыВыгрузки["П000002002408_Ч"] + ПараметрыВыгрузки["П000003005205_Ч"] + ПараметрыВыгрузки["П000003005206_Ч"])
		Или ПараметрыВыгрузки["П000002002109_Ч"] < (ПараметрыВыгрузки["П000002002209_Ч"] + ПараметрыВыгрузки["П000002002309_Ч"]
		+ ПараметрыВыгрузки["П000002002409_Ч"] + ПараметрыВыгрузки["П000003005305_Ч"] + ПараметрыВыгрузки["П000003005306_Ч"]) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не выполнено условие контроля:"
			+ " стр.21 по графам 3-9 ≥ стр.22 + стр.23 + стр.24 по соответствующим графам + гр.5, 6 раздела 3"
			+ " по соответствующим строкам (в разделе 2 графе 3 соответствует строка 37 раздела 3,"
			+ " графе 4 - строка 45, графе 5 - строка 46, графе 6 - строки 47, 48, 55, 56,"
			+ " графе 7 - строка 49, графе 8 - строка 52, графе 9 - строка 53)!",
			ИмяПоляТаблДокумента, "П000002002103");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// Стр.21 по всем графам ≥ стр.22 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020021" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020022" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.21 по всем графам ≥ стр.22 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000020021" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.21 по всем графам ≥ стр.23 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020021" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020023" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.21 по всем графам ≥ стр.23 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000020021" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.21 по всем графам ≥ стр.24 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000020021" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000020024" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.21 по всем графам ≥ стр.24 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000020021" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.21 по всем графам ≥ гр.5 раздела 3 по соответствующим строкам.
	Если ПараметрыВыгрузки["П000002002103_Ч"] < ПараметрыВыгрузки["П000003003705_Ч"]
		Или ПараметрыВыгрузки["П000002002104_Ч"] < ПараметрыВыгрузки["П000003004505_Ч"]
		Или ПараметрыВыгрузки["П000002002105_Ч"] < ПараметрыВыгрузки["П000003004605_Ч"]
		Или ПараметрыВыгрузки["П000002002106_Ч"] < (ПараметрыВыгрузки["П000003004705_Ч"]
		+ ПараметрыВыгрузки["П000003004805_Ч"] + ПараметрыВыгрузки["П000003005505_Ч"] + ПараметрыВыгрузки["П000003005605_Ч"])
		Или ПараметрыВыгрузки["П000002002107_Ч"] < ПараметрыВыгрузки["П000003004905_Ч"]
		Или ПараметрыВыгрузки["П000002002108_Ч"] < ПараметрыВыгрузки["П000003005205_Ч"]
		Или ПараметрыВыгрузки["П000002002109_Ч"] < ПараметрыВыгрузки["П000003005305_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: стр.21 по всем графам ≥ гр.5 раздела 3 по соответствующим строкам!",
			ИмяПоляТаблДокумента, "П000002002103");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// Стр.21 по всем графам ≥ гр.6 раздела 3 по соответствующим строкам.
	Если ПараметрыВыгрузки["П000002002103_Ч"] < ПараметрыВыгрузки["П000003003706_Ч"]
		Или ПараметрыВыгрузки["П000002002104_Ч"] < ПараметрыВыгрузки["П000003004506_Ч"] 
		Или ПараметрыВыгрузки["П000002002105_Ч"] < ПараметрыВыгрузки["П000003004606_Ч"]
		Или ПараметрыВыгрузки["П000002002106_Ч"] < (ПараметрыВыгрузки["П000003004706_Ч"]
		+ ПараметрыВыгрузки["П000003004806_Ч"] + ПараметрыВыгрузки["П000003005506_Ч"] + ПараметрыВыгрузки["П000003005606_Ч"])
		Или ПараметрыВыгрузки["П000002002107_Ч"] < ПараметрыВыгрузки["П000003004906_Ч"]
		Или ПараметрыВыгрузки["П000002002108_Ч"] < ПараметрыВыгрузки["П000003005206_Ч"]
		Или ПараметрыВыгрузки["П000002002109_Ч"] < ПараметрыВыгрузки["П000003005306_Ч"] Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: стр.21 по всем графам ≥ гр.6 раздела 3 по соответствующим строкам!",
			ИмяПоляТаблДокумента, "П000002002103");
		СтатусПроверки = Ложь;
	КонецЕсли;
	// По разделу 3.
	// Стр.37 по графам 3-9 = стр.38 +стр.39 по соответствующим графам - обеспечивается расчетом.
	// Стр.39 по графам 3-9 ≥ стр.40+ стр.41+стр.42+стр.43 по соответствующим графам.
	Для НомКол = 3 По 9 Цикл
		Если НомКол = 6 Тогда
			Если ПараметрыВыгрузки["П0000030039" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
				< (ПараметрыВыгрузки["П0000030040" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
				+ ПараметрыВыгрузки["П0000030041" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
				+ ПараметрыВыгрузки["П0000030042" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"Не выполнено условие контроля: стр.39 по графам 3-9 ≥ стр.40+ стр.41+стр.42+стр.43 по соответствующим графам!",
					ИмяПоляТаблДокумента, "П0000030039" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
				СтатусПроверки = Ложь;
				Прервать;
			КонецЕсли;
		Иначе	
			Если ПараметрыВыгрузки["П0000030039" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
				< (ПараметрыВыгрузки["П0000030040" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
				+ ПараметрыВыгрузки["П0000030041" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
				+ ПараметрыВыгрузки["П0000030042" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
				+ ПараметрыВыгрузки["П0000030043" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"Не выполнено условие контроля: стр.39 по графам 3-9 ≥ стр.40+ стр.41+стр.42+стр.43 по соответствующим графам!",
					ИмяПоляТаблДокумента, "П0000030039" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
				СтатусПроверки = Ложь;
		...
		КонецЕсли;
	КонецЦикла;
	// Стр.39 по всем графам ≥ стр.40 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000030039" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000030040" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.39 по всем графам ≥ стр.40 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000030039" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.39 по всем графам ≥ стр.41 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000030039" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000030041" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.39 по всем графам ≥ стр.41 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000030039" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.39 по всем графам ≥ стр.42 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000030039" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000030042" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.39 по всем графам ≥ стр.42 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000030039" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.39 по всем графам ≥ стр.43 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если НомКол = 6 Тогда
			Продолжить;
		КонецЕсли;
		Если ПараметрыВыгрузки["П0000030039" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000030043" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.39 по всем графам ≥ стр.43 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000030039" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.44 по графам 3-9 = Сумма(стр.:45-49)+стр.52+стр.53+стр.55+стр.56
	// по соответствующим графам - обеспечивается расчетом.
	// Стр.57 по графам 3-9 = стр.37+стр.44 по соответствующим графам - обеспечивается расчетом.
	// Стр.49 по всем графам ≥ стр.50+стр.51 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000030049" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< (ПараметрыВыгрузки["П0000030050" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000030051" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.49 по всем графам ≥ стр.50+стр.51 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000030049" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.49 по всем графам ≥ стр.50 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000030049" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000030050" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.49 по всем графам ≥ стр.50 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000030049" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.49 по всем графам ≥ стр.51 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000030049" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000030051" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.49 по всем графам ≥ стр.51 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000030049" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Стр.53 по всем графам ≥ стр.54 по соответствующим графам.
	Для НомКол = 3 По 11 Цикл
		Если ПараметрыВыгрузки["П0000030053" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000030054" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: стр.53 по всем графам ≥ стр.54 по соответствующим графам!",
				ИмяПоляТаблДокумента, "П0000030053" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Гр.7 по всем строкам ≥ гр.8 по всем строкам.
	Для НомСтр = 37 По 57 Цикл
		Если ПараметрыВыгрузки["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "07_Ч"]
			< ПараметрыВыгрузки["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "08_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: гр.7 по всем строкам раздела 3 ≥ гр.8 по всем строкам раздела 3!",
				ИмяПоляТаблДокумента, "П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "07");
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Гр.7 по всем строкам ≥ гр.3 по всем строкам.
	Для НомСтр = 37 По 57 Цикл
		Если ПараметрыВыгрузки["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "07_Ч"]
			< ПараметрыВыгрузки["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "03_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: гр.7 по всем строкам раздела 3 ≥ гр.3 по всем строкам раздела 3!",
				ИмяПоляТаблДокумента, "П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "07");
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// Гр.8 по всем строкам ≥ гр.3 по всем строкам.
	Для НомСтр = 37 По 57 Цикл
		Если ПараметрыВыгрузки["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "08_Ч"]
			< ПараметрыВыгрузки["П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "03_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Не выполнено условие контроля: гр.8 по всем строкам раздела 3 ≥ гр.3 по всем строкам раздела 3!",
				ИмяПоляТаблДокумента, "П000003" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "08");
			СтатусПроверки = Ложь;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	// 18 ≤ стр.58 ≤ 40.
	Если ПараметрыВыгрузки["П000003005801_Ч"] < 18 Или ПараметрыВыгрузки["П000003005801_Ч"] > 40 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: 18 ≤ стр.58 ≤ 40!",
			ИмяПоляТаблДокумента, "П000003005801");
		СтатусПроверки = Ложь;
	КонецЕсли;
...
Функция СформироватьСтруктуруПараметров()
	...
	// Для ПОСЛЕДУЮЩЕГО (ПЕРЕД ВЫГРУЗКОЙ) контроля показателей формы (Указания ФСН по заполнению Формы 22-ЖКХ (сводная)).
	// По разделу 1.
	...
	КонецЦикла;
	// По разделу 2.
	Для НомСтр = 5 По 34 Цикл
		НомКол = 3;
		Если НомСтр = 12 Или НомСтр = 13 Или НомСтр = 18 Или НомСтр = 19 Тогда
			НомКол = 4;
		КонецЕсли;
		Пока РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(ТабДокумент, "П000002" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=")) Цикл
	...
	Для НомСтр = 37 По 57 Цикл
		...
		КонецЦикла;
	КонецЦикла;
	ПараметрыВыгрузки.Вставить("П000003004307_Ч", ТабДокумент["П000003004307"]);
	ПараметрыВыгрузки.Вставить("П000003004308_Ч", ТабДокумент["П000003004308"]);
	ПараметрыВыгрузки.Вставить("П000003004309_Ч", ТабДокумент["П000003004309"]);
	ПараметрыВыгрузки.Вставить("П000003004310_Ч", ТабДокумент["П000003004310"]);
	ПараметрыВыгрузки.Вставить("П000003004311_Ч", ТабДокумент["П000003004311"]);
	ПараметрыВыгрузки.Вставить("П000003005801_Ч", ТабДокумент["П000003005801"]);
	Для НомСтр = 59 По 64 Цикл
		Если РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(ТабДокумент, "П000004" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "03") Тогда
			ПараметрыВыгрузки.Вставить("П000004" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "03_Ч",
			ТабДокумент["П000004" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "03"]);
		КонецЕсли;
	КонецЦикла;
	ПараметрыВыгрузки.Вставить("П000004006004_Ч", ТабДокумент["П000004006004"]);
	Для НомСтр = 59 По 64 Цикл
		Если НомСтр = 60 Тогда
			Продолжить;
		КонецЕсли;
		Если РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(ТабДокумент, "П000004" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "05") Тогда
			ПараметрыВыгрузки.Вставить("П000004" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "05_Ч",
			ТабДокумент["П000004" + Формат(НомСтр, "ЧЦ=4; ЧВН=; ЧГ=") + "05"]);
		КонецЕсли;
	КонецЦикла;
