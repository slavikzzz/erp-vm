...
Процедура ВставитьДополнительнуюСтраницуВДругойРазделНаСервере(Форма, ИмяСтраницыПанели = Неопределено)
	...
	ТабличныйДокумент.Очистить();
	ТабличныйДокумент.Вывести(Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет(Сред(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, "ФормаОтчета")) + "_" + ИмяСтраницыПанели));
...
Процедура ЗаполнитьСведенияОбОрганизации(ВПрограммеИзмененаДатаПодписи = Ложь)
	...
	Если НЕ ВПрограммеИзмененаДатаПодписи Тогда
		...
		ЗаполнитьОКАТО(СведенияОбОрганизации.ОКАТО);
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	СоответствиеРазделовМакетам.Вставить("Титульный",   "МЧБ_2011кв2_01_Титульный");
	СоответствиеРазделовМакетам.Вставить("Раздел1",     "МЧБ_2011кв2_02_Раздел1");
	СоответствиеРазделовМакетам.Вставить("Раздел12",    "МЧБ_2011кв2_03_Раздел12");
	СоответствиеРазделовМакетам.Вставить("Раздел13",    "МЧБ_2011кв2_04_Раздел13");
	СоответствиеРазделовМакетам.Вставить("Раздел2",     "МЧБ_2011кв2_05_Раздел2");
	СоответствиеРазделовМакетам.Вставить("Раздел24",    "МЧБ_2011кв2_06_Раздел24");
	СоответствиеРазделовМакетам.Вставить("Раздел25",    "МЧБ_2011кв2_07_Раздел25");
	СоответствиеРазделовМакетам.Вставить("Приложение1", "МЧБ_2011кв2_08_Приложение1");
	СоответствиеРазделовМакетам.Вставить("Приложение2", "МЧБ_2011кв2_09_Приложение2");
	СоответствиеРазделовМакетам.Вставить("Приложение3", "МЧБ_2011кв2_10_Приложение3");
	СоответствиеРазделовМакетам.Вставить("Приложение4", "МЧБ_2011кв2_11_Приложение4");
	СоответствиеРазделовМакетам.Вставить("Приложение5", "МЧБ_2011кв2_12_Приложение5");
	СоответствиеРазделовМакетам.Вставить("Приложение6", "МЧБ_2011кв2_13_Приложение6");
	СоответствиеРазделовМакетам.Вставить("Приложение7", "МЧБ_2011кв2_14_Приложение7");
...
Процедура СформироватьСпискиВыбора()
	...
	Если ДатаПодписи >= '2013-05-21' Тогда	
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "КодНаличияСвидетельства1", 1, , "Выбор кода наличия свидетельства", КоллекцияСписковВыбора["КодНаличияСвидетельства"]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000120002020", 20, , "Выбор КБК", КоллекцияСписковВыбора[ИмяКоллекцииВыбораКБК]);
	...
	// Раздел 2.
	Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '2013-03-01' Тогда
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000210001001", 5, , "Выбор кода показателя", КоллекцияСписковВыбора["КодПоказателя21"]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000220001001", 5, , "Выбор кода показателя", КоллекцияСписковВыбора["КодПоказателя22"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000220002001", 5, , "Выбор кода показателя", КоллекцияСписковВыбора["КодПоказателя22"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000220003001", 5, , "Выбор кода показателя", КоллекцияСписковВыбора["КодПоказателя22"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000220004001", 5, , "Выбор кода показателя", КоллекцияСписковВыбора["КодПоказателя22"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000220005001", 5, , "Выбор кода показателя", КоллекцияСписковВыбора["КодПоказателя22"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000220006001", 5, , "Выбор кода показателя", КоллекцияСписковВыбора["КодПоказателя22"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000220007001", 5, , "Выбор кода показателя", КоллекцияСписковВыбора["КодПоказателя22"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000220008001", 5, , "Выбор кода показателя", КоллекцияСписковВыбора["КодПоказателя22"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000220009001", 5, , "Выбор кода показателя", КоллекцияСписковВыбора["КодПоказателя22"]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000900000001", 5, , "Выбор кода показателя", КоллекцияСписковВыбора["КодПоказателяП1"]);
...
&НаСервере
Процедура ЗаполнитьОКАТО(Знач ОКАТО)
	...
	ПроставитьНаВсехЛистах(ЭтаФорма, ОКАТО);
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("НомКорр",		Строка(НомерКорректировки));
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если ПустаяСтрока(ПараметрыВыгрузки.НалСвид) Тогда
		СообщитьВТС("На титульном листе не задан код наличия свидетельства у налогоплательщика!", "Титульный", "КодНаличияСвидетельства1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Если ПараметрыВыгрузки.ЭтоПБОЮЛ тогда
		...
		Если ПустаяСтрока(ПараметрыВыгрузки.ФамилияИП) Тогда
			СообщитьВТС("На титульном листе не заполнено или некорректно указано наименование налогоплательщика!", "Титульный", "НаимОрг");
			СтатусПроверки = Ложь;
		КонецЕсли;	
	...
	Иначе //юр. лицо
		...
		Если ПустаяСтрока(ПараметрыВыгрузки.НаимОрг) Тогда
			СообщитьВТС("На титульном листе не задано наименование организации-налогоплательщика!", "Титульный", "НаимОрг");
			СтатусПроверки = Ложь;
		КонецЕсли;	
	...
	Для Каждого Стр Из Раздел1 Цикл
		...
		Если КодОКАТОРаздел1 <> 11 Тогда
			СообщитьВТС("В разделе 1.1 на странице " + НомерСтраницы + " не" + ?(КодОКАТОРаздел1  = 0, "", "верно") + " задан код ОКАТО!", "Раздел1", "П000110001003", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Пока ДанныеСтраницы.Свойство("П000110002020_" + Формат(НомерСтроки, "ЧГ=")) Цикл
			...
			Если СуммаКУплатеРаздел1МнчКод <> "0" И СуммаКУменьшениюРаздел1МнчКод <> "0" Тогда
				СообщитьВТС("В разделе 1 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " должно быть указано только одно значение суммы акциза из двух!", "Раздел1", "П000110002030_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			КБКРаздел1МнчКод = СтрДлина(КБКРаздел1МнчКод);
			Если КБКРаздел1МнчКод <> 20 Тогда
				СообщитьВТС("В разделе 1 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(КБКРаздел1МнчКод = 0, "", "верно") + " задан код КБК!", "Раздел1", "П000110002020_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		...
		Если НЕ ЗаполненаХотяБыОднастрокаТаблЧастиРаздела1 Тогда
			СообщитьВТС("В разделе 1.1 на странице " + НомерСтраницы + " не заполнена ни одна строка табличной части!", "Раздел1", "П000110002020_1", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
	...
	Для Каждого Стр Из Раздел12 Цикл
		...
		Если КодОКАТОРаздел12 <> 11 Тогда
			СообщитьВТС("В разделе 1.2 на странице " + НомерСтраницы + " не" + ?(КодОКАТОРаздел12  = 0, "", "верно") + " задан код ОКАТО!", "Раздел12", "П000120001003", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Пока ДанныеСтраницы.Свойство("П000120002020_" + Формат(НомерСтроки, "ЧГ=")) Цикл
			...
			Если СуммаКУплатеРаздел12МнчКод <> "0" И СуммаКУменьшениюРаздел12МнчКод <> "0" Тогда
				СообщитьВТС("В разделе 1.2 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " должно быть указано только одно значение суммы акциза из двух!", "Раздел12", "П000120002030_" + НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			КБКРаздел12МнчКод = СтрДлина(КБКРаздел12МнчКод);
			Если КБКРаздел12МнчКод <> 20 Тогда
				СообщитьВТС("В разделе 1.2 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(КБКРаздел12МнчКод = 0, "", "верно") + " задан код КБК!", "Раздел12", "П000120002020_" + НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		...
		Если НЕ ЗаполненаХотяБыОднастрокаТаблЧастиРаздела12 Тогда
			СообщитьВТС("В разделе 1.2 на странице " + НомерСтраницы + " не заполнена ни одна строка табличной части!", "Раздел12", "П000120002020_1", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
	...
	Для Каждого Стр Из Раздел13 Цикл
		...
		Если КодОКАТОРаздел13 <> 11 Тогда
			СообщитьВТС("В разделе 1.3 на странице " + НомерСтраницы + " не" + ?(КодОКАТОРаздел13  = 0, "", "верно") + " задан код ОКАТО!", "Раздел13", "П000130001003", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Пока ДанныеСтраницы.Свойство("П000130002020_" + Формат(НомерСтроки, "ЧГ=")) Цикл
			...
			Если КБКРаздел13МнчКод <> 20 Тогда
				СообщитьВТС("В разделе 1.3 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(КБКРаздел13МнчКод = 0, "", "верно") + " задан код КБК!", "Раздел13", "П000130002020_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		...
		Если НЕ ЗаполненаХотяБыОднастрокаТаблЧастиРаздела13 Тогда
			СообщитьВТС("В разделе 1.3 на странице " + НомерСтраницы + " не заполнена ни одна строка табличной части!", "Раздел13", "П000130002020_1", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
	...
	Если НЕ ЗаполненХотяБыОдинЭкземплярРаздела1 И НЕ ЗаполненХотяБыОдинЭкземплярРаздела12 И Не ЗаполненХотяБыОдинЭкземплярРаздела13 Тогда 
		СообщитьВТС("Раздел 1 обязателен к заполнению. Нужно заполнить хотя бы один из его подразделов!", "Раздел1", "П000110001003");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Для Каждого Стр Из Раздел2 Цикл
		...
		Если КодПТРаздел2 <> 3 Тогда
			СообщитьВТС("В разделе 2 на странице " + НомерСтраницы + " не" + ?(КодПТРаздел2  = 0, "", "верно") + " задан код вида подакцизного товара!", "Раздел2", "П000200001000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если КодОКЕИРаздел2 <> 3 Тогда
			СообщитьВТС("В разделе 2 на странице " + НомерСтраницы + " не" + ?(КодОКЕИРаздел2  = 0, "", "верно") + " задан код единицы измерения по ОКЕИ!", "Раздел2", "П000200002000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Пока ДанныеСтраницы.Свойство("П000210001001_" + Формат(НомерСтроки, "ЧГ=")) Цикл
			...
			Если КПРаздел21МнчКод <> 5 Тогда
				СообщитьВТС("В разделе 2.1 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(КПРаздел21МнчКод = 0, "", "верно") + " задан код показателя!", "Раздел2", "П000210001001_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		...
		Если НЕ ЗаполненаХотяБыОднастрокаТаблЧастиРаздела21 Тогда
			СообщитьВТС("В разделе 2.1 на странице " + НомерСтраницы + " не заполнена ни одна строка табличной части!", "Раздел2", "П000210001001_1", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Для Сч = 1 по 9 Цикл 
			...
			Если КПРаздел22МнчКод <> 5 Тогда
				СообщитьВТС("В разделе 2.2 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(КПРаздел22МнчКод = 0, "", "верно") + " задан код показателя!", "Раздел2", "П00022000"+сч+"001", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		КонецЦикла;
	...
	Если НЕ ЗаполненХотяБыОдинЭкземплярРаздела2 Тогда 	
		СообщитьВТС("Обязательно должен быть заполнен хотя бы один экземпляр раздела 2!", "Раздел2", "П000200001000");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Для Каждого Стр Из Раздел24 Цикл
		...
		Пока ДанныеСтраницы.Свойство("П000240001001_" + Формат(НомерСтроки, "ЧГ=")) Цикл
			...
			Если КПРаздел24МнчКод <> 5 Тогда
				СообщитьВТС("В разделе 2.4 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(КПРаздел24МнчКод = 0, "", "верно") + " задан код показателя!", "Раздел2", "П000240001001_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			...
			Если КодНалПериодаРаздел24МнчКод <> 2 И КодНалПериодаРаздел24МнчКод <> 0 Тогда
				СообщитьВТС("В разделе 2.4 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " неверно задан код налогового периода!", "Раздел2", "П000240001004_"+НомерСтроки , НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
	...
	Для Каждого Стр Из Прил1 Цикл
		...
		Если КодПТРазделПрил1 <> 3 Тогда
			СообщитьВТС("В Приложении №1 на странице " + НомерСтраницы + " не" + ?(КодПТРазделПрил1  = 0, "", "верно") + " задан код вида подакцизного товара!", "Приложение1", "П000900001000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если КодОКЕИПрил1 <> 3 Тогда
			СообщитьВТС("В Приложении №1 на странице " + НомерСтраницы + " не" + ?(КодОКЕИПрил1  = 0, "", "верно") + " задан код единицы измерения по ОКЕИ!", "Приложение1", "П000900002000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Пока ДанныеСтраницы.Свойство("П000900000001_" + Формат(НомерСтроки, "ЧГ=")) Цикл
			...
			Если КППрил1МнчКод <> 5 Тогда
				СообщитьВТС("В Приложении № 1 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(КППрил1МнчКод = 0, "", "верно") + " задан код показателя!", "Приложение1", "П000900000001_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		...
		Если НЕ ЗаполненаХотяБыОднастрокаТаблЧастиПрил1 Тогда
			СообщитьВТС("В Приложении № 1 на странице " + НомерСтраницы + " не заполнена ни одна строка табличной части!", "Приложение1", "П000900000001_1", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
	...
	Для Каждого Стр Из Прил2 Цикл
		...
		Если ИННПродавцаПрил2 <> 10 Тогда
			СообщитьВТС("В Приложении №2 на странице " + НомерСтраницы + " не" + ?(ИННПродавцаПрил2  = 0, "", "верно") + " задан ИНН продавца!", "Приложение2", "П000910001000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если КПППродавцаПрил2 <> 9 Тогда
			СообщитьВТС("В Приложении №2 на странице " + НомерСтраницы + " не" + ?(КПППродавцаПрил2  = 0, "", "верно") + " задан КПП продавца!", "Приложение2", "П000910002000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Пока ДанныеСтраницы.Свойство("П000910000001_" + Формат(НомерСтроки, "ЧГ=")) Цикл
			...
			Если КППрил2МнчКод <> 5 Тогда
				СообщитьВТС("В Приложении № 2 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(КППрил2МнчКод = 0, "", "верно") + " задан код показателя!", "Приложение2", "П000910000001_" + НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			КодВидаСпиртаПрил2МнчКод = СтрДлина(КодВидаСпиртаПрил2МнчКод);
			Если КодВидаСпиртаПрил2МнчКод <> 3 Тогда
				СообщитьВТС("В Приложении № 2 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(КодВидаСпиртаПрил2МнчКод = 0, "", "верно") + " задан код вида приобретаемого спирта!", "Приложение2", "П000910000002_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			КодВидаТовараПрил2МнчКод = СтрДлина(КодВидаТовараПрил2МнчКод);
			Если КодВидаТовараПрил2МнчКод <> 3 Тогда
				СообщитьВТС("В Приложении № 2 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(КодВидаТовараПрил2МнчКод = 0, "", "верно") + " задан код вида подакцизного товара!", "Приложение2", "П000910000004_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		...
		Если НЕ ЗаполненаХотяБыОднастрокаТаблЧастиПрил2 Тогда
			СообщитьВТС("В Приложении № 2 на странице " + НомерСтраницы + " не заполнена ни одна строка табличной части!", "Приложение2", "П000910000001_1", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	...
	Для Каждого Стр Из Прил3 Цикл
		...
		Если ИННПокупателяПрил3 <> 10 Тогда
			СообщитьВТС("В Приложении №3 на странице " + НомерСтраницы + " не" + ?(ИННПокупателяПрил3  = 0, "", "верно") + " задан ИНН покупателя!", "Приложение3", "П000920001000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если КПППокупателяПрил3 <> 9 Тогда
			СообщитьВТС("В Приложении №3 на странице " + НомерСтраницы + " не" + ?(КПППокупателяПрил3  = 0, "", "верно") + " задан КПП покупателя!", "Приложение3", "П000920002000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Пока ДанныеСтраницы.Свойство("П000920000001_" + Формат(НомерСтроки, "ЧГ=")) Цикл
			...
			Если КППрил3МнчКод <> 5 Тогда
				СообщитьВТС("В Приложении № 3 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(КППрил3МнчКод = 0, "", "верно") + " задан код показателя!", "Приложение3", "П000920000001_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			КодВидаСпиртаПрил3МнчКод = СтрДлина(КодВидаСпиртаПрил3МнчКод);
			Если КодВидаСпиртаПрил3МнчКод <> 3 Тогда
				СообщитьВТС("В Приложении № 3 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(КодВидаСпиртаПрил3МнчКод = 0, "", "верно") + " задан код вида приобретаемого спирта!", "Приложение3", "П000920000002_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			КодВидаТовараПрил3МнчКод = СтрДлина(КодВидаТовараПрил3МнчКод);
			Если КодВидаТовараПрил3МнчКод <> 3 Тогда
				СообщитьВТС("В Приложении № 3 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(КодВидаТовараПрил3МнчКод = 0, "", "верно") + " задан код вида подакцизного товара!", "Приложение3", "П000920000004_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		...
		Если НЕ ЗаполненаХотяБыОднастрокаТаблЧастиПрил3 Тогда
			СообщитьВТС("В Приложении № 3 на странице " + НомерСтраницы + " не заполнена ни одна строка табличной части!", "Приложение3", "П000920000001_1", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;	
	...
	Для Каждого Стр Из Прил4 Цикл
		...
		Если ПустаяСтрока(НаимОргПрил4) Тогда
			СообщитьВТС("В Приложении № 4 на странице " + НомерСтраницы + "  не заполнено наименование организации-поставщика!", "Приложение4", "П000930001000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если ИННПоставщикаПрил4 <> 10 Тогда
			СообщитьВТС("В Приложении № 4 на странице " + НомерСтраницы + " не" + ?(ИННПоставщикаПрил4 = 0, "", "верно") + " задан ИНН поставщика!", "Приложение4", "П000930002000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если КПППоставщикаПрил4 <> 9 Тогда
			СообщитьВТС("В Приложении № 4 на странице " + НомерСтраницы + " не" + ?(КПППоставщикаПрил4  = 0, "", "верно") + " задан КПП поставщика!", "Приложение4", "П000930003000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если СерияСвидПрил4 <> 2 Тогда
			СообщитьВТС("В Приложении № 4 на странице " + НомерСтраницы + " не" + ?(СерияСвидПрил4  = 0, "", "верно") + " указана серия свидетельства!", "Приложение4", "П000930004000_1", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если ПустаяСтрока(НомСвидПрил4) Тогда
			СообщитьВТС("В Приложении № 4 на странице " + НомерСтраницы + " не указан номер свидетельства!", "Приложение4", "П000930004000_2", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Пока ДанныеСтраницы.Свойство("П000930000001_" + Формат(НомерСтроки, "ЧГ=")) Цикл
			...
			Если КППрил4МнчКод <> 3 Тогда
				СообщитьВТС("В Приложении № 4 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(КППрил4МнчКод = 0, "", "верно") + " задан код показателя!", "Приложение4", "П000930000001_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			ДатаСФПрил4МнчКод = СтрДлина(ДатаСФПрил4МнчКод);
			Если ДатаСФПрил4МнчКод <> 10 Тогда
				СообщитьВТС("В Приложении № 4 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(ДатаСФПрил4МнчКод = 0, "", "верно") + " указана дата счета-фактуры!", "Приложение4", "П000930000002_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			
			Если ПустаяСтрока(НомСФПрил4МнчКод) Тогда
				СообщитьВТС("В Приложении № 4 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не указан номер счета-фактуры!", "Приложение4", "П000930000004_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		...
		Если НЕ ЗаполненаХотяБыОднастрокаТаблЧастиПрил4 Тогда
			СообщитьВТС("В Приложении № 4 на странице " + НомерСтраницы + " не заполнена ни одна строка табличной части!", "Приложение4", "П000930000001_1", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
	...
	Для Каждого Стр Из Прил5 Цикл
		...
		Если ПустаяСтрока(НаимОргПрил5) Тогда
			СообщитьВТС("В Приложении № 5 на странице " + НомерСтраницы + "  не заполнено наименование организации-покупателя!", "Приложение5", "П000940001000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если ИННПокупателяПрил5 <> 10 Тогда
			СообщитьВТС("В Приложении № 5 на странице " + НомерСтраницы + " не" + ?(ИННПокупателяПрил5 = 0, "", "верно") + " задан ИНН покупателя!", "Приложение5", "П000940002000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если КПППокупателяПрил5 <> 9 Тогда
			СообщитьВТС("В Приложении № 5 на странице " + НомерСтраницы + " не" + ?(КПППокупателяПрил5  = 0, "", "верно") + " задан КПП покупателя!", "Приложение5", "П000940003000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если СерияСвидПрил5 <> 2 Тогда
			СообщитьВТС("В Приложении № 5 на странице " + НомерСтраницы + " не" + ?(СерияСвидПрил5  = 0, "", "верно") + " указана серия свидетельства!", "Приложение5", "П000940004000_1", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если ПустаяСтрока(НомСвидПрил5) Тогда
			СообщитьВТС("В Приложении № 5 на странице " + НомерСтраницы + " не указан номер свидетельства!", "Приложение5", "П000940004000_2", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Пока ДанныеСтраницы.Свойство("П000940000001_" + Формат(НомерСтроки, "ЧГ=")) Цикл
			...
			Если КППрил5МнчКод <> 3 Тогда
				СообщитьВТС("В Приложении № 5 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(КППрил5МнчКод = 0, "", "верно") + " задан код показателя!", "Приложение5", "П000940000001_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			ДатаСФПрил5МнчКод = СтрДлина(ДатаСФПрил5МнчКод);
			Если ДатаСФПрил5МнчКод <> 10 Тогда
				СообщитьВТС("В Приложении № 5 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(ДатаСФПрил5МнчКод = 0, "", "верно") + " указана дата счета-фактуры!", "Приложение5", "П000940000002_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			Если ПустаяСтрока(НомСФПрил5МнчКод)  Тогда
				СообщитьВТС("В Приложении № 5 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не указан номер счета-фактуры!", "Приложение5", "П000940000004_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		...
		Если НЕ ЗаполненаХотяБыОднастрокаТаблЧастиПрил5 Тогда
			СообщитьВТС("В Приложении № 5 на странице " + НомерСтраницы + " не заполнена ни одна строка табличной части!", "Приложение5", "П000940000001_1", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;	
	...
	Для Каждого Стр Из Прил6 Цикл
		...
		Если ИННПоставщикаПрил6 <> 10 И ИННПоставщикаПрил6 <> 12 Тогда
			СообщитьВТС("В Приложении № 6 на странице " + НомерСтраницы + " не" + ?(ИННПоставщикаПрил6 = 0, "", "верно") + " задан ИНН поставщика!", "Приложение6", "П000950002000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если  ИННПоставщикаПрил6 = 10  Тогда //юрлицо
			...
			Если КПППоставщикаПрил6 <> 9 Тогда
				СообщитьВТС("В Приложении № 6 на странице " + НомерСтраницы + " не" + ?(КПППоставщикаПрил6  = 0, "", "верно") + " задан КПП поставщика!", "Приложение6", "П000950003000", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		КонецЕсли;
		...
		Если ПустаяСтрока(НаимОргПрил6) Тогда
			СообщитьВТС("В Приложении № 6 на странице " + НомерСтраницы + "  не заполнено наименование организации-поставщика!", "Приложение6", "П000950001000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если СерияСвидПрил6 <> 2 Тогда
			СообщитьВТС("В Приложении № 6 на странице " + НомерСтраницы + " не" + ?(СерияСвидПрил6  = 0, "", "верно") + " указана серия свидетельства!", "Приложение6", "П000950004000_1", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если ПустаяСтрока(НомСвидПрил6) Тогда
			СообщитьВТС("В Приложении № 6 на странице " + НомерСтраницы + " не указан номер свидетельства!", "Приложение6", "П000950004000_2", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Пока ДанныеСтраницы.Свойство("П000950000001_" + Формат(НомерСтроки, "ЧГ=")) Цикл
			...
			Если ДатаСФПрил6МнчКод <> 10 Тогда
				СообщитьВТС("В Приложении № 6 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(ДатаСФПрил6МнчКод = 0, "", "верно") + " указана дата счета-фактуры!", "Приложение6", "П000950000001_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			Если ПустаяСтрока(НомСФПрил6МнчКод)  Тогда
				СообщитьВТС("В Приложении № 6 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не указан номер счета-фактуры!", "Приложение6", "П000950000003_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		...
		Если НЕ ЗаполненаХотяБыОднастрокаТаблЧастиПрил6 Тогда
			СообщитьВТС("В Приложении № 6 на странице " + НомерСтраницы + " не заполнена ни одна строка табличной части!", "Приложение6", "П000950000001_1", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;	
	...
	Для Каждого Стр Из Прил7 Цикл
		...
		Если ИННПокупателяПрил7 <> 10 И ИННПокупателяПрил7 <> 12 Тогда
			СообщитьВТС("В Приложении № 7 на странице " + НомерСтраницы + " не" + ?(ИННПокупателяПрил7 = 0, "", "верно") + " задан ИНН покупателя!", "Приложение7", "П000960002000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если  ИННПокупателяПрил7 = 10  Тогда //юрлицо
			...
			Если КПППокупателяПрил7 <> 9 Тогда
				СообщитьВТС("В Приложении № 7 на странице " + НомерСтраницы + " не" + ?(КПППокупателяПрил7  = 0, "", "верно") + " задан КПП покупателя!", "Приложение7", "П000960003000", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		КонецЕсли;
		...
		Если ПустаяСтрока(НаимОргПрил7) Тогда
			СообщитьВТС("В Приложении № 7 на странице " + НомерСтраницы + "  не заполнено наименование организации-покупателя!", "Приложение7", "П000960001000", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если СерияСвидПрил7 <> 2 Тогда
			СообщитьВТС("В Приложении № 7 на странице " + НомерСтраницы + " не" + ?(СерияСвидПрил7  = 0, "", "верно") + " указана серия свидетельства!", "Приложение7", "П000960004000_1", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если ПустаяСтрока(НомСвидПрил7) Тогда
			СообщитьВТС("В Приложении № 7 на странице " + НомерСтраницы + " не указан номер свидетельства!", "Приложение7", "П000960004000_2", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Пока ДанныеСтраницы.Свойство("П000960000001_" + Формат(НомерСтроки, "ЧГ=")) Цикл
			...
			Если ДатаСФПрил7МнчКод <> 10 Тогда
				СообщитьВТС("В Приложении № 7 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не" + ?(ДатаСФПрил7МнчКод = 0, "", "верно") + " указана дата счета-фактуры!", "Приложение7", "П000960000001_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			Если ПустаяСтрока(НомСФПрил7МнчКод) Тогда
				СообщитьВТС("В Приложении № 7 на странице " + НомерСтраницы + " в строке " + НомерСтроки + " не указан номер счета-фактуры!", "Приложение7", "П000960000003_"+НомерСтроки, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		...
		Если НЕ ЗаполненаХотяБыОднастрокаТаблЧастиПрил7 Тогда
			СообщитьВТС("В Приложении № 7 на странице " + НомерСтраницы + " не заполнена ни одна строка табличной части!", "Приложение7", "П000960000001_1", НомерСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;	
...
Процедура ВывестиМакетВТаблДокНаСервере(ИмяТекРаздела, НомерСтраницыРазделаОтчета)
	...
	Если ИмяТекРаздела <> "Титульный" Тогда
		...
		Если Обл <> Неопределено Тогда
			Если ЭтаФорма["ТаблицаСтраницы" + ИмяТекРаздела].Количество() = 1 Тогда 
	...
	Если СтрНайти(РежимОчистки, "ОчиститьТекущийРаздел") > 0 Тогда
		...
		Если (Многостраничность) И (КолВоСтраницВРазделе > 1) Тогда
			...
			Для каждого ЭлИмяРаздела Из СтруктураИменРазделов Цикл
				...
				ТабличныйДокумент.Очистить();
				ТабличныйДокумент.Вывести(Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет(Сред(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, "ФормаОтчета")) + "_" + ЭлИмяРаздела.Ключ));
...
Процедура ЗаполнитьСведенияОПодписантахИКодПоОКАТО(Ссылка)
	...
	ЗаполнитьОКАТО(Ссылка.КодПоОКАТО);
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
		...
		Если КодПоказателя = "П000210001001" Тогда // проверка уникальности значения на тек. странице
			Если  СокрЛП(ЗначПоказателя) <> ""  И  ЭтаФорма["П0002100010"].НайтиСтроки(Новый Структура("П000210001001", ЗначПоказателя)).Количество() > 0 И СокрЛП(Область.Значение) <> СокрЛП(ЗначПоказателя) Тогда 
				...
				Сообщение.Текст = НСтр("ru = 'Код показателя на одной странице раздела должен быть уникальным!';
										|en = 'Код показателя на одной странице раздела должен быть уникальным!'");
				Сообщение.Сообщить();
				Область.Значение = "";
			КонецЕсли;
		КонецЕсли;
			...
			Для Каждого Страница Из ТаблицаРаздела Цикл
				...
				И СокрЛП(Данные.П000900002000) = СокрЛП(ТабличныйДокумент.Области.П000900002000.Значение) Тогда //совпали коды вида и ОКЕИ
					...
					Сообщение.Текст = НСтр("ru = 'Такая комбинация значений кода вида подакцизного товара и ОКЕИ уже есть на другом листе отчета!';
											|en = 'Такая комбинация значений кода вида подакцизного товара и ОКЕИ уже есть на другом листе отчета!'");
					Сообщение.Сообщить();
					Область.Значение = "";
					Прервать;
				КонецЕсли;
	...
	//завершение ОКАТО
	Если (СтрНайти(Область.Имя, "П000110001003") > 0
	 ИЛИ СтрНайти(Область.Имя, "П000120001003") > 0
	 ИЛИ СтрНайти(Область.Имя, "П000130001003") > 0)
