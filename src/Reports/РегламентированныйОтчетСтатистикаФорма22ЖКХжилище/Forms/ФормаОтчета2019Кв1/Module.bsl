...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "25/04/2019";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Тот = 0;
	Для Инд = 50 По 56 Цикл 
		Тот = Тот + Области["П02" + Инд + "04"].Значение;
	КонецЦикла;
	Области["П024904"].Значение = Тот;
	
	Для Гр = 4 по 5 Цикл
		Области["П02410" + Гр].Значение = Области["П02420" + Гр].Значение + Области["П02430" + Гр].Значение;
		Если Гр = 4 Тогда
			Области["П024104"].Значение = Области["П024104"].Значение + Области["П024404"].Значение;
		КонецЕсли;
	КонецЦикла;
	
	Тот = 0;
	Для Инд = 35 По 40 Цикл 
		Тот = Тот + Области["П02" + Инд + "04"].Значение;
	КонецЦикла;
	Области["П023404"].Значение = Тот;
	
	Для Гр = 4 по 5 Цикл
		Области["П02270" + Гр].Значение = Области["П02280" + Гр].Значение + Области["П02290" + Гр].Значение;
		Если Гр = 4 Тогда
			Области["П022704"].Значение = Области["П022704"].Значение + Области["П023004"].Значение;
		КонецЕсли;
	КонецЦикла;
	
	Тот = 0;
	Для Инд = 21 По 26 Цикл 
		Тот = Тот + Области["П02" + Инд + "04"].Значение;
	КонецЦикла;
	Области["П022004"].Значение = Тот;
	
	Для Гр = 4 по 5 Цикл
		Области["П02130" + Гр].Значение = Области["П02140" + Гр].Значение + Области["П02150" + Гр].Значение;
		Если Гр = 4 Тогда
			Области["П021304"].Значение = Области["П021304"].Значение + Области["П021604"].Значение;
		КонецЕсли;
	КонецЦикла;
	
	Тот = 0;
	Для Инд = 7 По 12 Цикл 
		Тот = Тот + Области["П02" + Формат(Инд, "ЧЦ=2; ЧВН=") + "04"].Значение;
	КонецЦикла;
	Области["П020604"].Значение = Тот;
	Области["П020404"].Значение = Области["П020504"].Значение + Области["П021704"].Значение;
	
	Для Гр = 4 по 8 Цикл 
		Области["П04630" + Гр].Значение = Области["П04640" + Гр].Значение + Области["П04650" + Гр].Значение;
		Тот = 0;
		Для Инд = 71 по 83 Цикл 
			Если Инд = 76 Или Инд = 77 Или Инд = 80 Тогда 
				Продолжить;
			КонецЕсли;
			Тот = Тот + Области["П04" + Инд + "0" + Гр].Значение;
		КонецЦикла;
		Области["П04700" + Гр].Значение = Тот;
		Области["П04840" + Гр].Значение = Области["П04630" + Гр].Значение + Области["П04690" + Гр].Значение + Области["П04700" + Гр].Значение;
	КонецЦикла;
КонецПроцедуры
