...
Процедура ПриОпределенииПараметровВыбора(Форма, СвойстваНастройки) Экспорт
	...
	Если СвойстваНастройки.ПолеКД = Новый ПолеКомпоновкиДанных("ПараметрыДанных.ТипСобытия") Тогда
		Если ТипЗнч(СвойстваНастройки.ПользовательскаяНастройкаКД.Значение) = Тип("СписокЗначений") Тогда
			...
			Для Каждого Элемент Из ЭлементыКУдалению Цикл
				СвойстваНастройки.ПользовательскаяНастройкаКД.Значение.Удалить(Элемент);
			КонецЦикла;
		ИначеЕсли СвойстваНастройки.ПользовательскаяНастройкаКД.Значение = "" Тогда
			СвойстваНастройки.ПользовательскаяНастройкаКД.Значение = Новый СписокЗначений;
		КонецЕсли;
	КонецЕсли;
