...
Процедура ПриКомпоновкеВариантаСправкаПоДСВ(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Исключение
		...
		ВызватьИсключение НСтр("ru = 'В настройку отчета ""Регламентированная форма справка по ДСВ"" внесены критичные изменения. Отчет не будет сформирован.';
								|en = 'Critical changes have been made to the settings of the ""Local form DSV certificate"" report. Cannot generate the report.'") + " " + КраткоеПредставлениеОшибки(Инфо);
	КонецПопытки;
