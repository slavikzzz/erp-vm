...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если Лев(Область.Имя, 13) = "П000020103401" Или Лев(Область.Имя, 13) = "П000020103402" Тогда
		...
		Если Лев(Область.Имя, 13) = "П000020103401" Тогда
			...
			ЭтотОбъект.ПолеТабличногоДокументаФормаОтчета.Области["П000020103402_" + Прав(Область.Имя, 1)].Значение =
		...
		ИначеЕсли Лев(Область.Имя, 13) = "П000020103402" Тогда
			...
			ЭтотОбъект.ПолеТабличногоДокументаФормаОтчета.Области["П000020103401_" + Прав(Область.Имя, 1)].Значение =
