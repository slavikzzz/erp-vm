...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "21/08/2019";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Области.П0330504.Значение = Области.П0330604.Значение + Области.П0330704.Значение;
	Области.П0330505.Значение = Области.П0330605.Значение + Области.П0330705.Значение;
	Области.П0330506.Значение = Области.П0330606.Значение + Области.П0330706.Значение;
КонецПроцедуры
