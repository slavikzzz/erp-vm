...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	Для НомерКолонки = 1 По 2 Цикл
		...
		ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П00200010" + (3 + НомерКолонки)]);
		ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П00200020" + (3 + НомерКолонки)]);
		Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " " + Строка(ПраваяЧасть);
	...
	Для НомерКолонки = 1 По 2 Цикл
		...
		ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П00200030" + (3 + НомерКолонки)]);
		ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П00200040" + (3 + НомерКолонки)]);
		Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " " + Строка(ПраваяЧасть);
	...
	Для НомерКолонки = 1 По 2 Цикл
		...
		ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П00200010" + (3 + НомерКолонки)]);
		ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П00200030" + (3 + НомерКолонки)]);
	...
	Для НомерКолонки = 1 По 2 Цикл
		...
		ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П00200020" + (3 + НомерКолонки)]);
		ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П00200040" + (3 + НомерКолонки)]);
		Расшифровка = Строка(ЛеваяЧасть) + " , " + Строка(ПраваяЧасть);
	...
	Попытка
		Пока Истина Цикл
			...
			КодСтроки   = Показатели["П00300" + Формат(НомерСтроки, "ЧЦ=2; ЧВН=; ЧГ=") + "02"];
			Если КодСтроки <> "50" Тогда 
				Продолжить;
			КонецЕсли;
			
			ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П00300" + Формат(НомерСтроки, "ЧЦ=2; ЧВН=; ЧГ=") + "08"]);
			ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П00300" + Формат(НомерСтроки, "ЧЦ=2; ЧВН=; ЧГ=") + "09"]);
			Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " " + Строка(ПраваяЧасть);
