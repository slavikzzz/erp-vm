...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Элементы.ФормаПроверить.Видимость = (Метаданные.Отчеты.Найти("РегламентированныйОтчетСтатистикаПрочиеФормы") = Неопределено);
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	ЗнЛ = Показатели["П020240"];
	ЗнП = Показатели["П020241"];
	ТекстФормулы = "стр. 240 >=  строке 241";
	Описание     = "стр. 240 <  строке 241";
