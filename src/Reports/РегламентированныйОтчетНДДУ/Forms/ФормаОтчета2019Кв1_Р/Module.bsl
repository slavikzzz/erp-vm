...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
	...
	Если ИмяРаздела = "Раздел2" Тогда
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			ДоходУбыток
			= Ветка.Данные["П000020005003"] - Ветка.Данные["П000020006003"] - Ветка.Данные["П000020007003"]
			+ Ветка.Данные["П000020008003"] + Ветка.Данные["П000020008303"] - Ветка.Данные["П000020008403"];
