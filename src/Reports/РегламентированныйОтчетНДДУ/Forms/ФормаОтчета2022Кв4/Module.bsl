...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мВерсияФормы = "01/10/2022";
...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	СтруктураРеквизитовФормы.Вставить("ФормаВРедакцииОт20220808", Ложь);
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	СтруктураРеквизитовФормы["ФормаВРедакцииОт20220808"] = Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) < 2024;
...
Процедура ИнициализироватьМногострочныеЧасти()
	...
	Для Инд = 1 По 34 Цикл
		// Строки с "30701" по "30734".
	...
	ИменаГраф.Добавить("П00102М133000");
	ИменаПодчиненныхГрупп = Новый Массив;
	...
	"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп", ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
	// Группа П00104М2, подчиненная группе П00104М1.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П00104М201503");
	ИменаГраф.Добавить("П00104М201504");
	ИменаПодчиненныхГрупп = Новый Массив;
...
Процедура СформироватьСпискиВыбора()
		...
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Строки Тогда
			...
			Для НомСтр = ВерхОбласти По НизОбласти Цикл
				...
				Если КодПоказателя <> "###" Тогда
					...
					Если Область.Имя = "КодыОснованияНалогообложения" И СтруктураРеквизитовФормы["ФормаВРедакцииОт20220808"] Тогда
						
						Если КодПоказателя = "274" ИЛИ КодПоказателя = "275" ИЛИ КодПоказателя = "276"
							ИЛИ КодПоказателя = "277" ИЛИ КодПоказателя = "278" Тогда
							Продолжить;
						КонецЕсли;
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П00104М201503", 0, ,
	"Выбор коэффициента индексации", КоллекцияСписковВыбора["КоэффициентыИндексации"]);
	
	//Приложение 5 к разделу 2.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П001050002003", 0, ,
	"Выбор коэффициента индексации убытка", КоллекцияСписковВыбора["КоэффициентыИндексации"]);
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли СтрНачинаетсяС(Область.Имя, "П00104М201504") ИЛИ СтрНачинаетсяС(Область.Имя, "П00104М101603")
		ИЛИ Область.Имя = "П001050001003" ИЛИ СтрНачинаетсяС(Область.Имя, "П00105М110101")
		ИЛИ СтрНачинаетсяС(Область.Имя, "П00105М270101") ИЛИ СтрНачинаетсяС(Область.Имя, "П00105М380101")
		ИЛИ СтрНачинаетсяС(Область.Имя, "П00106М110101") ИЛИ СтрНачинаетсяС(Область.Имя, "П00106М230101")
		ИЛИ СтрНачинаетсяС(Область.Имя, "П00106М340101") Тогда
	...
	ИначеЕсли СтрНачинаетсяС(Область.Имя, "П00101М100703") ИЛИ СтрНачинаетсяС(Область.Имя, "П00102М100007")
	...
	ИначеЕсли Область.Имя = "П001070065003"
		И Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) >= 2022
		...
		Если Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 2025 Тогда
			...
			СписокКоэффициентов.Добавить(1.388, "1,388");
			
		ИначеЕсли Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 2024 Тогда
			
			СписокКоэффициентов.Добавить(1.284, "1,284");
			
		ИначеЕсли Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 2023 Тогда
			
			СписокКоэффициентов.Добавить(1.215, "1,215");
			
		Иначе// 2022 год
			
			СписокКоэффициентов.Добавить(1.06, "1,06");
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяРаздела)
	...
	Если ИмяРаздела = "Титульный" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы["ФормаВРедакцииОт20220808"] Тогда
			
			Обл = ТДО.Найти("РеквизитыПриказа");
			Если Обл <> Неопределено Тогда
				Обл.Текст = НСтр("ru = 'Приложение № 1 к приказу ФНС России
				|от 30.03.2021 № КВ-7-3/234@
				|(в редакции приказа ФНС России
				|от 08.08.2022 № ЕД-7-3/727@)';
				|en = 'Приложение № 1 к приказу ФНС России
				|от 30.03.2021 № КВ-7-3/234@
				|(в редакции приказа ФНС России
				|от 08.08.2022 № ЕД-7-3/727@)'");
			КонецЕсли;
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				Пока Обл <> Неопределено Цикл
					...
					+ ТДО.Найти("П00102М133000_" + ИндексСтр).Значение;
	...
	ИначеЕсли ИмяРаздела = "Приложение2" Тогда
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Для каждого СтрокаМнЧ Из ДеревоМнЧ.Строки Цикл
				...
				КонецЦикла;
				Стр30000 = Стр30000 + СтрокаМнЧ.Данные["П00102М132000"] + СтрокаМнЧ.Данные["П00102М133000"];
		...
		Для каждого Ветка Из ДеревоРаздела.Строки Цикл
			...
			Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
				Если ЗаполненаСтрокаМногострочнойЧасти(СтрокаМнЧ) Тогда
					...
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Раздел 2 -> Страница " + НомСтраницы + " -> Приложение 1: " + Текст_СтрокаГруппыСтрок + "не задан "
						+ "код источника цены на природный газ", "Приложение1", "П00101М105503_" + НомСтроки, КоординатыПриложения);
						СтатусПроверки = Ложь;
			...
			Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
				Если ЗаполненаСтрокаМногострочнойЧасти(СтрокаМнЧ) Тогда
					НомСтроки = Формат(ДанныеМнЧ.Строки.Индекс(СтрокаМнЧ) + 1, "ЧГ=");
					Текст_СтрокаГруппыСтрок = ?(КолСтрокМнЧ = 1, "", "в строке " + НомСтроки + " сведений о расходах ");
					...
					Для каждого СтрокаПодчМнЧ Из ДанныеПодчМнЧ.Строки Цикл
						Если ЗаполненаСтрокаМногострочнойЧасти(СтрокаПодчМнЧ) Тогда
							НомПодчСтроки = Формат(ДанныеПодчМнЧ.Строки.Индекс(СтрокаПодчМнЧ) + 1, "ЧГ=");
							
							Если НЕ ЗначениеЗаполнено(СтрокаПодчМнЧ.Данные["П00104М201503"]) Тогда
								СообщитьВТС("Раздел 2 -> Страница " + НомСтраницы + " -> Приложение 4: " + Текст_СтрокаГруппыСтрок
								+ "не задан коэффициент индексации в строке 015",
								"Приложение4", "П00104М201503_" + НомСтроки + "_" + НомПодчСтроки, КоординатыПриложения);
								СтатусПроверки = Ложь;
							КонецЕсли;
							
							Если НЕ ЗначениеЗаполнено(СокрЛП(СтрокаПодчМнЧ.Данные["П00104М201504"])) Тогда
								СообщитьВТС("Раздел 2 -> Страница " + НомСтраницы + " -> Приложение 4: " + Текст_СтрокаГруппыСтрок
								+ "не задан налоговый период (год) в строке 015",
								"Приложение4", "П00104М201504_" + НомСтроки + "_" + НомПодчСтроки, КоординатыПриложения);
								СтатусПроверки = Ложь;
							КонецЕсли;
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель, ПараметрыВыгрузки)
	...
	Для каждого Ветка Из ДеревоРаздела.Строки Цикл
		...
		Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
			...
			Для каждого Эл Из ЭкзВосстСумРасх.Строки Цикл
				Если Эл.Код <> "КоэфУб" Тогда
					ВывестиПоказательВXML(Эл, СтрокаМнЧ.Данные[Эл.Ключ]);
				КонецЕсли;
			КонецЦикла;
			КоэфУб = ПолучитьПодчиненныйЭлемент(ЭкзВосстСумРасх, "КоэфУб");
			ДанныеПодчМнЧ = СтрокаМнЧ.ДанныеМногострочныхЧастей[СтруктураРеквизитовФормы.мИдГруппыП4М2];
			Для каждого СтрокаПодчМнЧ Из ДанныеПодчМнЧ.Строки Цикл
				ЭкзКоэфУб = СкопироватьУзел(ЭкзВосстСумРасх, КоэфУб, ЭкзВосстСумРасх.Строки.Количество() - 1);
				Если ЗначениеЗаполнено(СтрокаПодчМнЧ.Данные["П00104М201503"])
					И ЗначениеЗаполнено(СтрокаПодчМнЧ.Данные["П00104М201504"]) Тогда
					КоэфУб_Строка = Формат(СтрокаПодчМнЧ.Данные["П00104М201503"], "ЧРД=.");
					КоэфУб_Строка = ?(СтрДлина(КоэфУб_Строка) = 1, КоэфУб_Строка + ".0", КоэфУб_Строка);
					ВывестиПоказательВXML(ЭкзКоэфУб, КоэфУб_Строка + "-" + СокрЛП(СтрокаПодчМнЧ.Данные["П00104М201504"]));
				КонецЕсли;
			КонецЦикла;
		КонецЦикла;
...
Процедура ВывестиНаПечатьДанныеМногоуровневогоРаздела(СтруктураПараметров, ОбщиеРеквизитыРазделов, СтрПоля)
	...
	ИначеЕсли ИмяТекРаздела = "Раздел2" Тогда
		...
		Для каждого Ветка Из ДеревоДанныхРаздела.Строки Цикл
			...
			МакетРаздела = ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(
			ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_Приложение1");
			...
			МакетРаздела = ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(
			ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_Приложение2");
			ДанныеМнЧ = ВеткаПриложения.ДанныеМногострочныхЧастей[ИмяГруппыМнЧ];
			Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
				Если ЗаполненаСтрокаМногострочнойЧасти(СтрокаМнЧ) Тогда
					ТабличныйДокумент.Очистить();
			...
			МакетРаздела = ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(
			ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_Приложение3");
			ДанныеМнЧ = ВеткаПриложения.ДанныеМногострочныхЧастей[ИмяГруппыМнЧ];
			Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
				Если ЗаполненаСтрокаМногострочнойЧасти(СтрокаМнЧ) Тогда
					ТабличныйДокумент.Очистить();
			...
			МакетРаздела = ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(
			ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_Приложение4");
			...
			МакетРаздела = ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(
			ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_Приложение5");
			...
			МакетРаздела = ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(
			ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_Приложение6");
			...
			МакетРаздела = ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(
			ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_Приложение7");
...
Процедура ЗаполнитьМакетМЧБ(ПараметрыПечати, МакетМЧБ, ОбщиеРеквизитыРазделов)
	...
	Если ПараметрыПечати.ИмяСтраницы = "Титульный" Тогда
		...
		// Особая обработка: реквизиты приказа.
		Если СтруктураРеквизитовФормы["ФормаВРедакцииОт20220808"] Тогда
...
Процедура СформироватьДанныеОтчета()
	...
	Для Счетчик = 1 По ДанныеКС.Раздел1.КолвоСтрокП00001М1 Цикл
		ЗаполнитьПоказатель(Показатели.Р1С020, ДанныеКС.Раздел1, Счетчик);
		Если КБК_Раздел1.Найти(Показатели.Р1С020.Значение) = Неопределено Тогда
			КБК_Раздел1.Добавить(Показатели.Р1С020.Значение);
		КонецЕсли;
	КонецЦикла;
	...
	Для каждого Элемент Из ВнешнийЭлемент.Строки Цикл
		...
		Если Уровень = 1 И НомерРезультат = 5 Тогда
			...
			Для каждого СтраницаПриложения Из Элемент.Строки Цикл
				...
				ДанныеСтраницы.Вставить("НомерСтраницы", "" + НомерСтраницы + ",5," + (Элемент.Строки.Индекс(СтраницаПриложения) 
					+ 1));
...
Процедура ПересчетСтрокМногострочныхЧастей(ДанныеСтраницы)
	...
	Если ДанныеСтраницы.Свойство("П00104М101003_1") Тогда
		Для Счетчик = 1 По ДанныеСтраницы.КолвоСтрокП00104М1 Цикл
				
			Счетчик2 = 1;
			Пока ДанныеСтраницы.Свойство("П00104М201503_" + XMLСтрока(Счетчик) + "_" + XMLСтрока(Счетчик2 + 1)) Цикл
				Счетчик2 = Счетчик2 + 1
			КонецЦикла;
			
			ДанныеСтраницы.Вставить("КолвоСтрокП00104М2_" + XMLСтрока(Счетчик), Счетчик2);
...
Процедура СформироватьСлужебныеДанные()
	...
	ПредставленияРазделов.Вставить("Р1", "Раздела 1");
	ПредставленияРазделов.Вставить("Р2", "Раздела 2");
	ПредставленияРазделов.Вставить("П1", "Приложения 1 к Разделу 2");
	ПредставленияРазделов.Вставить("П2", "Приложения 2 к Разделу 2");
	ПредставленияРазделов.Вставить("П3", "Приложения 3 к Разделу 2");
	ПредставленияРазделов.Вставить("П4", "Приложения 4 к Разделу 2");
	ПредставленияРазделов.Вставить("П5", "Приложения 5 к Разделу 2");
	ПредставленияРазделов.Вставить("П6", "Приложения 6 к Разделу 2");
	ПредставленияРазделов.Вставить("П7", "Приложения 7 к Разделу 2");
	
	ДанныеКС.Вставить("ПредставленияРазделов", ПредставленияРазделов);
	
	ИменаРазделов = Новый Структура();
	
	ИменаРазделов.Вставить("Р0", "Титульный");
	ИменаРазделов.Вставить("Р1", "Раздел1");
	ИменаРазделов.Вставить("Р2", "Раздел2");
	ИменаРазделов.Вставить("П1", "Приложение1");
	ИменаРазделов.Вставить("П2", "Приложение2");
	ИменаРазделов.Вставить("П3", "Приложение3");
	ИменаРазделов.Вставить("П4", "Приложение4");
	ИменаРазделов.Вставить("П5", "Приложение5");
	ИменаРазделов.Вставить("П6", "Приложение6");
	ИменаРазделов.Вставить("П7", "Приложение7");
	...
	МассивПолейСписочныхЗначений.Добавить("П00104М201503");
	...
	Для каждого СтрокаТЗ Из ТаблицаСписков Цикл
		Если НЕ МассивПолейСписочныхЗначений.Найти(СтрокаТЗ.Показатель) = Неопределено Тогда
			...
			ПреобразоватьВЧисло = СтрокаТЗ.Показатель = "П00104М201503";
	...
	МногострочныеЧасти.Вставить("П00104М201503", "П00104М2");
...
Функция ПолучитьДанныеРаздела0(ДанныеОтчета)
	...
	СтруктураР0.Вставить("НомерСтраницы", 1);
...
Функция ПолучитьДанныеРаздела1(ДанныеОтчета)
	...
	СтруктураР1.Вставить("НомерСтраницы", 1);
...
Функция ПолучитьДанныеРаздела2(ДанныеОтчета)
	...
	Для каждого СтраницаР2 Из Раздел2 Цикл
		...
		СтруктураР2.Вставить("НомерСтраницы", НомерСтраницы);
...
Процедура СформироватьПриоритетыРазделов()
	...
	ПриоритетыРазделов.Добавить("Приложение 7");
...
Функция СформироватьПоказатели(ИменаПоказателей)
	...
	Для каждого Элемент Из ИменаПоказателей Цикл
		...
		ПрефиксРаздела		= Лев(Элемент.Ключ, 2);
		
		Если ПрефиксРаздела = "П2" Тогда
...
Процедура ПроверкаКС_5_01_1_к()
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р1С030"		, "П00001М103003_");
	...
	Для Счетчик = 1 По ДанныеКС.Раздел1.КолвоСтрокП00001М1 Цикл
		...
		НастройкиКС.ЭтоОшибка = Показатели.Р1С030.Значение < 0;
		НастройкиКС.Детализация = СтрЗаменить(НастройкиКС.ШаблонДетализации, "%1", Показатели.Р1С030.Значение); 
...
&НаСервере
Процедура ПроверкаКС_5_01_2_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, ДанныеКС.КритичныйРаздел);
	Заголовки.Вставить("Критичность"		, 3);
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '05.01.2';
													|en = '05.01.2'"));
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.040 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.040 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Группа строк %1 Раздела 1';
													|en = 'Группа строк %1 Раздела 1'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р1С040"		, "П00001М104003_");
	...
	Для Счетчик = 1 По ДанныеКС.Раздел1.КолвоСтрокП00001М1 Цикл
		...
		НастройкиКС.ЭтоОшибка = Показатели.Р1С040.Значение < 0;
		НастройкиКС.Детализация = СтрЗаменить(НастройкиКС.ШаблонДетализации, "%1", Показатели.Р1С040.Значение);
		НастройкиКС.ДопСведения = СтрЗаменить(НастройкиКС.ШаблонДопСведений, "%1", Счетчик);
		ДополнитьТаблицуРезультата();
...
&НаСервере
Процедура ПроверкаКС_5_02_1_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, ДанныеКС.КритичныйРаздел);
	Заголовки.Вставить("Критичность"		, 3);
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '05.02.1';
													|en = '05.02.1'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.030 Раздела 1 = стр.(150 - 160) Раздела 2, если стр.020 Раздела 1 = стр.005 ';
			|en = 'Сумма налога в стр.030 Раздела 1 = стр.(150 - 160) Раздела 2, если стр.020 Раздела 1 = стр.005 '") +
		НСтр("ru = 'Раздела 2 и стр.030 Раздела 1 > 0 ';
			|en = 'Раздела 2 и стр.030 Раздела 1 > 0 '"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 - %4), КБК %5';
													|en = '%1 = %2 (%3 - %4), КБК %5'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	...
	Для каждого КБКРаздела1 Из ДанныеКС.КБК_Раздел1 Цикл 
		...
		ЗарегистрироватьПроверку();
		Показатели.Р1С030.Итог = 0;
		Показатели.Р2С150.Итог = 0;
		Показатели.Р2С160.Итог = 0;
		КБКРаздела1Стр = "(...)";
		
		Для Счетчик = 1 По ДанныеКС.Раздел1.КолвоСтрокП00001М1 Цикл
			ЗаполнитьПоказатель(Показатели.Р1С020, ДанныеКС.Раздел1, Счетчик);
			Если Показатели.Р1С020.Значение = КБКРаздела1 Тогда
				КБКРаздела1Стр = Показатели.Р1С020.ЗначениеСтр;
				ЗаполнитьИРасшифроватьПоказатель(Показатели.Р1С030, ДанныеКС.Раздел1, Счетчик);
			КонецЕсли;
		КонецЦикла;
		
		Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
			ЗаполнитьПоказатель(Показатели.Р2С005, Раздел2);
			Если Показатели.Р2С005.Значение = КБКРаздела1 Тогда
				ЗаполнитьИРасшифроватьПоказатель(Показатели.Р2С150, Раздел2);
				ЗаполнитьИРасшифроватьПоказатель(Показатели.Р2С160, Раздел2);
			КонецЕсли;
		КонецЦикла;
		
		РасчетнаяСумма = Макс(0, Показатели.Р2С150.Итог - Показатели.Р2С160.Итог);
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р1С030.Итог = 0 И НЕ Показатели.Р1С030.Итог = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р1С030.Итог, РасчетнаяСумма, Показатели.Р2С150.Итог, Показатели.Р2С160.Итог, КБКРаздела1Стр); 
		ДополнитьТаблицуРезультата();
...
&НаСервере
Процедура ПроверкаКС_5_02_2_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, ДанныеКС.КритичныйРаздел);
	Заголовки.Вставить("Критичность"		, 3);
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '05.02.2';
													|en = '05.02.2'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.040 Раздела 1 = стр.(160 - 150) Раздела 2, если стр.020 Раздела 1 = стр.005 ';
			|en = 'Сумма налога в стр.040 Раздела 1 = стр.(160 - 150) Раздела 2, если стр.020 Раздела 1 = стр.005 '") +
		НСтр("ru = 'Раздела 2 и стр.040 Раздела 1 > 0 ';
			|en = 'Раздела 2 и стр.040 Раздела 1 > 0 '"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 - %4), КБК %5';
													|en = '%1 = %2 (%3 - %4), КБК %5'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в стр.040 Раздела 1';
													|en = 'Уточните сумму налога в стр.040 Раздела 1'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'"));
	ПодготовитьНастройки(Заголовки); 
	...
	Для каждого КБКРаздела1 Из ДанныеКС.КБК_Раздел1 Цикл 
		...
		Для Счетчик = 1 По ДанныеКС.Раздел1.КолвоСтрокП00001М1 Цикл
			...
			Если Показатели.Р1С020.Значение = КБКРаздела1 Тогда
				КБКРаздела1Стр = Показатели.Р1С020.ЗначениеСтр;
				ЗаполнитьИРасшифроватьПоказатель(Показатели.Р1С040, ДанныеКС.Раздел1, Счетчик);
			КонецЕсли;
		КонецЦикла;
		...
		РасчетнаяСумма = Макс(0, Показатели.Р2С160.Итог - Показатели.Р2С150.Итог);
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р1С040.Итог = 0 И НЕ Показатели.Р1С040.Итог = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р1С040.Итог, РасчетнаяСумма, Показатели.Р2С160.Итог, Показатели.Р2С150.Итог, КБКРаздела1Стр); 
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_1_01()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, "Титульный лист");
	Заголовки.Вставить("НомерКС"			, "01.01");
	Заголовки.Вставить("Описание"			, 
		"Дата представления первичного отчета <= установленному ст.333.56 НК РФ сроку " +
		"представления налоговой декларации по налогу на дополнительный доход");
	Заголовки.Вставить("ШаблонДетализации"	, "%1 <= %2");
	Заголовки.Вставить("Нарушение"			, "Возможно нарушение срока представления отчета");
	Заголовки.Вставить("Рекомендации"		, "Проверьте правильность даты подписи отчета на титульном листе");
	Заголовки.Вставить("Основание"			, "Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@");
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.ЭтоОшибка = ДанныеКС.Отчет.Вид = 0 И Показатели.Р0С001.Значение > УстановленныйСрок;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р0С001.ЗначениеСтр, 
		УстановленныйСрокСтр);
	ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_1_02()
	...
	Заголовки.Вставить("Раздел"				, "Раздел 2");
	Заголовки.Вставить("Описание"			, 
		"Количество Разделов 2 в отчете за текущий период >= количеству Разделов 2 отчета за " +
		"предыдущий отчетный период. Для отчета за 1 квартал проверка не выполняется");
	Заголовки.Вставить("ШаблонДетализации"	, "%1 >= %2");
	Заголовки.Вставить("Нарушение"			, "Возможно ошибочное количество Разделов 2");
	Заголовки.Вставить("Рекомендации"		, "Дополните Раздел 2 в отчете за текущий период");
	Заголовки.Вставить("Основание"			, "Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@");
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.ЭтоОшибка = ДанныеКС.МесОтчета > 3 И НЕ ДанныеКС.ОтчетПРП = Неопределено 
		И КоличествоР2ТОП < КоличествоР2ПРП;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации	, КоличествоР2ТОП, КоличествоР2ПРП);
	ДополнитьТаблицуРезультата();
...
&НаСервере
Процедура ПроверкаКС_2_01_1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '02.01.1';
													|en = '02.01.1'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.030 Раздела 1 = стр.(150 - 160) Раздела 2, если стр.020 Раздела 1 = стр.005 ';
			|en = 'Сумма налога в стр.030 Раздела 1 = стр.(150 - 160) Раздела 2, если стр.020 Раздела 1 = стр.005 '") +
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в стр.030 Раздела 1';
													|en = 'Уточните сумму налога в стр.030 Раздела 1'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки); 
...
&НаСервере
Процедура ПроверкаКС_2_01_2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '02.01.2';
													|en = '02.01.2'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.040 Раздела 1 = стр.(160 - 150) Раздела 2, если стр.020 Раздела 1 = стр.005 ';
			|en = 'Сумма налога в стр.040 Раздела 1 = стр.(160 - 150) Раздела 2, если стр.020 Раздела 1 = стр.005 '") +
...
Процедура ПроверкаКС_2_03_доп()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '02.03.доп';
													|en = '02.03.доп'"));
	Заголовки.Вставить("Описание"			, 
	...
	Если НЕ Список = Неопределено Тогда
		Для Счетчик = 1 По ДанныеКС.Раздел1.КолвоСтрокП00001М1 Цикл
			...
			НастройкиКС.ЭтоОшибка = Список.Получить(Показатели.Р1С020.Значение) = Неопределено;
			НастройкиКС.Детализация = СтрЗаменить(НастройкиКС.ШаблонДетализации, "%1", Показатели.Р1С020.ЗначениеСтр);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_01()
	...
	Заголовки.Вставить("Рекомендации"		, "Выберите код основания налогообложения в стр.030 Раздела 2 из списка значений");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Если НЕ Список = Неопределено Тогда
		Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
			Для Счетчик = 1 По Раздел2.КолвоСтрокП00002М1 Цикл
				...
				НастройкиКС.ЭтоОшибка = Список.Получить(Показатели.Р2С030.Значение) = Неопределено;
				НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С030.ЗначениеСтр);
				НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
				ДополнитьТаблицуРезультата();
...
&НаСервере
Процедура ПроверкаКС_3_02_1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.02.1';
													|en = '03.02.1'"));
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '101 - 106';
			|en = '101 - 106'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 18210705010011000110, если %2 = 101 - 106';
													|en = '%1 = 18210705010011000110, если %2 = 101 - 106'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение КБК';
													|en = 'Возможно ошибочное значение КБК'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите значение КБК 18210705010011000110");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("ИсточникНСИ", "КомплектНСИ_1л");
	ПроверкаКС_3_02_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_3_02_2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.02.2';
													|en = '03.02.2'"));
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '107';
			|en = '107'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 18210705020011000110, если %2 = 107';
													|en = '%1 = 18210705020011000110, если %2 = 107'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение КБК';
													|en = 'Возможно ошибочное значение КБК'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите значение КБК 18210705020011000110");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("ИсточникНСИ", "КомплектНСИ_1м");
	ПроверкаКС_3_02_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_3_02_3()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.02.3';
													|en = '03.02.3'"));
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '108 - 142, 154 - 157, 183 - 184, 188 - 217';
			|en = '108 - 142, 154 - 157, 183 - 184, 188 - 217'"));
	Заголовки.Вставить("ШаблонДетализации"	, 
		НСтр("ru = '%1 = 18210705030011000110, если %2 = 108 - 142, 154 - 157, 183 - 184, 188 - 217';
			|en = '%1 = 18210705030011000110, если %2 = 108 - 142, 154 - 157, 183 - 184, 188 - 217'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение КБК';
													|en = 'Возможно ошибочное значение КБК'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите значение КБК 18210705030011000110");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("ИсточникНСИ", "КомплектНСИ_1н");
	ПроверкаКС_3_02_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_3_02_4()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.02.4';
													|en = '03.02.4'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, 
		НСтр("ru = '%1 = 18210705040011000110, если %2 = 143 - 153, 158 - 172, 176 - 181, 185, 218 - 273';
			|en = '%1 = 18210705040011000110, если %2 = 143 - 153, 158 - 172, 176 - 181, 185, 218 - 273'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение КБК';
													|en = 'Возможно ошибочное значение КБК'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите значение КБК 18210705040011000110");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("ИсточникНСИ", "КомплектНСИ_1о");
	ПроверкаКС_3_02_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_3_02_5()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.02.5';
													|en = '03.02.5'"));
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '173 - 175';
			|en = '173 - 175'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 18210705050011000110, если %2 = 173 - 175';
													|en = '%1 = 18210705050011000110, если %2 = 173 - 175'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение КБК';
													|en = 'Возможно ошибочное значение КБК'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите значение КБК 18210705050011000110");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("ИсточникНСИ", "КомплектНСИ_1п");
	ПроверкаКС_3_02_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_3_02_6()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.02.6';
													|en = '03.02.6'"));
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '182, 186, 187';
			|en = '182, 186, 187'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 18210705060011000110, если %2 = 182, 186, 187';
													|en = '%1 = 18210705060011000110, если %2 = 182, 186, 187'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение КБК';
													|en = 'Возможно ошибочное значение КБК'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите значение КБК 18210705060011000110");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("ИсточникНСИ", "КомплектНСИ_1р");
	ПроверкаКС_3_02_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_3_02_код()
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
			...
			РасчетноеЗначение = ДанныеКС[НастройкиКС.ИсточникНСИ].Получить(Показатели.Р2С030.Значение);
			НастройкиКС.ЭтоОшибка = НЕ РасчетноеЗначение = Неопределено 
				И НЕ Показатели.Р2С005.Значение = РасчетноеЗначение;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С005.ЗначениеСтр, 
				Показатели.Р2С030.ЗначениеСтр);
			НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
			ДополнитьТаблицуРезультата();
...
&НаСервере
Процедура ПроверкаКС_3_03_1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.03.1';
													|en = '03.03.1'"));
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '101 - 106';
			|en = '101 - 106'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 0,4, 0,6, 0,8, 1, если %2 = 101 - 106';
													|en = '%1 = 0,4, 0,6, 0,8, 1, если %2 = 101 - 106'"));
	...
	Заголовки.Вставить("Рекомендации"		, "Уточните значение коэффициента Кг в стр.040 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("ИсточникНСИ", "КомплектНСИ_1е");
	ПроверкаКС_3_03_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_3_03_2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.03.2';
													|en = '03.03.2'"));
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '107';
			|en = '107'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 0,4, 0,6, 0,8, 1, 1,2, 1,95, если %2 = 107';
													|en = '%1 = 0,4, 0,6, 0,8, 1, 1,2, 1,95, если %2 = 107'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение коэффициента Кг';
													|en = 'Возможно ошибочное значение коэффициента Кг'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение коэффициента Кг в стр.040 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
	...
	НастройкиКС.Вставить("МассивЗначений", МассивЗначений);
	НастройкиКС.Вставить("ИсточникНСИ", "КомплектНСИ_1ж");
	ПроверкаКС_3_03_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_3_03_3()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.03.3';
													|en = '03.03.3'"));
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '108 - 142, 154 - 157, 182 - 184, 186 - 217';
			|en = '108 - 142, 154 - 157, 182 - 184, 186 - 217'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 1, если %2 = 108 - 142, 154 - 157, 182 - 184, 186 - 217';
													|en = '%1 = 1, если %2 = 108 - 142, 154 - 157, 182 - 184, 186 - 217'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение коэффициента Кг';
													|en = 'Возможно ошибочное значение коэффициента Кг'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите значение коэффициента Кг 1");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("МассивЗначений", МассивЗначений);
	НастройкиКС.Вставить("ИсточникНСИ", "КомплектНСИ_1з");
	ПроверкаКС_3_03_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_3_03_4()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.03.4';
													|en = '03.03.4'"));
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '143 - 153, 158 - 172, 176 - 181, 185, 218 - 273';
			|en = '143 - 153, 158 - 172, 176 - 181, 185, 218 - 273'"));
	Заголовки.Вставить("ШаблонДетализации"	, 
		НСтр("ru = '%1 = 0,5, 0,75, 1, если %2 = 143 - 153, 158 - 172, 176 - 181, 185, 218 - 273';
			|en = '%1 = 0,5, 0,75, 1, если %2 = 143 - 153, 158 - 172, 176 - 181, 185, 218 - 273'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение коэффициента Кг';
													|en = 'Возможно ошибочное значение коэффициента Кг'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение коэффициента Кг в стр.040 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
	...
	НастройкиКС.Вставить("МассивЗначений", МассивЗначений);
	НастройкиКС.Вставить("ИсточникНСИ", "КомплектНСИ_1и");
	ПроверкаКС_3_03_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_3_03_5()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.03.5';
													|en = '03.03.5'"));
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '173 - 175';
			|en = '173 - 175'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 0, 0,2, 0,4, 0,6, 0,8, 1, если %2 = 173 - 175';
													|en = '%1 = 0, 0,2, 0,4, 0,6, 0,8, 1, если %2 = 173 - 175'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение коэффициента Кг';
													|en = 'Возможно ошибочное значение коэффициента Кг'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение коэффициента Кг в стр.040 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
	...
	НастройкиКС.Вставить("МассивЗначений", МассивЗначений);
	НастройкиКС.Вставить("ИсточникНСИ", "КомплектНСИ_1к");
	ПроверкаКС_3_03_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_3_03_код()
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		РасчетноеЗначение = ДанныеКС[НастройкиКС.ИсточникНСИ].Получить(Показатели.Р2С030.Значение);
		НастройкиКС.ЭтоОшибка = НЕ РасчетноеЗначение = Неопределено 
			И НастройкиКС.МассивЗначений.Найти(Показатели.Р2С040.Значение) = Неопределено;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С040.Значение, 
			Показатели.Р2С030.ЗначениеСтр);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_04()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.04';
													|en = '03.04'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расчетная выручка в стр.050 Раздела 2 = сумме стр.051 - 056 Раздела 2';
			|en = 'Расчетная выручка в стр.050 Раздела 2 = сумме стр.051 - 056 Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8)';
													|en = '%1 = %2 (%3 + %4 + %5 + %6 + %7 + %8)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма расчетной выручки';
													|en = 'Возможно ошибочная сумма расчетной выручки'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетной выручки в стр.050 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р2С050.Значение = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С050.Значение, РасчетнаяСумма, 
			Показатели.Р2С051.Значение, Показатели.Р2С052.Значение, Показатели.Р2С053.Значение, Показатели.Р2С054.Значение, 
			Показатели.Р2С055.Значение, Показатели.Р2С056.Значение);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_05()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.05';
													|en = '03.05'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расчетная выручка в стр.051 Раздела 2 = стр.010 Приложения 1 к Разделу 2 ';
			|en = 'Расчетная выручка в стр.051 Раздела 2 = стр.010 Приложения 1 к Разделу 2 '") +
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма расчетной выручки';
													|en = 'Возможно ошибочная сумма расчетной выручки'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетной выручки в стр.051 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.Раздел0.Период < "50" И НЕ Показатели.Р2С051.Значение = Показатели.П1С010.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С051.Значение, 
			Показатели.П1С010.Итог);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_06()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.06';
													|en = '03.06'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расчетная выручка в стр.052 Раздела 2 = стр.010 Приложения 1 к Разделу 2 ';
			|en = 'Расчетная выручка в стр.052 Раздела 2 = стр.010 Приложения 1 к Разделу 2 '") +
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма расчетной выручки';
													|en = 'Возможно ошибочная сумма расчетной выручки'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетной выручки в стр.052 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.Раздел0.Период < "50" И НЕ Показатели.Р2С052.Значение = Показатели.П1С010.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С052.Значение, 
			Показатели.П1С010.Итог);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_07()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.07';
													|en = '03.07'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расчетная выручка в стр.053 Раздела 2 = стр.010 Приложения 1 к Разделу 2 ';
			|en = 'Расчетная выручка в стр.053 Раздела 2 = стр.010 Приложения 1 к Разделу 2 '") +
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма расчетной выручки';
													|en = 'Возможно ошибочная сумма расчетной выручки'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетной выручки в стр.053 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.Раздел0.Период < "50" И НЕ Показатели.Р2С053.Значение = Показатели.П1С010.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С053.Значение, 
			Показатели.П1С010.Итог);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_08()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.08';
													|en = '03.08'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Фактические расходы в стр.060 Раздела 2 = сумме стр.061 - 064 Раздела 2';
			|en = 'Фактические расходы в стр.060 Раздела 2 = сумме стр.061 - 064 Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4 + %5 + %6)';
													|en = '%1 = %2 (%3 + %4 + %5 + %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма фактических расходов';
													|en = 'Возможно ошибочная сумма фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму фактических расходов в стр.060 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р2С060.Значение = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С060.Значение, РасчетнаяСумма,
			Показатели.Р2С061.Значение, Показатели.Р2С062.Значение, Показатели.Р2С063.Значение, Показатели.Р2С064.Значение);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_09()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.09';
													|en = '03.09'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Фактические расходы в стр.061 Раздела 2 = стр.10000 Приложения 2 к Разделу 2 ';
			|en = 'Фактические расходы в стр.061 Раздела 2 = стр.10000 Приложения 2 к Разделу 2 '") +
		НСтр("ru = 'за 1 месяц отчетного периода';
			|en = 'за 1 месяц отчетного периода'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма фактических расходов';
													|en = 'Возможно ошибочная сумма фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму фактических расходов в стр.061 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.Раздел0.Период < "50" И НЕ Показатели.Р2С061.Значение = Показатели.П2С10000.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С061.Значение, 
			Показатели.П2С10000.Итог);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_10()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.10';
													|en = '03.10'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Фактические расходы в стр.062 Раздела 2 = стр.10000 Приложения 2 к Разделу 2 ';
			|en = 'Фактические расходы в стр.062 Раздела 2 = стр.10000 Приложения 2 к Разделу 2 '") +
		НСтр("ru = 'за 2 месяц отчетного периода';
			|en = 'за 2 месяц отчетного периода'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма фактических расходов';
													|en = 'Возможно ошибочная сумма фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму фактических расходов в стр.062 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.Раздел0.Период < "50" И НЕ Показатели.Р2С062.Значение = Показатели.П2С10000.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С062.Значение, 
			Показатели.П2С10000.Итог);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_11()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.11';
													|en = '03.11'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Фактические расходы в стр.063 Раздела 2 = стр.10000 Приложения 2 к Разделу 2 ';
			|en = 'Фактические расходы в стр.063 Раздела 2 = стр.10000 Приложения 2 к Разделу 2 '") +
		НСтр("ru = 'за 3 месяц отчетного периода';
			|en = 'за 3 месяц отчетного периода'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма фактических расходов';
													|en = 'Возможно ошибочная сумма фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму фактических расходов в стр.063 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.Раздел0.Период < "50" И НЕ Показатели.Р2С063.Значение = Показатели.П2С10000.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С063.Значение, 
			Показатели.П2С10000.Итог);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_12()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.12';
													|en = '03.12'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Фактические расходы в стр.064 Раздела 2 = стр.060 Раздела 2 ';
			|en = 'Фактические расходы в стр.064 Раздела 2 = стр.060 Раздела 2 '") +
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма фактических расходов';
													|en = 'Возможно ошибочная сумма фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму фактических расходов в стр.064 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ЗначениеЗаполнено(ДанныеКС.ОтчетПРП) 
			И НЕ Показатели.Р2С064.Значение = Показатели.Р2С060П.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С064.Значение, 
			Показатели.Р2С060П.Итог);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_13()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.13';
													|en = '03.13'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расчетные расходы в стр.070 Раздела 2 = сумме стр.071 - 074 Раздела 2';
			|en = 'Расчетные расходы в стр.070 Раздела 2 = сумме стр.071 - 074 Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4 + %5 + %6)';
													|en = '%1 = %2 (%3 + %4 + %5 + %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма расчетных расходов';
													|en = 'Возможно ошибочная сумма расчетных расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетных расходов в стр.070 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р2С070.Значение = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С070.Значение, РасчетнаяСумма,
			Показатели.Р2С071.Значение, Показатели.Р2С072.Значение, Показатели.Р2С073.Значение, Показатели.Р2С074.Значение);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_14()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.14';
													|en = '03.14'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расчетные расходы в стр.071 Раздела 2 = стр.010 Приложения 3 к Разделу 2 ';
			|en = 'Расчетные расходы в стр.071 Раздела 2 = стр.010 Приложения 3 к Разделу 2 '") +
		НСтр("ru = 'за 1 месяц отчетного периода';
			|en = 'за 1 месяц отчетного периода'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма расчетных расходов';
													|en = 'Возможно ошибочная сумма расчетных расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетных расходов в стр.071 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.Раздел0.Период < "50" И НЕ Показатели.Р2С071.Значение = Показатели.П3С010.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С071.Значение, 
			Показатели.П3С010.Итог);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_15()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.15';
													|en = '03.15'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расчетные расходы в стр.072 Раздела 2 = стр.010 Приложения 3 к Разделу 2 ';
			|en = 'Расчетные расходы в стр.072 Раздела 2 = стр.010 Приложения 3 к Разделу 2 '") +
		НСтр("ru = 'за 2 месяц отчетного периода';
			|en = 'за 2 месяц отчетного периода'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма расчетных расходов';
													|en = 'Возможно ошибочная сумма расчетных расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетных расходов в стр.072 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.Раздел0.Период < "50" И НЕ Показатели.Р2С072.Значение = Показатели.П3С010.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С072.Значение, 
			Показатели.П3С010.Итог);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_16()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.16';
													|en = '03.16'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расчетные расходы в стр.073 Раздела 2 = стр.010 Приложения 3 к Разделу 2 ';
			|en = 'Расчетные расходы в стр.073 Раздела 2 = стр.010 Приложения 3 к Разделу 2 '") +
		НСтр("ru = 'за 3 месяц отчетного периода';
			|en = 'за 3 месяц отчетного периода'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма расчетных расходов';
													|en = 'Возможно ошибочная сумма расчетных расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетных расходов в стр.073 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.Раздел0.Период < "50" И НЕ Показатели.Р2С073.Значение = Показатели.П3С010.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С073.Значение, 
			Показатели.П3С010.Итог);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_17()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.17';
													|en = '03.17'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расчетные расходы в стр.074 Раздела 2 = стр.070 Раздела 2 ';
			|en = 'Расчетные расходы в стр.074 Раздела 2 = стр.070 Раздела 2 '") +
		НСтр("ru = 'за предыдущий отчетный период';
			|en = 'за предыдущий отчетный период'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма расчетных расходов';
													|en = 'Возможно ошибочная сумма расчетных расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетных расходов в стр.074 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С074.Значение, 
			Показатели.Р2С070П.Итог);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_18()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.18';
													|en = '03.18'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Восстановленные фактические расходы в стр.080 Раздела 2 = сумме стр.081 - 082 Раздела 2';
			|en = 'Восстановленные фактические расходы в стр.080 Раздела 2 = сумме стр.081 - 082 Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4)';
													|en = '%1 = %2 (%3 + %4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма восстановленных фактических расходов';
													|en = 'Возможно ошибочная сумма восстановленных фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму восстановленных фактических расходов в стр.080 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р2С080.Значение = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С080.Значение, РасчетнаяСумма,
			Показатели.Р2С081.Значение, Показатели.Р2С082.Значение);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_19()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.19';
													|en = '03.19'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Восстановленные фактические расходы в стр.081 Раздела 2 = стр.020 Приложения 4 ';
			|en = 'Восстановленные фактические расходы в стр.081 Раздела 2 = стр.020 Приложения 4 '") +
		НСтр("ru = 'к Разделу 2';
			|en = 'к Разделу 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма восстановленных фактических расходов';
													|en = 'Возможно ошибочная сумма восстановленных фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму восстановленных фактических расходов в стр.081 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р2С081.Значение = Показатели.П4С020.Значение;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С081.Значение, 
			Показатели.П4С020.Значение);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_20()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.20';
													|en = '03.20'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Восстановленные фактические расходы в стр.082 Раздела 2 = стр.080 Раздела 2 ';
			|en = 'Восстановленные фактические расходы в стр.082 Раздела 2 = стр.080 Раздела 2 '") +
		НСтр("ru = 'за предыдущий отчетный период';
			|en = 'за предыдущий отчетный период'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма восстановленных фактических расходов';
													|en = 'Возможно ошибочная сумма восстановленных фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму восстановленных фактических расходов в стр.082 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С082.Значение, Показатели.Р2С080П.Итог);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_21()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.21';
													|en = '03.21'"));
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '+ стр.085) Раздела 2, если результат >= 0, иначе 0';
			|en = '+ стр.085) Раздела 2, если результат >= 0, иначе 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %9 (%2 - %3 - %4 + %5 + %6 - %7 + %8)';
													|en = '%1 = %9 (%2 - %3 - %4 + %5 + %6 - %7 + %8)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма дополнительного дохода';
													|en = 'Возможно ошибочная сумма дополнительного дохода'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму дополнительного дохода в стр.090 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р2С090.Значение = Макс(0, РасчетнаяСумма);
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
...
Процедура ПроверкаКС_3_22()
	...
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму убытка в стр.095 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		РасчетнаяСумма = Показатели.Р2С050.Значение - Показатели.Р2С060.Значение - Показатели.Р2С070.Значение 
			+ Показатели.Р2С080.Значение + Показатели.Р2С083.Значение - Показатели.Р2С084.Значение + Показатели.Р2С085.Значение;
		НастройкиКС.ЭтоОшибка = НЕ -Показатели.Р2С095.Значение = Мин(0, РасчетнаяСумма);
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
...
Процедура ПроверкаКС_3_23()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.23';
													|en = '03.23'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма убытка в стр.100 Раздела 2 = стр.300 Приложения 6 к Разделу 2';
			|en = 'Сумма убытка в стр.100 Раздела 2 = стр.300 Приложения 6 к Разделу 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма убытка';
													|en = 'Возможно ошибочная сумма убытка'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите сумму убытка из стр.300 Приложения 6");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р2С100.Значение = Показатели.П6С300.Значение;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С100.Значение, 
			Показатели.П6С300.Значение);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_24()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.24';
													|en = '03.24'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Налоговая база в стр.110 Раздела 2 = (стр.090 - стр.100) Раздела 2, если результат >= 0, ';
			|en = 'Налоговая база в стр.110 Раздела 2 = (стр.090 - стр.100) Раздела 2, если результат >= 0, '") +
		НСтр("ru = 'иначе 0';
			|en = 'иначе 0'"));
	...
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налоговой базы в стр.110 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		РасчетнаяСумма = Макс(0, Показатели.Р2С090.Значение - Показатели.Р2С100.Значение);
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р2С110.Значение = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
...
Процедура ПроверкаКС_3_25()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.25';
													|en = '03.25'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Налоговая ставка в стр.120 Раздела 2 = ставке налога, установленной ст.333.54 НК РФ';
			|en = 'Налоговая ставка в стр.120 Раздела 2 = ставке налога, установленной ст.333.54 НК РФ'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная ставка налога';
													|en = 'Возможно ошибочная ставка налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните ставку налога в стр.120 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ЗначениеЗаполнено(Показатели.Р2С120.Значение) И НЕ Показатели.Р2С120.Значение = СтавкаНалога;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С120.Значение, СтавкаНалога);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_26()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.26';
													|en = '03.26'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 * %3 / 100)';
													|en = '%1 = %4 (%2 * %3 / 100)'"));
	...
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму исчисленного налога в стр.130 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р2С130.Значение = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
...
Процедура ПроверкаКС_3_27()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.27';
													|en = '03.27'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма минимального налога';
													|en = 'Возможно ошибочная сумма минимального налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму минимального налога в стр.135 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р2С135.Значение = 0
			ИЛИ НЕ УсловиеВыполнено И НЕ Показатели.Р2С135.Значение = Показатели.П7С900.Значение;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С135.Значение,
...
Процедура ПроверкаКС_3_28()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.28';
													|en = '03.28'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма авансовых платежей в стр.140 Раздела 2 = стр.130 Раздела 2 ';
			|en = 'Сумма авансовых платежей в стр.140 Раздела 2 = стр.130 Раздела 2 '") +
	...
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансовых платежей в стр.140 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С140.Значение, РасчетнаяСумма);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_29()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.29';
													|en = '03.29'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога к доплате в стр.150 Раздела 2 = разности стр.130 Раздела 2 ';
			|en = 'Сумма налога к доплате в стр.150 Раздела 2 = разности стр.130 Раздела 2 '") +
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 - %3)';
													|en = '%1 = %4 (%2 - %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога к доплате';
													|en = 'Возможно ошибочная сумма налога к доплате'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога к доплате в стр.150 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		РасчетнаяСумма = Макс(0, СуммаНалога - Показатели.Р2С140.Значение);
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р2С150.Значение = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации	, 
...
Процедура ПроверкаКС_3_30()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.30';
													|en = '03.30'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога к уменьшению в стр.160 Раздела 2 = разности стр.140 Раздела 2 и ';
			|en = 'Сумма налога к уменьшению в стр.160 Раздела 2 = разности стр.140 Раздела 2 и '") +
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 - %3)';
													|en = '%1 = %4 (%2 - %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога к уменьшению';
													|en = 'Возможно ошибочная сумма налога к уменьшению'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога к уменьшению в стр.160 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р2С160.Значение = Макс(0, РасчетнаяСумма);
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
...
Процедура ПроверкаКС_3_31()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 > 0, если %2 > 0';
													|en = '%1 > 0, если %2 > 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение количества нефти и газа';
													|en = 'Возможно ошибочное значение количества нефти и газа'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните количество нефти и газа в одной из стр.030, 070, 100 Приложения 1");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = РасчетнаяСумма2 > 0 И НЕ РасчетнаяСумма1 > 0;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, РасчетнаяСумма1, РасчетнаяСумма2);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_34_доп()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.34.доп';
													|en = '03.34.доп'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение КБК';
													|en = 'Возможно ошибочное значение КБК'"));
	Заголовки.Вставить("Рекомендации"		, "Внесите значение КБК в стр.020 Раздела 1");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Проверка носит справочный характер';
													|en = 'Проверка носит справочный характер'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		Показатели.Р1С020.ЗначениеСтр = ?(НастройкиКС.ЭтоОшибка, "(...)", Показатели.Р2С005.ЗначениеСтр);
		НастройкиКС.ЭтоОшибка = НастройкиКС.ЭтоОшибка И ЗначениеЗаполнено(Показатели.Р2С005.Значение);
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С005.ЗначениеСтр, 
			Показатели.Р1С020.ЗначениеСтр);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_35_доп()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.35.доп';
													|en = '03.35.доп'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расчетная выручка в стр.054 Раздела 2 = стр.050 Раздела 2 ';
			|en = 'Расчетная выручка в стр.054 Раздела 2 = стр.050 Раздела 2 '") +
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма расчетной выручки';
													|en = 'Возможно ошибочная сумма расчетной выручки'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетной выручки в стр.054 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Проверка носит справочный характер';
													|en = 'Проверка носит справочный характер'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С054.Значение, 
			Показатели.Р2С050П.Итог, Показатели.Р2С056.Значение, РасчетнаяСумма);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
&НаСервере
Процедура ПроверкаКС_3_36_доп()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '03.36.доп';
													|en = '03.36.доп'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Доходы от аренды в стр.056 Раздела 2 = сумме стр.055, 056 Раздела 2 ';
			|en = 'Доходы от аренды в стр.056 Раздела 2 = сумме стр.055, 056 Раздела 2 '") +
		НСтр("ru = 'за предыдущий отчетный период';
			|en = 'за предыдущий отчетный период'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 + %3)';
													|en = '%1 = %4 (%2 + %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма доходов от аренды';
													|en = 'Возможно ошибочная сумма доходов от аренды'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму доходов от аренды в стр.056 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Проверка носит справочный характер';
													|en = 'Проверка носит справочный характер'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р2С056.Значение, 
			Показатели.Р2С055П.Итог, Показатели.Р2С056П.Итог, РасчетнаяСумма);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, Раздел2.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_4_01()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '04.01';
													|en = '04.01'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Значение месяца в стр.007 Приложения 1 = 01, 02, 03 для отчета за 1 квартал, ';
			|en = 'Значение месяца в стр.007 Приложения 1 = 01, 02, 03 для отчета за 1 квартал, '") +
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочный месяц отчетного периода';
													|en = 'Возможно ошибочный месяц отчетного периода'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите месяц из текущего отчетного периода");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00101М1 Цикл
			...
			НастройкиКС.ЭтоОшибка =  ДанныеКС.Раздел0.Период < "50" И ЗначениеЗаполнено(Показатели.П1С007.Значение) 
				И МассивМесяцев.Найти(Показатели.П1С007.Значение) = Неопределено;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П1С007.ЗначениеСтр, СтрокаМесяцев);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_4_02()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма расчетной выручки';
													|en = 'Возможно ошибочная сумма расчетной выручки'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетной выручки в стр.010 Приложения 1");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	
	НастройкиКС.Вставить("ШаблонДетализации2", "%1 х %2 х %3 х %4 + %5 х %6 + %7 х %8 х %9"); 
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00101М1 Цикл
			...
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П1С010.Значение = РасчетнаяСумма;
			СтрокаДетализации = СтрШаблон(НастройкиКС.ШаблонДетализации2, Показатели.П1С020.Значение, 
				Показатели.П1С030.Значение, Показатели.П1С040.Значение, Показатели.П1С050.Значение, 
				Показатели.П1С060.Значение, Показатели.П1С070.Значение, Показатели.П1С080.Значение,
				Показатели.П1С090.Значение, Показатели.П1С100.Значение);
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П1С010.Значение, РасчетнаяСумма, 
				СтрокаДетализации);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_4_03()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение кода источника цены';
													|en = 'Возможно ошибочное значение кода источника цены'"));
	Заголовки.Вставить("Рекомендации"		, "Выберите код источника цены в стр.055 Приложения 1 из списка значений");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Если НЕ Список = Неопределено Тогда
		Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
			Для Счетчик = 1 По Раздел2.КолвоСтрокП00101М1 Цикл
				...
				НастройкиКС.ЭтоОшибка = Список.Получить(Показатели.П1С055.Значение) = Неопределено;
				НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П1С055.ЗначениеСтр);
				ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_4_04()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение коэффициента для попутного газа';
													|en = 'Возможно ошибочное значение коэффициента для попутного газа'"));
	Заголовки.Вставить("Рекомендации"		, 
		"Выберите значение коэффициента для попутного газа в стр.080 Приложения 1 из списка значений");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Если НЕ Список = Неопределено Тогда
		Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
			Для Счетчик = 1 По Раздел2.КолвоСтрокП00101М1 Цикл
				...
				НастройкиКС.ЭтоОшибка = Список.Получить(Показатели.П1С080.Значение) = Неопределено;
				НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П1С080.Значение);
				ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_4_05()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '04.05';
													|en = '04.05'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Количество попутного газа в стр.100 Приложения 1 = (стр.091 - стр.092) Приложения 1';
			|en = 'Количество попутного газа в стр.100 Приложения 1 = (стр.091 - стр.092) Приложения 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 - %3)';
													|en = '%1 = %4 (%2 - %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение количества попутного газа';
													|en = 'Возможно ошибочное значение количества попутного газа'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение количества попутного газа в стр.100 Приложения 1");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00101М1 Цикл
			...
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П1С100.Значение = РасчетнаяСумма;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П1С100.Значение,
...
Процедура ПроверкаКС_4_06()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 + %3)';
													|en = '%1 = %4 (%2 + %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение количества нефти и газового конденсата';
													|en = 'Возможно ошибочное значение количества нефти и газового конденсата'"));
	Заголовки.Вставить("Рекомендации"		, 
		"Уточните значение количества нефти и газового конденсата в стр.030 Приложения 1");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00101М1 Цикл
			...
			НастройкиКС.ЭтоОшибка = ЗначениеЗаполнено(РасчетнаяСумма) И НЕ Показатели.П1С030.Значение = РасчетнаяСумма;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П1С030.Значение, 
...
Процедура ПроверкаКС_5_01()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '05.01';
													|en = '05.01'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Значение месяца в стр.00007 Приложения 2 = 01, 02, 03 для отчета за 1 квартал, ';
			|en = 'Значение месяца в стр.00007 Приложения 2 = 01, 02, 03 для отчета за 1 квартал, '") +
		НСтр("ru = '04, 05, 06 для отчета за полугодие, 07, 08, 09 для отчета за 9 месяцев, 10, 11, 12 для отчета ';
			|en = '04, 05, 06 для отчета за полугодие, 07, 08, 09 для отчета за 9 месяцев, 10, 11, 12 для отчета '") +
		НСтр("ru = 'за налоговый период';
			|en = 'за налоговый период'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение месяца отчетного периода';
													|en = 'Возможно ошибочное значение месяца отчетного периода'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите месяц из текущего отчетного периода");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00102М1 Цикл
			...
			НастройкиКС.ЭтоОшибка =  ДанныеКС.Раздел0.Период < "50" И ЗначениеЗаполнено(Показатели.П2С00007.Значение) 
				И МассивМесяцев.Найти(Показатели.П2С00007.Значение) = Неопределено;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П2С00007.ЗначениеСтр, СтрокаМесяцев);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_5_02()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '05.02';
													|en = '05.02'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Фактические расходы в стр.10000 Приложения 2 = сумме стр.20000 и 30000 Приложения 2';
			|en = 'Фактические расходы в стр.10000 Приложения 2 = сумме стр.20000 и 30000 Приложения 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4)';
													|en = '%1 = %2 (%3 + %4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма фактических расходов';
													|en = 'Возможно ошибочная сумма фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму фактических расходов в стр.10000 Приложения 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00102М1 Цикл
			...
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П2С10000.Значение = РасчетнаяСумма;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П2С10000.Значение, РасчетнаяСумма, 
				Показатели.П2С20000.Значение, Показатели.П2С30000.Значение);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_5_03()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '05.03';
													|en = '05.03'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Фактические расходы в стр.30000 Приложения 2 = сумме стр.30100, 30200, 30300, ';
			|en = 'Фактические расходы в стр.30000 Приложения 2 = сумме стр.30100, 30200, 30300, '") +
		НСтр("ru = '30400, 30500, 30600, 30700, 30800, 30900, 31000, 32000, 33000 Приложения 2';
			|en = '30400, 30500, 30600, 30700, 30800, 30900, 31000, 32000, 33000 Приложения 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма фактических расходов';
													|en = 'Возможно ошибочная сумма фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму фактических расходов в стр.30000 Приложения 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	ИменаПоказателей.Вставить("П2С33000"	, "П00102М133000_");
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00102М1 Цикл
			...
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П2С30000.Значение = РасчетнаяСумма;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П2С30000.Значение, РасчетнаяСумма);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_5_04()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '05.04';
													|en = '05.04'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расходы в стр.30700 Приложения 2 = сумме стр.30701 - 30734 Приложения 2';
			|en = 'Расходы в стр.30700 Приложения 2 = сумме стр.30701 - 30734 Приложения 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма фактических расходов';
													|en = 'Возможно ошибочная сумма фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму фактических расходов в стр.30700 Приложения 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	ИменаПоказателей.Вставить("П2С30734"	, "П00102М130734_");
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00102М1 Цикл
			...
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П2С30700.Значение = РасчетнаяСумма;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П2С30700.Значение, РасчетнаяСумма);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_5_05()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '05.05';
													|en = '05.05'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расходы в стр.31000 Приложения 2 = сумме стр.31010 - 31050 Приложения 2';
			|en = 'Расходы в стр.31000 Приложения 2 = сумме стр.31010 - 31050 Приложения 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4 + %5 + %6 + %7)';
													|en = '%1 = %2 (%3 + %4 + %5 + %6 + %7)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма фактических расходов';
													|en = 'Возможно ошибочная сумма фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму фактических расходов в стр.31000 Приложения 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00102М1 Цикл
			...
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П2С31000.Значение = РасчетнаяСумма;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П2С31000.Значение, РасчетнаяСумма, 
				Показатели.П2С31010.Значение, Показатели.П2С31020.Значение, Показатели.П2С31030.Значение, 
				Показатели.П2С31040.Значение, Показатели.П2С31050.Значение, );
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_5_06()
	...
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расходов в стр.20000 Приложения 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00102М1 Цикл
			...
			НастройкиКС.ЭтоОшибка = Показатели.П2С20000.Значение < Показатели.П2С21000.Значение;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П2С20000.Значение, 
				Показатели.П2С21000.Значение);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_6_01()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '06.01';
													|en = '06.01'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Значение месяца в стр.007 Приложения 3 = 01, 02, 03 для отчета за 1 квартал, ';
			|en = 'Значение месяца в стр.007 Приложения 3 = 01, 02, 03 для отчета за 1 квартал, '") +
		НСтр("ru = '04, 05, 06 для отчета за полугодие, 07, 08, 09 для отчета за 9 месяцев, 10, 11, 12 для отчета ';
			|en = '04, 05, 06 для отчета за полугодие, 07, 08, 09 для отчета за 9 месяцев, 10, 11, 12 для отчета '") +
		НСтр("ru = 'за налоговый период';
			|en = 'за налоговый период'"));
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00103М1 Цикл
			...
			НастройкиКС.ЭтоОшибка =  ДанныеКС.Раздел0.Период < "50" И ЗначениеЗаполнено(Показатели.П3С007.Значение) 
				И МассивМесяцев.Найти(Показатели.П3С007.Значение) = Неопределено;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П3С007.ЗначениеСтр, СтрокаМесяцев);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_6_02()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '06.02';
													|en = '06.02'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расчетные расходы в стр.010 Приложения 3 = (стр.020 + стр.070) Приложения 3';
			|en = 'Расчетные расходы в стр.010 Приложения 3 = (стр.020 + стр.070) Приложения 3'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4)';
													|en = '%1 = %2 (%3 + %4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма расчетных расходов';
													|en = 'Возможно ошибочная сумма расчетных расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетных расходов в стр.010 Приложения 3");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00103М1 Цикл
			...
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П3С010.Значение = РасчетнаяСумма;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П3С010.Значение, РасчетнаяСумма, 
				Показатели.П3С020.Значение, Показатели.П3С070.Значение, );
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_6_03()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 х %4 х (%5 + %6))';
													|en = '%1 = %2 (%3 х %4 х (%5 + %6))'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма таможенной пошлины';
													|en = 'Возможно ошибочная сумма таможенной пошлины'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму таможенной пошлины в стр.020 Приложения 3");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00103М1 Цикл
			...
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П3С020.Значение = РасчетнаяСумма;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П3С020.Значение, РасчетнаяСумма, 
				Показатели.П3С030.Значение, Показатели.П3С040.Значение, Показатели.П3С050.Значение, Показатели.П3С060.Значение);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_6_04()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма расчетных расходов';
													|en = 'Возможно ошибочная сумма расчетных расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетных расходов в стр.070 Приложения 3");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00103М1 Цикл
			...
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П3С070.Значение = РасчетнаяСумма;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П3С070.Значение, РасчетнаяСумма, 
				Показатели.П3С080.Значение, Показатели.П3С090.Значение);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_6_05()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '06.05';
													|en = '06.05'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Количество нефти и газового конденсата в стр.090 Приложения 3 = (стр.050 + стр.060) ';
			|en = 'Количество нефти и газового конденсата в стр.090 Приложения 3 = (стр.050 + стр.060) '") +
		НСтр("ru = 'Приложения 3';
			|en = 'Приложения 3'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 + %4)';
													|en = '%1 = %2 (%3 + %4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное количество нефти и газового конденсата';
													|en = 'Возможно ошибочное количество нефти и газового конденсата'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните количество нефти и газового конденсата в стр.090 Приложения 3");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00103М1 Цикл
			...
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П3С090.Значение = РасчетнаяСумма;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П3С090.Значение, РасчетнаяСумма, 
				Показатели.П3С050.Значение, Показатели.П3С060.Значение);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_7_01()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение кода основания';
													|en = 'Возможно ошибочное значение кода основания'"));
	Заголовки.Вставить("Рекомендации"		, "Выберите код основания из списка значений");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Если НЕ Список = Неопределено Тогда
		Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
			Для Счетчик = 1 По Раздел2.КолвоСтрокП00104М1 Цикл
				...
				НастройкиКС.ЭтоОшибка = Список.Получить(Показатели.П4С010.Значение) = Неопределено;
				НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П4С010.ЗначениеСтр);
				ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_7_02()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение признака номера';
													|en = 'Возможно ошибочное значение признака номера'"));
	Заголовки.Вставить("Рекомендации"		, "Выберите признак номера из списка значений");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Если НЕ Список = Неопределено Тогда
		Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
			Для Счетчик = 1 По Раздел2.КолвоСтрокП00104М1 Цикл
				...
				НастройкиКС.ЭтоОшибка = Список.Получить(Показатели.П4С012.Значение) = Неопределено;
				НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П4С012.ЗначениеСтр);
				ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_7_03()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение коэффициента индексации убытка';
													|en = 'Возможно ошибочное значение коэффициента индексации убытка'"));
	Заголовки.Вставить("Рекомендации"		, "Выберите коэффициент индексации убытка из списка значений");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("П4С015"		, "П00104М201503_");
	...
	Если НЕ Список = Неопределено Тогда
		Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
			Для Счетчик = 1 По Раздел2.КолвоСтрокП00104М1 Цикл
				...
				Для Счетчик2 = 1 По Раздел2["КолвоСтрокП00104М2_" + XMLСтрока(Счетчик)] Цикл
					
					ЗарегистрироватьПроверку();
					МассивНомеровСтрок.Установить(1, XMLСтрока(Счетчик2));
					ЗаполнитьИРасшифроватьПоказатель(Показатели.П4С015, Раздел2, МассивНомеровСтрок);
					
					НастройкиКС.ЭтоОшибка = Список.Получить(Показатели.П4С015.Значение) = Неопределено;
					НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П4С015.Значение);
					ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_7_04()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '07.04';
													|en = '07.04'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Восстановленные фактические расходы в стр.017 Приложения 4 = стр.014 х все Кинд в стр.015 ';
			|en = 'Восстановленные фактические расходы в стр.017 Приложения 4 = стр.014 х все Кинд в стр.015 '") +
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма восстановленных фактических расходов';
													|en = 'Возможно ошибочная сумма восстановленных фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму восстановленных фактических расходов в стр.017 Приложения 4");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'")); 
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00104М1 Цикл
			...
			ЗаполнитьИРасшифроватьПоказатель(Показатели.П4С014, Раздел2, Счетчик);
			
			Для Счетчик2 = 1 По Раздел2["КолвоСтрокП00104М2_" + XMLСтрока(Счетчик)] Цикл
				МассивНомеровСтрок.Установить(1, XMLСтрока(Счетчик2));
				ЗаполнитьИРасшифроватьПоказатель(Показатели.П4С015, Раздел2, МассивНомеровСтрок);
				МассивЗначений.Добавить(Показатели.П4С015.Значение);
				РасчетнаяСумма = РасчетнаяСумма * Показатели.П4С015.Значение; 
			КонецЦикла;
			
			РасчетнаяСумма = Окр(Показатели.П4С014.Значение * РасчетнаяСумма);
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П4С017.Значение = РасчетнаяСумма;
			Расшифровка2 = СтрСоединить(МассивЗначений, " х ");
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П4С017.Значение, 
				РасчетнаяСумма, Показатели.П4С014.Значение, Расшифровка2);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_7_05()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '07.05';
													|en = '07.05'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Восстановленные фактические расходы в стр.020 Приложения 4 = сумме всех стр.017 ';
			|en = 'Восстановленные фактические расходы в стр.020 Приложения 4 = сумме всех стр.017 '") +
		НСтр("ru = 'Приложения 4';
			|en = 'Приложения 4'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма восстановленных фактических расходов';
													|en = 'Возможно ошибочная сумма восстановленных фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму восстановленных фактических расходов в стр.020 Приложения 4");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.П4С020.Значение = Показатели.П4С017.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П4С020.Значение, 
			Показатели.П4С017.Итог);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_8_01()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '08.01';
													|en = '08.01'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма убытка в стр.100 Приложения 5 = сумме группы строк 101 Приложения 5 за ';
			|en = 'Сумма убытка в стр.100 Приложения 5 = сумме группы строк 101 Приложения 5 за '") +
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма убытка';
													|en = 'Возможно ошибочная сумма убытка'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму убытка в стр.100 Приложения 5");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для каждого Приложение5 Из Раздел2.Приложение5 Цикл
			...
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П5С100.Значение = Показатели.П5С103.Итог;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П5С100.Значение, 
				Показатели.П5С103.Итог);
			ДополнитьТаблицуРезультата();
...
&НаСервере
Процедура ПроверкаКС_8_02_1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 5';
														|en = 'Приложение 5'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '08.02.1';
													|en = '08.02.1'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, 
		НСтр("ru = '%1 = 1,163 если %2 = 101 - 107, 143 - 153, 158 - 172, 176 - 181, 185, 218 - 273 и %3 <= 2019';
			|en = '%1 = 1,163 если %2 = 101 - 107, 143 - 153, 158 - 172, 176 - 181, 185, 218 - 273 и %3 <= 2019'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение коэффициента индексации убытка';
													|en = 'Возможно ошибочное значение коэффициента индексации убытка'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите значение коэффициента индексации убытка 1,163");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для каждого Приложение5 Из Раздел2.Приложение5 Цикл
			...
			НастройкиКС.ЭтоОшибка = ЗначениеЗаполнено(Показатели.П5С020.Значение) И КлючВСписке 
			...
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П5С020.Значение,
...
&НаСервере
Процедура ПроверкаКС_8_02_2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 5';
														|en = 'Приложение 5'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '08.02.2';
													|en = '08.02.2'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 1,163 если %2 = 173 - 175';
													|en = '%1 = 1,163 если %2 = 173 - 175'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение коэффициента индексации убытка';
													|en = 'Возможно ошибочное значение коэффициента индексации убытка'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите значение коэффициента индексации убытка 1,163");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
	...
	НастройкиКС.Вставить("ИсточникНСИ", "КомплектНСИ_1в");
	ПроверкаКС_8_02_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_8_02_3()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 5';
														|en = 'Приложение 5'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '08.02.3';
													|en = '08.02.3'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 1,1 если %2 = 101 - 106 и %3 > 2019';
													|en = '%1 = 1,1 если %2 = 101 - 106 и %3 > 2019'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение коэффициента индексации убытка';
													|en = 'Возможно ошибочное значение коэффициента индексации убытка'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите значение коэффициента индексации убытка 1,1");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
...
&НаСервере
Процедура ПроверкаКС_8_02_4()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 5';
														|en = 'Приложение 5'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '08.02.4';
													|en = '08.02.4'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, 
		НСтр("ru = '%1 = 1,07 если %2 = 107, 143 - 153, 158 - 172, 176 - 181, 185, 218 - 273 и %3 > 2019';
			|en = '%1 = 1,07 если %2 = 107, 143 - 153, 158 - 172, 176 - 181, 185, 218 - 273 и %3 > 2019'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение коэффициента индексации убытка';
													|en = 'Возможно ошибочное значение коэффициента индексации убытка'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите значение коэффициента индексации убытка 1,07");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_8_03()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '08.03';
													|en = '08.03'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Значение года в группе строк 101 Приложения 5 < значения года в стр.010 Приложения 5';
			|en = 'Значение года в группе строк 101 Приложения 5 < значения года в стр.010 Приложения 5'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 < %2';
													|en = '%1 < %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение года';
													|en = 'Возможно ошибочное значение года'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение года в группе строк 101 Приложения 5");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для каждого Приложение5 Из Раздел2.Приложение5 Цикл
			...
			Для Счетчик = 1 По Приложение5.КолвоСтрокП00105М1 Цикл
				...
				НастройкиКС.ЭтоОшибка = НастройкиКС.ЭтоОшибка ИЛИ ЗначениеЗаполнено(Показатели.П5С010.Значение) 
			...
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, СтрСоединить(МассивГодов, ", "), 
				Показатели.П5С010.ЗначениеСтр);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_8_04()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '08.04';
													|en = '08.04'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Значение года в группе строк 701 Приложения 5 < значения года в стр.010 Приложения 5';
			|en = 'Значение года в группе строк 701 Приложения 5 < значения года в стр.010 Приложения 5'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 < %2';
													|en = '%1 < %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение года';
													|en = 'Возможно ошибочное значение года'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение года в группе строк 701 Приложения 5");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_8_05()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 - %4 - %5 + %6)';
													|en = '%1 = %2 (%3 - %4 - %5 + %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма финансового результата';
													|en = 'Возможно ошибочная сумма финансового результата'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму финансового результата в стр.600 Приложения 5");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для каждого Приложение5 Из Раздел2.Приложение5 Цикл
			...
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П5С600.Значение = РасчетнаяСумма;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П5С600.Значение, РасчетнаяСумма, 
				Показатели.П5С200.Значение, Показатели.П5С300.Значение, Показатели.П5С400.Значение, Показатели.П5С500.Значение);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_8_06()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма убытка';
													|en = 'Возможно ошибочная сумма убытка'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму убытка в стр.650 Приложения 5");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для каждого Приложение5 Из Раздел2.Приложение5 Цикл
			...
			РасчетнаяСумма = - Мин(Показатели.П5С200.Значение - Показатели.П5С300.Значение - Показатели.П5С400.Значение 
				+ Показатели.П5С500.Значение, 0);
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П5С650.Значение = РасчетнаяСумма;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П5С650.Значение, РасчетнаяСумма,
				Показатели.П5С200.Значение, Показатели.П5С300.Значение, Показатели.П5С400.Значение, Показатели.П5С500.Значение);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_8_07()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '08.07';
													|en = '08.07'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма убытка в стр.700 Приложения 5 = сумме группы строк 701 Приложения 5 за ';
			|en = 'Сумма убытка в стр.700 Приложения 5 = сумме группы строк 701 Приложения 5 за '") +
		НСтр("ru = 'соответствующие годы';
			|en = 'соответствующие годы'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма убытка';
													|en = 'Возможно ошибочная сумма убытка'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму убытка в стр.700 Приложения 5");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для каждого Приложение5 Из Раздел2.Приложение5 Цикл
			...
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П5С700.Значение = Показатели.П5С703.Итог;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П5С700.Значение, 
				Показатели.П5С703.Итог);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_8_08()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '08.08';
													|en = '08.08'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма убытка в стр.800 Приложения 5 = сумме группы строк 801 Приложения 5 за ';
			|en = 'Сумма убытка в стр.800 Приложения 5 = сумме группы строк 801 Приложения 5 за '") +
		НСтр("ru = 'соответствующие годы';
			|en = 'соответствующие годы'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма убытка';
													|en = 'Возможно ошибочная сумма убытка'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму убытка в стр.800 Приложения 5");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		Для каждого Приложение5 Из Раздел2.Приложение5 Цикл
			...
			НастройкиКС.ЭтоОшибка = НЕ Показатели.П5С800.Значение = Показатели.П5С803.Итог;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П5С800.Значение, 
				Показатели.П5С803.Итог);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_9_01()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '09.01';
													|en = '09.01'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма убытка в стр.100 Приложения 6 = сумме группы строк 101 Приложения 6';
			|en = 'Сумма убытка в стр.100 Приложения 6 = сумме группы строк 101 Приложения 6'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма убытка';
													|en = 'Возможно ошибочная сумма убытка'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму убытка в стр.100 Приложения 6");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.П6С100.Значение = Показатели.П6С103.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П6С100.Значение, 
			Показатели.П6С103.Итог);
		ДополнитьТаблицуРезультата();
...
&НаСервере
Процедура ПроверкаКС_9_02_1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 6';
														|en = 'Приложение 6'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '09.02.1';
													|en = '09.02.1'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 1,1 когда %2 = 101 - 106';
	...
	НастройкиКС.Вставить("ИсточникНСИ", "КомплектНСИ_1а");
	ПроверкаКС_9_02_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_9_02_2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 6';
														|en = 'Приложение 6'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '09.02.2';
													|en = '09.02.2'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 1,07 когда %2 = 107 - 172, 176 - 187, 218 - 273';
	...
	НастройкиКС.Вставить("ИсточникНСИ", "КомплектНСИ_1б");
	ПроверкаКС_9_02_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_9_02_3()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 6';
														|en = 'Приложение 6'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '09.02.3';
													|en = '09.02.3'"));
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'стр.030 Раздела 2 = 173 - 175';
			|en = 'стр.030 Раздела 2 = 173 - 175'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 1,163 когда %2 = 173 - 175';
...
Процедура ПроверкаКС_9_02_код()
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		РасчетноеЗначение = ДанныеКС[НастройкиКС.ИсточникНСИ].Получить(Показатели.Р2С030.Значение);
		КлючВСписке = НЕ РасчетноеЗначение = Неопределено;
		НастройкиКС.ЭтоОшибка = ЗначениеЗаполнено(Раздел2.Приложение6Включено) И ЗначениеЗаполнено(Показатели.П6С010.Значение)
			И КлючВСписке И НЕ Показатели.П6С010.Значение = РасчетноеЗначение;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П6С010.Значение, 
			Показатели.Р2С030.ЗначениеСтр);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_9_03()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '09.03';
													|en = '09.03'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Значение года в группе строк 101 Приложения 6 < значения отчетного года на ';
			|en = 'Значение года в группе строк 101 Приложения 6 < значения отчетного года на '") +
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение года';
													|en = 'Возможно ошибочное значение года'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение года в группе строк 101 Приложения 6");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00106М1 Цикл
			...
			НастройкиКС.ЭтоОшибка = НастройкиКС.ЭтоОшибка ИЛИ ЗначениеЗаполнено(Показатели.Р0С002.Значение) 
...
Процедура ПроверкаКС_9_04()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '09.04';
													|en = '09.04'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Значение года в группе строк 301 Приложения 6 < значения отчетного года на ';
			|en = 'Значение года в группе строк 301 Приложения 6 < значения отчетного года на '") +
		НСтр("ru = 'титульном листе';
			|en = 'титульном листе'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 < %2';
													|en = '%1 < %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение года';
													|en = 'Возможно ошибочное значение года'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение года в группе строк 301 Приложения 6");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_9_05()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '09.05';
													|en = '09.05'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Дополнительный доход в стр.200 Приложения 6 = стр.090 Раздела 2, ';
			|en = 'Дополнительный доход в стр.200 Приложения 6 = стр.090 Раздела 2, '") +
	...
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму дохода в стр.200 Приложения 6");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ЗначениеЗаполнено(Раздел2.Приложение6Включено) 
			И НЕ Показатели.П6С200.Значение = Показатели.Р2С090.Значение;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П6С200.Значение, 
			Показатели.Р2С090.Значение);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_9_06()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '09.06';
													|en = '09.06'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Убыток в стр.250 Приложения 6 = стр.095 Раздела 2, ';
			|en = 'Убыток в стр.250 Приложения 6 = стр.095 Раздела 2, '") +
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма убытка';
													|en = 'Возможно ошибочная сумма убытка'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму убытка в стр.250 Приложения 6");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = УсловиеВыполнено И ЗначениеЗаполнено(Раздел2.Приложение6Включено) 
			И НЕ Показатели.П6С250.Значение = Показатели.Р2С095.Значение;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П6С250.Значение, 
			Показатели.Р2С095.Значение);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_9_07()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '09.07';
													|en = '09.07'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма убытка в стр.300 Приложения 6 = сумме группы строк 301 Приложения 6';
			|en = 'Сумма убытка в стр.300 Приложения 6 = сумме группы строк 301 Приложения 6'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма убытка';
													|en = 'Возможно ошибочная сумма убытка'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму убытка в стр.300 Приложения 6");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.П6С300.Значение = Показатели.П6С303.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П6С300.Значение, 
			Показатели.П6С303.Итог);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_9_08()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '09.08';
													|en = '09.08'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма убытка в стр.400 Приложения 6 = сумме группы строк 401 Приложения 6';
			|en = 'Сумма убытка в стр.400 Приложения 6 = сумме группы строк 401 Приложения 6'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма убытка';
													|en = 'Возможно ошибочная сумма убытка'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму убытка в стр.400 Приложения 6");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.П6С400.Значение = Показатели.П6С403.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П6С400.Значение, 
			Показатели.П6С403.Итог);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_9_09()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '09.09';
													|en = '09.09'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма убытка в стр.100 Приложения 6 = стр.400 Приложения 6 ';
			|en = 'Сумма убытка в стр.100 Приложения 6 = стр.400 Приложения 6 '") +
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ЗначениеЗаполнено(ДанныеКС.ОтчетПНП) И ЗначениеЗаполнено(Раздел2.Приложение6Включено) 
			И НЕ Показатели.П6С100.Значение = Показатели.П6С400Н.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П6С100.Значение, 
			Показатели.П6С400Н.Итог);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_10_01()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.01';
													|en = '10.01'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расчетная выручка в стр.100 Приложения 7 = стр.050 Раздела 2, ';
			|en = 'Расчетная выручка в стр.100 Приложения 7 = стр.050 Раздела 2, '") +
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма расчетной выручки';
													|en = 'Возможно ошибочная сумма расчетной выручки'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетной выручки в стр.100 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ЗначениеЗаполнено(Раздел2.Приложение7Включено) 
			И НЕ Показатели.П7С100.Значение = Показатели.Р2С050.Значение;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П7С100.Значение, 
...
Процедура ПроверкаКС_10_02()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.02';
													|en = '10.02'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расчетные расходы в стр.200 Приложения 7 = стр.070 Раздела 2, ';
			|en = 'Расчетные расходы в стр.200 Приложения 7 = стр.070 Раздела 2, '") +
		НСтр("ru = 'если Приложение 7 включено в отчет';
			|en = 'если Приложение 7 включено в отчет'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма расчетных расходов';
													|en = 'Возможно ошибочная сумма расчетных расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетных расходов в стр.200 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П7С200.Значение, 
			Показатели.Р2С070.Значение);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_10_03_01()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.03.01';
													|en = '10.03.01'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, когда %3 = 01';
													|en = '%1 = %2, когда %3 = 01'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение количества добытой нефти';
													|en = 'Возможно ошибочное значение количества добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение количества добытой нефти в стр.501 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("НомерМесяца"		,"01");
	НастройкиКС.Вставить("КлючПоказателя"	,"П7С501");
	НастройкиКС.Вставить("ИмяПоказателя"	,"П001070050103");
...
Процедура ПроверкаКС_10_03_02()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.03.02';
													|en = '10.03.02'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, когда %3 = 02';
													|en = '%1 = %2, когда %3 = 02'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение количества добытой нефти';
													|en = 'Возможно ошибочное значение количества добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение количества добытой нефти в стр.502 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("НомерМесяца"		,"02");
	НастройкиКС.Вставить("КлючПоказателя"	,"П7С502");
	НастройкиКС.Вставить("ИмяПоказателя"	,"П001070050203");
...
Процедура ПроверкаКС_10_03_03()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.03.03';
													|en = '10.03.03'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, когда %3 = 03';
													|en = '%1 = %2, когда %3 = 03'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение количества добытой нефти';
													|en = 'Возможно ошибочное значение количества добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение количества добытой нефти в стр.503 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("НомерМесяца"		,"03");
	НастройкиКС.Вставить("КлючПоказателя"	,"П7С503");
	НастройкиКС.Вставить("ИмяПоказателя"	,"П001070050303");
...
Процедура ПроверкаКС_10_03_04()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.03.04';
													|en = '10.03.04'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, когда %3 = 04';
													|en = '%1 = %2, когда %3 = 04'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение количества добытой нефти';
													|en = 'Возможно ошибочное значение количества добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение количества добытой нефти в стр.504 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("НомерМесяца"		,"04");
	НастройкиКС.Вставить("КлючПоказателя"	,"П7С504");
	НастройкиКС.Вставить("ИмяПоказателя"	,"П001070050403");
...
Процедура ПроверкаКС_10_03_05()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.03.05';
													|en = '10.03.05'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, когда %3 = 05';
													|en = '%1 = %2, когда %3 = 05'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение количества добытой нефти';
													|en = 'Возможно ошибочное значение количества добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение количества добытой нефти в стр.505 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("НомерМесяца"		,"05");
	НастройкиКС.Вставить("КлючПоказателя"	,"П7С505");
	НастройкиКС.Вставить("ИмяПоказателя"	,"П001070050503");
...
Процедура ПроверкаКС_10_03_06()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.03.06';
													|en = '10.03.06'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, когда %3 = 06';
													|en = '%1 = %2, когда %3 = 06'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение количества добытой нефти';
													|en = 'Возможно ошибочное значение количества добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение количества добытой нефти в стр.506 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("НомерМесяца"		,"06");
	НастройкиКС.Вставить("КлючПоказателя"	,"П7С506");
	НастройкиКС.Вставить("ИмяПоказателя"	,"П001070050603");
...
Процедура ПроверкаКС_10_03_07()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.03.07';
													|en = '10.03.07'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, когда %3 = 07';
													|en = '%1 = %2, когда %3 = 07'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение количества добытой нефти';
													|en = 'Возможно ошибочное значение количества добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение количества добытой нефти в стр.507 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("НомерМесяца"		,"07");
	НастройкиКС.Вставить("КлючПоказателя"	,"П7С507");
	НастройкиКС.Вставить("ИмяПоказателя"	,"П001070050703");
...
Процедура ПроверкаКС_10_03_08()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.03.08';
													|en = '10.03.08'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, когда %3 = 08';
													|en = '%1 = %2, когда %3 = 08'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение количества добытой нефти';
													|en = 'Возможно ошибочное значение количества добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение количества добытой нефти в стр.508 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("НомерМесяца"		,"08");
	НастройкиКС.Вставить("КлючПоказателя"	,"П7С508");
	НастройкиКС.Вставить("ИмяПоказателя"	,"П001070050803");
...
Процедура ПроверкаКС_10_03_09()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.03.09';
													|en = '10.03.09'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, когда %3 = 09';
													|en = '%1 = %2, когда %3 = 09'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение количества добытой нефти';
													|en = 'Возможно ошибочное значение количества добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение количества добытой нефти в стр.509 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("НомерМесяца"		,"09");
	НастройкиКС.Вставить("КлючПоказателя"	,"П7С509");
	НастройкиКС.Вставить("ИмяПоказателя"	,"П001070050903");
...
Процедура ПроверкаКС_10_03_10()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.03.10';
													|en = '10.03.10'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, когда %3 = 10';
													|en = '%1 = %2, когда %3 = 10'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение количества добытой нефти';
													|en = 'Возможно ошибочное значение количества добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение количества добытой нефти в стр.510 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("НомерМесяца"		,"10");
	НастройкиКС.Вставить("КлючПоказателя"	,"П7С510");
	НастройкиКС.Вставить("ИмяПоказателя"	,"П001070051003");
...
Процедура ПроверкаКС_10_03_11()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.03.11';
													|en = '10.03.11'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, когда %3 = 11';
													|en = '%1 = %2, когда %3 = 11'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение количества добытой нефти';
													|en = 'Возможно ошибочное значение количества добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение количества добытой нефти в стр.511 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("НомерМесяца"		,"11");
	НастройкиКС.Вставить("КлючПоказателя"	,"П7С511");
	НастройкиКС.Вставить("ИмяПоказателя"	,"П001070051103");
...
Процедура ПроверкаКС_10_03_12()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.03.12';
													|en = '10.03.12'"));
	Заголовки.Вставить("Описание"			, 
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, когда %3 = 12';
													|en = '%1 = %2, когда %3 = 12'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение количества добытой нефти';
													|en = 'Возможно ошибочное значение количества добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значение количества добытой нефти в стр.512 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("НомерМесяца"		,"12");
	НастройкиКС.Вставить("КлючПоказателя"	,"П7С512");
	НастройкиКС.Вставить("ИмяПоказателя"	,"П001070051203");
...
Процедура ПроверкаКС_10_03_код()
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		ЗарегистрироватьПроверку();
		ЗаполнитьИРасшифроватьПоказатель(Показатели[НастройкиКС.КлючПоказателя], Раздел2);
		...
		Для Счетчик = 1 По Раздел2.КолвоСтрокП00103М1 Цикл
			...
			Если Показатели.П3С007.Значение = НастройкиКС.НомерМесяца Тогда
				ЗаполнитьИРасшифроватьПоказатель(Показатели.П3С050, Раздел2, Счетчик);
				МесяцСтр = Показатели.П3С007.Значение;
			КонецЕсли;
		КонецЦикла; 
		
		НастройкиКС.ЭтоОшибка = ЗначениеЗаполнено(Раздел2.Приложение7Включено) И НЕ МесяцСтр = "(...)" 
			И НЕ Показатели[НастройкиКС.КлючПоказателя].Значение = Показатели.П3С050.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели[НастройкиКС.КлючПоказателя].Значение, Показатели.П3С050.Итог, МесяцСтр);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_10_04_01()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.04.01';
													|en = '10.04.01'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Количество добытой нефти в стр.500 Приложения 7 = сумме стр.501 - 512 Приложения 7';
			|en = 'Количество добытой нефти в стр.500 Приложения 7 = сумме стр.501 - 512 Приложения 7'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное количество добытой нефти';
													|en = 'Возможно ошибочное количество добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните количество добытой нефти в стр.500 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.П7С500.Значение = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П7С500.Значение, РасчетнаяСумма);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_10_04_02()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.04.02';
													|en = '10.04.02'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'При заполнении отчета за 1 квартал стр.504 - 512 Приложения 7 = 0';
			|en = 'При заполнении отчета за 1 квартал стр.504 - 512 Приложения 7 = 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 0';
													|en = '%1 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное количество добытой нефти';
													|en = 'Возможно ошибочное количество добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Очистите стр.504 - 512 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.МесОтчета = 3 И НЕ РасчетнаяСумма = 0;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, РасчетнаяСумма);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_10_04_03()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.04.03';
													|en = '10.04.03'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'При заполнении отчета за 1 полугодие стр.507 - 512 Приложения 7 = 0';
			|en = 'При заполнении отчета за 1 полугодие стр.507 - 512 Приложения 7 = 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 0';
													|en = '%1 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное количество добытой нефти';
													|en = 'Возможно ошибочное количество добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Очистите стр.507 - 512 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		РасчетнаяСумма = СуммаПоказателей(Показатели);
		НастройкиКС.ЭтоОшибка = ДанныеКС.МесОтчета = 6 И НЕ РасчетнаяСумма = 0;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, РасчетнаяСумма);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_10_04_04()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 7';
														|en = 'Приложение 7'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.04.04';
													|en = '10.04.04'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'При заполнении отчета за 9 месяцев стр.510 - 512 Приложения 7 = 0';
			|en = 'При заполнении отчета за 9 месяцев стр.510 - 512 Приложения 7 = 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 0';
													|en = '%1 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное количество добытой нефти';
													|en = 'Возможно ошибочное количество добытой нефти'"));
	Заголовки.Вставить("Рекомендации"		, "Очистите стр.510 - 512 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		РасчетнаяСумма = СуммаПоказателей(Показатели);
		НастройкиКС.ЭтоОшибка = ДанныеКС.МесОтчета = 9 И НЕ РасчетнаяСумма = 0;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, РасчетнаяСумма);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_10_05()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'Приложения 7, если результат > 0, иначе 0';
			|en = 'Приложения 7, если результат > 0, иначе 0'"));
		Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 - %4 - %5 - %6)';
														|en = '%1 = %2 (%3 - %4 - %5 - %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма минимальной налоговой базы';
													|en = 'Возможно ошибочная сумма минимальной налоговой базы'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму минимальной налоговой базы в стр.700 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.П7С700.Значение = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П7С700.Значение, РасчетнаяСумма, 
			Показатели.П7С100.Значение, Показатели.П7С200.Значение, Показатели.П7С300.Значение, Показатели.П7С400.Значение);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_10_06()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '10.06';
													|en = '10.06'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Налоговая ставка в стр.800 Приложения 7 = ставке налога, установленной ст.333.54 НК РФ';
			|en = 'Налоговая ставка в стр.800 Приложения 7 = ставке налога, установленной ст.333.54 НК РФ'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная ставка налога';
													|en = 'Возможно ошибочная ставка налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните ставку налога в стр.800 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = ЗначениеЗаполнено(Показатели.П7С800.Значение) 
			И НЕ Показатели.П7С800.Значение = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П7С800.Значение, РасчетнаяСумма);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_10_07()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма минимального налога';
													|en = 'Возможно ошибочная сумма минимального налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму минимального налога в стр.900 Приложения 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@';
													|en = 'Письмо ФНС России от 06.06.2023 № БВ-4-3/7078@'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.П7С900.Значение = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.П7С900.Значение, 
...
Процедура ВвестиПоказатель(Элемент, Область, КодПоказателя, Знач ЭтоСумма, Знач ТекстВыбора, ТаблицаВыбора, СтандартнаяОбработка, КолонкаПоиска = "Код") Экспорт
	...
	Если Область.Имя = КодПоказателя ИЛИ МногострочнаяЧастьТекущейОбласти(ЭтаФорма, Область.Имя) <> Неопределено Тогда
		...
		// Особая обработка.
		Если СтрНачинаетсяС(Область.Имя, "П00104М201503") ИЛИ Область.Имя = "П001050002003" ИЛИ Область.Имя = "П001060001003" Тогда
