...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мВерсияФормы = "21/07/2015";
...
Процедура УстановитьЦветФорматДоступностьЯчеек() Экспорт 
	...
	МакетСоставаПоказателей = Отчеты[Сред(Лев(ИмяФормы, Найти(ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет(СтруктураРеквизитовФормы.мСоставПоказателей);
