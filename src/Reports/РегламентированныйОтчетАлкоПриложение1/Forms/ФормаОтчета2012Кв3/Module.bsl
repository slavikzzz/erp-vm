...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000112", "П000010000110;П000010000111");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000119", "П000010000113;П000010000114;П000010000115;П000010000116;П000010000117;П000010000118");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000122", "П000010000106;П000010000107;П000010000108;П000010000109;П000010000110;П000010000111;П000010000113;П000010000114;П000010000115;П000010000116;П000010000117;П000010000118;П000010000120;П000010000121");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000212", "П000010000110;П000010000111");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000213", "П000010000113");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000219", "П000010000113;П000010000114;П000010000115;П000010000116;П000010000117;П000010000118");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000220", "П000010000120");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000221", "П000010000121");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000222", "П000010000106;П000010000107;П000010000108;П000010000109;П000010000110;П000010000111;П000010000113;П000010000114;П000010000115;П000010000116;П000010000117;П000010000118;П000010000120;П000010000121");
	
	//Многострочная часть 2
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000312", "П000010000310;П000010000311");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000319", "П000010000313;П000010000314;П000010000315;П000010000316;П000010000317;П000010000318");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000322", "П000010000306;П000010000307;П000010000308;П000010000309;П000010000310;П000010000311;П000010000313;П000010000314;П000010000315;П000010000316;П000010000317;П000010000318;П000010000320;П000010000321");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000410", "П000010000310");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000411", "П000010000311");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000412", "П000010000310;П000010000311");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000419", "П000010000313;П000010000314;П000010000315;П000010000316;П000010000317;П000010000318");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000422", "П000010000306;П000010000307;П000010000308;П000010000309;П000010000310;П000010000311;П000010000313;П000010000314;П000010000315;П000010000316;П000010000317;П000010000318;П000010000320;П000010000321");
...
Процедура УстановитьДоступностьПолейДекларация(Форма)
	...
	Пока Форма.ТабличныйДокумент.Области.Найти("П000010000101_" + Постфикс) <> Неопределено Цикл
		...
		УстановитьЦветФонаЯчейки(Форма, "П000010000112_" + Постфикс, ВариантАвторасчета,  "Декларация");
		...
		УстановитьЦветФонаЯчейки(Форма, "П000010000119_" + Постфикс, ВариантАвторасчета,  "Декларация");
	...
	УстановитьЦветФонаЯчейки(Форма, "П000010000221", ВариантАвторасчета, "Декларация");
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010000101", 5, , "Выбор вида продукции", КоллекцияСписковВыбора["КодыВидовПродукции"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010000103", 5, , "Выбор вида продукции", КоллекцияСписковВыбора["КодыВидовПродукции"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010000301", 5, , "Выбор вида продукции", КоллекцияСписковВыбора["КодыВидовПродукции"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010000303", 5, , "Выбор вида продукции", КоллекцияСписковВыбора["КодыВидовПродукции"]);
...
Процедура ВывестиМакетВТаблДокНаСервере(ИмяТекРаздела, НомерСтраницыРазделаОтчета, РазделОтчета = Ложь)
	...
	// Многостраничные и многострочные разделы.
	//
	ИначеЕсли ИмяТекРаздела = "Декларация" Тогда // Многостраничные и многострочные разделы.
	...
	Если ИмяТекРаздела = "Титульный" ИЛИ ИмяТекРаздела = "Лицензии" Тогда
	Иначе
	...
	Если ИмяТекущейСтраницыПанели = "Декларация" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) Тогда
			...
			Для Инд = 1 По КоличествоСтрок Цикл
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000112, ОбластьИмя) > 0 Тогда   
					...
					ЗначениеГрафы12 = Графа10 + Графа11;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100001" + "12" + ПостфиксСтроки, ЗначениеГрафы12);
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000119, ОбластьИмя) > 0 Тогда
					...
					ЗначениеГрафы19 = Графа13 + Графа14 + Графа15 + Графа16 + Графа17 + Графа18;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100001" + "19" + ПостфиксСтроки, ЗначениеГрафы19);
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000122, ОбластьИмя) > 0 Тогда
					...
					Графа21 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П0000100001" + "21" + ПостфиксСтроки);
					
					ЗначениеГрафы22 = (Графа06 + Графа07 + Графа08 + Графа09) - Графа12 - Графа19 - Графа20 - Графа21;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000221, ОбластьИмя) > 0 Тогда
			...
			КоличествоСтрок = СтруктураГруппы.Количество();
			Форма.ТабличныйДокумент.Области.П000010000221.Значение = 0;
			Для Инд = 1 По КоличествоСтрок Цикл
				Постфикс = "_" + Формат(Инд, "ЧГ=0");
				Форма.ТабличныйДокумент.Области.П000010000221.Значение = Форма.ТабличныйДокумент.Области.П000010000221.Значение + Форма.ТабличныйДокумент.Области["П000010000121" + Постфикс].Значение;
			КонецЦикла;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) Тогда
			...
			Для Инд = 1 По КоличествоСтрок Цикл
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000312, ОбластьИмя) > 0 Тогда   
					...
					ЗначениеГрафы12 = Графа10 + Графа11;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100003" + "12" + ПостфиксСтроки, ЗначениеГрафы12);
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000319, ОбластьИмя) > 0 Тогда
					...
					ЗначениеГрафы19 = Графа13 + Графа14 + Графа15 + Графа16 + Графа17 + Графа18;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100003" + "19" + ПостфиксСтроки, ЗначениеГрафы19);
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Если ИмяОбласти = "ЗаявлениеОКорректировкеПредставление" Тогда
		...
		Иначе
			...
			ПараметрыФормы.Вставить("НомерПриложения",          "1");
...
Процедура ЗаполнитьСвязанныеПоказатели(ИмяОбласти, РезультатВыбора)
	...
	ИначеЕсли СтрНайти(ИмяОбласти, "П000010000301") = 1 Тогда
		ИмяСвязаннойОбласти = "П000010000303" + Сред(ИмяОбласти, 14);
		СвязаннаяОбласть = ТабличныйДокумент.Области[ИмяСвязаннойОбласти];
		СвязаннаяОбласть.Значение = РезультатВыбора.Код;
		Если ПустаяСтрока(РезультатВыбора.Код) Тогда
			ТабличныйДокумент.Области[ИмяОбласти].Значение = "";
	...
	ИначеЕсли СтрНайти(ИмяОбласти, "П000010000303") = 1 Тогда
...
Процедура ПроверитьЗаполнениеТаблицыДекларации(СтатусПроверки, ИдГруппы, ДанныеДопСтрок, ДополнительныеДанные, НомерЛиста, КоличЗаполненных)
	...
	Для Каждого СтрокаДекларации Из ДанныеДопСтрок Цикл
		...
		Если НЕ ЗначениеЗаполнено(ЗначениеГрафы) Тогда
			ТекстОписанияОшибки = "В строке " + НомерСтрокиСтроковый + " таблицы "+ ИмяТаблицы + " на листе " + НомерЛистаСтроковый + " раздела ""Декларация"" не указано объемное содержание безводного спирта!";
			СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Декларация", ИмяПоказателя, НомерЛиста);
		КонецЕсли;
		...
		ЗначениеГрафы = СокрЛП(СтрокаДекларации[ИмяГрафы]);
		Если ПустаяСтрока(ЗначениеГрафы) Тогда
			ТекстОписанияОшибки = "В строке " + НомерСтрокиСтроковый + " таблицы "+ ИмяТаблицы + " на листе " + НомерЛистаСтроковый + " раздела ""Декларация"" не задан вид сырья!";
			СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Декларация", ИмяПоказателя, НомерЛиста);
		КонецЕсли;
		
		ИмяГрафы = ПрефиксИмени + "05";
		ИмяПоказателя = ПрефиксИмени + "05_" + НомерСтрокиСтроковый;
		ЗначениеГрафы = СтрокаДекларации[ИмяГрафы];
		Если НЕ ЗначениеЗаполнено(ЗначениеГрафы) Тогда
			ТекстОписанияОшибки = "В строке " + НомерСтрокиСтроковый + " таблицы "+ ИмяТаблицы + " на листе " + НомерЛистаСтроковый + " раздела ""Декларация"" не указано o количество (объем) использованного сырья!";
			СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Декларация", ИмяПоказателя, НомерЛиста);
		КонецЕсли;
	...
	Если СтруктураРеквизитовФормы.мСохраненныйДок.ДатаОкончания > '20140901' Тогда
		...
		ИмяКодаВидаПродукции         = ПрефиксИмени + "03";
		ИмяСодержанияЭтиловогоСпирта = ПрефиксИмени + "02";
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель, КорневойУзел, Параметры)
	...
	ПрототипУзла_ОбъемПроизводства = ПолучитьПодчиненныйЭлемент(Узел_Документ, "ОбъемПроизводства");
	...
	Для Каждого Страница Из мДанныеОтчета.Декларация Цикл
		...
		Узел_ОбъемПроизводства = НовыйУзелИзПрототипа(ПрототипУзла_ОбъемПроизводства);
		УстановитьЗначениеЭлемента(Узел_ОбъемПроизводства, "НаимЮЛ", НазваниеОрганизации);
		УстановитьЗначениеЭлемента(Узел_ОбъемПроизводства, "КППЮЛ", КПП);
		
		Узел_АдрОрг = ПолучитьПодчиненныйЭлемент(Узел_ОбъемПроизводства, "АдрОрг");
		...
		ЗаполнитьСведенияПоСтранице(Страница, Узел_ОбъемПроизводства);
		
		Узел_Производство = ПолучитьПодчиненныйЭлемент(Узел_ОбъемПроизводства, "Производство");
		ЕстьПеревозки = (Узел_Производство <> Неопределено);
		УстановитьЗначениеЭлемента(Узел_ОбъемПроизводства, "НаличиеПроизводства", ?(ЕстьПеревозки, "true", "false"));
		
	КонецЦикла;
	РегламентированнаяОтчетность.УдалитьУзел(ПрототипУзла_ОбъемПроизводства);
...
Процедура ЗаполнитьСведенияПоСтранице(Страница, УзелСведений)
	...
	ПрототипУзла_Производство = ПолучитьПодчиненныйЭлемент(УзелСведений, "Производство");
	
	ТаблицаПродукции = ДанныеДопСтрок[СтруктураРеквизитовФормы.мИдГруппы2].Выгрузить();
	
	ВидыПродукции = ТаблицаПродукции.Скопировать(, "П000010000302, П000010000303");
	ВидыПродукции.Свернуть("П000010000302, П000010000303");
	
	НомерПП_Производство = 0;
	Для Каждого ВидПродукции Из ВидыПродукции Цикл
		Если ПустаяСтрока(ВидПродукции.П000010000303) Тогда
			Продолжить;
		КонецЕсли;
		
		Узел_Производство = НовыйУзелИзПрототипа(ПрототипУзла_Производство);
		
		НомерПП_Производство = НомерПП_Производство + 1;
		УстановитьЗначениеЭлемента(Узел_Производство, "ПN", НомерПП_Производство);
		
		УсловияОтбора = Новый Структура;
		УсловияОтбора.Вставить("П000010000302", ВидПродукции.П000010000302); // Содержание спирта
		УсловияОтбора.Вставить("П000010000303", ВидПродукции.П000010000303); // Код вида продукции
		
		СтрокиПродукции = ТаблицаПродукции.НайтиСтроки(УсловияОтбора);
		
		ТаблицаПоПродукции = ТаблицаПродукции.Скопировать(СтрокиПродукции);
		
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000003", ВидПродукции.П000010000303);
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000004", ВидПродукции.П000010000302);
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000005", ТаблицаПоПродукции.Итог("П000010000306"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000006", ТаблицаПоПродукции.Итог("П000010000307"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000007", ТаблицаПоПродукции.Итог("П000010000308"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000008", ТаблицаПоПродукции.Итог("П000010000309"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000009", ТаблицаПоПродукции.Итог("П000010000310"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000010", ТаблицаПоПродукции.Итог("П000010000311"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000011", ТаблицаПоПродукции.Итог("П000010000312"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000012", ТаблицаПоПродукции.Итог("П000010000313"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000013", ТаблицаПоПродукции.Итог("П000010000314"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000014", ТаблицаПоПродукции.Итог("П000010000315"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000015", ТаблицаПоПродукции.Итог("П000010000316"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000016", ТаблицаПоПродукции.Итог("П000010000317"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000017", ТаблицаПоПродукции.Итог("П000010000318"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000018", ТаблицаПоПродукции.Итог("П000010000319"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000019", ТаблицаПоПродукции.Итог("П000010000320"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000020", ТаблицаПоПродукции.Итог("П000010000321"));
		УстановитьЗначениеЭлемента(Узел_Производство, "П000000000021", ТаблицаПоПродукции.Итог("П000010000322"));
		
		ТаблицаСырья = ТаблицаПоПродукции.Скопировать();
		ТаблицаСырья.Свернуть("П000010000304", "П000010000305");
		
		Узел_СырьеВерхний = ПолучитьПодчиненныйЭлемент(Узел_Производство, "Сырьё");
		ПрототипУзла_Сырье = ПолучитьПодчиненныйЭлемент(Узел_СырьеВерхний, "Сырьё");
		
		НомерПП_Сырье = 0;
		Для Каждого Сырье Из ТаблицаСырья Цикл
			Узел_Сырье = НовыйУзелИзПрототипа(ПрототипУзла_Сырье);
			НомерПП_Сырье = НомерПП_Сырье + 1;
			УстановитьЗначениеЭлемента(Узел_Сырье, "ПN", НомерПП_Сырье);
			
			УстановитьЗначениеЭлемента(Узел_Сырье, "П000000000002", Сырье.П000010000304);
			УстановитьЗначениеЭлемента(Узел_Сырье, "П000000000003", Сырье.П000010000305);
		КонецЦикла;
		РегламентированнаяОтчетность.УдалитьУзел(ПрототипУзла_Сырье);
		
	КонецЦикла;
	РегламентированнаяОтчетность.УдалитьУзел(ПрототипУзла_Производство);
