...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мКодОтчета = 1152022;
	...
	СтруктураРеквизитовФормы.КНД = "1152022";
	СтруктураРеквизитовФормы.НаименованиеОтчетаДляВыгрузки = "ДЕКЛАРАЦИЯ ОБ ОБЪЕМАХ ИСПОЛЬЗОВАНИЯ АЛКОГОЛЬНО И СПИРТОСОДЕРЖАЩЕЙ ПРОДУКЦИИ";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", Знач ОбластьИмя = "", НомерИзменяемойСтроки = Неопределено) Экспорт
	...
	Если ИмяТекущейСтраницыПанели = "Декларация" Тогда
		...
		Для Ном = НачальныйНомер По КонечныйНомер Цикл
			...
			ТекСтрокаТаблицы.П000000000009 = Форма.ТабличныйДокумент.Области["П000000000009" + НомСтр].Значение;
			...
			ТекСтрокаТаблицы.П000000000014 = Форма.ТабличныйДокумент.Области["П000000000014" + НомСтр].Значение;
		...
		Если Форма.ФлажокИтог Тогда
			...
			Форма.ТабличныйДокумент.Области.СуммаКолонка9.Значение = СтруктураГруппы.Итог("П000000000009");
			Форма.ТабличныйДокумент.Области.СуммаКолонка14.Значение = СтруктураГруппы.Итог("П000000000014");
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если (СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Декларация") И (НЕ ((СтрНайти(Элемент.ТекущаяОбласть.Имя, "П000000000002_") > 0) Или (СтрНайти(Элемент.ТекущаяОбласть.Имя, "П000000000003_") > 0) Или (СтрНайти(Элемент.ТекущаяОбласть.Имя, "П000000000004_") > 0))) Тогда	
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ИмяФайлаСхемы",				"ALK_1152022_4_01.xsd");
	ПараметрыВыгрузки.Вставить("ПрефиксИмениФайлаВыгрузки",	"A4");
...
Процедура ДобавитьСтрокуИтогов()
	...
	Ячейка = "R" + ВставляемаяОбластьСтр + "C3:R" + ВставляемаяОбластьСтр + "C16";
