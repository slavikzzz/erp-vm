...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000109", "П000010000105;П000010000106;П000010000107;П000010000108");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000114", "П000010000110;П000010000111;П000010000112;П000010000113");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000115", "П000010000104;П000010000105;П000010000106;П000010000107;П000010000108;П000010000110;П000010000111;П000010000112;П000010000113");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000209", "П000010000105;П000010000106;П000010000107;П000010000108");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000214", "П000010000110;П000010000111;П000010000112;П000010000113");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000215", "П000010000104;П000010000105;П000010000106;П000010000107;П000010000108;П000010000110;П000010000111;П000010000112;П000010000113");
	
	//Многострочная часть 2
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000309", "П000010000305;П000010000306;П000010000307;П000010000308");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000314", "П000010000310;П000010000311;П000010000312;П000010000313");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000315", "П000010000304;П000010000305;П000010000306;П000010000307;П000010000308;П000010000310;П000010000311;П000010000312;П000010000313");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000409", "П000010000305;П000010000306;П000010000307;П000010000308");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000414", "П000010000310;П000010000311;П000010000312;П000010000313");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000415", "П000010000304;П000010000305;П000010000306;П000010000307;П000010000308;П000010000310;П000010000311;П000010000312;П000010000313");
...
Процедура УстановитьДоступностьПолейДекларация(Форма)
	...
	Пока Форма.ТабличныйДокумент.Области.Найти("П000010000101_" + Постфикс) <> Неопределено Цикл
		...
		УстановитьЦветФонаЯчейки(Форма, "П000010000109_" + Постфикс, ВариантАвторасчета,  "Декларация");
		...
		УстановитьЦветФонаЯчейки(Форма, "П000010000115_" + Постфикс, ВариантАвторасчета,  "Декларация");
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010000102", 5, , "Выбор вида продукции", КоллекцияСписковВыбора["КодыВидовПродукции"]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010000302", 5, , "Выбор вида продукции", КоллекцияСписковВыбора["КодыВидовПродукции"]);
	...
	Если ИмяТекущейСтраницыПанели = "Декларация" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) Тогда
			...
			Для Инд = 1 По КоличествоСтрок Цикл
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000109, ОбластьИмя) > 0 Тогда   
					...
					ЗначениеГрафы09 = Графа05 + Графа06 + Графа07 + Графа08;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100001" + "09" + ПостфиксСтроки, ЗначениеГрафы09);
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000115, ОбластьИмя) > 0 Тогда
					...
					ЗначениеГрафы15 = Графа04 + Графа09 - Графа14;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100001" + "15" + ПостфиксСтроки, ЗначениеГрафы15);
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) Тогда
			...
			Для Инд = 1 По КоличествоСтрок Цикл
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000309, ОбластьИмя) > 0 Тогда   
					...
					ЗначениеГрафы09 = Графа05 + Графа06 + Графа07 + Графа08;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100003" + "09" + ПостфиксСтроки, ЗначениеГрафы09);
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000315, ОбластьИмя) > 0 Тогда
					...
					ЗначениеГрафы15 = Графа04 + Графа09 - Графа14;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100003" + "15" + ПостфиксСтроки, ЗначениеГрафы15);
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Если ИмяОбласти = "ЗаявлениеОКорректировкеПредставление" Тогда
		...
		Иначе
			...
			ПараметрыФормы.Вставить("НомерПриложения",          "4");
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель, КорневойУзел, Параметры)
	...
	Для Каждого Страница Из мДанныеОтчета.Декларация Цикл
		...
		Если Число(Лев(СтруктураРеквизитовФормы.мВерсияФормата, 3)) >= 431 Тогда		
			// формат 4.31
			УстановитьЗначениеЭлемента(Узел_ОбъемИспользования, "Наим", НазваниеОрганизации);			
		Иначе			
			// формат 4.30
...
Процедура ЗаполнитьСведенияПоСтранице(Страница, УзелСведений)
	...
	Для Каждого Продукция Из ТаблицаПродукции Цикл
		...
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000003", Продукция.П000010000302);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000004", Продукция.П000010000303);
