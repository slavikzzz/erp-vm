...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр р.НДС прилож.11 21к2") Тогда
...
Функция ВыполнитьДокументированиеНаСервере()
	...
	СтруктураРезультата.Вставить("НаименованиеОтчета"	, "Реестр НДС Приложение 11");
...
#Область ОбщиеДанные
	...
	ДанныеКС.Вставить("ГрафаНалоговойБазы"		, "07");
...
&НаСервере
Процедура ПроверкаКС_11_1_1()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '11.1.1';
													|en = '11.1.1'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Реестр 11';
														|en = 'Реестр 11'"));
...
&НаСервере
Процедура ПроверкаКС_11_1_2()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '11.1.2';
													|en = '11.1.2'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Реестр 11';
														|en = 'Реестр 11'"));
...
&НаСервере
Процедура ПроверкаКС_11_1_3()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '11.1.3';
													|en = '11.1.3'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Реестр 11';
														|en = 'Реестр 11'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибка ввода';
													|en = 'Ошибка ввода'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Код страны станции отправления в гр.3 Реестра должен соответствовать справочнику ОКСМ';
			|en = 'Код страны станции отправления в гр.3 Реестра должен соответствовать справочнику ОКСМ'"));
	...
	Настройки.Вставить("ИмяПоказателя", "П1000031_");
	ПроверкаКС_11_1_4_код(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_11_1_4()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '11.1.4';
													|en = '11.1.4'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Реестр 11';
														|en = 'Реестр 11'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибка ввода';
													|en = 'Ошибка ввода'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Код страны станции назначения в гр.5 Реестра должен соответствовать справочнику ОКСМ';
			|en = 'Код страны станции назначения в гр.5 Реестра должен соответствовать справочнику ОКСМ'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Код страны %1 соответствует справочнику ОКСМ';
													|en = 'Код страны %1 соответствует справочнику ОКСМ'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный код страны';
														|en = 'Ошибочный код страны'"));
...
&НаСервере
Процедура ПроверкаКС_11_1_4_код(Настройки)
...
&НаСервере
Процедура ПроверкаКС_11_1_5()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '11.1.5';
													|en = '11.1.5'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Реестр 11';
														|en = 'Реестр 11'"));
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибка ввода';
													|en = 'Ошибка ввода'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Коды железнодорожных станций, указанные в гр.3 - 6 Реестра, должны соответствовать ';
			|en = 'Коды железнодорожных станций, указанные в гр.3 - 6 Реестра, должны соответствовать '") +
		НСтр("ru = 'Тарифному Руководству №4';
			|en = 'Тарифному Руководству №4'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Код ж/д станции %1 соответствует Тарифному Руководству №4';
													|en = 'Код ж/д станции %1 соответствует Тарифному Руководству №4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный код ж/д станции';
														|en = 'Ошибочный код ж/д станции'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1, Строка %2';
													|en = 'Страница %1, Строка %2'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
&НаСервере
Процедура ПроверкаКС_11_1_6()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '11.1.6';
													|en = '11.1.6'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Реестр 11';
														|en = 'Реестр 11'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибка ввода';
													|en = 'Ошибка ввода'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Из сведений о станции отправления в гр.3 Реестра должны быть указаны код станции отправления ';
			|en = 'Из сведений о станции отправления в гр.3 Реестра должны быть указаны код станции отправления '") +
		НСтр("ru = 'и (или) наименование станции отправления с кодом страны станции отправления';
			|en = 'и (или) наименование станции отправления с кодом страны станции отправления'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Сведения о ж/д станции %1, %2, %3 заполнены';
													|en = 'Сведения о ж/д станции %1, %2, %3 заполнены'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р01Г001", "П1000033_");
	ИменаПоказателей.Вставить("Р01Г002", "П1000032_");
	ИменаПоказателей.Вставить("Р01Г003", "П1000031_");
	
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
	ПроверкаКС_11_1_7_код(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_11_1_7()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '11.1.7';
													|en = '11.1.7'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Реестр 11';
														|en = 'Реестр 11'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибка ввода';
													|en = 'Ошибка ввода'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Из сведений о станции назначения в гр.5 Реестра должны быть указаны код станции назначения ';
			|en = 'Из сведений о станции назначения в гр.5 Реестра должны быть указаны код станции назначения '") +
		НСтр("ru = 'и (или) наименование станции назначения с кодом страны станции назначения';
			|en = 'и (или) наименование станции назначения с кодом страны станции назначения'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Сведения о ж/д станции %1, %2, %3 заполнены';
													|en = 'Сведения о ж/д станции %1, %2, %3 заполнены'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Не заполнены сведения о ж/д станции';
														|en = 'Не заполнены сведения о ж/д станции'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р01Г001", "П1000053_");
	ИменаПоказателей.Вставить("Р01Г002", "П1000052_");
	ИменаПоказателей.Вставить("Р01Г003", "П1000051_");
...
&НаСервере
Процедура ПроверкаКС_11_1_7_код(Настройки)
	...
	Для каждого СтраницаРеестра Из ДанныеКС.Реестр Цикл
		Для Счетчик = 1 По СтраницаРеестра.КолвоСтрокП10000 Цикл
			...
			Настройки.ЭтоОшибка = СтраницаРеестра.РазделЗаполнен И НЕ (ЗначениеЗаполнено(Показатели.Р01Г001.Значение)
				ИЛИ ЗначениеЗаполнено(Показатели.Р01Г002.Значение) И ЗначениеЗаполнено(Показатели.Р01Г003.Значение));
			Настройки.Расшифровка = СтрШаблон(Настройки.ШаблонРасшифровки, Показатели.Р01Г001.ЗначениеСтр,
				Показатели.Р01Г002.ЗначениеСтр, Показатели.Р01Г003.ЗначениеСтр);
			Настройки.ДопСведения = Дополнение;
			ДополнитьСтруктуруОшибок(Настройки);
...
&НаСервере
Процедура ПроверкаКС_11_1_8()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '11.1.8';
													|en = '11.1.8'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Реестр 11';
														|en = 'Реестр 11'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибка ввода';
													|en = 'Ошибка ввода'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Из сведений о входной ж/д станции в гр.4 Реестра должны быть указаны код входной ж/д станции ';
			|en = 'Из сведений о входной ж/д станции в гр.4 Реестра должны быть указаны код входной ж/д станции '") +
		НСтр("ru = 'и (или) наименование входной ж/д станции';
			|en = 'и (или) наименование входной ж/д станции'"));
	...
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
	ПроверкаКС_11_1_9_код(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_11_1_9()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '11.1.9';
													|en = '11.1.9'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Реестр 11';
														|en = 'Реестр 11'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибка ввода';
													|en = 'Ошибка ввода'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Из сведений о выходной ж/д станции в гр.6 Реестра должны быть указаны код выходной ж/д станции ';
			|en = 'Из сведений о выходной ж/д станции в гр.6 Реестра должны быть указаны код выходной ж/д станции '") +
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р01Г001", "П1000062_");
	ИменаПоказателей.Вставить("Р01Г002", "П1000061_");
...
&НаСервере
Процедура ПроверкаКС_11_1_9_код(Настройки)
...
&НаСервере
Процедура ПроверкаКС_11_2_1а()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '11.2.1.а';
													|en = '11.2.1.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Реестр 11';
														|en = 'Реестр 11'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибка ввода';
...
&НаСервере
Процедура ПроверкаКС_11_2_1б()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '11.2.1.б';
													|en = '11.2.1.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Реестр 11';
														|en = 'Реестр 11'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибка ввода';
...
&НаСервере
Процедура ПроверкаКС_11_2_2()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '11.2.2';
													|en = '11.2.2'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Реестр 11';
														|en = 'Реестр 11'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Ошибка ввода';
