...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	Если РазделЗаполнен(ДанныеРеестра.Строки, Ложь) Тогда
		...
		ПроверитьКС_11_1_1(СтруктураРезультата);
		ПроверитьКС_11_1_2(СтруктураРезультата);
		ПроверитьКС_11_1_3(СтруктураРезультата);
		ПроверитьКС_11_1_4(СтруктураРезультата);
		// КС 11_1_5 приостановлено
		ПроверитьКС_11_1_6(СтруктураРезультата);
		ПроверитьКС_11_1_7(СтруктураРезультата);
		ПроверитьКС_11_1_8(СтруктураРезультата);
		ПроверитьКС_11_1_9(СтруктураРезультата);
		ПроверитьКС_11_2_1(СтруктураРезультата);
		ПроверитьКС_11_2_2(СтруктураРезультата);
		ПроверитьКС_11_2_3(СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_11_1_1(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 11.1.1';
												|en = 'Проверка КС 11.1.1'"));
...
&НаСервере
Процедура ПроверитьКС_11_1_2(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 11.1.2';
												|en = 'Проверка КС 11.1.2'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_11_1_3(СтруктураРезультата)
	
	Заголовки		= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"		,НСтр("ru = 'Проверка КС 11.1.3';
													|en = 'Проверка КС 11.1.3'"));
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Код страны станции отправления (если указан в графе 3 Реестра) должен соответствовать справочнику ОКСМ';
			|en = 'Код страны станции отправления (если указан в графе 3 Реестра) должен соответствовать справочнику ОКСМ'"));
	Заголовки.Вставить("ШаблонОшибки"		,
		НСтр("ru = 'Указанный код страны станции отправления отсутствует в справочнике ОКСМ';
			|en = 'Указанный код страны станции отправления отсутствует в справочнике ОКСМ'"));
	Заголовки.Вставить("ШаблонРасшифровки"	,НСтр("ru = 'Указанный код: (""%1"")';
													|en = 'Указанный код: (""%1"")'"));
	Заголовки.Вставить("Показатель"			,НСтр("ru = 'СтанцияОтпрСтрана';
													|en = 'СтанцияОтпрСтрана'"));
...
&НаСервере
Процедура ПроверитьКС_11_1_4(СтруктураРезультата)
	
	Заголовки		= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"		,НСтр("ru = 'Проверка КС 11.1.4';
													|en = 'Проверка КС 11.1.4'"));
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Код страны станции назначения (если указан в графе 5 Реестра) должен соответствовать справочнику ОКСМ';
			|en = 'Код страны станции назначения (если указан в графе 5 Реестра) должен соответствовать справочнику ОКСМ'"));
	Заголовки.Вставить("ШаблонОшибки"		,
		НСтр("ru = 'Указанный код страны станции назначения отсутствует в справочнике ОКСМ';
			|en = 'Указанный код страны станции назначения отсутствует в справочнике ОКСМ'"));
	Заголовки.Вставить("ШаблонРасшифровки"	,НСтр("ru = 'Указанный код: (""%1"")';
													|en = 'Указанный код: (""%1"")'"));
	Заголовки.Вставить("Показатель"			,НСтр("ru = 'СтанцияНазнСтрана';
													|en = 'СтанцияНазнСтрана'"));
	Заголовки.Вставить("ПроверятьПустые"	,Ложь);
	Настройки	= ОбработатьНастройки(		, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_11_1_6(СтруктураРезультата)
	
	Настройки	= ОбработатьНастройки(,, СтруктураРезультата);
	Настройки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 11.1.6';
												|en = 'Проверка КС 11.1.6'"));
	Настройки.Вставить("ОписаниеКС"		,
		НСтр("ru = 'Проверка заполнения сведений по станции отправления в графе 3 Реестра:
								|- должен быть указан код станции отправления и(или) 
								|- наименование станции отправления с кодом страны';
								|en = 'Проверка заполнения сведений по станции отправления в графе 3 Реестра:
								|- должен быть указан код станции отправления и(или) 
								|- наименование станции отправления с кодом страны'"));
	Настройки.Вставить("ШаблонОшибки"	,
		НСтр("ru = 'Одновременно отсутствуют сведения о коде станции отправления и о наименовании станции отправления с кодом страны';
			|en = 'Одновременно отсутствуют сведения о коде станции отправления и о наименовании станции отправления с кодом страны'"));
	Настройки.Показатели.Добавить("СтанцияОтпрКод");
	Настройки.Показатели.Добавить("СтанцияОтпрНаим");
	Настройки.Показатели.Добавить("СтанцияОтпрСтрана");
	
	ПроверитьКС_КодСтанцииКодСтраныИНаименованиеЗаполнены(СтруктураРезультата, Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверитьКС_11_1_7(СтруктураРезультата)
	
	Настройки	= ОбработатьНастройки(,, СтруктураРезультата);
	Настройки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 11.1.7';
												|en = 'Проверка КС 11.1.7'"));
	Настройки.Вставить("ОписаниеКС"		,
		НСтр("ru = 'Проверка заполнения сведений по станции назначения в графе 5 Реестра:
								|- должен быть указан  код станции  назначения и(или) 
								|- наименование станции  назначения с кодом страны';
								|en = 'Проверка заполнения сведений по станции назначения в графе 5 Реестра:
								|- должен быть указан  код станции  назначения и(или) 
								|- наименование станции  назначения с кодом страны'"));
	Настройки.Вставить("ШаблонОшибки"	,
		НСтр("ru = 'Одновременно отсутствуют сведения о коде станции назначения и о наименовании станции назначения с кодом страны';
			|en = 'Одновременно отсутствуют сведения о коде станции назначения и о наименовании станции назначения с кодом страны'"));
	Настройки.Показатели.Добавить("СтанцияНазнКод");
	Настройки.Показатели.Добавить("СтанцияНазнНаим");
	Настройки.Показатели.Добавить("СтанцияНазнСтрана");
...
&НаСервере
Процедура ПроверитьКС_11_1_8(СтруктураРезультата)
	
	Настройки	= ОбработатьНастройки(,, СтруктураРезультата);
	Настройки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 11.1.8';
												|en = 'Проверка КС 11.1.8'"));
	Настройки.Вставить("ОписаниеКС"		,
		НСтр("ru = 'Проверка заполнения сведений по входной железнодорожной станции (пограничной и (или) припортовой) в графе 4 Реестра';
			|en = 'Проверка заполнения сведений по входной железнодорожной станции (пограничной и (или) припортовой) в графе 4 Реестра'"));
	Настройки.Вставить("ШаблонОшибки"	,
		НСтр("ru = 'Одновременно отсутствуют сведения о коде входной железнодорожной станции (пограничной и (или) припортовой) и о её наименовании';
			|en = 'Одновременно отсутствуют сведения о коде входной железнодорожной станции (пограничной и (или) припортовой) и о её наименовании'"));
...
&НаСервере
Процедура ПроверитьКС_11_1_9(СтруктураРезультата)
	
	Настройки	= ОбработатьНастройки(,, СтруктураРезультата);
	Настройки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 11.1.9';
												|en = 'Проверка КС 11.1.9'"));
	Настройки.Вставить("ОписаниеКС"		,
		НСтр("ru = 'Проверка заполнения сведений по выходной железнодорожной станции (пограничной и (или) припортовой) в графе 6 Реестра';
			|en = 'Проверка заполнения сведений по выходной железнодорожной станции (пограничной и (или) припортовой) в графе 6 Реестра'"));
	Настройки.Вставить("ШаблонОшибки"	,
		НСтр("ru = 'Одновременно отсутствуют сведения о коде выходной железнодорожной станции (пограничной и (или) припортовой) и о её наименовании';
			|en = 'Одновременно отсутствуют сведения о коде выходной железнодорожной станции (пограничной и (или) припортовой) и о её наименовании'"));
	Настройки.Вставить("ВидыОпераций"	,Неопределено);
...
&НаСервере
Процедура ПроверитьКС_11_2_1(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 11.2.1';
												|en = 'Проверка КС 11.2.1'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_11_2_2(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 11.2.2';
												|en = 'Проверка КС 11.2.2'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_11_2_3(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 11.2.3';
												|en = 'Проверка КС 11.2.3'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_КодСтанцииКодСтраныИНаименованиеЗаполнены(СтруктураРезультата, Настройки);
	...
	Для каждого СтраницаРаздела Из ДанныеРеестра.Строки Цикл
		...
		Для НомерСтроки = 1 По КоличествоСтрок Цикл
			...
			Настройки.Вставить("ДопСведенияПараметры", Новый Структура("НомерСтраницы, Ключ, НомерСтроки", НомерСтраницы, 
				", Строка ", НомерРасчетный));
			Показатели		= ЗаполнитьПоказатели(СтрСоединить(Настройки.Показатели, ", "), 
				ДанныеСтраницы[НомерСтроки - 1].Данные, НомерСтроки);
			РасшифроватьПоказатели(Показатели, Настройки, "Реестр", НомерСтраницы);
			КодОбъекта		= Показатели[Настройки.Показатели[0]];
			НаименованиеОбъекта = Показатели[Настройки.Показатели[1]];
			КодСтраны = Показатели[Настройки.Показатели[2]];
			Настройки.ОписаниеОшибки = Настройки.ШаблонОшибки;
			ПодстрокаРасшифровки = "%1%2%3%4%5";
			ПодстрокаРасшифровки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ПодстрокаРасшифровки, 
				КодОбъекта.Значение, ",", НаименованиеОбъекта.Значение, ",", КодСтраны.Значение);
			МассивПодстрок	= СтрРазделить(ПодстрокаРасшифровки, ",", Ложь);
			Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
				СтрСоединить(МассивПодстрок, ", "));
			Настройки.ЭтоОшибка	= Не ЗначениеЗаполнено(КодОбъекта.Значение) 
				И Не (ЗначениеЗаполнено(НаименованиеОбъекта.Значение) И ЗначениеЗаполнено(КодСтраны.Значение));
			ДобавитьЭлементВСтруктуруОшибок(Настройки);
...
Функция ПоказательПоСтроке(УсловныйКодПоказателя)
	...
	ИначеЕсли УсловныйКодПоказателя = "СтанцияОтпрНаим" Тогда
		Результат.Вставить("Имя", "П1000032%1%2");
		Результат.Вставить("Представление", Нстр("ru = 'Наименование станции отправления';
												|en = 'Наименование станции отправления'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "СтанцияОтпрКод" Тогда
		Результат.Вставить("Имя", "П1000033%1%2");
		Результат.Вставить("Представление", Нстр("ru = 'Код станции отправления';
												|en = 'Код станции отправления'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "СтанцияНазнСтрана" Тогда
		Результат.Вставить("Имя", "П1000051%1%2");
		Результат.Вставить("Представление", Нстр("ru = 'Код страны станции назначения';
												|en = 'Код страны станции назначения'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "СтанцияНазнНаим" Тогда
		Результат.Вставить("Имя", "П1000052%1%2");
		Результат.Вставить("Представление", Нстр("ru = 'Наименование станции назначения';
												|en = 'Наименование станции назначения'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "СтанцияНазнКод" Тогда
		Результат.Вставить("Имя", "П1000053%1%2");
		Результат.Вставить("Представление", Нстр("ru = 'Код станции назначения';
												|en = 'Код станции назначения'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
	...
	ИначеЕсли УсловныйКодПоказателя = "СтанцияВыхНаим" Тогда
		Результат.Вставить("Имя", "П1000061%1%2");
	...
	ИначеЕсли УсловныйКодПоказателя = "СтанцияВыхКод" Тогда
		Результат.Вставить("Имя", "П1000062%1%2");
