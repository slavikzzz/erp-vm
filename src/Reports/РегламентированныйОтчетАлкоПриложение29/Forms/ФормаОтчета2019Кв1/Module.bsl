...
Процедура Просуммировать() Экспорт
	...
	П000010000308 = П000010000309 + П000010000310 + П000010000311 + П000010000312;
	Элемент = Элементы.Найти("П000010000308");
...
Процедура УстановитьПараметрыДекларации() Экспорт
	...
	СписокИдГруппОтчета.Добавить("П0000100003", "мИдГруппы12"); // Таблица Поставщики.	
	СписокИдГруппОтчета.Добавить("П0000110003", "мИдГруппы22"); // Таблица Произведено.
	...
	СписокИдГруппРаздела.Добавить(СтруктураРеквизитовФормы.мИдГруппы12, "Поставщики");
	СписокИдГруппРаздела.Добавить(СтруктураРеквизитовФормы.мИдГруппы22, "Производство");
