...
Функция ПечатьНаСервере(ВидПечати)
	...
	Заголовок_Стр4 = ПечатнаяФормаМакет.ПолучитьОбласть("Заголовок_Стр4");
	...
	Стр431 = ПечатнаяФормаМакет.ПолучитьОбласть("Стр431");
	Стр432 = ПечатнаяФормаМакет.ПолучитьОбласть("Стр432");
	Стр442 = ПечатнаяФормаМакет.ПолучитьОбласть("Стр442");
	Стр451 = ПечатнаяФормаМакет.ПолучитьОбласть("Стр451");
	Стр452 = ПечатнаяФормаМакет.ПолучитьОбласть("Стр452");
	Стр461 = ПечатнаяФормаМакет.ПолучитьОбласть("Стр461");
	Стр462 = ПечатнаяФормаМакет.ПолучитьОбласть("Стр462");
	...
	МассивОбластей.Добавить(Заголовок_Стр4);
	...
	МассивОбластей.Добавить(Стр431);
	МассивОбластей.Добавить(Стр432);
	МассивОбластей.Добавить(Стр442);
	МассивОбластей.Добавить(Стр451);
	МассивОбластей.Добавить(Стр452);
	МассивОбластей.Добавить(Стр461);
	МассивОбластей.Добавить(Стр462);
	...
	нСтр = РегламентированнаяОтчетность.НоваяСтраница();
	нСтр.ОриентацияСтраницы = ОриентацияСтраницы.Портрет;
	ПечатьМногострочнойЧасти(нСтр, МнгСтрШаблон, ПечатнаяФормаМакет.ПолучитьОбласть("Заголовок_Стр3"), "1.5.", "П0105000000", "1");
	...
	нСтр = РегламентированнаяОтчетность.НоваяСтраница();
	нСтр.ОриентацияСтраницы = ОриентацияСтраницы.Портрет;
	ПечатьМногострочнойЧасти(нСтр, МнгСтрШаблон, Заголовок_Стр4, "4.1.1.", "П0401010100", "2");
	ПечатьМногострочнойЧасти(нСтр, МнгСтрШаблон, Стр412, "4.1.2.", "П0401020100", "2");
	ПечатьМногострочнойЧасти(нСтр, МнгСтрШаблон, Стр421, "4.2.1.", "П0402010100", "2");
	ПечатьМногострочнойЧасти(нСтр, МнгСтрШаблон, Стр422, "4.2.2.", "П0402020100", "2");
	ПечатьМногострочнойЧасти(нСтр, МнгСтрШаблон, Стр431, "4.3.1.", "П0403010100", "2");
	ПечатьМногострочнойЧасти(нСтр, МнгСтрШаблон, Стр432, "4.3.2.", "П0403020100", "2");
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(нСтр, "ОН00002");
	
	нСтр = РегламентированнаяОтчетность.НоваяСтраница();
	нСтр.ОриентацияСтраницы = ОриентацияСтраницы.Портрет;
	ПечатьМногострочнойЧасти(нСтр, МнгСтрШаблон, Заголовок_Стр5, "4.4.1.", "П0404010100", "2");
	ПечатьМногострочнойЧасти(нСтр, МнгСтрШаблон, Стр442, "4.4.2.", "П0404020100", "2");
	ПечатьМногострочнойЧасти(нСтр, МнгСтрШаблон, Стр451, "4.5.1.", "П0405010100", "2");
	ПечатьМногострочнойЧасти(нСтр, МнгСтрШаблон, Стр452, "4.5.2.", "П0405020100", "2");
	ПечатьМногострочнойЧасти(нСтр, МнгСтрШаблон, Стр461, "4.6.1.", "П0406010100", "2");
	ПечатьМногострочнойЧасти(нСтр, МнгСтрШаблон, Стр462, "4.6.2.", "П0406020100", "2");
	нСтр.Вывести(Подвал);
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(нСтр, "ОН00002");
