...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мВерсияФормы = "15/05/2012";
...
Процедура ОчиститьТабличноеПоле(Форма, ВыбТабличноеПолеИмя) Экспорт
	...
	СписокПоказателейНеПодлежащихОчистке.Добавить("ОргВебСайт");
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	//Раздел 1
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Строки_301_306","П101010103;П101010203");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Строки_307_313","П101010703");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Строка_312","П103031103;П101010703");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Строки_314_329","П101010103;П101010203;П101010303");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Строки_330_336","П101010103;П101010203;П101010303;П101010703;П101010803;П101010903;П101011003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Строки_401_438","П101010703");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Строка_431","П104042003;П104042103;П104042203;П104042303;П104042403;П104042503;П104042603;П104042703;П104042803;П104042903;П104043003; П101010703");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Строки_439_445","П101010103;П101010203;П101010303;П101010703;П101010803;П101010903;П101011003;П101011103;П101011203");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Строки_446_447","П101010703;П101011003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Строки_448_459","П101011203");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Строки_614_621","П101010103;П101010203;П101010303;П101010703;П101010803;П101010903;П101011003;П101011303");
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Если ИмяТекущейСтраницыПанели = "Раздел1" Тогда
		...
		Если Форма.ТабличныйДокумент.Области.П103030203.Значение > Форма.ТабличныйДокумент.Области.П103030103.Значение Тогда
			Форма.ТабличныйДокумент.Области.П103030203.Значение = Форма.ТабличныйДокумент.Области.П103030103.Значение;
		КонецЕсли;
		Если Форма.ТабличныйДокумент.Области.П103030303.Значение > Форма.ТабличныйДокумент.Области.П103030103.Значение Тогда
			Форма.ТабличныйДокумент.Области.П103030303.Значение = Форма.ТабличныйДокумент.Области.П103030103.Значение;
		КонецЕсли;
		Если Форма.ТабличныйДокумент.Области.П103030403.Значение > Форма.ТабличныйДокумент.Области.П103030103.Значение Тогда
			Форма.ТабличныйДокумент.Области.П103030403.Значение = Форма.ТабличныйДокумент.Области.П103030103.Значение;
		КонецЕсли;
		Если Форма.ТабличныйДокумент.Области.П103030603.Значение > Форма.ТабличныйДокумент.Области.П103030103.Значение Тогда
			Форма.ТабличныйДокумент.Области.П103030603.Значение = Форма.ТабличныйДокумент.Области.П103030103.Значение;
		КонецЕсли;
		Если Форма.ТабличныйДокумент.Области.П103030503.Значение > Форма.ТабличныйДокумент.Области.П103030403.Значение Тогда
			Форма.ТабличныйДокумент.Области.П103030503.Значение = Форма.ТабличныйДокумент.Области.П103030403.Значение;
		КонецЕсли;
		Если Форма.ТабличныйДокумент.Области.П103033703.Значение > Форма.ТабличныйДокумент.Области.П103030503.Значение Тогда
			Форма.ТабличныйДокумент.Области.П103033703.Значение = Форма.ТабличныйДокумент.Области.П103030503.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрНайти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_301_306, ОбластьИмя) > 0 Тогда
			...
			ИЛИ Форма.ТабличныйДокумент.Области.П101010203.Значение = 1;
		...
		// Установка цвета и доступности строки 312 для ввода 
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрНайти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строка_312, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П103031103.Значение = 1;
			УстановитьЦветИДоступностьЯчейки(Форма, "П103031203", УсловиеДоступа);
		КонецЕсли;
		
		// Установка цвета и доступности строк 314-329 для ввода 
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрНайти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_314_329, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010103.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010203.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010303.Значение = 1;
			Для КодСтроки = 314 По 329 Цикл
				ИмяЯчейки = "П1030" + Строка(КодСтроки) + "03";
				УстановитьЦветИДоступностьЯчейки(Форма, ИмяЯчейки, УсловиеДоступа);
			КонецЦикла;
		КонецЕсли;
		
		// Установка цвета и доступности строк 330-336 для ввода 
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрНайти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_330_336, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010103.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010203.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010303.Значение = 1
			...
			Для КодСтроки = 330 По 336 Цикл
				ИмяЯчейки = "П1030" + Строка(КодСтроки) + "03";
				УстановитьЦветИДоступностьЯчейки(Форма, ИмяЯчейки, УсловиеДоступа);
			КонецЦикла;
		КонецЕсли;
		
		// Установка цвета и доступности строк 401-438 для ввода 
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрНайти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_401_438, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010703.Значение = 1;
			Для КодСтроки = 401 По 438 Цикл
				ИмяЯчейки = "П1040" + Строка(КодСтроки) + "03";
				УстановитьЦветИДоступностьЯчейки(Форма, ИмяЯчейки, УсловиеДоступа);
			КонецЦикла;
		КонецЕсли;
		
		// Установка цвета и доступности строки 431 для ввода 
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрНайти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строка_431, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Ложь;
			Для КодСтроки = 420 По 430 Цикл
				ИмяЯчейки = "П1040" + Строка(КодСтроки) + "03";
				...
				КонецЕсли;
			КонецЦикла;
			УстановитьЦветИДоступностьЯчейки(Форма, "П104043103", УсловиеДоступа);
		КонецЕсли;
		
		// Установка цвета и доступности строк 439-445 для ввода 
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрНайти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_439_445, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010103.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010203.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010303.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010703.Значение = 1
			...
			Для КодСтроки = 439 По 445 Цикл
				ИмяЯчейки = "П1040" + Строка(КодСтроки) + "03";
				УстановитьЦветИДоступностьЯчейки(Форма, ИмяЯчейки, УсловиеДоступа);
			КонецЦикла;
		КонецЕсли;
		
		// Установка цвета и доступности строк 446-447 для ввода 
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрНайти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_446_447, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010703.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101011003.Значение = 1;
			Для КодСтроки = 446 По 447 Цикл
				ИмяЯчейки = "П1040" + Строка(КодСтроки) + "03";
				УстановитьЦветИДоступностьЯчейки(Форма, ИмяЯчейки, УсловиеДоступа);
			КонецЦикла;
		КонецЕсли;
		
		// Установка цвета и доступности строк 448-459 для ввода 
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрНайти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_448_459, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101011203.Значение = 1;
			Для КодСтроки = 448 По 459 Цикл
				ИмяЯчейки = "П1040" + Строка(КодСтроки) + "03";
				УстановитьЦветИДоступностьЯчейки(Форма, ИмяЯчейки, УсловиеДоступа);
			КонецЦикла;
		КонецЕсли;
		
		// Установка цвета и доступности строк 614-621 для ввода 
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрНайти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_614_621, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010103.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010203.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010303.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010703.Значение = 1
			...
			ИЛИ Форма.ТабличныйДокумент.Области.П101010903.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101011003.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101011303.Значение = 1;
			Для КодСтроки = 614 По 621 Цикл
				ИмяЯчейки = "П1060" + Строка(КодСтроки) + "03";
				УстановитьЦветИДоступностьЯчейки(Форма, ИмяЯчейки, УсловиеДоступа);
			КонецЦикла;
		КонецЕсли;
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "Раздел2" Тогда
		...
		Форма.ТабличныйДокумент.Области.П208080103.Значение = Форма.ТабличныйДокумент.Области.П208080203.Значение
		+ Форма.ТабличныйДокумент.Области.П208080303.Значение
		+ Форма.ТабличныйДокумент.Области.П208080403.Значение
		+ Форма.ТабличныйДокумент.Области.П208080503.Значение
		+ Форма.ТабличныйДокумент.Области.П208080603.Значение
		+ Форма.ТабличныйДокумент.Области.П208080703.Значение
		+ Форма.ТабличныйДокумент.Области.П208080803.Значение
		+ Форма.ТабличныйДокумент.Области.П208080903.Значение
		+ Форма.ТабличныйДокумент.Области.П208081003.Значение
		+ Форма.ТабличныйДокумент.Области.П208081103.Значение
		+ Форма.ТабличныйДокумент.Области.П208081203.Значение
		+ Форма.ТабличныйДокумент.Области.П208081303.Значение
		+ Форма.ТабличныйДокумент.Области.П208081403.Значение;
		
		Форма.ТабличныйДокумент.Области.П208081503.Значение = Форма.ТабличныйДокумент.Области.П208081603.Значение
		+ Форма.ТабличныйДокумент.Области.П208081703.Значение
		+ Форма.ТабличныйДокумент.Области.П208081803.Значение;
		
		Если Форма.ТабличныйДокумент.Области.П209090203.Значение > Форма.ТабличныйДокумент.Области.П209090103.Значение Тогда
			Форма.ТабличныйДокумент.Области.П209090203.Значение = Форма.ТабличныйДокумент.Области.П209090103.Значение;
		КонецЕсли;
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	СоответствиеРазделовМакетам.Вставить("Титульный", "ФормаОтчета2011Кв4_Титульный");
	СоответствиеРазделовМакетам.Вставить("Раздел1",   "ФормаОтчета2011Кв4_Раздел1");
	СоответствиеРазделовМакетам.Вставить("Раздел2",   "ФормаОтчета2011Кв4_Раздел2");
...
Процедура ОчиститьНаСервере() Экспорт
	...
	Для каждого ЭлементСтруктуры Из СтруктураДанныхРаздел2 Цикл
		...
		Если СписокПоказателейНеПодлежащихОчистке.НайтиПоЗначению(ЭлементСтруктуры.Ключ) <> Неопределено Тогда
			Продолжить;
		КонецЕсли;
		СтруктураДанныхРаздел1.Удалить(ЭлементСтруктуры.Ключ);
	КонецЦикла;
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел1" Тогда
		...
		Если Область.Защита ИЛИ Область.ЦветФона = СтруктураРеквизитовФормы.мЦветБелый Тогда
		...
		Если (Часть1Имени = "П101" И Часть2Имени >= "101" И Часть2Имени <= "114" И Часть3Имени = "03") //Номера строк 101-114
			...
			ИЛИ (Часть1Имени = "П103" И Часть2Имени >= "314" И Часть2Имени <= "329" И Часть3Имени = "03") //Номера строк 314-329
			ИЛИ (Часть1Имени = "П104" И Часть2Имени >= "401" И Часть2Имени <= "430" И Часть3Имени = "03") //Номера строк 401-430
			ИЛИ (Часть1Имени = "П104" И Часть2Имени >= "432" И Часть2Имени <= "443" И Часть3Имени = "03") //Номера строк 432-443
			ИЛИ (Часть1Имени = "П104" И Часть2Имени >= "448" И Часть2Имени <= "459" И Часть3Имени = "03") //Номера строк 448-459
			ИЛИ (Часть1Имени = "П107" И Часть2Имени >= "707" И Часть2Имени <= "709" И Часть3Имени = "03") //Номера строк 707-709
			ИЛИ (Часть1Имени = "П107" И Часть2Имени =  "701") //Номер строки 701, колонки 3, 4
			ИЛИ (Часть1Имени = "П107" И Часть2Имени =  "706") //Номер строки 706, колонки 3, 4
			Тогда
		...
		ИначеЕсли Часть1Имени = "П102" И Часть2Имени >= "201" И Часть2Имени <= "216" И Часть3Имени = "03" Тогда //Номера строк 201-216
		...
		ИначеЕсли ОбластьИмя = "П103031303" Тогда
			...
			Список = Новый СписокЗначений;
			Список.Добавить(0,"Пустое значение      ");
			Список.Добавить(1,"1 - ниже 128 Кбит/сек");
			Список.Добавить(2,"2 - 128-255 Кбит/сек");
			Список.Добавить(3,"3 - 256-511 Кбит/сек");
			Список.Добавить(4,"4 - 512-999 Кбит/сек");
			Список.Добавить(5,"5 - 1.0-1.4 Мбит/сек");
			Список.Добавить(6,"6 - 1.5-1.9 Мбит/сек");
			Список.Добавить(7,"7 - 2 и выше Мбит/сек");
		...
		ИначеЕсли Часть1Имени = "П103" И Часть2Имени >= "330" И Часть2Имени <= "336" И Часть3Имени = "03" Тогда //Номера строк 330-336
			
			СтандартнаяОбработка = Ложь;
			
			Список = Новый СписокЗначений;
			Список.Добавить(0,"Пустое значение");
			Список.Добавить(1,"1 - используем");
			Список.Добавить(2,"2 - не используем, но планируем начать использование");
			Список.Добавить(3,"3 - не используем и не планируем использовать");
		...
		ИначеЕсли ОбластьИмя = "П104043103" Тогда
		...
		ИначеЕсли ОбластьИмя = "П104044403" Тогда
			...
			Список.Добавить(6,"6 - электронные документы не отправляли");
		...
		ИначеЕсли ОбластьИмя = "П104044503" Тогда
			...
			Список.Добавить(4,"4 - 50-69%");
			Список.Добавить(5,"5 - 70-100%");
			Список.Добавить(6,"6 - электронные документы не поступали");
		...
		ИначеЕсли (Часть1Имени = "П104" И Часть2Имени >= "446" И Часть2Имени <= "447" И Часть3Имени = "03") //Номера строк 446-447
			ИЛИ (Часть1Имени = "П106" И Часть2Имени >= "618" И Часть2Имени <= "621" И Часть3Имени = "03") //Номера строк 618-621
			Тогда
			...
			Список.Добавить(4,"4 - 50-69%");
			Список.Добавить(5,"5 - 70-100%");
			Список.Добавить(6,"6 - не использовали");
		...
		ИначеЕсли Часть1Имени = "П107" И Часть2Имени >= "702" И Часть2Имени <= "705" Тогда //Номера строк 702-705, колонки 3,4
			...
			Список.Добавить(1,"1 - незначительная или малосущественная");
			Список.Добавить(2,"2 - значительная");
			Список.Добавить(3,"3 - затрудняюсь ответить");
...
Функция ЗагрузкаОтчетаИзФайлаНаСервере(ДанныеДляЗагрузки)
	...
	ДеревоДляЗагрузки = РегламентированнаяОтчетность.ПолучитьДеревоВыгрузки(ЭтаФорма, "СхемаВыгрузкиXML2011Кв4");
...
Функция ПроверитьПоказатели() Экспорт
	...
	РегламентированнаяОтчетность.СформироватьСтруктуруПоказателей(ЭтаФорма);
	ДеревоВыгрузки = РегламентированнаяОтчетность.ПолучитьДеревоВыгрузки(ЭтаФорма, "СхемаВыгрузкиXML2011Кв4");
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если НЕ РегламентированнаяОтчетность.ПроверитьРазделыНаНаличиеИнформации(ЭтаФорма, ДеревоВыгрузки, "ПолеТабличногоДокументаРаздел2") Тогда
		
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не заполнен раздел II!", "Раздел2", "");
		СтатусПроверки = Ложь;
...
Функция СформироватьИмяФайла(ПараметрыВыгрузки, ДопАтрибуты)
	...
	ОтчетныйПериод = 1; // Годовая отчетность
	...
	ИмяФайлаXML = ИмяФайлаXML + ?(ПустаяСтрока(ПризнакСекр), "", "_" + ПризнакСекр) + ".xml";
...
Функция СформироватьСтруктуруПараметров()
	...
	ДопАтрибуты = РегламентированнаяОтчетность.СформироватьСтруктуруДопАтрибутов(ЭтаФорма.ИмяФормы, "АтрибВыгрузкиXML2011Кв4");
	...
	ПараметрыВыгрузки.Вставить("ПрзСекр", "");
