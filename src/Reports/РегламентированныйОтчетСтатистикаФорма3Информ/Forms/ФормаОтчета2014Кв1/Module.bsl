...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Если ИмяТекущейСтраницыПанели = "Раздел1" Тогда
		...
		+ Области.П105050503.Значение
		+ Области.П105050703.Значение
		...
		+ Области.П106060504.Значение
		+ Области.П106060604.Значение
		+ Области.П106060704.Значение
		+ Области.П106060804.Значение
		+ Области.П106060904.Значение
		+ Области.П106061004.Значение
		+ Области.П106061104.Значение;
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	СоответствиеРазделовМакетам.Вставить("Раздел2",   "ФормаОтчета2014Кв1_Раздел2");
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел1" Тогда
		...
		Если (Часть1Имени = "П101" И Часть2Имени >= "101" И Часть2Имени <= "115" И Часть3Имени = "03") // номера строк 101-115
			...
			ИЛИ (Часть1Имени = "П103" И Часть2Имени >= "310" И Часть2Имени <= "337" И Часть3Имени = "03") // номера строк 310-337
		...
		ИначеЕсли ОбластьИмя = "П103030703" Или ОбластьИмя = "П103030803" Или ОбластьИмя = "П103030903" Тогда
			...
			Если ОбластьИмя = "П103030803" Или ОбластьИмя = "П103030903" Тогда 
				Список.Добавить(7,"7 - этот вид доступа не используется");
			КонецЕсли;
