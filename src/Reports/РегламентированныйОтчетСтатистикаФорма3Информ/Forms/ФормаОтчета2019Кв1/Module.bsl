...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мВерсияФормы = "31/07/2019";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Если ИмяТекущейСтраницыПанели = "Раздел1" Тогда
		...
		Области.П105052503.Значение = Области.П105052603.Значение + Области.П105052703.Значение;
		Области.П105052303.Значение = Области.П105052403.Значение + Области.П105052503.Значение
										+ Области.П105052803.Значение + Области.П105052903.Значение;
		Области.П105051503.Значение = Области.П105051603.Значение + Области.П105051703.Значение
										+ Области.П105052103.Значение + Области.П105052203.Значение;
		Области.П105050303.Значение = Области.П105050403.Значение + Области.П105050803.Значение
										+ Области.П105051003.Значение + Области.П105051103.Значение
										+ Области.П105051303.Значение + Области.П105051403.Значение;
		Области.П105050103.Значение = Области.П105050303.Значение + Области.П105051503.Значение;
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	СоответствиеРазделовМакетам.Вставить("Раздел2",   "ФормаОтчета2019Кв1_Раздел2");
