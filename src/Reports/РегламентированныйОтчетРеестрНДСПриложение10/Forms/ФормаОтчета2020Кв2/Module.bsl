...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	Если РазделЗаполнен(ДанныеРеестра.Строки, Ложь) Тогда
		...
		ПроверитьКС_10_1_1(СтруктураРезультата);
		ПроверитьКС_10_1_2(СтруктураРезультата);
		ПроверитьКС_10_1_3(СтруктураРезультата);
		ПроверитьКС_10_1_4(СтруктураРезультата);
		ПроверитьКС_10_1_5(СтруктураРезультата);
		ПроверитьКС_10_1_6(СтруктураРезультата);
		ПроверитьКС_10_1_7(СтруктураРезультата);
		ПроверитьКС_10_2_1(СтруктураРезультата);
		ПроверитьКС_10_2_2(СтруктураРезультата);
		ПроверитьКС_10_2_3(СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_10_1_1(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 10.1.1';
												|en = 'Проверка КС 10.1.1'"));
...
&НаСервере
Процедура ПроверитьКС_10_1_2(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 10.1.2';
												|en = 'Проверка КС 10.1.2'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_10_1_3(СтруктураРезультата)
	
	Заголовки		= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"		,НСтр("ru = 'Проверка КС 10.1.3';
													|en = 'Проверка КС 10.1.3'"));
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Код страны регистрации судна (графа 7 Реестра) должен соответствовать справочнику ОКСМ';
			|en = 'Код страны регистрации судна (графа 7 Реестра) должен соответствовать справочнику ОКСМ'"));
	Заголовки.Вставить("ШаблонОшибки"		,
		НСтр("ru = 'Указанный код страны регистрации судна отсутствует в справочнике ОКСМ';
			|en = 'Указанный код страны регистрации судна отсутствует в справочнике ОКСМ'"));
	Заголовки.Вставить("ШаблонРасшифровки"	,НСтр("ru = 'Указанный код: (""%1"")';
													|en = 'Указанный код: (""%1"")'"));
	Заголовки.Вставить("Показатель"			,НСтр("ru = 'СтранаРегистрации';
													|en = 'СтранаРегистрации'"));
...
&НаСервере
Процедура ПроверитьКС_10_1_4(СтруктураРезультата)
	
	Заголовки		= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"		,НСтр("ru = 'Проверка КС 10.1.4';
													|en = 'Проверка КС 10.1.4'"));
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Код страны порта погрузки груза (графа 8 Реестра) должен соответствовать справочнику ОКСМ';
			|en = 'Код страны порта погрузки груза (графа 8 Реестра) должен соответствовать справочнику ОКСМ'"));
	Заголовки.Вставить("ШаблонОшибки"		,
		НСтр("ru = 'Указанный код страны порта погрузки груза отсутствует в справочнике ОКСМ';
			|en = 'Указанный код страны порта погрузки груза отсутствует в справочнике ОКСМ'"));
	Заголовки.Вставить("ШаблонРасшифровки"	,НСтр("ru = 'Указанный код: (""%1"")';
													|en = 'Указанный код: (""%1"")'"));
...
&НаСервере
Процедура ПроверитьКС_10_1_5(СтруктураРезультата)
	
	Заголовки		= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"		,НСтр("ru = 'Проверка КС 10.1.5';
													|en = 'Проверка КС 10.1.5'"));
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Код страны порта разгрузки груза (графа 9 реестра) должен соответствовать справочнику ОКСМ';
			|en = 'Код страны порта разгрузки груза (графа 9 реестра) должен соответствовать справочнику ОКСМ'"));
	Заголовки.Вставить("ШаблонОшибки"		,
		НСтр("ru = 'Указанный код страны порта разгрузки груза отсутствует в справочнике ОКСМ';
			|en = 'Указанный код страны порта разгрузки груза отсутствует в справочнике ОКСМ'"));
	Заголовки.Вставить("ШаблонРасшифровки"	,НСтр("ru = 'Указанный код: (""%1"")';
													|en = 'Указанный код: (""%1"")'"));
...
&НаСервере
Процедура ПроверитьКС_10_1_6(СтруктураРезультата)
	
	Настройки	= ОбработатьНастройки(,, СтруктураРезультата);
	Настройки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 10.1.6';
												|en = 'Проверка КС 10.1.6'"));
	Настройки.Вставить("Нарушение"		,НСтр("ru = 'Ошибка заполнения';
												|en = 'Ошибка заполнения'"));
	Настройки.Вставить("ОписаниеКС"		,
		НСтр("ru = 'Дата отметки российского таможенного органа ""Погрузка разрешена"" (при вывозе) (графа 10 Реестра) должна быть заполнена, если:
		|- вывоз товаров осуществлялся морским, речным транспортом (значение кода страны порта погрузки равно ""RU"", значение кода страны порта разгрузки не равно ""RU"");
		|- в графе 2 установлен Вид документа ""Поручение на отгрузку""';
		|en = 'Дата отметки российского таможенного органа ""Погрузка разрешена"" (при вывозе) (графа 10 Реестра) должна быть заполнена, если:
		|- вывоз товаров осуществлялся морским, речным транспортом (значение кода страны порта погрузки равно ""RU"", значение кода страны порта разгрузки не равно ""RU"");
		|- в графе 2 установлен Вид документа ""Поручение на отгрузку""'"));
	Настройки.Вставить("ШаблонОшибки"	,
		НСтр("ru = 'Не указана дата отметки российского таможенного органа ""Погрузка разрешена"" при вывозе товара';
			|en = 'Не указана дата отметки российского таможенного органа ""Погрузка разрешена"" при вывозе товара'"));
	Настройки.Вставить("ШаблонРасшифровки"	,НСтр("ru = 'Указанная дата: (""%1"")';
													|en = 'Указанная дата: (""%1"")'"));
	...
	Для каждого СтраницаРаздела Из ДанныеРеестра.Строки Цикл
		...
		Для НомерСтроки = 1 По КоличествоСтрок Цикл
			...
			Список2Уровня	= ДанныеСтраницы[НомерСтроки - 1].ДанныеМногострочныхЧастей.П11000.Строки;
			...
			Для НомерСтроки2Уровня = 1 По КоличествоСтрок2Уровня Цикл
				...
				Показатели		= ЗаполнитьПоказатели("ВидДокумента, СтранаПогрузки, СтранаРазгрузки, ДатаПогрузки", 
					Список2Уровня[НомерСтроки2Уровня - 1].Данные, НомерСтроки, НомерСтроки2Уровня);
				
				Если Не (Показатели.ВидДокумента.Значение = "06" 
					И ВРег(Показатели.СтранаПогрузки.Значение) = НСтр("ru = 'RU';
																		|en = 'RU'")
					И Не ВРег(Показатели.СтранаРазгрузки.Значение) = НСтр("ru = 'RU';
																			|en = 'RU'")) Тогда
					Продолжить;
				КонецЕсли;
				...
				Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
					Показатели.ДатаПогрузки.ЗначениеСтр);
				Настройки.ОписаниеОшибки = Настройки.ШаблонОшибки;
				Настройки.ЭтоОшибка	= Не ЗначениеЗаполнено(Показатели.ДатаПогрузки.Значение);
...
&НаСервере
Процедура ПроверитьКС_10_1_7(СтруктураРезультата)
	
	Настройки	= ОбработатьНастройки(,, СтруктураРезультата);
	Настройки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 10.1.7';
												|en = 'Проверка КС 10.1.7'"));
	Настройки.Вставить("Нарушение"		,НСтр("ru = 'Ошибка заполнения';
												|en = 'Ошибка заполнения'"));
	Настройки.Вставить("ОписаниеКС"		,
		НСтр("ru = 'В случае выполнения работ (услуг), предусмотренных подпунктом 2.5 пункта 1 статьи 164 Налогового ';
			|en = 'В случае выполнения работ (услуг), предусмотренных подпунктом 2.5 пункта 1 статьи 164 Налогового '") +
		НСтр("ru = 'кодекса Российской Федерации (код вида операции 1010433/1010482/1010483/1010484), связанных с ввозом ';
			|en = 'кодекса Российской Федерации (код вида операции 1010433/1010482/1010483/1010484), связанных с ввозом '") +
		НСтр("ru = 'товаров морским и речным транспортом (значение кода страны порта погрузки не равно ""RU"", значение ';
			|en = 'товаров морским и речным транспортом (значение кода страны порта погрузки не равно ""RU"", значение '") +
		НСтр("ru = 'кода страны порта разгрузки равно ""RU"") осуществляется проверка обязательности заполнения графы 11 ';
			|en = 'кода страны порта разгрузки равно ""RU"") осуществляется проверка обязательности заполнения графы 11 '") +
		НСтр("ru = 'Реестра ""Дата отметки российского таможенного органа (при ввозе)""';
			|en = 'Реестра ""Дата отметки российского таможенного органа (при ввозе)""'"));
	Настройки.Вставить("ШаблонОшибки"	,
		НСтр("ru = 'Не указана дата отметки российского таможенного органа при ввозе товара';
			|en = 'Не указана дата отметки российского таможенного органа при ввозе товара'"));
	Настройки.Вставить("ШаблонРасшифровки"	,НСтр("ru = 'Указанная дата: (""%1"")';
													|en = 'Указанная дата: (""%1"")'"));
	Настройки.Вставить("ШаблонДопСведений"	,НСтр("ru = 'Страница %1%2%3%4%5';
													|en = 'Страница %1%2%3%4%5'"));
	ВидыОпераций			= Новый Соответствие;
	ВидыОпераций.Вставить("1010433", "1010433");
	ВидыОпераций.Вставить("1010482", "1010482");
	ВидыОпераций.Вставить("1010483", "1010483");
	ВидыОпераций.Вставить("1010484", "1010484");
	КолвоСтрокРасч			= Новый Соответствие;
	НомерСтраницы			= 0;
	...
	Для каждого СтраницаРаздела Из ДанныеРеестра.Строки Цикл
		...
		Если ВидыОпераций.Получить(Показатели1.КодОперации.Значение) = Неопределено Тогда
			Продолжить;
		КонецЕсли; 
		...
		Для НомерСтроки = 1 По КоличествоСтрок Цикл
			...
			Для НомерСтроки2Уровня = 1 По КоличествоСтрок2Уровня Цикл
				...
				Настройки.Вставить("ДопСведенияПараметры", Новый Структура(
					"НомерСтраницы, Ключ1, НомерСтроки, Ключ2, НомерПодстроки", НомерСтраницы, ", Строка ", НомерРасчетный, 
					", Подстрока ", НомерСтроки2Уровня));
				Показатели2		= ЗаполнитьПоказатели("СтранаПогрузки, СтранаРазгрузки, ДатаВвоза", 
					Список2Уровня[НомерСтроки2Уровня - 1].Данные, НомерСтроки, НомерСтроки2Уровня);
				
				Если Не (Не ВРег(Показатели2.СтранаПогрузки.Значение) = НСтр("ru = 'RU';
																			|en = 'RU'") 
					И ВРег(Показатели2.СтранаРазгрузки.Значение) = НСтр("ru = 'RU';
																		|en = 'RU'")) Тогда
					Продолжить;
				КонецЕсли;
				...
				Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
					Показатели2.ДатаВвоза.ЗначениеСтр);
				Настройки.ОписаниеОшибки = Настройки.ШаблонОшибки;
				Настройки.ЭтоОшибка	= Не ЗначениеЗаполнено(Показатели2.ДатаВвоза.Значение);
				ДобавитьЭлементВСтруктуруОшибок(Настройки);
...
&НаСервере
Процедура ПроверитьКС_10_2_1(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 10.2.1';
												|en = 'Проверка КС 10.2.1'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_10_2_2(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 10.2.2';
												|en = 'Проверка КС 10.2.2'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_10_2_3(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 10.2.3';
												|en = 'Проверка КС 10.2.3'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
Функция ПоказательПоСтроке(УсловныйКодПоказателя)
	...
	ИначеЕсли УсловныйКодПоказателя = "СтранаРегистрации" Тогда
		Результат.Вставить("Имя", "П1100007%1%2%3%4");
		Результат.Вставить("Представление", Нстр("ru = 'Код страны регистрации судна';
												|en = 'Код страны регистрации судна'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "СтранаПогрузки" Тогда
		Результат.Вставить("Имя", "П1100028%1%2%3%4");
		Результат.Вставить("Представление", Нстр("ru = 'Код страны порта погрузки';
												|en = 'Код страны порта погрузки'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "СтранаРазгрузки" Тогда
		Результат.Вставить("Имя", "П1100029%1%2%3%4");
	...
	ИначеЕсли УсловныйКодПоказателя = "ВидДокумента" Тогда
		Результат.Вставить("Имя", "П1100002%1%2%3%4");
		Результат.Вставить("Представление", Нстр("ru = 'Вид товаросопроводительного документа';
												|en = 'Вид товаросопроводительного документа'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "ДатаПогрузки" Тогда
		Результат.Вставить("Имя", "П1100010%1%2%3%4");
		Результат.Вставить("Представление", Нстр("ru = 'Дата отметки ""Погрузка разрешена""';
												|en = 'Дата отметки ""Погрузка разрешена""'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "ДатаВвоза" Тогда
		Результат.Вставить("Имя", "П1100011%1%2%3%4");
		Результат.Вставить("Представление", Нстр("ru = 'Дата отметки российского таможенного органа при ввозе товара';
												|en = 'Дата отметки российского таможенного органа при ввозе товара'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
