		...
		Для каждого Ветка_П10000 Из ДанныеМнЧ_П10000 Цикл
			...
			Для каждого Ветка_П11000 Из ДанныеМнЧ_П11000 Цикл
				...
				Если ВыпУсловие Тогда
					...
					КонецЕсли;
				КонецЕсли;
				ВыпУсловие = (Ветка.Данные["КодОперации"] = "1010433"
						  ИЛИ Ветка.Данные["КодОперации"] = "1010482"
						  ИЛИ Ветка.Данные["КодОперации"] = "1010483"
						  ИЛИ Ветка.Данные["КодОперации"] = "1010484");
				Если ВыпУсловие Тогда
