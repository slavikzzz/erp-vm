...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = НСтр("ru = 'Сокращенный отчет по остаткам алкогольной продукции в ЕГАИС.';
										|en = 'Сокращенный отчет по остаткам алкогольной продукции в ЕГАИС.'");
...
//
// Параметры:
//  СписокОтчетов - Массив из ДокументСсылка.ОтчетЕГАИС - массив документов ОтчетЕГАИС.
//
...
// см. ОтчетыЕГАИС.ЕстьРасхожденияВПолученныхДанных
