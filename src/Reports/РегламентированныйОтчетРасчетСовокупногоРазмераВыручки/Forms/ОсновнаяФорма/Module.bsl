...
Процедура ВыбратьФорму(Команда)
	...
	ДопТекстОписания = НСтр("ru = 'Расчет совокупного размера выручки представляют организации.';
							|en = 'Расчет совокупного размера выручки представляют организации.'");
...
Функция ДоступныеОрганизацииОтсутствуютТекст()
	...
	Возврат НСтр(
		"ru = 'Расчет совокупного размера выручки представляют только организации.
		|В справочнике ""Организации"" сведения об организациях отсутствуют.';
		|en = 'Расчет совокупного размера выручки представляют только организации.
		|В справочнике ""Организации"" сведения об организациях отсутствуют.'");
