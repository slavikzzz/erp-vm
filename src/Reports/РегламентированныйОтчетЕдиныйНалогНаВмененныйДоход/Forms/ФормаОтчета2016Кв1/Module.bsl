		...
		Если ЗначениеЗаполнено(ДанныеЛиста.П000020001000) ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020002001)
		 ...
		 ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020011003) Тогда
			...
			Если НЕ (Ставка >= 7.5 И Ставка <= 15) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 2 не" + ?(Ставка = 0, "", "верно") + " задана ставка налога. Возможные значения: от 7.5 до 15 процентов.", "Раздел2", "П000020010503", НомерЛиста);
				СтатусПроверки = Ложь;
			КонецЕсли;
...
Процедура ПроверитьКС_2(СтруктураРезультата)
	...
	ИмяРаздела = "Раздел2";
	НазваниеСписка = "СпискиВыбора2016Кв1";
...
Процедура ПроверитьКС_6_1(СтруктураРезультата)
	...
	ОписаниеКС   = НСтр("ru = 'Сумма единого налога на вмененный доход, подлежащий к уплате (строка 040 Раздела 3) должна быть равна разнице значений по строке 010 Раздела 3 и по строке 020 Раздела 3, если результат такого вычитания больше или равен 50% строки 010 Раздела 3 и строка 005 Раздела 3 = ""1""';
						|en = 'Сумма единого налога на вмененный доход, подлежащий к уплате (строка 040 Раздела 3) должна быть равна разнице значений по строке 010 Раздела 3 и по строке 020 Раздела 3, если результат такого вычитания больше или равен 50% строки 010 Раздела 3 и строка 005 Раздела 3 = ""1""'");
...
Процедура ПроверитьКС_6_2(СтруктураРезультата)
	...
	ОписаниеКС   = НСтр("ru = 'Сумма единого налога на вмененный доход, подлежащий к уплате (строка 040 Раздела 3) должна быть равна разнице значений по строкам 010 Раздела 3 и по строке 030 Раздела 3, если результат такого вычитания больше или равен нулю и строка 005 Раздела 3 = ""2""';
						|en = 'Сумма единого налога на вмененный доход, подлежащий к уплате (строка 040 Раздела 3) должна быть равна разнице значений по строкам 010 Раздела 3 и по строке 030 Раздела 3, если результат такого вычитания больше или равен нулю и строка 005 Раздела 3 = ""2""'");
