		...
		Если ЗначениеЗаполнено(СтруктураРеквизитовФормы.мСкопированаФорма) Тогда
			...
			Если ИсходнаяОрганизация <> СтруктураРеквизитовФормы.Организация
			 ИЛИ ИсходныйПериод <> СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета Тогда
				...
				СтруктураДанныхРаздел3.П000030003503 = 0;
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000030004003", "П000030000503;П000030001003;П000030002003;П000030003003;П000030003503");
...
Функция Сохранить(Автосохранение = Ложь, КодИФНС, КПП, Вариант, ВидДокументаНомерКорректировкиИзменен = Неопределено, НаимТекРаздела) Экспорт
	...
	СтруктураРеквизитовФормы.мСохраненныйДок.ИсточникОтчета
		= Метаданные.Отчеты[ИмяОтчета(ЭтаФорма.ИмяФормы)].Имя;
...
Процедура ОбработкаВыбораВПолеТабличногоДокумента(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли СтрНачинаетсяС(Область.Имя, "СохранитьПояснительнуюЗаписку") Тогда
		СохранитьПояснительнуюЗаписку();
	КонецЕсли;
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "", ПриИзмененииСодержимогоОбласти = Ложь)
	...
	ИначеЕсли ИмяСтраницыПанели = "Раздел3" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000030004003, ОбластьИмя) > 0 Тогда
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел3" Тогда
				...
				Строка035 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Форма.ТабличныйДокумент.Области.П000030003503.Значение);
			...
			Иначе
				...
				Если Форма.СтруктураДанныхРаздел3.Количество() > 0 Тогда
					...
					Строка035 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Форма.СтруктураДанныхРаздел3.П000030003503);
	...
	ИначеЕсли ИмяСтраницыПанели = "Раздел4" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел4" Тогда
			...
			Форма.СтруктураДанныхРаздел3.П000030003503 = ОбщаяСумма;
		...
		Иначе
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел3" Тогда
				Форма.ТабличныйДокумент.Области.П000030003503.Значение = ОбщаяСумма;
			Иначе
				Форма.СтруктураДанныхРаздел3.П000030003503 = ОбщаяСумма;
			КонецЕсли;
...
Процедура РасчетВСтруктуре() Экспорт
	...
	Если СтруктураДанныхРаздел3.Количество() = 0 Тогда
		...
		СтруктураДанныхРаздел3.Вставить("П000030003503", 0);
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел4" Тогда
		...
		Пока Обл <> Неопределено Цикл
			ЗначП000030003503 = ЗначП000030003503
		...
		КонецЦикла;
		ТабличныйДокумент.Области.П000040015003.Значение = ЗначП000030003503;
	Иначе
		Для каждого СтрокаТЗ Из ЭтаФорма.П00004000 Цикл
			ЗначП000030003503 = ЗначП000030003503
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, СтрокаТЗ["П000040005003"]);
		КонецЦикла;
		СтруктураДанныхРаздел4.П000040015003 = ЗначП000030003503;
	КонецЕсли;
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел3" Тогда
		...
		ТабличныйДокумент.Области.П000030003503.Значение = ЗначП000030003503;
	Иначе
		СтруктураДанныхРаздел3.П000030001003 = ЗначП000030001003;
		СтруктураДанныхРаздел3.П000030003503 = ЗначП000030003503;
	КонецЕсли;
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел3" Тогда
		...
		СтруктураДанныхРаздел3.П000030003503 = ТабличныйДокумент.Области.П000030003503.Значение;
...
Процедура ОбработкаИзмененияСодержимогоВПолеТабличногоДокумента(Элемент, Область)
	...
	Если Область.Имя = "ОКВЭД" Тогда
		...
		Если НЕ ПустаяСтрока(Область.Значение) И НЕ РегламентированнаяОтчетностьКлиентСервер.ОКВЭДСоответствуетТребованиям(Область.Значение) Тогда
			...
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'На титульном листе задано некорректное значение кода вида деятельности по ОКВЭД.%1Допустимы значения, соответствующие следующим шаблонам:%2""XX"", ""XX.X"", ""XX.XX"", ""XX.XX.X"", ""XX.XX.XX"" (X - любая цифра).';
...
Процедура ИзменитьРамкиОбластейТабличногоДокумента(Форма, ИмяСтраницыПанели = "")
	...
	Если ИмяСтраницыПанели = "Титульный" Тогда
		...
		ПараметрыВыделяемыхОбластей.Добавить(Новый Структура("ИмяОбласти", "ОКВЭД"));
...
Процедура ВывестиМакетВТаблДокНаСервере(ИмяТекРаздела, НомерСтраницыРазделаОтчета)
	...
	Если ИмяТекРаздела = "Раздел1"
		...
		Если ИмяТекРаздела = "Раздел4" Тогда
			Если СтруктураРеквизитовФормы.ИП Тогда
				ТабличныйДокумент.Области.ПериодПЗ.Текст = СтруктураДанныхТитульный.Период;
				ТабличныйДокумент.Области.ОтчетГодПЗ.Текст = СтруктураДанныхТитульный.ОтчетГод;
				ТабличныйДокумент.Области.НаимОргПЗ.Текст = СтруктураДанныхТитульный.НаимОрг;
				ТабличныйДокумент.Области.ИННПЗ.Текст = СтруктураДанныхТитульный.ИНН1;
			Иначе
				ТабличныйДокумент.Области.СекцияСохранитьПояснительнуюЗаписку.Видимость = Ложь;
			КонецЕсли;
		КонецЕсли;
...
Процедура ОчисткаИПодготовкаРаздела3НаСервере()
	...
	П000030003503 = ТабличныйДокумент.Области.П000030003503.Значение;
	...
	ТабличныйДокумент.Области.П000030003503.Значение = П000030003503;
...
Процедура ОчиститьТекущуюСтраницу(Команда)
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел3" Тогда
		СтруктураРеквизитовФормы.Вставить("Раздел3Строка035ДоОчистки", ТабличныйДокумент.Области.П000030003503.Значение);
	КонецЕсли;
...
Процедура ОчиститьТекущуюСтраницуЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Иначе
		...
		Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел3"
			И СтруктураРеквизитовФормы.Свойство("Раздел3Строка035ДоОчистки") Тогда
			ТабличныйДокумент.Области.П000030003503.Значение = СтруктураРеквизитовФормы["Раздел3Строка035ДоОчистки"];
		КонецЕсли;
	КонецЕсли;
...
Функция ПечатьНаСервере(ВидПечати)
	...
	Для Каждого СтрокаУровня1 Из мДеревоВыбранныхСтраниц.ПолучитьЭлементы() Цикл
		...
		Если СтрокаУровня1.ВыводНаПечать = 0
			ИЛИ СтрокаУровня1.ИмяСтраницы = "Раздел4" Тогда
			Продолжить;
		КонецЕсли;
...
&НаКлиенте
Процедура СохранитьПояснительнуюЗаписку()
	...
	Если СтруктураРеквизитовФормы.ЕдиницаИзмерения
		...
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru = 'Сохранение пояснительной записки возможно только при установленной единице измерения ""в рублях"" и точности ""0"".';
								|en = 'Сохранение пояснительной записки возможно только при установленной единице измерения ""в рублях"" и точности ""0"".'");
		Сообщение.Сообщить();
	...
	#Если ВебКлиент Тогда
		...
		ВыгрузитьПояснительнуюЗапискуНаДискВВебКлиенте();
		
	#Иначе
		
		ВыгрузитьПояснительнуюЗапискуНаДиск();
...
&НаКлиенте
Процедура ВыгрузитьПояснительнуюЗапискуНаДиск()
	...
	ДобавитьПояснительнуюЗапискуВПакетИПолучитьИмяФайла(ПакетТаблДок, ИмяФайлаПояснительнойЗаписки);
	
	ИмяФайла = ПутьДляВыгрузки + ИмяФайлаПояснительнойЗаписки;
	
	Состояние(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
	НСтр("ru = 'Сохранение %1';
		|en = 'Сохранение %1'"), ИмяФайла), , , БиблиотекаКартинок.Записать);
	...
	Попытка
		...
		|en = 'Файл %1 сохранен в каталог %2.'"), ДанныеФайла.Имя, ДанныеФайла.Путь);
		Сообщение.Сообщить();
	...
	Если ПризнакОшибки Тогда
		...
		ПоказатьПредупреждение(, СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Не удалось сохранить печатный бланк в указанный каталог.%1Возможно, нет прав для записи в выбранный каталог, нет доступа к файлу, т. к. файл открыт в другой программе, недостаточно места на диске.';
																								|en = 'Не удалось сохранить печатный бланк в указанный каталог.%1Возможно, нет прав для записи в выбранный каталог, нет доступа к файлу, т. к. файл открыт в другой программе, недостаточно места на диске.'"), Символы.ПС), , НСтр("ru = 'Ошибка записи на диск.';
																																																																																|en = 'Ошибка записи на диск.'"));
...
&НаКлиенте
Процедура ВыгрузитьПояснительнуюЗапискуНаДискВВебКлиенте()
...
&НаСервере
Функция ПоместитьЛистыВоВременноеХранилищеНаСервере(АдресаЛистовВоВременномХранилище) Экспорт
	...
	ПоместитьВоВременноеХранилище(ФайлЛиста, ЭтаФорма.УникальныйИдентификатор), ИмяФайлаПояснительнойЗаписки));
...
Процедура Подключаемый_ПолучитьФайл()
	...
	НачатьПолучениеФайлаССервера(АдресаЛистовВоВременномХранилище[0].АдресВоВременномХранилище,
	АдресаЛистовВоВременномХранилище[0].Наименование, ПараметрыДиалога);
...
&НаСервере
Процедура ДобавитьПояснительнуюЗапискуВПакетИПолучитьИмяФайла(ПакетТаблДок, ИмяФайлаПояснительнойЗаписки)
	
	СохранитьДанныеРаздела(СтруктураРеквизитовФормы.НаимТекущегоРаздела, Истина);
	
	СтруктураПараметров = Новый Структура;
	СтруктураПараметров.Вставить("ДанныеТитульногоЛиста", СтруктураДанныхТитульный);
	СтруктураПараметров.Вставить("ДанныеРаздела4",        СтруктураДанныхРаздел4);
	
	ТабличныйДокументПояснительнойЗаписки = ОбъектОтчета(ЭтаФорма.ИмяФормы).ТабличныйДокументПояснительнойЗаписки(
	ИмяФормыОтчета(ЭтаФорма.ИмяФормы), СтруктураПараметров);
	
	ПакетТаблДок.Состав.Добавить(
	ПоместитьВоВременноеХранилище(ТабличныйДокументПояснительнойЗаписки, ЭтаФорма.УникальныйИдентификатор));
	
	СтруктПараметров = Новый Структура;
	СтруктПараметров.Вставить("ДатаНачала",      СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета);
	СтруктПараметров.Вставить("ДатаОкончания",   СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета);
	СтруктПараметров.Вставить("НаимОрганизации", СтруктураРеквизитовФормы.НаимОрганизации);
	
	ИмяФайлаПояснительнойЗаписки = ОбъектОтчета(ЭтаФорма.ИмяФормы).ИмяФайлаПояснительнойЗаписки(
	ИмяФормыОтчета(ЭтаФорма.ИмяФормы), СтруктПараметров);
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	ИначеЕсли СтрНачинаетсяС(Область.Имя, "П000040005003") Тогда
		Если РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Область.Значение) > 18000 Тогда
			Область.Очистить();
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru = 'Сумма расходов на один экземпляр ККТ не может превышать 18000 рублей. Значение очищено.';
									|en = 'Сумма расходов на один экземпляр ККТ не может превышать 18000 рублей. Значение очищено.'");
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	ПроверитьКС_1_11а(СтруктураРезультата);
	ПроверитьКС_1_11б(СтруктураРезультата);
...
Процедура ПроверитьКС_1_2(СтруктураРезультата)
	...
	ИмяРаздела = "Раздел2";
	НазваниеСписка = "СпискиВыбора2017Кв1";
...
Процедура ПроверитьКС_1_9(СтруктураРезультата)
	...
	ОписаниеКС   = НСтр("ru='Сумма единого налога на вмененный доход, подлежащая к уплате (строка 040 Раздела 3) " +
		...
		". Для ИП строка 040 Раздела 3 может быть уменьшена на значение строки 035 Раздела 3 до 0'", "'"));
	...
	ВставитьЗначениеПоказателя(Раздел3, Р3Стр035);
	...
	Если СтруктураРеквизитовФормы.ИП Тогда
		ВнестиПоказательВРасшифровку(Р3Стр035, "Раздел3");
	КонецЕсли;
	...
	КС2 = ПоказателиКС(Р3Стр040.Значение, КС1.ПраваяЧасть - Р3Стр035.Значение);
	
	Если НЕ СтруктураРеквизитовФормы.ИП Тогда
		УсловиеВыполнено = КС2.ЛеваяЧасть = Макс(КС1.ЛеваяЧасть, КС1.ПраваяЧасть);
	Иначе
		УсловиеВыполнено = КС2.ЛеваяЧасть = Макс(0, Макс(КС1.ЛеваяЧасть, КС1.ПраваяЧасть) - Р3Стр035.Значение);
	КонецЕсли;
	...
	Расшифровка2	= СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонРасшифровки2, КС2.ЛеваяЧасть, 
		Р3Стр010.Значение, Р3Стр020.Значение, Р3Стр030.Значение, Макс(КС1.ЛеваяЧасть, КС1.ПраваяЧасть), Р3Стр035.Значение, 
		Макс(0, Макс(КС1.ЛеваяЧасть, КС1.ПраваяЧасть) - Р3Стр035.Значение));
...
Процедура ПроверитьКС_1_10(СтруктураРезультата)
	...
	ОписаниеКС   = НСтр("ru='Сумма единого налога на вмененный доход, подлежащая к уплате (строка 040 Раздела 3) " +
		"должна быть равна разнице значений по строкам 010 Раздела 3 и по строкам 030, 035 Раздела 3, если результат такого " +
	...
	КС = ПоказателиКС(Р3Стр040.Значение, Р3Стр010.Значение - Р3Стр030.Значение - Р3Стр035.Значение);
	...
	Расшифровка	= СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонРасшифровки, КС.ЛеваяЧасть, 
		Р3Стр010.Значение, Р3Стр030.Значение, Р3Стр035.Значение, Макс(0, КС.ПраваяЧасть));
...
&НаСервере
Процедура ПроверитьКС_1_11а(СтруктураРезультата)
	
	ОбщееЧислоОшибок    = СтруктураРезультата.КоличествоНайденныхОшибок;
	ОбщееЧислоБезОшибок = СтруктураРезультата.КоличествоНайденныхБезОшибок;
	СтруктураОшибок     = СтруктураРезультата.СтруктураОшибок;
	
	ТекстФормулы = НСтр("ru = 'Проверка раздела 3 (КС 1.11а)';
						|en = 'Проверка раздела 3 (КС 1.11а)'");
	ОписаниеКС   = НСтр("ru='Сумма расходов ИП на приобретение ККТ, уменьшающая общую сумму ЕНВД (строка 035 Раздела 3) " +
		"должна быть равна разнице значений строки 010 Раздела 3 и строк 020, 030 Раздела 3 (но не менее 50% от суммы " +
		"строки 10), и строки 040 Раздела 3, когда строка 005 Раздела 3 = ""1""'");
	...
	КС = ПоказателиКС(Р3Стр035.Значение, Макс(Расчеты.ЛеваяЧасть, Расчеты.ПраваяЧасть) - Р3Стр040.Значение);
	...
	Расшифровка	= СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонРасшифровки, КС.ЛеваяЧасть, 
		...
		Р3Стр040.Значение, КС.ПраваяЧасть);
...
&НаСервере
Процедура ПроверитьКС_1_11б(СтруктураРезультата)
	
	ОбщееЧислоОшибок    = СтруктураРезультата.КоличествоНайденныхОшибок;
	ОбщееЧислоБезОшибок = СтруктураРезультата.КоличествоНайденныхБезОшибок;
	СтруктураОшибок     = СтруктураРезультата.СтруктураОшибок;
	
	ТекстФормулы = НСтр("ru = 'Проверка раздела 3 (КС 1.11б)';
						|en = 'Проверка раздела 3 (КС 1.11б)'");
	ОписаниеКС   = НСтр("ru='Сумма расходов ИП на приобретение ККТ, уменьшающая общую сумму ЕНВД (строка 035 Раздела 3) " +
		"должна быть равна разнице значений строки 010 Раздела 3 и строк 030, 040 Раздела 3, когда строка 005 Раздела 3 = ""2""'");
	...
	КС = ПоказателиКС(Р3Стр035.Значение, Р3Стр010.Значение - Р3Стр030.Значение - Р3Стр040.Значение);
	...
	Расшифровка	= СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонРасшифровки, КС.ЛеваяЧасть, 
		Р3Стр010.Значение, Р3Стр030.Значение, Р3Стр040.Значение, КС.ПраваяЧасть);
...
Функция ПоказательПоСтроке(УсловныйКодПоказателя)
	...
	ИначеЕсли УсловныйКодПоказателя = "Р3Стр010" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Сумма авансового платежа к уменьшению';
												|en = 'Сумма авансового платежа к уменьшению'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
