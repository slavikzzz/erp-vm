...
Функция ЗначениеК1(Форма)
	...
	Если Год(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) >= 2018 Тогда
		Возврат 1.868;
	Иначе
		Возврат 1.798;
	КонецЕсли;
...
Процедура ПроверитьКС_1_9(СтруктураРезультата)
	...
	ОписаниеКС   = НСтр("ru = 'Сумма единого налога на вмененный доход, подлежащая к уплате (строка 040 Раздела 3) должна быть равна разнице значений строки 010 Раздела 3 и строк 020, 030 Раздела 3, если результат такого вычитания больше или равен 50% строки 010 Раздела 3 и строка 005 Раздела 3 = ""1""';
						|en = 'Сумма единого налога на вмененный доход, подлежащая к уплате (строка 040 Раздела 3) должна быть равна разнице значений строки 010 Раздела 3 и строк 020, 030 Раздела 3, если результат такого вычитания больше или равен 50% строки 010 Раздела 3 и строка 005 Раздела 3 = ""1""'");
	...
	КС = ПоказателиКС(Р3Стр040.Значение, Р3Стр010.Значение - Р3Стр020.Значение - Р3Стр030.Значение);
	...
	Расшифровка = КС.ЛеваяЧастьСтр + " = " + Р3Стр010.ЗначениеСтр + " - " + Р3Стр020.ЗначениеСтр + " - " + Р3Стр030.ЗначениеСтр + " Итог [" + КС.ПраваяЧастьСтр + "], когда "
...
Процедура ПроверитьКС_1_10(СтруктураРезультата)
	...
	ОписаниеКС   = НСтр("ru = 'Сумма единого налога на вмененный доход, подлежащая к уплате (строка 040 Раздела 3) должна быть равна разнице значений по строкам 010 Раздела 3 и по строке 030 Раздела 3, если результат такого вычитания больше или равен нулю и строка 005 Раздела 3 = ""2""';
						|en = 'Сумма единого налога на вмененный доход, подлежащая к уплате (строка 040 Раздела 3) должна быть равна разнице значений по строкам 010 Раздела 3 и по строке 030 Раздела 3, если результат такого вычитания больше или равен нулю и строка 005 Раздела 3 = ""2""'");
