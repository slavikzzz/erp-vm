...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("ЭтоРасшифровкаДекларации") Тогда
		ТекстСообщения = НСтр("ru = 'Непосредственное открытие этой формы не предусмотрено. Расшифровка открывается из декларации по НДС и анализа учета по НДС.';
								|en = 'Application cannot open this form explicitly. It opens implicitly from the VAT declaration and analysis of VAT accounting.'");
...
#Область ОбработчикСобытийТабличногоДокумента
