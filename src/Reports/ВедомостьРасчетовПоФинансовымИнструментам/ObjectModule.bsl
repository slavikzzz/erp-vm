...
Процедура НастроитьПараметрыОтборыПоФункциональнымОпциям(КомпоновщикНастроекФормы)
	...
	Если ПараметрФинансовыйИнструмент <> Неопределено Тогда
		...
		Если ВнеоборотныеАктивы.ИспользуетсяУправлениеВНА() Тогда
			СписокФинансовыхИнструментов.Добавить(Перечисления.ХарактерыДоговоровФинансовыхИнструментов.Аренда);
		КонецЕсли;
		//-- НЕ УТ
	КонецЕсли;
