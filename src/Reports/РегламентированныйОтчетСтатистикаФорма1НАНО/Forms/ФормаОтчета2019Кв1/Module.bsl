...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мКодОтчета   = "0610012";
...
Процедура УстановитьЗащитуИЦветФонаОбластейАвторассчитываемыхПоказателей()
	...
	Для Гр = 1 По 2 Цикл
		...
		мФормаОтчета.Области["П00001011020" + Гр].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П00001011020" + Гр].Защита   = Не ОтклАвтоРасчетЗначение;
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Для Гр = 1 По 2 Цикл
		...
		Области["П00001011020" + Гр].Значение
			= Области["П00001011030" + Гр].Значение + Области["П00001011040" + Гр].Значение
			+ Области["П00001011060" + Гр].Значение + Области["П00001011080" + Гр].Значение;
...
Функция ПечатьНаСервере(ВидПечати)
	...
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 1-НАНО");
