...
Процедура ПоказатьПериод(Форма)
	...
	Иначе
		...
		Если КонецДня(Форма.мДатаКонцаПериодаОтчета) >= КонецГода('20241001') Тогда
			Форма.ОписаниеНормативДок = "Форма утратила силу в соответствии с приказом Росстата от 26.09.2024 № 431.";
		Иначе
