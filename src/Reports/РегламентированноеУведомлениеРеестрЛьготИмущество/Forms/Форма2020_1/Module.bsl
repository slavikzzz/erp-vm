...
Процедура ПредставлениеУведомленияВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Область.Имя = "КодНалЛьг"
		...
		ПараметрыВыборСтруктурнойЕдиницы = Новый Структура("РеквизитыДляРедактирования, ИмяОбласти, СпискиВыбора",
														Область.Значение, Область.Имя, ЭтотОбъект["СпискиВыбора"]);
	...
	ИначеЕсли ЭтотОбъект["Подключена1СОтчетность"] И Область.Имя = "ИмяФайлТреб" Тогда 
		СтандартнаяОбработка = Ложь;
...
Процедура ЗаполнитьДаннымиТребования(Требование) Экспорт
	...
	ЭтотОбъект["ДанныеУведомления"]["Титульная"]["ИмяФайлТреб"] = ДанныеТребования._ИмяФайлТреб;
