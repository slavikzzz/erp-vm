...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КолКолонокИдМСЧ_Раздел2 = 9;
	КолКолонокИдМСЧ_Раздел3 = 5;
	...
	СтруктураРеквизитовФормы.АдресРегистрации = Новый Структура();
	СтруктураРеквизитовФормы.АдресРегистрации.Вставить("АдресИндекс", "");
	СтруктураРеквизитовФормы.АдресРегистрации.Вставить("АдресРегион", "");
	СтруктураРеквизитовФормы.АдресРегистрации.Вставить("АдресРайон", "");
	СтруктураРеквизитовФормы.АдресРегистрации.Вставить("АдресГород", "");
	СтруктураРеквизитовФормы.АдресРегистрации.Вставить("АдресНаселенныйПункт", "");
	СтруктураРеквизитовФормы.АдресРегистрации.Вставить("АдресУлица", "");
	СтруктураРеквизитовФормы.АдресРегистрации.Вставить("АдресДом", "");
	СтруктураРеквизитовФормы.АдресРегистрации.Вставить("АдресКорпус", "");
	СтруктураРеквизитовФормы.АдресРегистрации.Вставить("АдресКвартира", "");
	...
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "01/12/2012";
...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	СтруктураРеквизитовФормы.Вставить("АдресРегистрации");
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если СтруктураРеквизитовФормы.мСохраненныйДок = Неопределено Тогда
		...
		ВывестиНомерКорректировкиНаТитульныйЛист(ЭтаФорма);
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010013003", "П000010010003;П000010011003;П000010012003;П000020000107;П000030000103");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010013004", "П000010010004;П000010011004;П000010012004;П000020000108;П000030000104");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010013005", "П000010010005;П000010011005;П000010012005;П000020000109;П000030000105");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010015003", "П000010013003;П000010014003;П000010010003;П000010011003;П000010012003;П000020000107;П000030000103");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010015004", "П000010013004;П000010014004;П000010010004;П000010011004;П000010012004;П000020000108;П000030000104");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010015005", "П000010013005;П000010014005;П000010010005;П000010011005;П000010012005;П000020000109;П000030000105");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020000209", "П000020000109");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000030000205", "П000030000105");
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ПризнакПодписанта", 1, , "Выбор подписанта", КоллекцияСписковВыбора["Подписант"]);
...
Процедура ВосстановитьСохраненныеДанные()
	...
	Если СтруктураРеквизитовФормы.ДокументПредставителя = Неопределено Тогда
		ИнициализироватьДокументПредставителя(СтруктураРеквизитовФормы);
	КонецЕсли;
	...
	Если СтруктураРеквизитовФормы.НаименованияЭлементовАдреса = Неопределено Тогда
		...
		ДанныеАдреса.Вставить("Индекс",          ТабличныйДокумент.Области.АдресИндекс.Значение);
		ДанныеАдреса.Вставить("Регион",          ТабличныйДокумент.Области.АдресРегион.Значение);
		ДанныеАдреса.Вставить("Район",           ТабличныйДокумент.Области.АдресРайон.Значение);
		ДанныеАдреса.Вставить("Город",           ТабличныйДокумент.Области.АдресГород.Значение);
		ДанныеАдреса.Вставить("НаселенныйПункт", ТабличныйДокумент.Области.АдресНаселенныйПункт.Значение);
		ДанныеАдреса.Вставить("Улица",           ТабличныйДокумент.Области.АдресУлица.Значение);
		ДанныеАдреса.Вставить("Дом",             ТабличныйДокумент.Области.АдресДом.Значение);
		ДанныеАдреса.Вставить("Корпус",          ТабличныйДокумент.Области.АдресКорпус.Значение);
		ДанныеАдреса.Вставить("Квартира",        ТабличныйДокумент.Области.АдресКвартира.Значение);
	КонецЕсли;
...
Процедура ЗаполнитьСведенияОбОрганизации(ВПрограммеИзмененаДатаПодписи = Ложь, СменилсяПризнакПодписанта = Ложь)
	...
	Если СтруктураРеквизитовФормы.ИзмененаОрганизация ИЛИ (НЕ ЗначениеЗаполнено(ТабличныйДокумент.Области.ГлаваХозяйстваФИО.Значение)) Тогда
		ТабличныйДокумент.Области.ГлаваХозяйстваФИО.Значение = НаимЮЛПол;
	КонецЕсли;
	
	Если СтруктураРеквизитовФормы.ИзмененаОрганизация ИЛИ (НЕ ЗначениеЗаполнено(ТабличныйДокумент.Области.ПризнакПодписанта.Значение)) ИЛИ (СменилсяПризнакПодписанта) Тогда
		ТабличныйДокумент.Области.ПризнакПодписанта.Значение = "1"; 
	КонецЕсли;
	
	Если СтруктураРеквизитовФормы.ИзмененаОрганизация ИЛИ (НЕ ЗначениеЗаполнено(ТабличныйДокумент.Области.ПодписантФИО.Значение)) ИЛИ (СменилсяПризнакПодписанта) Тогда
		ТабличныйДокумент.Области.ПодписантФИО.Значение = ФИОРук;
	КонецЕсли;
	
	Если СтруктураРеквизитовФормы.ИзмененаОрганизация ИЛИ (НЕ ЗначениеЗаполнено(ТабличныйДокумент.Области.ДокументПредставителя.Значение)) ИЛИ (СменилсяПризнакПодписанта) Тогда
		Если ТабличныйДокумент.Области.ПризнакПодписанта.Значение = "1" Тогда
			ЗапретитьВводСведенийОПредставителе(ЭтаФорма);
		Иначе
			РазрешитьВводСведенийОПредставителе(ЭтаФорма);
	...
	Если (СтруктураРеквизитовФормы.ИзмененаОрганизация) ИЛИ (НЕ ЗначениеЗаполнено(РегламентированнаяОтчетностьКлиентСервер.ВернутьЗначениеПараметраСЛиста(ЭтаФорма, "Титульный", "РегНомПФР"))) Тогда
	...
	Если СтруктураРеквизитовФормы.ИзмененаОрганизация ИЛИ НЕ ЗначениеЗаполнено(ЗначениеПоказателяРаздела(ЭтаФорма, "Титульный", "ИНН")) Тогда
		УстановитьПоказательРаздела(ЭтаФорма, "Титульный", "ИНН", ИННЮЛ);
	КонецЕсли;
	
	Если СтруктураРеквизитовФормы.ИзмененаОрганизация ИЛИ НЕ ЗначениеЗаполнено(ЗначениеПоказателяРаздела(ЭтаФорма, "Титульный", "ОГРН")) Тогда
		УстановитьПоказательРаздела(ЭтаФорма, "Титульный", "ОГРНИП", ОГРН);
	КонецЕсли;
	
	Если СтруктураРеквизитовФормы.ИзмененаОрганизация ИЛИ НЕ ЗначениеЗаполнено(ЗначениеПоказателяРаздела(ЭтаФорма, "Титульный", "КонтактныйТелефон")) Тогда
	...
	Если СтруктураРеквизитовФормы.ИзмененаОрганизация Тогда
		УстановитьПоказательРаздела(ЭтаФорма, "Титульный", "ОКАТО", ОКАТО);
	КонецЕсли;

	ГодРожд = Формат(ДатаРожд, "ДФ=гггг");
	Если СтруктураРеквизитовФормы.ИзмененаОрганизация ИЛИ НЕ ЗначениеЗаполнено(ЗначениеПоказателяРаздела(ЭтаФорма, "Титульный", "ГодРож")) Тогда
		УстановитьПоказательРаздела(ЭтаФорма, "Титульный", "ГодРождения", ГодРожд);
	КонецЕсли;
	
	Если СтруктураРеквизитовФормы.ИзмененаОрганизация ИЛИ НЕ ЗначениеЗаполнено(СтрЗаменить(ЗначениеПоказателяРаздела(ЭтаФорма, "Титульный", "СНИЛС"), "-", "")) Тогда
	...
	Если Не СтруктураАдреса = Неопределено Тогда
		...
		ТабличныйДокумент.Области.АдресИндекс.Значение          = СтруктураАдреса.Индекс;
		ТабличныйДокумент.Области.АдресРегион.Значение          = СтруктураАдреса.Регион;
		ТабличныйДокумент.Области.АдресРайон.Значение           = СтруктураАдреса.Район;
		ТабличныйДокумент.Области.АдресГород.Значение           = СтруктураАдреса.Город;
		ТабличныйДокумент.Области.АдресНаселенныйПункт.Значение = СтруктураАдреса.НаселенныйПункт;
		ТабличныйДокумент.Области.АдресУлица.Значение           = СтруктураАдреса.Улица;
		ТабличныйДокумент.Области.АдресДом.Значение             = СтруктураАдреса.Дом;
		ТабличныйДокумент.Области.АдресКорпус.Значение          = СтруктураАдреса.Корпус;
		ТабличныйДокумент.Области.АдресКвартира.Значение        = СтруктураАдреса.Квартира;
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", Знач ОбластьИмя = "")
	...
	Если ИмяТекущейСтраницыПанели = "Раздел1" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1" Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				Форма.ТабличныйДокумент.Области.П000010011004.Значение = Форма.СтруктураДанныхРаздел1.П000010011004;
				Форма.ТабличныйДокумент.Области.П000010011005.Значение = Форма.СтруктураДанныхРаздел1.П000010011005;
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010013003, ОбластьИмя) > 0 Тогда
				Форма.ТабличныйДокумент.Области.П000010013003.Значение = ОкруглитьЧислоПоФормату(Форма, Форма.ТабличныйДокумент.Области.П000010010003.Значение)
				+ Форма.ТабличныйДокумент.Области.П000010011003.Значение
				+ Форма.ТабличныйДокумент.Области.П000010012003.Значение;
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010013004, ОбластьИмя) > 0 Тогда
				Форма.ТабличныйДокумент.Области.П000010013004.Значение = ОкруглитьЧислоПоФормату(Форма, Форма.ТабличныйДокумент.Области.П000010010004.Значение)
				+ Форма.ТабличныйДокумент.Области.П000010011004.Значение
				+ Форма.ТабличныйДокумент.Области.П000010012004.Значение;
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010013005, ОбластьИмя) > 0 Тогда									   
				Форма.ТабличныйДокумент.Области.П000010013005.Значение = ОкруглитьЧислоПоФормату(Форма, Форма.ТабличныйДокумент.Области.П000010010005.Значение)
				+ Форма.ТабличныйДокумент.Области.П000010011005.Значение
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010015003, ОбластьИмя) > 0 Тогда									   										  
				Форма.ТабличныйДокумент.Области.П000010015003.Значение = Форма.ТабличныйДокумент.Области.П000010013003.Значение
				- ОкруглитьЧислоПоФормату(Форма, Форма.ТабличныйДокумент.Области.П000010014003.Значение);
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010015004, ОбластьИмя) > 0 Тогда									   										   
				Форма.ТабличныйДокумент.Области.П000010015004.Значение = Форма.ТабличныйДокумент.Области.П000010013004.Значение
				- ОкруглитьЧислоПоФормату(Форма, Форма.ТабличныйДокумент.Области.П000010014004.Значение);
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010015005, ОбластьИмя) > 0 Тогда									   										   
				Форма.ТабличныйДокумент.Области.П000010015005.Значение = Форма.ТабличныйДокумент.Области.П000010013005.Значение
		...
		Иначе
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010013003, ОбластьИмя) > 0 Тогда
				Форма.СтруктураДанныхРаздел1.П000010013003 = ОкруглитьЧислоПоФормату(Форма, Форма.СтруктураДанныхРаздел1.П000010010003)
				+ Форма.СтруктураДанныхРаздел1.П000010011003
				+ Форма.СтруктураДанныхРаздел1.П000010012003;
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010013004, ОбластьИмя) > 0 Тогда
				Форма.СтруктураДанныхРаздел1.П000010013004 = ОкруглитьЧислоПоФормату(Форма, Форма.СтруктураДанныхРаздел1.П000010010004)
				+ Форма.СтруктураДанныхРаздел1.П000010011004
				+ Форма.СтруктураДанныхРаздел1.П000010012004;
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010013005, ОбластьИмя) > 0 Тогда									   
				Форма.СтруктураДанныхРаздел1.П000010013005 = ОкруглитьЧислоПоФормату(Форма, Форма.СтруктураДанныхРаздел1.П000010010005)
				+ Форма.СтруктураДанныхРаздел1.П000010011005
				+ Форма.СтруктураДанныхРаздел1.П000010012005;
			КонецЕсли; 
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010015003, ОбластьИмя) > 0 Тогда									   										  
				Форма.СтруктураДанныхРаздел1.П000010015003 = Форма.СтруктураДанныхРаздел1.П000010013003
				- ОкруглитьЧислоПоФормату(Форма, Форма.СтруктураДанныхРаздел1.П000010014003);
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010015004, ОбластьИмя) > 0 Тогда									   										   
				Форма.СтруктураДанныхРаздел1.П000010015004 = Форма.СтруктураДанныхРаздел1.П000010013004
				- ОкруглитьЧислоПоФормату(Форма, Форма.СтруктураДанныхРаздел1.П000010014004);
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010015005, ОбластьИмя) > 0 Тогда									   										   
				Форма.СтруктураДанныхРаздел1.П000010015005 = Форма.СтруктураДанныхРаздел1.П000010013005
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "Раздел2" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020000207, ОбластьИмя) > 0 Тогда
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
				...
				Для Ном = 1 По ТаблицаБлока.Количество() Цикл
					Колонка7 = Колонка7 + ОкруглитьЧислоПоФормату(Форма, Форма.ТабличныйДокумент.Области["П000020000107_" + Ном].Значение);
				КонецЦикла;
			...
			Иначе
				...
				Для Ном = 1 По ТаблицаБлока.Количество() Цикл
					Колонка7 = Колонка7 + ОкруглитьЧислоПоФормату(Форма, Форма.СтруктураДанныхРаздел2["П000020000107_" + Ном]);
				КонецЦикла;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020000208, ОбластьИмя) > 0 Тогда
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
				...
				Для Ном = 1 По ТаблицаБлока.Количество() Цикл
					Колонка8 = Колонка8 + ОкруглитьЧислоПоФормату(Форма, Форма.ТабличныйДокумент.Области["П000020000108_" + Ном].Значение);
				КонецЦикла;
				Форма.ТабличныйДокумент.Области.П000020000208.Значение = Колонка8;
				Форма.СтруктураДанныхРаздел1.П000010011004 = Форма.ТабличныйДокумент.Области.П000020000208.Значение;
				
			Иначе
				
				Для Ном = 1 По ТаблицаБлока.Количество() Цикл
					Колонка8 = Колонка8 + ОкруглитьЧислоПоФормату(Форма, Форма.СтруктураДанныхРаздел2["П000020000108_" + Ном]);
				КонецЦикла;
				Форма.СтруктураДанныхРаздел2.П000020000208 = Колонка8;
				Форма.СтруктураДанныхРаздел1.П000010011004 = Форма.СтруктураДанныхРаздел2.П000020000208;
				
			КонецЕсли;
			
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020000209, ОбластьИмя) > 0 Тогда
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
				...
				Для Ном = 1 По ТаблицаБлока.Количество() Цикл
					Колонка9 = Колонка9 + ОкруглитьЧислоПоФормату(Форма, Форма.ТабличныйДокумент.Области["П000020000109_" + Ном].Значение);
				КонецЦикла;
				Форма.ТабличныйДокумент.Области.П000020000209.Значение = Колонка9;
				Форма.СтруктураДанныхРаздел1.П000010011005 = Форма.ТабличныйДокумент.Области.П000020000209.Значение;
				
			Иначе
				
				Для Ном = 1 По ТаблицаБлока.Количество() Цикл
					Колонка9 = Колонка9 + ОкруглитьЧислоПоФормату(Форма, Форма.СтруктураДанныхРаздел2["П000020000109_" + Ном]);
				КонецЦикла;
				Форма.СтруктураДанныхРаздел2.П000020000209 = Колонка9;
				Форма.СтруктураДанныхРаздел1.П000010011005 = Форма.СтруктураДанныхРаздел2.П000020000209;
	...
	ИначеЕсли  ИмяТекущейСтраницыПанели = "Раздел3" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000030000203, ОбластьИмя) > 0 Тогда
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел3" Тогда
				...
				Для Ном = 1 По ТаблицаБлока.Количество() Цикл
					Колонка3 = Колонка3 + ОкруглитьЧислоПоФормату(Форма, Форма.ТабличныйДокумент.Области["П000030000103_" + Ном].Значение);
				КонецЦикла;
				Форма.ТабличныйДокумент.Области.П000030000203.Значение = Колонка3;
				Форма.СтруктураДанныхРаздел1.П000010012003 = Форма.ТабличныйДокумент.Области.П000030000203.Значение;
				
			Иначе
				
				Для Ном = 1 По ТаблицаБлока.Количество() Цикл
					Колонка3 = Колонка3 + ОкруглитьЧислоПоФормату(Форма, Форма.СтруктураДанныхРаздел3["П000030000103_" + Ном]);
				КонецЦикла;
				Форма.СтруктураДанныхРаздел3.П000030000203 = Колонка3;
				Форма.СтруктураДанныхРаздел1.П000010012003 = Форма.СтруктураДанныхРаздел3.П000030000203;
				
			КонецЕсли;
			
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000030000204, ОбластьИмя) > 0 Тогда
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел3" Тогда
				...
				Для Ном = 1 По ТаблицаБлока.Количество() Цикл
					Колонка4 = Колонка4 + ОкруглитьЧислоПоФормату(Форма, Форма.ТабличныйДокумент.Области["П000030000104_" + Ном].Значение);
				КонецЦикла;
				Форма.ТабличныйДокумент.Области.П000030000204.Значение = Колонка4;
				Форма.СтруктураДанныхРаздел1.П000010012004 = Форма.ТабличныйДокумент.Области.П000030000204.Значение;
				
			Иначе
				
				Для Ном = 1 По ТаблицаБлока.Количество() Цикл
					Колонка4 = Колонка4 + ОкруглитьЧислоПоФормату(Форма, Форма.СтруктураДанныхРаздел3["П000030000104_" + Ном]);
				КонецЦикла;
				Форма.СтруктураДанныхРаздел3.П000030000204 = Колонка4;
				Форма.СтруктураДанныхРаздел1.П000010012004 = Форма.СтруктураДанныхРаздел3.П000030000204;
				
			КонецЕсли;
			
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000030000205, ОбластьИмя) > 0 Тогда
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел3" Тогда
				...
				Для Ном = 1 По ТаблицаБлока.Количество() Цикл
					Колонка5 = Колонка5 + ОкруглитьЧислоПоФормату(Форма, Форма.ТабличныйДокумент.Области["П000030000105_" + Ном].Значение);
				КонецЦикла;
				Форма.ТабличныйДокумент.Области.П000030000205.Значение = Колонка5;
				Форма.СтруктураДанныхРаздел1.П000010012005 = Форма.ТабличныйДокумент.Области.П000030000205.Значение;
				
			Иначе
				
				Для Ном = 1 По ТаблицаБлока.Количество() Цикл
					Колонка5 = Колонка5 + ОкруглитьЧислоПоФормату(Форма, Форма.СтруктураДанныхРаздел3["П000030000105_" + Ном]);
				КонецЦикла;
				Форма.СтруктураДанныхРаздел3.П000030000205 = Колонка5;
				Форма.СтруктураДанныхРаздел1.П000010012005 = Форма.СтруктураДанныхРаздел3.П000030000205;
...
Функция ОкруглитьЧислоПоФормату(Форма, ИсходноеЧисло)
	...
	Делитель = Форма.СоответствиеЕдиницыИзмеренияДелителю["Окр" + СтрЗаменить(Форма.СтруктураРеквизитовФормы.ЕдиницаИзмерения, " ", "")];
...
Процедура ОбработкаВыбораВПолеТабличногоДокументаЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат <> Неопределено Тогда
		...
		Текст = ДобавитьРеквизит(Текст, СтруктураРеквизитовФормы.ДокументПредставителя.НаименованиеУдостоверяющего, "");
		Текст = ДобавитьРеквизит(Текст, СтруктураРеквизитовФормы.ДокументПредставителя.СерияРимскиеЦифры, " ");
		Текст = ДобавитьРеквизит(Текст, СтруктураРеквизитовФормы.ДокументПредставителя.СерияРусскиеБуквы, " ");
		Текст = ДобавитьРеквизит(Текст, СтруктураРеквизитовФормы.ДокументПредставителя.НомерУдостоверяющего, " № ");
		Текст = ДобавитьРеквизит(Текст, Формат(СтруктураРеквизитовФормы.ДокументПредставителя.ДатаВыдачи,"ДФ=dd.MM.yyyy"), " от ");
...
Процедура ВвестиПоказатель(Элемент, Область, КодПоказателя, Знач ЭтоСумма, Знач ТекстВыбора, ТаблицаВыбора, СтандартнаяОбработка, КолонкаПоиска = "Код") Экспорт
	...
	ДополнительныеПараметры = Новый Структура("ИндексОбласти, ИсходныйПризнакПодписанта, КодПоказателя, КолонкаПоиска, Область, Разделитель, Элемент", ИндексОбласти, ИсходныйПризнакПодписанта, КодПоказателя, КолонкаПоиска, Область, Разделитель, Элемент);
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	СоответствиеРазделовМакетам.Вставить("Титульный", "ПечатнаяФормаОтчета2012Кв4_Титульный");
	СоответствиеРазделовМакетам.Вставить("Раздел1",   "ПечатнаяФормаОтчета2012Кв4_Раздел1");
	СоответствиеРазделовМакетам.Вставить("Раздел2",   "ПечатнаяФормаОтчета2012Кв4_Раздел2");
	СоответствиеРазделовМакетам.Вставить("Раздел3",   "ПечатнаяФормаОтчета2012Кв4_Раздел3");
...
Функция СформироватьСтруктуруПоказателей()
	...
	Если СтруктураРеквизитовФормы.НаименованияЭлементовАдреса = Неопределено Тогда
		ДанныеАдреса = Новый Структура;
		ДанныеАдреса.Вставить("Индекс",          мДанныеОтчета.ПолеТабличногоДокументаТитульный.АдресИндекс);
		ДанныеАдреса.Вставить("Регион",          мДанныеОтчета.ПолеТабличногоДокументаТитульный.АдресРегион);
		ДанныеАдреса.Вставить("Район",           мДанныеОтчета.ПолеТабличногоДокументаТитульный.АдресРайон);
		ДанныеАдреса.Вставить("Город",           мДанныеОтчета.ПолеТабличногоДокументаТитульный.АдресГород);
		ДанныеАдреса.Вставить("НаселенныйПункт", мДанныеОтчета.ПолеТабличногоДокументаТитульный.АдресНаселенныйПункт);
		ДанныеАдреса.Вставить("Улица",           мДанныеОтчета.ПолеТабличногоДокументаТитульный.АдресУлица);
		ДанныеАдреса.Вставить("Дом",             мДанныеОтчета.ПолеТабличногоДокументаТитульный.АдресДом);
		ДанныеАдреса.Вставить("Корпус",          мДанныеОтчета.ПолеТабличногоДокументаТитульный.АдресКорпус);
		ДанныеАдреса.Вставить("Квартира",        мДанныеОтчета.ПолеТабличногоДокументаТитульный.АдресКвартира);
	КонецЕсли;
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ЛицоПодтверждающееСведения", ПредставлениеЧисла(Титульный.ПризнакПодписанта));
	...
	ПараметрыВыгрузки.Вставить("ИмяКлючевогоУзлаСодержательнойЧасти", "РАСЧЕТ_ПО_СТРАХОВЫМ_ВЗНОСАМ_НА_ОПС_И_ОМС_ГЛАВАМИ_КФХ");
                     	
	ПараметрыВыгрузки.Вставить("Индекс", СокрЛП(Титульный.АдресИндекс));
    	
	РегионСокращение = "";
	РегионНазвание = РегламентированнаяОтчетность.ПолучитьИмяИАдресноеСокращение(ВРЕГ(СокрЛП(Титульный.АдресРегион)), РегионСокращение);
	...
	РайонСокращение = "";
	РайонНазвание = РегламентированнаяОтчетность.ПолучитьИмяИАдресноеСокращение(ВРЕГ(СокрЛП(Титульный.АдресРайон)), РайонСокращение);
	...
	ГородСокращение = "";
	ГородНазвание = РегламентированнаяОтчетность.ПолучитьИмяИАдресноеСокращение(ВРЕГ(СокрЛП(Титульный.АдресГород)), ГородСокращение);
	...
	НаселенныйПунктНазвание = РегламентированнаяОтчетность.ПолучитьИмяИАдресноеСокращение(ВРЕГ(СокрЛП(Титульный.АдресНаселенныйПункт)), НаселенныйПунктСокращение);
	...
	УлицаСокращение = "";
	УлицаНазвание = РегламентированнаяОтчетность.ПолучитьИмяИАдресноеСокращение(ВРЕГ(СокрЛП(Титульный.АдресУлица)), УлицаСокращение);
	...
	ДомНомер = ВРЕГ(СокрЛП(Титульный.АдресДом));
	...
	КорпусНомер = ВРЕГ(СокрЛП(Титульный.АдресКорпус));
	...
	КвартираНомер = ВРЕГ(СокрЛП(Титульный.АдресКвартира));
	...
	ПараметрыВыгрузки.Вставить("НаименованиеУдостоверяющего", ВРЕГ(СокрЛП(СтруктураРеквизитовФормы.ДокументПредставителя.НаименованиеУдостоверяющего)));
	ПараметрыВыгрузки.Вставить("СерияРимскиеЦифры",           ВРЕГ(СокрЛП(СтруктураРеквизитовФормы.ДокументПредставителя.СерияРимскиеЦифры)));
	ПараметрыВыгрузки.Вставить("СерияРусскиеБуквы",           ВРЕГ(СокрЛП(СтруктураРеквизитовФормы.ДокументПредставителя.СерияРусскиеБуквы)));
	ПараметрыВыгрузки.Вставить("НомерУдостоверяющего",        ПредставлениеЧисла(СтруктураРеквизитовФормы.ДокументПредставителя.НомерУдостоверяющего));
	ПараметрыВыгрузки.Вставить("ДатаВыдачи",                  Формат(СтруктураРеквизитовФормы.ДокументПредставителя.ДатаВыдачи, "ДФ=dd.MM.yyyy"));
...
Функция ИзвлечьСтруктуруXML()
	...
	Макет = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("СхемаВыгрузки700_2013");
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если ПустаяСтрока(ПараметрыВыгрузки.ОГРНИП) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не задан ОГРН индивидуального предпринимателя!", "Титульный", "ОГРНИП1");
		СтатусПроверки = Ложь;
	ИначеЕсли СтрДлина(ПараметрыВыгрузки.ОГРНИП) <> 15 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Неверно задан ОГРН индивидуального предпринимателя!", "Титульный", "ОГРНИП1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Если НЕ РегНомерПФРСоответствуетТребованиям(ПараметрыВыгрузки.РегистрационныйНомерПФР) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Значение рег. номера в ПФР не соответствует шаблону:""XXX-XXX-XXXXXX"" (X - любая цифра)!", "Титульный", "РегНомПФР1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПустаяСтрока(ПараметрыВыгрузки.СтраховойНомер) ИЛИ ПараметрыВыгрузки.СтраховойНомер = "-   -   -" Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не задан СНИЛС!", "Титульный", "СНИЛС1");
		СтатусПроверки = Ложь;
	ИначеЕсли СтрДлина(ПараметрыВыгрузки.СтраховойНомер) <> 14 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Неверно задан СНИЛС!", "Титульный", "СНИЛС1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПустаяСтрока(ПараметрыВыгрузки.ГодРождения) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не задан год рождения!", "Титульный", "ГодРождения1");
		СтатусПроверки = Ложь;
	ИначеЕсли СтрДлина(ПараметрыВыгрузки.ГодРождения) <> 4 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Неверно задан год рождения!", "Титульный", "ГодРождения1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Если ПустаяСтрока(СокрЛП(СтрЗаменить(ПараметрыВыгрузки.КодПоОКВЭД, ".", ""))) ИЛИ НЕ РегламентированнаяОтчетностьКлиентСервер.ОКВЭДСоответствуетТребованиям(ПараметрыВыгрузки.КодПоОКВЭД) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Некорректное значение кода вида деятельности по ОКВЭД!", "Титульный", "ОКВЭД1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Если ПараметрыВыгрузки.ЛицоПодтверждающееСведения = "2" Тогда
		Если ПустаяСтрока(ПараметрыВыгрузки.НаименованиеУдостоверяющего) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не указано наименование документа, подтверждающего полномочия представителя!", "Титульный", "ДокументПредставителя");
			СтатусПроверки = Ложь;
		КонецЕсли;
	...
	Если ПустаяСтрока(ПараметрыВыгрузки.Индекс) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не задан почтовый индекс адреса регистрации!", "Титульный", "АдресИндекс");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ЛишьОдноИзЗначениеЗаполнено(ПараметрыВыгрузки.РегионНазвание, ПараметрыВыгрузки.РегионСокращение) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Регион не соответствует шаблону (Название Сокращение)!", "Титульный", "АдресРегион");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ЛишьОдноИзЗначениеЗаполнено(ПараметрыВыгрузки.РайонНазвание, ПараметрыВыгрузки.РайонСокращение) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Район не соответствует шаблону (Название Сокращение)!", "Титульный", "АдресРайон");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ЛишьОдноИзЗначениеЗаполнено(ПараметрыВыгрузки.ГородНазвание, ПараметрыВыгрузки.ГородСокращение) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Город не соответствует шаблону (Название Сокращение)!", "Титульный", "АдресГород");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Если ЛишьОдноИзЗначениеЗаполнено(ПараметрыВыгрузки.НаселенныйПунктНазвание, ПараметрыВыгрузки.НаселенныйПунктСокращение) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Населенный пункт не соответствует шаблону (Название Сокращение)!", "Титульный", "АдресНаселенныйПункт");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	 Если ЛишьОдноИзЗначениеЗаполнено(ПараметрыВыгрузки.УлицаНазвание, ПараметрыВыгрузки.УлицаСокращение) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Улица не соответствует шаблону (Название Сокращение)!", "Титульный", "АдресУлица");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Пока РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(ДанныеРаздела2, "П000020000101_" + Формат(Инд, "ЧГ=0")) Цикл
		...
		СтрокаЗаполнена = ЗначениеЗаполнено(ДанныеРаздела2["П000020000101_" + НомерСтроки])
					  ...
					  ИЛИ ЗначениеЗаполнено(ДанныеРаздела2["П000020000109_" + НомерСтроки]);
		...
		Если СтрокаЗаполнена Тогда
			...
			Если НЕ ЗначениеЗаполнено(ФИО.Имя) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В разделе 2, в строке " + НомерСтроки + " не указано имя крестьянского (фермерского) хозяйства!", "Раздел2", "П000020000102_" + НомерСтроки);
				СтатусПроверки = Ложь;
			КонецЕсли;
	...
	Пока РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(ДанныеРаздела3, "П000030000101_" + Формат(Инд, "ЧГ=0")) Цикл
		...
		Если СтрокаЗаполнена Тогда
			...
			ПериодДоначисления = Формат(ДанныеРаздела3["П000030000102_" + НомерСтроки], "ЧГ=0");
			Если НЕ ЗначениеЗаполнено(ПериодДоначисления) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В разделе 3, в строке " + НомерСтроки + " не указан период, за который выявлены и доначислены страховые взносы!", "Раздел3", "П000030000102_" + НомерСтроки);
				СтатусПроверки = Ложь;
			ИначеЕсли СтрДлина(СокрЛП(ПериодДоначисления)) <> 4 Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В разделе 3, в строке " + НомерСтроки + " неверно указан период, за который выявлены и доначислены страховые взносы!", "Раздел3", "П000030000102_" + НомерСтроки);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			СуммаУказана = ЗначениеЗаполнено(ДанныеРаздела3["П000030000103_" + НомерСтроки])
			           ИЛИ ЗначениеЗаполнено(ДанныеРаздела3["П000030000104_" + НомерСтроки])
			           ИЛИ ЗначениеЗаполнено(ДанныеРаздела3["П000030000105_" + НомерСтроки]);

			
			Если НЕ СуммаУказана Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В разделе 3, в строке " + НомерСтроки + " не указана ни одна из сумм доначисленных страховых взносов!", "Раздел3", "П000030000103_" + НомерСтроки);
				СтатусПроверки = Ложь;
			КонецЕсли;
...
Функция ЛишьОдноИзЗначениеЗаполнено(Значение1, Значение2)
	...
	ЗаполненоЗначение1 = ЗначениеЗаполнено(Значение1);
	ЗаполненоЗначение2 = ЗначениеЗаполнено(Значение2);
	
	Возврат (ЗаполненоЗначение1 И НЕ ЗаполненоЗначение2)
	    ИЛИ (ЗаполненоЗначение2 И НЕ ЗаполненоЗначение1);
...
Процедура ЗаполнитьСодержательнуюЧасть(ПараметрыВыгрузки, УзелРодитель)
	...
	// Раздел 1.
	Узел_РасчетПоСтраховымВзносамНачисленнымИуплаченным = ПолучитьПодчиненныйЭлемент(УзелРодитель, "РасчетПоСтраховымВзносамНачисленнымИуплаченным");
	ЗаполнитьДаннымиУзел(Раздел1, Узел_РасчетПоСтраховымВзносамНачисленнымИуплаченным);
	
	// Раздел 2.
	Узел_РасчетНачисленийСтраховыхВзносовЗаЧленовФХ = ПолучитьПодчиненныйЭлемент(УзелРодитель, "РасчетНачисленийСтраховыхВзносовЗаЧленовФХ");
	ЗаполнитьДаннымиУзел(Раздел2, Узел_РасчетНачисленийСтраховыхВзносовЗаЧленовФХ);
	
	ПрототипУзла_РасчетНачисленийСтраховыхВзносовЗаЧленаФХ = ПолучитьПодчиненныйЭлемент(Узел_РасчетНачисленийСтраховыхВзносовЗаЧленовФХ, "РасчетНачисленийСтраховыхВзносовЗаЧленаФХ");
	Инд = 1;
	НомерПП = 0;
	Пока РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(Раздел2, "П000020000101_" + Формат(Инд, "ЧГ=0")) Цикл
		...
		СтрокаЗаполнена = ЗначениеЗаполнено(Раздел2["П000020000101" + Постфикс])
					  ...
					  ИЛИ ЗначениеЗаполнено(Раздел2["П000020000109" + Постфикс]);
		Если СтрокаЗаполнена Тогда
			НомерПП = НомерПП + 1;
			ФИО = РегламентированнаяОтчетность.РазложитьФИО(Раздел2["П000020000102" + Постфикс]);
			ЗаменитьБуквуЁ(ФИО.Фамилия,  "Раздел 2, строка " + Формат(НомерПП, "ЧГ=0") +" Фамилия");
			ЗаменитьБуквуЁ(ФИО.Имя,      "Раздел 2, строка " + Формат(НомерПП, "ЧГ=0") +" Имя");
			ЗаменитьБуквуЁ(ФИО.Отчество, "Раздел 2, строка " + Формат(НомерПП, "ЧГ=0") +" Отчество");
			
			Узел_РасчетНачисленийСтраховыхВзносовЗаЧленаФХ = НовыйУзелИзПрототипа(ПрототипУзла_РасчетНачисленийСтраховыхВзносовЗаЧленаФХ);
			...
			УстановитьЗначениеЭлемента(Узел_РасчетНачисленийСтраховыхВзносовЗаЧленаФХ, "ДатаНачалаПериода", Раздел2["П000020000105" + Постфикс]);
			УстановитьЗначениеЭлемента(Узел_РасчетНачисленийСтраховыхВзносовЗаЧленаФХ, "ДатаКонцаПериода",  Раздел2["П000020000106" + Постфикс]);
			
			Узел_СуммаНачисленыхСтраховыхВзносов = ПолучитьПодчиненныйЭлемент(Узел_РасчетНачисленийСтраховыхВзносовЗаЧленаФХ, "СуммаНачисленыхСтраховыхВзносов");
			УстановитьЗначениеЭлемента(Узел_СуммаНачисленыхСтраховыхВзносов, "ОПСстраховаяЧасть",     Раздел2["П000020000107" + Постфикс]);
			УстановитьЗначениеЭлемента(Узел_СуммаНачисленыхСтраховыхВзносов, "ОПСнакопительнаяЧасть", Раздел2["П000020000108" + Постфикс]);
			УстановитьЗначениеЭлемента(Узел_СуммаНачисленыхСтраховыхВзносов, "СтраховыеВзносыОМС",    Раздел2["П000020000109" + Постфикс]);
		КонецЕсли;
	...
	Если НомерПП > 0 Тогда
		РегламентированнаяОтчетность.УдалитьУзел(ПрототипУзла_РасчетНачисленийСтраховыхВзносовЗаЧленаФХ);
	КонецЕсли;
	
	// Раздел 3.
	Узел_СуммыДоначисленныхСВсНачалаРасчетногоПериода = ПолучитьПодчиненныйЭлемент(УзелРодитель, "СуммыДоначисленныхСВсНачалаРасчетногоПериода");
	ЗаполнитьДаннымиУзел(Раздел3, Узел_СуммыДоначисленныхСВсНачалаРасчетногоПериода);
	
	ПрототипУзла_СуммаДоначисленныхВзносовЗаПериод = ПолучитьПодчиненныйЭлемент(Узел_СуммыДоначисленныхСВсНачалаРасчетногоПериода, "СуммаДоначисленныхВзносовЗаПериод");
	Инд = 1;
	НомерПП = 0;
	Пока РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(Раздел3, "П000030000101_" + Формат(Инд, "ЧГ=0")) Цикл
		...
		Если СтрокаЗаполнена Тогда
			...
			УстановитьЗначениеЭлемента(Узел_СуммаДоначисленныхВзносовЗаПериод, "НомерПП", НомерПП);
			УстановитьЗначениеЭлемента(Узел_СуммаДоначисленныхВзносовЗаПериод, "Период", Формат(Раздел3["П000030000102" + Постфикс], "ЧГ=0"));
			
			Узел_СуммаДоначисленныхСтраховыхВзносов = ПолучитьПодчиненныйЭлемент(Узел_СуммаДоначисленныхВзносовЗаПериод, "СуммаДоначисленныхСтраховыхВзносов");
			УстановитьЗначениеЭлемента(Узел_СуммаДоначисленныхСтраховыхВзносов, "ОПСстраховаяЧасть",     Раздел3["П000030000103" + Постфикс]);
			УстановитьЗначениеЭлемента(Узел_СуммаДоначисленныхСтраховыхВзносов, "ОПСнакопительнаяЧасть", Раздел3["П000030000104" + Постфикс]);
			УстановитьЗначениеЭлемента(Узел_СуммаДоначисленныхСтраховыхВзносов, "СтраховыеВзносыОМС",    Раздел3["П000030000105" + Постфикс]);
		КонецЕсли;
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если Область.Имя = "ПрекращениеДеятельности" Тогда
		...
		Если НЕ (ПрекращениеДеятельности = "Л" Или ПрекращениеДеятельности = "") Тогда
			...
			|en = 'Значение признака прекращения деятельности должно быть либо не заполнено, либо равно ""Л""!'"));
		Иначе
	...
	Если Область.Имя = "ПризнакПодписанта" Тогда
		...
		Иначе
			...
			ПоказатьПредупреждение( , НСтр("ru = 'Значение признака подписанта должно быть равно 1 или 2!';
											|en = 'Значение признака подписанта должно быть равно 1 или 2!'"));
		КонецЕсли;
	КонецЕсли;
...
Процедура РазрешитьВводСведенийОПредставителе(Форма)
	...
	Форма.ТабличныйДокумент.Области.ПодписантФИО.Значение = "";
...
&НаКлиентеНаСервереБезКонтекста
Процедура ВывестиНомерКорректировкиНаТитульныйЛист(Форма)
	...
	УстановитьПоказательРаздела(Форма, "Титульный", "НомерКорректировки", НомерКорректировкиСтрока);
...
Процедура ИнициализироватьДокументПредставителя(СтруктураРеквизитовФормы)
	...
	СтруктураРеквизитовФормы.ДокументПредставителя.Вставить("НаименованиеУдостоверяющего", " ");
	СтруктураРеквизитовФормы.ДокументПредставителя.Вставить("СерияРимскиеЦифры", " ");
	СтруктураРеквизитовФормы.ДокументПредставителя.Вставить("СерияРусскиеБуквы", " ");
	СтруктураРеквизитовФормы.ДокументПредставителя.Вставить("НомерУдостоверяющего", " ");
