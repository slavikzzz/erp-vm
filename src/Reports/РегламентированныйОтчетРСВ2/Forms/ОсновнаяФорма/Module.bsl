...
Процедура ПоказатьПериод(Форма)
	...
	Иначе
		...
		Форма.НадписьКтоСдаетОтчет = НСтр("ru = 'Только главы крестьянских (фермерских) хозяйств (ч. 5 ст. 16 Закона № 212-ФЗ, п. 6 ст. 6 ч. 1 ст. 9 Закона № 379-ФЗ).';
											|en = 'Только главы крестьянских (фермерских) хозяйств (ч. 5 ст. 16 Закона № 212-ФЗ, п. 6 ст. 6 ч. 1 ст. 9 Закона № 379-ФЗ).'");
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РегламентированнаяОтчетностьВызовСервера.ЭтоЮридическоеЛицо(ОргПоУмолчанию) Тогда
...
Процедура ВыбратьФорму(Команда)
	...
	ДопТекстОписания = НСтр("ru = 'Расчет РСВ-2 представляют главы крестьянских (фермерских) хозяйств (ч. 5 ст. 16 Закона № 212-ФЗ, п. 6 ст. 6 ч. 1 ст. 9 Закона № 379-ФЗ).';
							|en = 'Расчет РСВ-2 представляют главы крестьянских (фермерских) хозяйств (ч. 5 ст. 16 Закона № 212-ФЗ, п. 6 ст. 6 ч. 1 ст. 9 Закона № 379-ФЗ).'");
...
Функция ДоступныеОрганизацииОтсутствуютТекст()
	...
	Возврат НСтр(
		"ru = 'Расчет РСВ-2 представляют только главы крестьянских (фермерских) хозяйств (ч. 5 ст. 16 Закона № 212-ФЗ, п. 6 ст. 6 ч. 1 ст. 9 Закона № 379-ФЗ).
		|В справочнике ""Организации"" сведения об индивидуальных предпринимателях отсутствуют.';
		|en = 'Расчет РСВ-2 представляют только главы крестьянских (фермерских) хозяйств (ч. 5 ст. 16 Закона № 212-ФЗ, п. 6 ст. 6 ч. 1 ст. 9 Закона № 379-ФЗ).
		|В справочнике ""Организации"" сведения об индивидуальных предпринимателях отсутствуют.'");
