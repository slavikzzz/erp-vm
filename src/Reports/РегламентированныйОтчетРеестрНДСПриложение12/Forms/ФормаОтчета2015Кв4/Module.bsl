...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	Если РазделЗаполнен(ДанныеРеестра.Строки, Ложь) Тогда
		...
		ПроверитьКС_12_1_1(СтруктураРезультата);
		ПроверитьКС_12_1_2(СтруктураРезультата);
		ПроверитьКС_12_1_3(СтруктураРезультата);
		ПроверитьКС_12_1_4(СтруктураРезультата);
		ПроверитьКС_12_2_1(СтруктураРезультата);
		ПроверитьКС_12_2_2(СтруктураРезультата);
		ПроверитьКС_12_2_3(СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_12_1_1(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 12.1.1';
												|en = 'Проверка КС 12.1.1'"));
...
&НаСервере
Процедура ПроверитьКС_12_1_2(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 12.1.2';
												|en = 'Проверка КС 12.1.2'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_12_1_3(СтруктураРезультата)
	
	Заголовки		= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"		,НСтр("ru = 'Проверка КС 12.1.3а';
													|en = 'Проверка КС 12.1.3а'"));
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Указанный код страны аэропорта назначения (графа 8 Реестра) должен соответсвовать справочнику ОКСМ';
			|en = 'Указанный код страны аэропорта назначения (графа 8 Реестра) должен соответсвовать справочнику ОКСМ'"));
	Заголовки.Вставить("ШаблонОшибки"		,
		НСтр("ru = 'Указанный код страны аэропорта назначения отсутствует в справочнике ОКСМ';
			|en = 'Указанный код страны аэропорта назначения отсутствует в справочнике ОКСМ'"));
	Заголовки.Вставить("ШаблонРасшифровки"	,НСтр("ru = 'Указанный код: (""%1"")';
													|en = 'Указанный код: (""%1"")'"));
	Заголовки.Вставить("Показатель"			,НСтр("ru = 'АэропортНазн';
													|en = 'АэропортНазн'"));
	...
	Заголовки		= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"		,НСтр("ru = 'Проверка КС 12.1.3б';
													|en = 'Проверка КС 12.1.3б'"));
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Указанный код страны аэропорта отправления (графа 6 Реестра) должен соответсвовать справочнику ОКСМ';
			|en = 'Указанный код страны аэропорта отправления (графа 6 Реестра) должен соответсвовать справочнику ОКСМ'"));
	Заголовки.Вставить("ШаблонОшибки"		,
		НСтр("ru = 'Указанный код страны аэропорта отправления отсутствует в справочнике ОКСМ';
			|en = 'Указанный код страны аэропорта отправления отсутствует в справочнике ОКСМ'"));
	Заголовки.Вставить("ШаблонРасшифровки"	,НСтр("ru = 'Указанный код: (""%1"")';
													|en = 'Указанный код: (""%1"")'"));
	Заголовки.Вставить("Показатель"			,НСтр("ru = 'АэропортОтпр';
													|en = 'АэропортОтпр'"));
	Заголовки.Вставить("ПроверятьПустые"	,Ложь);
	Настройки	= ОбработатьНастройки(		, Заголовки, СтруктураРезультата);
	...
	Заголовки		= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"		,НСтр("ru = 'Проверка КС 12.1.3в';
													|en = 'Проверка КС 12.1.3в'"));
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Указанный код страны аэропорта прибытия/убытия (графа 7 Реестра)  должен соответсвовать справочнику ОКСМ';
			|en = 'Указанный код страны аэропорта прибытия/убытия (графа 7 Реестра)  должен соответсвовать справочнику ОКСМ'"));
	Заголовки.Вставить("ШаблонОшибки"		,
		НСтр("ru = 'Указанный код страны аэропорта прибытия/убытия отсутствует в справочнике ОКСМ';
			|en = 'Указанный код страны аэропорта прибытия/убытия отсутствует в справочнике ОКСМ'"));
	Заголовки.Вставить("ШаблонРасшифровки"	,НСтр("ru = 'Указанный код: (""%1"")';
													|en = 'Указанный код: (""%1"")'"));
	Заголовки.Вставить("Показатель"			,НСтр("ru = 'АэропортПрУб';
													|en = 'АэропортПрУб'"));
	Заголовки.Вставить("ПроверятьПустые"	,Ложь);
	Настройки	= ОбработатьНастройки(		, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_12_1_4(СтруктураРезультата)
	
	Заголовки		= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"		,НСтр("ru = 'Проверка КС 12.1.4';
													|en = 'Проверка КС 12.1.4'"));
	Заголовки.Вставить("Нарушение"			,НСтр("ru = 'п. 3.9 ст. 165 НК РФ';
													|en = 'п. 3.9 ст. 165 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Количество цифр в номере авианакладной (графа 3 Реестра) должно быть 11, если указана в качестве ';
			|en = 'Количество цифр в номере авианакладной (графа 3 Реестра) должно быть 11, если указана в качестве '") +
		НСтр("ru = 'вида перевозочного документа авианакладная (графа 2 Реестра = 04)';
			|en = 'вида перевозочного документа авианакладная (графа 2 Реестра = 04)'"));
	Заголовки.Вставить("ШаблонОшибки"		,	
		НСтр("ru = 'Сверка с данными ФТС России не производилась. Номер авиационной накладной не соответствует формату ';
			|en = 'Сверка с данными ФТС России не производилась. Номер авиационной накладной не соответствует формату '") +
		НСтр("ru = '(допустимо только 11 цифр в номере)';
			|en = '(допустимо только 11 цифр в номере)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	,НСтр("ru = 'Указанный номер: (""%1"")';
													|en = 'Указанный номер: (""%1"")'"));
	Настройки	= ОбработатьНастройки(		, Заголовки, СтруктураРезультата);
	
	ПроверитьКС_СоответствиеНомераАвианакладнойФормату_2Уровня(СтруктураРезультата, Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверитьКС_12_2_1(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 12.2.1';
												|en = 'Проверка КС 12.2.1'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_12_2_2(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 12.2.2';
												|en = 'Проверка КС 12.2.2'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_12_2_3(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 12.2.3';
												|en = 'Проверка КС 12.2.3'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_СоответствиеНомераАвианакладнойФормату_2Уровня(СтруктураРезультата, Настройки);
	...
	Для каждого СтраницаРаздела Из ДанныеРеестра.Строки Цикл
		...
		Для НомерСтроки = 1 По КоличествоСтрок Цикл
			...
			Для НомерСтроки2Уровня = 1 По КоличествоСтрок2Уровня Цикл
				...
				Настройки.Вставить("ДопСведенияПараметры", Новый Структура("НомерСтраницы, НомерСтроки, НомерПодстроки", 
					НомерСтраницы, НомерРасчетный, НомерСтроки2Уровня));
				Показатели	= ЗаполнитьПоказатели("ВидДокумента, НомерДокумента", 
					Список2Уровня[НомерСтроки2Уровня - 1].Данные, НомерСтроки, НомерСтроки2Уровня);
				
				Если Не Показатели.ВидДокумента.Значение = "04" Тогда
					Продолжить;
				КонецЕсли;
				...
				РасшифроватьПоказатели(Показатели, Настройки, "Реестр", НомерСтраницы);
				Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
					Показатели.НомерДокумента.Значение);
				Настройки.ОписаниеОшибки = Настройки.ШаблонОшибки;
				НомерАН 		= Показатели.НомерДокумента;
				НормализованныйНомер = "";
				Для НомерСимвола = 1 По СтрДлина(НомерАН.Значение) Цикл
					НормализованныйНомер = НормализованныйНомер + ?(СтроковыеФункцииКлиентСервер.ТолькоЦифрыВСтроке(
						Сред(НомерАН.Значение, НомерСимвола, 1)), Сред(НомерАН.Значение, НомерСимвола, 1), "");
				КонецЦикла; 
				ДлинаНомера		= СтрДлина(НормализованныйНомер);
				Настройки.ЭтоОшибка	 = Не (СтрДлина(НормализованныйНомер) = 11 И СтрДлина(НомерАН.Значение) = 11);
				ДобавитьЭлементВСтруктуруОшибок(Настройки);
...
Функция ПоказательПоСтроке(УсловныйКодПоказателя)
	...
	ИначеЕсли УсловныйКодПоказателя = "НалоговаяБаза" Тогда
		Результат.Вставить("Имя", "П1000014%1%2");
		Результат.Вставить("Представление", Нстр("ru = 'Сумма налоговой базы';
												|en = 'Сумма налоговой базы'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "СтанцияОтпрСтрана" Тогда
		Результат.Вставить("Имя", "П1000031%1%2");
		Результат.Вставить("Представление", Нстр("ru = 'Код страны станции отправления';
												|en = 'Код страны станции отправления'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
	
	ИначеЕсли УсловныйКодПоказателя = "АэропортОтпр" Тогда
		Результат.Вставить("Имя", "П1100006%1%2%3%4");
		Результат.Вставить("Представление", Нстр("ru = 'Код страны аэропорта отправления';
												|en = 'Код страны аэропорта отправления'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "АэропортПрУб" Тогда
		Результат.Вставить("Имя", "П1100007%1%2%3%4");
		Результат.Вставить("Представление", Нстр("ru = 'Код страны аэропорта прибытия/убытия';
												|en = 'Код страны аэропорта прибытия/убытия'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "АэропортНазн" Тогда
		Результат.Вставить("Имя", "П1100008%1%2%3%4");
		Результат.Вставить("Представление", Нстр("ru = 'Код страны аэропорта назначения';
												|en = 'Код страны аэропорта назначения'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
	...
	ИначеЕсли УсловныйКодПоказателя = "НомерДокумента" Тогда
		Результат.Вставить("Имя", "П1100003%1%2%3%4");
		Результат.Вставить("Представление", Нстр("ru = 'Номер авианакладной';
												|en = 'Номер авианакладной'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
