...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета), ЭтотОбъект["мДеревоСтраницОтчета"]);
	...
	Если СтруктураРеквизитовФормы.мСохраненныйДок = Неопределено
		...
		Если (ТабличныйДокумент.Области.ПоМесту.Значение = "124" ИЛИ ТабличныйДокумент.Области.ПоМесту.Значение = "240")
			И СтрРазделить("34,51,52,53,83,84,85,86,90", ",", Ложь).Найти(
			СокрЛП(ТабличныйДокумент.Области.Период.Значение)) <> Неопределено Тогда
	...
	Если НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.РСВ 25к1", '20250101') Тогда
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010008001", 20, ,
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010012001", 20, ,
	"Выбор кода бюджетной классификации", КоллекцияСписковВыбора["КБК_Раздел1_Стр120"]);
	...
	//Подр. 3 разд. 1.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000130000101", 1, ,
	"Выбор кода основания исчисления", КоллекцияСписковВыбора["КодыОснованияИсчисленияНаДСО"]);
	
	//Подр. 4 разд. 1.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000140000101", 0, ,
	"Выбор кода тарифа плательщика", КоллекцияСписковВыбора["КодыТарифаПлательщика"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000140000201", 0, ,
	"Выбор признака исчисления", КоллекцияСписковВыбора["ПризнакиИсчисления"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000140000301", 0, ,
	"Выбор признака исчисления", КоллекцияСписковВыбора["ПризнакиИсчисления"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000140000401", 0, ,
	"Выбор признака исчисления", КоллекцияСписковВыбора["ПризнакиИсчисления"]);
	...
	//Прил. 5 к разд. 1.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П001050006201", 1, ,
	"Выбор пола", КоллекцияСписковВыбора["ПризнакиМЖ"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П001050006301", 2, ,
	...
	//Подр. 1 разд. 2.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000210000101", 1, ,
	"Выбор вида составления расчета", КоллекцияСписковВыбора["ВидыРасчета"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000210001001", 1, ,
	"Выбор признака прекращения обязанности", КоллекцияСписковВыбора["ПризнакиПрекрОбяз"]);
	...
	"Выбор кода вида документа", КоллекцияСписковВыбора["КодыВидовДокументов"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П00021М210301", 2, ,
	"Выбор кода периода освобождения", КоллекцияСписковВыбора["КодыПериодаОсвоб"]);
	...
	//Прил. 1 к разд. 4.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П004010005201", 1, ,
	"Выбор пола", КоллекцияСписковВыбора["ПризнакиМЖ"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П004010005301", 2, ,
	"Выбор кода вида документа", КоллекцияСписковВыбора["КодыВидовДокументов"]);
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли СтрНачинаетсяС(Область.Имя, "П001050006001") ИЛИ Область.Имя = "П000310008001" Тогда
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если ИмяПоказателя = "П000010002001" ИЛИ СтрНачинаетсяС(ИмяПоказателя, "П00001М104001")
		ИЛИ СтрНачинаетсяС(ИмяПоказателя, "П00001М206001") ИЛИ ИмяПоказателя = "П000010008001"
		ИЛИ ИмяПоказателя = "П000010010001" ИЛИ ИмяПоказателя = "П000010012001"
		ИЛИ ИмяПоказателя = "П000020002001" ИЛИ ИмяПоказателя = "П000040002001" ИЛИ ИмяПоказателя = "П000040004001" Тогда
	...
	Если ИмяПоказателя = "П000110000101" ИЛИ ИмяПоказателя = "П000140000101" Тогда
	...
	Если ИмяПоказателя = "П001050004001" ИЛИ ИмяПоказателя = "П000210005001"
		ИЛИ ИмяПоказателя = "П000310002001" ИЛИ ИмяПоказателя = "П004010004001" Тогда
	...
	Если ИмяПоказателя = "П001050005001" ИЛИ ИмяПоказателя = "П000210006001"
		ИЛИ ИмяПоказателя = "П000310003001" ИЛИ ИмяПоказателя = "П004010005001" Тогда
	...
	Если ИмяПоказателя = "П001050006301" ИЛИ ИмяПоказателя = "П000210007501" ИЛИ ИмяПоказателя = "П000310010001" Тогда
	...
	Если ИмяПоказателя = "П001050006401" ИЛИ ИмяПоказателя = "П001050006402"
		ИЛИ ИмяПоказателя = "П000210007701" ИЛИ ИмяПоказателя = "П000210007702"
		ИЛИ ИмяПоказателя = "П000310011001" ИЛИ ИмяПоказателя = "П000310011002" Тогда
		ВведенноеЗначение = СтрЗаменить(СокрЛП(ЗначПоказателя), "№", "");
		Если ИмяПоказателя = "П001050006401" ИЛИ ИмяПоказателя = "П001050006402" Тогда
			СерияДокумента = СтрЗаменить(СокрЛП(ТабличныйДокумент.Области.Найти("П001050006401").Значение), "№", "");
			НомерДокумента = СтрЗаменить(СокрЛП(ТабличныйДокумент.Области.Найти("П001050006402").Значение), "№", "");
		ИначеЕсли ИмяПоказателя = "П000210007701" ИЛИ ИмяПоказателя = "П000210007702" Тогда
	...
	Если ИмяПоказателя = "П001050001001" ИЛИ ИмяПоказателя = "П001050002001"
		ИЛИ ИмяПоказателя = "П001050003001" ИЛИ ИмяПоказателя = "П001050006101" Тогда
		СтруктПарам = Новый Структура;
		СтруктПарам.Вставить("Фам", ТабличныйДокумент.Область("П001050001001").Значение);
		СтруктПарам.Вставить("Имя", ТабличныйДокумент.Область("П001050002001").Значение);
		СтруктПарам.Вставить("Отч", ТабличныйДокумент.Область("П001050003001").Значение);
		СтруктПарам.Вставить("ДатаРожд", ТабличныйДокумент.Область("П001050006101").Значение);
	...
	Если ИмяПоказателя = "П004010001001" ИЛИ ИмяПоказателя = "П004010002001"
		ИЛИ ИмяПоказателя = "П004010003001" ИЛИ ИмяПоказателя = "П004010005101" Тогда
		СтруктПарам = Новый Структура;
		СтруктПарам.Вставить("Фам", ТабличныйДокумент.Область("П004010001001").Значение);
		СтруктПарам.Вставить("Имя", ТабличныйДокумент.Область("П004010002001").Значение);
		СтруктПарам.Вставить("Отч", ТабличныйДокумент.Область("П004010003001").Значение);
		СтруктПарам.Вставить("ДатаРожд", ТабличныйДокумент.Область("П004010005101").Значение);
		СтруктПарам.Вставить("НомерСтраницы",
		Элементы.РазделыОтчета.ТекущиеДанные.КолонкаНомерСтраницыРазделаОтчета);
		Если Элементы.РазделыОтчета.ТекущиеДанные.ПолучитьРодителя() = Неопределено Тогда
			Элементы.РазделыОтчета.ТекущиеДанные.ПолучитьЭлементы()[0].КолонкаРазделыОтчета
	...
	Если ИмяПоказателя = "П000110000101" Тогда
		...
		Если Элементы.РазделыОтчета.ТекущиеДанные.ПолучитьРодителя() = Неопределено Тогда
			Элементы.РазделыОтчета.ТекущиеДанные.ПолучитьЭлементы()[0].КолонкаРазделыОтчета
			= ПредставлениеСтраницыПодраздела1Раздела1(СтруктПарам);
		Иначе
			Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчета = ПредставлениеСтраницыПодраздела1Раздела1(СтруктПарам);
		КонецЕсли;
	КонецЕсли;
	
	Если ИмяПоказателя = "П000140000101" Тогда
		СтруктПарам = Новый Структура;
		СтруктПарам.Вставить("КодТарифа", ТабличныйДокумент.Область("П000140000101").Значение);
		СтруктПарам.Вставить("НомерСтраницы",
		Элементы.РазделыОтчета.ТекущиеДанные.КолонкаНомерСтраницыРазделаОтчета);
		Если Элементы.РазделыОтчета.ТекущиеДанные.ПолучитьРодителя() = Неопределено Тогда
			Элементы.РазделыОтчета.ТекущиеДанные.ПолучитьЭлементы()[0].КолонкаРазделыОтчета
			= ПредставлениеСтраницыПодраздела4Раздела1(СтруктПарам);
		Иначе
			Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчета = ПредставлениеСтраницыПодраздела4Раздела1(СтруктПарам);
		КонецЕсли;
	КонецЕсли;
	...
	// Особая обработка для подраздела 1 раздела 2.
	Если Область.Имя = "П000210000101" И СокрЛП(Область.Значение) = "2" Тогда
		УдалитьДополнительныеСтрокиВПодразделе1Раздела2();
	КонецЕсли;
	...
	ОтобразитьИтоги(ЭтотОбъект, ИмяРаздела);
...
Процедура ТабличныйДокументПриАктивизации(Элемент)
	...
	Если ЗначениеЗаполнено(ИмяГруппы) Тогда
		...
		Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2Подр1" Тогда
			// Особая обработка для подраздела 1 раздела 2.
			Обл = ТабличныйДокумент.Области.Найти("П000210000101");
			Если Обл <> Неопределено И СокрЛП(Обл.Значение) = "2"
				И СтрНачинаетсяС(Элемент.ТекущаяОбласть.Имя, "П00021М2") Тогда
				Элементы.ТабличныйДокументКонтекстноеМенюУдалитьСтроку.Доступность = Ложь;
				Элементы.ТабличныйДокументКонтекстноеМенюДобавитьСтроку.Доступность = Ложь;
			КонецЕсли;
...
Процедура УстановитьКодПоОКТМОИКБКВРазделах1и2ПриАктивномТитульномЛисте_ЗаполнитьСведенияОПодписантах(СсылкаНаРегистрациюВНО)
	...
	ДополнительныеПараметры.Вставить("Период",  СокрЛП(ТабличныйДокумент.Области.Период.Значение));
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяРаздела)
		...
		Если ТипПлательщика = "2" Тогда
			...
			Для каждого Обл Из ТДО Цикл
				Если Обл.Имя = "П000010003101" ИЛИ Обл.Имя = "П000010003201" ИЛИ Обл.Имя = "П000010003301"
					...
					ИЛИ СтрНачинаетсяС(Обл.Имя, "П00001М207201") ИЛИ СтрНачинаетсяС(Обл.Имя, "П00001М207301")
					ИЛИ Обл.Имя = "П000010009101" ИЛИ Обл.Имя = "П000010009201" ИЛИ Обл.Имя = "П000010009301"
					ИЛИ Обл.Имя = "П000010011101" ИЛИ Обл.Имя = "П000010011201" ИЛИ Обл.Имя = "П000010011301"
					ИЛИ Обл.Имя = "П000010013101" ИЛИ Обл.Имя = "П000010013201" ИЛИ Обл.Имя = "П000010013301" Тогда
					ЗапретитьВводДанныхВОбласть(Форма, Обл);
				ИначеЕсли Обл.Имя = "П000010003001" ИЛИ СтрНачинаетсяС(Обл.Имя, "П00001М105001")
					ИЛИ СтрНачинаетсяС(Обл.Имя, "П00001М207001") ИЛИ Обл.Имя = "П000010009001" ИЛИ Обл.Имя = "П000010011001"
					ИЛИ Обл.Имя = "П000010013001" Тогда
	...
	ИначеЕсли ИмяРаздела = "Раздел1Подр1" ИЛИ ИмяРаздела = "Раздел1Подр3" ИЛИ ИмяРаздела = "Раздел1Подр4"
		ИЛИ ИмяРаздела = "Раздел1Прил2" ИЛИ ИмяРаздела = "Раздел1Прил3" ИЛИ ИмяРаздела = "Раздел1Прил31"
		ИЛИ ИмяРаздела = "Раздел1Прил5" ИЛИ ИмяРаздела = "Раздел2" ИЛИ ИмяРаздела = "Раздел4"
		ИЛИ ИмяРаздела = "Раздел4Подр1" ИЛИ ИмяРаздела = "Раздел4Прил1" Тогда
	...
	ИначеЕсли ИмяРаздела = "Раздел2Подр1" Тогда
		...
		РасчСост = СокрЛП(ТДО["П000210000101"].Значение);
		
		ТДО["СекцияПояснение_Р2П1"].Видимость = РасчСост = "2";
		
		Если РасчСост = "2" Тогда
			ЗапретитьВводДанныхВОбласть(Форма, ТДО["П000210001001"]);
		Иначе
			РазрешитьВводДанныхВОбласть(Форма, ТДО["П000210001001"]);
		КонецЕсли;
		
		ИмяГруппыМнЧ = Форма.СтруктураРеквизитовФормы.мИдГруппы21М2;
		...
		Для каждого Обл Из ТДО Цикл
			Если ИменаГрафМнЧ.Найти(Лев(Обл.Имя, Форма.СтруктураРеквизитовФормы.ДлинаИмениГрафы)) <> Неопределено Тогда
				Если РасчСост = "2" Тогда
					ЗапретитьВводДанныхВОбласть(Форма, Обл);
				Иначе
					РазрешитьВводДанныхВОбласть(Форма, Обл);
		...
		Для каждого Обл Из ТДО Цикл
			Если СтрНачинаетсяС(Обл.Имя, "ДобавлениеСтрокиП00021М2") Тогда
				Обл.Видимость = РасчСост <> "2";
			ИначеЕсли СтрНачинаетсяС(Обл.Имя, "П00021М210301") Тогда
				Форма.ТабличныйДокумент.Область(Обл.Верх, , Обл.Низ, ).Видимость = РасчСост <> "2";
			КонецЕсли;
		КонецЦикла;
	...
	ИначеЕсли ИмяРаздела = "Раздел3" Тогда
		...
		"П00321М112001,П00321М113001,П00321М114001,П00321М114101,П00321М115001,П00321М116001,П00321М117001", ",", Ложь);
		ИменаСуммовыхПоказателей = СтрРазделить(
		"П00321М114001,П00321М114101,П00321М115001,П00321М116001,П00321М117001", ",", Ложь);
		Ном = 1;
		Постфикс = "_1";
...
Процедура ВывестиДанныеВТабличныйДокумент(ИмяТекРаздела, НовыеНомераСтрокМногоуровнегоРаздела = Неопределено)
	...
	Если мСтруктураМногоуровневыхРазделов.Свойство(ИмяТекРаздела) Тогда
		...
		ИТОГО_ЗаИсключениемТекущейВеткиДерева(ИмяТекРаздела, НовыеНомераСтрокМногоуровнегоРаздела[0] - 1));
		
		ОтобразитьИтоги(ЭтотОбъект, ИмяТекРаздела);
...
&НаСервере
Функция ИТОГО_ЗаИсключениемТекущейВеткиДерева(ИмяРаздела, ИндексТекущейВетки)
	
	ИменаЯчеекИТОГО = СтрРазделить(
	"ИтогоСумВсего,ИтогоСум1Мес,ИтогоСум2Мес,ИтогоСум3Мес,ИтогоБазаВсего,ИтогоБаза1Мес,ИтогоБаза2Мес,ИтогоБаза3Мес",
	",", Ложь);
	
	Если ИмяРаздела = "Раздел1Прил5" Тогда
		
		ИменаПоказателей = СтрРазделить(
		"П001050007001,П001050007002,П001050007003,П001050007004,П001050008001,П001050008002,П001050008003,П001050008004",
		",", Ложь);
		
	ИначеЕсли ИмяРаздела = "Раздел4Прил1" Тогда
		
		ИменаПоказателей = СтрРазделить(
		"П004010006001,П004010006002,П004010006003,П004010006004,П004010007001,П004010007002,П004010007003,П004010007004",
		",", Ложь);
	...
	Для Инд = 0 По ИменаЯчеекИТОГО.Количество() - 1 Цикл
		Мас = Новый Массив;
		Мас.Добавить(ИменаЯчеекИТОГО[Инд]);
		Мас.Добавить(ИменаПоказателей[Инд]);
		Мас.Добавить(0);
		Результат.Добавить(Мас);
	КонецЦикла;
	...
	Для Инд = 0 По ДеревоДанныхРаздела.Строки.Количество() - 1 Цикл
		Если Инд <> ИндексТекущейВетки Тогда
			Дан = ДеревоДанныхРаздела.Строки[Инд].Данные;
			Для каждого Элем Из Результат Цикл
				Элем[2] = Элем[2] + Окр(Дан[Элем[1]], 2);
			КонецЦикла;
		КонецЕсли;
	КонецЦикла;
	ДеревоДанныхРаздела = Неопределено;
...
Процедура ДобавитьСтраницу(Команда)
	...
	Если ИмяРаздела = "Раздел1Подр1" ИЛИ ИмяРаздела = "Раздел1Подр4" ИЛИ ИмяРаздела = "Раздел1Прил5"
		ИЛИ ИмяРаздела = "Раздел2Подр1" ИЛИ ИмяРаздела = "Раздел3" ИЛИ ИмяРаздела = "Раздел4Прил1" Тогда
...
Процедура ВставитьДополнительнуюСтроку()
	...
	Если СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей.Свойство(ИмяГруппы) Тогда
		...
		Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2Подр1"
			ИЛИ СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел3" Тогда
...
&НаКлиенте
Процедура УдалитьДополнительныеСтрокиВПодразделе1Раздела2()
	
	СохрТекОбл = Элементы.ТабличныйДокумент.ТекущаяОбласть;
	
	Префикс1 = "УдалитьСтрокуП00021М1_";
	Ном1 = 1;
	
	Обл1 = ТабличныйДокумент.Области.Найти(Префикс1 + Формат(Ном1, "ЧГ="));
	
	Пока Обл1 <> Неопределено Цикл
		
		ИмяОбл2 = "УдалитьСтрокуП00021М2_" + Формат(Ном1, "ЧГ=") + "_2";
		
		Обл2 = ТабличныйДокумент.Области.Найти(ИмяОбл2);
		
		Пока Обл2 <> Неопределено Цикл
			
			Элементы.ТабличныйДокумент.ТекущаяОбласть = Обл2;
			УдалитьДопСтрокуНаСервере();
			Обл2 = ТабличныйДокумент.Области.Найти(ИмяОбл2);
...
Процедура Расчет(Форма, ИмяРаздела = "", ОбластьИмя = "") Экспорт
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				Если ТипПлательщика = "2" Тогда
					...
					ТДО["П000010009101"].Значение = 0;
					ТДО["П000010009201"].Значение = 0;
					ТДО["П000010009301"].Значение = 0;
					
					ТДО["П000010011101"].Значение = 0;
					ТДО["П000010011201"].Значение = 0;
					ТДО["П000010011301"].Значение = 0;
					
					ТДО["П000010013101"].Значение = 0;
					ТДО["П000010013201"].Значение = 0;
					ТДО["П000010013301"].Значение = 0;
				...
				ИначеЕсли РасчетЗаПервыйКвартал Тогда
					...
					ТДО["П000010009001"].Значение
					= ТДО["П000010009101"].Значение + ТДО["П000010009201"].Значение + ТДО["П000010009301"].Значение;
					
					ТДО["П000010011001"].Значение
					= ТДО["П000010011101"].Значение + ТДО["П000010011201"].Значение + ТДО["П000010011301"].Значение;
					
					ТДО["П000010013001"].Значение
					= ТДО["П000010013101"].Значение + ТДО["П000010013201"].Значение + ТДО["П000010013301"].Значение;
	...
	ИначеЕсли ИмяРаздела = "Раздел1Подр3" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				Если РасчетЗаПервыйКвартал Тогда
					ТДО["П000130002001"].Значение
						= ТДО["П000130002002"].Значение + ТДО["П000130002003"].Значение + ТДО["П000130002004"].Значение;
					ТДО["П000130003001"].Значение
						= ТДО["П000130003002"].Значение + ТДО["П000130003003"].Значение + ТДО["П000130003004"].Значение;
					ТДО["П000130005001"].Значение
						= ТДО["П000130005002"].Значение + ТДО["П000130005003"].Значение + ТДО["П000130005004"].Значение;
				КонецЕсли;
				
				ТДО["П000130004001"].Значение = ТДО["П000130002001"].Значение - ТДО["П000130003001"].Значение;
				ТДО["П000130004002"].Значение = ТДО["П000130002002"].Значение - ТДО["П000130003002"].Значение;
				ТДО["П000130004003"].Значение = ТДО["П000130002003"].Значение - ТДО["П000130003003"].Значение;
				ТДО["П000130004004"].Значение = ТДО["П000130002004"].Значение - ТДО["П000130003004"].Значение;
	...
	ИначеЕсли ИмяРаздела = "Раздел1Подр4" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				Если РасчетЗаПервыйКвартал Тогда
					ТДО["П000140003001"].Значение
					= ТДО["П000140003002"].Значение + ТДО["П000140003003"].Значение + ТДО["П000140003004"].Значение;
					ТДО["П000140004001"].Значение
					= ТДО["П000140004002"].Значение + ТДО["П000140004003"].Значение + ТДО["П000140004004"].Значение;
					ТДО["П000140004501"].Значение
					= ТДО["П000140004502"].Значение + ТДО["П000140004503"].Значение + ТДО["П000140004504"].Значение;
					ТДО["П000140005101"].Значение
					= ТДО["П000140005102"].Значение + ТДО["П000140005103"].Значение + ТДО["П000140005104"].Значение;
					ТДО["П000140005201"].Значение
					= ТДО["П000140005202"].Значение + ТДО["П000140005203"].Значение + ТДО["П000140005204"].Значение;
					ТДО["П000140006101"].Значение
					= ТДО["П000140006102"].Значение + ТДО["П000140006103"].Значение + ТДО["П000140006104"].Значение;
					ТДО["П000140006201"].Значение
					= ТДО["П000140006202"].Значение + ТДО["П000140006203"].Значение + ТДО["П000140006204"].Значение;
					ТДО["П000140007101"].Значение
					= ТДО["П000140007102"].Значение + ТДО["П000140007103"].Значение + ТДО["П000140007104"].Значение;
					ТДО["П000140007201"].Значение
					= ТДО["П000140007202"].Значение + ТДО["П000140007203"].Значение + ТДО["П000140007204"].Значение;
					ТДО["П000140008101"].Значение
					= ТДО["П000140008102"].Значение + ТДО["П000140008103"].Значение + ТДО["П000140008104"].Значение;
					ТДО["П000140008201"].Значение
					= ТДО["П000140008202"].Значение + ТДО["П000140008203"].Значение + ТДО["П000140008204"].Значение;
				КонецЕсли;
				
				ТДО["П000140002001"].Значение = ТДО["П000140002101"].Значение + ТДО["П000140002201"].Значение;
				ТДО["П000140002002"].Значение = ТДО["П000140002102"].Значение + ТДО["П000140002202"].Значение;
				ТДО["П000140002003"].Значение = ТДО["П000140002103"].Значение + ТДО["П000140002203"].Значение;
				ТДО["П000140002004"].Значение = ТДО["П000140002104"].Значение + ТДО["П000140002204"].Значение;
				
				ТДО["П000140005001"].Значение
				= ТДО["П000140003001"].Значение - ТДО["П000140004001"].Значение - ТДО["П000140004501"].Значение;
				ТДО["П000140005002"].Значение
				= ТДО["П000140003002"].Значение - ТДО["П000140004002"].Значение - ТДО["П000140004502"].Значение;
				ТДО["П000140005003"].Значение
				= ТДО["П000140003003"].Значение - ТДО["П000140004003"].Значение - ТДО["П000140004503"].Значение;
				ТДО["П000140005004"].Значение
				= ТДО["П000140003004"].Значение - ТДО["П000140004004"].Значение - ТДО["П000140004504"].Значение;
				
				ТДО["П000140006001"].Значение = ТДО["П000140006101"].Значение + ТДО["П000140006201"].Значение;
				ТДО["П000140006002"].Значение = ТДО["П000140006102"].Значение + ТДО["П000140006202"].Значение;
				ТДО["П000140006003"].Значение = ТДО["П000140006103"].Значение + ТДО["П000140006203"].Значение;
				ТДО["П000140006004"].Значение = ТДО["П000140006104"].Значение + ТДО["П000140006204"].Значение;
				
				ТДО["П000140007001"].Значение = ТДО["П000140007101"].Значение + ТДО["П000140007201"].Значение;
				ТДО["П000140007002"].Значение = ТДО["П000140007102"].Значение + ТДО["П000140007202"].Значение;
				ТДО["П000140007003"].Значение = ТДО["П000140007103"].Значение + ТДО["П000140007203"].Значение;
				ТДО["П000140007004"].Значение = ТДО["П000140007104"].Значение + ТДО["П000140007204"].Значение;
				
				ТДО["П000140008001"].Значение = ТДО["П000140008101"].Значение + ТДО["П000140008201"].Значение;
				ТДО["П000140008002"].Значение = ТДО["П000140008102"].Значение + ТДО["П000140008202"].Значение;
				ТДО["П000140008003"].Значение = ТДО["П000140008103"].Значение + ТДО["П000140008203"].Значение;
				ТДО["П000140008004"].Значение = ТДО["П000140008104"].Значение + ТДО["П000140008204"].Значение;
	...
	ИначеЕсли ИмяРаздела = "Раздел1Прил2" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				+ ТДО["П001020003001"].Значение + ТДО["П001020004001"].Значение + ТДО["П001020004101"].Значение)
				/ Знаменатель * 100, 2));
				
				Знаменатель = ТДО["П001020001002"].Значение;
				ТДО["П001020005002"].Значение = ?(Знаменатель = 0, 0, Окр((ТДО["П001020002002"].Значение
				+ ТДО["П001020003002"].Значение + ТДО["П001020004002"].Значение + ТДО["П001020004102"].Значение)
				/ Знаменатель * 100, 2));
	...
	ИначеЕсли ИмяРаздела = "Раздел1Прил31" Тогда
		
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				
				Знаменатель = ТДО["П001310001001"].Значение;
				ТДО["П001310003001"].Значение = ?(Знаменатель = 0, 0, Окр(ТДО["П001310002001"].Значение / Знаменатель * 100, 2));
				
				Знаменатель = ТДО["П001310001002"].Значение;
				ТДО["П001310003002"].Значение = ?(Знаменатель = 0, 0, Окр(ТДО["П001310002002"].Значение / Знаменатель * 100, 2));
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				Если РасчетЗаПервыйКвартал Тогда
					...
					ТДО["П001050007001"].Значение
					= ТДО["П001050007002"].Значение + ТДО["П001050007003"].Значение + ТДО["П001050007004"].Значение;
					ТДО["П001050008001"].Значение
					= ТДО["П001050008002"].Значение + ТДО["П001050008003"].Значение + ТДО["П001050008004"].Значение;
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				Если РасчетЗаПервыйКвартал Тогда
					...
					ТДО["П004010006001"].Значение
					= ТДО["П004010006002"].Значение + ТДО["П004010006003"].Значение + ТДО["П004010006004"].Значение;
					ТДО["П004010007001"].Значение
					= ТДО["П004010007002"].Значение + ТДО["П004010007003"].Значение + ТДО["П004010007004"].Значение;
...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
	...
	Если ИмяРаздела = "Раздел1" Тогда
		...
		Если ТипПлательщика = "2" Тогда
			...
			КонецЦикла;
			Данные.Вставить("П000010009101", 0);
			Данные.Вставить("П000010009201", 0);
			Данные.Вставить("П000010009301", 0);
			Данные.Вставить("П000010011101", 0);
			Данные.Вставить("П000010011201", 0);
			Данные.Вставить("П000010011301", 0);
			Данные.Вставить("П000010013101", 0);
			Данные.Вставить("П000010013201", 0);
			Данные.Вставить("П000010013301", 0);
		...
		ИначеЕсли РасчетЗаПервыйКвартал Тогда
			...
			КонецЦикла;
			Данные.Вставить("П000010009001", Данные["П000010009101"] + Данные["П000010009201"] + Данные["П000010009301"]);
			Данные.Вставить("П000010011001", Данные["П000010011101"] + Данные["П000010011201"] + Данные["П000010011301"]);
			Данные.Вставить("П000010013001", Данные["П000010013101"] + Данные["П000010013201"] + Данные["П000010013301"]);
	...
	ИначеЕсли ИмяРаздела = "Раздел1Подр3" Тогда
		...
		Если РасчетЗаПервыйКвартал Тогда
			Данные.Вставить("П000130002001", Данные["П000130002002"] + Данные["П000130002003"] + Данные["П000130002004"]);
			Данные.Вставить("П000130003001", Данные["П000130003002"] + Данные["П000130003003"] + Данные["П000130003004"]);
			Данные.Вставить("П000130005001", Данные["П000130005002"] + Данные["П000130005003"] + Данные["П000130005004"]);
		КонецЕсли;
		Данные.Вставить("П000130004001", Данные["П000130002001"] - Данные["П000130003001"]);
		Данные.Вставить("П000130004002", Данные["П000130002002"] - Данные["П000130003002"]);
		Данные.Вставить("П000130004003", Данные["П000130002003"] - Данные["П000130003003"]);
		Данные.Вставить("П000130004004", Данные["П000130002004"] - Данные["П000130003004"]);
	...
	ИначеЕсли ИмяРаздела = "Раздел1Подр4" Тогда
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Если РасчетЗаПервыйКвартал Тогда
				Данные.Вставить("П000140003001", Данные["П000140003002"] + Данные["П000140003003"] + Данные["П000140003004"]);
				Данные.Вставить("П000140004001", Данные["П000140004002"] + Данные["П000140004003"] + Данные["П000140004004"]);
				Данные.Вставить("П000140004501", Данные["П000140004502"] + Данные["П000140004503"] + Данные["П000140004504"]);
				Данные.Вставить("П000140005101", Данные["П000140005102"] + Данные["П000140005103"] + Данные["П000140005104"]);
				Данные.Вставить("П000140005201", Данные["П000140005202"] + Данные["П000140005203"] + Данные["П000140005204"]);
				Данные.Вставить("П000140006101", Данные["П000140006102"] + Данные["П000140006103"] + Данные["П000140006104"]);
				Данные.Вставить("П000140006201", Данные["П000140006202"] + Данные["П000140006203"] + Данные["П000140006204"]);
				Данные.Вставить("П000140007101", Данные["П000140007102"] + Данные["П000140007103"] + Данные["П000140007104"]);
				Данные.Вставить("П000140007201", Данные["П000140007202"] + Данные["П000140007203"] + Данные["П000140007204"]);
				Данные.Вставить("П000140008101", Данные["П000140008102"] + Данные["П000140008103"] + Данные["П000140008104"]);
				Данные.Вставить("П000140008201", Данные["П000140008202"] + Данные["П000140008203"] + Данные["П000140008204"]);
			КонецЕсли;
			
			Данные.Вставить("П000140002001", Данные["П000140002101"] + Данные["П000140002201"]);
			Данные.Вставить("П000140002002", Данные["П000140002102"] + Данные["П000140002202"]);
			Данные.Вставить("П000140002003", Данные["П000140002103"] + Данные["П000140002203"]);
			Данные.Вставить("П000140002004", Данные["П000140002104"] + Данные["П000140002204"]);
			
			Данные.Вставить("П000140005001", Данные["П000140003001"] - Данные["П000140004001"] - Данные["П000140004501"]);
			Данные.Вставить("П000140005002", Данные["П000140003002"] - Данные["П000140004002"] - Данные["П000140004502"]);
			Данные.Вставить("П000140005003", Данные["П000140003003"] - Данные["П000140004003"] - Данные["П000140004503"]);
			Данные.Вставить("П000140005004", Данные["П000140003004"] - Данные["П000140004004"] - Данные["П000140004504"]);
			
			Данные.Вставить("П000140006001", Данные["П000140006101"] + Данные["П000140006201"]);
			Данные.Вставить("П000140006002", Данные["П000140006102"] + Данные["П000140006202"]);
			Данные.Вставить("П000140006003", Данные["П000140006103"] + Данные["П000140006203"]);
			Данные.Вставить("П000140006004", Данные["П000140006104"] + Данные["П000140006204"]);
			
			Данные.Вставить("П000140007001", Данные["П000140007101"] + Данные["П000140007201"]);
			Данные.Вставить("П000140007002", Данные["П000140007102"] + Данные["П000140007202"]);
			Данные.Вставить("П000140007003", Данные["П000140007103"] + Данные["П000140007203"]);
			Данные.Вставить("П000140007004", Данные["П000140007104"] + Данные["П000140007204"]);
			
			Данные.Вставить("П000140008001", Данные["П000140008101"] + Данные["П000140008201"]);
			Данные.Вставить("П000140008002", Данные["П000140008102"] + Данные["П000140008202"]);
			Данные.Вставить("П000140008003", Данные["П000140008103"] + Данные["П000140008203"]);
			Данные.Вставить("П000140008004", Данные["П000140008104"] + Данные["П000140008204"]);
	...
	ИначеЕсли ИмяРаздела = "Раздел1Прил2" Тогда
		...
		Данные.Вставить("П001020005001", ?(Знаменатель = 0, 0, Окр((Данные["П001020002001"]
		+ Данные["П001020003001"] + Данные["П001020004001"] + Данные["П001020004101"]) / Знаменатель * 100, 2)));
		
		Знаменатель = Данные["П001020001002"];
		Данные.Вставить("П001020005002", ?(Знаменатель = 0, 0, Окр((Данные["П001020002002"]
		+ Данные["П001020003002"] + Данные["П001020004002"] + Данные["П001020004102"]) / Знаменатель * 100, 2)));
	...
	ИначеЕсли ИмяРаздела = "Раздел1Прил31" Тогда
		...
		Знаменатель = Данные["П001310001001"];
		Данные.Вставить("П001310003001", ?(Знаменатель = 0, 0, Окр(Данные["П001310002001"] / Знаменатель * 100, 2)));
		
		Знаменатель = Данные["П001310001002"];
		Данные.Вставить("П001310003002", ?(Знаменатель = 0, 0, Окр(Данные["П001310002002"] / Знаменатель * 100, 2)));
	...
	ИначеЕсли ИмяРаздела = "Раздел1Прил5" Тогда
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Если РасчетЗаПервыйКвартал Тогда
				Данные.Вставить("П001050007001", Данные["П001050007002"] + Данные["П001050007003"] + Данные["П001050007004"]);
				Данные.Вставить("П001050008001", Данные["П001050008002"] + Данные["П001050008003"] + Данные["П001050008004"]);
			КонецЕсли;
	...
	ИначеЕсли ИмяРаздела = "Раздел2" ИЛИ ИмяРаздела = "Раздел2Подр1" Тогда
		...
		Для каждого Ветка21 Из ДеревоДанных21.Строки Цикл
			...
			Если Ветка21 = АктивнаяВетка21 Тогда
				Для каждого Пок Из Ветка21.Данные Цикл
					Ветка21.Данные.Вставить(Пок.Ключ, ТДО[Пок.Ключ].Значение);
				КонецЦикла;
				Для каждого СтрокаМнЧ Из ДеревоМнЧ.Строки Цикл
					ИндСтроки = Формат(ДеревоМнЧ.Строки.Индекс(СтрокаМнЧ) + 1, "ЧГ=");
			...
			РасчСост = СокрЛП(Ветка21.Данные["П000210000101"]);
			ПрПрекр  = СокрЛП(Ветка21.Данные["П000210001001"]);
			
			Сумма_Стр030 = ?(РасчСост = "2" ИЛИ (РасчСост = "1" И ПрПрекр = "0"), Сумма_Стр030 + Сумма_Стр110, Сумма_Стр030);
			Сумма_Стр050 = ?(РасчСост = "1" И ПрПрекр = "1", Сумма_Стр050 + Сумма_Стр110, Сумма_Стр050);
		...
		Ветка2.Данные.Вставить("П000020003001", Сумма_Стр030);
		Ветка2.Данные.Вставить("П000020005001", Сумма_Стр050);
		
		Если Ветка2 = АктивнаяВетка2 Тогда
			ТДО["П000020003001"].Значение = Сумма_Стр030;
			ТДО["П000020005001"].Значение = Сумма_Стр050;
		КонецЕсли;
	...
	ИначеЕсли ИмяРаздела = "Раздел4Прил1" Тогда
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Если РасчетЗаПервыйКвартал Тогда
				Данные.Вставить("П004010006001", Данные["П004010006002"] + Данные["П004010006003"] + Данные["П004010006004"]);
				Данные.Вставить("П004010007001", Данные["П004010007002"] + Данные["П004010007003"] + Данные["П004010007004"]);
			КонецЕсли;
...
Процедура СформироватьРаздел1()
	...
	Стр072_Код2 = 0;
	Стр073_Код2 = 0;
	Стр001 = СокрЛП(Дан["П000130000101"]);
	Если Стр001 = "1" Тогда
		Стр070_Код1 = Стр070_Код1 + Дан["П000130005001"];
		Стр071_Код1 = Стр071_Код1 + Дан["П000130005002"];
		Стр072_Код1 = Стр072_Код1 + Дан["П000130005003"];
		Стр073_Код1 = Стр073_Код1 + Дан["П000130005004"];
	ИначеЕсли Стр001 = "2" Тогда
		Стр070_Код2 = Стр070_Код2 + Дан["П000130005001"];
		Стр071_Код2 = Стр071_Код2 + Дан["П000130005002"];
		Стр072_Код2 = Стр072_Код2 + Дан["П000130005003"];
		Стр073_Код2 = Стр073_Код2 + Дан["П000130005004"];
	КонецЕсли;
	ВыплатыИИныеВознагрВПользуФизЛицВПосл3МесНачислялись = ВыплатыИИныеВознагрВПользуФизЛицВПосл3МесНачислялись
	ИЛИ Дан["П000130002002"] > 0 ИЛИ Дан["П000130002003"] > 0 ИЛИ Дан["П000130002004"] > 0;
	...
	// Строки 080-133.
	ДеревоРазд = ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел1Подр4"]);
	ПроизводитсяИсчислениеОПС = Ложь;
	ПроизводитсяИсчислениеОСС = Ложь;
	ПроизводитсяИсчислениеОМС = Ложь;
	Для каждого Ветка Из ДеревоРазд.Строки Цикл
		Дан = Ветка.Данные;
		ПроизводитсяИсчислениеОПС = ПроизводитсяИсчислениеОПС ИЛИ СокрЛП(Дан["П000140000201"]) = "1";
		ПроизводитсяИсчислениеОСС = ПроизводитсяИсчислениеОСС ИЛИ СокрЛП(Дан["П000140000301"]) = "1";
		ПроизводитсяИсчислениеОМС = ПроизводитсяИсчислениеОМС ИЛИ СокрЛП(Дан["П000140000401"]) = "1";
		ВеткаРаздел1.Данные["П000010009001"] = ВеткаРаздел1.Данные["П000010009001"] + Дан["П000140006001"];
		ВеткаРаздел1.Данные["П000010009101"] = ВеткаРаздел1.Данные["П000010009101"] + Дан["П000140006002"];
		ВеткаРаздел1.Данные["П000010009201"] = ВеткаРаздел1.Данные["П000010009201"] + Дан["П000140006003"];
		ВеткаРаздел1.Данные["П000010009301"] = ВеткаРаздел1.Данные["П000010009301"] + Дан["П000140006004"];
		ВеткаРаздел1.Данные["П000010011001"] = ВеткаРаздел1.Данные["П000010011001"] + Дан["П000140007001"];
		ВеткаРаздел1.Данные["П000010011101"] = ВеткаРаздел1.Данные["П000010011101"] + Дан["П000140007002"];
		ВеткаРаздел1.Данные["П000010011201"] = ВеткаРаздел1.Данные["П000010011201"] + Дан["П000140007003"];
		ВеткаРаздел1.Данные["П000010011301"] = ВеткаРаздел1.Данные["П000010011301"] + Дан["П000140007004"];
		ВеткаРаздел1.Данные["П000010013001"] = ВеткаРаздел1.Данные["П000010013001"] + Дан["П000140008001"];
		ВеткаРаздел1.Данные["П000010013101"] = ВеткаРаздел1.Данные["П000010013101"] + Дан["П000140008002"];
		ВеткаРаздел1.Данные["П000010013201"] = ВеткаРаздел1.Данные["П000010013201"] + Дан["П000140008003"];
		ВеткаРаздел1.Данные["П000010013301"] = ВеткаРаздел1.Данные["П000010013301"] + Дан["П000140008004"];
		ВыплатыИИныеВознагрВПользуФизЛицВПосл3МесНачислялись = ВыплатыИИныеВознагрВПользуФизЛицВПосл3МесНачислялись
		ИЛИ Дан["П000140003002"] > 0 ИЛИ Дан["П000140003003"] > 0 ИЛИ Дан["П000140003004"] > 0;
	КонецЦикла;
	Если ПроизводитсяИсчислениеОПС
		ИЛИ ЗначениеЗаполнено(ВеткаРаздел1.Данные["П000010009001"])
		ИЛИ ЗначениеЗаполнено(ВеткаРаздел1.Данные["П000010009101"])
		ИЛИ ЗначениеЗаполнено(ВеткаРаздел1.Данные["П000010009201"])
		ИЛИ ЗначениеЗаполнено(ВеткаРаздел1.Данные["П000010009301"]) Тогда
		ВеткаРаздел1.Данные["П000010008001"] = "18210215010061000160";
	КонецЕсли;
	Если ПроизводитсяИсчислениеОСС
		ИЛИ ЗначениеЗаполнено(ВеткаРаздел1.Данные["П000010011001"])
		ИЛИ ЗначениеЗаполнено(ВеткаРаздел1.Данные["П000010011101"])
		ИЛИ ЗначениеЗаполнено(ВеткаРаздел1.Данные["П000010011201"])
		ИЛИ ЗначениеЗаполнено(ВеткаРаздел1.Данные["П000010011301"]) Тогда
		ВеткаРаздел1.Данные["П000010010001"] = "18210215020061000160";
	КонецЕсли;
	Если ПроизводитсяИсчислениеОМС
		ИЛИ ЗначениеЗаполнено(ВеткаРаздел1.Данные["П000010013001"])
		ИЛИ ЗначениеЗаполнено(ВеткаРаздел1.Данные["П000010013101"])
		ИЛИ ЗначениеЗаполнено(ВеткаРаздел1.Данные["П000010013201"])
		ИЛИ ЗначениеЗаполнено(ВеткаРаздел1.Данные["П000010013301"]) Тогда
		ВеткаРаздел1.Данные["П000010012001"] = "18210215030081000160";
	КонецЕсли;
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	Если РасчетЗаПервыйКвартал Тогда
		Структ.Вставить("П004010006001");
		Структ.Вставить("П004010007001");
	КонецЕсли;
	...
	Структ.Вставить("П000020005001");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Раздел2", Структ);
	
	// Прил. 5 к разделу 1.
	Структ = Новый Структура;
	Если РасчетЗаПервыйКвартал Тогда
		Структ.Вставить("П001050007001");
		Структ.Вставить("П001050008001");
	КонецЕсли;
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Раздел1Прил5", Структ);
	
	// Прил. 3.1 к разделу 1.
	Структ = Новый Структура;
	Структ.Вставить("П001310003001");
	Структ.Вставить("П001310003002");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Раздел1Прил31", Структ);
	...
	Структ = Новый Структура;
	Если РасчетЗаПервыйКвартал Тогда
		Структ.Вставить("П000140003001");
		Структ.Вставить("П000140004001");
		Структ.Вставить("П000140004501");
		Структ.Вставить("П000140005101");
		Структ.Вставить("П000140005201");
		Структ.Вставить("П000140006101");
		Структ.Вставить("П000140006201");
		Структ.Вставить("П000140007101");
		Структ.Вставить("П000140007201");
		Структ.Вставить("П000140008101");
		Структ.Вставить("П000140008201");
	КонецЕсли;
	Структ.Вставить("П000140002001");
	Структ.Вставить("П000140002002");
	Структ.Вставить("П000140002003");
	Структ.Вставить("П000140002004");
	Структ.Вставить("П000140005001");
	Структ.Вставить("П000140005002");
	Структ.Вставить("П000140005003");
	Структ.Вставить("П000140005004");
	Структ.Вставить("П000140006001");
	Структ.Вставить("П000140006002");
	Структ.Вставить("П000140006003");
	Структ.Вставить("П000140006004");
	Структ.Вставить("П000140007001");
	Структ.Вставить("П000140007002");
	Структ.Вставить("П000140007003");
	Структ.Вставить("П000140007004");
	Структ.Вставить("П000140008001");
	Структ.Вставить("П000140008002");
	Структ.Вставить("П000140008003");
	Структ.Вставить("П000140008004");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Раздел1Подр4", Структ);
	
	// Подр. 3 Раздела 1.
	Структ = Новый Структура;
	Если РасчетЗаПервыйКвартал Тогда
		Структ.Вставить("П000130002001");
		Структ.Вставить("П000130003001");
		Структ.Вставить("П000130005001");
	КонецЕсли;
	Структ.Вставить("П000130004001");
	Структ.Вставить("П000130004002");
	Структ.Вставить("П000130004003");
	Структ.Вставить("П000130004004");
	...
	Если РасчетЗаПервыйКвартал Тогда
		...
		Структ.Вставить("П000010009001");
		Структ.Вставить("П000010011001");
		Структ.Вставить("П000010013001");
	КонецЕсли;
...
&НаКлиентеНаСервереБезКонтекста
Процедура ОтобразитьИтоги(Форма, ИмяРаздела)
	
	Если Форма.СтруктураРеквизитовФормы.Свойство("ИТОГО_ЗаИсключениемТекущейСтраницы")
		И Форма.СтруктураРеквизитовФормы.ИТОГО_ЗаИсключениемТекущейСтраницы <> Неопределено Тогда
		
		ТДО = Форма.ТабличныйДокумент.Области;
		Для каждого Элем Из Форма.СтруктураРеквизитовФормы.ИТОГО_ЗаИсключениемТекущейСтраницы Цикл
			ОблЯчейкиИТОГО = ТДО.Найти(Элем[0]);
			ОблПоказателя  = ТДО.Найти(Элем[1]);
			Если ОблЯчейкиИТОГО <> Неопределено И ОблПоказателя <> Неопределено Тогда
				ОблЯчейкиИТОГО.Текст = Формат(Элем[2] + Окр(ОблПоказателя.Значение, 2), "ЧДЦ=2; ЧРД=,; ЧН=0,00");
			КонецЕсли;
		КонецЦикла;
...
Функция УниверсальнаяВыгрузка(ТекстВыгрузки = Неопределено, ПроверятьБлокировки = Истина) Экспорт
	...
	Если СтруктураРеквизитовФормы.мПроверятьСоотношенияПриПечатиИВыгрузки = Истина Тогда // возможны 3 состояния
		СтруктураПараметров = Новый Структура;
		СтруктураПараметров.Вставить("ИсточникОтчета"	, "РегламентированныйОтчетРасчетПоСтраховымВзносам"); 
		СтруктураПараметров.Вставить("ИмяФормы"			, "ФормаОтчета2025Кв1"); 
		СтруктураПараметров.Вставить("Сценарий"			, "Служебный"); 
		РегламентированнаяОтчетностьКлиент.ПроверитьКонтрольныеСоотношения_СКП(ЭтаФорма, СтруктураПараметров);
	КонецЕсли;
...
Процедура ОчиститьТекущийРазделНаСервере(ИмяРаздела)
	...
	Если ИмяРаздела = "Раздел1Прил5" ИЛИ ИмяРаздела = "Раздел2Подр1"
		ИЛИ ИмяРаздела = "Раздел3" ИЛИ ИмяРаздела = "Раздел4Прил1" Тогда
...
Процедура ОчиститьТекущуюСтраницуЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Иначе
		Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1Подр1" Тогда
			...
			Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчета = ПредставлениеСтраницыПодраздела1Раздела1(СтруктПарам);
		ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1Подр4" Тогда
			СтруктПарам = Новый Структура;
			СтруктПарам.Вставить("КодТарифа", ТабличныйДокумент.Область("П000140000101").Значение);
			СтруктПарам.Вставить("НомерСтраницы", Элементы.РазделыОтчета.ТекущиеДанные.КолонкаНомерСтраницыРазделаОтчета);
			Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчета = ПредставлениеСтраницыПодраздела4Раздела1(СтруктПарам);
		...
		ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1Прил5" Тогда
			СтруктПарам = Новый Структура;
			СтруктПарам.Вставить("Фам", ТабличныйДокумент.Область("П001050001001").Значение);
			СтруктПарам.Вставить("Имя", ТабличныйДокумент.Область("П001050002001").Значение);
			СтруктПарам.Вставить("Отч", ТабличныйДокумент.Область("П001050003001").Значение);
		...
		ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел3" Тогда
			...
			= РегламентированнаяОтчетностьКлиентСервер.ПредставлениеСтраницыРазделаРеглОтчетаСодержащегоДанныеФизическихЛиц(
			СтруктПарам);
		ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел4Прил1" Тогда
			СтруктПарам = Новый Структура;
			СтруктПарам.Вставить("Фам", ТабличныйДокумент.Область("П004010001001").Значение);
			СтруктПарам.Вставить("Имя", ТабличныйДокумент.Область("П004010002001").Значение);
			СтруктПарам.Вставить("Отч", ТабличныйДокумент.Область("П004010003001").Значение);
...
Функция ПечатьРеестраНаСервере(ВидПечати, ЗаголовокПечатнойФормы)
	...
	ИмяМакета = "ПечатныйБланк2025Кв1_Реестр";
	...
	ТЗ.Колонки.Добавить("Мес1_СумВыпВсего", ОписаниеТиповЧ);
	ТЗ.Колонки.Добавить("Мес1_СумВыпГПДог", ОписаниеТиповЧ);
	...
	ТЗ.Колонки.Добавить("Мес2_СумВыпВсего", ОписаниеТиповЧ);
	ТЗ.Колонки.Добавить("Мес2_СумВыпГПДог", ОписаниеТиповЧ);
	...
	ТЗ.Колонки.Добавить("Мес3_СумВыпВсего", ОписаниеТиповЧ);
	ТЗ.Колонки.Добавить("Мес3_СумВыпГПДог", ОписаниеТиповЧ);
	...
	СтрокаСуммирования
	= "Мес1_СумВыпВсего,Мес1_СумВыпГПДог,Мес1_БазаВсего,Мес1_БазаГПДог,Мес1_СуммаСтВз,"
	+ "Мес2_СумВыпВсего,Мес2_СумВыпГПДог,Мес2_БазаВсего,Мес2_БазаГПДог,Мес2_СуммаСтВз,"
	+ "Мес3_СумВыпВсего,Мес3_СумВыпГПДог,Мес3_БазаВсего,Мес3_БазаГПДог,Мес3_СуммаСтВз";
	...
	Для каждого Ветка Из ДеревоДанных.Строки Цикл
		...
		Для каждого СтрокаМнЧ Из ДеревоМнЧ.Строки Цикл
			...
			Если ИндМес <> Неопределено Тогда
				...
				НовСтрТЗ["Мес" + Инд_ + "СумВыпВсего"] = ДанныеСтрокиМнЧ["П00321М114001"];
				НовСтрТЗ["Мес" + Инд_ + "СумВыпГПДог"] = ДанныеСтрокиМнЧ["П00321М114101"];
				...
				НовСтрТЗ_ИтогПоРазделу["Мес" + Инд_ + "СумВыпВсего"] = ДанныеСтрокиМнЧ["П00321М114001"];
				НовСтрТЗ_ИтогПоРазделу["Мес" + Инд_ + "СумВыпГПДог"] = ДанныеСтрокиМнЧ["П00321М114101"];
		...
		ТЗ.Свернуть("КодКатегорииЗЛ", СтрокаСуммирования);
		...
		Если ТЗ.Количество() > 0 Тогда
			...
			Для ИндСтрТЗ = 1 По ТЗ.Количество() - 1 Цикл
				...
				Если ИндСтрТЗ = ТЗ.Количество() - 1 Тогда
					...
					ТЗ_ = ТЗ.Скопировать();
					ТЗ_.Свернуть("", СтрокаСуммирования);
					...
					Обл = ПФ.Область(ОблВерх, 5, ОблВерх, 20);
	...
	ТЗ_ИтогПоРазделу.Свернуть("", СтрокаСуммирования);
	...
	Для каждого Ветка Из ДеревоДанных.Строки Цикл
		...
		НовСтрТЗ_ИтогПоРазделу["Мес1_СумВыпВсего"] = Ветка.Данные["П000110003002"];
		НовСтрТЗ_ИтогПоРазделу["Мес2_СумВыпВсего"] = Ветка.Данные["П000110003003"];
		НовСтрТЗ_ИтогПоРазделу["Мес3_СумВыпВсего"] = Ветка.Данные["П000110003004"];
	...
	СтрокаСуммирования = "Мес1_База,Мес1_СуммаСтВз,Мес2_База,Мес2_СуммаСтВз,Мес3_База,Мес3_СуммаСтВз";
	...
	Для каждого Ветка Из ДеревоДанных.Строки Цикл
		...
		ТЗ.Свернуть("КодЗЛ", СтрокаСуммирования);
...
Процедура Расшифровать(Команда)
	...
	ОбластьТаблДокумента = ТабличныйДокумент.Области.Найти("П000130000101");
	Если ОбластьТаблДокумента <> Неопределено Тогда
		Раздел1Подр3КодОснования = СокрЛП(ОбластьТаблДокумента.Значение);
	КонецЕсли;
	
	Раздел1Подр4КодТарифа = "";
	ОбластьТаблДокумента = ТабличныйДокумент.Области.Найти("П000140000101");
	Если ОбластьТаблДокумента <> Неопределено Тогда
		Раздел1Подр4КодТарифа = СокрЛП(ОбластьТаблДокумента.Значение);
	КонецЕсли;
	...
	ПараметрыОтчета.Вставить("Раздел1Подр4КодТарифа",        Раздел1Подр4КодТарифа);
...
Процедура Проверить(Команда)
	...
	Если Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) > 2025 Тогда
		...
		"ru = 'Проверка контрольных соотношений для 2026 и более поздних 
		| календарных годов будет реализована в будущих версиях программы';
		|en = 'Проверка контрольных соотношений для 2026 и более поздних 
		| календарных годов будет реализована в будущих версиях программы'"));
	...
	ДополнительныеПараметры.Вставить("ИсточникОтчета"	, "РегламентированныйОтчетРасчетПоСтраховымВзносам");
	ДополнительныеПараметры.Вставить("ИмяФормы"			, "ФормаОтчета2025Кв1"); 
	ДополнительныеПараметры.Вставить("Сценарий"			, "Основной");
...
&НаСервере
Функция ПроверитьКонтрольныеСоотношенияВОтчете(ДополнительныеПараметры) Экспорт
	...
	СписочныеЗначения.Вставить("П00001М104001");
	СписочныеЗначения.Вставить("П00001М206001");
	СписочныеЗначения.Вставить("П000010008001");
	СписочныеЗначения.Вставить("П000010010001");
	СписочныеЗначения.Вставить("П000010012001");
	СписочныеЗначения.Вставить("П000020002001");
	СписочныеЗначения.Вставить("П000040002001");
	СписочныеЗначения.Вставить("П000040004001");
	...
	Если ДополнительныеПараметры.Сценарий = "Основной" Тогда 
		// длительная операция
		Возврат ДлительныеОперации.ВыполнитьВФоне(ИмяПроцедуры, ПараметрыВыполнения, ПараметрыЗапуска);
	Иначе
		// для служебных сценариев обычное выполнение
...
Функция ВыполнитьДокументированиеНаСервере()
	...
	ДополнительныеПараметры = Новый Структура;
	ДополнительныеПараметры.Вставить("НаименованиеФормы", "2025Кв1");
	
	Возврат ОбъектОтчета.ВыполнитьДокументированиеОбъект2025(ДополнительныеПараметры);
...
Функция ВыполнитьПоискКопийРеглОтчетовНаСервере(ДополнительныеПараметры)
	...
	|	И Документ.ВыбраннаяФорма = ""ФормаОтчета2025Кв1""
...
Процедура ВвестиПоказатель(Элемент, Область, КодПоказателя, Знач ЭтоСумма, Знач ТекстВыбора, ТаблицаВыбора, СтандартнаяОбработка, КолонкаПоиска = "Код") Экспорт
	...
	Если ТаблицаВыбора = Неопределено ИЛИ (СтруктураРеквизитовФормы.мАвтоВыборКодов
		И НЕ Область.Имя = "Период" И НЕ Область.Имя = "ПоМесту" И НЕ Область.Имя = "КодФормыРеорганизации") Тогда
		Возврат;
	КонецЕсли;
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если Область.Имя = "ПоМесту" Тогда
		...
		Период = СокрЛП(ТабличныйДокумент.Области.Найти("Период").Значение);
		
		ПрежнееСостояние_ДолжныПрисутствовать_Р2_И_П1 = ПрежнийКодПоМестуЭтоКодГлавыКФХ
		И СтрРазделить("34,51,52,53,83,84,85,86,90", ",", Ложь).Найти(Период) <> Неопределено;
		
		ПрежнееСостояние_ДолжныОтсутствовать_Р2_И_П1 = НЕ ПрежнийКодПоМестуЭтоКодГлавыКФХ
		ИЛИ (ПрежнийКодПоМестуЭтоКодГлавыКФХ И СтрРазделить("21,31,33", ",", Ложь).Найти(Период) <> Неопределено);
		
		НовоеСостояние_ДолжныПрисутствовать_Р2_И_П1 = НовыйКодПоМестуЭтоКодГлавыКФХ
		И СтрРазделить("34,51,52,53,83,84,85,86,90", ",", Ложь).Найти(Период) <> Неопределено;
		
		НовоеСостояние_ДолжныОтсутствовать_Р2_И_П1 = НЕ НовыйКодПоМестуЭтоКодГлавыКФХ
		ИЛИ (НовыйКодПоМестуЭтоКодГлавыКФХ И СтрРазделить("21,31,33", ",", Ложь).Найти(Период) <> Неопределено);
		
		ДополнительныеПараметры = Новый Структура();
		ДополнительныеПараметры.Вставить("Область", Область);
		ДополнительныеПараметры.Вставить("НовыйКод", НовыйКодПоМесту);
		ДополнительныеПараметры.Вставить(
		"ПрежнееСостояние_ДолжныПрисутствовать_Р2_И_П1", ПрежнееСостояние_ДолжныПрисутствовать_Р2_И_П1);
		ДополнительныеПараметры.Вставить(
		"ПрежнееСостояние_ДолжныОтсутствовать_Р2_И_П1", ПрежнееСостояние_ДолжныОтсутствовать_Р2_И_П1);
		ДополнительныеПараметры.Вставить(
		"НовоеСостояние_ДолжныПрисутствовать_Р2_И_П1", НовоеСостояние_ДолжныПрисутствовать_Р2_И_П1);
		ДополнительныеПараметры.Вставить(
		"НовоеСостояние_ДолжныОтсутствовать_Р2_И_П1", НовоеСостояние_ДолжныОтсутствовать_Р2_И_П1);
		
		Если ПрежнееСостояние_ДолжныПрисутствовать_Р2_И_П1 И НовоеСостояние_ДолжныОтсутствовать_Р2_И_П1 Тогда
			Оп = Новый ОписаниеОповещения("ВопросВвестиКодЗавершение", ЭтотОбъект, ДополнительныеПараметры);
			...
			Возврат;
		ИначеЕсли ПрежнееСостояние_ДолжныОтсутствовать_Р2_И_П1 И НовоеСостояние_ДолжныПрисутствовать_Р2_И_П1 Тогда
			ВопросВвестиКодЗавершение(КодВозвратаДиалога.Да, ДополнительныеПараметры);
		КонецЕсли;
		
	ИначеЕсли Область.Имя = "КодФормыРеорганизации" Тогда
		
		ПрежнийКодФормыРеорг = СокрЛП(Область.Значение);
		НовыйКодФормыРеорг   = СокрЛП(РезультатВыбора[КолонкаПоиска]);
		
		ЭтоОтчетЗаГод = Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 12;
		
		Период     = СокрЛП(ТабличныйДокумент.Области.Найти("Период").Значение);
		КодПоМесту = СокрЛП(ТабличныйДокумент.Области.Найти("ПоМесту").Значение);
		
		КодПоМестуЭтоКодГлавыКФХ = (КодПоМесту = "124" ИЛИ КодПоМесту = "240");
		
		ПрежнееСостояние_ДолжныПрисутствовать_Р2_И_П1 = КодПоМестуЭтоКодГлавыКФХ
		И СтрРазделить("34,51,52,53,83,84,85,86,90", ",", Ложь).Найти(Период) <> Неопределено;
		
		ПрежнееСостояние_ДолжныОтсутствовать_Р2_И_П1 = НЕ КодПоМестуЭтоКодГлавыКФХ
		ИЛИ (КодПоМестуЭтоКодГлавыКФХ И СтрРазделить("21,31,33", ",", Ложь).Найти(Период) <> Неопределено);
		
		НовоеСостояние_ДолжныПрисутствовать_Р2_И_П1 = КодПоМестуЭтоКодГлавыКФХ
		И (ЗначениеЗаполнено(НовыйКодФормыРеорг) ИЛИ ЭтоОтчетЗаГод);
		
		НовоеСостояние_ДолжныОтсутствовать_Р2_И_П1 = НЕ КодПоМестуЭтоКодГлавыКФХ
		ИЛИ (КодПоМестуЭтоКодГлавыКФХ И НЕ (ЗначениеЗаполнено(НовыйКодФормыРеорг) ИЛИ ЭтоОтчетЗаГод));
		
		ДополнительныеПараметры = Новый Структура();
		ДополнительныеПараметры.Вставить("Область", Область);
		ДополнительныеПараметры.Вставить("НовыйКод", НовыйКодФормыРеорг);
		ДополнительныеПараметры.Вставить(
		"ПрежнееСостояние_ДолжныПрисутствовать_Р2_И_П1", ПрежнееСостояние_ДолжныПрисутствовать_Р2_И_П1);
		ДополнительныеПараметры.Вставить(
		"ПрежнееСостояние_ДолжныОтсутствовать_Р2_И_П1", ПрежнееСостояние_ДолжныОтсутствовать_Р2_И_П1);
		...
		Если ПрежнееСостояние_ДолжныПрисутствовать_Р2_И_П1 И НовоеСостояние_ДолжныОтсутствовать_Р2_И_П1 Тогда
			Оп = Новый ОписаниеОповещения("ВопросВвестиКодЗавершение", ЭтотОбъект, ДополнительныеПараметры);
			ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'При изменении значения кода формы реорганизации
			|(ликвидации) с %1 на %2 Раздел 2
			|и Подраздел 1 Раздела 2 будут очищены и исключены
			|из состава дерева разделов. Продолжить?';
			|en = 'При изменении значения кода формы реорганизации
			|(ликвидации) с %1 на %2 Раздел 2
			|и Подраздел 1 Раздела 2 будут очищены и исключены
			|из состава дерева разделов. Продолжить?'"),
			?(ПрежнийКодФормыРеорг = "", "пустого значения", """" + ПрежнийКодФормыРеорг + """"),
			?(НовыйКодФормыРеорг = "", "пустое значение", """" + НовыйКодФормыРеорг + """"));
			ПоказатьВопрос(Оп, ТекстВопроса, РежимДиалогаВопрос.ДаНет, 60, КодВозвратаДиалога.Нет);
			Возврат;
		ИначеЕсли ПрежнееСостояние_ДолжныОтсутствовать_Р2_И_П1 И НовоеСостояние_ДолжныПрисутствовать_Р2_И_П1 Тогда
			ВопросВвестиКодЗавершение(КодВозвратаДиалога.Да, ДополнительныеПараметры);
	...
	ИначеЕсли Область.Имя = "Период" Тогда
		...
		ПрежнееСостояние_ДолжныПрисутствовать_Р2_И_П1 = КодПоМестуЭтоКодГлавыКФХ
		И СтрРазделить("34,51,52,53,83,84,85,86,90", ",", Ложь).Найти(ПрежнийПериод) <> Неопределено;
		
		ПрежнееСостояние_ДолжныОтсутствовать_Р2_И_П1 = НЕ КодПоМестуЭтоКодГлавыКФХ
		ИЛИ (КодПоМестуЭтоКодГлавыКФХ И СтрРазделить("21,31,33", ",", Ложь).Найти(ПрежнийПериод) <> Неопределено);
		
		НовоеСостояние_ДолжныПрисутствовать_Р2_И_П1 = КодПоМестуЭтоКодГлавыКФХ
		И СтрРазделить("34,51,52,53,83,84,85,86,90", ",", Ложь).Найти(НовыйПериод) <> Неопределено;
		
		НовоеСостояние_ДолжныОтсутствовать_Р2_И_П1 = НЕ КодПоМестуЭтоКодГлавыКФХ
		ИЛИ (КодПоМестуЭтоКодГлавыКФХ И СтрРазделить("21,31,33", ",", Ложь).Найти(НовыйПериод) <> Неопределено);
		
		ДополнительныеПараметры = Новый Структура();
		ДополнительныеПараметры.Вставить("Область", Область);
		ДополнительныеПараметры.Вставить("НовыйКод", НовыйПериод);
		ДополнительныеПараметры.Вставить(
		"ПрежнееСостояние_ДолжныПрисутствовать_Р2_И_П1", ПрежнееСостояние_ДолжныПрисутствовать_Р2_И_П1);
		ДополнительныеПараметры.Вставить(
		"ПрежнееСостояние_ДолжныОтсутствовать_Р2_И_П1", ПрежнееСостояние_ДолжныОтсутствовать_Р2_И_П1);
		...
		Если ПрежнееСостояние_ДолжныПрисутствовать_Р2_И_П1 И НовоеСостояние_ДолжныОтсутствовать_Р2_И_П1 Тогда
			Оп = Новый ОписаниеОповещения("ВопросВвестиКодЗавершение", ЭтотОбъект, ДополнительныеПараметры);
			ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'При изменении значения кода расчетного (отчетного)
			|периода с ""%1"" на ""%2"" Раздел 2 и Подраздел 1
			|Раздела 2 будут очищены и исключены из состава
			|дерева разделов. Продолжить?';
			|en = 'При изменении значения кода расчетного (отчетного)
			|периода с ""%1"" на ""%2"" Раздел 2 и Подраздел 1
			|Раздела 2 будут очищены и исключены из состава
			|дерева разделов. Продолжить?'"), ПрежнийПериод, НовыйПериод);
			ПоказатьВопрос(Оп, ТекстВопроса, РежимДиалогаВопрос.ДаНет, 60, КодВозвратаДиалога.Нет);
			Возврат;
		ИначеЕсли ПрежнееСостояние_ДолжныОтсутствовать_Р2_И_П1 И НовоеСостояние_ДолжныПрисутствовать_Р2_И_П1 Тогда
			ВопросВвестиКодЗавершение(КодВозвратаДиалога.Да, ДополнительныеПараметры);
...
&НаКлиенте
Процедура ВопросВвестиКодЗавершение(РезультатВопроса, ДополнительныеПараметры) Экспорт
	...
	Если ДополнительныеПараметры.ПрежнееСостояние_ДолжныПрисутствовать_Р2_И_П1
		И ДополнительныеПараметры.НовоеСостояние_ДолжныОтсутствовать_Р2_И_П1 Тогда
	...
	ИначеЕсли ДополнительныеПараметры.ПрежнееСостояние_ДолжныОтсутствовать_Р2_И_П1
		И ДополнительныеПараметры.НовоеСостояние_ДолжныПрисутствовать_Р2_И_П1 Тогда
...
Процедура АктивизироватьЯчейку(Ячейка) Экспорт
	...
	Если Ячейка.Раздел = "Раздел1" ИЛИ Ячейка.Раздел = "Раздел1Подр2" ИЛИ Ячейка.Раздел = "Раздел1Подр3"
		...
		ИЛИ Ячейка.Раздел = "Раздел1Прил31" ИЛИ Ячейка.Раздел = "Раздел1Прил4" ИЛИ Ячейка.Раздел = "Раздел2"
		ИЛИ Ячейка.Раздел = "Раздел4" ИЛИ Ячейка.Раздел = "Раздел4Подр1" Тогда
		Для каждого НайденныйРаздел Из РазделыОтчета.ПолучитьЭлементы() Цикл
			...
			КонецЕсли;
		КонецЦикла;
	ИначеЕсли Ячейка.Раздел = "Раздел1Подр1" ИЛИ Ячейка.Раздел = "Раздел1Подр4" ИЛИ Ячейка.Раздел = "Раздел1Прил5"
		ИЛИ Ячейка.Раздел = "Раздел2Подр1" ИЛИ Ячейка.Раздел = "Раздел3" ИЛИ Ячейка.Раздел = "Раздел4Прил1" Тогда
		Для каждого НайденныйРаздел Из РазделыОтчета.ПолучитьЭлементы() Цикл
			Если НайденныйРаздел.КолонкаРазделыОтчетаСокрНаим = Ячейка.Раздел Тогда
				...
				Если СтруктураРаздела.Свойство("Многостраничность") Тогда
					...
					Для НомерСтраницыРаздела = 1 По КолСтрокВДеревеДанныхРаздела Цикл
						...
						Если ИмяРаздела = "Раздел1Подр1" Тогда
							...
							ЭлементРаздел.КолонкаРазделыОтчета = ПредставлениеСтраницыПодраздела1Раздела1(СтруктПарам);
						...
						ИначеЕсли ИмяРаздела = "Раздел1Подр4" Тогда
							...
							СтруктПарам = Новый Структура;
							СтруктПарам.Вставить("КодТарифа", ДанныеСтраницы.П000140000101);
							СтруктПарам.Вставить("НомерСтраницы", НомерСтраницыРаздела);
							
							ЭлементРаздел.КолонкаРазделыОтчета = ПредставлениеСтраницыПодраздела4Раздела1(СтруктПарам);
						...
						ИначеЕсли ИмяРаздела = "Раздел1Прил5" Тогда
							...
							СтруктПарам = Новый Структура;
							СтруктПарам.Вставить("Фам", ДанныеСтраницы.П001050001001);
							СтруктПарам.Вставить("Имя", ДанныеСтраницы.П001050002001);
							СтруктПарам.Вставить("Отч", ДанныеСтраницы.П001050003001);
							СтруктПарам.Вставить("ДатаРожд", ДанныеСтраницы.П001050006101);
							СтруктПарам.Вставить("НомерСтраницы", НомерСтраницыРаздела);
						...
						ИначеЕсли ИмяРаздела = "Раздел4Прил1" Тогда
							...
							СтруктПарам = Новый Структура;
							СтруктПарам.Вставить("Фам", ДанныеСтраницы.П004010001001);
							СтруктПарам.Вставить("Имя", ДанныеСтраницы.П004010002001);
							СтруктПарам.Вставить("Отч", ДанныеСтраницы.П004010003001);
							СтруктПарам.Вставить("ДатаРожд", ДанныеСтраницы.П004010005101);
							СтруктПарам.Вставить("НомерСтраницы", НомерСтраницыРаздела);
...
&НаКлиентеНаСервереБезКонтекста
Функция ПредставлениеСтраницыПодраздела1Раздела1(СтруктураПараметров)
	
	Возврат ПредставлениеСтраницыПодразделаРаздела1(СтруктураПараметров);
	
КонецФункции

&НаКлиентеНаСервереБезКонтекста
Функция ПредставлениеСтраницыПодраздела4Раздела1(СтруктураПараметров)
...
&НаКлиентеНаСервереБезКонтекста
Функция ПредставлениеСтраницыПодразделаРаздела1(СтруктураПараметров)
...
Процедура РазделыОтчетаПриАктивизацииСтроки(Элемент)
	...
	Если мСтруктураМногоуровневыхРазделов.Свойство(
		...
		Если мСтруктураМногоуровневыхРазделов[Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим].Свойство(
			...
			= (Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел1Прил5"
			ИЛИ Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел2Подр1"
			ИЛИ Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел3"
			ИЛИ Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел4Прил1");
