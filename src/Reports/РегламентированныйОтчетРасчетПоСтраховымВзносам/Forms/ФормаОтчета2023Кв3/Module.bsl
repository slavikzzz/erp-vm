...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.ФормаРекомендованаПисьмомОт20230926 = Параметры.ФормаРекомендованаПисьмомОт20230926;
		...
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Строки Тогда
			...
			Для НомСтр = ВерхОбласти По НизОбласти Цикл
				...
				Если КодПоказателя <> "###" Тогда
					...
					Если Область.Имя = "КодыТарифаПлательщика" И КодПоказателя = "27"
						И СтруктураРеквизитовФормы["ФормаРекомендованаПисьмомОт20230926"] Тогда
						
						НовСтрока.Название
						= "Плательщики страховых взносов - организации, которые включены в реестр организаций, являющихся участниками "
						+ "промышленных кластеров, подтвердивших соответствие требованиям к промышленным кластерам, установленным "
						+ "Правительством Российской Федерации, являющихся одновременно сторонами специальных инвестиционных "
						+ "контрактов, стороной которых является Российская Федерация, заключенных в соответствии со статьей 16 "
						+ "Федерального закона от 31.12.2014 № 488-ФЗ ""О промышленной политике в Российской Федерации"" (Собрание "
						+ "законодательства Российской Федерации, 2023, № 25, ст. 4434)";
						
					ИначеЕсли Область.Имя = "КодыКатегорииЗастрахованногоЛица" И КодПоказателя = "ПРОМ"
						И СтруктураРеквизитовФормы["ФормаРекомендованаПисьмомОт20230926"] Тогда
						
						НовСтрока.Название
						= "Физические лица, с выплат и вознаграждений которым исчисляются страховые взносы организациями, которые "
						+ "включены в реестр организаций, являющихся участниками промышленных кластеров, подтвердивших соответствие "
						+ "требованиям к промышленным кластерам, установленным Правительством Российской Федерации, являющихся "
						+ "одновременно сторонами специальных инвестиционных контрактов, стороной которых является Российская "
						+ "Федерация, заключенных в соответствии со статьей 16 Федерального закона от 31.12.2014 № 488-ФЗ ""О "
						+ "промышленной политике в Российской Федерации""";
						
					ИначеЕсли Область.Имя = "КодыКатегорииЗастрахованногоЛица" И КодПоказателя = "ВЖПР"
						И СтруктураРеквизитовФормы["ФормаРекомендованаПисьмомОт20230926"] Тогда
						
						НовСтрока.Название
						= "Застрахованные в системе обязательного пенсионного страхования лица из числа иностранных граждан или лиц "
						+ "без гражданства, временно проживающие на территории Российской Федерации, а также временно пребывающие на "
						+ "территории Российской Федерации иностранные граждане или лица без гражданства, которым предоставлено "
						+ "временное убежище в соответствии с Федеральным законом от 19.02.1993 № 4528-1 ""О беженцах"", с выплат и "
						+ "вознаграждений которым исчисляются страховые взносы организациями, которые включены в реестр организаций, "
						+ "являющихся участниками промышленных кластеров, подтвердивших соответствие требованиям к промышленным "
						+ "кластерам, установленным Правительством Российской Федерации, являющихся одновременно сторонами специальных "
						+ "инвестиционных контрактов, стороной которых является Российская Федерация, заключенных в соответствии со "
						+ "статьей 16 Федерального закона от 31.12.2014 № 488-ФЗ ""О промышленной политике в Российской Федерации""";
						
					ИначеЕсли Область.Имя = "КодыКатегорииЗастрахованногоЛица" И КодПоказателя = "ВППР"
						И СтруктураРеквизитовФормы["ФормаРекомендованаПисьмомОт20230926"] Тогда
						
						НовСтрока.Название
						= "Иностранные граждане или лица без гражданства (за исключением высококвалифицированных специалистов в "
						+ "соответствии с Федеральным законом от 25.07.2002 № 115-ФЗ ""О правовом положении иностранных граждан в "
						+ "Российской Федерации""), временно пребывающие на территории Российской Федерации"", с выплат и "
						+ "вознаграждений которым исчисляются страховые взносы организациями, которые включены в реестр организаций, "
						+ "являющихся участниками промышленных кластеров, подтвердивших соответствие требованиям к промышленным "
						+ "кластерам, установленным Правительством Российской Федерации, являющихся одновременно сторонами специальных "
						+ "инвестиционных контрактов, стороной которых является Российская Федерация, заключенных в соответствии со "
...
Функция Сохранить(Автосохранение = Ложь, КодИФНС, КПП, Вариант, ВидДокументаНомерКорректировкиИзменен = Неопределено, НаимТекРаздела) Экспорт
	...
	Если Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 2023 Тогда
		ПараметрыЗаписи.Вставить("ФормаРекомендованаПисьмомОт20230926",
		СтруктураРеквизитовФормы["ФормаРекомендованаПисьмомОт20230926"]);
	КонецЕсли;
...
Процедура ВосстановитьСохраненныеДанные()
	...
	Если СтруктураРеквизитовФормы.мСкопированаФорма = Неопределено Тогда
		...
		// Особая обработка: реквизиты приказа.
		Если Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 2023 Тогда
			СписокСохранения.Свойство("ФормаРекомендованаПисьмомОт20230926",
			СтруктураРеквизитовФормы.ФормаРекомендованаПисьмомОт20230926);
			Если СтруктураРеквизитовФормы.ФормаРекомендованаПисьмомОт20230926 = Неопределено Тогда
				СтруктураРеквизитовФормы.Вставить("ФормаРекомендованаПисьмомОт20230926", Истина);
			КонецЕсли;
		КонецЕсли;
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли СтрНачинаетсяС(Область.Имя, "П00105М106001") ИЛИ Область.Имя = "П000310008001" Тогда
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если СтрНачинаетсяС(ИмяПоказателя, "П00105М104001") ИЛИ ИмяПоказателя = "П000210005001"
		ИЛИ ИмяПоказателя = "П000310002001" ИЛИ СтрНачинаетсяС(ИмяПоказателя, "П00401М104001") Тогда
	...
	Если СтрНачинаетсяС(ИмяПоказателя, "П00105М105001") ИЛИ ИмяПоказателя = "П000210006001"
		ИЛИ ИмяПоказателя = "П000310003001" ИЛИ СтрНачинаетсяС(ИмяПоказателя, "П00401М105001") Тогда
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяРаздела)
	...
	Если ИмяРаздела = "Титульный" Тогда
		...
		// Особая обработка: реквизиты приказа.
		Если Форма.СтруктураРеквизитовФормы["ФормаРекомендованаПисьмомОт20230926"] Тогда
			
			Обл = ТДО.Найти("РеквизитыПриказа");
			Если Обл <> Неопределено Тогда
				Обл.Текст = НСтр("ru = 'Рекомендована
				|письмом ФНС России
				|от 26.09.2023
				|№ БС-4-11/12322@';
				|en = 'Рекомендована
	...
	ИначеЕсли ИмяРаздела = "Раздел1Подр1" ИЛИ ИмяРаздела = "Раздел1Подр4" ИЛИ ИмяРаздела = "Раздел1Прил2"
		ИЛИ ИмяРаздела = "Раздел1Прил3" ИЛИ ИмяРаздела = "Раздел2" ИЛИ ИмяРаздела = "Раздел2Подр1"
		ИЛИ ИмяРаздела = "Раздел4" ИЛИ ИмяРаздела = "Раздел4Подр1" Тогда
	...
	ИначеЕсли ИмяРаздела = "Раздел1Прил5" Тогда
		...
		Инд = 1;
		Инд_Строка = "_1";
		Обл = ТДО.Найти("П00105М107001" + Инд_Строка);
		Пока Обл <> Неопределено Цикл
			Для каждого Пок Из СтруктЗависимыхЯчеек Цикл
				АвтоРасчПоказатели.Добавить(Пок.Ключ + Инд_Строка);
			КонецЦикла;
...
Процедура ДобавитьСтраницу(Команда)
	...
	Если ИмяРаздела = "Раздел1Подр1" ИЛИ ИмяРаздела = "Раздел1Подр4"
		ИЛИ ИмяРаздела = "Раздел2Подр1" ИЛИ ИмяРаздела = "Раздел3" Тогда
...
Процедура УдалитьДопСтрокуНаСервере()
	...
	ОтобразитьИтоги(ЭтотОбъект, СтруктураРеквизитовФормы.НаимТекущегоРаздела);
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				Если РасчетЗаПервыйКвартал Тогда
					...
					ТДО["П00105М107001" + _Инд].Значение = ТДО["П00105М107002" + _Инд].Значение
					+ ТДО["П00105М107003" + _Инд].Значение + ТДО["П00105М107004" + _Инд].Значение;
...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
	...
	ИначеЕсли ИмяРаздела = "Раздел1Прил5" Тогда
		...
		ИмяГруппыМнЧ = Форма.СтруктураРеквизитовФормы.мИдГруппы105М1;
		СтруктураГруппыМнЧ = Форма.СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей[ИмяГруппыМнЧ];
		ИменаГрафМнЧ = СтруктураГруппыМнЧ["ИменаГраф"];
		...
		Если РасчетЗаПервыйКвартал Тогда
			Для каждого СтрокаМнЧ Из ДеревоМнЧ.Строки Цикл
				ДанСтр = СтрокаМнЧ.Данные;
				ДанСтр.Вставить("П00105М107001", ДанСтр["П00105М107002"] + ДанСтр["П00105М107003"] + ДанСтр["П00105М107004"]);
			КонецЦикла;
		КонецЕсли;
...
Процедура ОтобразитьИтоги(Форма, ИмяРаздела)
	...
	Если ИмяРаздела = "Раздел1Прил5" ИЛИ ИмяРаздела = "Раздел4Прил1" Тогда
		...
		Если ИмяРаздела = "Раздел1Прил5" Тогда
			...
			Пока Обл <> Неопределено Цикл
				...
				ИтогоСумВсего = ИтогоСумВсего + Окр(Обл.Значение, 2);
				Обл = ТДО.Найти("П00105М107002" + Инд_Строка);
				Если Обл <> Неопределено Тогда
					ИтогоСум1Мес = ИтогоСум1Мес + Окр(Обл.Значение, 2);
				КонецЕсли;
				Обл = ТДО.Найти("П00105М107003" + Инд_Строка);
				Если Обл <> Неопределено Тогда
					ИтогоСум2Мес = ИтогоСум2Мес + Окр(Обл.Значение, 2);
				КонецЕсли;
				Обл = ТДО.Найти("П00105М107004" + Инд_Строка);
				Если Обл <> Неопределено Тогда
					ИтогоСум3Мес = ИтогоСум3Мес + Окр(Обл.Значение, 2);
				КонецЕсли;
		...
		Иначе// "Раздел4Прил1"
			...
			Пока Обл <> Неопределено Цикл
				...
				ИтогоСумВсего = ИтогоСумВсего + Окр(Обл.Значение, 2);
				Обл = ТДО.Найти("П00401М106002" + Инд_Строка);
				Если Обл <> Неопределено Тогда
					ИтогоСум1Мес = ИтогоСум1Мес + Окр(Обл.Значение, 2);
				КонецЕсли;
				Обл = ТДО.Найти("П00401М106003" + Инд_Строка);
				Если Обл <> Неопределено Тогда
					ИтогоСум2Мес = ИтогоСум2Мес + Окр(Обл.Значение, 2);
				КонецЕсли;
				Обл = ТДО.Найти("П00401М106004" + Инд_Строка);
				Если Обл <> Неопределено Тогда
					ИтогоСум3Мес = ИтогоСум3Мес + Окр(Обл.Значение, 2);
				КонецЕсли;
		...
		Обл = ТДО.Найти("ИтогоСумВсего");
		Если Обл <> Неопределено И Обл.СодержитЗначение = Ложь Тогда
			Обл.Текст = Формат(ИтогоСумВсего, "ЧДЦ=2; ЧН=0,00");
		КонецЕсли;
		Обл = ТДО.Найти("ИтогоСум1Мес");
		Если Обл <> Неопределено И Обл.СодержитЗначение = Ложь Тогда
			Обл.Текст = Формат(ИтогоСум1Мес, "ЧДЦ=2; ЧН=0,00");
		КонецЕсли;
		Обл = ТДО.Найти("ИтогоСум2Мес");
		Если Обл <> Неопределено И Обл.СодержитЗначение = Ложь Тогда
			Обл.Текст = Формат(ИтогоСум2Мес, "ЧДЦ=2; ЧН=0,00");
		КонецЕсли;
		Обл = ТДО.Найти("ИтогоСум3Мес");
		Если Обл <> Неопределено И Обл.СодержитЗначение = Ложь Тогда
			Обл.Текст = Формат(ИтогоСум3Мес, "ЧДЦ=2; ЧН=0,00");
		КонецЕсли;
...
Функция УниверсальнаяВыгрузка(ТекстВыгрузки = Неопределено, ПроверятьБлокировки = Истина) Экспорт
	...
	Если СтруктураРеквизитовФормы.мПроверятьСоотношенияПриПечатиИВыгрузки = Истина Тогда // возможны 3 состояния
		...
		СтруктураПараметров.Вставить("ИмяФормы"			, "ФормаОтчета2023Кв3"); 
...
Функция ПечатьРеестраНаСервере(ВидПечати, ЗаголовокПечатнойФормы)
	...
	ИмяМакета = "ПечатныйБланк2023Кв3_Реестр";
...
Процедура Проверить(Команда)
	...
	Если Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) > 2024 Тогда
		...
		"ru = 'Проверка контрольных соотношений для 2025 и более поздних 
		| календарных годов будет реализована в будущих версиях программы';
		|en = 'Проверка контрольных соотношений для 2025 и более поздних 
		| календарных годов будет реализована в будущих версиях программы'"));
	...
	ДополнительныеПараметры.Вставить("ИмяФормы"			, "ФормаОтчета2023Кв3"); 
...
Функция ВыполнитьДокументированиеНаСервере()
	...
	ДополнительныеПараметры = Новый Структура;
	ДополнительныеПараметры.Вставить("НаименованиеФормы", "2023Кв3");
	
	Если Год(ТекущаяДата()) >= 2024 Тогда
		Возврат ОбъектОтчета.ВыполнитьДокументированиеОбъект2024(ДополнительныеПараметры);
	Иначе
...
Функция ВыполнитьПоискКопийРеглОтчетовНаСервере(ДополнительныеПараметры)
	...
	|			ИЛИ Документ.ВыбраннаяФорма = ""ФормаОтчета2023Кв3"")
...
Процедура АктивизироватьЯчейку(Ячейка) Экспорт
	...
	Если Ячейка.Раздел = "Раздел1" ИЛИ Ячейка.Раздел = "Раздел1Подр2" ИЛИ Ячейка.Раздел = "Раздел1Подр3"
		...
		ИЛИ Ячейка.Раздел = "Раздел1Прил4" ИЛИ Ячейка.Раздел = "Раздел1Прил5" ИЛИ Ячейка.Раздел = "Раздел2"
		ИЛИ Ячейка.Раздел = "Раздел4" ИЛИ Ячейка.Раздел = "Раздел4Подр1" ИЛИ Ячейка.Раздел = "Раздел4Прил1" Тогда
		Для каждого НайденныйРаздел Из РазделыОтчета.ПолучитьЭлементы() Цикл
			...
			КонецЕсли;
		КонецЦикла;
	ИначеЕсли Ячейка.Раздел = "Раздел1Подр1" ИЛИ Ячейка.Раздел = "Раздел1Подр4"
		ИЛИ Ячейка.Раздел = "Раздел2Подр1" ИЛИ Ячейка.Раздел = "Раздел3" Тогда
		Для каждого НайденныйРаздел Из РазделыОтчета.ПолучитьЭлементы() Цикл
			Если НайденныйРаздел.КолонкаРазделыОтчетаСокрНаим = Ячейка.Раздел Тогда
