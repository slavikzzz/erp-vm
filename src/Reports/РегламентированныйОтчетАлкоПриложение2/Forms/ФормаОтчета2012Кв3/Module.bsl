...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000110", "П000010000105;П000010000106;П000010000107;П000010000108;П000010000109");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000119", "П000010000111;П000010000112;П000010000113;П000010000114;П000010000115;П000010000116;П000010000117;П000010000118");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000120", "П000010000104;П000010000105;П000010000106;П000010000107;П000010000108;П000010000109;П000010000111;П000010000112;П000010000113;П000010000114;П000010000115;П000010000116;П000010000117;П000010000118");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000210", "П000010000105;П000010000106;П000010000107;П000010000108;П000010000109");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000219", "П000010000111;П000010000112;П000010000113;П000010000114;П000010000115;П000010000116;П000010000117;П000010000118");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000220", "П000010000104;П000010000105;П000010000106;П000010000107;П000010000108;П000010000109;П000010000111;П000010000112;П000010000113;П000010000114;П000010000115;П000010000116;П000010000117;П000010000118");
	
	//Многострочная часть 2
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000310", "П000010000305;П000010000306;П000010000307;П000010000308;П000010000309");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000319", "П000010000311;П000010000312;П000010000313;П000010000314;П000010000315;П000010000316;П000010000317;П000010000318");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000320", "П000010000304;П000010000305;П000010000306;П000010000307;П000010000308;П000010000309;П000010000311;П000010000312;П000010000313;П000010000314;П000010000315;П000010000316;П000010000317;П000010000318");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000410", "П000010000305;П000010000306;П000010000307;П000010000308;П000010000309");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000419", "П000010000311;П000010000312;П000010000313;П000010000314;П000010000315;П000010000316;П000010000317;П000010000318");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000010000420", "П000010000304;П000010000305;П000010000306;П000010000307;П000010000308;П000010000309;П000010000311;П000010000312;П000010000313;П000010000314;П000010000315;П000010000316;П000010000317;П000010000318");
...
Процедура УстановитьДоступностьПолейДекларация(Форма)
	...
	Пока Форма.ТабличныйДокумент.Области.Найти("П000010000101_" + Постфикс) <> Неопределено Цикл
		...
		УстановитьЦветФонаЯчейки(Форма, "П000010000120_" + Постфикс, ВариантАвторасчета,  "Декларация");
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) Тогда
			...
			Для Инд = 1 По КоличествоСтрок Цикл
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000110, ОбластьИмя) > 0 Тогда   
					...
					ЗначениеГрафы10 = Графа05 + Графа06 + Графа07 + Графа08 + Графа09 ;
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000119, ОбластьИмя) > 0 Тогда
					...
					ЗначениеГрафы19 = Графа11 + Графа12 + Графа13 + Графа14 + Графа15 + Графа16 + Графа17 + Графа18;
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000120, ОбластьИмя) > 0 Тогда
					...
					ЗначениеГрафы20 = Графа04 + Графа10 - Графа19;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100001" + "20" + ПостфиксСтроки, ЗначениеГрафы20);
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) Тогда
			...
			Для Инд = 1 По КоличествоСтрок Цикл
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000010000320, ОбластьИмя) > 0 Тогда
					...
					ЗначениеГрафы20 = Графа04 + Графа10 - Графа19;
					ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П0000100003" + "20" + ПостфиксСтроки, ЗначениеГрафы20);
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Если ИмяОбласти = "ЗаявлениеОКорректировкеПредставление" Тогда
		...
		Иначе
			...
			ПараметрыФормы.Вставить("НомерПриложения",          "2");
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель, КорневойУзел, Параметры)
	...
	ПрототипУзла_ОбъемИспользования = ПолучитьПодчиненныйЭлемент(Узел_Документ, "ОбъемИспользования");
	...
	Для Каждого Страница Из мДанныеОтчета.Декларация Цикл
		...
		Узел_ОбъемИспользования = НовыйУзелИзПрототипа(ПрототипУзла_ОбъемИспользования);
		УстановитьЗначениеЭлемента(Узел_ОбъемИспользования, "НаимЮЛ", НазваниеОрганизации);
		УстановитьЗначениеЭлемента(Узел_ОбъемИспользования, "КППЮЛ", КПП);
		
		Узел_АдрОрг = ПолучитьПодчиненныйЭлемент(Узел_ОбъемИспользования, "АдрОрг");
		...
		ЗаполнитьСведенияПоСтранице(Страница, Узел_ОбъемИспользования);
		
		Узел_Использование = ПолучитьПодчиненныйЭлемент(Узел_ОбъемИспользования, "Использование");
		ЕстьИспользование = (Узел_Использование <> Неопределено);
		УстановитьЗначениеЭлемента(Узел_ОбъемИспользования, "НаличиеИспользования", ?(ЕстьИспользование, "true", "false"));
		
	КонецЦикла;
	РегламентированнаяОтчетность.УдалитьУзел(ПрототипУзла_ОбъемИспользования);
...
Процедура ЗаполнитьСведенияПоСтранице(Страница, УзелСведений)
	...
	ПрототипУзла_Использование = ПолучитьПодчиненныйЭлемент(УзелСведений, "Использование");
	
	ТаблицаПродукции = ДанныеДопСтрок[СтруктураРеквизитовФормы.мИдГруппы2].Выгрузить();
	
	НомерПП_Использование = 0;
	Для Каждого Продукция Из ТаблицаПродукции Цикл
		Если ПустаяСтрока(Продукция.П000010000303) Тогда
			Продолжить;
		КонецЕсли;
		
		Узел_Использование = НовыйУзелИзПрототипа(ПрототипУзла_Использование);
		
		НомерПП_Использование = НомерПП_Использование + 1;
		УстановитьЗначениеЭлемента(Узел_Использование, "ПN", НомерПП_Использование);
		
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000003", Продукция.П000010000303);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000004", Продукция.П000010000302);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000005", Продукция.П000010000304);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000006", Продукция.П000010000305);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000007", Продукция.П000010000306);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000008", Продукция.П000010000307);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000009", Продукция.П000010000308);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000010", Продукция.П000010000309);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000011", Продукция.П000010000310);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000012", Продукция.П000010000311);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000013", Продукция.П000010000312);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000014", Продукция.П000010000313);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000015", Продукция.П000010000314);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000016", Продукция.П000010000315);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000017", Продукция.П000010000316);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000018", Продукция.П000010000317);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000019", Продукция.П000010000318);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000020", Продукция.П000010000319);
		УстановитьЗначениеЭлемента(Узел_Использование, "П000000000021", Продукция.П000010000320);
		
	КонецЦикла;
	РегламентированнаяОтчетность.УдалитьУзел(ПрототипУзла_Использование);
