...
Процедура СформироватьСпискиВыбора()
		...
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Строки Тогда
			...
			Для НомСтр = ВерхОбласти По НизОбласти Цикл
				...
				Если КодПоказателя <> "###" Тогда
					...
					Если Область.Имя = "Периоды" Тогда
						Если СтруктураРеквизитовФормы.мПериодичность = Перечисления.Периодичность.Месяц
							И ЗначениеЗаполнено(МакетСоставаПоказателей.Область(НомСтр, 3).Текст)
							И (Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета)
							<> Число(СокрП(МакетСоставаПоказателей.Область(НомСтр, 3).Текст))) Тогда
							
							Продолжить;
							
						КонецЕсли;
						
					ИначеЕсли КодПоказателя = "473" И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20200101'
						И (Область.Имя = "КодыВидаПодакцизныхТоваров_1151074" ИЛИ Область.Имя = "КодыВидаПодакцизныхТоваров") Тогда
						
						Продолжить;
						
					ИначеЕсли КодПоказателя = "679" И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20200401'
						И (Область.Имя = "КодыВидаПодакцизныхТоваров_1151089" ИЛИ Область.Имя = "КодыВидаПодакцизныхТоваров") Тогда
	...
	Если Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) >= 2025 Тогда
		...
		ИмяСекции_КодыВидаПодакцизныхТоваров = "КодыВидаПодакцизныхТоваров_20250101";
		ИмяСекции_КодыВидаПодакцизныхТоваров_1151074 = "КодыВидаПодакцизныхТоваров_1151074_20250101";
		ИмяСекции_КодыВидаПодакцизныхТоваров_1151089 = "КодыВидаПодакцизныхТоваров_1151089_20250101";
		ИмяСекции_КодыВидаПодакцизныхТоваров_1151090 = "КодыВидаПодакцизныхТоваров_1151090_20250101";
		
		ИмяСекции_КодыОКЕИ = "КодыОКЕИ_20250101";
		ИмяСекции_КодыОКЕИ_1151074 = "КодыОКЕИ_1151074_20250101";
		ИмяСекции_КодыОКЕИ_1151089 = "КодыОКЕИ_1151089_20250101";
		ИмяСекции_КодыОКЕИ_1151090 = "КодыОКЕИ_1151090_20250101";
		
	Иначе
		
		ИмяСекции_КодыВидаПодакцизныхТоваров = "КодыВидаПодакцизныхТоваров";
		ИмяСекции_КодыВидаПодакцизныхТоваров_1151074 = "КодыВидаПодакцизныхТоваров_1151074";
		ИмяСекции_КодыВидаПодакцизныхТоваров_1151089 = "КодыВидаПодакцизныхТоваров_1151089";
		ИмяСекции_КодыВидаПодакцизныхТоваров_1151090 = "КодыВидаПодакцизныхТоваров_1151090";
		
		ИмяСекции_КодыОКЕИ = "КодыОКЕИ";
		ИмяСекции_КодыОКЕИ_1151074 = "КодыОКЕИ_1151074";
		ИмяСекции_КодыОКЕИ_1151089 = "КодыОКЕИ_1151089";
		ИмяСекции_КодыОКЕИ_1151090 = "КодыОКЕИ_1151090";
		
	КонецЕсли;
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000002", 3, ,
		"Выбор кода вида подакцизного товара", КоллекцияСписковВыбора[ИмяСекции_КодыВидаПодакцизныхТоваров]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000002_1151074", 3, ,
		"Выбор кода вида подакцизного товара", КоллекцияСписковВыбора[ИмяСекции_КодыВидаПодакцизныхТоваров_1151074]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000002_1151089", 3, ,
		"Выбор кода вида подакцизного товара", КоллекцияСписковВыбора[ИмяСекции_КодыВидаПодакцизныхТоваров_1151089]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000002_1151090", 3, ,
		"Выбор кода вида подакцизного товара", КоллекцияСписковВыбора[ИмяСекции_КодыВидаПодакцизныхТоваров_1151090]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000005", 0, ,
		"Выбор кода единицы измерения", КоллекцияСписковВыбора[ИмяСекции_КодыОКЕИ]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000005_1151074", 0, ,
		"Выбор кода единицы измерения", КоллекцияСписковВыбора[ИмяСекции_КодыОКЕИ_1151074]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000005_1151089", 0, ,
		"Выбор кода единицы измерения", КоллекцияСписковВыбора[ИмяСекции_КодыОКЕИ_1151089]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000005_1151090", 0, ,
		"Выбор кода единицы измерения", КоллекцияСписковВыбора[ИмяСекции_КодыОКЕИ_1151090]);
	...
	Иначе
		...
		Если СтрНачинаетсяС(Область.Имя, "П1000002_") Тогда
			...
			Если КодДекларации = "1151074"
				...
				ЭтотОбъект, "П1000002_" + КодДекларации);
			КонецЕсли;
		ИначеЕсли СтрНачинаетсяС(Область.Имя, "П1000005_") Тогда
			...
			Если КодДекларации = "1151074"
				...
				ИЛИ КодДекларации = "1151090" Тогда
				ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(
				ЭтотОбъект, "П1000005_" + КодДекларации);
			КонецЕсли;
		КонецЕсли;
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если СтрНачинаетсяС(ИмяПоказателя, "П1000002_") Тогда
		ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "П1000002");
		Если ПараметрВводаПоля <> Неопределено И ПараметрВводаПоля.ТаблицаЗначений.Количество() > 0 Тогда
			...
			Если ВРег(Прав(СтруктураРеквизитовФормы.СведенияВыгрузкиДекларации["ИмяФайлаВыгрузкиДекларации"], 8)) = "NNNNNNNN" Тогда
				...
				Если ЗначениеЗаполнено(ТабличныйДокумент.Область("ИндексВИмениФайлаВыгрузкиДекларации").Значение) Тогда
					...
					Сообщение.Текст = НСтр("ru = 'Установлено значение индекса последнего выгруженного файла в версии формата 3.00 по данным информационной базы. В случае, если оно не соответствует индексу из имени файла ранее переданного в ФНС электронного представления декларации по акцизам, его необходимо отредактировать.';
											|en = 'Установлено значение индекса последнего выгруженного файла в версии формата 3.00 по данным информационной базы. В случае, если оно не соответствует индексу из имени файла ранее переданного в ФНС электронного представления декларации по акцизам, его необходимо отредактировать.'");
					Сообщение.Сообщить();
				КонецЕсли;
			КонецЕсли;
		КонецЕсли;
...
Процедура ПереопределитьЗначенияСвойствЯчеекТабличногоДокумента(ИмяРаздела)
	...
	Если ИмяРаздела = "Реестр" Тогда
		...
		Для каждого Обл Из ТабличныйДокумент.Области Цикл
			...
			ИмяГруппы = МногострочнаяЧастьТекущейОбласти(ЭтотОбъект, Обл.Имя);
...
Функция СравнениеОтчетовНаСервере(ДанныеДляСравнения)
	...
	ДеревьяДляСравнения.Вставить("ДеревоСравненияРеестра",  ИзвлечьСтруктуруXML("СхемаВыгрузки503_2020Кв1_1"));
	ДеревьяДляСравнения.Вставить("ДеревоСравненияСведений", ИзвлечьСтруктуруXML("СхемаВыгрузки503_2020Кв1_2"));
...
Функция ЗагрузкаОтчетаИзФайлаНаСервере(ДанныеДляЗагрузки)
	...
	ДеревьяДляЗагрузки.Вставить("ДеревоЗагрузкиРеестра",  ИзвлечьСтруктуруXML("СхемаВыгрузки503_2020Кв1_1"));
	ДеревьяДляЗагрузки.Вставить("ДеревоЗагрузкиСведений", ИзвлечьСтруктуруXML("СхемаВыгрузки503_2020Кв1_2"));
...
Функция УниверсальнаяВыгрузкаXMLНаСервере(ТекстВыгрузки, ПараметрыВыгрузки)
	...
	ДеревоВыгрузкиРеестра  = ИзвлечьСтруктуруXML("СхемаВыгрузки503_2020Кв1_1");
	ДеревоВыгрузкиСведений = ИзвлечьСтруктуруXML("СхемаВыгрузки503_2020Кв1_2");
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ИмяКлючевогоУзлаСодержательнойЧасти", "РеестрТД_3.7.198");
	
	ПараметрыВыгрузки.Вставить("ИдФайл", ИдентификаторФайлаВыгрузки(ПараметрыВыгрузки, "KO_RR198.7.3TD"));
	
	ПараметрыВыгрузки.Вставить("ИдСведФайл", ИдентификаторФайлаВыгрузки(ПараметрыВыгрузки, "KO_RR198.7.3TD.2"));
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузкиРеестра, ДеревоВыгрузкиСведений)
	...
	Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.ПериодОтч) Тогда
		...
		СтатусПроверки = Ложь;
	Иначе
		ВозмКодыПериода = ВозможныеЗначенияИзСпискаВыбораПоказателя("Период");
		Если ВозмКодыПериода.МассивЗначений.Найти(ПараметрыВыгрузки.ПериодОтч) = Неопределено Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект,
		...
		ИначеЕсли НЕ ПараметрыВыгрузки.ЭтоПБОЮЛ И ЗначениеЗаполнено(ПараметрыВыгрузки.КодФормРеорг)
			И НЕ (Лев(ПараметрыВыгрузки.ПериодОтч, 1) = "7" ИЛИ Лев(ПараметрыВыгрузки.ПериодОтч, 1) = "8"
			ИЛИ Лев(ПараметрыВыгрузки.ПериодОтч, 1) = "B" ИЛИ Лев(ПараметрыВыгрузки.ПериодОтч, 1) = "D") Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект,
		...
		ИначеЕсли НЕ ПараметрыВыгрузки.ЭтоПБОЮЛ И НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.КодФормРеорг)
			И НЕ (Лев(ПараметрыВыгрузки.ПериодОтч, 1) = "0" ИЛИ Лев(ПараметрыВыгрузки.ПериодОтч, 1) = "1"
			ИЛИ Лев(ПараметрыВыгрузки.ПериодОтч, 1) = "A" ИЛИ Лев(ПараметрыВыгрузки.ПериодОтч, 1) = "C") Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект,
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель)
	...
	РеестрТД_3_7_198 = ПолучитьПодчиненныйЭлемент(УзелРодитель.Родитель, "РеестрТД_3.7.198");
	...
	Для каждого ЭлемСтруктуры Из УпорядоченныеДанныеДерева Цикл
		...
		ЭкзРеестрТД_3_7_198 = СкопироватьУзел(УзелРодитель.Родитель, РеестрТД_3_7_198);
		Для каждого Эл Из ЭкзРеестрТД_3_7_198.Строки Цикл
		...
		СведОпер = ПолучитьПодчиненныйЭлемент(ЭкзРеестрТД_3_7_198, "СведОпер");
		Если СведОпер = Неопределено Тогда
			РегламентированнаяОтчетность.УдалитьУзел(РеестрТД_3_7_198);
			Продолжить;
		КонецЕсли;
		...
		Для каждого ИндексВетки Из МассивУпорядоченныхДанных Цикл
			...
			Для каждого Ветка_П10000 Из ДанныеМнЧ_П10000 Цикл
				...
				ЭкзСведОпер = СкопироватьУзел(ЭкзРеестрТД_3_7_198, СведОпер, ЭкзРеестрТД_3_7_198.Строки.Количество() - 1);
...
Функция ВыгрузкаРеестра(ТекстВыгрузки, ПараметрыВыгрузки)
	...
	РезультатВыгрузки.Вставить("ТипФайлаВыгрузки", "РеестрАкцизы_1");
...
Функция ВыгрузкаСведений(ТекстВыгрузки, ПараметрыВыгрузки)
	...
	РезультатВыгрузки.Вставить("АдресФайлаВыгрузки", АдресВоВремХранилище);
	РезультатВыгрузки.Вставить("ТипФайлаВыгрузки", "РеестрАкцизы_1_Сведения");
	РезультатВыгрузки.Вставить("КодировкаФайлаВыгрузки", КодировкаФайлаВыгрузки);
...
Процедура ВывестиНаПечатьОтчет(СтруктураПараметров, ВыбранныеСтраницы, СтрПоля = Неопределено)
	...
	Если ВыбранныеСтраницы.Найти("Титульный") <> Неопределено Тогда
		...
		ИмяМакета = "ПечатныйБланк2020Кв1_Титульный";
