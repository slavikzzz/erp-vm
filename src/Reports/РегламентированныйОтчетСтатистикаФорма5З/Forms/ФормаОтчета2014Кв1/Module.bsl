...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "05/10/2013";
...
Процедура ВосстановитьСохраненныеДанные()
	...
	Если ВерсияФормы = "04/10/2013" Тогда
		СтруктураРеквизитовФормы.ЕдиницаИзмерения         = ПорядкиОкругленияОтчетности.ПеречислениеПорядкиОкругленияОтчетностиОкр1;
		СтруктураРеквизитовФормы.ТочностьЕдиницыИзмерения = 0;
	КонецЕсли;
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П02007401", "П02007501;П02007601;");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П02007402", "П02007502;П02007602;");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П02007403", "П02007503;П02007603;");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П02007404", "П02007504;П02007604;");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П01007103", "П01000103;П01000203;П01000303;П01000403;П01000503;П01000603;П01000703;П01000803;П01000903;П01001003;П01001103;П01001203;П01001303;П01001403;П01001503;П01001603;П01001703;П01001803;П01001903;П01002003;П01002103;П01002203;П01002303;П01002403;П01002503;П01002603;П01002703;П01002803;П01002903;П01003003;П01003103;П01003203;П01003303;П01003403;П01003503;П01003603;П01003703;П01003803;П01003903;П01004003;П01004103;П01004203;П01004303;П01004403;П01004503;П01004603;П01004703;П01004803;П01004903;П01005003;П01005103;П01005203;П01005303;П01005403;П01005503;П01005903;П01006103;П01006203;П01006303;П01006403;П01006503;П01006603;П01006703;П01006803;П01006903;П01007003;");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П01007104", "П01000104;П01000204;П01000304;П01000404;П01000504;П01000604;П01000704;П01000804;П01000904;П01001004;П01001104;П01001204;П01001304;П01001404;П01001504;П01001604;П01001704;П01001804;П01001904;П01002004;П01002104;П01002204;П01002304;П01002404;П01002504;П01002604;П01002704;П01002804;П01002904;П01003004;П01003104;П01003204;П01003304;П01003404;П01003504;П01003604;П01003704;П01003804;П01003904;П01004004;П01004104;П01004204;П01004304;П01004404;П01004504;П01004604;П01004704;П01004804;П01004904;П01005004;П01005104;П01005204;П01005304;П01005404;П01005504;П01005904;П01006104;П01006204;П01006304;П01006404;П01006504;П01006604;П01006704;П01006804;П01006904;П01007004;");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П02007801", "П02007201;П02007301;П02007401;П02007501;П02007601;П02007701;");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П02007802", "П02007202;П02007302;П02007402;П02007502;П02007602;П02007702;");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П02007803", "П02007203;П02007303;П02007403;П02007503;П02007603;П02007703;");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П02007804", "П02007204;П02007304;П02007404;П02007504;П02007604;П02007704;");
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П02007401, ОбластьИмя) > 0 Тогда
		мФормаОтчета.Области.П02007401.Значение = мФормаОтчета.Области.П02007501.Значение + мФормаОтчета.Области.П02007601.Значение;
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П02007402, ОбластьИмя) > 0 Тогда
		мФормаОтчета.Области.П02007402.Значение = мФормаОтчета.Области.П02007502.Значение + мФормаОтчета.Области.П02007602.Значение;
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П02007403, ОбластьИмя) > 0 Тогда
		мФормаОтчета.Области.П02007403.Значение = мФормаОтчета.Области.П02007503.Значение + мФормаОтчета.Области.П02007603.Значение;
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П02007404, ОбластьИмя) > 0 Тогда
		мФормаОтчета.Области.П02007404.Значение = мФормаОтчета.Области.П02007504.Значение + мФормаОтчета.Области.П02007604.Значение;
	КонецЕсли;
	
	
	Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П01007103, ОбластьИмя) > 0 Тогда
		мФормаОтчета.Области.П01007103.Значение = 0;
		Для Инд = 1 По 70 Цикл
			// Пропустить неиспользуемые строки
			Если (Инд >= 56 И Инд <= 58) Или (Инд = 60) Тогда
				Продолжить;
			КонецЕсли;
			НомСтр = ?(Инд < 10, "0" + Строка(Инд), Строка(Инд));
			мФормаОтчета.Области.П01007103.Значение = мФормаОтчета.Области.П01007103.Значение + мФормаОтчета.Область("П0100" + НомСтр + "03").Значение;
		КонецЦикла;
	КонецЕсли;
	
	Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П01007104, ОбластьИмя) > 0 Тогда
		мФормаОтчета.Области.П01007104.Значение = 0;
		Для Инд = 1 По 70 Цикл
			// Пропустить неиспользуемые строки
			Если (Инд >= 56 И Инд <= 58) Или (Инд = 60) Тогда
				Продолжить;
			КонецЕсли;
			НомСтр = ?(Инд < 10, "0" + Строка(Инд), Строка(Инд));
			мФормаОтчета.Области.П01007104.Значение = мФормаОтчета.Области.П01007104.Значение + мФормаОтчета.Область("П0100" + НомСтр + "04").Значение;
		КонецЦикла;
	КонецЕсли;
	
	
	Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П02007801, ОбластьИмя) > 0 Тогда
		мФормаОтчета.Области.П02007801.Значение = 0;
		Для Инд = 72 По 77 Цикл
			мФормаОтчета.Области.П02007801.Значение = мФормаОтчета.Области.П02007801.Значение + мФормаОтчета.Область("П0200" + Инд + "01").Значение;
		КонецЦикла;
	КонецЕсли;
	
	Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П02007802, ОбластьИмя) > 0 Тогда
		мФормаОтчета.Области.П02007802.Значение = 0;
		Для Инд = 72 По 77 Цикл
			мФормаОтчета.Области.П02007802.Значение = мФормаОтчета.Области.П02007802.Значение + мФормаОтчета.Область("П0200" + Инд + "02").Значение;
		КонецЦикла;
	КонецЕсли;
	
	Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П02007803, ОбластьИмя) > 0 Тогда
		мФормаОтчета.Области.П02007803.Значение = 0;
		Для Инд = 72 По 77 Цикл
			мФормаОтчета.Области.П02007803.Значение = мФормаОтчета.Области.П02007803.Значение + мФормаОтчета.Область("П0200" + Инд + "03").Значение;
		КонецЦикла;
	КонецЕсли;
	
	Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П02007804, ОбластьИмя) > 0 Тогда
		мФормаОтчета.Области.П02007804.Значение = 0;
		Для Инд = 72 По 77 Цикл
			мФормаОтчета.Области.П02007804.Значение = мФормаОтчета.Области.П02007804.Значение + мФормаОтчета.Область("П0200" + Инд + "04").Значение;
		КонецЦикла;
	КонецЕсли;
