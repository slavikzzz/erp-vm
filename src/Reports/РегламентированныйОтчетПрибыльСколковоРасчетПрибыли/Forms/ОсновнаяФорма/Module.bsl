...
Процедура ПоказатьПериод(Форма)
	...
	ГодПериода = Год(Форма.мДатаКонцаПериодаОтчета);
	ФормаУтратилаСилу = ГодПериода >= 2019;
	...
	Иначе
		...
		НСтр("ru = 'Утратила силу (приказ Минфина от 28.05.2019 № 79н). С отчетности за 2019 г. применяется новая форма ""Расчет совокупного размера прибыли"".';
			|en = 'Утратила силу (приказ Минфина от 28.05.2019 № 79н). С отчетности за 2019 г. применяется новая форма ""Расчет совокупного размера прибыли"".'"),
...
Процедура ВыбратьФорму(Команда)
	...
	ДопТекстОписания = НСтр("ru = 'Расчет совокупного размера прибыли (убытка) участника проекта ""Сколково"" представляют организации.';
							|en = 'Расчет совокупного размера прибыли (убытка) участника проекта ""Сколково"" представляют организации.'");
...
Функция ДоступныеОрганизацииОтсутствуютТекст()
	...
	|en = 'Расчет совокупного размера прибыли (убытка) участника проекта ""Сколково"" представляют только организации.
	|В справочнике ""Организации"" сведения об организациях отсутствуют.'");
