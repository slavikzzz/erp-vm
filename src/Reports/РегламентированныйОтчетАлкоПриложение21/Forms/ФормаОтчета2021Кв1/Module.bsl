...
Процедура УстановитьПараметрыДекларации() Экспорт
	...
	СписокИдГруппОтчета.Добавить("П0000100003", "мИдГруппы12"); // Раздел 2 Таблица 2.	
	СписокИдГруппОтчета.Добавить("П0000200003", "мИдГруппы22"); // Раздел 3 Таблица 2.
	...
	СписокИдГруппРаздела.Добавить(СтруктураРеквизитовФормы.мИдГруппы12, "Раздел 1 (Поставки)");
	СписокИдГруппРаздела.Добавить(СтруктураРеквизитовФормы.мИдГруппы22, "Раздел 2 (Возвраты)");
