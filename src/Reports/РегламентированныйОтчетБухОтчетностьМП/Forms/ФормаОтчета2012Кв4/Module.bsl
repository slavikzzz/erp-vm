...
Процедура ВидДокументаПредставлениеПриИзменении(Элемент)
	...
	РегламентированнаяОтчетностьКлиент.ПриИзмененииВидаДокументаИКорректировки(ЭтотОбъект);
...
Процедура ОчиститьТекущуюСтраницу(Команда)
	...
	ТекстВопроса = НСтр("ru = 'Внимание! Будут очищены все показатели текущего отчета.%1Продолжить операцию?';
						|en = 'Внимание! Будут очищены все показатели текущего отчета.%1Продолжить операцию?'");
...
Функция РазделыОтчетаСДанными()
	...
	Возврат СтрРазделить("Баланс,ОПУ", ",", Ложь);
...
&НаКлиенте
Процедура СформироватьНастройкиФормыВыбораПечати()
...
Процедура ВывестиНаПечатьЛист(ПараметрыПечати)
	...
	РегламентированнаяОтчетность.ВывестиНаПечатьЛистОбщая(
		Заголовок, ПараметрыПечати, ТабличныйДокумент, СтруктураРеквизитовФормы.мПечатныеФормы);
...
Процедура УстановитьЦветФонаЯчейкиНаСервере(ИмяЯчейки = Неопределено, ВариантЗаполнения = Неопределено, ИмяТекущейСтраницыПанели = "") Экспорт
	...
	РегламентированнаяОтчетностьКлиентСервер.УстановитьЦветФонаЯчейки(ЭтотОбъект, , , ИмяТекущейСтраницыПанели);
...
Процедура ОткрытьФормуВыбораСтраниц()
	...
	ПараметрыВыбора.Вставить("ОтключитьАвтоРасчет", Ложь);
