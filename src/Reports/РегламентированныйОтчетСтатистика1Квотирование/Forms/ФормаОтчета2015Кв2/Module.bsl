...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "03/09/2015";
	...
	ПолеТабличногоДокументаФормаОтчета.Вывести(ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("ФормаОтчета2015Кв2_ФормаОтчета"));
...
Процедура Расчет(Форма)
	...
	Если Области.П000010001003.Значение = Области.П000010001004.Значение Тогда 
		Области.П000010004003.Значение = 4*Области.П000010001003.Значение/100;
	...
	ИначеЕсли Области.П000010001003.Значение > Области.П000010001004.Значение Тогда 
		Области.П000010004005.Значение = 2*Области.П000010001003.Значение/100;
		Области.П000010004004.Значение = 2*Области.П000010001004.Значение/100;
	...
	Если Области.П000010002003.Значение = Области.П000010002004.Значение Тогда 
		Области.П000010005003.Значение = 4*Области.П000010002003.Значение/100;
	...
	ИначеЕсли Области.П000010002003.Значение > Области.П000010002004.Значение Тогда 
		Области.П000010005005.Значение = 2*Области.П000010002003.Значение/100;
		Области.П000010005004.Значение = 2*Области.П000010002004.Значение/100;
	...
	Если Области.П000010003003.Значение = Области.П000010003004.Значение Тогда 
		Области.П000010006003.Значение = 4*Области.П000010003003.Значение/100;
	...
	ИначеЕсли Области.П000010003003.Значение > Области.П000010003004.Значение Тогда 
		Области.П000010006005.Значение = 2*Области.П000010003003.Значение/100;
		Области.П000010006004.Значение = 2*Области.П000010003004.Значение/100;
	...
	// Раздел II.
	// строки 14 - 17
	Области.П000010014003.Значение = Области.П000010014004.Значение + Области.П000010014005.Значение;
	Области.П000010015003.Значение = Области.П000010015004.Значение + Области.П000010015005.Значение;
	...
	// Раздел Справочно
	// Справка 1
	Области.П000010118003.Значение = Области.П000010118004.Значение + Области.П000010118005.Значение;
	
	// Раздел III
	// строка 18
	Если Области.П000010018004.Значение > 0 Тогда
		Области.П000010021004.Значение = 0;
		Области.П000010021004.ЦветФона = Форма.СтруктураРеквизитовФормы.мЦветБелый;
		Области.П000010021004.Защита = Истина;
	Иначе
		Области.П000010021004.ЦветФона = Форма.СтруктураРеквизитовФормы.мЦветЖелтый;
		Области.П000010021004.Защита = Ложь;
	КонецЕсли;
	
	// контроль диапазона значений
	Области.П000010019004.Значение = Мин(Области.П000010018004.Значение, Макс(Области.П000010019004.Значение, 0));
	Области.П000010020004.Значение = Мин(Области.П000010018004.Значение - Области.П000010019004.Значение, Области.П000010020004.Значение);
	
	// Раздел IV
	// Начислена обязательная плата
	// по месяцам квартала
	Области.П000010023003.Значение = Области.П000010011003.Значение;
	Области.П000010024003.Значение = Области.П000010012003.Значение;
	Области.П000010025003.Значение = Области.П000010013003.Значение;
	
	// строка 22
	Области.П000010022003.Значение = Области.П000010010003.Значение;
	Области.П000010022004.Значение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Области.П000010023004.Значение) + РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Области.П000010024004.Значение) + РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Области.П000010025004.Значение);
	
	// строка 28
	// Всего причитается к платежу 
	Области.П000010028004.Значение = Области.П000010018004.Значение - Области.П000010021004.Значение + Области.П000010022004.Значение + Области.П000010026004.Значение + Области.П000010027004.Значение;
	
	// строка 30
	// В том числе: административные штрафы 
	Области.П000010030004.Значение = Мин(Области.П000010029004.Значение, Области.П000010030004.Значение);
	
	// строка 31
	// Остаток неуплаты на конец отчетного квартала
	Области.П000010031004.Значение = Макс(Области.П000010028004.Значение - Области.П000010029004.Значение, 0);
	
	Переплата = Области.П000010029004.Значение - Области.П000010028004.Значение;
	
	// строка 31
	Если Области.П000010031004.Значение > 0 Тогда
		Области.П000010034004.Значение = 0;
	Иначе
		Области.П000010034004.Значение = Переплата;
	КонецЕсли;
	
	// контроль диапазона значений
	Области.П000010032004.Значение = Мин(Области.П000010031004.Значение, Макс(Области.П000010032004.Значение, 0));
	Области.П000010033004.Значение = Мин(Области.П000010031004.Значение - Области.П000010032004.Значение, Области.П000010033004.Значение);
