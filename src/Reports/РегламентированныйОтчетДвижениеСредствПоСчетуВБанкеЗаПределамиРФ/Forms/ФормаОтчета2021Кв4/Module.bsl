...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	СтруктураРеквизитовФормы.Вставить("мИдГруппыЛ9М1");
	СтруктураРеквизитовФормы.Вставить("мИдГруппыЛ10М1");
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.дв.ден.б.за пр.21к4") Тогда
...
Процедура ИнициализироватьМногострочныеЧасти()
	...
	СтруктураРеквизитовФормы.мИдГруппыЛ9М1  = "П000Л9М1";
	СтруктураРеквизитовФормы.мИдГруппыЛ10М1 = "П00Л10М1";
	...
	// Группа П000Л9М1.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П000Л9М100001");
	ИменаГраф.Добавить("П000Л9М100002");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(СтруктураРеквизитовФормы.мИдГруппыЛ9М1, Новый Структура(
	"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп", ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
	
	// Группа П00Л10М1.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П00Л10М100001");
	ИменаГраф.Добавить("П00Л10М100002");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(СтруктураРеквизитовФормы.мИдГруппыЛ10М1, Новый Структура(
	"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп", ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
...
Процедура ИнициализироватьМногоуровневыеРазделы()
	...
	мСтруктураМногоуровневыхРазделов.Вставить("Лист2", СтруктураРаздела);
	...
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппыЛ5М1);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	мСтруктураМногоуровневыхРазделов.Вставить("Листы3_5", СтруктураРаздела);
	
	СтруктураРаздела = Новый Структура;
	СтруктураРаздела.Вставить("Многостраничность");
	мСтруктураМногоуровневыхРазделов.Вставить("Лист6", СтруктураРаздела);
	
	СтруктураРаздела = Новый Структура;
	мСтруктураМногоуровневыхРазделов.Вставить("Лист7", СтруктураРаздела);
	
	СтруктураРаздела = Новый Структура;
	СтруктураРаздела.Вставить("Многостраничность");
	ИменаГруппМнЧ = Новый Массив;
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппыЛ9М1);
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппыЛ10М1);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	мСтруктураМногоуровневыхРазделов.Вставить("Листы8_10", СтруктураРаздела);
...
Процедура ФормироватьСтруктуруСтраницОтчета() Экспорт
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы        = "Листы3_5";
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы        = "Лист6";
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы        = "Лист7";
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы        = "Листы8_10";
...
Процедура СформироватьСпискиВыбора()
	...
	//Лист 6.
	//
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000Л6ВФА0001", 1, ,
	"Выбор вида иного финансового актива", КоллекцияСписковВыбора["ПризнакиОтсутствияПрисутствия"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000Л6ВФА0002", 1, ,
	"Выбор вида иного финансового актива", КоллекцияСписковВыбора["ПризнакиОтсутствияПрисутствия"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000Л6ВФА0003", 1, ,
	"Выбор вида иного финансового актива", КоллекцияСписковВыбора["ПризнакиОтсутствияПрисутствия"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000Л6ВФА0004", 1, ,
	"Выбор вида иного финансового актива", КоллекцияСписковВыбора["ПризнакиОтсутствияПрисутствия"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000Л6ВФА0005", 1, ,
	"Выбор вида иного финансового актива", КоллекцияСписковВыбора["ПризнакиОтсутствияПрисутствия"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000Л6ВФА0006", 1, ,
	"Выбор вида иного финансового актива", КоллекцияСписковВыбора["ПризнакиОтсутствияПрисутствия"]);
	
	//Лист 7.
	//
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000Л70000003", 1, ,
	"Выбор признака организации", КоллекцияСписковВыбора["ПризнакиОрганизацииЛист7"]);
...
Процедура ЗаполнитьПериодОтчета()
	...
	ДеревоРаздела = ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхЛист7"]);
	
	ДеревоРаздела.Строки[0].Данные.Вставить("П000Л70000002",
	НачалоДня(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета));
	
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхЛист7"]
	= ПоместитьВоВременноеХранилище(ДеревоРаздела, УникальныйИдентификатор);
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Область.Имя = "КодСтраны" ИЛИ Область.Имя = "П000Л20000008" ИЛИ Область.Имя = "П000Л70000008" Тогда
	...
	ИначеЕсли Область.Имя = "П000Л30000001" ИЛИ Область.Имя = "П000Л60000001" ИЛИ Область.Имя = "П000Л80000001" Тогда
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяРаздела)
	...
	ИначеЕсли ИмяРаздела = "Листы3_5" ИЛИ ИмяРаздела = "Лист6" ИЛИ ИмяРаздела = "Листы8_10" Тогда
...
Процедура ДобавитьСтраницу(Команда)
	...
	Если ИмяРаздела = "Листы3_5" ИЛИ ИмяРаздела = "Лист6" ИЛИ ИмяРаздела = "Листы8_10" Тогда
...
Процедура УдалитьДопСтрокуНаСервере()
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Листы3_5" Тогда
		Расчет(ЭтаФорма, СтруктураРеквизитовФормы.НаимТекущегоРаздела, "П000Л30000005");
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Листы8_10" Тогда
		Расчет(ЭтаФорма, СтруктураРеквизитовФормы.НаимТекущегоРаздела, "П000Л80000005");
	КонецЕсли;
...
Процедура Расчет(Форма, ИмяРаздела = "", ОбластьИмя = "") Экспорт
	...
	Если ИмяРаздела = "Листы3_5" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				Сумма = 0;
				РегламентированнаяОтчетностьКлиентСервер.УстановитьИндекс(Индекс, ИндексСтр);
				Обл = ТДО.Найти("П000Л5М100002_" + ИндексСтр);
				Пока Обл <> Неопределено Цикл
					Сумма = Сумма + Обл.Значение;
					РегламентированнаяОтчетностьКлиентСервер.УвеличитьИндекс(Индекс, ИндексСтр);
					Обл = ТДО.Найти("П000Л5М100002_" + ИндексСтр);
				...
				ТДО["П000Л30000005"].Значение
				= ТДО["П000Л30000002"].Значение + ТДО["П000Л30000003"].Значение - ТДО["П000Л30000004"].Значение;
	...
	ИначеЕсли ИмяРаздела = "Лист6" Тогда
		
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				
				ТДО["П000Л60000005"].Значение
				= ТДО["П000Л60000002"].Значение + ТДО["П000Л60000003"].Значение - ТДО["П000Л60000004"].Значение;
	...
	ИначеЕсли ИмяРаздела = "Листы8_10" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				Сумма = 0;
				РегламентированнаяОтчетностьКлиентСервер.УстановитьИндекс(Индекс, ИндексСтр);
				Обл = ТДО.Найти("П000Л9М100002_" + ИндексСтр);
				Пока Обл <> Неопределено Цикл
					Сумма = Сумма + Обл.Значение;
					РегламентированнаяОтчетностьКлиентСервер.УвеличитьИндекс(Индекс, ИндексСтр);
					Обл = ТДО.Найти("П000Л9М100002_" + ИндексСтр);
				КонецЦикла;
				ТДО["П000Л80000003"].Значение = Сумма;
				
				Сумма = 0;
				РегламентированнаяОтчетностьКлиентСервер.УстановитьИндекс(Индекс, ИндексСтр);
				Обл = ТДО.Найти("П00Л10М100002_" + ИндексСтр);
				Пока Обл <> Неопределено Цикл
					Сумма = Сумма + Обл.Значение;
					РегламентированнаяОтчетностьКлиентСервер.УвеличитьИндекс(Индекс, ИндексСтр);
					Обл = ТДО.Найти("П00Л10М100002_" + ИндексСтр);
				КонецЦикла;
				ТДО["П000Л80000004"].Значение = Сумма;
				
				ТДО["П000Л80000005"].Значение
				= ТДО["П000Л80000002"].Значение + ТДО["П000Л80000003"].Значение - ТДО["П000Л80000004"].Значение;
...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
	...
	Если ИмяРаздела = "Листы3_5" Тогда
		...
		ИмяГруппыМнЧЛ5М1 = Форма.СтруктураРеквизитовФормы.мИдГруппыЛ5М1;
		СтруктураГруппыМнЧЛ5М1 = Форма.СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей[ИмяГруппыМнЧЛ5М1];
		ИменаГрафМнЧЛ5М1 = СтруктураГруппыМнЧЛ5М1["ИменаГраф"];
		
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			
			ДеревоМнЧЛ4М1 = Ветка.ДанныеМногострочныхЧастей[ИмяГруппыМнЧЛ4М1];
			ДеревоМнЧЛ5М1 = Ветка.ДанныеМногострочныхЧастей[ИмяГруппыМнЧЛ5М1];
			...
			Если Ветка = АктивнаяВетка Тогда
				...
				Для каждого СтрокаМнЧ Из ДеревоМнЧЛ4М1.Строки Цикл
					...
					КонецЦикла;
				КонецЦикла;
				Для каждого СтрокаМнЧ Из ДеревоМнЧЛ5М1.Строки Цикл
					ИндСтроки = Формат(ДеревоМнЧЛ5М1.Строки.Индекс(СтрокаМнЧ) + 1, "ЧГ=");
					Для каждого ИмяГрафы Из ИменаГрафМнЧЛ5М1 Цикл
						СтрокаМнЧ.Данные.Вставить(ИмяГрафы, Форма.ТабличныйДокумент.Области[ИмяГрафы + "_" + ИндСтроки].Значение);
					КонецЦикла;
				КонецЦикла;
			КонецЕсли;
			...
			Сумма = 0;
			Для каждого СтрокаМнЧ Из ДеревоМнЧЛ4М1.Строки Цикл
				Сумма = Сумма + СтрокаМнЧ.Данные["П000Л4М100002"];
			КонецЦикла;
			Ветка.Данные.Вставить("П000Л30000003", Сумма);
			
			Сумма = 0;
			Для каждого СтрокаМнЧ Из ДеревоМнЧЛ5М1.Строки Цикл
				Сумма = Сумма + СтрокаМнЧ.Данные["П000Л5М100002"];
			КонецЦикла;
			Ветка.Данные.Вставить("П000Л30000004", Сумма);
			
			Ветка.Данные.Вставить("П000Л30000005",
			Ветка.Данные["П000Л30000002"] + Ветка.Данные["П000Л30000003"] - Ветка.Данные["П000Л30000004"]);
	...
	ИначеЕсли ИмяРаздела = "Лист6" Тогда
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Ветка.Данные.Вставить("П000Л60000005",
			Ветка.Данные["П000Л60000002"] + Ветка.Данные["П000Л60000003"] - Ветка.Данные["П000Л60000004"]);
	...
	ИначеЕсли ИмяРаздела = "Листы8_10" Тогда
		...
		ИмяГруппыМнЧЛ9М1 = Форма.СтруктураРеквизитовФормы.мИдГруппыЛ9М1;
		СтруктураГруппыМнЧЛ9М1 = Форма.СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей[ИмяГруппыМнЧЛ9М1];
		ИменаГрафМнЧЛ9М1 = СтруктураГруппыМнЧЛ9М1["ИменаГраф"];
		
		ИмяГруппыМнЧЛ10М1 = Форма.СтруктураРеквизитовФормы.мИдГруппыЛ10М1;
		СтруктураГруппыМнЧЛ10М1 = Форма.СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей[ИмяГруппыМнЧЛ10М1];
		ИменаГрафМнЧЛ10М1 = СтруктураГруппыМнЧЛ10М1["ИменаГраф"];
		
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			
			ДеревоМнЧЛ9М1  = Ветка.ДанныеМногострочныхЧастей[ИмяГруппыМнЧЛ9М1];
			ДеревоМнЧЛ10М1 = Ветка.ДанныеМногострочныхЧастей[ИмяГруппыМнЧЛ10М1];
			
			Если Ветка = АктивнаяВетка Тогда
				Для каждого Пок Из Ветка.Данные Цикл
					Ветка.Данные.Вставить(Пок.Ключ, Форма.ТабличныйДокумент.Области[Пок.Ключ].Значение);
				КонецЦикла;
				Для каждого СтрокаМнЧ Из ДеревоМнЧЛ9М1.Строки Цикл
					ИндСтроки = Формат(ДеревоМнЧЛ9М1.Строки.Индекс(СтрокаМнЧ) + 1, "ЧГ=");
					Для каждого ИмяГрафы Из ИменаГрафМнЧЛ9М1 Цикл
						СтрокаМнЧ.Данные.Вставить(ИмяГрафы, Форма.ТабличныйДокумент.Области[ИмяГрафы + "_" + ИндСтроки].Значение);
					КонецЦикла;
				КонецЦикла;
				Для каждого СтрокаМнЧ Из ДеревоМнЧЛ10М1.Строки Цикл
					ИндСтроки = Формат(ДеревоМнЧЛ10М1.Строки.Индекс(СтрокаМнЧ) + 1, "ЧГ=");
					Для каждого ИмяГрафы Из ИменаГрафМнЧЛ10М1 Цикл
						СтрокаМнЧ.Данные.Вставить(ИмяГрафы, Форма.ТабличныйДокумент.Области[ИмяГрафы + "_" + ИндСтроки].Значение);
					КонецЦикла;
				КонецЦикла;
			КонецЕсли;
			...
			Сумма = 0;
			Для каждого СтрокаМнЧ Из ДеревоМнЧЛ9М1.Строки Цикл
				Сумма = Сумма + СтрокаМнЧ.Данные["П000Л9М100002"];
			КонецЦикла;
			Ветка.Данные.Вставить("П000Л80000003", Сумма);
			
			Сумма = 0;
			Для каждого СтрокаМнЧ Из ДеревоМнЧЛ10М1.Строки Цикл
				Сумма = Сумма + СтрокаМнЧ.Данные["П00Л10М100002"];
			КонецЦикла;
			Ветка.Данные.Вставить("П000Л80000004", Сумма);
			
			Ветка.Данные.Вставить("П000Л80000005",
			Ветка.Данные["П000Л80000002"] + Ветка.Данные["П000Л80000003"] - Ветка.Данные["П000Л80000004"]);
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	Структ.Вставить("П000Л80000003");
	Структ.Вставить("П000Л80000004");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Листы8_10", Структ);
	
	Структ = Новый Структура;
	Структ.Вставить("П000Л60000005");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Лист6", Структ);
	
	Структ = Новый Структура;
	Структ.Вставить("П000Л30000005");
	Структ.Вставить("П000Л30000003");
	Структ.Вставить("П000Л30000004");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Листы3_5", Структ);
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ИмяКлючевогоУзлаСодержательнойЧасти1", "ОтчЮЛИПСчетИно");
	ПараметрыВыгрузки.Вставить("ИмяКлючевогоУзлаСодержательнойЧасти2", "ОтчЮЛИПЭлСредИно");
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если ПараметрыВыгрузки.ЭтоИП Тогда
		...
		Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.ИННОрг) Тогда
			СообщитьВТС("Не задан ИНН индивидуального предпринимателя - резидента", "Титульный", "ИНН");
			СтатусПроверки = Ложь;
		ИначеЕсли СтрДлина(ПараметрыВыгрузки.ИННОрг) <> 12 Тогда
			СообщитьВТС("Задан ИНН индивидуального предпринимателя - резидента, не состоящий из 12 цифр", "Титульный", "ИНН");
			СтатусПроверки = Ложь;
		КонецЕсли;
		Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.Фамилия) Тогда
			СообщитьВТС("Не задана фамилия индивидуального предпринимателя - резидента", "Титульный", "НаимОрг");
			СтатусПроверки = Ложь;
		ИначеЕсли НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.Имя) Тогда
			СообщитьВТС("Не задано имя индивидуального предпринимателя - резидента", "Титульный", "НаимОрг");
			СтатусПроверки = Ложь;
		КонецЕсли;
		Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.ОГРНИП) Тогда
			СообщитьВТС("Не задан ОГРНИП", "Титульный", "ОГРНИП");
			СтатусПроверки = Ложь;
		ИначеЕсли СтрДлина(ПараметрыВыгрузки.ОГРНИП) <> 15 Тогда
			СообщитьВТС("Задан ОГРНИП, не состоящий из 15 цифр", "Титульный", "ОГРНИП");
			СтатусПроверки = Ложь;
		КонецЕсли;
	...
	Иначе
		...
		Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.ИННОрг) Тогда
			СообщитьВТС("Не задан ИНН юридического лица - резидента", "Титульный", "ИНН");
			СтатусПроверки = Ложь;
		ИначеЕсли СтрДлина(ПараметрыВыгрузки.ИННОрг) <> 10 Тогда
			СообщитьВТС("Задан ИНН юридического лица - резидента, не состоящий из 10 цифр", "Титульный", "ИНН");
			СтатусПроверки = Ложь;
		КонецЕсли;
		Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.КПП) Тогда
			СообщитьВТС("Не задан КПП", "Титульный", "КПП");
			СтатусПроверки = Ложь;
		ИначеЕсли СтрДлина(ПараметрыВыгрузки.КПП) <> 9 Тогда
			СообщитьВТС("Задан КПП, не состоящий из 9 символов", "Титульный", "КПП");
			СтатусПроверки = Ложь;
		КонецЕсли;
		Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.НаимОрг) Тогда
			СообщитьВТС("Не задано наименование юридического лица - резидента", "Титульный", "НаимОрг");
			СтатусПроверки = Ложь;
		КонецЕсли;
		Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.ОГРН) Тогда
			СообщитьВТС("Не задан ОГРН", "Титульный", "ОГРН");
			СтатусПроверки = Ложь;
		ИначеЕсли СтрДлина(ПараметрыВыгрузки.ОГРН) <> 13 Тогда
			СообщитьВТС("Задан ОГРН, не состоящий из 13 цифр", "Титульный", "ОГРН");
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если ЗначениеЗаполнено(ПараметрыВыгрузки.НаимФил)
			...
			Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.НаимФил) Тогда
				СообщитьВТС("Не задано наименование филиала, представительства или иного подразделения юридического лица"
			...
			Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.АдрФил) Тогда
				СообщитьВТС("Не задано место нахождения филиала, представительства или иного подразделения юридического лица"
			...
			Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.КодСтраны) Тогда
				СообщитьВТС("Не задан код страны филиала, представительства или иного подразделения юридического лица - резидента,"
			...
			ИначеЕсли СтрДлина(ПараметрыВыгрузки.КодСтраны) <> 3 Тогда
				СообщитьВТС("Задан код страны филиала, представительства или иного подразделения юридического лица - резидента, "
	...
	Если ЗначениеЗаполнено(ПараметрыВыгрузки.ПодписантИНН) Тогда
		Если ПараметрыВыгрузки.ПрПодп = "3" Тогда
			СообщитьВТС("Не должен быть заполнен ИНН подписанта, если признак подписанта равен ""3""",
			"Титульный", "ПодписантИНН");
			СтатусПроверки = Ложь;
		ИначеЕсли СтрДлина(ПараметрыВыгрузки.ПодписантИНН) <> 12 Тогда
			СообщитьВТС("Задан ИНН подписанта, не состоящий из 12 цифр", "Титульный", "ПодписантИНН");
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЕсли;
	...
	ЗаполненРаздел1 = ЗаполненРаздел(СохрСтруктура.ДанныеМногоуровневыхРазделов["Лист2"], "Лист2")
	ИЛИ ЗаполненРаздел(СохрСтруктура.ДанныеМногоуровневыхРазделов["Листы3_5"], "Листы3_5")
	ИЛИ ЗаполненРаздел(СохрСтруктура.ДанныеМногоуровневыхРазделов["Лист6"], "Лист6");
	
	ЗаполненРаздел2 = ЗаполненРаздел(СохрСтруктура.ДанныеМногоуровневыхРазделов["Лист7"], "Лист7")
	ИЛИ ЗаполненРаздел(СохрСтруктура.ДанныеМногоуровневыхРазделов["Листы8_10"], "Листы8_10");
	
	Если СтруктураРеквизитовФормы.мСохраненныйДок.Вид = 999 Тогда
		
		Если ЗаполненРаздел1 ИЛИ ЗаполненРаздел2 Тогда
			СообщитьВТС("Листы 2-10 не должны быть заполнены при отмене сообщения (значении номера корректировки, равном 999)",
	...
	Иначе
		...
		Если ЗаполненРаздел1 И ЗаполненРаздел2 Тогда
			...
			СообщитьВТС("Не допускается одновременное заполнение Листов 2-6 и Листов 7-10", "Лист2", "П000Л20000001", "1");
			СтатусПроверки = Ложь;
			
		ИначеЕсли НЕ (ЗаполненРаздел1 ИЛИ ЗаполненРаздел2) Тогда
			
			СообщитьВТС("Листы 2-6 или Листы 7-10 должны быть заполнены", "Лист2", "П000Л20000003", "1");
			СтатусПроверки = Ложь;
		...
		ИначеЕсли ЗаполненРаздел1 Тогда
			...
			// Лист 2.
			//
			ДеревоРаздела = СохрСтруктура.ДанныеМногоуровневыхРазделов["Лист2"];
			НомСтраницы = "1";
			Если ЗаполненРаздел(ДеревоРаздела, "Лист2") Тогда
				
				Ветка = ДеревоРаздела.Строки[0];
				
				ВозмКоды = ВозможныеЗначенияИзСпискаВыбораПоказателя("П000Л20000003");
				
				ПрОрг = СокрЛП(Ветка.Данные["П000Л20000003"]);
				
				Если НЕ ЗначениеЗаполнено(ПрОрг) Тогда
					
					СообщитьВТС("Сведения о счете: не задан признак организации", "Лист2", "П000Л20000003", НомСтраницы);
					СтатусПроверки = Ложь;
					
				ИначеЕсли ВозмКоды.МассивЗначений.Найти(ПрОрг) = Неопределено Тогда
					
					СообщитьВТС("Сведения о счете: некорректно задан признак организации. Возможны значения: "
				...
				ИначеЕсли ПрОрг = "1" Тогда
					...
					Для каждого ИмяПок Из ИменаПровПоказателей Цикл
						Если ЗначениеЗаполнено(Ветка.Данные[ИмяПок]) Тогда
							СообщитьВТС("Сведения о счете: вид иной организации финансового рынка не должен быть задан, "
				...
				ИначеЕсли ПрОрг = "2" Тогда
					...
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Сведения о счете: не задан вид иной организации финансового рынка "
						+ "(небанковская кредитная организация)", "Лист2", "П000Л2ВОФР001", НомСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
						СообщитьВТС("Сведения о счете: некорректно задан вид иной организации финансового рынка "
					...
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Сведения о счете: не задан вид иной организации финансового рынка (страховщик, "
						+ "осуществляющий деятельность по добровольному страхованию жизни)", "Лист2", "П000Л2ВОФР002", НомСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
						СообщитьВТС("Сведения о счете: некорректно задан вид иной организации финансового рынка (страховщик, "
					...
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Сведения о счете: не задан вид иной организации финансового рынка (профессиональный участник "
						...
						СтатусПроверки = Ложь;
					ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
						СообщитьВТС("Сведения о счете: некорректно задан вид иной организации финансового рынка (профессиональный "
					...
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Сведения о счете: не задан вид иной организации финансового рынка (управляющий по договору "
						+ "доверительного управления имуществом)", "Лист2", "П000Л2ВОФР004", НомСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
						СообщитьВТС("Сведения о счете: некорректно задан вид иной организации финансового рынка (управляющий по договору"
					...
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Сведения о счете: не задан вид иной организации финансового рынка (управляющая компания "
						...
						СтатусПроверки = Ложь;
					ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
						СообщитьВТС("Сведения о счете: некорректно задан вид иной организации финансового рынка (управляющая компания"
						+ " инвестиционного фонда, паевого инвестиционного фонда или негосударственного пенсионного фонда)."
					...
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Сведения о счете: не задан вид иной организации финансового рынка (центральный контрагент)",
					...
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Сведения о счете: не задан вид иной организации финансового рынка (управляющий товарищ "
						+ "инвестиционного товарищества)", "Лист2", "П000Л2ВОФР009", НомСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
						СообщитьВТС("Сведения о счете: некорректно задан вид иной организации финансового рынка (управляющий товарищ"
					...
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Сведения о счете: не задан вид иной организации финансового рынка (иная организация или структура "
						...
						СтатусПроверки = Ложь;
					ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
						СообщитьВТС("Сведения о счете: некорректно задан вид иной организации финансового рынка (иная организация или "
					...
					Если НЕ ЗаполненПризнакПрисутствия Тогда
						...
						СообщитьВТС("Сведения о счете: хотя бы один из видов иной организации финансового рынка "
				...
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Сведения о счете: не задано наименование", "Лист2", "П000Л20000004", НомСтраницы);
					СтатусПроверки = Ложь;
				ИначеЕсли НЕ СтроковыеФункцииКлиентСервер.ТолькоЛатиницаВСтроке(
					ЗначПок, Истина, " 0123456789!""`@#№$%&'()[]<>{}*+~=_-.,:;/|\^?") Тогда
					СообщитьВТС("Сведения о счете: наименование должно быть заполнено с использованием букв латинского алфавита,"
					+ " пробелов и символов 0123456789!""`@#№$%&'()[]<>{}*+~=_-.,:;/|\^? (также должно соблюдаться следующее"
					+ " соответствие символов и кодов ASCII: "" - 0022; ` - 0060; @ - 0040; № - 2116; $ - 0024; ' - 0027; ~ - 007E;"
					+ " _ - 005F; / - 002F; | - 007C; \ - 005C; ^ - 005E)", "Лист2", "П000Л20000004", НомСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
				...
				Если ЗначениеЗаполнено(ЗначПок) ИЛИ ПрОрг = "1" Тогда
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Сведения о счете: SWIFT код или БИК должен быть задан, если признак организации равен 1",
						"Лист2", "П000Л20000005", НомСтраницы);
						СтатусПроверки = Ложь;
					Иначе
						Если СтрДлина(ЗначПок) < 3 ИЛИ СтрДлина(ЗначПок) > 25 Тогда
							СообщитьВТС("Сведения о счете: задан SWIFT код или БИК недопустимой длины. Возможна длина от 3 до 25 символов",
							"Лист2", "П000Л20000005", НомСтраницы);
							СтатусПроверки = Ложь;
						КонецЕсли;
						Если НЕ СтроковыеФункцииКлиентСервер.ТолькоЛатиницаВСтроке(ЗначПок, Истина, "0123456789") Тогда
							СообщитьВТС("Сведения о счете: SWIFT код или БИК должен быть заполнен только цифрами и буквами латинского"
				...
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Сведения о счете: не задан полный адрес", "Лист2", "П000Л20000007", НомСтраницы);
					СтатусПроверки = Ложь;
				ИначеЕсли НЕ СтроковыеФункцииКлиентСервер.ТолькоЛатиницаВСтроке(
					ЗначПок, Истина, " 0123456789!""`@#№$%&'()[]<>{}*+~=_-.,:;/|\^?") Тогда
					СообщитьВТС("Сведения о счете: полный адрес должен быть заполнен с использованием букв латинского алфавита,"
					+ " пробелов и символов 0123456789!""`@#№$%&'()[]<>{}*+~=_-.,:;/|\^? (также должно соблюдаться следующее"
					+ " соответствие символов и кодов ASCII: "" - 0022; ` - 0060; @ - 0040; № - 2116; $ - 0024; ' - 0027; ~ - 007E;"
					+ " _ - 005F; / - 002F; | - 007C; \ - 005C; ^ - 005E)", "Лист2", "П000Л20000007", НомСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
				
				ЗначПок = СокрЛП(Ветка.Данные["П000Л20000008"]);
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Сведения о счете: не задан код страны", "Лист2", "П000Л20000008", НомСтраницы);
					СтатусПроверки = Ложь;
				ИначеЕсли СтрДлина(ЗначПок) <> 3 Тогда
					СообщитьВТС("Сведения о счете: задан код страны, не состоящий из 3 цифр", "Лист2", "П000Л20000008", НомСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
				
				ЗначПок = СокрЛП(Ветка.Данные["П000Л20000009"]);
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Сведения о счете: не задан номер счета (вклада)", "Лист2", "П000Л20000009", НомСтраницы);
					СтатусПроверки = Ложь;
				...
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Сведения о счете: не задана дата открытия счета (вклада)", "Лист2", "П000Л20000010", НомСтраницы);
					СтатусПроверки = Ложь;
				...
				Иначе
					...
					Если ЗначениеЗаполнено(ЗначПок_) И ДатаВходитВРазрешенныйПериод(ЗначПок_) И (ЗначПок_ < ЗначПок) Тогда
						СообщитьВТС("Сведения о счете: дата закрытия счета (вклада) не должна быть меньше даты открытия счета",
				...
				Если ЗначениеЗаполнено(ЗначПок) И НЕ ДатаВходитВРазрешенныйПериод(ЗначПок) Тогда
					СообщитьВТС("Сведения о счете: задана дата договора, выходящая за пределы периода с 01.01.1900 по 31.12.2099",
			...
			Иначе
				...
				СообщитьВТС("Не заполнены сведения о счете", "Лист2", "П000Л20000003", "1");
				СтатусПроверки = Ложь;
			...
			// Листы 3-5.
			//
			ДеревоРаздела = СохрСтруктура.ДанныеМногоуровневыхРазделов["Листы3_5"];
			
			ЗаполненыЛисты3_5 = ЗаполненРаздел(ДеревоРаздела, "Листы3_5");
			
			Если ЗаполненыЛисты3_5 Тогда
				...
				Для каждого Ветка Из ДеревоРаздела.Строки Цикл
					...
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Движение средств -> Страница " + НомСтраницы + ": не задан код валюты",
						"Листы3_5", "П000Л30000001", НомСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли СтрДлина(ЗначПок) <> 3 Тогда
						СообщитьВТС("Движение средств -> Страница " + НомСтраницы + ": задан код валюты, не состоящий из 3 цифр",
						"Листы3_5", "П000Л30000001", НомСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					Если Ветка.Данные["П000Л30000003"] > 0 И НЕ ЗаполненаМногострочнаяЧасть(ДанныеМнЧ) Тогда
						СообщитьВТС("Движение средств -> Страница " + НомСтраницы
						+ ": должен быть заполнен Лист 4 при заполненной строке ""Зачислено денежных средств за отчетный период - всего""",
						"Листы3_5", "П000Л4М100001_1", НомСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
						Если ЗаполненаСтрокаМногострочнойЧасти(СтрокаМнЧ) Тогда
							...
							Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
								СообщитьВТС("Движение средств -> Страница " + НомСтраницы + ": в строке " + НомСтроки
								+ " Листа 4 не задан код вида операции", "Листы3_5", "П000Л4М100001_" + НомСтроки, НомСтраницы);
								СтатусПроверки = Ложь;
							ИначеЕсли СтрДлина(ЗначПок) <> 5 Тогда
								СообщитьВТС("Движение средств -> Страница " + НомСтраницы + ": в строке " + НомСтроки + " Листа 4 задан код"
								+ " вида операции, не состоящий из 5 символов", "Листы3_5", "П000Л4М100001_" + НомСтроки, НомСтраницы);
								СтатусПроверки = Ложь;
							КонецЕсли;
							...
							Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
								СообщитьВТС("Движение средств -> Страница " + НомСтраницы + ": в строке " + НомСтроки
								+ " Листа 4 не задана сумма", "Листы3_5", "П000Л4М100002_" + НомСтроки, НомСтраницы);
								СтатусПроверки = Ложь;
							КонецЕсли;
						КонецЕсли;
					КонецЦикла;
					...
					// Лист 5.
					//
					ДанныеМнЧ = Ветка.ДанныеМногострочныхЧастей[СтруктураРеквизитовФормы.мИдГруппыЛ5М1];
					
					Если Ветка.Данные["П000Л30000004"] > 0 И НЕ ЗаполненаМногострочнаяЧасть(ДанныеМнЧ) Тогда
						СообщитьВТС("Движение средств -> Страница " + НомСтраницы
						+ ": должен быть заполнен Лист 5 при заполненной строке ""Списано денежных средств за отчетный период - всего""",
						"Листы3_5", "П000Л5М100001_1", НомСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
						Если ЗаполненаСтрокаМногострочнойЧасти(СтрокаМнЧ) Тогда
							...
							ЗначПок = СокрЛП(СтрокаМнЧ.Данные["П000Л5М100001"]);
							Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
								СообщитьВТС("Движение средств -> Страница " + НомСтраницы + ": в строке " + НомСтроки
								+ " Листа 5 не задан код вида операции", "Листы3_5", "П000Л5М100001_" + НомСтроки, НомСтраницы);
								СтатусПроверки = Ложь;
							ИначеЕсли СтрДлина(ЗначПок) <> 5 Тогда
								СообщитьВТС("Движение средств -> Страница " + НомСтраницы + ": в строке " + НомСтроки + " Листа 5 задан код"
								+ " вида операции, не состоящий из 5 символов", "Листы3_5", "П000Л5М100001_" + НомСтроки, НомСтраницы);
								СтатусПроверки = Ложь;
							КонецЕсли;
							
							ЗначПок = СтрокаМнЧ.Данные["П000Л5М100002"];
							Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
								СообщитьВТС("Движение средств -> Страница " + НомСтраницы + ": в строке " + НомСтроки
								+ " Листа 5 не задана сумма", "Листы3_5", "П000Л5М100002_" + НомСтроки, НомСтраницы);
								СтатусПроверки = Ложь;
							КонецЕсли;
						КонецЕсли;
					КонецЦикла;
			...
			// Лист 6.
			//
			ДеревоРаздела = СохрСтруктура.ДанныеМногоуровневыхРазделов["Лист6"];
			
			ЗаполненыЛисты6 = ЗаполненРаздел(ДеревоРаздела, "Лист6");
			
			Если ЗаполненыЛисты6 Тогда
				
				Для каждого Ветка Из ДеревоРаздела.Строки Цикл
					
					НомСтраницы = Формат(ДеревоРаздела.Строки.Индекс(Ветка) + 1, "ЧГ=");
					
					ЗначПок = СокрЛП(Ветка.Данные["П000Л60000001"]);
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": не задан код валюты",
						"Лист6", "П000Л60000001", НомСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли СтрДлина(ЗначПок) <> 3 Тогда
						СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": задан код валюты, не состоящий из 3 цифр",
						"Лист6", "П000Л60000001", НомСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					ЗначПок = СокрЛП(Ветка.Данные["П000Л6ВФА0001"]);
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": не задан вид иного финансового актива"
						+ " (ценные бумаги)", "Лист6", "П000Л6ВФА0001", НомСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
						СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": некорректно задан вид иного финансового"
						+ " актива (ценные бумаги). Возможны значения: 0, 1", "Лист6", "П000Л6ВФА0001", НомСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					ЗаполненПризнакПрисутствия = ЗаполненПризнакПрисутствия ИЛИ ЗначПок = "1";
					
					ЗначПок = СокрЛП(Ветка.Данные["П000Л6ВФА0002"]);
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": не задан вид иного финансового актива"
						+ " (производные финансовые инструменты)", "Лист6", "П000Л6ВФА0002", НомСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
						СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": некорректно задан вид иного финансового"
						+ " актива (производные финансовые инструменты). Возможны значения: 0, 1",
						"Лист6", "П000Л6ВФА0002", НомСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					ЗаполненПризнакПрисутствия = ЗаполненПризнакПрисутствия ИЛИ ЗначПок = "1";
					
					ЗначПок = СокрЛП(Ветка.Данные["П000Л6ВФА0003"]);
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": не задан вид иного финансового актива (доли"
						+ " участия в уставном (складочном) капитале юридического лица)", "Лист6", "П000Л6ВФА0003", НомСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
						СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": некорректно задан вид иного финансового"
						+ " актива (доли участия в уставном (складочном) капитале юридического лица). Возможны значения: 0, 1",
						"Лист6", "П000Л6ВФА0003", НомСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					ЗаполненПризнакПрисутствия = ЗаполненПризнакПрисутствия ИЛИ ЗначПок = "1";
					
					ЗначПок = СокрЛП(Ветка.Данные["П000Л6ВФА0004"]);
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": не задан вид иного финансового актива (доли"
						+ " участия в иностранной структуре без образования юридического лица)", "Лист6", "П000Л6ВФА0004", НомСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
						СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": некорректно задан вид иного финансового"
						+ " актива (доли участия в иностранной структуре без образования юридического лица). Возможны значения: 0, 1",
						"Лист6", "П000Л6ВФА0004", НомСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					ЗаполненПризнакПрисутствия = ЗаполненПризнакПрисутствия ИЛИ ЗначПок = "1";
					
					ЗначПок = СокрЛП(Ветка.Данные["П000Л6ВФА0005"]);
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": не задан вид иного финансового актива (права"
						+ " требования из договора страхования)", "Лист6", "П000Л6ВФА0005", НомСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
						СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": некорректно задан вид иного финансового"
						+ " актива (права требования из договора страхования). Возможны значения: 0, 1",
						"Лист6", "П000Л6ВФА0005", НомСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					ЗаполненПризнакПрисутствия = ЗаполненПризнакПрисутствия ИЛИ ЗначПок = "1";
					
					ЗначПок = СокрЛП(Ветка.Данные["П000Л6ВФА0006"]);
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": не задан вид иного финансового актива (иные"
						+ " финансовые активы, не включенные в вышеуказанный перечень)", "Лист6", "П000Л6ВФА0006", НомСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
						СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": некорректно задан вид иного финансового"
						+ " актива (иные финансовые активы, не включенные в вышеуказанный перечень). Возможны значения: 0, 1",
						"Лист6", "П000Л6ВФА0006", НомСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					ЗаполненПризнакПрисутствия = ЗаполненПризнакПрисутствия ИЛИ ЗначПок = "1";
					...
					Если НЕ ЗаполненПризнакПрисутствия Тогда
						...
						СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": хотя бы один из "
						+ "видов иных финансовых активов должен принимать значение 1", "Лист6", "П000Л6ВФА0001", НомСтраницы);
						СтатусПроверки = Ложь;
			...
			Если НЕ ЗаполненыЛисты3_5 И НЕ ЗаполненыЛисты6 Тогда
				
				СообщитьВТС("Не заполнены сведения о движении денежных средств и(или) сведения об иных финансовых активах",
				"Листы3_5", "П000Л30000001", "1");
				СтатусПроверки = Ложь;
		...
		ИначеЕсли ЗаполненРаздел2 Тогда
			...
			// Лист 7.
			//
			ДеревоРаздела = СохрСтруктура.ДанныеМногоуровневыхРазделов["Лист7"];
			НомСтраницы = "1";
			Если ЗаполненРаздел(ДеревоРаздела, "Лист7") Тогда
				
				Ветка = ДеревоРаздела.Строки[0];
				
				ЗначПок = Ветка.Данные["П000Л70000001"];
				...
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Сведения об ЭСП: не задана дата начала отчетного периода", "Лист7", "П000Л70000001", НомСтраницы);
					СтатусПроверки = Ложь;
				ИначеЕсли НЕ ДатаВходитВРазрешенныйПериод(ЗначПок, ВозможнаяЛеваяГраница, ВозможнаяПраваяГраница) Тогда
					СообщитьВТС("Сведения об ЭСП: задана дата начала отчетного периода, выходящая за пределы периода с "
					+ Формат(ВозможнаяЛеваяГраница, "ДФ=дд.ММ.гггг") + " по " + Формат(ВозможнаяПраваяГраница, "ДФ=дд.ММ.гггг"),
					"Лист7", "П000Л70000001", НомСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
				
				ВозмКоды = ВозможныеЗначенияИзСпискаВыбораПоказателя("П000Л70000003");
				
				ПрОрг = СокрЛП(Ветка.Данные["П000Л70000003"]);
				
				Если НЕ ЗначениеЗаполнено(ПрОрг) Тогда
					СообщитьВТС("Сведения об ЭСП: не задан признак организации", "Лист7", "П000Л70000003", НомСтраницы);
					СтатусПроверки = Ложь;
				ИначеЕсли ВозмКоды.МассивЗначений.Найти(ПрОрг) = Неопределено Тогда
					СообщитьВТС("Сведения об ЭСП: некорректно задан признак организации. Возможны значения: "
					+ ВозмКоды.СтрокаЗначений, "Лист7", "П000Л70000003", НомСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
				
				ЗначПок = СокрЛП(Ветка.Данные["П000Л70000004"]);
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Сведения об ЭСП: не задано наименование", "Лист7", "П000Л70000004", НомСтраницы);
					СтатусПроверки = Ложь;
				ИначеЕсли НЕ СтроковыеФункцииКлиентСервер.ТолькоЛатиницаВСтроке(
					ЗначПок, Истина, " 0123456789!""`@#№$%&'()[]<>{}*+~=_-.,:;/|\^?") Тогда
					СообщитьВТС("Сведения об ЭСП: наименование должно быть заполнено с использованием букв латинского алфавита,"
					+ " пробелов и символов 0123456789!""`@#№$%&'()[]<>{}*+~=_-.,:;/|\^? (также должно соблюдаться следующее"
					+ " соответствие символов и кодов ASCII: "" - 0022; ` - 0060; @ - 0040; № - 2116; $ - 0024; ' - 0027; ~ - 007E;"
					+ " _ - 005F; / - 002F; | - 007C; \ - 005C; ^ - 005E)", "Лист7", "П000Л70000004", НомСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
				
				ЗначПок = СокрЛП(Ветка.Данные["П000Л70000005"]);
				Если ЗначениеЗаполнено(ЗначПок) ИЛИ ПрОрг = "1" Тогда
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Сведения об ЭСП: SWIFT код или БИК должен быть задан, если признак организации равен 1",
						"Лист7", "П000Л70000005", НомСтраницы);
						СтатусПроверки = Ложь;
					Иначе
						Если СтрДлина(ЗначПок) < 3 ИЛИ СтрДлина(ЗначПок) > 25 Тогда
							СообщитьВТС("Сведения об ЭСП: задан SWIFT код или БИК недопустимой длины. Возможна длина от 3 до 25 символов",
							"Лист7", "П000Л70000005", НомСтраницы);
							СтатусПроверки = Ложь;
						КонецЕсли;
						Если НЕ СтроковыеФункцииКлиентСервер.ТолькоЛатиницаВСтроке(ЗначПок, Истина, "0123456789") Тогда
							СообщитьВТС("Сведения об ЭСП: SWIFT код или БИК должен быть заполнен только цифрами и буквами латинского"
							+ " алфавита", "Лист7", "П000Л70000005", НомСтраницы);
							СтатусПроверки = Ложь;
						КонецЕсли;
					КонецЕсли;
				КонецЕсли;
				
				ЗначПок = СокрЛП(Ветка.Данные["П000Л70000007"]);
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Сведения об ЭСП: не задан полный адрес", "Лист7", "П000Л70000007", НомСтраницы);
					СтатусПроверки = Ложь;
				ИначеЕсли НЕ СтроковыеФункцииКлиентСервер.ТолькоЛатиницаВСтроке(
					ЗначПок, Истина, " 0123456789!""`@#№$%&'()[]<>{}*+~=_-.,:;/|\^?") Тогда
					СообщитьВТС("Сведения об ЭСП: полный адрес должен быть заполнен с использованием букв латинского алфавита,"
					+ " пробелов и символов 0123456789!""`@#№$%&'()[]<>{}*+~=_-.,:;/|\^? (также должно соблюдаться следующее"
					+ " соответствие символов и кодов ASCII: "" - 0022; ` - 0060; @ - 0040; № - 2116; $ - 0024; ' - 0027; ~ - 007E;"
					+ " _ - 005F; / - 002F; | - 007C; \ - 005C; ^ - 005E)", "Лист7", "П000Л70000007", НомСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
				
				ЗначПок = СокрЛП(Ветка.Данные["П000Л70000008"]);
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Сведения об ЭСП: не задан код страны", "Лист7", "П000Л70000008", НомСтраницы);
					СтатусПроверки = Ложь;
				ИначеЕсли СтрДлина(ЗначПок) <> 3 Тогда
					СообщитьВТС("Сведения об ЭСП: задан код страны, не состоящий из 3 цифр", "Лист7", "П000Л70000008", НомСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
				
				ЗначПок = СокрЛП(Ветка.Данные["П000Л70000009"]);
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Сведения об ЭСП: не задан идентификатор электронного средства платежа",
					"Лист7", "П000Л70000009", НомСтраницы);
					СтатусПроверки = Ложь;
				ИначеЕсли НЕ СтроковыеФункцииКлиентСервер.ТолькоЛатиницаВСтроке(ЗначПок, Истина, "0123456789") Тогда
					СообщитьВТС("Сведения об ЭСП: идентификатор электронного средства платежа должен быть заполнен "
					+ "только цифрами и буквами латинского алфавита", "Лист7", "П000Л70000009", НомСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
				
				ЗначПок = Ветка.Данные["П000Л70000010"];
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Сведения об ЭСП: не задана дата предоставления права использования электронного средства платежа",
					"Лист7", "П000Л70000010", НомСтраницы);
					СтатусПроверки = Ложь;
				ИначеЕсли НЕ ДатаВходитВРазрешенныйПериод(ЗначПок) Тогда
					СообщитьВТС("Сведения об ЭСП: задана дата предоставления права использования электронного средства платежа, "
					+ "выходящая за пределы периода с 01.01.1900 по 31.12.2099", "Лист7", "П000Л70000010", НомСтраницы);
					СтатусПроверки = Ложь;
				Иначе
					ЗначПок_ = Ветка.Данные["П000Л70000011"];
					Если ЗначениеЗаполнено(ЗначПок_) И ДатаВходитВРазрешенныйПериод(ЗначПок_) И (ЗначПок_ < ЗначПок) Тогда
						СообщитьВТС("Сведения об ЭСП: дата прекращения права использования электронного средства платежа "
						+ "не должна быть меньше даты предоставления права использования электронного средства платежа",
						"Лист7", "П000Л70000011", НомСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
				КонецЕсли;
				
				ЗначПок = Ветка.Данные["П000Л70000011"];
				Если ЗначениеЗаполнено(ЗначПок) И НЕ ДатаВходитВРазрешенныйПериод(ЗначПок) Тогда
					СообщитьВТС("Сведения об ЭСП: задана дата прекращения права использования электронного средства платежа, "
					+ "выходящая за пределы периода с 01.01.1900 по 31.12.2099", "Лист7", "П000Л70000011", НомСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
				
			Иначе
				
				СообщитьВТС("Не заполнены сведения об ЭСП", "Лист7", "П000Л70000001", "1");
				СтатусПроверки = Ложь;
			...
			// Листы 8-10.
			//
			ДеревоРаздела = СохрСтруктура.ДанныеМногоуровневыхРазделов["Листы8_10"];
			
			ЗаполненыЛисты8_10 = ЗаполненРаздел(ДеревоРаздела, "Листы8_10");
			
			Если ЗаполненыЛисты8_10 Тогда
				...
				Для каждого Ветка Из ДеревоРаздела.Строки Цикл
					...
					Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
						СообщитьВТС("Переводы средств -> Страница " + НомСтраницы + ": не задан код валюты",
						"Листы8_10", "П000Л80000001", НомСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли СтрДлина(ЗначПок) <> 3 Тогда
						СообщитьВТС("Переводы средств -> Страница " + НомСтраницы + ": задан код валюты, не состоящий из 3 цифр",
						"Листы8_10", "П000Л80000001", НомСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					// Лист 9.
					//
					ДанныеМнЧ = Ветка.ДанныеМногострочныхЧастей[СтруктураРеквизитовФормы.мИдГруппыЛ9М1];
					
					Если Ветка.Данные["П000Л80000003"] > 0 И НЕ ЗаполненаМногострочнаяЧасть(ДанныеМнЧ) Тогда
						СообщитьВТС("Переводы средств -> Страница " + НомСтраницы + ": должен быть заполнен Лист 9 "
						+ "при заполненной строке ""Зачислено денежных средств на электронное средство платежа - всего""",
						"Листы8_10", "П000Л9М100001_1", НомСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
						Если ЗаполненаСтрокаМногострочнойЧасти(СтрокаМнЧ) Тогда
							...
							ЗначПок = СокрЛП(СтрокаМнЧ.Данные["П000Л9М100001"]);
							Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
								СообщитьВТС("Переводы средств -> Страница " + НомСтраницы + ": в строке " + НомСтроки
								+ " Листа 9 не задан код вида операции", "Листы8_10", "П000Л9М100001_" + НомСтроки, НомСтраницы);
								СтатусПроверки = Ложь;
							ИначеЕсли СтрДлина(ЗначПок) <> 5 Тогда
								СообщитьВТС("Переводы средств -> Страница " + НомСтраницы + ": в строке " + НомСтроки + " Листа 9 задан код"
								+ " вида операции, не состоящий из 5 символов", "Листы8_10", "П000Л9М100001_" + НомСтроки, НомСтраницы);
								СтатусПроверки = Ложь;
							КонецЕсли;
							
							ЗначПок = СтрокаМнЧ.Данные["П000Л9М100002"];
							Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
								СообщитьВТС("Переводы средств -> Страница " + НомСтраницы + ": в строке " + НомСтроки
								+ " Листа 9 не задана сумма", "Листы8_10", "П000Л9М100002_" + НомСтроки, НомСтраницы);
								СтатусПроверки = Ложь;
							КонецЕсли;
						КонецЕсли;
					КонецЦикла;
					...
					// Лист 10.
					//
					ДанныеМнЧ = Ветка.ДанныеМногострочныхЧастей[СтруктураРеквизитовФормы.мИдГруппыЛ10М1];
					
					Если Ветка.Данные["П000Л80000004"] > 0 И НЕ ЗаполненаМногострочнаяЧасть(ДанныеМнЧ) Тогда
						СообщитьВТС("Переводы средств -> Страница " + НомСтраницы + ": должен быть заполнен Лист 10 "
						+ "при заполненной строке ""Списано денежных средств с электронного средства платежа - всего""",
						"Листы8_10", "П00Л10М100001_1", НомСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
						Если ЗаполненаСтрокаМногострочнойЧасти(СтрокаМнЧ) Тогда
							...
							ЗначПок = СокрЛП(СтрокаМнЧ.Данные["П00Л10М100001"]);
							Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
								СообщитьВТС("Переводы средств -> Страница " + НомСтраницы + ": в строке " + НомСтроки
								+ " Листа 10 не задан код вида операции", "Листы8_10", "П00Л10М100001_" + НомСтроки, НомСтраницы);
								СтатусПроверки = Ложь;
							ИначеЕсли СтрДлина(ЗначПок) <> 5 Тогда
								СообщитьВТС("Переводы средств -> Страница " + НомСтраницы + ": в строке " + НомСтроки + " Листа 10 задан код"
								+ " вида операции, не состоящий из 5 символов", "Листы8_10", "П00Л10М100001_" + НомСтроки, НомСтраницы);
								СтатусПроверки = Ложь;
							КонецЕсли;
							
							ЗначПок = СтрокаМнЧ.Данные["П00Л10М100002"];
							Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
								СообщитьВТС("Переводы средств -> Страница " + НомСтраницы + ": в строке " + НомСтроки
								+ " Листа 10 не задана сумма", "Листы8_10", "П00Л10М100002_" + НомСтроки, НомСтраницы);
								СтатусПроверки = Ложь;
							КонецЕсли;
						КонецЕсли;
					КонецЦикла;
...
Функция ПоказателиНеанализируемыеНаЗаполненность()
	...
	ИменаПоказателей.Добавить("П000Л70000002");
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель, ПараметрыВыгрузки)
	...
	Если ПараметрыВыгрузки.НомКорр <> "999" Тогда
		...
		Если УзелРодитель.Код = ПараметрыВыгрузки.ИмяКлючевогоУзлаСодержательнойЧасти1 И ЗаполненРаздел1 Тогда
			...
			// Лист 2.
			ДеревоРаздела = СохрСтруктура.ДанныеМногоуровневыхРазделов["Лист2"];
			ЗаполнитьДаннымиУзел(ДеревоРаздела.Строки[0].Данные, УзелРодитель);
			
			СвСчетИно = ПолучитьПодчиненныйЭлемент(УзелРодитель, "СвСчетИно");
			
			// Листы 3-5.
			ДеревоРаздела = СохрСтруктура.ДанныеМногоуровневыхРазделов["Листы3_5"];
			СвДвижСред = ПолучитьПодчиненныйЭлемент(СвСчетИно, "СвДвижСред");
			Для каждого Ветка Из ДеревоРаздела.Строки Цикл
				ЭкзСвДвижСред = СкопироватьУзел(СвСчетИно, СвДвижСред, СвСчетИно.Строки.Количество() - 1);
				Для каждого Эл Из ЭкзСвДвижСред.Строки Цикл
					Если Эл.Строки.Количество() = 0 Тогда
						ВывестиПоказательВXML(Эл, Ветка.Данные[Эл.Ключ]);
					КонецЕсли;
				КонецЦикла;
				ЗачСред = ПолучитьПодчиненныйЭлемент(ЭкзСвДвижСред, "ЗачСред");
				ЗачСредКод = ПолучитьПодчиненныйЭлемент(ЗачСред, "ЗачСредКод");
				ДанныеМнЧ = Ветка.ДанныеМногострочныхЧастей[СтруктураРеквизитовФормы.мИдГруппыЛ4М1];
				Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
					ЗаполнитьДаннымиУзел(СтрокаМнЧ.Данные, СкопироватьУзел(ЗачСред, ЗачСредКод, ЗачСред.Строки.Количество() - 1));
				КонецЦикла;
				СписСред = ПолучитьПодчиненныйЭлемент(ЭкзСвДвижСред, "СписСред");
				СписСредКод = ПолучитьПодчиненныйЭлемент(СписСред, "СписСредКод");
				ДанныеМнЧ = Ветка.ДанныеМногострочныхЧастей[СтруктураРеквизитовФормы.мИдГруппыЛ5М1];
				Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
					ЗаполнитьДаннымиУзел(СтрокаМнЧ.Данные, СкопироватьУзел(СписСред, СписСредКод, СписСред.Строки.Количество() - 1));
				КонецЦикла;
			...
			// Лист 6.
			ДеревоРаздела = СохрСтруктура.ДанныеМногоуровневыхРазделов["Лист6"];
			СведФинАкт = ПолучитьПодчиненныйЭлемент(СвСчетИно, "СведФинАкт");
			Для каждого Ветка Из ДеревоРаздела.Строки Цикл
				ЗаполнитьДаннымиУзел(Ветка.Данные, СкопироватьУзел(СвСчетИно, СведФинАкт, СвСчетИно.Строки.Количество() - 1));
			КонецЦикла;
		...
		ИначеЕсли УзелРодитель.Код = ПараметрыВыгрузки.ИмяКлючевогоУзлаСодержательнойЧасти2 И ЗаполненРаздел2 Тогда
			...
			СвЭлСред = ПолучитьПодчиненныйЭлемент(УзелРодитель, "СвЭлСред");
			
			// Листы 8-10.
			ДеревоРаздела = СохрСтруктура.ДанныеМногоуровневыхРазделов["Листы8_10"];
			СвПерСред = ПолучитьПодчиненныйЭлемент(СвЭлСред, "СвПерСред");
			Для каждого Ветка Из ДеревоРаздела.Строки Цикл
				ЭкзСвПерСред = СкопироватьУзел(СвЭлСред, СвПерСред, СвЭлСред.Строки.Количество() - 1);
				Для каждого Эл Из ЭкзСвПерСред.Строки Цикл
					Если Эл.Строки.Количество() = 0 Тогда
						ВывестиПоказательВXML(Эл, Ветка.Данные[Эл.Ключ]);
					КонецЕсли;
				КонецЦикла;
				ЗачСред = ПолучитьПодчиненныйЭлемент(ЭкзСвПерСред, "ЗачСред");
				ЗачСредКод = ПолучитьПодчиненныйЭлемент(ЗачСред, "ЗачСредКод");
				ДанныеМнЧ = Ветка.ДанныеМногострочныхЧастей[СтруктураРеквизитовФормы.мИдГруппыЛ9М1];
				Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
					ЗаполнитьДаннымиУзел(СтрокаМнЧ.Данные, СкопироватьУзел(ЗачСред, ЗачСредКод, ЗачСред.Строки.Количество() - 1));
				КонецЦикла;
				СписСред = ПолучитьПодчиненныйЭлемент(ЭкзСвПерСред, "СписСред");
				СписСредКод = ПолучитьПодчиненныйЭлемент(СписСред, "СписСредКод");
				ДанныеМнЧ = Ветка.ДанныеМногострочныхЧастей[СтруктураРеквизитовФормы.мИдГруппыЛ10М1];
				Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
					ЗаполнитьДаннымиУзел(СтрокаМнЧ.Данные, СкопироватьУзел(СписСред, СписСредКод, СписСред.Строки.Количество() - 1));
...
Процедура ОчисткаРегламентированногоОтчетаНаСервере(ИмяСтраницы) Экспорт
	...
	Иначе
		...
		Если ИмяСтраницы = "Лист2" ИЛИ ИмяСтраницы = "Лист7" Тогда
			
			ЗаполнитьПериодОтчета();
			ВывестиДанныеВТабличныйДокумент(ИмяСтраницы, СтруктураРеквизитовФормы.НомераСтрокМногоуровнегоРаздела);
...
Функция ПечатьНаСервере(ВидПечати)
	...
	ЗаполненРаздел1
	= ЗаполненРаздел(ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхЛист2"]), "Лист2")
	ИЛИ ЗаполненРаздел(ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхЛисты3_5"]), "Листы3_5")
	ИЛИ ЗаполненРаздел(ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхЛист6"]), "Лист6");
	
	ЗаполненРаздел2
	= ЗаполненРаздел(ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхЛист7"]), "Лист7")
	ИЛИ ЗаполненРаздел(ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхЛисты8_10"]), "Листы8_10");
...
Процедура ВывестиНаПечатьДанныеМногоуровневогоРаздела(СтруктураПараметров, ОбщиеРеквизитыРазделов, СтрПоля)
	...
	Если ИмяТекРаздела = "Лист2" ИЛИ ИмяТекРаздела = "Лист6" ИЛИ ИмяТекРаздела = "Лист7" Тогда
		...
		Для каждого Ветка Из ДеревоДанныхРаздела.Строки Цикл
			...
			ИначеЕсли ИмяТекРаздела = "Лист7" И НЕ СтруктураПараметров.ЗаполненРаздел2 Тогда
				
				Обл = ТабличныйДокумент.Области.Найти("П000Л70000002");
				Если Обл <> Неопределено Тогда
					Обл.Очистить();
				КонецЕсли;
	...
	ИначеЕсли ИмяТекРаздела = "Листы3_5" Тогда
		...
		Для каждого Ветка Из ДеревоДанныхРаздела.Строки Цикл
			...
			//
			ИмяГруппыМнЧ = СтруктураРеквизитовФормы.мИдГруппыЛ5М1;
			ИменаГрафМнЧ = СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей[ИмяГруппыМнЧ]["ИменаГраф"];
			СтрокМнЧНаЛисте = 27;
	...
	ИначеЕсли ИмяТекРаздела = "Листы8_10" Тогда
		...
		Для каждого Ветка Из ДеревоДанныхРаздела.Строки Цикл
			...
			// Определение количества Листов 9.
			//
			ИмяГруппыМнЧ = СтруктураРеквизитовФормы.мИдГруппыЛ9М1;
			ИменаГрафМнЧ = СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей[ИмяГруппыМнЧ]["ИменаГраф"];
			СтрокМнЧНаЛисте = 27;
			...
			// Подготовка многострочных данных для заполнения Листов 9.
			//
			МассивДанныхМнЧДляПечати = Новый Массив;
			Для НомЛиста = 1 По КолЛистовРаздела Цикл
				ПриращениеКНомеру = (НомЛиста - 1) * СтрокМнЧНаЛисте;
			...
			Для НомЛиста = 1 По КолЛистовРаздела Цикл
				...
				СтруктураПараметровРаздела = ОбщегоНазначения.СкопироватьРекурсивно(СтруктураПараметров);
				СтруктураПараметровРаздела.Вставить("ИмяСтраницы", "Лист9");
				ВывестиНаПечатьЛист(СтруктураПараметровРаздела, ОбщиеРеквизитыРазделов, СтрПоля);
				
			КонецЦикла;
			
			// Определение количества Листов 10.
			//
			ИмяГруппыМнЧ = СтруктураРеквизитовФормы.мИдГруппыЛ10М1;
			ИменаГрафМнЧ = СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей[ИмяГруппыМнЧ]["ИменаГраф"];
			СтрокМнЧНаЛисте = 27;
			...
			// Подготовка многострочных данных для заполнения Листов 10.
			//
			МассивДанныхМнЧДляПечати = Новый Массив;
			Для НомЛиста = 1 По КолЛистовРаздела Цикл
				ПриращениеКНомеру = (НомЛиста - 1) * СтрокМнЧНаЛисте;
	...
	Для Каждого Область Из ИсходныйМакет.Области Цикл
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Прямоугольник
			...
			Если Область.Значение = 0
				...
				ИЛИ Область.Имя = "П000Л60000003" ИЛИ Область.Имя = "П000Л60000004"))
				ИЛИ (ПараметрыПечати.ЗаполненРаздел2
				И (Область.Имя = "П000Л80000003" ИЛИ Область.Имя = "П000Л80000004"))) Тогда
...
Процедура АктивизироватьЯчейку(Ячейка) Экспорт
	...
	Если Ячейка.Раздел = "Лист2" ИЛИ Ячейка.Раздел = "Лист7" Тогда
	...
	ИначеЕсли Ячейка.Раздел = "Листы3_5" ИЛИ Ячейка.Раздел = "Лист6" ИЛИ Ячейка.Раздел = "Листы8_10" Тогда
