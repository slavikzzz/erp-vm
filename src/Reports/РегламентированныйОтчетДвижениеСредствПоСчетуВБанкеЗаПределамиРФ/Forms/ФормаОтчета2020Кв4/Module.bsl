...
Процедура ИнициализироватьМногоуровневыеРазделы()
	...
	СтруктураРаздела = Новый Структура;
	СтруктураРаздела.Вставить("Многостраничность");
	мСтруктураМногоуровневыхРазделов.Вставить("Листы6_7", СтруктураРаздела);
...
Процедура ФормироватьСтруктуруСтраницОтчета() Экспорт
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы        = "Листы6_7";
...
Процедура СформироватьСпискиВыбора()
	...
	//Лист 7.
	//
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000Л7ВФА0001", 1, ,
	"Выбор вида иного финансового актива", КоллекцияСписковВыбора["ПризнакиОтсутствияПрисутствия"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000Л7ВФА0002", 1, ,
	"Выбор вида иного финансового актива", КоллекцияСписковВыбора["ПризнакиОтсутствияПрисутствия"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000Л7ВФА0003", 1, ,
	"Выбор вида иного финансового актива", КоллекцияСписковВыбора["ПризнакиОтсутствияПрисутствия"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000Л7ВФА0004", 1, ,
	"Выбор вида иного финансового актива", КоллекцияСписковВыбора["ПризнакиОтсутствияПрисутствия"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000Л7ВФА0005", 1, ,
	"Выбор вида иного финансового актива", КоллекцияСписковВыбора["ПризнакиОтсутствияПрисутствия"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000Л7ВФА0006", 1, ,
	"Выбор вида иного финансового актива", КоллекцияСписковВыбора["ПризнакиОтсутствияПрисутствия"]);
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Область.Имя = "КодСтраны" ИЛИ Область.Имя = "П000Л20000008" Тогда
	...
	ИначеЕсли Область.Имя = "П000Л30000001" ИЛИ Область.Имя = "П000Л60000001" Тогда
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяРаздела)
	...
	ИначеЕсли ИмяРаздела = "Листы3_5" ИЛИ ИмяРаздела = "Листы6_7" Тогда
...
Процедура ДобавитьСтраницу(Команда)
	...
	Если ИмяРаздела = "Листы3_5" ИЛИ ИмяРаздела = "Листы6_7" Тогда
...
Процедура Расчет(Форма, ИмяРаздела = "", ОбластьИмя = "") Экспорт
	...
	ИначеЕсли ИмяРаздела = "Листы6_7" Тогда
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Листы6_7", Структ);
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ИмяКлючевогоУзлаСодержательнойЧасти", "ОтчЮЛИПСчетИно");
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если ЗаполненРаздел(ДеревоРаздела, "Лист2") Тогда
		...
		ИначеЕсли ПрОрг = "1" Тогда
			...
			Для каждого ИмяПок Из ИменаПровПоказателей Цикл
				Если ЗначениеЗаполнено(Ветка.Данные[ИмяПок]) Тогда
					СообщитьВТС(
					"Сведения о счете: вид организации финансового рынка не должен быть задан, если признак организации равен 1",
					"Лист2", ИмяПок, НомСтраницы);
					СтатусПроверки = Ложь;
					Прервать;
				КонецЕсли;
			КонецЦикла;
		...
		ИначеЕсли ПрОрг = "2" Тогда
			...
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Сведения о счете: не задан вид организации финансового рынка (небанковская кредитная организация)",
				"Лист2", "П000Л2ВОФР001", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Сведения о счете: некорректно задан вид организации финансового рынка (небанковская кредитная"
				+ " организация). Возможны значения: 0, 1", "Лист2", "П000Л2ВОФР001", НомСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			ЗначПок = СокрЛП(Ветка.Данные["П000Л2ВОФР002"]);
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Сведения о счете: не задан вид организации финансового рынка (страховщик, осуществляющий"
				+ " деятельность по добровольному страхованию жизни)", "Лист2", "П000Л2ВОФР002", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Сведения о счете: некорректно задан вид организации финансового рынка (страховщик, осуществляющий"
				+ " деятельность по добровольному страхованию жизни). Возможны значения: 0, 1",
				"Лист2", "П000Л2ВОФР002", НомСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			ЗначПок = СокрЛП(Ветка.Данные["П000Л2ВОФР003"]);
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Сведения о счете: не задан вид организации финансового рынка (профессиональный участник рынка ценных"
				+ " бумаг, осуществляющий брокерскую деятельность, и (или) деятельность по управлению ценными бумагами, и (или)"
				+ " депозитарную деятельность)", "Лист2", "П000Л2ВОФР003", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Сведения о счете: некорректно задан вид организации финансового рынка (профессиональный участник"
				+ " рынка ценных бумаг, осуществляющий брокерскую деятельность, и (или) деятельность по управлению ценными"
				+ " бумагами, и (или) депозитарную деятельность). Возможны значения: 0, 1", "Лист2", "П000Л2ВОФР003", НомСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			ЗначПок = СокрЛП(Ветка.Данные["П000Л2ВОФР004"]);
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Сведения о счете: не задан вид организации финансового рынка (управляющий по договору доверительного"
				+ " управления имуществом)", "Лист2", "П000Л2ВОФР004", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Сведения о счете: некорректно задан вид организации финансового рынка (управляющий по договору"
			...
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Сведения о счете: не задан вид организации финансового рынка (негосударственный пенсионный фонд)",
				"Лист2", "П000Л2ВОФР005", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Сведения о счете: некорректно задан вид организации финансового рынка (негосударственный пенсионный"
				+ " фонд). Возможны значения: 0, 1", "Лист2", "П000Л2ВОФР005", НомСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			ЗначПок = СокрЛП(Ветка.Данные["П000Л2ВОФР006"]);
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Сведения о счете: не задан вид организации финансового рынка (акционерный инвестиционный фонд)",
				"Лист2", "П000Л2ВОФР006", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Сведения о счете: некорректно задан вид организации финансового рынка (акционерный инвестиционный"
				+ " фонд). Возможны значения: 0, 1", "Лист2", "П000Л2ВОФР006", НомСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			ЗначПок = СокрЛП(Ветка.Данные["П000Л2ВОФР007"]);
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Сведения о счете: не задан вид организации финансового рынка (управляющая компания инвестиционного"
				+ " фонда, паевого инвестиционного фонда или негосударственного пенсионного фонда)",
				"Лист2", "П000Л2ВОФР007", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Сведения о счете: некорректно задан вид организации финансового рынка (управляющая компания"
			...
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Сведения о счете: не задан вид организации финансового рынка (центральный контрагент)",
				"Лист2", "П000Л2ВОФР008", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Сведения о счете: некорректно задан вид организации финансового рынка (центральный контрагент)."
				+ " Возможны значения: 0, 1", "Лист2", "П000Л2ВОФР008", НомСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			ЗначПок = СокрЛП(Ветка.Данные["П000Л2ВОФР009"]);
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Сведения о счете: не задан вид организации финансового рынка (управляющий товарищ инвестиционного"
				+ " товарищества)", "Лист2", "П000Л2ВОФР009", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Сведения о счете: некорректно задан вид организации финансового рынка (управляющий товарищ"
			...
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Сведения о счете: не задан вид организации финансового рынка (иная организация или структура без"
				+ " образования юридического лица, которая в рамках своей деятельности принимает от клиентов денежные средства"
				+ " или иные финансовые активы для хранения, управления, инвестирования и (или) осуществления иных сделок в"
				+ " интересах клиента либо прямо или косвенно за счет клиента)", "Лист2", "П000Л2ВОФР010", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Сведения о счете: некорректно задан вид организации финансового рынка (иная организация или структура"
				+ " без образования юридического лица, которая в рамках своей деятельности принимает от клиентов денежные средства"
				+ " или иные финансовые активы для хранения, управления, инвестирования и (или) осуществления иных сделок в"
				+ " интересах клиента либо прямо или косвенно за счет клиента). Возможны значения: 0, 1",
		...
		Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
			СообщитьВТС("Сведения о счете: не задан номер счета", "Лист2", "П000Л20000009", НомСтраницы);
			СтатусПроверки = Ложь;
		ИначеЕсли НЕ СтроковыеФункцииКлиентСервер.ТолькоЛатиницаВСтроке(ЗначПок, Истина, "0123456789") Тогда
			СообщитьВТС("Сведения о счете: номер счета должен быть заполнен только цифрами и буквами латинского алфавита",
		...
		Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
			СообщитьВТС("Сведения о счете: не задана дата открытия счета", "Лист2", "П000Л20000010", НомСтраницы);
			СтатусПроверки = Ложь;
		ИначеЕсли НЕ ДатаВходитВРазрешенныйПериод(ЗначПок) Тогда
			СообщитьВТС("Сведения о счете: задана дата открытия счета, выходящая за пределы периода с 01.01.1900 по 31.12.2099",
		...
		Иначе
			...
			Если ЗначениеЗаполнено(ЗначПок_) И ДатаВходитВРазрешенныйПериод(ЗначПок_) И (ЗначПок_ < ЗначПок) Тогда
				СообщитьВТС("Сведения о счете: дата закрытия счета не должна быть меньше даты открытия счета",
		...
		Если ЗначениеЗаполнено(ЗначПок) И НЕ ДатаВходитВРазрешенныйПериод(ЗначПок) Тогда
			СообщитьВТС("Сведения о счете: задана дата закрытия счета, выходящая за пределы периода с 01.01.1900 по 31.12.2099",
			"Лист2", "П000Л20000011", НомСтраницы);
			СтатусПроверки = Ложь;
		КонецЕсли;
	...
	// Листы 6, 7.
	//
	ДеревоРаздела = СохрСтруктура.ДанныеМногоуровневыхРазделов["Листы6_7"];
	
	ЗаполненыЛисты6_7 = ЗаполненРаздел(ДеревоРаздела, "Листы6_7");
	
	Если ЗаполненыЛисты6_7 Тогда
		...
		Для каждого Ветка Из ДеревоРаздела.Строки Цикл
			...
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				...
				"Листы6_7", "П000Л60000001", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли СтрДлина(ЗначПок) <> 3 Тогда
			...
			// Лист 7.
			//
			ЗначПок = СокрЛП(Ветка.Данные["П000Л7ВФА0001"]);
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": не задан вид иного финансового актива"
				+ " (ценные бумаги)", "Листы6_7", "П000Л7ВФА0001", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": некорректно задан вид иного финансового"
				+ " актива (ценные бумаги). Возможны значения: 0, 1", "Листы6_7", "П000Л7ВФА0001", НомСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			ЗначПок = СокрЛП(Ветка.Данные["П000Л7ВФА0002"]);
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": не задан вид иного финансового актива"
				+ " (производные финансовые инструменты)", "Листы6_7", "П000Л7ВФА0002", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": некорректно задан вид иного финансового"
				+ " актива (производные финансовые инструменты). Возможны значения: 0, 1",
				"Листы6_7", "П000Л7ВФА0002", НомСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			ЗначПок = СокрЛП(Ветка.Данные["П000Л7ВФА0003"]);
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": не задан вид иного финансового актива (доли"
				+ " участия в уставном (складочном) капитале юридического лица)", "Листы6_7", "П000Л7ВФА0003", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": некорректно задан вид иного финансового"
				+ " актива (доли участия в уставном (складочном) капитале юридического лица). Возможны значения: 0, 1",
				"Листы6_7", "П000Л7ВФА0003", НомСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			ЗначПок = СокрЛП(Ветка.Данные["П000Л7ВФА0004"]);
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": не задан вид иного финансового актива (доли"
				+ " участия в иностранной структуре без образования юридического лица)", "Листы6_7", "П000Л7ВФА0004", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": некорректно задан вид иного финансового"
				+ " актива (доли участия в иностранной структуре без образования юридического лица). Возможны значения: 0, 1",
				"Листы6_7", "П000Л7ВФА0004", НомСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			ЗначПок = СокрЛП(Ветка.Данные["П000Л7ВФА0005"]);
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": не задан вид иного финансового актива (права"
				+ " требования из договора страхования)", "Листы6_7", "П000Л7ВФА0005", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": некорректно задан вид иного финансового"
				+ " актива (права требования из договора страхования). Возможны значения: 0, 1",
				"Листы6_7", "П000Л7ВФА0005", НомСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			ЗначПок = СокрЛП(Ветка.Данные["П000Л7ВФА0006"]);
			Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
				СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": не задан вид иного финансового актива (иные"
				+ " финансовые активы, не включенные в вышеуказанный перечень)", "Листы6_7", "П000Л7ВФА0006", НомСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли ЗначПок <> "0" И ЗначПок <> "1" Тогда
				СообщитьВТС("Иные финансовые активы -> Страница " + НомСтраницы + ": некорректно задан вид иного финансового"
				+ " актива (иные финансовые активы, не включенные в вышеуказанный перечень). Возможны значения: 0, 1",
				"Листы6_7", "П000Л7ВФА0006", НомСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
	...
	Если НЕ ЗаполненыЛисты3_5 И НЕ ЗаполненыЛисты6_7 Тогда
...
Процедура ВывестиНаПечатьДанныеМногоуровневогоРаздела(СтруктураПараметров, ОбщиеРеквизитыРазделов, СтрПоля)
	...
	ИначеЕсли ИмяТекРаздела = "Листы6_7" Тогда
...
Процедура АктивизироватьЯчейку(Ячейка) Экспорт
	...
	Если Ячейка.Раздел = "Лист2" Тогда
	...
	ИначеЕсли Ячейка.Раздел = "Листы3_5" ИЛИ Ячейка.Раздел = "Листы6_7" Тогда
