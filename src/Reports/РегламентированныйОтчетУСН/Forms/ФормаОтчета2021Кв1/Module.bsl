...
Процедура СформироватьДанныеОтчета(ОтчетСсылка, СтруктураОтчета)
	...
	Для каждого Элемент Из СтруктураРазделов Цикл
		...
		ДанныеКС[Элемент.Значение].Вставить("Страница", 1);
...
Процедура СформироватьСлужебныеДанные()
	...
	ПредставлениеРазделов.Вставить("Р21", "Раздела 2.1.1");
	ПредставлениеРазделов.Вставить("Р22", "Раздела 2.1.2");
	ПредставлениеРазделов.Вставить("Р23", "Раздела 2.2");
	...
	РазделыПоказателей.Вставить("Р22", "Раздел21");
	РазделыПоказателей.Вставить("Р23", "Раздел22");
...
&НаСервере
Функция КолвоСтрокМнЧ(Источник, ИмяПоля)
	
	Счетчик = 0;
	
	Пока Источник.Свойство(ИмяПоля + (Счетчик + 1)) Цикл 
		Счетчик = Счетчик + 1;
	КонецЦикла; 
...
&НаСервере
Процедура ПроверкаКС_1_00()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.0';
													|en = '1.0'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1.1';
														|en = 'Раздел 1.1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.3, 3.1, 8 ст.346.21 НК РФ';
													|en = 'п.3, 3.1, 8 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.020 Раздела 1.1 = (стр.130 - стр.140) Раздела 2.1.1 - стр.160 ';
			|en = 'Сумма авансового платежа в стр.020 Раздела 1.1 = (стр.130 - стр.140) Раздела 2.1.1 - стр.160 '") +
		НСтр("ru = 'Раздела 2.1.2, если результат вычисления >= 0';
			|en = 'Раздела 2.1.2, если результат вычисления >= 0'"));
...
Процедура ПроверкаКС_1_01()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.3, 3.1, 8 ст.346.21 НК РФ';
													|en = 'п.3, 3.1, 8 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.020 Раздела 1.1 = 0, если (стр.130 - стр.140) Раздела 2.1.1 - стр.160 ';
			|en = 'Сумма авансового платежа в стр.020 Раздела 1.1 = 0, если (стр.130 - стр.140) Раздела 2.1.1 - стр.160 '") +
		НСтр("ru = 'Раздела 2.1.2 < 0';
			|en = 'Раздела 2.1.2 < 0'"));
...
&НаСервере
Процедура ПроверкаКС_1_01_код(Настройки)
	
	Перем Показатели;
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р11С020"		, "П000110002003");
	ИменаПоказателей.Вставить("Р21С130"		, "П002110013003");
	ИменаПоказателей.Вставить("Р21С140"		, "П002110014003");
	ИменаПоказателей.Вставить("Р22С160"		, "П002120016003");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	
	Показатели.Р21С130.Округление = Истина;
	Показатели.Р21С140.Округление = Истина;
	Показатели.Р22С160.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С020, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р21С130, ДанныеКС.Раздел21);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р21С140, ДанныеКС.Раздел21);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р22С160, ДанныеКС.Раздел21);
	
	РасчетнаяСумма = Показатели.Р21С130.Значение - Показатели.Р21С140.Значение - Показатели.Р22С160.Значение;
	РасчетнаяСумма2 = Макс(0, РасчетнаяСумма);
	УсловиеВыполнено = ?(Настройки.НомерКС = "1.0", РасчетнаяСумма >=0, РасчетнаяСумма < 0);
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р11С020.Значение = РасчетнаяСумма2;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р11С020.Значение, Показатели.Р21С130.Значение, Показатели.Р21С140.Значение, Показатели.Р22С160.Значение,
		РасчетнаяСумма);
...
Процедура ПроверкаКС_1_02()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.3, 3.1, 8 ст.346.21 НК РФ';
													|en = 'п.3, 3.1, 8 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.040 Раздела 1.1 = (стр.131 - стр.141) Раздела 2.1.1 - стр.161 ';
			|en = 'Сумма авансового платежа в стр.040 Раздела 1.1 = (стр.131 - стр.141) Раздела 2.1.1 - стр.161 '") +
		НСтр("ru = 'Раздела 2.1.2 - стр.020 Раздела 1.1, если результат вычисления >= 0';
			|en = 'Раздела 2.1.2 - стр.020 Раздела 1.1, если результат вычисления >= 0'"));
...
Процедура ПроверкаКС_1_03()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.3, 3.1, 8 ст.346.21 НК РФ';
													|en = 'п.3, 3.1, 8 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.040 Раздела 1.1 = 0, если (стр.131 - стр.141) Раздела 2.1.1 - стр.161 ';
			|en = 'Сумма авансового платежа в стр.040 Раздела 1.1 = 0, если (стр.131 - стр.141) Раздела 2.1.1 - стр.161 '") +
		НСтр("ru = 'Раздела 2.1.2 - стр.020 Раздела 1.1 < 0';
			|en = 'Раздела 2.1.2 - стр.020 Раздела 1.1 < 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = 0';
													|en = '%1 = 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
...
&НаСервере
Процедура ПроверкаКС_1_03_код(Настройки)
	
	Перем Показатели;
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р11С040"		, "П000110004003");
	ИменаПоказателей.Вставить("Р21С131"		, "П002110013103");
	ИменаПоказателей.Вставить("Р21С141"		, "П002110014103");
	ИменаПоказателей.Вставить("Р22С161"		, "П002120016103");
	ИменаПоказателей.Вставить("Р11С020"		, "П000110002003");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	
	Показатели.Р21С131.Округление = Истина;
	Показатели.Р21С141.Округление = Истина;
	Показатели.Р22С161.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С040, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р21С131, ДанныеКС.Раздел21);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р21С141, ДанныеКС.Раздел21);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р22С161, ДанныеКС.Раздел21);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С020, ДанныеКС.Раздел11);
	
	РасчетнаяСумма = Показатели.Р21С131.Значение - Показатели.Р21С141.Значение - Показатели.Р22С161.Значение -
		Показатели.Р11С020.Значение;
	РасчетнаяСумма2 = Макс(0, РасчетнаяСумма);
	УсловиеВыполнено = ?(Настройки.НомерКС = "1.2", РасчетнаяСумма >=0, РасчетнаяСумма < 0);
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р11С040.Значение = РасчетнаяСумма2;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р11С040.Значение, Показатели.Р21С131.Значение, Показатели.Р21С141.Значение, Показатели.Р22С161.Значение,
		Показатели.Р11С020.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_04()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1.1';
														|en = 'Раздел 1.1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.3, 3.1, 5, 8 ст.346.21 НК РФ';
													|en = 'п.3, 3.1, 5, 8 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.050 Раздела 1.1 = стр.020 Раздела 1.1 - ((стр.131 - стр.141) ';
			|en = 'Сумма авансового платежа в стр.050 Раздела 1.1 = стр.020 Раздела 1.1 - ((стр.131 - стр.141) '") +
		НСтр("ru = 'Раздела 2.1.1 - стр.161 Раздела 2.1.2), если результат вычисления > 0';
			|en = 'Раздела 2.1.1 - стр.161 Раздела 2.1.2), если результат вычисления > 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - (%3 - %4 - %5) Итог [%6]';
													|en = '%1 = %2 - (%3 - %4 - %5) Итог [%6]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
	...
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С050, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С020, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р21С131, ДанныеКС.Раздел21);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р21С141, ДанныеКС.Раздел21);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р22С161, ДанныеКС.Раздел21);
	
	РасчетнаяСумма = Показатели.Р11С020.Значение - Показатели.Р21С131.Значение + Показатели.Р21С141.Значение + 
		Показатели.Р22С161.Значение;
	Настройки.ЭтоОшибка = РасчетнаяСумма > 0 И НЕ Показатели.Р11С050.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р11С050.Значение, Показатели.Р11С020.Значение, Показатели.Р21С131.Значение, Показатели.Р21С141.Значение, 
		Показатели.Р22С161.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_05()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.3, 3.1, 5, 8 ст.346.21 НК РФ';
													|en = 'п.3, 3.1, 5, 8 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.070 Раздела 1.1 = (стр.132 - стр.142) Раздела 2.1.1 - стр.162 ';
			|en = 'Сумма авансового платежа в стр.070 Раздела 1.1 = (стр.132 - стр.142) Раздела 2.1.1 - стр.162 '") +
		НСтр("ru = 'Раздела 2.1.2 - (стр.020 + стр.040 - стр.050) Раздела 1.1, если результат вычисления >= 0';
			|en = 'Раздела 2.1.2 - (стр.020 + стр.040 - стр.050) Раздела 1.1, если результат вычисления >= 0'"));
...
Процедура ПроверкаКС_1_06()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.3, 3.1, 5, 8 ст.346.21 НК РФ';
													|en = 'п.3, 3.1, 5, 8 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.070 Раздела 1.1 = 0, если (стр.132 - стр.142) Раздела 2.1.1 ';
			|en = 'Сумма авансового платежа в стр.070 Раздела 1.1 = 0, если (стр.132 - стр.142) Раздела 2.1.1 '") +
		НСтр("ru = '- стр.162 Раздела 2.1.2 - (стр.020 + стр.040 - стр.050) Раздела 1.1 < 0';
			|en = '- стр.162 Раздела 2.1.2 - (стр.020 + стр.040 - стр.050) Раздела 1.1 < 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = 0';
													|en = '%1 = 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
...
Процедура ПроверкаКС_1_06_код(Настройки)
	...
	ИменаПоказателей.Вставить("Р21С132"		, "П002110013203");
	ИменаПоказателей.Вставить("Р21С142"		, "П002110014203");
	ИменаПоказателей.Вставить("Р22С162"		, "П002120016203");
	ИменаПоказателей.Вставить("Р11С020"		, "П000110002003");
	ИменаПоказателей.Вставить("Р11С040"		, "П000110004003");
	ИменаПоказателей.Вставить("Р11С050"		, "П000110005003");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	
	Показатели.Р21С132.Округление = Истина;
	Показатели.Р21С142.Округление = Истина;
	Показатели.Р22С162.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С070, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р21С132, ДанныеКС.Раздел21);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р21С142, ДанныеКС.Раздел21);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р22С162, ДанныеКС.Раздел21);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С020, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С040, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С050, ДанныеКС.Раздел11);
	
	РасчетнаяСумма = Показатели.Р21С132.Значение - Показатели.Р21С142.Значение - Показатели.Р22С162.Значение -
		Показатели.Р11С020.Значение - Показатели.Р11С040.Значение + Показатели.Р11С050.Значение;
	РасчетнаяСумма2 = Макс(0, РасчетнаяСумма);
	УсловиеВыполнено = ?(Настройки.НомерКС = "1.5", РасчетнаяСумма >=0, РасчетнаяСумма < 0);
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р11С070.Значение = РасчетнаяСумма2;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р11С070.Значение, Показатели.Р21С132.Значение, Показатели.Р21С142.Значение, Показатели.Р22С162.Значение,
		Показатели.Р11С020.Значение, Показатели.Р11С040.Значение, Показатели.Р11С050.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_07()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.3, 3.1, 5, 8 ст.346.21 НК РФ';
													|en = 'п.3, 3.1, 5, 8 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.080 Раздела 1.1 = (стр.020 + стр.040 - стр.050) Раздела 1.1 - ';
			|en = 'Сумма авансового платежа в стр.080 Раздела 1.1 = (стр.020 + стр.040 - стр.050) Раздела 1.1 - '") +
		НСтр("ru = '((стр.132 - стр.142) Раздела 2.1.1 - стр.162 Раздела 2.1.2), если результат вычисления > 0';
			|en = '((стр.132 - стр.142) Раздела 2.1.1 - стр.162 Раздела 2.1.2), если результат вычисления > 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 + %3 - %4 - (%5 - %6 - %7) Итог [%8]';
													|en = '%1 = %2 + %3 - %4 - (%5 - %6 - %7) Итог [%8]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
	...
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С080, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С020, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С040, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С050, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р21С132, ДанныеКС.Раздел21);
	...
	РасчетнаяСумма = Показатели.Р11С020.Значение + Показатели.Р11С040.Значение - Показатели.Р11С050.Значение -  
		Показатели.Р21С132.Значение + Показатели.Р21С142.Значение + Показатели.Р22С162.Значение;
	Настройки.ЭтоОшибка = РасчетнаяСумма > 0 И НЕ Показатели.Р11С080.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р11С080.Значение, Показатели.Р11С020.Значение, Показатели.Р11С040.Значение, Показатели.Р11С050.Значение,  
		Показатели.Р21С132.Значение, Показатели.Р21С142.Значение, Показатели.Р22С162.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_08()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1.1';
														|en = 'Раздел 1.1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.3.1, 5, 8 ст.346.21 НК РФ';
													|en = 'п.3.1, 5, 8 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.100 Раздела 1.1 = (стр.133 - стр.143) Раздела 2.1.1 - стр.163 Раздела 2.1.2 - ';
			|en = 'Сумма налога в стр.100 Раздела 1.1 = (стр.133 - стр.143) Раздела 2.1.1 - стр.163 Раздела 2.1.2 - '") +
		НСтр("ru = '(стр.020 + стр.040 - стр.050 + стр.070 - стр.080 + стр.101) Раздела 1.1, ';
			|en = '(стр.020 + стр.040 - стр.050 + стр.070 - стр.080 + стр.101) Раздела 1.1, '") +
		НСтр("ru = 'если результат вычисления >= 0';
			|en = 'если результат вычисления >= 0'"));
...
Процедура ПроверкаКС_1_09()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.3.1, 5, 8 ст.346.21 НК РФ';
													|en = 'п.3.1, 5, 8 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.100 Раздела 1.1 = 0, если (стр.133 - стр.143) Раздела 2.1.1 - стр.163 ';
			|en = 'Сумма налога в стр.100 Раздела 1.1 = 0, если (стр.133 - стр.143) Раздела 2.1.1 - стр.163 '") +
		НСтр("ru = 'Раздела 2.1.2 - (стр.020 + стр.040 - стр.050 + стр.070 - стр.080 + стр.101) Раздела 1.1 < 0';
			|en = 'Раздела 2.1.2 - (стр.020 + стр.040 - стр.050 + стр.070 - стр.080 + стр.101) Раздела 1.1 < 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = 0';
													|en = '%1 = 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_09_код(Настройки)
	...
	ИменаПоказателей.Вставить("Р21С133"		, "П002110013303");
	ИменаПоказателей.Вставить("Р21С143"		, "П002110014303");
	ИменаПоказателей.Вставить("Р22С163"		, "П002120016303");
	ИменаПоказателей.Вставить("Р11С020"		, "П000110002003");
	ИменаПоказателей.Вставить("Р11С040"		, "П000110004003");
	ИменаПоказателей.Вставить("Р11С050"		, "П000110005003");
	ИменаПоказателей.Вставить("Р11С070"		, "П000110007003");
	...
	Показатели.Р21С133.Округление = Истина;
	Показатели.Р21С143.Округление = Истина;
	Показатели.Р22С163.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С100, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р21С133, ДанныеКС.Раздел21);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р21С143, ДанныеКС.Раздел21);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р22С163, ДанныеКС.Раздел21);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С020, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С040, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С050, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С070, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С080, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С101, ДанныеКС.Раздел11);
	
	РасчетнаяСумма = Показатели.Р21С133.Значение - Показатели.Р21С143.Значение - Показатели.Р22С163.Значение -
		Показатели.Р11С020.Значение - Показатели.Р11С040.Значение + Показатели.Р11С050.Значение - 
		Показатели.Р11С070.Значение + Показатели.Р11С080.Значение - Показатели.Р11С101.Значение;
	РасчетнаяСумма2 = Макс(0, РасчетнаяСумма);
	УсловиеВыполнено = ?(Настройки.НомерКС = "1.8", РасчетнаяСумма >=0, РасчетнаяСумма < 0);
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р11С100.Значение = РасчетнаяСумма2;
	ШаблонРасшифровки2 = ПодставитьПараметрыВСтроку("%1 - %2 - %3", Показатели.Р21С133.Значение, 
		Показатели.Р21С143.Значение, Показатели.Р22С163.Значение);
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р11С100.Значение, ШаблонРасшифровки2, Показатели.Р11С020.Значение, Показатели.Р11С040.Значение, 
		Показатели.Р11С050.Значение, Показатели.Р11С070.Значение, Показатели.Р11С080.Значение, 
		Показатели.Р11С101.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_10()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.3.1, 5, 8 ст.346.21 НК РФ';
													|en = 'п.3.1, 5, 8 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.110 Раздела 1.1 = (стр.020 + стр.040 - стр.050 + стр.070 - стр.080) Раздела 1.1 - ';
			|en = 'Сумма налога в стр.110 Раздела 1.1 = (стр.020 + стр.040 - стр.050 + стр.070 - стр.080) Раздела 1.1 - '") +
		НСтр("ru = '((стр.133 - стр.143) Раздела 2.1.1 - стр.163 Раздела 2.1.2), если результат вычисления > 0';
			|en = '((стр.133 - стр.143) Раздела 2.1.1 - стр.163 Раздела 2.1.2), если результат вычисления > 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 + %3 - %4 + %5 - %6 - (%7) Итог [%8]';
													|en = '%1 = %2 + %3 - %4 + %5 - %6 - (%7) Итог [%8]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	...
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С110, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С020, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С040, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С050, ДанныеКС.Раздел11);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р11С070, ДанныеКС.Раздел11);
	...
	РасчетнаяСумма = Показатели.Р11С020.Значение + Показатели.Р11С040.Значение - Показатели.Р11С050.Значение +  
		Показатели.Р11С070.Значение - Показатели.Р11С080.Значение - Показатели.Р21С133.Значение + 
		Показатели.Р21С143.Значение + Показатели.Р22С163.Значение;
	Настройки.ЭтоОшибка = РасчетнаяСумма > 0 И НЕ Показатели.Р11С110.Значение = РасчетнаяСумма;
	ШаблонРасшифровки2 = ПодставитьПараметрыВСтроку("%1 - %2 - %3", Показатели.Р21С133.Значение, 
		Показатели.Р21С143.Значение, Показатели.Р22С163.Значение);
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р11С110.Значение, Показатели.Р11С020.Значение, Показатели.Р11С040.Значение, Показатели.Р11С050.Значение,  
		Показатели.Р11С070.Значение, Показатели.Р11С080.Значение, ШаблонРасшифровки2, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_11()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1.2';
														|en = 'Раздел 1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.4 ст.346.21 НК РФ';
													|en = 'п.4 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.020 Раздела 1.2 = стр.270 Раздела 2.2, если стр.270 Раздела 2.2 >= 0';
			|en = 'Сумма авансового платежа в стр.020 Раздела 1.2 = стр.270 Раздела 2.2, если стр.270 Раздела 2.2 >= 0'"));
	...
	ИменаПоказателей.Вставить("Р23С270"		, "П000220027003");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	Показатели.Р23С270.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С020, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р23С270, ДанныеКС.Раздел22);
	
	Настройки.ЭтоОшибка = Показатели.Р23С270.Значение >= 0 И НЕ Показатели.Р12С020.Значение = Показатели.Р23С270.Значение;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р12С020.Значение, 
		Показатели.Р23С270.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_12()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.4 ст.346.21 НК РФ';
													|en = 'п.4 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.020 Раздела 1.2 = 0, если стр.210 Раздела 2.2 = стр.220 Раздела 2.2';
			|en = 'Сумма авансового платежа в стр.020 Раздела 1.2 = 0, если стр.210 Раздела 2.2 = стр.220 Раздела 2.2'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р12С020"		, "П000120002003");
	ИменаПоказателей.Вставить("Р23С210"		, "П000220021003");
	ИменаПоказателей.Вставить("Р23С220"		, "П000220022003");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	
	Показатели.Р23С210.Округление = Истина;
	Показатели.Р23С220.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С020, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р23С210, ДанныеКС.Раздел22);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р23С220, ДанныеКС.Раздел22);
	
	Настройки.ЭтоОшибка = Показатели.Р23С210.Значение = Показатели.Р23С220.Значение И НЕ Показатели.Р12С020.Значение = 0;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р12С020.Значение, 
		Показатели.Р23С210.Значение, Показатели.Р23С220.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_13()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1.2';
														|en = 'Раздел 1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.4, 5 ст.346.21 НК РФ';
													|en = 'п.4, 5 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.040 Раздела 1.2 = стр.271 Раздела 2.2 - стр.020 Раздела 1.2, ';
			|en = 'Сумма авансового платежа в стр.040 Раздела 1.2 = стр.271 Раздела 2.2 - стр.020 Раздела 1.2, '") +
		НСтр("ru = 'если результат вычисления >= 0';
			|en = 'если результат вычисления >= 0'"));
...
Процедура ПроверкаКС_1_14()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.4, 5 ст.346.21 НК РФ';
													|en = 'п.4, 5 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.040 Раздела 1.2 = 0, если стр.271 Раздела 2.2 - стр.020 ';
			|en = 'Сумма авансового платежа в стр.040 Раздела 1.2 = 0, если стр.271 Раздела 2.2 - стр.020 '") +
		НСтр("ru = 'Раздела 1.2 < 0';
			|en = 'Раздела 1.2 < 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = 0';
													|en = '%1 = 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
...
Процедура ПроверкаКС_1_14_код(Настройки)
	...
	ИменаПоказателей.Вставить("Р23С271"		, "П000220027103");
	ИменаПоказателей.Вставить("Р12С020"		, "П000120002003");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	Показатели.Р23С271.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С040, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р23С271, ДанныеКС.Раздел22);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С020, ДанныеКС.Раздел12);
	
	РасчетнаяСумма = Показатели.Р23С271.Значение - Показатели.Р12С020.Значение;
	РасчетнаяСумма2 = Макс(0, РасчетнаяСумма);
	УсловиеВыполнено = ?(Настройки.НомерКС = "1.13", РасчетнаяСумма >=0, РасчетнаяСумма < 0);
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р12С040.Значение = РасчетнаяСумма2;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р12С040.Значение, Показатели.Р23С271.Значение, Показатели.Р12С020.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_15()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.4, 5 ст.346.21 НК РФ';
													|en = 'п.4, 5 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.050 Раздела 1.2 = стр.020 Раздела 1.2 - стр.271 ';
			|en = 'Сумма авансового платежа в стр.050 Раздела 1.2 = стр.020 Раздела 1.2 - стр.271 '") +
		НСтр("ru = 'Раздела 2.2, если результат вычисления > 0';
			|en = 'Раздела 2.2, если результат вычисления > 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - %3 Итог [%4]';
													|en = '%1 = %2 - %3 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
	...
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С050, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С020, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р23С271, ДанныеКС.Раздел22);
	
	РасчетнаяСумма = Показатели.Р12С020.Значение - Показатели.Р23С271.Значение;
	Настройки.ЭтоОшибка = РасчетнаяСумма > 0 И НЕ Показатели.Р12С050.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р12С050.Значение, 
		Показатели.Р12С020.Значение, Показатели.Р23С271.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_16()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.4, 5 ст.346.21 НК РФ';
													|en = 'п.4, 5 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.070 Раздела 1.2 = стр.272 Раздела 2.2 - (стр.020 + стр.040 - ';
			|en = 'Сумма авансового платежа в стр.070 Раздела 1.2 = стр.272 Раздела 2.2 - (стр.020 + стр.040 - '") +
		НСтр("ru = 'стр.050) Раздела 1.2, если результат вычисления >= 0';
			|en = 'стр.050) Раздела 1.2, если результат вычисления >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - (%3 + %4 - %5) Итог [%6]';
													|en = '%1 = %2 - (%3 + %4 - %5) Итог [%6]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
...
Процедура ПроверкаКС_1_17()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.4, 5 ст.346.21 НК РФ';
													|en = 'п.4, 5 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.070 Раздела 1.2 = 0, если стр.272 Раздела 2.2 - ';
			|en = 'Сумма авансового платежа в стр.070 Раздела 1.2 = 0, если стр.272 Раздела 2.2 - '") +
		НСтр("ru = '(стр.020 + стр.040 - стр.050) Раздела 1.2 < 0';
			|en = '(стр.020 + стр.040 - стр.050) Раздела 1.2 < 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = 0';
													|en = '%1 = 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
...
Процедура ПроверкаКС_1_17_код(Настройки)
	...
	ИменаПоказателей.Вставить("Р23С272"		, "П000220027203");
	ИменаПоказателей.Вставить("Р12С020"		, "П000120002003");
	ИменаПоказателей.Вставить("Р12С040"		, "П000120004003");
	ИменаПоказателей.Вставить("Р12С050"		, "П000120005003");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	Показатели.Р23С272.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С070, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р23С272, ДанныеКС.Раздел22);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С020, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С040, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С050, ДанныеКС.Раздел12);
	
	РасчетнаяСумма = Показатели.Р23С272.Значение - Показатели.Р12С020.Значение - Показатели.Р12С040.Значение + 
		Показатели.Р12С050.Значение;
	РасчетнаяСумма2 = Макс(0, РасчетнаяСумма);
	УсловиеВыполнено = ?(Настройки.НомерКС = "1.16", РасчетнаяСумма >=0, РасчетнаяСумма < 0);
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р12С070.Значение = РасчетнаяСумма2;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р12С070.Значение, Показатели.Р23С272.Значение, Показатели.Р12С020.Значение, 
		Показатели.Р12С040.Значение, Показатели.Р12С050.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_18()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.4, 5 ст.346.21 НК РФ';
													|en = 'п.4, 5 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.080 Раздела 1.2 = (стр.020 + стр.040 - стр.050) Раздела 1.1 - ';
			|en = 'Сумма авансового платежа в стр.080 Раздела 1.2 = (стр.020 + стр.040 - стр.050) Раздела 1.1 - '") +
		НСтр("ru = 'стр.272 Раздела 2.2, если результат вычисления > 0';
			|en = 'стр.272 Раздела 2.2, если результат вычисления > 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 + %3 - %4 - %5 Итог [%6]';
													|en = '%1 = %2 + %3 - %4 - %5 Итог [%6]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
	...
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С080, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С020, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С040, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С050, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р23С272, ДанныеКС.Раздел22);
	
	РасчетнаяСумма = Показатели.Р12С020.Значение + Показатели.Р12С040.Значение - Показатели.Р12С050.Значение -  
		Показатели.Р23С272.Значение;
	Настройки.ЭтоОшибка = РасчетнаяСумма > 0 И НЕ Показатели.Р12С080.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р12С080.Значение, Показатели.Р12С020.Значение, Показатели.Р12С040.Значение, 
		Показатели.Р12С050.Значение, Показатели.Р23С272.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_19()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1.2';
														|en = 'Раздел 1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.5 ст.346.21 НК РФ';
													|en = 'п.5 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.100 Раздела 1.2 = стр.273 Раздела 2.2 - (стр.020 + стр.040 - стр.050 + ';
			|en = 'Сумма налога в стр.100 Раздела 1.2 = стр.273 Раздела 2.2 - (стр.020 + стр.040 - стр.050 + '") +
		НСтр("ru = 'стр.070 - стр.080 + стр.101) Раздела 1.2, если результат вычисления >= 0 и стр.273 ';
			|en = 'стр.070 - стр.080 + стр.101) Раздела 1.2, если результат вычисления >= 0 и стр.273 '") +
		НСтр("ru = 'Раздела 2.2 >= стр.280 Раздела 2.2';
			|en = 'Раздела 2.2 >= стр.280 Раздела 2.2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - (%3) Итог [%4] и %2 >= %5';
													|en = '%1 = %2 - (%3) Итог [%4] и %2 >= %5'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_20()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.5 ст.346.21 НК РФ';
													|en = 'п.5 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.100 Раздела 1.2 = 0, если стр.273 Раздела 2.2 - (стр.020 + стр.040 - ';
			|en = 'Сумма налога в стр.100 Раздела 1.2 = 0, если стр.273 Раздела 2.2 - (стр.020 + стр.040 - '") +
		НСтр("ru = 'стр.050 + стр.070 - стр.080 + стр.101) Раздела 1.2 < 0';
			|en = 'стр.050 + стр.070 - стр.080 + стр.101) Раздела 1.2 < 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = 0';
													|en = '%1 = 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
...
&НаСервере
Процедура ПроверкаКС_1_20_код(Настройки)
	
	Перем Показатели;
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р12С100"		, "П000120010003");
	ИменаПоказателей.Вставить("Р23С273"		, "П000220027303");
	ИменаПоказателей.Вставить("Р12С020"		, "П000120002003");
	ИменаПоказателей.Вставить("Р12С040"		, "П000120004003");
	ИменаПоказателей.Вставить("Р12С050"		, "П000120005003");
	ИменаПоказателей.Вставить("Р12С070"		, "П000120007003");
	...
	ИменаПоказателей.Вставить("Р23С280"		, "П000220028003");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	Показатели.Р23С273.Округление = Истина;
	Показатели.Р23С280.Округление = Истина;
	Показатели.Р23С280.Расшифровывать = Настройки.НомерКС = "1.19";
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С100, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р23С273, ДанныеКС.Раздел22);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С020, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С040, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С050, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С070, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С080, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С101, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р23С280, ДанныеКС.Раздел22);
	
	РасчетнаяСумма = Показатели.Р23С273.Значение - Показатели.Р12С020.Значение - Показатели.Р12С040.Значение + 
		Показатели.Р12С050.Значение - Показатели.Р12С070.Значение + Показатели.Р12С080.Значение - 
		Показатели.Р12С101.Значение;
	РасчетнаяСумма2 = Макс(0, РасчетнаяСумма);
	УсловиеВыполнено = ?(Настройки.НомерКС = "1.19", РасчетнаяСумма >= 0 И Показатели.Р23С273.Значение >= 
		Показатели.Р23С280.Значение, РасчетнаяСумма < 0);
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р12С100.Значение = РасчетнаяСумма2;
	ШаблонРасшифровки2 = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку("%1 + %2 - %3 + %4 - %5 + %6",
	    Показатели.Р12С020.Значение, Показатели.Р12С040.Значение, Показатели.Р12С050.Значение, 
		Показатели.Р12С070.Значение, Показатели.Р12С080.Значение, Показатели.Р12С101.Значение); 
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р12С100.Значение, Показатели.Р23С273.Значение, ШаблонРасшифровки2, 
		РасчетнаяСумма, Показатели.Р23С280.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_21()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.5 ст.346.21 НК РФ';
													|en = 'п.5 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.110 Раздела 1.2 = (стр.020 + стр.040 - стр.050 + стр.070 - стр.080) Раздела 1.1 - ';
			|en = 'Сумма налога в стр.110 Раздела 1.2 = (стр.020 + стр.040 - стр.050 + стр.070 - стр.080) Раздела 1.1 - '") +
		НСтр("ru = 'стр.273 Раздела 2.2, если результат вычисления > 0 и стр.273 Раздела 2.2 >= стр.280 Раздела 2.2 или ';
			|en = 'стр.273 Раздела 2.2, если результат вычисления > 0 и стр.273 Раздела 2.2 >= стр.280 Раздела 2.2 или '") +
		НСтр("ru = '(стр.020 + стр.040 - стр.050 + стр.070 - стр.080) Раздела 1.1 - стр.280 Раздела 2.2, если ';
			|en = '(стр.020 + стр.040 - стр.050 + стр.070 - стр.080) Раздела 1.1 - стр.280 Раздела 2.2, если '") +
		НСтр("ru = 'результат вычисления > 0 и стр.273 Раздела 2.2 < стр.280 Раздела 2.2';
			|en = 'результат вычисления > 0 и стр.273 Раздела 2.2 < стр.280 Раздела 2.2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = (%2) - %3 Итог [%4] и %3 >= %5 или %1 = (%2) - %5 Итог [%6] и %3 < %5';
			|en = '%1 = (%2) - %3 Итог [%4] и %3 >= %5 или %1 = (%2) - %5 Итог [%6] и %3 < %5'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С110, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С020, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С040, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С050, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С070, ДанныеКС.Раздел12);
	...
	Многочлен = Показатели.Р12С020.Значение + Показатели.Р12С040.Значение - Показатели.Р12С050.Значение +
	    Показатели.Р12С070.Значение - Показатели.Р12С080.Значение;
	РасчетнаяСумма1 = Многочлен - Показатели.Р23С273.Значение;
	РасчетнаяСумма2 = Многочлен - Показатели.Р23С280.Значение;
	Условие1Выполнено = Показатели.Р23С273.Значение >= Показатели.Р23С280.Значение И РасчетнаяСумма1 > 0;
	Условие2Выполнено = Показатели.Р23С273.Значение < Показатели.Р23С280.Значение И РасчетнаяСумма2 > 0;
	Настройки.ЭтоОшибка = Условие1Выполнено И НЕ Показатели.Р12С110.Значение = РасчетнаяСумма1 
		ИЛИ Условие2Выполнено И НЕ Показатели.Р12С110.Значение = РасчетнаяСумма2;
	ШаблонРасшифровки2 = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку("%1 + %2 - %3 + %4 - %5",
	    Показатели.Р12С020.Значение, Показатели.Р12С040.Значение, Показатели.Р12С050.Значение, 
		Показатели.Р12С070.Значение, Показатели.Р12С080.Значение); 
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р12С110.Значение, ШаблонРасшифровки2, Показатели.Р23С273.Значение, 
		РасчетнаяСумма1, Показатели.Р23С280.Значение, РасчетнаяСумма2);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_22()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.5 ст.346.21 НК РФ';
													|en = 'п.5 ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.120 Раздела 1.2 = стр.280 Раздела 2.2 - (стр.020 + стр.040 - стр.050 + ';
			|en = 'Сумма налога в стр.120 Раздела 1.2 = стр.280 Раздела 2.2 - (стр.020 + стр.040 - стр.050 + '") +
		НСтр("ru = 'стр.070 - стр.080 + стр.101) Раздела 1.2, если результат вычисления > 0 и стр.273 ';
			|en = 'стр.070 - стр.080 + стр.101) Раздела 1.2, если результат вычисления > 0 и стр.273 '") +
		НСтр("ru = 'Раздела 2.2 < стр.280 Раздела 2.2';
			|en = 'Раздела 2.2 < стр.280 Раздела 2.2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - (%3) Итог [%4] и %5 < %2';
													|en = '%1 = %2 - (%3) Итог [%4] и %5 < %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С120, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р23С280, ДанныеКС.Раздел22);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С020, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С040, ДанныеКС.Раздел12);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р12С050, ДанныеКС.Раздел12);
	...
	РасчетнаяСумма = Показатели.Р23С280.Значение - Показатели.Р12С020.Значение - Показатели.Р12С040.Значение + 
		Показатели.Р12С050.Значение - Показатели.Р12С070.Значение + Показатели.Р12С080.Значение - 
		Показатели.Р12С101.Значение;
	УсловиеВыполнено = РасчетнаяСумма > 0 И Показатели.Р23С273.Значение < Показатели.Р23С280.Значение;
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р12С120.Значение = РасчетнаяСумма;
	ШаблонРасшифровки2 = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку("%1 + %2 - %3 + %4 - %5 + %6",
	    Показатели.Р12С020.Значение, Показатели.Р12С040.Значение, Показатели.Р12С050.Значение, 
		Показатели.Р12С070.Значение, Показатели.Р12С080.Значение, Показатели.Р12С101.Значение); 
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р12С120.Значение, Показатели.Р23С280.Значение, ШаблонРасшифровки2, 
		РасчетнаяСумма, Показатели.Р23С273.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
...
#Область КС_Проверки_Раздела_2_1_1
...
Процедура ПроверкаКС_1_23()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.23';
													|en = '1.23'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение признака налогоплательщика в стр.102 Раздела 2.1.1 должно соответствовать списку ';
			|en = 'Значение признака налогоплательщика в стр.102 Раздела 2.1.1 должно соответствовать списку '") +
	...
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочное значение признака налогоплательщика';
														|en = 'Ошибочное значение признака налогоплательщика'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р21С102"		, "П002110010203");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	Список	= ДанныеКС.СоответствиеСписков.Получить(Показатели.Р21С102.ИмяПоказателя);
	
	Если НЕ Список = Неопределено Тогда
		ЗарегистрироватьФормулу(Настройки);
		ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел21);
		
		Настройки.ЭтоОшибка = Список.Получить(Показатели.Р21С102.Значение) = Неопределено;
		Настройки.Расшифровка = СтрЗаменить(Настройки.ШаблонРасшифровки, "%1", Показатели.Р21С102.ЗначениеСтр);
		ДополнитьСтруктуруОшибок(Настройки);
	КонецЕсли;
...
Процедура ПроверкаКС_1_24()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.130 Раздела 2.1.1 = стр.110 х стр.120 Раздела 2.1.1 / 100';
			|en = 'Сумма налога в стр.130 Раздела 2.1.1 = стр.110 х стр.120 Раздела 2.1.1 / 100'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р21С130"		, "П002110013003");
	ИменаПоказателей.Вставить("Р21С110"		, "П002110011003");
	ИменаПоказателей.Вставить("Р21С120"		, "П002110012003");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	Показатели.Р21С130.Округление = Истина;
	Показатели.Р21С110.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел21);
	
	РасчетнаяСумма = Окр(Показатели.Р21С110.Значение * Показатели.Р21С120.Значение / 100);
	...
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р21С130.Значение, 
		Показатели.Р21С110.Значение, Показатели.Р21С120.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_25а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.25.а';
													|en = '1.25.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
													|en = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.131 Раздела 2.1.1 = стр.111 х стр.121 Раздела 2.1.1 / 100, если стр.101 ';
			|en = 'Сумма налога в стр.131 Раздела 2.1.1 = стр.111 х стр.121 Раздела 2.1.1 / 100, если стр.101 '") +
		НСтр("ru = 'Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.121 Раздела 2.1.1 = стр.120 Раздела 2.1.1';
			|en = 'Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.121 Раздела 2.1.1 = стр.120 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6';
			|en = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р21С001"		, "П002110013103");
	ИменаПоказателей.Вставить("Р21С002"		, "П002110011103");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110012103");
	ИменаПоказателей.Вставить("Р21С004"		, "П002110010103");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110012003");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
	
	ПроверкаКС_1_27а_код(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_25б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.25.б';
													|en = '1.25.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.131 Раздела 2.1.1 = стр.130 + (стр.111 - стр.110) х стр.121 Раздела 2.1.1 ';
			|en = 'Сумма налога в стр.131 Раздела 2.1.1 = стр.130 + (стр.111 - стр.110) х стр.121 Раздела 2.1.1 '") +
		НСтр("ru = '/ 100, если стр.101 Раздела 2.1.1 = 2 и стр.121 Раздела 2.1.1 > стр.120 Раздела 2.1.1';
			|en = '/ 100, если стр.101 Раздела 2.1.1 = 2 и стр.121 Раздела 2.1.1 > стр.120 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8';
			|en = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р21С001"		, "П002110013103");
	ИменаПоказателей.Вставить("Р21С002"		, "П002110013003");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110011103");
	ИменаПоказателей.Вставить("Р21С004"		, "П002110011003");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110012103");
	ИменаПоказателей.Вставить("Р21С006"		, "П002110010103");
	ИменаПоказателей.Вставить("Р21С007"		, "П002110012003");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
	
	ПроверкаКС_1_27б_код(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_26а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.26.а';
													|en = '1.26.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
													|en = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'В редакции Письма ФНС России от 24.11.2021 N СД-4-3/16342@';
													|en = 'В редакции Письма ФНС России от 24.11.2021 N СД-4-3/16342@'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.132 Раздела 2.1.1 = стр.112 х стр.122 Раздела 2.1.1 / 100, если стр.101 ';
			|en = 'Сумма налога в стр.132 Раздела 2.1.1 = стр.112 х стр.122 Раздела 2.1.1 / 100, если стр.101 '") +
		НСтр("ru = 'Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.122 Раздела 2.1.1 = стр.120 Раздела 2.1.1';
			|en = 'Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.122 Раздела 2.1.1 = стр.120 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6';
			|en = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р21С001"		, "П002110013203");
	ИменаПоказателей.Вставить("Р21С002"		, "П002110011203");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110012203");
	ИменаПоказателей.Вставить("Р21С004"		, "П002110010103");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110012003");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_26б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.26.б';
													|en = '1.26.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.132 Раздела 2.1.1 = стр.131 + (стр.112 - стр.111) х стр.122 Раздела 2.1.1 ';
			|en = 'Сумма налога в стр.132 Раздела 2.1.1 = стр.131 + (стр.112 - стр.111) х стр.122 Раздела 2.1.1 '") +
		НСтр("ru = '/ 100, если стр.101 Раздела 2.1.1 = 2 и стр.122 Раздела 2.1.1 > стр.121 Раздела 2.1.1';
			|en = '/ 100, если стр.101 Раздела 2.1.1 = 2 и стр.122 Раздела 2.1.1 > стр.121 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8';
			|en = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р21С001"		, "П002110013203");
	ИменаПоказателей.Вставить("Р21С002"		, "П002110013103");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110011203");
	ИменаПоказателей.Вставить("Р21С004"		, "П002110011103");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110012203");
	ИменаПоказателей.Вставить("Р21С006"		, "П002110010103");
	ИменаПоказателей.Вставить("Р21С007"		, "П002110012103");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_26в()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.26.в';
													|en = '1.26.в'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.132 Раздела 2.1.1 = стр.130 + (стр.112 - стр.110) х стр.122 Раздела 2.1.1 ';
			|en = 'Сумма налога в стр.132 Раздела 2.1.1 = стр.130 + (стр.112 - стр.110) х стр.122 Раздела 2.1.1 '") +
		НСтр("ru = '/ 100, если стр.101 Раздела 2.1.1 = 2 и стр.122 Раздела 2.1.1 = стр.121 Раздела 2.1.1 и ';
			|en = '/ 100, если стр.101 Раздела 2.1.1 = 2 и стр.122 Раздела 2.1.1 = стр.121 Раздела 2.1.1 и '") + 
		НСтр("ru = 'стр.122 Раздела 2.1.1 > стр.120 Раздела 2.1.1';
			|en = 'стр.122 Раздела 2.1.1 > стр.120 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 = %8 и %5 > %9';
			|en = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 = %8 и %5 > %9'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	ИменаПоказателей.Вставить("Р21С006"		, "П002110010103");
	ИменаПоказателей.Вставить("Р21С007"		, "П002110012103");
	ИменаПоказателей.Вставить("Р21С008"		, "П002110012003");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
	
	ПроверкаКС_1_27г_код(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_27а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.27.а';
													|en = '1.27.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.133 Раздела 2.1.1 = стр.113 х стр.123 Раздела 2.1.1 / 100, если стр.101 ';
			|en = 'Сумма налога в стр.133 Раздела 2.1.1 = стр.113 х стр.123 Раздела 2.1.1 / 100, если стр.101 '") +
		НСтр("ru = 'Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 = стр.120 Раздела 2.1.1';
			|en = 'Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 = стр.120 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6';
			|en = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р21С001"		, "П002110013303");
	ИменаПоказателей.Вставить("Р21С002"		, "П002110011303");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110012303");
	ИменаПоказателей.Вставить("Р21С004"		, "П002110010103");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110012003");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_27б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.27.б';
													|en = '1.27.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.133 Раздела 2.1.1 = стр.132 + (стр.113 - стр.112) х стр.123 Раздела 2.1.1 ';
			|en = 'Сумма налога в стр.133 Раздела 2.1.1 = стр.132 + (стр.113 - стр.112) х стр.123 Раздела 2.1.1 '") +
		НСтр("ru = '/ 100, если стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 > стр.122 Раздела 2.1.1';
			|en = '/ 100, если стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 > стр.122 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8';
			|en = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р21С001"		, "П002110013303");
	ИменаПоказателей.Вставить("Р21С002"		, "П002110013203");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110011303");
	ИменаПоказателей.Вставить("Р21С004"		, "П002110011203");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110012303");
	ИменаПоказателей.Вставить("Р21С006"		, "П002110010103");
	ИменаПоказателей.Вставить("Р21С007"		, "П002110012203");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_27в()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.27.в';
													|en = '1.27.в'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.133 Раздела 2.1.1 = стр.131 + (стр.113 - стр.111) х стр.123 Раздела 2.1.1 ';
			|en = 'Сумма налога в стр.133 Раздела 2.1.1 = стр.131 + (стр.113 - стр.111) х стр.123 Раздела 2.1.1 '") +
		НСтр("ru = '/ 100, если стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 = стр.122 Раздела 2.1.1 и ';
			|en = '/ 100, если стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 = стр.122 Раздела 2.1.1 и '") + 
		НСтр("ru = 'стр.123 Раздела 2.1.1 > стр.121 Раздела 2.1.1';
			|en = 'стр.123 Раздела 2.1.1 > стр.121 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 = %8 и %5 > %9';
			|en = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 = %8 и %5 > %9'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей.Вставить("Р21С006"		, "П002110010103");
	ИменаПоказателей.Вставить("Р21С007"		, "П002110012203");
	ИменаПоказателей.Вставить("Р21С008"		, "П002110012103");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_27г()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.27.г';
													|en = '1.27.г'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.133 Раздела 2.1.1 = стр.130 + (стр.113 - стр.110) х стр.123 Раздела 2.1.1 ';
			|en = 'Сумма налога в стр.133 Раздела 2.1.1 = стр.130 + (стр.113 - стр.110) х стр.123 Раздела 2.1.1 '") +
		НСтр("ru = '/ 100, если стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 = стр.121 Раздела 2.1.1 и ';
			|en = '/ 100, если стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 = стр.121 Раздела 2.1.1 и '") + 
		НСтр("ru = 'стр.123 Раздела 2.1.1 > стр.120 Раздела 2.1.1';
			|en = 'стр.123 Раздела 2.1.1 > стр.120 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 = %8 и %5 > %9';
			|en = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 = %8 и %5 > %9'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
...
&НаСервере
Процедура ПроверкаКС_1_27а_код(Настройки)
	
	Перем Показатели;
	СформироватьПоказатели(Показатели, Настройки.ИменаПоказателей);
	Показатели.Р21С001.Округление = Истина;
	Показатели.Р21С002.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел21);
	
	РасчетнаяСумма = Окр(Показатели.Р21С002.Значение * Показатели.Р21С003.Значение / 100);
	УсловиеВыполнено = Показатели.Р21С004.Значение = "1" ИЛИ Показатели.Р21С004.Значение = "2" И 
		Показатели.Р21С003.Значение = Показатели.Р21С005.Значение;
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р21С001.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р21С001.Значение, Показатели.Р21С002.Значение, Показатели.Р21С003.Значение, РасчетнаяСумма, 
		Показатели.Р21С004.ЗначениеСтр, Показатели.Р21С005.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_27б_код(Настройки)
	
	Перем Показатели;
	СформироватьПоказатели(Показатели, Настройки.ИменаПоказателей);
	Показатели.Р21С001.Округление = Истина;
	Показатели.Р21С002.Округление = Истина;
	Показатели.Р21С003.Округление = Истина;
	Показатели.Р21С004.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел21);
	
	РасчетнаяСумма = Макс(0, Окр(Показатели.Р21С002.Значение + (Показатели.Р21С003.Значение 
		- Показатели.Р21С004.Значение) * Показатели.Р21С005.Значение / 100));
	УсловиеВыполнено = Показатели.Р21С006.Значение = "2" И Показатели.Р21С005.Значение > Показатели.Р21С007.Значение;
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р21С001.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р21С001.Значение, Показатели.Р21С002.Значение, Показатели.Р21С003.Значение, Показатели.Р21С004.Значение, 
		Показатели.Р21С005.Значение, РасчетнаяСумма, Показатели.Р21С006.ЗначениеСтр, Показатели.Р21С007.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_27г_код(Настройки)
	...
	РасчетнаяСумма = Макс(0, Окр(Показатели.Р21С002.Значение + (Показатели.Р21С003.Значение 
		- Показатели.Р21С004.Значение) * Показатели.Р21С005.Значение / 100));
	УсловиеВыполнено = Показатели.Р21С006.Значение = "2" И Показатели.Р21С005.Значение = Показатели.Р21С007.Значение
		И Показатели.Р21С005.Значение > Показатели.Р21С008.Значение;
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р21С001.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р21С001.Значение, Показатели.Р21С002.Значение, Показатели.Р21С003.Значение, Показатели.Р21С004.Значение, 
		Показатели.Р21С005.Значение, РасчетнаяСумма, Показатели.Р21С006.ЗначениеСтр, Показатели.Р21С007.Значение, 
		Показатели.Р21С008.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
	
КонецПроцедуры
		
&НаСервере
Процедура ПроверкаКС_1_28а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.28.а';
													|en = '1.28.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.140 Раздела 2.1.1 <= стр.130 Раздела 2.1.1 / 2, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.140 Раздела 2.1.1 <= стр.130 Раздела 2.1.1 / 2, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 1';
			|en = 'Раздела 2.1.1 = 1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2 / 2 Итог [%4], когда %3 = 1';
													|en = '%1 <= %2 / 2 Итог [%4], когда %3 = 1'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р21С001"		, "П002110014003");
	ИменаПоказателей.Вставить("Р21С002"		, "П002110013003");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110010203");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
	Настройки.Вставить("ПН"					, "1");
...
&НаСервере
Процедура ПроверкаКС_1_28б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.28.б';
													|en = '1.28.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.140 Раздела 2.1.1 <= стр.130 Раздела 2.1.1, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.140 Раздела 2.1.1 <= стр.130 Раздела 2.1.1, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 2';
			|en = 'Раздела 2.1.1 = 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2, когда %3 = 2';
													|en = '%1 <= %2, когда %3 = 2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма страховых взносов';
														|en = 'Ошибочная сумма страховых взносов'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
&НаСервере
Процедура ПроверкаКС_1_29а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.29.а';
													|en = '1.29.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.141 Раздела 2.1.1 <= стр.131 Раздела 2.1.1 / 2, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.141 Раздела 2.1.1 <= стр.131 Раздела 2.1.1 / 2, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 1';
			|en = 'Раздела 2.1.1 = 1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2 / 2 Итог [%4], когда %3 = 1';
													|en = '%1 <= %2 / 2 Итог [%4], когда %3 = 1'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р21С001"		, "П002110014103");
	ИменаПоказателей.Вставить("Р21С002"		, "П002110013103");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110010203");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
	Настройки.Вставить("ПН"					, "1");
...
&НаСервере
Процедура ПроверкаКС_1_29б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.29.б';
													|en = '1.29.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.141 Раздела 2.1.1 <= стр.131 Раздела 2.1.1, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.141 Раздела 2.1.1 <= стр.131 Раздела 2.1.1, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 2';
			|en = 'Раздела 2.1.1 = 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2, когда %3 = 2';
													|en = '%1 <= %2, когда %3 = 2'"));
...
&НаСервере
Процедура ПроверкаКС_1_30а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.30.а';
													|en = '1.30.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.142 Раздела 2.1.1 <= стр.132 Раздела 2.1.1 / 2, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.142 Раздела 2.1.1 <= стр.132 Раздела 2.1.1 / 2, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 1';
			|en = 'Раздела 2.1.1 = 1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2 / 2 Итог [%4], когда %3 = 1';
													|en = '%1 <= %2 / 2 Итог [%4], когда %3 = 1'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р21С001"		, "П002110014203");
	ИменаПоказателей.Вставить("Р21С002"		, "П002110013203");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110010203");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
	Настройки.Вставить("ПН"					, "1");
...
&НаСервере
Процедура ПроверкаКС_1_30б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.30.б';
													|en = '1.30.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.142 Раздела 2.1.1 <= стр.132 Раздела 2.1.1, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.142 Раздела 2.1.1 <= стр.132 Раздела 2.1.1, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 2';
			|en = 'Раздела 2.1.1 = 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2, когда %3 = 2';
													|en = '%1 <= %2, когда %3 = 2'"));
...
&НаСервере
Процедура ПроверкаКС_1_31а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.а';
													|en = '1.31.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.143 Раздела 2.1.1 <= стр.133 Раздела 2.1.1 / 2, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.143 Раздела 2.1.1 <= стр.133 Раздела 2.1.1 / 2, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 1';
			|en = 'Раздела 2.1.1 = 1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2 / 2 Итог [%4], когда %3 = 1';
													|en = '%1 <= %2 / 2 Итог [%4], когда %3 = 1'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р21С001"		, "П002110014303");
	ИменаПоказателей.Вставить("Р21С002"		, "П002110013303");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110010203");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
	Настройки.Вставить("ПН"					, "1");
...
&НаСервере
Процедура ПроверкаКС_1_31б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.б';
													|en = '1.31.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.143 Раздела 2.1.1 <= стр.133 Раздела 2.1.1, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.143 Раздела 2.1.1 <= стр.133 Раздела 2.1.1, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 2';
			|en = 'Раздела 2.1.1 = 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2, когда %3 = 2';
													|en = '%1 <= %2, когда %3 = 2'"));
...
Процедура ПроверкаКС_1_31_код(Настройки)
	...
	РасчетнаяСумма = Окр(Показатели.Р21С002.Значение / ?(Настройки.ПН = "1", 2, 1));
	Настройки.ЭтоОшибка = Показатели.Р21С003.Значение = Настройки.ПН И Показатели.Р21С001.Значение > РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р21С001.Значение, Показатели.Р21С002.Значение, Показатели.Р21С003.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
...
#Область КС_Проверки_Раздела_2_1_2
...
Процедура ПроверкаКС_1_31_1()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.1';
													|en = '1.31.1'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.130 Раздела 2.1.2 = стр.110 Раздела 2.1.2 х стр.120 Раздела 2.1.1 / 100';
			|en = 'Сумма налога в стр.130 Раздела 2.1.2 = стр.110 Раздела 2.1.2 х стр.120 Раздела 2.1.1 / 100'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 х %3 / 100 Итог [%4]';
													|en = '%1 = %2 х %3 / 100 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р22С130"		, "П002120013003");
	ИменаПоказателей.Вставить("Р22С110"		, "П002120011003");
	ИменаПоказателей.Вставить("Р21С120"		, "П002110012003");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	Показатели.Р22С130.Округление = Истина;
	Показатели.Р22С110.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел21);
	
	РасчетнаяСумма = Окр(Показатели.Р22С110.Значение * Показатели.Р21С120.Значение / 100);
	Настройки.ЭтоОшибка = НЕ Показатели.Р22С130.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р22С130.Значение, 
		Показатели.Р22С110.Значение, Показатели.Р21С120.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_31_2а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.2.а';
													|en = '1.31.2.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.131 Раздела 2.1.2 = стр.111 Раздела 2.1.2 х стр.121 Раздела 2.1.1 / 100, если стр.';
			|en = 'Сумма налога в стр.131 Раздела 2.1.2 = стр.111 Раздела 2.1.2 х стр.121 Раздела 2.1.1 / 100, если стр.'") +
		НСтр("ru = '101 Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.121 Раздела 2.1.1 = стр.120 Раздела 2.1.1';
			|en = '101 Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.121 Раздела 2.1.1 = стр.120 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6';
			|en = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р22С001"		, "П002120013103");
	ИменаПоказателей.Вставить("Р22С002"		, "П002120011103");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110012103");
	ИменаПоказателей.Вставить("Р21С004"		, "П002110010103");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110012003");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
	
	ПроверкаКС_1_31_4а_код(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_31_2б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.2.б';
													|en = '1.31.2.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.131 Раздела 2.1.2 = стр.130 + (стр.111 - стр.110) Раздела 2.1.2 х стр.121 Раздела ';
			|en = 'Сумма налога в стр.131 Раздела 2.1.2 = стр.130 + (стр.111 - стр.110) Раздела 2.1.2 х стр.121 Раздела '") +
		НСтр("ru = '2.1.1 / 100, если стр.101 Раздела 2.1.1 = 2 и стр.121 Раздела 2.1.1 > стр.120 Раздела 2.1.1';
			|en = '2.1.1 / 100, если стр.101 Раздела 2.1.1 = 2 и стр.121 Раздела 2.1.1 > стр.120 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8';
			|en = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р22С001"		, "П002120013103");
	ИменаПоказателей.Вставить("Р22С002"		, "П002120013003");
	ИменаПоказателей.Вставить("Р22С003"		, "П002120011103");
	ИменаПоказателей.Вставить("Р22С004"		, "П002120011003");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110012103");
	ИменаПоказателей.Вставить("Р21С006"		, "П002110010103");
	ИменаПоказателей.Вставить("Р21С007"		, "П002110012003");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
	
	ПроверкаКС_1_31_4б_код(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_31_3а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.3.а';
													|en = '1.31.3.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.132 Раздела 2.1.2 = стр.112 Раздела 2.1.2 х стр.122 Раздела 2.1.1 / 100, если стр.';
			|en = 'Сумма налога в стр.132 Раздела 2.1.2 = стр.112 Раздела 2.1.2 х стр.122 Раздела 2.1.1 / 100, если стр.'") +
		НСтр("ru = '101 Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.122 Раздела 2.1.1 = стр.120 Раздела 2.1.1';
			|en = '101 Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.122 Раздела 2.1.1 = стр.120 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6';
			|en = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р22С001"		, "П002120013203");
	ИменаПоказателей.Вставить("Р22С002"		, "П002120011203");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110012203");
	ИменаПоказателей.Вставить("Р21С004"		, "П002110010103");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110012003");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_31_3б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.3.б';
													|en = '1.31.3.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.132 Раздела 2.1.2 = стр.131 + (стр.112 - стр.111) Раздела 2.1.2 х стр.122 Раздела ';
			|en = 'Сумма налога в стр.132 Раздела 2.1.2 = стр.131 + (стр.112 - стр.111) Раздела 2.1.2 х стр.122 Раздела '") +
		НСтр("ru = '2.1.1 / 100, если стр.101 Раздела 2.1.1 = 2 и стр.122 Раздела 2.1.1 > стр.121 Раздела 2.1.1';
			|en = '2.1.1 / 100, если стр.101 Раздела 2.1.1 = 2 и стр.122 Раздела 2.1.1 > стр.121 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8';
			|en = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р22С001"		, "П002120013203");
	ИменаПоказателей.Вставить("Р22С002"		, "П002120013103");
	ИменаПоказателей.Вставить("Р22С003"		, "П002120011203");
	ИменаПоказателей.Вставить("Р22С004"		, "П002120011103");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110012203");
	ИменаПоказателей.Вставить("Р21С006"		, "П002110010103");
	ИменаПоказателей.Вставить("Р21С007"		, "П002110012103");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_31_3в()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.3.в';
													|en = '1.31.3.в'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.132 Раздела 2.1.2 = стр.130 + (стр.112 - стр.110) Раздела 2.1.2 х стр.122 Раздела ';
			|en = 'Сумма налога в стр.132 Раздела 2.1.2 = стр.130 + (стр.112 - стр.110) Раздела 2.1.2 х стр.122 Раздела '") +
		НСтр("ru = '2.1.1 / 100, если стр.101 Раздела 2.1.1 = 2 и стр.122 Раздела 2.1.1 = стр.121 Раздела 2.1.1 и ';
			|en = '2.1.1 / 100, если стр.101 Раздела 2.1.1 = 2 и стр.122 Раздела 2.1.1 = стр.121 Раздела 2.1.1 и '") + 
		НСтр("ru = 'стр.122 Раздела 2.1.1 > стр.120 Раздела 2.1.1';
			|en = 'стр.122 Раздела 2.1.1 > стр.120 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 = %8 и %5 > %9';
	...
	ПроверкаКС_1_31_4г_код(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_31_4а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.4.а';
													|en = '1.31.4.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.133 Раздела 2.1.2 = стр.113 Раздела 2.1.2 х стр.123 Раздела 2.1.1 / 100, если стр.';
			|en = 'Сумма налога в стр.133 Раздела 2.1.2 = стр.113 Раздела 2.1.2 х стр.123 Раздела 2.1.1 / 100, если стр.'") +
		НСтр("ru = '101 Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 = стр.120 Раздела 2.1.1';
			|en = '101 Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 = стр.120 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6';
			|en = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р22С001"		, "П002120013303");
	ИменаПоказателей.Вставить("Р22С002"		, "П002120011303");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110012303");
	ИменаПоказателей.Вставить("Р21С004"		, "П002110010103");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110012003");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_31_4б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.4.б';
													|en = '1.31.4.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.133 Раздела 2.1.2 = стр.132 + (стр.113 - стр.112) Раздела 2.1.2 х стр.123 Раздела ';
			|en = 'Сумма налога в стр.133 Раздела 2.1.2 = стр.132 + (стр.113 - стр.112) Раздела 2.1.2 х стр.123 Раздела '") +
		НСтр("ru = '2.1.1 / 100, если стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 > стр.122 Раздела 2.1.1';
			|en = '2.1.1 / 100, если стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 > стр.122 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8';
			|en = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р22С001"		, "П002120013303");
	ИменаПоказателей.Вставить("Р22С002"		, "П002120013203");
	ИменаПоказателей.Вставить("Р22С003"		, "П002120011303");
	ИменаПоказателей.Вставить("Р22С004"		, "П002120011203");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110012303");
	ИменаПоказателей.Вставить("Р21С006"		, "П002110010103");
	ИменаПоказателей.Вставить("Р21С007"		, "П002110012203");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_31_4в()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.4.в';
													|en = '1.31.4.в'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.133 Раздела 2.1.2 = стр.131 + (стр.113 - стр.111) Раздела 2.1.2 х стр.123 Раздела ';
			|en = 'Сумма налога в стр.133 Раздела 2.1.2 = стр.131 + (стр.113 - стр.111) Раздела 2.1.2 х стр.123 Раздела '") +
		НСтр("ru = '2.1.1 / 100, если стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 = стр.122 Раздела 2.1.1 и ';
			|en = '2.1.1 / 100, если стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 = стр.122 Раздела 2.1.1 и '") + 
		НСтр("ru = 'стр.123 Раздела 2.1.1 > стр.121 Раздела 2.1.1';
			|en = 'стр.123 Раздела 2.1.1 > стр.121 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 = %8 и %5 > %9';
...
&НаСервере
Процедура ПроверкаКС_1_31_4г()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.4.г';
													|en = '1.31.4.г'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.133 Раздела 2.1.2 = стр.130 + (стр.113 - стр.110) Раздела 2.1.2 х стр.123 Раздела ';
			|en = 'Сумма налога в стр.133 Раздела 2.1.2 = стр.130 + (стр.113 - стр.110) Раздела 2.1.2 х стр.123 Раздела '") +
		НСтр("ru = '2.1.1 / 100, если стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 = стр.121 Раздела 2.1.1 и ';
			|en = '2.1.1 / 100, если стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 = стр.121 Раздела 2.1.1 и '") + 
		НСтр("ru = 'стр.123 Раздела 2.1.1 > стр.120 Раздела 2.1.1';
			|en = 'стр.123 Раздела 2.1.1 > стр.120 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 = %8 и %5 > %9';
...
&НаСервере
Процедура ПроверкаКС_1_31_4а_код(Настройки)
	
	Перем Показатели;
	СформироватьПоказатели(Показатели, Настройки.ИменаПоказателей);
	Показатели.Р22С001.Округление = Истина;
	Показатели.Р22С002.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел21);
	
	РасчетнаяСумма = Окр(Показатели.Р22С002.Значение * Показатели.Р21С003.Значение / 100);
	УсловиеВыполнено = Показатели.Р21С004.Значение = "1" ИЛИ Показатели.Р21С004.Значение = "2" И 
		Показатели.Р21С003.Значение = Показатели.Р21С005.Значение;
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р22С001.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р22С001.Значение, Показатели.Р22С002.Значение, Показатели.Р21С003.Значение, РасчетнаяСумма, 
		Показатели.Р21С004.ЗначениеСтр, Показатели.Р21С005.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
...
&НаСервере
Процедура ПроверкаКС_1_31_4б_код(Настройки)
	
	Перем Показатели;
	СформироватьПоказатели(Показатели, Настройки.ИменаПоказателей);
	Показатели.Р22С001.Округление = Истина;
	Показатели.Р22С002.Округление = Истина;
	Показатели.Р22С003.Округление = Истина;
	Показатели.Р22С004.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел21);
	
	РасчетнаяСумма = Макс(0, Окр(Показатели.Р22С002.Значение + (Показатели.Р22С003.Значение 
		- Показатели.Р22С004.Значение) * Показатели.Р21С005.Значение / 100));
	УсловиеВыполнено = Показатели.Р21С006.Значение = "2" И Показатели.Р21С005.Значение > Показатели.Р21С007.Значение;
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р22С001.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р22С001.Значение, Показатели.Р22С002.Значение, Показатели.Р22С003.Значение, Показатели.Р22С004.Значение, 
		Показатели.Р21С005.Значение, РасчетнаяСумма, Показатели.Р21С006.ЗначениеСтр, Показатели.Р21С007.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
...
&НаСервере
Процедура ПроверкаКС_1_31_4г_код(Настройки)
...
&НаСервере
Процедура ПроверкаКС_1_31_5а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.5.а';
													|en = '1.31.5.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.140 Раздела 2.1.2 <= стр.130 Раздела 2.1.2 / 2, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.140 Раздела 2.1.2 <= стр.130 Раздела 2.1.2 / 2, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 1';
			|en = 'Раздела 2.1.1 = 1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2 / 2 Итог [%4], когда %3 = 1';
													|en = '%1 <= %2 / 2 Итог [%4], когда %3 = 1'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р22С001"		, "П002120014003");
	ИменаПоказателей.Вставить("Р22С002"		, "П002120013003");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110010203");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
	Настройки.Вставить("ПН"					, "1");
	
	ПроверкаКС_1_31_8_код(Настройки);
	
КонецПроцедуры
		
&НаСервере
Процедура ПроверкаКС_1_31_5б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.5.б';
													|en = '1.31.5.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.140 Раздела 2.1.2 <= стр.130 Раздела 2.1.2, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.140 Раздела 2.1.2 <= стр.130 Раздела 2.1.2, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 2';
			|en = 'Раздела 2.1.1 = 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2, когда %3 = 2';
													|en = '%1 <= %2, когда %3 = 2'"));
...
&НаСервере
Процедура ПроверкаКС_1_31_6а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.6.а';
													|en = '1.31.6.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.141 Раздела 2.1.2 <= стр.131 Раздела 2.1.2 / 2, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.141 Раздела 2.1.2 <= стр.131 Раздела 2.1.2 / 2, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 1';
			|en = 'Раздела 2.1.1 = 1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2 / 2 Итог [%4], когда %3 = 1';
													|en = '%1 <= %2 / 2 Итог [%4], когда %3 = 1'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р22С001"		, "П002120014103");
	ИменаПоказателей.Вставить("Р22С002"		, "П002120013103");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110010203");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
	Настройки.Вставить("ПН"					, "1");
...
&НаСервере
Процедура ПроверкаКС_1_31_6б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.6.б';
													|en = '1.31.6.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.141 Раздела 2.1.2 <= стр.131 Раздела 2.1.2, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.141 Раздела 2.1.2 <= стр.131 Раздела 2.1.2, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 2';
			|en = 'Раздела 2.1.1 = 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2, когда %3 = 2';
													|en = '%1 <= %2, когда %3 = 2'"));
...
&НаСервере
Процедура ПроверкаКС_1_31_7а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.7.а';
													|en = '1.31.7.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.142 Раздела 2.1.2 <= стр.132 Раздела 2.1.2 / 2, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.142 Раздела 2.1.2 <= стр.132 Раздела 2.1.2 / 2, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 1';
			|en = 'Раздела 2.1.1 = 1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2 / 2 Итог [%4], когда %3 = 1';
													|en = '%1 <= %2 / 2 Итог [%4], когда %3 = 1'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р22С001"		, "П002120014203");
	ИменаПоказателей.Вставить("Р22С002"		, "П002120013203");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110010203");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
	Настройки.Вставить("ПН"					, "1");
...
&НаСервере
Процедура ПроверкаКС_1_31_7б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.7.б';
													|en = '1.31.7.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.142 Раздела 2.1.2 <= стр.132 Раздела 2.1.2, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.142 Раздела 2.1.2 <= стр.132 Раздела 2.1.2, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 2';
			|en = 'Раздела 2.1.1 = 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2, когда %3 = 2';
													|en = '%1 <= %2, когда %3 = 2'"));
...
&НаСервере
Процедура ПроверкаКС_1_31_8а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.8.а';
													|en = '1.31.8.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.143 Раздела 2.1.2 <= стр.133 Раздела 2.1.2 / 2, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.143 Раздела 2.1.2 <= стр.133 Раздела 2.1.2 / 2, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 1';
			|en = 'Раздела 2.1.1 = 1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2 / 2 Итог [%4], когда %3 = 1';
													|en = '%1 <= %2 / 2 Итог [%4], когда %3 = 1'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р22С001"		, "П002120014303");
	ИменаПоказателей.Вставить("Р22С002"		, "П002120013303");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110010203");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
	Настройки.Вставить("ПН"					, "1");
...
&НаСервере
Процедура ПроверкаКС_1_31_8б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.8.б';
													|en = '1.31.8.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма страховых взносов в стр.143 Раздела 2.1.2 <= стр.133 Раздела 2.1.2, если стр.102 ';
			|en = 'Сумма страховых взносов в стр.143 Раздела 2.1.2 <= стр.133 Раздела 2.1.2, если стр.102 '") +
		НСтр("ru = 'Раздела 2.1.1 = 2';
			|en = 'Раздела 2.1.1 = 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2, когда %3 = 2';
													|en = '%1 <= %2, когда %3 = 2'"));
...
&НаСервере
Процедура ПроверкаКС_1_31_8_код(Настройки)
	...
	РасчетнаяСумма = Окр(Показатели.Р22С002.Значение / ?(Настройки.ПН = "1", 2, 1));
	Настройки.ЭтоОшибка = Показатели.Р21С003.Значение = Настройки.ПН И Показатели.Р22С001.Значение > РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р22С001.Значение, Показатели.Р22С002.Значение, Показатели.Р21С003.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
...
&НаСервере
Процедура ПроверкаКС_1_31_9()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.9';
													|en = '1.31.9'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма торгового сбора в стр.160 Раздела 2.1.2 = стр.130 Раздела 2.1.2 - стр.140 Раздела 2.1.2, ';
			|en = 'Сумма торгового сбора в стр.160 Раздела 2.1.2 = стр.130 Раздела 2.1.2 - стр.140 Раздела 2.1.2, '") +
		НСтр("ru = 'если стр.130 Раздела 2.1.2 - стр.140 Раздела 2.1.2 < стр.150 Раздела 2.1.2 и стр.160 Раздела 2.1.2 <= ';
			|en = 'если стр.130 Раздела 2.1.2 - стр.140 Раздела 2.1.2 < стр.150 Раздела 2.1.2 и стр.160 Раздела 2.1.2 <= '") +
		НСтр("ru = 'стр.130 Раздела 2.1.1 - стр.140 Раздела 2.1.1, или стр.160 Раздела 2.1.2 = стр.150 Раздела 2.1.2, ';
			|en = 'стр.130 Раздела 2.1.1 - стр.140 Раздела 2.1.1, или стр.160 Раздела 2.1.2 = стр.150 Раздела 2.1.2, '") +
		НСтр("ru = 'если стр.130 Раздела 2.1.2 - стр.140 Раздела 2.1.2 >= стр.150 Раздела 2.1.2 и стр.160 Раздела 2.1.2 <=';
			|en = 'если стр.130 Раздела 2.1.2 - стр.140 Раздела 2.1.2 >= стр.150 Раздела 2.1.2 и стр.160 Раздела 2.1.2 <='") +
		НСтр("ru = ' стр.130 Раздела 2.1.1 - стр.140 Раздела 2.1.1';
			|en = ' стр.130 Раздела 2.1.1 - стр.140 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = (%2 - %3 Итог [%4]) или %5';
													|en = '%1 = (%2 - %3 Итог [%4]) или %5'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма торгового сбора';
														|en = 'Ошибочная сумма торгового сбора'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р22С001"		, "П002120016003");
	ИменаПоказателей.Вставить("Р22С002"		, "П002120013003");
	ИменаПоказателей.Вставить("Р22С003"		, "П002120014003");
	ИменаПоказателей.Вставить("Р22С004"		, "П002120015003");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110013003");
	ИменаПоказателей.Вставить("Р21С006"		, "П002110014003");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
	
	ПроверкаКС_1_31_12_код(Настройки);
	
КонецПроцедуры
		
&НаСервере
Процедура ПроверкаКС_1_31_10()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.10';
													|en = '1.31.10'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма торгового сбора в стр.161 Раздела 2.1.2 = стр.131 Раздела 2.1.2 - стр.141 Раздела 2.1.2, ';
			|en = 'Сумма торгового сбора в стр.161 Раздела 2.1.2 = стр.131 Раздела 2.1.2 - стр.141 Раздела 2.1.2, '") +
		НСтр("ru = 'если стр.131 Раздела 2.1.2 - стр.141 Раздела 2.1.2 < стр.151 Раздела 2.1.2 и стр.161 Раздела 2.1.2 <= ';
			|en = 'если стр.131 Раздела 2.1.2 - стр.141 Раздела 2.1.2 < стр.151 Раздела 2.1.2 и стр.161 Раздела 2.1.2 <= '") +
		НСтр("ru = 'стр.131 Раздела 2.1.1 - стр.141 Раздела 2.1.1, или стр.161 Раздела 2.1.2 = стр.151 Раздела 2.1.2, ';
			|en = 'стр.131 Раздела 2.1.1 - стр.141 Раздела 2.1.1, или стр.161 Раздела 2.1.2 = стр.151 Раздела 2.1.2, '") +
		НСтр("ru = 'если стр.131 Раздела 2.1.2 - стр.141 Раздела 2.1.2 >= стр.151 Раздела 2.1.2 и стр.161 Раздела 2.1.2 <=';
			|en = 'если стр.131 Раздела 2.1.2 - стр.141 Раздела 2.1.2 >= стр.151 Раздела 2.1.2 и стр.161 Раздела 2.1.2 <='") +
		НСтр("ru = ' стр.131 Раздела 2.1.1 - стр.141 Раздела 2.1.1';
			|en = ' стр.131 Раздела 2.1.1 - стр.141 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = (%2 - %3 Итог [%4]) или %5';
													|en = '%1 = (%2 - %3 Итог [%4]) или %5'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма торгового сбора';
														|en = 'Ошибочная сумма торгового сбора'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р22С001"		, "П002120016103");
	ИменаПоказателей.Вставить("Р22С002"		, "П002120013103");
	ИменаПоказателей.Вставить("Р22С003"		, "П002120014103");
	ИменаПоказателей.Вставить("Р22С004"		, "П002120015103");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110013103");
	ИменаПоказателей.Вставить("Р21С006"		, "П002110014103");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_31_11()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.11';
													|en = '1.31.11'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма торгового сбора в стр.162 Раздела 2.1.2 = стр.132 Раздела 2.1.2 - стр.142 Раздела 2.1.2, ';
			|en = 'Сумма торгового сбора в стр.162 Раздела 2.1.2 = стр.132 Раздела 2.1.2 - стр.142 Раздела 2.1.2, '") +
		НСтр("ru = 'если стр.132 Раздела 2.1.2 - стр.142 Раздела 2.1.2 < стр.152 Раздела 2.1.2 и стр.162 Раздела 2.1.2 <= ';
			|en = 'если стр.132 Раздела 2.1.2 - стр.142 Раздела 2.1.2 < стр.152 Раздела 2.1.2 и стр.162 Раздела 2.1.2 <= '") +
		НСтр("ru = 'стр.132 Раздела 2.1.1 - стр.142 Раздела 2.1.1, или стр.162 Раздела 2.1.2 = стр.152 Раздела 2.1.2, ';
			|en = 'стр.132 Раздела 2.1.1 - стр.142 Раздела 2.1.1, или стр.162 Раздела 2.1.2 = стр.152 Раздела 2.1.2, '") +
		НСтр("ru = 'если стр.132 Раздела 2.1.2 - стр.142 Раздела 2.1.2 >= стр.152 Раздела 2.1.2 и стр.162 Раздела 2.1.2 <=';
			|en = 'если стр.132 Раздела 2.1.2 - стр.142 Раздела 2.1.2 >= стр.152 Раздела 2.1.2 и стр.162 Раздела 2.1.2 <='") +
		НСтр("ru = ' стр.132 Раздела 2.1.1 - стр.142 Раздела 2.1.1';
			|en = ' стр.132 Раздела 2.1.1 - стр.142 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = (%2 - %3 Итог [%4]) или %5';
													|en = '%1 = (%2 - %3 Итог [%4]) или %5'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма торгового сбора';
														|en = 'Ошибочная сумма торгового сбора'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р22С001"		, "П002120016203");
	ИменаПоказателей.Вставить("Р22С002"		, "П002120013203");
	ИменаПоказателей.Вставить("Р22С003"		, "П002120014203");
	ИменаПоказателей.Вставить("Р22С004"		, "П002120015203");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110013203");
	ИменаПоказателей.Вставить("Р21С006"		, "П002110014203");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_31_12()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.31.12';
													|en = '1.31.12'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.2';
														|en = 'Раздел 2.1.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма торгового сбора в стр.163 Раздела 2.1.2 = стр.133 Раздела 2.1.2 - стр.143 Раздела 2.1.2, ';
			|en = 'Сумма торгового сбора в стр.163 Раздела 2.1.2 = стр.133 Раздела 2.1.2 - стр.143 Раздела 2.1.2, '") +
		НСтр("ru = 'если стр.133 Раздела 2.1.2 - стр.143 Раздела 2.1.2 < стр.153 Раздела 2.1.2 и стр.163 Раздела 2.1.2 <= ';
			|en = 'если стр.133 Раздела 2.1.2 - стр.143 Раздела 2.1.2 < стр.153 Раздела 2.1.2 и стр.163 Раздела 2.1.2 <= '") +
		НСтр("ru = 'стр.133 Раздела 2.1.1 - стр.143 Раздела 2.1.1, или стр.163 Раздела 2.1.2 = стр.153 Раздела 2.1.2, ';
			|en = 'стр.133 Раздела 2.1.1 - стр.143 Раздела 2.1.1, или стр.163 Раздела 2.1.2 = стр.153 Раздела 2.1.2, '") +
		НСтр("ru = 'если стр.133 Раздела 2.1.2 - стр.143 Раздела 2.1.2 >= стр.153 Раздела 2.1.2 и стр.163 Раздела 2.1.2 <=';
			|en = 'если стр.133 Раздела 2.1.2 - стр.143 Раздела 2.1.2 >= стр.153 Раздела 2.1.2 и стр.163 Раздела 2.1.2 <='") +
		НСтр("ru = ' стр.133 Раздела 2.1.1 - стр.143 Раздела 2.1.1';
			|en = ' стр.133 Раздела 2.1.1 - стр.143 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = (%2 - %3 Итог [%4]) или %5';
													|en = '%1 = (%2 - %3 Итог [%4]) или %5'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма торгового сбора';
														|en = 'Ошибочная сумма торгового сбора'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р22С001"		, "П002120016303");
	ИменаПоказателей.Вставить("Р22С002"		, "П002120013303");
	ИменаПоказателей.Вставить("Р22С003"		, "П002120014303");
	ИменаПоказателей.Вставить("Р22С004"		, "П002120015303");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110013303");
	ИменаПоказателей.Вставить("Р21С006"		, "П002110014303");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_31_12_код(Настройки)
	...
	Показатели.Р22С003.Округление = Истина;
	Показатели.Р22С004.Округление = Истина;
	Показатели.Р21С005.Округление = Истина;
	Показатели.Р21С006.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел21);
	
	УсловиеВыполнено = Показатели.Р22С001.Значение <= Показатели.Р21С005.Значение - Показатели.Р21С006.Значение; 
	Разность = Показатели.Р22С002.Значение - Показатели.Р22С003.Значение;
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р22С001.Значение = Мин(Разность, Показатели.Р22С004.Значение);
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р22С001.Значение, Показатели.Р22С002.Значение, Показатели.Р22С003.Значение, Разность, 
		Показатели.Р22С004.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
...
#Область КС_Проверки_Раздела_2_2
...
Процедура ПроверкаКС_1_32()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.2';
														|en = 'Раздел 2.2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.18 НК РФ';
													|en = 'ст.346.18 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Налоговая база в стр.240 Раздела 2.2 = стр.210 Раздела 2.2 - стр.220 Раздела 2.2, ';
			|en = 'Налоговая база в стр.240 Раздела 2.2 = стр.210 Раздела 2.2 - стр.220 Раздела 2.2, '") +
		НСтр("ru = 'если результат вычисления > 0';
			|en = 'если результат вычисления > 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - %3 Итог [%4]';
													|en = '%1 = %2 - %3 Итог [%4]'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220024003");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220021003");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220022003");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
...
Процедура ПроверкаКС_1_33()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.18 НК РФ';
													|en = 'ст.346.18 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Налоговая база в стр.241 Раздела 2.2 = стр.211 Раздела 2.2 - стр.221 Раздела 2.2, ';
			|en = 'Налоговая база в стр.241 Раздела 2.2 = стр.211 Раздела 2.2 - стр.221 Раздела 2.2, '") +
		НСтр("ru = 'если результат вычисления > 0';
			|en = 'если результат вычисления > 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - %3 Итог [%4]';
													|en = '%1 = %2 - %3 Итог [%4]'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220024103");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220021103");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220022103");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
...
Процедура ПроверкаКС_1_34()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.18 НК РФ';
													|en = 'ст.346.18 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Налоговая база в стр.242 Раздела 2.2 = стр.212 Раздела 2.2 - стр.222 Раздела 2.2, ';
			|en = 'Налоговая база в стр.242 Раздела 2.2 = стр.212 Раздела 2.2 - стр.222 Раздела 2.2, '") +
		НСтр("ru = 'если результат вычисления > 0';
			|en = 'если результат вычисления > 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - %3 Итог [%4]';
													|en = '%1 = %2 - %3 Итог [%4]'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220024203");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220021203");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220022203");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
...
Процедура ПроверкаКС_1_34_код(Настройки)
	...
	Перем Показатели;
	СформироватьПоказатели(Показатели, Настройки.ИменаПоказателей);
	Показатели.Р23С001.Округление = Истина;
	Показатели.Р23С002.Округление = Истина;
	Показатели.Р23С003.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел22);
	
	РасчетнаяСумма = Показатели.Р23С002.Значение - Показатели.Р23С003.Значение;
	Настройки.ЭтоОшибка = РасчетнаяСумма > 0 И НЕ Показатели.Р23С001.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р23С001.Значение, 
		Показатели.Р23С002.Значение, Показатели.Р23С003.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_35()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.18 НК РФ';
													|en = 'ст.346.18 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Налоговая база в стр.243 Раздела 2.2 = стр.213 Раздела 2.2 - стр.223 Раздела 2.2 - стр.230 ';
			|en = 'Налоговая база в стр.243 Раздела 2.2 = стр.213 Раздела 2.2 - стр.223 Раздела 2.2 - стр.230 '") +
		НСтр("ru = 'Раздела 2.2, если результат вычисления > 0';
			|en = 'Раздела 2.2, если результат вычисления > 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - %3 - %4 Итог [%5]';
													|en = '%1 = %2 - %3 - %4 Итог [%5]'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220024303");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220021303");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220022303");
	ИменаПоказателей.Вставить("Р23С004"		, "П000220023003");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	
	Показатели.Р23С001.Округление = Истина;
	Показатели.Р23С002.Округление = Истина;
	Показатели.Р23С003.Округление = Истина;
	Показатели.Р23С004.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел22);
	
	РасчетнаяСумма = Показатели.Р23С002.Значение - Показатели.Р23С003.Значение - Показатели.Р23С004.Значение;
	Настройки.ЭтоОшибка = РасчетнаяСумма > 0 И НЕ Показатели.Р23С001.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р23С001.Значение, Показатели.Р23С002.Значение, Показатели.Р23С003.Значение, 
		Показатели.Р23С004.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_36()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.18 НК РФ';
													|en = 'ст.346.18 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма убытка в стр.250 Раздела 2.2 = стр.220 Раздела 2.2 - стр.210 Раздела 2.2, ';
			|en = 'Сумма убытка в стр.250 Раздела 2.2 = стр.220 Раздела 2.2 - стр.210 Раздела 2.2, '") +
		НСтр("ru = 'если результат вычисления > 0';
			|en = 'если результат вычисления > 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - %3 Итог [%4]';
													|en = '%1 = %2 - %3 Итог [%4]'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220025003");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220022003");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220021003");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
...
Процедура ПроверкаКС_1_37()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.18 НК РФ';
													|en = 'ст.346.18 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма убытка в стр.251 Раздела 2.2 = стр.221 Раздела 2.2 - стр.211 Раздела 2.2, ';
			|en = 'Сумма убытка в стр.251 Раздела 2.2 = стр.221 Раздела 2.2 - стр.211 Раздела 2.2, '") +
		НСтр("ru = 'если результат вычисления > 0';
			|en = 'если результат вычисления > 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - %3 Итог [%4]';
													|en = '%1 = %2 - %3 Итог [%4]'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220025103");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220022103");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220021103");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
...
Процедура ПроверкаКС_1_38()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.18 НК РФ';
													|en = 'ст.346.18 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма убытка в стр.252 Раздела 2.2 = стр.222 Раздела 2.2 - стр.212 Раздела 2.2, ';
			|en = 'Сумма убытка в стр.252 Раздела 2.2 = стр.222 Раздела 2.2 - стр.212 Раздела 2.2, '") +
		НСтр("ru = 'если результат вычисления > 0';
			|en = 'если результат вычисления > 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - %3 Итог [%4]';
													|en = '%1 = %2 - %3 Итог [%4]'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220025203");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220022203");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220021203");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
...
Процедура ПроверкаКС_1_39()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.18 НК РФ';
													|en = 'ст.346.18 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма убытка в стр.253 Раздела 2.2 = стр.223 Раздела 2.2 - стр.213 Раздела 2.2, ';
			|en = 'Сумма убытка в стр.253 Раздела 2.2 = стр.223 Раздела 2.2 - стр.213 Раздела 2.2, '") +
		НСтр("ru = 'если результат вычисления > 0';
			|en = 'если результат вычисления > 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - %3 Итог [%4]';
													|en = '%1 = %2 - %3 Итог [%4]'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220025303");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220022303");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220021303");
	Настройки.Вставить("ИменаПоказателей"	, ИменаПоказателей);
...
Процедура ПроверкаКС_1_40()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.270 Раздела 2.2 = стр.240 х стр.260 Раздела 2.2 / 100';
			|en = 'Сумма налога в стр.270 Раздела 2.2 = стр.240 х стр.260 Раздела 2.2 / 100'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 х %3 / 100 Итог [%4]';
													|en = '%1 = %2 х %3 / 100 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С270"		, "П000220027003");
	ИменаПоказателей.Вставить("Р23С240"		, "П000220024003");
	ИменаПоказателей.Вставить("Р23С260"		, "П000220026003");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	Показатели.Р23С270.Округление = Истина;
	Показатели.Р23С240.Округление = Истина;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел22);
	
	РасчетнаяСумма = Окр(Показатели.Р23С240.Значение * Показатели.Р23С260.Значение / 100);
	Настройки.ЭтоОшибка = НЕ Показатели.Р23С270.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р23С270.Значение, 
		Показатели.Р23С240.Значение, Показатели.Р23С260.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_41а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.41.а';
													|en = '1.41.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.2';
														|en = 'Раздел 2.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.271 Раздела 2.2 = стр.241 х стр.261 Раздела 2.2 / 100, если стр.201 ';
			|en = 'Сумма налога в стр.271 Раздела 2.2 = стр.241 х стр.261 Раздела 2.2 / 100, если стр.201 '") +
		НСтр("ru = 'Раздела 2.2 = 1 или стр.201 Раздела 2.2 = 2 и стр.261 Раздела 2.2 = стр.260 Раздела 2.2';
			|en = 'Раздела 2.2 = 1 или стр.201 Раздела 2.2 = 2 и стр.261 Раздела 2.2 = стр.260 Раздела 2.2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6';
			|en = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220027103");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220024103");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220026103");
	ИменаПоказателей.Вставить("Р23С004"		, "П000220020103");
	ИменаПоказателей.Вставить("Р23С005"		, "П000220026003");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
	
	ПроверкаКС_1_43а_код(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_41б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.41.б';
													|en = '1.41.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.2';
														|en = 'Раздел 2.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.271 Раздела 2.2 = стр.270 + (стр.241 - стр.240) х стр.261 Раздела 2.2 ';
			|en = 'Сумма налога в стр.271 Раздела 2.2 = стр.270 + (стр.241 - стр.240) х стр.261 Раздела 2.2 '") +
		НСтр("ru = '/ 100, если стр.201 Раздела 2.2 = 2 и стр.261 Раздела 2.2 > стр.260 Раздела 2.2';
			|en = '/ 100, если стр.201 Раздела 2.2 = 2 и стр.261 Раздела 2.2 > стр.260 Раздела 2.2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8';
			|en = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220027103");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220027003");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220024103");
	ИменаПоказателей.Вставить("Р23С004"		, "П000220024003");
	ИменаПоказателей.Вставить("Р23С005"		, "П000220026103");
	ИменаПоказателей.Вставить("Р23С006"		, "П000220020103");
	ИменаПоказателей.Вставить("Р23С007"		, "П000220026003");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
	
	ПроверкаКС_1_43б_код(Настройки);
	
КонецПроцедуры
		
&НаСервере
Процедура ПроверкаКС_1_42а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.42.а';
													|en = '1.42.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.2';
														|en = 'Раздел 2.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.272 Раздела 2.2 = стр.242 х стр.262 Раздела 2.2 / 100, если стр.201 ';
			|en = 'Сумма налога в стр.272 Раздела 2.2 = стр.242 х стр.262 Раздела 2.2 / 100, если стр.201 '") +
		НСтр("ru = 'Раздела 2.2 = 1 или стр.201 Раздела 2.2 = 2 и стр.262 Раздела 2.2 = стр.260 Раздела 2.2';
			|en = 'Раздела 2.2 = 1 или стр.201 Раздела 2.2 = 2 и стр.262 Раздела 2.2 = стр.260 Раздела 2.2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6';
			|en = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220027203");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220024203");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220026203");
	ИменаПоказателей.Вставить("Р23С004"		, "П000220020103");
	ИменаПоказателей.Вставить("Р23С005"		, "П000220026003");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_42б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.42.б';
													|en = '1.42.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.2';
														|en = 'Раздел 2.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.272 Раздела 2.2 = стр.271 + (стр.242 - стр.241) х стр.262 Раздела 2.2 ';
			|en = 'Сумма налога в стр.272 Раздела 2.2 = стр.271 + (стр.242 - стр.241) х стр.262 Раздела 2.2 '") +
		НСтр("ru = '/ 100, если стр.201 Раздела 2.2 = 2 и стр.262 Раздела 2.2 > стр.261 Раздела 2.2';
			|en = '/ 100, если стр.201 Раздела 2.2 = 2 и стр.262 Раздела 2.2 > стр.261 Раздела 2.2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8';
			|en = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220027203");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220027103");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220024203");
	ИменаПоказателей.Вставить("Р23С004"		, "П000220024103");
	ИменаПоказателей.Вставить("Р23С005"		, "П000220026203");
	ИменаПоказателей.Вставить("Р23С006"		, "П000220020103");
	ИменаПоказателей.Вставить("Р23С007"		, "П000220026103");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_42в()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.42.в';
													|en = '1.42.в'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.2';
														|en = 'Раздел 2.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.272 Раздела 2.2 = стр.270 + (стр.242 - стр.240) х стр.262 Раздела 2.2 ';
			|en = 'Сумма налога в стр.272 Раздела 2.2 = стр.270 + (стр.242 - стр.240) х стр.262 Раздела 2.2 '") +
		НСтр("ru = '/ 100, если стр.201 Раздела 2.2 = 2 и стр.262 Раздела 2.2 = стр.261 Раздела 2.2 и ';
			|en = '/ 100, если стр.201 Раздела 2.2 = 2 и стр.262 Раздела 2.2 = стр.261 Раздела 2.2 и '") + 
		НСтр("ru = 'стр.262 Раздела 2.2 > стр.260 Раздела 2.2';
			|en = 'стр.262 Раздела 2.2 > стр.260 Раздела 2.2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 = %8 и %5 > %9';
			|en = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 = %8 и %5 > %9'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей.Вставить("Р23С006"		, "П000220020103");
	ИменаПоказателей.Вставить("Р23С007"		, "П000220026103");
	ИменаПоказателей.Вставить("Р23С008"		, "П000220026003");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
	
	ПроверкаКС_1_43г_код(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_43а()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.43.а';
													|en = '1.43.а'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.2';
														|en = 'Раздел 2.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.273 Раздела 2.2 = стр.243 х стр.263 Раздела 2.2 / 100, если стр.201 ';
			|en = 'Сумма налога в стр.273 Раздела 2.2 = стр.243 х стр.263 Раздела 2.2 / 100, если стр.201 '") +
		НСтр("ru = 'Раздела 2.2 = 1 или стр.201 Раздела 2.2 = 2 и стр.263 Раздела 2.2 = стр.260 Раздела 2.2';
			|en = 'Раздела 2.2 = 1 или стр.201 Раздела 2.2 = 2 и стр.263 Раздела 2.2 = стр.260 Раздела 2.2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6';
			|en = '%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220027303");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220024303");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220026303");
	ИменаПоказателей.Вставить("Р23С004"		, "П000220020103");
	ИменаПоказателей.Вставить("Р23С005"		, "П000220026003");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_43б()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.43.б';
													|en = '1.43.б'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.2';
														|en = 'Раздел 2.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.273 Раздела 2.2 = стр.272 + (стр.243 - стр.242) х стр.263 Раздела 2.2 ';
			|en = 'Сумма налога в стр.273 Раздела 2.2 = стр.272 + (стр.243 - стр.242) х стр.263 Раздела 2.2 '") +
		НСтр("ru = '/ 100, если стр.201 Раздела 2.2 = 2 и стр.263 Раздела 2.2 > стр.262 Раздела 2.2';
			|en = '/ 100, если стр.201 Раздела 2.2 = 2 и стр.263 Раздела 2.2 > стр.262 Раздела 2.2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8';
			|en = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 > %8'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220027303");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220027203");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220024303");
	ИменаПоказателей.Вставить("Р23С004"		, "П000220024203");
	ИменаПоказателей.Вставить("Р23С005"		, "П000220026303");
	ИменаПоказателей.Вставить("Р23С006"		, "П000220020103");
	ИменаПоказателей.Вставить("Р23С007"		, "П000220026203");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_43в()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.43.в';
													|en = '1.43.в'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.2';
														|en = 'Раздел 2.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.273 Раздела 2.2 = стр.271 + (стр.243 - стр.241) х стр.263 Раздела 2.2 ';
			|en = 'Сумма налога в стр.273 Раздела 2.2 = стр.271 + (стр.243 - стр.241) х стр.263 Раздела 2.2 '") +
		НСтр("ru = '/ 100, если стр.201 Раздела 2.2 = 2 и стр.263 Раздела 2.2 = стр.262 Раздела 2.2 и ';
			|en = '/ 100, если стр.201 Раздела 2.2 = 2 и стр.263 Раздела 2.2 = стр.262 Раздела 2.2 и '") + 
		НСтр("ru = 'стр.263 Раздела 2.2 > стр.261 Раздела 2.2';
			|en = 'стр.263 Раздела 2.2 > стр.261 Раздела 2.2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 = %8 и %5 > %9';
			|en = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 = %8 и %5 > %9'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
	...
	ИменаПоказателей.Вставить("Р23С006"		, "П000220020103");
	ИменаПоказателей.Вставить("Р23С007"		, "П000220026203");
	ИменаПоказателей.Вставить("Р23С008"		, "П000220026103");
	Настройки.Вставить("ИменаПоказателей", ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_1_43г()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.43.г';
													|en = '1.43.г'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.2';
														|en = 'Раздел 2.2'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'До 2022 года (Письмо ФНС России от 14.12.2022 № СД-4-3/16972@)';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.21 НК РФ';
													|en = 'ст.346.21 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.273 Раздела 2.2 = стр.270 + (стр.243 - стр.240) х стр.263 Раздела 2.2 ';
			|en = 'Сумма налога в стр.273 Раздела 2.2 = стр.270 + (стр.243 - стр.240) х стр.263 Раздела 2.2 '") +
		НСтр("ru = '/ 100, если стр.201 Раздела 2.2 = 2 и стр.263 Раздела 2.2 = стр.261 Раздела 2.2 и ';
			|en = '/ 100, если стр.201 Раздела 2.2 = 2 и стр.263 Раздела 2.2 = стр.261 Раздела 2.2 и '") + 
		НСтр("ru = 'стр.263 Раздела 2.2 > стр.260 Раздела 2.2';
			|en = 'стр.263 Раздела 2.2 > стр.260 Раздела 2.2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 = %8 и %5 > %9';
			|en = '%1 = %2 + (%3 - %4) х %5 / 100 Итог [%6], когда %7 = 2 и %5 = %8 и %5 > %9'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
...
&НаСервере
Процедура ПроверкаКС_1_43а_код(Настройки)
	...
	РасчетнаяСумма = Окр(Показатели.Р23С002.Значение * Показатели.Р23С003.Значение / 100);
	УсловиеВыполнено = Показатели.Р23С004.Значение = "1" ИЛИ Показатели.Р23С004.Значение = "2" И 
		Показатели.Р23С003.Значение = Показатели.Р23С005.Значение;
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р23С001.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р23С001.Значение, Показатели.Р23С002.Значение, Показатели.Р23С003.Значение, РасчетнаяСумма, 
		Показатели.Р23С004.ЗначениеСтр, Показатели.Р23С005.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_43б_код(Настройки)
	...
	РасчетнаяСумма = Макс(0, Окр(Показатели.Р23С002.Значение + (Показатели.Р23С003.Значение 
		- Показатели.Р23С004.Значение) * Показатели.Р23С005.Значение / 100));
	УсловиеВыполнено = Показатели.Р23С006.Значение = "2" И Показатели.Р23С005.Значение > Показатели.Р23С007.Значение;
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р23С001.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р23С001.Значение, Показатели.Р23С002.Значение, Показатели.Р23С003.Значение, Показатели.Р23С004.Значение, 
		Показатели.Р23С005.Значение, РасчетнаяСумма, Показатели.Р23С006.ЗначениеСтр, Показатели.Р23С007.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_43г_код(Настройки)
	...
	РасчетнаяСумма = Макс(0, Окр(Показатели.Р23С002.Значение + (Показатели.Р23С003.Значение 
		- Показатели.Р23С004.Значение) * Показатели.Р23С005.Значение / 100));
	УсловиеВыполнено = Показатели.Р23С006.Значение = "2" 
		И Показатели.Р23С005.Значение = Показатели.Р23С007.Значение
		И Показатели.Р23С005.Значение > Показатели.Р23С008.Значение;
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р23С001.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р23С001.Значение, Показатели.Р23С002.Значение, Показатели.Р23С003.Значение, Показатели.Р23С004.Значение, 
		Показатели.Р23С005.Значение, РасчетнаяСумма, Показатели.Р23С006.ЗначениеСтр, Показатели.Р23С007.Значение, 
		Показатели.Р23С008.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_44()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.18 НК РФ';
													|en = 'ст.346.18 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.280 Раздела 2.2 = стр.213 Раздела 2.2 х 1 / 100';
			|en = 'Сумма налога в стр.280 Раздела 2.2 = стр.213 Раздела 2.2 х 1 / 100'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 х 1 / 100 Итог [%3]';
													|en = '%1 = %2 х 1 / 100 Итог [%3]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С280"		, "П000220028003");
	ИменаПоказателей.Вставить("Р23С213"		, "П000220021303");
	ИменаПоказателей.Вставить("Р23С260"		, "П000220026003");
	ИменаПоказателей.Вставить("Р23С261"		, "П000220026103");
	ИменаПоказателей.Вставить("Р23С262"		, "П000220026203");
	ИменаПоказателей.Вставить("Р23С263"		, "П000220026303");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	Показатели.Р23С280.Округление = Истина;
	Показатели.Р23С213.Округление = Истина;
	Показатели.Р23С260.Расшифровывать = Ложь;
	Показатели.Р23С261.Расшифровывать = Ложь;
	Показатели.Р23С262.Расшифровывать = Ложь;
	Показатели.Р23С263.Расшифровывать = Ложь;
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел22);
	
	НалоговыеКаникулыИП = СтруктураРеквизитовФормы.ИП И ДанныеКС.ГодОтчета >= 2015 И ДанныеКС.ГодОтчета <= 2023 И
		Показатели.Р23С260.Значение = 0 И Показатели.Р23С261.Значение = 0 И Показатели.Р23С262.Значение = 0 И 
		Показатели.Р23С263.Значение = 0; 
	РасчетнаяСумма = Окр(Показатели.Р23С213.Значение / 100);
	Настройки.ЭтоОшибка = НЕ НалоговыеКаникулыИП И НЕ Показатели.Р23С280.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р23С280.Значение, 
		Показатели.Р23С213.Значение, РасчетнаяСумма);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_45()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.18 НК РФ';
													|en = 'ст.346.18 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.280 Раздела 2.2 = 0, если стр.213 Раздела 2.2 = 0';
			|en = 'Сумма налога в стр.280 Раздела 2.2 = 0, если стр.213 Раздела 2.2 = 0'"));
	...
	Настройки.ЭтоОшибка = Показатели.Р23С213.Значение = 0 И НЕ Показатели.Р23С280.Значение = 0;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р23С280.Значение, 
		Показатели.Р23С213.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_46()
	...
	КолвоСтрок = КолвоСтрокМнЧ(ДанныеКС.Раздел03, "П000030000107_");
	Для Счетчик = 1 По КолвоСтрок Цикл
	
		ЗарегистрироватьФормулу(Настройки);
		ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел03, Счетчик);
		
		РасчетнаяСумма = Макс(Показатели.Р03Г003.Значение - Показатели.Р03Г004.Значение - Показатели.Р03Г006.Значение, 0);
...
&НаСервере
Процедура ПроверкаКС_1_47_доп()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.47.доп';
													|en = '1.47.доп'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Проверка носит справочный характер и может быть проигнорирована';
													|en = 'Проверка носит справочный характер и может быть проигнорирована'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Код обоснования применения налоговой ставки в первой части стр.124 Раздела 2.1.1 должен быть ';
			|en = 'Код обоснования применения налоговой ставки в первой части стр.124 Раздела 2.1.1 должен быть '") +
		НСтр("ru = 'заполнен, если значение налоговой ставки в стр.120, 121, 122, 123 Раздела 2.1.1 < 6';
			|en = 'заполнен, если значение налоговой ставки в стр.120, 121, 122, 123 Раздела 2.1.1 < 6'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение %1 заполнено, когда %2, %3, %4, %5 < 6';
													|en = 'Значение %1 заполнено, когда %2, %3, %4, %5 < 6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Не указан код обоснования применения налоговой ставки';
														|en = 'Не указан код обоснования применения налоговой ставки'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р21С001"		, "П002110012403");
	ИменаПоказателей.Вставить("Р21С002"		, "П002110012003");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110012103");
	ИменаПоказателей.Вставить("Р21С004"		, "П002110012203");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110012303");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	...
	УсловиеВыполнено = Макс(Показатели.Р21С002.Значение, Показатели.Р21С003.Значение, Показатели.Р21С004.Значение, 
		Показатели.Р21С005.Значение) > 0 И Мин(Показатели.Р21С002.Значение, Показатели.Р21С003.Значение, 
		Показатели.Р21С004.Значение, Показатели.Р21С005.Значение) < 6;
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ ЗначениеЗаполнено(Показатели.Р21С001.Значение);
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р21С001.ЗначениеСтр, Показатели.Р21С002.Значение, Показатели.Р21С003.Значение, 
		Показатели.Р21С004.Значение, Показатели.Р21С005.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_48_доп()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.48.доп';
													|en = '1.48.доп'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.1.1';
														|en = 'Раздел 2.1.1'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Проверка носит справочный характер и может быть проигнорирована';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Обоснование применения налоговой ставки во второй части стр.124 Раздела 2.1.1 должно быть ';
			|en = 'Обоснование применения налоговой ставки во второй части стр.124 Раздела 2.1.1 должно быть '") +
		НСтр("ru = 'заполнено и отлично от значения ""000000000000"", если значение налоговой ставки в ';
			|en = 'заполнено и отлично от значения ""000000000000"", если значение налоговой ставки в '") +
		НСтр("ru = 'стр.120, 121, 122, 123 Раздела 2.1.1 < 6';
			|en = 'стр.120, 121, 122, 123 Раздела 2.1.1 < 6'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение %1 заполнено, когда %2, %3, %4, %5 < 6';
													|en = 'Значение %1 заполнено, когда %2, %3, %4, %5 < 6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Не указано обоснование применения налоговой ставки';
														|en = 'Не указано обоснование применения налоговой ставки'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р21С001"		, "П002110012404");
	ИменаПоказателей.Вставить("Р21С002"		, "П002110012003");
	ИменаПоказателей.Вставить("Р21С003"		, "П002110012103");
	ИменаПоказателей.Вставить("Р21С004"		, "П002110012203");
	ИменаПоказателей.Вставить("Р21С005"		, "П002110012303");
	...
	УсловиеВыполнено = Макс(Показатели.Р21С002.Значение, Показатели.Р21С003.Значение, Показатели.Р21С004.Значение, 
		...
		Показатели.Р21С004.Значение, Показатели.Р21С005.Значение) < 6;
	Настройки.ЭтоОшибка = УсловиеВыполнено И (НЕ ЗначениеЗаполнено(Показатели.Р21С001.Значение) 
		ИЛИ Показатели.Р21С001.Значение = "000000000000");
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р21С001.ЗначениеСтр, Показатели.Р21С002.Значение, Показатели.Р21С003.Значение, 
		Показатели.Р21С004.Значение, Показатели.Р21С005.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
...
&НаСервере
Процедура ПроверкаКС_1_49_доп()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.49.доп';
													|en = '1.49.доп'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.2';
														|en = 'Раздел 2.2'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Проверка носит справочный характер и может быть проигнорирована';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Код обоснования применения налоговой ставки в первой части стр.264 Раздела 2.2 должен быть ';
			|en = 'Код обоснования применения налоговой ставки в первой части стр.264 Раздела 2.2 должен быть '") +
		НСтр("ru = 'заполнен, если значение налоговой ставки в стр.260, 261, 262, 263 Раздела 2.2 < 15';
			|en = 'заполнен, если значение налоговой ставки в стр.260, 261, 262, 263 Раздела 2.2 < 15'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение %1 заполнено, когда %2, %3, %4, %5 < 15';
													|en = 'Значение %1 заполнено, когда %2, %3, %4, %5 < 15'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Не указан код обоснования применения налоговой ставки';
														|en = 'Не указан код обоснования применения налоговой ставки'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220026403");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220026003");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220026103");
	ИменаПоказателей.Вставить("Р23С004"		, "П000220026203");
	ИменаПоказателей.Вставить("Р23С005"		, "П000220026303");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	...
	УсловиеВыполнено = Макс(Показатели.Р23С002.Значение, Показатели.Р23С003.Значение, Показатели.Р23С004.Значение, 
		Показатели.Р23С005.Значение) > 0 И Мин(Показатели.Р23С002.Значение, Показатели.Р23С003.Значение, 
		Показатели.Р23С004.Значение, Показатели.Р23С005.Значение) < 15;
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ ЗначениеЗаполнено(Показатели.Р23С001.Значение);
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р23С001.ЗначениеСтр, Показатели.Р23С002.Значение, Показатели.Р23С003.Значение, 
		Показатели.Р23С004.Значение, Показатели.Р23С005.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_50_доп()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.50.доп';
													|en = '1.50.доп'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2.2';
														|en = 'Раздел 2.2'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Проверка носит справочный характер и может быть проигнорирована';
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.346.20 НК РФ';
													|en = 'ст.346.20 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Обоснование применения налоговой ставки во второй части стр.264 Раздела 2.2 должно быть ';
			|en = 'Обоснование применения налоговой ставки во второй части стр.264 Раздела 2.2 должно быть '") +
		НСтр("ru = 'заполнено и отлично от значения ""000000000000"", если значение налоговой ставки в ';
			|en = 'заполнено и отлично от значения ""000000000000"", если значение налоговой ставки в '") +
		НСтр("ru = 'стр.260, 261, 262, 263 Раздела 2.2 < 15';
			|en = 'стр.260, 261, 262, 263 Раздела 2.2 < 15'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение %1 заполнено, когда %2, %3, %4, %5 < 15';
													|en = 'Значение %1 заполнено, когда %2, %3, %4, %5 < 15'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Не указано обоснование применения налоговой ставки';
														|en = 'Не указано обоснование применения налоговой ставки'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р23С001"		, "П000220026404");
	ИменаПоказателей.Вставить("Р23С002"		, "П000220026003");
	ИменаПоказателей.Вставить("Р23С003"		, "П000220026103");
	ИменаПоказателей.Вставить("Р23С004"		, "П000220026203");
	ИменаПоказателей.Вставить("Р23С005"		, "П000220026303");
	...
	УсловиеВыполнено = Макс(Показатели.Р23С002.Значение, Показатели.Р23С003.Значение, Показатели.Р23С004.Значение, 
		...
		Показатели.Р23С004.Значение, Показатели.Р23С005.Значение) < 15;
	Настройки.ЭтоОшибка = УсловиеВыполнено И (НЕ ЗначениеЗаполнено(Показатели.Р23С001.Значение) 
		ИЛИ Показатели.Р23С001.Значение = "000000000000");
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
		Показатели.Р23С001.ЗначениеСтр, Показатели.Р23С002.Значение, Показатели.Р23С003.Значение, 
		Показатели.Р23С004.Значение, Показатели.Р23С005.Значение);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_51()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = '(Стр.020 + стр.040 + стр.070 + стр.100) Раздела 1.1 >= (стр.050 + стр.080 + стр.110) Раздела 1.1';
			|en = '(Стр.020 + стр.040 + стр.070 + стр.100) Раздела 1.1 >= (стр.050 + стр.080 + стр.110) Раздела 1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '(%1 + %2 + %3 + %4) Итог [%5] >= (%6 + %7 + %8) Итог [%9]';
													|en = '(%1 + %2 + %3 + %4) Итог [%5] >= (%6 + %7 + %8) Итог [%9]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочные суммы авансовых платежей';
														|en = 'Ошибочные суммы авансовых платежей'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	РасчетнаяСумма1 = Показатели.Р11С020.Значение + Показатели.Р11С040.Значение + Показатели.Р11С070.Значение + 
		Показатели.Р11С100.Значение;
	РасчетнаяСумма2 = Показатели.Р11С050.Значение + Показатели.Р11С080.Значение + Показатели.Р11С110.Значение;
	Настройки.ЭтоОшибка = РасчетнаяСумма1 < РасчетнаяСумма2;
	Настройки.Расшифровка = СтрШаблон(Настройки.ШаблонРасшифровки, 
		...
		РасчетнаяСумма1, Показатели.Р11С050.Значение, Показатели.Р11С080.Значение, Показатели.Р11С110.Значение,
		РасчетнаяСумма2);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_52()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = '(Стр.020 + стр.040 + стр.070 + стр.100 + стр.120) Раздела 1.2 >= (стр.050 + стр.080 + ';
			|en = '(Стр.020 + стр.040 + стр.070 + стр.100 + стр.120) Раздела 1.2 >= (стр.050 + стр.080 + '") +
		НСтр("ru = 'стр.110) Раздела 1.2';
			|en = 'стр.110) Раздела 1.2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '(%1 + %2 + %3 + %4 + %5) Итог [%6] >= %7 Итог [%8]';
													|en = '(%1 + %2 + %3 + %4 + %5) Итог [%6] >= %7 Итог [%8]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочные суммы авансовых платежей';
														|en = 'Ошибочные суммы авансовых платежей'"));
	Настройки = ОбработатьНастройки(Заголовки);
	
	Настройки.Вставить("ШаблонРасшифровки2"	, НСтр("ru = '(%1 + %2 + %3)';
														|en = '(%1 + %2 + %3)'"));
	...
	РасчетнаяСумма1 = Показатели.Р12С020.Значение + Показатели.Р12С040.Значение + Показатели.Р12С070.Значение + 
		Показатели.Р12С100.Значение + Показатели.Р12С120.Значение;
	РасчетнаяСумма2 = Показатели.Р12С050.Значение + Показатели.Р12С080.Значение + Показатели.Р12С110.Значение;
	Настройки.ЭтоОшибка = РасчетнаяСумма1 < РасчетнаяСумма2;
	Расшифровка2 = СтрШаблон(Настройки.ШаблонРасшифровки2,
		Показатели.Р12С050.Значение, Показатели.Р12С080.Значение, Показатели.Р12С110.Значение);
	Настройки.Расшифровка = СтрШаблон(Настройки.ШаблонРасшифровки, 
		Показатели.Р12С020.Значение, Показатели.Р12С040.Значение, Показатели.Р12С070.Значение, Показатели.Р12С100.Значение, 
		Показатели.Р12С120.Значение, РасчетнаяСумма1, Расшифровка2, РасчетнаяСумма2);
	ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_1_53()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма авансового платежа в стр.020 Раздела 1.1 >= 0';
														|en = 'Сумма авансового платежа в стр.020 Раздела 1.1 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
	...
	Настройки.Вставить("Показатель"			, "П000110002003");
	
	ПроверкаКС_1_53_код(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_53_код(Настройки)
	
	Перем Показатели;
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р11С001", Настройки.Показатель);
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел11);
	
	Настройки.ЭтоОшибка = Показатели.Р11С001.Значение < 0;
	Настройки.Расшифровка = СтрШаблон(Настройки.ШаблонРасшифровки, 
...
Процедура ПроверкаКС_1_54()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма авансового платежа в стр.040 Раздела 1.1 >= 0';
														|en = 'Сумма авансового платежа в стр.040 Раздела 1.1 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
	...
	Настройки.Вставить("Показатель"			, "П000110004003");
...
Процедура ПроверкаКС_1_55()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма авансового платежа в стр.050 Раздела 1.1 >= 0';
														|en = 'Сумма авансового платежа в стр.050 Раздела 1.1 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
	...
	Настройки.Вставить("Показатель"			, "П000110005003");
...
Процедура ПроверкаКС_1_56()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма авансового платежа в стр.070 Раздела 1.1 >= 0';
														|en = 'Сумма авансового платежа в стр.070 Раздела 1.1 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
	...
	Настройки.Вставить("Показатель"			, "П000110007003");
...
Процедура ПроверкаКС_1_57()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма авансового платежа в стр.080 Раздела 1.1 >= 0';
														|en = 'Сумма авансового платежа в стр.080 Раздела 1.1 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
	...
	Настройки.Вставить("Показатель"			, "П000110008003");
...
Процедура ПроверкаКС_1_58()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога в стр.100 Раздела 1.1 >= 0';
														|en = 'Сумма налога в стр.100 Раздела 1.1 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	...
	Настройки.Вставить("Показатель"			, "П000110010003");
...
Процедура ПроверкаКС_1_59()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога в стр.110 Раздела 1.1 >= 0';
														|en = 'Сумма налога в стр.110 Раздела 1.1 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	...
	Настройки.Вставить("Показатель"			, "П000110011003");
...
Процедура ПроверкаКС_1_60()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма авансового платежа в стр.020 Раздела 1.2 >= 0';
														|en = 'Сумма авансового платежа в стр.020 Раздела 1.2 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
	...
	Настройки.Вставить("Показатель"			, "П000120002003");
...
Процедура ПроверкаКС_1_60_код(Настройки)
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р12С001", Настройки.Показатель);
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел12);
	
	Настройки.ЭтоОшибка = Показатели.Р12С001.Значение < 0;
	Настройки.Расшифровка = СтрШаблон(Настройки.ШаблонРасшифровки, 
...
Процедура ПроверкаКС_1_61()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма авансового платежа в стр.040 Раздела 1.2 >= 0';
														|en = 'Сумма авансового платежа в стр.040 Раздела 1.2 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
	...
	Настройки.Вставить("Показатель"			, "П000120004003");
...
Процедура ПроверкаКС_1_62()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма авансового платежа в стр.050 Раздела 1.2 >= 0';
														|en = 'Сумма авансового платежа в стр.050 Раздела 1.2 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
	...
	Настройки.Вставить("Показатель"			, "П000120005003");
...
Процедура ПроверкаКС_1_63()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма авансового платежа в стр.070 Раздела 1.2 >= 0';
														|en = 'Сумма авансового платежа в стр.070 Раздела 1.2 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
	...
	Настройки.Вставить("Показатель"			, "П000120007003");
...
Процедура ПроверкаКС_1_64()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма авансового платежа в стр.080 Раздела 1.2 >= 0';
														|en = 'Сумма авансового платежа в стр.080 Раздела 1.2 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма авансового платежа';
														|en = 'Ошибочная сумма авансового платежа'"));
	...
	Настройки.Вставить("Показатель"			, "П000120008003");
...
Процедура ПроверкаКС_1_65()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога в стр.100 Раздела 1.2 >= 0';
														|en = 'Сумма налога в стр.100 Раздела 1.2 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	...
	Настройки.Вставить("Показатель"			, "П000120010003");
...
Процедура ПроверкаКС_1_66()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога в стр.110 Раздела 1.2 >= 0';
														|en = 'Сумма налога в стр.110 Раздела 1.2 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	...
	Настройки.Вставить("Показатель"			, "П000120011003");
...
Процедура ПроверкаКС_1_67()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога в стр.120 Раздела 1.2 >= 0';
														|en = 'Сумма налога в стр.120 Раздела 1.2 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	...
	Настройки.Вставить("Показатель"			, "П000120012003");
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(Параметры.мВыбраннаяФорма) Тогда 
		ЧастиИмениФормы = СтрРазделить(ЭтотОбъект.ИмяФормы, ".");
		Параметры.мВыбраннаяФорма = ЧастиИмениФормы[ЧастиИмениФормы.ВГраница()];
	КонецЕсли;
	...
	Если СтруктураРеквизитовФормы.мСохраненныйДок = Неопределено
		...
		ИначеЕсли ИсходныйГод <> ОтчетныйГод Тогда
			...
			Если СтруктураРеквизитовФормы.ИП Тогда
				ГодыНалоговыхКаникулИП = "2015|2016|2017|2018|2019|2020|2021|2022|2023";
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = Отчеты[СтруктураРеквизитовФормы.НаименованиеОтчета].ПолучитьМакет("СпискиВыбора2021Кв1");
...
Процедура ОбновитьПользовательскиеНастройки()
	...
	Сообщение.Текст = НСтр("ru = 'Изменилась версия формы отчета. Выполняется обновление пользовательских настроек...';
							|en = 'Изменилась версия формы отчета. Выполняется обновление пользовательских настроек...'");
	Сообщение.Сообщить();
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000120010003", "П000120010103;П000220021303;П000220022303;П000220023003;П000220026303;П000220021203;П000220022203;П000220026203;П000220021103;П000220022103;П000220026103;П000220021003;П000220022003;П000220026003");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000120012003", "П000120010103;П000220021303;П000220022303;П000220023003;П000220026303;П000220021203;П000220022203;П000220026203;П000220021103;П000220022103;П000220026103;П000220021003;П000220022003;П000220026003");
	
	// Раздел 2.1.
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П002110010103", "П002110012003;П002110012103;П002110012203;П002110012303");
	
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П002110013003", "П002110011003;П002110012003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П002110013103", "П002110011003;П002110011103;П002110012003;П002110012103");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П002110013203", "П002110011003;П002110011103;П002110011203;П002110012003;П002110012103;П002110012203");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П002110013303", "П002110011003;П002110011103;П002110011203;П002110012003;П002110012103;П002110012203;П002110011303;П002110012303");
	
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П002120013003", "П002120011003;П002110012003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П002120013103", "П002120011003;П002120011103;П002110012003;П002110012103");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П002120013203", "П002120011003;П002120011103;П002120011203;П002110012003;П002110012103;П002110012203");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П002120013303", "П002120011003;П002120011103;П002120011203;П002120011303;П002110012003;П002110012103;П002110012203;П002110012303");
	...
	// Раздел 2.2.
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000220020103", "П000220026003;П000220026103;П000220026203;П000220026303");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000220027103", "П000220021003;П000220021103;П000220022003;П000220022103;П000220026003;П000220026103");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000220027203", "П000220021003;П000220021103;П000220021203;П000220022003;П000220022103;П000220022203;П000220026003;П000220026103;П000220026203");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000220027303", "П000220021003;П000220021103;П000220021203;П000220021303;П000220022003;П000220022103;П000220022203;П000220022303;П000220023003;П000220026003;П000220026103;П000220026203;П000220026303");
...
Процедура Расчет(Форма, ИмяРаздела = "", ОбластьИмя = "")
	...
	Если ИмяРаздела = "Раздел11" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел11" Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
				...
				ТДО["П000110010003"].Значение = Макс(0, Окр_П002110013303 - Окр_П002110014303
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел12" Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
				...
				Если Окр_П000220027303 >= Окр_П000220028003 Тогда
					ТДО["П000120010003"].Значение = Макс(0, Окр_П000220027303 - (Окр_П000120002003
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
				...
				Если Окр_П000220028003 > Окр_П000220027303 Тогда
					ТДО["П000120012003"].Значение = Макс(0, Окр_П000220028003 - (Окр_П000120002003
					+ Окр_П000120004003 - Окр_П000120005003 + Окр_П000120007003 - Окр_П000120008003) - Окр_П000120010103);
				Иначе
	...
	ИначеЕсли ИмяРаздела = "Раздел21" Тогда
		...
		Если Год(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) >= 2022 Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
				...
				Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
					...
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012103"].Значение > ТДО["П002110012003"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П002110011103"].Значение) - ОкрЧФ(Форма, ТДО["П002110011003"].Значение);
						ТДО["П002110013103"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002110013003"].Значение) + РазностьНалБаз * ТДО["П002110012103"].Значение / 100));
					Иначе
						ТДО["П002110013103"].Значение = 0;
					КонецЕсли;
				Иначе
					...
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012103"] > ДанРазд["П002110012003"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П002110011103"]) - ОкрЧФ(Форма, ДанРазд["П002110011003"]);
						ДанРазд.Вставить("П002110013103", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002110013003"]) + РазностьНалБаз * ДанРазд["П002110012103"] / 100)));
					Иначе
						ДанРазд.Вставить("П002110013103", 0);
					КонецЕсли;
				КонецЕсли;
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
				...
				Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
					...
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012203"].Значение > ТДО["П002110012103"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П002110011203"].Значение) - ОкрЧФ(Форма, ТДО["П002110011103"].Значение);
						ТДО["П002110013203"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002110013103"].Значение) + РазностьНалБаз * ТДО["П002110012203"].Значение / 100));
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012203"].Значение = ТДО["П002110012103"].Значение
						И ТДО["П002110012203"].Значение > ТДО["П002110012003"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П002110011203"].Значение) - ОкрЧФ(Форма, ТДО["П002110011003"].Значение);
						ТДО["П002110013203"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002110013003"].Значение) + РазностьНалБаз * ТДО["П002110012203"].Значение / 100));
					Иначе
						ТДО["П002110013203"].Значение = 0;
					КонецЕсли;
				Иначе
					...
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012203"] > ДанРазд["П002110012103"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П002110011203"]) - ОкрЧФ(Форма, ДанРазд["П002110011103"]);
						ДанРазд.Вставить("П002110013203", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002110013103"]) + РазностьНалБаз * ДанРазд["П002110012203"] / 100)));
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012203"] = ДанРазд["П002110012103"]
						И ДанРазд["П002110012203"] > ДанРазд["П002110012003"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П002110011203"]) - ОкрЧФ(Форма, ДанРазд["П002110011003"]);
						ДанРазд.Вставить("П002110013203", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002110013003"]) + РазностьНалБаз * ДанРазд["П002110012203"] / 100)));
					Иначе
						ДанРазд.Вставить("П002110013203", 0);
					КонецЕсли;
				КонецЕсли;
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
				...
				Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
					...
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012303"].Значение > ТДО["П002110012203"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П002110011303"].Значение) - ОкрЧФ(Форма, ТДО["П002110011203"].Значение);
						ТДО["П002110013303"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002110013203"].Значение) + РазностьНалБаз * ТДО["П002110012303"].Значение / 100));
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012303"].Значение = ТДО["П002110012203"].Значение
						И ТДО["П002110012303"].Значение > ТДО["П002110012103"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П002110011303"].Значение) - ОкрЧФ(Форма, ТДО["П002110011103"].Значение);
						ТДО["П002110013303"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002110013103"].Значение) + РазностьНалБаз * ТДО["П002110012303"].Значение / 100));
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012303"].Значение = ТДО["П002110012103"].Значение
						И ТДО["П002110012303"].Значение > ТДО["П002110012003"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П002110011303"].Значение) - ОкрЧФ(Форма, ТДО["П002110011003"].Значение);
						ТДО["П002110013303"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002110013003"].Значение) + РазностьНалБаз * ТДО["П002110012303"].Значение / 100));
					Иначе
						ТДО["П002110013303"].Значение = 0;
					КонецЕсли;
				Иначе
					...
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012303"] > ДанРазд["П002110012203"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П002110011303"]) - ОкрЧФ(Форма, ДанРазд["П002110011203"]);
						ДанРазд.Вставить("П002110013303", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002110013203"]) + РазностьНалБаз * ДанРазд["П002110012303"] / 100)));
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012303"] = ДанРазд["П002110012203"]
						И ДанРазд["П002110012303"] > ДанРазд["П002110012103"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П002110011303"]) - ОкрЧФ(Форма, ДанРазд["П002110011103"]);
						ДанРазд.Вставить("П002110013303", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002110013103"]) + РазностьНалБаз * ДанРазд["П002110012303"] / 100)));
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012303"] = ДанРазд["П002110012103"]
						И ДанРазд["П002110012303"] > ДанРазд["П002110012003"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П002110011303"]) - ОкрЧФ(Форма, ДанРазд["П002110011003"]);
						ДанРазд.Вставить("П002110013303", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002110013003"]) + РазностьНалБаз * ДанРазд["П002110012303"] / 100)));
					Иначе
						ДанРазд.Вставить("П002110013303", 0);
					КонецЕсли;
				КонецЕсли;
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
				...
				Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
					...
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012103"].Значение > ТДО["П002110012003"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П002120011103"].Значение) - ОкрЧФ(Форма, ТДО["П002120011003"].Значение);
						ТДО["П002120013103"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002120013003"].Значение) + РазностьНалБаз * ТДО["П002110012103"].Значение / 100));
					Иначе
						ТДО["П002120013103"].Значение = 0;
					КонецЕсли;
				Иначе
					...
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012103"] > ДанРазд["П002110012003"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П002120011103"]) - ОкрЧФ(Форма, ДанРазд["П002120011003"]);
						ДанРазд.Вставить("П002120013103", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002120013003"]) + РазностьНалБаз * ДанРазд["П002110012103"] / 100)));
					Иначе
						ДанРазд.Вставить("П002120013103", 0);
					КонецЕсли;
				КонецЕсли;
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
				...
				Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
					...
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012203"].Значение > ТДО["П002110012103"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П002120011203"].Значение) - ОкрЧФ(Форма, ТДО["П002120011103"].Значение);
						ТДО["П002120013203"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002120013103"].Значение) + РазностьНалБаз * ТДО["П002110012203"].Значение / 100));
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012203"].Значение = ТДО["П002110012103"].Значение
						И ТДО["П002110012203"].Значение > ТДО["П002110012003"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П002120011203"].Значение) - ОкрЧФ(Форма, ТДО["П002120011003"].Значение);
						ТДО["П002120013203"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002120013003"].Значение) + РазностьНалБаз * ТДО["П002110012203"].Значение / 100));
					Иначе
						ТДО["П002120013203"].Значение = 0;
					КонецЕсли;
				Иначе
					...
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012203"] > ДанРазд["П002110012103"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П002120011203"]) - ОкрЧФ(Форма, ДанРазд["П002120011103"]);
						ДанРазд.Вставить("П002120013203", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002120013103"]) + РазностьНалБаз * ДанРазд["П002110012203"] / 100)));
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012203"] = ДанРазд["П002110012103"]
						И ДанРазд["П002110012203"] > ДанРазд["П002110012003"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П002120011203"]) - ОкрЧФ(Форма, ДанРазд["П002120011003"]);
						ДанРазд.Вставить("П002120013203", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002120013003"]) + РазностьНалБаз * ДанРазд["П002110012203"] / 100)));
					Иначе
						ДанРазд.Вставить("П002120013203", 0);
					КонецЕсли;
				КонецЕсли;
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
				...
				Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
					...
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012303"].Значение > ТДО["П002110012203"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П002120011303"].Значение) - ОкрЧФ(Форма, ТДО["П002120011203"].Значение);
						ТДО["П002120013303"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002120013203"].Значение) + РазностьНалБаз * ТДО["П002110012303"].Значение / 100));
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012303"].Значение = ТДО["П002110012203"].Значение
						И ТДО["П002110012303"].Значение > ТДО["П002110012103"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П002120011303"].Значение) - ОкрЧФ(Форма, ТДО["П002120011103"].Значение);
						ТДО["П002120013303"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002120013103"].Значение) + РазностьНалБаз * ТДО["П002110012303"].Значение / 100));
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012303"].Значение = ТДО["П002110012103"].Значение
						И ТДО["П002110012303"].Значение > ТДО["П002110012003"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П002120011303"].Значение) - ОкрЧФ(Форма, ТДО["П002120011003"].Значение);
						ТДО["П002120013303"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002120013003"].Значение) + РазностьНалБаз * ТДО["П002110012303"].Значение / 100));
					Иначе
						ТДО["П002120013303"].Значение = 0;
					КонецЕсли;
				Иначе
					...
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012303"] > ДанРазд["П002110012203"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П002120011303"]) - ОкрЧФ(Форма, ДанРазд["П002120011203"]);
						ДанРазд.Вставить("П002120013303", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002120013203"]) + РазностьНалБаз * ДанРазд["П002110012303"] / 100)));
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012303"] = ДанРазд["П002110012203"]
						И ДанРазд["П002110012303"] > ДанРазд["П002110012103"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П002120011303"]) - ОкрЧФ(Форма, ДанРазд["П002120011103"]);
						ДанРазд.Вставить("П002120013303", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002120013103"]) + РазностьНалБаз * ДанРазд["П002110012303"] / 100)));
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012303"] = ДанРазд["П002110012103"]
						И ДанРазд["П002110012303"] > ДанРазд["П002110012003"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П002120011303"]) - ОкрЧФ(Форма, ДанРазд["П002120011003"]);
						ДанРазд.Вставить("П002120013303", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002120013003"]) + РазностьНалБаз * ДанРазд["П002110012303"] / 100)));
					Иначе
						ДанРазд.Вставить("П002120013303", 0);
					КонецЕсли;
				КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Иначе
				Окр_П002110013003 = ОкрЧФ(Форма, ДанРазд["П002110013003"]);
				Окр_П002110014003 = ОкрЧФ(Форма, ДанРазд["П002110014003"]);
				Окр_П002120016003 = ОкрЧФ(Форма, ДанРазд["П002120016003"]);
			КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Иначе
				Окр_П002110013103 = ОкрЧФ(Форма, ДанРазд["П002110013103"]);
				Окр_П002110014103 = ОкрЧФ(Форма, ДанРазд["П002110014103"]);
				Окр_П002120016103 = ОкрЧФ(Форма, ДанРазд["П002120016103"]);
			КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Иначе
				Окр_П002110013203 = ОкрЧФ(Форма, ДанРазд["П002110013203"]);
				Окр_П002110014203 = ОкрЧФ(Форма, ДанРазд["П002110014203"]);
				Окр_П002120016203 = ОкрЧФ(Форма, ДанРазд["П002120016203"]);
			КонецЕсли;
			Окр_П000110002003 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел11["П000110002003"]);
			...
			Форма.СтруктураДанныхРаздел11.Вставить("П000110007003", Макс(0, Окр_П002110013203
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Окр_П000110004003 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел11["П000110004003"]);
			Окр_П000110005003 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел11["П000110005003"]);
			Форма.СтруктураДанныхРаздел11.Вставить("П000110008003", Макс(0, Окр_П000110002003
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Иначе
				Окр_П002110013303 = ОкрЧФ(Форма, ДанРазд["П002110013303"]);
				Окр_П002110014303 = ОкрЧФ(Форма, ДанРазд["П002110014303"]);
				Окр_П002120016303 = ОкрЧФ(Форма, ДанРазд["П002120016303"]);
			КонецЕсли;
			Окр_П000110002003 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел11["П000110002003"]);
			Окр_П000110004003 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел11["П000110004003"]);
			Окр_П000110005003 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел11["П000110005003"]);
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Окр_П000110007003 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел11["П000110007003"]);
			Окр_П000110008003 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел11["П000110008003"]);
			Форма.СтруктураДанныхРаздел11.Вставить("П000110011003",
	...
	ИначеЕсли ИмяРаздела = "Раздел22" Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
				...
				Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел22" Тогда
					...
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П000220026103"].Значение > ТДО["П000220026003"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П000220024103"].Значение) - ОкрЧФ(Форма, ТДО["П000220024003"].Значение);
						ТДО["П000220027103"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П000220027003"].Значение) + РазностьНалБаз * ТДО["П000220026103"].Значение / 100));
					Иначе
						ТДО["П000220027103"].Значение = 0;
					КонецЕсли;
				Иначе
					...
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П000220026103"] > ДанРазд["П000220026003"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П000220024103"]) - ОкрЧФ(Форма, ДанРазд["П000220024003"]);
						ДанРазд.Вставить("П000220027103", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П000220027003"]) + РазностьНалБаз * ДанРазд["П000220026103"] / 100)));
					Иначе
						ДанРазд.Вставить("П000220027103", 0);
					КонецЕсли;
				КонецЕсли;
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
				...
				Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел22" Тогда
					...
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П000220026203"].Значение = ТДО["П000220026103"].Значение
						...
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П000220024203"].Значение) - ОкрЧФ(Форма, ТДО["П000220024003"].Значение);
						ТДО["П000220027203"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П000220027003"].Значение) + РазностьНалБаз * ТДО["П000220026203"].Значение / 100));
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П000220026203"].Значение > ТДО["П000220026103"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П000220024203"].Значение) - ОкрЧФ(Форма, ТДО["П000220024103"].Значение);
						ТДО["П000220027203"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П000220027103"].Значение) + РазностьНалБаз * ТДО["П000220026203"].Значение / 100));
					Иначе
						ТДО["П000220027203"].Значение = 0;
					КонецЕсли;
				Иначе
					...
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П000220026203"] = ДанРазд["П000220026103"]
						...
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П000220024203"]) - ОкрЧФ(Форма, ДанРазд["П000220024003"]);
						ДанРазд.Вставить("П000220027203", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П000220027003"]) + РазностьНалБаз * ДанРазд["П000220026203"] / 100)));
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П000220026203"] > ДанРазд["П000220026103"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П000220024203"]) - ОкрЧФ(Форма, ДанРазд["П000220024103"]);
						ДанРазд.Вставить("П000220027203", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П000220027103"]) + РазностьНалБаз * ДанРазд["П000220026203"] / 100)));
					Иначе
						ДанРазд.Вставить("П000220027203", 0);
					КонецЕсли;
				КонецЕсли;
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
				...
				Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел22" Тогда
					...
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П000220026303"].Значение > ТДО["П000220026203"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П000220024303"].Значение) - ОкрЧФ(Форма, ТДО["П000220024203"].Значение);
						ТДО["П000220027303"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П000220027203"].Значение) + РазностьНалБаз * ТДО["П000220026303"].Значение / 100));
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П000220026303"].Значение = ТДО["П000220026203"].Значение
						И ТДО["П000220026303"].Значение > ТДО["П000220026103"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П000220024303"].Значение) - ОкрЧФ(Форма, ТДО["П000220024103"].Значение);
						ТДО["П000220027303"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П000220027103"].Значение) + РазностьНалБаз * ТДО["П000220026303"].Значение / 100));
					ИначеЕсли ПризнакСтавки = "2" И ТДО["П000220026303"].Значение = ТДО["П000220026103"].Значение
						И ТДО["П000220026303"].Значение > ТДО["П000220026003"].Значение Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ТДО["П000220024303"].Значение) - ОкрЧФ(Форма, ТДО["П000220024003"].Значение);
						ТДО["П000220027303"].Значение = Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П000220027003"].Значение) + РазностьНалБаз * ТДО["П000220026303"].Значение / 100));
					Иначе
						ТДО["П000220027303"].Значение = 0;
					КонецЕсли;
				Иначе
					...
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П000220026303"] > ДанРазд["П000220026203"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П000220024303"]) - ОкрЧФ(Форма, ДанРазд["П000220024203"]);
						ДанРазд.Вставить("П000220027303", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П000220027203"]) + РазностьНалБаз * ДанРазд["П000220026303"] / 100)));
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П000220026303"] = ДанРазд["П000220026203"]
						И ДанРазд["П000220026303"] > ДанРазд["П000220026103"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П000220024303"]) - ОкрЧФ(Форма, ДанРазд["П000220024103"]);
						ДанРазд.Вставить("П000220027303", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П000220027103"]) + РазностьНалБаз * ДанРазд["П000220026303"] / 100)));
					ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П000220026303"] = ДанРазд["П000220026103"]
						И ДанРазд["П000220026303"] > ДанРазд["П000220026003"] Тогда
						РазностьНалБаз = ОкрЧФ(Форма, ДанРазд["П000220024303"]) - ОкрЧФ(Форма, ДанРазд["П000220024003"]);
						ДанРазд.Вставить("П000220027303", Макс(0,
						ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П000220027003"]) + РазностьНалБаз * ДанРазд["П000220026303"] / 100)));
					Иначе
						ДанРазд.Вставить("П000220027303", 0);
					КонецЕсли;
				КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел22" Тогда
				Если Форма.СтруктураРеквизитовФормы.ИП
					...
					И Год(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) <= 2023
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Иначе
				Окр_П000220027003 = ОкрЧФ(Форма, ДанРазд["П000220027003"]);
			КонецЕсли;
			Форма.СтруктураДанныхРаздел12.Вставить("П000120002003", Окр_П000220027003);
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Иначе
				Окр_П000220027103 = ОкрЧФ(Форма, ДанРазд["П000220027103"]);
			КонецЕсли;
			Окр_П000120002003 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел12["П000120002003"]);
			Форма.СтруктураДанныхРаздел12.Вставить("П000120004003", Макс(0, Окр_П000220027103 - Окр_П000120002003));
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			КонецЕсли;
			Окр_П000120002003 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел12["П000120002003"]);
			Форма.СтруктураДанныхРаздел12.Вставить("П000120005003", - Мин(0, Окр_П000220027103 - Окр_П000120002003));
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Иначе
				Окр_П000220027203 = ОкрЧФ(Форма, ДанРазд["П000220027203"]);
			КонецЕсли;
			Окр_П000120002003 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел12["П000120002003"]);
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Иначе
				Окр_П000220027303 = ОкрЧФ(Форма, ДанРазд["П000220027303"]);
				Окр_П000220028003 = ОкрЧФ(Форма, ДанРазд["П000220028003"]);
			КонецЕсли;
			Окр_П000120002003 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел12["П000120002003"]);
			Окр_П000120004003 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел12["П000120004003"]);
			Окр_П000120005003 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел12["П000120005003"]);
			...
			Если Окр_П000220027303 >= Окр_П000220028003 Тогда
				Форма.СтруктураДанныхРаздел12.Вставить("П000120010003", Макс(0, Окр_П000220027303 - (Окр_П000120002003
				+ Окр_П000120004003 - Окр_П000120005003 + Окр_П000120007003 - Окр_П000120008003) - Окр_П000120010103));
			Иначе
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Окр_П000120008003 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел12["П000120008003"]);
			Если Окр_П000220027303 >= Окр_П000220028003 Тогда
				Форма.СтруктураДанныхРаздел12.Вставить("П000120011003", - Мин(0, Окр_П000220027303 - (Окр_П000120002003
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Окр_П000120010103 = ОкрЧФ(Форма, Форма.СтруктураДанныхРаздел12["П000120010103"]);
			Если Окр_П000220028003 > Окр_П000220027303 Тогда
				Форма.СтруктураДанныхРаздел12.Вставить("П000120012003", Макс(0, Окр_П000220028003 - (Окр_П000120002003
				+ Окр_П000120004003 - Окр_П000120005003 + Окр_П000120007003 - Окр_П000120008003) - Окр_П000120010103));
			Иначе
	...
	Иначе
		...
		Если ЗначениеЗаполнено(ПарамКодыНалога211) ИЛИ ЗначениеЗаполнено(ПарамКодыНалога212) Тогда
			...
			ТекстВопроса = НСтр("ru = 'Сумма страховых взносов, выплаченных работникам пособий по временной
									...
									|en = 'Сумма страховых взносов, выплаченных работникам пособий по временной
									|нетрудоспособности и платежей (взносов) по договорам добровольного
									|личного страхования (нарастающим итогом) по код%1 стр. %2,
									|предусмотренных пунктом 3.1 статьи 346.21 Кодекса, уменьшает сумму
									|исчисленного налога (авансового платежа по налогу) по код%1 стр. %3
...
Процедура ПриОткрытииЗавершение(Отказ, ДополнительныеПараметры) Экспорт
	...
	Если ЭтоАдресВременногоХранилища(ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(СтруктураРеквизитовФормы, "ПараметрыФормированияПриОткрытии", "")) Тогда 
		...
		ПараметрыОжидания.ТекстСообщения = НСтр("ru = 'Выполняется формирование отчета';
												|en = 'Выполняется формирование отчета'");
...
Процедура ОбработкаИзмененияСодержимогоВПолеТабличногоДокумента(Элемент, Область)
	...
	Если ИмяПоказателя = "П002110010103" Тогда
		...
		Если НЕ (ЗначПоказателя = "1" ИЛИ ЗначПоказателя = "2") Тогда
			...
			|en = 'Задано некорректное значение кода признака применения налоговой ставки.%1Допустимы значения 1 или 2'"),
			Символы.ПС);
			Сообщение.Сообщить();
	...
	Если ИмяПоказателя = "П002110010203" Тогда
		...
		Если НЕ (ЗначПоказателя = "1" ИЛИ ЗначПоказателя = "2") Тогда
			...
			|en = 'Задано некорректное значение признака налогоплательщика.%1Допустимы значения 1 или 2'"),
			Символы.ПС);
			Сообщение.Сообщить();
	...
	Если ИмяПоказателя = "П002110012003" Тогда
		Если ЗначПоказателя > 6 И ЗначПоказателя <> 8 Тогда
			...
			|en = 'Значение налоговой ставки должно либо не превышать 6%, либо равняться 8%'");
			Сообщение.Сообщить();
		КонецЕсли;
	...
	Если ИмяПоказателя = "П000220026003" Тогда
		Если ЗначПоказателя > 15 И ЗначПоказателя <> 20 Тогда
			...
			|en = 'Значение налоговой ставки должно либо не превышать 15%, либо равняться 20%'");
			Сообщение.Сообщить();
		КонецЕсли;
...
Функция ЗаполненРаздел3()
	...
	Иначе
		...
		Для Каждого Показатель Из СтруктураДанныхРаздел3 Цикл
...
Функция ИзвлечьСтруктуруXML()
	...
	Макет =Отчеты[СтруктураРеквизитовФормы.НаименованиеОтчета].ПолучитьМакет("СхемаВыгрузки506");
...
Функция ВыгрузкаВозможна(ПараметрыВыгрузки)
	...
	Если ПрименяетсяУСН(ЭтотОбъект) Тогда
		КодВидаОбъекта = КодВидаОбъектаНалогообложения(ЭтотОбъект);
	Иначе
	...
	Если КодВидаОбъекта = 1 Тогда
		Если ЗаполненоПоКоду2 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "При действующей системе налогообложения не допускается заполнение отчета по объектам налогообложения с кодом 2", "Раздел12", "П000120001003");
			СтатусПроверки = Ложь;
	...
	ИначеЕсли КодВидаОбъекта = 2 Тогда
		Если ЗаполненоПоКоду1 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "При действующей системе налогообложения не допускается заполнение отчета по объектам налогообложения с кодом 1", "Раздел11", "П000110001003");
			СтатусПроверки = Ложь;
			СочетаниеРазделовКорректно = Ложь;
		КонецЕсли;
	...
	Иначе
		Если ЗаполненоПоКоду1 И ЗаполненоПоКоду2 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "Не допускается одновременное заполнение отчета по объектам налогообложения с кодами 1 и 2", "Раздел11", "П000110001003");
			СтатусПроверки = Ложь;
			СочетаниеРазделовКорректно = Ложь;
		Иначе
			Если НЕ ПараметрыВыгрузки.ВыгружатьРаздел11 И НЕ ПараметрыВыгрузки.ВыгружатьРаздел12 Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект, "Не указан объект налогообложения УСН", "Раздел11", "П000110001003");
				СтатусПроверки = Ложь;
				СочетаниеРазделовКорректно = Ложь;
			КонецЕсли;
		КонецЕсли;
