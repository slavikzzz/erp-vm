...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки, ЕстьПредупреждения = Ложь)
	...
	Если НЕ (ПараметрыВыгрузки.ОтчетГод >= 2021 И ПараметрыВыгрузки.ОтчетГод <= 2024) Тогда
		СообщитьВТС("ОШИБКА: Задан год представления отчета, не входящий в интервал с 2021 г. по 2024 г.", "Титульный", "NamePeriod");
		СтатусПроверки = Ложь;
	КонецЕсли;
...
Процедура ЗагрузитьПодготовленныеДанные()
	...
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел11"] = ПоместитьВоВременноеХранилище(Контейнер.Раздел11, СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел11"]);
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел121"] = ПоместитьВоВременноеХранилище(Контейнер.Раздел121, СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел121"]);
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел122"] = ПоместитьВоВременноеХранилище(Контейнер.Раздел122, СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел122"]);
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел21"] = ПоместитьВоВременноеХранилище(Контейнер.Раздел21, СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел21"]);
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел221"] = ПоместитьВоВременноеХранилище(Контейнер.Раздел221, СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел221"]);
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел222"] = ПоместитьВоВременноеХранилище(Контейнер.Раздел222, СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел222"]);
...
Функция ЗаполнитьАвтоНаСервере()
	...
	Контейнер.Вставить("Раздел11", ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел11"]));
	Контейнер.Вставить("Раздел121", ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел121"]));
	Контейнер.Вставить("Раздел122", ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел122"]));
	Контейнер.Вставить("Раздел21", ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел21"]));
	Контейнер.Вставить("Раздел221", ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел221"]));
	Контейнер.Вставить("Раздел222", ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел222"]));
