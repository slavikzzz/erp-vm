...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	СтруктураРеквизитовФормы.Вставить("мИдГруппы210");
	СтруктураРеквизитовФормы.Вставить("мИдГруппы221");
	СтруктураРеквизитовФормы.Вставить("мИдГруппы222");
...
Процедура ИнициализироватьМногострочныеЧасти()
	...
	СтруктураРеквизитовФормы.мИдГруппы210 = "П21000";
	СтруктураРеквизитовФормы.мИдГруппы221 = "П22100";
	СтруктураРеквизитовФормы.мИдГруппы222 = "П22200";
	...
	ИменаГраф.Добавить("П1210006");
	ИменаГраф.Добавить("П1210007");
	ИменаГраф.Добавить("П1210008");
	ИменаГраф.Добавить("П1210009");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
	...
	ИменаГраф.Добавить("П1220006");
	ИменаГраф.Добавить("П1220007");
	ИменаГраф.Добавить("П1220008");
	ИменаГраф.Добавить("П1220009");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
	...
	// Группа П21000.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П2100001");
	ИменаГраф.Добавить("П2100002");
	ИменаГраф.Добавить("П2100003");
	ИменаГраф.Добавить("П2100004");
	ИменаГраф.Добавить("П2100005");
	ИменаГраф.Добавить("П2100006");
	ИменаГраф.Добавить("П2100007");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
		СтруктураРеквизитовФормы.мИдГруппы210, Новый Структура(
		"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп",
		ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
	
	// Группа П22100.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П2210001");
	ИменаГраф.Добавить("П2210002");
	ИменаГраф.Добавить("П2210003");
	ИменаГраф.Добавить("П2210004");
	ИменаГраф.Добавить("П2210005");
	ИменаГраф.Добавить("П2210006");
	ИменаГраф.Добавить("П2210007");
	ИменаГраф.Добавить("П2210008");
	ИменаГраф.Добавить("П2210009");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
		СтруктураРеквизитовФормы.мИдГруппы221, Новый Структура(
		"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп",
		ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
	
	// Группа П22200.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П2220001");
	ИменаГраф.Добавить("П2220002");
	ИменаГраф.Добавить("П2220003");
	ИменаГраф.Добавить("П2220004");
	ИменаГраф.Добавить("П2220005");
	ИменаГраф.Добавить("П2220006");
	ИменаГраф.Добавить("П2220007");
	ИменаГраф.Добавить("П2220008");
	ИменаГраф.Добавить("П2220009");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
		СтруктураРеквизитовФормы.мИдГруппы222, Новый Структура(
		"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп",
		ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
...
Процедура ИнициализироватьМногоуровневыеРазделы()
	...
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппы110);
	...
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	мСтруктураМногоуровневыхРазделов.Вставить("Раздел121", СтруктураРаздела);
	
	СтруктураРаздела = Новый Структура;
	ИменаГруппМнЧ = Новый Массив;
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппы122);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	мСтруктураМногоуровневыхРазделов.Вставить("Раздел122", СтруктураРаздела);
	
	СтруктураРаздела = Новый Структура;
	ИменаГруппМнЧ = Новый Массив;
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппы210);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	мСтруктураМногоуровневыхРазделов.Вставить("Раздел21", СтруктураРаздела);
	
	СтруктураРаздела = Новый Структура;
	ИменаГруппМнЧ = Новый Массив;
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппы221);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	мСтруктураМногоуровневыхРазделов.Вставить("Раздел221", СтруктураРаздела);
	СтруктураРаздела = Новый Структура;
	
	ИменаГруппМнЧ = Новый Массив;
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппы222);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	мСтруктураМногоуровневыхРазделов.Вставить("Раздел222", СтруктураРаздела);
...
Процедура ФормироватьСтруктуруСтраницОтчета() Экспорт
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "Раздел121";
	СтрокаУровня1.Представление            = "Раздел 1.2.1";
	СтрокаУровня1.ОриентацияСтраницы       = "Ландщафт";
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
	СтрокаУровня1.ВыгрузитьСтраницу        = 2;
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "Раздел122";
	СтрокаУровня1.Представление            = "Раздел 1.2.2";
	СтрокаУровня1.ОриентацияСтраницы       = "Ландщафт";
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
	СтрокаУровня1.ВыгрузитьСтраницу        = 2;
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "Раздел221";
	СтрокаУровня1.Представление            = "Раздел 2.2.1";
	СтрокаУровня1.ОриентацияСтраницы       = "Ландщафт";
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
	СтрокаУровня1.ВыгрузитьСтраницу        = 2;
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "Раздел222";
	СтрокаУровня1.Представление            = "Раздел 2.2.2";
	СтрокаУровня1.ОриентацияСтраницы       = "Ландщафт";
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
	СтрокаУровня1.ВыгрузитьСтраницу        = 2;
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1100003", , ,
		"Выбор кода вида транспорта", КоллекцияСписковВыбора["ВидыТранспорта"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1100004", 3, ,
		"Выбор кода страны контрагента", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1100005", 2, ,
		"Выбор кода операции", КоллекцияСписковВыбора["КодыОпераций"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1100006", 3, ,
		"Выбор кода валюты", КоллекцияСписковВыбора["КодыВалют"]);
	
	//Раздел 1.2.1.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1210002", 2, ,
		"Выбор кода территории", КоллекцияСписковВыбора["Регионы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1210003", 3, ,
		"Выбор кода страны контрагента", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1210004", 3, ,
		"Выбор кода валюты", КоллекцияСписковВыбора["КодыВалют"]);
	
	//Раздел 1.2.2.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1220002", 2, ,
		"Выбор кода региона", КоллекцияСписковВыбора["Регионы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1220003", 3, ,
		"Выбор кода страны контрагента", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1220004", 3, ,
		"Выбор кода валюты", КоллекцияСписковВыбора["КодыВалют"]);
	
	//Раздел 2.1.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2100002", 2, ,
		"Выбор кода территории", КоллекцияСписковВыбора["Регионы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2100003", , ,
		"Выбор кода вида транспорта", КоллекцияСписковВыбора["ВидыТранспорта"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2100004", 3, ,
		"Выбор кода страны контрагента", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2100005", 2, ,
		"Выбор кода операции", КоллекцияСписковВыбора["КодыОпераций"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2100006", 3, ,
		"Выбор кода валюты", КоллекцияСписковВыбора["КодыВалют"]);
	
	//Раздел 2.2.1.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2210002", 2, ,
		"Выбор кода территории", КоллекцияСписковВыбора["Регионы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2210003", 3, ,
		"Выбор кода страны контрагента", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2210004", 3, ,
		"Выбор кода валюты", КоллекцияСписковВыбора["КодыВалют"]);
	
	//Раздел 2.2.2.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2220002", 2, ,
		"Выбор кода региона", КоллекцияСписковВыбора["Регионы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2220003", 3, ,
		"Выбор кода страны контрагента", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2220004", 3, ,
		"Выбор кода валюты", КоллекцияСписковВыбора["КодыВалют"]);
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	ИначеЕсли ЗначениеЗаполнено(Область.Формат) И ЗначениеЗаполнено(Область.Маска)
			И СтрЗаменить(СтрЗаменить(Область.Маска, "9", ""), "#", "") = "" Тогда
	...
	Если ИмяРаздела = "Раздел11"
	 ИЛИ ИмяРаздела = "Раздел121"
	 ИЛИ ИмяРаздела = "Раздел122"
	 ИЛИ ИмяРаздела = "Раздел21"
	 ИЛИ ИмяРаздела = "Раздел221"
	 ИЛИ ИмяРаздела = "Раздел222" Тогда
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяСтраницыПанели)
	...
	Если ИмяСтраницыПанели = "Раздел11"
	 ИЛИ ИмяСтраницыПанели = "Раздел121"
	 ИЛИ ИмяСтраницыПанели = "Раздел122"
	 ИЛИ ИмяСтраницыПанели = "Раздел21"
	 ИЛИ ИмяСтраницыПанели = "Раздел221"
	 ИЛИ ИмяСтраницыПанели = "Раздел222" Тогда
		
		Если ИмяСтраницыПанели = "Раздел11" Тогда
			ИмяОбрабОбласти = "П1100001";
		ИначеЕсли ИмяСтраницыПанели = "Раздел121" Тогда
			ИмяОбрабОбласти = "П1210001";
		ИначеЕсли ИмяСтраницыПанели = "Раздел122" Тогда
			ИмяОбрабОбласти = "П1220001";
		ИначеЕсли ИмяСтраницыПанели = "Раздел21" Тогда
			ИмяОбрабОбласти = "П2100001";
		ИначеЕсли ИмяСтраницыПанели = "Раздел221" Тогда
			ИмяОбрабОбласти = "П2210001";
		ИначеЕсли ИмяСтраницыПанели = "Раздел222" Тогда
			ИмяОбрабОбласти = "П2220001";
		КонецЕсли;
...
Процедура ВывестиДанныеВТабличныйДокумент(ИмяТекРаздела, НовыеНомераСтрокМногоуровнегоРаздела = Неопределено)
	...
	Если мСтруктураМногоуровневыхРазделов.Свойство(ИмяТекРаздела) Тогда
		...
		СтруктураРаздела1 = мСтруктураМногоуровневыхРазделов["Раздел11"];
...
Процедура Расчет(Форма, ИмяРаздела = "", ОбластьИмя = "") Экспорт
				...
				Если НайденнаяОбласть <> Неопределено И НайденнаяОбласть.СодержитЗначение Тогда
					...
					Если ЗначениеЗаполнено(НайденнаяОбласть.Значение) Тогда
						...
						Если НомПоз > 0 Тогда
							...
							Форма.ТабличныйДокумент.Области["П1100001_" + СтрНом].Значение = Число(" " + СтрНом);
	...
	ИначеЕсли ИмяРаздела = "Раздел121" Тогда
				...
				Если НайденнаяОбласть <> Неопределено И НайденнаяОбласть.СодержитЗначение Тогда
					...
					Если ЗначениеЗаполнено(НайденнаяОбласть.Значение) Тогда
						...
						Если НомПоз > 0 Тогда
							...
							СтрНом = Сред(ОбластьИмя, НомПоз + 1);
							Форма.ТабличныйДокумент.Области["П1210001_" + СтрНом].Значение = Число(" " + СтрНом);
	...
	ИначеЕсли ИмяРаздела = "Раздел122" Тогда
				...
				Если НайденнаяОбласть <> Неопределено И НайденнаяОбласть.СодержитЗначение Тогда
					...
					Если ЗначениеЗаполнено(НайденнаяОбласть.Значение) Тогда
						...
						Если НомПоз > 0 Тогда
							...
							СтрНом = Сред(ОбластьИмя, НомПоз + 1);
							Форма.ТабличныйДокумент.Области["П1220001_" + СтрНом].Значение = Число(" " + СтрНом);
				...
				Если НайденнаяОбласть <> Неопределено И НайденнаяОбласть.СодержитЗначение Тогда
					...
					Если ЗначениеЗаполнено(НайденнаяОбласть.Значение) Тогда
						...
						Если НомПоз > 0 Тогда
							...
							СтрНом = Сред(ОбластьИмя, НомПоз + 1);
							Форма.ТабличныйДокумент.Области["П2100001_" + СтрНом].Значение = Число(" " + СтрНом);
	...
	ИначеЕсли ИмяРаздела = "Раздел221" Тогда
				...
				Если НайденнаяОбласть <> Неопределено И НайденнаяОбласть.СодержитЗначение Тогда
					...
					Если ЗначениеЗаполнено(НайденнаяОбласть.Значение) Тогда
						...
						Если НомПоз > 0 Тогда
							...
							СтрНом = Сред(ОбластьИмя, НомПоз + 1);
							Форма.ТабличныйДокумент.Области["П2210001_" + СтрНом].Значение = Число(" " + СтрНом);
	...
	ИначеЕсли ИмяРаздела = "Раздел222" Тогда
				...
				Если НайденнаяОбласть <> Неопределено И НайденнаяОбласть.СодержитЗначение Тогда
					...
					Если ЗначениеЗаполнено(НайденнаяОбласть.Значение) Тогда
						...
						Если НомПоз > 0 Тогда
							...
							СтрНом = Сред(ОбластьИмя, НомПоз + 1);
							Форма.ТабличныйДокумент.Области["П2220001_" + СтрНом].Значение = Число(" " + СтрНом);
	...
	ИначеЕсли ИмяРаздела = "" Тогда
		...
		Расчет(Форма, "Раздел121");
		Расчет(Форма, "Раздел122");
		Расчет(Форма, "Раздел21");
		Расчет(Форма, "Раздел221");
		Расчет(Форма, "Раздел222");
...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
	...
	Если ИмяРаздела = "Раздел11"
	 ...
	 ИЛИ ИмяРаздела = "Раздел222" Тогда
		...
		Если ИмяРаздела = "Раздел11" Тогда
			ИмяГрафыНомера = "П1100001";
			ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы110;
		ИначеЕсли  ИмяРаздела = "Раздел121" Тогда
			ИмяГрафыНомера = "П1210001";
			ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы121;
		ИначеЕсли  ИмяРаздела = "Раздел122" Тогда
			ИмяГрафыНомера = "П1220001";
			ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы122;
		ИначеЕсли  ИмяРаздела = "Раздел21" Тогда
			ИмяГрафыНомера = "П2100001";
			ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы210;
		ИначеЕсли  ИмяРаздела = "Раздел221" Тогда
			ИмяГрафыНомера = "П2210001";
			ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы221;
		ИначеЕсли  ИмяРаздела = "Раздел222" Тогда
			ИмяГрафыНомера = "П2220001";
			ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы222;
		КонецЕсли;
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ИмяФайлаШаблона", "3-ТРАНСПОРТ");
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель, ПараметрыВыгрузки)
	...
	ДеревоДанныхРаздел121 = ДанныеМногоуровневыхРазделов["Раздел121"];
	ДеревоДанныхРаздел122 = ДанныеМногоуровневыхРазделов["Раздел122"];
	ДеревоДанныхРаздел21  = ДанныеМногоуровневыхРазделов["Раздел21"];
	ДеревоДанныхРаздел221 = ДанныеМногоуровневыхРазделов["Раздел221"];
	ДеревоДанныхРаздел222 = ДанныеМногоуровневыхРазделов["Раздел222"];
...
Функция ИдентификаторФайлаВыгрузки(ПараметрыВыгрузки)
		...
		ИдентификаторФайла = "OKUD0414008"
...
Функция ВыгрузкаОтчета(ТекстВыгрузки, ПараметрыВыгрузки)
	...
	РезультатВыгрузки.Вставить("ТипФайлаВыгрузки", "Форма3ТРАНСПОРТ");
...
Процедура ВывестиНаПечатьОтчет(СтруктураПараметров, ВыбранныеСтраницы, СтрПоля = Неопределено)
		...
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел11 = Макет.Получитьобласть("Раздел11_Строка");
					Стр_Раздел11.Области["Раздел11_Строка"].Имя = "Раздел11_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел11.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						...
						ПечФорма.Области["Раздел11_Шапка"].Имя = "Раздел11_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
					ПечФорма.Вывести(Стр_Раздел11);
	...
	// Раздел 1.2.1.
	//
	Если ВыбранныеСтраницы.Найти("Раздел121") <> Неопределено Тогда
		
		ДеревоДанных = ПолучитьИзВременногоХранилища(
			СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел121"]);
		
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			
			Заг_Раздел121 = Макет.Получитьобласть("Раздел121_Заголовок");
			Шап_Раздел121 = Макет.Получитьобласть("Раздел121_Шапка");
			Стр_Раздел121 = Макет.Получитьобласть("Раздел121_Строка");
			
			МассивПроверки = Новый Массив;
			МассивПроверки.Добавить(Заг_Раздел121);
			МассивПроверки.Добавить(Шап_Раздел121);
			МассивПроверки.Добавить(Стр_Раздел121);
			
			Если НЕ ПечФорма.ПроверитьВывод(МассивПроверки) Тогда
				ПечФорма.ВывестиГоризонтальныйРазделительСтраниц();
			КонецЕсли;
			
			ПечФорма.Вывести(Заг_Раздел121);
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел121 = Макет.Получитьобласть("Раздел121_Строка");
					Стр_Раздел121.Области["Раздел121_Строка"].Имя = "Раздел121_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел121.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						ПечФорма.Вывести(Шап_Раздел121);
						ПечФорма.Области["Раздел121_Шапка"].Имя = "Раздел121_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
					ПечФорма.Вывести(Стр_Раздел121);
	...
	// Раздел 1.2.2.
	//
	Если ВыбранныеСтраницы.Найти("Раздел122") <> Неопределено Тогда
		
		ДеревоДанных = ПолучитьИзВременногоХранилища(
			СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел122"]);
		
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			
			Заг_Раздел122 = Макет.Получитьобласть("Раздел122_Заголовок");
			Шап_Раздел122 = Макет.Получитьобласть("Раздел122_Шапка");
			Стр_Раздел122 = Макет.Получитьобласть("Раздел122_Строка");
			
			МассивПроверки = Новый Массив;
			МассивПроверки.Добавить(Заг_Раздел122);
			МассивПроверки.Добавить(Шап_Раздел122);
			МассивПроверки.Добавить(Стр_Раздел122);
			
			Если НЕ ПечФорма.ПроверитьВывод(МассивПроверки) Тогда
				ПечФорма.ВывестиГоризонтальныйРазделительСтраниц();
			КонецЕсли;
			
			ПечФорма.Вывести(Заг_Раздел122);
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел122 = Макет.Получитьобласть("Раздел122_Строка");
					Стр_Раздел122.Области["Раздел122_Строка"].Имя = "Раздел122_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел122.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						ПечФорма.Вывести(Шап_Раздел122);
						ПечФорма.Области["Раздел122_Шапка"].Имя = "Раздел122_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
					ПечФорма.Вывести(Стр_Раздел122);
	...
	Если ВыбранныеСтраницы.Найти("Раздел21") <> Неопределено Тогда
		...
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Стр_Раздел21 = Макет.Получитьобласть("Раздел21_Строка");
			
			МассивПроверки = Новый Массив;
			МассивПроверки.Добавить(Заг_Раздел21);
			МассивПроверки.Добавить(Шап_Раздел21);
			МассивПроверки.Добавить(Стр_Раздел21);
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел21 = Макет.Получитьобласть("Раздел21_Строка");
					Стр_Раздел21.Области["Раздел21_Строка"].Имя = "Раздел21_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел21.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						...
						ПечФорма.Области["Раздел21_Шапка"].Имя = "Раздел21_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
					ПечФорма.Вывести(Стр_Раздел21);
	...
	// Раздел 2.2.1.
	//
	Если ВыбранныеСтраницы.Найти("Раздел221") <> Неопределено Тогда
		
		ДеревоДанных = ПолучитьИзВременногоХранилища(
			СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел221"]);
		
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			
			Заг_Раздел221 = Макет.Получитьобласть("Раздел221_Заголовок");
			Шап_Раздел221 = Макет.Получитьобласть("Раздел221_Шапка");
			Стр_Раздел221 = Макет.Получитьобласть("Раздел221_Строка");
			
			МассивПроверки = Новый Массив;
			МассивПроверки.Добавить(Заг_Раздел221);
			МассивПроверки.Добавить(Шап_Раздел221);
			МассивПроверки.Добавить(Стр_Раздел221);
			
			Если НЕ ПечФорма.ПроверитьВывод(МассивПроверки) Тогда
				ПечФорма.ВывестиГоризонтальныйРазделительСтраниц();
			КонецЕсли;
			
			ПечФорма.Вывести(Заг_Раздел221);
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел221 = Макет.Получитьобласть("Раздел221_Строка");
					Стр_Раздел221.Области["Раздел221_Строка"].Имя = "Раздел221_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел221.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						ПечФорма.Вывести(Шап_Раздел221);
						ПечФорма.Области["Раздел221_Шапка"].Имя = "Раздел221_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
					ПечФорма.Вывести(Стр_Раздел221);
	...
	// Раздел 2.2.2.
	//
	Если ВыбранныеСтраницы.Найти("Раздел222") <> Неопределено Тогда
		
		ДеревоДанных = ПолучитьИзВременногоХранилища(
			СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел222"]);
		
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			
			Заг_Раздел222 = Макет.Получитьобласть("Раздел222_Заголовок");
			Шап_Раздел222 = Макет.Получитьобласть("Раздел222_Шапка");
			Стр_Раздел222 = Макет.Получитьобласть("Раздел222_Строка");
			
			МассивПроверки = Новый Массив;
			МассивПроверки.Добавить(Заг_Раздел222);
			МассивПроверки.Добавить(Шап_Раздел222);
			МассивПроверки.Добавить(Стр_Раздел222);
			
			Если НЕ ПечФорма.ПроверитьВывод(МассивПроверки) Тогда
				ПечФорма.ВывестиГоризонтальныйРазделительСтраниц();
			КонецЕсли;
			
			ПечФорма.Вывести(Заг_Раздел222);
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел222 = Макет.Получитьобласть("Раздел222_Строка");
					Стр_Раздел222.Области["Раздел222_Строка"].Имя = "Раздел222_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел222.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						ПечФорма.Вывести(Шап_Раздел222);
						ПечФорма.Области["Раздел222_Шапка"].Имя = "Раздел222_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
					ПечФорма.Вывести(Стр_Раздел222);
...
Процедура ЗаполнитьАвтоНаСервере()
	...
	Контейнер.Вставить("Раздел11",  СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел11"]);
	Контейнер.Вставить("Раздел121", СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел121"]);
	Контейнер.Вставить("Раздел122", СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел122"]);
	Контейнер.Вставить("Раздел21",  СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел21"]);
	Контейнер.Вставить("Раздел221", СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел221"]);
	Контейнер.Вставить("Раздел222", СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел222"]);
	...
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел11"]  = Контейнер["Раздел11"];
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел121"] = Контейнер["Раздел121"];
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел122"] = Контейнер["Раздел122"];
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел21"]  = Контейнер["Раздел21"];
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел221"] = Контейнер["Раздел221"];
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел222"] = Контейнер["Раздел222"];
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ВПрограммеИзмененаДатаПодписи = Ложь)
	...
	Если НЕ ВПрограммеИзмененаДатаПодписи Тогда
		...
		Форма.ТабличныйДокумент.Области.EmailUser.Значение = СокрЛП(СведенияОбОрганизации.НаимЮлПол);
...
&НаКлиенте
Процедура ВвестиПоказатель(Элемент, Область, КодПоказателя, Знач ЭтоСумма, Знач ТекстВыбора,
	ТаблицаВыбора, СтандартнаяОбработка, КолонкаПоиска = "Код", МножественныйВыбор = Ложь) Экспорт
	...
	Если МножественныйВыбор Тогда
		...
		ПараметрыФормы.Вставить("НаимКолонкиНазвание", "Вид транспортной деятельности");
		ОткрытьФорму("Обработка.ОбщиеОбъектыРеглОтчетности.Форма.ФормаМножественногоВыбораЗначенийИзТаблицы",
			ПараметрыФормы, ЭтаФорма,,,, ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	Иначе
		ОткрытьФорму("Обработка.ОбщиеОбъектыРеглОтчетности.Форма.ФормаВыбораЗначенияИзТаблицы",
			ПараметрыФормы, ЭтаФорма,,,, ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура АктивизироватьЯчейку(Ячейка) Экспорт
	...
	Если Ячейка.Раздел = "Раздел11"
	 ИЛИ Ячейка.Раздел = "Раздел121"
	 ИЛИ Ячейка.Раздел = "Раздел122"
	 ИЛИ Ячейка.Раздел = "Раздел21"
	 ИЛИ Ячейка.Раздел = "Раздел221"
	 ИЛИ Ячейка.Раздел = "Раздел222" Тогда
