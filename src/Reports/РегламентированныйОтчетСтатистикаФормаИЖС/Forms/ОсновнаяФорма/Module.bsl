...
Процедура ИзменитьПериод(Форма, Шаг)
	...
	Если Месяц(Форма.мДатаКонцаПериодаОтчета) = 12 И Месяц(Форма.мДатаНачалаПериодаОтчета) = 12 Тогда 
		Если Шаг = 1 И Год(Форма.мДатаКонцаПериодаОтчета) <= 2020 Тогда
		...
		КонецЕсли;
	ИначеЕсли Месяц(Форма.мДатаКонцаПериодаОтчета) = 12 И Месяц(Форма.мДатаНачалаПериодаОтчета) = 1 Тогда 
		Если Шаг = 1 Тогда
			Форма.мДатаКонцаПериодаОтчета  = КонецМесяца(ДобавитьМесяц(Форма.мДатаКонцаПериодаОтчета, Шаг));
			Форма.мДатаНачалаПериодаОтчета = НачалоМесяца(Форма.мДатаКонцаПериодаОтчета);
		Иначе
			Форма.мДатаНачалаПериодаОтчета = НачалоМесяца(Форма.мДатаКонцаПериодаОтчета);
		КонецЕсли;
	ИначеЕсли Месяц(Форма.мДатаКонцаПериодаОтчета) = 1 И Месяц(Форма.мДатаНачалаПериодаОтчета) = 1 Тогда 
		Если Шаг = 1 Тогда
			Форма.мДатаКонцаПериодаОтчета  = КонецМесяца(ДобавитьМесяц(Форма.мДатаКонцаПериодаОтчета, Шаг));
			Форма.мДатаНачалаПериодаОтчета = НачалоМесяца(Форма.мДатаКонцаПериодаОтчета);
		ИначеЕсли Шаг = -1 И Год(Форма.мДатаКонцаПериодаОтчета) <= 2021 Тогда 
			Форма.мДатаКонцаПериодаОтчета  = КонецМесяца(ДобавитьМесяц(Форма.мДатаКонцаПериодаОтчета, Шаг));
