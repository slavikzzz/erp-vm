...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание =
		НСтр("ru = 'Плановые начисления и ФОТ по штатному расписанию с точностью до видов начислений.';
			|en = 'Scheduled accruals and salary budget by the headcount to the precision of accrual kinds.'");
	...
	НастройкиВарианта.Описание = НСтр("ru = 'Штатное расписание (Унифицированная форма Т-3).';
										|en = 'Headcount (Unified form T-3).'");
