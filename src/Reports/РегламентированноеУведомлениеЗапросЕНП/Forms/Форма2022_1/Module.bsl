...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Объект.ВидУведомления = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ЗапросСостояниеРасчетов;
	...
	Если НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.запр.сост.расчетов") Тогда
	...
	ПоказатьТекущуюСтраницу("Титульная_2022_1", Неопределено);
КонецПроцедуры
