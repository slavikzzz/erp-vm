...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мВерсияФормы = "04/07/2017";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	Области = Форма.СтруктураДанныхТитульный;
	Для НомКол = 3 По 13 Цикл
		НомКолСтр = Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=");
		Области["П0100001" + НомКолСтр] =
		Области["П0100002" + НомКолСтр]
		+ Области["П0100004" + НомКолСтр]
		+ Области["П0100006" + НомКолСтр]
		+ Области["П0100009" + НомКолСтр]
		+ Области["П0100010" + НомКолСтр]
		+ Области["П0100011" + НомКолСтр]
		+ Области["П0100012" + НомКолСтр]
		+ Области["П0100013" + НомКолСтр]
		+ Области["П0100014" + НомКолСтр];
	КонецЦикла;
	
	Для НомКол = 3 По 4 Цикл
		НомКолСтр = Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=");
		Области["П0100046" + НомКолСтр] =
		Области["П0100047" + НомКолСтр]
		+ Области["П0100049" + НомКолСтр]
		+ Области["П0100050" + НомКолСтр]
		+ Области["П0100051" + НомКолСтр]
		+ Области["П0100052" + НомКолСтр];
	КонецЦикла;
	...
	Если ИмяТекущейСтраницыПанели = "Титульный" Тогда
		...
		Для НомКол = 3 По 4 Цикл
			...
			Области["П0100047" + НомКолСтр].Значение
			+ Области["П0100049" + НомКолСтр].Значение
			+ Области["П0100050" + НомКолСтр].Значение
			+ Области["П0100051" + НомКолСтр].Значение
			+ Области["П0100052" + НомКолСтр].Значение;
		КонецЦикла;
	КонецЕсли;
КонецПроцедуры
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	СоответствиеРазделовМакетам.Вставить("Подразделения",   "ФормаОтчета2018Кв1_Подразделения");
