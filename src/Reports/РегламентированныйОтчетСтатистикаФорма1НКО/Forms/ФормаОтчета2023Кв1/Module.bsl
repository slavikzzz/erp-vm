...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мКодОтчета = "0608032";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	//6. стр. 20 = стр. 21 + стр. 22
	Области["П001001002003"].Значение
		= Области["П001001002103"].Значение
		+ Области["П001001002203"].Значение;
	
	//5. стр. 18 = стр. 19 + стр. 20
	Области["П001001001803"].Значение
		= Области["П001001001903"].Значение
		+ Области["П001001002003"].Значение;
	
	//11. стр. 38 = сумме стр. 01, 14, 15, 16, 17, 18, 23, 24, 26, 27, 29, 35, 36, 37
	Области["П001001003803"].Значение
		= Области["П001001000103"].Значение
		+ Области["П001001001403"].Значение
		+ Области["П001001001503"].Значение
		+ Области["П001001001603"].Значение
		+ Области["П001001001703"].Значение
		+ Области["П001001001803"].Значение
		+ Области["П001001002303"].Значение
		+ Области["П001001002403"].Значение
		+ Области["П001001002603"].Значение
		+ Области["П001001002703"].Значение
		+ Области["П001001002903"].Значение
		+ Области["П001001003503"].Значение
		+ Области["П001001003603"].Значение
		+ Области["П001001003703"].Значение;
		
	//17. стр. 42 = стр. 43 + стр. 48
	Области["П002001004203"].Значение
		= Области["П002001004303"].Значение
		+ Области["П002001004803"].Значение;
	
	//19. стр. 49 = стр. 50 + стр. 51
	Области["П002001004903"].Значение
		= Области["П002001005003"].Значение
		+ Области["П002001005103"].Значение;
	
	//20. стр. 53 = стр. 54 + стр. 55
	Области["П002001005303"].Значение
		= Области["П002001005403"].Значение
		+ Области["П002001005503"].Значение;
		
	//14. стр. 41 =сумме стр. 42, 49, 52, 53, 56, 63, 64, 65, 66, 67, 68, 82
	Области["П002001004103"].Значение
		= Области["П002001004203"].Значение
		+ Области["П002001004903"].Значение
		+ Области["П002001005203"].Значение
		+ Области["П002001005303"].Значение
		+ Области["П002001005603"].Значение
		+ Области["П002001006303"].Значение
		+ Области["П002001006403"].Значение
		+ Области["П002001006503"].Значение
		+ Области["П002001006603"].Значение
		+ Области["П002001006703"].Значение
		+ Области["П002001006803"].Значение
		+ Области["П002001008203"].Значение;
		
	//23. стр. 70 = стр.71 + стр. 73
	Области["П002001007003"].Значение
		= Области["П002001007103"].Значение
		+ Области["П002001007303"].Значение;
		
	//29. стр. 93 = сумме стр. 41, 85, 86, 88, 90, 91, 92
	Области["П002001009303"].Значение
		= Области["П002001004103"].Значение
		+ Области["П002001008503"].Значение
		+ Области["П002001008603"].Значение
		+ Области["П002001008803"].Значение
		+ Области["П002001009003"].Значение
		+ Области["П002001009103"].Значение
		+ Области["П002001009203"].Значение;
...
Процедура УстановитьЗащитуИЦветФонаОбластейАвторассчитываемыхПоказателей()
	...
	мФормаОтчета.Области["П001001003803"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П001001003803"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П002001004103"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П002001004103"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П002001004203"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П002001004203"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П002001004903"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П002001004903"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П002001005303"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П002001005303"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П002001007003"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П002001007003"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П002001009303"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П002001009303"].Защита   = Не ОтклАвтоРасчетЗначение;
...
Функция ПечатьНаСервере(ВидПечати)
	...
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 1-НКО");
