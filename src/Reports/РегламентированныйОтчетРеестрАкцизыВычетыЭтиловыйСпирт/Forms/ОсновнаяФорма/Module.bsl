...
Процедура ПоказатьПериод(Форма)
	...
	ФормаУтратилаСилу = КонецДня(Форма.мДатаКонцаПериодаОтчета) > КонецДня('20211031');
	...
	Иначе
		...
		НСтр("ru = 'С 01.11.2021 утратила силу в связи с изданием приказа ФНС России от 26.04.2021 № ЕД-7-15/419@.';
			|en = 'С 01.11.2021 утратила силу в связи с изданием приказа ФНС России от 26.04.2021 № ЕД-7-15/419@.'"),
