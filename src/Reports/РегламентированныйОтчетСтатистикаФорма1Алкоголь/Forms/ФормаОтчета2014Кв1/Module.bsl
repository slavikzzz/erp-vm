...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "04/09/2013";
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	// Строка 001 ≥ строка 002 + строка 012 + строка 020 + строка 021.
	Для НомКол = 4 По 13 Цикл
		Если ПараметрыВыгрузки["П0000010001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			...
			+ ПараметрыВыгрузки["П0000010012" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010020" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010021" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: по графе " + Формат(НомКол, "ЧГ=")
			+ " значение в строке 001 должно быть больше или равно сумме значений в строках 002 + 012 + 020 + 021!",
			ИмяПоляТаблДокумента, "П0000010001" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// Строка 002 ≥ строка 003 + строка 004 + строка 005 + строка 006 + строка 008 + строка 009 + строка 010 + строка 011.
	Для НомКол = 4 По 13 Цикл
		Если ПараметрыВыгрузки["П0000010002" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000010003" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010004" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010005" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010006" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010008" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010009" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010010" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010011" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: по графе " + Формат(НомКол, "ЧГ=")
			+ " значение в строке 002 должно быть больше или равно сумме значений в строках 003 + 004 + 005 + 006 + 008 + 009 + 010 + 011!",
			ИмяПоляТаблДокумента, "П0000010002" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// Строка 012 ≥ строка 013 + строка 014 + строка 016 + строка 017 + строка 018 + строка 019.
	Для НомКол = 4 По 13 Цикл
		Если ПараметрыВыгрузки["П0000010012" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000010013" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010014" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010016" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010017" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010018" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010019" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: по графе " + Формат(НомКол, "ЧГ=")
			+ " значение в строке 012 должно быть больше или равно сумме значений в строках 013 + 014 + 016 + 017 + 018 + 019!",
	...
	Для НомКол = 4 По 13 Цикл
		Если ПараметрыВыгрузки["П0000010014" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000010015" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: по графе " + Формат(НомКол, "ЧГ=")
			+ " значение в строке 014 должно быть больше или равно значению в строке 015!",
			ИмяПоляТаблДокумента, "П0000010014" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// Строка 022 ≥ строка 023 + строка 024 + строка 025 + строка 026 + строка 027.
	Для НомКол = 4 По 13 Цикл
		Если НомКол = 7 Или НомКол = 8 Тогда
			Продолжить;
		КонецЕсли;
		Если ПараметрыВыгрузки["П0000010022" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000010023" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010024" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010025" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010026" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010027" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: по графе " + Формат(НомКол, "ЧГ=")
			+ " значение в строке 022 должно быть больше или равно сумме значений в строках 023 + 024 + 025 + 026 + 027!",
			ИмяПоляТаблДокумента, "П0000010022" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// Строка 028 ≥ строка 029 + строка 030 + строка 031 + строка 035 + строка 036 + строка 037 + строка 038 + строка 039 + строка 040.
	Для НомКол = 4 По 13 Цикл
		Если НомКол = 7 Или НомКол = 8 Тогда
			Продолжить;
		КонецЕсли;
		Если ПараметрыВыгрузки["П0000010028" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000010029" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010030" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010031" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010035" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010036" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010037" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010038" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010039" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010040" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: по графе " + Формат(НомКол, "ЧГ=")
			+ " значение в строке 028 должно быть больше или равно сумме значений в строках 029 + 030 + 031 + 035 + 036 + 037 + 038 + 039 + 040!",
			ИмяПоляТаблДокумента, "П0000010028" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// Строка 031 ≥ строка 032 + строка 033 + строка 034.
	Для НомКол = 4 По 13 Цикл
		Если НомКол = 7 Или НомКол = 8 Тогда
			Продолжить;
		КонецЕсли;
		Если ПараметрыВыгрузки["П0000010031" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000010032" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010033" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010034" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: по графе " + Формат(НомКол, "ЧГ=")
			+ " значение в строке 031 должно быть больше или равно сумме значений в строках 032 + 033 + 034!",
			ИмяПоляТаблДокумента, "П0000010031" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	// Строка 043 ≥ строка 044 + строка 045 + строка 046.
	Для НомКол = 4 По 13 Цикл
		Если ПараметрыВыгрузки["П0000010043" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			< ПараметрыВыгрузки["П0000010044" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010045" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"]
			+ ПараметрыВыгрузки["П0000010046" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ=") + "_Ч"] Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"Не выполнено условие контроля: по графе " + Формат(НомКол, "ЧГ=")
			+ " значение в строке 043 должно быть больше или равно сумме значений в строках 044 + 045 + 046!",
			ИмяПоляТаблДокумента, "П0000010043" + Формат(НомКол, "ЧЦ=2; ЧВН=; ЧГ="));
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
...
Функция СформироватьСтруктуруПараметров()
	...
	Для НомСтр = 1 По 46 Цикл
		Для НомКол = 4 По 13 Цикл
			Если (НомСтр = 7 Или (НомСтр >= 22 И НомСтр <= 42)) И (НомКол = 7 Или НомКол = 8) Тогда
				Продолжить;
			КонецЕсли;
