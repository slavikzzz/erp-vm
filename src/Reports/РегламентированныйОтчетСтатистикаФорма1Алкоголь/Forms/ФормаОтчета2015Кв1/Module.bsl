...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	// Стр.21>=суммы строк с 22 по 26;
	// Стр.27>=суммы строк 28,31 и 35;
	// Стр.28>=суммы строк 29 и 30;
	// Стр.31>=суммы строк 32,33 и 34;
	// Стр.44>=суммы строк 45,46 и 47;
	СоответствиеСтрок = Новый Соответствие;
	МассивСтрок = Новый Массив;
	МассивСтрок.Добавить(22);
	МассивСтрок.Добавить(23);
	МассивСтрок.Добавить(24);
	МассивСтрок.Добавить(25);
	МассивСтрок.Добавить(26);
	СоответствиеСтрок[21] = МассивСтрок;
	
	МассивСтрок = Новый Массив;
	МассивСтрок.Добавить(28);
	МассивСтрок.Добавить(31);
	МассивСтрок.Добавить(35);
	СоответствиеСтрок[27] = МассивСтрок;
	...
	МассивСтрок.Добавить(34);
	СоответствиеСтрок[31] = МассивСтрок;
	
	МассивСтрок = Новый Массив;
	МассивСтрок.Добавить(45);
	МассивСтрок.Добавить(46);
	МассивСтрок.Добавить(47);
	СоответствиеСтрок[44] = МассивСтрок;
	...
	Для Каждого Элемент Из СоответствиеСтрок Цикл 
		...
		Для НомерКолонки = 4 По 13 Цикл
			...
			НомКолСтр = Формат(НомерКолонки, "ЧЦ=2; ЧВН=; ЧГ=;");
			ЛеваяЧасть  = Показатели["П00000100" + ИсхСтрока + НомКолСтр];
			ПраваяЧастьВсего = 0;
			Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " ";
			
			ПервыйЭлт = Истина;
			Для Каждого Элт Из МассивСтрок Цикл
				ПраваяЧасть = Показатели["П00000100" + Элт + НомКолСтр];
...
Процедура Расчет(Форма) 
	...
	Для Гр = 4 По 13 Цикл 
		...
		Области["П0000010013" + ГрСтр].Значение = Области["П0000010014" + ГрСтр].Значение + Области["П0000010015" + ГрСтр].Значение
												+ Области["П0000010017" + ГрСтр].Значение + Области["П0000010018" + ГрСтр].Значение
												+ Области["П0000010019" + ГрСтр].Значение + Области["П0000010020" + ГрСтр].Значение;
		Области["П0000010002" + ГрСтр].Значение = Области["П0000010003" + ГрСтр].Значение + Области["П0000010004" + ГрСтр].Значение
												+ Области["П0000010005" + ГрСтр].Значение + Области["П0000010006" + ГрСтр].Значение
												+ Области["П0000010007" + ГрСтр].Значение + Области["П0000010009" + ГрСтр].Значение
												+ Области["П0000010010" + ГрСтр].Значение + Области["П0000010011" + ГрСтр].Значение
												+ Области["П0000010012" + ГрСтр].Значение;
		...
		Если Гр < 7 Или Гр > 8 Тогда
			Области["П0000010035" + ГрСтр].Значение = Области["П0000010036" + ГрСтр].Значение + Области["П0000010037" + ГрСтр].Значение
													+ Области["П0000010038" + ГрСтр].Значение + Области["П0000010039" + ГрСтр].Значение
													+ Области["П0000010040" + ГрСтр].Значение + Области["П0000010041" + ГрСтр].Значение;
		КонецЕсли;
	КонецЦикла;
