...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "31/07/2015";
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	Нарушение = "Приказ Росстата от 03.12.2015 № 613";
	
	// Стр.15>=стр.16;
	// Стр.18>=стр.19;
	МассивСтрок = Новый Массив;
	МассивСтрок.Добавить(15);
	МассивСтрок.Добавить(18);
	
	Знак = ">=";
	Для Каждого Элт Из МассивСтрок Цикл
		Стр1 = Элт;
		Стр2 = Элт+1;
		Для НомерКолонки = 4 По 13 Цикл
			ТекстФормулы = "стр." + Стр1 + " гр." + НомерКолонки + " >= стр." + Стр2 + " гр." + НомерКолонки;
			Описание     = "стр." + Стр1 + " гр." + НомерКолонки + " < стр." + Стр2 + " гр." + НомерКолонки;
			
			НомКолСтр = Формат(НомерКолонки, "ЧЦ=2; ЧВН=; ЧГ=;");
			ЛеваяЧасть  = Показатели["П00000100" + Стр1 + НомКолСтр];
			ПраваяЧасть = Показатели["П00000100" + Стр2 + НомКолСтр];
	...
	//строка 002 ≥ строка 003 + строка 004 + строка 005 + строка 006 + строка 007 + строка 009 + строка 010 + строка 011+ строка 012
	МассивСтрок = Новый Массив;
	МассивСтрок.Добавить(3);
	МассивСтрок.Добавить(4);
	МассивСтрок.Добавить(5);
	МассивСтрок.Добавить(6);
	МассивСтрок.Добавить(7);
	МассивСтрок.Добавить(9);
	МассивСтрок.Добавить(10);
	МассивСтрок.Добавить(11);
	МассивСтрок.Добавить(12);
	СоответствиеСтрок[2] = МассивСтрок;
	
	//строка 013 ≥ строка 014 + строка 015 + строка 017 + строка 018 + строка 020 + строка 021 
	МассивСтрок = Новый Массив;
	МассивСтрок.Добавить(14);
	МассивСтрок.Добавить(15);
	МассивСтрок.Добавить(17);
	МассивСтрок.Добавить(18);
	МассивСтрок.Добавить(20);
	МассивСтрок.Добавить(21);
	СоответствиеСтрок[13] = МассивСтрок;
	
	//строка 022 ≥ строка 023 + строка 024 + строка 025 + строка 026 + строка 027
	МассивСтрок = Новый Массив;
	МассивСтрок.Добавить(23);
	МассивСтрок.Добавить(24);
	МассивСтрок.Добавить(25);
	МассивСтрок.Добавить(26);
	МассивСтрок.Добавить(27);
	СоответствиеСтрок[22] = МассивСтрок;
	
	//строка 028 ≥ строка 029 + строка 032 + строка 036
	МассивСтрок = Новый Массив;
	МассивСтрок.Добавить(29);
	МассивСтрок.Добавить(32);
	МассивСтрок.Добавить(36);
	СоответствиеСтрок[28] = МассивСтрок;
	
	//строка 029 ≥ строка 030 + строка 031
	МассивСтрок = Новый Массив;
	МассивСтрок.Добавить(30);
	МассивСтрок.Добавить(31);
	СоответствиеСтрок[29] = МассивСтрок;
	
	//строка 045 ≥ строка 046 + строка 047 + строка 048
	МассивСтрок = Новый Массив;
	МассивСтрок.Добавить(46);
	МассивСтрок.Добавить(47);
	МассивСтрок.Добавить(48);
	СоответствиеСтрок[45] = МассивСтрок;
	
	Для Каждого Элемент Из СоответствиеСтрок Цикл 
		МассивСтрок = Элемент.Значение;
		ИсхСтрока = Формат(Элемент.Ключ, "ЧЦ=3; ЧВН=; ЧГ=;");
		Для НомерКолонки = 4 По 13 Цикл
			НомКолСтр = Формат(НомерКолонки, "ЧЦ=2; ЧВН=; ЧГ=;");
			Если Не Показатели.Свойство("П0000010" + ИсхСтрока + НомКолСтр) Тогда 
				Продолжить;
			КонецЕсли;
			
			ТекстФормулы = "стр." + ИсхСтрока + " гр." + НомерКолонки + " >= (";
			Описание     = "стр." + ИсхСтрока + " гр." + НомерКолонки + " < (";
			
			ЛеваяЧасть  = Показатели["П0000010" + ИсхСтрока + НомКолСтр];
			ПраваяЧастьВсего = 0;
			Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " ";
			
			ПервыйЭлт = Истина;
			Для Каждого Элт Из МассивСтрок Цикл
				ЭлтСтр = Формат(Элт, "ЧЦ=3; ЧВН=; ЧГ=;");
				ПраваяЧасть = Показатели["П0000010" + ЭлтСтр + НомКолСтр];
				ПраваяЧастьВсего = ПраваяЧастьВсего + ПраваяЧасть;
				
				Если Не ПервыйЭлт Тогда
				...
				ТекстФормулы = ТекстФормулы + "стр." + ЭлтСтр;
				Описание     = Описание + "стр." + ЭлтСтр;
				Расшифровка  = Расшифровка + Строка(ПраваяЧасть);
			КонецЦикла;
			
			ТекстФормулы = ТекстФормулы + ") гр." + НомерКолонки;
			Описание     = Описание + ") гр." + НомерКолонки;
			
			Если ЛеваяЧасть >= ПраваяЧастьВсего Тогда
				ЭтоОшибка = Ложь;
				ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
			Иначе
				ЭтоОшибка = Истина;
...
Процедура Расчет(Форма) 
	...
	Для Гр = 4 По 13 Цикл 
		...
		Области["П0000010001" + ГрСтр].Значение = Области["П0000010002" + ГрСтр].Значение + Области["П0000010013" + ГрСтр].Значение;
		
		Если Гр < 7 Или Гр > 8 Тогда
			Области["П0000010032" + ГрСтр].Значение = Области["П0000010033" + ГрСтр].Значение + Области["П0000010034" + ГрСтр].Значение + Области["П0000010035" + ГрСтр].Значение;
			Области["П0000010036" + ГрСтр].Значение = Области["П0000010037" + ГрСтр].Значение + Области["П0000010038" + ГрСтр].Значение
													+ Области["П0000010039" + ГрСтр].Значение + Области["П0000010040" + ГрСтр].Значение
													+ Области["П0000010041" + ГрСтр].Значение + Области["П0000010042" + ГрСтр].Значение;
		КонецЕсли;
	КонецЦикла;
...
Функция ПолучитьПредидущийПериод() Экспорт 
	...
	Если Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) <> 1 Тогда 
		Результат.мДатаНачалаПериодаОтчета = НачалоМесяца(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, -1));
