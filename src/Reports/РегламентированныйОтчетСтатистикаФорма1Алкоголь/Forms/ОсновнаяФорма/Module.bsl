...
Процедура ПоказатьПериод(Форма)
	...
	Иначе
		...
		Если НачалоДня(Форма.мДатаНачалаПериодаОтчета) >= '20170101' Тогда
			Форма.ОписаниеНормативДок = "Форма утратила силу в соответствии с приказом Росстата от 11.08.2016 № 414.";
		Иначе
