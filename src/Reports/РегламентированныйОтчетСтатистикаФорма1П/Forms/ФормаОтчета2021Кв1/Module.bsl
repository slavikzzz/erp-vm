...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураДанныхРаздел13  = Новый Структура;
	...
	СтруктураРеквизитовФормы.мИдГруппы5  = "П0110016001";
	СтруктураРеквизитовФормы.мИдГруппы6  = "П0110016600";
	СтруктураРеквизитовФормы.мИдГруппы7  = "П0110017001";
	СтруктураРеквизитовФормы.мИдГруппы8  = "П0110017600";
	СтруктураРеквизитовФормы.мИдГруппы9  = "П0110018001";
	СтруктураРеквизитовФормы.мИдГруппы10 = "П0110018600";
	...
	КолКолонокИдГруппы5  = 3;
	КолКолонокИдГруппы6  = 3;
	КолКолонокИдГруппы7  = 3;
	КолКолонокИдГруппы8  = 3;
	КолКолонокИдГруппы9  = 3;
	КолКолонокИдГруппы10 = 3;
	...
	СтруктураРеквизитовФормы.мСоответствияМнгЧ.Вставить(СтруктураРеквизитовФормы.мИдГруппы7, "МногострочнаяЧасть1");
	СтруктураРеквизитовФормы.мСоответствияМнгЧ.Вставить(СтруктураРеквизитовФормы.мИдГруппы8, "МногострочнаяЧасть2");
...
Функция ОпределитьТабличноеПолеПоИдМногострочногоРаздела(ИдГруппы, ИдГрупп) Экспорт
	...
	ИначеЕсли ИдГруппы = ИдГрупп.мИдГруппы5 Или ИдГруппы = ИдГрупп.мИдГруппы6 Тогда
		
		ТекТабличноеПоле = "Раздел11";
		
	ИначеЕсли ИдГруппы = ИдГрупп.мИдГруппы7 Или ИдГруппы = ИдГрупп.мИдГруппы8 Тогда
		
		ТекТабличноеПоле = "Раздел12";
		
	ИначеЕсли ИдГруппы = ИдГрупп.мИдГруппы9 Или ИдГруппы = ИдГрупп.мИдГруппы10 Тогда
...
Процедура ФормироватьСтруктуруСтраницОтчета() 
	...
	СтрокаУровня1.Представление            = "Раздел 13";
	СтрокаУровня1.ОриентацияСтраницы       = "Ландшафт";
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
	СтрокаУровня1.ВыгрузитьСтраницу        = 2;
...
Функция ОпределитьИдМногострочногоРазделаПоАктивнойСтранице(ИмяЛиста = Неопределено, ТекущаяСтраница = Неопределено, ИдГрупп, Форма)
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "Раздел11" Тогда
		...
		Иначе
			ИмяТекущейОбласти = СтрЗаменить(Форма.Элементы.ТабличныйДокумент.ТекущаяОбласть.Имя, "ДобавитьСтрокуЗначок", "ДобавитьСтроку");
			
			Если ИмяТекущейОбласти = "ДобавитьСтроку1" Или Найти(ИмяТекущейОбласти, "П0110016001") > 0 Тогда
				ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы5;
			ИначеЕсли ИмяТекущейОбласти = "ДобавитьСтроку2" Или Найти(ИмяТекущейОбласти, "П0110016600") > 0 Тогда
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "Раздел12" Тогда
		...
		Иначе
			...
			Если ИмяТекущейОбласти = "ДобавитьСтроку1" Или Найти(ИмяТекущейОбласти, "П0110017001") > 0 Тогда
				ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы7;
			ИначеЕсли ИмяТекущейОбласти = "ДобавитьСтроку2" Или Найти(ИмяТекущейОбласти, "П0110017600") > 0 Тогда
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "Раздел13" Тогда
		Если Форма = Неопределено Тогда
			ИмяГруппы = ИдГрупп.мИдГруппы9;
		Иначе
			ИмяТекущейОбласти = СтрЗаменить(Форма.Элементы.ТабличныйДокумент.ТекущаяОбласть.Имя, "ДобавитьСтрокуЗначок", "ДобавитьСтроку");
			
			Если ИмяТекущейОбласти = "ДобавитьСтроку1" Или Найти(ИмяТекущейОбласти, "П0110018001") > 0 Тогда
				ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы9;
			ИначеЕсли ИмяТекущейОбласти = "ДобавитьСтроку2" Или Найти(ИмяТекущейОбласти, "П0110018600") > 0 Тогда
...
Функция ОпределитьИдМногострочногоРазделаПоТабличномуПолю(ТекТабличноеПоле) Экспорт
	...
	ИначеЕсли ТекТабличноеПоле = "Раздел11" Тогда
		ИдГруппы = СтруктураРеквизитовФормы.мИдГруппы5;
	ИначеЕсли ТекТабличноеПоле = "Раздел12" Тогда
		ИдГруппы = СтруктураРеквизитовФормы.мИдГруппы7;
	ИначеЕсли ТекТабличноеПоле = "Раздел13" Тогда
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "КодыДопРаздел11_1",
		512, , "Выбор кода строки", КоллекцияСписковВыбора["ДопРаздел11_1"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "КодыДопРаздел11_2",
		512, , "Выбор кода строки", КоллекцияСписковВыбора["ДопРаздел11_2"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "s_TZVform_TRIprod_6001",
		512, , "Выбор кода строки", КоллекцияСписковВыбора["s_TZVform_TRIprod_6001"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "КодыДопРаздел12_1",
		512, , "Выбор кода строки", КоллекцияСписковВыбора["ДопРаздел12_1"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "s_TZVform_TRIprod_7001",
		512, , "Выбор кода строки", КоллекцияСписковВыбора["s_TZVform_TRIprod_7001"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "КодыДопРаздел13_1",
		512, , "Выбор кода строки", КоллекцияСписковВыбора["ДопРаздел13_1"]);
		
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "s_TZVform_TRIprod_8001",
		512, , "Выбор кода строки", КоллекцияСписковВыбора["s_TZVform_TRIprod_8001"]);
...
Процедура РазделыОтчетаПриАктивизацииСтроки(Элемент)
	...
	Если СтруктураРеквизитовФормы.ВыводитьСтраницуВТаблДокНаСервере Тогда
		...
		ИначеЕсли ИмяТекРаздела = "Раздел11" Тогда
			СтруктураДанных = СтруктураДанныхРаздел11;
		ИначеЕсли ИмяТекРаздела = "Раздел12" Тогда
			СтруктураДанных = СтруктураДанныхРаздел12;
		ИначеЕсли ИмяТекРаздела = "Раздел13" Тогда
			СтруктураДанных = СтруктураДанныхРаздел13;
		КонецЕсли;
	...
	Если Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел3_4"
		...
		Или Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел11"
		Или Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел12"
		Или Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел13" Тогда
...
Процедура ВывестиМакетСтраницыВТабличныйДокументНаСервере(ИмяТекРаздела, НомерСтраницыРазделаОтчета, СтруктураДанных = Неопределено)
	...
	Если СтруктураДанных <> Неопределено Тогда
		...
		ИначеЕсли ИмяТекРаздела = "Раздел11" Тогда
			СтруктураДанныхРаздел11 = СтруктураДанных;
		ИначеЕсли ИмяТекРаздела = "Раздел12" Тогда
			СтруктураДанныхРаздел12 = СтруктураДанных;
		ИначеЕсли ИмяТекРаздела = "Раздел13" Тогда
			СтруктураДанныхРаздел13 = СтруктураДанных;
		КонецЕсли;
	КонецЕсли;
...
Процедура СохранитьДанныеРаздела(НаимРаздела, ОчищатьРазделЕслиЕстьМногострочность, ИзменятьАктивнуюСтраницу = Истина)
	...
	ИначеЕсли НаимРаздела = "Раздел11" Тогда
		ЭтотОбъект["СтруктураДанных" + НаимРаздела] = СобратьДанныеТекущегоТаблПоля(ЭтотОбъект, "ТабличныйДокумент");
		ИмяГруппы = "П0110016001";
		ОбновитьСтруктуруМногострочногоРаздела(ЭтотОбъект, ИмяГруппы);
		ИмяГруппы = "П0110016600";
		ОбновитьСтруктуруМногострочногоРаздела(ЭтотОбъект, ИмяГруппы);
	ИначеЕсли НаимРаздела = "Раздел12" Тогда
		ЭтотОбъект["СтруктураДанных" + НаимРаздела] = СобратьДанныеТекущегоТаблПоля(ЭтотОбъект, "ТабличныйДокумент");
		ИмяГруппы = "П0110017001";
		ОбновитьСтруктуруМногострочногоРаздела(ЭтотОбъект, ИмяГруппы);
		ИмяГруппы = "П0110017600";
		ОбновитьСтруктуруМногострочногоРаздела(ЭтотОбъект, ИмяГруппы);
	ИначеЕсли НаимРаздела = "Раздел13" Тогда
		ЭтотОбъект["СтруктураДанных" + НаимРаздела] = СобратьДанныеТекущегоТаблПоля(ЭтотОбъект, "ТабличныйДокумент");
		ИмяГруппы = "П0110018001";
		ОбновитьСтруктуруМногострочногоРаздела(ЭтотОбъект, ИмяГруппы);
		ИмяГруппы = "П0110018600";
		ОбновитьСтруктуруМногострочногоРаздела(ЭтотОбъект, ИмяГруппы);
	Иначе
...
Процедура ВывестиМакетВТаблДокНаСервере(ИмяТекРаздела, НомерСтраницыРазделаОтчета)
	...
	// Многострочные разделы.
	//
	ИначеЕсли ИмяТекРаздела = "Раздел3_4" Или ИмяТекРаздела = "Раздел7_8" Или ИмяТекРаздела = "Раздел9"
		  Или ИмяТекРаздела = "Раздел11" Или ИмяТекРаздела = "Раздел12" Или ИмяТекРаздела = "Раздел13" Тогда
		
		Если ИмяТекРаздела = "Раздел11" Тогда
	...
	Для НомерГрафы = 1 По Форма.мСтруктураКолвоКолонокРазделов[ИмяГруппы] Цикл
		...
		Если СтруктураГруппы[0].Свойство(ИмяКолонки) Тогда
			...
			Если НомерГрафы = 1 Тогда
				НомерПервойКолонки = ?(ИмяГруппы = "П0000301302", 3, 2);
...
Функция ПечатьНаСервере(ВидПечати)
	...
	Для Каждого СтрокаУровня1 Из мДеревоВыбранныхСтраниц.ПолучитьЭлементы() Цикл
		...
		Если СтрокаУровня1.ИмяСтраницы = "Раздел11" Или СтрокаУровня1.ИмяСтраницы = "Раздел12" Или СтрокаУровня1.ИмяСтраницы = "Раздел13" Тогда
			Продолжить;
		КонецЕсли;
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	СоответствиеРазделовМакетам.Вставить("Раздел1_2", "ФормаОтчета2021Кв1_Раздел1_2");
	СоответствиеРазделовМакетам.Вставить("Раздел3_4", "ФормаОтчета2021Кв1_Раздел3_4");
	СоответствиеРазделовМакетам.Вставить("Раздел5",   "ФормаОтчета2021Кв1_Раздел5");
	СоответствиеРазделовМакетам.Вставить("Раздел6",   "ФормаОтчета2021Кв1_Раздел6");
	СоответствиеРазделовМакетам.Вставить("Раздел7_8", "ФормаОтчета2021Кв1_Раздел7_8");
	СоответствиеРазделовМакетам.Вставить("Раздел9",   "ФормаОтчета2021Кв1_Раздел9");
	СоответствиеРазделовМакетам.Вставить("Раздел10",  "ФормаОтчета2021Кв1_Раздел10");
	СоответствиеРазделовМакетам.Вставить("Подписи",   "ФормаОтчета2021Кв1_Подписи");
...
Процедура ОчиститьНаСервере() Экспорт
	...
	СтруктураДанныхРаздел13.Очистить();
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел10" Тогда
		...
		ИначеЕсли Область.Имя = "ОргАдрес" Тогда
			...
			РегламентированнаяОтчетностьКлиент.ОбработкаАдресаВСтатистическомОтчетеJSON2(
				ЭтотОбъект, Область, ИмяКлючаВСтруктуре, СтандартнаяОбработка);
		КонецЕсли;
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел11" Тогда
		ТЗВыбора.Очистить();
		Если Область.Имя = "П011001599901" Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "КодыДопРаздел11_1");
			КопироватьДанныеФормы(ПараметрВводаПоля.ТаблицаЗначений, ТЗВыбора);
			СмежнаяОбласть = Область;
		ИначеЕсли Лев(Область.Имя, 13) = "П011001660001" Или Лев(Область.Имя, 13) = "П011001660002" Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "КодыДопРаздел11_2");
			КопироватьДанныеФормы(ПараметрВводаПоля.ТаблицаЗначений, ТЗВыбора);
			СмежнаяОбласть = ТабличныйДокумент.Области.Найти(СтрЗаменить(Область.Имя, "П011001660001_", "П011001660002_"));
		ИначеЕсли Лев(Область.Имя, 13) = "П011001600101" Или Лев(Область.Имя, 13) = "П011001600102" Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(
				ЭтотОбъект, "s_TZVform_TRIprod_6001");
			МассивВыбора = ПараметрВводаПоля.ТаблицаЗначений.НайтиСтроки(Новый Структура("ДопИнфо",
				ТабличныйДокумент.Области["П011001599901"].Значение));
			...
			СмежнаяОбласть = ТабличныйДокумент.Области.Найти(СтрЗаменить(Область.Имя, "П011001600101_", "П011001600102_"));
		КонецЕсли;
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел12" Тогда
		ТЗВыбора.Очистить();
		Если Лев(Область.Имя, 13) = "П011001760001" Или Лев(Область.Имя, 13) = "П011001760002" Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "КодыДопРаздел12_1");
			КопироватьДанныеФормы(ПараметрВводаПоля.ТаблицаЗначений, ТЗВыбора);
			СмежнаяОбласть = ТабличныйДокумент.Области.Найти(СтрЗаменить(Область.Имя, "П011001760001_", "П011001760002_"));
		ИначеЕсли Лев(Область.Имя, 13) = "П011001700101" Или Лев(Область.Имя, 13) = "П011001700102" Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(
				ЭтотОбъект, "s_TZVform_TRIprod_7001");
			МассивВыбора = ПараметрВводаПоля.ТаблицаЗначений.НайтиСтроки(Новый Структура("ДопИнфо",
				СтруктураДанныхРаздел11.П011001599901));
			Для Каждого ЭлемМассива Из МассивВыбора Цикл
				НовСтрТЗВыбора = ТЗВыбора.Добавить();
				НовСтрТЗВыбора.Код = ЭлемМассива.Код;
				НовСтрТЗВыбора.Название = ЭлемМассива.Название;
			...
			НовСтрТЗВыбора.Код = "";
			НовСтрТЗВыбора.Название = "Пустое значение";
			СмежнаяОбласть = ТабличныйДокумент.Области.Найти(СтрЗаменить(Область.Имя, "П011001700101_", "П011001700102_"));
		КонецЕсли;
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел13" Тогда
		ТЗВыбора.Очистить();
		Если Лев(Область.Имя, 13) = "П011001860001" Или Лев(Область.Имя, 13) = "П011001860002" Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "КодыДопРаздел13_1");
			КопироватьДанныеФормы(ПараметрВводаПоля.ТаблицаЗначений, ТЗВыбора);
			СмежнаяОбласть = ТабличныйДокумент.Области.Найти(СтрЗаменить(Область.Имя, "П011001860001_", "П011001860002_"));
		ИначеЕсли Лев(Область.Имя, 13) = "П011001800101" Или Лев(Область.Имя, 13) = "П011001800102" Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(
				ЭтотОбъект, "s_TZVform_TRIprod_8001");
			МассивВыбора = ПараметрВводаПоля.ТаблицаЗначений.НайтиСтроки(Новый Структура("ДопИнфо",
				СтруктураДанныхРаздел11.П011001599901));
			Для Каждого ЭлемМассива Из МассивВыбора Цикл
				НовСтрТЗВыбора = ТЗВыбора.Добавить();
			...
			НовСтрТЗВыбора.Код = "";
			НовСтрТЗВыбора.Название = "Пустое значение";
			СмежнаяОбласть = ТабличныйДокумент.Области.Найти(СтрЗаменить(Область.Имя, "П011001800101_", "П011001800102_"));
		КонецЕсли;
...
Функция СформироватьСтруктуруПараметров() Экспорт
	...
	ТабДокументРаздел11  = мДанныеОтчета.ПолеТабличногоДокументаРаздел11;
	ТабДокументРаздел12  = мДанныеОтчета.ПолеТабличногоДокументаРаздел12;
	ТабДокументРаздел13  = мДанныеОтчета.ПолеТабличногоДокументаРаздел13;
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	ПоказателиОтчета = Новый Структура();
	ЗаполнитьПоказателиОтчетаНаСервере(ПоказателиОтчета);
	Нарушение = "Приказ Росстата от 30.07.2021 № 462";
