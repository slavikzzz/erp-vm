...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мВерсияФормы = "21/05/2024";
...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	СтруктураРеквизитовФормы.Вставить("мИдГруппы511");
	СтруктураРеквизитовФормы.Вставить("мИдГруппы512");
	СтруктураРеквизитовФормы.Вставить("мИдГруппы521");
	СтруктураРеквизитовФормы.Вставить("мИдГруппы522");
...
Процедура ИнициализироватьМногострочныеЧасти()
	...
	СтруктураРеквизитовФормы.мИдГруппы511 = "П51100";
	СтруктураРеквизитовФормы.мИдГруппы512 = "П51200";
	СтруктураРеквизитовФормы.мИдГруппы521 = "П52100";
	СтруктураРеквизитовФормы.мИдГруппы522 = "П52200";
	...
	// Группа П20000.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П2000001");
	ИменаГраф.Добавить("П2000002");
	ИменаГраф.Добавить("П2000003");
	ИменаГраф.Добавить("П2000004");
	ИменаГраф.Добавить("П2000005");
	ИменаГраф.Добавить("П2000006");
	ИменаГраф.Добавить("П2000007");
	ИменаГраф.Добавить("П2000008");
	ИменаГраф.Добавить("П2000009");
	ИменаГраф.Добавить("П2000010");
	...
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
		СтруктураРеквизитовФормы.мИдГруппы200, Новый Структура(
		"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп",
		ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
	
	// Группа П30000.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П3000001");
	ИменаГраф.Добавить("П3000002");
	ИменаГраф.Добавить("П3000003");
	ИменаГраф.Добавить("П3000004");
	ИменаГраф.Добавить("П3000005");
	ИменаГраф.Добавить("П3000006");
	ИменаГраф.Добавить("П3000007");
	ИменаГраф.Добавить("П3000008");
	ИменаГраф.Добавить("П3000009");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
		СтруктураРеквизитовФормы.мИдГруппы300, Новый Структура(
		"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп",
		ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
	
	// Группа П40000.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П4000001");
	ИменаГраф.Добавить("П4000002");
	ИменаГраф.Добавить("П4000003");
	ИменаГраф.Добавить("П4000004");
	ИменаГраф.Добавить("П4000005");
	ИменаГраф.Добавить("П4000006");
	ИменаГраф.Добавить("П4000007");
	ИменаГраф.Добавить("П4000008");
	ИменаГраф.Добавить("П4000009");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
		СтруктураРеквизитовФормы.мИдГруппы400, Новый Структура(
		"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп",
		ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
		
	// Группа П51100.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П5110001");
	ИменаГраф.Добавить("П5110002");
	ИменаГраф.Добавить("П5110003");
	ИменаГраф.Добавить("П5110004");
	ИменаГраф.Добавить("П5110005");
	ИменаГраф.Добавить("П5110006");
	ИменаГраф.Добавить("П5110007");
	ИменаГраф.Добавить("П5110008");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
		СтруктураРеквизитовФормы.мИдГруппы511, Новый Структура(
		"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп",
		ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
		
	// Группа П51200.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П5120001");
	ИменаГраф.Добавить("П5120002");
	ИменаГраф.Добавить("П5120003");
	ИменаГраф.Добавить("П5120004");
	ИменаГраф.Добавить("П5120005");
	ИменаГраф.Добавить("П5120006");
	ИменаГраф.Добавить("П5120007");
	ИменаГраф.Добавить("П5120008");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
		СтруктураРеквизитовФормы.мИдГруппы512, Новый Структура(
		"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп",
		ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
		
	// Группа П52100.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П5210001");
	ИменаГраф.Добавить("П5210002");
	ИменаГраф.Добавить("П5210003");
	ИменаГраф.Добавить("П5210004");
	ИменаГраф.Добавить("П5210005");
	ИменаГраф.Добавить("П5210006");
	ИменаГраф.Добавить("П5210007");
	ИменаГраф.Добавить("П5210008");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
		СтруктураРеквизитовФормы.мИдГруппы521, Новый Структура(
		"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп",
		ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
		
	// Группа П52200.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П5220001");
	ИменаГраф.Добавить("П5220002");
	ИменаГраф.Добавить("П5220003");
	ИменаГраф.Добавить("П5220004");
	ИменаГраф.Добавить("П5220005");
	ИменаГраф.Добавить("П5220006");
	ИменаГраф.Добавить("П5220007");
	ИменаГраф.Добавить("П5220008");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
		СтруктураРеквизитовФормы.мИдГруппы522, Новый Структура(
		"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп",
		ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
...
Процедура ИнициализироватьМногоуровневыеРазделы()
	...
	СтруктураРаздела = Новый Структура;
	ИменаГруппМнЧ = Новый Массив;
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппы200);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	мСтруктураМногоуровневыхРазделов.Вставить("Раздел2", СтруктураРаздела);
	
	СтруктураРаздела = Новый Структура;
	ИменаГруппМнЧ = Новый Массив;
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппы300);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	мСтруктураМногоуровневыхРазделов.Вставить("Раздел3", СтруктураРаздела);
	
	СтруктураРаздела = Новый Структура;
	ИменаГруппМнЧ = Новый Массив;
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппы400);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	мСтруктураМногоуровневыхРазделов.Вставить("Раздел4", СтруктураРаздела);
	
	СтруктураРаздела = Новый Структура;
	ИменаГруппМнЧ = Новый Массив;
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппы511);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	мСтруктураМногоуровневыхРазделов.Вставить("Раздел511", СтруктураРаздела);
	
	СтруктураРаздела = Новый Структура;
	ИменаГруппМнЧ = Новый Массив;
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппы512);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	мСтруктураМногоуровневыхРазделов.Вставить("Раздел512", СтруктураРаздела);
	
	СтруктураРаздела = Новый Структура;
	ИменаГруппМнЧ = Новый Массив;
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппы521);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	мСтруктураМногоуровневыхРазделов.Вставить("Раздел521", СтруктураРаздела);
	
	СтруктураРаздела = Новый Структура;
	ИменаГруппМнЧ = Новый Массив;
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппы522);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	мСтруктураМногоуровневыхРазделов.Вставить("Раздел522", СтруктураРаздела);
...
Функция ТипАдресаПоУмолчанию()
	...
	Если НЕ ПустаяСтрока(Адреса.АдрЮР) Тогда
		Результат = "АдрЮР";
...
Процедура ФормироватьСтруктуруСтраницОтчета() Экспорт
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "Раздел511";
	СтрокаУровня1.Представление            = "Раздел 5.1.1";
	СтрокаУровня1.ОриентацияСтраницы       = "Ландщафт";
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
	СтрокаУровня1.ВыгрузитьСтраницу        = 2;
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "Раздел512";
	СтрокаУровня1.Представление            = "Раздел 5.1.2";
	СтрокаУровня1.ОриентацияСтраницы       = "Ландщафт";
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
	СтрокаУровня1.ВыгрузитьСтраницу        = 2;
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "Раздел521";
	СтрокаУровня1.Представление            = "Раздел 5.2.1";
	СтрокаУровня1.ОриентацияСтраницы       = "Ландщафт";
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
	СтрокаУровня1.ВыгрузитьСтраницу        = 2;
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "Раздел522";
	СтрокаУровня1.Представление            = "Раздел 5.2.2";
	СтрокаУровня1.ОриентацияСтраницы       = "Ландщафт";
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
	СтрокаУровня1.ВыгрузитьСтраницу        = 2;
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("СпискиВыбора2023Кв3");
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "Razdel2", 2, ,
		"Выбор кода вида отчета", КоллекцияСписковВыбора["ВидыОтчетов"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "Razdel3", 2, ,
		"Выбор кода вида отчета", КоллекцияСписковВыбора["ВидыОтчетов"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "Razdel4", 2, ,
		"Выбор кода вида отчета", КоллекцияСписковВыбора["ВидыОтчетов"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "Razdel5", 2, ,
		"Выбор кода вида отчета", КоллекцияСписковВыбора["ВидыОтчетов"]);

	//Раздел 1.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000002", 3, ,
		"Выбор кода страны нахождения объекта строительства", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000003", 2, ,
		"Выбор кода территории", КоллекцияСписковВыбора["КодыТерриторий"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000007", 2, ,
		"Выбор формы участия респондента в договоре", КоллекцияСписковВыбора["ФормыУчастия"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000008", 2, ,
		"Выбор кода вида работ", КоллекцияСписковВыбора["ВидыРабот"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000009", 3, ,
		"Выбор кода страны контрагента-нерезидента", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000011", 3, ,
		"Выбор кода страны инвестора строительства", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000013", 3, ,
		"Выбор кода валюты договора", КоллекцияСписковВыбора["КодыВалют"]);
	
	//Раздел 2.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000002", 3, ,
		"Выбор кода страны нахождения объекта строительства", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000003", 2, ,
		"Выбор кода территории", КоллекцияСписковВыбора["КодыТерриторий"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000007", 2, ,
		"Выбор формы участия нерезидента в договоре", КоллекцияСписковВыбора["ФормыУчастия"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000008", 2, ,
		"Выбор кода вида работ", КоллекцияСписковВыбора["ВидыРабот"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000009", 3, ,
		"Выбор кода страны контрагента-нерезидента", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000011", 3, ,
		"Выбор кода страны инвестора строительства", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000013", 3, ,
		"Выбор кода валюты договора", КоллекцияСписковВыбора["КодыВалют"]);
	
	//Раздел 3.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П3000002", 3, ,
		"Выбор кода страны нахождения объекта строительства", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П3000003", 2, ,
		"Выбор кода территории", КоллекцияСписковВыбора["КодыТерриторий"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П3000005", 3, ,
		"Выбор кода страны контрагента-нерезидента", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П3000007", 3, ,
		"Выбор кода страны поставки товара", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П3000008", 3, ,
		"Выбор кода валюты договора", КоллекцияСписковВыбора["КодыВалют"]);
	
	//Раздел 4.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П4000002", 3, ,
		"Выбор кода страны нахождения объекта строительства", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П4000003", 2, ,
		"Выбор кода территории", КоллекцияСписковВыбора["КодыТерриторий"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П4000005", 3, ,
		"Выбор кода страны контрагента-нерезидента", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П4000007", 3, ,
		"Выбор кода страны отгрузки товара", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П4000008", 3, ,
		"Выбор кода валюты договора", КоллекцияСписковВыбора["КодыВалют"]);
	
	//Раздел 5.1.1.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П5110002", 3, ,
		"Выбор кода страны контрагента-нерезидента", КоллекцияСписковВыбора["КодыСтран2"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П5110003", 3, ,
		"Выбор кода валюты договора", КоллекцияСписковВыбора["КодыВалют"]);
	
	//Раздел 5.1.2.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П5120002", 3, ,
		"Выбор кода страны контрагента-нерезидента", КоллекцияСписковВыбора["КодыСтран2"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П5120003", 3, ,
		"Выбор кода валюты договора", КоллекцияСписковВыбора["КодыВалют"]);
	
	//Раздел 5.2.1.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П5210002", 3, ,
		"Выбор кода страны контрагента-нерезидента", КоллекцияСписковВыбора["КодыСтран2"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П5210003", 3, ,
		"Выбор кода валюты договора", КоллекцияСписковВыбора["КодыВалют"]);
	
	//Раздел 5.2.2.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П5220002", 3, ,
		"Выбор кода страны контрагента-нерезидента", КоллекцияСписковВыбора["КодыСтран2"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П5220003", 3, ,
		"Выбор кода валюты договора", КоллекцияСписковВыбора["КодыВалют"]);
...
Процедура СформироватьПараметрыШаблона()
	...
	МакетМетаданныхШаблона = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("МетаданныеШаблона2023Кв3");
...
Процедура ЗаполнитьПериодИВерсиюОтчета()
	...
	НаименованиеПериода = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = '%1 года';
																						|en = '%1 года'"), СтрПериод);
	...
	Если ОбластьВерсияШаблона <> Неопределено И ЗначениеЗаполнено(СтрДатаВерсииШаблона) Тогда
		ОбластьВерсияШаблона.Значение = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Версия шаблона %1 от %2 г.';
				|en = 'Версия шаблона %1 от %2 г.'"), СтрВерсияШаблона, СтрДатаВерсииШаблона);
	КонецЕсли;
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Если Область.Имя = "Uaddress" Тогда
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если СтрНачинаетсяС(ИмяРаздела, "Раздел") Тогда
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяСтраницыПанели)
	...
	Если СтрНачинаетсяС(ИмяСтраницыПанели, "Раздел") Тогда
		 
		Если ИмяСтраницыПанели = "Раздел1" Тогда
			ИмяОбрабОбласти = "П1000001";
		ИначеЕсли ИмяСтраницыПанели = "Раздел2" Тогда
			ИмяОбрабОбласти = "П2000001";
		ИначеЕсли ИмяСтраницыПанели = "Раздел3" Тогда
			ИмяОбрабОбласти = "П3000001";
		ИначеЕсли ИмяСтраницыПанели = "Раздел4" Тогда
			ИмяОбрабОбласти = "П4000001";
		ИначеЕсли ИмяСтраницыПанели = "Раздел4" Тогда
			ИмяОбрабОбласти = "П4000001";
		ИначеЕсли ИмяСтраницыПанели = "Раздел511" Тогда
			ИмяОбрабОбласти = "П5110001";
		ИначеЕсли ИмяСтраницыПанели = "Раздел512" Тогда
			ИмяОбрабОбласти = "П5120001";
		ИначеЕсли ИмяСтраницыПанели = "Раздел521" Тогда
			ИмяОбрабОбласти = "П5210001";
		ИначеЕсли ИмяСтраницыПанели = "Раздел522" Тогда
			ИмяОбрабОбласти = "П5220001";
		КонецЕсли;
...
Процедура Расчет(Форма, ИмяРаздела = "", ОбластьИмя = "") Экспорт
				...
				Если НайденнаяОбласть <> Неопределено И НайденнаяОбласть.СодержитЗначение Тогда
					...
					Если ЗначениеЗаполнено(НайденнаяОбласть.Значение) Тогда
						...
						Если НомПоз > 0 Тогда
							...
							СтрНом = Сред(ОбластьИмя, НомПоз + 1);
							Форма.ТабличныйДокумент.Области["П2000001_" + СтрНом].Значение = Число(" " + СтрНом);
				...
				Если НайденнаяОбласть <> Неопределено И НайденнаяОбласть.СодержитЗначение Тогда
					...
					Если ЗначениеЗаполнено(НайденнаяОбласть.Значение) Тогда
						...
						Если НомПоз > 0 Тогда
							...
							СтрНом = Сред(ОбластьИмя, НомПоз + 1);
							Форма.ТабличныйДокумент.Области["П3000001_" + СтрНом].Значение = Число(" " + СтрНом);
				...
				Если НайденнаяОбласть <> Неопределено И НайденнаяОбласть.СодержитЗначение Тогда
					...
					Если ЗначениеЗаполнено(НайденнаяОбласть.Значение) Тогда
						...
						Если НомПоз > 0 Тогда
							...
							СтрНом = Сред(ОбластьИмя, НомПоз + 1);
							Форма.ТабличныйДокумент.Области["П4000001_" + СтрНом].Значение = Число(" " + СтрНом);
	...
	ИначеЕсли ИмяРаздела = "Раздел511" Тогда
				...
				Если НайденнаяОбласть <> Неопределено И НайденнаяОбласть.СодержитЗначение Тогда
					...
					Если ЗначениеЗаполнено(НайденнаяОбласть.Значение) Тогда
						...
						Если НомПоз > 0 Тогда
							...
							СтрНом = Сред(ОбластьИмя, НомПоз + 1);
							Форма.ТабличныйДокумент.Области["П5110001_" + СтрНом].Значение = Число(" " + СтрНом);
	...
	ИначеЕсли ИмяРаздела = "Раздел512" Тогда
				...
				Если НайденнаяОбласть <> Неопределено И НайденнаяОбласть.СодержитЗначение Тогда
					...
					Если ЗначениеЗаполнено(НайденнаяОбласть.Значение) Тогда
						...
						Если НомПоз > 0 Тогда
							...
							СтрНом = Сред(ОбластьИмя, НомПоз + 1);
							Форма.ТабличныйДокумент.Области["П5120001_" + СтрНом].Значение = Число(" " + СтрНом);
	...
	ИначеЕсли ИмяРаздела = "Раздел521" Тогда
				...
				Если НайденнаяОбласть <> Неопределено И НайденнаяОбласть.СодержитЗначение Тогда
					...
					Если ЗначениеЗаполнено(НайденнаяОбласть.Значение) Тогда
						...
						Если НомПоз > 0 Тогда
							...
							СтрНом = Сред(ОбластьИмя, НомПоз + 1);
							Форма.ТабличныйДокумент.Области["П5210001_" + СтрНом].Значение = Число(" " + СтрНом);
	...
	ИначеЕсли ИмяРаздела = "Раздел522" Тогда
				...
				Если НайденнаяОбласть <> Неопределено И НайденнаяОбласть.СодержитЗначение Тогда
					...
					Если ЗначениеЗаполнено(НайденнаяОбласть.Значение) Тогда
						...
						Если НомПоз > 0 Тогда
							...
							СтрНом = Сред(ОбластьИмя, НомПоз + 1);
							Форма.ТабличныйДокумент.Области["П5220001_" + СтрНом].Значение = Число(" " + СтрНом);
	...
	ИначеЕсли ИмяРаздела = "" Тогда
		...
		Расчет(Форма, "Раздел511");
		Расчет(Форма, "Раздел512");
		Расчет(Форма, "Раздел521");
		Расчет(Форма, "Раздел522");
...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
	...
	Если СтрНачинаетсяС(ИмяРаздела, "Раздел") Тогда
		...
		ИначеЕсли  ИмяРаздела = "Раздел2" Тогда
			ИмяГрафыНомера = "П2000001";
			ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы200;
		ИначеЕсли  ИмяРаздела = "Раздел3" Тогда
			ИмяГрафыНомера = "П3000001";
			ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы300;
		ИначеЕсли  ИмяРаздела = "Раздел4" Тогда
			ИмяГрафыНомера = "П4000001";
			ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы400;
		ИначеЕсли  ИмяРаздела = "Раздел511" Тогда
			ИмяГрафыНомера = "П5110001";
			ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы511;
		ИначеЕсли  ИмяРаздела = "Раздел512" Тогда
			ИмяГрафыНомера = "П5120001";
			ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы512;
		ИначеЕсли  ИмяРаздела = "Раздел521" Тогда
			ИмяГрафыНомера = "П5210001";
			ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы521;
		ИначеЕсли  ИмяРаздела = "Раздел522" Тогда
			ИмяГрафыНомера = "П5220001";
			ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы522;
		КонецЕсли;
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ИмяФайлаШаблона", "1-СТР");
	
	ПараметрыВыгрузки.Вставить("ИмяМакетаШаблона", "ШаблонБанка2023Кв3");
	
	ПараметрыВыгрузки.Вставить("ИмяСхемыВыгрузки", "СхемаВыгрузкиXML2023Кв3");
	
	ПараметрыВыгрузки.Вставить("ИмяМакетаСписковВыбора", "СпискиВыбора2023Кв3");
	
	ПараметрыВыгрузки.Вставить("ИмяМакетаМетаданныхШаблона", "МетаданныеШаблона2023Кв3");
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки, ЕстьПредупреждения = Ложь)
	...
	Если НЕ (ПараметрыВыгрузки.ОтчетГод >= 2023 И ПараметрыВыгрузки.ОтчетГод <= 2025) Тогда
		СообщитьВТС("ОШИБКА: Задан год представления отчета, не входящий в интервал с 2023 г. по 2025 г.", "Титульный", "NamePeriod");
		СтатусПроверки = Ложь;
	КонецЕсли;
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель, ПараметрыВыгрузки)
	...
	ДеревоДанныхРаздел511 = ДанныеМногоуровневыхРазделов["Раздел511"];
	ДеревоДанныхРаздел512 = ДанныеМногоуровневыхРазделов["Раздел512"];
	ДеревоДанныхРаздел521 = ДанныеМногоуровневыхРазделов["Раздел521"];
	ДеревоДанныхРаздел522 = ДанныеМногоуровневыхРазделов["Раздел522"];
...
Функция ИдентификаторФайлаВыгрузки(ПараметрыВыгрузки)
		...
		ИдентификаторФайла = "OKUD0414009"
...
Функция ВыгрузкаОтчета(ТекстВыгрузки, ПараметрыВыгрузки)
	...
	РезультатВыгрузки.Вставить("ТипФайлаВыгрузки", "Форма1СТР");
...
Процедура ПроверитьВыгрузкуОтчетаЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Иначе
		...
		ПоказатьПредупреждение(,НСтр("ru = 'Ошибок и предупреждений не обнаружено!';
									|en = 'Ошибок и предупреждений не обнаружено!'"));
...
Процедура ВывестиСообщениеПослеПроверкиВыгрузки(ТолькоПредупреждения = Ложь)
	...
	Если ТолькоПредупреждения <> Истина Тогда
		ТекстСообщения = НСтр("ru = 'В ходе проверки были найдены ошибки, препятствующие выгрузке.';
								|en = 'В ходе проверки были найдены ошибки, препятствующие выгрузке.'");
		ТекстСообщения = ТекстСообщения + Символы.ПС
		+ НСтр("ru = 'Для исправления ошибок используйте специальное окно навигации по ошибкам.';
				|en = 'Для исправления ошибок используйте специальное окно навигации по ошибкам.'");
	Иначе
		ТекстСообщения = НСтр("ru = 'В ходе проверки были получены предупреждения, не препятствующие выгрузке.';
								|en = 'В ходе проверки были получены предупреждения, не препятствующие выгрузке.'");
		ТекстСообщения = ТекстСообщения + Символы.ПС
		+ НСтр("ru = 'Если необходимо внести исправления - используйте специальное окно навигации по ошибкам и предупреждениям.';
				|en = 'Если необходимо внести исправления - используйте специальное окно навигации по ошибкам и предупреждениям.'");
	КонецЕсли;
...
Процедура ВывестиНаПечатьОтчет(СтруктураПараметров, ВыбранныеСтраницы, СтрПоля = Неопределено)
	...
	ИмяМакета = "ПечатныйБланк2023Кв3";
	...
	Если ВыбранныеСтраницы.Найти("Раздел2") <> Неопределено Тогда
		...
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл // часть 1
			...
			Заг_Раздел2 = Макет.Получитьобласть("Раздел2_Заголовок");
			Рзд_Раздел2 = Макет.Получитьобласть("Раздел2_Разделитель");
			Шап_Раздел2 = Макет.Получитьобласть("Раздел2_Шапка1");
			Стр_Раздел2 = Макет.Получитьобласть("Раздел2_Строка1");
			
			Рзд_Раздел2.Области["Раздел2_Разделитель"].Имя = "Раздел2_Разделитель1";
			
			МассивПроверки = Новый Массив;
			МассивПроверки.Добавить(Заг_Раздел2);
			МассивПроверки.Добавить(Рзд_Раздел2);
			МассивПроверки.Добавить(Шап_Раздел2);
			МассивПроверки.Добавить(Стр_Раздел2);
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел2 = Макет.Получитьобласть("Раздел2_Строка1");
					Стр_Раздел2.Области["Раздел2_Строка1"].Имя = "Раздел2_Строка1_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел2.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						ПечФорма.Вывести(Шап_Раздел2);
						ПечФорма.Области["Раздел2_Шапка1"].Имя = "Раздел2_Шапка1_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
					ПечФорма.Вывести(Стр_Раздел2);
		...
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл  // часть 2
			...
			Рзд_Раздел2 = Макет.Получитьобласть("Раздел2_Разделитель");
			Шап_Раздел2 = Макет.Получитьобласть("Раздел2_Шапка2");
			Стр_Раздел2 = Макет.Получитьобласть("Раздел2_Строка2");
			
			Рзд_Раздел2.Области["Раздел2_Разделитель"].Имя = "Раздел2_Разделитель2";
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел2 = Макет.Получитьобласть("Раздел2_Строка2");
					Стр_Раздел2.Области["Раздел2_Строка2"].Имя = "Раздел2_Строка2_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел2.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						ПечФорма.Вывести(Шап_Раздел2);
						ПечФорма.Области["Раздел2_Шапка2"].Имя = "Раздел2_Шапка2_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
	...
	Если ВыбранныеСтраницы.Найти("Раздел3") <> Неопределено Тогда
		...
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Заг_Раздел3 = Макет.Получитьобласть("Раздел3_Заголовок");
			Шап_Раздел3 = Макет.Получитьобласть("Раздел3_Шапка");
			Стр_Раздел3 = Макет.Получитьобласть("Раздел3_Строка");
			
			МассивПроверки = Новый Массив;
			МассивПроверки.Добавить(Заг_Раздел3);
			МассивПроверки.Добавить(Шап_Раздел3);
			МассивПроверки.Добавить(Стр_Раздел3);
			
			Если НЕ ПечФорма.ПроверитьВывод(МассивПроверки) Тогда
				ПечФорма.ВывестиГоризонтальныйРазделительСтраниц();
			КонецЕсли;
			
			ПечФорма.Вывести(Заг_Раздел3);
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел3 = Макет.Получитьобласть("Раздел3_Строка");
					Стр_Раздел3.Области["Раздел3_Строка"].Имя = "Раздел3_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел3.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						ПечФорма.Вывести(Шап_Раздел3);
						ПечФорма.Области["Раздел3_Шапка"].Имя = "Раздел3_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
					ПечФорма.Вывести(Стр_Раздел3);
	...
	Если ВыбранныеСтраницы.Найти("Раздел4") <> Неопределено Тогда
		...
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Заг_Раздел4 = Макет.Получитьобласть("Раздел4_Заголовок");
			Шап_Раздел4 = Макет.Получитьобласть("Раздел4_Шапка");
			Стр_Раздел4 = Макет.Получитьобласть("Раздел4_Строка");
			
			МассивПроверки = Новый Массив;
			МассивПроверки.Добавить(Заг_Раздел4);
			МассивПроверки.Добавить(Шап_Раздел4);
			МассивПроверки.Добавить(Стр_Раздел4);
			
			Если НЕ ПечФорма.ПроверитьВывод(МассивПроверки) Тогда
				ПечФорма.ВывестиГоризонтальныйРазделительСтраниц();
			КонецЕсли;
			
			ПечФорма.Вывести(Заг_Раздел4);
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел4 = Макет.Получитьобласть("Раздел4_Строка");
					Стр_Раздел4.Области["Раздел4_Строка"].Имя = "Раздел4_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел4.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						ПечФорма.Вывести(Шап_Раздел4);
						ПечФорма.Области["Раздел4_Шапка"].Имя = "Раздел4_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
					ПечФорма.Вывести(Стр_Раздел4);
	...
	// Раздел 5.1.1.
	//
	Если ВыбранныеСтраницы.Найти("Раздел511") <> Неопределено Тогда
		
		ДеревоДанных = ПолучитьИзВременногоХранилища(
			СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел511"]);
		
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			
			Заг_Раздел511 = Макет.Получитьобласть("Раздел511_Заголовок");
			Шап_Раздел511 = Макет.Получитьобласть("Раздел511_Шапка");
			Стр_Раздел511 = Макет.Получитьобласть("Раздел511_Строка");
			
			МассивПроверки = Новый Массив;
			МассивПроверки.Добавить(Заг_Раздел511);
			МассивПроверки.Добавить(Шап_Раздел511);
			МассивПроверки.Добавить(Стр_Раздел511);
			
			Если НЕ ПечФорма.ПроверитьВывод(МассивПроверки) Тогда
				ПечФорма.ВывестиГоризонтальныйРазделительСтраниц();
			КонецЕсли;
			
			ПечФорма.Вывести(Заг_Раздел511);
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел511 = Макет.Получитьобласть("Раздел511_Строка");
					Стр_Раздел511.Области["Раздел511_Строка"].Имя = "Раздел511_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел511.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						ПечФорма.Вывести(Шап_Раздел511);
						ПечФорма.Области["Раздел511_Шапка"].Имя = "Раздел511_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
					ПечФорма.Вывести(Стр_Раздел511);
	...
	// Раздел 5.1.2.
	//
	Если ВыбранныеСтраницы.Найти("Раздел512") <> Неопределено Тогда
		
		ДеревоДанных = ПолучитьИзВременногоХранилища(
			СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел512"]);
		
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			
			Заг_Раздел512 = Макет.Получитьобласть("Раздел512_Заголовок");
			Шап_Раздел512 = Макет.Получитьобласть("Раздел512_Шапка");
			Стр_Раздел512 = Макет.Получитьобласть("Раздел512_Строка");
			
			МассивПроверки = Новый Массив;
			МассивПроверки.Добавить(Заг_Раздел512);
			МассивПроверки.Добавить(Шап_Раздел512);
			МассивПроверки.Добавить(Стр_Раздел512);
			
			Если НЕ ПечФорма.ПроверитьВывод(МассивПроверки) Тогда
				ПечФорма.ВывестиГоризонтальныйРазделительСтраниц();
			КонецЕсли;
			
			ПечФорма.Вывести(Заг_Раздел512);
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел512 = Макет.Получитьобласть("Раздел512_Строка");
					Стр_Раздел512.Области["Раздел512_Строка"].Имя = "Раздел512_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел512.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						ПечФорма.Вывести(Шап_Раздел512);
						ПечФорма.Области["Раздел512_Шапка"].Имя = "Раздел512_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
					ПечФорма.Вывести(Стр_Раздел512);
	...
	// Раздел 5.2.1.
	//
	Если ВыбранныеСтраницы.Найти("Раздел521") <> Неопределено Тогда
		
		ДеревоДанных = ПолучитьИзВременногоХранилища(
			СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел521"]);
		
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			
			Заг_Раздел521 = Макет.Получитьобласть("Раздел521_Заголовок");
			Шап_Раздел521 = Макет.Получитьобласть("Раздел521_Шапка");
			Стр_Раздел521 = Макет.Получитьобласть("Раздел521_Строка");
			
			МассивПроверки = Новый Массив;
			МассивПроверки.Добавить(Заг_Раздел521);
			МассивПроверки.Добавить(Шап_Раздел521);
			МассивПроверки.Добавить(Стр_Раздел521);
			
			Если НЕ ПечФорма.ПроверитьВывод(МассивПроверки) Тогда
				ПечФорма.ВывестиГоризонтальныйРазделительСтраниц();
			КонецЕсли;
			
			ПечФорма.Вывести(Заг_Раздел521);
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел521 = Макет.Получитьобласть("Раздел521_Строка");
					Стр_Раздел521.Области["Раздел521_Строка"].Имя = "Раздел521_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел521.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						ПечФорма.Вывести(Шап_Раздел521);
						ПечФорма.Области["Раздел521_Шапка"].Имя = "Раздел521_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
					ПечФорма.Вывести(Стр_Раздел521);
	...
	// Раздел 5.2.2.
	//
	Если ВыбранныеСтраницы.Найти("Раздел522") <> Неопределено Тогда
		
		ДеревоДанных = ПолучитьИзВременногоХранилища(
			СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел522"]);
		
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			
			Заг_Раздел522 = Макет.Получитьобласть("Раздел522_Заголовок");
			Шап_Раздел522 = Макет.Получитьобласть("Раздел522_Шапка");
			Стр_Раздел522 = Макет.Получитьобласть("Раздел522_Строка");
			
			МассивПроверки = Новый Массив;
			МассивПроверки.Добавить(Заг_Раздел522);
			МассивПроверки.Добавить(Шап_Раздел522);
			МассивПроверки.Добавить(Стр_Раздел522);
			
			Если НЕ ПечФорма.ПроверитьВывод(МассивПроверки) Тогда
				ПечФорма.ВывестиГоризонтальныйРазделительСтраниц();
			КонецЕсли;
			
			ПечФорма.Вывести(Заг_Раздел522);
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел522 = Макет.Получитьобласть("Раздел522_Строка");
					Стр_Раздел522.Области["Раздел522_Строка"].Имя = "Раздел522_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел522.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						ПечФорма.Вывести(Шап_Раздел522);
						ПечФорма.Области["Раздел522_Шапка"].Имя = "Раздел522_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
					ПечФорма.Вывести(Стр_Раздел522);
...
Процедура ЗагрузитьПодготовленныеДанные()
	...
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел511"] = ПоместитьВоВременноеХранилище(Контейнер.Раздел511, СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел511"]);
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел512"] = ПоместитьВоВременноеХранилище(Контейнер.Раздел512, СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел512"]);
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел521"] = ПоместитьВоВременноеХранилище(Контейнер.Раздел521, СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел521"]);
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел522"] = ПоместитьВоВременноеХранилище(Контейнер.Раздел522, СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел522"]);
...
Функция ЗаполнитьАвтоНаСервере()
	...
	Контейнер.Вставить("Раздел511", ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел511"]));
	Контейнер.Вставить("Раздел512", ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел512"]));
	Контейнер.Вставить("Раздел521", ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел521"]));
	Контейнер.Вставить("Раздел522", ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел522"]));
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ВПрограммеИзмененаДатаПодписи = Ложь)
	...
	Если НЕ ВПрограммеИзмененаДатаПодписи Тогда
		...
		СтрокаСведений
		= "ИННЮЛ, ОГРН, ОКПО, ОКТМО, ОКАТО, ОКВЭД2, ОКФС, НаимЮЛПол, НаимЮЛСокр, ТелОрганизации, ФаксОрганизации, "
		...
		Форма.ТабличныйДокумент.Области.oktmo.Значение = СокрЛП(СведенияОбОрганизации.ОКТМО);
		...
		Форма.ТабличныйДокумент.Области.EmailUser.Значение = СокрЛП(СведенияОбОрганизации.АдресЭлектроннойПочтыОрганизации);
...
Процедура АктивизироватьЯчейку(Ячейка) Экспорт
	...
	Если СтрНачинаетсяС(Ячейка.Раздел, "Раздел") Тогда
