...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "02/12/2009";
	СтруктураРеквизитовФормы.мКодОтчета   = "0607006";
	СтруктураРеквизитовФормы.мПечатныеФормы = Новый СписокЗначений;
	
	ПолеТабличногоДокументаФормаОтчета.Вывести(Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("ФормаОтчета2010Кв4_ФормаОтчета"));
...
Процедура Расчет(Форма) Экспорт
	...
	//раздел 2
	//Строка 101 по графе 4 определяется как сумма граф  с 5 по 11
	мФормаОтчета.Области.П000020010104.Значение = мФормаОтчета.Области.П000020010105.Значение 
												...
												+ мФормаОтчета.Области.П000020010111.Значение;
												
	
	//Строка 101 по графе 3 определяется как сумма граф 4 и 12
	мФормаОтчета.Области.П000020010103.Значение = мФормаОтчета.Области.П000020010104.Значение
												+ мФормаОтчета.Области.П000020010112.Значение;											   
	...
	мФормаОтчета.Области.П000020011311.Значение = мФормаОтчета.Области.П000020011411.Значение
												 + мФормаОтчета.Области.П000020011511.Значение;
												   
	мФормаОтчета.Области.П000020011312.Значение = мФормаОтчета.Области.П000020011412.Значение
												 + мФормаОтчета.Области.П000020011512.Значение;
												   
												   
	//Строка 206 равняется сумме строк 207, 208, 209
	мФормаОтчета.Области.П000020020603.Значение = мФормаОтчета.Области.П000020020703.Значение
												+ мФормаОтчета.Области.П000020020803.Значение	
												+ мФормаОтчета.Области.П000020020903.Значение;	
												
	мФормаОтчета.Области.П000020020604.Значение = мФормаОтчета.Области.П000020020704.Значение
												+ мФормаОтчета.Области.П000020020804.Значение	
												+ мФормаОтчета.Области.П000020020904.Значение;
												
	мФормаОтчета.Области.П000020020605.Значение = мФормаОтчета.Области.П000020020705.Значение
												+ мФормаОтчета.Области.П000020020805.Значение	
												+ мФормаОтчета.Области.П000020020905.Значение;
												   
	мФормаОтчета.Области.П000020020606.Значение = мФормаОтчета.Области.П000020020706.Значение
												+ мФормаОтчета.Области.П000020020806.Значение	
												+ мФормаОтчета.Области.П000020020906.Значение;	
												
	мФормаОтчета.Области.П000020020607.Значение = мФормаОтчета.Области.П000020020707.Значение
												+ мФормаОтчета.Области.П000020020807.Значение	
												+ мФормаОтчета.Области.П000020020907.Значение;
												
	мФормаОтчета.Области.П000020020608.Значение = мФормаОтчета.Области.П000020020708.Значение
												+ мФормаОтчета.Области.П000020020808.Значение	
												+ мФормаОтчета.Области.П000020020908.Значение;
												
	мФормаОтчета.Области.П000020020609.Значение = мФормаОтчета.Области.П000020020709.Значение
												+ мФормаОтчета.Области.П000020020809.Значение	
												+ мФормаОтчета.Области.П000020020909.Значение;	
												
	мФормаОтчета.Области.П000020020610.Значение = мФормаОтчета.Области.П000020020710.Значение
												+ мФормаОтчета.Области.П000020020810.Значение	
												+ мФормаОтчета.Области.П000020020910.Значение;
												
	//По графам 11, 12 строка 301 равняется строке 306
	мФормаОтчета.Области.П000020030111.Значение = мФормаОтчета.Области.П000020030611.Значение;
	мФормаОтчета.Области.П000020030112.Значение = мФормаОтчета.Области.П000020030612.Значение;
	
	
	//раздел 3
	//Строка 101 по графе 3 определяется как сумма граф с 4 по 9
	мФормаОтчета.Области.П000030010103.Значение = мФормаОтчета.Области.П000030010104.Значение
												...
												+ мФормаОтчета.Области.П000030010109.Значение;

	//раздел 4
	//Строка 101 по графе 3 определяется как сумма граф с 4 по 8
	мФормаОтчета.Области.П000040010103.Значение = мФормаОтчета.Области.П000040010104.Значение
												+ мФормаОтчета.Области.П000040010105.Значение										
												+ мФормаОтчета.Области.П000040010106.Значение										
												+ мФормаОтчета.Области.П000040010107.Значение										
												+ мФормаОтчета.Области.П000040010108.Значение;	
...
Функция ЗагрузкаОтчетаИзФайлаНаСервере(ДанныеДляЗагрузки)
	...
	ДеревоДляЗагрузки = РегламентированнаяОтчетность.ПолучитьДеревоВыгрузки(ЭтаФорма, "СхемаВыгрузкиXML2010Кв4");
...
Функция ПроверитьПоказатели() Экспорт
	...
	РегламентированнаяОтчетность.СформироватьСтруктуруПоказателей(ЭтаФорма);
	ДеревоВыгрузки = РегламентированнаяОтчетность.ПолучитьДеревоВыгрузки(ЭтаФорма, "СхемаВыгрузкиXML2010Кв4");
...
Функция СформироватьИмяФайла(ПараметрыВыгрузки, ДопАтрибуты)
	...
	ИмяФайлаXML = ИмяФайлаXML + ?(ПустаяСтрока(КодОКФС), "", "_" + КодОКФС) + ?(ПустаяСтрока(КодОКВЭД), "", "_" + КодОКВЭД) + ?(ПустаяСтрока(Признак), "", "_" + Признак) + ".xml";
