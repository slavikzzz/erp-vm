...
Процедура ПоказатьПериод(Форма)
	...
	Иначе
		...
		Если НачалоДня(Форма.мДатаКонцаПериодаОтчета) >= '20130701' Тогда
			Форма.ОписаниеНормативДок = "Форма утратила силу в соответствии с приказом Росстата от 18.09.2013 № 374.";
		Иначе
