...
Функция НалоговаяСтавкаВидаПодакцизногоТовара(КодВидаПодакцизногоТовара, ДатаДействия)
	...
	Если ГодДействия = 2020 Тогда
		
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "410", 3172, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "412", 3172, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "413", 3172, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "414", 3172, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "415", 3172, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "420", 3172, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "430", 215,  СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "440", 3055, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "441", 3055, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "442", 3055, СтавкаВидаПТ);
		...
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "473", 50,   СтавкаВидаПТ);
		
	ИначеЕсли ГодДействия = 2021 Тогда
		
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "410", 3806, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "412", 3806, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "413", 3806, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "414", 3806, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "415", 3806, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "420", 3806, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "430", 258,  СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "440", 3666, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "441", 3666, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "442", 3666, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "470", 60,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "471", 16,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "472", 7248, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "473", 60,   СтавкаВидаПТ);
		
	ИначеЕсли ГодДействия = 2022 Тогда
	...
	ИначеЕсли ГодДействия = 2023 Тогда
		...
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "470", 64,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "471", 18,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "472", 7839, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "473", 64,   СтавкаВидаПТ);
		
	ИначеЕсли ГодДействия = 2024 Тогда
		
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "410", 4281, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "412", 4281, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "413", 4281, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "414", 4281, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "415", 4281, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "420", 4281, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "430", 289,  СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "440", 4124, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "441", 4124, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "442", 4124, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "470", 67,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "471", 19,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "472", 8153, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "473", 67,   СтавкаВидаПТ);
		
	ИначеЕсли ГодДействия = 2025 Тогда
		
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "410", 4452, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "412", 4452, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "413", 4452, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "414", 4452, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "415", 4452, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "420", 4452, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "430", 301,  СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "440", 4289, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "441", 4289, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "442", 4289, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "470", 70,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "471", 20,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "472", 8479, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "473", 70,   СтавкаВидаПТ);
...
Процедура СформироватьСлужебныеДанные()
	...
	ПредставлениеРазделов.Вставить("Р20", "Раздела 2");
	...
	ПредставлениеРазделов.Вставить("П11", "Приложения 1");
	ПредставлениеРазделов.Вставить("П02", "Приложения 2");
	ПредставлениеРазделов.Вставить("П21", "раздела 1 Приложения 2");
	ПредставлениеРазделов.Вставить("П22", "раздела 2 Приложения 2");
	...
	РазделыПоказателей.Вставить("Р20", "Раздел21");
	РазделыПоказателей.Вставить("Р21", "Раздел21");
	РазделыПоказателей.Вставить("Р22", "Раздел21");
	РазделыПоказателей.Вставить("Р23", "Раздел21");
	РазделыПоказателей.Вставить("Р24", "Раздел21");
	РазделыПоказателей.Вставить("Р25", "Раздел21");
	РазделыПоказателей.Вставить("П01", "Приложение1");
	РазделыПоказателей.Вставить("П11", "Приложение11");
	РазделыПоказателей.Вставить("П02", "Приложение2");
	РазделыПоказателей.Вставить("П21", "Приложение2");
	РазделыПоказателей.Вставить("П22", "Приложение2");
	...
	МногостраничныеРазделы.Добавить("Р01");
	...
	Если ДанныеКС.ГодОтчета >= 2026 Тогда
		
		СтавкиСигарет = Неопределено;
		
	ИначеЕсли ДанныеКС.ГодОтчета >= 2025 Тогда
		
		СтавкиСигарет.Вставить("СтавкаТвердая"		, 2760);
		СтавкиСигарет.Вставить("СтавкаАдвалорная"	, 16);
		СтавкиСигарет.Вставить("СтавкаМинимальная"	, 3750);
		
	ИначеЕсли ДанныеКС.ГодОтчета >= 2024 Тогда
		
		СтавкиСигарет.Вставить("СтавкаТвердая"		, 2654);
		СтавкиСигарет.Вставить("СтавкаАдвалорная"	, 16);
		СтавкиСигарет.Вставить("СтавкаМинимальная"	, 3606);
	...
	ИначеЕсли ДанныеКС.ГодОтчета >= 2021 Тогда
		
		СтавкиСигарет.Вставить("СтавкаТвердая"		, 2359);
		СтавкиСигарет.Вставить("СтавкаАдвалорная"	, 16);
		СтавкиСигарет.Вставить("СтавкаМинимальная"	, 3205);
		
	ИначеЕсли ДанныеКС.ГодОтчета >= 2020 Тогда
			...
			Иначе
				...
				Для каждого СтраницаПриложения Из СтруктураИсточник.Строки Цикл
					...
					Если КлючПриложения = "Раздел21" Тогда
						ДанныеСтраницы.Вставить("Страница", XMLСтрока(СтруктураИсточник.Строки.Индекс(СтраницаПриложения) + 1));
					Иначе
...
Процедура СформироватьВременныеТаблицы()
	...
	СформироватьПоказатели(Показатели1	, ИменаПоказателей);
	...
	СформироватьПоказатели(Показатели2	, ИменаПоказателей);
	...
	НоваяСтрока.НомерСтраницы = ДанныеКС.Раздел2.Страница;
...
Процедура ПроверкаКС_1_01()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 80 НК РФ';
													|en = 'ст. 80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Код ОКТМО в стр.010 Раздела 1 должен быть заполнен';
	...
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Не заполнен код ОКТМО';
...
Процедура ПроверкаКС_1_02()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 80 НК РФ';
													|en = 'ст. 80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'КБК в стр.020 Раздела 1 должен быть заполнен';
...
Процедура ПроверкаКС_1_03()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма акциза, подлежащая уплате в бюджет в стр.030 Раздела 1 должна быть равна сумме ';
			|en = 'Сумма акциза, подлежащая уплате в бюджет в стр.030 Раздела 1 должна быть равна сумме '") +
		НСтр("ru = 'акциза в гр.2 подраздела 2.4 по коду 40001 в гр.1 подраздела 2.4 и соответствующему КБК';
			|en = 'акциза в гр.2 подраздела 2.4 по коду 40001 в гр.1 подраздела 2.4 и соответствующему КБК'"));
	...
	Настройки.Вставить("ЗначениеР1",		"П00001М103003_");
...
Процедура ПроверкаКС_1_04()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма акциза, исчисленная к уменьшению в стр.040 Раздела 1 должна быть равна сумме ';
			|en = 'Сумма акциза, исчисленная к уменьшению в стр.040 Раздела 1 должна быть равна сумме '") +
		НСтр("ru = 'акциза в гр.2 подраздела 2.4 по коду 40002 в гр.1 подраздела 2.4 и соответствующему КБК';
			|en = 'акциза в гр.2 подраздела 2.4 по коду 40002 в гр.1 подраздела 2.4 и соответствующему КБК'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма акциза';
														|en = 'Ошибочная сумма акциза'"));
	...
	Настройки.Вставить("ЗначениеР1",		"П00001М104003_");
...
Процедура ПроверкаКС_1_04_код(Настройки)
	...
	ИменаПоказателей.Вставить("Р01С020", "П00001М102003_");
	ИменаПоказателей.Вставить(Настройки.ПоказательР1, Настройки.ЗначениеР1);
	ИменаПоказателей.Вставить("Р20С040", "П000020004003");
	ИменаПоказателей.Вставить("Р24Г020", "П000240000002");
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	...
	Пока ВыборкаР1.Следующий() Цикл
		...
		Показатели[Настройки.ПоказательР1].Итог = 0;
		Показатели.Р24Г020.Итог = 0;
		Настройки.ДопСведения = ЗначСтроки(ВыборкаР1.Р01С020);
		ЗарегистрироватьФормулу(Настройки);
			
		Выборка = ВыборкаР1.Выбрать();
		Пока Выборка.Следующий() Цикл
			ЗаполнитьИРасшифроватьПоказатель(Показатели.Р01С020, Выборка, Выборка.НомерСтроки);
			ЗаполнитьИРасшифроватьПоказатель(Показатели[Настройки.ПоказательР1], Выборка, Выборка.НомерСтроки);
		КонецЦикла;
		...
		Настройки.ЭтоОшибка	= ?(Настройки.ПоказательР1 = "Р01С030", НЕ Показатели[Настройки.ПоказательР1].Итог = 
			Макс(Показатели.Р24Г020.Итог, 0), НЕ Показатели[Настройки.ПоказательР1].Итог = Мин(Показатели.Р24Г020.Итог, 0));
		Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
			Показатели[Настройки.ПоказательР1].Итог, Показатели.Р24Г020.Итог); 
		ДополнитьСтруктуруОшибок(Настройки);
		ВыборкаР2.Сбросить();
	КонецЦикла;
...
Процедура ПроверкаКС_2_01()
	...
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = 1 когда %2 <= %3';
													|en = '%1 = 1 когда %2 <= %3'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочное значение коэффициента Т';
														|en = 'Ошибочное значение коэффициента Т'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	Настройки.ДопСведения = ПодставитьПараметрыВСтроку(Настройки.ШаблонДопСведений, ДанныеКС.Раздел2.Страница);
	
	Настройки.ЭтоОшибка = ДанныеКС.Раздел2.РазделЗаполнен И Показатели.Р02С010.Значение <= Показатели.Р02С020.Значение
...
Процедура ПроверкаКС_2_02()
	...
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = 1 + 0,3 х (%2 - %3) / %2 Итог [%4] когда %2 > %3';
													|en = '%1 = 1 + 0,3 х (%2 - %3) / %2 Итог [%4] когда %2 > %3'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочное значение коэффициента Т';
														|en = 'Ошибочное значение коэффициента Т'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	Настройки.ЭтоОшибка = ДанныеКС.Раздел2.РазделЗаполнен И ЗначениеЗаполнено(Показатели.Р02С020.Значение)
...
Процедура ПроверкаКС_2_03()
	...
	Настройки.ЭтоОшибка = ДанныеКС.Раздел2.РазделЗаполнен И ЗначениеЗаполнено(Показатели.Р02С010.Значение) 
...
Процедура ПроверкаКС_2_04()
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		Если НЕ Список = Неопределено Тогда
			...
			Настройки.ДопСведения = ПодставитьПараметрыВСтроку(Настройки.ШаблонДопСведений, СтраницаРаздела.Страница);
			
			Настройки.ЭтоОшибка = Список.Получить(Показатели.Р20С040.Значение) = Неопределено;
			Настройки.Расшифровка = СтрЗаменить(Настройки.ШаблонРасшифровки, "%1", Показатели.Р20С040.ЗначениеСтр);
			ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_2_05()
	...
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1, строка %2, код операции %3';
													|en = 'Страница %1, строка %2, код операции %3'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочное значение кода операции';
														|en = 'Ошибочное значение кода операции'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	Настройки.Вставить("КодПоказателя"	, "Р21Г010");
	Настройки.Вставить("ИмяПоказателя"	, "П00021М100001_");
	Настройки.Вставить("СтрокиТЧ"		, "КолвоСтрокП00021М1");
	
	ПроверкаКС_2_28_код(Настройки);
...
Процедура ПроверкаКС_2_06()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 80 НК РФ';
													|en = 'ст. 80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450 или 460, то объем подакцизного товара ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450 или 460, то объем подакцизного товара '") +
	...
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2, когда код товара %3 = 450, 460, код операции %4';
													|en = '%1 = %2, когда код товара %3 = 450, 460, код операции %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочное значение объема подакцизного товара';
														|en = 'Ошибочное значение объема подакцизного товара'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	Настройки.Вставить("ПоказательР1"	, "Р21Г020");
	Настройки.Вставить("ЗначениеР1"		, "П00021М100002_");
	Настройки.Вставить("ПоказательР2"	, "П01С040");
	Настройки.Вставить("ЗначениеР2"		, "П001010004003");
	
	ПроверкаКС_2_30_код(Настройки);
...
Процедура ПроверкаКС_2_07()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 80 НК РФ';
													|en = 'ст. 80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 410 - 430 или 470 - 473, ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 410 - 430 или 470 - 473, '") +
		НСтр("ru = 'то исчисленная сумма акциза в гр.3 подр.2.1 Раздела 2 = 0';
			|en = 'то исчисленная сумма акциза в гр.3 подр.2.1 Раздела 2 = 0'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1, код товара %2';
													|en = 'Страница %1, код товара %2'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00021М1 Цикл
			...
			Настройки.ЭтоОшибка = НЕ СтрНайти("410,412,413,414,415,420,430,470,471,472,473", Показатели.Р20С040.Значение) = 0 
				И НЕ Показатели.Р21Г030.Значение = 0;
			Настройки.Расшифровка = СтрЗаменить(Настройки.ШаблонРасшифровки, "%1", Показатели.Р21Г030.Значение);
			ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_2_08()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru = 'коду операции в гр.1 подр.2.1 Раздела 2 х Ставка акциза';
			|en = 'коду операции в гр.1 подр.2.1 Раздела 2 х Ставка акциза'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1, код товара %2';
													|en = 'Страница %1, код товара %2'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00021М1 Цикл
			...
			РасчетнаяСумма = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтотОбъект, 
				Показатели.Р21Г020.Значение * Показатели.Р20С041.Значение);
			Настройки.ЭтоОшибка = НЕ СтрНайти("440,441,442", Показатели.Р20С040.Значение) = 0 
				И НЕ Показатели.Р21Г030.Значение = РасчетнаяСумма;
			Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р21Г030.Значение,
...
Процедура ПроверкаКС_2_09()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 80 НК РФ';
													|en = 'ст. 80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450 или 460, то исчисленная сумма акциза ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450 или 460, то исчисленная сумма акциза '") +
	...
	Настройки.Вставить("ПоказательР1"	, "Р21Г030");
	Настройки.Вставить("ЗначениеР1"		, "П00021М100003_");
	Настройки.Вставить("ПоказательР2"	, "П01С030");
	Настройки.Вставить("ЗначениеР2"		, "П001010003003");
...
Процедура ПроверкаКС_2_10()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 80 НК РФ';
													|en = 'ст. 80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 410 - 430 или 470 - 473, то сумма акциза ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 410 - 430 или 470 - 473, то сумма акциза '") +
		НСтр("ru = 'к уплате в гр.4 подр.2.1 Раздела 2 = объем подакцизного товара в гр.2 подр.2.1 Раздела 2 по ';
			|en = 'к уплате в гр.4 подр.2.1 Раздела 2 = объем подакцизного товара в гр.2 подр.2.1 Раздела 2 по '") +
		НСтр("ru = 'соответствующему коду операции в гр.1 подр.2.1 Раздела 2 х Ставка акциза';
			|en = 'соответствующему коду операции в гр.1 подр.2.1 Раздела 2 х Ставка акциза'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1, код товара %2';
													|en = 'Страница %1, код товара %2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 * %3 Итог [%4]';
													|en = '%1 = %2 * %3 Итог [%4]'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00021М1 Цикл
			...
			Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р21Г040.Значение,
				Показатели.Р21Г020.Значение, Показатели.Р20С041.Значение, РасчетнаяСумма);
			ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_2_11()
	...
	Заголовки.Вставить("ОписаниеКС"			,
		...
		НСтр("ru = '= 440 - 460, то сумма акциза к уплате в гр.4 подр.2.1 Раздела 2 = коэффициент Т в стр.030 Раздела 2 ';
			|en = '= 440 - 460, то сумма акциза к уплате в гр.4 подр.2.1 Раздела 2 = коэффициент Т в стр.030 Раздела 2 '") +
		НСтр("ru = 'х исчисленная сумма акциза в гр.3 подр.2.1 Раздела 2 по соответствующему коду операции в гр.1 ';
			|en = 'х исчисленная сумма акциза в гр.3 подр.2.1 Раздела 2 по соответствующему коду операции в гр.1 '") +
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00021М1 Цикл
			...
			РасчетнаяСумма = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтотОбъект, 
				Показатели.Р02С030.Значение * Показатели.Р21Г030.Значение);
			Настройки.ЭтоОшибка = ДанныеКС.МесОтчета > 8 И НЕ СтрНайти("440,441,442,450,460", Показатели.Р20С040.Значение) = 0 
				И НЕ Показатели.Р21Г040.Значение = РасчетнаяСумма;
			Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р21Г040.Значение,
...
Процедура ПроверкаКС_2_12()
	...
	Заголовки.Вставить("ОписаниеКС"			,
		...
		НСтр("ru = '= 440 - 460, то сумма акциза к уплате в гр.4 подр.2.1 Раздела 2 = исчисленная сумма акциза ';
			|en = '= 440 - 460, то сумма акциза к уплате в гр.4 подр.2.1 Раздела 2 = исчисленная сумма акциза '") +
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00021М1 Цикл
			...
			Настройки.ЭтоОшибка = ДанныеКС.МесОтчета < 9 И НЕ СтрНайти("440,441,442,450,460", Показатели.Р20С040.Значение) = 0 
...
Процедура ПроверкаКС_2_13()
	...
	Настройки.Вставить("КодПоказателя"	, "Р22Г010");
	Настройки.Вставить("ИмяПоказателя"	, "П00022М100001_");
	Настройки.Вставить("СтрокиТЧ"		, "КолвоСтрокП00022М1");
...
Процедура ПроверкаКС_2_14()
	...
	Настройки.Вставить("ПоказательР1"	, "Р22Г020");
	Настройки.Вставить("ЗначениеР1"		, "П00022М100002_");
	Настройки.Вставить("ПоказательР2"	, "П01С040");
	Настройки.Вставить("ЗначениеР2"		, "П001010004003");
...
Процедура ПроверкаКС_2_15()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru = 'то исчисленная сумма акциза в гр.3 подр.2.2 Раздела 2 = 0';
			|en = 'то исчисленная сумма акциза в гр.3 подр.2.2 Раздела 2 = 0'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1, код товара %2';
													|en = 'Страница %1, код товара %2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = 0';
													|en = '%1 = 0'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00022М1 Цикл
			...
			Настройки.Расшифровка = СтрЗаменить(Настройки.ШаблонРасшифровки, "%1", Показатели.Р22Г030.Значение);
			ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_2_16()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru = 'коду операции в гр.1 подр.2.2 Раздела 2 х Ставка акциза';
			|en = 'коду операции в гр.1 подр.2.2 Раздела 2 х Ставка акциза'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1, код товара %2';
													|en = 'Страница %1, код товара %2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 * %3 Итог [%4]';
													|en = '%1 = %2 * %3 Итог [%4]'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00022М1 Цикл
			...
			РасчетнаяСумма = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтотОбъект, 
				Показатели.Р22Г020.Значение * Показатели.Р20С041.Значение);
			Настройки.ЭтоОшибка = НЕ СтрНайти("440,441,442", Показатели.Р20С040.Значение) = 0 
				И НЕ Показатели.Р22Г030.Значение = РасчетнаяСумма;
			Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р22Г030.Значение,
...
Процедура ПроверкаКС_2_17()
	...
	Настройки.Вставить("ПоказательР1"	, "Р22Г030");
	Настройки.Вставить("ЗначениеР1"		, "П00022М100003_");
	Настройки.Вставить("ПоказательР2"	, "П01С030");
	Настройки.Вставить("ЗначениеР2"		, "П001010003003");
...
Процедура ПроверкаКС_2_18()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru = 'к уплате в гр.4 подр.2.2 Раздела 2 = объем подакцизного товара в гр.2 подр.2.2 Раздела 2 по ';
			|en = 'к уплате в гр.4 подр.2.2 Раздела 2 = объем подакцизного товара в гр.2 подр.2.2 Раздела 2 по '") +
		НСтр("ru = 'соответствующему коду операции в гр.1 подр.2.2 Раздела 2 х Ставка акциза';
			|en = 'соответствующему коду операции в гр.1 подр.2.2 Раздела 2 х Ставка акциза'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1, код товара %2';
													|en = 'Страница %1, код товара %2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 * %3 Итог [%4]';
													|en = '%1 = %2 * %3 Итог [%4]'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00022М1 Цикл
			...
			Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р22Г040.Значение,
				Показатели.Р22Г020.Значение, Показатели.Р20С041.Значение, РасчетнаяСумма);
			ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_2_19()
	...
	Заголовки.Вставить("ОписаниеКС"			,
		...
		НСтр("ru = '= 440 - 460, то сумма акциза к уплате в гр.4 подр.2.2 Раздела 2 = коэффициент Т в стр.030 Раздела 2 ';
			|en = '= 440 - 460, то сумма акциза к уплате в гр.4 подр.2.2 Раздела 2 = коэффициент Т в стр.030 Раздела 2 '") +
		НСтр("ru = 'х исчисленная сумма акциза в гр.3 подр.2.2 Раздела 2 по соответствующему коду операции в гр.1 ';
			|en = 'х исчисленная сумма акциза в гр.3 подр.2.2 Раздела 2 по соответствующему коду операции в гр.1 '") +
		НСтр("ru = 'подр.2.2 Раздела 2';
			|en = 'подр.2.2 Раздела 2'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1, код товара %2';
													|en = 'Страница %1, код товара %2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 * %3 Итог [%4]';
													|en = '%1 = %2 * %3 Итог [%4]'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00022М1 Цикл
			...
			РасчетнаяСумма = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтотОбъект, 
				Показатели.Р02С030.Значение * Показатели.Р22Г030.Значение);
			Настройки.ЭтоОшибка = ДанныеКС.МесОтчета > 8 И НЕ СтрНайти("440,441,442,450,460", Показатели.Р20С040.Значение) = 0 
				И НЕ Показатели.Р22Г040.Значение = РасчетнаяСумма;
			Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р22Г040.Значение,
...
Процедура ПроверкаКС_2_20()
	...
	Заголовки.Вставить("ОписаниеКС"			,
		...
		НСтр("ru = '= 440 - 460, то сумма акциза к уплате в гр.4 подр.2.2 Раздела 2 = исчисленная сумма акциза ';
			|en = '= 440 - 460, то сумма акциза к уплате в гр.4 подр.2.2 Раздела 2 = исчисленная сумма акциза '") +
...
Процедура ПроверкаКС_2_21()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Код операции в гр.1 подр. 2.3 Раздела 2 должен соответствовать списку ';
			|en = 'Код операции в гр.1 подр. 2.3 Раздела 2 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1, строка %2, код операции %3';
													|en = 'Страница %1, строка %2, код операции %3'"));
	...
	Настройки.Вставить("КодПоказателя"	, "Р23Г010");
	Настройки.Вставить("ИмяПоказателя"	, "П00023М100001_");
	Настройки.Вставить("СтрокиТЧ"		, "КолвоСтрокП00023М1");
...
Процедура ПроверкаКС_2_22()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru = 'в гр.2 подр. 2.3 Раздела 2 = стр.040 Приложения 1 по соответствующим кодам в стр.010, 020 Приложения 1';
			|en = 'в гр.2 подр. 2.3 Раздела 2 = стр.040 Приложения 1 по соответствующим кодам в стр.010, 020 Приложения 1'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Код товара %1, код операции %2';
													|en = 'Код товара %1, код операции %2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2, когда код товара %3 = 450, 460, код операции %4';
													|en = '%1 = %2, когда код товара %3 = 450, 460, код операции %4'"));
	...
	Настройки.Вставить("ПоказательР1"	, "Р23Г020");
	Настройки.Вставить("ЗначениеР1"		, "П00023М100002_");
	Настройки.Вставить("ПоказательР2"	, "П01С040");
	Настройки.Вставить("ЗначениеР2"		, "П001010004003");
...
Процедура ПроверкаКС_2_23()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 80 НК РФ';
													|en = 'ст. 80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450 или 460, то сумма акциза к вычету ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450 или 460, то сумма акциза к вычету '") +
		НСтр("ru = 'в гр.3 подр. 2.3 Раздела 2 = стр.030 Приложения 1 по соответствующим кодам в стр.010, 020 Приложения 1';
			|en = 'в гр.3 подр. 2.3 Раздела 2 = стр.030 Приложения 1 по соответствующим кодам в стр.010, 020 Приложения 1'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Код товара %1, код операции %2';
													|en = 'Код товара %1, код операции %2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2, когда код товара %3 = 450, 460, код операции %4';
													|en = '%1 = %2, когда код товара %3 = 450, 460, код операции %4'"));
	...
	Настройки.Вставить("ПоказательР1"	, "Р23Г030");
	Настройки.Вставить("ЗначениеР1"		, "П00023М100003_");
	Настройки.Вставить("ПоказательР2"	, "П01С030");
	Настройки.Вставить("ЗначениеР2"		, "П001010003003");
...
Процедура ПроверкаКС_2_24()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Код показателя в гр.1 подр. 2.4 Раздела 2 должен иметь значение 40001 или 40002';
			|en = 'Код показателя в гр.1 подр. 2.4 Раздела 2 должен иметь значение 40001 или 40002'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1';
													|en = 'Страница %1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		Если НЕ Список = Неопределено Тогда
			...
			Настройки.ЭтоОшибка = Список.Получить(Показатели.Р24Г010.Значение) = Неопределено;
			Настройки.Расшифровка = СтрЗаменить(Настройки.ШаблонРасшифровки, "%1", Показатели.Р24Г010.ЗначениеСтр);
			ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_2_25()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru = 'или 20013, 20015 гр.1 подр.2.2 Раздела 2) - Сумма гр.3 подр.2.3 Раздела 2, если результат >= 0';
			|en = 'или 20013, 20015 гр.1 подр.2.2 Раздела 2) - Сумма гр.3 подр.2.3 Раздела 2, если результат >= 0'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1';
													|en = 'Страница %1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
...
&НаСервере
Процедура ПроверкаКС_2_26_код(Настройки)
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Настройки.ЭтоОшибка = Показатели.Р24Г010.Значение = "40001" 
		...
		Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р24Г020.Значение,
...
Процедура ПроверкаКС_2_27()
	...
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Сумма акциза в гр.2 подр.2.4 Раздела 2 по коду 40002 гр.1 подр.2.4 Раздела 2 должно быть больше 0';
			|en = 'Сумма акциза в гр.2 подр.2.4 Раздела 2 по коду 40002 гр.1 подр.2.4 Раздела 2 должно быть больше 0'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1';
													|en = 'Страница %1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 > 0';
													|en = '%1 > 0'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Настройки.ЭтоОшибка = Показатели.Р24Г010.Значение = "40002" И НЕ Показатели.Р24Г020.Значение > 0; 
		Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.Р24Г020.Значение);
		ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_2_28()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Код операции в гр.1 подр. 2.5 Раздела 2 должен соответствовать списку ';
			|en = 'Код операции в гр.1 подр. 2.5 Раздела 2 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1, строка %2, код операции %3';
													|en = 'Страница %1, строка %2, код операции %3'"));
	...
	Настройки.Вставить("КодПоказателя"	, "Р25Г010");
	Настройки.Вставить("ИмяПоказателя"	, "П00025М100001_");
	Настройки.Вставить("СтрокиТЧ"		, "КолвоСтрокП00025М1");
...
&НаСервере
Процедура ПроверкаКС_2_28_код(Настройки)
	
	Перем Показатели;
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить(Настройки.КодПоказателя, Настройки.ИмяПоказателя);
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	
	Список = ДанныеКС.СоответствиеСписков.Получить(Лев(Показатели[Настройки.КодПоказателя].ИмяПоказателя, 13));
	
	Если НЕ Список = Неопределено Тогда
		Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
			Для Счетчик = 1 По СтраницаРаздела[Настройки.СтрокиТЧ] Цикл
			
				ЗарегистрироватьФормулу(Настройки);
				ЗаполнитьИРасшифроватьПоказатели(Показатели, СтраницаРаздела, Счетчик);
				Настройки.ДопСведения = ПодставитьПараметрыВСтроку(Настройки.ШаблонДопСведений, СтраницаРаздела.Страница, Счетчик, 
					Показатели[Настройки.КодПоказателя].ЗначениеСтр);
				
				Настройки.ЭтоОшибка = Список.Получить(Показатели[Настройки.КодПоказателя].Значение) = Неопределено;
...
Процедура ПроверкаКС_2_29()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 80 НК РФ';
													|en = 'ст. 80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450 или 460, то объем подакцизного товара в гр';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450 или 460, то объем подакцизного товара в гр'") +
	...
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Код товара %1, код операции %2, период %3';
													|en = 'Код товара %1, код операции %2, период %3'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2, когда код товара %3 = 450, 460, код операции %4';
													|en = '%1 = %2, когда код товара %3 = 450, 460, код операции %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочное значение объема подакцизного товара';
														|en = 'Ошибочное значение объема подакцизного товара'"));
	...
	Настройки.Вставить("ПоказательР1"	, "Р25Г020");
	Настройки.Вставить("ЗначениеР1"		, "П00025М100002_");
	Настройки.Вставить("ПоказательР2"	, "П01С040");
	Настройки.Вставить("ЗначениеР2"		, "П001010004003");
...
Процедура ПроверкаКС_2_30()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 80 НК РФ';
													|en = 'ст. 80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450 или 460, то сумма акциза в гр.3 ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450 или 460, то сумма акциза в гр.3 '") +
	...
	Настройки.Вставить("ПоказательР1"	, "Р25Г030");
	Настройки.Вставить("ЗначениеР1"		, "П00025М100003_");
	Настройки.Вставить("ПоказательР2"	, "П01С030");
	Настройки.Вставить("ЗначениеР2"		, "П001010003003");
...
&НаСервере
Процедура ПроверкаКС_2_30_код(Настройки)
	...
	ИменаПоказателей.Вставить("Р20С040", "П000020004003");
	ИменаПоказателей.Вставить(Настройки.ПоказательР1, Настройки.ЗначениеР1);
	ИменаПоказателей.Вставить(Настройки.ПоказательР2, Настройки.ЗначениеР2);
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	Округление = Сред(Настройки.ПоказательР1, 6, 1) = "3";
	Показатели[Настройки.ПоказательР1].Округление = Округление;
	Показатели[Настройки.ПоказательР2].Округление = Округление;
	
	КодРаздела 	= Сред(Настройки.ПоказательР1, 2, 2);
	КодКС 		= Сред(Настройки.НомерКС, 3);
	...
	Пока ВыборкаР1.Следующий() Цикл
		...
		ЗарегистрироватьФормулу(Настройки);
		Показатели[Настройки.ПоказательР1].Итог = 0;
		Показатели[Настройки.ПоказательР2].Итог = 0;
		...
		Если ВыборкаР2.НайтиСледующий(ВыборкаР1.Ключ, "Ключ") Тогда
			Выборка = ВыборкаР2.Выбрать();
			Пока Выборка.Следующий() Цикл
				ЗаполнитьИРасшифроватьПоказатель(Показатели[Настройки.ПоказательР2], Выборка);
			КонецЦикла;
		КонецЕсли; 
			
		Настройки.ЭтоОшибка		= НЕ СтрНайти("450,460", Показатели.Р20С040.Значение) = 0 
			И НЕ Показатели[Настройки.ПоказательР1].Итог = Показатели[Настройки.ПоказательР2].Итог;
		Настройки.Расшифровка	= ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
			Показатели[Настройки.ПоказательР1].Итог, Показатели[Настройки.ПоказательР2].Итог, ЗначСтроки(ВыборкаР1.Р20С040), 
...
Процедура ПроверкаКС_2_31()
	...
	Настройки.Вставить("ПоказательР1", "Р25Г020");
	Настройки.Вставить("ПоказательР2", "П22П074");
	ПроверкаКС_2_32_код(Настройки);
...
Процедура ПроверкаКС_2_32()
	...
	Настройки.Вставить("ПоказательР1", "Р25Г030");
	Настройки.Вставить("ПоказательР2", "П22П075");
	ПроверкаКС_2_32_код(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_2_32_код(Настройки)
	...
	ИменаПоказателей.Вставить("Р20С040", "П000020004003");
	ИменаПоказателей.Вставить(Настройки.ПоказательР1, "П00025М10000" + ?(Настройки.НомерКС = "2.31", "2_", "3_"));
	ИменаПоказателей.Вставить(Настройки.ПоказательР2, "П00102М20700" + ?(Настройки.НомерКС = "2.31", "4_", "5_"));
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	Показатели[Настройки.ПоказательР1].Округление = Настройки.НомерКС = "2.32";
	Показатели[Настройки.ПоказательР2].Округление = Настройки.НомерКС = "2.32";
	...
	Пока ВыборкаР1.Следующий() Цикл
		...
		Настройки.ДопСведения = ПодставитьПараметрыВСтроку(Настройки.ШаблонДопСведений, ВыборкаР1.Р20С040);
		ЗарегистрироватьФормулу(Настройки);
		Показатели[Настройки.ПоказательР1].Итог = 0;
		Показатели[Настройки.ПоказательР2].Итог = 0;
		...
		Выборка = ВыборкаР1.Выбрать();
		Пока Выборка.Следующий() Цикл
			ЗаполнитьИРасшифроватьПоказатель(Показатели[Настройки.ПоказательР1], Выборка);
		КонецЦикла;
		...
		Настройки.ЭтоОшибка		= НЕ Показатели[Настройки.ПоказательР1].Итог = Показатели[Настройки.ПоказательР2].Итог;
		Настройки.Расшифровка	= ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
			Показатели[Настройки.ПоказательР1].Итог, Показатели[Настройки.ПоказательР2].Итог);
		ДополнитьСтруктуруОшибок(Настройки);
		ВыборкаР2.Сбросить();
	КонецЦикла;
...
Процедура ПроверкаКС_2_33_доп()
	...
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1, строка %2, месяц %3';
													|en = 'Страница %1, строка %2, месяц %3'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочное значение месяца налогового периода';
														|en = 'Ошибочное значение месяца налогового периода'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	Настройки.Вставить("КодПоказателя"	, "Р25Г040");
	Настройки.Вставить("ИмяПоказателя"	, "П00025М100004_");
	Настройки.Вставить("СтрокиТЧ"		, "КолвоСтрокП00025М1");
...
Процедура ПроверкаКС_2_34_доп()
	...
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1, строка %2, год %3';
													|en = 'Страница %1, строка %2, год %3'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочное значение года налогового периода';
														|en = 'Ошибочное значение года налогового периода'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	Настройки.Вставить("КодПоказателя"	, "Р25Г050");
	Настройки.Вставить("ИмяПоказателя"	, "П00025М100005_");
	Настройки.Вставить("СтрокиТЧ"		, "КолвоСтрокП00025М1");
...
Процедура ПроверкаКС_3_02()
	...
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочное значение кода вида операции';
														|en = 'Ошибочное значение кода вида операции'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	Если НЕ Список = Неопределено Тогда
		Для каждого СтраницаРаздела Из ДанныеКС.Приложение1 Цикл
			...
			Настройки.ЭтоОшибка = Список.Получить(Показатели.П01С020.Значение) = Неопределено;
			Настройки.Расшифровка = СтрЗаменить(Настройки.ШаблонРасшифровки, "%1", Показатели.П01С020.ЗначениеСтр);
			ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_3_03()
	...
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 > 0, %2 > 0';
													|en = '%1 > 0, %2 > 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Не заполнен налоговый период';
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение1 Цикл
		...
		Настройки.ЭтоОшибка = ЗначениеЗаполнено(Показатели.П01С020.Значение) 
		...
		Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.П01С025.ЗначениеСтр, 
...
Процедура ПроверкаКС_3_04()
	...
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = (%2 х %3) / 1000 Итог [%4]';
													|en = '%1 = (%2 х %3) / 1000 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочное значение объема реализованных табачных изделий';
														|en = 'Ошибочное значение объема реализованных табачных изделий'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение1 Цикл
		Для каждого СтраницаПодраздела Из СтраницаРаздела.Приложение11 Цикл
			...
			Настройки.ДопСведения = ПодставитьПараметрыВСтроку(Настройки.ШаблонДопСведений, СтраницаПодраздела.Страница);
			
			РасчетнаяСумма = Показатели.П11С060.Значение * Показатели.П11С070.Значение / 1000;
			Настройки.ЭтоОшибка	= НЕ Показатели.П11С080.Значение = РасчетнаяСумма;
			Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
	...
	Если НЕ ДанныеКС.СтавкиСигарет = Неопределено Тогда
		Для каждого СтраницаРаздела Из ДанныеКС.Приложение1 Цикл
			Для каждого СтраницаПодраздела Из СтраницаРаздела.Приложение11 Цикл
				...
				РасчетнаяСумма = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтотОбъект, 
					Показатели.П11С080.Значение * ДанныеКС.СтавкиСигарет.СтавкаТвердая);
				Настройки.ЭтоОшибка	= НЕ Показатели.П11С090.Значение = РасчетнаяСумма;
				Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
...
Процедура ПроверкаКС_3_06()
	...
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 х %3 Итог [%4]';
													|en = '%1 = %2 х %3 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочное значение стоимости реализованных табачных изделий';
														|en = 'Ошибочное значение стоимости реализованных табачных изделий'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение1 Цикл
		Для каждого СтраницаПодраздела Из СтраницаРаздела.Приложение11 Цикл
			...
			РасчетнаяСумма = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтотОбъект, 
				Показатели.П11С060.Значение * Показатели.П11С100.Значение);
			Настройки.ЭтоОшибка	= НЕ Показатели.П11С110.Значение = РасчетнаяСумма;
			Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
	...
	Если НЕ ДанныеКС.СтавкиСигарет = Неопределено Тогда
		Для каждого СтраницаРаздела Из ДанныеКС.Приложение1 Цикл
			Для каждого СтраницаПодраздела Из СтраницаРаздела.Приложение11 Цикл
				...
				РасчетнаяСумма = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтотОбъект, 
					Показатели.П11С110.Значение * ДанныеКС.СтавкиСигарет.СтавкаАдвалорная / 100);
				Настройки.ЭтоОшибка	= НЕ Показатели.П11С120.Значение = РасчетнаяСумма;
				Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
...
Процедура ПроверкаКС_3_08()
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение1 Цикл
		Для каждого СтраницаПодраздела Из СтраницаРаздела.Приложение11 Цикл
			...
			Настройки.ЭтоОшибка	= НЕ Показатели.П11С130.Значение = РасчетнаяСумма;
			Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
...
Процедура ПроверкаКС_3_09()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма акциза, расчитанная исходя из минимальной ставки в стр.140 Приложения 1 = ';
			|en = 'Сумма акциза, расчитанная исходя из минимальной ставки в стр.140 Приложения 1 = '") +
	...
	Если НЕ ДанныеКС.СтавкиСигарет = Неопределено Тогда
		Для каждого СтраницаРаздела Из ДанныеКС.Приложение1 Цикл
			Для каждого СтраницаПодраздела Из СтраницаРаздела.Приложение11 Цикл
				...
				РасчетнаяСумма = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтотОбъект, 
					Показатели.П11С080.Значение * ДанныеКС.СтавкиСигарет.СтавкаМинимальная);
				Настройки.ЭтоОшибка	= НЕ Показатели.П11С140.Значение = РасчетнаяСумма;
				Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
...
Процедура ПроверкаКС_3_10()
	...
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1';
													|en = 'Страница %1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2, когда %2 > %3';
													|en = '%1 = %2, когда %2 > %3'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма акциза';
														|en = 'Ошибочная сумма акциза'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение1 Цикл
		Для каждого СтраницаПодраздела Из СтраницаРаздела.Приложение11 Цикл
			...
			Настройки.ЭтоОшибка	= НЕ Показатели.П11С150.Значение = РасчетнаяСумма;
			Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
...
Процедура ПроверкаКС_3_11()
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение1 Цикл
		Для каждого СтраницаПодраздела Из СтраницаРаздела.Приложение11 Цикл
			...
			Настройки.ЭтоОшибка	= НЕ Показатели.П11С151.Значение = РасчетнаяСумма;
			Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
...
Процедура ПроверкаКС_3_12_доп()
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение1 Цикл
		...
		Настройки.ЭтоОшибка	= НЕ Показатели.П01С030.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
...
Процедура ПроверкаКС_3_13_доп()
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение1 Цикл
		...
		Настройки.ЭтоОшибка	= НЕ Показатели.П01С040.Значение = Показатели.П11С080.Итог;
		Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
...
Процедура ПроверкаКС_3_14_доп()
	...
	Настройки.Вставить("КодПоказателя"	, "П01С025");
	Настройки.Вставить("ИмяПоказателя"	, "П001010002503");
	
	ПроверкаКС_3_15_код(Настройки);
...
Процедура ПроверкаКС_3_15_доп()
	...
	Настройки.Вставить("КодПоказателя"	, "П01С025");
	Настройки.Вставить("ИмяПоказателя"	, "П001010002504");
...
&НаСервере
Процедура ПроверкаКС_3_15_код(Настройки)
	...
	Список = ДанныеКС.СоответствиеСписков.Получить(Показатели[Настройки.КодПоказателя].ИмяПоказателя);
...
Процедура ПроверкаКС_4_01()
	...
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочное значение признака документа';
														|en = 'Ошибочное значение признака документа'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
Процедура ПроверкаКС_4_02()
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение2 Цикл
		...
		Настройки.ЭтоОшибка = Показатели.П02С020.Значение > Показатели.П02С030.Значение;
		Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.П02С020.ЗначениеСтр, 
...
Процедура ПроверкаКС_4_03()
	...
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная дата начала срока действия банковской гарантии';
														|en = 'Ошибочная дата начала срока действия банковской гарантии'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение2 Цикл
		...
		Настройки.ЭтоОшибка = Показатели.П02С020.Значение > Показатели.П02С030.Значение;
		Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.П02С030.ЗначениеСтр, 
			Показатели.П02С020.ЗначениеСтр);
		ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_4_04()
	...
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 > %2 и %1 > %3';
													|en = '%1 > %2 и %1 > %3'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная дата окончания срока действия банковской гарантии';
														|en = 'Ошибочная дата окончания срока действия банковской гарантии'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение2 Цикл
		...
		Настройки.ЭтоОшибка		= СтраницаРаздела.РазделЗаполнен И НЕ (Показатели.П02С040.Значение > Показатели.П02С020.Значение 
			И Показатели.П02С040.Значение > Показатели.П02С030.Значение);
		Настройки.Расшифровка	= ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.П02С040.ЗначениеСтр, 
...
Процедура ПроверкаКС_4_05()
	...
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма обязательств по банковской гарантии';
														|en = 'Ошибочная сумма обязательств по банковской гарантии'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение2 Цикл
		...
		Настройки.ЭтоОшибка = Показатели.П02С060.Значение > Показатели.П02С050.Значение;
		Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.П02С050.Значение, 
...
Процедура ПроверкаКС_4_06()
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение2 Цикл
		...
		Настройки.ЭтоОшибка = Показатели.П02С060.Значение > Показатели.П02С050.Значение;
		Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.П02С060.Значение, 
			Показатели.П02С050.Значение);
		ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_4_07()
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение2 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.П02С060.Значение = Показатели.П21Г030.Итог;
		Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.П02С060.Значение, 
...
Процедура ПроверкаКС_4_08()
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение2 Цикл
		...
		Настройки.ЭтоОшибка = Показатели.П02С060.Значение < РасчетнаяСумма;
		Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, Показатели.П02С060.Значение, 
...
Процедура ПроверкаКС_4_09()
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение2 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.П02С065.Значение = РасчетнаяСумма;
	...
	Если НЕ Список = Неопределено Тогда
		Для каждого СтраницаРаздела Из ДанныеКС.Приложение2 Цикл
			Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00102М1 Цикл
				...
				Настройки.ЭтоОшибка = Список.Получить(Показатели.П21Г010.Значение) = Неопределено;
				Настройки.Расшифровка = СтрЗаменить(Настройки.ШаблонРасшифровки, "%1", Показатели.П21Г010.ЗначениеСтр);
				ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_4_11а()
	...
	Настройки.Вставить("КодПоказателя"	, "П22П073");
	Настройки.Вставить("ИмяПоказателя"	, "П00102М207003_");
	
	ПроверкаКС_4_15_код(Настройки);
...
Процедура ПроверкаКС_4_11б()
	...
	Настройки.Вставить("КодПоказателя"	, "П22П083");
	Настройки.Вставить("ИмяПоказателя"	, "П00102М208003_");
...
Процедура ПроверкаКС_4_12()
	...
	Настройки.Вставить("КодПоказателя"	, "П22П075");
	Настройки.Вставить("ИмяПоказателя"	, "П00102М207005_");
...
Процедура ПроверкаКС_4_13()
	...
	Настройки.Вставить("КодПоказателя"	, "П22П085");
	Настройки.Вставить("ИмяПоказателя"	, "П00102М208005_");
...
Процедура ПроверкаКС_4_13_код(Настройки)
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение2 Цикл
		...
		ЗарегистрироватьФормулу(Настройки);
		Настройки.ДопСведения = ПодставитьПараметрыВСтроку(Настройки.ШаблонДопСведений, СтраницаРаздела.Страница);
		Показатели[Настройки.КодПоказателя].Итог = 0;
		
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00102М2 Цикл
			ЗаполнитьИРасшифроватьПоказатель(Показатели[Настройки.КодПоказателя], СтраницаРаздела, Счетчик);
		КонецЦикла;
		
		ЗаполнитьИРасшифроватьПоказатель(Показатели.П02С060, СтраницаРаздела);
		Настройки.ЭтоОшибка = Показатели[Настройки.КодПоказателя].Итог > Показатели.П02С060.Значение;
		Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
			Показатели[Настройки.КодПоказателя].Итог, Показатели.П02С060.Значение);
		ДополнитьСтруктуруОшибок(Настройки);
...
Процедура ПроверкаКС_4_14_доп()
	...
	Настройки.Вставить("КодПоказателя"	, "П22П076");
	Настройки.Вставить("ИмяПоказателя"	, "П00102М207006_");
...
Процедура ПроверкаКС_4_15_доп()
	...
	Настройки.Вставить("КодПоказателя"	, "П22П077");
	Настройки.Вставить("ИмяПоказателя"	, "П00102М207007_");
...
&НаСервере
Процедура ПроверкаКС_4_15_код(Настройки)
