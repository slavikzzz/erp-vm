...
Процедура ИнициализироватьМногострочныеЧасти()
	...
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
		СтруктураРеквизитовФормы.мИдГруппыР24М1, Новый Структура(
		"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп",
		ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
	...
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
		СтруктураРеквизитовФормы.мИдГруппыП3М1, Новый Структура(
		"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп",
		ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли СтрНачинаетсяС(Область.Имя, "П00023М100005") ИЛИ СтрНачинаетсяС(Область.Имя, "П00025М100005")
		ИЛИ СтрНачинаетсяС(Область.Имя, "П001010002504") ИЛИ СтрНачинаетсяС(Область.Имя, "П00102М207007") Тогда
	...
	ИначеЕсли СтрНачинаетсяС(Область.Имя, "П00023М100004") ИЛИ СтрНачинаетсяС(Область.Имя, "П00025М100004")
		ИЛИ СтрНачинаетсяС(Область.Имя, "П001010002503") ИЛИ СтрНачинаетсяС(Область.Имя, "П00102М207006") Тогда
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если СтрНачинаетсяС(ИмяПоказателя, "П00001М102003") Тогда
	...
	Если ИмяПоказателя = "П001010015003" ИЛИ ИмяПоказателя = "П001010015103" Тогда
		Если ТабличныйДокумент.Области.Найти("П001010015003").Значение <> 0
			...
			ОбщегоНазначенияКлиент.СообщитьПользователю(СтрШаблон(НСтр(
				"ru = 'Не допускается одновременное заполнение строк 150 и 151. Значение в строке %1 очищено.';
				|en = 'Не допускается одновременное заполнение строк 150 и 151. Значение в строке %1 очищено.'"), Парам));
		КонецЕсли;
	КонецЕсли;
...
Функция НалоговаяСтавкаВидаПодакцизногоТовара(КодВидаПодакцизногоТовара, ДатаДействия)
	...
	Если ГодДействия = 2025 Тогда
		...
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "410", 4657,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "412", 4657,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "413", 4657,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "414", 4657,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "415", 4657,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "420", 4657,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "430",  315,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "440", 4485,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "441", 4485,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "442", 4485,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "471",   44,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "472", 9807,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "474",    2.2, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "475",  925,   СтавкаВидаПТ);
		
	ИначеЕсли ГодДействия = 2026 Тогда
		
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "410",  4843,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "412",  4843,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "413",  4843,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "414",  4843,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "415",  4843,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "420",  4843,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "430",   328,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "440",  4664,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "441",  4664,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "442",  4664,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "471",    46,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "472", 10199,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "474",     2.3, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "475",   962,   СтавкаВидаПТ);
		
	ИначеЕсли ГодДействия = 2027 Тогда
		
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "410",  5037,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "412",  5037,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "413",  5037,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "414",  5037,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "415",  5037,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "420",  5037,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "430",   341,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "440",  4851,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "441",  4851,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "442",  4851,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "471",    48,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "472", 10607,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "474",     2.4, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "475",  1000,   СтавкаВидаПТ);
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяРаздела)
	...
	ИначеЕсли ИмяРаздела = "Раздел21" Тогда
		...
		КодыВидаПТ_ДоступностьСтавкиВидаПТ
			= СтрРазделить("410,412,413,414,415,420,430,440,441,442,471,472,474,475", ",", Ложь);
		...
		КодыВидаПТ_НедоступностьР21Гр3Р22Гр3
			= СтрРазделить("410,412,413,414,415,420,430,471,472,474,475", ",", Ложь);
...
Процедура ДобавитьСтраницу(Команда)
	...
	Если ИмяРаздела = "Приложение1" ИЛИ ИмяРаздела = "Приложение2" ИЛИ ИмяРаздела = "Приложение3" Тогда
	...
	Если ИмяРаздела = "Раздел21" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				КодыОперацийДляСуммирования_Возмещение = СтрРазделить("50001,50002,50006,50007", ",", Ложь);
				...
				РегламентированнаяОтчетностьКлиентСервер.УстановитьИндекс(Индекс, ИндексСтр);
				Обл = Форма.ТабличныйДокумент.Области.Найти("П00025М100003_" + ИндексСтр);
				Пока Обл <> Неопределено Цикл
					КодОперации = СокрЛП(Форма.ТабличныйДокумент.Области.Найти("П00025М100001_" + ИндексСтр).Значение);
					Если КодыОперацийДляСуммирования_Возмещение.Найти(КодОперации) <> Неопределено Тогда
						СуммаВозмещение = СуммаВозмещение
							+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Обл.Значение);
					КонецЕсли;
					РегламентированнаяОтчетностьКлиентСервер.УвеличитьИндекс(Индекс, ИндексСтр);
					Обл = Форма.ТабличныйДокумент.Области.Найти("П00025М100003_" + ИндексСтр);
				КонецЦикла;
				...
				РегламентированнаяОтчетностьКлиентСервер.УстановитьИндекс(Индекс, ИндексСтр);
				Обл = Форма.ТабличныйДокумент.Области.Найти("П00024М100001_" + ИндексСтр);
				Пока Обл <> Неопределено Цикл
					ТекКодПокР24Г1 = СокрЛП(Обл.Значение);
					Если ТекКодПокР24Г1 = "40001" Тогда
						Форма.ТабличныйДокумент.Области["П00024М100002_" + ИндексСтр].Значение = ?(Сумма > 0, Сумма, 0);
					ИначеЕсли ТекКодПокР24Г1 = "40002" Тогда
						Форма.ТабличныйДокумент.Области["П00024М100002_" + ИндексСтр].Значение = ?(Сумма < 0, - Сумма, 0);
					ИначеЕсли ТекКодПокР24Г1 = "40003" Тогда
						Форма.ТабличныйДокумент.Области["П00024М100002_" + ИндексСтр].Значение = ?(СуммаВозмещение > 0,
							СуммаВозмещение, 0);
					КонецЕсли;
					РегламентированнаяОтчетностьКлиентСервер.УвеличитьИндекс(Индекс, ИндексСтр);
					Обл = Форма.ТабличныйДокумент.Области.Найти("П00024М100001_" + ИндексСтр);
...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
	...
	Если ИмяРаздела = "Раздел21" Тогда
		...
		АктивнаяВеткаР21_25 = Неопределено;
		
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			
			АктивнаяВеткаР21_25 = ДеревоДанных.Строки[
		...
		Для каждого ВеткаР2 Из ДеревоДанных.Строки Цикл
			...
			Для каждого ВеткаР21_25 Из ВеткаР2.Строки[0].Строки Цикл
				...
				ДеревоМнЧР21М1 = ВеткаР21_25.ДанныеМногострочныхЧастей[ИмяГруппыМнЧР21М1];
				ДеревоМнЧР22М1 = ВеткаР21_25.ДанныеМногострочныхЧастей[ИмяГруппыМнЧР22М1];
				ДеревоМнЧР23М1 = ВеткаР21_25.ДанныеМногострочныхЧастей[ИмяГруппыМнЧР23М1];
				ДеревоМнЧР24М1 = ВеткаР21_25.ДанныеМногострочныхЧастей[ИмяГруппыМнЧР24М1];
				ДеревоМнЧР25М1 = ВеткаР21_25.ДанныеМногострочныхЧастей[ИмяГруппыМнЧР25М1];
				
				Если ВеткаР21_25 = АктивнаяВеткаР21_25 Тогда
					Для каждого Пок Из ВеткаР21_25.Данные Цикл
						ВеткаР21_25.Данные.Вставить(Пок.Ключ, Форма.ТабличныйДокумент.Области[Пок.Ключ].Значение);
					КонецЦикла;
				...
				КодВидаПТ = СокрЛП(ВеткаР21_25.Данные["П000020004003"]);
				
				СтавкаВидаПТ = ВеткаР21_25.Данные["П0000200040А3"];
				...
				// Расчет подразделе 2.4.
				СуммыАкцизаДляР24 = СуммыАкцизаДляР24(Форма, ВеткаР21_25);
				
				Сумма           = СуммыАкцизаДляР24["Сумма"];
				СуммаВозмещение = СуммыАкцизаДляР24["СуммаВозмещение"];
				...
				//
				//Для каждого СтрокаМнЧ Из ДеревоМнЧР25М1.Строки Цикл
				//	КодОперации = СокрЛП(СтрокаМнЧ.Данные["П00025М100001"]);
				//	Если КодыОперацийДляСуммирования_Возмещение.Найти(КодОперации) <> Неопределено Тогда
				//		СуммаВозмещение = СуммаВозмещение + РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
				//		Форма, СтрокаМнЧ.Данные["П00025М100003"]);
				//	КонецЕсли;
				//КонецЦикла;
				
				Для каждого СтрокаМнЧ Из ДеревоМнЧР24М1.Строки Цикл
					ТекКодПокР24Г1 = СокрЛП(СтрокаМнЧ.Данные["П00024М100001"]);
					Если ТекКодПокР24Г1 = "40001" Тогда
						СтрокаМнЧ.Данные.Вставить("П00024М100002", ?(Сумма > 0, Сумма, 0));
					ИначеЕсли ТекКодПокР24Г1 = "40002" Тогда
						СтрокаМнЧ.Данные.Вставить("П00024М100002", ?(Сумма < 0, - Сумма, 0));
					ИначеЕсли ТекКодПокР24Г1 = "40003" Тогда
						СтрокаМнЧ.Данные.Вставить("П00024М100002", ?(СуммаВозмещение > 0, СуммаВозмещение, 0));
					КонецЕсли;
				КонецЦикла;
...
&НаКлиентеНаСервереБезКонтекста
Функция СуммыАкцизаДляР24(Форма, ВеткаР21_25)
	
	ДеревоМнЧР21М1 = ВеткаР21_25.ДанныеМногострочныхЧастей[Форма.СтруктураРеквизитовФормы.мИдГруппыР21М1];
	ДеревоМнЧР22М1 = ВеткаР21_25.ДанныеМногострочныхЧастей[Форма.СтруктураРеквизитовФормы.мИдГруппыР22М1];
	ДеревоМнЧР23М1 = ВеткаР21_25.ДанныеМногострочныхЧастей[Форма.СтруктураРеквизитовФормы.мИдГруппыР23М1];
	ДеревоМнЧР25М1 = ВеткаР21_25.ДанныеМногострочныхЧастей[Форма.СтруктураРеквизитовФормы.мИдГруппыР25М1];
	...
	Возврат Новый Структура("Сумма,СуммаВозмещение", Сумма, СуммаВозмещение);
...
Процедура СформироватьРаздел1()
	...
	СоответствиеКБККодуВидаПТ.Вставить("_474", "18210302510011000110");
	СоответствиеКБККодуВидаПТ.Вставить("_475", "18210302520011000110");
	...
	Для каждого ВеткаРаздел2 Из ДеревоДанныхРаздел2.Строки Цикл
		...
		Для каждого ВеткаРаздел21 Из ВеткаРаздел2.Строки[0].Строки Цикл
			...
			ДеревоМнЧР24М1 = ВеткаРаздел21.ДанныеМногострочныхЧастей[СтруктураРеквизитовФормы.мИдГруппыР24М1];
			
			Для Каждого СтрокаР24М1 Из ДеревоМнЧР24М1.Строки Цикл
				
				КодПок = СокрЛП(СтрокаР24М1.Данные["П00024М100001"]);
				Сумма = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
				ЭтотОбъект, СтрокаР24М1.Данные["П00024М100002"]);
				
				НоваяСтрокаТЗ = ТЗ.Добавить();
				НоваяСтрокаТЗ.КБК = КБК;
				НоваяСтрокаТЗ.СуммаКУплате = ?(КодПок = "40001", Сумма, 0);
				НоваяСтрокаТЗ.СуммаКУменьш = ?(КодПок = "40002" ИЛИ КодПок = "40003", Сумма, 0);
...
Процедура СформироватьСтраницуПодразделов21_25ПоКодуВидаПодакцизногоТовара(КодВидаПодакцизногоТовара)
	...
	ТЗ_23.Колонки.Добавить("П00023М100004");
	ТЗ_23.Колонки.Добавить("П00023М100005");
	
	ТЗ_24 = Новый ТаблицаЗначений;
	ТЗ_24.Колонки.Добавить("П00024М100001");
	ТЗ_24.Колонки.Добавить("П00024М100002");
	...
	Для каждого ВеткаП1 Из ДеревоРаздела.Строки Цикл
		...
		Если КодВидаПТ = КодВидаПодакцизногоТовара
			...
			ИначеЕсли СтрНачинаетсяС(КодОперации, "3") Тогда
				...
				ЭтотОбъект, ВеткаП1.Данные["П001010003003"]);
				НовСтрТЗ_23["П00023М100004"] = ВеткаП1.Данные["П001010002503"];
				НовСтрТЗ_23["П00023М100005"] = ВеткаП1.Данные["П001010002504"];
	...
	ТЗ_23.Свернуть("П00023М100001,П00023М100004,П00023М100005", "П00023М100002,П00023М100003");
	ТЗ_23.Сортировать("П00023М100001 Возр, П00023М100005 Возр, П00023М100004 Возр");
	...
	// Установка кодов показателя в подразделе 2.4 для последующего авторасчета сумм акциза.
	СуммыАкцизаДляР24 = СуммыАкцизаДляР24(ЭтотОбъект, СтраницаПодразделов21_25);
	НовСтрТЗ_24 = ТЗ_24.Добавить();
	НовСтрТЗ_24["П00024М100001"] = ?(СуммыАкцизаДляР24["Сумма"] >= 0, "40001", "40002");
	НовСтрТЗ_24["П00024М100002"] = 0;
	Если СуммыАкцизаДляР24["СуммаВозмещение"] > 0 Тогда
		НовСтрТЗ_24 = ТЗ_24.Добавить();
		НовСтрТЗ_24["П00024М100001"] = "40003";
		НовСтрТЗ_24["П00024М100002"] = 0;
	КонецЕсли;
	
	СформироватьМногострочнуюЧастьОдногоИзПодразделов21_25(СтраницаПодразделов21_25, ТЗ_24);
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	Структ.Вставить("П001010008003");
	Структ.Вставить("П001010011003");
	Структ.Вставить("П001010013003");
	Структ.Вставить("П001010015003");
	Структ.Вставить("П001010015103");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Приложение11", Структ);
	
	// Приложение2.
	Структ = Новый Структура;
	Структ.Вставить("П001020006003");
	Структ.Вставить("П001020006503");
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	ВозмКодыПокР24 = ВозможныеЗначенияИзСпискаВыбораПоказателя("П00024М100001");
	...
	Если ЗаполненРаздел(ДеревоРаздела, "Раздел2") Тогда
		...
		Для каждого Страница21 Из СтраницаРаздела.Строки[0].Строки Цикл
			...
			Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
				...
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Раздел 2 -> Страница " + НомСтраницы21 + ": в строке " + НомСтроки
					+ " подраздела 2.3 не задан код налогового периода, в котором осуществлена операция",
					"Раздел21", "П00023М100004_" + НомСтроки, НомСтраницы21);
					СтатусПроверки = Ложь;
				КонецЕсли;
				...
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Раздел 2 -> Страница " + НомСтраницы21 + ": в строке " + НомСтроки
					+ " подраздела 2.3 не задан год налогового периода, в котором осуществлена операция",
					"Раздел21", "П00023М100005_" + НомСтроки, НомСтраницы21);
					СтатусПроверки = Ложь;
				КонецЕсли;
			КонецЦикла;
			
			ИмяГруппы = СтруктураРеквизитовФормы.мИдГруппыР24М1;
			ДанныеМнЧ = Страница21.ДанныеМногострочныхЧастей[ИмяГруппы];
			Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
				ИндСтрокиМнЧ = ДанныеМнЧ.Строки.Индекс(СтрокаМнЧ);
				НомСтроки = Формат(ИндСтрокиМнЧ + 1, "ЧГ=");
				...
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Раздел 2 -> Страница " + НомСтраницы21 + ": в строке " + НомСтроки
					+ " подраздела 2.4 не задан код показателя",
					"Раздел21", "П00024М100001_" + НомСтроки, НомСтраницы21);
					СтатусПроверки = Ложь;
				ИначеЕсли ВозмКодыПокР24.МассивЗначений.Найти(ЗначПок) = Неопределено Тогда
					СообщитьВТС("Раздел 2 -> Страница " + НомСтраницы21 + ": в строке " + НомСтроки
					+ " подраздела 2.4 код показателя должен принимать одно из значений: " + ВозмКодыПокР24.СтрокаЗначений,
					"Раздел21", "П00024М100001_" + НомСтроки, НомСтраницы21);
					СтатусПроверки = Ложь;
				КонецЕсли;
			КонецЦикла;
	...
	Если ЗаполненРаздел(ДеревоРаздела, "Приложение2") Тогда
		...
		Для каждого СтраницаРаздела Из ДеревоРаздела.Строки Цикл
			...
			ИначеЕсли ВозмКодыПризнДок.МассивЗначений.Найти(ЗначПок) = Неопределено Тогда
				...
				+ ВозмКодыПризнДок.СтрокаЗначений, "Приложение2", "П001020000103", НомСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
	...
	// Приложение 3.
	//
	ВозмКодыПризнСвед = ВозможныеЗначенияИзСпискаВыбораПоказателя("П001030000103");
	...
	Если ЗаполненРаздел(ДеревоРаздела, "Приложение3") Тогда
		...
		Для каждого СтраницаРаздела Из ДеревоРаздела.Строки Цикл
			...
			ЗначПок = СокрЛП(СтраницаРаздела.Данные["П001030000103"]);
			...
			Иначе
				...
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Приложение 3 -> Страница " + НомСтраницы
					+ ": признак сведений должен быть задан, если на Титульном листе номер корректировки неравен 0",
					"Приложение3", "П001030000103", НомСтраницы);
					СтатусПроверки = Ложь;
				ИначеЕсли ВозмКодыПризнСвед.МассивЗначений.Найти(ЗначПок) = Неопределено Тогда
					СообщитьВТС("Приложение 3 -> Страница " + НомСтраницы + ": признак сведений должен принимать одно из значений: "
					+ ВозмКодыПризнСвед.СтрокаЗначений, "Приложение3", "П001030000103", НомСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
				
			КонецЕсли;
			
			ИмяГруппы = СтруктураРеквизитовФормы.мИдГруппыП3М1;
			ДанныеМнЧ = СтраницаРаздела.ДанныеМногострочныхЧастей[ИмяГруппы];
			Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
				ИндСтрокиМнЧ = ДанныеМнЧ.Строки.Индекс(СтрокаМнЧ);
				НомСтроки = Формат(ИндСтрокиМнЧ + 1, "ЧГ=");
				
				ЗначПок = СокрЛП(СтрокаМнЧ.Данные["П00103М101003"]);
				Если НЕ ЗначениеЗаполнено(ЗначПок) Тогда
					СообщитьВТС("Приложение 3 -> Страница " + НомСтраницы + ": в строке " + НомСтроки
					+ " не задан идентификатор файла обмена универсального передаточного документа, подписанного первой стороной",
					"Приложение3", "П00103М101003_" + НомСтроки, НомСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
			КонецЦикла;
	...
	ИначеЕсли СтруктураРеквизитовФормы.мСохраненныйДок.ДатаОкончания >= '20250701' Тогда
		
		СообщитьВТС("Приложение 3 должно быть заполнено, если на Титульном листе номер корректировки равен 0",
		"Приложение3", "П001030000103", "1");
		СтатусПроверки = Ложь;
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель, ПараметрыВыгрузки)
	...
	ДеревоПриложение3 = ДанныеМногоуровневыхРазделов["Приложение3"];
	...
	Для каждого СтрокаМнЧР1М1 Из ДанныеМнЧР1М1.Строки Цикл
		...
		Для каждого Эл Из ЭкзСумНалПУКод.Строки Цикл
			Если Эл.Код = "НалПУ" Тогда
				ВывестиПоказательВXML(Эл, Макс(0, СтрокаМнЧР1М1.Данные["П00001М103003"] - СтрокаМнЧР1М1.Данные["П00001М104003"]));
			ИначеЕсли Эл.Код = "НалПУВозм" Тогда
				ВывестиПоказательВXML(Эл, Макс(0, СтрокаМнЧР1М1.Данные["П00001М104003"] - СтрокаМнЧР1М1.Данные["П00001М103003"]));
			Иначе
	...
	Для каждого Страница21 Из ДеревоРаздел21.Строки Цикл
		...
		КонецЦикла;
		// Подраздел 2.4.
		АкцизПУ = ПолучитьПодчиненныйЭлемент(ЭкзРасчАкцПТ, "АкцизПУ");
		ДанныеМнЧР24М1 = Страница21.ДанныеМногострочныхЧастей[СтруктураРеквизитовФормы.мИдГруппыР24М1];
		Для каждого СтрокаМнЧР24М1 Из ДанныеМнЧР24М1.Строки Цикл
			ЗаполнитьДаннымиУзел(СтрокаМнЧР24М1.Данные, СкопироватьУзел(ЭкзРасчАкцПТ, АкцизПУ));
		КонецЦикла;
		//АкцизПУ = ПолучитьПодчиненныйЭлемент(ЭкзРасчАкцПТ, "АкцизПУ");
		//ДанныеМнЧР24М1 = Страница21.ДанныеМногострочныхЧастей[СтруктураРеквизитовФормы.мИдГруппыР24М1];
		//Для каждого СтрокаМнЧР24М1 Из ДанныеМнЧР24М1.Строки Цикл
		//	ЗаполнитьДаннымиУзел(СтрокаМнЧР24М1.Данные, СкопироватьУзел(
		//		ЭкзРасчАкцПТ, АкцизПУ, ЭкзРасчАкцПТ.Строки.Количество() - 1));
		//КонецЦикла;
		// Подраздел 2.5.
	...
	// Приложение 3.
	//
	СведРеалПТ = ПолучитьПодчиненныйЭлемент(УзелРодитель, "СведРеалПТ");
	Для каждого Страница Из ДеревоПриложение3.Строки Цикл
		ЭкзСведРеалПТ = СкопироватьУзел(УзелРодитель, СведРеалПТ, УзелРодитель.Строки.Количество() - 1);
		Для каждого Эл Из ЭкзСведРеалПТ.Строки Цикл
			Если Эл.Код = "ПрСвед" Тогда
				ВывестиПоказательВXML(Эл, Страница.Данные[Эл.Ключ]);
			КонецЕсли;
		КонецЦикла;
		ИдФайлДок = ПолучитьПодчиненныйЭлемент(ЭкзСведРеалПТ, "ИдФайлДок");
		ДанныеМнЧП3М1 = Страница.ДанныеМногострочныхЧастей[СтруктураРеквизитовФормы.мИдГруппыП3М1];
		Для каждого СтрокаМнЧП3М1 Из ДанныеМнЧП3М1.Строки Цикл
			ЭкзИдФайлДок = СкопироватьУзел(ЭкзСведРеалПТ, ИдФайлДок, ЭкзСведРеалПТ.Строки.Количество() - 1);
			ВывестиПоказательВXML(ЭкзИдФайлДок, СтрокаМнЧП3М1.Данные[ЭкзИдФайлДок.Ключ]);
		КонецЦикла;
	КонецЦикла;
...
Процедура УстановитьФорматВыводаНаСервере(ИмяРаздела)
	...
	ИначеЕсли ИмяРаздела = "Раздел21" Тогда
		...
		ИменаМногострочныхПоказателей.Добавить("П00024М100002");
...
Процедура ВывестиНаПечатьДанныеМногоуровневогоРаздела(СтруктураПараметров, ОбщиеРеквизитыРазделов, СтрПоля)
	...
	ИначеЕсли ИмяТекРаздела = "Раздел2" Тогда
		...
		ИмяГруппыМнЧР24М1 = СтруктураРеквизитовФормы.мИдГруппыР24М1;
		...
		Для каждого Ветка21 Из Ветка2.Строки[0].Строки Цикл
			...
			ДанныеМнЧР24М1 = Ветка21.ДанныеМногострочныхЧастей[ИмяГруппыМнЧР24М1];
			КолСтрокМнЧР24М1 = ДанныеМнЧР24М1.Строки.Количество();
			ДробКолМнЧР24М1 = КолСтрокМнЧР24М1 / СтрокМнЧР24М1НаЛисте;
			ЦелКолМнЧР24М1  = Цел(КолСтрокМнЧР24М1 / СтрокМнЧР24М1НаЛисте);
			КолЛистовМнЧР24М1 = ?(ДробКолМнЧР24М1 = ЦелКолМнЧР24М1, ЦелКолМнЧР24М1, ЦелКолМнЧР24М1 + 1);
			...
			КолЛистовРаздела2 = Макс(КолЛистовМнЧР23М1, КолЛистовМнЧР24М1, КолЛистовМнЧР25М1);
			...
			ИмяП00023М100004 = "П00023М100004";
			ИмяП00023М100005 = "П00023М100005";
			
			МассивДанныхМнЧР24М1ДляПечати = Новый Массив;
			ИмяП00024М100001 = "П00024М100001";
			ИмяП00024М100002 = "П00024М100002";
			...
			Для НомЛиста = 1 По КолЛистовРаздела2 Цикл
				...
				Для ИндСтроки = 1 По СтрокМнЧР23М1НаЛисте Цикл
					...
					НовИмяП00023М100004 = ИмяП00023М100004 + _ИндСтроки;
					НовИмяП00023М100005 = ИмяП00023М100005 + _ИндСтроки;
					...
					ДанныеМнЧДляПечати.Вставить(НовИмяП00023М100004, "");
					ДанныеМнЧДляПечати.Вставить(НовИмяП00023М100005, "");
					...
					Если КолСтрокМнЧР23М1 >= ИндСПриращением Тогда
						...
						ДанныеМнЧДляПечати.Вставить(НовИмяП00023М100004,
						ДанныеМнЧР23М1.Строки[ИндСПриращением - 1].Данные[ИмяП00023М100004]);
						ДанныеМнЧДляПечати.Вставить(НовИмяП00023М100005,
						ДанныеМнЧР23М1.Строки[ИндСПриращением - 1].Данные[ИмяП00023М100005]);
					КонецЕсли;
				КонецЦикла;
				МассивДанныхМнЧР23М1ДляПечати.Добавить(ДанныеМнЧДляПечати);
				
				ПриращениеКНомеру = (НомЛиста - 1) * СтрокМнЧР24М1НаЛисте;
				ДанныеМнЧДляПечати = Новый Структура;
				Для ИндСтроки = 1 По СтрокМнЧР24М1НаЛисте Цикл
					_ИндСтроки = СтрокаСИндексомПоказателя(ИндСтроки);
					ИндСПриращением = ИндСтроки + ПриращениеКНомеру;
					
					НовИмяП00024М100001 = ИмяП00024М100001 + _ИндСтроки;
					НовИмяП00024М100002 = ИмяП00024М100002 + _ИндСтроки;
					
					ДанныеМнЧДляПечати.Вставить(НовИмяП00024М100001, "");
					ДанныеМнЧДляПечати.Вставить(НовИмяП00024М100002, 0);
					
					Если КолСтрокМнЧР24М1 >= ИндСПриращением Тогда
						ДанныеМнЧДляПечати.Вставить(НовИмяП00024М100001,
						ДанныеМнЧР24М1.Строки[ИндСПриращением - 1].Данные[ИмяП00024М100001]);
						ДанныеМнЧДляПечати.Вставить(НовИмяП00024М100002,
						РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтотОбъект,
						ДанныеМнЧР24М1.Строки[ИндСПриращением - 1].Данные[ИмяП00024М100002]));
					КонецЕсли;
				КонецЦикла;
				МассивДанныхМнЧР24М1ДляПечати.Добавить(ДанныеМнЧДляПечати);
			...
			Для НомЛиста = 1 По КолЛистовРаздела2 Цикл
				...
				КонецЦикла;
				Для Ном = 1 По СтрокМнЧР24М1НаЛисте - 1 Цикл
					ИмяОбластиПреемника = "ДобавлениеСтроки" + ИмяГруппыМнЧР24М1 + СтрокаСИндексомПоказателя(Ном);
					ВставитьДопСтроку(ИмяГруппыМнЧР24М1, ИмяОбластиПреемника);
				КонецЦикла;
				...
				Для каждого Пок Из ДанныеМнЧДляПечати Цикл
					...
					КонецЕсли;
				КонецЦикла;
				ДанныеМнЧДляПечати = МассивДанныхМнЧР24М1ДляПечати[НомЛиста - 1];
				Для каждого Пок Из ДанныеМнЧДляПечати Цикл
					Обл = ТабличныйДокумент.Области.Найти(Пок.Ключ);
					Если Обл <> Неопределено Тогда
						Обл.Значение = Пок.Значение;
	...
	ИначеЕсли ИмяТекРаздела = "Приложение1" Тогда
		...
		Для каждого Ветка1 Из ДеревоДанныхРаздела.Строки Цикл
			...
			Для каждого Ветка11 Из Ветка1.Строки[0].Строки Цикл
				...
				УстановитьФорматВыводаНаСервере(ИмяТекРаздела);
				УстановитьФорматВыводаНаСервере("Приложение11");
	...
	ИначеЕсли ИмяТекРаздела = "Приложение3" Тогда
		...
		ИмяГруппыМнЧП3М1 = СтруктураРеквизитовФормы.мИдГруппыП3М1;
		
		СтрокМнЧ1НаЛисте = 5;
		
		Для каждого Ветка Из ДеревоДанныхРаздела.Строки Цикл
			
			ДанныеМнЧ1 = Ветка.ДанныеМногострочныхЧастей[ИмяГруппыМнЧП3М1];
			...
			// Подготовка многострочных данных для заполнения листов.
			МассивДанныхМнЧ1ДляПечати = Новый Массив;
			ИмяП00103М101003 = "П00103М101003";
			...
			Для НомЛиста = 1 По КолЛистовРаздела1 Цикл
				...
				Для ИндСтрокиМнЧ = 1 По СтрокМнЧ1НаЛисте Цикл
					...
					НовИмяП00103М101003 = ИмяП00103М101003 + _ИндСтрокиМнЧ;
					
					ДанныеМнЧ1ДляПечати.Вставить(НовИмяП00103М101003, "");
					
					Если КолСтрокМнЧ1 >= ИндСПриращением Тогда
						ДанныеМнЧ1ДляПечати.Вставить(НовИмяП00103М101003,
						ДанныеМнЧ1.Строки[ИндСПриращением - 1].Данные[ИмяП00103М101003]);
					КонецЕсли;
				КонецЦикла;
				МассивДанныхМнЧ1ДляПечати.Добавить(ДанныеМнЧ1ДляПечати);
			...
			Для НомЛиста = 1 По КолЛистовРаздела1 Цикл
				...
				Для Ном = 1 По СтрокМнЧ1НаЛисте - 1 Цикл
					ИмяОбластиПреемника = "ДобавлениеСтроки" + ИмяГруппыМнЧП3М1 + СтрокаСИндексомПоказателя(Ном);
					ВставитьДопСтроку(ИмяГруппыМнЧП3М1, ИмяОбластиПреемника);
				КонецЦикла;
...
Процедура СформироватьСлужебныеДанные()
	...
	ЦелочисленныеРазделы.Добавить("Р25"); 
	...
	СоответствиеКБККодуВидаПТ = Новый Соответствие;
	СоответствиеКБККодуВидаПТ.Вставить(""	, "");
	СоответствиеКБККодуВидаПТ.Вставить("410", "18210302030011000110");
	СоответствиеКБККодуВидаПТ.Вставить("412", "18210302030011000110");
	СоответствиеКБККодуВидаПТ.Вставить("413", "18210302030011000110");
	СоответствиеКБККодуВидаПТ.Вставить("414", "18210302030011000110");
	СоответствиеКБККодуВидаПТ.Вставить("415", "18210302030011000110");
	СоответствиеКБККодуВидаПТ.Вставить("420", "18210302030011000110");
	СоответствиеКБККодуВидаПТ.Вставить("430", "18210302030011000110");
	СоответствиеКБККодуВидаПТ.Вставить("440", "18210302030011000110");
	СоответствиеКБККодуВидаПТ.Вставить("441", "18210302030011000110");
	СоответствиеКБККодуВидаПТ.Вставить("442", "18210302030011000110");
	СоответствиеКБККодуВидаПТ.Вставить("450", "18210302030011000110");
	СоответствиеКБККодуВидаПТ.Вставить("460", "18210302030011000110");
	СоответствиеКБККодуВидаПТ.Вставить("471", "18210302370011000110");
	СоответствиеКБККодуВидаПТ.Вставить("472", "18210302380011000110");
	СоответствиеКБККодуВидаПТ.Вставить("474", "18210302510011000110");
	СоответствиеКБККодуВидаПТ.Вставить("475", "18210302520011000110");
	
	ДанныеКС.Вставить("СоответствиеКБК", СоответствиеКБККодуВидаПТ);
	...
	Если ДанныеКС.ГодОтчета >= 2028 Тогда
		
		СтавкиСигарет = Неопределено;
		
	ИначеЕсли ДанныеКС.ГодОтчета = 2027 Тогда
		
		СтавкиСигарет.Вставить("СтавкаТвердая"		, 3186);
		СтавкиСигарет.Вставить("СтавкаАдвалорная"	, 18);
		СтавкиСигарет.Вставить("СтавкаМинимальная"	, 4326);
		
	ИначеЕсли ДанныеКС.ГодОтчета = 2026 Тогда
		
		СтавкиСигарет.Вставить("СтавкаТвердая"		, 3063);
		СтавкиСигарет.Вставить("СтавкаАдвалорная"	, 18);
		СтавкиСигарет.Вставить("СтавкаМинимальная"	, 4160);
		
	ИначеЕсли ДанныеКС.ГодОтчета = 2025 Тогда
		
		СтавкиСигарет.Вставить("СтавкаТвердая"		, 2945);
		СтавкиСигарет.Вставить("СтавкаАдвалорная"	, 18);
		СтавкиСигарет.Вставить("СтавкаМинимальная"	, 4000);
...
Процедура СформироватьДанныеОтчета()
	...
	МассивКодовПТ_Р2 = Новый Массив;
	
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		ЗаполнитьПоказатели(Показатели, СтраницаРаздела);
		СформироватьИЗаписатьКлюч(Показатели, МассивКодовПТ_Р2);
	КонецЦикла;
	
	ДанныеКС.Вставить("МассивКодовПТ_Р2", МассивКодовПТ_Р2); 
	...
	МассивКлючей_Р21 = Новый Массив;
	
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		ЗаполнитьПоказатель(Показатели.Р20С040, СтраницаРаздела);
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00021М1 Цикл
			ЗаполнитьПоказатель(Показатели.Р21Г010, СтраницаРаздела, Счетчик);
			СформироватьИЗаписатьКлюч(Показатели, МассивКлючей_Р21);
		КонецЦикла;
	КонецЦикла;
	
	ДанныеКС.Вставить("МассивКлючей_Р21", МассивКлючей_Р21); 
	...
	МассивКлючей_Р22 = Новый Массив;
	
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		ЗаполнитьПоказатель(Показатели.Р20С040, СтраницаРаздела);
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00022М1 Цикл
			ЗаполнитьПоказатель(Показатели.Р22Г010, СтраницаРаздела, Счетчик);
			СформироватьИЗаписатьКлюч(Показатели, МассивКлючей_Р22);
		КонецЦикла;
	КонецЦикла;
	
	ДанныеКС.Вставить("МассивКлючей_Р22", МассивКлючей_Р22); 
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р20С040"	, "П000020004003");
	ИменаПоказателей.Вставить("Р23Г010"	, "П00023М100001_");
	ИменаПоказателей.Вставить("Р23Г040"	, "П00023М100004_");
	ИменаПоказателей.Вставить("Р23Г050"	, "П00023М100005_");
	
	Показатели = СформироватьПоказатели(ИменаПоказателей); 
	
	МассивКлючей_Р23 = Новый Массив;
	
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		ЗаполнитьПоказатель(Показатели.Р20С040, СтраницаРаздела);
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00023М1 Цикл
			ЗаполнитьПоказатель(Показатели.Р23Г010, СтраницаРаздела, Счетчик);
			ЗаполнитьПоказатель(Показатели.Р23Г040, СтраницаРаздела, Счетчик);
			ЗаполнитьПоказатель(Показатели.Р23Г050, СтраницаРаздела, Счетчик);
			СформироватьИЗаписатьКлюч(Показатели, МассивКлючей_Р23);
		КонецЦикла;
	КонецЦикла;
	
	ДанныеКС.Вставить("МассивКлючей_Р23", МассивКлючей_Р23); 
	...
	МассивКлючей_Р25 = Новый Массив;
	
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		ЗаполнитьПоказатель(Показатели.Р20С040, СтраницаРаздела);
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00025М1 Цикл
			ЗаполнитьПоказатель(Показатели.Р25Г010, СтраницаРаздела, Счетчик);
			ЗаполнитьПоказатель(Показатели.Р25Г040, СтраницаРаздела, Счетчик);
			ЗаполнитьПоказатель(Показатели.Р25Г050, СтраницаРаздела, Счетчик);
			СформироватьИЗаписатьКлюч(Показатели, МассивКлючей_Р25);
		КонецЦикла;
	КонецЦикла;
	
	ДанныеКС.Вставить("МассивКлючей_Р25", МассивКлючей_Р25); 
...
&НаСервере
Процедура СформироватьИЗаписатьКлюч(Показатели, МассивКлючей)
	
	Ключ = "";
	
	Для каждого Элемент Из Показатели Цикл
		Ключ = Ключ + Элемент.Значение.Значение;
	КонецЦикла;
...
Процедура ПроверкаКС_9_01_к()
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму акциза в стр.030 Раздела 1 >= 0';
													|en = 'Укажите сумму акциза в стр.030 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@,
														|Письмо ФНС России от 11.12.2024 № СД-4-3/14070@';
	...
	НастройкиКС.Вставить("ИмяПоказателя"	, "П00001М103003_");
	ПроверкаКС_9_01_к_код();

КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_9_01_к_код()

	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р01С020"	, "П00001М102003_");
	ИменаПоказателей.Вставить("Р01С030"	, НастройкиКС.ИмяПоказателя);
	Показатели = СформироватьПоказатели(ИменаПоказателей);
...
Процедура ПроверкаКС_1_01()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Значение %1 не заполнено';
													|en = 'Значение %1 не заполнено'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Не заполнен код ОКТМО';
													|en = 'Не заполнен код ОКТМО'"));
	Заголовки.Вставить("Рекомендации"		, "Заполните значение кода ОКТМО в стр.010 Раздела 1");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@';
													|en = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@'"));
...
Процедура ПроверкаКС_1_03()
	...
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@';
													|en = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru = 'Отключено. Дублирует критичное КС 9.01';
													|en = 'Отключено. Дублирует критичное КС 9.01'"));
	ПодготовитьНастройки(Заголовки); 
	...
	//Отключено. Дублирует критичное КС 9.01
	Возврат;
...
Процедура ПроверкаКС_1_04()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма акциза в стр.030 Раздела 1 = гр.2 подр.2.4 Раздела 2 по коду 40001 в гр.1 подр.2.4 Раздела ';
			|en = 'Сумма акциза в стр.030 Раздела 1 = гр.2 подр.2.4 Раздела 2 по коду 40001 в гр.1 подр.2.4 Раздела '") + 
		НСтр("ru = '2 - гр.2 подр.2.4 Раздела 2 по кодам 40002, 40003 в гр.1 подр.2.4 Раздела 2 в разрезе КБК';
			|en = '2 - гр.2 подр.2.4 Раздела 2 по кодам 40002, 40003 в гр.1 подр.2.4 Раздела 2 в разрезе КБК'"));   
	...
	НастройкиКС.Вставить("ИмяПоказателя"	, "П00001М103003_");
	НастройкиКС.Вставить("Реверс"			, Ложь);
...
Процедура ПроверкаКС_1_04_код()
	...
	ИменаПоказателей.Вставить("Р24Г003", "П00024М100002_");
	Показатели = СформироватьПоказатели(ИменаПоказателей);
	...
	Для каждого КБК_Р1 Из ДанныеКС.КБК_Р1 Цикл
		...
		Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл 
			ЗаполнитьПоказатель(Показатели.Р20С040, СтраницаРаздела);
			КБК_Р2 = ДанныеКС.СоответствиеКБК.Получить(Показатели.Р20С040.Значение);
			
			Если НЕ КБК_Р2 = КБК_Р1 Тогда 
				Продолжить;
			КонецЕсли;
			...
			Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00024М1 Цикл 
				...
				Если ЗначениеЗаполнено(Показатели.Р24Г001.Значение) 
					И НЕ СтрНайти("40001", Показатели.Р24Г001.Значение) = 0 Тогда
				...
				Если ЗначениеЗаполнено(Показатели.Р24Г001.Значение) 
					И НЕ СтрНайти("40002,40003", Показатели.Р24Г001.Значение) = 0 Тогда
					РасшифроватьПоказатель(Показатели.Р20С040);
					РасшифроватьПоказатель(Показатели.Р24Г001);
					ЗаполнитьИРасшифроватьПоказатель(Показатели.Р24Г003, СтраницаРаздела, Счетчик);
				КонецЕсли;
			КонецЦикла;
		КонецЦикла;
		
		Если НастройкиКС.Реверс Тогда 
			РасчетнаяСумма = Макс(0, Показатели.Р24Г003.Итог - Показатели.Р24Г002.Итог);
		Иначе
			РасчетнаяСумма = Макс(0, Показатели.Р24Г002.Итог - Показатели.Р24Г003.Итог);
		КонецЕсли;
		
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р01С030.Итог = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
			Показатели.Р01С030.Итог, РасчетнаяСумма, ЗначСтроки(КБК_Р1));
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_1_05()
	...
	НастройкиКС.Вставить("ИмяПоказателя"	, "П00001М104003_");
	ПроверкаКС_9_01_к_код();
...
Процедура ПроверкаКС_1_06()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма акциза в стр.040 Раздела 1 = гр.2 подр.2.4 Раздела 2 по кодам 40002, 40003 в гр.1 подр.2.4 Раздела ';
			|en = 'Сумма акциза в стр.040 Раздела 1 = гр.2 подр.2.4 Раздела 2 по кодам 40002, 40003 в гр.1 подр.2.4 Раздела '") + 
		НСтр("ru = '2 - гр.2 подр.2.4 Раздела 2 по коду 40001 в гр.1 подр.2.4 Раздела 2 в разрезе КБК';
			|en = '2 - гр.2 подр.2.4 Раздела 2 по коду 40001 в гр.1 подр.2.4 Раздела 2 в разрезе КБК'"));   
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2, КБК %3';
													|en = '%1 = %2, КБК %3'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	НастройкиКС.Вставить("ИмяПоказателя"	, "П00001М104003_");
	НастройкиКС.Вставить("Реверс"			, Истина);
...
Процедура ПроверкаКС_1_07_доп()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Значение КБК в стр.020 Раздела 1 должно соответствовать списку ';
			|en = 'Значение КБК в стр.020 Раздела 1 должно соответствовать списку '") +
...
Процедура ПроверкаКС_1_08()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма акциза, подлежащая уплате в бюджет в стр.030 Раздела 1 >= 0';
													|en = 'Сумма акциза, подлежащая уплате в бюджет в стр.030 Раздела 1 >= 0'"));
...
Процедура ПроверкаКС_1_09()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма акциза, исчисленная к уменьшению в стр.040 Раздела 1 >= 0';
													|en = 'Сумма акциза, исчисленная к уменьшению в стр.040 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Группа строк %1 Раздела 1");
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru = 'Отключено. Дублирует КС 1.05';
													|en = 'Отключено. Дублирует КС 1.05'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_2_01()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'За налоговый период сентябрь - декабрь: значение коэффициента Т в стр.030 Раздела 2 ';
			|en = 'За налоговый период сентябрь - декабрь: значение коэффициента Т в стр.030 Раздела 2 '") +
		НСтр("ru = 'должно быть равно 1, если значение по стр.010 Раздела 2 <= значения по стр.020 Раздела 2';
			|en = 'должно быть равно 1, если значение по стр.010 Раздела 2 <= значения по стр.020 Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 1, если %2 <= %3';
													|en = '%1 = 1, если %2 <= %3'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение коэффициента Т';
													|en = 'Возможно ошибочное значение коэффициента Т'"));
	...
	НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, 
		ДанныеКС.Раздел2.НомерСтраницы);
...
Процедура ПроверкаКС_2_02()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'должно быть равно 1 + 0,3 х (стр.010 Раздела 2 - стр.020 Раздела 2) / стр.010 Раздела 2, ';
			|en = 'должно быть равно 1 + 0,3 х (стр.010 Раздела 2 - стр.020 Раздела 2) / стр.010 Раздела 2, '") +
		НСтр("ru = 'если стр.010 Раздела 2 > стр.020 Раздела 2';
			|en = 'если стр.010 Раздела 2 > стр.020 Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (1 + 0,3 х (%2 - %3) / %2), если %2 > %3';
													|en = '%1 = %4 (1 + 0,3 х (%2 - %3) / %2), если %2 > %3'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение коэффициента Т';
													|en = 'Возможно ошибочное значение коэффициента Т'"));
...
Процедура ПроверкаКС_2_03()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'должно быть равно 1 для впервые ставших налогоплательщиками (стр.020 Раздела 2 = 0)';
			|en = 'должно быть равно 1 для впервые ставших налогоплательщиками (стр.020 Раздела 2 = 0)'"));
...
Процедура ПроверкаКС_2_04()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Код вида подакцизного товара в стр.040 Раздела 2 должен соответствовать списку ';
			|en = 'Код вида подакцизного товара в стр.040 Раздела 2 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение кода вида подакцизного товара';
													|en = 'Возможно ошибочное значение кода вида подакцизного товара'"));
...
Процедура ПроверкаКС_2_05()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Код операции в гр.1 подр.2.1 Раздела 2 должен соответствовать списку ';
			|en = 'Код операции в гр.1 подр.2.1 Раздела 2 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение кода операции';
													|en = 'Возможно ошибочное значение кода операции'"));
...
Процедура ПроверкаКС_2_06()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450, 460, то объем подакцизного товара ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450, 460, то объем подакцизного товара '") +
		НСтр("ru = 'в гр.2 подр.2.1 Раздела 2 = стр.040 Приложения 1 по соответствующим кодам в стр.010, 020 Приложения 1';
			|en = 'в гр.2 подр.2.1 Раздела 2 = стр.040 Приложения 1 по соответствующим кодам в стр.010, 020 Приложения 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение объема подакцизного товара';
													|en = 'Возможно ошибочное значение объема подакцизного товара'"));
	...
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Код товара %1, код операции %2';
													|en = 'Код товара %1, код операции %2'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("Раздел2х"			, "21");
	НастройкиКС.Вставить("Показатель1"		, "П00021М100002_");
	НастройкиКС.Вставить("НомерСтроки1"		, "040");
...
&НаСервере
Процедура ПроверкаКС_2_06_код() 
	
	Перем КодТовара, КодОперации, КодМесяца, КодГода;
	
	Если ДанныеКС.МассивКодовПТ_Р2.Найти("450") = Неопределено 
		И ДанныеКС.МассивКодовПТ_Р2.Найти("460") = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	Если НЕ НастройкиКС.Свойство("Период") Тогда
		НастройкиКС.Вставить("Период", Ложь);
	КонецЕсли;
	...
	Если НЕ НастройкиКС.Свойство("ОграничениеПериода") Тогда
		НастройкиКС.Вставить("ОграничениеПериода", Ложь);
	КонецЕсли;
	
	СтрокаМесяцев = "01,02,03,04,05,06,07,08";
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р02С001"	, "П000020004003");
	ИменаПоказателей.Вставить("Р21Г001"	, "П000" + НастройкиКС.Раздел2х + "М100001_");
	ИменаПоказателей.Вставить("Р21Г002"	, НастройкиКС.Показатель1);
	ИменаПоказателей.Вставить("П01С001"	, "П001010001003");
	ИменаПоказателей.Вставить("П01С002"	, "П001010002003");
	ИменаПоказателей.Вставить("П01С003"	, "П0010100" + НастройкиКС.НомерСтроки1 + "03");

	Если НастройкиКС.Период Тогда
		ИменаПоказателей.Вставить("Р21Г004"	, "П000" + НастройкиКС.Раздел2х + "М100004_");
		ИменаПоказателей.Вставить("Р21Г005"	, "П000" + НастройкиКС.Раздел2х + "М100005_");
		ИменаПоказателей.Вставить("П01С004"	, "П001010002503");
		ИменаПоказателей.Вставить("П01С005"	, "П001010002504");
	КонецЕсли;
	
	Показатели = СформироватьПоказатели(ИменаПоказателей, НастройкиКС.МассивЗамен);
	Показатели.П01С003.Округление = НастройкиКС.НомерСтроки1 = "030";
	Показатели.Р21Г002.Округление = НастройкиКС.НомерСтроки1 = "030";
	
	Для каждого КлючР2х Из ДанныеКС["МассивКлючей_Р" + НастройкиКС.Раздел2х] Цикл
		
		ЗарегистрироватьПроверку();
		Показатели.Р21Г002.Итог = 0;
		Показатели.П01С003.Итог = 0;
		УсловиеВыполнено = Ложь;
		
		Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
			ЗаполнитьПоказатель(Показатели.Р02С001, СтраницаРаздела);
			Для Счетчик = 1 По СтраницаРаздела["КолвоСтрокП000" + НастройкиКС.Раздел2х + "М1"] Цикл
				ЗаполнитьПоказатель(Показатели.Р21Г001, СтраницаРаздела, Счетчик);
				ТекущийКлюч = "" + Показатели.Р02С001.Значение  + Показатели.Р21Г001.Значение;
				ПериодНайден = Истина;
				  
				Если НастройкиКС.Период Тогда
					ЗаполнитьПоказатель(Показатели.Р21Г004, СтраницаРаздела, Счетчик);
					ЗаполнитьПоказатель(Показатели.Р21Г005, СтраницаРаздела, Счетчик);
					ТекущийКлюч = ТекущийКлюч + Показатели.Р21Г004.Значение + Показатели.Р21Г005.Значение;
					Если НастройкиКС.ОграничениеПериода И СтрНайти(СтрокаМесяцев, Показатели.Р21Г004.Значение) = 0 Тогда
						ПериодНайден = Ложь;
					КонецЕсли;
				КонецЕсли;
				  
				Если ТекущийКлюч = КлючР2х И ПериодНайден Тогда
					ЗаполнитьИРасшифроватьПоказатель(Показатели.Р21Г002, СтраницаРаздела, Счетчик);
					КодТовара 	= Показатели.Р02С001.ЗначениеСтр;
					КодОперации = Показатели.Р21Г001.ЗначениеСтр;
					Если НастройкиКС.Период Тогда
						КодМесяца 	= Показатели.Р21Г004.ЗначениеСтр;
						КодГода 	= Показатели.Р21Г005.ЗначениеСтр;
					КонецЕсли;
		...
		Для каждого СтраницаРаздела Из ДанныеКС.Приложение1 Цикл 
			...
			ЗаполнитьПоказатель(Показатели.П01С002, СтраницаРаздела);
			ТекущийКлюч = "" + Показатели.П01С001.Значение + Показатели.П01С002.Значение; 
			ПериодНайден = Истина;
			
			Если НастройкиКС.Период Тогда
				ЗаполнитьПоказатель(Показатели.П01С004, СтраницаРаздела);
				ЗаполнитьПоказатель(Показатели.П01С005, СтраницаРаздела);
				ТекущийКлюч = ТекущийКлюч + Показатели.П01С004.Значение + Показатели.П01С005.Значение;  
				Если НастройкиКС.ОграничениеПериода И СтрНайти(СтрокаМесяцев, Показатели.П01С004.Значение) = 0 Тогда
					ПериодНайден = Ложь;
				КонецЕсли;
			КонецЕсли;
			  
			Если ТекущийКлюч = КлючР2х И ПериодНайден Тогда
				ЗаполнитьИРасшифроватьПоказатель(Показатели.П01С003, СтраницаРаздела); 
			КонецЕсли;
		КонецЦикла;
			
		НастройкиКС.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р21Г002.Итог = Показатели.П01С003.Итог; 
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р21Г002.Итог, Показатели.П01С003.Итог); 
		НастройкиКС.ДопСведения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НастройкиКС.ШаблонДопСведений, 
			КодТовара, КодОперации, ?(НастройкиКС.Период, КодМесяца, ""), ?(НастройкиКС.Период, КодГода, ""));
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_07()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '2.07';
													|en = '2.07'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 410, 412 - 415, 420, 430, 471, 472, ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 410, 412 - 415, 420, 430, 471, 472, '") +
		НСтр("ru = '474, 475, то исчисленная сумма акциза в гр.3 подр.2.1 Раздела 2 = 0';
			|en = '474, 475, то исчисленная сумма акциза в гр.3 подр.2.1 Раздела 2 = 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 0';
													|en = '%1 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@';
													|en = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 2, код товара %2';
													|en = 'Страница %1 Раздела 2, код товара %2'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("Показатель1"		, "П00021М100003_");
	НастройкиКС.Вставить("МассивЗамен");
...
Процедура ПроверкаКС_2_07_код()
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р02С001", "П000020004003");
	ИменаПоказателей.Вставить("Р21Г001", НастройкиКС.Показатель1);
	Показатели = СформироватьПоказатели(ИменаПоказателей, НастройкиКС.МассивЗамен);
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00021М1 Цикл
			...
			ЗаполнитьИРасшифроватьПоказатель(Показатели.Р21Г001, СтраницаРаздела, Счетчик);
			
			УсловиеВыполнено = НЕ СтрНайти("410,412,413,414,415,420,430,471,472,474,475", Показатели.Р02С001.Значение) = 0;
			НастройкиКС.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р21Г001.Значение = 0;
			НастройкиКС.Детализация = СтрЗаменить(НастройкиКС.ШаблонДетализации, "%1", Показатели.Р21Г001.Значение);
			НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, 
				СтраницаРаздела.НомерСтраницы, Показатели.Р02С001.ЗначениеСтр);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_08()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 440 - 442, то исчисленная сумма акциза ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 440 - 442, то исчисленная сумма акциза '") +
		НСтр("ru = 'в гр.3 подр.2.1 Раздела 2 = объем подакцизного товара в гр.2 подр.2.1 Раздела 2 по соответствующему ';
			|en = 'в гр.3 подр.2.1 Раздела 2 = объем подакцизного товара в гр.2 подр.2.1 Раздела 2 по соответствующему '") +
		НСтр("ru = 'коду операции в гр.1 подр.2.1 Раздела 2 х ставку акциза';
			|en = 'коду операции в гр.1 подр.2.1 Раздела 2 х ставку акциза'"));
	...
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@';
													|en = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 2, строка %2 подр.2.1, код товара %3';
													|en = 'Страница %1 Раздела 2, строка %2 подр.2.1, код товара %3'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("Показатель1"		, "П00021М100003_");
	НастройкиКС.Вставить("Раздел2х"			, "21"); 
	НастройкиКС.Вставить("СтрокаКодов"		, "440,441,442"); 
	НастройкиКС.Вставить("МассивЗамен");
...
&НаСервере
Процедура ПроверкаКС_2_08_код()
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р20С040", "П000020004003");
	ИменаПоказателей.Вставить("Р21Г030", НастройкиКС.Показатель1);
	ИменаПоказателей.Вставить("Р21Г020", "П000" + НастройкиКС.Раздел2х + "М100002_");
	ИменаПоказателей.Вставить("Р20С041", "П0000200040А3"); 
	
	Показатели = СформироватьПоказатели(ИменаПоказателей, НастройкиКС.МассивЗамен);
	Показатели.Р21Г020.Округление = Ложь;
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Для Счетчик = 1 По СтраницаРаздела["КолвоСтрокП000" + НастройкиКС.Раздел2х + "М1"] Цикл
			...
			УсловиеВыполнено = НЕ СтрНайти(НастройкиКС.СтрокаКодов, Показатели.Р20С040.Значение) = 0;
			НастройкиКС.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р21Г030.Значение = РасчетнаяСумма;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
				Показатели.Р21Г030.Значение, Показатели.Р21Г020.Значение, Показатели.Р20С041.Значение, РасчетнаяСумма); 
			НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, 
				СтраницаРаздела.НомерСтраницы, Счетчик, Показатели.Р20С040.ЗначениеСтр);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_09()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450, 460, то исчисленная сумма акциза ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450, 460, то исчисленная сумма акциза '") +
		НСтр("ru = 'в гр.3 подр.2.1 Раздела 2 = стр.030 Приложения 1 по соответствующим кодам в стр.010, 020 Приложения 1';
			|en = 'в гр.3 подр.2.1 Раздела 2 = стр.030 Приложения 1 по соответствующим кодам в стр.010, 020 Приложения 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	НастройкиКС.Вставить("Раздел2х"			, "21");
	НастройкиКС.Вставить("Показатель1"		, "П00021М100003_");
	НастройкиКС.Вставить("НомерСтроки1"		, "030");
...
Процедура ПроверкаКС_2_10()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '2.10';
													|en = '2.10'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 410, 412 - 415, 420, 430, 471, 472, 474, 475, ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 410, 412 - 415, 420, 430, 471, 472, 474, 475, '") +
		НСтр("ru = 'то сумма акциза к уплате в гр.4 подр.2.1 Раздела 2 = объем подакцизного товара в гр.2 подр.2.1 ';
			|en = 'то сумма акциза к уплате в гр.4 подр.2.1 Раздела 2 = объем подакцизного товара в гр.2 подр.2.1 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду операции в гр.1 подр.2.1 Раздела 2 х ставку акциза';
			|en = 'Раздела 2 по соответствующему коду операции в гр.1 подр.2.1 Раздела 2 х ставку акциза'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 Х %3)';
													|en = '%1 = %4 (%2 Х %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	НастройкиКС.Вставить("Показатель1"		, "П00021М100004_");
	НастройкиКС.Вставить("Раздел2х"			, "21"); 
	НастройкиКС.Вставить("СтрокаКодов"		, "410,412,413,414,415,420,430,471,472,474,475"); 
	НастройкиКС.Вставить("МассивЗамен");
...
Процедура ПроверкаКС_2_11()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'За налоговый период сентябрь - декабрь: если код вида подакцизного товара в стр.040 Раздела 2 ';
			|en = 'За налоговый период сентябрь - декабрь: если код вида подакцизного товара в стр.040 Раздела 2 '") +
		НСтр("ru = '= 440 - 442, 450, 460, то сумма акциза к уплате в гр.4 подр.2.1 Раздела 2 = коэффициент Т в стр.030 ';
			|en = '= 440 - 442, 450, 460, то сумма акциза к уплате в гр.4 подр.2.1 Раздела 2 = коэффициент Т в стр.030 '") +
		НСтр("ru = 'Раздела 2 х исчисленная сумма акциза в гр.3 подр.2.1 Раздела 2 по соответствующему коду операции в ';
			|en = 'Раздела 2 х исчисленная сумма акциза в гр.3 подр.2.1 Раздела 2 по соответствующему коду операции в '") +
		НСтр("ru = 'гр.1 подр.2.1 Раздела 2';
			|en = 'гр.1 подр.2.1 Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 х %3)';
													|en = '%1 = %4 (%2 х %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00021М1 Цикл
			...
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
				Показатели.Р21Г040.Значение, Показатели.Р02С030.Значение, Показатели.Р21Г030.Значение, РасчетнаяСумма); 
			НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, 
				СтраницаРаздела.НомерСтраницы, Счетчик, Показатели.Р20С040.ЗначениеСтр);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_12()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'За налоговый период январь - август: если код вида подакцизного товара в стр.040 Раздела 2 ';
			|en = 'За налоговый период январь - август: если код вида подакцизного товара в стр.040 Раздела 2 '") +
		НСтр("ru = '= 440 - 442, 450, 460, то сумма акциза к уплате в гр.4 подр.2.1 Раздела 2 = исчисленная сумма акциза ';
			|en = '= 440 - 442, 450, 460, то сумма акциза к уплате в гр.4 подр.2.1 Раздела 2 = исчисленная сумма акциза '") +
		НСтр("ru = 'в гр.3 подр.2.1 Раздела 2 по соответствующему коду операции в гр.1 подр.2.1 Раздела 2';
			|en = 'в гр.3 подр.2.1 Раздела 2 по соответствующему коду операции в гр.1 подр.2.1 Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00021М1 Цикл
			...
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
				Показатели.Р21Г040.Значение, Показатели.Р21Г030.Значение);
			НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, 
				СтраницаРаздела.НомерСтраницы, Счетчик, Показатели.Р20С040.ЗначениеСтр);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_13()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Код операции в гр.1 подр.2.2 Раздела 2 должен соответствовать списку ';
			|en = 'Код операции в гр.1 подр.2.2 Раздела 2 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
...
Процедура ПроверкаКС_2_14()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'в гр.2 подр.2.2 Раздела 2 = стр.040 Приложения 1 по соответствующим кодам в стр.010, 020 Приложения 1';
			|en = 'в гр.2 подр.2.2 Раздела 2 = стр.040 Приложения 1 по соответствующим кодам в стр.010, 020 Приложения 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение объема подакцизного товара';
													|en = 'Возможно ошибочное значение объема подакцизного товара'"));
	...
	НастройкиКС.Вставить("Раздел2х"			, "22");
	НастройкиКС.Вставить("Показатель1"		, "П00022М100002_");
	НастройкиКС.Вставить("НомерСтроки1"		, "040"); 
	НастройкиКС.Вставить("МассивЗамен"		, СтрРазделить(
		"Р02,Р22,Р22,П01,П01,П01", ","));
...
Процедура ПроверкаКС_2_15()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 410, 412 - 415, 420, 430, 471, 472, ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 410, 412 - 415, 420, 430, 471, 472, '") +
		НСтр("ru = '474, 475, то исчисленная сумма акциза в гр.3 подр.2.2 Раздела 2 = 0';
			|en = '474, 475, то исчисленная сумма акциза в гр.3 подр.2.2 Раздела 2 = 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 0';
													|en = '%1 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	НастройкиКС.Вставить("Показатель1"		, "П00022М100003_");
	НастройкиКС.Вставить("МассивЗамен"		, СтрРазделить(
		"Р02,Р22", ","));
...
Процедура ПроверкаКС_2_16()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'в гр.3 подр.2.2 Раздела 2 = объем подакцизного товара в гр.2 подр.2.2 Раздела 2 по соответствующему ';
			|en = 'в гр.3 подр.2.2 Раздела 2 = объем подакцизного товара в гр.2 подр.2.2 Раздела 2 по соответствующему '") +
		НСтр("ru = 'коду операции в гр.1 подр.2.2 Раздела 2 х ставку акциза';
			|en = 'коду операции в гр.1 подр.2.2 Раздела 2 х ставку акциза'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 х %3)';
													|en = '%1 = %4 (%2 х %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@';
													|en = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 2, строка %2 подр.2.2, код товара %3';
													|en = 'Страница %1 Раздела 2, строка %2 подр.2.2, код товара %3'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_2_17()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'в гр.3 подр.2.2 Раздела 2 = стр.030 Приложения 1 по соответствующим кодам в стр.010, 020 Приложения 1';
			|en = 'в гр.3 подр.2.2 Раздела 2 = стр.030 Приложения 1 по соответствующим кодам в стр.010, 020 Приложения 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
...
Процедура ПроверкаКС_2_18()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 410, 412 - 415, 420, 430, 471, 472, 474, 475, ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 410, 412 - 415, 420, 430, 471, 472, 474, 475, '") +
		НСтр("ru = 'то сумма акциза к уплате в гр.4 подр.2.2 Раздела 2 = объем подакцизного товара в гр.2 подр.2.2 ';
			|en = 'то сумма акциза к уплате в гр.4 подр.2.2 Раздела 2 = объем подакцизного товара в гр.2 подр.2.2 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду операции в гр.1 подр.2.2 Раздела 2 х ставку акциза';
			|en = 'Раздела 2 по соответствующему коду операции в гр.1 подр.2.2 Раздела 2 х ставку акциза'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 х %3)';
													|en = '%1 = %4 (%2 х %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	НастройкиКС.Вставить("Показатель1"		, "П00022М100004_");
	НастройкиКС.Вставить("Раздел2х"			, "22"); 
	НастройкиКС.Вставить("СтрокаКодов"		, "410,412,413,414,415,420,430,471,472,474,475"); 
	НастройкиКС.Вставить("МассивЗамен"		, СтрРазделить(
		"Р20,Р22,Р22,Р20", ","));
...
Процедура ПроверкаКС_2_19()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'За налоговый период сентябрь - декабрь: если код вида подакцизного товара в стр.040 Раздела 2 ';
			|en = 'За налоговый период сентябрь - декабрь: если код вида подакцизного товара в стр.040 Раздела 2 '") +
		НСтр("ru = '= 440 - 442, 450, 460, то сумма акциза к уплате в гр.4 подр.2.2 Раздела 2 = коэффициент Т в стр.030 ';
			|en = '= 440 - 442, 450, 460, то сумма акциза к уплате в гр.4 подр.2.2 Раздела 2 = коэффициент Т в стр.030 '") +
		НСтр("ru = 'Раздела 2 х исчисленная сумма акциза в гр.3 подр.2.2 Раздела 2 по соответствующему коду операции в ';
			|en = 'Раздела 2 х исчисленная сумма акциза в гр.3 подр.2.2 Раздела 2 по соответствующему коду операции в '") +
		НСтр("ru = 'гр.1 подр.2.2 Раздела 2';
			|en = 'гр.1 подр.2.2 Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 х %3)';
													|en = '%1 = %4 (%2 х %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00022М1 Цикл
			...
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
				Показатели.Р22Г040.Значение, Показатели.Р02С030.Значение, Показатели.Р22Г030.Значение, РасчетнаяСумма);
			НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, 
				СтраницаРаздела.НомерСтраницы, Счетчик, Показатели.Р20С040.ЗначениеСтр);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_20()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'За налоговый период январь - август: если код вида подакцизного товара в стр.040 Раздела 2 ';
			|en = 'За налоговый период январь - август: если код вида подакцизного товара в стр.040 Раздела 2 '") +
		НСтр("ru = '= 440 - 442, 450, 460, то сумма акциза к уплате в гр.4 подр.2.2 Раздела 2 = исчисленная сумма акциза ';
			|en = '= 440 - 442, 450, 460, то сумма акциза к уплате в гр.4 подр.2.2 Раздела 2 = исчисленная сумма акциза '") +
		НСтр("ru = 'в гр.3 подр.2.2 Раздела 2 по соответствующему коду операции в гр.1 подр.2.2 Раздела 2';
			|en = 'в гр.3 подр.2.2 Раздела 2 по соответствующему коду операции в гр.1 подр.2.2 Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00022М1 Цикл
			...
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
				Показатели.Р22Г040.Значение, Показатели.Р22Г030.Значение);
			НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, 
				СтраницаРаздела.НомерСтраницы, Счетчик, Показатели.Р20С040.ЗначениеСтр);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_21()
	...
	Заголовки.Вставить("Рекомендации"		, "Выберите код показателя в гр.1 подр.2.3 Раздела 2 из списка значений");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@';
													|en = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@'"));
...
Процедура ПроверкаКС_2_22()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '2.22';
													|en = '2.22'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450, 460, то объем подакцизного товара в гр.2 ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450, 460, то объем подакцизного товара в гр.2 '") +
		НСтр("ru = 'подр.2.3 Раздела 2 = стр.040 Приложения 1 по соответствующим кодам в стр.010, 020, 025 Приложения 1';
			|en = 'подр.2.3 Раздела 2 = стр.040 Приложения 1 по соответствующим кодам в стр.010, 020, 025 Приложения 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение объема подакцизного товара';
													|en = 'Возможно ошибочное значение объема подакцизного товара'"));
	...
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@';
													|en = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Код товара %1, код операции %2, период %3.%4';
													|en = 'Код товара %1, код операции %2, период %3.%4'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("Раздел2х"			, "23");
	НастройкиКС.Вставить("Показатель1"		, "П00023М100002_");
	НастройкиКС.Вставить("НомерСтроки1"		, "040");
	НастройкиКС.Вставить("Период"			, Истина);
	НастройкиКС.Вставить("МассивЗамен"		, СтрРазделить(
		"Р02,Р23,Р23,П01,П01,П01,Р23,Р23,П01,П01", ","));
...
Процедура ПроверкаКС_2_23()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '2.23';
													|en = '2.23'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450, 460, то сумма акциза к вычету в гр.3 ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450, 460, то сумма акциза к вычету в гр.3 '") +
		НСтр("ru = 'подр.2.3 Раздела 2 = стр.030 Приложения 1 по соответствующим кодам в стр.010, 020, 025 Приложения 1';
			|en = 'подр.2.3 Раздела 2 = стр.030 Приложения 1 по соответствующим кодам в стр.010, 020, 025 Приложения 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	НастройкиКС.Вставить("Раздел2х"			, "23");
	НастройкиКС.Вставить("Показатель1"		, "П00023М100003_");
	НастройкиКС.Вставить("НомерСтроки1"		, "030");
	НастройкиКС.Вставить("Период"			, Истина);
	НастройкиКС.Вставить("МассивЗамен"		, СтрРазделить(
		"Р02,Р23,Р23,П01,П01,П01,Р23,Р23,П01,П01", ","));
...
Процедура ПроверкаКС_2_24()
	...
	НастройкиКС.Вставить("КодПоказателя"	, "Р24Г010");
	НастройкиКС.Вставить("ИмяПоказателя"	, "П00024М100001_");
	НастройкиКС.Вставить("СтрокиТЧ"			, "КолвоСтрокП00024М1");
...
Процедура ПроверкаКС_2_25()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма акциза в гр.2 подр.2.4 Раздела 2 по коду 40001 гр.1 подр.2.4 Раздела 2 = (Сумма гр.4 подр.2.1 ';
			|en = 'Сумма акциза в гр.2 подр.2.4 Раздела 2 по коду 40001 гр.1 подр.2.4 Раздела 2 = (Сумма гр.4 подр.2.1 '") +
		НСтр("ru = 'Раздела 2 + Сумма гр.4 подр.2.2 Раздела 2 с кодами 20003, 20004, 20005, 20007, 20009, 20011, ';
			|en = 'Раздела 2 + Сумма гр.4 подр.2.2 Раздела 2 с кодами 20003, 20004, 20005, 20007, 20009, 20011, '") +
		НСтр("ru = '20013, 20015 гр.1 подр.2.2 Раздела 2) - Сумма гр.3 подр.2.3 Раздела 2, если результат >= 0';
			|en = '20013, 20015 гр.1 подр.2.2 Раздела 2) - Сумма гр.3 подр.2.3 Раздела 2, если результат >= 0'"));
	...
	НастройкиКС.Вставить("КодПоказателя"	, "40001");
...
Процедура ПроверкаКС_2_26()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма акциза в гр.2 подр.2.4 Раздела 2 по коду 40002 гр.1 подр.2.4 Раздела 2 = (Сумма гр.4 подр.2.1 ';
			|en = 'Сумма акциза в гр.2 подр.2.4 Раздела 2 по коду 40002 гр.1 подр.2.4 Раздела 2 = (Сумма гр.4 подр.2.1 '") +
		НСтр("ru = 'Раздела 2 + Сумма гр.4 подр.2.2 Раздела 2 с кодами 20003, 20004, 20005, 20007, 20009, 20011, ';
			|en = 'Раздела 2 + Сумма гр.4 подр.2.2 Раздела 2 с кодами 20003, 20004, 20005, 20007, 20009, 20011, '") +
		НСтр("ru = '20013, 20015 гр.1 подр.2.2 Раздела 2) - Сумма гр.3 подр.2.3 Раздела 2, если результат < 0';
			|en = '20013, 20015 гр.1 подр.2.2 Раздела 2) - Сумма гр.3 подр.2.3 Раздела 2, если результат < 0'"));
	...
	НастройкиКС.Вставить("КодПоказателя"	, "40002");
...
Процедура ПроверкаКС_2_26_код()
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р24Г010", "П00024М100001_");
	ИменаПоказателей.Вставить("Р24Г020", "П00024М100002_");
	ИменаПоказателей.Вставить("Р21Г040", "П00021М100004_");
	ИменаПоказателей.Вставить("Р22Г010", "П00022М100001_");
	ИменаПоказателей.Вставить("Р22Г040", "П00022М100004_");
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		КодПоказателяНайден = Ложь;
		
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00024М1 Цикл
			ЗаполнитьПоказатель(Показатели.Р24Г010, СтраницаРаздела, Счетчик);
			Если Показатели.Р24Г010.Значение = НастройкиКС.КодПоказателя Тогда
				РасшифроватьПоказатель(Показатели.Р24Г010);
				ЗаполнитьИРасшифроватьПоказатель(Показатели.Р24Г020, СтраницаРаздела, Счетчик);
				КодПоказателяНайден = Истина;
			КонецЕсли;
		КонецЦикла; 
		...
		НастройкиКС.ЭтоОшибка = КодПоказателяНайден 
			И НЕ Показатели.Р24Г020.Итог = ?(НастройкиКС.КодПоказателя = "40001", Макс(0, РасчетнаяСумма), 
			-Мин(0, РасчетнаяСумма)); 
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р24Г020.Итог, ?(НастройкиКС.КодПоказателя = "40001", РасчетнаяСумма, -РасчетнаяСумма), 
			Показатели.Р21Г040.Итог, Показатели.Р22Г040.Итог, Показатели.Р23Г030.Итог);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_27()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '2.27';
													|en = '2.27'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма акциза в гр.2 подр.2.4 Раздела 2 по коду 40003 гр.1 подр.2.4 Раздела 2 = Сумма гр.3 подр.2.5 ';
			|en = 'Сумма акциза в гр.2 подр.2.4 Раздела 2 по коду 40003 гр.1 подр.2.4 Раздела 2 = Сумма гр.3 подр.2.5 '") +
		НСтр("ru = 'Раздела 2 с кодами 50001, 50002, 50006, 50007 в гр.1 подр.2.5 Раздела 2';
			|en = 'Раздела 2 с кодами 50001, 50002, 50006, 50007 в гр.1 подр.2.5 Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	СтрокаКодов = "50001,50002,50006,50007";
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		...
		Показатели.Р24Г020.Итог = 0;
		Показатели.Р25Г030.Итог = 0;
		КодПоказателяНайден = Ложь;
		
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00024М1 Цикл
			ЗаполнитьПоказатель(Показатели.Р24Г010, СтраницаРаздела, Счетчик);
			Если Показатели.Р24Г010.Значение = "40003" Тогда
				РасшифроватьПоказатель(Показатели.Р24Г010);
				ЗаполнитьИРасшифроватьПоказатель(Показатели.Р24Г020, СтраницаРаздела, Счетчик);
				КодПоказателяНайден = Истина;
			КонецЕсли;
		...
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00025М1 Цикл
			ЗаполнитьПоказатель(Показатели.Р25Г010, СтраницаРаздела, Счетчик);
			Если ЗначениеЗаполнено(Показатели.Р25Г010.Значение) 
				И НЕ СтрНайти(СтрокаКодов, Показатели.Р25Г010.Значение) = 0 Тогда
				ЗаполнитьИРасшифроватьПоказатель(Показатели.Р25Г030, СтраницаРаздела, Счетчик);
			КонецЕсли;
		КонецЦикла; 
		
		НастройкиКС.ЭтоОшибка = КодПоказателяНайден 
			И НЕ Показатели.Р24Г020.Итог = Показатели.Р25Г030.Итог; 
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р24Г020.Итог, Показатели.Р25Г030.Итог);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, 
			СтраницаРаздела.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_28()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '2.28';
													|en = '2.28'"));
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'Сумма акциза в гр.2 подр.2.4 Раздела 2 по кодам 40002, 40003 гр.1 подр.2.4 Раздела 2 > 0';
			|en = 'Сумма акциза в гр.2 подр.2.4 Раздела 2 по кодам 40002, 40003 гр.1 подр.2.4 Раздела 2 > 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 > 0';
													|en = '%1 > 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите положительную сумму акциза в гр.2 подр.2.4 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@';
													|en = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Страница %1 Раздела 2, строка %2 подр.2.4';
													|en = 'Страница %1 Раздела 2, строка %2 подр.2.4'"));
	...
	МассивКодов = Новый Массив;
	МассивКодов.Добавить("40002");
	МассивКодов.Добавить("40003");
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00024М1 Цикл 
			...
			НастройкиКС.ЭтоОшибка = НЕ МассивКодов.Найти(Показатели.Р24Г010.Значение) = Неопределено 
				И НЕ Показатели.Р24Г020.Значение > 0; 
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
				Показатели.Р24Г020.Значение); 
			НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, 
				СтраницаРаздела.НомерСтраницы, Счетчик);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_29()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение кода показателя';
													|en = 'Возможно ошибочное значение кода показателя'"));
	Заголовки.Вставить("Рекомендации"		, "Выберите код показателя в гр.1 подр.2.5 Раздела 2 из списка значений");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@';
													|en = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@'"));
...
Процедура ПроверкаКС_2_30()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450, 460, то объем подакцизного товара в гр';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450, 460, то объем подакцизного товара в гр'") +
		НСтр("ru = '.2 подр.2.5 Раздела 2 = стр.040 Приложения 1 по соответствующим кодам в стр.010, 020, 025 Приложения 1';
			|en = '.2 подр.2.5 Раздела 2 = стр.040 Приложения 1 по соответствующим кодам в стр.010, 020, 025 Приложения 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение объема подакцизного товара';
													|en = 'Возможно ошибочное значение объема подакцизного товара'"));
	...
	НастройкиКС.Вставить("Раздел2х"			, "25");
	НастройкиКС.Вставить("Показатель1"		, "П00025М100002_");
	НастройкиКС.Вставить("НомерСтроки1"		, "040");
	НастройкиКС.Вставить("Период"			, Истина);
	НастройкиКС.Вставить("МассивЗамен"		, СтрРазделить(
		"Р02,Р25,Р25,П01,П01,П01,Р25,Р25,П01,П01", ","));
...
Процедура ПроверкаКС_2_31() 
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450, 460, то сумма акциза в гр.3 ';
			|en = 'Если код вида подакцизного товара в стр.040 Раздела 2 = 450, 460, то сумма акциза в гр.3 '") +
		НСтр("ru = 'подр.2.5 Раздела 2 = стр.030 Приложения 1 по соответствующим кодам в стр.010, 020, 025 ';
			|en = 'подр.2.5 Раздела 2 = стр.030 Приложения 1 по соответствующим кодам в стр.010, 020, 025 '") +
		НСтр("ru = 'Приложения 1, если значение месяца в гр.4 подр.2.5 Раздела 2 = 01 - 08';
			|en = 'Приложения 1, если значение месяца в гр.4 подр.2.5 Раздела 2 = 01 - 08'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	НастройкиКС.Вставить("Раздел2х"			, "25");
	НастройкиКС.Вставить("Показатель1"		, "П00025М100003_");
	НастройкиКС.Вставить("НомерСтроки1"		, "030");
	НастройкиКС.Вставить("Период"			, Истина);
	НастройкиКС.Вставить("ОграничениеПериода", Истина);
	НастройкиКС.Вставить("МассивЗамен"		, СтрРазделить(
		"Р02,Р25,Р25,П01,П01,П01,Р25,Р25,П01,П01", ","));
...
Процедура ПроверкаКС_2_32()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Значение объема подакцизного товара в гр.2 подр.2.5 Раздела 2 по кодам 50003, 50008, 50009 гр.1 ';
			|en = 'Значение объема подакцизного товара в гр.2 подр.2.5 Раздела 2 по кодам 50003, 50008, 50009 гр.1 '") +
		НСтр("ru = 'подр.2.5 Раздела 2 = Сумма гр.4 стр.070 раздела 2 Приложения 2 по соответствующему коду гр.3 ';
			|en = 'подр.2.5 Раздела 2 = Сумма гр.4 стр.070 раздела 2 Приложения 2 по соответствующему коду гр.3 '") +
		НСтр("ru = 'стр.070 раздела 2 Приложения 2';
			|en = 'стр.070 раздела 2 Приложения 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 по коду товара %3';
	...
	НастройкиКС.Вставить("Показатель1"		, "П00025М100002_"); 
	НастройкиКС.Вставить("Показатель2"		, "П00102М207004_"); 
	НастройкиКС.Вставить("Округление"		, Ложь);
...
Процедура ПроверкаКС_2_32_код()
	...
	СтрокаКодовОпераций = "50003,50008,50009";
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р20С001"	, "П000020004003");
	ИменаПоказателей.Вставить("Р25Г001"	, "П00025М100001_");
	ИменаПоказателей.Вставить("Р25Г002"	, НастройкиКС.Показатель1);
	ИменаПоказателей.Вставить("П22П001"	, "П00102М207003_");
	ИменаПоказателей.Вставить("П22П002"	, НастройкиКС.Показатель2);
	
	Показатели = СформироватьПоказатели(ИменаПоказателей);
	Показатели.Р25Г002.Округление = НастройкиКС.Округление;
	Показатели.П22П002.Округление = НастройкиКС.Округление;
	
	Для каждого КодПТ Из ДанныеКС.МассивКодовПТ_Р2 Цикл
		
		ЗарегистрироватьПроверку();
		Показатели.Р25Г002.Итог = 0;
		Показатели.П22П002.Итог = 0;
		УсловиеВыполнено = Ложь;
		
		Для каждого СтраницаРаздела Из ДанныеКС.Раздел2.Раздел21 Цикл
			ЗаполнитьПоказатель(Показатели.Р20С001, СтраницаРаздела);
			
			Если НЕ Показатели.Р20С001.Значение = КодПТ Тогда 
				Продолжить;
			КонецЕсли;
			...
			Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00025М1 Цикл
				...
				Если ЗначениеЗаполнено(Показатели.Р25Г001.Значение) 
					И НЕ СтрНайти(СтрокаКодовОпераций, Показатели.Р25Г001.Значение) = 0 Тогда 
					РасшифроватьПоказатель(Показатели.Р25Г001);
					ЗаполнитьИРасшифроватьПоказатель(Показатели.Р25Г002, СтраницаРаздела, Счетчик);
					УсловиеВыполнено = Истина;
					КодТовара = Показатели.Р20С001.ЗначениеСтр;
				КонецЕсли;
			КонецЦикла;
		КонецЦикла;
		...
		Для каждого СтраницаРаздела Из ДанныеКС.Приложение2 Цикл
			Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00102М2 Цикл
				ЗаполнитьПоказатель(Показатели.П22П001, СтраницаРаздела, Счетчик);
				Если НЕ Показатели.П22П001.Значение = КодПТ Тогда  
					Продолжить;
				КонецЕсли;
				ЗаполнитьИРасшифроватьПоказатель(Показатели.П22П002, СтраницаРаздела, Счетчик);
			КонецЦикла;
		КонецЦикла;
	
		НастройкиКС.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р25Г002.Итог = Показатели.П22П002.Итог; 
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р25Г002.Итог, Показатели.П22П002.Итог, КодТовара); 
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_33()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма акциза в гр.3 подр.2.5 Раздела 2 по кодам 50003, 50008, 50009 гр.1 ';
			|en = 'Сумма акциза в гр.3 подр.2.5 Раздела 2 по кодам 50003, 50008, 50009 гр.1 '") +
		НСтр("ru = 'подр.2.5 Раздела 2 = Сумма гр.5 стр.070 раздела 2 Приложения 2 по соответствующему коду гр.3 ';
			|en = 'подр.2.5 Раздела 2 = Сумма гр.5 стр.070 раздела 2 Приложения 2 по соответствующему коду гр.3 '") +
		НСтр("ru = 'стр.070 раздела 2 Приложения 2';
			|en = 'стр.070 раздела 2 Приложения 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 по коду товара %3';
													|en = '%1 = %2 по коду товара %3'"));
	...
	НастройкиКС.Вставить("Показатель1"		, "П00025М100003_"); 
	НастройкиКС.Вставить("Показатель2"		, "П00102М207005_"); 
	НастройкиКС.Вставить("Округление"		, Истина);
...
Процедура ПроверкаКС_2_34_доп()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Месяц налогового периода в гр.4 подр.2.5 Раздела 2 должен соответствовать списку ';
			|en = 'Месяц налогового периода в гр.4 подр.2.5 Раздела 2 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение месяца налогового периода';
													|en = 'Возможно ошибочное значение месяца налогового периода'"));
...
Процедура ПроверкаКС_2_35_доп()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Год налогового периода в гр.5 подр.2.5 Раздела 2 должен соответствовать списку ';
			|en = 'Год налогового периода в гр.5 подр.2.5 Раздела 2 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение года налогового периода';
													|en = 'Возможно ошибочное значение года налогового периода'"));
...
Процедура ПроверкаКС_3_01()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Код вида подакцизного товара в стр.010 Приложения 1 должен соответствовать списку ';
			|en = 'Код вида подакцизного товара в стр.010 Приложения 1 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
...
Процедура ПроверкаКС_3_02()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Код операции в стр.020 Приложения 1 должен соответствовать списку ';
			|en = 'Код операции в стр.020 Приложения 1 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение кода вида операции';
													|en = 'Возможно ошибочное значение кода вида операции'"));
...
Процедура ПроверкаКС_3_03()
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение1 Цикл
		...
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.П01С025.ЗначениеСтр, Показатели.П01С026.ЗначениеСтр);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_04()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Объем реализованных табачных изделий в стр.080 Приложения 1 = стр.060 Приложения 1 х ';
			|en = 'Объем реализованных табачных изделий в стр.080 Приложения 1 = стр.060 Приложения 1 х '") +
		НСтр("ru = 'стр.070 Приложения 1 / 1000';
			|en = 'стр.070 Приложения 1 / 1000'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 ((%2 х %3) / 1000)';
													|en = '%1 = %4 ((%2 х %3) / 1000)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение объема реализованных табачных изделий';
													|en = 'Возможно ошибочное значение объема реализованных табачных изделий'"));
...
Процедура ПроверкаКС_3_05()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма акциза, рассчитанная исходя из твердой ставки в стр.090 Приложения 1 = стр.080 Приложения 1 ';
			|en = 'Сумма акциза, рассчитанная исходя из твердой ставки в стр.090 Приложения 1 = стр.080 Приложения 1 '") +
		НСтр("ru = 'х ставку акциза (твердая часть)';
			|en = 'х ставку акциза (твердая часть)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 х %3)';
													|en = '%1 = %4 (%2 х %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
...
Процедура ПроверкаКС_3_06()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Расчетная стоимость реализованных табачных изделий в стр.110 Приложения 1 = ';
			|en = 'Расчетная стоимость реализованных табачных изделий в стр.110 Приложения 1 = '") +
		НСтр("ru = 'стр.060 Приложения 1 х стр.100 Приложения 1';
			|en = 'стр.060 Приложения 1 х стр.100 Приложения 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 х %3)';
													|en = '%1 = %4 (%2 х %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение стоимости реализованных табачных изделий';
													|en = 'Возможно ошибочное значение стоимости реализованных табачных изделий'"));
...
Процедура ПроверкаКС_3_07()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма акциза, рассчитанная исходя из адвалорной ставки в стр.120 Приложения 1 = стр.110 Приложения 1 ';
			|en = 'Сумма акциза, рассчитанная исходя из адвалорной ставки в стр.120 Приложения 1 = стр.110 Приложения 1 '") +
		НСтр("ru = 'х ставку акциза (адвалорная часть)';
			|en = 'х ставку акциза (адвалорная часть)'"));
...
Процедура ПроверкаКС_3_08()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма акциза из комбинированной ставки в стр.130 Приложения 1 = стр.090 Приложения 1 ';
			|en = 'Сумма акциза из комбинированной ставки в стр.130 Приложения 1 = стр.090 Приложения 1 '") +
		НСтр("ru = '+ стр.120 Приложения 1';
			|en = '+ стр.120 Приложения 1'"));
...
Процедура ПроверкаКС_3_09()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '3.09';
													|en = '3.09'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма акциза, рассчитанная исходя из минимальной ставки в стр.140 Приложения 1 = ';
			|en = 'Сумма акциза, рассчитанная исходя из минимальной ставки в стр.140 Приложения 1 = '") +
		НСтр("ru = 'стр.080 Приложения 1 х минимальную ставку акциза';
			|en = 'стр.080 Приложения 1 х минимальную ставку акциза'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 х %3)';
													|en = '%1 = %4 (%2 х %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
...
Процедура ПроверкаКС_3_10()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма акциза, принимаемая к расчету исходя из комбинированной ставки акциза в стр.150 Приложения 1 ';
			|en = 'Сумма акциза, принимаемая к расчету исходя из комбинированной ставки акциза в стр.150 Приложения 1 '") +
		НСтр("ru = '= стр.130 Приложения 1, если стр.130 Приложения 1 > стр.140 Приложения 1. Если стр.130 ';
			|en = '= стр.130 Приложения 1, если стр.130 Приложения 1 > стр.140 Приложения 1. Если стр.130 '") +
		НСтр("ru = 'Приложения 1 <= стр.140 Приложения 1, то стр.150 Приложения 1 = 0';
			|en = 'Приложения 1 <= стр.140 Приложения 1, то стр.150 Приложения 1 = 0'"));
...
Процедура ПроверкаКС_3_11()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма акциза, принимаемая к расчету исходя из минимальной ставки акциза в стр.151 Приложения 1 ';
			|en = 'Сумма акциза, принимаемая к расчету исходя из минимальной ставки акциза в стр.151 Приложения 1 '") +
		НСтр("ru = '= стр.140 Приложения 1, если стр.130 Приложения 1 <= стр.140 Приложения 1. Если стр.130 ';
			|en = '= стр.140 Приложения 1, если стр.130 Приложения 1 <= стр.140 Приложения 1. Если стр.130 '") +
		НСтр("ru = 'Приложения 1 > стр.140 Приложения 1, то стр.151 Приложения 1 = 0';
			|en = 'Приложения 1 > стр.140 Приложения 1, то стр.151 Приложения 1 = 0'"));
...
Процедура ПроверкаКС_3_13_доп()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма акциза по виду подакцизного товара в стр. 030 Приложения 1 = сумме стр.150 Приложения 1 и ';
			|en = 'Сумма акциза по виду подакцизного товара в стр. 030 Приложения 1 = сумме стр.150 Приложения 1 и '") +
		НСтр("ru = 'сумме стр.151 Приложения 1 по соотв. кодам стр.010, стр.020 Приложения 1, и, в случае документального ';
			|en = 'сумме стр.151 Приложения 1 по соотв. кодам стр.010, стр.020 Приложения 1, и, в случае документального '") +
		НСтр("ru = 'подтверждения факта реализации подакцизного товара за пределы территории РФ (коды операций ';
			|en = 'подтверждения факта реализации подакцизного товара за пределы территории РФ (коды операций '") +
		НСтр("ru = '50001 - 50011), - по соотв. стр.025 Приложения 1';
			|en = '50001 - 50011), - по соотв. стр.025 Приложения 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 + %3)';
													|en = '%1 = %4 (%2 + %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
...
Процедура ПроверкаКС_3_14_доп()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Объем реализованных табачных изделий в стр. 040 Приложения 1 = сумме стр.080 Приложения 1 ';
			|en = 'Объем реализованных табачных изделий в стр. 040 Приложения 1 = сумме стр.080 Приложения 1 '") +
		НСтр("ru = 'по соотв. кодам стр.010, стр.020 Приложения 1, и, в случае документального подтверждения ';
			|en = 'по соотв. кодам стр.010, стр.020 Приложения 1, и, в случае документального подтверждения '") +
		НСтр("ru = 'факта реализации подакцизного товара за пределы территории РФ (коды операций ';
			|en = 'факта реализации подакцизного товара за пределы территории РФ (коды операций '") +
		НСтр("ru = '50001 - 50011), - по соотв. стр.025 Приложения 1';
			|en = '50001 - 50011), - по соотв. стр.025 Приложения 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
...
Процедура ПроверкаКС_3_15_доп()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Месяц налогового периода в стр.025 Приложения 1 должен соответствовать списку ';
			|en = 'Месяц налогового периода в стр.025 Приложения 1 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
...
Процедура ПроверкаКС_3_16_доп()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Год налогового периода в стр.025 Приложения 1 должен соответствовать списку ';
			|en = 'Год налогового периода в стр.025 Приложения 1 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
...
Процедура ПроверкаКС_4_02()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Дата выдачи банковской гарантии в стр.020 Приложения 2 <= даты начала срока ';
			|en = 'Дата выдачи банковской гарантии в стр.020 Приложения 2 <= даты начала срока '") +
		НСтр("ru = 'действия банковской гарантии в стр.030 Приложения 2';
			|en = 'действия банковской гарантии в стр.030 Приложения 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная дата выдачи банковской гарантии';
													|en = 'Возможно ошибочная дата выдачи банковской гарантии'"));
...
Процедура ПроверкаКС_4_03()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Дата начала срока действия банковской гарантии в стр.030 Приложения 2 >= даты выдачи ';
			|en = 'Дата начала срока действия банковской гарантии в стр.030 Приложения 2 >= даты выдачи '") +
		НСтр("ru = 'банковской гарантии в стр.020 Приложения 2';
			|en = 'банковской гарантии в стр.020 Приложения 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная дата начала срока действия банковской гарантии';
													|en = 'Возможно ошибочная дата начала срока действия банковской гарантии'"));
	Заголовки.Вставить("Рекомендации"		, 
	...
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru = 'Отключено как избыточное, дублирует КС 4.2';
													|en = 'Отключено как избыточное, дублирует КС 4.2'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_4_04()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Дата окончания срока действия банковской гарантии в стр.040 Приложения 2 > даты выдачи в стр.020 ';
			|en = 'Дата окончания срока действия банковской гарантии в стр.040 Приложения 2 > даты выдачи в стр.020 '") +
		НСтр("ru = 'Приложения 2 и даты начала срока действия банковской гарантии в стр.030 Приложения 2';
			|en = 'Приложения 2 и даты начала срока действия банковской гарантии в стр.030 Приложения 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 > %2 и %1 > %3';
													|en = '%1 > %2 и %1 > %3'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная дата окончания срока действия банковской гарантии';
													|en = 'Возможно ошибочная дата окончания срока действия банковской гарантии'"));
	Заголовки.Вставить("Рекомендации"		, 
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение2 Цикл
		...
		НастройкиКС.ЭтоОшибка = СтраницаРаздела.РазделЗаполнен 
			И НЕ (Показатели.П02С040.Значение > Показатели.П02С020.Значение 
...
Процедура ПроверкаКС_4_05()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма обязательств по банковской гарантии в стр.050 Приложения 2 >= общая сумма акциза, ';
			|en = 'Сумма обязательств по банковской гарантии в стр.050 Приложения 2 >= общая сумма акциза, '") +
		НСтр("ru = 'освобожденная от уплаты в связи с представлением банковской гарантии в стр.060 Приложения 2';
			|en = 'освобожденная от уплаты в связи с представлением банковской гарантии в стр.060 Приложения 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма обязательств по банковской гарантии';
													|en = 'Возможно ошибочная сумма обязательств по банковской гарантии'"));
...
Процедура ПроверкаКС_4_06()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Общая сумма акциза, освобожденная от уплаты в связи с представлением банковской гарантии ';
			|en = 'Общая сумма акциза, освобожденная от уплаты в связи с представлением банковской гарантии '") +
		НСтр("ru = 'в стр.060 Приложения 2 <= сумма обязательств по банковской гарантии в стр.050 Приложения 2';
			|en = 'в стр.060 Приложения 2 <= сумма обязательств по банковской гарантии в стр.050 Приложения 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru = 'Отключено как избыточное, дублирует КС 4.5';
													|en = 'Отключено как избыточное, дублирует КС 4.5'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_4_07()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'в стр.060 Приложения 2 = сумма гр.3 раздела 1 Приложения 2 по соотв. стр.010 Приложения 2';
			|en = 'в стр.060 Приложения 2 = сумма гр.3 раздела 1 Приложения 2 по соотв. стр.010 Приложения 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение2 Цикл
		...
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.П02С060.Значение, Показатели.П21Г030.Итог);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_4_08()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Общая сумма акциза, освобожденная от уплаты в связи с представлением банковской гарантии в стр.060 ';
			|en = 'Общая сумма акциза, освобожденная от уплаты в связи с представлением банковской гарантии в стр.060 '") +
		НСтр("ru = 'Приложения 2 >= сумма гр.5 стр.070 + сумма гр.5 стр.080 раздела 2 Приложения 2 по соотв. ';
			|en = 'Приложения 2 >= сумма гр.5 стр.070 + сумма гр.5 стр.080 раздела 2 Приложения 2 по соотв. '") +
		НСтр("ru = 'стр.010 Приложения 2';
			|en = 'стр.010 Приложения 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %4 (%2 + %3)';
													|en = '%1 >= %4 (%2 + %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение2 Цикл
		...
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.П02С060.Значение, Показатели.П22П075.Итог, Показатели.П22П085.Итог, РасчетнаяСумма);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_4_09()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 2';
														|en = 'Приложение 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '4.09';
													|en = '4.09'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Превышение суммы акциза в стр.065 Приложения 2 = общая сумма акциза, освобожденная от ';
			|en = 'Превышение суммы акциза в стр.065 Приложения 2 = общая сумма акциза, освобожденная от '") +
		НСтр("ru = 'уплаты в стр.060 Приложения 2 - (гр.5 стр.070 + гр.5 стр.080 раздела 2 Приложения 2)';
			|en = 'уплаты в стр.060 Приложения 2 - (гр.5 стр.070 + гр.5 стр.080 раздела 2 Приложения 2)'"));
...
Процедура ПроверкаКС_4_10()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Код вида подакцизного товара в гр.1 раздела 1 Приложения 2 должен соответствовать списку ';
			|en = 'Код вида подакцизного товара в гр.1 раздела 1 Приложения 2 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
...
Процедура ПроверкаКС_4_11а()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 2';
														|en = 'Приложение 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '4.11.1';
													|en = '4.11.1'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Код вида подакцизного товара в гр.3 стр.070 раздела 2 Приложения 2 должен соответствовать списку ';
			|en = 'Код вида подакцизного товара в гр.3 стр.070 раздела 2 Приложения 2 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
...
Процедура ПроверкаКС_4_11б()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 2';
														|en = 'Приложение 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '4.11.2';
													|en = '4.11.2'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Код вида подакцизного товара в гр.3 стр.080 раздела 2 Приложения 2 должен соответствовать списку ';
			|en = 'Код вида подакцизного товара в гр.3 стр.080 раздела 2 Приложения 2 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
...
Процедура ПроверкаКС_4_12()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма акциза в гр.5 стр.070 раздела 2 Приложения 2 <= общая сумма акциза, ';
			|en = 'Сумма акциза в гр.5 стр.070 раздела 2 Приложения 2 <= общая сумма акциза, '") +
		НСтр("ru = 'освобожденная от уплаты в стр.060 Приложения 2';
			|en = 'освобожденная от уплаты в стр.060 Приложения 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма акциза';
													|en = 'Возможно ошибочная сумма акциза'"));
...
Процедура ПроверкаКС_4_13()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма акциза в гр.5 стр.080 раздела 2 Приложения 2 <= общая сумма акциза, ';
			|en = 'Сумма акциза в гр.5 стр.080 раздела 2 Приложения 2 <= общая сумма акциза, '") +
		НСтр("ru = 'освобожденная от уплаты в стр.060 Приложения 2';
			|en = 'освобожденная от уплаты в стр.060 Приложения 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
...
Процедура ПроверкаКС_4_14_доп()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Месяц налогового периода в гр.6 стр.070 раздела 2 Приложения 2 должен соответствовать списку ';
			|en = 'Месяц налогового периода в гр.6 стр.070 раздела 2 Приложения 2 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
...
Процедура ПроверкаКС_4_15_доп()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Год налогового периода в гр.7 стр.070 раздела 2 Приложения 2 должен соответствовать списку ';
			|en = 'Год налогового периода в гр.7 стр.070 раздела 2 Приложения 2 должен соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
...
Процедура ПроверкаКС_5_01()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '5.01';
													|en = '5.01'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Признак сведений в стр.001 Приложения 3 уточненной декларации = 0 или 1, если ';
			|en = 'Признак сведений в стр.001 Приложения 3 уточненной декларации = 0 или 1, если '") +
		НСтр("ru = 'Приложение 3 заполнено';
			|en = 'Приложение 3 заполнено'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Недопустимое значение %1';
													|en = 'Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочное значение признака сведений';
													|en = 'Возможно ошибочное значение признака сведений'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите значение признака сведений в стр.001 Приложения 3 0 или 1");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@';
													|en = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение3 Цикл
		...
		ЗарегистрироватьПроверку();
		ЗаполнитьИРасшифроватьПоказатель(Показатели.П03С001, СтраницаРаздела);
		ЗаполнитьИРасшифроватьПоказатель(Показатели.Р00С001, ДанныеКС.Раздел0);
		
		НастройкиКС.ЭтоОшибка = Показатели.Р00С001.Значение > 0 И СтраницаРаздела.РазделЗаполнен
			И МассивЗначений.Найти(Показатели.П03С001.Значение) = Неопределено;
		НастройкиКС.Детализация = СтрЗаменить(НастройкиКС.ШаблонДетализации, "%1", Показатели.П03С001.ЗначениеСтр);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, 
			СтраницаРаздела.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_5_02()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '5.02';
													|en = '5.02'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Идентификатор файла в стр.010 Приложения 3 должен быть заполнен, если ';
			|en = 'Идентификатор файла в стр.010 Приложения 3 должен быть заполнен, если '") +
		НСтр("ru = 'налоговый период первичной декларации >= июль';
			|en = 'налоговый период первичной декларации >= июль'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = 'Стр.010 Приложения 3 = %1';
													|en = 'Стр.010 Приложения 3 = %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Значение не заполнено';
													|en = 'Значение не заполнено'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите значение идентификатора файла в стр.010 Приложения 3");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@';
													|en = 'Письмо ФНС России от 11.12.2024 № СД-4-3/14070@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru = 'Строка %1 Страница %2 Приложения 3';
													|en = 'Строка %1 Страница %2 Приложения 3'"));
	ПодготовитьНастройки(Заголовки);
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("П03С001"		, "П00103М101003_");
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение3 Цикл
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00103М1 Цикл
			...
			ЗарегистрироватьПроверку();
			ЗаполнитьИРасшифроватьПоказатель(Показатели.П03С001, СтраницаРаздела, Счетчик); 
			РасшифроватьПоказатель(Показатели.Р00С002);
			РасшифроватьПоказатель(Показатели.Р00С001);
			
			НастройкиКС.ЭтоОшибка = Показатели.Р00С001.Значение = 0 И СтраницаРаздела.РазделЗаполнен
				И Показатели.Р00С002.Значение >= "07" И НЕ ЗначениеЗаполнено(Показатели.П03С001.Значение);
			НастройкиКС.Детализация = СтрЗаменить(НастройкиКС.ШаблонДетализации, "%1", Показатели.П03С001.ЗначениеСтр);
			НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, 
...
Процедура АктивизироватьЯчейку(Ячейка) Экспорт
	...
	ИначеЕсли Ячейка.Раздел = "Приложение1" ИЛИ Ячейка.Раздел = "Приложение2"
