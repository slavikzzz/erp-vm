...
Процедура ДоступностьРазделов()
	...
	Если Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 3
		...
		Для НомСтр = 1 По 5 Цикл
			ПолеТабличногоДокументаФормаОтчета.Области["П000140100102_" + НомСтр].ЦветФона = Новый Цвет();
			ПолеТабличногоДокументаФормаОтчета.Области["П000140100102_" + НомСтр].Защита = Истина;
		КонецЦикла;
	КонецЕсли;
	...
	Если СтруктураРеквизитовФормы.мСкопированаФорма <> Неопределено Тогда
		Если Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 3
		 Или Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 9 Тогда
			...
			Для НомСтр = 1 По 5 Цикл
				Обл = ПолеТабличногоДокументаФормаОтчета.Области.Найти("П000140100102_" + НомСтр);
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли ТекГруппа = "П00003" Тогда
		...
		КонецЕсли;
	ИначеЕсли ТекГруппа = "П00004" Тогда
		СтандартнаяОбработка = Ложь;
		Модифицированность = Истина;
		НомерСтроки = Число(Сред(Область.Имя, 10, 2));
		Если СтрНайти("234", Прав(Область.Имя, 1)) > 0 Тогда
		...
		КонецЕсли;
	ИначеЕсли ТекГруппа = "П00009" Тогда
		СтандартнаяОбработка = Ложь;
		Модифицированность = Истина;
		УстановитьЗначокВГруппеЯчеек(Область, 1, 14, 2, 2, Истина);
	ИначеЕсли ТекГруппа = "П00010" Тогда
		СтандартнаяОбработка = Ложь;
		Модифицированность = Истина;
		УстановитьЗначокВГруппеЯчеек(Область, 1, 5, 2, 2);
	ИначеЕсли ТекГруппа = "П00011" Тогда
		СтандартнаяОбработка = Ложь;
		Модифицированность = Истина;
		УстановитьЗначокВГруппеЯчеек(Область, 1, 7, 2, 2);
	ИначеЕсли ТекГруппа = "П00012" Тогда
		СтандартнаяОбработка = Ложь;
		Модифицированность = Истина;
		УстановитьЗначокВГруппеЯчеек(Область, 1, 8, 2, 2);
	ИначеЕсли ТекГруппа = "П00013" Тогда
		СтандартнаяОбработка = Ложь;
		Модифицированность = Истина;
		УстановитьЗначокВГруппеЯчеек(Область, 1, 8, 2, 2);
	ИначеЕсли ТекГруппа = "П00014" Тогда
...
Процедура УстановитьЗначокВГруппеЯчеек(Область, НачальнаяСтрокаВГруппе, КонечнаяСтрокаВГруппе, НачальнаяКолонкаВГруппе, КонечнаяКолонкаВГруппе, МножественныйВыбор = Ложь)
	...
	Если Лев(Область.Имя, 6) = "П00009" И НовЗначениеОбласти <> "" Тогда
		КолВТаб = 0;
		МассОбластей = Новый Массив;
		Для Н = 1 По 14 Цикл
			ОтмеченнаяОбласть = ПолеТабличногоДокументаФормаОтчета.Области["П000090100102_" + Н];
			Если ЗначениеЗаполнено(ОтмеченнаяОбласть.Значение) Тогда
				МассОбластей.Добавить(ОтмеченнаяОбласть);
				КолВТаб = КолВТаб + 1;
			КонецЕсли;
		КонецЦикла;
		Если МассОбластей.Количество() = 4 Тогда
			МассОбластей[0].Значение = "";
		КонецЕсли;
	КонецЕсли;
...
Процедура ЗаполнитьДанными(ДеревоВыгрузки, ПараметрыВыгрузки) Экспорт 
	...
	Для Стр = 1 По 10 Цикл
		...
		Если ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П0000301" + НомСтр + "02"].Значение) Тогда
			ПараметрыВыгрузки.Вставить("ПД000301" + НомСтр + "02", "1");
		ИначеЕсли ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П0000301" + НомСтр + "03"].Значение) Тогда
			ПараметрыВыгрузки.Вставить("ПД000301" + НомСтр + "02", "2");
		ИначеЕсли ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П0000301" + НомСтр + "04"].Значение) Тогда
			ПараметрыВыгрузки.Вставить("ПД000301" + НомСтр + "02", "3");
		КонецЕсли;
		
		Если ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П0000301" + НомСтр + "05"].Значение) Тогда
			ПараметрыВыгрузки.Вставить("ПД000301" + НомСтр + "04", "1");
		ИначеЕсли ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П0000301" + НомСтр + "06"].Значение) Тогда
			ПараметрыВыгрузки.Вставить("ПД000301" + НомСтр + "04", "2");
		ИначеЕсли ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П0000301" + НомСтр + "07"].Значение) Тогда
			ПараметрыВыгрузки.Вставить("ПД000301" + НомСтр + "04", "3");
		КонецЕсли;
	КонецЦикла;
	...
	Для Стр = 1 По 3 Цикл
		...
		Если ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П0000401" + НомСтр + "02"].Значение) Тогда
			ПараметрыВыгрузки.Вставить("ПД000401" + НомСтр + "02", "16");
		ИначеЕсли ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П0000401" + НомСтр + "03"].Значение) Тогда
			ПараметрыВыгрузки.Вставить("ПД000401" + НомСтр + "02", "17");
		ИначеЕсли ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П0000401" + НомСтр + "04"].Значение) Тогда
			ПараметрыВыгрузки.Вставить("ПД000401" + НомСтр + "02", "18");
		КонецЕсли;
		
		Если ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П0000401" + НомСтр + "05"].Значение) Тогда
			ПараметрыВыгрузки.Вставить("ПД000401" + НомСтр + "05", "19");
		ИначеЕсли ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П0000401" + НомСтр + "06"].Значение) Тогда
			ПараметрыВыгрузки.Вставить("ПД000401" + НомСтр + "05", "2");
		ИначеЕсли ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П0000401" + НомСтр + "07"].Значение) Тогда
			ПараметрыВыгрузки.Вставить("ПД000401" + НомСтр + "05", "20");
		КонецЕсли;
		
		Если ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П0000401" + НомСтр + "08"].Значение) Тогда
			ПараметрыВыгрузки.Вставить("ПД000401" + НомСтр + "08", "19");
		ИначеЕсли ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П0000401" + НомСтр + "09"].Значение) Тогда
			ПараметрыВыгрузки.Вставить("ПД000401" + НомСтр + "08", "2");
		ИначеЕсли ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П0000401" + НомСтр + "10"].Значение) Тогда
			ПараметрыВыгрузки.Вставить("ПД000401" + НомСтр + "08", "20");
		КонецЕсли;
	КонецЦикла;
	
	Для Стр = 1 По 14 Цикл
		Если ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П000090100102_" + Стр].Значение) Тогда
			...
			Если МассивВыбора.Количество() = 1 Тогда
				ПараметрыВыгрузки.Вставить("П000090100102_" + Стр, МассивВыбора[0].Код);
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
	
	Для Стр = 1 По 5 Цикл
		Если ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П000100100" + Стр + "02"].Значение) Тогда
			СтруктураПоиска = Новый Структура("Ключ", Строка(Стр));
			МассивВыбора = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект,
				"ЧислоПерепродаж").ТаблицаЗначений.НайтиСтроки(СтруктураПоиска);
			Если МассивВыбора.Количество() = 1 Тогда
				ПараметрыВыгрузки.Вставить("ПД00100100102", МассивВыбора[0].Код);
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
	
	Для Стр = 1 По 7 Цикл
		Если ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П000110100" + Стр + "02"].Значение) Тогда
			СтруктураПоиска = Новый Структура("Ключ", Строка(Стр));
			МассивВыбора = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект,
				"ДоляЭлектроннойПродажи").ТаблицаЗначений.НайтиСтроки(СтруктураПоиска);
			Если МассивВыбора.Количество() = 1 Тогда
				ПараметрыВыгрузки.Вставить("ПД00110100102", МассивВыбора[0].Код);
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
	
	Для Стр = 1 По 8 Цикл
		Если ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П000120100" + Стр + "02"].Значение) Тогда
			СтруктураПоиска = Новый Структура("Ключ", Строка(Стр));
			МассивВыбора = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект,
				"СреднийУровеньТорговойОценки").ТаблицаЗначений.НайтиСтроки(СтруктураПоиска);
			Если МассивВыбора.Количество() = 1 Тогда
				ПараметрыВыгрузки.Вставить("ПД00120100102", МассивВыбора[0].Код);
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
	
	Для Стр = 1 По 8 Цикл
		Если ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П000130100" + Стр + "02"].Значение) Тогда
			СтруктураПоиска = Новый Структура("Ключ", Строка(Стр));
			МассивВыбора = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект,
				"СреднийУровеньТорговойОценки").ТаблицаЗначений.НайтиСтроки(СтруктураПоиска);
			Если МассивВыбора.Количество() = 1 Тогда
				ПараметрыВыгрузки.Вставить("ПД00130100102", МассивВыбора[0].Код);
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
	
	Для Стр = 1 По 5 Цикл
		Если ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П000140100102_" + Стр].Значение) Тогда
			СтруктураПоиска = Новый Структура("Ключ", Строка(Стр));
			МассивВыбора = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект,
				"СостояниеКонкурентнойСреды").ТаблицаЗначений.НайтиСтроки(СтруктураПоиска);
			Если МассивВыбора.Количество() = 1 Тогда
				ПараметрыВыгрузки.Вставить("П000140100102_" + Стр, МассивВыбора[0].Код);
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
