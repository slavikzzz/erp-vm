...
Функция ВыполнитьДокументированиеНаСервере()
	...
	СтруктураРезультата.Вставить("НаименованиеФормы"	, "2021Кв3");
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("Списки2021Кв3");
...
Функция ЗаполнитьАвтоНаСервере()
	...
	ЭтаФормаИмя = "ВнешнийОтчет.РегламентированныйОтчетНДС.Форма.ФормаОтчета2021Кв3";
