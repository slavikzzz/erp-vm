...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("Списки2020Кв4");
			...
			Для НомСтр = ВерхОбласти По НизОбласти Цикл
				...
				Если КодПоказателя <> "###" Тогда
					...
					ИначеЕсли Область.Имя = "КодыОпераций_Раздел7" Тогда
						...
						Если КодПоказателя = "1011213" И Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) < 2021 Тогда
							Продолжить;
						КонецЕсли;
...
Процедура ОбработкаИзмененияСодержимогоВПолеТабличногоДокумента(Элемент, Область)
	...
	Если ИмяРаздела = "Раздел1"
		...
		Если ИмяРаздела = "Раздел1" Тогда
			...
			Если Область.Имя = "П000100009003" ИЛИ Область.Имя = "П000100009503" Тогда
...
Функция ЗаполнитьАвтоНаСервере()
	...
	ЭтаФормаИмя = "ВнешнийОтчет.РегламентированныйОтчетНДС.Форма.ФормаОтчета2020Кв4";
...
Процедура ПроверкаКС_1_26а()
	...
	ЗаполнитьИРасшифроватьПоказатели(Показатели	, ДанныеКС.ДанныеР02);
	ЗаполнитьИРасшифроватьПоказатели(Показатели	, ДанныеКС.ДанныеР09);
	ЗаполнитьИРасшифроватьПоказатели(Показатели	, ДанныеКС.ДанныеР91);
