...
Процедура РасшифроватьПоказатель(Показатель)
	...
	Если ТипЗнч(Показатель.Значение) = Тип("Строка") ИЛИ ТипЗнч(Показатель.Значение) = Тип("Дата") Тогда
...
Процедура ПроверкаКС_1_1()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'При отражении в стр.070 Раздела 2 кодов 1011711, 1011703, необходимо соблюдение условия: стр.180 ';
			|en = 'При отражении в стр.070 Раздела 2 кодов 1011711, 1011703, необходимо соблюдение условия: стр.180 '") +
		НСтр("ru = 'гр.3 Раздела 3 <= стр.060 Раздела 2 декларации прошлого (прошлых) налоговых периодов, в случае ';
			|en = 'гр.3 Раздела 3 <= стр.060 Раздела 2 декларации прошлого (прошлых) налоговых периодов, в случае '") +
		НСтр("ru = 'если покупка принята к вычету';
			|en = 'если покупка принята к вычету'"));
	...
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Необоснованное применение вычетов налоговым агентом';
			|en = 'Необоснованное применение вычетов налоговым агентом'"));
	Настройки = ОбработатьНастройки(Заголовки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_2()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 161, 171, 172 НК РФ';
													|en = 'ст. 161, 171, 172 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Если в стр.070 Раздела 2 отражены только коды 1011705, 1011707, 1011714, то сумма налога по ';
			|en = 'Если в стр.070 Раздела 2 отражены только коды 1011705, 1011707, 1011714, то сумма налога по '") +
		НСтр("ru = 'стр.180 гр.3 Раздела 3 должна быть равна 0';
			|en = 'стр.180 гр.3 Раздела 3 должна быть равна 0'"));
	...
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей вычету';
														|en = 'Ошибка исчисления суммы НДС, подлежащей вычету'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_3()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 161, 173, 174 НК РФ';
													|en = 'ст. 161, 173, 174 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Если в стр.070 Раздела 2 отражены коды 1011705, 1011707, то сумма налога по ';
			|en = 'Если в стр.070 Раздела 2 отражены коды 1011705, 1011707, то сумма налога по '") +
		НСтр("ru = 'стр.060 Раздела 2 = стр.080 Раздела 2 + стр.090 Раздела 2 - стр.100 Раздела 2';
			|en = 'стр.060 Раздела 2 = стр.080 Раздела 2 + стр.090 Раздела 2 - стр.100 Раздела 2'"));
	...
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
														|en = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
&НаСервере
Процедура ПроверкаКС_1_4()
	
	// проверка переведена в справочный режим
	// выдача ошибок приостановлена по многочисленным обращениям пользователей
	...
	ЗарегистрироватьФормулу(Настройки);
	ЗаполнитьИРасшифроватьПоказатели(ПоказателиЛевЧисл, ДанныеКС.ДанныеР03);
	РасчетнаяСуммаЛевЧисл = СуммаПоказателей(ПоказателиЛевЧисл);
	
	КолвоСтрок = КоличествоСтрок(ДанныеКС.ДанныеР07, ПоказателиЛевЗнам.Р07С001Г1.ИмяПоказателя);
	Для Инд = 1 По КолвоСтрок Цикл
		...
		ЗаполнитьИРасшифроватьПоказатель(ПоказателиЛевЗнам.Р07С001Г1, ДанныеКС.ДанныеР07);
		Если ЗначениеЗаполнено(ПоказателиЛевЗнам.Р07С001Г1.Значение) 
			...
			ЗаполнитьИРасшифроватьПоказатель(ПоказателиЛевЗнам.Р07С001Г2, ДанныеКС.ДанныеР07);
		КонецЕсли;
	КонецЦикла;
	
	ЗаполнитьИРасшифроватьПоказатели(ПоказателиПрвЧисл, ДанныеКС.ДанныеР03);
	...
	Для Инд = 1 По КолвоСтрок Цикл
		...
		ЗаполнитьИРасшифроватьПоказатель(ПоказателиПрвЗнам.Р07С001Г1, ДанныеКС.ДанныеР07);
		Если ЗначениеЗаполнено(ПоказателиПрвЗнам.Р07С001Г1.Значение) 
			...
			ЗаполнитьИРасшифроватьПоказатель(ПоказателиПрвЗнам.Р07С001Г4, ДанныеКС.ДанныеР07);
		КонецЕсли;
	КонецЦикла;
	...
	Настройки.ЭтоОшибка = НЕ РасчетнаяСуммаЛев = РасчетнаяСуммаПрв И Ложь;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверкаКС_1_5()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Требуется соблюдение равенства: стр.080 гр.5 Раздела 3 >= суммы стр.090 и 100 гр.5 Раздела 3 и ';
			|en = 'Требуется соблюдение равенства: стр.080 гр.5 Раздела 3 >= суммы стр.090 и 100 гр.5 Раздела 3 и '") +
		НСтр("ru = 'стр.070 гр.4 Приложения 1 к Разделу 3 по кодам 1011801, 1011802, 1011803, 1011805, 1011806, ';
			|en = 'стр.070 гр.4 Приложения 1 к Разделу 3 по кодам 1011801, 1011802, 1011803, 1011805, 1011806, '") +
		НСтр("ru = '1011807, 1011808 за отчетный год, указанный в стр.070 гр.1 Приложения 1 к Разделу 3 и ';
			|en = '1011807, 1011808 за отчетный год, указанный в стр.070 гр.1 Приложения 1 к Разделу 3 и '") +
		НСтр("ru = 'соответствующий отчетному году на титульном листе';
			|en = 'соответствующий отчетному году на титульном листе'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= %2 + %3 + %4 Итог [%5]';
													|en = '%1 >= %2 + %3 + %4 Итог [%5]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Возможна ошибка исчисления суммы НДС, подлежащей восстановлению';
														|en = 'Возможна ошибка исчисления суммы НДС, подлежащей восстановлению'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_6()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Требуется соблюдение равенства: (стр.080 - стр.090 - стр.100 гр.5 Раздела 3) >= суммы стр.070 ';
			|en = 'Требуется соблюдение равенства: (стр.080 - стр.090 - стр.100 гр.5 Раздела 3) >= суммы стр.070 '") +
		НСтр("ru = 'гр.4 Приложения 1 к Разделу 3 по кодам 1011801, 1011802, 1011803, 1011805, 1011806, 1011807, ';
			|en = 'гр.4 Приложения 1 к Разделу 3 по кодам 1011801, 1011802, 1011803, 1011805, 1011806, 1011807, '") +
		НСтр("ru = '1011808 за отчетный год, указанный в стр.070 гр.1 Приложения 1 к Разделу 3 и соответствующий ';
			|en = '1011808 за отчетный год, указанный в стр.070 гр.1 Приложения 1 к Разделу 3 и соответствующий '") +
		НСтр("ru = 'отчетному году на титульном листе';
			|en = 'отчетному году на титульном листе'"));
...
Процедура ПроверкаКС_1_7()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 146, 154, 155, 156, 158, 159, 162 НК РФ';
													|en = 'ст. 146, 154, 155, 156, 158, 159, 162 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Общая сумма налога в стр.118 гр.5 Раздела 3 должна быть равна сумме стр.010, 020, 030, 040, ';
			|en = 'Общая сумма налога в стр.118 гр.5 Раздела 3 должна быть равна сумме стр.010, 020, 030, 040, '") +
		НСтр("ru = '041, 042, 045, 046, 050, 060, 070, 080, 105, 109, 110, 115 по гр.5 Раздела 3';
			|en = '041, 042, 045, 046, 050, 060, 070, 080, 105, 109, 110, 115 по гр.5 Раздела 3'"));
...
Процедура ПроверкаКС_1_8()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Общая сумма НДС, подлежащая вычету по стр.190 гр.3 Раздела 3 должна быть равна сумме стр.';
			|en = 'Общая сумма НДС, подлежащая вычету по стр.190 гр.3 Раздела 3 должна быть равна сумме стр.'") +
		НСтр("ru = '120, 130, 135, 140, 150, 160, 170, 180, 185 по гр.3 Раздела 3';
			|en = '120, 130, 135, 140, 150, 160, 170, 180, 185 по гр.3 Раздела 3'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей возмещению';
														|en = 'Ошибка исчисления суммы НДС, подлежащей возмещению'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
&НаСервере
Процедура ПроверкаКС_1_9()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.9 (КС 1)';
													|en = '1.9 (КС 1)'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 3';
														|en = 'Раздел 3'"));
	Заголовки.Вставить("Комментарий"		, 
		НСтр("ru = 'Важно! При невыполнении данного контрольного соотношения декларация по НДС может считаться непредставленной!';
			|en = 'Важно! При невыполнении данного контрольного соотношения декларация по НДС может считаться непредставленной!'"));
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога, подлежащая уплате в бюджет по стр.200 гр.3 Раздела 3 должна быть равна разнице ';
			|en = 'Сумма налога, подлежащая уплате в бюджет по стр.200 гр.3 Раздела 3 должна быть равна разнице '") +
		НСтр("ru = 'значений стр.118 гр.5 и стр.190 гр.3 Раздела 3, если такая разница > 0, иначе 0';
			|en = 'значений стр.118 гр.5 и стр.190 гр.3 Раздела 3, если такая разница > 0, иначе 0'"));
...
Процедура ПроверкаКС_1_10()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога, подлежащая уплате в бюджет по стр.210 гр.3 Раздела 3 должна быть равна разнице ';
			|en = 'Сумма налога, подлежащая уплате в бюджет по стр.210 гр.3 Раздела 3 должна быть равна разнице '") +
		НСтр("ru = 'значений стр.190 гр.3 и стр.118 гр.5 Раздела 3, если такая разница > 0, иначе 0';
			|en = 'значений стр.190 гр.3 и стр.118 гр.5 Раздела 3, если такая разница > 0, иначе 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - %3 Итог [%4]';
													|en = '%1 = %2 - %3 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей возмещению';
														|en = 'Ошибка исчисления суммы НДС, подлежащей возмещению'"));
...
Процедура ПроверкаКС_1_11()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. п.8 ст.171, п.6 ст.172, п.1 ст.146 НК РФ';
													|en = 'ст. п.8 ст.171, п.6 ст.172, п.1 ст.146 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма стр.010, 020, 030, 040 гр.5 Раздела 3 должна быть больше или равна сумме ';
			|en = 'Сумма стр.010, 020, 030, 040 гр.5 Раздела 3 должна быть больше или равна сумме '") +
		НСтр("ru = 'налога, подлежащей вычету по стр.170 гр.3 Раздела 3';
			|en = 'налога, подлежащей вычету по стр.170 гр.3 Раздела 3'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 + %2 + %3 + %4 Итог [%7] >= %8';
													|en = '%1 + %2 + %3 + %4 Итог [%7] >= %8'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС к уплате в бюджет либо подлежащей вычету';
			|en = 'Ошибка исчисления суммы НДС к уплате в бюджет либо подлежащей вычету'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	Если НЕ Документирование Тогда
		...
		ИменаПоказателей.Вставить("Р03С041Г5", "П000300004100");
		ИменаПоказателей.Вставить("Р03С042Г5", "П000300004200");
		ИменаПоказателей.Вставить("Р03С170Г3", "П000300017003");
		
		СформироватьПоказатели(Показатели, ИменаПоказателей);
		Показатели.Р03С041Г5.Расшифровывать = Ложь;
		Показатели.Р03С042Г5.Расшифровывать = Ложь;
		ЗарегистрироватьФормулу(Настройки);
		
		ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.ДанныеР03);
		
		РасчетнаяСумма = Показатели.Р03С010Г5.Значение + Показатели.Р03С020Г5.Значение + Показатели.Р03С030Г5.Значение + 
			Показатели.Р03С040Г5.Значение + Показатели.Р03С041Г5.Итог + Показатели.Р03С042Г5.Итог;
		...
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
			...
			Показатели.Р03С040Г5.Значение, Показатели.Р03С041Г5.Итог, Показатели.Р03С042Г5.Итог, РасчетнаяСумма, 
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма стр.010, 020, 030, 040, 041, 042 гр.5 Раздела 3 должна быть больше или равна сумме ';
			|en = 'Сумма стр.010, 020, 030, 040, 041, 042 гр.5 Раздела 3 должна быть больше или равна сумме '") +
		НСтр("ru = 'налога, подлежащей вычету по стр.170 гр.3 Раздела 3';
			|en = 'налога, подлежащей вычету по стр.170 гр.3 Раздела 3'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 + %2 + %3 + %4 + %5 + %6 Итог [%7] >= %8';
													|en = '%1 + %2 + %3 + %4 + %5 + %6 Итог [%7] >= %8'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС к уплате в бюджет либо подлежащей вычету';
			|en = 'Ошибка исчисления суммы НДС к уплате в бюджет либо подлежащей вычету'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_12()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. п.6 ст.171, п.5 ст.172 НК РФ';
													|en = 'ст. п.6 ст.171, п.5 ст.172 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма НДС по выполненным СМР для собственного потребления по стр.060 гр.5 Раздела 3 ';
			|en = 'Сумма НДС по выполненным СМР для собственного потребления по стр.060 гр.5 Раздела 3 '") +
		НСтр("ru = 'должна быть больше либо равна сумме налога, подлежащей вычету по стр.140 гр.3 Раздела 3';
			|en = 'должна быть больше либо равна сумме налога, подлежащей вычету по стр.140 гр.3 Раздела 3'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
...
Процедура ПроверкаКС_1_14()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 170, 171, 172 НК РФ';
													|en = 'ст. 170, 171, 172 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налоговых вычетов по гр.3 Приложения 2 к Разделу 3 должна быть меньше или равна общей ';
			|en = 'Сумма налоговых вычетов по гр.3 Приложения 2 к Разделу 3 должна быть меньше или равна общей '") +
		НСтр("ru = 'суммы НДС, подлежащей вычету в стр. 190 Раздела 3';
			|en = 'суммы НДС, подлежащей вычету в стр. 190 Раздела 3'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей вычету';
...
Процедура ПроверкаКС_1_15()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по стр.120 Раздела 4 должна быть равна сумме значений стр.030 и 040 за минусом ';
			|en = 'Сумма налога по стр.120 Раздела 4 должна быть равна сумме значений стр.030 и 040 за минусом '") +
		НСтр("ru = 'суммы значений стр.050 и 080 Раздела 4, если полученная разница > 0, иначе 0';
			|en = 'суммы значений стр.050 и 080 Раздела 4, если полученная разница > 0, иначе 0'"));
...
Процедура ПроверкаКС_1_16()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по стр.080 Раздела 5 должна быть равна сумме стр.050 Раздела 5';
			|en = 'Сумма налога по стр.080 Раздела 5 должна быть равна сумме стр.050 Раздела 5'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей вычету';
	...
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.ДанныеР05);
...
Процедура ПроверкаКС_1_17()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по стр.090 Раздела 5 должна быть равна сумме стр.070 Раздела 5';
			|en = 'Сумма налога по стр.090 Раздела 5 должна быть равна сумме стр.070 Раздела 5'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей вычету';
...
Процедура ПроверкаКС_1_18()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 153, 164, 165, 167 НК РФ';
													|en = 'ст. 153, 164, 165, 167 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по стр.050 Раздела 6 должна быть равна сумме стр.030 Раздела 6';
			|en = 'Сумма налога по стр.050 Раздела 6 должна быть равна сумме стр.030 Раздела 6'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
Процедура ПроверкаКС_1_19()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по стр.060 Раздела 6 должна быть равна сумме стр.040 Раздела 6';
			|en = 'Сумма налога по стр.060 Раздела 6 должна быть равна сумме стр.040 Раздела 6'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей вычету';
...
Процедура ПроверкаКС_1_20()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.20 (КС 2)';
													|en = '1.20 (КС 2)'"));
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога, подлежащая к уплате в бюджет в стр.040 Раздела 1 должна быть равна (стр.200 ';
			|en = 'Сумма налога, подлежащая к уплате в бюджет в стр.040 Раздела 1 должна быть равна (стр.200 '") +
		НСтр("ru = 'Раздела 3 + стр.130 Раздела 4 + стр.160 Раздела 6) - (стр.210 Раздела 3 + стр.120 Раздела 4 + ';
			|en = 'Раздела 3 + стр.130 Раздела 4 + стр.160 Раздела 6) - (стр.210 Раздела 3 + стр.120 Раздела 4 + '") +
		НСтр("ru = 'стр.080 Раздела 5 + стр.090 Раздела 5 + стр.170 Раздела 6), когда полученная разница > 0, иначе 0';
			|en = 'стр.080 Раздела 5 + стр.090 Раздела 5 + стр.170 Раздела 6), когда полученная разница > 0, иначе 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = (%2 Итог[%3]) - (%4 Итог[%5]) Итог[%6]';
													|en = '%1 = (%2 Итог[%3]) - (%4 Итог[%5]) Итог[%6]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
			|en = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_21()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога, исчисленная к возмещению из бюджета в стр.050 Раздела 1 должна быть равна (стр.210 ';
			|en = 'Сумма налога, исчисленная к возмещению из бюджета в стр.050 Раздела 1 должна быть равна (стр.210 '") +
		НСтр("ru = 'Раздела 3 + стр.120 Раздела 4 + стр.080 Раздела 5 + стр.090 Раздела 5 + стр.170 Раздела 6) - ';
			|en = 'Раздела 3 + стр.120 Раздела 4 + стр.080 Раздела 5 + стр.090 Раздела 5 + стр.170 Раздела 6) - '") +
		НСтр("ru = '(стр.200 Раздела 3 + стр.130 Раздела 4 + стр.160 Раздела 6), когда полученная разница > 0, иначе 0';
			|en = '(стр.200 Раздела 3 + стр.130 Раздела 4 + стр.160 Раздела 6), когда полученная разница > 0, иначе 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = (%4 Итог[%5]) - (%2 Итог[%3]) Итог[%6]';
													|en = '%1 = (%4 Итог[%5]) - (%2 Итог[%3]) Итог[%6]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
...
Процедура ПроверкаКС_1_22()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 1 к Разделу 8';
														|en = 'Приложение 1 к Разделу 8'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 171, 172 НК РФ';
													|en = 'ст. 171, 172 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по книге покупок в стр.005 Приложения 1 к Разделу 8 должна быть равна ';
			|en = 'Сумма налога по книге покупок в стр.005 Приложения 1 к Разделу 8 должна быть равна '") +
		НСтр("ru = 'сумме налога в стр.190 Раздела 8';
			|en = 'сумме налога в стр.190 Раздела 8'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей вычету';
	...
	Настройки.ЭтоОшибка = РазделЗаполнен(ДанныеКС.ДанныеР81) 
		И НЕ Показатели.Р81С005.Значение = Показатели.Р08С190.Значение;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверкаКС_1_23а()
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 1 к Разделу 9';
														|en = 'Приложение 1 к Разделу 9'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 173 НК РФ';
													|en = 'ст. 173 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Стоимость продаж по ставке 20% в стр.020 Приложения 1 к Разделу 9 должна быть равна ';
			|en = 'Стоимость продаж по ставке 20% в стр.020 Приложения 1 к Разделу 9 должна быть равна '") +
		НСтр("ru = 'значению стр.230 Раздела 9';
			|en = 'значению стр.230 Раздела 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможно ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
			|en = 'Возможно ошибка исчисления суммы НДС, подлежащей уплате в бюджет'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	Настройки.ЭтоОшибка = РазделЗаполнен(ДанныеКС.ДанныеР91) 
		И НЕ Показатели.Р91С020.Значение = Показатели.Р09С230.Значение;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверкаКС_1_23б()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Стоимость продаж по ставке 18% в стр.025 Приложения 1 к Разделу 9 должна быть равна ';
			|en = 'Стоимость продаж по ставке 18% в стр.025 Приложения 1 к Разделу 9 должна быть равна '") +
		НСтр("ru = 'значению стр.235 Раздела 9';
			|en = 'значению стр.235 Раздела 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможно ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
	...
	Настройки.ЭтоОшибка = РазделЗаполнен(ДанныеКС.ДанныеР91) 
		И НЕ Показатели.Р91С025.Значение = Показатели.Р09С235.Значение;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверкаКС_1_23в()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Стоимость продаж по ставке 10% в стр.030 Приложения 1 к Разделу 9 должна быть равна ';
			|en = 'Стоимость продаж по ставке 10% в стр.030 Приложения 1 к Разделу 9 должна быть равна '") +
		НСтр("ru = 'значению стр.240 Раздела 9';
			|en = 'значению стр.240 Раздела 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможно ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
	...
	Настройки.ЭтоОшибка = РазделЗаполнен(ДанныеКС.ДанныеР91) 
		И НЕ Показатели.Р91С030.Значение = Показатели.Р09С240.Значение;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверкаКС_1_23г()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Стоимость продаж по ставке 0% в стр.040 Приложения 1 к Разделу 9 должна быть равна ';
			|en = 'Стоимость продаж по ставке 0% в стр.040 Приложения 1 к Разделу 9 должна быть равна '") +
		НСтр("ru = 'значению стр.250 Раздела 9';
			|en = 'значению стр.250 Раздела 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможно ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
	...
	Настройки.ЭтоОшибка = РазделЗаполнен(ДанныеКС.ДанныеР91) 
		И НЕ Показатели.Р91С040.Значение = Показатели.Р09С250.Значение;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверкаКС_1_23д()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по ставке 20% в стр.050 Приложения 1 к Разделу 9 должна быть равна ';
			|en = 'Сумма налога по ставке 20% в стр.050 Приложения 1 к Разделу 9 должна быть равна '") +
		НСтр("ru = 'значению стр.260 Раздела 9';
			|en = 'значению стр.260 Раздела 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
	...
	Настройки.ЭтоОшибка = РазделЗаполнен(ДанныеКС.ДанныеР91) 
		И НЕ Показатели.Р91С050.Значение = Показатели.Р09С260.Значение;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверкаКС_1_23е()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по ставке 18% в стр.055 Приложения 1 к Разделу 9 должна быть равна ';
			|en = 'Сумма налога по ставке 18% в стр.055 Приложения 1 к Разделу 9 должна быть равна '") +
		НСтр("ru = 'значению стр.265 Раздела 9';
			|en = 'значению стр.265 Раздела 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
	...
	Настройки.ЭтоОшибка = РазделЗаполнен(ДанныеКС.ДанныеР91) 
		И НЕ Показатели.Р91С055.Значение = Показатели.Р09С265.Значение;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверкаКС_1_23ж()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по ставке 10% в стр.060 Приложения 1 к Разделу 9 должна быть равна ';
			|en = 'Сумма налога по ставке 10% в стр.060 Приложения 1 к Разделу 9 должна быть равна '") +
		НСтр("ru = 'значению стр.270 Раздела 9';
			|en = 'значению стр.270 Раздела 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
	...
	Настройки.ЭтоОшибка = РазделЗаполнен(ДанныеКС.ДанныеР91) 
		И НЕ Показатели.Р91С060.Значение = Показатели.Р09С270.Значение;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверкаКС_1_23з()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Стоимость продаж, освобождаемых от налога в стр.070 Приложения 1 к Разделу 9 должна быть равна ';
			|en = 'Стоимость продаж, освобождаемых от налога в стр.070 Приложения 1 к Разделу 9 должна быть равна '") +
		НСтр("ru = 'значению стр.280 Раздела 9';
			|en = 'значению стр.280 Раздела 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможно ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
	...
	Настройки.ЭтоОшибка = РазделЗаполнен(ДанныеКС.ДанныеР91) 
		И НЕ Показатели.Р91С070.Значение = Показатели.Р09С280.Значение;
	Настройки.Расшифровка = ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверкаКС_1_24()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.24 (КС 13)';
													|en = '1.24 (КС 13)'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по стр.030 Раздела 1, подлежащая уплате в бюджет в соответствии с п.5 ст.173 НК РФ, ';
			|en = 'Сумма налога по стр.030 Раздела 1, подлежащая уплате в бюджет в соответствии с п.5 ст.173 НК РФ, '") +
		НСтр("ru = 'должна быть равна сумме стр.070 Раздела 12, с учетом погрешности округления (при наличии)';
			|en = 'должна быть равна сумме стр.070 Раздела 12, с учетом погрешности округления (при наличии)'"));
...
Процедура ПроверкаКС_1_25()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Если сумма налога в стр.050 Раздела 1 > 0, требуется соблюдение условия: стр.190 Раздела 8 + ';
			|en = 'Если сумма налога в стр.050 Раздела 1 > 0, требуется соблюдение условия: стр.190 Раздела 8 + '") +
		НСтр("ru = '(стр.190 - стр.005 Приложения 1 к Разделу 8) - (стр.260 + стр.265 + стр.270 Раздела 9) - ';
			|en = '(стр.190 - стр.005 Приложения 1 к Разделу 8) - (стр.260 + стр.265 + стр.270 Раздела 9) - '") +
		НСтр("ru = '(стр.200 + стр.205 + стр.210 Раздела 9 в которых стр.010 = 06) + (стр.340 + стр.345 + стр.350 - ';
			|en = '(стр.200 + стр.205 + стр.210 Раздела 9 в которых стр.010 = 06) + (стр.340 + стр.345 + стр.350 - '") +
		НСтр("ru = 'стр.050 - стр.055 - стр.060 Приложения 1 к Разделу 9) - (стр.280 + стр.285 + стр.290 Приложения ';
			|en = 'стр.050 - стр.055 - стр.060 Приложения 1 к Разделу 9) - (стр.280 + стр.285 + стр.290 Приложения '") +
		НСтр("ru = '1 к Разделу 9 в которых стр.090 = 06) > 0, с учетом погрешности округления (при наличии)';
			|en = '1 к Разделу 9 в которых стр.090 = 06) > 0, с учетом погрешности округления (при наличии)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 + (%2 - %3) - %4 + %5 Итог [%6] > 0';
													|en = '%1 + (%2 - %3) - %4 + %5 Итог [%6] > 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей возмещению';
			|en = 'Ошибка исчисления суммы НДС, подлежащей возмещению'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	РасчетнаяСумма = Показатели.Р08С190.Итог + Показатели.Р81С190.Итог - Показатели.Р81С005.Итог -(Показатели.Р09С260.Итог
		...
		+ Показатели.Р09С210К06.Итог) + Показатели.Р91С340.Итог + Показатели.Р91С345.Итог + Показатели.Р91С350.Итог 
...
Процедура ПроверкаКС_1_26а()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 161, п.4, 4.1 ст. 173 НК РФ';
													|en = 'ст. 161, п.4, 4.1 ст. 173 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'При условии отсутствия в стр.070 Раздела 2 кода 1011715, ';
			|en = 'При условии отсутствия в стр.070 Раздела 2 кода 1011715, '") +
		НСтр("ru = 'стр.060 Раздела 2 >= (стр.200 + стр.205 + стр.210 Раздела 9 в которых стр.010 = 06) + ';
			|en = 'стр.060 Раздела 2 >= (стр.200 + стр.205 + стр.210 Раздела 9 в которых стр.010 = 06) + '") +
		НСтр("ru = '(стр.280 + стр.285 + стр.290 Приложения 1 к Разделу 9 в которых стр.090 = 06), с учетом ';
			|en = '(стр.280 + стр.285 + стр.290 Приложения 1 к Разделу 9 в которых стр.090 = 06), с учетом '") +
		НСтр("ru = 'погрешности округления (при наличии)';
			|en = 'погрешности округления (при наличии)'"));
	...
	Код1011715Отсутствует = Ложь;
	ЗарегистрироватьФормулу(Настройки);
	
	Для каждого Лист02 Из ДанныеКС.ДанныеР02 Цикл
		ЗаполнитьИРасшифроватьПоказатель(Показатели.Р02С070, Лист02);
		Код1011715ОтсутствуетНаЛисте =  
			НЕ ЗначениеЗаполнено(Показатели.Р02С070.Значение) ИЛИ СтрНайти("1011715", Показатели.Р02С070.Значение) = 0;
		Если Код1011715ОтсутствуетНаЛисте Тогда
			ЗаполнитьИРасшифроватьПоказатель(Показатели.Р02С060, Лист02);
		КонецЕсли;
		Код1011715Отсутствует = Код1011715Отсутствует ИЛИ Код1011715ОтсутствуетНаЛисте ;
	КонецЦикла;
	...
	Настройки.ЭтоОшибка = Код1011715Отсутствует И Показатели.Р02С060.Итог < 
...
Процедура ПроверкаКС_1_26б()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'При условии наличия в стр.070 Раздела 2 кода 1011715, ';
			|en = 'При условии наличия в стр.070 Раздела 2 кода 1011715, '") +
		НСтр("ru = 'стр.060 Раздела 2 >= (стр.200 + стр.205 + стр.210 Раздела 9 в которых стр.010 = 41, 43, 44) + ';
			|en = 'стр.060 Раздела 2 >= (стр.200 + стр.205 + стр.210 Раздела 9 в которых стр.010 = 41, 43, 44) + '") +
		НСтр("ru = '(стр.280 + стр.285 + стр.290 Приложения 1 к Разделу 9 в которых стр.090 = 41, 43, 44) - ';
			|en = '(стр.280 + стр.285 + стр.290 Приложения 1 к Разделу 9 в которых стр.090 = 41, 43, 44) - '") +
		НСтр("ru = '(стр.180 Раздела 8 в которых стр.010 = 41, 43, 44) + (стр.180 Приложения 1 к Разделу 8 в ';
			|en = '(стр.180 Раздела 8 в которых стр.010 = 41, 43, 44) + (стр.180 Приложения 1 к Разделу 8 в '") +
		НСтр("ru = 'которых стр.010 = 41, 43, 44), с учетом погрешности округления (при наличии)';
			|en = 'которых стр.010 = 41, 43, 44), с учетом погрешности округления (при наличии)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= %2 - %3 + %4 Итог [%5]';
													|en = '%1 >= %2 - %3 + %4 Итог [%5]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
	...
	Настройки.ЭтоОшибка = Код1011715Присутствует И ПоказателиР02.Р02С060.Итог < 
		РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, РасчетнаяСумма);
...
Процедура ПроверкаКС_1_27()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.27 (КС 3)';
													|en = '1.27 (КС 3)'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 3';
														|en = 'Раздел 3'"));
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
...
Процедура ПроверкаКС_1_28()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.28 (КС 4)';
													|en = '1.28 (КС 4)'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 3';
														|en = 'Раздел 3'"));
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма показателей стр.190 Раздела 3, стр.030, 040 Раздела 4, стр.080, 090 Раздела 5, стр.060, ';
			|en = 'Сумма показателей стр.190 Раздела 3, стр.030, 040 Раздела 4, стр.080, 090 Раздела 5, стр.060, '") +
		НСтр("ru = '090, 150 Раздела 6 должна быть равна сумме стр.190 Раздела 8 и разницы стр.190 Приложения 1 к ';
			|en = '090, 150 Раздела 6 должна быть равна сумме стр.190 Раздела 8 и разницы стр.190 Приложения 1 к '") +
		НСтр("ru = 'Разделу 8 и стр.005 Приложения 1 к Разделу 8, с учетом погрешности округления (при наличии)';
			|en = 'Разделу 8 и стр.005 Приложения 1 к Разделу 8, с учетом погрешности округления (при наличии)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 Итог [%2...%3] = %4 Итог [%5]';
													|en = '%1 Итог [%2...%3] = %4 Итог [%5]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей вычету';
...
Процедура ПроверкаКС_1_29()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога, уплаченная налогоплательщиком таможенным органам при ввозе товаров на территорию РФ ';
			|en = 'Сумма налога, уплаченная налогоплательщиком таможенным органам при ввозе товаров на территорию РФ '") +
		НСтр("ru = 'в стр.150 Раздела 3, должна быть мешьше или равна сумме стр.180 Раздела 8, в которых стр.010 ';
			|en = 'в стр.150 Раздела 3, должна быть мешьше или равна сумме стр.180 Раздела 8, в которых стр.010 '") +
		НСтр("ru = 'Раздела 8 = 20 и сумме стр.180 Приложения 1 к Разделу 8, в которых стр.010 = 20, с учетом ';
			|en = 'Раздела 8 = 20 и сумме стр.180 Приложения 1 к Разделу 8, в которых стр.010 = 20, с учетом '") +
		НСтр("ru = 'погрешности округления (при наличии)';
			|en = 'погрешности округления (при наличии)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 ± 0,49 <= %2 + %3 Итог [%4]';
													|en = '%1 ± 0,49 <= %2 + %3 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей вычету';
			|en = 'Ошибка исчисления суммы НДС, подлежащей вычету'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_30()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.1 ст. 153, ст. 171, 172 НК РФ';
													|en = 'п.1 ст. 153, ст. 171, 172 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога, уплаченная налогоплательщиком налоговым органам при ввозе товаров в стр.160 Раздела 3 ';
			|en = 'Сумма налога, уплаченная налогоплательщиком налоговым органам при ввозе товаров в стр.160 Раздела 3 '") +
		НСтр("ru = 'должна быть равна сумме стр.180 Раздела 8, в которых стр.010 Раздела 8 = 19 и сумме стр.180 ';
			|en = 'должна быть равна сумме стр.180 Раздела 8, в которых стр.010 Раздела 8 = 19 и сумме стр.180 '") +
		НСтр("ru = 'Приложения 1 к Разделу 8, в которых стр.010 = 19, с учетом погрешности округления (при наличии)';
			|en = 'Приложения 1 к Разделу 8, в которых стр.010 = 19, с учетом погрешности округления (при наличии)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 ± 0,49 = %2 + %3 Итог [%4]';
													|en = '%1 ± 0,49 = %2 + %3 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей вычету';
...
Процедура ПроверкаКС_1_31()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога, уплаченная в бюджет в стр.180 гр.3 Раздела 3 должна быть равна сумме стр.180 ';
			|en = 'Сумма налога, уплаченная в бюджет в стр.180 гр.3 Раздела 3 должна быть равна сумме стр.180 '") +
		НСтр("ru = 'Раздела 8, в которых стр.010 Раздела 8 = 06 и сумме стр.180 Приложения 1 к Разделу 8, в которых ';
			|en = 'Раздела 8, в которых стр.010 Раздела 8 = 06 и сумме стр.180 Приложения 1 к Разделу 8, в которых '") +
		НСтр("ru = 'стр.010 = 06, с учетом погрешности округления (при наличии)';
			|en = 'стр.010 = 06, с учетом погрешности округления (при наличии)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 ± 0,49 = %2 + %3 Итог [%4]';
													|en = '%1 ± 0,49 = %2 + %3 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей вычету';
...
Процедура ПроверкаКС_1_32()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.32 (КС 5)';
													|en = '1.32 (КС 5)'"));
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по счету-фактуре в стр.190 Раздела 8 должна быть равна сумме стр.180 ';
			|en = 'Сумма налога по счету-фактуре в стр.190 Раздела 8 должна быть равна сумме стр.180 '") +
		НСтр("ru = 'Раздела 8';
			|en = 'Раздела 8'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
...
Процедура ПроверкаКС_1_33()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.33 (КС 6)';
													|en = '1.33 (КС 6)'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 1 к Разделу 8';
														|en = 'Приложение 1 к Разделу 8'"));
	Заголовки.Вставить("Комментарий"		, 
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по стр.190 Приложения 1 к Разделу 8 должна быть равна сумме стр.005 и 180 ';
			|en = 'Сумма налога по стр.190 Приложения 1 к Разделу 8 должна быть равна сумме стр.005 и 180 '") +
		НСтр("ru = 'Приложения 1 к Разделу 8';
			|en = 'Приложения 1 к Разделу 8'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 + %3 Итог [%4]';
													|en = '%1 = %2 + %3 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей вычету';
...
Процедура ПроверкаКС_1_34()
	...
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Стоимость продаж, облагаемых налогом по ставке 20% по стр.230 Раздела 9 должна быть равна ';
			|en = 'Стоимость продаж, облагаемых налогом по ставке 20% по стр.230 Раздела 9 должна быть равна '") +
		НСтр("ru = 'сумме стр.170 Раздела 9';
			|en = 'сумме стр.170 Раздела 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможна ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
			|en = 'Возможна ошибка исчисления суммы НДС, подлежащей уплате в бюджет'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_35()
	...
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Стоимость продаж, облагаемых налогом по ставке 10% по стр.240 Раздела 9 должна быть равна ';
			|en = 'Стоимость продаж, облагаемых налогом по ставке 10% по стр.240 Раздела 9 должна быть равна '") +
		НСтр("ru = 'сумме стр.180 Раздела 9';
			|en = 'сумме стр.180 Раздела 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможна ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
Процедура ПроверкаКС_1_36()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 164, 165, 167, 173 НК РФ';
													|en = 'ст. 164, 165, 167, 173 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Стоимость продаж, облагаемых налогом по ставке 0% по стр.250 Раздела 9 должна быть равна ';
			|en = 'Стоимость продаж, облагаемых налогом по ставке 0% по стр.250 Раздела 9 должна быть равна '") +
		НСтр("ru = 'сумме стр.190 Раздела 9';
			|en = 'сумме стр.190 Раздела 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможна ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
Процедура ПроверкаКС_1_37()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.37 (КС 7)';
													|en = '1.37 (КС 7)'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 9';
														|en = 'Раздел 9'"));
	Заголовки.Вставить("Комментарий"		, 
	...
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Сумма налога по ставке 20% в стр.260 Раздела 9 должна быть равна ';
			|en = 'Сумма налога по ставке 20% в стр.260 Раздела 9 должна быть равна '") +
		НСтр("ru = 'сумме стр.200 Раздела 9';
			|en = 'сумме стр.200 Раздела 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
Процедура ПроверкаКС_1_38()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.38 (КС 8)';
													|en = '1.38 (КС 8)'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 9';
														|en = 'Раздел 9'"));
	Заголовки.Вставить("Комментарий"		, 
	...
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Сумма налога по ставке 10% в стр.270 Раздела 9 должна быть равна ';
			|en = 'Сумма налога по ставке 10% в стр.270 Раздела 9 должна быть равна '") +
		НСтр("ru = 'сумме стр.210 Раздела 9';
			|en = 'сумме стр.210 Раздела 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
Процедура ПроверкаКС_1_39()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Стоимость продаж по ставке 20% в стр.310 Приложения 1 к Разделу 9 должна быть равна сумме ';
			|en = 'Стоимость продаж по ставке 20% в стр.310 Приложения 1 к Разделу 9 должна быть равна сумме '") +
		НСтр("ru = 'стр.020 и 250 Приложения 1 к Разделу 9';
			|en = 'стр.020 и 250 Приложения 1 к Разделу 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 + %3 Итог [%4]';
													|en = '%1 = %2 + %3 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможно ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
Процедура ПроверкаКС_1_40()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Стоимость продаж по ставке 10% в стр.320 Приложения 1 к Разделу 9 должна быть равна сумме ';
			|en = 'Стоимость продаж по ставке 10% в стр.320 Приложения 1 к Разделу 9 должна быть равна сумме '") +
		НСтр("ru = 'стр.030 и 260 Приложения 1 к Разделу 9';
			|en = 'стр.030 и 260 Приложения 1 к Разделу 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 + %3 Итог [%4]';
													|en = '%1 = %2 + %3 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможно ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
Процедура ПроверкаКС_1_41()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Стоимость продаж по ставке 0% в стр.330 Приложения 1 к Разделу 9 должна быть равна сумме ';
			|en = 'Стоимость продаж по ставке 0% в стр.330 Приложения 1 к Разделу 9 должна быть равна сумме '") +
		НСтр("ru = 'стр.040 и 270 Приложения 1 к Разделу 9';
			|en = 'стр.040 и 270 Приложения 1 к Разделу 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 + %3 Итог [%4]';
													|en = '%1 = %2 + %3 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможно ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
Процедура ПроверкаКС_1_42()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.42 (КС 10)';
													|en = '1.42 (КС 10)'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 1 к Разделу 9';
														|en = 'Приложение 1 к Разделу 9'"));
	Заголовки.Вставить("Комментарий"		, 
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по ставке 20% в стр.340 Приложения 1 к Разделу 9 должна быть равна сумме ';
			|en = 'Сумма налога по ставке 20% в стр.340 Приложения 1 к Разделу 9 должна быть равна сумме '") +
		НСтр("ru = 'стр.050 и 280 Приложения 1 к Разделу 9';
			|en = 'стр.050 и 280 Приложения 1 к Разделу 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 + %3 Итог [%4]';
													|en = '%1 = %2 + %3 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
Процедура ПроверкаКС_1_43()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.43 (КС 11)';
													|en = '1.43 (КС 11)'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 1 к Разделу 9';
														|en = 'Приложение 1 к Разделу 9'"));
	Заголовки.Вставить("Комментарий"		, 
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по ставке 10% в стр.350 Приложения 1 к Разделу 9 должна быть равна сумме ';
			|en = 'Сумма налога по ставке 10% в стр.350 Приложения 1 к Разделу 9 должна быть равна сумме '") +
		НСтр("ru = 'стр.060 и 290 Приложения 1 к Разделу 9';
			|en = 'стр.060 и 290 Приложения 1 к Разделу 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 + %3 Итог [%4]';
													|en = '%1 = %2 + %3 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
Процедура ПроверкаКС_1_44()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога в стр.070 Раздела 12 должна быть равна разнице значений ';
			|en = 'Сумма налога в стр.070 Раздела 12 должна быть равна разнице значений '") +
		НСтр("ru = 'стр.080 и 060 Раздела 12';
			|en = 'стр.080 и 060 Раздела 12'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 - %3 Итог [%4]';
													|en = '%1 = %2 - %3 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
Процедура ПроверкаКС_1_45()
	...
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Стоимость продаж, облагаемых налогом по ставке 18% по стр.235 Раздела 9 должна быть равна ';
			|en = 'Стоимость продаж, облагаемых налогом по ставке 18% по стр.235 Раздела 9 должна быть равна '") +
		НСтр("ru = 'сумме стр.175 Раздела 9';
			|en = 'сумме стр.175 Раздела 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможна ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
Процедура ПроверкаКС_1_46()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.46 (КС 9)';
													|en = '1.46 (КС 9)'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 9';
														|en = 'Раздел 9'"));
	Заголовки.Вставить("Комментарий"		, 
	...
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Сумма налога по ставке 18% в стр.265 Раздела 9 должна быть равна ';
			|en = 'Сумма налога по ставке 18% в стр.265 Раздела 9 должна быть равна '") +
		НСтр("ru = 'сумме стр.205 Раздела 9';
			|en = 'сумме стр.205 Раздела 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
Процедура ПроверкаКС_1_47()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Стоимость продаж по ставке 18% в стр.315 Приложения 1 к Разделу 9 должна быть равна сумме ';
			|en = 'Стоимость продаж по ставке 18% в стр.315 Приложения 1 к Разделу 9 должна быть равна сумме '") +
		НСтр("ru = 'стр.025 и 255 Приложения 1 к Разделу 9';
			|en = 'стр.025 и 255 Приложения 1 к Разделу 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 + %3 Итог [%4]';
													|en = '%1 = %2 + %3 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможно ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
Процедура ПроверкаКС_1_48()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.48 (КС 12)';
													|en = '1.48 (КС 12)'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Приложение 1 к Разделу 9';
														|en = 'Приложение 1 к Разделу 9'"));
	Заголовки.Вставить("Комментарий"		, 
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по ставке 18% в стр.345 Приложения 1 к Разделу 9 должна быть равна сумме ';
			|en = 'Сумма налога по ставке 18% в стр.345 Приложения 1 к Разделу 9 должна быть равна сумме '") +
		НСтр("ru = 'стр.055 и 285 Приложения 1 к Разделу 9';
			|en = 'стр.055 и 285 Приложения 1 к Разделу 9'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 + %3 Итог [%4]';
													|en = '%1 = %2 + %3 Итог [%4]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
Процедура ПроверкаКС_1_49()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.1, 4 ст. 174 НК РФ';
													|en = 'п.1, 4 ст. 174 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'При условии отражения в стр.070 Раздела 2 кода 1011700, стр.060 Раздела 2 = 0';
			|en = 'При условии отражения в стр.070 Раздела 2 кода 1011700, стр.060 Раздела 2 = 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = 0';
													|en = '%1 = 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможно нарушение срока уплаты суммы налога';
			|en = 'Возможно нарушение срока уплаты суммы налога'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_50()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'п.4, 6, 8 ст. 161 НК РФ';
													|en = 'п.4, 6, 8 ст. 161 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'При условии заполнения стр.040 - 060 Раздела 2, в стр.070 Раздела 2 указывается код ';
			|en = 'При условии заполнения стр.040 - 060 Раздела 2, в стр.070 Раздела 2 указывается код '") +
		НСтр("ru = '1011705, 1011709, 1011715, 1011716, 1011717, 1011718';
			|en = '1011705, 1011709, 1011715, 1011716, 1011717, 1011718'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = 1011705, 1011709, 1011715, 1011716, 1011717, 1011718';
													|en = '%1 = 1011705, 1011709, 1011715, 1011716, 1011717, 1011718'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Возможно указан неверный код';
			|en = 'Возможно указан неверный код'"));
	Настройки = ОбработатьНастройки(Заголовки);
	Настройки.Вставить("СтрокаОпераций"		, "1011705,1011709,1011715,1011716,1011717,1011718");

	Если Документирование Тогда
		Возврат;
	КонецЕсли;
	
	ПроверкаКС_1_50_код(Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_50_код(Настройки)
	...
	Для каждого Лист02 Из ДанныеКС.ДанныеР02 Цикл
		...
		Настройки.ЭтоОшибка = НЕ ЗначениеЗаполнено(Показатели.Р02С020.Значение) 
			...
			ИЛИ		СтрНайти(Настройки.СтрокаОпераций, Показатели.Р02С070.Значение) = 0);
		Настройки.Расшифровка = СтрЗаменить(Настройки.ШаблонРасшифровки, "%1", Показатели.Р02С070.ЗначениеСтр);
		ДополнитьСтруктуруОшибок(Настройки);
	КонецЦикла;
...
Процедура ПроверкаКС_1_51()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'При условии заполнения стр.020 - 060 Раздела 2, в стр.070 Раздела 2 указывается код 1011703';
			|en = 'При условии заполнения стр.020 - 060 Раздела 2, в стр.070 Раздела 2 указывается код 1011703'"));
	...
	Для каждого Лист02 Из ДанныеКС.ДанныеР02 Цикл
		...
		Настройки.ЭтоОшибка = ЗначениеЗаполнено(СтрЗаменить(Показатели.Р02С020.Значение, "-", "")) 
			...
			И ЗначениеЗаполнено(Показатели.Р02С060.Значение) И НЕ	Показатели.Р02С070.Значение = "1011703";
		Настройки.Расшифровка = СтрЗаменить(Настройки.ШаблонРасшифровки, "%1", Показатели.Р02С070.ЗначениеСтр);
		ДополнитьСтруктуруОшибок(Настройки);
	КонецЦикла;
...
Процедура ПроверкаКС_1_53а()
	...
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 найдено в списке значений';
													|en = '%1 найдено в списке значений'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
	...
	Если НЕ Список = Неопределено Тогда
		...
		Настройки.ЭтоОшибка = ЗначениеЗаполнено(Показатели.Р01С020.Значение) 
...
Процедура ПроверкаКС_1_53б()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение КБК в стр.040 Раздела 2 должно соответствовать списку допустимых значений';
			|en = 'Значение КБК в стр.040 Раздела 2 должно соответствовать списку допустимых значений'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 найдено в списке значений';
													|en = '%1 найдено в списке значений'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Неверный код КБК';
	...
	Если НЕ Список = Неопределено Тогда
		Для каждого Лист02 Из ДанныеКС.ДанныеР02 Цикл
			...
			Настройки.ЭтоОшибка = ЗначениеЗаполнено(Показатели.Р02С040.Значение) 
				И Список.Получить(Показатели.Р02С040.Значение) = Неопределено;
			Настройки.Расшифровка = СтрЗаменить(Настройки.ШаблонРасшифровки, "%1", Показатели.Р02С040.ЗначениеСтр);
			ДополнитьСтруктуруОшибок(Настройки);
		КонецЦикла;
	КонецЕсли;
...
Процедура ПроверкаКС_1_54а()
	...
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Неверный код ОКТМО';
			|en = 'Неверный код ОКТМО'"));
	Настройки = ОбработатьНастройки(Заголовки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_54б()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение ОКТМО в стр.050 Раздела 2 должно соответствовать Общероссийскому классификатору ';
			|en = 'Значение ОКТМО в стр.050 Раздела 2 должно соответствовать Общероссийскому классификатору '") +
		НСтр("ru = 'территорий муниципальных образований';
			|en = 'территорий муниципальных образований'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '(%1) найдено в списке значений';
													|en = '(%1) найдено в списке значений'"));
...
Процедура ПроверкаКС_1_55()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога, заявленная к возмещению в стр.056 Раздела 1 <= стр.050 Раздела 1';
			|en = 'Сумма налога, заявленная к возмещению в стр.056 Раздела 1 <= стр.050 Раздела 1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, заявленной к возмещению';
			|en = 'Ошибка исчисления суммы НДС, заявленной к возмещению'"));
	Настройки = ОбработатьНастройки(Заголовки);
	...
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.ДанныеР01);
	Настройки.ЭтоОшибка = Показатели.Р01С056.Значение > Показатели.Р01С050.Значение;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверкаКС_1_56()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога, подлежащая уплате в стр.090 Раздела 1 <= стр.118 Раздела 3';
			|en = 'Сумма налога, подлежащая уплате в стр.090 Раздела 1 <= стр.118 Раздела 3'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
	...
	Настройки.ЭтоОшибка = Показатели.Р01С090.Значение > Показатели.Р03С118.Значение;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверкаКС_1_57()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога, исчисленная к возмещению в стр.095 Раздела 1 <= стр.190 Раздела 3';
			|en = 'Сумма налога, исчисленная к возмещению в стр.095 Раздела 1 <= стр.190 Раздела 3'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей возмещению';
	...
	Настройки.ЭтоОшибка = Показатели.Р01С095.Значение > Показатели.Р03С190.Значение;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
&НаСервере
Процедура ПроверкаКС_1_58_доп()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.58.доп';
													|en = '1.58.доп'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 4';
														|en = 'Раздел 4'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 173 НК РФ';
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по стр.130 Раздела 4 должна быть равна сумме значений стр.050 и 080 за минусом ';
			|en = 'Сумма налога по стр.130 Раздела 4 должна быть равна сумме значений стр.050 и 080 за минусом '") +
		НСтр("ru = 'суммы значений стр.030 и 040 Раздела 4, если полученная разница > 0, иначе 0';
			|en = 'суммы значений стр.030 и 040 Раздела 4, если полученная разница > 0, иначе 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = (%2 + %3) - (%4 + %5) Итог [%6]';
													|en = '%1 = (%2 + %3) - (%4 + %5) Итог [%6]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
&НаСервере
Процедура ПроверкаКС_1_59_доп()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.59.доп';
													|en = '1.59.доп'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 6';
														|en = 'Раздел 6'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 173 НК РФ';
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по стр.160 Раздела 6 должна быть равна сумме значений стр.050, 100 и 130 за минусом ';
			|en = 'Сумма налога по стр.160 Раздела 6 должна быть равна сумме значений стр.050, 100 и 130 за минусом '") +
		НСтр("ru = 'суммы значений стр.060, 090 и 150 Раздела 6, если полученная разница > 0, иначе 0';
			|en = 'суммы значений стр.060, 090 и 150 Раздела 6, если полученная разница > 0, иначе 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = (%2 + %3 + %4) - (%5 + %6 + %7) Итог [%8]';
													|en = '%1 = (%2 + %3 + %4) - (%5 + %6 + %7) Итог [%8]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей уплате в бюджет';
...
&НаСервере
Процедура ПроверкаКС_1_60_доп()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.60.доп';
													|en = '1.60.доп'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 6';
														|en = 'Раздел 6'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст. 153, 164, 165, 167 НК РФ';
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма налога по стр.170 Раздела 6 должна быть равна сумме значений стр.060, 090 и 150 за минусом ';
			|en = 'Сумма налога по стр.170 Раздела 6 должна быть равна сумме значений стр.060, 090 и 150 за минусом '") +
		НСтр("ru = 'суммы значений стр.050, 100 и 130 Раздела 6, если полученная разница > 0, иначе 0';
			|en = 'суммы значений стр.050, 100 и 130 Раздела 6, если полученная разница > 0, иначе 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = (%2 + %3 + %4) - (%5 + %6 + %7) Итог [%8]';
													|en = '%1 = (%2 + %3 + %4) - (%5 + %6 + %7) Итог [%8]'"));
	Заголовки.Вставить("ОписаниеОшибки"		, 
		НСтр("ru = 'Ошибка исчисления суммы НДС, подлежащей вычету';
...
Процедура ПроверкаКС_1_62()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога в стр.040 Раздела 1 >= 0';
...
Процедура ПроверкаКС_1_63()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога в стр.050 Раздела 1 >= 0';
														|en = 'Сумма налога в стр.050 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	...
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.ДанныеР01);
	Настройки.ЭтоОшибка = Показатели.Р01С050.Значение < 0;
	Настройки.Расшифровка = СтрШаблон(Настройки.ШаблонРасшифровки,
...
Процедура ПроверкаКС_1_64()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@';
													|en = 'Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
	Заголовки.Вставить("ОписаниеКС"			, НСтр("ru = 'Сумма налога в стр.060 Раздела 2 >= 0';
														|en = 'Сумма налога в стр.060 Раздела 2 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма налога';
														|en = 'Ошибочная сумма налога'"));
	...
	Для каждого Лист02 Из ДанныеКС.ДанныеР02 Цикл
		...
		Настройки.ЭтоОшибка = Показатели.Р02С060.Значение < 0;
		Настройки.Расшифровка = СтрЗаменить(Настройки.ШаблонРасшифровки, "%1", Показатели.Р02С060.Значение);
		ДополнитьСтруктуруОшибок(Настройки);
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("Списки2022Кв1");
		...
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Строки Тогда
			...
			Для НомСтр = ВерхОбласти По НизОбласти Цикл
				...
				Если КодПоказателя <> "###" Тогда
					...
					ИначеЕсли Область.Имя = "КодыОпераций_Раздел2" Тогда
						
						Если КодПоказателя = "1011719" И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20220701' Тогда
							
							Продолжить;
							
						ИначеЕсли КодПоказателя = "1011720" И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20221001' Тогда
							
							Продолжить;
							
						КонецЕсли;
						
					ИначеЕсли Область.Имя = "КодыОпераций_Раздел4" Тогда
						
						Если (КодПоказателя = "1011455" ИЛИ КодПоказателя = "1011456" ИЛИ КодПоказателя = "1011457")
							И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20220701' Тогда
							
							Продолжить;
							
						ИначеЕсли (КодПоказателя = "1011458" ИЛИ КодПоказателя = "1011459")
							И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20221001' Тогда
							
							Продолжить;
							
						ИначеЕсли (КодПоказателя = "1011460" ИЛИ КодПоказателя = "1011461" ИЛИ КодПоказателя = "1011462"
							ИЛИ КодПоказателя = "1011463" ИЛИ КодПоказателя = "1011464" ИЛИ КодПоказателя = "1011465"
							ИЛИ КодПоказателя = "1011466" ИЛИ КодПоказателя = "1011467")
							И НачалоДня(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) < НачалоДня('20220930') Тогда
					...
					ИначеЕсли Область.Имя = "КодыОпераций_Раздел7" Тогда
						...
						Если (КодПоказателя = "1010834" ИЛИ КодПоказателя = "1011216" ИЛИ КодПоказателя = "1011219"
							ИЛИ КодПоказателя = "1011222") И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20221001' Тогда
							
							Продолжить;
							
						ИначеЕсли (КодПоказателя = "1011215" ИЛИ КодПоказателя = "1011217")
							И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20220701' Тогда
...
Процедура СохранитьОтчет(Команда)
	...
	Если (НЕ АвтоЗаполнениеРеглОтчетаДоступно()
		...
		|en = 'Декларация по НДС сдана. Запись запрещена.
		|Для подготовки уточненной декларации создайте новый отчет.'"));
		Возврат;
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если (НЕ СтруктураРеквизитовФормы.АвтоЗаполнениеРеглОтчетаДоступно
		...
		Если ЗавершениеРаботы Тогда
			...
			|Для подготовки уточненной декларации создайте новый отчет.';
			|en = 'Декларация по НДС сдана. Изменения не сохранены.
			|Для подготовки уточненной декларации создайте новый отчет.'");
		...
		Если КодОперации = "1011705" ИЛИ КодОперации = "1011707" Тогда
			...
			Если ТекущаяОбластьИмя = "П000200007003"
				...
				Сообщение.Текст = НСтр("ru = 'Значения по строкам 060, 080, 090, 100 раздела 2 очищены вследствие изменения кода операции по строке 070.';
										|en = 'Значения по строкам 060, 080, 090, 100 раздела 2 очищены вследствие изменения кода операции по строке 070.'");
		...
		Иначе
			...
			Если Строка060БылаАвторасчитываемая
				...
				Сообщение.Текст = НСтр("ru = 'Значение по строке 060 раздела 2 очищено вследствие изменения кода операции по строке 070.';
										|en = 'Значение по строке 060 раздела 2 очищено вследствие изменения кода операции по строке 070.'");
...
Процедура ВставитьДополнительнуюСтраницуНаСервере(ИмяТекущейСтраницыПанели = Неопределено)
	...
	Иначе
		...
		Если МаксКолвоЭкз <> 0 И ЭтаФорма[мСтруктураМногостраничныхРазделов[ИмяТекущейСтраницыПанели]].Количество() >= МаксКолвоЭкз Тогда
			...
			|en = 'В разделе ""%1"" максимальное количество экземпляров страниц равно %2.'"),
...
Процедура ДобавитьСтроку(Команда)
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1" Тогда
		...
		Если СтрНайти(ТабличныйДокумент.ТекущаяОбласть.Имя, "М1") > 0
			И ТабличныйДокумент.Области.Найти("П0001М1005503_7") <> Неопределено Тогда
			ТекстПредупреждения = НСтр("ru = 'Возможно не более 7 строк 055 в разделе 1';
										|en = 'Возможно не более 7 строк 055 в разделе 1'");
		КонецЕсли;
...
Процедура УдалитьСтроку(Команда)
	...
	НСтр("ru = 'Удалить выбранную строку?';
		|en = 'Удалить выбранную строку?'"), Символы.ПС);
			...
			Если СтрНачинаетсяС(Область.Имя, "П0001М1005503") Тогда
				...
				Пока Обл <> Неопределено Цикл
					Если Обл.Имя <> Область.Имя И СокрЛП(Область.Значение) <> ""
						...
						|en = 'Код основания применения заявительного порядка возмещения налога ""%1"" уже заполнен. Значение очищено'"),
			...
			ИначеЕсли Область.Имя = "П000100009003" ИЛИ Область.Имя = "П000100009503" Тогда
				...
				Если ОблПарногоПоказателя <> Неопределено Тогда
					...
					Если ЗначениеЗаполнено(ЗначПоказателя) И ЗначениеЗаполнено(ЗначПарногоПоказателя) Тогда
						...
						|en = 'Не допускается одновременное заполнение строк %1 и %2. Значение в строке %2 очищено'"),
...
Процедура ЗаполнитьАвто(Команда) Экспорт
	...
	Если НЕ АвтоЗаполнениеРеглОтчетаДоступно()
		...
		|Для подготовки уточненной декларации создайте новый отчет.';
		|en = 'Декларация по НДС сдана. Автоматическое заполнение запрещено.
		|Для подготовки уточненной декларации создайте новый отчет.'"));
		Возврат;
...
Процедура ЗаполнитьАвтоПредупредитьОСохранении(Отказ, ДополнительныеПараметры) Экспорт
	...
	ТекстВопроса = НСтр("ru = 'Автоматическое заполнение приведет к сохранению отчета с новыми данными. Заполнить отчет?';
						|en = 'Автоматическое заполнение приведет к сохранению отчета с новыми данными. Заполнить отчет?'");
	...
	ЗаголовокВопроса = НСтр("ru = 'Автоматическое заполнение отчета';
							|en = 'Автоматическое заполнение отчета'");
...
Функция ЗаполнитьАвтоНаСервере()
	...
	ЭтаФормаИмя = "ВнешнийОтчет.РегламентированныйОтчетНДС.Форма.ФормаОтчета2022Кв1";
...
Процедура ТабличныйДокументПриАктивизации(Элемент)
	...
	Если СтрЧислоВхождений(Элемент.ТекущаяОбласть.Имя, "УдалитьСтроку") = 0
		И (СтрНачинаетсяС(Элемент.ТекущаяОбласть.Имя, "П0001М1")
		ИЛИ СтрЧислоВхождений(Элемент.ТекущаяОбласть.Имя, "П0003200001") > 0
...
Процедура ПоказатьРекомендацииПриОшибкеПодключения()
	Если СтрНачинаетсяС(ЭтаФорма.ИмяФормы, "Внешний") Тогда
...
Функция СтрокаФНСОшибкаПодключения()
	...
	ЧастиСтроки.Добавить(НСтр("ru = ' Проверка контрагентов сервисом ФНС не выполнена из-за ';
								|en = ' Проверка контрагентов сервисом ФНС не выполнена из-за '"));
	ЧастиСтроки.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'ошибки подключения к сервису';
															|en = 'ошибки подключения к сервису'"),
	...
	ИначеЕсли РезультатПроверкиВыгрузки.КоличествоОбнаруженныхОшибок = 0
		...
		Если РезультатПроверкиКонтрагентов.ОшибкаПодключенияКСервису Тогда
			...
			Если ПроверкаКонтрагентовОтклонена Тогда
				...
				|en = 'Нет ошибок, препятствующих отправке декларации. Проверка контрагентов сервисом ФНС отключена.'"));
			...
			Иначе
				...
				ЧастиСтроки.Добавить(НСтр("ru = 'Нет ошибок, препятствующих отправке декларации.';
											|en = 'Нет ошибок, препятствующих отправке декларации.'"));
		...
		Иначе
			...
			|en = 'Нет ошибок, препятствующих отправке декларации, и ошибок проверки контрагентов сервисом ФНС.'"));
	...
	ИначеЕсли РезультатПроверкиВыгрузки.КоличествоОбнаруженныхОшибок > 0
		...
		Если РезультатПроверкиКонтрагентов.ОшибкаПодключенияКСервису Тогда
			...
			Если ПроверкаКонтрагентовОтклонена Тогда
				ТекстРезультатаПроверки.Добавить(НСтр("ru = '. Проверка контрагентов сервисом ФНС отключена.';
														|en = '. Проверка контрагентов сервисом ФНС отключена.'"));
			Иначе
		...
		Иначе
			...
			ТекстРезультатаПроверки.Добавить(НСтр("ru = '. Нет ошибок проверки контрагентов сервисом ФНС.';
													|en = '. Нет ошибок проверки контрагентов сервисом ФНС.'"));
...
Функция ФорматированныйТекстРезультатаПроверки(КолвоОшибок, НаимОперации)
	...
	ИначеЕсли (Прав(Строка(КолвоОшибок), 1) = "2"
		...
		Если НаимОперации = "ПроверкаВыгрузки" Тогда
			...
			ТекстРезультатаПроверки.Добавить(Новый ФорматированнаяСтрока(Строка(КолвоОшибок)
			+ НСтр("ru = ' ошибки';
					|en = ' ошибки'"), , , , "ПоказатьОшибкиПроверкиВыгрузки"));
			
			ТекстРезультатаПроверки.Добавить(НСтр("ru = ', препятствующие отправке декларации';
													|en = ', препятствующие отправке декларации'"));
			
		ИначеЕсли НаимОперации = "ПроверкаКС" Тогда
			
			ТекстРезультатаПроверки.Добавить(Новый ФорматированнаяСтрока(Строка(КолвоОшибок)
			+ НСтр("ru = ' ошибки';
					|en = ' ошибки'"), , , , "ПоказатьОшибкиПроверкиКС"));
		...
		ИначеЕсли НаимОперации = "ПроверкаКонтрагентов" Тогда
			...
			ТекстРезультатаПроверки.Добавить(Новый ФорматированнаяСтрока(Строка(КолвоОшибок)
			+ НСтр("ru = ' ошибки';
					|en = ' ошибки'"), , , , "ПоказатьОшибкиПроверкиКонтрагентов"));
	...
	Иначе
		...
		Если НаимОперации = "ПроверкаВыгрузки" Тогда
			...
			ТекстРезультатаПроверки.Добавить(Новый ФорматированнаяСтрока(Строка(КолвоОшибок)
			+ НСтр("ru = ' ошибок';
					|en = ' ошибок'"), , , , "ПоказатьОшибкиПроверкиВыгрузки"));
			
			ТекстРезультатаПроверки.Добавить(НСтр("ru = ', препятствующих отправке декларации';
													|en = ', препятствующих отправке декларации'"));
			
		ИначеЕсли НаимОперации = "ПроверкаКС" Тогда
			
			ТекстРезультатаПроверки.Добавить(Новый ФорматированнаяСтрока(Строка(КолвоОшибок)
			+ НСтр("ru = ' ошибок';
					|en = ' ошибок'"), , , , "ПоказатьОшибкиПроверкиКС"));
		...
		ИначеЕсли НаимОперации = "ПроверкаКонтрагентов" Тогда
			...
			ТекстРезультатаПроверки.Добавить(Новый ФорматированнаяСтрока(Строка(КолвоОшибок)
			+ НСтр("ru = ' ошибок';
					|en = ' ошибок'"), , , , "ПоказатьОшибкиПроверкиКонтрагентов"));
...
Процедура ПроверитьВозможностьВыгрузкиВФоне()
	...
	НаименованиеЗадания = НСтр("ru = 'Проверка возможности формирования электронного представления';
								|en = 'Проверка возможности формирования электронного представления'");
	...
	Если ИмяСобытия = "ВыполненоСохранениеФайлаВыгрузки" Тогда
		...
		Если НЕ СтруктураРеквизитовФормы.ПодключенДокументооборотСКонтролирующимОрганом
		   И НЕ Элементы.НаименованиеЭтапа.Заголовок = "Сдано" Тогда
			...
			|en = 'Декларация выгружена, рекомендуется установить для нее состояние ""Сдано"".
			|Для сданной декларации редактирование запрещено. Состояние можно установить
			|или снять вручную в форме декларации.
			|
			|Установить для декларации состояние ""Сдано""?'");
