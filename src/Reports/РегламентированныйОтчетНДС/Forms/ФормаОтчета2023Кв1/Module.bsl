...
Процедура ПроверкаКС_1_09()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога, подлежащая уплате в бюджет в гр.3 стр.200 Раздела 3 = ';
			|en = 'Сумма налога, подлежащая уплате в бюджет в гр.3 стр.200 Раздела 3 = '") +
		НСтр("ru = '(гр.5 стр.118 - гр.3 стр.190) Раздела 3, если (гр.5 стр.118 - гр.3 стр.190) Раздела 3 >= 0';
			|en = '(гр.5 стр.118 - гр.3 стр.190) Раздела 3, если (гр.5 стр.118 - гр.3 стр.190) Раздела 3 >= 0'"));
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
	...
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 25.05.2021 N ЕД-7-15/519@';
													|en = 'Приказ ФНС России от 25.05.2021 N ЕД-7-15/519@'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_20()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога, подлежащая к уплате в бюджет в стр.040 Раздела 1 = (стр.200 ';
			|en = 'Сумма налога, подлежащая к уплате в бюджет в стр.040 Раздела 1 = (стр.200 '") +
		...
		НСтр("ru = 'стр.080 Раздела 5 + стр.090 Раздела 5 + стр.170 Раздела 6), если результат > 0, иначе 0';
			|en = 'стр.080 Раздела 5 + стр.090 Раздела 5 + стр.170 Раздела 6), если результат > 0, иначе 0'"));
...
Процедура ПроверкаКС_1_27()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'стр.050, 130 Раздела 6 = сумме показателей стр.260, 265, 270 Раздела 9, ';
			|en = 'стр.050, 130 Раздела 6 = сумме показателей стр.260, 265, 270 Раздела 9, '") +
		...
		НСтр("ru = 'Приложения 1 к Разделу 9, с учетом погрешности округления 1 руб.';
			|en = 'Приложения 1 к Разделу 9, с учетом погрешности округления 1 руб.'"));
	...
	Заголовки.Вставить("Комментарий"		, 
		НСтр("ru = 'Возможно ложное срабатывание в результате влияния погрешности округления';
			|en = 'Возможно ложное срабатывание в результате влияния погрешности округления'"));
	ПодготовитьНастройки(Заголовки);
	...
	ШаблонДетализацииРазделов	= НСтр("ru = '%1 + %2 + %3 + %4 + %5 + %6';
										|en = '%1 + %2 + %3 + %4 + %5 + %6'");
	ШаблонДетализацииКнигПрод	= НСтр("ru = '%1 + %2 + %3 + %4 + %5 + %6 - %7 - %8 - %9';
...
Процедура ПроверкаКС_1_28()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '090, 150 Раздела 6 = сумме стр.190 Раздела 8 и разницы стр.190 Приложения 1 к ';
			|en = '090, 150 Раздела 6 = сумме стр.190 Раздела 8 и разницы стр.190 Приложения 1 к '") +
		НСтр("ru = 'Разделу 8 и стр.005 Приложения 1 к Разделу 8, с учетом погрешности округления 1 руб.';
			|en = 'Разделу 8 и стр.005 Приложения 1 к Разделу 8, с учетом погрешности округления 1 руб.'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 (%2) ± 1 руб. = %3 (%4)';
													|en = '%1 (%2) ± 1 руб. = %3 (%4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая вычету';
													|en = 'Возможно ошибочная сумма НДС, подлежащая вычету'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните показатели для соблюдения равенства");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 25.05.2021 N ЕД-7-15/519@';
													|en = 'Приказ ФНС России от 25.05.2021 N ЕД-7-15/519@'"));
	Заголовки.Вставить("Комментарий"		, 
...
Процедура ПроверкаКС_1_32()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога по счету-фактуре в стр.190 Раздела 8 = стр.180 Раздела 8';
			|en = 'Сумма налога по счету-фактуре в стр.190 Раздела 8 = стр.180 Раздела 8'"));
...
Процедура ПроверкаКС_1_33()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.190 Приложения 1 к Разделу 8 = стр.(005 + 180) Приложения 1 к Разделу 8';
			|en = 'Сумма налога в стр.190 Приложения 1 к Разделу 8 = стр.(005 + 180) Приложения 1 к Разделу 8'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 + %3)';
													|en = '%1 = %4 (%2 + %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая вычету';
													|en = 'Возможно ошибочная сумма НДС, подлежащая вычету'"));
...
Процедура ПроверкаКС_1_37()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'Сумма налога по ставке 20% в стр.260 Раздела 9 = сумме стр.200 Раздела 9';
			|en = 'Сумма налога по ставке 20% в стр.260 Раздела 9 = сумме стр.200 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_38()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'Сумма налога по ставке 10% в стр.270 Раздела 9  = сумме стр.210 Раздела 9';
			|en = 'Сумма налога по ставке 10% в стр.270 Раздела 9  = сумме стр.210 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_46()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'Сумма налога по ставке 18% в стр.265 Раздела 9 = стр.205 Раздела 9';
			|en = 'Сумма налога по ставке 18% в стр.265 Раздела 9 = стр.205 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_42()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога по ставке 20% в стр.340 Приложения 1 к Разделу 9 = стр.(050 + 280) Приложения 1 ';
			|en = 'Сумма налога по ставке 20% в стр.340 Приложения 1 к Разделу 9 = стр.(050 + 280) Приложения 1 '") +
		НСтр("ru = 'к Разделу 9';
			|en = 'к Разделу 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 + %3)';
													|en = '%1 = %4 (%2 + %3)'"));
...
Процедура ПроверкаКС_1_43()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога по ставке 10% в стр.350 Приложения 1 к Разделу 9 = стр.(060 + 290) Приложения 1 ';
			|en = 'Сумма налога по ставке 10% в стр.350 Приложения 1 к Разделу 9 = стр.(060 + 290) Приложения 1 '") +
		НСтр("ru = 'к Разделу 9';
			|en = 'к Разделу 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 + %3)';
													|en = '%1 = %4 (%2 + %3)'"));
...
Процедура ПроверкаКС_1_48()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога по ставке 18% в стр.345 Приложения 1 к Разделу 9 = стр.(055 + 285) Приложения 1 ';
			|en = 'Сумма налога по ставке 18% в стр.345 Приложения 1 к Разделу 9 = стр.(055 + 285) Приложения 1 '") +
		НСтр("ru = 'к Разделу 9';
			|en = 'к Разделу 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %4 (%2 + %3)';
													|en = '%1 = %4 (%2 + %3)'"));
...
Процедура ПроверкаКС_1_24()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.030 Раздела 1 = сумме стр.070 Раздела 12, ';
			|en = 'Сумма налога в стр.030 Раздела 1 = сумме стр.070 Раздела 12, '") +
		НСтр("ru = 'с учетом погрешности округления (при наличии)';
			|en = 'с учетом погрешности округления (при наличии)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 ± 0,49';
													|en = '%1 = %2 ± 0,49'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
	...
	Заголовки.Вставить("Комментарий"		, 
		НСтр("ru = 'Возможно срабатывание в результате влияния погрешности округления показателей';
			|en = 'Возможно срабатывание в результате влияния погрешности округления показателей'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.ЭтоОшибка = НЕ Показатели.Р01С030.Значение = Окр(Показатели.Р12С070.Значение);
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
...
Процедура ПроверкаКС_1_01()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.1';
													|en = '1.1'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Гр.3 стр.180 Раздела 3 <= стр.060 Раздела 2 декларации прошлого (прошлых) налоговых периодов, ';
			|en = 'Гр.3 стр.180 Раздела 3 <= стр.060 Раздела 2 декларации прошлого (прошлых) налоговых периодов, '") +
		НСтр("ru = 'если покупка принята к вычету и стр.070 Раздела 2 = 1011703, 1011720, 1011721';
			|en = 'если покупка принята к вычету и стр.070 Раздела 2 = 1011703, 1011720, 1011721'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("Нарушение"			, 
		НСтр("ru = 'Возможно необоснованное применение вычетов налоговым агентом';
			|en = 'Возможно необоснованное применение вычетов налоговым агентом'"));
	Заголовки.Вставить("Рекомендации"		, "");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.161, 171, 172, 174 НК РФ';
...
Процедура ПроверкаКС_1_02()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в гр.3 стр.180 Раздела 3 = 0, если стр.070 Раздела 2 = 1011705, 1011707, ';
			|en = 'Сумма налога в гр.3 стр.180 Раздела 3 = 0, если стр.070 Раздела 2 = 1011705, 1011707, '") +
		НСтр("ru = '1011714, 1011719';
			|en = '1011714, 1011719'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 0';
													|en = '%1 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибка исчисления суммы НДС, подлежащей вычету';
													|en = 'Возможно ошибка исчисления суммы НДС, подлежащей вычету'"));
...
Процедура ПроверкаКС_1_03()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Cумма налога в стр.060 Раздела 2 = (стр.080 + стр.090 - стр.100) Раздела 2, ';
			|en = 'Cумма налога в стр.060 Раздела 2 = (стр.080 + стр.090 - стр.100) Раздела 2, '") +
		НСтр("ru = 'если стр.070 Раздела 2 = 1011705, 1011707';
			|en = 'если стр.070 Раздела 2 = 1011705, 1011707'"));
...
Процедура ПроверкаКС_1_04()
	...
	// проверка отключена по многочисленным обращениям пользователей
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.4';
													|en = '1.4'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Требуется соблюдение равенства: гр.3 (стр.010 + стр.020 + стр.030 + стр.040 + стр.041 + стр.042) ';
			|en = 'Требуется соблюдение равенства: гр.3 (стр.010 + стр.020 + стр.030 + стр.040 + стр.041 + стр.042) '") +
		НСтр("ru = 'Раздела 3) / (гр.3 (стр.010 + стр.020 + стр.030 + стр.040 + стр.041 + стр.042) Раздела 3 + ';
			|en = 'Раздела 3) / (гр.3 (стр.010 + стр.020 + стр.030 + стр.040 + стр.041 + стр.042) Раздела 3 + '") +
		НСтр("ru = '(сумма гр.2 Раздела 7 по кодам 1010800 - 1010830)) = гр.3 (стр.120 + стр.150 + стр.160) Раздела 3 ';
			|en = '(сумма гр.2 Раздела 7 по кодам 1010800 - 1010830)) = гр.3 (стр.120 + стр.150 + стр.160) Раздела 3 '") +
		НСтр("ru = '/ (гр.3 (стр.120 + стр.150 + стр.160) Раздела 3 + (сумма гр.4 Раздела 7 по кодам 1010800 - 1010830))';
			|en = '/ (гр.3 (стр.120 + стр.150 + стр.160) Раздела 3 + (сумма гр.4 Раздела 7 по кодам 1010800 - 1010830))'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%3 (%1 / (%1 + %2)) = %6( %4 / (%4 + %5))';
													|en = '%3 (%1 / (%1 + %2)) = %6( %4 / (%4 + %5))'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая вычету';
													|en = 'Возможно ошибочная сумма НДС, подлежащая вычету'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните суммы НДС в Разделах 3, 7");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст.149, п.4 ст.170 НК РФ';
													|en = 'ст.149, п.4 ст.170 НК РФ'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru = 'Отключена по обращениям пользователей';
													|en = 'Отключена по обращениям пользователей'"));
	ПодготовитьНастройки(Заголовки);
	...
	ПоказателиЛевЧисл = СформироватьПоказатели(ИменаПоказателейЛевЧисл);
	ПоказателиЛевЗнам = СформироватьПоказатели(ИменаПоказателейЛевЗнам);
	ПоказателиПрвЧисл = СформироватьПоказатели(ИменаПоказателейПрвЧисл);
	ПоказателиПрвЗнам = СформироватьПоказатели(ИменаПоказателейПрвЗнам);
	...
	НастройкиКС.ЭтоОшибка = НЕ РасчетнаяСуммаЛев = РасчетнаяСуммаПрв И Ложь;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
...
Процедура ПроверкаКС_1_05()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Гр.5 стр.080 Раздела 3 >= гр.5 (стр.090 + стр.100) Раздела 3 + гр.4 стр.070 Приложения 1 к ';
			|en = 'Гр.5 стр.080 Раздела 3 >= гр.5 (стр.090 + стр.100) Раздела 3 + гр.4 стр.070 Приложения 1 к '") +
		НСтр("ru = 'Разделу 3 по кодам 1011801, 1011802, 1011803, 1011805, 1011806, 1011807, 1011808 за отчетный ';
			|en = 'Разделу 3 по кодам 1011801, 1011802, 1011803, 1011805, 1011806, 1011807, 1011808 за отчетный '") +
		НСтр("ru = 'год, указанный в гр.1 стр.070 Приложения 1 к Разделу 3 и соответствующий отчетному году на ';
			|en = 'год, указанный в гр.1 стр.070 Приложения 1 к Разделу 3 и соответствующий отчетному году на '") +
		НСтр("ru = 'Титульном листе';
			|en = 'Титульном листе'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %5 (%2 + %3 + %4)';
													|en = '%1 >= %5 (%2 + %3 + %4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая восстановлению';
													|en = 'Возможно ошибочная сумма НДС, подлежащая восстановлению'"));
...
Процедура ПроверкаКС_1_06()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Гр.5 (стр.080 - стр.090 - стр.100) Раздела 3 >= суммы гр.4 стр.070 Приложения 1 к Разделу 3 ';
			|en = 'Гр.5 (стр.080 - стр.090 - стр.100) Раздела 3 >= суммы гр.4 стр.070 Приложения 1 к Разделу 3 '") +
		НСтр("ru = 'по кодам 1011801, 1011802, 1011803, 1011805, 1011806, 1011807, 1011808 за отчетный год, указанный ';
			|en = 'по кодам 1011801, 1011802, 1011803, 1011805, 1011806, 1011807, 1011808 за отчетный год, указанный '") +
		НСтр("ru = 'в гр.1 стр.070 Приложения 1 к Разделу 3 и соответствующий отчетному году на титульном листе';
			|en = 'в гр.1 стр.070 Приложения 1 к Разделу 3 и соответствующий отчетному году на титульном листе'"));
...
Процедура ПроверкаКС_1_07()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.7';
													|en = '1.7'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в гр.5 стр.118 Раздела 3 >= гр.5 (стр.010 + стр.020 + стр.030 + стр.040 + стр.041 + ';
			|en = 'Сумма налога в гр.5 стр.118 Раздела 3 >= гр.5 (стр.010 + стр.020 + стр.030 + стр.040 + стр.041 + '") +
		НСтр("ru = 'стр.042 + стр.045 + стр.046 + стр.050 + стр.060 + стр.070 + стр.080 + стр.105 + стр.109 + ';
			|en = 'стр.042 + стр.045 + стр.046 + стр.050 + стр.060 + стр.070 + стр.080 + стр.105 + стр.109 + '") +
		НСтр("ru = 'стр.110 + стр.115) Раздела 3';
			|en = 'стр.110 + стр.115) Раздела 3'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_08()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма НДС, подлежащая вычету в гр.3 стр.190 Раздела 3 <= гр.3 (стр.120 + стр.130 + стр.135 + ';
			|en = 'Сумма НДС, подлежащая вычету в гр.3 стр.190 Раздела 3 <= гр.3 (стр.120 + стр.130 + стр.135 + '") +
		НСтр("ru = 'стр.140 + стр.150 + стр.160 + стр.170 + стр.180 + стр.185) Раздела 3';
			|en = 'стр.140 + стр.150 + стр.160 + стр.170 + стр.180 + стр.185) Раздела 3'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащей возмещению';
													|en = 'Возможно ошибочная сумма НДС, подлежащей возмещению'"));
...
Процедура ПроверкаКС_1_10()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога, исчисленная к возмещению в гр.3 стр.210 Раздела 3 <= ';
			|en = 'Сумма налога, исчисленная к возмещению в гр.3 стр.210 Раздела 3 <= '") +
		НСтр("ru = '(гр.3 стр.190 - гр.5 стр.118) Раздела 3, если (гр.3 стр.190 - гр.5 стр.118) Раздела 3 > 0';
			|en = '(гр.3 стр.190 - гр.5 стр.118) Раздела 3, если (гр.3 стр.190 - гр.5 стр.118) Раздела 3 > 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %4 (%2 - %3)';
													|en = '%1 <= %4 (%2 - %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, исчисленная к возмещению';
													|en = 'Возможно ошибочная сумма НДС, исчисленная к возмещению'"));
...
Процедура ПроверкаКС_1_11()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '1.11';
													|en = '1.11'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога, подлежащей вычету в гр.3 стр.170 Раздела 3 <= гр.5 (стр.010 + стр.020 + ';
			|en = 'Сумма налога, подлежащей вычету в гр.3 стр.170 Раздела 3 <= гр.5 (стр.010 + стр.020 + '") +
		НСтр("ru = 'стр.030 + стр.040) Раздела 3';
			|en = 'стр.030 + стр.040) Раздела 3'"));
	...
	Заголовки.Вставить("Основание"			, НСтр("ru = 'п.8 ст.171, п.6 ст.172, п.1 ст.146 НК РФ';
													|en = 'п.8 ст.171, п.6 ст.172, п.1 ст.146 НК РФ'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Проверка носит справочный характер';
													|en = 'Проверка носит справочный характер'"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
		...
		Показатели.Р03С030Г5.Значение, Показатели.Р03С040Г5.Значение);
	ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_1_12()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма НДС по выполненным СМР в гр.5 стр.060 Раздела 3 >= гр.3 стр.140 Раздела 3';
			|en = 'Сумма НДС по выполненным СМР в гр.5 стр.060 Раздела 3 >= гр.3 стр.140 Раздела 3'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибка исчисления суммы НДС, подлежащей вычету';
													|en = 'Возможно ошибка исчисления суммы НДС, подлежащей вычету'"));
	...
	Заголовки.Вставить("Основание"			, НСтр("ru = 'п.6 ст.171, п.5 ст.172 НК РФ';
													|en = 'п.6 ст.171, п.5 ст.172 НК РФ'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Проверка носит справочный характер';
													|en = 'Проверка носит справочный характер'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_13()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма исчисленного налога в гр.2 Приложения 2 к Разделу 3 <= гр.5 стр.118 Раздела 3';
			|en = 'Сумма исчисленного налога в гр.2 Приложения 2 к Разделу 3 <= гр.5 стр.118 Раздела 3'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("Нарушение"		, 
...
Процедура ПроверкаКС_1_14()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налоговых вычетов в гр.3 Приложения 2 к Разделу 3 <= гр.3 стр.190 Раздела 3';
			|en = 'Сумма налоговых вычетов в гр.3 Приложения 2 к Разделу 3 <= гр.3 стр.190 Раздела 3'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая вычету';
													|en = 'Возможно ошибочная сумма НДС, подлежащая вычету'"));
...
Процедура ПроверкаКС_1_15()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.120 Раздела 4 <= стр.(030 + 040 - 050 - 080) Раздела 4, ';
			|en = 'Сумма налога в стр.120 Раздела 4 <= стр.(030 + 040 - 050 - 080) Раздела 4, '") +
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая возмещению';
													|en = 'Возможно ошибочная сумма НДС, подлежащая возмещению'"));
...
Процедура ПроверкаКС_1_16()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.080 Раздела 5 <= сумме стр.050 Раздела 5';
													|en = 'Сумма налога в стр.080 Раздела 5 <= сумме стр.050 Раздела 5'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая вычету';
													|en = 'Возможно ошибочная сумма НДС, подлежащая вычету'"));
...
Процедура ПроверкаКС_1_17()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.090 Раздела 5 <= сумме стр.070 Раздела 5';
													|en = 'Сумма налога в стр.090 Раздела 5 <= сумме стр.070 Раздела 5'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая вычету';
													|en = 'Возможно ошибочная сумма НДС, подлежащая вычету'"));
...
Процедура ПроверкаКС_1_18()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.050 Раздела 6 >= сумме стр.030 Раздела 6';
													|en = 'Сумма налога в стр.050 Раздела 6 >= сумме стр.030 Раздела 6'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_19()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.060 Раздела 6 <= сумме стр.040 Раздела 6';
													|en = 'Сумма налога в стр.060 Раздела 6 <= сумме стр.040 Раздела 6'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая вычету';
													|en = 'Возможно ошибочная сумма НДС, подлежащая вычету'"));
...
Процедура ПроверкаКС_1_21()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога, исчисленная к возмещению из бюджета в стр.050 Раздела 1 = (стр.210 ';
			|en = 'Сумма налога, исчисленная к возмещению из бюджета в стр.050 Раздела 1 = (стр.210 '") +
		...
		НСтр("ru = '(стр.200 Раздела 3 + стр.130 Раздела 4 + стр.160 Раздела 6), если результат > 0, иначе 0';
			|en = '(стр.200 Раздела 3 + стр.130 Раздела 4 + стр.160 Раздела 6), если результат > 0, иначе 0'"));
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная НДС, подлежащая возмещению';
													|en = 'Возможно ошибочная НДС, подлежащая возмещению'"));
...
Процедура ПроверкаКС_1_22()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога по книге покупок в стр.005 Приложения 1 к ';
													|en = 'Сумма налога по книге покупок в стр.005 Приложения 1 к '") +
		НСтр("ru = 'Разделу 8 <= сумме налога в стр.190 Раздела 8';
			|en = 'Разделу 8 <= сумме налога в стр.190 Раздела 8'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая вычету';
													|en = 'Возможно ошибочная сумма НДС, подлежащая вычету'"));
...
Процедура ПроверкаКС_1_23а()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стоимость продаж по ставке 20% в стр.020 Приложения 1 к Разделу 9 >= стр.230 Раздела 9';
			|en = 'Стоимость продаж по ставке 20% в стр.020 Приложения 1 к Разделу 9 >= стр.230 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_23б()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стоимость продаж по ставке 18% в стр.025 Приложения 1 к Разделу 9 >= стр.235 Раздела 9';
			|en = 'Стоимость продаж по ставке 18% в стр.025 Приложения 1 к Разделу 9 >= стр.235 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_23в()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стоимость продаж по ставке 10% в стр.030 Приложения 1 к Разделу 9 >= стр.240 Раздела 9';
			|en = 'Стоимость продаж по ставке 10% в стр.030 Приложения 1 к Разделу 9 >= стр.240 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_23г()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стоимость продаж по ставке 0% в стр.040 Приложения 1 к Разделу 9 >= стр.250 Раздела 9';
			|en = 'Стоимость продаж по ставке 0% в стр.040 Приложения 1 к Разделу 9 >= стр.250 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_23д()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога по ставке 20% в стр.050 Приложения 1 к Разделу 9 >= стр.260 Раздела 9';
			|en = 'Сумма налога по ставке 20% в стр.050 Приложения 1 к Разделу 9 >= стр.260 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_23е()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога по ставке 18% в стр.055 Приложения 1 к Разделу 9 >= стр.265 Раздела 9';
			|en = 'Сумма налога по ставке 18% в стр.055 Приложения 1 к Разделу 9 >= стр.265 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_23ж()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога по ставке 10% в стр.060 Приложения 1 к Разделу 9 >= стр.270 Раздела 9';
			|en = 'Сумма налога по ставке 10% в стр.060 Приложения 1 к Разделу 9 >= стр.270 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_23з()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стоимость продаж, освобождаемых от налога в стр.070 Приложения 1 к Разделу 9 >= стр.280 Раздела 9';
			|en = 'Стоимость продаж, освобождаемых от налога в стр.070 Приложения 1 к Разделу 9 >= стр.280 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_25()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '1 к Разделу 9 в которых стр.090 = 06) > 0';
			|en = '1 к Разделу 9 в которых стр.090 = 06) > 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%6 (%1 + (%2 - %3) - %4 + %5) > 0';
													|en = '%6 (%1 + (%2 - %3) - %4 + %5) > 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая возмещению';
													|en = 'Возможно ошибочная сумма НДС, подлежащая возмещению'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму НДС в стр.050 Раздела 1");
	...
	ШаблонДетализацииР09	= НСтр("ru = '(%1 + %2 + %3) - (%4 + %5 + %6)';
									|en = '(%1 + %2 + %3) - (%4 + %5 + %6)'");
	ШаблонДетализацииР91	= НСтр("ru = '(%1 + %2 + %3 - %4 - %5 - %6) - (%7 + %8 + %9)';
									|en = '(%1 + %2 + %3 - %4 - %5 - %6) - (%7 + %8 + %9)'");
	...
	НастройкиКС.ЭтоОшибка = Показатели.Р01С050.Итог > 0 И 
	...
	РасшифровкаР91 = СтрШаблон(ШаблонДетализацииР91,
...
Процедура ПроверкаКС_1_26()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = 'которых стр.010 = 41, 43, 44), с учетом ';
			|en = 'которых стр.010 = 41, 43, 44), с учетом '") +
	...
	НастройкиКС.ЭтоОшибка = Код1011715Присутствует И ПоказателиР02.Р02С060.Итог < Окр(РасчетнаяСумма);
...
Процедура ПроверкаКС_1_29()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога, уплаченная налогоплательщиком таможенным органам при ввозе товаров ';
			|en = 'Сумма налога, уплаченная налогоплательщиком таможенным органам при ввозе товаров '") +
		НСтр("ru = 'на территорию РФ в стр.150 Раздела 3 <= (стр.180 Раздела 8, в которых стр.010 ';
			|en = 'на территорию РФ в стр.150 Раздела 3 <= (стр.180 Раздела 8, в которых стр.010 '") +
		НСтр("ru = 'Раздела 8 = 20 + стр.180 Приложения 1 к Разделу 8, в которых стр.010 = 20), с учетом ';
			|en = 'Раздела 8 = 20 + стр.180 Приложения 1 к Разделу 8, в которых стр.010 = 20), с учетом '") +
		НСтр("ru = 'погрешности округления (при наличии)';
			|en = 'погрешности округления (при наличии)'"));
...
Процедура ПроверкаКС_1_30()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога, уплаченная налогоплательщиком налоговым органам при ввозе товаров ';
			|en = 'Сумма налога, уплаченная налогоплательщиком налоговым органам при ввозе товаров '") +
		НСтр("ru = 'в стр.160 Раздела 3 <= (стр.180 Раздела 8, в которых стр.010 Раздела 8 = 19 + стр.180 ';
			|en = 'в стр.160 Раздела 3 <= (стр.180 Раздела 8, в которых стр.010 Раздела 8 = 19 + стр.180 '") +
		НСтр("ru = 'Приложения 1 к Разделу 8, в которых стр.010 = 19), с учетом ';
			|en = 'Приложения 1 к Разделу 8, в которых стр.010 = 19), с учетом '") +
		НСтр("ru = 'погрешности округления (при наличии)';
			|en = 'погрешности округления (при наличии)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %4 (%2 + %3) + 0,49';
													|en = '%1 <= %4 (%2 + %3) + 0,49'"));
	...
	НастройкиКС.ЭтоОшибка = Показатели.Р03С160.Итог > Окр(РасчетнаяСумма);
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
...
Процедура ПроверкаКС_1_31()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога, уплаченная в бюджет в стр.180 гр.3 Раздела 3 <= (стр.180 Раздела 8, в которых ';
			|en = 'Сумма налога, уплаченная в бюджет в стр.180 гр.3 Раздела 3 <= (стр.180 Раздела 8, в которых '") +
		НСтр("ru = 'стр.010 Раздела 8 = 06 + стр.180 Приложения 1 к Разделу 8, в которых стр.010 = 06), с учетом ';
			|en = 'стр.010 Раздела 8 = 06 + стр.180 Приложения 1 к Разделу 8, в которых стр.010 = 06), с учетом '") +
		НСтр("ru = 'погрешности округления (при наличии)';
			|en = 'погрешности округления (при наличии)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %4 (%2 + %3) + 0,49';
													|en = '%1 <= %4 (%2 + %3) + 0,49'"));
...
Процедура ПроверкаКС_1_34()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'Стоимость продаж, облагаемых налогом по ставке 20% в стр.230 Раздела 9 >= сумме стр.170 Раздела 9';
			|en = 'Стоимость продаж, облагаемых налогом по ставке 20% в стр.230 Раздела 9 >= сумме стр.170 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможна ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможна ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_35()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'Стоимость продаж, облагаемых налогом по ставке 10% в стр.240 Раздела 9 >= сумме стр.180 Раздела 9';
			|en = 'Стоимость продаж, облагаемых налогом по ставке 10% в стр.240 Раздела 9 >= сумме стр.180 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможна ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможна ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_36()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'Стоимость продаж, облагаемых налогом по ставке 0% в стр.250 Раздела 9 <= сумме стр.190 Раздела 9';
			|en = 'Стоимость продаж, облагаемых налогом по ставке 0% в стр.250 Раздела 9 <= сумме стр.190 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %2';
													|en = '%1 <= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможна ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможна ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_39()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стоимость продаж по ставке 20% в стр.310 Приложения 1 к Разделу 9 >= стр.(020 + 250) Приложения 1 ';
			|en = 'Стоимость продаж по ставке 20% в стр.310 Приложения 1 к Разделу 9 >= стр.(020 + 250) Приложения 1 '") +
		НСтр("ru = 'к Разделу 9';
			|en = 'к Разделу 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %4 (%2 + %3)';
													|en = '%1 >= %4 (%2 + %3)'"));
...
Процедура ПроверкаКС_1_40()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стоимость продаж по ставке 10% в стр.320 Приложения 1 к Разделу 9 >= стр.(030 + 260) Приложения 1 ';
			|en = 'Стоимость продаж по ставке 10% в стр.320 Приложения 1 к Разделу 9 >= стр.(030 + 260) Приложения 1 '") +
		НСтр("ru = 'к Разделу 9';
			|en = 'к Разделу 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %4 (%2 + %3)';
													|en = '%1 >= %4 (%2 + %3)'"));
...
Процедура ПроверкаКС_1_41()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стоимость продаж по ставке 0% в стр.330 Приложения 1 к Разделу 9 <= стр.(040 + 270) Приложения 1 ';
			|en = 'Стоимость продаж по ставке 0% в стр.330 Приложения 1 к Разделу 9 <= стр.(040 + 270) Приложения 1 '") +
		НСтр("ru = 'к Разделу 9';
			|en = 'к Разделу 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %4 (%2 + %3)';
													|en = '%1 <= %4 (%2 + %3)'"));
...
Процедура ПроверкаКС_1_44()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.070 Раздела 12 >= стр.(080 - 060) Раздела 12';
			|en = 'Сумма налога в стр.070 Раздела 12 >= стр.(080 - 060) Раздела 12'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %4 (%2 - %3)';
													|en = '%1 >= %4 (%2 - %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_45()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru = 'Стоимость продаж, облагаемых налогом по ставке 18% в стр.235 Раздела 9 >= стр.175 Раздела 9';
			|en = 'Стоимость продаж, облагаемых налогом по ставке 18% в стр.235 Раздела 9 >= стр.175 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %2';
													|en = '%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможна ошибочная сумма НДС, подлежащая уплате в бюджет';
													|en = 'Возможна ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_47()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Стоимость продаж по ставке 18% в стр.315 Приложения 1 к Разделу 9 >= стр.(025 + 255) Приложения 1 ';
			|en = 'Стоимость продаж по ставке 18% в стр.315 Приложения 1 к Разделу 9 >= стр.(025 + 255) Приложения 1 '") +
		НСтр("ru = 'к Разделу 9';
			|en = 'к Разделу 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %4 (%2 + %3)';
													|en = '%1 >= %4 (%2 + %3)'"));
...
Процедура ПроверкаКС_1_51()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'При условии заполнения стр.020 - 060 Раздела 2, в стр.070 Раздела 2 указываются коды 1011703, 1011722';
			|en = 'При условии заполнения стр.020 - 060 Раздела 2, в стр.070 Раздела 2 указываются коды 1011703, 1011722'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 1011703, 1011722';
													|en = '%1 = 1011703, 1011722'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно указан неверный код';
													|en = 'Возможно указан неверный код'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните код в стр.070 Раздела 2");
...
Процедура ПроверкаКС_1_52()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru = '1011707, 1011714, 1011719, 1011720, 1011721';
			|en = '1011707, 1011714, 1011719, 1011720, 1011721'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = 1011707, 1011714, 1011719, 1011720, 1011721';
													|en = '%1 = 1011707, 1011714, 1011719, 1011720, 1011721'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно указан неверный код';
													|en = 'Возможно указан неверный код'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните код в стр.070 Раздела 2");
	...
	Для каждого Лист02 Из ДанныеКС.ДанныеР02 Цикл
		...
		НастройкиКС.ЭтоОшибка = ЗначениеЗаполнено(Показатели.Р02С020.Значение) 
			...
			И		ЗначениеЗаполнено(Показатели.Р02С050.Значение) И ЗначениеЗаполнено(Показатели.Р02С060.Значение)
			И		(НЕ ЗначениеЗаполнено(Показатели.Р02С070.Значение)
			ИЛИ 	СтрНайти("1011707,1011714,1011719,1011720,1011721", Показатели.Р02С070.Значение) = 0);
		НастройкиКС.Детализация = СтрЗаменить(НастройкиКС.ШаблонДетализации, "%1", Показатели.Р02С070.ЗначениеСтр);
		ДополнитьТаблицуРезультата();
	КонецЦикла;
...
Процедура ПроверкаКС_1_54а()
	...
	Заголовки.Вставить("Рекомендации"		, "Уточните код ОКТМО в стр.010 Раздела 1");
	Заголовки.Вставить("Основание"			, НСтр("ru = 'ст. 80 НК РФ';
													|en = 'ст. 80 НК РФ'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru = 'Реализация отложена';
													|en = 'Реализация отложена'"));
...
Процедура ПроверкаКС_1_55()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма НДС, заявленная к возмещению';
													|en = 'Возможно ошибочная сумма НДС, заявленная к возмещению'"));
...
Процедура ПроверкаКС_1_58_доп()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.130 Раздела 4 >= стр.(050 + 080 - 030 - 040) Раздела 4, ';
			|en = 'Сумма налога в стр.130 Раздела 4 >= стр.(050 + 080 - 030 - 040) Раздела 4, '") +
		НСтр("ru = 'если результат > 0, иначе 0';
			|en = 'если результат > 0, иначе 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= %6 (%2 + %3 - %4 - %5)';
													|en = '%1 >= %6 (%2 + %3 - %4 - %5)'"));
...
Процедура ПроверкаКС_1_59_доп()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.160 Раздела 6 >= стр.(050 + 100 + 130) - стр.(060 + 090 + 150) Раздела 6, ';
			|en = 'Сумма налога в стр.160 Раздела 6 >= стр.(050 + 100 + 130) - стр.(060 + 090 + 150) Раздела 6, '") +
		НСтр("ru = 'если результат > 0, иначе 0';
			|en = 'если результат > 0, иначе 0'"));
...
Процедура ПроверкаКС_1_60_доп()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.170 Раздела 6 <= стр.(060 + 090 + 150) - стр.(050 + 100 + 130) Раздела 6, ';
			|en = 'Сумма налога в стр.170 Раздела 6 <= стр.(060 + 090 + 150) - стр.(050 + 100 + 130) Раздела 6, '") +
		НСтр("ru = 'если результат > 0, иначе 0';
			|en = 'если результат > 0, иначе 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 <= %8 ((%2 + %3 + %4) - (%5 + %6 + %7))';
													|en = '%1 <= %8 ((%2 + %3 + %4) - (%5 + %6 + %7))'"));
		...
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Строки Тогда
			...
			Для НомСтр = ВерхОбласти По НизОбласти Цикл
				...
				Если КодПоказателя <> "###" Тогда
					...
					ИначеЕсли Область.Имя = "КодыОпераций_Раздел4" ИЛИ Область.Имя = "КодыОпераций_Раздел6" Тогда
						
						Если (КодПоказателя = "1011468" ИЛИ КодПоказателя = "1011470")
							И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20250101' Тогда
							
							Продолжить;
							
						ИначеЕсли КодПоказателя = "1011473" И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20230701' Тогда
							
							Продолжить;
							
						ИначеЕсли КодПоказателя = "1011474" И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20231001' Тогда
							
							Продолжить;
							
						ИначеЕсли КодПоказателя = "1011475" И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20240101' Тогда
					...
					ИначеЕсли Область.Имя = "КодыОпераций_Раздел7" Тогда
						...
						Если КодПоказателя = "1010836" И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20240701' Тогда
							
							Продолжить;
							
						ИначеЕсли (КодПоказателя = "1010837" ИЛИ КодПоказателя = "1010838")
							И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20240101' Тогда
							
							Продолжить;
							
						ИначеЕсли КодПоказателя = "1011232" И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20241001' Тогда
							
							Продолжить;
							
						ИначеЕсли КодПоказателя = "1011229" И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20240401' Тогда
							
							Продолжить;
							
						ИначеЕсли КодПоказателя = "1011221" И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20230401' Тогда
							
							Продолжить;
							
						ИначеЕсли (КодПоказателя = "1011224" ИЛИ КодПоказателя = "1011225")
							И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20230701' Тогда
							
							Продолжить;
							
						ИначеЕсли (КодПоказателя = "1010835" ИЛИ КодПоказателя = "1011722")
							И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20231001' Тогда
							
							Продолжить;
							
						ИначеЕсли КодПоказателя = "1011226" И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20250101' Тогда
							
							Продолжить;
							
						ИначеЕсли КодПоказателя = "1011227" И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20231001' Тогда
							
							Продолжить;
							
						ИначеЕсли КодПоказателя = "1011228" И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20250101' Тогда
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1" Тогда
		...
		Если СтрНайти(ТабличныйДокумент.ТекущаяОбласть.Имя, "М1") > 0
			...
			ТекстПредупреждения = НСтр("ru = 'Возможно не более 8 строк 055 в разделе 1';
										|en = 'Возможно не более 8 строк 055 в разделе 1'");
		КонецЕсли;
...
Функция ЗаполнитьАвтоНаСервере()
	...
	ЭтаФормаИмя = "ВнешнийОтчет.РегламентированныйОтчетНДС.Форма.ФормаОтчета2023Кв1";
