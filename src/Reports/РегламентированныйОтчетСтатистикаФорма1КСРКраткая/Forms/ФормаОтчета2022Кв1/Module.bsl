...
Процедура ПоказатьПериод()
	...
	СтрПериод = "" + Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) / 3 + " квартал "
		+ Формат(Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета), "ЧГ=") + " г.";
...
Процедура ВосстановитьСохраненныеДанные()
	...
	СтруктураРеквизитовФормы.ФлажокОтклАвтоРасчет = ?(Авторасчет = Неопределено, Ложь, Истина);
...
Процедура Расчет(Форма)
	...
	Области["П301"].Значение = Области["П302"].Значение + Области["П303"].Значение;
	Области["П304"].Значение = Области["П305"].Значение + Области["П306"].Значение;
	Области["П307"].Значение = Области["П308"].Значение + Области["П309"].Значение;
...
Процедура УстановитьЗащитуИЦветФонаОбластейАвторассчитываемыхПоказателей()
	...
	мФормаОтчета.Области["П301"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П301"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П304"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П304"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П307"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П307"].Защита   = Не ОтклАвтоРасчетЗначение;
