...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	Зн06 = Показатели["П0106"];
	Зн07 = Показатели["П0107"];
	Зн08 = Показатели["П0108"];
	Зн09 = Показатели["П0109"];
	
	ТекстФормулы = "стр.05 >= стр.06";
	Описание = "стр.05 < стр.06";
	Расшифровка = Строка(Зн05)+" >= "+Строка(Зн06);
	Если Зн05 >= Зн06 Тогда
		ЭтоОшибка = Ложь;
	...
	ТекстФормулы = "стр.05 >= стр.07";
	Описание = "стр.05 < стр.07";
	Расшифровка = Строка(Зн05)+" >= "+Строка(Зн07);
	Если Зн05 >= Зн07 Тогда
		ЭтоОшибка = Ложь;
		ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
	Иначе
		ЭтоОшибка = Истина;
	...
	ТекстФормулы = "если стр. 4 > 0, то стр. 2,3,5 > 0";
	Описание = "стр. 4 > 0, но стр. 2 или 3 или 5 = 0";
	Расшифровка = "";
	Если Зн04 = 0 Или (Зн02>0 И Зн03>0 И Зн05>0) Тогда
		ЭтоОшибка = Ложь;
		ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
	Иначе
		ЭтоОшибка = Истина;
	...
	ТекстФормулы = "если стр. 8 > 0, то стр. 2,3,5 > 0";
	Описание = "стр. 8 > 0, но стр. 2 или 3 или 5 = 0";
	Расшифровка = "";
	Если Зн08 = 0 Или (Зн02>0 И Зн03>0 И Зн05>0) Тогда
		ЭтоОшибка = Ложь;
		ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
	Иначе
		ЭтоОшибка = Истина;
	...
	ТекстФормулы = "если стр. 9 > 0, то стр. 2,3 > 0";
	Описание = "стр. 9 > 0, но стр. 2 или 3 = 0";
	Расшифровка = "";
	Если Зн09 = 0 Или (Зн02>0 И Зн03>0) Тогда
		ЭтоОшибка = Ложь;
		ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
	Иначе
		ЭтоОшибка = Истина;
	...
	ТекстФормулы = "если стр.6 или 7 > 0, то стр. 2,3,5 > 0";
	Описание = "стр.6 или 7 > 0, но стр. 2 или 3 или 5 = 0";
	Расшифровка = "";
	Если (Зн06 = 0 И Зн07 = 0) Или (Зн02>0 И Зн03>0 И Зн05>0) Тогда
		ЭтоОшибка = Ложь;
		ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
	Иначе
		ЭтоОшибка = Истина;
