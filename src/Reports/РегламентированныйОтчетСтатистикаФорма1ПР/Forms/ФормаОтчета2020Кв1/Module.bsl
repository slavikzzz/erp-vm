...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Область.Имя = "П000010000117_1" Или Область.Имя = "П000010000116_1" Тогда
		ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Результат = ?(РезультатВыбора["Название"] = "Пустое значение" , "",
		?(Область.Имя = "П000010000117_1", РезультатНазвание, РезультатКод));
	
	Область.Значение = Результат;
	
	Если Область.Имя = "П000010000117_1" Тогда
		ПолеТабличногоДокументаФормаОтчета.Области["П000010000116_1"].Значение = РезультатКод;
	ИначеЕсли Область.Имя = "П000010000116_1" Тогда
		ПолеТабличногоДокументаФормаОтчета.Области["П000010000117_1"].Значение = ?(РезультатНазвание = "Пустое значение", "",
			РезультатНазвание);
	КонецЕсли;
