...
Функция ВариантыНастроек() Экспорт
	...
	Вариант.Вставить("Имя",           "РеализацияОСиНМА");
	Вариант.Вставить("Представление", НСтр("ru = 'Финансовые результаты от реализации ОС и НМА';
											|en = 'Financial results of FA and IA sales'"));
...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета, ОрганизацияВНачале = Истина) Экспорт 
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Регистр информации о финансовых результатах от реализации амортизируемого имущества';
			|en = 'Register of information about financial results from sale of depreciable fixed assets'"),
...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	Если ПараметрыОтчета.Свойство("ВариантНалогообложенияПрибыли") И ЗначениеЗаполнено(ПараметрыОтчета.ВариантНалогообложенияПрибыли) Тогда
		...
		Субконто = БухгалтерскиеОтчетыКлиентСервер.ПолучитьПараметр(КомпоновщикНастроек, "ВидСубконтоПрочиеДоходыРасходы").Значение;
		Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.ВариантыНалогообложенияПрибыли);
		
		БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "ВидСубконтоПрочиеДоходыРасходы", Субконто);
	КонецЕсли;
