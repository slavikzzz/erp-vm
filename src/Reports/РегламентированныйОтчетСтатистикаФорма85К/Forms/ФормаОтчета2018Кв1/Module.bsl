...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мВерсияФормы = "02/08/2019";
...
Процедура ПоказатьПериод()
	...
	СтруктураДанныхРаздел2.Вставить("ЗаголовокРаздел2_2", "в том числе в возрасте, лет
		|(число полных лет на 01.01." + НРег(Формат(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, 12), "ДФ = 'гггг'")) + " г.):");
	СтруктураДанныхРаздел3.Вставить("ЗаголовокРаздела3_2",
		"Число полных лет по состоянию на 1 января " + НРег(Формат(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, 12), "ДФ = 'гггг'")) + " года");
КонецПроцедуры
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если ПолеДаНет(Область.Имя) Или Область.Имя = "П01020603" Тогда 
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Если ИмяТекущейСтраницыПанели = "Раздел2" Тогда
		...
		Пока Истина Цикл 
			Стр = Стр + 1;
			Обл = Области.Найти("П000002060204_"+Стр);
			Если Обл = Неопределено Тогда 
				Прервать;
			КонецЕсли;
		...
		Области["П02060104"].Значение = СуммаПоГрафе;
		
		Для Стр = 1 По 4 Цикл 
			Сумм4_11 = 0;
			Для Гр = 4 По 11 Цикл
				Сумм4_11 = Сумм4_11 + Области["П02020"+Стр+Формат(Гр, "ЧЦ=2; ЧВН=; ЧГ=;")].Значение;
			КонецЦикла;
			Области["П02020"+Стр+"03"].Значение = Сумм4_11;
		КонецЦикла;
		
		Для Гр = 3 По 9 Цикл 
			Сумм3_10 = Области["П0201100"+Гр].Значение;
			Для Стр = 3 По 9 Цикл 
				Сумм3_10 = Сумм3_10 + Области["П02010"+Стр+"0"+Гр].Значение;
			КонецЦикла;
			Области["П0201020"+Гр].Значение = Сумм3_10;
			
			Если Гр = 4 Или  Гр = 8 Тогда 
				Области["П0201010"+Гр].Значение = Области["П0201020"+Гр].Значение + Области["П0201110"+Гр].Значение + Области["П0201120"+Гр].Значение
												+ Области["П0201150"+Гр].Значение + Области["П0201170"+Гр].Значение + Области["П0201180"+Гр].Значение;
			Иначе 
				Области["П0201010"+Гр].Значение = Области["П0201020"+Гр].Значение + Области["П0201110"+Гр].Значение + Области["П0201120"+Гр].Значение
												+ Области["П0201150"+Гр].Значение + Области["П0201160"+Гр].Значение + Области["П0201170"+Гр].Значение + Области["П0201180"+Гр].Значение;
			КонецЕсли;
		КонецЦикла;
	ИначеЕсли ИмяТекущейСтраницыПанели = "Раздел3" Тогда
		Для Гр = 3 По 9 Цикл 
			ГрСтр = "0" + Гр;
			Сумм2_12 = 0;
			Для Стр = 2 По 12 Цикл 
				Сумм2_12 = Сумм2_12 + Области["П0301" + Формат(Стр, "ЧЦ=2; ЧВН=") + ГрСтр].Значение;
			КонецЦикла;
			Области["П030101" + ГрСтр].Значение = Сумм2_12;
		КонецЦикла;
		...
		Для Гр = 3 По 12 Цикл 
			...
			Сумм2_12 = 0;
			Для Стр = 2 По 12 Цикл 
				Сумм2_12 = Сумм2_12 + Области["П0302" + Формат(Стр, "ЧЦ=2; ЧВН=") + ГрСтр].Значение;
			КонецЦикла;
			Области["П030201" + ГрСтр].Значение = Сумм2_12;
		КонецЦикла;
		
		Области["П03030103"].Значение = Области["П03030104"].Значение
										+Области["П03030105"].Значение
										+Области["П03030106"].Значение
										+Области["П03030107"].Значение
										+Области["П03030108"].Значение
										+Области["П03030109"].Значение;
		Области["П03030110"].Значение = Области["П03030111"].Значение
										+Области["П03030112"].Значение
										+Области["П03030113"].Значение
										+Области["П03030114"].Значение
										+Области["П03030115"].Значение
										+Области["П03030116"].Значение;
	ИначеЕсли ИмяТекущейСтраницыПанели = "Раздел4" Тогда
		...
		Области.П05010103.Значение = Области.П05010303.Значение
										+Области.П05011203.Значение;
		Области.П05020103.Значение = Области.П05020203.Значение
										+Области.П05020303.Значение
...
Функция ПечатьНаСервере(ВидПечати)
	...
	ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2018Кв1_Раздел1", "Раздел1", СтруктураДанныхРаздел1);
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 85-К");
	
	ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2018Кв1_Раздел2", "Раздел2_1", СтруктураДанныхРаздел2);
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 85-К");
	
	ПФ = РегламентированнаяОтчетность.НоваяСтраница();
	ЗаполнитьДаннымиТабличныйДокумент(ПФ, "ФормаОтчета2018Кв1_Раздел2", "", СтруктураДанныхРаздел2);
	ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2018Кв1_Раздел2", "Раздел2_2", СтруктураДанныхРаздел2);
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2018Кв1_Раздел2", "Раздел2_3_1", СтруктураДанныхРаздел2);
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2018Кв1_Раздел2", "Раздел2_3_Заголовок", СтруктураДанныхРаздел2);
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2018Кв1_Раздел2", "Раздел2_3_2", СтруктураДанныхРаздел2);
	...
	ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2018Кв1_Раздел3", "Раздел3_1", СтруктураДанныхРаздел3);
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 85-К");
	
	ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2018Кв1_Раздел3", "Раздел3_2", СтруктураДанныхРаздел3);
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 85-К");
	
	ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2018Кв1_Раздел4", "Раздел4_1", СтруктураДанныхРаздел4);
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 85-К");
	
	ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2018Кв1_Раздел4", "Раздел4_2", СтруктураДанныхРаздел4);
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 85-К");
	
	ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2018Кв1_Раздел4", "Раздел4_3", СтруктураДанныхРаздел4);
	ЗаполнитьДаннымиТабличныйДокумент(ПечатнаяФорма, "ФормаОтчета2018Кв1_Подписи", "Подписи", СтруктураДанныхПодписи);
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 85-К");
...
Процедура ОчиститьНаСервере() Экспорт
	...
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел3" Тогда
		ТабличныйДокумент.Области.ЗаголовокРаздела3_2.Значение = "Число полных лет по состоянию на 1 января " + НРег(Формат(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, 12), "ДФ = 'гггг'")) + " года";
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Подписи" Тогда
	...
	СтруктураДанныхРаздел2.Вставить("ЗаголовокРаздел2_2", "в том числе в возрасте, лет
	|(число полных лет на 01.01." + НРег(Формат(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, 12), "ДФ = 'гггг'")) + " г.)");
	СтруктураДанныхРаздел3.Вставить("ЗаголовокРаздела3_2", "Число полных лет по состоянию на 1 января " + НРег(Формат(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, 12), "ДФ = 'гггг'")) + " года");
...
Процедура ПеренумероватьСтроки(Форма)
	...
	Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда 
		...
		КонецЦикла;
		//Форма.ТабличныйДокумент.Области.Раздел2_6_Заголовок.Значение = "Численность воспитанников - всего 
	...
	Иначе
		...
		КонецЦикла;
		//Форма.СтруктураДанныхРаздел2.Раздел2_6_Заголовок = "Численность воспитанников - всего 
...
Функция ПолеДаНет(ИмяОбласти)
	Если (СтрНайти(ИмяОбласти, "П0101") = 1 
			...
			Или (СтрНайти(ИмяОбласти, "П04020") = 1 И СтрДлина(ИмяОбласти) = 7)
			Или (ИмяОбласти = "П04040403" Или ИмяОбласти = "П04040503" Или ИмяОбласти = "П04040603")
			Или ИмяОбласти = "П01020503"
