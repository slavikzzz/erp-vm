...
Процедура ПоказатьПериод(Форма)
	...
	ФормаУтратилаСилу = Форма.ДатаПодписи >= '20200614';
	...
	Иначе
		...
		НСтр("ru = 'Утратила силу (приказ ФНС России от 24.04.2020 № ЕД-7-3/273@). С 14.06.2020 создавайте отчет ""Реестр счетов-фактур по этиловому спирту"".';
			|en = 'Утратила силу (приказ ФНС России от 24.04.2020 № ЕД-7-3/273@). С 14.06.2020 создавайте отчет ""Реестр счетов-фактур по этиловому спирту"".'"),
