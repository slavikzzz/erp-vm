...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "05/09/2012";
	СтруктураРеквизитовФормы.мКодОтчета   = "0617001";
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ВПрограммеИзмененаДатаПодписи = Ложь)
	...
	Если (НЕ ЗначениеЗаполнено(Форма.ПолеТабличногоДокументаФормаОтчета.Области.КодОКВЭД.Значение)) ИЛИ (Форма.СтруктураРеквизитовФормы.мВПрограммеИзмененаОрганизация) Тогда
		Если Число("0" + Форма.ПолеТабличногоДокументаФормаОтчета.Области.КодИнвест.Значение) = 1 Тогда
			Форма.ПолеТабличногоДокументаФормаОтчета.Области.КодОКВЭД.Значение = "0";
		ИначеЕсли Число("0" + Форма.ПолеТабличногоДокументаФормаОтчета.Области.КодИнвест.Значение) = 2 Тогда
				СведенияОбОрганизации = РегламентированнаяОтчетностьВызовСервера.ПолучитьСведенияОбОрганизации(Форма.СтруктураРеквизитовФормы.Организация, Форма.ДатаПодписи, "ОКВЭД");
				Если СведенияОбОрганизации.Свойство("ОКВЭД") Тогда
					Форма.ПолеТабличногоДокументаФормаОтчета.Области.КодОКВЭД.Значение = Лев(СокрЛП(СведенияОбОрганизации.ОКВЭД), 2);
				КонецЕсли;
		КонецЕсли;
	КонецЕсли;
...
Процедура ПоказатьПериод()
	...
	ПериодОтчета = " за " + СтрЗаменить(СтруктураРеквизитовФормы.СтрПериодОтчета, "г.", "года");
...
Процедура ОчиститьТабличноеПоле(Форма)
	...
	СписокПоказателейНеПодлежащихОчистке.Добавить("КодЗн3");
	СписокПоказателейНеПодлежащихОчистке.Добавить("КодЗн4");
...
Процедура Расчет(Форма) Экспорт
	...
	Для Инд=1 По 8 Цикл
		Колонка = "0"+Строка(Инд);

   		// По строке 030
		мФормаОтчета.Область("П010030"+Колонка).Значение = мФормаОтчета.Область("П010040"+Колонка).Значение + 
		                                                   мФормаОтчета.Область("П010060"+Колонка).Значение +
													       мФормаОтчета.Область("П010061"+Колонка).Значение;
		
		// По строке 020											  
		мФормаОтчета.Область("П010020"+Колонка).Значение = мФормаОтчета.Область("П010030"+Колонка).Значение +
		                                                   мФормаОтчета.Область("П010070"+Колонка).Значение +
													       мФормаОтчета.Область("П010080"+Колонка).Значение +
		                                                   мФормаОтчета.Область("П010100"+Колонка).Значение;											  
		
		// По строке 150
		мФормаОтчета.Область("П010150"+Колонка).Значение = мФормаОтчета.Область("П010160"+Колонка).Значение +
		                                                   мФормаОтчета.Область("П010170"+Колонка).Значение;
		
	    // По строке 130
		мФормаОтчета.Область("П010130"+Колонка).Значение = мФормаОтчета.Область("П010140"+Колонка).Значение +
		                                                   мФормаОтчета.Область("П010150"+Колонка).Значение;

		// По строке 110
		мФормаОтчета.Область("П010110"+Колонка).Значение = мФормаОтчета.Область("П010120"+Колонка).Значение + 
		                                                   мФормаОтчета.Область("П010130"+Колонка).Значение +
													       мФормаОтчета.Область("П010180"+Колонка).Значение;
		// По строке 210
		мФормаОтчета.Область("П010210"+Колонка).Значение = мФормаОтчета.Область("П010211"+Колонка).Значение +
		                                                   мФормаОтчета.Область("П010212"+Колонка).Значение;
		
		// По строке 220											  
		мФормаОтчета.Область("П010220"+Колонка).Значение = мФормаОтчета.Область("П010230"+Колонка).Значение +
		                                                   мФормаОтчета.Область("П010240"+Колонка).Значение;
													  
		// По строке 190											  
		мФормаОтчета.Область("П010190"+Колонка).Значение = мФормаОтчета.Область("П010200"+Колонка).Значение +
		                                                   мФормаОтчета.Область("П010210"+Колонка).Значение +
													       мФормаОтчета.Область("П010241"+Колонка).Значение +
													       мФормаОтчета.Область("П010250"+Колонка).Значение +
		                                                   мФормаОтчета.Область("П010260"+Колонка).Значение;											  
													  
		// По строке 010
		мФормаОтчета.Область("П010010"+Колонка).Значение = мФормаОтчета.Область("П010020"+Колонка).Значение + 
		                                                   мФормаОтчета.Область("П010110"+Колонка).Значение +
													       мФормаОтчета.Область("П010190"+Колонка).Значение;
	
	КонецЦикла;

	// По строке 280
	мФормаОтчета.Области.П01028003.Значение = мФормаОтчета.Области.П01029003.Значение + мФормаОтчета.Области.П01030003.Значение;
	мФормаОтчета.Области.П01028004.Значение = мФормаОтчета.Области.П01029004.Значение + мФормаОтчета.Области.П01030004.Значение;

	// По строке 270
	мФормаОтчета.Области.П01027003.Значение = мФормаОтчета.Области.П01028003.Значение + мФормаОтчета.Области.П01031003.Значение + мФормаОтчета.Области.П01032003.Значение;
	мФормаОтчета.Области.П01027004.Значение = мФормаОтчета.Области.П01028004.Значение + мФормаОтчета.Области.П01031004.Значение + мФормаОтчета.Области.П01032004.Значение;

	// РАЗДЕЛ 2

	мФормаОтчета.Области.П02033501.Значение = мФормаОтчета.Области.П02034001.Значение + 
	                                          мФормаОтчета.Области.П02035001.Значение + мФормаОтчета.Области.П02035101.Значение +
	                                          мФормаОтчета.Области.П02035501.Значение + мФормаОтчета.Области.П02035601.Значение +
	                                          мФормаОтчета.Области.П02036001.Значение + мФормаОтчета.Области.П02036101.Значение +
	                                          мФормаОтчета.Области.П02036501.Значение + мФормаОтчета.Области.П02036601.Значение +
	                                          мФормаОтчета.Области.П02036701.Значение + мФормаОтчета.Области.П02037001.Значение + 
	                                          мФормаОтчета.Области.П02037101.Значение + мФормаОтчета.Области.П02037201.Значение + 
	                                          мФормаОтчета.Области.П02038001.Значение + мФормаОтчета.Области.П02039001.Значение;

	мФормаОтчета.Области.П02033502.Значение = мФормаОтчета.Области.П02034002.Значение + 
	                                          мФормаОтчета.Области.П02035002.Значение + мФормаОтчета.Области.П02035102.Значение +
	                                          мФормаОтчета.Области.П02035502.Значение + мФормаОтчета.Области.П02035602.Значение +
	                                          мФормаОтчета.Области.П02036002.Значение + мФормаОтчета.Области.П02036102.Значение +
	                                          мФормаОтчета.Области.П02036502.Значение + мФормаОтчета.Области.П02036602.Значение +
	                                          мФормаОтчета.Области.П02036702.Значение + мФормаОтчета.Области.П02037002.Значение + 
	                                          мФормаОтчета.Области.П02037102.Значение + мФормаОтчета.Области.П02037202.Значение +
	                                          мФормаОтчета.Области.П02038002.Значение + мФормаОтчета.Области.П02039002.Значение;
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Область.Имя = "КодИнвест" Тогда
		
		СтандартнаяОбработка = Ложь;
		
		Список = Новый СписокЗначений;
		Список.Добавить("01","01 - инвестиции в Россию из-за рубежа");
		Список.Добавить("02","02 - инвестиции из России за рубеж");
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыборЗавершение(СписокЭлемент, ДополнительныеПараметры) Экспорт
	...
	Если СписокЭлемент <> Неопределено  Тогда
		...
		Если Число("0" + СписокЭлемент.Значение) = 1 Тогда
			ПолеТабличногоДокументаФормаОтчета.Области.КодОКВЭД.Значение = "0";
		ИначеЕсли Число("0" + СписокЭлемент.Значение) = 2 Тогда
			СведенияОбОрганизации = РегламентированнаяОтчетностьВызовСервера.ПолучитьСведенияОбОрганизации(СтруктураРеквизитовФормы.Организация, ДатаПодписи, "ОКВЭД");
			Если СведенияОбОрганизации.Свойство("ОКВЭД") Тогда
				ПолеТабличногоДокументаФормаОтчета.Области.КодОКВЭД.Значение = Лев(СокрЛП(СведенияОбОрганизации.ОКВЭД), 2);
			КонецЕсли;
		КонецЕсли;
...
Процедура ПриОткрытии(Отказ)
	...
	#Если Не ВебКлиент Тогда
		...
		ПолеТабличногоДокументаФормаОтчета.Области.КодОКВЭД.Примечание.Текст = "При выборе вида инвестирования - 01 в данное поле должен быть занесен ноль, при виде инвестирования - 02 должны быть занесены первые две цифры Вашего ОКВЭД. (См указания по заполнению Приказа Росстата № 563 от 24.10.2012г.).";
...
Функция ПечатьНаСервере(ВидПечати)
	...
	Для Каждого Обл Из ОбластиСтроки Цикл
		...
		СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 1-Инвест");
	КонецЦикла;
...
Функция СравнениеОтчетовНаСервере(ДанныеДляСравнения)
	...
	ДеревоДляСравнения = РегламентированнаяОтчетность.ПолучитьДеревоВыгрузки(ЭтаФорма, "СхемаВыгрузкиXML2010Кв1");
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если ПустаяСтрока(ПараметрыВыгрузки.ОКСМ) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не задан код страны по ОКСМ!", ИмяПоляТаблДокумента, "КодОКСМ");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПустаяСтрока(ПараметрыВыгрузки.ВИ) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не задан код вида инвестировния!", ИмяПоляТаблДокумента, "КодИнвест");
		СтатусПроверки = Ложь;
	КонецЕсли;
...
Функция СформироватьИмяФайла(ПараметрыВыгрузки, ДопАтрибуты)
	...
	ПараметрыВыгрузки.Свойство("ОКСМ", ПолученноеЗначение);
	КодОКСМ = СокрЛП(ПолученноеЗначение);
	ПараметрыВыгрузки.Свойство("ВИ", ПолученноеЗначение);
	КодВИ   = СокрЛП(ПолученноеЗначение);
	...
	Если ПустаяСтрока(КодыИФ.ДатаВыгрузки) Тогда // "старый" формат
		ИмяФайлаXML = КодОКУД + "_"
					...
					+ РасчетныйГод + "_"
					+ ОтчетныйПериод
					+ ?(ПустаяСтрока(КодВИ),    "", "_" + КодВИ)
					+ ?(ПустаяСтрока(КодОКСМ),  "", "_" + КодОКСМ)
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ОКВЭД", СокрЛП(?(ЗначениеЗаполнено(ТабДокумент.КодОКВЭД), ТабДокумент.КодОКВЭД, СведенияОбОрганизации.ОКВЭД)));
	...
	ПараметрыВыгрузки.Вставить("ОКСМ", СокрЛП(ТабДокумент.КодОКСМ));
	ПараметрыВыгрузки.Вставить("ВИ", СокрЛП(ТабДокумент.КодИнвест));
