...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мКодОтчета   = "0609303";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Для Гр = 3 По 4 Цикл
		...
		Для Стр = 2 По 18 Цикл
			НомСтр = Формат(Стр, "ЧЦ=2; ЧВН=");
			Сумма = Сумма + Области["П00200100" + НомСтр + Графа].Значение;
		КонецЦикла;
		Области["П0020010001" + Графа].Значение = Сумма;
	КонецЦикла;
...
Функция ПечатьНаСервере(ВидПечати)
	...
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 7-травматизм (приложение)");
...
Процедура ФормироватьСтруктуруСтраницОтчета() Экспорт
	...
	СтрокаУровня1.Представление            = "Статистика: Форма 7-травматизм (приложение)";
