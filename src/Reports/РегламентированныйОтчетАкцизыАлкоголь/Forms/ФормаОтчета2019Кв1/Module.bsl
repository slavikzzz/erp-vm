...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ИмяФормы).ПолучитьМакет("СпискиВыбора2019Кв1");
	...
	Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20200101' Тогда
		ИмяСекции_КБК                 = "КБК_20200101";
		ИмяСекции_КодыВидаПТ          = "КодыВидаПодакцизныхТоваров_20200101";
		ИмяСекции_КодыПоказателей_Р21 = "КодыПоказателей_Р21_20200101";
		ИмяСекции_КодыПоказателей_Р23 = "КодыПоказателей_Р23_20200101";
		ИмяСекции_КодыПоказателей_П1  = "КодыПоказателей_П1_20200101";
	Иначе
		ИмяСекции_КБК                 = "КБК";
		ИмяСекции_КодыВидаПТ          = "КодыВидаПодакцизныхТоваров";
		ИмяСекции_КодыПоказателей_Р21 = "КодыПоказателей_Р21";
		ИмяСекции_КодыПоказателей_Р23 = "КодыПоказателей_Р23";
		ИмяСекции_КодыПоказателей_П1  = "КодыПоказателей_П1";
	КонецЕсли;
	...
	"Выбор кода вида подакцизного товара", КоллекцияСписковВыбора[ИмяСекции_КодыВидаПТ]);
	//Подраздел 2.1.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П00021М100001", 5, ,
	"Выбор кода показателя", КоллекцияСписковВыбора[ИмяСекции_КодыПоказателей_Р21]);
	...
	"Выбор кода показателя", КоллекцияСписковВыбора[ИмяСекции_КодыПоказателей_Р23]);
	//Подраздел 2.4.
	...
	"Выбор кода показателя", КоллекцияСписковВыбора[ИмяСекции_КодыПоказателей_П1]);
	...
	"Выбор кода вида этилового спирта", КоллекцияСписковВыбора[ИмяСекции_КодыВидаПТ]);
	...
	"Выбор кода вида закупаемого спирта", КоллекцияСписковВыбора[ИмяСекции_КодыВидаПТ]);
	//Раздел 1.1.
	...
	"Выбор кода вида закупаемого этилового спирта", КоллекцияСписковВыбора[ИмяСекции_КодыВидаПТ]);
	//Раздел 1.1.
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяРаздела)
	...
	ИначеЕсли ИмяРаздела = "Приложение1" Тогда
		...
		ВариантОбработкиЗначенияНалоговойБазы = ВариантОбработкиЗначенияНалоговойБазы_Приложение1(Форма, КодВидаПТ);
		
		Если ВариантОбработкиЗначенияНалоговойБазы = 4 Тогда
		...
		Иначе
			...
			Пока Обл <> Неопределено Цикл
				Если ВариантОбработкиЗначенияНалоговойБазы = 5 Тогда
					ЗапретитьВводДанныхВОбласть(Форма, Обл);
				ИначеЕсли ВариантОбработкиЗначенияНалоговойБазы = 0 Тогда
	...
	ИначеЕсли ИмяРаздела = "Приложение1" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				КодВидаПТ = СокрЛП(Форма.ТабличныйДокумент.Области.Найти("П001010001003").Значение);
				
				ВариантОбработкиЗначенияНалоговойБазы = ВариантОбработкиЗначенияНалоговойБазы_Приложение1(Форма, КодВидаПТ);
				
				Если ВариантОбработкиЗначенияНалоговойБазы = 0 Тогда
					
					// В графе 5 значение доступно для редактирования вручную.
				...
				Иначе
					...
					//
					РегламентированнаяОтчетностьКлиентСервер.УстановитьИндекс(Индекс, ИндексСтр);
					ОблГр5 = Форма.ТабличныйДокумент.Области.Найти("П00101М100005_" + ИндексСтр);
					Пока ОблГр5 <> Неопределено Цикл
						Если ВариантОбработкиЗначенияНалоговойБазы = 4 Тогда
							Гр3 = Форма.ТабличныйДокумент.Области.Найти("П00101М100003_" + ИндексСтр).Значение;
							Гр4 = Форма.ТабличныйДокумент.Области.Найти("П00101М100004_" + ИндексСтр).Значение;
							ОблГр5.Значение = Окр(Гр3 * Гр4 / 100, 3);
						ИначеЕсли ВариантОбработкиЗначенияНалоговойБазы = 5 Тогда
							ОблГр5.Значение = 0;
						КонецЕсли;
						РегламентированнаяОтчетностьКлиентСервер.УвеличитьИндекс(Индекс, ИндексСтр);
						ОблГр5 = Форма.ТабличныйДокумент.Области.Найти("П00101М100005_" + ИндексСтр);
...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
	...
	ИначеЕсли ИмяРаздела = "Приложение1" Тогда
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			КодВидаПТ = СокрЛП(Ветка.Данные["П001010001003"]);
			...
			Иначе
				...
				Для каждого СтрокаМнЧ Из ДеревоМнЧП1М1.Строки Цикл
					...
					ИначеЕсли ВариантОбработкиЗначенияНалоговойБазы = 5 Тогда
						СтрокаМнЧ.Данные.Вставить("П00101М100005", 0);
					КонецЕсли;
...
Процедура СформироватьРаздел1()
	...
	Для каждого Ветка Из ДеревоР2.Строки Цикл
		...
		КБК = КБКПоКодуВидаПодакцизногоТовара(КодВидаПТ);
	...
	ТЗ_Ур0.Свернуть("КБК", "СуммаКУменьшению,СуммаКЗачету");
...
&НаСервере
Функция КБКПоКодуВидаПодакцизногоТовара(КодВидаПодакцизногоТовара)
	
	ТекЗнач = СокрЛП(КодВидаПодакцизногоТовара);
	
	Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20200101' Тогда
		
		Если ТекЗнач = "111" ИЛИ ТекЗнач = "140" ИЛИ ТекЗнач = "160" Тогда
			Возврат "18210302011011000110";
		ИначеЕсли ТекЗнач = "121" ИЛИ ТекЗнач = "150" ИЛИ ТекЗнач = "170" Тогда
			Возврат "18210302012011000110";
		ИначеЕсли ТекЗнач = "161" ИЛИ ТекЗнач = "162" ИЛИ ТекЗнач = "163"
			ИЛИ ТекЗнач = "130" ИЛИ ТекЗнач = "164" ИЛИ ТекЗнач = "165" Тогда
			Возврат "18210302013011000110";
		ИначеЕсли ТекЗнач = "290" Тогда
			Возврат "18210302020011000110";
		ИначеЕсли ТекЗнач = "251" ИЛИ ТекЗнач = "253" ИЛИ ТекЗнач = "297" Тогда
			Возврат "18210302021011000110";
		ИначеЕсли ТекЗнач = "252" ИЛИ ТекЗнач = "254" Тогда
			Возврат "18210302022011000110";
		ИначеЕсли ТекЗнач = "276" ИЛИ ТекЗнач = "274" ИЛИ ТекЗнач = "287" ИЛИ ТекЗнач = "288" Тогда
			Возврат "18210302090011000110";
		ИначеЕсли ТекЗнач = "277" ИЛИ ТекЗнач = "275" Тогда
			Возврат "18210302091011000110";
		ИначеЕсли ТекЗнач = "310" ИЛИ ТекЗнач = "320" ИЛИ ТекЗнач = "330" Тогда
			Возврат "18210302100011000110";
		ИначеЕсли ТекЗнач = "224" Тогда
			// Для кода 224 в письме ФНС от 05.03.2020 № СД-4-3/3941 указан КБК, который не действует в 2020 году.
			Возврат "18210302110011000110";
		ИначеЕсли ТекЗнач = "225" Тогда
			Возврат "18210302111011000110";
		ИначеЕсли ТекЗнач = "226" Тогда
			Возврат "18210302112011000110";
		ИначеЕсли ТекЗнач = "232" Тогда
			Возврат "18210302120011000110";
		ИначеЕсли ТекЗнач = "231" Тогда
			Возврат "18210302130011000110";
		ИначеЕсли ТекЗнач = "294" Тогда
			// Для кода 294 КБК отсутствует.
			Возврат "";
		КонецЕсли;
	...
	Иначе
		...
		ИначеЕсли ТекЗнач = "161" ИЛИ ТекЗнач = "162" ИЛИ ТекЗнач = "163"
			ИЛИ ТекЗнач = "130" ИЛИ ТекЗнач = "164" ИЛИ ТекЗнач = "165" Тогда
			Возврат "18210302013011000110";
		ИначеЕсли ТекЗнач = "291" ИЛИ ТекЗнач = "292" ИЛИ ТекЗнач = "293" Тогда
			Возврат "18210302020011000110";
		ИначеЕсли ТекЗнач = "284" ИЛИ ТекЗнач = "271" Тогда
			Возврат "18210302090011000110";
		ИначеЕсли ТекЗнач = "310" ИЛИ ТекЗнач = "320" ИЛИ ТекЗнач = "330" Тогда
			Возврат "18210302100011000110";
		ИначеЕсли ТекЗнач = "224" Тогда
		...
		ИначеЕсли ТекЗнач = "231" Тогда
			Возврат "18210302130011000110";
		ИначеЕсли ТекЗнач = "285" Тогда
			Возврат "18210302340011000110";
		ИначеЕсли ТекЗнач = "272" Тогда
			Возврат "18210302350011000110";
		КонецЕсли;
...
&НаКлиентеНаСервереБезКонтекста
Функция ВариантОбработкиЗначенияНалоговойБазы_Приложение1(Форма, КодВидаПодакцизногоТовара)
	
	ТекЗнач = СокрЛП(КодВидаПодакцизногоТовара);
	
	Если Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20200101' Тогда
		МасЗнач = СтрРазделить("111,121,140,150,160,161,162,163,130,164,165,170,231,224,225,226,290", ",");
	Иначе
		МасЗнач = СтрРазделить("111,121,140,150,160,161,162,163,130,164,165,170,231,224", ",");
	КонецЕсли;
	Если МасЗнач.Найти(ТекЗнач) <> Неопределено Тогда
		// Значение недоступно для редактирования вручную, авторассчитывается.
		Возврат 4;
	КонецЕсли;
	
	Если Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20200101' Тогда
		МасЗнач = СтрРазделить("232,287,288,310,320,330", ",");
	Иначе
		МасЗнач = СтрРазделить("232,310,320,330", ",");
	КонецЕсли;
	Если МасЗнач.Найти(ТекЗнач) <> Неопределено Тогда
		// Значение недоступно для редактирования вручную, заполнение не предусмотрено.
		Возврат 5;
	КонецЕсли;
	
	// Значение доступно для редактирования вручную.
	Возврат 0;
			...
			Для НомЛиста = 1 По КолЛистовРаздела Цикл
				...
				Для каждого Пок Из ДанныеМнЧДляПечати Цикл
					...
					Если Обл <> Неопределено Тогда
						...
						// Особая обработка: учет в Приложении 1 формата N(5,2) в графе 3.
						//
						Если СтрНачинаетсяС(Пок.Ключ, "П00101М100003") И Пок.Значение <> Цел(Пок.Значение) Тогда
							Приложение1_СодСпирт_5_2 = Истина;
						КонецЕсли;
				...
				// Особая обработка: учет в Приложении 1 формата N(5,2) в графе 3.
				//
				Если НЕ Приложение1_СодСпирт_5_2 Тогда
					Для Ном = 1 По СтрокМнЧНаЛисте Цикл
						Обл = ТабличныйДокумент.Области.Найти("П00101М100003_" + Формат(Ном, "ЧГ="));
						Если Обл <> Неопределено Тогда
							Обл.Формат = СтрЗаменить(Обл.Формат, "ЧДЦ=2", "ЧДЦ=0");
						КонецЕсли;
					КонецЦикла;
				КонецЕсли;
				СтруктураПараметровРаздела.Вставить("Приложение1_СодСпирт_5_2", Приложение1_СодСпирт_5_2);
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	// Особая обработка: учет в Приложении 1 формата N(5,2) в графе 3.
	//
	Если Парам1.ИмяСтраницы = "Приложение1" И Парам1.Приложение1_СодСпирт_5_2 Тогда
		ИмяМЧБ = ПрефиксИменМакетов + "Приложение1_СодСпирт_5_2";
	КонецЕсли;
...
Процедура СформироватьДанныеОтчета(ОтчетСсылка, СтруктураОтчета)
	...
	СтруктураОтчета.Вставить("ДатаОтчета"	, ОтчетСсылка.ДатаОкончания);
...
Процедура СформироватьТаблицыОтчета()
	...
	ТаблицаР1а.Колонки.Добавить("Ключ"			, ТипСтрока);
	...
	ТаблицаР1б.Колонки.Добавить("Ключ"			, ТипСтрока);
	...
	ТаблицаР24.Колонки.Добавить("Ключ"			, ТипСтрока);
	...
	ТаблицаР26.Колонки.Добавить("Ключ"			, ТипСтрока);
	...
	ТаблицаП05.Колонки.Добавить("Страница"		, ТипЧисло);
	...
	ТаблицаП52.Колонки.Добавить("Страница"		, ТипЧисло);
	ТаблицаП52.Колонки.Добавить("Строка_"		, ТипЧисло);
	...
	ТаблицаП62.Колонки.Добавить("Страница"		, ТипЧисло);
	ТаблицаП62.Колонки.Добавить("Строка_"		, ТипЧисло);
	...
	ТаблицаП64.Колонки.Добавить("Страница"		, ТипЧисло);
	ТаблицаП64.Колонки.Добавить("Строка_"		, ТипЧисло);
...
#Область Раздел_1
	...
	Для Счетчик = 1 По КолвоСтрок Цикл
		...
		КлючКБК = ДанныеКС.КлючКБК.Получить(Показатели.Р01С020.Значение);
		КлючКБК = ?(КлючКБК = Неопределено, "НетДанных", КлючКБК);
		
		НоваяСтрока				= ДанныеКС.ТаблицаР1б.Добавить();
		НоваяСтрока.КБК			= Показатели.Р01С020.Значение;
		НоваяСтрока.Ключ		= КлючКБК;
...
#Область Раздел_2
	...
	Для каждого СтраницаРаздела2 Из СтруктураОтчета.Раздел2 Цикл
		...
		КлючПТ = ДанныеКС.КлючПТ.Получить(Показатели.Р02С010.Значение);
		КлючПТ = ?(КлючПТ = Неопределено, "НетДанных", КлючПТ);
...
#Область Приложение_5
	...
	Для каждого СтраницаПриложения5 Из СтруктураОтчета.Приложение5 Цикл
		...
		КолвоСтрок = КоличествоСтрок(СтраницаПриложения5, Показатели.П52С190.ИмяПоказателя);
		Для Счетчик = 1 По КолвоСтрок Цикл
...
#Область Приложение_6
	...
	Для каждого СтраницаПриложения6 Из СтруктураОтчета.Приложение6 Цикл
		
		КолвоСтрок = КоличествоСтрок(СтраницаПриложения6, Показатели.П62С210.ИмяПоказателя);
		Для Счетчик = 1 По КолвоСтрок Цикл
			
			ЗаполнитьПоказатель(Показатели.П62С210, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П62С250, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П62С255, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П62С260, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П62С265, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П62С266, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П62С267, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П62С270, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П62С275, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П62С276, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П62С277, СтраницаПриложения6, Счетчик);
		...
		КолвоСтрок = КоличествоСтрок(СтраницаПриложения6, Показатели.П64С385.ИмяПоказателя);
		Для Счетчик = 1 По КолвоСтрок Цикл
			
			ЗаполнитьПоказатель(Показатели.П64С385, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П64С410, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П64С415, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П64С420, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П64С425, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П64С430, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П64С435, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П64С460, СтраницаПриложения6, Счетчик);
			ЗаполнитьПоказатель(Показатели.П64С470, СтраницаПриложения6, Счетчик);
...
Процедура СформироватьСлужебныеДанные()
	...
	КлючПТ = Новый Соответствие;
	КлючПТ.Вставить("111"	,"111,140,160");				// этиловый спирт пищевой
	КлючПТ.Вставить("121"	,"121,150,170");				// этиловый спирт непищевой
	КлючПТ.Вставить("130"	,"130,161,162,163,164,165");	// дистиллят коньячный
	КлючПТ.Вставить("140"	,"111,140,160");				// этиловый спирт-сырец пищевой
	КлючПТ.Вставить("150"	,"121,150,170");				// этиловый спирт-сырец непищевой
	КлючПТ.Вставить("160"	,"111,140,160");				// этиловый спирт неденатурированный
	КлючПТ.Вставить("161"	,"130,161,162,163,164,165");	// дистиллят винный
	КлючПТ.Вставить("162"	,"130,161,162,163,164,165");	// дистиллят виноградный
	КлючПТ.Вставить("163"	,"130,161,162,163,164,165");	// дистиллят плодовый
	КлючПТ.Вставить("164"	,"130,161,162,163,164,165");	// дистиллят кальвадосный
	КлючПТ.Вставить("165"	,"130,161,162,163,164,165");	// дистиллят висковый
	КлючПТ.Вставить("170"	,"121,150,170");				// этиловый спирт непищевой неденатурированный
	КлючПТ.Вставить("231"	,"231");						// алкогольная продукция до 9%
	КлючПТ.Вставить("232"	,"232");						// сидр пуаре медовуха
	КлючПТ.Вставить("310"	,"310,320,330");				// пиво безалкогольное
	КлючПТ.Вставить("320"	,"310,320,330");				// пиво до 9%
	КлючПТ.Вставить("330"	,"310,320,330");				// пиво свыше 9%
	КлючПТ.Вставить(""		,"");
	
	КлючКБК = Новый Соответствие;
	КлючКБК.Вставить("18210302011011000110"	,"111,140,160");
	КлючКБК.Вставить("18210302012011000110"	,"121,150,170");
	КлючКБК.Вставить("18210302013011000110"	,"130,161,162,163,164,165");
	КлючКБК.Вставить("18210302120011000110"	,"232");
	КлючКБК.Вставить("18210302130011000110"	,"231");
	КлючКБК.Вставить("18210302100011000110"	,"310,320,330");
	КлючКБК.Вставить(""						,"");
	
	Если ДанныеКС.ДатаОтчета >= '20200301' Тогда
		
		КлючПТ.Вставить("225"	,"225");
		КлючПТ.Вставить("226"	,"226");
		КлючПТ.Вставить("251"	,"251,253,297");
		КлючПТ.Вставить("252"	,"254,252");
		КлючПТ.Вставить("253"	,"251,253,297");
		КлючПТ.Вставить("254"	,"254,252");
		КлючПТ.Вставить("274"	,"274,276,287,288");
		КлючПТ.Вставить("275"	,"275,277");
		КлючПТ.Вставить("276"	,"274,276,287,288");
		КлючПТ.Вставить("277"	,"275,277");
		
		КлючПТ.Вставить("287"	,"274,276,287,288");		// фруктовые вина
		КлючПТ.Вставить("288"	,"274,276,287,288");		// винные напитки
		КлючПТ.Вставить("290"	,"290");					// спиртосодержащая продукция
		КлючПТ.Вставить("297"	,"251,253,297");			// фруктовое сусло
		
		КлючКБК.Вставить("18210302090011000110"	,"274,276,287,288");
		КлючКБК.Вставить("18210302020011000110"	,"290");
		КлючКБК.Вставить("18210302021011000110"	,"251,253,297");
		КлючКБК.Вставить("18210302022011000110"	,"254,252");
		КлючКБК.Вставить("18210302091011000110"	,"275,277");
		КлючКБК.Вставить("18210302111011000110"	,"225");
		КлючКБК.Вставить("18210302112011000110"	,"226");
		
	ИначеЕсли ДанныеКС.ДатаОтчета >= '20200101' Тогда
		
		КлючПТ.Вставить("224"	,"224");					// алкогольная продукция свыше 9%
		КлючПТ.Вставить("273"	,"273,286,287,288");		// игристые вина
		КлючПТ.Вставить("286"	,"273,286,287,288");		// вина
		КлючПТ.Вставить("294"	,"294,295,296,297");		// виноград
		КлючПТ.Вставить("295"	,"294,295,296,297");		// виноматериалы
		КлючПТ.Вставить("296"	,"294,295,296,297");		// виноградное сусло
		
		КлючПТ.Вставить("287"	,"273,286,287,288");		// фруктовые вина
		КлючПТ.Вставить("288"	,"273,286,287,288");		// винные напитки
		КлючПТ.Вставить("290"	,"290");					// спиртосодержащая продукция
		КлючПТ.Вставить("297"	,"294,295,296,297");		// фруктовое сусло
		
		КлючПТ.Вставить("225"	,"224");
		КлючПТ.Вставить("226"	,"224");
		КлючПТ.Вставить("251"	,"294,295,296,297");
		КлючПТ.Вставить("252"	,"294,295,296,297");
		КлючПТ.Вставить("253"	,"294,295,296,297");
		КлючПТ.Вставить("254"	,"294,295,296,297");
		КлючПТ.Вставить("274"	,"273,286,287,288");
		КлючПТ.Вставить("275"	,"273,286,287,288");
		КлючПТ.Вставить("276"	,"273,286,287,288");
		КлючПТ.Вставить("277"	,"273,286,287,288");
		
		КлючКБК.Вставить("18210302090011000110"	,"273,286,287,288");
		КлючКБК.Вставить("18210302020011000110"	,"290");
		КлючКБК.Вставить("18210302021011000110"	,"294,295,296,297");
		КлючКБК.Вставить("18210302022011000110"	,"294,295,296,297");
		КлючКБК.Вставить("18210302091011000110"	,"273,286,287,288");
		КлючКБК.Вставить("18210302111011000110"	,"224");
		КлючКБК.Вставить("18210302112011000110"	,"224");
		
	Иначе
		
		КлючПТ.Вставить("224"	,"224");					// алкогольная продукция свыше 9%
		КлючПТ.Вставить("271"	,"271,284");				// игристые вина негеографические
		КлючПТ.Вставить("272"	,"272");					// игристые вина географические
		КлючПТ.Вставить("284"	,"271,284");				// вина негеографические
		КлючПТ.Вставить("285"	,"285");					// вина географические
		КлючПТ.Вставить("291"	,"291,292,293");			// спиртосодержащая продукция парфюмерная
		КлючПТ.Вставить("292"	,"291,292,293");			// спиртосодержащая продукция бытовая
		КлючПТ.Вставить("293"	,"291,292,293");			// спиртосодержащая продукция прочая
		
		КлючКБК.Вставить("18210302090011000110"	,"271,284");
		КлючКБК.Вставить("18210302020011000110"	,"291,292,293");
		КлючКБК.Вставить("18210302340011000110"	,"285");
		КлючКБК.Вставить("18210302350011000110"	,"272");
		КлючКБК.Вставить("18210302110011000110"	,"224");
		
	КонецЕсли;
	
	ДанныеКС.Вставить("КлючПТ"	, КлючПТ);
	ДанныеКС.Вставить("КлючКБК"	, КлючКБК);
	
	Если ДанныеКС.ДатаОтчета >= '20200301' Тогда
		
		СтрокаКодовПТСПересчетом	= ",111,121,130,140,150,160,161,162,163,164,165,170,224,225,226,231,290";
		СтрокаКодовПТБезПересчета	= ",232,251,252,253,254,274,275,276,277,287,288,294,297,310,320,330";
		
	ИначеЕсли ДанныеКС.ДатаОтчета >= '20200101' Тогда
		
		СтрокаКодовПТСПересчетом	= ",111,121,130,140,150,160,161,162,163,164,165,170,224,225,226,231,290";
		СтрокаКодовПТБезПересчета	= ",232,251,252,253,254,273,274,275,276,277,286,287,288,294,295,296,297,310,320,330";
	...
	Если Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 2022 Тогда
		...
		СтавкиАкцизов.Вставить("130", 589);
		СтавкиАкцизов.Вставить("140", 589);
		СтавкиАкцизов.Вставить("150", 589);
		СтавкиАкцизов.Вставить("160", 589);
		СтавкиАкцизов.Вставить("161", 589);
		СтавкиАкцизов.Вставить("162", 589);
		СтавкиАкцизов.Вставить("163", 589);
		СтавкиАкцизов.Вставить("164", 589);
		СтавкиАкцизов.Вставить("165", 589);
	...
	ИначеЕсли Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 2019 Тогда
		
		СтавкиАкцизов.Вставить("111", 107);
		СтавкиАкцизов.Вставить("121", 107);
		СтавкиАкцизов.Вставить("130", 107);
		СтавкиАкцизов.Вставить("140", 107);
		СтавкиАкцизов.Вставить("150", 107);
		СтавкиАкцизов.Вставить("160", 107);
		СтавкиАкцизов.Вставить("161", 107);
		СтавкиАкцизов.Вставить("162", 107);
		СтавкиАкцизов.Вставить("163", 107);
		СтавкиАкцизов.Вставить("164", 107);
		СтавкиАкцизов.Вставить("165", 107);
		СтавкиАкцизов.Вставить("170", 107);
		СтавкиАкцизов.Вставить("224", 523);
		СтавкиАкцизов.Вставить("231", 418);
		СтавкиАкцизов.Вставить("232", 21);
		СтавкиАкцизов.Вставить("271", 36);
		СтавкиАкцизов.Вставить("272", 14);
		СтавкиАкцизов.Вставить("284", 18);
		СтавкиАкцизов.Вставить("285", 5);
		СтавкиАкцизов.Вставить("291", 0);
		СтавкиАкцизов.Вставить("292", 0);
		СтавкиАкцизов.Вставить("293", 418);
		СтавкиАкцизов.Вставить("310", 0);
		СтавкиАкцизов.Вставить("320", 21);
		СтавкиАкцизов.Вставить("330", 39);
	...
	ПубликацияКомментариев.Добавить("1.1");
...
Процедура ДополнитьСтруктуруОшибок(Настройки)
	...
	ПубликоватьКомментарий = НЕ ДанныеКС.ПубликацияКомментариев.Найти(Настройки.НомерКС) = Неопределено;
	Настройки.СтруктураОшибок.Вставить("Комментарий"	+ Счетчик, ?(ПубликоватьКомментарий, Настройки.Комментарий, ""));
...
Процедура ПроверкаКС_1_01(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Титульного листа (КС 1.1)';
													|en = 'Проверка Титульного листа (КС 1.1)'"));
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru = 'представления налоговой декларации по акцизам на алкогольную продукцию';
			|en = 'представления налоговой декларации по акцизам на алкогольную продукцию'"));
	...
	Если ДанныеКС.ГодОтчета = 2020 И ДанныеКС.МесОтчета <= 6 Тогда
		Возврат;
	КонецЕсли;
...
Процедура ПроверкаКС_2_06(СтруктураРезультата)
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'Заполнена стр.040 код 03, 04 или пустой';
													|en = 'Заполнена стр.040 код 03, 04 или пустой'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Раздела 1 (КС 2.6)';
													|en = 'Проверка Раздела 1 (КС 2.6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Ст.040 Раздела 1 с кодом срока уплаты 03, 04 (или с пустым значением кода срока уплаты в стр.030 ';
			|en = 'Ст.040 Раздела 1 с кодом срока уплаты 03, 04 (или с пустым значением кода срока уплаты в стр.030 '") +
		НСтр("ru = 'Раздела 1) должна быть равна гр.2 подраздела 2.4 Раздела 2 по коду показателя 40001 и КБК. ';
			|en = 'Раздела 1) должна быть равна гр.2 подраздела 2.4 Раздела 2 по коду показателя 40001 и КБК. '") +
		НСтр("ru = 'Если несколько сумм акциза, рассчитанных по разным видам подакцизных товаров, подлежат зачислению ';
			|en = 'Если несколько сумм акциза, рассчитанных по разным видам подакцизных товаров, подлежат зачислению '") +
		НСтр("ru = 'на один и тот же КБК, для заполнения стр.040 Раздела 1 необходимо определить конечный результат ';
			|en = 'на один и тот же КБК, для заполнения стр.040 Раздела 1 необходимо определить конечный результат '") +
		НСтр("ru = 'расчета с бюджетом по соответствующему КБК.';
			|en = 'расчета с бюджетом по соответствующему КБК.'"));
	...
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма акциза, подлежащей уплате в бюджет';
														|en = 'Ошибочная сумма акциза, подлежащей уплате в бюджет'"));
	Настройки = ОбработатьНастройки(		, Заголовки, СтруктураРезультата);
	...
	Пока ВыборкаР1.Следующий() Цикл
		...
		Если НЕ ЗначениеЗаполнено(ВыборкаР1.Р01С041) Тогда
			Продолжить;
		КонецЕсли;
		...
		Пока Выборка.Следующий() Цикл
			...
			Показатели.Р01С041.Дополнение = "КБК " + Выборка.КБК;
			ЗаполнитьИРасшифроватьПоказатель(Показатели.Р01С041, Источник, Выборка.Строка2, Ложь);
		КонецЦикла; 
		
		Если ВыборкаР2.НайтиСледующий(Новый Структура("Ключ", ВыборкаР1.Ключ)) Тогда
		...
		Если СуммаР21 = 0 И Сумма1 = 0 Тогда
			...
			Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
				ВыборкаР1.Р01С041, РасчетнаяСумма, ВыборкаР1.КБК);
		ИначеЕсли Сумма1 <= 0 ИЛИ Сумма2 >= 0 Тогда
			...
			Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки2,
				ВыборкаР1.Р01С041, СуммаР21, СуммаР22, РасчетнаяСумма, ВыборкаР1.КБК);
		Иначе
			...
			Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки3,
				ВыборкаР1.Р01С041, СуммаР21, СуммаР22, СуммаР23, СуммаР24, РасчетнаяСумма, ВыборкаР1.КБК);
		КонецЕсли;
...
Процедура ПроверкаКС_2_07(СтруктураРезультата)
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("Условие"			, НСтр("ru = 'Заполнена стр.040 код 01, 02';
													|en = 'Заполнена стр.040 код 01, 02'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Раздела 1 (КС 2.7)';
													|en = 'Проверка Раздела 1 (КС 2.7)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Ст.040 Раздела 1 с кодом срока уплаты 01, 02 в стр.030 Раздела 1 должна быть равна гр.2 ';
			|en = 'Ст.040 Раздела 1 с кодом срока уплаты 01, 02 в стр.030 Раздела 1 должна быть равна гр.2 '") +
		НСтр("ru = 'подраздела 2.4.1 Раздела 2 по коду показателя 60005, 60006, 60007, 60009 и КБК. Если ';
			|en = 'подраздела 2.4.1 Раздела 2 по коду показателя 60005, 60006, 60007, 60009 и КБК. Если '") +
		НСтр("ru = 'несколько сумм акциза, рассчитанных по разным видам подакцизных товаров, подлежат зачислению ';
			|en = 'несколько сумм акциза, рассчитанных по разным видам подакцизных товаров, подлежат зачислению '") +
		НСтр("ru = 'на один и тот же КБК, для заполнения стр.040 Раздела 1 необходимо определить конечный результат ';
			|en = 'на один и тот же КБК, для заполнения стр.040 Раздела 1 необходимо определить конечный результат '") +
		НСтр("ru = 'расчета с бюджетом по соответствующему КБК.';
			|en = 'расчета с бюджетом по соответствующему КБК.'"));
	...
	Пока ВыборкаР1.Следующий() Цикл
		...
		Если НЕ ЗначениеЗаполнено(ВыборкаР1.Р01С042) Тогда
			Продолжить;
		КонецЕсли;
		...
		Пока Выборка.Следующий() Цикл
			...
			Показатели.Р01С042.Дополнение = "КБК " + Выборка.КБК;
		...
		Если СуммаР21 = 0 И Сумма1 = 0 Тогда
			РасчетнаяСумма = СуммаР21;
			Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
				ВыборкаР1.Р01С042, РасчетнаяСумма, ВыборкаР1.КБК);
		ИначеЕсли Сумма1 <= 0 ИЛИ Сумма2 >= 0 Тогда
			РасчетнаяСумма = Макс(Сумма1, 0);
			Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки2,
				ВыборкаР1.Р01С042, СуммаР21, СуммаР22, РасчетнаяСумма, ВыборкаР1.КБК);
		Иначе
			РасчетнаяСумма = Макс(Сумма3, 0);
			Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки3,
				ВыборкаР1.Р01С042, СуммаР21, СуммаР22, СуммаР23, СуммаР24, РасчетнаяСумма, ВыборкаР1.КБК);
		КонецЕсли;
...
Процедура ПроверкаКС_2_08(СтруктураРезультата)
	...
	Пока ВыборкаР1.Следующий() Цикл
		...
		Если НЕ ЗначениеЗаполнено(ВыборкаР1.Р01С050) Тогда
			Продолжить;
		КонецЕсли;
		...
		Пока Выборка.Следующий() Цикл
			...
			Показатели.Р01С050.Дополнение = "КБК " + Выборка.КБК;
		...
		Если СуммаР21 = 0 И Сумма1 = 0 Тогда
			РасчетнаяСумма = СуммаР21;
			Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
				ВыборкаР1.Р01С050, РасчетнаяСумма, ВыборкаР1.КБК);
		ИначеЕсли Сумма1 <= 0 ИЛИ Сумма2 >= 0 Тогда
			РасчетнаяСумма = Макс(Сумма1, 0);
			Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки2,
				ВыборкаР1.Р01С050, СуммаР21, СуммаР22, РасчетнаяСумма, ВыборкаР1.КБК);
		Иначе
			РасчетнаяСумма = Макс(Сумма3, 0);
			Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки3,
				ВыборкаР1.Р01С050, СуммаР21, СуммаР22, СуммаР23, СуммаР24, РасчетнаяСумма, ВыборкаР1.КБК);
		КонецЕсли;
...
Процедура ПроверкаКС_2_09(СтруктураРезультата)
	...
	Пока ВыборкаР1.Следующий() Цикл
		...
		Если НЕ ЗначениеЗаполнено(ВыборкаР1.Р01С060) Тогда
			Продолжить;
		КонецЕсли;
		...
		Пока Выборка.Следующий() Цикл
			...
			Показатели.Р01С060.Дополнение = "КБК " + Выборка.КБК;
		...
		Если СуммаР21 = 0 И Сумма1 = 0 Тогда
			РасчетнаяСумма = СуммаР21;
			Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
				ВыборкаР1.Р01С060, РасчетнаяСумма, ВыборкаР1.КБК);
		ИначеЕсли Сумма1 <= 0 ИЛИ Сумма2 >= 0 Тогда
			РасчетнаяСумма = Макс(Сумма1, 0);
			Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки2,
				ВыборкаР1.Р01С060, СуммаР21, СуммаР22, РасчетнаяСумма, ВыборкаР1.КБК);
		Иначе
			РасчетнаяСумма = Макс(Сумма3, 0);
			Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки3,
				ВыборкаР1.Р01С060, СуммаР21, СуммаР22, СуммаР23, СуммаР24, РасчетнаяСумма, ВыборкаР1.КБК);
		КонецЕсли;
...
Процедура ПроверкаКС_2_10(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Раздела 1 (КС 2.10)';
													|en = 'Проверка Раздела 1 (КС 2.10)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма акциза, подлежащая возврату в стр.060 Раздела 1 >= 0, если код формы реорганизации ';
			|en = 'Сумма акциза, подлежащая возврату в стр.060 Раздела 1 >= 0, если код формы реорганизации '") +
		НСтр("ru = 'на Титульном листе = 0 ';
			|en = 'на Титульном листе = 0 '"));
	...
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма акциза, подлежащая зачету (возврату)';
														|en = 'Ошибочная сумма акциза, подлежащая зачету (возврату)'"));
	Настройки = ОбработатьНастройки(		, Заголовки, СтруктураРезультата);
...
Процедура ПроверкаКС_3_06(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Раздела 2 (КС 3.6)';
													|en = 'Проверка Раздела 2 (КС 3.6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение кода показателя в гр.1 подр. 2.4.1 Раздела 2 должно соответствовать списку ';
			|en = 'Значение кода показателя в гр.1 подр. 2.4.1 Раздела 2 должно соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
...
Процедура ПроверкаКС_3_08(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Раздела 2 (КС 3.8)';
													|en = 'Проверка Раздела 2 (КС 3.8)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.2 и гр.3 подраздела 2.5 Раздела 2 <= гр.3 и гр.4 подраздела 2.2 Раздела 2 за налоговый ';
			|en = 'Гр.2 и гр.3 подраздела 2.5 Раздела 2 <= гр.3 и гр.4 подраздела 2.2 Раздела 2 за налоговый '") +
		НСтр("ru = 'период, отраженный в гр.4 и гр.5 подраздела 2.5 Раздела 2 по соответствующему коду подакцизного ';
			|en = 'период, отраженный в гр.4 и гр.5 подраздела 2.5 Раздела 2 по соответствующему коду подакцизного '") +
		НСтр("ru = 'товара';
			|en = 'товара'"));
...
Процедура ПроверкаКС_4_01(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.1)';
													|en = 'Проверка Приложения 1 (КС 4.1)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
...
Процедура ПроверкаКС_4_02(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.2)';
													|en = 'Проверка Приложения 1 (КС 4.2)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение кода показателя в гр.1 подр. 2.1 Раздела 2 должно соответствовать списку ';
...
Процедура ПроверкаКС_4_03(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.3 в редакции 2019г)';
													|en = 'Проверка Приложения 1 (КС 4.3 в редакции 2019г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.4 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.1 Раздела 2 по кодам подакцизных ';
			|en = 'Гр.4 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.1 Раздела 2 по кодам подакцизных '") +
		НСтр("ru = 'товаров 232, 271, 272, 284, 285, 310, 320, 330 и кодам показателей 10001, 10006-10012, 10020, 10022';
			|en = 'товаров 232, 271, 272, 284, 285, 310, 320, 330 и кодам показателей 10001, 10006-10012, 10020, 10022'"));
	...
	Если НЕ Документирование И ДанныеКС.ГодОтчета <= 2019 Тогда
		ПроверкаКС_4_03_код(Настройки);
		СтруктураРезультата = ОбработатьРезультат(Настройки, СтруктураРезультата);
	КонецЕсли;
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.3 в редакции 01-02 мес 2020г)';
													|en = 'Проверка Приложения 1 (КС 4.3 в редакции 01-02 мес 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.4 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.1 Раздела 2 по кодам подакцизных ';
			|en = 'Гр.4 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.1 Раздела 2 по кодам подакцизных '") +
		НСтр("ru = 'товаров 232, 273, 286, 287, 288, 294, 295, 296, 297, 310, 320, 330 и кодам показателей 10001, ';
			|en = 'товаров 232, 273, 286, 287, 288, 294, 295, 296, 297, 310, 320, 330 и кодам показателей 10001, '") +
		НСтр("ru = '10006-10012, 10020, 10022 - 10026';
			|en = '10006-10012, 10020, 10022 - 10026'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4';
													|en = '%1 = %2 по коду товара %3, коду показателя %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	...
	Если НЕ Документирование И ДанныеКС.ДатаОтчета < '20200301' И ДанныеКС.ДатаОтчета >= '20200101' Тогда
		ПроверкаКС_4_03_код(Настройки);
		СтруктураРезультата = ОбработатьРезультат(Настройки, СтруктураРезультата);
	КонецЕсли;
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.3 в редакции 03 мес 2020г и позднее)';
													|en = 'Проверка Приложения 1 (КС 4.3 в редакции 03 мес 2020г и позднее)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.4 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.1 Раздела 2 по кодам подакцизных ';
			|en = 'Гр.4 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.1 Раздела 2 по кодам подакцизных '") +
		НСтр("ru = 'товаров 232, 251, 252, 253, 254, 274, 275, 276, 277, 287, 288, 294, 297, 310, 320, 330 и кодам ';
			|en = 'товаров 232, 251, 252, 253, 254, 274, 275, 276, 277, 287, 288, 294, 297, 310, 320, 330 и кодам '") +
		НСтр("ru = 'показателей 10001, 10006-10012, 10020, 10022 - 10026';
			|en = 'показателей 10001, 10006-10012, 10020, 10022 - 10026'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4';
													|en = '%1 = %2 по коду товара %3, коду показателя %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	...
	Если Документирование ИЛИ ДанныеКС.ДатаОтчета < '20200301' Тогда
		Возврат;
	КонецЕсли;
...
&НаСервере
Процедура ПроверкаКС_4_03_код(Настройки)
...
Процедура ПроверкаКС_4_04(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.4 в редакции 2019г)';
													|en = 'Проверка Приложения 1 (КС 4.4 в редакции 2019г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.4 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.2 Раздела 2 по кодам подакцизных ';
			|en = 'Гр.4 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.2 Раздела 2 по кодам подакцизных '") +
		НСтр("ru = 'товаров 232, 271, 272, 284, 285, 310, 320, 330 и кодам показателей 20001-20015';
			|en = 'товаров 232, 271, 272, 284, 285, 310, 320, 330 и кодам показателей 20001-20015'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4';
													|en = '%1 = %2 по коду товара %3, коду показателя %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.4 в редакции 01-02 мес 2020г)';
													|en = 'Проверка Приложения 1 (КС 4.4 в редакции 01-02 мес 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.4 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.2 Раздела 2 по кодам подакцизных ';
			|en = 'Гр.4 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.2 Раздела 2 по кодам подакцизных '") +
		НСтр("ru = 'товаров 232, 273, 286, 287, 288, 294, 295, 296, 297, 310, 320, 330 и кодам показателей 20001-20015';
			|en = 'товаров 232, 273, 286, 287, 288, 294, 295, 296, 297, 310, 320, 330 и кодам показателей 20001-20015'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4';
													|en = '%1 = %2 по коду товара %3, коду показателя %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.4 в редакции 03 мес 2020г и позднее)';
													|en = 'Проверка Приложения 1 (КС 4.4 в редакции 03 мес 2020г и позднее)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.4 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.2 Раздела 2 по кодам подакцизных ';
		...
		НСтр("ru = 'товаров 232, 251, 252, 253, 254, 274, 275, 276, 277, 287, 288, 294, 297, 310, 320, 330 и кодам ';
			|en = 'товаров 232, 251, 252, 253, 254, 274, 275, 276, 277, 287, 288, 294, 297, 310, 320, 330 и кодам '") +
		НСтр("ru = 'показателей 20001-20015';
			|en = 'показателей 20001-20015'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4';
													|en = '%1 = %2 по коду товара %3, коду показателя %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
...
&НаСервере
Процедура ПроверкаКС_4_04_код(Настройки)
...
Процедура ПроверкаКС_4_05(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.5 в редакции 2019г)';
													|en = 'Проверка Приложения 1 (КС 4.5 в редакции 2019г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.4 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.3 Раздела 2 по кодам подакцизных ';
			|en = 'Гр.4 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.3 Раздела 2 по кодам подакцизных '") +
		НСтр("ru = 'товаров 232, 271, 272, 284, 285, 310, 320, 330 и кодам показателей 30001-30005, 30008-30010, 30012';
			|en = 'товаров 232, 271, 272, 284, 285, 310, 320, 330 и кодам показателей 30001-30005, 30008-30010, 30012'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4';
													|en = '%1 = %2 по коду товара %3, коду показателя %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.5 в редакции 01-02 мес 2020г)';
													|en = 'Проверка Приложения 1 (КС 4.5 в редакции 01-02 мес 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.4 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.3 Раздела 2 по кодам подакцизных товаров ';
			|en = 'Гр.4 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.3 Раздела 2 по кодам подакцизных товаров '") +
		НСтр("ru = '232, 273, 286, 287, 288, 294, 295, 296, 297, 310, 320, 330 и кодам показателей 30001-30003, 30008-30016';
			|en = '232, 273, 286, 287, 288, 294, 295, 296, 297, 310, 320, 330 и кодам показателей 30001-30003, 30008-30016'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4';
													|en = '%1 = %2 по коду товара %3, коду показателя %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.5 в редакции 03 мес 2020г и позднее)';
													|en = 'Проверка Приложения 1 (КС 4.5 в редакции 03 мес 2020г и позднее)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.4 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.3 Раздела 2 по кодам подакцизных товаров ';
			|en = 'Гр.4 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.3 Раздела 2 по кодам подакцизных товаров '") +
		НСтр("ru = '232, 251, 252, 253, 254, 274, 275, 276, 277, 287, 288, 294, 297, 310, 320, 330 и кодам показателей ';
			|en = '232, 251, 252, 253, 254, 274, 275, 276, 277, 287, 288, 294, 297, 310, 320, 330 и кодам показателей '") +
		НСтр("ru = '30001-30003, 30008-30016';
			|en = '30001-30003, 30008-30016'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4';
													|en = '%1 = %2 по коду товара %3, коду показателя %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
...
Процедура ПроверкаКС_4_06(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.6 в редакции 2019г)';
													|en = 'Проверка Приложения 1 (КС 4.6 в редакции 2019г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.4 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.5 Раздела 2 по кодам подакцизных товаров ';
			|en = 'Гр.4 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.5 Раздела 2 по кодам подакцизных товаров '") +
		НСтр("ru = '232, 271, 272, 284, 285, 310, 320, 330, кодам показателей 50001-50011, соответствующему коду НП и году';
			|en = '232, 271, 272, 284, 285, 310, 320, 330, кодам показателей 50001-50011, соответствующему коду НП и году'"));
	Заголовки.Вставить("ШаблонРасшифровки"	
		, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4, коду НП %5, году %6';
				|en = '%1 = %2 по коду товара %3, коду показателя %4, коду НП %5, году %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	Настройки = ОбработатьНастройки(		, Заголовки, СтруктураРезультата);

	Если НЕ Документирование И ДанныеКС.ГодОтчета <= 2019 Тогда
		ПроверкаКС_4_06_код(Настройки);
		СтруктураРезультата = ОбработатьРезультат(Настройки, СтруктураРезультата);
	КонецЕсли;
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.6 в редакции 01-02 мес 2020г)';
													|en = 'Проверка Приложения 1 (КС 4.6 в редакции 01-02 мес 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.4 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.5 Раздела 2 по кодам подакцизных товаров ';
			|en = 'Гр.4 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.5 Раздела 2 по кодам подакцизных товаров '") +
		НСтр("ru = '232, 273, 286, 287, 288, 294, 295, 296, 297, 310, 320, 330, кодам показателей 50001-50011, ';
			|en = '232, 273, 286, 287, 288, 294, 295, 296, 297, 310, 320, 330, кодам показателей 50001-50011, '") +
		НСтр("ru = 'соответствующему коду НП и году';
			|en = 'соответствующему коду НП и году'"));
	Заголовки.Вставить("ШаблонРасшифровки"	
		, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4, коду НП %5, году %6';
				|en = '%1 = %2 по коду товара %3, коду показателя %4, коду НП %5, году %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.6 в редакции 03 мес 2020г и позднее)';
													|en = 'Проверка Приложения 1 (КС 4.6 в редакции 03 мес 2020г и позднее)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.4 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.5 Раздела 2 по кодам подакцизных товаров ';
			|en = 'Гр.4 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.5 Раздела 2 по кодам подакцизных товаров '") +
		НСтр("ru = '232, 251, 252, 253, 254, 274, 275, 276, 277, 287, 288, 294, 297, 310, 320, 330, кодам показателей ';
			|en = '232, 251, 252, 253, 254, 274, 275, 276, 277, 287, 288, 294, 297, 310, 320, 330, кодам показателей '") +
		НСтр("ru = '50001-50011, соответствующему коду НП и году';
			|en = '50001-50011, соответствующему коду НП и году'"));
	Заголовки.Вставить("ШаблонРасшифровки"	
		, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4, коду НП %5, году %6';
				|en = '%1 = %2 по коду товара %3, коду показателя %4, коду НП %5, году %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
...
&НаСервере
Процедура ПроверкаКС_4_06_код(Настройки)
...
Процедура ПроверкаКС_4_07(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.7 в редакции 2019г)';
													|en = 'Проверка Приложения 1 (КС 4.7 в редакции 2019г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.5 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.1 Раздела 2 по кодам подакцизных ';
			|en = 'Гр.5 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.1 Раздела 2 по кодам подакцизных '") +
		НСтр("ru = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 291, 292, 293 и ';
			|en = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 291, 292, 293 и '") +
		НСтр("ru = 'кодам показателей 10001, 10006-10012, 10020, 10022';
			|en = 'кодам показателей 10001, 10006-10012, 10020, 10022'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4';
													|en = '%1 = %2 по коду товара %3, коду показателя %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.7 в редакции 01-02 мес 2020г)';
													|en = 'Проверка Приложения 1 (КС 4.7 в редакции 01-02 мес 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.5 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.1 Раздела 2 по кодам подакцизных ';
			|en = 'Гр.5 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.1 Раздела 2 по кодам подакцизных '") +
		НСтр("ru = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 290 и ';
			|en = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 290 и '") +
		НСтр("ru = 'кодам показателей 10001, 10006-10012, 10020, 10022 - 10026';
			|en = 'кодам показателей 10001, 10006-10012, 10020, 10022 - 10026'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4';
													|en = '%1 = %2 по коду товара %3, коду показателя %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.7 в редакции 03 мес 2020г и позднее)';
													|en = 'Проверка Приложения 1 (КС 4.7 в редакции 03 мес 2020г и позднее)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.5 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.1 Раздела 2 по кодам подакцизных ';
			|en = 'Гр.5 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.1 Раздела 2 по кодам подакцизных '") +
		НСтр("ru = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 225, 226, 231, 290 и ';
			|en = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 225, 226, 231, 290 и '") +
		НСтр("ru = 'кодам показателей 10001, 10006-10012, 10020, 10022 - 10026';
			|en = 'кодам показателей 10001, 10006-10012, 10020, 10022 - 10026'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4';
													|en = '%1 = %2 по коду товара %3, коду показателя %4'"));
...
&НаСервере
Процедура ПроверкаКС_4_07_код(Настройки)
...
Процедура ПроверкаКС_4_08(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.8 в редакции 2019г)';
													|en = 'Проверка Приложения 1 (КС 4.8 в редакции 2019г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.5 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.2 Раздела 2 по кодам подакцизных ';
			|en = 'Гр.5 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.2 Раздела 2 по кодам подакцизных '") +
		НСтр("ru = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 291, 292, 293 и ';
			|en = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 291, 292, 293 и '") +
		НСтр("ru = 'кодам показателей 20001-20015';
			|en = 'кодам показателей 20001-20015'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4';
													|en = '%1 = %2 по коду товара %3, коду показателя %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.8 в редакции 01-02 мес 2020г)';
													|en = 'Проверка Приложения 1 (КС 4.8 в редакции 01-02 мес 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.5 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.2 Раздела 2 по кодам подакцизных ';
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.8 в редакции 03 мес 2020г и позднее)';
													|en = 'Проверка Приложения 1 (КС 4.8 в редакции 03 мес 2020г и позднее)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.5 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.2 Раздела 2 по кодам подакцизных ';
...
Процедура ПроверкаКС_4_09(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.9 в редакции 2019г)';
													|en = 'Проверка Приложения 1 (КС 4.9 в редакции 2019г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.5 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.3 Раздела 2 по кодам подакцизных ';
			|en = 'Гр.5 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.3 Раздела 2 по кодам подакцизных '") +
		НСтр("ru = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 291, 292, 293 и ';
			|en = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 291, 292, 293 и '") +
		НСтр("ru = 'кодам показателей 30001-30005, 30008-30010, 30012';
			|en = 'кодам показателей 30001-30005, 30008-30010, 30012'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4';
													|en = '%1 = %2 по коду товара %3, коду показателя %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.9 в редакции 01-02 мес 2020г)';
													|en = 'Проверка Приложения 1 (КС 4.9 в редакции 01-02 мес 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.5 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.3 Раздела 2 по кодам подакцизных ';
		...
		НСтр("ru = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 290 и ';
			|en = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 290 и '") +
		НСтр("ru = 'кодам показателей 30001-30003, 30008-30016';
			|en = 'кодам показателей 30001-30003, 30008-30016'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4';
													|en = '%1 = %2 по коду товара %3, коду показателя %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.9 в редакции 03 мес 2020г и позднее)';
													|en = 'Проверка Приложения 1 (КС 4.9 в редакции 03 мес 2020г и позднее)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.5 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.3 Раздела 2 по кодам подакцизных ';
...
&НаСервере
Процедура ПроверкаКС_4_09_код(Настройки)
...
Процедура ПроверкаКС_4_10(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.10 в редакции 2019г)';
													|en = 'Проверка Приложения 1 (КС 4.10 в редакции 2019г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.5 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.5 Раздела 2 по кодам подакцизных ';
			|en = 'Гр.5 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.5 Раздела 2 по кодам подакцизных '") +
		НСтр("ru = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 291, 292, 293, ';
			|en = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 291, 292, 293, '") +
		НСтр("ru = 'кодам показателей 50001-50011, соответствующему коду НП и году';
			|en = 'кодам показателей 50001-50011, соответствующему коду НП и году'"));
	Заголовки.Вставить("ШаблонРасшифровки"	
		, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4, коду НП %5, году %6';
				|en = '%1 = %2 по коду товара %3, коду показателя %4, коду НП %5, году %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.10 в редакции 01-02 мес 2020г)';
													|en = 'Проверка Приложения 1 (КС 4.10 в редакции 01-02 мес 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.5 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.5 Раздела 2 по кодам подакцизных ';
			|en = 'Гр.5 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.5 Раздела 2 по кодам подакцизных '") +
		НСтр("ru = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 290, ';
			|en = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 290, '") +
		НСтр("ru = 'кодам показателей 50001-50011, соответствующему коду НП и году';
			|en = 'кодам показателей 50001-50011, соответствующему коду НП и году'"));
	Заголовки.Вставить("ШаблонРасшифровки"	
		, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4, коду НП %5, году %6';
	...
	Заголовки.Вставить("Условие"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.10 в редакции 03 мес 2020г и позднее)';
													|en = 'Проверка Приложения 1 (КС 4.10 в редакции 03 мес 2020г и позднее)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.5 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.5 Раздела 2 по кодам подакцизных ';
			|en = 'Гр.5 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.5 Раздела 2 по кодам подакцизных '") +
		НСтр("ru = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 225, 226, 231, 290, ';
			|en = 'товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 225, 226, 231, 290, '") +
		НСтр("ru = 'кодам показателей 50001-50011, соответствующему коду НП и году';
			|en = 'кодам показателей 50001-50011, соответствующему коду НП и году'"));
	Заголовки.Вставить("ШаблонРасшифровки"	
		, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4, коду НП %5, году %6';
...
&НаСервере
Процедура ПроверкаКС_4_10_код(Настройки)
...
Процедура ПроверкаКС_5_01(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.1)';
													|en = 'Проверка Приложения 2 (КС 5.1)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
...
Процедура ПроверкаКС_5_02(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.2)';
													|en = 'Проверка Приложения 2 (КС 5.2)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
...
Процедура ПроверкаКС_5_04(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.4)';
													|en = 'Проверка Приложения 2 (КС 5.4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
...
Процедура ПроверкаКС_5_05(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.5)';
													|en = 'Проверка Приложения 2 (КС 5.5)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
...
Процедура ПроверкаКС_5_06(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.6)';
													|en = 'Проверка Приложения 2 (КС 5.6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
...
Процедура ПроверкаКС_5_07(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.7)';
													|en = 'Проверка Приложения 2 (КС 5.7)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Превышение суммы акциза в стр.055 Приложения 2 должно быть равно сумме стр.100 Приложения 2';
			|en = 'Превышение суммы акциза в стр.055 Приложения 2 должно быть равно сумме стр.100 Приложения 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
...
Процедура ПроверкаКС_5_08(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.8)';
													|en = 'Проверка Приложения 2 (КС 5.8)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение кода вида подакцизного товара в стр.060 Приложения 2 должно соответствовать списку ';
			|en = 'Значение кода вида подакцизного товара в стр.060 Приложения 2 должно соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
...
Процедура ПроверкаКС_5_09а(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, 
		НСтр("ru = 'Код показателя в гр.3 стр.070 Приложения 2 = 20001, 20008, 20012 или не заполнен';
			|en = 'Код показателя в гр.3 стр.070 Приложения 2 = 20001, 20008, 20012 или не заполнен'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.9а)';
													|en = 'Проверка Приложения 2 (КС 5.9а)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.4 стр.070 Приложения 2 >= гр.3 подраздела 2.2 Раздела 2 по соответствующему ';
			|en = 'Гр.4 стр.070 Приложения 2 >= гр.3 подраздела 2.2 Раздела 2 по соответствующему '") +
...
Процедура ПроверкаКС_5_09б(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.9б)';
													|en = 'Проверка Приложения 2 (КС 5.9б)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.5 стр.070 Приложения 2 >= гр.4 подраздела 2.2 Раздела 2 по соответствующему ';
			|en = 'Гр.5 стр.070 Приложения 2 >= гр.4 подраздела 2.2 Раздела 2 по соответствующему '") +
		НСтр("ru = 'коду подакцизного товара и кодам показателей 20001, 20008, 20012';
			|en = 'коду подакцизного товара и кодам показателей 20001, 20008, 20012'"));
	Заголовки.Вставить("ШаблонРасшифровки"	
		, НСтр("ru = '%1 >= %2 по коду товара %3, коду показателя %4';
...
Процедура ПроверкаКС_5_10а(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, 
		НСтр("ru = 'Код показателя в гр.3 стр.080 Приложения 2 = 50003, 50008, 50009 или не заполнен';
			|en = 'Код показателя в гр.3 стр.080 Приложения 2 = 50003, 50008, 50009 или не заполнен'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.10а)';
													|en = 'Проверка Приложения 2 (КС 5.10а)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.4 стр.080 Приложения 2 = гр.2 подраздела 2.5 Раздела 2 по соответствующему ';
			|en = 'Гр.4 стр.080 Приложения 2 = гр.2 подраздела 2.5 Раздела 2 по соответствующему '") +
...
Процедура ПроверкаКС_5_10б(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.10б)';
													|en = 'Проверка Приложения 2 (КС 5.10б)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.5 стр.080 Приложения 2 = гр.3 подраздела 2.5 Раздела 2 по соответствующему ';
			|en = 'Гр.5 стр.080 Приложения 2 = гр.3 подраздела 2.5 Раздела 2 по соответствующему '") +
		НСтр("ru = 'коду подакцизного товара, кодам показателей 50003, 50008, 50009, коду НП и года';
			|en = 'коду подакцизного товара, кодам показателей 50003, 50008, 50009, коду НП и года'"));
	Заголовки.Вставить("ШаблонРасшифровки"	
		, НСтр("ru = '%1 = %2 по коду товара %3, коду показателя %4, коду НП %5, коду года %6';
...
Процедура ПроверкаКС_5_11(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.11)';
													|en = 'Проверка Приложения 2 (КС 5.11)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Описание контрольного соотношения отсутствует по причине: некорректная формулировка ';
			|en = 'Описание контрольного соотношения отсутствует по причине: некорректная формулировка '") +
		НСтр("ru = 'описания контрольного соотношения';
			|en = 'описания контрольного соотношения'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru=''"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru=''"));
	Настройки = ОбработатьНастройки(		, Заголовки, СтруктураРезультата);
...
Процедура ПроверкаКС_5_12(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.12)';
													|en = 'Проверка Приложения 2 (КС 5.12)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Гр.3,4,5 стр.090 Приложения 2 текущего налогового периода по соответствующим кодам подакцизного ';
			|en = 'Гр.3,4,5 стр.090 Приложения 2 текущего налогового периода по соответствующим кодам подакцизного '") +
		НСтр("ru = 'товара, налогового периода, года, банковской гарантии (гр.6,7 стр.090 Приложения 2, гр.3 стр.010, ';
			|en = 'товара, налогового периода, года, банковской гарантии (гр.6,7 стр.090 Приложения 2, гр.3 стр.010, '") +
		НСтр("ru = '020 Приложения 2) должны равняться гр.3,4,5 стр.080 Приложения 2 предыдущих налоговых периодов';
			|en = '020 Приложения 2) должны равняться гр.3,4,5 стр.080 Приложения 2 предыдущих налоговых периодов'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru=''"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru=''"));
	Настройки = ОбработатьНастройки(		, Заголовки, СтруктураРезультата);
...
Процедура ПроверкаКС_5_13(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.13)';
													|en = 'Проверка Приложения 2 (КС 5.13)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Превышение суммы акциза в стр.100 Приложения 2 = стр.070 - стр.080 - стр.090 Приложения 2 ';
			|en = 'Превышение суммы акциза в стр.100 Приложения 2 = стр.070 - стр.080 - стр.090 Приложения 2 '") +
		НСтр("ru = 'по каждому коду подакцизного товара в стр.060 Приложения 2';
			|en = 'по каждому коду подакцизного товара в стр.060 Приложения 2'"));
...
Процедура ПроверкаКС_6_01(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 3 (КС 6.1)';
													|en = 'Проверка Приложения 3 (КС 6.1)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение ИНН организации - покупателя в стр.010 Приложения 3 должно быть заполнено';
			|en = 'Значение ИНН организации - покупателя в стр.010 Приложения 3 должно быть заполнено'"));
...
Процедура ПроверкаКС_6_02(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 3 (КС 6.2)';
													|en = 'Проверка Приложения 3 (КС 6.2)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение КПП организации - покупателя в стр.020 Приложения 3 должно быть заполнено';
			|en = 'Значение КПП организации - покупателя в стр.020 Приложения 3 должно быть заполнено'"));
...
Процедура ПроверкаКС_6_06(СтруктураРезультата)
	...
	ИменаПоказателей.Вставить("Ставка"		, "Ставка");
	ИменаПоказателей.Вставить("П03Г005"		, "П00103М100005_");
	
	СформироватьПоказатели(Показатели, ИменаПоказателей);
	Показатели.Ставка.Представление = НСтр("ru = 'Ставка акциза, руб.';
											|en = 'Ставка акциза, руб.'");
	
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение3 Цикл
		КолвоСтрок = КоличествоСтрок(СтраницаРаздела, Лев(Показатели.П03Г004.ИмяПоказателя, 14));
		...
		Для Счетчик = 1 По КолвоСтрок Цикл
			...
			Показатели.Ставка.Значение = ЗначениеСтавки;
			Показатели.Ставка.Дополнение = "Код подакцизного товара " + Показатели.П03Г004.ЗначениеСтр;
			РасшифроватьПоказатель(Показатели.Ставка);
...
Процедура ПроверкаКС_7_02(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 4 (КС 7.2)';
													|en = 'Проверка Приложения 4 (КС 7.2)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение ИНН организации в стр.010 Приложения 4 должно быть заполнено';
			|en = 'Значение ИНН организации в стр.010 Приложения 4 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение ИНН %1 заполнено';
													|en = 'Значение ИНН %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении ИНН';
														|en = 'Ошибка при заполнении ИНН'"));
...
Процедура ПроверкаКС_7_03(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 4 (КС 7.3)';
													|en = 'Проверка Приложения 4 (КС 7.3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение КПП организации в стр.020 Приложения 4 должно быть заполнено';
			|en = 'Значение КПП организации в стр.020 Приложения 4 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение КПП %1 заполнено';
													|en = 'Значение КПП %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении КПП';
														|en = 'Ошибка при заполнении КПП'"));
...
Процедура ПроверкаКС_7_06(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 4 (КС 7.6)';
													|en = 'Проверка Приложения 4 (КС 7.6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение номера счета-фактуры в стр.050 Приложения 4 должно быть заполнено';
			|en = 'Значение номера счета-фактуры в стр.050 Приложения 4 должно быть заполнено'"));
...
Процедура ПроверкаКС_7_07(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 4 (КС 7.7)';
													|en = 'Проверка Приложения 4 (КС 7.7)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение даты счета-фактуры в стр.060 Приложения 4 должно быть заполнено';
			|en = 'Значение даты счета-фактуры в стр.060 Приложения 4 должно быть заполнено'"));
...
Процедура ПроверкаКС_7_09(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 4 (КС 7.9)';
													|en = 'Проверка Приложения 4 (КС 7.9)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значения реквизитов корректировочной счета-фактуры в стр.080, 090, 100 Приложения 4 должны ';
			|en = 'Значения реквизитов корректировочной счета-фактуры в стр.080, 090, 100 Приложения 4 должны '") +
		НСтр("ru = 'быть заполнены в случае заполнения одного из значений';
			|en = 'быть заполнены в случае заполнения одного из значений'"));
	...
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении реквизитов корректировочной счета-фактуры';
														|en = 'Ошибка при заполнении реквизитов корректировочной счета-фактуры'"));
	Настройки = ОбработатьНастройки(		, Заголовки, СтруктураРезультата);
...
Процедура ПроверкаКС_8_01(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.1)';
													|en = 'Проверка Приложения 5 (КС 8.1)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение регистрационного номера извещения в стр.010 Приложения 5 должно быть заполнено';
			|en = 'Значение регистрационного номера извещения в стр.010 Приложения 5 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение регистрационного номера %1 заполнено';
													|en = 'Значение регистрационного номера %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении регистрационного номера';
														|en = 'Ошибка при заполнении регистрационного номера'"));
...
Процедура ПроверкаКС_8_02(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.2)';
													|en = 'Проверка Приложения 5 (КС 8.2)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение даты регистрации извещения в стр.020 Приложения 5 должно быть заполнено';
			|en = 'Значение даты регистрации извещения в стр.020 Приложения 5 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение даты регистрации %1 заполнено';
													|en = 'Значение даты регистрации %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении даты регистрации';
														|en = 'Ошибка при заполнении даты регистрации'"));
...
Процедура ПроверкаКС_8_05(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.5)';
													|en = 'Проверка Приложения 5 (КС 8.5)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение кода вида этилового спирта в стр.050 Приложения 5 должно соответствовать списку ';
			|en = 'Значение кода вида этилового спирта в стр.050 Приложения 5 должно соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
...
Процедура ПроверкаКС_8_07(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			
		, НСтр("ru = 'Дата извещения в стр.020 Приложения 5 относится к отчетному периоду декларации';
				|en = 'Дата извещения в стр.020 Приложения 5 относится к отчетному периоду декларации'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru=''"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.7)';
													|en = 'Проверка Приложения 5 (КС 8.7)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.070 Приложения 5 должно равняться гр.2 подраздела 2.4.1 ';
			|en = 'Значение суммы акциза в стр.070 Приложения 5 должно равняться гр.2 подраздела 2.4.1 '") +
	...
	|	Раздел26.Страница КАК Страница,
	|	Раздел26.Строка_ КАК Строка_
	|ИЗ
	|	ВТ_Р26 КАК Раздел26
	|ГДЕ
	...
	|	Приложение5.Страница КАК Страница
	|ИЗ
	|	ВТ_П05 КАК Приложение5
	|ГДЕ
	|	Приложение5.Отчет = &Отчет
	|	И ГОД(Приложение5.П05С020) = &ГодОтчета
	|	И МЕСЯЦ(Приложение5.П05С020) = &МесОтчета
	|
	|УПОРЯДОЧИТЬ ПО
	|	Страница
	|ИТОГИ
	...
	Пока ВыборкаП5.Следующий() Цикл
		...
		ЗарегистрироватьФормулу(Настройки);
		СуммаП05	= ВыборкаП5[ПоказательП5];
		СуммаР26	= 0;
		
		Выборка = ВыборкаП5.Выбрать();
		Пока Выборка.Следующий() Цикл
			Источник = ИсточникИзВыборки(Выборка, Показатели[ПоказательП5]);
			Показатели[ПоказательП5].Дополнение = "Страница " + Выборка.Страница;
			ЗаполнитьИРасшифроватьПоказатель(Показатели[ПоказательП5], Источник);
		КонецЦикла; 
		
		Если ВыборкаР2.НайтиСледующий(Новый Структура("КодТовара", ВыборкаП5.КодТовара)) Тогда
			
			СуммаР26	= ВыборкаР2[ПоказательР2];
			Выборка		= ВыборкаР2.Выбрать();
			
			Пока Выборка.Следующий() Цикл
				Источник = ИсточникИзВыборки(Выборка, Показатели[ПоказательР2], Выборка.Строка_);
				Показатели[ПоказательР2].Дополнение = "Страница " + Выборка.Страница + ", строка " + Выборка.Строка_ 
					+ ", код показателя " + ЗначениеСтр(Выборка.КодПоказателя);
				ЗаполнитьИРасшифроватьПоказатель(Показатели[ПоказательР2], Источник, Выборка.Строка_);
			КонецЦикла;
			ВыборкаР2.Сбросить();
		КонецЕсли;
		
		Настройки.ЭтоОшибка = НЕ СуммаП05 = СуммаР26;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
			СуммаП05, СуммаР26, ЗначениеСтр(ВыборкаП5.КодТовара));
		ДополнитьСтруктуруОшибок(Настройки);
	КонецЦикла;
...
Процедура ПроверкаКС_8_11(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.11)';
													|en = 'Проверка Приложения 5 (КС 8.11)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма авансового платежа в стр.110 Приложения 5 должен быть равен сумме стр.330 Приложения 5';
			|en = 'Сумма авансового платежа в стр.110 Приложения 5 должен быть равен сумме стр.330 Приложения 5'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
...
Процедура ПроверкаКС_8_12(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.12)';
													|en = 'Проверка Приложения 5 (КС 8.12)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение регистрационного номера извещения в стр.120 Приложения 5 должно быть заполнено ';
			|en = 'Значение регистрационного номера извещения в стр.120 Приложения 5 должно быть заполнено '") +
		НСтр("ru = 'в случае заполнения подраздела 1.1 Приложения 5';
			|en = 'в случае заполнения подраздела 1.1 Приложения 5'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение регистрационного номера %1 заполнено';
													|en = 'Значение регистрационного номера %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении регистрационного номера';
														|en = 'Ошибка при заполнении регистрационного номера'"));
...
Процедура ПроверкаКС_8_13(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.13)';
													|en = 'Проверка Приложения 5 (КС 8.13)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение даты регистрации извещения в стр.130 Приложения 5 должно быть заполнено ';
			|en = 'Значение даты регистрации извещения в стр.130 Приложения 5 должно быть заполнено '") +
		НСтр("ru = 'в случае заполнения подраздела 1.1 Приложения 5';
			|en = 'в случае заполнения подраздела 1.1 Приложения 5'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение даты регистрации %1 заполнено';
													|en = 'Значение даты регистрации %1 заполнено'"));
...
Процедура ПроверкаКС_8_14(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.14)';
													|en = 'Проверка Приложения 5 (КС 8.14)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение ИНН организации в стр.140 Приложения 5 должно быть заполнено ';
			|en = 'Значение ИНН организации в стр.140 Приложения 5 должно быть заполнено '") +
		НСтр("ru = 'в случае заполнения подраздела 1.1 Приложения 5';
			|en = 'в случае заполнения подраздела 1.1 Приложения 5'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение ИНН организации %1 заполнено';
													|en = 'Значение ИНН организации %1 заполнено'"));
...
Процедура ПроверкаКС_8_15(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.15)';
													|en = 'Проверка Приложения 5 (КС 8.15)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение КПП организации в стр.150 Приложения 5 должно быть заполнено ';
			|en = 'Значение КПП организации в стр.150 Приложения 5 должно быть заполнено '") +
		НСтр("ru = 'в случае заполнения подраздела 1.1 Приложения 5';
			|en = 'в случае заполнения подраздела 1.1 Приложения 5'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение КПП организации %1 заполнено';
													|en = 'Значение КПП организации %1 заполнено'"));
...
Процедура ПроверкаКС_8_16(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.16)';
													|en = 'Проверка Приложения 5 (КС 8.16)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение кода вида этилового спирта в стр.160 Приложения 5 должно соответствовать списку ';
			|en = 'Значение кода вида этилового спирта в стр.160 Приложения 5 должно соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
...
Процедура ПроверкаКС_8_17(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.17)';
													|en = 'Проверка Приложения 5 (КС 8.17)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема этилового спирта в стр.170 Приложения 5 должно быть заполнено ';
			|en = 'Значение объема этилового спирта в стр.170 Приложения 5 должно быть заполнено '") +
		НСтр("ru = 'в случае заполнения подраздела 1.1 Приложения 5';
			|en = 'в случае заполнения подраздела 1.1 Приложения 5'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение объема этилового спирта %1 заполнено';
													|en = 'Значение объема этилового спирта %1 заполнено'"));
...
Процедура ПроверкаКС_8_19(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.19)';
													|en = 'Проверка Приложения 5 (КС 8.19)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение кода вида подакцизного товара в стр.190 Приложения 5 должно соответствовать списку ';
			|en = 'Значение кода вида подакцизного товара в стр.190 Приложения 5 должно соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
...
Процедура ПроверкаКС_8_20(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.20)';
													|en = 'Проверка Приложения 5 (КС 8.20)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема этилового спирта в стр.200 Приложения 5 должно быть заполнено';
			|en = 'Значение объема этилового спирта в стр.200 Приложения 5 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение объема этилового спирта %1 заполнено';
													|en = 'Значение объема этилового спирта %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении объема этилового спирта';
														|en = 'Ошибка при заполнении объема этилового спирта'"));
...
Процедура ПроверкаКС_8_21(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.21)';
													|en = 'Проверка Приложения 5 (КС 8.21)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение стр.210 Приложения 5 должно равняться сумме значений стр.270 Приложения 5 ';
			|en = 'Значение стр.210 Приложения 5 должно равняться сумме значений стр.270 Приложения 5 '") +
		НСтр("ru = 'деклараций за прошедшие налоговые периоды по соответствующему извещению';
			|en = 'деклараций за прошедшие налоговые периоды по соответствующему извещению'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru=''"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru=''"));
	Настройки = ОбработатьНастройки(		, Заголовки, СтруктураРезультата);
...
Процедура ПроверкаКС_8_22(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.22)';
													|en = 'Проверка Приложения 5 (КС 8.22)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма акциза в стр.220 Приложения 5 должна равняться произведению стр.210 Приложения 5 ';
			|en = 'Сумма акциза в стр.220 Приложения 5 должна равняться произведению стр.210 Приложения 5 '") +
		НСтр("ru = 'и ставки акциза по соответствующему подакцизному товару';
			|en = 'и ставки акциза по соответствующему подакцизному товару'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 х %3 Итог [%4] по коду товара %5';
													|en = '%1 = %2 х %3 Итог [%4] по коду товара %5'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение5 Цикл
		КолвоСтрок = КоличествоСтрок(СтраницаРаздела, Лев(Показатели.П52С190.ИмяПоказателя, 14));
		...
		Для Счетчик = 1 По КолвоСтрок Цикл
			...
			Показатели.Ставка.Значение = ЗначениеСтавки;
			Показатели.Ставка.Дополнение = "Код подакцизного товара " + Показатели.П52С190.ЗначениеСтр;
			РасшифроватьПоказатель(Показатели.Ставка);
...
Процедура ПроверкаКС_8_23(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.23)';
													|en = 'Проверка Приложения 5 (КС 8.23)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение стр.230 Приложения 5 должно равняться сумме значений стр.290 Приложения 5 ';
			|en = 'Значение стр.230 Приложения 5 должно равняться сумме значений стр.290 Приложения 5 '") +
		НСтр("ru = 'деклараций за прошедшие налоговые периоды по соответствующему извещению';
			|en = 'деклараций за прошедшие налоговые периоды по соответствующему извещению'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru=''"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru=''"));
...
Процедура ПроверкаКС_8_24(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.24)';
													|en = 'Проверка Приложения 5 (КС 8.24)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение стр.240 Приложения 5 должно равняться сумме значений стр.300 Приложения 5 ';
			|en = 'Значение стр.240 Приложения 5 должно равняться сумме значений стр.300 Приложения 5 '") +
		НСтр("ru = 'деклараций за прошедшие налоговые периоды по соответствующему извещению';
			|en = 'деклараций за прошедшие налоговые периоды по соответствующему извещению'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru=''"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru=''"));
...
Процедура ПроверкаКС_8_25(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.25)';
													|en = 'Проверка Приложения 5 (КС 8.25)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение стр.250 Приложения 5 должно равняться сумме значений стр.310 Приложения 5 ';
			|en = 'Значение стр.250 Приложения 5 должно равняться сумме значений стр.310 Приложения 5 '") +
		НСтр("ru = 'деклараций за прошедшие налоговые периоды по соответствующему извещению';
			|en = 'деклараций за прошедшие налоговые периоды по соответствующему извещению'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru=''"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru=''"));
...
Процедура ПроверкаКС_8_26(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.26)';
													|en = 'Проверка Приложения 5 (КС 8.26)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение стр.260 Приложения 5 должно равняться сумме значений стр.320 Приложения 5 ';
			|en = 'Значение стр.260 Приложения 5 должно равняться сумме значений стр.320 Приложения 5 '") +
		НСтр("ru = 'деклараций за прошедшие налоговые периоды по соответствующему извещению';
			|en = 'деклараций за прошедшие налоговые периоды по соответствующему извещению'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru=''"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru=''"));
...
Процедура ПроверкаКС_8_27(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.27)';
													|en = 'Проверка Приложения 5 (КС 8.27)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема подакцизного товара в стр.270 Приложения 5 должно равняться гр.2 подраздела 2.3 ';
			|en = 'Значение объема подакцизного товара в стр.270 Приложения 5 должно равняться гр.2 подраздела 2.3 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.190 Приложения 5 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.190 Приложения 5 и коду показателя '") +
		НСтр("ru = '30003 в гр.1 подраздела 2.3 Раздела 2';
			|en = '30003 в гр.1 подраздела 2.3 Раздела 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3';
													|en = '%1 = %2 по коду товара %3'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	...
	|	Приложение5.Отчет КАК Отчет,
	|	Приложение5.Страница КАК Страница,
	|	Приложение5.Строка_ КАК Строка_
	|ИЗ
	...
	Пока ВыборкаП5.Следующий() Цикл
		...
		ЗарегистрироватьФормулу(Настройки);
		СуммаП52	= ВыборкаП5[ПоказательП5];
		СуммаР23	= 0;
		
		Выборка = ВыборкаП5.Выбрать();
		Пока Выборка.Следующий() Цикл
			Источник = ИсточникИзВыборки(Выборка, Показатели[ПоказательП5], Выборка.Строка_);
			Показатели[ПоказательП5].Дополнение = "Страница " + Выборка.Страница + ", группа строк " + Выборка.Строка_;
			ЗаполнитьИРасшифроватьПоказатель(Показатели[ПоказательП5], Источник, Выборка.Строка_);
		КонецЦикла; 
		
		Если ВыборкаР2.НайтиСледующий(Новый Структура("КодТовара", ВыборкаП5.КодТовара)) Тогда
			
			СуммаР23	= ВыборкаР2[ПоказательР2];
			Выборка		= ВыборкаР2.Выбрать();
		...
		Настройки.ЭтоОшибка = НЕ СуммаП52 = СуммаР23;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
			СуммаП52, СуммаР23, ЗначениеСтр(ВыборкаП5.КодТовара));
		ДополнитьСтруктуруОшибок(Настройки);
	КонецЦикла;
...
Процедура ПроверкаКС_8_28(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.28)';
													|en = 'Проверка Приложения 5 (КС 8.28)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма акциза в стр.280 Приложения 5 должна равняться произведению стр.270 Приложения 5 ';
			|en = 'Сумма акциза в стр.280 Приложения 5 должна равняться произведению стр.270 Приложения 5 '") +
		НСтр("ru = 'и ставки акциза по соответствующему подакцизному товару';
			|en = 'и ставки акциза по соответствующему подакцизному товару'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 х %3 Итог [%4] по коду товара %5';
													|en = '%1 = %2 х %3 Итог [%4] по коду товара %5'"));
...
Процедура ПроверкаКС_8_30(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 5 (КС 8.30)';
													|en = 'Проверка Приложения 5 (КС 8.30)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма акциза в стр.330 Приложения 5 должна равняться произведению стр.320 Приложения 5 ';
			|en = 'Сумма акциза в стр.330 Приложения 5 должна равняться произведению стр.320 Приложения 5 '") +
		НСтр("ru = 'и ставки акциза по соответствующему подакцизному товару';
			|en = 'и ставки акциза по соответствующему подакцизному товару'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 х %3 Итог [%4] по коду товара %5';
													|en = '%1 = %2 х %3 Итог [%4] по коду товара %5'"));
...
Процедура ПроверкаКС_9_02(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.2)';
													|en = 'Проверка Приложения 6 (КС 9.2)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение номера банковской гарантии в стр.010 Приложения 6 должно быть заполнено';
			|en = 'Значение номера банковской гарантии в стр.010 Приложения 6 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение номера банковской гарантии %1 заполнено';
													|en = 'Значение номера банковской гарантии %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Не указан номер банковской гарантии';
														|en = 'Не указан номер банковской гарантии'"));
...
Процедура ПроверкаКС_9_03(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.3)';
													|en = 'Проверка Приложения 6 (КС 9.3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
...
Процедура ПроверкаКС_9_04(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.4)';
													|en = 'Проверка Приложения 6 (КС 9.4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
...
Процедура ПроверкаКС_9_05(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.5)';
													|en = 'Проверка Приложения 6 (КС 9.5)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
...
Процедура ПроверкаКС_9_06(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.6)';
													|en = 'Проверка Приложения 6 (КС 9.6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
...
Процедура ПроверкаКС_9_07(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.7)';
													|en = 'Проверка Приложения 6 (КС 9.7)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение регистрационного номера извещения в стр.050 Приложения 6 должно быть заполнено';
			|en = 'Значение регистрационного номера извещения в стр.050 Приложения 6 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение регистрационного номера %1 заполнено';
													|en = 'Значение регистрационного номера %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении регистрационного номера';
														|en = 'Ошибка при заполнении регистрационного номера'"));
...
Процедура ПроверкаКС_9_08(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.8)';
													|en = 'Проверка Приложения 6 (КС 9.8)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение даты регистрации извещения в стр.060 Приложения 6 должно быть заполнено';
			|en = 'Значение даты регистрации извещения в стр.060 Приложения 6 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение даты регистрации %1 заполнено';
													|en = 'Значение даты регистрации %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении даты регистрации';
														|en = 'Ошибка при заполнении даты регистрации'"));
...
Процедура ПроверкаКС_9_09(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.9)';
													|en = 'Проверка Приложения 6 (КС 9.9)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение ИНН организации в стр.070 Приложения 6 должно быть заполнено';
			|en = 'Значение ИНН организации в стр.070 Приложения 6 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение ИНН организации %1 заполнено';
													|en = 'Значение ИНН организации %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении ИНН организации';
														|en = 'Ошибка при заполнении ИНН организации'"));
...
Процедура ПроверкаКС_9_10(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.10)';
													|en = 'Проверка Приложения 6 (КС 9.10)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение КПП организации в стр.080 Приложения 6 должно быть заполнено';
			|en = 'Значение КПП организации в стр.080 Приложения 6 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение КПП организации %1 заполнено';
													|en = 'Значение КПП организации %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении КПП организации';
														|en = 'Ошибка при заполнении КПП организации'"));
...
Процедура ПроверкаКС_9_11(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.11)';
													|en = 'Проверка Приложения 6 (КС 9.11)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение кода вида этилового спирта в стр.090 Приложения 6 должно соответствовать списку ';
			|en = 'Значение кода вида этилового спирта в стр.090 Приложения 6 должно соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
...
Процедура ПроверкаКС_9_12(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.12)';
													|en = 'Проверка Приложения 6 (КС 9.12)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема этилового спирта в стр.100 Приложения 6 должно быть заполнено';
			|en = 'Значение объема этилового спирта в стр.100 Приложения 6 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение объема этилового спирта %1 заполнено';
													|en = 'Значение объема этилового спирта %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении объема этилового спирта';
														|en = 'Ошибка при заполнении объема этилового спирта'"));
...
Процедура ПроверкаКС_9_13(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.13)';
													|en = 'Проверка Приложения 6 (КС 9.13)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы авансового платежа в стр.110 Приложения 6 должно быть заполнено';
			|en = 'Значение суммы авансового платежа в стр.110 Приложения 6 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение суммы авансового платежа %1 заполнено';
													|en = 'Значение суммы авансового платежа %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы авансового платежа';
														|en = 'Ошибка при заполнении суммы авансового платежа'"));
...
Процедура ПроверкаКС_9_14(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.14)';
													|en = 'Проверка Приложения 6 (КС 9.14)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема этилового спирта в стр.120 Приложения 6 должно быть заполнено';
			|en = 'Значение объема этилового спирта в стр.120 Приложения 6 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение объема этилового спирта %1 заполнено';
													|en = 'Значение объема этилового спирта %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении объема этилового спирта';
														|en = 'Ошибка при заполнении объема этилового спирта'"));
...
Процедура ПроверкаКС_9_15(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.15)';
													|en = 'Проверка Приложения 6 (КС 9.15)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы авансового платежа в стр.130 Приложения 6 должно быть заполнено';
			|en = 'Значение суммы авансового платежа в стр.130 Приложения 6 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение суммы авансового платежа %1 заполнено';
													|en = 'Значение суммы авансового платежа %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы авансового платежа';
														|en = 'Ошибка при заполнении суммы авансового платежа'"));
...
Процедура ПроверкаКС_9_17(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.17)';
													|en = 'Проверка Приложения 6 (КС 9.17)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение регистрационного номера извещения в стр.140 Приложения 6 должно быть заполнено ';
			|en = 'Значение регистрационного номера извещения в стр.140 Приложения 6 должно быть заполнено '") +
		НСтр("ru = 'в случае заполнения подраздела 1.1 Приложения 6';
			|en = 'в случае заполнения подраздела 1.1 Приложения 6'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение регистрационного номера %1 заполнено';
													|en = 'Значение регистрационного номера %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении регистрационного номера';
														|en = 'Ошибка при заполнении регистрационного номера'"));
...
Процедура ПроверкаКС_9_18(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.18)';
													|en = 'Проверка Приложения 6 (КС 9.18)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение даты регистрации извещения в стр.150 Приложения 6 должно быть заполнено ';
			|en = 'Значение даты регистрации извещения в стр.150 Приложения 6 должно быть заполнено '") +
		НСтр("ru = 'в случае заполнения подраздела 1.1 Приложения 6';
			|en = 'в случае заполнения подраздела 1.1 Приложения 6'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение даты регистрации %1 заполнено';
													|en = 'Значение даты регистрации %1 заполнено'"));
...
Процедура ПроверкаКС_9_19(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.19)';
													|en = 'Проверка Приложения 6 (КС 9.19)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение ИНН организации в стр.160 Приложения 6 должно быть заполнено ';
			|en = 'Значение ИНН организации в стр.160 Приложения 6 должно быть заполнено '") +
		НСтр("ru = 'в случае заполнения подраздела 1.1 Приложения 6';
			|en = 'в случае заполнения подраздела 1.1 Приложения 6'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение ИНН организации %1 заполнено';
													|en = 'Значение ИНН организации %1 заполнено'"));
...
Процедура ПроверкаКС_9_20(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.20)';
													|en = 'Проверка Приложения 6 (КС 9.20)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение КПП организации в стр.170 Приложения 6 должно быть заполнено ';
			|en = 'Значение КПП организации в стр.170 Приложения 6 должно быть заполнено '") +
		НСтр("ru = 'в случае заполнения подраздела 1.1 Приложения 6';
			|en = 'в случае заполнения подраздела 1.1 Приложения 6'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение КПП организации %1 заполнено';
													|en = 'Значение КПП организации %1 заполнено'"));
...
Процедура ПроверкаКС_9_21(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.21)';
													|en = 'Проверка Приложения 6 (КС 9.21)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение кода вида этилового спирта в стр.180 Приложения 6 должно соответствовать списку ';
			|en = 'Значение кода вида этилового спирта в стр.180 Приложения 6 должно соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
...
Процедура ПроверкаКС_9_22(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.22)';
													|en = 'Проверка Приложения 6 (КС 9.22)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема этилового спирта в стр.190 Приложения 6 должно быть заполнено ';
			|en = 'Значение объема этилового спирта в стр.190 Приложения 6 должно быть заполнено '") +
		НСтр("ru = 'в случае заполнения подраздела 1.1 Приложения 6';
			|en = 'в случае заполнения подраздела 1.1 Приложения 6'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение объема этилового спирта %1 заполнено';
													|en = 'Значение объема этилового спирта %1 заполнено'"));
...
Процедура ПроверкаКС_9_23(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.23)';
													|en = 'Проверка Приложения 6 (КС 9.23)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы авансового платежа в стр.200 Приложения 6 должно быть заполнено ';
			|en = 'Значение суммы авансового платежа в стр.200 Приложения 6 должно быть заполнено '") +
		НСтр("ru = 'в случае заполнения подраздела 1.1 Приложения 6';
			|en = 'в случае заполнения подраздела 1.1 Приложения 6'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение суммы авансового платежа %1 заполнено';
													|en = 'Значение суммы авансового платежа %1 заполнено'"));
...
Процедура ПроверкаКС_9_24(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.24)';
													|en = 'Проверка Приложения 6 (КС 9.24)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение кода вида подакцизного товара в стр.210 Приложения 6 должно соответствовать списку ';
			|en = 'Значение кода вида подакцизного товара в стр.210 Приложения 6 должно соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
...
Процедура ПроверкаКС_9_25(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.25)';
													|en = 'Проверка Приложения 6 (КС 9.25)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема этилового спирта в стр.220 Приложения 6 должно быть заполнено';
			|en = 'Значение объема этилового спирта в стр.220 Приложения 6 должно быть заполнено'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = 'Значение объема этилового спирта %1 заполнено';
													|en = 'Значение объема этилового спирта %1 заполнено'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении объема этилового спирта';
														|en = 'Ошибка при заполнении объема этилового спирта'"));
...
Процедура ПроверкаКС_9_26(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.26)';
													|en = 'Проверка Приложения 6 (КС 9.26)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма акциза в стр.230 Приложения 6 должна равняться произведению стр.220 Приложения 6 ';
			|en = 'Сумма акциза в стр.230 Приложения 6 должна равняться произведению стр.220 Приложения 6 '") +
		НСтр("ru = 'и ставки акциза по соответствующему подакцизному товару';
			|en = 'и ставки акциза по соответствующему подакцизному товару'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 х %3 Итог [%4] по коду товара %5';
													|en = '%1 = %2 х %3 Итог [%4] по коду товара %5'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение6 Цикл
		...
		Для Счетчик = 1 По КолвоСтрок Цикл
			...
			ЗаполнитьПоказатель(Показатели.П62С210, СтраницаРаздела, XMLСтрока(Счетчик));
			...
			ЗаполнитьИРасшифроватьПоказатель(Показатели.П62С220, СтраницаРаздела, XMLСтрока(Счетчик));
			Показатели.Ставка.Значение = ЗначениеСтавки;
			Показатели.Ставка.Дополнение = "Код подакцизного товара " + Показатели.П62С210.ЗначениеСтр;
			РасшифроватьПоказатель(Показатели.Ставка);
			ЗаполнитьИРасшифроватьПоказатель(Показатели.П62С230, СтраницаРаздела, XMLСтрока(Счетчик));
...
Процедура ПроверкаКС_9_29(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.29)';
													|en = 'Проверка Приложения 6 (КС 9.29)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема подакцизного товара в стр.250 Приложения 6 должно равняться гр.3 подраздела 2.1 ';
			|en = 'Значение объема подакцизного товара в стр.250 Приложения 6 должно равняться гр.3 подраздела 2.1 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя '") +
		НСтр("ru = '10001, 10006-10012 в гр.1 подраздела 2.1 Раздела 2';
			|en = '10001, 10006-10012 в гр.1 подраздела 2.1 Раздела 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3';
													|en = '%1 = %2 по коду товара %3'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	...
	ПроверкаКС_9_31_код(Настройки, СтруктураРезультата);
...
Процедура ПроверкаКС_9_31(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.31)';
													|en = 'Проверка Приложения 6 (КС 9.31)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.255 Приложения 6 должно равняться гр.4 подраздела 2.1 ';
			|en = 'Значение суммы акциза в стр.255 Приложения 6 должно равняться гр.4 подраздела 2.1 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя '") +
		НСтр("ru = '10001, 10006-10012 в гр.1 подраздела 2.1 Раздела 2';
			|en = '10001, 10006-10012 в гр.1 подраздела 2.1 Раздела 2'"));
...
&НаСервере
Процедура ПроверкаКС_9_31_код(Настройки, СтруктураРезультата)
	...
	|	Приложение6.Страница КАК Страница,
	|	Приложение6.Строка_ КАК Строка_
	|ИЗ
	...
	Пока ВыборкаП6.Следующий() Цикл
		...
		ЗарегистрироватьФормулу(Настройки);
		СуммаП62	= ВыборкаП6[ПоказательП6];
		СуммаР21	= 0;
		
		Выборка = ВыборкаП6.Выбрать();
		Пока Выборка.Следующий() Цикл
			Источник = ИсточникИзВыборки(Выборка, Показатели[ПоказательП6], Выборка.Строка_);
			Показатели[ПоказательП6].Дополнение = "Страница " + Выборка.Страница + ", группа строк " + Выборка.Строка_;
			ЗаполнитьИРасшифроватьПоказатель(Показатели[ПоказательП6], Источник, Выборка.Строка_);
		КонецЦикла; 
		
		Если ВыборкаР2.НайтиСледующий(Новый Структура("КодТовара", ВыборкаП6.КодТовара)) Тогда
			
			СуммаР21	= ВыборкаР2[ПоказательР2];
			Выборка		= ВыборкаР2.Выбрать();
		...
		Настройки.ЭтоОшибка = НЕ СуммаП62 = СуммаР21;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
			СуммаП62, СуммаР21, ЗначениеСтр(ВыборкаП6.КодТовара));
		ДополнитьСтруктуруОшибок(Настройки);
	КонецЦикла;
...
Процедура ПроверкаКС_9_32(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.32)';
													|en = 'Проверка Приложения 6 (КС 9.32)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема подакцизных товаров в стр.260 Приложения 6 >= 0';
			|en = 'Значение объема подакцизных товаров в стр.260 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении объема подакцизных товаров';
														|en = 'Ошибка при заполнении объема подакцизных товаров'"));
...
Процедура ПроверкаКС_9_33(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.33)';
													|en = 'Проверка Приложения 6 (КС 9.33)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема подакцизного товара в стр.260 Приложения 6 должно равняться гр.3 подраздела 2.2 ';
			|en = 'Значение объема подакцизного товара в стр.260 Приложения 6 должно равняться гр.3 подраздела 2.2 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя '") +
		НСтр("ru = '20001, 20003, 20005, 20006, 20007 в гр.1 подраздела 2.2 Раздела 2';
			|en = '20001, 20003, 20005, 20006, 20007 в гр.1 подраздела 2.2 Раздела 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3';
													|en = '%1 = %2 по коду товара %3'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	...
	ПроверкаКС_9_43_код(Настройки, СтруктураРезультата);
...
Процедура ПроверкаКС_9_34(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.34)';
													|en = 'Проверка Приложения 6 (КС 9.34)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.265 Приложения 6 >= 0';
			|en = 'Значение суммы акциза в стр.265 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы акциза';
														|en = 'Ошибка при заполнении суммы акциза'"));
...
Процедура ПроверкаКС_9_35(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.35)';
													|en = 'Проверка Приложения 6 (КС 9.35)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.265 Приложения 6 должно равняться гр.4 подраздела 2.2 ';
			|en = 'Значение суммы акциза в стр.265 Приложения 6 должно равняться гр.4 подраздела 2.2 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя '") +
		НСтр("ru = '20001, 20003, 20005, 20006, 20007 в гр.1 подраздела 2.2 Раздела 2';
			|en = '20001, 20003, 20005, 20006, 20007 в гр.1 подраздела 2.2 Раздела 2'"));
...
Процедура ПроверкаКС_9_36(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.36)';
													|en = 'Проверка Приложения 6 (КС 9.36)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема подакцизных товаров в стр.266 Приложения 6 >= 0';
			|en = 'Значение объема подакцизных товаров в стр.266 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении объема подакцизных товаров';
														|en = 'Ошибка при заполнении объема подакцизных товаров'"));
...
Процедура ПроверкаКС_9_37(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.37)';
													|en = 'Проверка Приложения 6 (КС 9.37)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема подакцизного товара в стр.266 Приложения 6 должно равняться гр.2 подраздела 2.5 ';
			|en = 'Значение объема подакцизного товара в стр.266 Приложения 6 должно равняться гр.2 подраздела 2.5 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя '") +
		НСтр("ru = '50001, 50003, 50005 в гр.1 подраздела 2.5 Раздела 2';
			|en = '50001, 50003, 50005 в гр.1 подраздела 2.5 Раздела 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3';
													|en = '%1 = %2 по коду товара %3'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
	...
	Настройки.Вставить("ПоказательР2"	, "Р25Г002");
	Настройки.Вставить("МассивКодов"	, МассивКодовПоказателей);
	ПроверкаКС_9_47_код(Настройки, СтруктураРезультата);
...
Процедура ПроверкаКС_9_38(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.38)';
													|en = 'Проверка Приложения 6 (КС 9.38)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.267 Приложения 6 >= 0';
			|en = 'Значение суммы акциза в стр.267 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы акциза';
														|en = 'Ошибка при заполнении суммы акциза'"));
...
Процедура ПроверкаКС_9_39(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.39)';
													|en = 'Проверка Приложения 6 (КС 9.39)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.267 Приложения 6 должно равняться гр.3 подраздела 2.5 ';
			|en = 'Значение суммы акциза в стр.267 Приложения 6 должно равняться гр.3 подраздела 2.5 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя '") +
		НСтр("ru = '50001, 50003, 50005 в гр.1 подраздела 2.5 Раздела 2';
			|en = '50001, 50003, 50005 в гр.1 подраздела 2.5 Раздела 2'"));
...
Процедура ПроверкаКС_9_40(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.40)';
													|en = 'Проверка Приложения 6 (КС 9.40)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема подакцизных товаров в стр.270 Приложения 6 >= 0';
			|en = 'Значение объема подакцизных товаров в стр.270 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении объема подакцизных товаров';
														|en = 'Ошибка при заполнении объема подакцизных товаров'"));
...
Процедура ПроверкаКС_9_41(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.41)';
													|en = 'Проверка Приложения 6 (КС 9.41)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема подакцизного товара в стр.270 Приложения 6 должно равняться гр.3 подраздела 2.2 ';
			|en = 'Значение объема подакцизного товара в стр.270 Приложения 6 должно равняться гр.3 подраздела 2.2 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя '") +
		НСтр("ru = '20002, 20004 в гр.1 подраздела 2.2 Раздела 2';
			|en = '20002, 20004 в гр.1 подраздела 2.2 Раздела 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3';
													|en = '%1 = %2 по коду товара %3'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
...
Процедура ПроверкаКС_9_42(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.42)';
													|en = 'Проверка Приложения 6 (КС 9.42)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.275 Приложения 6 >= 0';
			|en = 'Значение суммы акциза в стр.275 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы акциза';
														|en = 'Ошибка при заполнении суммы акциза'"));
...
Процедура ПроверкаКС_9_43(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.43)';
													|en = 'Проверка Приложения 6 (КС 9.43)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.275 Приложения 6 должно равняться гр.4 подраздела 2.2 ';
			|en = 'Значение суммы акциза в стр.275 Приложения 6 должно равняться гр.4 подраздела 2.2 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя '") +
		НСтр("ru = '20002, 20004 в гр.1 подраздела 2.2 Раздела 2';
			|en = '20002, 20004 в гр.1 подраздела 2.2 Раздела 2'"));
...
&НаСервере
Процедура ПроверкаКС_9_43_код(Настройки, СтруктураРезультата)
	...
	Пока ВыборкаП6.Следующий() Цикл
		...
		Настройки.ЭтоОшибка = НЕ СуммаП62 = СуммаР22;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
			СуммаП62, СуммаР22, ЗначениеСтр(ВыборкаП6.КодТовара));
		ДополнитьСтруктуруОшибок(Настройки);
	КонецЦикла;
...
Процедура ПроверкаКС_9_44(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.44)';
													|en = 'Проверка Приложения 6 (КС 9.44)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема подакцизных товаров в стр.276 Приложения 6 >= 0';
			|en = 'Значение объема подакцизных товаров в стр.276 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении объема подакцизных товаров';
														|en = 'Ошибка при заполнении объема подакцизных товаров'"));
...
Процедура ПроверкаКС_9_45(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.45)';
													|en = 'Проверка Приложения 6 (КС 9.45)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема подакцизного товара в стр.276 Приложения 6 должно равняться гр.2 подраздела 2.5 ';
			|en = 'Значение объема подакцизного товара в стр.276 Приложения 6 должно равняться гр.2 подраздела 2.5 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя '") +
		НСтр("ru = '50002, 50004 в гр.1 подраздела 2.5 Раздела 2';
			|en = '50002, 50004 в гр.1 подраздела 2.5 Раздела 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3';
													|en = '%1 = %2 по коду товара %3'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочный объем подакцизного товара';
														|en = 'Ошибочный объем подакцизного товара'"));
...
Процедура ПроверкаКС_9_46(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.46)';
													|en = 'Проверка Приложения 6 (КС 9.46)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.277 Приложения 6 >= 0';
			|en = 'Значение суммы акциза в стр.277 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы акциза';
														|en = 'Ошибка при заполнении суммы акциза'"));
...
Процедура ПроверкаКС_9_47(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.47)';
													|en = 'Проверка Приложения 6 (КС 9.47)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.277 Приложения 6 должно равняться гр.3 подраздела 2.5 ';
			|en = 'Значение суммы акциза в стр.277 Приложения 6 должно равняться гр.3 подраздела 2.5 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.210 Приложения 6 и коду показателя '") +
		НСтр("ru = '50002, 50004 в гр.1 подраздела 2.5 Раздела 2';
			|en = '50002, 50004 в гр.1 подраздела 2.5 Раздела 2'"));
...
&НаСервере
Процедура ПроверкаКС_9_47_код(Настройки, СтруктураРезультата)
	...
	Пока ВыборкаП6.Следующий() Цикл
		...
		Настройки.ЭтоОшибка = НЕ СуммаП62 = СуммаР25;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
			СуммаП62, СуммаР25, ЗначениеСтр(ВыборкаП6.КодТовара));
		ДополнитьСтруктуруОшибок(Настройки);
	КонецЦикла;
...
Процедура ПроверкаКС_9_48(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.48)';
													|en = 'Проверка Приложения 6 (КС 9.48)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение стр.280 Приложения 6 должно равняться сумме значений стр.250 Приложения 6 ';
			|en = 'Значение стр.280 Приложения 6 должно равняться сумме значений стр.250 Приложения 6 '") +
		НСтр("ru = 'деклараций за прошедшие налоговые периоды по соответствующим коду подакцизного товара ';
			|en = 'деклараций за прошедшие налоговые периоды по соответствующим коду подакцизного товара '") +
		НСтр("ru = 'и банковской гарантии';
			|en = 'и банковской гарантии'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru=''"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru=''"));
	Настройки = ОбработатьНастройки(		, Заголовки, СтруктураРезультата);
...
Процедура ПроверкаКС_9_49(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.49)';
													|en = 'Проверка Приложения 6 (КС 9.49)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение стр.285 Приложения 6 должно равняться сумме значений стр.255 Приложения 6 ';
			|en = 'Значение стр.285 Приложения 6 должно равняться сумме значений стр.255 Приложения 6 '") +
		НСтр("ru = 'деклараций за прошедшие налоговые периоды по соответствующим коду подакцизного товара ';
			|en = 'деклараций за прошедшие налоговые периоды по соответствующим коду подакцизного товара '") +
		НСтр("ru = 'и банковской гарантии';
			|en = 'и банковской гарантии'"));
...
Процедура ПроверкаКС_9_50(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.50)';
													|en = 'Проверка Приложения 6 (КС 9.50)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение стр.290 Приложения 6 должно равняться сумме значений стр.260, 270 Приложения 6 ';
			|en = 'Значение стр.290 Приложения 6 должно равняться сумме значений стр.260, 270 Приложения 6 '") +
		НСтр("ru = 'деклараций за прошедшие налоговые периоды по соответствующей банковской гарантии';
			|en = 'деклараций за прошедшие налоговые периоды по соответствующей банковской гарантии'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru=''"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru=''"));
	Настройки = ОбработатьНастройки(		, Заголовки, СтруктураРезультата);
...
Процедура ПроверкаКС_9_51(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.51)';
													|en = 'Проверка Приложения 6 (КС 9.51)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение стр.295 Приложения 6 должно равняться сумме значений стр.265, 275 Приложения 6 ';
			|en = 'Значение стр.295 Приложения 6 должно равняться сумме значений стр.265, 275 Приложения 6 '") +
		НСтр("ru = 'деклараций за прошедшие налоговые периоды по соответствующей банковской гарантии';
			|en = 'деклараций за прошедшие налоговые периоды по соответствующей банковской гарантии'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru=''"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru=''"));
...
Процедура ПроверкаКС_9_53(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.53)';
													|en = 'Проверка Приложения 6 (КС 9.53)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы авансового платежа в стр.305 Приложения 6 >= 0';
			|en = 'Значение суммы авансового платежа в стр.305 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы авансового платежа';
														|en = 'Ошибка при заполнении суммы авансового платежа'"));
...
Процедура ПроверкаКС_9_54(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.54)';
													|en = 'Проверка Приложения 6 (КС 9.54)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема фактических потерь в стр.310 Приложения 6 >= 0';
			|en = 'Значение объема фактических потерь в стр.310 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении объема фактических потерь';
														|en = 'Ошибка при заполнении объема фактических потерь'"));
...
Процедура ПроверкаКС_9_55(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.55)';
													|en = 'Проверка Приложения 6 (КС 9.55)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы авансового платежа в стр.315 Приложения 6 >= 0';
			|en = 'Значение суммы авансового платежа в стр.315 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы авансового платежа';
														|en = 'Ошибка при заполнении суммы авансового платежа'"));
...
Процедура ПроверкаКС_9_56(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.56)';
													|en = 'Проверка Приложения 6 (КС 9.56)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение кода вида подакцизного товара в стр.325 Приложения 6 должно соответствовать списку ';
			|en = 'Значение кода вида подакцизного товара в стр.325 Приложения 6 должно соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
...
Процедура ПроверкаКС_9_57(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.57)';
													|en = 'Проверка Приложения 6 (КС 9.57)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.330 Приложения 6 >= 0';
			|en = 'Значение суммы акциза в стр.330 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы акциза';
														|en = 'Ошибка при заполнении суммы акциза'"));
...
Процедура ПроверкаКС_9_58(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.58)';
													|en = 'Проверка Приложения 6 (КС 9.58)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.340 Приложения 6 >= 0';
			|en = 'Значение суммы акциза в стр.340 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы акциза';
														|en = 'Ошибка при заполнении суммы акциза'"));
...
Процедура ПроверкаКС_9_59(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.59)';
													|en = 'Проверка Приложения 6 (КС 9.59)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.350 Приложения 6 >= 0';
			|en = 'Значение суммы акциза в стр.350 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы акциза';
														|en = 'Ошибка при заполнении суммы акциза'"));
...
Процедура ПроверкаКС_9_60(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.60)';
													|en = 'Проверка Приложения 6 (КС 9.60)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы авансового платежа в стр.360 Приложения 6 >= 0';
			|en = 'Значение суммы авансового платежа в стр.360 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы авансового платежа';
														|en = 'Ошибка при заполнении суммы авансового платежа'"));
...
Процедура ПроверкаКС_9_61(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение6 Цикл
		...
		Для Счетчик = 1 По КолвоСтрок Цикл
			ЗарегистрироватьФормулу(Настройки);
			ЗаполнитьИРасшифроватьПоказатель(Показатели.П63С370, СтраницаРаздела, XMLСтрока(Счетчик));
			ЗаполнитьПоказатель(Показатели.П63С325, СтраницаРаздела, XMLСтрока(Счетчик));
			
			Показатели.П62С230.Итог = 0;
			КолвоСтрок2 = КоличествоСтрок(СтраницаРаздела, Лев(Показатели.П62С210.ИмяПоказателя, 14));
			
			Для Счетчик2 = 1 По КолвоСтрок2 Цикл
				ЗаполнитьПоказатель(Показатели.П62С210, СтраницаРаздела, XMLСтрока(Счетчик2));
				Если Показатели.П63С325.Значение = Показатели.П62С210.Значение Тогда
					ЗаполнитьИРасшифроватьПоказатель(Показатели.П62С230, СтраницаРаздела, XMLСтрока(Счетчик2));
				КонецЕсли;
			КонецЦикла;
...
Процедура ПроверкаКС_9_62(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.62)';
													|en = 'Проверка Приложения 6 (КС 9.62)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение остатка этилового спирта в стр.380 Приложения 6 >= 0';
			|en = 'Значение остатка этилового спирта в стр.380 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении остатка этилового спирта';
														|en = 'Ошибка при заполнении остатка этилового спирта'"));
...
Процедура ПроверкаКС_9_63(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.63)';
													|en = 'Проверка Приложения 6 (КС 9.63)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение кода вида подакцизного товара в стр.385 Приложения 6 должно соответствовать списку ';
			|en = 'Значение кода вида подакцизного товара в стр.385 Приложения 6 должно соответствовать списку '") +
		НСтр("ru = 'допустимых значений';
			|en = 'допустимых значений'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 в списке допустимых значений';
													|en = '%1 в списке допустимых значений'"));
...
Процедура ПроверкаКС_9_64(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.64)';
													|en = 'Проверка Приложения 6 (КС 9.64)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы авансового платежа в стр.390 Приложения 6 >= 0';
			|en = 'Значение суммы авансового платежа в стр.390 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы авансового платежа';
														|en = 'Ошибка при заполнении суммы авансового платежа'"));
...
Процедура ПроверкаКС_9_65(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.65)';
													|en = 'Проверка Приложения 6 (КС 9.65)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы авансового платежа в стр.400 Приложения 6 >= 0';
			|en = 'Значение суммы авансового платежа в стр.400 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы авансового платежа';
														|en = 'Ошибка при заполнении суммы авансового платежа'"));
...
Процедура ПроверкаКС_9_66(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.66)';
													|en = 'Проверка Приложения 6 (КС 9.66)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение стр.405 Приложения 6 должно равняться сумме значений стр.490 Приложения 6 ';
			|en = 'Значение стр.405 Приложения 6 должно равняться сумме значений стр.490 Приложения 6 '") +
		НСтр("ru = 'деклараций за прошедшие налоговые периоды по соответствующим коду подакцизного товара ';
			|en = 'деклараций за прошедшие налоговые периоды по соответствующим коду подакцизного товара '") +
		НСтр("ru = 'и банковской гарантии';
			|en = 'и банковской гарантии'"));
...
Процедура ПроверкаКС_9_67(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.67)';
													|en = 'Проверка Приложения 6 (КС 9.67)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема подакцизного товара в стр.410 Приложения 6 должно равняться гр.3 подраздела 2.1 ';
			|en = 'Значение объема подакцизного товара в стр.410 Приложения 6 должно равняться гр.3 подраздела 2.1 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя '") +
		НСтр("ru = '10001, 10006-10012 в гр.1 подраздела 2.1 Раздела 2';
			|en = '10001, 10006-10012 в гр.1 подраздела 2.1 Раздела 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3';
													|en = '%1 = %2 по коду товара %3'"));
	...
	Настройки.Вставить("ПоказательР2", "Р21Г003");
	ПроверкаКС_9_69_код(Настройки, СтруктураРезультата);
...
Процедура ПроверкаКС_9_68(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.68)';
													|en = 'Проверка Приложения 6 (КС 9.68)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма акциза в стр.415 Приложения 6 должна равняться произведению стр.410 Приложения 6 ';
			|en = 'Сумма акциза в стр.415 Приложения 6 должна равняться произведению стр.410 Приложения 6 '") +
		НСтр("ru = 'и ставки акциза по соответствующему подакцизному товару';
			|en = 'и ставки акциза по соответствующему подакцизному товару'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 х %3 Итог [%4] по коду товара %5';
													|en = '%1 = %2 х %3 Итог [%4] по коду товара %5'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение6 Цикл
		...
		Для Счетчик = 1 По КолвоСтрок Цикл
			...
			ЗаполнитьПоказатель(Показатели.П64С385, СтраницаРаздела, XMLСтрока(Счетчик));
			...
			ЗарегистрироватьФормулу(Настройки);
			ЗаполнитьИРасшифроватьПоказатель(Показатели.П64С410, СтраницаРаздела, XMLСтрока(Счетчик));
			Показатели.Ставка.Значение = ЗначениеСтавки;
			Показатели.Ставка.Дополнение = "Код подакцизного товара " + Показатели.П64С385.ЗначениеСтр;
			РасшифроватьПоказатель(Показатели.Ставка);
			ЗаполнитьИРасшифроватьПоказатель(Показатели.П64С415, СтраницаРаздела, XMLСтрока(Счетчик));
...
Процедура ПроверкаКС_9_69(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.69)';
													|en = 'Проверка Приложения 6 (КС 9.69)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.415 Приложения 6 должно равняться гр.4 подраздела 2.1 ';
			|en = 'Значение суммы акциза в стр.415 Приложения 6 должно равняться гр.4 подраздела 2.1 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя '") +
		НСтр("ru = '10001, 10006-10012 в гр.1 подраздела 2.1 Раздела 2';
			|en = '10001, 10006-10012 в гр.1 подраздела 2.1 Раздела 2'"));
...
&НаСервере
Процедура ПроверкаКС_9_69_код(Настройки, СтруктураРезультата)
	...
	Пока ВыборкаП6.Следующий() Цикл
		...
		ЗарегистрироватьФормулу(Настройки);
		СуммаП64	= ВыборкаП6[ПоказательП6];
		СуммаР21	= 0;
		...
		Настройки.ЭтоОшибка = НЕ СуммаП64 = СуммаР21;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
			СуммаП64, СуммаР21, ЗначениеСтр(ВыборкаП6.КодТовара));
		ДополнитьСтруктуруОшибок(Настройки);
	КонецЦикла;
...
Процедура ПроверкаКС_9_70(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.70)';
													|en = 'Проверка Приложения 6 (КС 9.70)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема подакцизного товара в стр.420 Приложения 6 должно равняться гр.3 подраздела 2.2 ';
			|en = 'Значение объема подакцизного товара в стр.420 Приложения 6 должно равняться гр.3 подраздела 2.2 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя '") +
		НСтр("ru = '20001, 20003, 20005, 20006, 20007 в гр.1 подраздела 2.2 Раздела 2';
			|en = '20001, 20003, 20005, 20006, 20007 в гр.1 подраздела 2.2 Раздела 2'"));
	...
	Настройки.Вставить("ПоказательР2"	, "Р22Г003");
	Настройки.Вставить("МассивКодов"	, МассивКодовПоказателей);
	ПроверкаКС_9_75_код(Настройки, СтруктураРезультата);
...
Процедура ПроверкаКС_9_71(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.71)';
													|en = 'Проверка Приложения 6 (КС 9.71)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма акциза в стр.425 Приложения 6 должна равняться произведению стр.420 Приложения 6 ';
			|en = 'Сумма акциза в стр.425 Приложения 6 должна равняться произведению стр.420 Приложения 6 '") +
		НСтр("ru = 'и ставки акциза по соответствующему подакцизному товару';
			|en = 'и ставки акциза по соответствующему подакцизному товару'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 х %3 Итог [%4] по коду товара %5';
													|en = '%1 = %2 х %3 Итог [%4] по коду товара %5'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение6 Цикл
		...
		Для Счетчик = 1 По КолвоСтрок Цикл
			...
			ЗарегистрироватьФормулу(Настройки);
			ЗаполнитьИРасшифроватьПоказатель(Показатели.П64С420, СтраницаРаздела, XMLСтрока(Счетчик));
			Показатели.Ставка.Значение = ЗначениеСтавки;
			Показатели.Ставка.Дополнение = "Код подакцизного товара " + Показатели.П64С385.ЗначениеСтр;
			РасшифроватьПоказатель(Показатели.Ставка);
			ЗаполнитьИРасшифроватьПоказатель(Показатели.П64С425, СтраницаРаздела, XMLСтрока(Счетчик));
...
Процедура ПроверкаКС_9_72(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.72)';
													|en = 'Проверка Приложения 6 (КС 9.72)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.425 Приложения 6 должно равняться гр.4 подраздела 2.2 ';
			|en = 'Значение суммы акциза в стр.425 Приложения 6 должно равняться гр.4 подраздела 2.2 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя '") +
		НСтр("ru = '20001, 20003, 20005, 20006, 20007 в гр.1 подраздела 2.2 Раздела 2';
			|en = '20001, 20003, 20005, 20006, 20007 в гр.1 подраздела 2.2 Раздела 2'"));
...
Процедура ПроверкаКС_9_73(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.73)';
													|en = 'Проверка Приложения 6 (КС 9.73)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема подакцизного товара в стр.430 Приложения 6 должно равняться гр.3 подраздела 2.2 ';
			|en = 'Значение объема подакцизного товара в стр.430 Приложения 6 должно равняться гр.3 подраздела 2.2 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя '") +
		НСтр("ru = '20002, 20004 в гр.1 подраздела 2.2 Раздела 2';
			|en = '20002, 20004 в гр.1 подраздела 2.2 Раздела 2'"));
...
Процедура ПроверкаКС_9_74(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.74)';
													|en = 'Проверка Приложения 6 (КС 9.74)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма акциза в стр.435 Приложения 6 должна равняться произведению стр.430 Приложения 6 ';
			|en = 'Сумма акциза в стр.435 Приложения 6 должна равняться произведению стр.430 Приложения 6 '") +
		НСтр("ru = 'и ставки акциза по соответствующему подакцизному товару';
			|en = 'и ставки акциза по соответствующему подакцизному товару'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 х %3 Итог [%4] по коду товара %5';
													|en = '%1 = %2 х %3 Итог [%4] по коду товара %5'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение6 Цикл
		...
		Для Счетчик = 1 По КолвоСтрок Цикл
			...
			ЗарегистрироватьФормулу(Настройки);
			ЗаполнитьИРасшифроватьПоказатель(Показатели.П64С430, СтраницаРаздела, XMLСтрока(Счетчик));
			Показатели.Ставка.Значение = ЗначениеСтавки;
			Показатели.Ставка.Дополнение = "Код подакцизного товара " + Показатели.П64С385.ЗначениеСтр;
			РасшифроватьПоказатель(Показатели.Ставка);
			ЗаполнитьИРасшифроватьПоказатель(Показатели.П64С435, СтраницаРаздела, XMLСтрока(Счетчик));
...
Процедура ПроверкаКС_9_75(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.75)';
													|en = 'Проверка Приложения 6 (КС 9.75)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.435 Приложения 6 должно равняться гр.4 подраздела 2.2 ';
			|en = 'Значение суммы акциза в стр.435 Приложения 6 должно равняться гр.4 подраздела 2.2 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя '") +
		НСтр("ru = '20002, 20004 в гр.1 подраздела 2.2 Раздела 2';
			|en = '20002, 20004 в гр.1 подраздела 2.2 Раздела 2'"));
...
&НаСервере
Процедура ПроверкаКС_9_75_код(Настройки, СтруктураРезультата)
	...
	Пока ВыборкаП6.Следующий() Цикл
		...
		Настройки.ЭтоОшибка = НЕ СуммаП64 = СуммаР22;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
			СуммаП64, СуммаР22, ЗначениеСтр(ВыборкаП6.КодТовара));
		ДополнитьСтруктуруОшибок(Настройки);
	КонецЦикла;
...
Процедура ПроверкаКС_9_76(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.76)';
													|en = 'Проверка Приложения 6 (КС 9.76)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема фактических потерь в стр.440 Приложения 6 >= 0';
			|en = 'Значение объема фактических потерь в стр.440 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении объема фактических потерь';
														|en = 'Ошибка при заполнении объема фактических потерь'"));
...
Процедура ПроверкаКС_9_77(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.77)';
													|en = 'Проверка Приложения 6 (КС 9.77)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма акциза в стр.445 Приложения 6 должна равняться произведению стр.440 Приложения 6 ';
			|en = 'Сумма акциза в стр.445 Приложения 6 должна равняться произведению стр.440 Приложения 6 '") +
		НСтр("ru = 'и ставки акциза по соответствующему подакцизному товару';
			|en = 'и ставки акциза по соответствующему подакцизному товару'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 х %3 Итог [%4] по коду товара %5';
													|en = '%1 = %2 х %3 Итог [%4] по коду товара %5'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение6 Цикл
		...
		Для Счетчик = 1 По КолвоСтрок Цикл
			...
			Показатели.Ставка.Дополнение = "Код подакцизного товара " + Показатели.П64С385.ЗначениеСтр;
			РасшифроватьПоказатель(Показатели.Ставка);
			ЗаполнитьИРасшифроватьПоказатель(Показатели.П64С445, СтраницаРаздела, XMLСтрока(Счетчик));
...
Процедура ПроверкаКС_9_78(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.78)';
													|en = 'Проверка Приложения 6 (КС 9.78)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение объема фактических потерь в стр.450 Приложения 6 >= 0';
			|en = 'Значение объема фактических потерь в стр.450 Приложения 6 >= 0'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении объема фактических потерь';
														|en = 'Ошибка при заполнении объема фактических потерь'"));
...
Процедура ПроверкаКС_9_79(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.79)';
													|en = 'Проверка Приложения 6 (КС 9.79)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Сумма акциза в стр.455 Приложения 6 должна равняться произведению стр.450 Приложения 6 ';
			|en = 'Сумма акциза в стр.455 Приложения 6 должна равняться произведению стр.450 Приложения 6 '") +
		НСтр("ru = 'и ставки акциза по соответствующему подакцизному товару';
			|en = 'и ставки акциза по соответствующему подакцизному товару'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 х %3 Итог [%4] по коду товара %5';
													|en = '%1 = %2 х %3 Итог [%4] по коду товара %5'"));
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Приложение6 Цикл
		...
		Для Счетчик = 1 По КолвоСтрок Цикл
			...
			Показатели.Ставка.Дополнение = "Код подакцизного товара " + Показатели.П64С385.ЗначениеСтр;
			РасшифроватьПоказатель(Показатели.Ставка);
			ЗаполнитьИРасшифроватьПоказатель(Показатели.П64С455, СтраницаРаздела, XMLСтрока(Счетчик));
...
Процедура ПроверкаКС_9_80(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.80)';
													|en = 'Проверка Приложения 6 (КС 9.80)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы авансового платежа в стр.460 Приложения 6 = стр.415 + стр.425 + стр.435 + ';
			|en = 'Значение суммы авансового платежа в стр.460 Приложения 6 = стр.415 + стр.425 + стр.435 + '") +
		НСтр("ru = 'стр.445 Приложения 6';
			|en = 'стр.445 Приложения 6'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы авансового платежа';
														|en = 'Ошибка при заполнении суммы авансового платежа'"));
...
Процедура ПроверкаКС_9_81(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.81)';
													|en = 'Проверка Приложения 6 (КС 9.81)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.460 Приложения 6 должно равняться гр.3 подраздела 2.3 ';
			|en = 'Значение суммы акциза в стр.460 Приложения 6 должно равняться гр.3 подраздела 2.3 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя '") +
		НСтр("ru = '30008 в гр.1 подраздела 2.3 Раздела 2';
			|en = '30008 в гр.1 подраздела 2.3 Раздела 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3';
													|en = '%1 = %2 по коду товара %3'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма акциза';
														|en = 'Ошибочная сумма акциза'"));
	...
	Настройки.Вставить("МассивКодов"	, МассивКодовПоказателей);
	ПроверкаКС_9_82_код(Настройки, СтруктураРезультата);
...
Процедура ПроверкаКС_9_82(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.82)';
													|en = 'Проверка Приложения 6 (КС 9.82)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы акциза в стр.470 Приложения 6 должно равняться гр.3 подраздела 2.3 ';
			|en = 'Значение суммы акциза в стр.470 Приложения 6 должно равняться гр.3 подраздела 2.3 '") +
		НСтр("ru = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя ';
			|en = 'Раздела 2 по соответствующему коду подакцизного товара в стр.385 Приложения 6 и коду показателя '") +
		НСтр("ru = '30010 в гр.1 подраздела 2.3 Раздела 2';
			|en = '30010 в гр.1 подраздела 2.3 Раздела 2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2 по коду товара %3';
													|en = '%1 = %2 по коду товара %3'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибочная сумма акциза';
														|en = 'Ошибочная сумма акциза'"));
...
&НаСервере
Процедура ПроверкаКС_9_82_код(Настройки, СтруктураРезультата)
	...
	Пока ВыборкаП6.Следующий() Цикл
		...
		Настройки.ЭтоОшибка = НЕ СуммаП64 = СуммаР23;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
			СуммаП64, СуммаР23, ЗначениеСтр(ВыборкаП6.КодТовара));
		ДополнитьСтруктуруОшибок(Настройки);
	КонецЦикла;
...
Процедура ПроверкаКС_9_83(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 6 (КС 9.83)';
													|en = 'Проверка Приложения 6 (КС 9.83)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru = 'Значение суммы авансового платежа в стр.480 Приложения 6 = стр.400 - стр.460 Приложения 6';
			|en = 'Значение суммы авансового платежа в стр.480 Приложения 6 = стр.400 - стр.460 Приложения 6'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru = '%1 = %2';
													|en = '%1 = %2'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru = 'Ошибка при заполнении суммы авансового платежа';
														|en = 'Ошибка при заполнении суммы авансового платежа'"));
