...
Процедура ВставитьДополнительнуюСтраницуНаСервере(ИмяТекущейСтраницыПанели = Неопределено, СохранятьДанныеТекущейСтраницы = Истина)
	...
	Если ИмяТекущейСтраницыПанели = "Раздел2" Тогда
		ВставитьДополнительнуюСтраницу(ЭтотОбъект, ИмяТекущейСтраницыПанели);
	Иначе
		РегламентированнаяОтчетность.ВставитьДополнительнуюСтраницуНаСервере(ЭтотОбъект, ИмяТекущейСтраницыПанели, СохранятьДанныеТекущейСтраницы);
	КонецЕсли;
...
Функция ОпределитьТабличноеПолеПоИдМногострочногоРазделаНаСервере(ИдГруппы) Экспорт
	...
	ИдГрупп = ИдентификаторыМногострочныхГрупп(ЭтотОбъект);
...
Функция ПечатьНаСервере(ВидПечати)
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел11" Тогда
		СохрТЗМногострочнойГруппы11 = ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы11].Выгрузить();
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел12" Тогда
		СохрТЗМногострочнойГруппы12 = ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы12].Выгрузить();
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
		СохрТЗМногострочнойГруппы21 = ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы21].Выгрузить();
		СохрТЗМногострочнойГруппы22 = ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы22].Выгрузить();
		СохрТЗМногострочнойГруппы241 = ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы241].Выгрузить();
		СохрТЗМногострочнойГруппы242 = ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы242].Выгрузить();
		СохрТЗМногострочнойГруппы25 = ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы25].Выгрузить();
		СохрТЗМногострочнойГруппы26 = ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы26].Выгрузить();
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение1" Тогда
		СохрТЗМногострочнойГруппы101 = ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы101].Выгрузить();
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение31" Тогда
		СохрТЗМногострочнойГруппы131 = ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы131].Выгрузить();
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение32" Тогда
		СохрТЗМногострочнойГруппы132 = ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы132].Выгрузить();
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение4" Тогда
		СохрТЗМногострочнойГруппы104 = ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы104].Выгрузить();
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение5" Тогда
		СохрТЗМногострочнойГруппы105 = ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы105].Выгрузить();
	КонецЕсли;
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел11" Тогда
		ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы11].Загрузить(СохрТЗМногострочнойГруппы11);
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел12" Тогда
		ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы12].Загрузить(СохрТЗМногострочнойГруппы12);
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
		ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы21].Загрузить(СохрТЗМногострочнойГруппы21);
		ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы22].Загрузить(СохрТЗМногострочнойГруппы22);
		ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы241].Загрузить(СохрТЗМногострочнойГруппы241);
		ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы242].Загрузить(СохрТЗМногострочнойГруппы242);
		ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы25].Загрузить(СохрТЗМногострочнойГруппы25);
		ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы26].Загрузить(СохрТЗМногострочнойГруппы26);
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение1" Тогда
		ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы101].Загрузить(СохрТЗМногострочнойГруппы101);
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение31" Тогда
		ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы131].Загрузить(СохрТЗМногострочнойГруппы131);
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение32" Тогда
		ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы132].Загрузить(СохрТЗМногострочнойГруппы132);
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение4" Тогда
		ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы104].Загрузить(СохрТЗМногострочнойГруппы104);
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение5" Тогда
		ЭтотОбъект[СтруктураРеквизитовФормы.мИдГруппы105].Загрузить(СохрТЗМногострочнойГруппы105);
	КонецЕсли;
...
Процедура ВывестиНаПечатьРаздел1(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	ТабличныйДокумент.Вывести(ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_" + "Раздел11"));
	Для Каждого ЭлСтруктуры Из СтруктураДанныхРаздел11 Цикл
	...
	ТабличныйДокумент.Вывести(ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_" + "Раздел12"));
	Для Каждого ЭлСтруктуры Из СтруктураДанныхРаздел12 Цикл
		Обл = ТабличныйДокумент.Области.Найти(ЭлСтруктуры.Ключ);
		Если Обл <> Неопределено Тогда
			Обл.Значение = ЭлСтруктуры.Значение;
		КонецЕсли;
	...
	МакетМЧБ = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ПечатныйБланк2016Кв2_Раздел1");
	...
	ТекКолвоСтрокБлока11 = ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы11]].Количество();
	ТекКолвоСтрокБлока12 = ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы12]].Количество();
	...
	ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы11]], Тип("ТаблицаЗначений")).Колонки;
	Колонки12 = ДанныеФормыВЗначение(
	ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы12]], Тип("ТаблицаЗначений")).Колонки;
...
Процедура ВывестиНаПечатьРаздел2(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	МакетМЧБ = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ПечатныйБланк2016Кв2_Раздел2");
	...
	ТекКолвоСтрокБлока21  = ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы21]].Количество();
	ТекКолвоСтрокБлока22  = ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы22]].Количество();
	ТекКолвоСтрокБлока241 = ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы241]].Количество();
	ТекКолвоСтрокБлока242 = ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы242]].Количество();
	ТекКолвоСтрокБлока25  = ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы25]].Количество();
	ТекКолвоСтрокБлока26  = ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы26]].Количество();
	...
	ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы21]], Тип("ТаблицаЗначений")).Колонки;
	Колонки22  = ДанныеФормыВЗначение(
	ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы22]], Тип("ТаблицаЗначений")).Колонки;
	Колонки241 = ДанныеФормыВЗначение(
	ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы241]], Тип("ТаблицаЗначений")).Колонки;
	Колонки242 = ДанныеФормыВЗначение(
	ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы242]], Тип("ТаблицаЗначений")).Колонки;
	Колонки25  = ДанныеФормыВЗначение(
	ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы25]], Тип("ТаблицаЗначений")).Колонки;
	Колонки26  = ДанныеФормыВЗначение(
	ЭтотОбъект[мСтруктураМногострочныхРазделов[ИдГруппы26]], Тип("ТаблицаЗначений")).Колонки;
	...
	Если ИмяТекРаздела = "Приложение21" Тогда
		...
		Для НомСтрокиВДереве = 1 По ДеревоДанныхРаздела.Строки.Количество() Цикл
			...
			Для НомСтрокиВВетке21 = 1 По Ветка21.Строки.Количество() Цикл
				...
				ТабличныйДокумент.Вывести(ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_Приложение22"));
			...
			Если НЕ ТаблЗнач.Колонки.Найти("ДанныеДопСтрок") = Неопределено Тогда
				...
				Для Каждого СтрокаТаблЗнач Из ТаблЗнач Цикл
					...
					Если ЭлементСтруктуры.Ключ = "Раздел2" Тогда
						...
						Для Каждого ЭлСтруктуры Из ЭтотОбъект[ЭлементСтруктуры.Значение][Ном].ДанныеДопСтрок[0].Значение Цикл
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ИмяФормы).ПолучитьМакет("СпискиВыбора2016Кв2");
...
Процедура СохранитьДанныеРаздела(НаимРаздела, ОчищатьРазделЕслиЕстьМногострочность, ИзменятьАктивнуюСтраницу = Истина)
	...
	ИначеЕсли НаимРаздела = "Раздел2"
		...
		Если СтрТаблицыСтраниц.Количество() > 0 Тогда
			...
			СтруктураДанныхТекущейТаблицы = СобратьДанныеТекущегоТаблПоля(ЭтотОбъект, "ТабличныйДокумент");
			
			Если ПустаяСтрока(СтрТаблицаСтраницы.Представление) Тогда
				СтрТаблицаСтраницы.Представление = "Новая страница";
			КонецЕсли;
			
			СтруктураДанныхДопСтрокРаздела = СформироватьСтруктуруДанныхДопСтрокСтраницы(ЭтотОбъект, НаимРаздела);
	...
	ИначеЕсли НаимРаздела = "Приложение21"
		...
		ТекВетка.Данные = СобратьДанныеТекущегоТаблПоля(ЭтотОбъект, "ТабличныйДокумент");
	...
	ИначеЕсли ИмяТекРаздела = "Раздел2" Тогда
		...
		Если НовДанныеДопСтрокРаздела <> Неопределено Тогда
			...
			Для Каждого ГруппаСтрок Из НовДанныеДопСтрокРаздела Цикл
				...
				ОбновитьСтруктуруМногострочногоРаздела(ЭтотОбъект, ИмяГруппыДопСтрок);
				Если ЭтотОбъект[ИмяГруппыДопСтрок].Количество() = 1 Тогда 
...
Процедура ОчиститьОтчет(Команда)
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение22" Тогда
		...
		РегламентированнаяОтчетностьКлиент.МеханизмыОчисткиРегламентированныхОтчетов(
			ЭтотОбъект, "ОчиститьВесьОтчет", ОписаниеОповещения);
	Иначе
		РегламентированнаяОтчетностьКлиент.МеханизмыОчисткиРегламентированныхОтчетов(
...
Процедура ДобавитьСтраницуВПриложение21НаСервере()
	...
	ПредыдущаяВеткаПриложение21.Данные = СобратьДанныеТекущегоТаблПоля(ЭтотОбъект, "ТабличныйДокумент");
	
	// Вывод и сохранение данных новых страниц.
	ТабличныйДокумент.Очистить();
	ТабличныйДокумент.Вывести(ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_" + "Приложение22"));
	ВеткаПриложение22.Данные = СобратьДанныеТекущегоТаблПоля(ЭтотОбъект, "ТабличныйДокумент");
	ТабличныйДокумент.Очистить();
	ТабличныйДокумент.Вывести(ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_" + "Приложение21"));
	ВеткаПриложение21.Данные = СобратьДанныеТекущегоТаблПоля(ЭтотОбъект, "ТабличныйДокумент");
...
Процедура ДобавитьСтраницуВПриложение22НаСервере(НомСтраницыРодителя)
	...
	ПредыдущаяВеткаПриложение22.Данные = СобратьДанныеТекущегоТаблПоля(ЭтотОбъект, "ТабличныйДокумент");
	
	// Вывод и сохранение данных новых страниц.
	ТабличныйДокумент.Очистить();
	ТабличныйДокумент.Вывести(ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(ИмяФормы,
		СтрНайти(ИмяФормы, "ФормаОтчета")) + "_" + "Приложение22"));
...
Процедура УдалитьДополнительнуюСтраницуНаСервере(ИмяТекущейСтраницыПанели = Неопределено)
	...
	Если ИмяТекущейСтраницыПанели = "Раздел2" Тогда
		УдалитьДополнительнуюСтраницу(ЭтотОбъект, ИмяТекущейСтраницыПанели);
	Иначе
...
Процедура СобратьДанные(ИмяОбласти)
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела <> "Приложение21" Тогда
		Если ЭтотОбъект["ТаблицаСтраницы"
...
Процедура СформироватьРаздел25(НомерСтраницыРазделаОтчета)
	...
	Если НЕ ЗначениеЗаполнено(КодВидаПодакцизТовара_Раздел2) Тогда
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru='Не заполнен код вида подакцизного товара на странице "
...
Процедура СформироватьРаздел31()
	...
	ТаблСтраницРаздела31   = ЭтотОбъект[ТаблСтраницРаздела31];
	ТаблСтраницПриложения6 = ЭтотОбъект[ТаблСтраницПриложения6];
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел31" Тогда
		...
		РегламентированнаяОтчетностьКлиентСервер.ОчиститьВариантыЗаполнения(ЭтотОбъект, "Раздел31");
	Иначе
		ТаблСтраницРаздела31.Очистить();
		СтрПерваяСтраница = ТаблСтраницРаздела31.Добавить();
		СтрПерваяСтраница.Представление               = "Новая страница";
		СтрПерваяСтраница.АктивнаяСтраница            = Истина;
		СтрПерваяСтраница.АвтоматическоеПредставление = Истина;
		ЗаполнитьПустыеСтруктурыДанных();
...
Процедура СформироватьРаздел32()
	...
	ТаблСтраницРаздела32   = ЭтотОбъект[ТаблСтраницРаздела32];
	ТаблСтраницПриложения7 = ЭтотОбъект[ТаблСтраницПриложения7];
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел32" Тогда
		...
		РегламентированнаяОтчетностьКлиентСервер.ОчиститьВариантыЗаполнения(ЭтотОбъект, "Раздел32");
	Иначе
		ТаблСтраницРаздела32.Очистить();
		СтрПерваяСтраница = ТаблСтраницРаздела32.Добавить();
		СтрПерваяСтраница.Представление               = "Новая страница";
		СтрПерваяСтраница.АктивнаяСтраница            = Истина;
		СтрПерваяСтраница.АвтоматическоеПредставление = Истина;
		ЗаполнитьПустыеСтруктурыДанных();
...
Процедура СформироватьРаздел33()
	...
	ТаблСтраницРаздела33   = ЭтотОбъект[ТаблСтраницРаздела33];
	ТаблСтраницПриложения8 = ЭтотОбъект[ТаблСтраницПриложения8];
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел33" Тогда
		...
		РегламентированнаяОтчетностьКлиентСервер.ОчиститьВариантыЗаполнения(ЭтотОбъект, "Раздел33");
	Иначе
		ТаблСтраницРаздела33.Очистить();
		СтрПерваяСтраница = ТаблСтраницРаздела33.Добавить();
		СтрПерваяСтраница.Представление               = "Новая страница";
		СтрПерваяСтраница.АктивнаяСтраница            = Истина;
		СтрПерваяСтраница.АвтоматическоеПредставление = Истина;
		ЗаполнитьПустыеСтруктурыДанных();
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если СтрНайти(Область.Имя, "ОКВЭД") > 0 Тогда
		Если НЕ ПустаяСтрока(ЗначПоказателя)
			...
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru='" + ТекстСообщения + "'"));
		КонецЕсли;
	КонецЕсли;
	...
	ИначеЕсли Лев(ИмяПоказателя, 13) = "П000240000105"
		...
		Если Область.Значение > 0 И Область.Значение < 1000 Тогда
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru = 'Длина значения показателя должна быть равна 4.';
