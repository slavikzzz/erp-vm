...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	СписокИменТабличныхЧастейДокументов.Добавить("АктВыполненныхРабот.Услуги",     НСтр("ru = 'В актах выполненных работ';
																						|en = 'In Customer invoice —Services'"));
	...
	СписокИменТабличныхЧастейДокументов.Добавить("ВозвратТоваровОтКлиента.Товары", НСтр("ru = 'В возвратах';
																						|en = 'In returns'"));
	//++ НЕ УТКА
	СписокИменТабличныхЧастейДокументов.Добавить("ЗаказДавальца2_5.Продукция", НСтр("ru = 'В заказах';
																					|en = 'In orders'"));
	СписокИменТабличныхЧастейДокументов.Добавить("ОтчетДавальцу2_5.Продукция", НСтр("ru = 'В отчетах';
																					|en = 'In reports'"));
	СписокИменТабличныхЧастейДокументов.Добавить("ОтгрузкаТоваровСХранения.Товары", НСтр("ru = 'В передачах';
																						|en = 'In transfers'"));
	//-- НЕ УТКА
...
Функция ТекстЗапросаПоСпискуИменТабличныхЧастей(СписокИменТабличныхЧастейДокументов)
	...
	Если ТекстЗапроса = "" Тогда
		ВызватьИсключение НСтр("ru = 'Для текущего пользователя нет доступных документов по которым определяется состав продажи';
								|en = 'For the current user, there are no documents to determine the sale content'");
	КонецЕсли;
