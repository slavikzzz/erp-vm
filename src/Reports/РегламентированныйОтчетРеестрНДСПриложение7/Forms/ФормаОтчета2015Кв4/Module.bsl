...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	Если РазделЗаполнен(ДанныеРеестра.Строки, Ложь) Тогда
		...
		ПроверитьКС_7_1_1(СтруктураРезультата);
		ПроверитьКС_7_1_2(СтруктураРезультата);
		ПроверитьКС_7_1_3(СтруктураРезультата);
		ПроверитьКС_7_1_4(СтруктураРезультата);
		ПроверитьКС_7_1_5(СтруктураРезультата);
		ПроверитьКС_7_1_6(СтруктураРезультата);
		ПроверитьКС_7_2_1(СтруктураРезультата);
		ПроверитьКС_7_2_2(СтруктураРезультата);
		ПроверитьКС_7_2_3(СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_7_1_1(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 7.1.1';
												|en = 'Проверка КС 7.1.1'"));
...
&НаСервере
Процедура ПроверитьКС_7_1_2(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 7.1.2';
												|en = 'Проверка КС 7.1.2'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_7_1_3(СтруктураРезультата)
	
	Заголовки		= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"		,НСтр("ru = 'Проверка КС 7.1.3';
													|en = 'Проверка КС 7.1.3'"));
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Код страны отправления (графа 4 Реестра) должен соответствовать справочнику ОКСМ';
			|en = 'Код страны отправления (графа 4 Реестра) должен соответствовать справочнику ОКСМ'"));
	Заголовки.Вставить("ШаблонРасшифровки"	,НСтр("ru = 'Указанный код: (""%1"")';
													|en = 'Указанный код: (""%1"")'"));
	Заголовки.Вставить("Показатель"			,НСтр("ru = 'КодСтраныОтправления';
													|en = 'КодСтраныОтправления'"));
...
&НаСервере
Процедура ПроверитьКС_7_1_4(СтруктураРезультата)
	
	Заголовки		= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"		,НСтр("ru = 'Проверка КС 7.1.4';
													|en = 'Проверка КС 7.1.4'"));
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Код страны назначения (графа 6 Реестра) должен соответствовать справочнику ОКСМ';
			|en = 'Код страны назначения (графа 6 Реестра) должен соответствовать справочнику ОКСМ'"));
	Заголовки.Вставить("ШаблонРасшифровки"	,НСтр("ru = 'Указанный код: (""%1"")';
													|en = 'Указанный код: (""%1"")'"));
	Заголовки.Вставить("Показатель"			,НСтр("ru = 'КодСтраныНазначения';
													|en = 'КодСтраныНазначения'"));
	Заголовки.Вставить("ПроверятьПустые"	,Истина);
	Настройки	= ОбработатьНастройки(		, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_7_1_5(СтруктураРезультата)
	
	Заголовки		= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"		,НСтр("ru = 'Проверка КС 7.1.5';
													|en = 'Проверка КС 7.1.5'"));
	Заголовки.Вставить("ОписаниеКС"			,
		НСтр("ru = 'Если код страны порта разгрузки (графа 14 Реестра) указан, то он должен соответствовать справочнику ОКСМ';
			|en = 'Если код страны порта разгрузки (графа 14 Реестра) указан, то он должен соответствовать справочнику ОКСМ'"));
	Заголовки.Вставить("ШаблонРасшифровки"	,НСтр("ru = 'Указанный код: (""%1"")';
													|en = 'Указанный код: (""%1"")'"));
	Заголовки.Вставить("Показатель"			,НСтр("ru = 'КодСтраныПортаРазгрузки';
													|en = 'КодСтраныПортаРазгрузки'"));
	Заголовки.Вставить("ПроверятьПустые"	,Ложь);
	Настройки	= ОбработатьНастройки(		, Заголовки, СтруктураРезультата);
	
	ПроверитьКС_СоответствиеСправочникуОКСМ_2Уровня(СтруктураРезультата, Настройки);
	
КонецПроцедуры

&НаСервере
Процедура ПроверитьКС_7_1_6(СтруктураРезультата)
	
	Настройки	= ОбработатьНастройки(,, СтруктураРезультата);
	Настройки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 7.1.6';
												|en = 'Проверка КС 7.1.6'"));
	Настройки.Вставить("Нарушение"		,НСтр("ru = 'п. 3.1 и п. 3.7 ст. 165 НК РФ';
												|en = 'п. 3.1 и п. 3.7 ст. 165 НК РФ'"));
	Настройки.Вставить("ОписаниеКС"		,
		НСтр("ru = 'Если код операции равен 1010435/1010436, то должен быть указан транспортный, товаросопроводительный ';
			|en = 'Если код операции равен 1010435/1010436, то должен быть указан транспортный, товаросопроводительный '") +
		НСтр("ru = 'и (или) иной документ, подтверждающий факт убытия товара морским (речным) транспортом';
			|en = 'и (или) иной документ, подтверждающий факт убытия товара морским (речным) транспортом'"));
	Настройки.Вставить("ШаблонОшибки"	,
		НСтр("ru = 'Не указаны сведения, подтверждающие факт убытия товара морским (речным) транспортом, при ';
			|en = 'Не указаны сведения, подтверждающие факт убытия товара морским (речным) транспортом, при '") +
		НСтр("ru = 'указанном коде операции: ';
			|en = 'указанном коде операции: '"));
	Настройки.Вставить("ШаблонОшибки2"		,НСтр("ru = 'вид товаросопроводительного документа';
													|en = 'вид товаросопроводительного документа'"));
	Настройки.Вставить("ШаблонОшибки3"		,НСтр("ru = 'номер товаросопроводительного документа';
													|en = 'номер товаросопроводительного документа'"));
	Настройки.Вставить("ШаблонОшибки4"		,НСтр("ru = 'дата товаросопроводительного документа';
													|en = 'дата товаросопроводительного документа'"));
	Настройки.Вставить("ШаблонРасшифровки"	,НСтр("ru = 'Указанные сведения: (""%1"")';
													|en = 'Указанные сведения: (""%1"")'"));
	Настройки.Вставить("ШаблонРасшифровки2"	,НСтр("ru = '%1%2%3%4%5';
													|en = '%1%2%3%4%5'"));
	Настройки.Вставить("ШаблонДопСведений"	,НСтр("ru = 'Страница %1, Строка %2, Подстрока %3';
													|en = 'Страница %1, Строка %2, Подстрока %3'"));
	ВидыОпераций			= Новый Соответствие;
	ВидыОпераций.Вставить("1010435", "1010435");
	ВидыОпераций.Вставить("1010436", "1010436");
	...
	Для каждого СтраницаРаздела Из ДанныеРеестра.Строки Цикл
		...
		Показатели			= ЗаполнитьПоказатели("КодОперации", СтраницаРаздела.Данные);
		Если ВидыОпераций.Получить(Показатели.КодОперации.Значение) = Неопределено Тогда
			Продолжить;
		КонецЕсли; 
		...
		Для НомерСтроки = 1 По КоличествоСтрок Цикл
			...
			Список2Уровня	= ДанныеСтраницы[НомерСтроки - 1].ДанныеМногострочныхЧастей.П12000.Строки;
			Количество2Уровня = Список2Уровня.Количество();
			
			Для НомерСтроки2Уровня = 1 По Количество2Уровня Цикл
				
				Настройки.Вставить("ДопСведенияПараметры", Новый Структура("НомерСтраницы, НомерСтроки, НомерПодстроки", 
					НомерСтраницы, НомерРасчетный, НомерСтроки2Уровня));
				ЗарегистрироватьФормулу(Настройки);
				Показатели	= ЗаполнитьПоказатели("ВидДокумента, НомерДокумента, ДатаДокумента", 
					Список2Уровня[НомерСтроки2Уровня - 1].Данные, НомерСтроки, НомерСтроки2Уровня);
				РасшифроватьПоказатели(Показатели, Настройки, "Реестр", НомерСтраницы);
				Расшифровка	= СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки2, 
					Показатели.ВидДокумента.ЗначениеСтр, ",", Показатели.НомерДокумента.ЗначениеСтр, ",", 
					Показатели.ДатаДокумента.ЗначениеСтр);
				МассивРасшифровки = СтрРазделить(Расшифровка, ",", Ложь);
				...
				Если Не ЗначениеЗаполнено(Показатели.ВидДокумента.Значение) Тогда
					МассивОшибок.Добавить(Настройки.ШаблонОшибки2);
				КонецЕсли;
				
				Если Не ЗначениеЗаполнено(Показатели.НомерДокумента.Значение) Тогда
					МассивОшибок.Добавить(Настройки.ШаблонОшибки3);
				КонецЕсли;
				
				Если Не ЗначениеЗаполнено(Показатели.ДатаДокумента.Значение) Тогда
					МассивОшибок.Добавить(Настройки.ШаблонОшибки4);
				КонецЕсли;
...
&НаСервере
Процедура ПроверитьКС_7_2_1(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 7.2.1';
												|en = 'Проверка КС 7.2.1'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_7_2_2(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 7.2.2';
												|en = 'Проверка КС 7.2.2'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_7_2_3(СтруктураРезультата)
	
	Заголовки	= Новый Структура;
	Заголовки.Вставить("ТекстФормулы"	,НСтр("ru = 'Проверка КС 7.2.3';
												|en = 'Проверка КС 7.2.3'"));
	Настройки	= ОбработатьНастройки(	, Заголовки, СтруктураРезультата);
...
&НаСервере
Процедура ПроверитьКС_СоответствиеСправочникуОКСМ_2Уровня(СтруктураРезультата, Настройки)
	...
	Для каждого СтраницаРаздела Из ДанныеРеестра.Строки Цикл
		...
		Для НомерСтроки = 1 По КоличествоСтрок Цикл
			...
			НомерРасчетный	= НомерРасчетный + 1;
			Список2Уровня	= ДанныеСтраницы[НомерСтроки - 1].ДанныеМногострочныхЧастей.П12000.Строки;
			КоличествоСтрок2Уровня = Список2Уровня.Количество();
			
			Для НомерСтроки2Уровня = 1 По КоличествоСтрок2Уровня Цикл
			
				Настройки.Вставить("ДопСведенияПараметры", Новый Структура("НомерСтраницы, НомерСтроки, НомерПодстроки", 
					НомерСтраницы, НомерРасчетный, НомерСтроки2Уровня));
				Показатели		= ЗаполнитьПоказатели(Настройки.Показатель, Список2Уровня[НомерСтроки2Уровня - 1].Данные, 
					НомерСтроки, НомерСтроки2Уровня);
				ПоказательКода	= Показатели[Настройки.Показатель];
...
Функция ПоказательПоСтроке(УсловныйКодПоказателя)
	...
	ИначеЕсли УсловныйКодПоказателя = "КодСтраныОтправления" Тогда
		Результат.Вставить("Имя", "П1000004%1%2");
		Результат.Вставить("Представление", Нстр("ru = 'Код страны отправления';
												|en = 'Код страны отправления'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "КодСтраныНазначения" Тогда
		Результат.Вставить("Имя", "П1000006%1%2");
		Результат.Вставить("Представление", Нстр("ru = 'Код страны назначения';
												|en = 'Код страны назначения'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "КодСтраныПортаРазгрузки" Тогда
		Результат.Вставить("Имя", "П1200024%1%2%3%4");
		Результат.Вставить("Представление", Нстр("ru = 'Код страны порта разгрузки';
												|en = 'Код страны порта разгрузки'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "ВидДокумента" Тогда
		Результат.Вставить("Имя", "П1200009%1%2%3%4");
		Результат.Вставить("Представление", Нстр("ru = 'Вид товаросопроводительного документа';
												|en = 'Вид товаросопроводительного документа'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "НомерДокумента" Тогда
		Результат.Вставить("Имя", "П1200010%1%2%3%4");
		Результат.Вставить("Представление", Нстр("ru = 'Номер товаросопроводительного документа';
												|en = 'Номер товаросопроводительного документа'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
		
	ИначеЕсли УсловныйКодПоказателя = "ДатаДокумента" Тогда
		Результат.Вставить("Имя", "П1200011%1%2%3%4");
		Результат.Вставить("Представление", Нстр("ru = 'Дата товаросопроводительного документа';
												|en = 'Дата товаросопроводительного документа'"));
		Результат.Вставить("ИзменяемаяРазмерность", Ложь);
