...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	СтруктураРеквизитовФормы.Вставить("мИдГруппы310");
	СтруктураРеквизитовФормы.Вставить("мИдГруппы320");
...
Процедура ИнициализироватьМногострочныеЧасти()
	...
	СтруктураРеквизитовФормы.мИдГруппы310 = "П31000";
	СтруктураРеквизитовФормы.мИдГруппы320 = "П32000";
	...
	// Группа П31000.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П3100001");
	ИменаГраф.Добавить("П3100002");
	ИменаГраф.Добавить("П3100003");
	ИменаГраф.Добавить("П3100004");
	ИменаГраф.Добавить("П3100005");
	ИменаГраф.Добавить("П3100006");
	ИменаГраф.Добавить("П3100007");
	ИменаГраф.Добавить("П3100008");
	ИменаГраф.Добавить("П3100009");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
		СтруктураРеквизитовФормы.мИдГруппы310, Новый Структура(
		"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп",
		ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
	
	// Группа П32000.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П3200001");
	ИменаГраф.Добавить("П3200002");
	ИменаГраф.Добавить("П3200003");
	ИменаГраф.Добавить("П3200004");
	ИменаГраф.Добавить("П3200005");
	ИменаГраф.Добавить("П3200006");
	ИменаГраф.Добавить("П3200007");
	ИменаГраф.Добавить("П3200008");
	ИменаГраф.Добавить("П3200009");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
		СтруктураРеквизитовФормы.мИдГруппы320, Новый Структура(
		"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп",
		ИменаГраф, 1, 0, ИменаПодчиненныхГрупп));
...
Процедура ИнициализироватьМногоуровневыеРазделы()
	...
	СтруктураРаздела = Новый Структура;
	ИменаГруппМнЧ = Новый Массив;
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппы310);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	мСтруктураМногоуровневыхРазделов.Вставить("Раздел31", СтруктураРаздела);
	
	СтруктураРаздела = Новый Структура;
	ИменаГруппМнЧ = Новый Массив;
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппы320);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "TransportType", , ,
		"Выбор кода вида транспортной деятельности", КоллекцияСписковВыбора["ВидыТранспортнойДеятельности"]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000003", , ,
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000005", 3, ,
		"Выбор кода страны отправления", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000006", 3, ,
		"Выбор кода страны назначения", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000007", 3, ,
		"Выбор кода страны грузоотправителя", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000008", 3, ,
		"Выбор кода страны грузополучателя", КоллекцияСписковВыбора["КодыСтран"]);
	...
	//Раздел 2.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000002", 2, ,
		"Выбор кода территории", КоллекцияСписковВыбора["Регионы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000003", , ,
		"Выбор кода вида пассажирского транспорта", КоллекцияСписковВыбора["ВидыТранспортаПасс"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000004", 2, ,
		"Выбор кода операции", КоллекцияСписковВыбора["КодыОпераций"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000005", 3, ,
		"Выбор кода страны", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000006", 3, ,
		"Выбор кода валюты", КоллекцияСписковВыбора["КодыВалют"]);
	
	//Раздел 3.1.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П3100002", 2, ,
		"Выбор кода региона", КоллекцияСписковВыбора["Регионы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П3100003", 3, ,
		"Выбор кода страны контрагента", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П3100004", 3, ,
		"Выбор кода валюты", КоллекцияСписковВыбора["КодыВалют"]);

	//Раздел 3.2.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П3200002", 2, ,
		"Выбор кода региона", КоллекцияСписковВыбора["Регионы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П3200003", 3, ,
		"Выбор кода страны контрагента", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П3200004", 3, ,
		"Выбор кода валюты", КоллекцияСписковВыбора["КодыВалют"]);
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Область.Имя = "TransportType" Тогда
		...
		Если ПараметрВводаПоля <> Неопределено И ПараметрВводаПоля.ТаблицаЗначений.Количество() > 0 Тогда
			...
			ВвестиПоказатель(
				Элемент, Область, КодПоказателя, Ложь, ПараметрВводаПоля.ТекстПриВыборе, ТЗВыбора, СтандартнаяОбработка, , Истина);
		КонецЕсли;
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если ИмяРаздела = "Раздел1" ИЛИ ИмяРаздела = "Раздел2" ИЛИ ИмяРаздела = "Раздел31" ИЛИ ИмяРаздела = "Раздел32" Тогда
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяСтраницыПанели)
	...
	Если ИмяСтраницыПанели = "Раздел1"
	 ...
	 ИЛИ ИмяСтраницыПанели = "Раздел31" 
	 ИЛИ ИмяСтраницыПанели = "Раздел32" Тогда
		...
		ИначеЕсли ИмяСтраницыПанели = "Раздел31" Тогда
			ИмяОбрабОбласти = "П3100001";
		ИначеЕсли ИмяСтраницыПанели = "Раздел32" Тогда
			ИмяОбрабОбласти = "П3200001";
		КонецЕсли;
				...
				Если НайденнаяОбласть <> Неопределено И НайденнаяОбласть.СодержитЗначение Тогда
					...
					Если ЗначениеЗаполнено(НайденнаяОбласть.Значение) Тогда
						...
						Если НомПоз > 0 Тогда
							...
							СтрНом = Сред(ОбластьИмя, НомПоз + 1);
							Форма.ТабличныйДокумент.Области["П3100001_" + СтрНом].Значение = Число(" " + СтрНом);
				...
				Если НайденнаяОбласть <> Неопределено И НайденнаяОбласть.СодержитЗначение Тогда
					...
					Если ЗначениеЗаполнено(НайденнаяОбласть.Значение) Тогда
						...
						Если НомПоз > 0 Тогда
							...
							СтрНом = Сред(ОбластьИмя, НомПоз + 1);
							Форма.ТабличныйДокумент.Области["П3200001_" + СтрНом].Значение = Число(" " + СтрНом);
...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
	...
	Если ИмяРаздела = "Раздел1" ИЛИ ИмяРаздела = "Раздел2" ИЛИ ИмяРаздела = "Раздел31" ИЛИ ИмяРаздела = "Раздел32" Тогда
		...
		ИначеЕсли  ИмяРаздела = "Раздел31" Тогда
			ИмяГрафыНомера = "П3100001";
			ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы310;
		ИначеЕсли  ИмяРаздела = "Раздел32" Тогда
			ИмяГрафыНомера = "П3200001";
			ИмяГруппы = Форма.СтруктураРеквизитовФормы.мИдГруппы320;
		КонецЕсли;
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ИмяФайлаШаблона", "1-ТРАНСПОРТ");
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель, ПараметрыВыгрузки)
	...
	ДеревоДанныхРаздел32 = ДанныеМногоуровневыхРазделов["Раздел32"];
...
Функция ИдентификаторФайлаВыгрузки(ПараметрыВыгрузки)
		...
		ИдентификаторФайла = "OKUD0414006"
...
Функция ВыгрузкаОтчета(ТекстВыгрузки, ПараметрыВыгрузки)
	...
	РезультатВыгрузки.Вставить("ТипФайлаВыгрузки", "Форма1ТРАНСПОРТ");
...
Процедура ВывестиНаПечатьОтчет(СтруктураПараметров, ВыбранныеСтраницы, СтрПоля = Неопределено)
	...
	Если ВыбранныеСтраницы.Найти("Раздел1") <> Неопределено Тогда
		...
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Шап_Раздел1 = Макет.Получитьобласть("Раздел1_Шапка");
			Стр_Раздел1 = Макет.Получитьобласть("Раздел1_Строка");
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел1 = Макет.Получитьобласть("Раздел1_Строка");
					Стр_Раздел1.Области["Раздел1_Строка"].Имя = "Раздел1_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						...
						ПечФорма.Области["Раздел1_Шапка"].Имя = "Раздел1_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
	...
	Если ВыбранныеСтраницы.Найти("Раздел2") <> Неопределено Тогда
		...
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Шап_Раздел2 = Макет.Получитьобласть("Раздел2_Шапка");
			Стр_Раздел2 = Макет.Получитьобласть("Раздел2_Строка");
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел2 = Макет.Получитьобласть("Раздел2_Строка");
					Стр_Раздел2.Области["Раздел2_Строка"].Имя = "Раздел2_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						...
						ПечФорма.Области["Раздел2_Шапка"].Имя = "Раздел2_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
	...
	// Раздел 3.1.
	//
	Если ВыбранныеСтраницы.Найти("Раздел31") <> Неопределено Тогда
		
		ДеревоДанных = ПолучитьИзВременногоХранилища(
			СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел31"]);
		
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			
			Заг_Раздел31 = Макет.Получитьобласть("Раздел31_Заголовок");
			Шап_Раздел31 = Макет.Получитьобласть("Раздел31_Шапка");
			Стр_Раздел31 = Макет.Получитьобласть("Раздел31_Строка");
			
			МассивПроверки = Новый Массив;
			МассивПроверки.Добавить(Заг_Раздел31);
			МассивПроверки.Добавить(Шап_Раздел31);
			МассивПроверки.Добавить(Стр_Раздел31);
			
			Если НЕ ПечФорма.ПроверитьВывод(МассивПроверки) Тогда
				ПечФорма.ВывестиГоризонтальныйРазделительСтраниц();
			КонецЕсли;
			
			ПечФорма.Вывести(Заг_Раздел31);
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел31 = Макет.Получитьобласть("Раздел31_Строка");
					Стр_Раздел31.Области["Раздел31_Строка"].Имя = "Раздел31_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел31.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						ПечФорма.Вывести(Шап_Раздел31);
						ПечФорма.Области["Раздел31_Шапка"].Имя = "Раздел31_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
					ПечФорма.Вывести(Стр_Раздел31);
	...
	// Раздел 3.2.
	//
	Если ВыбранныеСтраницы.Найти("Раздел32") <> Неопределено Тогда
		
		ДеревоДанных = ПолучитьИзВременногоХранилища(
			СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел32"]);
		
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл
			
			Заг_Раздел32 = Макет.Получитьобласть("Раздел32_Заголовок");
			Шап_Раздел32 = Макет.Получитьобласть("Раздел32_Шапка");
			Стр_Раздел32 = Макет.Получитьобласть("Раздел32_Строка");
			
			МассивПроверки = Новый Массив;
			МассивПроверки.Добавить(Заг_Раздел32);
			МассивПроверки.Добавить(Шап_Раздел32);
			МассивПроверки.Добавить(Стр_Раздел32);
			
			Если НЕ ПечФорма.ПроверитьВывод(МассивПроверки) Тогда
				ПечФорма.ВывестиГоризонтальныйРазделительСтраниц();
			КонецЕсли;
			
			ПечФорма.Вывести(Заг_Раздел32);
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел32 = Макет.Получитьобласть("Раздел32_Строка");
					Стр_Раздел32.Области["Раздел32_Строка"].Имя = "Раздел32_Строка_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел32.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						ПечФорма.Вывести(Шап_Раздел32);
						ПечФорма.Области["Раздел32_Шапка"].Имя = "Раздел32_Шапка_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
					ПечФорма.Вывести(Стр_Раздел32);
...
Процедура ЗагрузитьПодготовленныеДанные()
	...
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел31"] = ПоместитьВоВременноеХранилище(Контейнер.Раздел31, СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел31"]);
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел31"] = ПоместитьВоВременноеХранилище(Контейнер.Раздел31, СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел31"]);
...
Функция ЗаполнитьАвтоНаСервере()
	...
	Контейнер.Вставить("Раздел31", ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел31"]));
	Контейнер.Вставить("Раздел31", ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел31"]));
...
Процедура АктивизироватьЯчейку(Ячейка) Экспорт
	...
	Если Ячейка.Раздел = "Раздел1"
	 ...
	 ИЛИ Ячейка.Раздел = "Раздел4" Тогда
