...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("СпискиВыбора2020Кв4_1");
	...
	//Реестр.
	//
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010000004", 3, ,
	"Выбор кода вида подакцизного товара", КоллекцияСписковВыбора["КодыВидаПодакцизныхТоваров"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010000018", 3, ,
	"Выбор кода вида подакцизного товара", КоллекцияСписковВыбора["КодыВидаПодакцизныхТоваров"]);
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если ИмяПоказателя = "П000010000002" ИЛИ ИмяПоказателя = "П000010000016" Тогда
	...
	Если ИмяПоказателя = "КППРеорганизованнойОрганизации"
		ИЛИ ИмяПоказателя = "П000010000003" ИЛИ ИмяПоказателя = "П000010000017" Тогда
...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
	...
	Если ИмяРаздела = "Реестр" Тогда
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Итого_Графа09 = Итого_Графа09 + Ветка.Данные["П000010000009"];
			Итого_Графа13 = Итого_Графа13 + Ветка.Данные["П000010000013"];
			Итого_Графа14 = Итого_Графа14 + Ветка.Данные["П000010000014"];
			Итого_Графа23 = Итого_Графа23 + Ветка.Данные["П000010000023"];
			Итого_Графа24 = Итого_Графа24 + Ветка.Данные["П000010000024"];
			Итого_Графа28 = Итого_Графа28 + Ветка.Данные["П000010000028"];
			Итого_Графа29 = Итого_Графа29 + Ветка.Данные["П000010000029"];
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Ветка.Данные.Вставить("П000010000109", Итого_Графа09);
			Ветка.Данные.Вставить("П000010000113", Итого_Графа13);
			Ветка.Данные.Вставить("П000010000114", Итого_Графа14);
			Ветка.Данные.Вставить("П000010000123", Итого_Графа23);
			Ветка.Данные.Вставить("П000010000124", Итого_Графа24);
			Ветка.Данные.Вставить("П000010000128", Итого_Графа28);
			Ветка.Данные.Вставить("П000010000129", Итого_Графа29);
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	Структ.Вставить("П000010000109");
	Структ.Вставить("П000010000113");
	Структ.Вставить("П000010000114");
	Структ.Вставить("П000010000123");
	Структ.Вставить("П000010000124");
	Структ.Вставить("П000010000128");
	Структ.Вставить("П000010000129");
...
Процедура ВывестиНаПечатьОтчет(СтруктураПараметров, ВыбранныеСтраницы, СтрПоля = Неопределено)
	...
	ИмяМакета = "ПечатныйБланк2020Кв4_1";
	...
	"П000010000003,П000010000006,П000010000011,П000010000017,П000010000021,П000010000026", ",", Ложь);
