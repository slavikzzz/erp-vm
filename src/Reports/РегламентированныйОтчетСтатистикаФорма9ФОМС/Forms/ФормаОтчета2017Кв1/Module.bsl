...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Сумм41_46 = 0;
	Для Стр = 41 По 46 Цикл
		Сумм41_46 = Сумм41_46 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_40.Значение = Сумм41_46;
	
	Сумм27_40 = 0;
	Для Стр = 27 По 40 Цикл
		Если Стр = 32 Тогда 
			Продолжить;
		КонецЕсли;
		Сумм27_40 = Сумм27_40 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_26.Значение = Сумм27_40 + Области.П01_47.Значение + Области.П01_48.Значение + Области.П01_49.Значение;
