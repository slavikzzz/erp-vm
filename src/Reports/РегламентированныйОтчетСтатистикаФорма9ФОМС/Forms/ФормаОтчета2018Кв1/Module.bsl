...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Сумм42_47 = 0;
	Для Стр = 42 По 47 Цикл
		Сумм42_47 = Сумм42_47 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_41.Значение = Сумм42_47;
	
	Области = Форма.ПолеТабличногоДокументаФормаОтчета.Области;
	Сумм30_33 = 0;
	Для Стр = 30 По 33 Цикл
		Сумм30_33 = Сумм30_33 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_29.Значение = Сумм30_33;
	
	Итог25 = 0;
	Для Стр = 26 По 29 Цикл
		Итог25 = Итог25+ Области["П01_"+Стр].Значение;
	КонецЦикла;
	Для Стр = 34 По 41 Цикл
		Итог25 = Итог25+ Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_25.Значение = Итог25 + Области.П01_48.Значение + Области.П01_49.Значение + Области.П01_50.Значение;
	
	Сумм14_22 = 0;
	Для Стр = 14 По 22 Цикл
		Сумм14_22 = Сумм14_22 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_13.Значение = Сумм14_22;
	...
	КонецЦикла;
	Области.П01_1.Значение = Сумм3_6 + Сумм7_13 + Области.П01_23.Значение + Области.П01_24.Значение;
