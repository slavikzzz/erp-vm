...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "21/07/2016";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Сумм44_49 = 0;
	Для Стр = 44 По 49 Цикл
		Сумм44_49 = Сумм44_49 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_43.Значение = Сумм44_49;
	
	Сумм29_43 = 0;
	Для Стр = 29 По 43 Цикл
		Если Стр = 36 Тогда 
			Продолжить;
		КонецЕсли;
		Сумм29_43 = Сумм29_43 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_28.Значение = Сумм29_43 + Области.П01_50.Значение + Области.П01_51.Значение + Области.П01_52.Значение;
	
	Сумм15_25 = 0;
	Для Стр = 15 По 25 Цикл
		Сумм15_25 = Сумм15_25 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_14.Значение = Сумм15_25;
	...
	КонецЦикла;
	Области.П01_1.Значение = Сумм3_7 + Сумм8_14 + Области.П01_26.Значение + Области.П01_27.Значение;
