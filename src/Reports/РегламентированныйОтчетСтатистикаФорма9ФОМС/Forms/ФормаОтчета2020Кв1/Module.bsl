...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мКодОтчета = "0608016";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Сумм54_59 = 0;
	Для Стр = 54 По 59 Цикл
		Сумм54_59 = Сумм54_59 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_53.Значение = Сумм54_59;
	Сумм36_40 = 0;
	Для Стр = 36 По 40 Цикл
		Сумм36_40 = Сумм36_40 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_35.Значение = Сумм36_40;
	Итог31 = Области["П01_32"].Значение + Области["П01_33"].Значение + Области["П01_34"].Значение + Области["П01_35"].Значение;
	Итог31 = Итог31 + Области["П01_41"].Значение + Области["П01_42"].Значение + Области["П01_43"].Значение;
	Итог31 = Итог31 + Области["П01_60"].Значение + Области["П01_61"].Значение + Области["П01_62"].Значение;
	Для Стр = 45 По 53 Цикл
		Итог31 = Итог31 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_31.Значение = Итог31;
	Сумм15_28 = 0;
	Для Стр = 15 По 28 Цикл
		Сумм15_28 = Сумм15_28 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_14.Значение = Сумм15_28;
	Сумм3_7 = 0;
	Для Стр = 3 По 7 Цикл
		Сумм3_7 = Сумм3_7 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_2.Значение = Сумм3_7;
	Итог1 = Области["П01_2"].Значение + Области["П01_29"].Значение + Области["П01_30"].Значение;
	Для Стр = 8 По 14 Цикл
		Итог1 = Итог1 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_1.Значение = Итог1;
КонецПроцедуры
...
Функция ПечатьНаСервере(ВидПечати)
	...
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 9-Ф (ОМС)");
	Для Ч = 2 По 5 Цикл 
		ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
...
Функция СформироватьПараметрыВыбораОтчетаПредыдущегоПериода() Экспорт 
	...
	Парам.Вставить("ИсточникОтчета", "РегламентированныйОтчетСтатистикаФорма9ФОМС");
	Парам.Вставить("ВидОтправляемогоДокумента", ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.СтатистикаФорма9ФОМС"));
