...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Для Стр = 35 По 37 Цикл
		Сумм35_37 = Сумм35_37 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_34.Значение = Сумм35_37;
	
	Сумм28_45 = 0;
	Для Стр = 28 По 45 Цикл
		Если Стр >= 35 И Стр <= 37 Тогда 
			Продолжить;
		КонецЕсли;
		Сумм28_45 = Сумм28_45 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_27.Значение = Сумм28_45 + Области.П01_52.Значение;
	
	Сумм14_24 = 0;
	Для Стр = 14 По 24 Цикл
		Сумм14_24 = Сумм14_24 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_13.Значение = Сумм14_24;
	...
	Для Стр = 8 По 13 Цикл
		Сумм8_13 = Сумм8_13 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_1.Значение = Сумм3_7 + Сумм8_13 + Области.П01_25.Значение + Области.П01_26.Значение;
