...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Сумм47_52 = 0;
	Для Стр = 47 По 52 Цикл
		Сумм47_52 = Сумм47_52 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_46.Значение = Сумм47_52;
	
	Области = Форма.ПолеТабличногоДокументаФормаОтчета.Области;
	Сумм31_34 = 0;
	Для Стр = 31 По 34 Цикл
		Сумм31_34 = Сумм31_34 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_30.Значение = Сумм31_34;
	
	Итог26 = 0;
	Для Стр = 27 По 30 Цикл
		Итог26 = Итог26+ Области["П01_"+Стр].Значение;
	КонецЦикла;
	Для Стр = 35 По 37 Цикл
		Итог26 = Итог26+ Области["П01_"+Стр].Значение;
	КонецЦикла;
	Для Стр = 39 По 46 Цикл
		Итог26 = Итог26+ Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_26.Значение = Итог26 + Области.П01_53.Значение + Области.П01_54.Значение + Области.П01_55.Значение;
	
	Сумм14_23 = 0;
	Для Стр = 14 По 23 Цикл
		Сумм14_23 = Сумм14_23 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_13.Значение = Сумм14_23;
	
	Сумм3_6 = 0;
	Для Стр = 3 По 6 Цикл
		Сумм3_6 = Сумм3_6 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_2.Значение = Сумм3_6;
	
	Сумм7_13 = 0;
	Для Стр = 7 По 13 Цикл
		Сумм7_13 = Сумм7_13 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_1.Значение = Сумм3_6 + Сумм7_13 + Области.П01_24.Значение + Области.П01_25.Значение;
КонецПроцедуры
