...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "15/02/2014";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Области.П01_49.Значение = Области.П01_50.Значение + Области.П01_51.Значение + Области.П01_52.Значение
								+ Области.П01_53.Значение + Области.П01_54.Значение;
	Области.П01_33.Значение = Области.П01_34.Значение + Области.П01_35.Значение
								+ Области.П01_36.Значение + Области.П01_37.Значение;
	Области.П01_17.Значение = Области.П01_18.Значение + Области.П01_19.Значение + Области.П01_20.Значение;
	...
	Сумм9_17 = 0;
	Для Стр = 9 По 17 Цикл 
		Сумм9_17 = Сумм9_17 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_1.Значение = Сумм9_17 + Сумм3_8;
	
	Сумм22_57 = 0;
	Для Стр = 22 По 57 Цикл
		Если (Стр >= 34 И Стр <= 37) Или (Стр >= 50 И Стр <= 54) Тогда 
			Продолжить;
		КонецЕсли;
		Сумм22_57 = Сумм22_57 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_21.Значение = Сумм22_57;
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	Нарушение = "Приказ Росстата от 22.01.2014 № 43";
	
	ТекстФормулы = "стр.58 >= стр.59";
	Описание     = "стр.58 < стр.59";
	ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П01_58"]);
	ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П01_59"]);
