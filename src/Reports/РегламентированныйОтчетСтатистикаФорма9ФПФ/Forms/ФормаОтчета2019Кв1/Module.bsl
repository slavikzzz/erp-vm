...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Области.П01_55.Значение = Области.П01_56.Значение + Области.П01_57.Значение
								+ Области.П01_58.Значение + Области.П01_59.Значение;
	...
	Для Стр = 24 По 61 Цикл
		Если (Стр >= 38 И Стр <= 41) Или (Стр >= 56 И Стр <= 59) Тогда 
			Продолжить;
		КонецЕсли;
