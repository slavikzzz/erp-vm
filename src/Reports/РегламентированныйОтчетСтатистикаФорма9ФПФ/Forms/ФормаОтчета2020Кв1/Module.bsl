...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мИдГруппы5 = "П0000500001";
	СтруктураРеквизитовФормы.мИдГруппы6 = "П0000600001";
	СтруктураРеквизитовФормы.мИдГруппы7 = "П0000020000";
	
	КолИсхСтрокИдГруппы1_6 = 1;
	КолИсхСтрокИдГруппы7 = 19;
	
	КолКолонокИдГруппы1 = 12;
	КолКолонокИдГруппы2 = 12;
	КолКолонокИдГруппы3 = 11;
	КолКолонокИдГруппы4 = 11;
	КолКолонокИдГруппы5 = 11;
	КолКолонокИдГруппы6 = 12;
	КолКолонокИдГруппы7 = 6;
	...
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы1, КолИсхСтрокИдГруппы1_6);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы2, КолИсхСтрокИдГруппы1_6);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы3, КолИсхСтрокИдГруппы1_6);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы4, КолИсхСтрокИдГруппы1_6);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы5, КолИсхСтрокИдГруппы1_6);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы6, КолИсхСтрокИдГруппы1_6);
...
Процедура ДоступностьРазделов()
	...
	Если Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) <> 12 Тогда
		...
		Для Кол = 3 По 6 Цикл
			мФормаОтчета.Области["П020" + Кол + "_1"].ЦветФона = Новый Цвет();
			мФормаОтчета.Области["П020" + Кол + "_1"].Защита = Истина;
		КонецЦикла;
		
		Для Стр = 1 По ЭтотОбъект.П0000020000.Количество() Цикл
			
			мФормаОтчета.Области["УдалитьСтрокуП000002000001" + "_" + Стр].Гиперссылка = Ложь;
			мФормаОтчета.Области["УдалитьСтрокуП000002000001" + "_" + Стр].Текст = "";
			
			Для Кол = 1 По 6 Цикл
				мФормаОтчета.Области["П0000020000" + Формат(Кол, "ЧЦ=2; ЧВН=") + "_" + Стр].ЦветФона = Новый Цвет();
				мФормаОтчета.Области["П0000020000" + Формат(Кол, "ЧЦ=2; ЧВН=") + "_" + Стр].Защита = Истина;
			КонецЦикла;
			
		КонецЦикла;
		
		мФормаОтчета.УдалитьОбласть(мФормаОтчета.Области["ДобавлениеСтроки7"], ТипСмещенияТабличногоДокумента.ПоВертикали);
...
Процедура ВставитьДополнительнуюСтроку(Форма, ТекущаяСтраница)
	...
	Если ИмяГруппы = "П0000100001" Тогда
		ИмяГруппыСинхронизируемой1 = "П0000200001";
		ИмяГруппыСинхронизируемой2 = "П0000300001";
		ИмяГруппыСинхронизируемой3 = "П0000400001";
		ИмяГруппыСинхронизируемой4 = "П0000500001";
		ИмяГруппыСинхронизируемой5 = "П0000600001";
	ИначеЕсли ИмяГруппы = "П0000200001" Тогда
		ИмяГруппыСинхронизируемой1 = "П0000100001";
		ИмяГруппыСинхронизируемой2 = "П0000300001";
		ИмяГруппыСинхронизируемой3 = "П0000400001";
		ИмяГруппыСинхронизируемой4 = "П0000500001";
		ИмяГруппыСинхронизируемой5 = "П0000600001";
	ИначеЕсли ИмяГруппы = "П0000300001" Тогда
		ИмяГруппыСинхронизируемой1 = "П0000100001";
		ИмяГруппыСинхронизируемой2 = "П0000200001";
		ИмяГруппыСинхронизируемой3 = "П0000400001";
		ИмяГруппыСинхронизируемой4 = "П0000500001";
		ИмяГруппыСинхронизируемой5 = "П0000600001";
	ИначеЕсли ИмяГруппы = "П0000400001" Тогда
		ИмяГруппыСинхронизируемой1 = "П0000100001";
		ИмяГруппыСинхронизируемой2 = "П0000200001";
		ИмяГруппыСинхронизируемой3 = "П0000300001";
		ИмяГруппыСинхронизируемой4 = "П0000500001";
		ИмяГруппыСинхронизируемой5 = "П0000600001";
	ИначеЕсли ИмяГруппы = "П0000500001" Тогда
		ИмяГруппыСинхронизируемой1 = "П0000100001";
		ИмяГруппыСинхронизируемой2 = "П0000200001";
		ИмяГруппыСинхронизируемой3 = "П0000300001";
		ИмяГруппыСинхронизируемой4 = "П0000400001";
		ИмяГруппыСинхронизируемой5 = "П0000600001";
	ИначеЕсли ИмяГруппы = "П0000600001" Тогда
		ИмяГруппыСинхронизируемой1 = "П0000100001";
		ИмяГруппыСинхронизируемой2 = "П0000200001";
		ИмяГруппыСинхронизируемой3 = "П0000300001";
		ИмяГруппыСинхронизируемой4 = "П0000400001";
		ИмяГруппыСинхронизируемой5 = "П0000500001";
	КонецЕсли;
	...
	Если ИмяГруппы = "П0000020000" Тогда
		ИмяПервойЯчейкиПоследнейСтроки = ИмяГруппы + "01_" + КолСтрокСтр;
		ГраФаКон = 6;
		ИмяТекущейОбласти = ИмяГруппы + "01_" + КолСтрокСтр1;
	Иначе
		ИмяПервойЯчейкиПоследнейСтроки = ИмяГруппы + "64_" + КолСтрокСтр;
		ГраФаКон = 65;
		ИмяТекущейОбласти = ИмяГруппы + "64_" + КолСтрокСтр1;
	КонецЕсли;
	...
	Для НомерГрафы = 1 По ГраФаКон Цикл
		...
		Если СтруктураГруппы[0].Свойство(ИмяКолонки) Тогда
			...
			Если (ИмяГруппы = "П0000020000" И НомерГрафы = 1) Или НомерГрафы = 64 Тогда
	...
	Если ИмяГруппы <> "П0000020000" Тогда
		...
		Для Раздел = 1 По 5 Цикл
			...
			ИмяПервойЯчейкиПоследнейСтрокиСинхронизируемой = ИмяГруппыСинхронизируемой + "64_" + КолСтрокСтрСинхронизируемых;
			...
			Для НомерГрафыСинхронизируемой = 1 По ГраФаКон Цикл
				...
				Если СтруктураГруппыСинхронизируемой[0].Свойство(ИмяКолонкиСинхронизируемой) Тогда
					...
					Если НомерГрафыСинхронизируемой = 64 Тогда
	...
	Если ИмяГруппы <> Форма.СтруктураРеквизитовФормы.мИдГруппы7 Тогда
		
		КолСтрок = Форма.П0000100001.Количество();
		...
		Для Раздел = 1 По 6 Цикл
			...
			Для Стр = 1 По КолСтрок Цикл
				...
				Области["УдалитьСтрокуП0000" + Раздел + "0000164_" + Стр].Гиперссылка = Истина;
				Области["УдалитьСтрокуП0000" + Раздел + "0000164_" + Стр].Текст = "х";
			КонецЦикла;
...
Процедура УдалитьДополнительнуюСтрокуИзГруппы(Форма, СпециальноеДобавление, ИмяКолонкиНомера, ТекущаяСтраница, ИмяГруппы, НомУдаляемойСтроки, НомерСтрокиТаблицы)
	...
	Если ИмяГруппы = "П0000100001" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П000020000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П000030000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой3 = "П000040000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой4 = "П000050000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой5 = "П000060000164_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0000200001" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П000010000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П000030000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой3 = "П000040000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой4 = "П000050000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой5 = "П000060000164_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0000300001" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П000010000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П000020000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой3 = "П000040000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой4 = "П000050000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой5 = "П000060000164_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0000400001" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П000010000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П000020000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой3 = "П000030000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой4 = "П000050000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой5 = "П000060000164_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0000500001" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П000010000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П000020000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой3 = "П000030000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой4 = "П000040000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой5 = "П000060000164_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0000600001" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П000010000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П000020000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой3 = "П000030000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой4 = "П000040000164_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой5 = "П000050000164_" + Сред(ИмяЯчейки, 15);
	КонецЕсли;
	...
	Если ИмяГруппы = "П0000020000" Тогда
		...
		ГраФаКон = 6;
	Иначе
		ИмяПервойЯчейкиУдаляемойСтроки = ИмяГруппы + "64_" + НомУдаляемойСтроки;
		ГраФаКон = 65;
	КонецЕсли;
	...
	Если ИмяГруппы <> "П0000020000" Тогда
		...
		Для Раздел = 1 По 5 Цикл
			...
			Если СтруктураГруппыСинхронизируемой.Количество() > ИсходноеКоличествоСтрокГруппыСинхронизируемой Тогда
				// Удаляется добавленная строка.
				ИмяПервойЯчейкиУдаляемойСтрокиСинхронизируемой = ИмяГруппыСинхронизируемой + "64_" + НомУдаляемойСтрокиСинхронизируемый;
		...
		Если Форма.П0000100001.Количество() = 1 Тогда
			
			Области = Форма.ПолеТабличногоДокументаФормаОтчета.Области;
			
			Для Раздел = 1 По 6 Цикл
				Области["УдалитьСтрокуП0000" + Раздел + "0000164_1"].Гиперссылка = Ложь;
				Области["УдалитьСтрокуП0000" + Раздел + "0000164_1"].Текст = "";
			КонецЦикла;
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ЯчейкаСпискаВыбора = Сред(Область.Имя,11,3)="164"
		Или Сред(Область.Имя,11,3)="165"
		Или СтрНачинаетсяС(Область.Имя,"П000002000001")
		Или СтрНачинаетсяС(Область.Имя,"П000002000002");
	...
	ИначеЕсли ЯчейкаСпискаВыбора Тогда
		Если СтрЧислоВхождений(Область.Имя, "П0000020000") > 0
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Результат = ?(РезультатВыбора["Название"] = "Пустое значение" , "",
		?(СтрНачинаетсяС(Область.Имя, "П000010000165") Или СтрНачинаетсяС(Область.Имя,"П000002000002"),
		РезультатКод, РезультатНазвание));
	
	Область.Значение = Результат;
	
	Если Сред(Область.Имя,11,3) = "164" Тогда
		
		ПолеТабличногоДокументаФормаОтчета.Области["П000010000165_" + Сред(Область.Имя,15)].Значение = РезультатКод;
		
		Для Н = 1 По 6 Цикл
			ОбластьДляИЗменения = ПолеТабличногоДокументаФормаОтчета.Области["П0000" + Н +"0000164_" + Сред(Область.Имя,15)];
	...
	ИначеЕсли Сред(Область.Имя,11,3) = "165" Тогда
	...
	ИначеЕсли СтрНачинаетсяС(Область.Имя,"П000002000001") Тогда
		
		ПолеТабличногоДокументаФормаОтчета.Области["П000002000002_" + Сред(Область.Имя,15)].Значение = РезультатКод;
		
	ИначеЕсли СтрНачинаетсяС(Область.Имя,"П000002000002") Тогда
		
		ПолеТабличногоДокументаФормаОтчета.Области["П000002000001_" + Сред(Область.Имя,15)].Значение = ?(Результат = "", "", РезультатНазвание);
...
Процедура ПолеТабличногоДокументаФормаОтчетаПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	ИначеЕсли Область.Имя = "НомерКорректировки" Тогда
		...
		Модифицированность = Истина;
		Возврат;
	ИначеЕсли Сред(Область.Имя,11,3) = "164" Тогда
		Для Н = 1 По 6 Цикл
			ОбластьДляИЗменения = ПолеТабличногоДокументаФормаОтчета.Области["П0000" + Н +"0000164_" + Сред(Область.Имя,15)];
			Если ОбластьДляИЗменения = Область Тогда
				Продолжить;
...
Процедура ОчиститьТабличноеПолеНаСервере()
	...
	ВыбТабличноеПоле.Вывести(ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет(СтруктураРеквизитовФормы["ИмяМакетаТабличногоДокумента"]));
	...
	Для Раздел = 1 По 6 Цикл
		ВыбТабличноеПоле.Области["УдалитьСтрокуП0000" + Раздел + "0000164_1"].Гиперссылка = Ложь;
		ВыбТабличноеПоле.Области["УдалитьСтрокуП0000" + Раздел + "0000164_1"].Текст = "";
	КонецЦикла;
...
Функция ПечатьНаСервере(ВидПечати)
	...
	ВерхМногострочнойЧасти = Области["ОсновнаяЧасть7_3"].Низ + 1;
	Если Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) <> 12 Тогда
		НизМногострочнойЧасти = Области["МногострочнаяЧасть7"].Низ;
	Иначе
		НизМногострочнойЧасти = Области["ДобавлениеСтроки7"].Верх - 1;
	КонецЕсли;
	ТекущийВерх = ВерхМногострочнойЧасти;
	Пока ТекущийВерх <= НизМногострочнойЧасти Цикл
		ТекущаяОбластьМногострочнойЧасти = ТабличныйДокумент.ПолучитьОбласть(ТекущийВерх,,ТекущийВерх,);
		...
		Иначе
			СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 9-Ф (ПФ)");
			ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
			ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть7_0"));
			ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть7_2"));
			ПечатнаяФорма.Вывести(ТекущаяОбластьМногострочнойЧасти);
		КонецЕсли;
		ТекущийВерх = ТекущийВерх + 1;
...
Функция СравнениеОтчетовНаСервере(ДанныеДляСравнения)
	...
	ДеревоДляСравнения = РегламентированнаяОтчетность.ПолучитьДеревоВыгрузки(ЭтаФорма,
...
Функция ЗагрузкаОтчетаИзФайлаНаСервере(ДанныеДляЗагрузки)
	...
	ДеревоДляЗагрузки = РегламентированнаяОтчетность.ПолучитьДеревоВыгрузки(ЭтаФорма,
		СтруктураРеквизитовФормы["ИмяМакетаСхемыВыгрузки"]);
...
Функция ПроверитьПоказатели() Экспорт
	...
	ДеревоВыгрузки = РегламентированнаяОтчетность.ПолучитьДеревоВыгрузки(ЭтаФорма,
		СтруктураРеквизитовФормы["ИмяМакетаСхемыВыгрузки"]);
...
Процедура ПолеТабличногоДокументаФормаОтчетаПриАктивизацииОбласти(Элемент)
	...
	Если СтрНачинаетсяС(Элемент.ТекущаяОбласть.Имя, "П0000020000")
		И Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) <> 12 Тогда
		Возврат;
	КонецЕсли;
	...
	НеобходимаяОбластьДляДопСтрок = СтрЧислоВхождений(ОбластьИмя, "УдалитьСтроку") = 0
		И (СтрНачинаетсяС(ОбластьИмя, "П0000100001")
		ИЛИ СтрНачинаетсяС(ОбластьИмя, "П0000200001")
		ИЛИ СтрНачинаетсяС(ОбластьИмя, "П0000300001")
		ИЛИ СтрНачинаетсяС(ОбластьИмя, "П0000400001")
		ИЛИ СтрНачинаетсяС(ОбластьИмя, "П0000500001")
		ИЛИ СтрНачинаетсяС(ОбластьИмя, "П0000600001")
		ИЛИ СтрНачинаетсяС(ОбластьИмя, "П0000020000"));
