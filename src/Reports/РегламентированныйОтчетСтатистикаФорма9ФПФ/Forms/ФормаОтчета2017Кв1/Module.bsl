...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Области.П01_37.Значение = Области.П01_38.Значение + Области.П01_39.Значение
								+ Области.П01_40.Значение + Области.П01_41.Значение;
	...
	КонецЦикла;
	Области.П01_1.Значение = Сумм9_18 + Сумм3_8 + Области.П01_22.Значение;
	
	Сумм24_60 = 0;
	Для Стр = 24 По 60 Цикл
		Если (Стр >= 38 И Стр <= 41) Или (Стр >= 55 И Стр <= 58) Тогда 
			Продолжить;
		КонецЕсли;
		Сумм24_60 = Сумм24_60 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_23.Значение = Сумм24_60;
