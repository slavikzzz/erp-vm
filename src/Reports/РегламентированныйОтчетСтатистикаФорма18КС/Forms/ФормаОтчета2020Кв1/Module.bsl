...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Области["П000010100102"].Значение = Области["П000010100302"].Значение
		+ Области["П000010102502"].Значение + Области["П000010103502"].Значение
		+ Области["П000010105602"].Значение + Области["П000010105802"].Значение
		+ Области["П000010106202"].Значение + Области["П000010107302"].Значение
		+ Области["П000010107402"].Значение + Области["П000010107502"].Значение
		+ Области["П000010107602"].Значение + Области["П000010107702"].Значение;
...
Процедура УстановитьЗащитуИЦветФонаОбластейАвторассчитываемыхПоказателей()
	...
	мФормаОтчета.Области["П000010100102"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П000010100102"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П000010100401"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П000010100401"].Защита   = Не ОтклАвтоРасчетЗначение;
	
	мФормаОтчета.Области["П000010100402"].ЦветФона = ЦветФонаЗначение;
	мФормаОтчета.Области["П000010100402"].Защита   = Не ОтклАвтоРасчетЗначение;
