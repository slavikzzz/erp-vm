...
Процедура УстановитьПараметрыДекларации() Экспорт
	...
	СписокИдГруппРаздела.Добавить(СтруктураРеквизитовФормы.мИдГруппы22, "Раздел 1 (Поступления)");
	СписокИдГруппРаздела.Добавить(СтруктураРеквизитовФормы.мИдГруппы32, "Раздел 2 (Возвраты)");
