...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если КлючВарианта = "КарточкаЭлектронногоДокумента" Тогда
		...
		Попытка
			НаборыВнешнихДанных = Отчеты.ДокументыКЭДОСотрудников.ВнешниеНаборыДанных();
			...
			Отчеты.ДокументыКЭДОСотрудников.Сформировать(ДокументРезультат, РезультатКомпоновки);
		Исключение
		
			ИнформацияОшибки = ИнформацияОбОшибке();
			ВызватьИсключение НСтр("ru = 'В настройку формирования карточки эелектронного документа внесены критичные изменения. Печатная форма не будет сформирована';
									|en = 'В настройку формирования карточки эелектронного документа внесены критичные изменения. Печатная форма не будет сформирована'") + ". " + КраткоеПредставлениеОшибки(ИнформацияОшибки);
			
		КонеЦпопытки;
		
	Иначе
		ЗарплатаКадрыОтчеты.ПриКомпоновкеРезультатаВТабличныйДокумент(
			ЭтотОбъект, ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка, Ложь, Отчеты.ДокументыКЭДОСотрудников.ВнешниеНаборыДанных());
	КонецЕсли;
