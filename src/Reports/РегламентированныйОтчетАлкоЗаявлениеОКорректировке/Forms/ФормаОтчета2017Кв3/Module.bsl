...
&НаКлиенте
Процедура СданныйАлкоОтчетПредставлениеНажатие(Элемент, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	
	Если Значениезаполнено(СданныйАлкоОтчет) Тогда
		
		ЭлементСданныйАлкоОтчет = Элементы.СданныйАлкоОтчет;
		НажатиеГиперссылки(ЭлементСданныйАлкоОтчет, СтандартнаяОбработка, РежимОткрытияОкнаФормы.Независимый);
	...
	Иначе
		...
		ИмяФормыВыбораОтчета = "Отчет." + ИмяОбъектаФормы + ".Форма.ФормаВыбораОтчета";
...
Процедура ЗавершениеВыбораОтчета(Результат, ДопПараметры) Экспорт
	...
	Если Значениезаполнено(Результат) Тогда
	    СданныйАлкоОтчет = Результат;
		СтруктураДанныхТитульный.Вставить("СданныйАлкоОтчет", СданныйАлкоОтчет);
		СтруктураРеквизитовФормы.Вставить("СданныйАлкоОтчет", СданныйАлкоОтчет);
	КонецЕсли; 
...
Процедура ИсходящийНомерПриИзменении(Элемент)
	...
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "ИсходящийНомер", "ИсходящийНомер");
		
КонецПроцедуры

&НаКлиенте
Процедура ОбоснованияПриИзменении(Элемент)
	
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "Обоснования", "Обоснования");
									
КонецПроцедуры

&НаКлиенте
Процедура ПереченьПриИзменении(Элемент)
...
&НаКлиенте
Процедура НажатиеГиперссылки(Элемент, СтандартнаяОбработка, РежимОткрытияОкна)
...
Процедура ЗаполнитьСписокАлкоОтчетов()
	...
	// Если нет подсистемы ОтчетностьПоАлкогольнойПродукции СоставАЛКО = Метаданные.Отчеты.Состав .
...
Процедура УстановитьПараметрыДекларации() Экспорт
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "14/07/2017";
	...
	СтруктураРеквизитовФормы.Вставить("НомерПриложения", Параметры.НомерПриложения);
	НомерПриложения = Параметры.НомерПриложения;
	
	СтруктураРеквизитовФормы.Вставить("СданныйАлкоОтчет", Параметры.СданныйАлкоОтчет);
	СданныйАлкоОтчет = Параметры.СданныйАлкоОтчет;
