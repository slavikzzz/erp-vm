...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "24/08/2015";
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	ТекстФормулы = "стр. 105 гр. 3 = сумме строк 116 - 121 гр. 3";
	Описание     = "стр. 105 гр. 3 <> сумме строк 116 - 121 гр. 3";
	...
	Расшифровка = Строка(ЛеваяЧасть) + " = " + Строка(ПраваяЧасть1) + " + " + Строка(ПраваяЧасть2) + " + " + Строка(ПраваяЧасть3) + " + " + Строка(ПраваяЧасть4) + " + " + Строка(ПраваяЧасть5) + " + " + Строка(ПраваяЧасть6);
	...
	ТекстФормулы = "строки 201, 204 гр. 3 не могут быть одновременно равны 0";
	Описание     = "строки 201, 204 гр. 3 = 0";
	ЛеваяЧасть  = Показатели["П0201"];
	ПраваяЧасть = Показатели["П0204"];
	Расшифровка = Строка(ЛеваяЧасть) + "," + Строка(ПраваяЧасть) + "=0";
	Если ЛеваяЧасть <> 0 И ПраваяЧасть <> 0 Тогда
		ЭтоОшибка = Ложь;
		ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
	Иначе
		ЭтоОшибка = Истина;
