...
Процедура ПриОткрытииЗавершение(Отказ, ДополнительныеПараметры) Экспорт
	...
	Если Год(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) >= 2016 Тогда
		...
		ПараметрыФорматированнойСтроки = Новый Массив;
		
		ПараметрыФорматированнойСтроки.Добавить(Новый ФорматированнаяСтрока(
		НСтр("ru = 'Для отражения вычета на сумму платы по системе ""Платон""
		|ФНС рекомендует применять новую форму декларации
		|по транспортному налогу
		|
		|';
		|en = 'Для отражения вычета на сумму платы по системе ""Платон""
		|ФНС рекомендует применять новую форму декларации
		|по транспортному налогу
		|
		|'"), Новый Шрифт(Шрифт,, 14), Новый Цвет(0, 0, 0)));
		
		ПараметрыФорматированнойСтроки.Добавить(НСтр("ru = 'Налогоплательщики могут уменьшить транспортный налог за 2016 год на сумму платы
		|в счет возмещения вреда, причиняемого автомобильным дорогам общего пользования
		|(система ""Платон""). В этом случае ФНС рекомендует применять новую форму
		|декларации, утвержденную приказом ФНС от 05.12.2016 № ММВ-7-21/668@.
		|Подробности - ';
		|en = 'Налогоплательщики могут уменьшить транспортный налог за 2016 год на сумму платы
		|в счет возмещения вреда, причиняемого автомобильным дорогам общего пользования
		|(система ""Платон""). В этом случае ФНС рекомендует применять новую форму
		|декларации, утвержденную приказом ФНС от 05.12.2016 № ММВ-7-21/668@.
		|Подробности - '"));
		...
		ПараметрыФорматированнойСтроки.Добавить(Новый ФорматированнаяСтрока(
		"в письме ФНС от 29.12.2016 № ПА-4-21/25455@",,,, "http://buh.ru/news/uchet_nalogi/52679/"));
		
		ПараметрыФорматированнойСтроки.Добавить(".");
		
		ТекстПредупреждения = Новый ФорматированнаяСтрока(ПараметрыФорматированнойСтроки);
...
Процедура ИзменитьФорматНевведенныхПоказателей(Форма)
	...
	ИначеЕсли Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
		...
		Если ЛистЗаполнен Тогда
			Форма.ТабличныйДокумент.Области.П000020011003.Формат = СтрокаФорматаНольЦифрой;
			Форма.ТабличныйДокумент.Области.П000020013003.Формат = "ЧДЦ=4; ЧН=";
		...
		Иначе
			Форма.ТабличныйДокумент.Области.П000020011003.Формат = СтрокаФорматаНольПрочерком;
			Форма.ТабличныйДокумент.Области.П000020013003.Формат = "ЧДЦ=4; ЧН=-";
			Форма.ТабличныйДокумент.Области.П000020014003.Формат = "ЧДЦ=2; ЧН=-";
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	ПроверитьКС_2_18а(СтруктураРезультата);
	
	ПроверитьКС_2_18б(СтруктураРезультата);
...
Процедура ПроверитьКС_1_1(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 021 Раздел 1) должна быть равна сумме всех значений по строкам 250 Раздела 2 по соответствующим кодам ОКТМО и КБК';
							|en = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 021 Раздел 1) должна быть равна сумме всех значений по строкам 250 Раздела 2 по соответствующим кодам ОКТМО и КБК'");
...
Процедура ПроверитьКС_2_1(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Код налоговой льготы в виде освобождения от налогообложения (строка 190 Раздела 2) должен быть заполнен, если значение строки 200 Раздела 2 больше нуля';
							|en = 'Код налоговой льготы в виде освобождения от налогообложения (строка 190 Раздела 2) должен быть заполнен, если значение строки 200 Раздела 2 больше нуля'");
...
Процедура ПроверитьКС_2_2(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма налоговой льготы (строка 200 Раздела 2) должна быть больше нуля, если значение строки 190 Раздела 2 заполнено';
							|en = 'Сумма налоговой льготы (строка 200 Раздела 2) должна быть больше нуля, если значение строки 190 Раздела 2 заполнено'");
...
Процедура ПроверитьКС_2_3(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Код налоговой льготы в виде уменьшения суммы налога (строка 210 Раздела 2) должен быть заполнен, если значение строки 220 Раздела 2 больше нуля';
							|en = 'Код налоговой льготы в виде уменьшения суммы налога (строка 210 Раздела 2) должен быть заполнен, если значение строки 220 Раздела 2 больше нуля'");
...
Процедура ПроверитьКС_2_4(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма налоговой льготы (строка 220 Раздела 2) должна быть больше нуля, если значение строки 210 Раздела 2 заполнено';
							|en = 'Сумма налоговой льготы (строка 220 Раздела 2) должна быть больше нуля, если значение строки 210 Раздела 2 заполнено'");
...
Процедура ПроверитьКС_2_5(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Код налоговой льготы в виде снижения налоговой ставки (строка 230 Раздела 2) должен быть заполнен, если значение строки 240 Раздела 2 больше нуля';
							|en = 'Код налоговой льготы в виде снижения налоговой ставки (строка 230 Раздела 2) должен быть заполнен, если значение строки 240 Раздела 2 больше нуля'");
...
Процедура ПроверитьКС_2_6(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма налоговой льготы (строка 240 Раздела 2) должна быть больше нуля, если значение строки 230 Раздела 2 заполнено';
							|en = 'Сумма налоговой льготы (строка 240 Раздела 2) должна быть больше нуля, если значение строки 230 Раздела 2 заполнено'");
...
Процедура ПроверитьКС_2_7(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Количество полных месяцев использования льготы (строка 170 Раздела 2) должно быть заполнено одновременно с показателями кода налоговой льготы (строка 190 или строка 210 или строка 230 Раздела 2) и суммы налоговой льготы (строка 200 или строка 220 или строка 240 Раздела 2)';
							|en = 'Количество полных месяцев использования льготы (строка 170 Раздела 2) должно быть заполнено одновременно с показателями кода налоговой льготы (строка 190 или строка 210 или строка 230 Раздела 2) и суммы налоговой льготы (строка 200 или строка 220 или строка 240 Раздела 2)'");
...
Процедура ПроверитьКС_2_10(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма налоговой льготы по строке 200 Раздела 2 должна быть равна нулю, если не заполнен код налоговой льготы по строке 190 Раздела 2';
							|en = 'Сумма налоговой льготы по строке 200 Раздела 2 должна быть равна нулю, если не заполнен код налоговой льготы по строке 190 Раздела 2'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ПроверятьСоотношение = НЕ ЗначениеЗаполнено(Р2Стр190.Значение);
		...
		СоотношениеВыполняется = НЕ ЗначениеЗаполнено(Р2Стр200.Значение);
		...
		Расшифровка = Р2Стр200.ЗначениеСтр + " = 0, когда код льготы в строке 190 не заполнен (""" + Р2Стр190.ЗначениеСтр + """)";
...
Процедура ПроверитьКС_2_11(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма налоговой льготы по строке по строке 220 раздела 2 должна быть равна нулю, если не заполнен код налоговой льготы по строке 210 Раздела 2';
							|en = 'Сумма налоговой льготы по строке по строке 220 раздела 2 должна быть равна нулю, если не заполнен код налоговой льготы по строке 210 Раздела 2'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ПроверятьСоотношение = НЕ ЗначениеЗаполнено(Р2Стр210.Значение);
		...
		СоотношениеВыполняется = НЕ ЗначениеЗаполнено(Р2Стр220.Значение);
		...
		Расшифровка = Р2Стр220.ЗначениеСтр + " = 0, когда код льготы в строке 210 не заполнен (""" + Р2Стр210.ЗначениеСтр + """)";
...
Процедура ПроверитьКС_2_12(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма налоговой льготы по строке 240 Раздела 2 должна быть равна нулю, если не заполнен код налоговой льготы по строке 230 Раздела 2';
							|en = 'Сумма налоговой льготы по строке 240 Раздела 2 должна быть равна нулю, если не заполнен код налоговой льготы по строке 230 Раздела 2'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ПроверятьСоотношение = НЕ ЗначениеЗаполнено(Р2Стр230.Значение);
		...
		СоотношениеВыполняется = НЕ ЗначениеЗаполнено(Р2Стр240.Значение);
		...
		Расшифровка = Р2Стр240.ЗначениеСтр + " = 0, когда код льготы в строке 230 не заполнен (""" + Р2Стр230.ЗначениеСтр + """)";
...
Процедура ПроверитьКС_2_13(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма налоговой льготы (строка 200 Раздела 2) должна быть равна строка 070 Раздела 2 * строка 140 Раздела 2 * строка 120 Раздела 2 * строка 150 * строка 180, если заполнен код льготы (строка 190 Раздела 2)';
							|en = 'Сумма налоговой льготы (строка 200 Раздела 2) должна быть равна строка 070 Раздела 2 * строка 140 Раздела 2 * строка 120 Раздела 2 * строка 150 * строка 180, если заполнен код льготы (строка 190 Раздела 2)'");
...
Процедура ПроверитьКС_2_14(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Коэффициент Кв (строка 130 Раздела 2) должен быть равен 1, если строка 110 Раздела 2 = 12 (транспортное средство использовалось в течение всего налогового периода)';
							|en = 'Коэффициент Кв (строка 130 Раздела 2) должен быть равен 1, если строка 110 Раздела 2 = 12 (транспортное средство использовалось в течение всего налогового периода)'");
...
Процедура ПроверитьКС_2_15(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма исчисленного налога (строка 160 Раздела 2) должна быть равна произведению строк 070, 140, 120, 130, 150 Раздела 2';
							|en = 'Сумма исчисленного налога (строка 160 Раздела 2) должна быть равна произведению строк 070, 140, 120, 130, 150 Раздела 2'");
...
Процедура ПроверитьКС_2_16(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма налоговой льготы (строка 220 Раздела 2) должна быть равна произведению значений строк 070, 140, 120, 150, 180, 210а Раздела 2 / 100%, если заполнен код льготы (строка 210 Раздела 2)';
							|en = 'Сумма налоговой льготы (строка 220 Раздела 2) должна быть равна произведению значений строк 070, 140, 120, 150, 180, 210а Раздела 2 / 100%, если заполнен код льготы (строка 210 Раздела 2)'");
...
Процедура ПроверитьКС_2_17(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru = 'Сумма налоговой льготы в виде снижения ставки налога (строка 240 Раздела 2) должна быть равна (строка 070 Раздела 2 х строка 140 Раздела 2) - (строка 070 Раздела 2 х строка 230а Раздела 2) х значение доли в строке 120 х значение коэффициента Кп в строке 150 x значение коэффициента Кл в строке 180, если заполнен код льготы (строка 230 Раздела 2)';
							|en = 'Сумма налоговой льготы в виде снижения ставки налога (строка 240 Раздела 2) должна быть равна (строка 070 Раздела 2 х строка 140 Раздела 2) - (строка 070 Раздела 2 х строка 230а Раздела 2) х значение доли в строке 120 х значение коэффициента Кп в строке 150 x значение коэффициента Кл в строке 180, если заполнен код льготы (строка 230 Раздела 2)'");
...
&НаСервере
Процедура ПроверитьКС_2_18а(СтруктураРезультата)
	
	ОбщееЧислоОшибок    = СтруктураРезультата.КоличествоНайденныхОшибок;
	ОбщееЧислоБезОшибок = СтруктураРезультата.КоличествоНайденныхБезОшибок;
	СтруктураОшибок     = СтруктураРезультата.СтруктураОшибок;
	
	ТекстФормулы   = НСтр("ru = 'Проверка раздела 2 (КС 2.18а)';
							|en = 'Проверка раздела 2 (КС 2.18а)'");
	ОписаниеКС     = НСтр("ru = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 250 Раздела 2) должна быть равна разнице строк 160 и 200 Раздела 2, если строка 200 Раздела 2 (сумма налоговой льготы) больше нуля и при этом заполнен код льготы по строке 190 Раздела 2';
							|en = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 250 Раздела 2) должна быть равна разнице строк 160 и 200 Раздела 2, если строка 200 Раздела 2 (сумма налоговой льготы) больше нуля и при этом заполнен код льготы по строке 190 Раздела 2'");
...
&НаСервере
Процедура ПроверитьКС_2_18б(СтруктураРезультата)
	
	ОбщееЧислоОшибок    = СтруктураРезультата.КоличествоНайденныхОшибок;
	ОбщееЧислоБезОшибок = СтруктураРезультата.КоличествоНайденныхБезОшибок;
	СтруктураОшибок     = СтруктураРезультата.СтруктураОшибок;
	
	ТекстФормулы   = НСтр("ru = 'Проверка раздела 2 (КС 2.18б)';
							|en = 'Проверка раздела 2 (КС 2.18б)'");
...
Функция ПоказательПоСтроке(УсловныйКодПоказателя)
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр070" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Налоговая база (строка 070%1 раздела 2)';
												|en = 'Налоговая база (строка 070%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр090" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Экологический класс (строка 090%1 раздела 2)';
												|en = 'Экологический класс (строка 090%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр100" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Количество полных лет, прошедших с года выпуска транспортного средства (строка 100%1 раздела 2)';
												|en = 'Количество полных лет, прошедших с года выпуска транспортного средства (строка 100%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр110" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Количество полных месяцев владения транспортным средством (строка 110%1 раздела 2)';
												|en = 'Количество полных месяцев владения транспортным средством (строка 110%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр120_Числ" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Доля налогоплательщика в праве на транспортное средство (числитель в строке 120%1 раздела 2)';
												|en = 'Доля налогоплательщика в праве на транспортное средство (числитель в строке 120%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр120_Знам" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Доля налогоплательщика в праве на транспортное средство (знаменатель в строке 120%1 раздела 2)';
												|en = 'Доля налогоплательщика в праве на транспортное средство (знаменатель в строке 120%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр130" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Коэффициент Кв (строка 130%1 раздела 2)';
												|en = 'Коэффициент Кв (строка 130%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр150" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Коэффициент Кп (строка 150%1 раздела 2)';
												|en = 'Коэффициент Кп (строка 150%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр160" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Сумма исчисленного налога (руб.) (строка 160%1 раздела 2)';
												|en = 'Сумма исчисленного налога (руб.) (строка 160%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр170" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Количество полных месяцев использования льготы (строка 170%1 раздела 2)';
												|en = 'Количество полных месяцев использования льготы (строка 170%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр180" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Коэффициент Кл (строка 180%1 раздела 2)';
												|en = 'Коэффициент Кл (строка 180%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр190" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Код налоговой льготы в виде освобождения от налогообложения (строка 190%1 раздела 2)';
												|en = 'Код налоговой льготы в виде освобождения от налогообложения (строка 190%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр200" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Сумма налоговой льготы (руб.) (строка 200%1 раздела 2)';
												|en = 'Сумма налоговой льготы (руб.) (строка 200%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр210" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Код налоговой льготы в виде уменьшения суммы налога (строка 210%1 раздела 2)';
												|en = 'Код налоговой льготы в виде уменьшения суммы налога (строка 210%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр210а" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Процент, уменьшающий исчисленную сумму налога (строка 210а%1 раздела 2)';
												|en = 'Процент, уменьшающий исчисленную сумму налога (строка 210а%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр220" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Сумма налоговой льготы (руб.) (строка 220%1 раздела 2)';
												|en = 'Сумма налоговой льготы (руб.) (строка 220%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр230" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Код налоговой льготы в виде снижения налоговой ставки (строка 230%1 раздела 2)';
												|en = 'Код налоговой льготы в виде снижения налоговой ставки (строка 230%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр230а" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Пониженная налоговая ставка (строка 230а%1 раздела 2)';
												|en = 'Пониженная налоговая ставка (строка 230а%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр240" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Сумма налоговой льготы (руб.) (строка 240%1 раздела 2)';
												|en = 'Сумма налоговой льготы (руб.) (строка 240%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр250" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (руб.) (строка 250%1 раздела 2)';
												|en = 'Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (руб.) (строка 250%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
