...
Процедура ПоказатьПериод(Форма)
	...
	Иначе
		...
		Если Форма.мДатаКонцаПериодаОтчета >= Дата('20230401') Тогда
			Форма.ОписаниеНормативДок = "Форма утратила силу в соответствии с Приказом Росстата от 03.05.2023 № 204";
		Иначе
