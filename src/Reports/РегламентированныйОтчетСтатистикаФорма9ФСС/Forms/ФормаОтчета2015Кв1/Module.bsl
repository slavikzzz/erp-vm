...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "20/01/2015";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Сумм24_43 = 0;
	Для Стр = 24 По 43 Цикл
		Сумм24_43 = Сумм24_43 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_23.Значение = Сумм24_43;
	
	Области.П01_20.Значение = Области.П01_21.Значение + Области.П01_22.Значение + Области.П01_23.Значение
							+ Области.П01_44.Значение + Области.П01_45.Значение + Области.П01_46.Значение
