...
Процедура ВставитьДополнительнуюСтроку(Форма, ТекущаяСтраница)
	...
	ИмяПервойЯчейкиПоследнейСтроки = ИмяГруппы + "66_" + КолСтрокСтр;
	ГраФаКон = 67;
	ИмяТекущейОбласти = ИмяГруппы + "66_" + КолСтрокСтр1;
	...
	Для Раздел = 1 По 6 Цикл
		...
		ИмяПервойЯчейкиПоследнейСтрокиСинхронизируемой = ИмяГруппыСинхронизируемой + "66_" + КолСтрокСтрСинхронизируемых;
		...
		Для НомерГрафыСинхронизируемой = 1 По ГраФаКон Цикл
			...
			Если СтруктураГруппыСинхронизируемой[0].Свойство(ИмяКолонкиСинхронизируемой) Тогда
				...
				Если НомерГрафыСинхронизируемой = 66 Тогда
	...
	Для Раздел = 1 По 7 Цикл
		...
		Для Стр = 1 По КолСтрок Цикл
			...
			Области["УдалитьСтрокуП0000" + Раздел + "0000466_" + Стр].Гиперссылка = Истина;
			Области["УдалитьСтрокуП0000" + Раздел + "0000466_" + Стр].Текст = "х";
		КонецЦикла;
...
Процедура УдалитьДополнительнуюСтрокуИзГруппы(Форма, СпециальноеДобавление, ИмяКолонкиНомера, ТекущаяСтраница, ИмяГруппы, НомУдаляемойСтроки, НомерСтрокиТаблицы)
	...
	Если ИмяГруппы = "П0000100004" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П000020000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П000030000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой3 = "П000040000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой4 = "П000050000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой5 = "П000060000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой6 = "П000070000466_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0000200004" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П000010000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П000030000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой3 = "П000040000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой4 = "П000050000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой5 = "П000060000466_" + Сред(ИмяЯчейки, 15);
	...
	ИначеЕсли ИмяГруппы = "П0000300004" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П000010000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П000020000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой3 = "П000040000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой4 = "П000050000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой5 = "П000060000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой6 = "П000070000466_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0000400004" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П000010000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П000020000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой3 = "П000030000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой4 = "П000050000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой5 = "П000060000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой6 = "П000070000466_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0000500004" Тогда
		...
		ИмяЯчейкиСинхронизируемой2 = "П000020000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой3 = "П000030000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой4 = "П000040000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой5 = "П000060000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой6 = "П000070000466_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0000600004" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П000010000466_" + Сред(ИмяЯчейки, 15);
		...
		ИмяЯчейкиСинхронизируемой3 = "П000030000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой4 = "П000040000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой5 = "П000050000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой6 = "П000070000466_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0000700004" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П000010000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П000020000466_" + Сред(ИмяЯчейки, 15);
		...
		ИмяЯчейкиСинхронизируемой4 = "П000040000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой5 = "П000050000466_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой6 = "П000060000466_" + Сред(ИмяЯчейки, 15);
	КонецЕсли;
	...
	ИмяПервойЯчейкиУдаляемойСтроки = ИмяГруппы + "66_" + НомУдаляемойСтроки;
	ГраФаКон = 67;
	...
	Для Раздел = 1 По 6 Цикл
		...
		Если СтруктураГруппыСинхронизируемой.Количество() > ИсходноеКоличествоСтрокГруппыСинхронизируемой Тогда
			// Удаляется добавленная строка.
			ИмяПервойЯчейкиУдаляемойСтрокиСинхронизируемой = ИмяГруппыСинхронизируемой + "66_" + НомУдаляемойСтрокиСинхронизируемый;
	...
	Если Форма.П0000100004.Количество() = 1 Тогда
		...
		Для Раздел = 1 По 7 Цикл
			Области["УдалитьСтрокуП0000" + Раздел + "0000466_1"].Гиперссылка = Ложь;
			Области["УдалитьСтрокуП0000" + Раздел + "0000466_1"].Текст = "";
		КонецЦикла;
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Сред(Область.Имя,11,3)="466" Или Сред(Область.Имя,11,3)="467" Тогда
...
Процедура ВвестиПоказатель(Элемент, Область, КодПоказателя, Знач ЭтоСумма, Знач ТекстВыбора, ТаблицаВыбора, СтандартнаяОбработка, КолонкаПоиска = "Код") Экспорт
	...
	Если Сред(Область.Имя, 11, 3) = "466" Тогда
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Результат = ?(РезультатВыбора["Название"] = "Пустое значение" , "",
		?(СтрНачинаетсяС(Область.Имя, "П000010000467"), РезультатКод, РезультатНазвание));
	
	Область.Значение = Результат;
	
	Если Сред(Область.Имя,11,3) = "466" Тогда
		
		ПолеТабличногоДокументаФормаОтчета.Области["П000010000467_" + Сред(Область.Имя,15)].Значение = РезультатКод;
		
		Для Н = 1 По 7 Цикл
			ОбластьДляИЗменения = ПолеТабличногоДокументаФормаОтчета.Области["П0000" + Н +"0000466_" + Сред(Область.Имя,15)];
	...
	ИначеЕсли Сред(Область.Имя,11,3) = "467" Тогда
...
Процедура ОчиститьТабличноеПолеНаСервере()
	...
	Для Раздел = 1 По 7 Цикл
		ВыбТабличноеПоле.Области["УдалитьСтрокуП0000" + Раздел + "0000466_1"].Гиперссылка = Ложь;
		ВыбТабличноеПоле.Области["УдалитьСтрокуП0000" + Раздел + "0000466_1"].Текст = "";
	КонецЦикла;
