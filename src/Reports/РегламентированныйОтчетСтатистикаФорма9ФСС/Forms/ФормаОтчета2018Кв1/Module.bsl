...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "31/01/2018";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Сумм51_58 = 0;
	Для Стр = 51 По 58 Цикл
		Сумм51_58 = Сумм51_58 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_50.Значение = Сумм51_58;
	...
	Области.П01_24.Значение = Области.П01_25.Значение + Области.П01_26.Значение + Области.П01_27.Значение
							+ Области.П01_48.Значение + Области.П01_49.Значение + Области.П01_50.Значение
							+ Области.П01_59.Значение + Области.П01_60.Значение + Области.П01_61.Значение;
