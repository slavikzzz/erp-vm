...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "21/07/2018";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Сумм46_52 = 0;
	Для Стр = 46 По 52 Цикл
		Сумм46_52 = Сумм46_52 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_45.Значение = Сумм46_52;
	
	Сумм24_42 = 0;
	Для Стр = 24 По 42 Цикл
		Сумм24_42 = Сумм24_42 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_23.Значение = Сумм24_42;
	
	Области.П01_20.Значение = Области.П01_21.Значение + Области.П01_22.Значение + Области.П01_23.Значение
							+ Области.П01_43.Значение + Области.П01_44.Значение + Области.П01_45.Значение
							+ Области.П01_53.Значение + Области.П01_54.Значение + Области.П01_55.Значение
							+ Области.П01_56.Значение + Области.П01_57.Значение + Области.П01_58.Значение
							+ Области.П01_59.Значение;
	
	Сумм15_18 = 0;
	Для Стр = 15 По 18 Цикл
		Сумм15_18 = Сумм15_18 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_14.Значение = Сумм15_18;
	...
	Для Стр = 8 По 14 Цикл
		Сумм8_14 = Сумм8_14 + Области["П01_"+Стр].Значение;
	КонецЦикла;
	Области.П01_1.Значение = Сумм3_7 + Сумм8_14 + Области.П01_19.Значение;
	...
	Пока Истина Цикл
		...
		Для Гр = 3 По 4 Цикл
			МассивСумм[Гр] = МассивСумм[Гр] + Области.Найти("П00000200000"+Гр+"_"+Стр).Значение;
		КонецЦикла;
...
Функция ПечатьНаСервере(ВидПечати)
	...
	Пока ТекущийВерх <= НизМногострочнойЧасти Цикл
		...
		Иначе
			СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 9-Ф (СС)");
			ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
			ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть5_00"));
			ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть5_2"));
			ПечатнаяФорма.Вывести(ТекущаяОбластьМногострочнойЧасти);
		КонецЕсли;
