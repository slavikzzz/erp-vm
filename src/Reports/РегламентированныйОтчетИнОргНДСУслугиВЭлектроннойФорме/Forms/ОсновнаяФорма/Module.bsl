...
Процедура ОткрытьФормуОтчета(Команда)
	...
	ИначеЕсли ВРег(мВыбраннаяФорма) = ВРег("ФормаОтчета2019Кв1")
		И НЕ РегламентированнаяОтчетностьВызовСервера.ЭтоЮридическоеЛицо(Организация) Тогда
		
		ПоказатьПредупреждение(,НСтр("ru='Отчет по форме, утвержденной приказом ФНС России от 30.11.2016 № ММВ-7-3/646@"
		+ " (в редакции приказа ФНС России от 05.03.2019 № ММВ-7-3/118@), представляют только юридические лица'"));
