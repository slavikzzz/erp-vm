...
Процедура ИнициализироватьМногострочныеЧасти()
	...
	ИменаГраф.Добавить("П1000034");
	ИменаГраф.Добавить("П1000035");
	ИменаГраф.Добавить("П1000036");
	ИменаГраф.Добавить("П1000037");
	ИменаГраф.Добавить("П1000038");
	...
	ИменаГраф.Добавить("П2000034");
	ИменаГраф.Добавить("П2000035");
	ИменаГраф.Добавить("П2000036");
	ИменаГраф.Добавить("П2000037");
	ИменаГраф.Добавить("П2000038");
	ИменаГраф.Добавить("П2000039");
	ИменаГраф.Добавить("П2000040");
	ИменаПодчиненныхГрупп = Новый Массив;
	СтруктураМногострочныхЧастей.Вставить(
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000002", 3, ,
		"Выбор кода страны регистрации туристов-нерезидентов", КоллекцияСписковВыбора["КодыСтран2"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000003", 2, ,
		"Выбор кода территории - региона пребывания туристов-нерезидентов", КоллекцияСписковВыбора["Регионы"]);
	
	//Раздел 2.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000002", 2, ,
		"Выбор кода региона отправления туристов-резидентов", КоллекцияСписковВыбора["Регионы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000003", 2, ,
		"Выбор кода территории респондента/филиала", КоллекцияСписковВыбора["Регионы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000004", 3, ,
		"Выбор кода страны - направления выезда туристов-резидентов", КоллекцияСписковВыбора["КодыСтран"]);
	
	//Раздел 3.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П3000002", 2, ,
		"Выбор кода региона", КоллекцияСписковВыбора["Регионы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П3000003", 3, ,
		"Выбор кода страны", КоллекцияСписковВыбора["КодыСтран2"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П3000004", 3, ,
		"Выбор кода вида транспорта", КоллекцияСписковВыбора["ВидыТранспорта"]);

	//Раздел 4.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П4000002", 2, ,
		"Выбор кода региона", КоллекцияСписковВыбора["Регионы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П4000003", 3, ,
		"Выбор кода страны", КоллекцияСписковВыбора["КодыСтран2"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П4000004", 3, ,
		"Выбор кода вида транспорта", КоллекцияСписковВыбора["ВидыТранспорта"]);
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если ИмяРаздела = "Раздел1" ИЛИ ИмяРаздела = "Раздел2" ИЛИ ИмяРаздела = "Раздел3" ИЛИ ИмяРаздела = "Раздел4" Тогда
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяСтраницыПанели)
	...
	Если ИмяСтраницыПанели = "Раздел1"
	 ...
	 ИЛИ ИмяСтраницыПанели = "Раздел3" 
	 ИЛИ ИмяСтраницыПанели = "Раздел4" Тогда
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ИмяФайлаШаблона", "1-ПОЕЗДКИ");
...
Функция ИдентификаторФайлаВыгрузки(ПараметрыВыгрузки)
		...
		ИдентификаторФайла = "OKUD0414004"
...
Функция ВыгрузкаОтчета(ТекстВыгрузки, ПараметрыВыгрузки)
	...
	РезультатВыгрузки.Вставить("ТипФайлаВыгрузки", "Форма1ПОЕЗДКИ");
...
Процедура ВывестиНаПечатьОтчет(СтруктураПараметров, ВыбранныеСтраницы, СтрПоля = Неопределено)
	...
	Если ВыбранныеСтраницы.Найти("Раздел2") <> Неопределено Тогда
		...
		Для Каждого Ветка Из ДеревоДанных.Строки Цикл  // часть 3
			...
			Рзд_Раздел2 = Макет.Получитьобласть("Раздел2_Разделитель");
			Шап_Раздел2 = Макет.Получитьобласть("Раздел2_Шапка3");
			Стр_Раздел2 = Макет.Получитьобласть("Раздел2_Строка3");
			
			Рзд_Раздел2.Области["Раздел2_Разделитель"].Имя = "Раздел2_Разделитель3";
			...
			Для Каждого ЭлемСтрукт Из Ветка.ДанныеМногострочныхЧастей Цикл
				...
				Для Каждого ВеткаСтр Из ЭлемСтрукт.Значение.Строки Цикл
					...
					Стр_Раздел2 = Макет.Получитьобласть("Раздел2_Строка3");
					Стр_Раздел2.Области["Раздел2_Строка3"].Имя = "Раздел2_Строка3_" + Формат(ИндСтр + 1, "ЧГ=");
					Стр_Раздел2.Параметры.Заполнить(ВеткаСтр.Данные);
					...
					Если НоваяСтраница ИЛИ ИндСтр = 0 Тогда
						ПечФорма.Вывести(Шап_Раздел2);
						ПечФорма.Области["Раздел2_Шапка3"].Имя = "Раздел2_Шапка3_Стр" + Формат(ИндСтр + 1, "ЧГ=");
						НоваяСтраница = Ложь;
					КонецЕсли;
