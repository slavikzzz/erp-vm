...
Функция ДоступныеОрганизацииОтсутствуютТекст()
	...
	Возврат НСтр(
	"ru = 'Уведомление о дате, времени и месте осуществления (отмены) розничной продажи алкогольной продукции
	|при оказании услуг общественного питания в условиях выездного обслуживания
	|представляют только организации (юридические лица)(ПП РФ от 19.04.2018 № 473).
	|В справочнике ""Организации"" сведения об организациях отсутствуют.';
	|en = 'Уведомление о дате, времени и месте осуществления (отмены) розничной продажи алкогольной продукции
	|при оказании услуг общественного питания в условиях выездного обслуживания
	|представляют только организации (юридические лица)(ПП РФ от 19.04.2018 № 473).
	|В справочнике ""Организации"" сведения об организациях отсутствуют.'");
