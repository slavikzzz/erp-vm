...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НомерАлкоОтчета = 1000;
	РегламентированнаяОтчетностьАЛКО.ПриСозданииНаСервереАЛКО(ЭтаФорма, НомерАлкоОтчета);
...
&НаКлиенте
Процедура ДатаНачалаУведомленияПриИзменении(Элемент)
	
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "ДатаНачалаУведомления", "ДатаНачалаУведомления");
	
КонецПроцедуры

&НаКлиенте
Процедура ДатаКонцаУведомленияПриИзменении(Элемент)
	
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "ДатаКонцаУведомления", "ДатаКонцаУведомления");
	
КонецПроцедуры

&НаКлиенте
Процедура ВремяНачалаУведомленияПриИзменении(Элемент)
	
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "ВремяНачалаУведомления", "ВремяНачалаУведомления");
	
КонецПроцедуры

&НаКлиенте
Процедура ВремяКонцаУведомленияПриИзменении(Элемент)
	
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "ВремяКонцаУведомления", "ВремяКонцаУведомления");
	
КонецПроцедуры

&НаКлиенте
Процедура НомерКонтактногоТелефонаПриИзменении(Элемент)
	
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "НомерКонтактногоТелефона", "НомерКонтактногоТелефона");
	
КонецПроцедуры

&НаКлиенте
Процедура ДобНомерПриИзменении(Элемент)
	
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "ДобНомер", "ДобНомер");
	
КонецПроцедуры

&НаКлиенте
Процедура ПереключательПредставителяПриИзменении(Элемент)
	
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "ПереключательПредставителя", "ПереключательПредставителя");
	Если ПереключательПредставителя = 1 Тогда
	
		// Руководитель - заполним автоматически ФИО.
		Представитель = ОрганизацияРуководитель;
		
		РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "Представитель", "Представитель");
...
Процедура НаименованиеДокументаПриИзменении(Элемент)
	...
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "НаименованиеДокумента", "НаименованиеДокумента");
	
КонецПроцедуры

&НаКлиенте
Процедура НомерКорректировкиУведомленияПриИзменении(Элемент)
	
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "НомерКорректировкиУведомления", "НомерКорректировкиУведомления");
...
Процедура ЭтоОтменаПриИзменении(Элемент)
	...
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "ЭтоОтмена", "ЭтоОтмена");
									
	Если ЭтоОтмена Тогда
	
		НомерКорректировкиУведомления = 0;
		РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "НомерКорректировкиУведомления", "НомерКорректировкиУведомления");
			
	КонецЕсли;
								
	Элементы.НомерКорректировкиУведомления.Доступность = НЕ ЭтоОтмена;
...
Процедура НаименованиеПолноеПриИзменении(Элемент)
	...
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "ОргНазв", "ОрганизацияНаименованиеПолное");
...
Процедура НаименованиеСокращенноеПриИзменении(Элемент)
	...
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "ОргНазвСокращ", "ОрганизацияНаименованиеСокращенное");
...
Процедура НомерЛицензииПриИзменении(Элемент)
	...
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "НомерЛицензии", "НомерЛицензии");
	
КонецПроцедуры

&НаКлиенте
Процедура КПП_ОППриИзменении(Элемент)
	
	РегламентированнаяОтчетностьАЛКОКлиент.ЭлементТитульногоПриИзмененииАЛКО(
									ЭтаФорма, Элемент, "КПП_ОП", "КПП_ОП");
...
Процедура СформироватьСпискиВыбораНаСервере() Экспорт
	...
	// Процедура "заглушка" для обеспечения общего механизма работы алкоотчетности.
	Возврат;
...
Процедура УстановитьПараметрыДекларации() Экспорт
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "19/04/2018";
	...
	Если Параметры.Свойство("КлючУникальности") Тогда
	    // Чтобы можно было найти при создании из алкоотчетов и не создавать для одного несколько Заявлений.
		СтруктураРеквизитовФормы.КлючУникальности = Параметры.КлючУникальности;
