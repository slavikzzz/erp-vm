...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ИмяФормы).ПолучитьМакет("СпискиВыбора2017Кв3");
...
Процедура ВосстановитьСохраненныеДанныеОтчетаСтарогоОбразца(СписокСохранения)
	...
	ДеревоРаздела.Строки[0].Данные = ОбщегоНазначения.СкопироватьРекурсивно(СтарДанные);
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если НЕ СтруктураРеквизитовФормы.ФлажокОтклАвтоРасчет Тогда
		...
		Если СообщитьОбОчисткеСтроки180Раздела24 Тогда
			...
			|en = 'При отрицательном значении в строке 050 Раздела 2 значение в строке 180 Раздела 2.4 должно быть равно нулю. Значение в строке 180 Раздела 2.4 очищено.'");
			Сообщение.Сообщить();
...
#Область Проверки
	...
	ПроверкаКС_19_1_01_к();
	ПроверкаКС_19_1_02_к();
	ПроверкаКС_19_1_03_к();
	ПроверкаКС_19_1_04_к();
	ПроверкаКС_19_1_05_к();
	ПроверкаКС_19_1_06_к();
	ПроверкаКС_19_1_07_к();
	ПроверкаКС_19_1_08_к();
	ПроверкаКС_19_1_09_к();
	ПроверкаКС_19_1_10_к();
	ПроверкаКС_19_2_к();
	ПроверкаКС_19_3_к();
	ПроверкаКС_19_4_к();
	ПроверкаКС_19_5_к();
...
Функция ВыполнитьДокументированиеНаСервере()
	...
	СтруктураРезультата.Вставить("НаименованиеОтчета"	, "Прибыль СРП");
	СтруктураРезультата.Вставить("НаименованиеФормы"	, "2017Кв3");
...
Процедура СформироватьСлужебныеДанные()
	...
	ИменаРазделов.Вставить("Р23", "Раздел23");
	ИменаРазделов.Вставить("Р24", "Раздел24");
...
Процедура СформироватьДанныеОтчета()
	...
	ДанныеКС.Вставить("Раздел22", ДанныеКС.Раздел22[0]);
	ДанныеКС.Вставить("Раздел23", ДанныеКС.Раздел23[0]);
	ДанныеКС.Вставить("Раздел24", ДанныеКС.Раздел24[0]);
...
Процедура СформироватьПриоритетыРазделов()
	...
	ПриоритетыРазделов.Добавить("Раздел 2.3");
	ПриоритетыРазделов.Добавить("Раздел 2.4");
...
&НаСервере
Процедура ПроверкаКС_19_1_01_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '19.1.01.к';
													|en = '19.1.01.к'"));
	...
	ПроверкаКС_19_1_01_к_код();

КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_19_1_01_к_код()
...
&НаСервере
Процедура ПроверкаКС_19_1_02_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '19.1.02.к';
													|en = '19.1.02.к'"));
...
&НаСервере
Процедура ПроверкаКС_19_1_03_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '19.1.03.к';
													|en = '19.1.03.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.060 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.060 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.060 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.060 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'")); 
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("ИмяПоказателя"	, "П000010006003");
	ПроверкаКС_19_1_01_к_код();

КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_19_1_04_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '19.1.04.к';
													|en = '19.1.04.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.070 Раздела 1 >= 0';
													|en = 'Сумма налога в стр.070 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.070 Раздела 1 >= 0';
													|en = 'Укажите сумму налога в стр.070 Раздела 1 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'")); 
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("ИмяПоказателя"	, "П000010007003");
	ПроверкаКС_19_1_01_к_код();

КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_19_1_05_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '19.1.05.к';
													|en = '19.1.05.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.100 Раздела 2 >= 0';
													|en = 'Сумма налога в стр.100 Раздела 2 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.100 Раздела 2 >= 0';
													|en = 'Укажите сумму налога в стр.100 Раздела 2 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'")); 
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("ИмяПоказателя"	, "П000020010003");
	ПроверкаКС_19_1_05_к_код();

КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_19_1_05_к_код()
...
&НаСервере
Процедура ПроверкаКС_19_1_06_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '19.1.06.к';
													|en = '19.1.06.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма налога в стр.110 Раздела 2 >= 0';
													|en = 'Сумма налога в стр.110 Раздела 2 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.110 Раздела 2 >= 0';
													|en = 'Укажите сумму налога в стр.110 Раздела 2 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'")); 
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("ИмяПоказателя"	, "П000020011003");
	ПроверкаКС_19_1_05_к_код();

КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_19_1_07_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '19.1.07.к';
													|en = '19.1.07.к'"));
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму налога в стр.120 Раздела 2 >= 0';
													|en = 'Укажите сумму налога в стр.120 Раздела 2 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'")); 
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("ИмяПоказателя"	, "П000020012003");
	ПроверкаКС_19_1_05_к_код();

КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_19_1_08_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '19.1.08.к';
													|en = '19.1.08.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма авансовых платежей в стр.130 Раздела 2 >= 0';
													|en = 'Сумма авансовых платежей в стр.130 Раздела 2 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму авансовых платежей в стр.130 Раздела 2 >= 0';
													|en = 'Укажите сумму авансовых платежей в стр.130 Раздела 2 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'")); 
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("ИмяПоказателя"	, "П000020013003");
	ПроверкаКС_19_1_05_к_код();

КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_19_1_09_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '19.1.09.к';
													|en = '19.1.09.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма авансовых платежей в стр.140 Раздела 2 >= 0';
													|en = 'Сумма авансовых платежей в стр.140 Раздела 2 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма авансовых платежей';
													|en = 'Возможно ошибочная сумма авансовых платежей'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму авансовых платежей в стр.140 Раздела 2 >= 0';
													|en = 'Укажите сумму авансовых платежей в стр.140 Раздела 2 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'")); 
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("ИмяПоказателя"	, "П000020014003");
	ПроверкаКС_19_1_05_к_код();

КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_19_1_10_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 2';
														|en = 'Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '19.1.10.к';
													|en = '19.1.10.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru = 'Сумма авансовых платежей в стр.150 Раздела 2 >= 0';
													|en = 'Сумма авансовых платежей в стр.150 Раздела 2 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 >= 0';
													|en = '%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма авансовых платежей';
													|en = 'Возможно ошибочная сумма авансовых платежей'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Укажите сумму авансовых платежей в стр.150 Раздела 2 >= 0';
													|en = 'Укажите сумму авансовых платежей в стр.150 Раздела 2 >= 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'")); 
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	НастройкиКС.Вставить("ИмяПоказателя"	, "П000020015003");
	ПроверкаКС_19_1_05_к_код();

КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_19_2_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '19.2.к';
													|en = '19.2.к'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.030 Раздела 1 = стр.(110 - 140) Раздела 2, если стр.(110 > 140) Раздела 2';
			|en = 'Сумма налога в стр.030 Раздела 1 = стр.(110 - 140) Раздела 2, если стр.(110 > 140) Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 - %4), если %3 > %4';
													|en = '%1 = %2 (%3 - %4), если %3 > %4'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р01С001"		, "П000010003003");
	ИменаПоказателей.Вставить("Р02С002"		, "П000020011003");
	ИменаПоказателей.Вставить("Р02С003"		, "П000020014003");
	НастройкиКС.Вставить("ИменаПоказателей"	, ИменаПоказателей);
	
	ПроверкаКС_19_2_к_код();

КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_19_2_к_код()

	Показатели = СформироватьПоказатели(НастройкиКС.ИменаПоказателей);
		
	ЗарегистрироватьПроверку();
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р01С001, ДанныеКС.Раздел1);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р02С002, ДанныеКС.Раздел2);
	ЗаполнитьИРасшифроватьПоказатель(Показатели.Р02С003, ДанныеКС.Раздел2);

	УсловиеВыполнено = Показатели.Р02С002.Значение > Показатели.Р02С003.Значение;
	РасчетнаяСумма = Окр(Окр(Показатели.Р02С002.Значение, 4) - Окр(Показатели.Р02С003.Значение, 4));
	НастройкиКС.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р01С001.Значение = РасчетнаяСумма;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
...
&НаСервере
Процедура ПроверкаКС_19_3_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '19.3.к';
													|en = '19.3.к'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.060 Раздела 1 = стр.(120 - 150) Раздела 2, если стр.(120 > 150) Раздела 2';
			|en = 'Сумма налога в стр.060 Раздела 1 = стр.(120 - 150) Раздела 2, если стр.(120 > 150) Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 - %4), если %3 > %4';
													|en = '%1 = %2 (%3 - %4), если %3 > %4'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в стр.060 Раздела 1';
													|en = 'Уточните сумму налога в стр.060 Раздела 1'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'")); 
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р01С001"		, "П000010006003");
	ИменаПоказателей.Вставить("Р02С002"		, "П000020012003");
	ИменаПоказателей.Вставить("Р02С003"		, "П000020015003");
	НастройкиКС.Вставить("ИменаПоказателей"	, ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_19_4_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '19.4.к';
													|en = '19.4.к'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.040 Раздела 1 = стр.(140 - 110) Раздела 2, если стр.(140 > 110) Раздела 2';
			|en = 'Сумма налога в стр.040 Раздела 1 = стр.(140 - 110) Раздела 2, если стр.(140 > 110) Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 - %4), если %3 > %4';
													|en = '%1 = %2 (%3 - %4), если %3 > %4'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р01С001"		, "П000010004003");
	ИменаПоказателей.Вставить("Р02С002"		, "П000020014003");
	ИменаПоказателей.Вставить("Р02С003"		, "П000020011003");
	НастройкиКС.Вставить("ИменаПоказателей"	, ИменаПоказателей);
...
&НаСервере
Процедура ПроверкаКС_19_5_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru = 'Раздел 1';
														|en = 'Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru = '19.5.к';
													|en = '19.5.к'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru = 'Сумма налога в стр.070 Раздела 1 = стр.(150 - 120) Раздела 2, если стр.(150 > 120) Раздела 2';
			|en = 'Сумма налога в стр.070 Раздела 1 = стр.(150 - 120) Раздела 2, если стр.(150 > 120) Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru = '%1 = %2 (%3 - %4), если %3 > %4';
													|en = '%1 = %2 (%3 - %4), если %3 > %4'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'Возможно ошибочная сумма налога';
													|en = 'Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru = 'Уточните сумму налога в стр.070 Раздела 1';
													|en = 'Уточните сумму налога в стр.070 Раздела 1'"));
	Заголовки.Вставить("Основание"			, НСтр("ru = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@';
													|en = 'Приказ ФНС России от 29.02.2024 № ЕД-7-3/164@'")); 
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Критическая проверка';
													|en = 'Критическая проверка'"));
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р01С001"		, "П000010007003");
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если Область.Имя = "КодФормыРеорганизации"
		...
		Если ЗначениеЗаполнено(ПрежнийКод) И НЕ ЗначениеЗаполнено(НовыйКод) Тогда
			...
			|en = 'В случае удаления значения кода формы реорганизации (ликвидации) Раздел 2.4
			|будет очищен и исключен из состава дерева разделов. Продолжить?'");
