...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мВерсияФормы = "05/12/2023";
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000003", , ,
		"Выбор кода финансового инструмента", КоллекцияСписковВыбора["КодыФИ"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000005", 3, ,
		"Выбор кода страны эмитента", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000006", , ,
		"Выбор кода сектора эмитента", КоллекцияСписковВыбора["Секторы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000008", 3, ,
		"Выбор кода валюты ценной бумаги", КоллекцияСписковВыбора["КодыВалют"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000011", , ,
		"Выбор кода метода оценки", КоллекцияСписковВыбора["МетодыОценки"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000012", , ,
		"Выбор кода места хранения", КоллекцияСписковВыбора["МестаХранения"]);
	
	//Раздел 2.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000005", , ,
		"Выбор кода финансового инструмента", КоллекцияСписковВыбора["КодыФИ"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000007", 3, ,
		"Выбор кода страны эмитента", КоллекцияСписковВыбора["КодыСтран"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000008", , ,
		"Выбор кода сектора эмитента", КоллекцияСписковВыбора["Секторы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000010", 3, ,
		"Выбор кода валюты ценной бумаги", КоллекцияСписковВыбора["КодыВалют"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000013", , ,
		"Выбор кода метода оценки", КоллекцияСписковВыбора["МетодыОценки"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000014", , ,
		"Выбор кода места хранения", КоллекцияСписковВыбора["МестаХранения"]);
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяСтраницыПанели)
	...
	Если ИмяСтраницыПанели = "Раздел1"
	 ИЛИ ИмяСтраницыПанели = "Раздел2" Тогда
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ИмяФайлаШаблона", "1-ИЦБ");
...
Функция ВыгрузкаОтчета(ТекстВыгрузки, ПараметрыВыгрузки)
	...
	РезультатВыгрузки.Вставить("ТипФайлаВыгрузки", "Форма1ИЦБ");
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ВПрограммеИзмененаДатаПодписи = Ложь)
	...
	Если НЕ ВПрограммеИзмененаДатаПодписи Тогда
		...
		СтрокаСведений
		= "ИННЮЛ, ОГРН, ОКПО, ОКТМО, ОКВЭД2, ОКОПФ, ОКФС, НаимЮЛПол, НаимЮЛСокр, ТелОрганизации, ФаксОрганизации, "
		+ "АдресЭлектроннойПочтыОрганизации, ФИО, ФИОРук, ДолжнРук, ТелРук, ФИОИсп, ДолжнИсп, ТелИсп, АдрЮР, "
