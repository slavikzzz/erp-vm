...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П1000013", , ,
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000014", , ,
		"Выбор кода метода оценки", КоллекцияСписковВыбора["МетодыОценки"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П2000015", , ,
		"Выбор кода места хранения", КоллекцияСписковВыбора["МестаХранения"]);
...
Процедура СформироватьПараметрыШаблона()
	...
	МакетМетаданныхШаблона = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("МетаданныеШаблона2021Кв1"
		+ ?(ЭтоРежимТестирования(), "_Тест", ""));
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Если Область.Имя = "Uaddress" ИЛИ Область.Имя = "Paddress" Тогда
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ИмяМакетаШаблона", "ШаблонБанка2021Кв1" + ?(ЭтоРежимТестирования(), "_Тест", ""));
	
	ПараметрыВыгрузки.Вставить("ИмяСхемыВыгрузки", "СхемаВыгрузкиXML2021Кв1");
	
	ПараметрыВыгрузки.Вставить("ИмяМакетаСписковВыбора", "СпискиВыбора2021Кв1");
	
	ПараметрыВыгрузки.Вставить("ИмяМакетаМетаданныхШаблона", "МетаданныеШаблона2021Кв1" + ?(ЭтоРежимТестирования(), "_Тест", ""));
...
Функция ИдентификаторФайлаВыгрузки(ПараметрыВыгрузки)
		...
		ИдентификаторФайла = ?(ЭтоРежимТестирования(), "ТЕСТ_", "")
		+ "OKUD0414002"
...
Процедура ВывестиНаПечатьОтчет(СтруктураПараметров, ВыбранныеСтраницы, СтрПоля = Неопределено)
	...
	ИмяМакета = "ПечатныйБланк2021Кв1";
