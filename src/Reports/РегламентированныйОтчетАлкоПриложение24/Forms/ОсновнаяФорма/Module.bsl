...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.Новости") Тогда
		...
		МодульОбработкаНовостей.КонтекстныеНовости_ПриСозданииНаСервере(
			ЭтаФорма,
			"БП.Отчет.РО_АлкоПриложение24",
			"ОсновнаяФорма",
			,
			НСтр("ru = 'Новости: Декларация об использовании производственных мощностей';
				|en = 'Новости: Декларация об использовании производственных мощностей'"),
			Ложь,
...
Функция ДоступныеОрганизацииОтсутствуютТекст()
	...
	Возврат НСтр(
	"ru = 'Декларацию об использовании производственных мощностей
	|представляют только организации (юридические лица)(ПП РФ от 29.12.2018 г. № 1719).
	|В справочнике ""Организации"" сведения об организациях отсутствуют.';
	|en = 'Декларацию об использовании производственных мощностей
	|представляют только организации (юридические лица)(ПП РФ от 29.12.2018 г. № 1719).
	|В справочнике ""Организации"" сведения об организациях отсутствуют.'");
