...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ РегламентированнаяОтчетностьАЛКО.ЕстьРеквизитВерхнегоУровняФормы(ЭтаФорма, "ЛицензияМожетБытьПустой") Тогда
	
		НовыйРеквизитФормы = Новый РеквизитФормы("ЛицензияМожетБытьПустой", Новый ОписаниеТипов("Булево"), , 
											"Лицензия может быть пустой", Ложь);
	...
	ЭтаФорма.ЛицензияМожетБытьПустой = Истина;
...
Процедура УстановитьПараметрыДекларации() Экспорт
    ...
    ЛицензияМожетБытьПустой = Истина;
