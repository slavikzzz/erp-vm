...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "11/02/2014";
	...
	СтруктураРеквизитовФормы.мИдГруппы1 = "П0000000130";
	СтруктураРеквизитовФормы.мИдГруппы2 = "П0000000245";
	СтруктураРеквизитовФормы.мИдГруппы3 = "П0000000335";
	СтруктураРеквизитовФормы.мИдГруппы4 = "П0000000430";
	КолИсхСтрокИдГруппы = 4;
	КолКолонокИдГруппы = 9;
	...
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы2, КолИсхСтрокИдГруппы);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы3, КолИсхСтрокИдГруппы);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы4, КолИсхСтрокИдГруппы);
	
	мСтруктураКолвоКолонокРазделов = Новый Структура;
	мСтруктураКолвоКолонокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы1, КолКолонокИдГруппы);
	мСтруктураКолвоКолонокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы2, КолКолонокИдГруппы);
	мСтруктураКолвоКолонокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы3, КолКолонокИдГруппы);
	мСтруктураКолвоКолонокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы4, КолКолонокИдГруппы);
...
Процедура ОчиститьТабличноеПоле(Форма)
	...
	Для Инд = 1 По 4 Цикл
		...
		Если ВыбТабличноеПоле.Области.Найти(ИмяГруппы+"01_5") <> Неопределено Тогда 
			Верх = ВыбТабличноеПоле.Области.Найти(ИмяГруппы+"01_5").Верх;
			Низ = Верх;
			Стр = 6;
			Пока Истина Цикл
...
Функция ПечатьНаСервере(ВидПечати)
	...
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-ДМ");
	...
	Область = ТабДок.ПолучитьОбласть("ОсновнаяЧасть2_4");
	Если ПечатнаяФорма.ПроверитьВывод(Область) Тогда
	...
	ВерхМногострочнойЧасти = Области.ОсновнаяЧасть2_4.Низ + 1;
	...
	Область = ТабДок.ПолучитьОбласть("ОсновнаяЧасть3_2");
	Если ПечатнаяФорма.ПроверитьВывод(Область) Тогда
		ПечатнаяФорма.Вывести(Область);
	Иначе
		СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-ДМ");
	...
	Область = ТабДок.ПолучитьОбласть("ОсновнаяЧасть3_3");
	Если ПечатнаяФорма.ПроверитьВывод(Область) Тогда
		ПечатнаяФорма.Вывести(Область);
	Иначе
		СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-ДМ");
	...
	Область = ТабДок.ПолучитьОбласть("ОсновнаяЧасть4_2");
	Если ПечатнаяФорма.ПроверитьВывод(Область) Тогда
		ПечатнаяФорма.Вывести(Область);
	Иначе
		СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-ДМ");
	...
	ОбластьПодписи = ТабДок.ПолучитьОбласть("ОсновнаяЧасть4_3");
	...
	Пока ТекущийВерх <= НизМногострочнойЧасти Цикл
		...
		МассивПроверки.Добавить(ОбластьПодписи);
	...
	ПечатнаяФорма.Вывести(ОбластьПодписи);
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4-ДМ");
...
Процедура СообщитьОНевозможностиВыгрузки()
	РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Выгрузка в электронном виде для формы 4-ДМ не предусмотрена.", "", "");
КонецПроцедуры
