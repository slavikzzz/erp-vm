...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли РегламентированнаяОтчетностьКлиент.ВыбраннаяОбластьРегламентированногоОтчетаНеВерна(ЭтаФорма, Область, СтандартнаяОбработка) Тогда
		Возврат;
	Иначе
		Если Лев(Область.Имя, 9) = "П00001010"
		   И (Прав(Область.Имя, 2) = "01" Или Прав(Область.Имя, 2) = "02" Или Прав(Область.Имя, 2) = "12" Или Прав(Область.Имя, 2) = "13") Тогда
...
Функция ПечатьНаСервере(ВидПечати)
	...
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 1-Т");
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	ВыборКодЗначение = ?(ВыборКод <> "", ВыборНазв, "");
	
	Если Прав(Область.Имя, 2) = "01" Или Прав(Область.Имя, 2) = "02" Тогда
		ПолеТабличногоДокументаФормаОтчета.Области[Лев(Область.Имя, 11) + "01"].Значение = ВыборКодЗначение;
		ПолеТабличногоДокументаФормаОтчета.Области[Лев(Область.Имя, 11) + "02"].Значение = ВыборКод;
		
		ПолеТабличногоДокументаФормаОтчета.Области[Лев(Область.Имя, 11) + "12"].Значение = ВыборКодЗначение;
		ПолеТабличногоДокументаФормаОтчета.Области[Лев(Область.Имя, 11) + "13"].Значение = ВыборКод;
	ИначеЕсли Прав(Область.Имя, 2) = "12" Или Прав(Область.Имя, 2) = "13" Тогда
		ПолеТабличногоДокументаФормаОтчета.Области[Лев(Область.Имя, 11) + "12"].Значение = ВыборКодЗначение;
		ПолеТабличногоДокументаФормаОтчета.Области[Лев(Область.Имя, 11) + "13"].Значение = ВыборКод;
