...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "30/11/2013";
...
Процедура ПронумероватьСтрокиДляВыгрузки()
	ОбновитьСтруктуруМногострочногоРаздела(ЭтаФорма, "П0000020001");
	ОбновитьСтруктуруМногострочногоРаздела(ЭтаФорма, "П0000040001");
...
Процедура ЗаполнитьЗагрязняющиеВещества()
	ЗагрязняющиеВещества = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "ЗагрязняющиеВещества").ТаблицаЗначений;
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли (Не (Область.Защита = Истина)) И СтрНайти(Область.Имя, "_") = 14 Тогда 
		...
		Если СтрНайти(Область.Имя, "П000002000102_") = 1 Или СтрНайти(Область.Имя, "П000002000103_") = 1 Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "ЗагрязняющиеВещества");
		...
		ИначеЕсли СтрНайти(Область.Имя, "П000004000103_") = 1 Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "ТипМероприятия");
			ОбластьДляВвода = ПолеТабличногоДокументаФормаОтчета.Области["П000004000193_" + НомерСтроки];
			ИмяСмежнойОбласти = ПолеТабличногоДокументаФормаОтчета.Области["П000004000103_" + НомерСтроки].Имя;
		ИначеЕсли СтрНайти(Область.Имя, "П000004000104_") = 1 Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "ПризнакМероприятия");
		...
		ВвестиПоказатель(Элемент, ОбластьДляВвода, КодПоказателя, Ложь, ПараметрВводаПоля.ТекстПриВыборе, ТЗВыбора, СтандартнаяОбработка, ИмяСмежнойОбласти);
	КонецЕсли;
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Для Гр = 3 По 8 Цикл 
		мФормаОтчета.Области["П00010030" + Гр].Значение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, мФормаОтчета.Области["П00010040" + Гр].Значение)
												+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, мФормаОтчета.Области["П00010050" + Гр].Значение)
												+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, мФормаОтчета.Области["П00010060" + Гр].Значение)
												+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, мФормаОтчета.Области["П00010070" + Гр].Значение)
												+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, мФормаОтчета.Области["П00010080" + Гр].Значение)
												+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, мФормаОтчета.Области["П00010090" + Гр].Значение);
		мФормаОтчета.Области["П00010010" + Гр].Значение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, мФормаОтчета.Области["П00010020" + Гр].Значение)
												+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, мФормаОтчета.Области["П00010030" + Гр].Значение);
	КонецЦикла;
	
	Для Стр = 1 По 9 Цикл
		мФормаОтчета.Области["П000100"+Стр+"08"].Значение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, мФормаОтчета.Области["П000100"+Стр+"03"].Значение)
														+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, мФормаОтчета.Области["П000100"+Стр+"05"].Значение)
														- РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, мФормаОтчета.Области["П000100"+Стр+"06"].Значение);
	КонецЦикла;
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ЗагрязняющиеВещества", 512, , "Выбор кода загрязняющего вещества", ЗагрязняющиеВещества);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ТипМероприятия", 512, , "Выбор типа мероприятия", ТипМероприятия);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ПризнакМероприятия", 512, , "Выбор признака", ПризнакМероприятия);
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если ТипЗнч(Область.Значение) = Тип("Число") Тогда 
		Попытка
			Область.Значение = Число(РезультатВыбора["Код"]);
		Исключение
			Область.Значение = 0;
		КонецПопытки;
	КонецЕсли;
...
Процедура ВыгрузитьИзФормыПослеСохраненияЗавершение(Результат, ДополнительныеПараметры) Экспорт
	ОбщегоНазначенияКлиент.СообщитьПользователю("Выгрузка отчета данной редакции не предусмотрена");
	Возврат;
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	Нарушение = "Приказ Росстата от 09.08.2012 № 441";
	
	Для Стр = 1 По 9 Цикл 
		ТекстФормулы = "по строке 10" + Стр + " раздела I гр.7 = гр.2 + гр.4 - гр.5";
		Описание     = "по строке 10" + Стр + " раздела I гр.7 <> гр.2 + гр.4 - гр.5";
		ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100" + Стр + "08"]);
		ПраваяЧасть1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100" + Стр + "03"]);
		ПраваяЧасть2 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100" + Стр + "06"]);
		ПраваяЧасть3 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100" + Стр + "07"]);
		Расшифровка = Строка(ЛеваяЧасть) + " = " + Строка(ПраваяЧасть1) + " + " + Строка(ПраваяЧасть2) + " - " + Строка(ПраваяЧасть3);
		
		Если ЛеваяЧасть = ПраваяЧасть1 + ПраваяЧасть2 - ПраваяЧасть3 Тогда
			ЭтоОшибка = Ложь;
		...
		ТекстФормулы = "по строке 10" + Стр + " раздела I гр.2 >= гр.3";
		Описание     = "по строке 10" + Стр + " раздела I гр.2 < гр.3";
		ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100" + Стр + "03"]);
		ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100" + Стр + "04"]);
		...
		ТекстФормулы = "по строке 10" + Стр + " раздела I гр.4 >= гр.5";
		Описание     = "по строке 10" + Стр + " раздела I гр.4 < гр.5";
		ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100" + Стр + "05"]);
		ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100" + Стр + "06"]);
		Расшифровка = Строка(ЛеваяЧасть) + " >= " + Строка(ПраваяЧасть);
		...
		ТекстФормулы = "по строке 10" + Стр + " раздела I гр.5 >= гр.6";
		Описание     = "по строке 10" + Стр + " раздела I гр.5 < гр.6";
		ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100" + Стр + "06"]);
		ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100" + Стр + "07"]);
		Расшифровка = Строка(ЛеваяЧасть) + " >= " + Строка(ПраваяЧасть);
		...
		ТекстФормулы = "по строке 10" + Стр + " раздела I гр.7 >= гр.2";
		Описание     = "по строке 10" + Стр + " раздела I гр.7 < гр.2";
		ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100" + Стр + "08"]);
		ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100" + Стр + "03"]);
		Расшифровка = Строка(ЛеваяЧасть) + " >= " + Строка(ПраваяЧасть);
	...
	Зн101_4 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100105"]);
	Зн101_5 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100106"]);
	Зн101_6 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100107"]);
	
	Если Зн101_4 = Зн101_5 И Зн101_5 = Зн101_6 Тогда
		Для Стр = 2 По 9 Цикл 
			ТекстФормулы = "если по строке 101 гр.4=гр.5=гр.6, тогда по строке 10" + Стр + " гр.4=гр.5=гр.6";
			Описание     = "по строке 101 гр.4=гр.5=гр.6, тогда по строке 10" + Стр + " гр.4<>гр.5 или гр.5<>гр.6";
			Зн101_4 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100"+Стр+"05"]);
			Зн101_5 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100"+Стр+"06"]);
			Зн101_6 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100"+Стр+"07"]);
			Расшифровка = Строка(Зн101_4) + "," + Строка(Зн101_5) + "," + Строка(Зн101_6);
	...
	Если СтруктураРеквизитовФормы.ЭтоЮрЛицо Тогда
		// Раздел 1.
		ТекстФормулы = "стр. 101 гр.7 = стр.301 гр.4";
		Описание     = "стр. 101 гр.7 <> стр.301 гр.4";
		ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100108"]);
		ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000300106"]);
		Расшифровка = Строка(ЛеваяЧасть) + " >= " + Строка(ПраваяЧасть);
		...
		ТекстФормулы = "стр.101 гр.7 = (стр.104+105+106) гр.7 + сумма стр.2** гр.2";
		Описание     = "стр.101 гр.7 <> (стр.104+105+106) гр.7 + сумма стр.2** гр.2";
		ЛеваяЧасть   = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100108"]);
		ПраваяЧасть1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100408"]);
		ПраваяЧасть2 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100508"]);
		ПраваяЧасть3 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100608"]);
		ПраваяЧасть4 = 0;
		Для Каждого Стр из П0000020001 Цикл 
			ПраваяЧасть4 = ПраваяЧасть4 + РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Стр.П000002000104);
		КонецЦикла;
		Расшифровка = Строка(ЛеваяЧасть) + " <> " + Строка(ПраваяЧасть1) + " + " + Строка(ПраваяЧасть2) + " + " + Строка(ПраваяЧасть3) + " + " + Строка(ПраваяЧасть4);
		
		Если ЛеваяЧасть = ПраваяЧасть1 + ПраваяЧасть2 + ПраваяЧасть3 + ПраваяЧасть4 Тогда
			ЭтоОшибка = Ложь;
			ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
		Иначе
			ЭтоОшибка = Истина;
		...
		// Раздел 2.
		Для Каждого Стр из П0000020001 Цикл 
			ТекстФормулы = "в разделе 2 Если гр.2 <> 0, то гр.1 <> 0";
			Описание     = "в разделе 2 Если гр.2 <> 0, и гр.1 = 0";
			ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Стр.П000002000102);
			ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Стр.П000002000104);
			Расшифровка = Строка(ЛеваяЧасть) + " = 0 и " + Строка(ПраваяЧасть) + " <> 0";
			
			Если ПраваяЧасть = 0 Или  ЛеваяЧасть <> 0 Тогда
				ЭтоОшибка = Ложь;
				ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
			Иначе
				ЭтоОшибка = Истина;
		...
		ЛеваяЧасть = 0;
		ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100808"]);
		СтрДляПроверки = "0402,0403,0404,0408,0409,0502,0524,0602,0616,0620,0621,0627,0708,0801,0803,0808,0856,0906,1051,1052,1054,1069,1071,1105,1210,1240,1301,1325,1401,1405,1508,1512,1530,1551,1555,1715,1730,1819,1868,1905,2001,2031,2034,2117,2119,2418,2425,2704,2735,2738,2748,2756";
		МассивКодов = Новый Массив;
		Пока ЗначениеЗаполнено(СтрДляПроверки) Цикл
			МассивКодов.Добавить(Лев(СтрДляПроверки,4));
			СтрДляПроверки = Сред(СтрДляПроверки,6);
		КонецЦикла;
		
		Для Каждого Стр из П0000020001 Цикл 
			Если МассивКодов.Найти(Формат(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Стр.П000002000102), "ЧЦ=4; ЧВН=; ЧГ=; ЧН=0000")) <> Неопределено Тогда 
				ЛеваяЧасть = ЛеваяЧасть + РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Стр.П000002000104);
			КонецЕсли;
		КонецЦикла;
		
		ТекстФормулы = "сумма гр.2 раздела 2 по кодам 0402,0403,0404,0408,0409,
						|0502,0524,0602,0616,0620,0621,0627,0708,0801,0803,0808,
						|0856,0906,1051,1052,1054,1069,1071,1105,1210,1240,1301,
						|1325,1401,1405,1508,1512,1530,1551,1555,1715,1730,1819,
						|1868,1905,2001,2031,2034,2117,2119,2418,2425,2704,2735,
						|2738,2748,2756 <= стр.108 гр.7";
		Описание     = "сумма гр.2 раздела 2 по кодам 0402,0403,0404,0408,0409,
						|0502,0524,0602,0616,0620,0621,0627,0708,0801,0803,0808,
						|0856,0906,1051,1052,1054,1069,1071,1105,1210,1240,1301,
						|1325,1401,1405,1508,1512,1530,1551,1555,1715,1730,1819,
						|1868,1905,2001,2031,2034,2117,2119,2418,2425,2704,2735,
		...
		// Раздел 3.
		Для Стр = 1 По 3 Цикл 
			ТекстФормулы = "гр.1 >= гр.2 по стр. 30" + Стр;
			Описание     = "гр.1 < гр.2 по стр. 30" + Стр;
			ЛеваяЧасть  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000300" + Стр + "03"]);
			ПраваяЧасть = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000300" + Стр + "04"]);
			Расшифровка = Строка(ЛеваяЧасть) + " = " + Строка(ПраваяЧасть);
		...
		ТекстФормулы = "если по стр.301 гр.1>гр.2, то по стр.101 гр.2 <> 0 и гр.2>гр.3";
		Описание     = "по стр.301 гр.1>гр.2, и по стр.101 гр.2 = 0 и гр.2<=гр.3";
		Зн1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000300103"]);
		Зн2 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000300104"]);
		Зн3 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100103"]);
		Зн4 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100104"]);
		Зн5 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100105"]);
		Расшифровка = "стр.301:"+Число(Зн1)+","+Число(Зн2)+" стр.101:"+Число(Зн3)+","+Число(Зн4);
		
		Если (Зн1<=Зн2) Или (Зн3=0 И Зн3>Зн4) Тогда 
			ЭтоОшибка = Ложь;
			ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
		Иначе
			ЭтоОшибка = Истина;
		...
		ТекстФормулы = "если по стр.301 гр.1=гр.2, то по стр.101 гр.2=гр.3";
		Описание     = "по стр.301 гр.1=гр.2, и по стр.101 гр.2<>гр.3";
		Расшифровка = "стр.301:"+Число(Зн1)+","+Число(Зн2)+" стр.101:"+Число(Зн3)+","+Число(Зн4);
		
		Если (Зн1<>Зн2) Или (Зн3=Зн4) Тогда 
			ЭтоОшибка = Ложь;
			ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
		Иначе
			ЭтоОшибка = Истина;
		...
		ТекстФормулы = "если по стр.301 гр.2=0, то по стр.101 гр.3=гр.4=0";
		Описание     = "стр.301 гр.2=0, по стр.101 гр.3 <> 0 или гр.4 <> 0";
		Расшифровка = "стр.301:"+Число(Зн2)+" стр.101:"+Число(Зн4)+","+Число(Зн5);
		
		Если (0<>Зн2) Или (Зн4=0 И Зн5=0) Тогда 
			ЭтоОшибка = Ложь;
			ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
		Иначе
			ЭтоОшибка = Истина;
		...
		// Раздел 4.
		Для Стр = 1 По 80 Цикл
			Если ПолеТабличногоДокументаФормаОтчета.Области.Найти("П000004000101_" + Стр) = Неопределено Тогда 
				Прервать;
			КонецЕсли;
			
			ТекстФормулы = "если гр.3 или гр.4 <> 0, тогда гр.5<0 и гр.6 <= 0 по стр." + Стр + " раздела 4";
			Описание     = "гр.3 или гр.4 <> 0, но гр.5>=0 или гр.6 > 0 по стр." + Стр + " раздела 4";
			ЗнГр3 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000004000105_" + Стр]);
			ЗнГр4 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000004000106_" + Стр]);
			ЗнГр5 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000004000107_" + Стр]);
			ЗнГр6 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000004000108_" + Стр]);
			Расшифровка = "гр.3,4,5,6 = " + Строка(ЗнГр3) + ", " + Строка(ЗнГр4) + ", " + Строка(ЗнГр5) + ", " + Строка(ЗнГр6);
			
			Если Не ((ЗнГр3 <> 0 И ЗнГр4 <> 0) И (ЗнГр5 >= 0 Или ЗнГр6 > 0)) Тогда
				ЭтоОшибка = Ложь;
				ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
			Иначе
				ЭтоОшибка = Истина;
		...
		// Раздел 5.
		ТекстФормулы = "стр. 102 гр.7 = стр.501(гр.3+гр.4)";
		Описание     = "стр. 102 гр.7 <> стр.501(гр.3+гр.4)";
		ЛеваяЧасть   = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100208"]);
		ПраваяЧасть1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000500104"]);
		ПраваяЧасть2 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000500105"]);
		...
		ТекстФормулы = "стр. 104 гр.7 = стр.502(гр.3+гр.4)";
		Описание     = "стр. 104 гр.7 <> стр.502(гр.3+гр.4)";
		ЛеваяЧасть   = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100408"]);
		ПраваяЧасть1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000500204"]);
		ПраваяЧасть2 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000500205"]);
		Расшифровка = Строка(ЛеваяЧасть) + " <> " + Строка(ПраваяЧасть1) + " + " + Строка(ПраваяЧасть2);
		...
		ТекстФормулы = "стр. 105 гр.7 = стр.503(гр.3+гр.4)";
		Описание     = "стр. 105 гр.7 <> стр.503(гр.3+гр.4)";
		ЛеваяЧасть   = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100508"]);
		ПраваяЧасть1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000500304"]);
		ПраваяЧасть2 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000500305"]);
		Расшифровка = Строка(ЛеваяЧасть) + " <> " + Строка(ПраваяЧасть1) + " + " + Строка(ПраваяЧасть2);
		...
		ТекстФормулы = "стр. 106 гр.7 = стр.504(гр.3+гр.4)";
		Описание     = "стр. 106 гр.7 <> стр.504(гр.3+гр.4)";
		ЛеваяЧасть   = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100608"]);
		ПраваяЧасть1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000500404"]);
		ПраваяЧасть2 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000500405"]);
		Расшифровка = Строка(ЛеваяЧасть) + " <> " + Строка(ПраваяЧасть1) + " + " + Строка(ПраваяЧасть2);
		...
		ТекстФормулы = "стр.505(гр.3+гр.4) + стр.2** Раздела 2 с кодом ""0410"" (метан) гр.2 = (стр.107 + стр.108) гр.7";
		Описание     = "стр.505(гр.3+гр.4) + стр.2** Раздела 2 с кодом ""0410"" (метан) гр.2 <> (стр.107 + стр.108) гр.7";
		ЛеваяЧасть1  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000500504"]);
		ЛеваяЧасть2  = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000500505"]);
		ЛеваяЧасть3  = 0;
		ПраваяЧасть1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100708"]);
		ПраваяЧасть2 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П000100808"]);
		Строки = П0000020001.НайтиСтроки(Новый Структура("П000002000102", 410));
		Для Каждого Стр Из Строки Цикл
			ЛеваяЧасть3 = ЛеваяЧасть3 + РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Стр.П000002000104);
		КонецЦикла;
		Расшифровка = Строка(ЛеваяЧасть1) + " + " + Строка(ЛеваяЧасть2) + " + " + Строка(ЛеваяЧасть3) + " <> " + Строка(ПраваяЧасть1) + " + " + Строка(ПраваяЧасть2);
