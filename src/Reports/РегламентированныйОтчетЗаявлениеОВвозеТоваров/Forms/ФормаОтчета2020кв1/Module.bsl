...
Процедура ПриОткрытии(Отказ)
	...
	ИмпортерСовпадаетСОтправителемПриИзменении(Ложь);
...
Процедура ФормироватьСтруктуруСтраницОтчета() 
	...
	= "Сведения об отправителе," + Символы.ПС + "импортере и подписантах";
...
Процедура ВосстановитьСохраненныеДанные()
	...
	Если ТипЗнч(СтруктураДанныхРаздел1.НомерЗаяв) = Тип("Число") Тогда
		НомерЗаяв = Формат(СтруктураДанныхРаздел1.НомерЗаяв, "ЧГ=");
		СтруктураДанныхРаздел1.Вставить("НомерЗаяв", НомерЗаяв);
		СтруктураДанныхРаздел2.Вставить("НомерЗаяв", НомерЗаяв);
		СтруктураДанныхРаздел3.Вставить("НомерЗаяв", НомерЗаяв);
		Для каждого СтраницаПриложение Из ТаблицаСтраницыПриложение Цикл
			ДанныеСтраницы = СтраницаПриложение.Данные[0].Значение;
			ДанныеСтраницы.Вставить("НомерЗаяв", НомерЗаяв);
		КонецЦикла;
	КонецЕсли;
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ВПрограммеИзмененаДатаПодписи = Ложь)
	...
	Форма.СтруктураРеквизитовФормы.Организация, Форма.ДатаПодписи, ОргСведения);
...
Процедура ОчиститьТабличноеПоле(Форма, ВыбТабличноеПолеИмя)
	...
	Если ВыбТабличноеПолеИмя="Раздел1" Тогда
		...
		ВыбТабличноеПоле.Области.КодСтраныПокупатель.Значение = "643";
...
Процедура Обновить(Команда)
	...
	ИмпортерСовпадаетСОтправителемПриИзменении("");
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	СоответствиеРазделовМакетам.Вставить("Раздел1",    "ФормаОтчета2020кв1_Раздел1");
	СоответствиеРазделовМакетам.Вставить("Раздел2",    "ФормаОтчета2020кв1_Раздел2");
	СоответствиеРазделовМакетам.Вставить("Раздел3",    "ПечатнаяФормаОтчета2020Кв1_Раздел3");
	СоответствиеРазделовМакетам.Вставить("Приложение", "ФормаОтчета2020кв1_Приложение");
...
Процедура ВывестиНаПечатьЛистРаздел1(СтруктураПараметров)
	...
	МакетПечатиРаздела = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ПечатнаяФормаОтчета2020Кв1_Раздел1");
	
	МакетОбразцаПечатиРаздела = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ПечатнаяФормаОтчета2020Кв1_Раздел1");
...
Функция СформироватьСтруктуруПараметров()
	...
	Если НЕ мСтруктураРеквизитовВыгрузки.ИмпортерСовпадаетСОтправителем Тогда
		Если мСтруктураРеквизитовВыгрузки.ИмпортерЯвляетсяЮЛ Тогда
			ПараметрыВыгрузки.Вставить("НаимИмп",  мСтруктураРеквизитовВыгрузки.НаимИмпорт);
			ПараметрыВыгрузки.Вставить("ИННЮЛИмп", мСтруктураРеквизитовВыгрузки.ИННЮЛИмпорт);
			ПараметрыВыгрузки.Вставить("КППИмп",   мСтруктураРеквизитовВыгрузки.КППИмпорт);
		Иначе
			ПараметрыВыгрузки.Вставить("ИННФЛИмп",      мСтруктураРеквизитовВыгрузки.ИННФЛИмпорт);
			ПараметрыВыгрузки.Вставить("ФамилияФЛИмп",  мСтруктураРеквизитовВыгрузки.ФамилияФЛИмпорт);
			ПараметрыВыгрузки.Вставить("ИмяФЛИмп",      мСтруктураРеквизитовВыгрузки.ИмяФЛИмпорт);
			ПараметрыВыгрузки.Вставить("ОтчествоФЛИмп", мСтруктураРеквизитовВыгрузки.ОтчествоФЛИмпорт);
		КонецЕсли;
	КонецЕсли;
...
Функция ИзвлечьСтруктуруXML()
	...
	Макет = ОбъектОтчета(ИмяФормы).ПолучитьМакет("СхемаВыгрузки508");
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель)
	...
	НомерЗаяв = "";
	Если ТипЗнч(Раздел1.НомерЗаяв) = Тип("Строка") Тогда
		НомерЗаяв = СокрЛП(Раздел1.НомерЗаяв);
	ИначеЕсли ТипЗнч(Раздел1.НомерЗаяв) = Тип("Число") Тогда
		НомерЗаяв = Формат(Раздел1.НомерЗаяв, "ЧГ=");
	КонецЕсли;
	УстановитьЗначениеЭлемента(Узел_СвЗвл, "НомерДокНП", НомерЗаяв);
	...
	Пока РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(Раздел1, "П000010000101_" + НомерСтрокиСтр) Цикл
		...
		Если ЗначениеЗаполнено(Раздел1["П000010000102_" + НомерСтрокиСтр]) Тогда
			...
			Если КодПричины <> "5" И КодПричины <> "6" Тогда
...
Функция ПолучитьСведенияОПредставителе(КодИФНС) Экспорт
	...
	Возврат Отчеты.РегламентированныйОтчетЗаявлениеОВвозеТоваров.ПолучитьСведенияОПредставителе(
...
Процедура ПроверитьВозможностьВыгрузки_ПараметрыВыгрузки(СтатусПроверки)
	...
	ИмпортерСовпадаетСОтправителем = мСтруктураРеквизитовВыгрузки.ИмпортерСовпадаетСОтправителем;
	
	ИмпортерЯвляетсяЮЛ = мСтруктураРеквизитовВыгрузки.ИмпортерЯвляетсяЮЛ;
	
	НаимИмпорт  = мСтруктураРеквизитовВыгрузки.НаимИмпорт;
	ИННЮЛИмпорт = мСтруктураРеквизитовВыгрузки.ИННЮЛИмпорт;
	КППИмпорт   = мСтруктураРеквизитовВыгрузки.КППИмпорт;
	
	ИННФЛИмпорт      = мСтруктураРеквизитовВыгрузки.ИННФЛИмпорт;
	ФамилияФЛИмпорт  = мСтруктураРеквизитовВыгрузки.ФамилияФЛИмпорт;
	ИмяФЛИмпорт      = мСтруктураРеквизитовВыгрузки.ИмяФЛИмпорт;
	ОтчествоФЛИмпорт = мСтруктураРеквизитовВыгрузки.ОтчествоФЛИмпорт;
	...
	Если НЕ ЗначениеЗаполнено(КодНО) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru = 'В сведениях об отправителе, импортере и подписантах не заполнен код налогового органа';
																				|en = 'В сведениях об отправителе, импортере и подписантах не заполнен код налогового органа'"), "Раздел1");
		СтатусПроверки = Ложь;
	ИначеЕсли СтрДлина(СокрЛП(КодНО))<> 4 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru = 'В сведениях об отправителе, импортере и подписантах неверно заполнен код налогового органа';
																				|en = 'В сведениях об отправителе, импортере и подписантах неверно заполнен код налогового органа'"), "Раздел1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ОтправительЯвляетсяЮЛ Тогда
		Если НЕ ЗначениеЗаполнено(НаимОтпр) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru = 'В сведениях об отправителе, импортере и подписантах не заполнено наименование организации отправителя';
																					|en = 'В сведениях об отправителе, импортере и подписантах не заполнено наименование организации отправителя'"), "Раздел1");
			СтатусПроверки = Ложь;
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(ИННЮЛОтпр) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru = 'В сведениях об отправителе, импортере и подписантах не заполнен ИНН организации отправителя';
																					|en = 'В сведениях об отправителе, импортере и подписантах не заполнен ИНН организации отправителя'"), "Раздел1");
			СтатусПроверки = Ложь;
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(КППОтпр) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru = 'В сведениях об отправителе, импортере и подписантах не заполнен КПП организации отправителя';
																					|en = 'В сведениях об отправителе, импортере и подписантах не заполнен КПП организации отправителя'"), "Раздел1");
			СтатусПроверки = Ложь;
		КонецЕсли;
	Иначе
		Если НЕ ЗначениеЗаполнено(ФамилияФЛОтпр) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru = 'В сведениях об отправителе, импортере и подписантах не заполнена фамилия отправителя';
																					|en = 'В сведениях об отправителе, импортере и подписантах не заполнена фамилия отправителя'"), "Раздел1");
			СтатусПроверки = Ложь;
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(ИмяФЛОтпр) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru = 'В сведениях об отправителе, импортере и подписантах не заполнено имя отправителя';
																					|en = 'В сведениях об отправителе, импортере и подписантах не заполнено имя отправителя'"), "Раздел1");
			СтатусПроверки = Ложь;
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(ИННФЛОтпр) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru = 'В сведениях об отправителе, импортере и подписантах не заполнен ИНН отправителя';
																					|en = 'В сведениях об отправителе, импортере и подписантах не заполнен ИНН отправителя'"), "Раздел1");
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЕсли;
	...
	Если НЕ ИмпортерСовпадаетСОтправителем Тогда
		...
		Если ИмпортерЯвляетсяЮЛ Тогда
			Если НЕ ЗначениеЗаполнено(НаимИмпорт) Тогда
				...
				"ru = 'В сведениях об отправителе, импортере и подписантах не заполнено наименование организации импортера';
				|en = 'В сведениях об отправителе, импортере и подписантах не заполнено наименование организации импортера'"), "Раздел1");
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ИННЮЛИмпорт) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр(
				"ru = 'В сведениях об отправителе, импортере и подписантах не заполнен ИНН организации импортера';
				|en = 'В сведениях об отправителе, импортере и подписантах не заполнен ИНН организации импортера'"), "Раздел1");
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(КППИмпорт) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр(
				"ru = 'В сведениях об отправителе, импортере и подписантах не заполнен КПП организации импортера';
				|en = 'В сведениях об отправителе, импортере и подписантах не заполнен КПП организации импортера'"), "Раздел1");
				СтатусПроверки = Ложь;
			КонецЕсли;
		Иначе
			Если НЕ ЗначениеЗаполнено(ФамилияФЛИмпорт) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр(
				"ru = 'В сведениях об отправителе, импортере и подписантах не заполнена фамилия импортера';
				|en = 'В сведениях об отправителе, импортере и подписантах не заполнена фамилия импортера'"), "Раздел1");
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ИмяФЛИмпорт) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр(
				"ru = 'В сведениях об отправителе, импортере и подписантах не заполнено имя импортера';
				|en = 'В сведениях об отправителе, импортере и подписантах не заполнено имя импортера'"), "Раздел1");
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ИННФЛИмпорт) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр(
				"ru = 'В сведениях об отправителе, импортере и подписантах не заполнен ИНН импортера';
				|en = 'В сведениях об отправителе, импортере и подписантах не заполнен ИНН импортера'"), "Раздел1");
				СтатусПроверки = Ложь;
			КонецЕсли;
		КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ФамилияПодп) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru = 'В сведениях об отправителе, импортере и подписантах не заполнена фамилия подписанта';
																				|en = 'В сведениях об отправителе, импортере и подписантах не заполнена фамилия подписанта'"), "Раздел1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если НЕ ЗначениеЗаполнено(ИмяПодп) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru = 'В сведениях об отправителе, импортере и подписантах не заполнено имя подписанта';
																				|en = 'В сведениях об отправителе, импортере и подписантах не заполнено имя подписанта'"), "Раздел1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПрПодп = 3 Тогда
		Если НЕ ЗначениеЗаполнено(НаимДовПодп) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru = 'В сведениях об отправителе, импортере и подписантах не заполнено наименование документа, подтверждающего полномочия представителя';
																					|en = 'В сведениях об отправителе, импортере и подписантах не заполнено наименование документа, подтверждающего полномочия представителя'"), "Раздел1");
			СтатусПроверки = Ложь;
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(НомерДовПодп) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru = 'В сведениях об отправителе, импортере и подписантах не заполнен номер документа, подтверждающего полномочия представителя';
																					|en = 'В сведениях об отправителе, импортере и подписантах не заполнен номер документа, подтверждающего полномочия представителя'"), "Раздел1");
			СтатусПроверки = Ложь;
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(ДатаДовПодп) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru = 'В сведениях об отправителе, импортере и подписантах не заполнена дата документа, подтверждающего полномочия представителя';
																					|en = 'В сведениях об отправителе, импортере и подписантах не заполнена дата документа, подтверждающего полномочия представителя'"), "Раздел1");
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЕсли;
...
Процедура ПроверитьВозможностьВыгрузки_Товары(СтатусПроверки)
	...
	КодПричины = КодПричиныВозникновенияЗаявления(СокрЛП(Раздел1.ПричинаЗаявления));
	ДопустимыПропускиВНумерацииСтрок = (КодПричины = "5" ИЛИ КодПричины = "6");
	ЗадействованныеНомераСтрок = Новый Массив;
	ПродублированныеНомераСтрок = Новый Массив;
	ПервыйДубльНомераСтроки = "";
	НайденНомерСтрокиНеПоПорядку = Ложь;
	...
	Пока Раздел1.Свойство("П000010000101_" + Формат(НомСтроки, "ЧГ=")) Цикл
		...
		ИндНач = ?(ДопустимыПропускиВНумерацииСтрок, 1, 2);
		
		Для Инд = ИндНач По 13 Цикл
		...
		Если ДопустимыПропускиВНумерацииСтрок Тогда
			
			Если НЕ ЗначениеЗаполнено(Раздел1["П000010000101_" + СтрНомСтроки]) Тогда
				
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В таблице товаров раздела 1 в строке " + СтрНомСтроки + " не заполнен № п/п", "Раздел1", "П000010000101_" + СтрНомСтроки);
				СтатусПроверки = Ложь;
				
			Иначе
				
				Если ЗадействованныеНомераСтрок.Количество() > 0
					И ЗадействованныеНомераСтрок[ЗадействованныеНомераСтрок.Количество() - 1]
					>= Раздел1["П000010000101_" + СтрНомСтроки] И НайденНомерСтрокиНеПоПорядку = Ложь Тогда
					
					НайденНомерСтрокиНеПоПорядку = Истина;
					
					РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"В таблице товаров раздела 1 нумерация строк в графе № п/п должна идти по порядку; "
					+ "допустимы пропуски в нумерации при заданной причине возникновения Заявления",
					"Раздел1", "П000010000101_" + СтрНомСтроки);
					СтатусПроверки = Ложь;
					
				КонецЕсли;
				
				Если ЗадействованныеНомераСтрок.Найти(Раздел1["П000010000101_" + СтрНомСтроки]) = Неопределено Тогда
					ЗадействованныеНомераСтрок.Добавить(Раздел1["П000010000101_" + СтрНомСтроки]);
				Иначе
					ПродублированныеНомераСтрок.Добавить(Раздел1["П000010000101_" + СтрНомСтроки]);
					ПервыйДубльНомераСтроки = ?(ПервыйДубльНомераСтроки = "", СтрНомСтроки, ПервыйДубльНомераСтроки);
				КонецЕсли;
		...
		Если (НЕ ЕстьДоговорЛизинга И НЕ ЕстьДоговорПереработки)
		 ИЛИ (НЕ ПустаяСтрока(Раздел1["П000010000105_" + СтрНомСтроки])) Тогда
		 	КодЕИ = СокрЛП(Раздел1["П000010000122_" + СтрНомСтроки]);
			Если ПустаяСтрока(Раздел1["П000010000104_" + СтрНомСтроки]) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В таблице товаров раздела 1 в строке "
				+ СтрНомСтроки + " не заполнена единица измерения товара", "Раздел1", "П000010000104_" + СтрНомСтроки);
				СтатусПроверки = Ложь;
			ИначеЕсли СтрДлина(КодЕИ) < 3 Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В таблице товаров раздела 1 в строке "
				+ СтрНомСтроки + " длина кода """ + КодЕИ + """ единицы измерения товара не должна быть менее 3 символов",
				"Раздел1", "П000010000104_" + СтрНомСтроки);
				СтатусПроверки = Ложь;
			КонецЕсли;
		КонецЕсли;
	...
	Если ДопустимыПропускиВНумерацииСтрок И ПродублированныеНомераСтрок.Количество() > 0 И ПервыйДубльНомераСтроки <> "" Тогда
		
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
		"В таблице товаров раздела 1 заданы следующие неуникальные значения № п/п: "
		+ СтрСоединить(ПродублированныеНомераСтрок, ", "), "Раздел1", "П000010000101_" + ПервыйДубльНомераСтроки);
		СтатусПроверки = Ложь;
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Если Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел1" Тогда
		...
		ИначеЕсли СтрНайти(Область.Имя, "П000010000116") > 0
			...
			СтруктураСтавокТабл.Вставить("Ст16",
				СтрЗаменить(ПолеТабличногоДокументаРаздел1.Области["П000010000116_" + НомерДопСтр].Значение, ",", "."));
			СтруктураСтавокТабл.Вставить("Ст17",
				СтрЗаменить(ПолеТабличногоДокументаРаздел1.Области["П000010000117_" + НомерДопСтр].Значение, ",", "."));
			СтруктураСтавокТабл.Вставить("Ст18",
				СтрЗаменить(ПолеТабличногоДокументаРаздел1.Области["П000010000118_" + НомерДопСтр].Значение, ",", "."));
			СтруктураСтавокТабл.Вставить("Ст21",
				СтрЗаменить(ПолеТабличногоДокументаРаздел1.Области["П000010000121_" + НомерДопСтр].Значение, ",", "."));
	...
	Если ВыбЭлемент = Неопределено Тогда
		Если НЕ ЗначениеЗаполнено(ТекОбласть.Значение) Тогда
			...
			Сообщение.Текст = НСтр("ru = 'Не выбрана причина возникновения заявления';
									|en = 'Не выбрана причина возникновения заявления'");
			Сообщение.Сообщить();
		КонецЕсли;
	Иначе
...
Процедура ОтобразитьКодСтраны(ПараметрыВвода, ХранилищеДополнительныхСведений)
	...
	ТабличныйДокумент.Области[ИмяОбластиКодаСтраны].Значение = КодСтраны;
		...
		Если СтрНайти(ОбластьИмя, "П000010000104") > 0  И СтруктураРеквизитовФормы.мАвтоВыборКодов Тогда
			...
			Если ТабличныйДокумент.Области.Найти(ИмяСлужебногоПоля) <> Неопределено Тогда
				...
				Сообщение.Текст = НСтр("ru = 'При вводе единицы измерения вручную в сформированный файл выгрузки попадет введенное значение!';
										|en = 'При вводе единицы измерения вручную в сформированный файл выгрузки попадет введенное значение!'");
				Сообщение.Сообщить();
			КонецЕсли;
		...
		ИначеЕсли СтрНайти(ОбластьИмя, "П000010000123") = 1 И СтруктураРеквизитовФормы.мАвтоВыборКодов Тогда
			...
			Если ТабличныйДокумент.Области.Найти(ИмяСлужебногоПоля) <> Неопределено Тогда
				...
				Сообщение.Текст = НСтр("ru = 'При вводе единицы измерения дополнительной величины вручную в сформированный файл выгрузки попадет введенное значение!';
										|en = 'При вводе единицы измерения дополнительной величины вручную в сформированный файл выгрузки попадет введенное значение!'");
				Сообщение.Сообщить();
			КонецЕсли;
		КонецЕсли;	
...
Функция ОбновитьДанныеРеквизитовВыгрузки()
	...
	Если ТипЗнч(мСтруктураРеквизитовВыгрузки) = Тип("Структура") Тогда
		
		ПараметрыВыгрузки.Вставить("ИмпортерСовпадаетСОтправителем",
		мСтруктураРеквизитовВыгрузки.ИмпортерСовпадаетСОтправителем);
		
		ПараметрыВыгрузки.Вставить("ИмпортерЯвляетсяЮЛ", мСтруктураРеквизитовВыгрузки.ИмпортерЯвляетсяЮЛ);
		
		ПараметрыВыгрузки.Вставить("НаимИмпорт",  мСтруктураРеквизитовВыгрузки.НаимИмпорт);
		ПараметрыВыгрузки.Вставить("ИННЮЛИмпорт", мСтруктураРеквизитовВыгрузки.ИННЮЛИмпорт);
		ПараметрыВыгрузки.Вставить("КППИмпорт",   мСтруктураРеквизитовВыгрузки.КППИмпорт);
		
		ПараметрыВыгрузки.Вставить("ИННФЛИмпорт",      мСтруктураРеквизитовВыгрузки.ИННФЛИмпорт);
		ПараметрыВыгрузки.Вставить("ФамилияФЛИмпорт",  мСтруктураРеквизитовВыгрузки.ФамилияФЛИмпорт);
		ПараметрыВыгрузки.Вставить("ИмяФЛИмпорт",      мСтруктураРеквизитовВыгрузки.ИмяФЛИмпорт);
		ПараметрыВыгрузки.Вставить("ОтчествоФЛИмпорт", мСтруктураРеквизитовВыгрузки.ОтчествоФЛИмпорт);
...
Процедура СохранитьДанныеОбласти()
	...
	мСтруктураРеквизитовВыгрузки.ИмпортерСовпадаетСОтправителем = ИмпортерСовпадаетСОтправителем;
	мСтруктураРеквизитовВыгрузки.ИмпортерЯвляетсяЮЛ = КтоИмпортирует <= 1;
	мСтруктураРеквизитовВыгрузки.ФамилияФЛИмпорт = ФамилияИмпортирует;
	мСтруктураРеквизитовВыгрузки.ИмяФЛИмпорт = ИмяИмпортирует;
	мСтруктураРеквизитовВыгрузки.ОтчествоФЛИмпорт = ОтчествоИмпортирует;
	мСтруктураРеквизитовВыгрузки.ИННФЛИмпорт = ИННИмпортирует;
	мСтруктураРеквизитовВыгрузки.КППИмпорт = КППИмпортирует;
	мСтруктураРеквизитовВыгрузки.ИННЮЛИмпорт = ИННИмпортируетЮЛ;
	мСтруктураРеквизитовВыгрузки.НаимИмпорт = НаименованиеИмпортирует;
...
Процедура ВосстановитьСохраненныеДанныеОбласти()
	...
	Иначе
		КтоИмпортирует = 2;
	КонецЕсли;
	ФамилияИмпортирует = мСтруктураРеквизитовВыгрузки.ФамилияФЛИмпорт;
	ИмяИмпортирует = мСтруктураРеквизитовВыгрузки.ИмяФЛИмпорт;
	ОтчествоИмпортирует = мСтруктураРеквизитовВыгрузки.ОтчествоФЛИмпорт;
	ИННИмпортирует = мСтруктураРеквизитовВыгрузки.ИННФЛИмпорт;
	КППИмпортирует = мСтруктураРеквизитовВыгрузки.КППИмпорт;
	ИННИмпортируетЮЛ = мСтруктураРеквизитовВыгрузки.ИННЮЛИмпорт;
	НаименованиеИмпортирует = мСтруктураРеквизитовВыгрузки.НаимИмпорт;
