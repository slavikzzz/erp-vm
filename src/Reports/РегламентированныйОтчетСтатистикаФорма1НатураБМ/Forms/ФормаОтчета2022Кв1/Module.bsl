...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КолИсхСтрокИдГруппы4 = 11;
	КолИсхСтрокИдГруппы5 = 11;
	
	КолКолонокИдГруппы1 = 11;
	КолКолонокИдГруппы2 = 16;
	КолКолонокИдГруппы4 = 12;
	КолКолонокИдГруппы5 = 14;
...
Процедура ОтфильтроватьЕдиницыИзмеренияПоКодуОКПД(КодОКПД, ИмяСписка)
	...
	СписокЕдиницИзмерения =
		РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, ИмяСписка).ТаблицаЗначений;
	...
	Если Таб1.Количество() > 0 Тогда
		ЗначениеВДанныеФормы(Таб1,
			РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ЕИОКПОтфильтрованный").ТаблицаЗначений);
	Иначе
		ЗначениеВДанныеФормы(Результат[2].Выгрузить(),
			РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ЕИОКПОтфильтрованный").ТаблицаЗначений);
	КонецЕсли;
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли (Не (Область.Защита = Истина)) И СтрНайти(Область.Имя, "_") = 14 Тогда 
		...
		Если СтрНайти(Область.Имя, "П000001000101_") = 1 Или СтрНайти(Область.Имя, "П000001000102_") = 1 Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ОКПД_55");
			ОбластьДляВвода = ПолеТабличногоДокументаФормаОтчета.Области["П000001000102_" + НомерСтроки];
			ИмяСмежнойОбласти = ПолеТабличногоДокументаФормаОтчета.Области["П000001000101_" + НомерСтроки].Имя;
			ОбластиДляОбнуления.Добавить(ПолеТабличногоДокументаФормаОтчета.Области["П000001000103_" + НомерСтроки]);
			ОбластиДляОбнуления.Добавить(ПолеТабличногоДокументаФормаОтчета.Области["П000001000104_" + НомерСтроки]);
		ИначеЕсли СтрНайти(Область.Имя, "П000001000103_") = 1 Или СтрНайти(Область.Имя, "П000001000104_") = 1 Тогда
			ОбластьДляВвода = ПолеТабличногоДокументаФормаОтчета.Области["П000001000104_" + НомерСтроки];
			ИмяСмежнойОбласти = ПолеТабличногоДокументаФормаОтчета.Области["П000001000103_" + НомерСтроки].Имя;
			ОтборЗначение = ПолеТабличногоДокументаФормаОтчета.Области["П000001000102_" + НомерСтроки].Значение;
			ОтфильтроватьЕдиницыИзмеренияПоКодуОКПД(ОтборЗначение, "ЕИОКП54_55");
			ПараметрВводаПоля =
				РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ЕИОКПОтфильтрованный");
		ИначеЕсли СтрНайти(Область.Имя, "П000002000101_") = 1 Или СтрНайти(Область.Имя, "П000002000102_") = 1 Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ОКПД_54");
			...
			ОбластиДляОбнуления.Добавить(ПолеТабличногоДокументаФормаОтчета.Области["П000002000103_" + НомерСтроки]);
			ОбластиДляОбнуления.Добавить(ПолеТабличногоДокументаФормаОтчета.Области["П000002000104_" + НомерСтроки]);
		ИначеЕсли СтрНайти(Область.Имя, "П000002000103_") = 1 Тогда
			...
			ОтборЗначение = ПолеТабличногоДокументаФормаОтчета.Области["П000002000102_" + НомерСтроки].Значение;
			ОтфильтроватьЕдиницыИзмеренияПоКодуОКПД(ОтборЗначение, "ЕИОКП54_55");
			ПараметрВводаПоля =
				РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ЕИОКПОтфильтрованный");
		ИначеЕсли СтрНайти(Область.Имя, "П000004000101_") = 1 Или СтрНайти(Область.Имя, "П000004000102_") = 1 Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ОКПД_56");
			ОбластьДляВвода = ПолеТабличногоДокументаФормаОтчета.Области["П000004000102_" + НомерСтроки];
			ИмяСмежнойОбласти = ПолеТабличногоДокументаФормаОтчета.Области["П000004000101_" + НомерСтроки].Имя;
			ОбластиДляОбнуления.Добавить(ПолеТабличногоДокументаФормаОтчета.Области["П000004000103_" + НомерСтроки]);
			ОбластиДляОбнуления.Добавить(ПолеТабличногоДокументаФормаОтчета.Области["П000004000104_" + НомерСтроки]);
		ИначеЕсли СтрНайти(Область.Имя, "П000004000103_") = 1 Или СтрНайти(Область.Имя, "П000004000104_") = 1 Тогда
			...
			ОтборЗначение = ПолеТабличногоДокументаФормаОтчета.Области["П000004000102_" + НомерСтроки].Значение;
			ОтфильтроватьЕдиницыИзмеренияПоКодуОКПД(ОтборЗначение, "ЕИОКП56");
			ПараметрВводаПоля =
				РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ЕИОКПОтфильтрованный");
		ИначеЕсли СтрНайти(Область.Имя, "П000005000101_") = 1 Или СтрНайти(Область.Имя, "П000005000102_") = 1 Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ОКПД_56");
			ОбластьДляВвода = ПолеТабличногоДокументаФормаОтчета.Области["П000005000102_" + НомерСтроки];
			ИмяСмежнойОбласти = ПолеТабличногоДокументаФормаОтчета.Области["П000005000101_" + НомерСтроки].Имя;
			ОбластиДляОбнуления.Добавить(ПолеТабличногоДокументаФормаОтчета.Области["П000005000103_" + НомерСтроки]);
			ОбластиДляОбнуления.Добавить(ПолеТабличногоДокументаФормаОтчета.Области["П000005000104_" + НомерСтроки]);
		ИначеЕсли СтрНайти(Область.Имя, "П000005000103_") = 1 Или СтрНайти(Область.Имя, "П000005000104_") = 1 Тогда
			ОбластьДляВвода = ПолеТабличногоДокументаФормаОтчета.Области["П000005000104_" + НомерСтроки];
			ИмяСмежнойОбласти = ПолеТабличногоДокументаФормаОтчета.Области["П000005000103_" + НомерСтроки].Имя;
			ОтборЗначение = ПолеТабличногоДокументаФормаОтчета.Области["П000005000102_" + НомерСтроки].Значение;
			ОтфильтроватьЕдиницыИзмеренияПоКодуОКПД(ОтборЗначение, "ЕИОКП56");
			ПараметрВводаПоля =
				РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ЕИОКПОтфильтрованный");
		Иначе
		...
		ВвестиПоказатель(Элемент, ОбластьДляВвода, КодПоказателя, Ложь, ПараметрВводаПоля.ТекстПриВыборе,
			ТЗВыбора, СтандартнаяОбработка, ИмяСмежнойОбласти, ОбластиДляОбнуления, Область);
		Возврат;
	КонецЕсли;
...
Процедура УдалитьДополнительнуюСтроку(Форма, СпециальноеДобавление = Ложь, ИмяКолонкиНомера = Неопределено, ТекущаяСтраница = Неопределено) Экспорт
	...
	Если ИмяГруппы = "П0000040001" Тогда
		УдалитьДополнительнуюСтрокуИзГруппы(Форма, СпециальноеДобавление, ИмяКолонкиНомера,
			ТекущаяСтраница, "П0000050001", НомУдаляемойСтроки, НомерСтрокиТаблицы);
	ИначеЕсли ИмяГруппы = "П0000050001" Тогда
		УдалитьДополнительнуюСтрокуИзГруппы(Форма, СпециальноеДобавление, ИмяКолонкиНомера,
			ТекущаяСтраница, "П0000040001", НомУдаляемойСтроки, НомерСтрокиТаблицы);
	КонецЕсли;
...
Процедура ВставитьДополнительнуюСтроку(Форма, ТекущаяСтраница)
	...
	СтруктураГруппы = Форма[СтруктураГруппы];
	КолСтрок = СтруктураГруппы.Количество();
	ИмяТекущейОбласти = ИмяГруппы + "01_" + КолСтрок;
...
Процедура ВвестиПоказатель(Элемент, Область, КодПоказателя, Знач ЭтоСумма, Знач ТекстВыбора, ТаблицаВыбора, СтандартнаяОбработка, ОбластьНаименование = "", ОбластиДляОбнуления, ОбластьСобытия) Экспорт
	...
	Дополнительныепараметры = Новый Структура("ОбластиДляОбнуления, Область, ОбластьНаименование, ОбластьСобытия",
		ОбластиДляОбнуления, Область, ОбластьНаименование, ОбластьСобытия);
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Пока Истина Цикл
		СтрЧ = СтрЧ + 1;
		Стр = Формат(СтрЧ, "ЧГ=");
		Обл = Области.Найти("П000004000107_" + Стр);
		Если Обл = Неопределено Тогда 
			Прервать;
		КонецЕсли;
		
		Области["П000004000106_" + Стр].Значение = Области["П000004000107_" + Стр].Значение
			+ Области["П000004000108_" + Стр].Значение
			+ Области["П000004000109_" + Стр].Значение
			+ Области["П000004000110_" + Стр].Значение
			+ Области["П000004000111_" + Стр].Значение
			+ Области["П000004000112_" + Стр].Значение;
			
		Области["П000005000105_" + Стр].Значение = Области["П000005000106_" + Стр].Значение
			+ Области["П000005000107_" + Стр].Значение
			+ Области["П000005000108_" + Стр].Значение
			+ Области["П000005000109_" + Стр].Значение;
			
		Области["П000005000110_" + Стр].Значение = Области["П000004000105_" + Стр].Значение
			+ Области["П000004000106_" + Стр].Значение
			- Области["П000005000105_" + Стр].Значение;
	КонецЦикла;
...
Процедура УстановитьЗащитуИЦветФонаОбластейАвторассчитываемыхПоказателей()
	...
	Для Н = 1 По 3 Цикл
		...
		Если Н = 1 Тогда
			СтрокаИмя = "П000004000106_";
		ИначеЕсли Н = 2 Тогда
			СтрокаИмя = "П000005000105_";
		ИначеЕсли Н = 3 Тогда
			СтрокаИмя = "П000005000110_";
		КонецЕсли;
		
		Инд = 0;
		Пока Истина Цикл
			Инд = Инд + 1;
			Обл = мФормаОтчета.Области.Найти(СтрокаИмя + Формат(Инд, "ЧГ="));
			Если Обл = Неопределено Тогда
				Прервать;
			КонецЕсли;
			Обл.ЦветФона = ЦветФонаЗначение;
			Обл.Защита   = Не ОтклАвтоРасчетЗначение;
		КонецЦикла;
...
Процедура ОчиститьТабличноеПолеНаСервере()
	...
	П0000020001.Очистить();
	П0000040001.Очистить();
	П0000050001.Очистить();
...
Процедура СформироватьСпискиВыбора()
	...
	Для Каждого Область Из МакетСоставаПоказателей.Области Цикл
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Строки Тогда
			...
			ТаблСписка.Колонки.Добавить("Код",
				Строка16, , МакетСоставаПоказателей.Область(ВерхОбласти, 1, ВерхОбласти, 1).ШиринаКолонки);
			ТаблСписка.Колонки.Добавить("Название",
				Строка512, , МакетСоставаПоказателей.Область(ВерхОбласти, 2, ВерхОбласти, 2).ШиринаКолонки);
			ТаблСписка.Колонки.Добавить("НазваниеДоп",
				Строка128, , МакетСоставаПоказателей.Область(ВерхОбласти, 3, ВерхОбласти, 3).ШиринаКолонки);
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ОКПД КАК ОКПД
	...
	Результат = Запрос.ВыполнитьПакет();
	ОКПД_54 = Результат[6].Выгрузить();
	ОКПД_55 = Результат[7].Выгрузить();
	ОКПД_56 = Результат[8].Выгрузить();
	ЕИОКП54_55 = Результат[9].Выгрузить();
	ЕИОКП56 = Результат[10].Выгрузить();
	ЕИОКПОтфильтрованный = Результат[11].Выгрузить();
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ОКПД_54",
		512, , "Выбор кода по ОКПД2", ОКПД_54);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ОКПД_55",
		512, , "Выбор кода по ОКПД2", ОКПД_55);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ОКПД_56",
		512, , "Выбор кода по ОКПД2", ОКПД_56);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ЕИОКП54_55",
		512, , "Выбор кода единицы измерения", ЕИОКП54_55);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ЕИОКП56",
		512, , "Выбор кода единицы измерения", ЕИОКП56);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ЕИОКПОтфильтрованный",
		512, , "Выбор кода единицы измерения", ЕИОКПОтфильтрованный);
