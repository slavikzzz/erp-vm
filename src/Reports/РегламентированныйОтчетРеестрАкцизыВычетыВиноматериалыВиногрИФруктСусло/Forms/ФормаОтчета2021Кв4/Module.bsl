...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.реестр акц.вин.сусло") Тогда
...
Процедура ИнициализироватьМногострочныеЧасти()
	...
	// Группа П20000.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П2000024");
	ИменаГраф.Добавить("П2000025");
	ИменаГраф.Добавить("П2000026");
	ИменаГраф.Добавить("П2000027");
	ИменаГраф.Добавить("П2000028");
	ИменаГраф.Добавить("П2000029");
	ИменаГраф.Добавить("П2000030");
	ИменаГраф.Добавить("П2000031");
	ИменаГраф.Добавить("П2000032");
	ИменаГраф.Добавить("П2000033");
...
Процедура ИнициализироватьМногоуровневыеРазделы()
	...
	Для каждого Элем Из мСтруктураМногоуровневыхРазделов Цикл
		...
		Если ИмяРаздела = "Таблица1" Тогда
			...
			СтруктураСуммПоКодуОперации.Вставить("ИтогоСуммаГрафа12", 0);
			СтруктураСуммПоКодуОперации.Вставить("ИтогоСуммаГрафа13", 0);
			СтруктураСуммПоКодуОперации.Вставить("ИтогоСуммаГрафа17", 0);
			СтруктураСуммПоКодуОперации.Вставить("ИтогоСуммаГрафа18", 0);
			
		ИначеЕсли ИмяРаздела = "Таблица2" Тогда
			
			СтруктураСуммПоКодуОперации.Вставить("ИтогоСуммаГрафа27", 0);
			СтруктураСуммПоКодуОперации.Вставить("ИтогоСуммаГрафа28", 0);
			СтруктураСуммПоКодуОперации.Вставить("ИтогоСуммаГрафа32", 0);
			СтруктураСуммПоКодуОперации.Вставить("ИтогоСуммаГрафа33", 0);
...
Процедура ФормироватьСтруктуруСтраницОтчета() Экспорт
	...
	СтрокаУровня1.Представление            = "Реестры по продавцам";
	СтрокаУровня1.ОриентацияСтраницы       = "Портрет";
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
	СтрокаУровня1.ВыгрузитьСтраницу        = 2;
	...
	СтрокаУровня1.Представление            = "Реестры по покупателям";
	СтрокаУровня1.ОриентацияСтраницы       = "Портрет";
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
	СтрокаУровня1.ВыгрузитьСтраницу        = 2;
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если ИмяРаздела = "Таблица1" ИЛИ ИмяРаздела = "Таблица2" Тогда
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяТекРаздела)
	...
	Иначе
		...
		Если ИмяТекРаздела = "Таблица1" Тогда
			...
			ОбрабОбласти.Добавить(ТДО["ИтогоСуммаГрафа12"]);
			ОбрабОбласти.Добавить(ТДО["ИтогоСуммаГрафа13"]);
			ОбрабОбласти.Добавить(ТДО["ИтогоСуммаГрафа17"]);
			ОбрабОбласти.Добавить(ТДО["ИтогоСуммаГрафа18"]);
			
		ИначеЕсли ИмяТекРаздела = "Таблица2" Тогда
			
			ОбрабОбласти.Добавить(ТДО["ИтогоСуммаГрафа27"]);
			ОбрабОбласти.Добавить(ТДО["ИтогоСуммаГрафа28"]);
			ОбрабОбласти.Добавить(ТДО["ИтогоСуммаГрафа32"]);
			ОбрабОбласти.Добавить(ТДО["ИтогоСуммаГрафа33"]);
	...
	Если мСтруктураМногоуровневыхРазделов.Свойство(НаимРаздела) Тогда
		...
		Если НЕ СтруктураРеквизитовФормы.ФлажокОтклАвтоРасчет Тогда
			...
			Если НаимРаздела = "Таблица1" Тогда
				...
				ИтогоСуммаГрафа12 = ТабличныйДокумент.Области["ИтогоСуммаГрафа12"].Значение;
				ИтогоСуммаГрафа13 = ТабличныйДокумент.Области["ИтогоСуммаГрафа13"].Значение;
				ИтогоСуммаГрафа17 = ТабличныйДокумент.Области["ИтогоСуммаГрафа17"].Значение;
				ИтогоСуммаГрафа18 = ТабличныйДокумент.Области["ИтогоСуммаГрафа18"].Значение;
				Для каждого Ветка Из ДеревоДанныхРаздела.Строки Цикл
					Если Ветка.Данные["КодОперации"] = КодОперации Тогда
						...
						Ветка.Данные["ИтогоСуммаГрафа12"] = ИтогоСуммаГрафа12;
						Ветка.Данные["ИтогоСуммаГрафа13"] = ИтогоСуммаГрафа13;
						Ветка.Данные["ИтогоСуммаГрафа17"] = ИтогоСуммаГрафа17;
						Ветка.Данные["ИтогоСуммаГрафа18"] = ИтогоСуммаГрафа18;
					КонецЕсли;
				КонецЦикла;
				
			ИначеЕсли НаимРаздела = "Таблица2" Тогда
				
				ИтогоСуммаГрафа27 = ТабличныйДокумент.Области["ИтогоСуммаГрафа27"].Значение;
				ИтогоСуммаГрафа28 = ТабличныйДокумент.Области["ИтогоСуммаГрафа28"].Значение;
				ИтогоСуммаГрафа32 = ТабличныйДокумент.Области["ИтогоСуммаГрафа32"].Значение;
				ИтогоСуммаГрафа33 = ТабличныйДокумент.Области["ИтогоСуммаГрафа33"].Значение;
				Для каждого Ветка Из ДеревоДанныхРаздела.Строки Цикл
					Если Ветка.Данные["КодОперации"] = КодОперации Тогда
						Ветка.Данные["ИтогоСуммаГрафа27"] = ИтогоСуммаГрафа27;
						Ветка.Данные["ИтогоСуммаГрафа28"] = ИтогоСуммаГрафа28;
						Ветка.Данные["ИтогоСуммаГрафа32"] = ИтогоСуммаГрафа32;
						Ветка.Данные["ИтогоСуммаГрафа33"] = ИтогоСуммаГрафа33;
					КонецЕсли;
				КонецЦикла;
...
Функция ДанныеТабличногоДокумента(НаимРаздела)
	...
	Если мСтруктураМногоуровневыхРазделов.Свойство(НаимРаздела) Тогда
		...
		СтруктураДанных.Вставить("ИННКонтрагента", ТабличныйДокумент.Область("ИННКонтрагента").Значение);
		СтруктураДанных.Вставить("КППКонтрагента", ТабличныйДокумент.Область("КППКонтрагента").Значение);
		СтруктураДанных.Вставить("НаименованиеКонтрагента", ТабличныйДокумент.Область("НаименованиеКонтрагента").Значение);
		...
		Если НаимРаздела = "Таблица1" Тогда
			...
			СтруктураДанных.Вставить("ИтогоСуммаГрафа12", ТабличныйДокумент.Область("ИтогоСуммаГрафа12").Значение);
			СтруктураДанных.Вставить("ИтогоСуммаГрафа13", ТабличныйДокумент.Область("ИтогоСуммаГрафа13").Значение);
			СтруктураДанных.Вставить("ИтогоСуммаГрафа17", ТабличныйДокумент.Область("ИтогоСуммаГрафа17").Значение);
			СтруктураДанных.Вставить("ИтогоСуммаГрафа18", ТабличныйДокумент.Область("ИтогоСуммаГрафа18").Значение);
			
		ИначеЕсли НаимРаздела = "Таблица2" Тогда
			
			СтруктураДанных.Вставить("КодПоказателя", ТабличныйДокумент.Область("КодПоказателя").Значение);
			
			СтруктураДанных.Вставить("ИтогоСуммаГрафа27", ТабличныйДокумент.Область("ИтогоСуммаГрафа27").Значение);
			СтруктураДанных.Вставить("ИтогоСуммаГрафа28", ТабличныйДокумент.Область("ИтогоСуммаГрафа28").Значение);
			СтруктураДанных.Вставить("ИтогоСуммаГрафа32", ТабличныйДокумент.Область("ИтогоСуммаГрафа32").Значение);
			СтруктураДанных.Вставить("ИтогоСуммаГрафа33", ТабличныйДокумент.Область("ИтогоСуммаГрафа33").Значение);
	...
	Если мСтруктураМногоуровневыхРазделов.Свойство(ИмяТекРаздела) Тогда
		...
		Если НЕ СтруктураРеквизитовФормы.ФлажокОтклАвтоРасчет Тогда
			...
			Если ИмяТекРаздела = "Таблица1" Тогда
				...
				Для каждого ЭлМассива Из СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяТекРаздела] Цикл
					Если ЭлМассива["КодОперации"] = КодОперации Тогда
						...
						СуммаГрафа12 = СуммаГрафа12 + ЭлМассива["ИтогоСуммаГрафа12"];
						СуммаГрафа13 = СуммаГрафа13 + ЭлМассива["ИтогоСуммаГрафа13"];
						СуммаГрафа17 = СуммаГрафа17 + ЭлМассива["ИтогоСуммаГрафа17"];
						СуммаГрафа18 = СуммаГрафа18 + ЭлМассива["ИтогоСуммаГрафа18"];
					КонецЕсли;
				КонецЦикла;
				...
				ТабличныйДокумент.Области["ИтогоСуммаГрафа12"].Значение = СуммаГрафа12;
				ТабличныйДокумент.Области["ИтогоСуммаГрафа13"].Значение = СуммаГрафа13;
				ТабличныйДокумент.Области["ИтогоСуммаГрафа17"].Значение = СуммаГрафа17;
				ТабличныйДокумент.Области["ИтогоСуммаГрафа18"].Значение = СуммаГрафа18;
			...
			ИначеЕсли ИмяТекРаздела = "Таблица2" Тогда
				...
				Для каждого ЭлМассива Из СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяТекРаздела] Цикл
					Если ЭлМассива["КодОперации"] = КодОперации Тогда
						СуммаГрафа27 = СуммаГрафа27 + ЭлМассива["ИтогоСуммаГрафа27"];
						СуммаГрафа28 = СуммаГрафа28 + ЭлМассива["ИтогоСуммаГрафа28"];
						СуммаГрафа32 = СуммаГрафа32 + ЭлМассива["ИтогоСуммаГрафа32"];
						СуммаГрафа33 = СуммаГрафа33 + ЭлМассива["ИтогоСуммаГрафа33"];
					КонецЕсли;
				КонецЦикла;
				ТабличныйДокумент.Области["ИтогоСуммаГрафа27"].Значение = СуммаГрафа27;
				ТабличныйДокумент.Области["ИтогоСуммаГрафа28"].Значение = СуммаГрафа28;
				ТабличныйДокумент.Области["ИтогоСуммаГрафа32"].Значение = СуммаГрафа32;
				ТабличныйДокумент.Области["ИтогоСуммаГрафа33"].Значение = СуммаГрафа33;
...
Процедура Расчет(Форма, ИмяРаздела = "", ОбластьИмя = "") Экспорт
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя)
				...
				Пока Форма.ТабличныйДокумент.Области.Найти("П1000008_" + Формат(Ном, "ЧГ=")) <> Неопределено Цикл
					СуммаГрафа8 = СуммаГрафа8 + Форма.ТабличныйДокумент.Области["П1000008_" + Формат(Ном, "ЧГ=")].Значение;
					Ном = Ном + 1;
				КонецЦикла;
			...
			Если ЗначениеЗаполнено(ОбластьИмя)
				...
				СуммаГрафа9 = 0;
				Ном = 1;
				Пока Форма.ТабличныйДокумент.Области.Найти("П1000009_" + Формат(Ном, "ЧГ=")) <> Неопределено Цикл
					СуммаГрафа9 = СуммаГрафа9 + Форма.ТабличныйДокумент.Области["П1000009_" + Формат(Ном, "ЧГ=")].Значение;
					Ном = Ном + 1;
				КонецЦикла;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["КодОперации"]
					= КодОперации;
				...
				Для каждого ЭлМассива Из Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела] Цикл
					...
					КонецЕсли;
				КонецЦикла;
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа9"].Значение = СуммаГрафа9;
			КонецЕсли;
			
			Если ЗначениеЗаполнено(ОбластьИмя)
				И ((СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.ИтогоСуммаГрафа12, ОбластьИмя) > 0)
				ИЛИ (СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.ИтогоСуммаГрафа12,
				Лев(ОбластьИмя, Форма.СтруктураРеквизитовФормы.ДлинаИмениГрафы)) > 0)) Тогда
				...
				Пока Форма.ТабличныйДокумент.Области.Найти("П1000012_" + Формат(Ном, "ЧГ=")) <> Неопределено Цикл
					СуммаГрафа12 = СуммаГрафа12 + Форма.ТабличныйДокумент.Области["П1000012_" + Формат(Ном, "ЧГ=")].Значение;
					Ном = Ном + 1;
				КонецЦикла;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["КодОперации"]
					= КодОперации;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["ИтогоСуммаГрафа12"]
					= СуммаГрафа12;
				СуммаГрафа12 = 0;
				Для каждого ЭлМассива Из Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела] Цикл
					Если ЭлМассива["КодОперации"] = КодОперации Тогда
					...
					КонецЕсли;
				КонецЦикла;
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа12"].Значение = СуммаГрафа12;
			КонецЕсли;
			
			Если ЗначениеЗаполнено(ОбластьИмя)
				И ((СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.ИтогоСуммаГрафа13, ОбластьИмя) > 0)
				ИЛИ (СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.ИтогоСуммаГрафа13,
				Лев(ОбластьИмя, Форма.СтруктураРеквизитовФормы.ДлинаИмениГрафы)) > 0)) Тогда
				...
				СуммаГрафа13 = 0;
				Ном = 1;
				Пока Форма.ТабличныйДокумент.Области.Найти("П1000013_" + Формат(Ном, "ЧГ=")) <> Неопределено Цикл
					СуммаГрафа13 = СуммаГрафа13 + Форма.ТабличныйДокумент.Области["П1000013_" + Формат(Ном, "ЧГ=")].Значение;
					Ном = Ном + 1;
				КонецЦикла;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["КодОперации"]
					= КодОперации;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["ИтогоСуммаГрафа13"]
					= СуммаГрафа13;
				СуммаГрафа13 = 0;
				Для каждого ЭлМассива Из Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела] Цикл
					Если ЭлМассива["КодОперации"] = КодОперации Тогда
					...
					КонецЕсли;
				КонецЦикла;
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа13"].Значение = СуммаГрафа13;
			КонецЕсли;
			
			Если ЗначениеЗаполнено(ОбластьИмя)
				И ((СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.ИтогоСуммаГрафа17, ОбластьИмя) > 0)
				ИЛИ (СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.ИтогоСуммаГрафа17,
				Лев(ОбластьИмя, Форма.СтруктураРеквизитовФормы.ДлинаИмениГрафы)) > 0)) Тогда
				...
				СуммаГрафа17 = 0;
				Ном = 1;
				Пока Форма.ТабличныйДокумент.Области.Найти("П1000017_" + Формат(Ном, "ЧГ=")) <> Неопределено Цикл
					СуммаГрафа17 = СуммаГрафа17 + Форма.ТабличныйДокумент.Области["П1000017_" + Формат(Ном, "ЧГ=")].Значение;
					Ном = Ном + 1;
				КонецЦикла;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["КодОперации"]
					= КодОперации;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["ИтогоСуммаГрафа17"]
					= СуммаГрафа17;
				СуммаГрафа17 = 0;
				Для каждого ЭлМассива Из Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела] Цикл
					Если ЭлМассива["КодОперации"] = КодОперации Тогда
					...
					КонецЕсли;
				КонецЦикла;
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа17"].Значение = СуммаГрафа17;
			КонецЕсли;
			
			Если ЗначениеЗаполнено(ОбластьИмя)
				И ((СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.ИтогоСуммаГрафа18, ОбластьИмя) > 0)
				ИЛИ (СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.ИтогоСуммаГрафа18,
				Лев(ОбластьИмя, Форма.СтруктураРеквизитовФормы.ДлинаИмениГрафы)) > 0)) Тогда
				...
				Пока Форма.ТабличныйДокумент.Области.Найти("П1000018_" + Формат(Ном, "ЧГ=")) <> Неопределено Цикл
					СуммаГрафа18 = СуммаГрафа18 + Форма.ТабличныйДокумент.Области["П1000018_" + Формат(Ном, "ЧГ=")].Значение;
					Ном = Ном + 1;
				КонецЦикла;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["КодОперации"]
					= КодОперации;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["ИтогоСуммаГрафа18"]
					= СуммаГрафа18;
				СуммаГрафа18 = 0;
				Для каждого ЭлМассива Из Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела] Цикл
					Если ЭлМассива["КодОперации"] = КодОперации Тогда
					...
					КонецЕсли;
				КонецЦикла;
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа18"].Значение = СуммаГрафа18;
			КонецЕсли;
	...
	ИначеЕсли ИмяРаздела = "Таблица2" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя)
				И ((СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.ИтогоСуммаГрафа27, ОбластьИмя) > 0)
				ИЛИ (СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.ИтогоСуммаГрафа27,
				Лев(ОбластьИмя, Форма.СтруктураРеквизитовФормы.ДлинаИмениГрафы)) > 0)) Тогда
				...
				СуммаГрафа27 = 0;
				Ном = 1;
				Пока Форма.ТабличныйДокумент.Области.Найти("П2000027_" + Формат(Ном, "ЧГ=")) <> Неопределено Цикл
					СуммаГрафа27 = СуммаГрафа27 + Форма.ТабличныйДокумент.Области["П2000027_" + Формат(Ном, "ЧГ=")].Значение;
					Ном = Ном + 1;
				КонецЦикла;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["КодОперации"]
					= КодОперации;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["ИтогоСуммаГрафа27"]
					= СуммаГрафа27;
				СуммаГрафа27 = 0;
				Для каждого ЭлМассива Из Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела] Цикл
					Если ЭлМассива["КодОперации"] = КодОперации Тогда
					...
					КонецЕсли;
				КонецЦикла;
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа27"].Значение = СуммаГрафа27;
			КонецЕсли;
			...
			Если ЗначениеЗаполнено(ОбластьИмя)
				...
				СуммаГрафа28 = 0;
				Ном = 1;
				Пока Форма.ТабличныйДокумент.Области.Найти("П2000028_" + Формат(Ном, "ЧГ=")) <> Неопределено Цикл
					СуммаГрафа28 = СуммаГрафа28 + Форма.ТабличныйДокумент.Области["П2000028_" + Формат(Ном, "ЧГ=")].Значение;
					Ном = Ном + 1;
				КонецЦикла;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["КодОперации"]
					= КодОперации;
				...
				Для каждого ЭлМассива Из Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела] Цикл
					...
					КонецЕсли;
				КонецЦикла;
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа28"].Значение = СуммаГрафа28;
			КонецЕсли;
			
			Если ЗначениеЗаполнено(ОбластьИмя)
				И ((СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.ИтогоСуммаГрафа32, ОбластьИмя) > 0)
				ИЛИ (СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.ИтогоСуммаГрафа32,
				Лев(ОбластьИмя, Форма.СтруктураРеквизитовФормы.ДлинаИмениГрафы)) > 0)) Тогда
				...
				СуммаГрафа32 = 0;
				Ном = 1;
				Пока Форма.ТабличныйДокумент.Области.Найти("П2000032_" + Формат(Ном, "ЧГ=")) <> Неопределено Цикл
					СуммаГрафа32 = СуммаГрафа32 + Форма.ТабличныйДокумент.Области["П2000032_" + Формат(Ном, "ЧГ=")].Значение;
					Ном = Ном + 1;
				КонецЦикла;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["КодОперации"]
					= КодОперации;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["ИтогоСуммаГрафа32"]
					= СуммаГрафа32;
				СуммаГрафа32 = 0;
				Для каждого ЭлМассива Из Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела] Цикл
					Если ЭлМассива["КодОперации"] = КодОперации Тогда
					...
					КонецЕсли;
				КонецЦикла;
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа32"].Значение = СуммаГрафа32;
			КонецЕсли;
			
			Если ЗначениеЗаполнено(ОбластьИмя)
				И ((СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.ИтогоСуммаГрафа33, ОбластьИмя) > 0)
				ИЛИ (СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.ИтогоСуммаГрафа33,
				Лев(ОбластьИмя, Форма.СтруктураРеквизитовФормы.ДлинаИмениГрафы)) > 0)) Тогда
				...
				СуммаГрафа33 = 0;
				Ном = 1;
				Пока Форма.ТабличныйДокумент.Области.Найти("П2000033_" + Формат(Ном, "ЧГ=")) <> Неопределено Цикл
					СуммаГрафа33 = СуммаГрафа33 + Форма.ТабличныйДокумент.Области["П2000033_" + Формат(Ном, "ЧГ=")].Значение;
					Ном = Ном + 1;
				КонецЦикла;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["КодОперации"]
					= КодОперации;
				Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы - 1]["ИтогоСуммаГрафа33"]
					= СуммаГрафа33;
				СуммаГрафа33 = 0;
				Для каждого ЭлМассива Из Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела] Цикл
					Если ЭлМассива["КодОперации"] = КодОперации Тогда
					...
					КонецЕсли;
				КонецЦикла;
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа33"].Значение = СуммаГрафа33;
			КонецЕсли;
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Если Ветка = АктивнаяВетка Тогда
				...
				Для каждого Ветка_П10000 Из ДанныеМнЧ_П10000 Цикл
					...
					+ Формат(ДанныеМнЧ_П10000.Индекс(Ветка_П10000) + 1, "ЧГ=")].Значение);
					Ветка_П10000.Данные.Вставить("П1000013", Форма.ТабличныйДокумент.Области["П1000013_"
					+ Формат(ДанныеМнЧ_П10000.Индекс(Ветка_П10000) + 1, "ЧГ=")].Значение);
					Ветка_П10000.Данные.Вставить("П1000017", Форма.ТабличныйДокумент.Области["П1000017_"
					+ Формат(ДанныеМнЧ_П10000.Индекс(Ветка_П10000) + 1, "ЧГ=")].Значение);
			...
			Для каждого Ветка_П10000 Из ДанныеМнЧ_П10000 Цикл
				...
				СуммаГрафа12 = СуммаГрафа12 + Ветка_П10000.Данные["П1000012"];
				СуммаГрафа13 = СуммаГрафа13 + Ветка_П10000.Данные["П1000013"];
				СуммаГрафа17 = СуммаГрафа17 + Ветка_П10000.Данные["П1000017"];
				СуммаГрафа18 = СуммаГрафа18 + Ветка_П10000.Данные["П1000018"];
			КонецЦикла;
			...
			Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы]["ИтогоСуммаГрафа9"]
				= СуммаГрафа9;
			Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы]["ИтогоСуммаГрафа12"]
				= СуммаГрафа12;
			Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы]["ИтогоСуммаГрафа13"]
				= СуммаГрафа13;
			Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы]["ИтогоСуммаГрафа17"]
				= СуммаГрафа17;
			Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы]["ИтогоСуммаГрафа18"]
				= СуммаГрафа18;
			...
			Ветка.Данные["ИтогоСуммаГрафа12"] = СуммаГрафа12;
			Ветка.Данные["ИтогоСуммаГрафа13"] = СуммаГрафа13;
			Ветка.Данные["ИтогоСуммаГрафа17"] = СуммаГрафа17;
			Ветка.Данные["ИтогоСуммаГрафа18"] = СуммаГрафа18;
			...
			Если Ветка = АктивнаяВетка Тогда
				...
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа12"].Значение = Ветка.Данные["ИтогоСуммаГрафа12"];
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа13"].Значение = Ветка.Данные["ИтогоСуммаГрафа13"];
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа17"].Значение = Ветка.Данные["ИтогоСуммаГрафа17"];
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа18"].Значение = Ветка.Данные["ИтогоСуммаГрафа18"];
			КонецЕсли;
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Если Ветка = АктивнаяВетка Тогда
				...
				Для каждого Ветка_П20000 Из ДанныеМнЧ_П20000 Цикл
					Ветка_П20000.Данные.Вставить("П2000027", Форма.ТабличныйДокумент.Области["П2000027_"
					+ Формат(ДанныеМнЧ_П20000.Индекс(Ветка_П20000) + 1, "ЧГ=")].Значение);
					Ветка_П20000.Данные.Вставить("П2000028", Форма.ТабличныйДокумент.Области["П2000028_"
					+ Формат(ДанныеМнЧ_П20000.Индекс(Ветка_П20000) + 1, "ЧГ=")].Значение);
					Ветка_П20000.Данные.Вставить("П2000032", Форма.ТабличныйДокумент.Области["П2000032_"
					+ Формат(ДанныеМнЧ_П20000.Индекс(Ветка_П20000) + 1, "ЧГ=")].Значение);
					Ветка_П20000.Данные.Вставить("П2000033", Форма.ТабличныйДокумент.Области["П2000033_"
					+ Формат(ДанныеМнЧ_П20000.Индекс(Ветка_П20000) + 1, "ЧГ=")].Значение);
				КонецЦикла;
			КонецЕсли;
			...
			ДанныеМнЧ_П20000 = Ветка.ДанныеМногострочныхЧастей.П20000.Строки;
			Для каждого Ветка_П20000 Из ДанныеМнЧ_П20000 Цикл
				СуммаГрафа27 = СуммаГрафа27 + Ветка_П20000.Данные["П2000027"];
				СуммаГрафа28 = СуммаГрафа28 + Ветка_П20000.Данные["П2000028"];
				СуммаГрафа32 = СуммаГрафа32 + Ветка_П20000.Данные["П2000032"];
				СуммаГрафа33 = СуммаГрафа33 + Ветка_П20000.Данные["П2000033"];
			КонецЦикла;
			Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы]["ИтогоСуммаГрафа27"]
				= СуммаГрафа27;
			Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы]["ИтогоСуммаГрафа28"]
				= СуммаГрафа28;
			Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы]["ИтогоСуммаГрафа32"]
				= СуммаГрафа32;
			Форма.СтруктураРеквизитовФормы["ИтоговыеСуммыПоКодамОпераций_" + ИмяРаздела][НомСтраницы]["ИтогоСуммаГрафа33"]
				= СуммаГрафа33;
			...
			Ветка.Данные["ИтогоСуммаГрафа27"] = СуммаГрафа27;
			Ветка.Данные["ИтогоСуммаГрафа28"] = СуммаГрафа28;
			Ветка.Данные["ИтогоСуммаГрафа32"] = СуммаГрафа32;
			Ветка.Данные["ИтогоСуммаГрафа33"] = СуммаГрафа33;
			
			Если Ветка = АктивнаяВетка Тогда
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа27"].Значение = Ветка.Данные["ИтогоСуммаГрафа27"];
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа28"].Значение = Ветка.Данные["ИтогоСуммаГрафа28"];
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа32"].Значение = Ветка.Данные["ИтогоСуммаГрафа32"];
				Форма.ТабличныйДокумент.Области["ИтогоСуммаГрафа33"].Значение = Ветка.Данные["ИтогоСуммаГрафа33"];
			КонецЕсли;
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("ИтогоСуммаГрафа12", "П1000012");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("ИтогоСуммаГрафа13", "П1000013");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("ИтогоСуммаГрафа17", "П1000017");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("ИтогоСуммаГрафа18", "П1000018");
	
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("ИтогоСуммаГрафа27", "П2000027");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("ИтогоСуммаГрафа28", "П2000028");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("ИтогоСуммаГрафа32", "П2000032");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("ИтогоСуммаГрафа33", "П2000033");
...
Процедура Выгрузить(Команда)
	...
	|от 26.04.2021 № ЕД-7-15/419@, будет
...
Функция СравнениеОтчетовНаСервере(ДанныеДляСравнения)
	...
	ДеревьяДляСравнения.Вставить("ДеревоСравненияРеестра",  ИзвлечьСтруктуруXML("СхемаВыгрузки501_1"));
	ДеревьяДляСравнения.Вставить("ДеревоСравненияСведений", ИзвлечьСтруктуруXML("СхемаВыгрузки501_2"));
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ИмяКлючевогоУзлаСодержательнойЧасти", "РеестрАк201.19");
	
	ПараметрыВыгрузки.Вставить("ИдФайл", ИдентификаторФайлаВыгрузки(ПараметрыВыгрузки, "KO_RRAKZ.201.19"));
	
	ПараметрыВыгрузки.Вставить("ИдСведФайл", ИдентификаторФайлаВыгрузки(ПараметрыВыгрузки, "KO_RRAKZ.201.19.2"));
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузкиРеестра, ДеревоВыгрузкиСведений)
	...
	Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.ПериодОтч) Тогда
		...
		СтатусПроверки = Ложь;
	Иначе
		ВозмКодыПериода_Стр = "01,02,03,04,05,06,07,08,09,10,11,12,71,72,73,74,75,76,77,78,79,80,81,82";
		ВозмКодыПериода = СтрРазделить(ВозмКодыПериода_Стр, ",", Ложь);
		Если ВозмКодыПериода.Найти(ПараметрыВыгрузки.ПериодОтч) = Неопределено Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект,
			"Задано некорректное значение кода налогового периода", "Титульный", "Период");
			СтатусПроверки = Ложь;
		ИначеЕсли НЕ ПараметрыВыгрузки.ЭтоПБОЮЛ И ЗначениеЗаполнено(ПараметрыВыгрузки.КодФормРеорг)
			И НЕ (Лев(ПараметрыВыгрузки.ПериодОтч, 1) = "7" ИЛИ Лев(ПараметрыВыгрузки.ПериодОтч, 1) = "8") Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект,
			"Задано некорректное значение кода налогового периода при заполненном коде формы реорганизации (ликвидации)",
			"Титульный", "Период");
			СтатусПроверки = Ложь;
		ИначеЕсли НЕ ПараметрыВыгрузки.ЭтоПБОЮЛ И НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.КодФормРеорг)
			И НЕ (Лев(ПараметрыВыгрузки.ПериодОтч, 1) = "0" ИЛИ Лев(ПараметрыВыгрузки.ПериодОтч, 1) = "1") Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект,
			"Задано некорректное значение кода налогового периода при незаполненном коде формы реорганизации (ликвидации)",
			"Титульный", "Период");
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЕсли;
	...
	ЗаполненыРеестрыПоПродавцам   = ЗаполненРаздел(ДанныеМногоуровневыхРазделов["Таблица1"], "Таблица1");
	ЗаполненыРеестрыПоПокупателям = ЗаполненРаздел(ДанныеМногоуровневыхРазделов["Таблица2"], "Таблица2");
	
	Если НЕ ЗаполненыРеестрыПоПродавцам И НЕ ЗаполненыРеестрыПоПокупателям Тогда
		
		СообщитьВТС("Не заполнены реестры по продавцам и (или) реестры по покупателям", "Таблица1", "ИННКонтрагента", "1");
		СтатусПроверки = Ложь;
		
	КонецЕсли;
	
	Если ЗаполненыРеестрыПоПродавцам Тогда
		
		// Реестры по продавцам.
		//
		...
		Для каждого Ветка Из ДанныеРеестра.Строки Цикл
			...
			ИмяПок = "ИННКонтрагента";
			Если НЕ ЗначениеЗаполнено(Ветка.Данные[ИмяПок]) Тогда
				СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка
				+ ": не задан ИНН контрагента", "Таблица1", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли СтрДлина(СокрЛП(Ветка.Данные[ИмяПок])) <> 10 Тогда
				СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка
				+ ": задан ИНН контрагента, не состоящий из 10 цифр", "Таблица1", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			ИмяПок = "КППКонтрагента";
			Если НЕ ЗначениеЗаполнено(Ветка.Данные[ИмяПок]) Тогда
				СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка
				+ ": не задан КПП контрагента или ""-"" при отсутствии КПП", "Таблица1", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли СтрДлина(СокрЛП(Ветка.Данные[ИмяПок])) <> 9 И СокрЛП(Ветка.Данные[ИмяПок]) <> "-" Тогда
				СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка
				+ ": задан КПП контрагента, не состоящий из 9 символов", "Таблица1", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			ИмяПок = "НаименованиеКонтрагента";
			Если НЕ ЗначениеЗаполнено(Ветка.Данные[ИмяПок]) Тогда
				СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка
				+ ": не задано наименование контрагента", "Таблица1", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			...
			Если НЕ ЗначениеЗаполнено(Ветка.Данные[ИмяПок]) Тогда
				СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка
				+ ": не задан код вида подакцизного товара", "Таблица1", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли СтрДлина(СокрЛП(Ветка.Данные[ИмяПок])) <> 3 Тогда
				СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка
				+ ": задан код вида подакцизного товара, не состоящий из 3 цифр", "Таблица1", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			...
			Для каждого Ветка_П10000 Из ДанныеМнЧ_П10000 Цикл
				...
				Если ЗаполненаСтрокаМногострочнойЧасти(Ветка_П10000,
					СтрРазделить("П1000005,П1000006,П1000007,П1000008,П1000009", ",", Ложь)) Тогда
					
					ИмяПок = "П1000005";
					Если НЕ ЗначениеЗаполнено(Ветка_П10000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка + ": в строке "
						+ НомерСтрокиП10000_Строка + " по графе 5 не задано наименование документа",
						"Таблица1", ИмяПок + "_" + НомерСтрокиП10000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					Если НЕ ЗначениеЗаполнено(Ветка_П10000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка + ": в строке "
						+ НомерСтрокиП10000_Строка + " по графе 6 не задан номер документа или ""-"" при отсутствии номера",
						"Таблица1", ИмяПок + "_" + НомерСтрокиП10000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					Если НЕ ЗначениеЗаполнено(Ветка_П10000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка + ": в строке "
						+ НомерСтрокиП10000_Строка + " по графе 7 не задана дата документа",
						"Таблица1", ИмяПок + "_" + НомерСтрокиП10000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли НЕ ДатаВходитВРазрешенныйПериод(Ветка_П10000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка + ": в строке " + НомерСтрокиП10000_Строка
						+ " по графе 7 задана дата документа, выходящая за пределы периода с 01.01.1900 по 31.12.2099",
						"Таблица1", ИмяПок + "_" + НомерСтрокиП10000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
				...
				Если ЗаполненаСтрокаМногострочнойЧасти(Ветка_П10000,
					СтрРазделить("П1000010,П1000011,П1000012,П1000013", ",", Ложь)) Тогда
					
					ИмяПок = "П1000010";
					Если НЕ ЗначениеЗаполнено(Ветка_П10000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка + ": в строке "
						+ НомерСтрокиП10000_Строка + " по графе 10 не задан номер документа или ""-"" при отсутствии номера",
						"Таблица1", ИмяПок + "_" + НомерСтрокиП10000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					Если НЕ ЗначениеЗаполнено(Ветка_П10000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка + ": в строке "
						+ НомерСтрокиП10000_Строка + " по графе 11 не задана дата документа",
						"Таблица1", ИмяПок + "_" + НомерСтрокиП10000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли НЕ ДатаВходитВРазрешенныйПериод(Ветка_П10000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка + ": в строке " + НомерСтрокиП10000_Строка
						+ " по графе 11 задана дата документа, выходящая за пределы периода с 01.01.1900 по 31.12.2099",
						"Таблица1", ИмяПок + "_" + НомерСтрокиП10000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
				...
				Если ЗаполненаСтрокаМногострочнойЧасти(Ветка_П10000,
					СтрРазделить("П1000014,П1000015,П1000016,П1000017,П1000018", ",", Ложь)) Тогда
					
					ИмяПок = "П1000014";
					Если НЕ ЗначениеЗаполнено(Ветка_П10000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка + ": в строке "
						+ НомерСтрокиП10000_Строка + " по графе 14 не задано наименование документа",
						"Таблица1", ИмяПок + "_" + НомерСтрокиП10000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					Если НЕ ЗначениеЗаполнено(Ветка_П10000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка + ": в строке "
						+ НомерСтрокиП10000_Строка + " по графе 15 не задан номер документа или ""-"" при отсутствии номера",
						"Таблица1", ИмяПок + "_" + НомерСтрокиП10000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					Если НЕ ЗначениеЗаполнено(Ветка_П10000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка + ": в строке "
						+ НомерСтрокиП10000_Строка + " по графе 16 не задана дата документа",
						"Таблица1", ИмяПок + "_" + НомерСтрокиП10000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли НЕ ДатаВходитВРазрешенныйПериод(Ветка_П10000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по продавцам -> Страница " + НомерСтраницы_Строка + ": в строке " + НомерСтрокиП10000_Строка
						+ " по графе 16 задана дата документа, выходящая за пределы периода с 01.01.1900 по 31.12.2099",
						"Таблица1", ИмяПок + "_" + НомерСтрокиП10000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
	...
	Если ЗаполненыРеестрыПоПокупателям Тогда
		
		// Реестры по покупателям.
		//
		...
		Для каждого Ветка Из ДанныеРеестра.Строки Цикл
			...
			ИмяПок = "ИННКонтрагента";
			Если НЕ ЗначениеЗаполнено(Ветка.Данные[ИмяПок]) Тогда
				СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка
				+ ": не задан ИНН контрагента", "Таблица2", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли СтрДлина(СокрЛП(Ветка.Данные[ИмяПок])) <> 10 Тогда
				СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка
				+ ": задан ИНН контрагента, не состоящий из 10 цифр", "Таблица2", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			...
			Если НЕ ЗначениеЗаполнено(Ветка.Данные[ИмяПок]) Тогда
				СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка
				+ ": не задан КПП контрагента или ""-"" при отсутствии КПП", "Таблица2", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли СтрДлина(СокрЛП(Ветка.Данные[ИмяПок])) <> 9 И СокрЛП(Ветка.Данные[ИмяПок]) <> "-" Тогда
				СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка
				+ ": задан КПП контрагента, не состоящий из 9 символов", "Таблица2", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			...
			Если НЕ ЗначениеЗаполнено(Ветка.Данные[ИмяПок]) Тогда
				СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка
				+ ": не задано наименование контрагента", "Таблица2", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			...
			Если НЕ ЗначениеЗаполнено(Ветка.Данные[ИмяПок]) Тогда
				СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка
				+ ": не задан код вида подакцизного товара", "Таблица2", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли СтрДлина(СокрЛП(Ветка.Данные[ИмяПок])) <> 3 Тогда
				СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка
				+ ": задан код вида подакцизного товара, не состоящий из 3 цифр", "Таблица2", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			ИмяПок = "КодПоказателя";
			Если НЕ ЗначениеЗаполнено(Ветка.Данные[ИмяПок]) Тогда
				СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка
				+ ": не задан код показателя", "Таблица2", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			ИначеЕсли СтрДлина(СокрЛП(Ветка.Данные[ИмяПок])) <> 5 Тогда
				СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка
				+ ": задан код показателя, не состоящий из 5 цифр", "Таблица2", ИмяПок, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			...
			Для каждого Ветка_П20000 Из ДанныеМнЧ_П20000 Цикл
				...
				Если ЗаполненаСтрокаМногострочнойЧасти(Ветка_П20000,
					СтрРазделить("П2000024,П2000025,П2000026,П2000027,П2000028", ",", Ложь)) Тогда
					
					ИмяПок = "П2000024";
					Если НЕ ЗначениеЗаполнено(Ветка_П20000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка + ": в строке "
						+ НомерСтрокиП20000_Строка + " по графе 24 не задано наименование документа",
						"Таблица2", ИмяПок + "_" + НомерСтрокиП20000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					Если НЕ ЗначениеЗаполнено(Ветка_П20000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка + ": в строке "
						+ НомерСтрокиП20000_Строка + " по графе 25 не задан номер документа или ""-"" при отсутствии номера",
						"Таблица2", ИмяПок + "_" + НомерСтрокиП20000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					Если НЕ ЗначениеЗаполнено(Ветка_П20000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка + ": в строке "
						+ НомерСтрокиП20000_Строка + " по графе 26 не задана дата документа",
						"Таблица2", ИмяПок + "_" + НомерСтрокиП20000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли НЕ ДатаВходитВРазрешенныйПериод(Ветка_П20000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка + ": в строке " + НомерСтрокиП20000_Строка
						+ " по графе 26 задана дата документа, выходящая за пределы периода с 01.01.1900 по 31.12.2099",
						"Таблица2", ИмяПок + "_" + НомерСтрокиП20000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
				...
				Если ЗаполненаСтрокаМногострочнойЧасти(Ветка_П20000,
					СтрРазделить("П2000029,П2000030,П2000031,П2000032,П2000033", ",", Ложь)) Тогда
					
					ИмяПок = "П2000029";
					Если НЕ ЗначениеЗаполнено(Ветка_П20000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка + ": в строке "
						+ НомерСтрокиП20000_Строка + " по графе 29 не задано наименование документа",
						"Таблица2", ИмяПок + "_" + НомерСтрокиП20000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					Если НЕ ЗначениеЗаполнено(Ветка_П20000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка + ": в строке "
						+ НомерСтрокиП20000_Строка + " по графе 30 не задан номер документа или ""-"" при отсутствии номера",
						"Таблица2", ИмяПок + "_" + НомерСтрокиП20000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
					...
					Если НЕ ЗначениеЗаполнено(Ветка_П20000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка + ": в строке "
						+ НомерСтрокиП20000_Строка + " по графе 31 не задана дата документа",
						"Таблица2", ИмяПок + "_" + НомерСтрокиП20000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					ИначеЕсли НЕ ДатаВходитВРазрешенныйПериод(Ветка_П20000.Данные[ИмяПок]) Тогда
						СообщитьВТС("Реестры по покупателям -> Страница " + НомерСтраницы_Строка + ": в строке " + НомерСтрокиП20000_Строка
						+ " по графе 31 задана дата документа, выходящая за пределы периода с 01.01.1900 по 31.12.2099",
						"Таблица2", ИмяПок + "_" + НомерСтрокиП20000_Строка, НомерСтраницы);
						СтатусПроверки = Ложь;
					КонецЕсли;
...
&НаСервере
Функция ЗаполненаСтрокаМногострочнойЧасти(Знач СтрокаМнЧ, ИменаПроверяемыхПоказателей = Неопределено)
	
	Для каждого Пок Из СтрокаМнЧ.Данные Цикл
		
		Если ТипЗнч(ИменаПроверяемыхПоказателей) = Тип("Массив")
			И ИменаПроверяемыхПоказателей.Найти(Пок.Ключ) = Неопределено Тогда
			Продолжить;
		КонецЕсли;
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель)
	...
	ДеревоДанных1 = ДанныеМногоуровневыхРазделов["Таблица1"];
	ДеревоДанных2 = ДанныеМногоуровневыхРазделов["Таблица2"];
	
	РеестрАк201_19 = ПолучитьПодчиненныйЭлемент(УзелРодитель.Родитель, "РеестрАк201.19");
	
	РрАк201_19_123 = ПолучитьПодчиненныйЭлемент(РеестрАк201_19, "РрАк201.19.123");
	РрАк201_19_45  = ПолучитьПодчиненныйЭлемент(РеестрАк201_19, "РрАк201.19.45");
	
	// Вывод немногострочных данных.
	//
	ЗаполнитьДаннымиУзел(ДеревоДанных1.Строки[0].Данные, РрАк201_19_123);
	ЗаполнитьДаннымиУзел(ДеревоДанных2.Строки[0].Данные, РрАк201_19_45);
	
	// Атрибут "Индекс" имеется только в схеме выгрузки "Сведений".
	// Если он не найден, значит, сейчас формируются данные "Реестра" (для выгрузки первого из 2-х файлов).
	//
	Если ПолучитьПодчиненныйЭлемент(УзелРодитель.Родитель, "Индекс") = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	// Вывод иерархических данных.
	//
	РрАк201_19_123Пр = ПолучитьПодчиненныйЭлемент(РрАк201_19_123, "РрАк201.19.123Пр");
	Для каждого Ветка Из ДеревоДанных1.Строки Цикл
		
		ЭкзРрАк201_19_123Пр = СкопироватьУзел(РрАк201_19_123, РрАк201_19_123Пр, РрАк201_19_123.Строки.Количество() - 1);
		
		ЗаполнитьДаннымиУзел(Ветка.Данные, ПолучитьПодчиненныйЭлемент(ЭкзРрАк201_19_123Пр, "КонрагПр"));
		ЗаполнитьДаннымиУзел(Ветка.Данные, ПолучитьПодчиненныйЭлемент(ЭкзРрАк201_19_123Пр, "КодПТ"));
		
		ДанныеМнЧ_П10000 = Ветка.ДанныеМногострочныхЧастей.П10000.Строки;
		
		ДокПдтвВыч1 = ПолучитьПодчиненныйЭлемент(ЭкзРрАк201_19_123Пр, "ДокПдтвВыч1");
		Для каждого Ветка_П10000 Из ДанныеМнЧ_П10000 Цикл
			Если ЗаполненаСтрокаМногострочнойЧасти(Ветка_П10000,
				СтрРазделить("П1000005,П1000006,П1000007,П1000008,П1000009", ",", Ложь)) Тогда
				ЭкзДокПдтвВыч1 = СкопироватьУзел(ЭкзРрАк201_19_123Пр, ДокПдтвВыч1, ЭкзРрАк201_19_123Пр.Строки.Количество() - 1);
				Для каждого Эл Из ЭкзДокПдтвВыч1.Строки Цикл
					Если Эл.Код = "НомерДок" И НЕ ЗначениеЗаполнено(Ветка_П10000.Данные[Эл.Ключ]) Тогда
			...
			КонецЕсли;
		КонецЦикла;
		РегламентированнаяОтчетность.УдалитьУзел(ДокПдтвВыч1);
		
		СчФПдтвВыч2 = ПолучитьПодчиненныйЭлемент(ЭкзРрАк201_19_123Пр, "СчФПдтвВыч2");
		Для каждого Ветка_П10000 Из ДанныеМнЧ_П10000 Цикл
			Если ЗаполненаСтрокаМногострочнойЧасти(Ветка_П10000,
				СтрРазделить("П1000010,П1000011,П1000012,П1000013", ",", Ложь)) Тогда
				ЭкзСчФПдтвВыч2 = СкопироватьУзел(ЭкзРрАк201_19_123Пр, СчФПдтвВыч2, ЭкзРрАк201_19_123Пр.Строки.Количество() - 1);
				Для каждого Эл Из ЭкзСчФПдтвВыч2.Строки Цикл
					Если Эл.Код = "НомерДок" И НЕ ЗначениеЗаполнено(Ветка_П10000.Данные[Эл.Ключ]) Тогда
						ВывестиПоказательВXML(Эл, "-");
					Иначе
						ВывестиПоказательВXML(Эл, Ветка_П10000.Данные[Эл.Ключ]);
			...
			КонецЕсли;
		КонецЦикла;
		РегламентированнаяОтчетность.УдалитьУзел(СчФПдтвВыч2);
		
		ДокПдтвВыч3 = ПолучитьПодчиненныйЭлемент(ЭкзРрАк201_19_123Пр, "ДокПдтвВыч3");
		Для каждого Ветка_П10000 Из ДанныеМнЧ_П10000 Цикл
			Если ЗаполненаСтрокаМногострочнойЧасти(Ветка_П10000,
				СтрРазделить("П1000014,П1000015,П1000016,П1000017,П1000018", ",", Ложь)) Тогда
				ЭкзДокПдтвВыч3 = СкопироватьУзел(ЭкзРрАк201_19_123Пр, ДокПдтвВыч3, ЭкзРрАк201_19_123Пр.Строки.Количество() - 1);
				Для каждого Эл Из ЭкзДокПдтвВыч3.Строки Цикл
					Если Эл.Код = "НомерДок" И НЕ ЗначениеЗаполнено(Ветка_П10000.Данные[Эл.Ключ]) Тогда
						ВывестиПоказательВXML(Эл, "-");
					Иначе
						ВывестиПоказательВXML(Эл, Ветка_П10000.Данные[Эл.Ключ]);
			...
			КонецЕсли;
		КонецЦикла;
		РегламентированнаяОтчетность.УдалитьУзел(ДокПдтвВыч3);
		
	КонецЦикла;
	РегламентированнаяОтчетность.УдалитьУзел(РрАк201_19_123Пр);
	
	РрАк201_19_45Пок = ПолучитьПодчиненныйЭлемент(РрАк201_19_45, "РрАк201.19.45Пок");
	Для каждого Ветка Из ДеревоДанных2.Строки Цикл
		
		ЭкзРрАк201_19_45Пок = СкопироватьУзел(РрАк201_19_45, РрАк201_19_45Пок, РрАк201_19_45.Строки.Количество() - 1);
		
		ЗаполнитьДаннымиУзел(Ветка.Данные, ПолучитьПодчиненныйЭлемент(ЭкзРрАк201_19_45Пок, "КонрагПок"));
		ЗаполнитьДаннымиУзел(Ветка.Данные, ПолучитьПодчиненныйЭлемент(ЭкзРрАк201_19_45Пок, "КодПТ"));
		ЗаполнитьДаннымиУзел(Ветка.Данные, ПолучитьПодчиненныйЭлемент(ЭкзРрАк201_19_45Пок, "КодПок"));
		
		ДанныеМнЧ_П20000 = Ветка.ДанныеМногострочныхЧастей.П20000.Строки;
		
		ДокПдтвВыч4 = ПолучитьПодчиненныйЭлемент(ЭкзРрАк201_19_45Пок, "ДокПдтвВыч4");
		Для каждого Ветка_П20000 Из ДанныеМнЧ_П20000 Цикл
			Если ЗаполненаСтрокаМногострочнойЧасти(Ветка_П20000,
				СтрРазделить("П2000024,П2000025,П2000026,П2000027,П2000028", ",", Ложь)) Тогда
				ЭкзДокПдтвВыч4 = СкопироватьУзел(ЭкзРрАк201_19_45Пок, ДокПдтвВыч4, ЭкзРрАк201_19_45Пок.Строки.Количество() - 1);
				Для каждого Эл Из ЭкзДокПдтвВыч4.Строки Цикл
					Если Эл.Код = "НомерДок" И НЕ ЗначениеЗаполнено(Ветка_П20000.Данные[Эл.Ключ]) Тогда
						ВывестиПоказательВXML(Эл, "-");
					Иначе
						ВывестиПоказательВXML(Эл, Ветка_П20000.Данные[Эл.Ключ]);
					КонецЕсли;
				КонецЦикла;
			КонецЕсли;
		КонецЦикла;
		РегламентированнаяОтчетность.УдалитьУзел(ДокПдтвВыч4);
		
		ДокПдтвВыч5 = ПолучитьПодчиненныйЭлемент(ЭкзРрАк201_19_45Пок, "ДокПдтвВыч5");
		Для каждого Ветка_П20000 Из ДанныеМнЧ_П20000 Цикл
			Если ЗаполненаСтрокаМногострочнойЧасти(Ветка_П20000,
				СтрРазделить("П2000029,П2000030,П2000031,П2000032,П2000033", ",", Ложь)) Тогда
				ЭкзДокПдтвВыч5 = СкопироватьУзел(ЭкзРрАк201_19_45Пок, ДокПдтвВыч5, ЭкзРрАк201_19_45Пок.Строки.Количество() - 1);
				Для каждого Эл Из ЭкзДокПдтвВыч5.Строки Цикл
					Если Эл.Код = "НомерДок" И НЕ ЗначениеЗаполнено(Ветка_П20000.Данные[Эл.Ключ]) Тогда
						ВывестиПоказательВXML(Эл, "-");
					Иначе
						ВывестиПоказательВXML(Эл, Ветка_П20000.Данные[Эл.Ключ]);
			...
			КонецЕсли;
		КонецЦикла;
		РегламентированнаяОтчетность.УдалитьУзел(ДокПдтвВыч5);
		
	КонецЦикла;
	РегламентированнаяОтчетность.УдалитьУзел(РрАк201_19_45Пок);
...
Функция ВыгрузкаРеестра(ТекстВыгрузки, ПараметрыВыгрузки)
	...
	РезультатВыгрузки.Вставить("ТипФайлаВыгрузки", "РеестрАкцизыВычетыВиноматериалыВиногрИФруктСусло");
...
Функция ВыгрузкаСведений(ТекстВыгрузки, ПараметрыВыгрузки)
	...
	РезультатВыгрузки.Вставить("АдресФайлаВыгрузки", АдресВоВремХранилище);
	РезультатВыгрузки.Вставить("ТипФайлаВыгрузки", "РеестрАкцизыВычетыВиноматериалыВиногрИФруктСусло_Сведения");
	РезультатВыгрузки.Вставить("КодировкаФайлаВыгрузки", КодировкаФайлаВыгрузки);
...
Процедура ОткрытьФормуВыбораСтраниц(ВариантВыбора)
	...
	мПараметры.Вставить("ИмяОтчета", "РегламентированныйОтчетРеестрАкцизыВычетыВиноматериалыВиногрИФруктСусло");
...
Процедура ОчиститьНаСервере() Экспорт
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Таблица1"
...
Процедура ОчисткаРегламентированногоОтчетаНаСервере(ИмяСтраницы, ЗапускатьОтдельнуюОбработкуПослеОчисткиЛиста, РежимОчистки, Многостраничность, КолВоСтраницВРазделе) Экспорт
	...
	Если ИмяСтраницы = "Таблица1" ИЛИ ИмяСтраницы = "Таблица2" Тогда
...
Процедура ОчиститьТекущуюСтраницуЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Титульный" Тогда
		...
		ЗаполнитьПериодОтчета(ЭтотОбъект);
		УстановитьДоступностьОбластей(ЭтотОбъект, СтруктураРеквизитовФормы.НаимТекущегоРаздела);
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Таблица1"
		ИЛИ СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Таблица2" Тогда
		УправлениеВидимостьюСсылкиУдалитьСтраницу();
		СпрятатьЗначкиУдалитьСтроку();
		...
		Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Таблица1" Тогда
			...
			ЭлМассива["ИтогоСуммаГрафа12"] = 0;
			ЭлМассива["ИтогоСуммаГрафа13"] = 0;
			ЭлМассива["ИтогоСуммаГрафа17"] = 0;
			ЭлМассива["ИтогоСуммаГрафа18"] = 0;
		Иначе
			ЭлМассива["ИтогоСуммаГрафа27"] = 0;
			ЭлМассива["ИтогоСуммаГрафа28"] = 0;
			ЭлМассива["ИтогоСуммаГрафа32"] = 0;
			ЭлМассива["ИтогоСуммаГрафа33"] = 0;
		КонецЕсли;
...
Процедура ВывестиНаПечатьОтчет(СтруктураПараметров, ВыбранныеСтраницы, СтрПоля = Неопределено)
	...
	Если ВыбранныеСтраницы.Найти("Титульный") <> Неопределено Тогда
		...
		ИмяМакета = "ПечатныйБланк2021Кв4_Титульный";
	...
	Если ВыбранныеСтраницы.Найти("Таблица1") <> Неопределено Тогда
		
		ИмяМакета = "ПечатныйБланк2021Кв4_Таблица1";
		...
		ВыводитьСноску_Таблица1 = ВыбранныеСтраницы.Найти("Таблица2") = Неопределено;
		...
		ДеревоДанныхРаздела = ПолучитьИзВременногоХранилища(
		СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхТаблица1"]);
		...
		Для каждого Страница Из ДеревоДанныхРаздела.Строки Цикл
			...
			Для каждого Строка1 Из Строки1 Цикл
				...
				Если Строки1.Индекс(Строка1) = 0 Тогда
				...
				Если ВыводитьСноску_Таблица1 Тогда
					МассивПроверки.Добавить(Сноска);
				КонецЕсли;
				
				Если НЕ ПечФорма.ПроверитьВывод(МассивПроверки) Тогда
					
					Обл = ПечФорма.Область(ПечФорма.ВысотаТаблицы, 2, ПечФорма.ВысотаТаблицы, 5);
					Если Обл <> Неопределено Тогда
						Обл.ГраницаСнизу = Новый Линия(ТипЛинииЯчейкиТабличногоДокумента.Сплошная);
					КонецЕсли;
	...
	Если ВыбранныеСтраницы.Найти("Таблица2") <> Неопределено Тогда
		
		ИмяМакета = "ПечатныйБланк2021Кв4_Таблица2";
		...
		ДеревоДанныхРаздела = ПолучитьИзВременногоХранилища(
		СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхТаблица2"]);
		
		Подвал.Параметры.Заполнить(ДеревоДанныхРаздела.Строки[0].Данные);
		
		Для каждого Страница Из ДеревоДанныхРаздела.Строки Цикл
			
			Строки2 = Страница.ДанныеМногострочныхЧастей.П20000.Строки;
			...
			Для каждого Строка2 Из Строки2 Цикл
				...
				СтрокаДокумент.Параметры.Заполнить(Строка2.Данные);
				
				Если Строки2.Индекс(Строка2) = 0 Тогда
					СтрокаДокумент.Параметры.Заполнить(Страница.Данные);
				КонецЕсли;
				...
				Если НЕ ПечФорма.ПроверитьВывод(МассивПроверки) Тогда
					...
					Обл = ПечФорма.Область(ПечФорма.ВысотаТаблицы, 2, ПечФорма.ВысотаТаблицы, 6);
					Если Обл <> Неопределено Тогда
						Обл.ГраницаСнизу = Новый Линия(ТипЛинииЯчейкиТабличногоДокумента.Сплошная);
					КонецЕсли;
...
Процедура СформироватьДеревоРазделовОтчетаНаСервере()
	...
	Для Каждого ЭлементДереваСтраницОтчета Из мДеревоСтраницОтчета.ПолучитьЭлементы() Цикл
		...
		Если ЭлементДереваСтраницОтчета.ПоказатьСтраницу = 1 Тогда
			...
			Если ЭлементРазделовОтчета.КолонкаРазделыОтчетаСокрНаим = "Таблица1"
				ИЛИ ЭлементРазделовОтчета.КолонкаРазделыОтчетаСокрНаим = "Таблица2" Тогда
				...
				Для НомерСтраницыРеестр = 1 По КолСтрокВДеревеДанныхРеестр Цикл
					...
					ЭлементРеестр.КолонкаРазделыОтчетаСокрНаим
						= ?(ЭлементРазделовОтчета.КолонкаРазделыОтчетаСокрНаим = "Таблица1", "Таблица1", "Таблица2");
...
Процедура РазделыОтчетаПриАктивизацииСтроки(Элемент)
	...
	Если СтруктураРеквизитовФормы.ВыводитьСтраницуВТаблДокНаСервере Тогда
		...
		Если Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Таблица1"
