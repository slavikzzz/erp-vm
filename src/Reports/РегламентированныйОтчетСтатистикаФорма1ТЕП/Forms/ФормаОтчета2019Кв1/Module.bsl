...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "05/08/2019";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Для Гр = 4 По 5 Цикл 
		ГрСтр = "0" + Гр;
		Области["П01123" + ГрСтр].Значение = 0;
		Для Стр = 124 По 127 Цикл
			Области["П01123" + ГрСтр].Значение = Области["П01123" + ГрСтр].Значение + Области["П01" + Стр + ГрСтр].Значение;
		КонецЦикла;
		Области["П01099" + ГрСтр].Значение = 0;
		Для Стр = 100 По 103 Цикл
			Области["П01099" + ГрСтр].Значение = Области["П01099" + ГрСтр].Значение + Области["П01" + Стр + ГрСтр].Значение;
		КонецЦикла;
		Области["П01098" + ГрСтр].Значение = Области["П01099" + ГрСтр].Значение + Области["П01104" + ГрСтр].Значение;
		Области["П01078" + ГрСтр].Значение = 0;
		Для Стр = 79 По 82 Цикл
			Области["П01078" + ГрСтр].Значение = Области["П01078" + ГрСтр].Значение + Области["П010" + Стр + ГрСтр].Значение;
		КонецЦикла;
		Области["П01073" + ГрСтр].Значение = 0;
		Для Стр = 74 По 77 Цикл
			Области["П01073" + ГрСтр].Значение = Области["П01073" + ГрСтр].Значение + Области["П010" + Стр + ГрСтр].Значение;
		КонецЦикла;
		Области["П01068" + ГрСтр].Значение = 0;
		Для Стр = 69 По 72 Цикл
			Области["П01068" + ГрСтр].Значение = Области["П01068" + ГрСтр].Значение + Области["П010" + Стр + ГрСтр].Значение;
		КонецЦикла;
		Области["П01063" + ГрСтр].Значение = 0;
		Для Стр = 64 По 67 Цикл
			Области["П01063" + ГрСтр].Значение = Области["П01063" + ГрСтр].Значение + Области["П010" + Стр + ГрСтр].Значение;
		КонецЦикла;
	КонецЦикла;
КонецПроцедуры
