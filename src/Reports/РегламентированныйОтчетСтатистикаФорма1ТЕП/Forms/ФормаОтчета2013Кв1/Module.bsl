...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "28/01/2014";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.П040.Значение = Форма.ПолеТабличногоДокументаФормаОтчета.Области.П041.Значение
																	+ Форма.ПолеТабличногоДокументаФормаОтчета.Области.П042.Значение
																	+ Форма.ПолеТабличногоДокументаФормаОтчета.Области.П043.Значение
																	+ Форма.ПолеТабличногоДокументаФормаОтчета.Области.П044.Значение;
	Форма.ПолеТабличногоДокументаФормаОтчета.Области.П039.Значение = Форма.ПолеТабличногоДокументаФормаОтчета.Области.П040.Значение
																	+ Форма.ПолеТабличногоДокументаФормаОтчета.Области.П045.Значение;
КонецПроцедуры
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	СоответвиеСумм = Новый Соответствие;
	
	МассивСумм = Новый Массив;
	МассивСумм.Добавить(2);
	МассивСумм.Добавить(3);
	МассивСумм.Добавить(4);
	СоответвиеСумм.Вставить(1, МассивСумм);
	
	МассивСумм = Новый Массив;
	МассивСумм.Добавить(12);
	МассивСумм.Добавить(13);
	МассивСумм.Добавить(14);
	СоответвиеСумм.Вставить(11, МассивСумм);
	
	МассивСумм = Новый Массив;
	МассивСумм.Добавить(19);
	МассивСумм.Добавить(20);
	МассивСумм.Добавить(21);
	СоответвиеСумм.Вставить(18, МассивСумм);
	
	МассивСумм = Новый Массив;
	МассивСумм.Добавить(24);
	МассивСумм.Добавить(25);
	МассивСумм.Добавить(26);
	СоответвиеСумм.Вставить(23, МассивСумм);
	
	МассивСумм = Новый Массив;
	МассивСумм.Добавить(35);
	МассивСумм.Добавить(36);
	МассивСумм.Добавить(37);
	СоответвиеСумм.Вставить(34, МассивСумм);
	
	МассивСумм = Новый Массив;
	МассивСумм.Добавить(47);
	МассивСумм.Добавить(48);
	СоответвиеСумм.Вставить(46, МассивСумм);
	
	МассивСумм = Новый Массив;
	МассивСумм.Добавить(27);
	СоответвиеСумм.Вставить(23, МассивСумм);
	
	МассивСумм = Новый Массив;
	МассивСумм.Добавить(28);
	СоответвиеСумм.Вставить(27, МассивСумм);
	
	МассивСумм = Новый Массив;
	МассивСумм.Добавить(30);
	СоответвиеСумм.Вставить(29, МассивСумм);
	
	МассивСумм = Новый Массив;
	МассивСумм.Добавить(40);
	СоответвиеСумм.Вставить(39, МассивСумм);
	
	МассивСумм = Новый Массив;
	МассивСумм.Добавить(68);
	СоответвиеСумм.Вставить(67, МассивСумм);
	
	Для Каждого КЗ из СоответвиеСумм Цикл
		СтрКлюч = Формат(КЗ.Ключ, "ЧЦ=2; ЧВН=; ЧГ=;");
		МассивСумм = КЗ.Значение;
		ЗначБР = Показатели["П0"+СтрКлюч];
		ЗначМР = Показатели["П0"+Формат(МассивСумм[0], "ЧЦ=2; ЧВН=; ЧГ=;")];
		ТекстФормулы = "стр." + СтрКлюч + " >= стр." + Формат(МассивСумм[0], "ЧЦ=2; ЧВН=; ЧГ=;");
		Описание = "стр." + СтрКлюч + " < стр." + Формат(МассивСумм[0], "ЧЦ=2; ЧВН=; ЧГ=;");
		Расшифровка = Строка(ЗначБР) + " >= " + Строка(Показатели["П0"+Формат(МассивСумм[0], "ЧЦ=2; ЧВН=; ЧГ=;")]);
		Для Инд = 1 По МассивСумм.Количество() - 1 Цикл
			ЗначМР = ЗначМР + Показатели["П0"+Формат(МассивСумм[Инд], "ЧЦ=2; ЧВН=; ЧГ=;")];
			ТекстФормулы = ТекстФормулы + "+стр." + Формат(МассивСумм[Инд], "ЧЦ=2; ЧВН=; ЧГ=;");
			Описание = Описание + "+стр." + Формат(МассивСумм[Инд], "ЧЦ=2; ЧВН=; ЧГ=;");
			Расшифровка = Расшифровка + "+" + Строка(Показатели["П0"+Формат(МассивСумм[Инд], "ЧЦ=2; ЧВН=; ЧГ=;")]);
		КонецЦикла;
		
		Если ЗначБР >= ЗначМР Тогда
			ЭтоОшибка = Ложь;
	...
	Зн67 = Показатели["П067"];
	Зн34 = Показатели["П034"];
	Зн38 = Показатели["П038"];
	Зн39 = Показатели["П039"];
	
	ТекстФормулы = "стр.67 <= стр.34+стр.38-стр.39";
	Описание = "стр.67 > стр.34+стр.38-стр.39";
	Расшифровка = Строка(Зн67)+"<="+Строка(Зн34)+"+"+Строка(Зн38)+"-"+Строка(Зн39);
	Если Зн67 <= Зн34+Зн38-Зн39 Тогда
		ЭтоОшибка = Ложь;
		ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
	Иначе
		ЭтоОшибка = Истина;
