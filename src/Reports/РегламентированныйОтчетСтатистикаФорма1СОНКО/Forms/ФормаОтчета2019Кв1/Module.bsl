	...
	Если СтруктураРеквизитовФормы.мСохраненныйДок = Неопределено Тогда
		...
		Иначе
			Для Инд = 1 По 32 Цикл 
				ПолеТабличногоДокументаФормаОтчета.Области["П010" + Формат(Инд, "ЧЦ=2; ЧВН=") + "03"].Значение = 
					Формат(Инд, "ЧЦ=2; ЧВН=");
			КонецЦикла;
		КонецЕсли;
...
Процедура ПоказатьПериод()
	...
	СтруктураРеквизитовФормы.СтрПериодОтчета =
		Нрег(Формат(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, "ДФ='yyyy'") + " г.");
...
Процедура ОчиститьТабличноеПоле(Форма)
	...
	Для Инд = 1 По 32 Цикл 
		ВыбТабличноеПоле.Области["П010" + Формат(Инд, "ЧЦ=2; ЧВН=") + "03"].Значение = Формат(Инд, "ЧЦ=2; ЧВН=");
	КонецЦикла;
...
Процедура Расчет(ПолеТабличногоДокументаФормаОтчета) 
	...
	Области["П0206903"].Значение = Области["П0204003"].Значение + Области["П0204203"].Значение
		+ Области["П0204303"].Значение + Области["П0204503"].Значение
		+ Области["П0204703"].Значение + Области["П0204903"].Значение
		+ Области["П0205203"].Значение + Области["П0205403"].Значение
		+ Области["П0205703"].Значение + Области["П0206003"].Значение
		+ Области["П0206103"].Значение + Области["П0206203"].Значение
		+ Области["П0206303"].Значение + Области["П0206603"].Значение
		+ Области["П0206703"].Значение + Области["П0206803"].Значение;
	Области["П0206904"].Значение = Области["П0204004"].Значение + Области["П0204204"].Значение
		+ Области["П0204304"].Значение + Области["П0204504"].Значение
		+ Области["П0204704"].Значение + Области["П0204904"].Значение
		+ Области["П0205204"].Значение + Области["П0205404"].Значение
		+ Области["П0205704"].Значение + Области["П0206004"].Значение
		+ Области["П0206104"].Значение + Области["П0206204"].Значение
		+ Области["П0206304"].Значение + Области["П0206604"].Значение
		+ Области["П0206704"].Значение + Области["П0206804"].Значение;
	Области["П0409103"].Значение = Области["П0409203"].Значение + Области["П0409303"].Значение
		+ Области["П0409403"].Значение + Области["П0409503"].Значение + Области["П0409603"].Значение;
	Области["П0409104"].Значение = Области["П0409204"].Значение + Области["П0409304"].Значение
		+ Области["П0409404"].Значение + Области["П0409504"].Значение + Области["П0409604"].Значение;
КонецПроцедуры
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Если СтрНачинаетсяС(Область.Имя, "П010") Тогда
...
Функция СформироватьСтруктуруПараметров() Экспорт 
	...
	Для Инд = 1 по 32 Цикл
		КлючИмя = "ПВ01" + Формат(Инд, "ЧЦ=2; ЧВН=") + "03";
		Показатель = мДанныеОтчета.ПолеТабличногоДокументаФормаОтчета["П010" + Формат(Инд, "ЧЦ=2; ЧВН=") + "03"];
		ПараметрыВыгрузки.Вставить(КлючИмя, ?(СтрНачинаетсяС(Показатель, "("), 1, 0));
	КонецЦикла;
