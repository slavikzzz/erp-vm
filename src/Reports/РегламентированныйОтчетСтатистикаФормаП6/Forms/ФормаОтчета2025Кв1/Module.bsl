...
Процедура ДоступностьРазделов()
	...
	Если НЕ (Месяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = 1
	   И Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета)  = 6) Тогда
		Для Стр = 70 По 80 Цикл
			Для Гр = 3 По 4 Цикл
				ЯчейкаИмя = "П0300" + Стр + Формат(Гр, "ЧЦ=3; ЧВН=");
...
Перем СтруктураГруппы;
	...
	СтрФорматаОкр1       = "ЧЦ = 17; ЧДЦ = " + Форма.СтруктураРеквизитовФормы.ТочностьЕдиницыИзмерения + "; ЧРД=,; ЧН=' '; ЧС = 0";
	СтрФорматаОкр1000    = "ЧЦ = 17; ЧДЦ = " + Форма.СтруктураРеквизитовФормы.ТочностьЕдиницыИзмерения + "; ЧРД=,; ЧН=' '; ЧС = 3";
	СтрФорматаОкр1000000 = "ЧЦ = 17; ЧДЦ = " + Форма.СтруктураРеквизитовФормы.ТочностьЕдиницыИзмерения + "; ЧРД=,; ЧН=' '; ЧС = 6";
...
Процедура ПоказатьПериод()
	...
	ПериодОтчета =
		НРег("за январь - " + Формат(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, "ДФ = 'ММММ гггг'") + " г.");
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Для Стр = 10 По 461 Цикл
		...
		Области[ИмяОблНач+"08"].Значение
			= Области[ИмяОблНач + "03"].Значение + Области[ИмяОблНач+"04"].Значение
			+ Области[ИмяОблНач + "06"].Значение + Области[ИмяОблНач+"07"].Значение
			- Области[ИмяОблНач + "05"].Значение;
	КонецЦикла;
	
	Для Стр = 500 По 690 Цикл
	...
	Для Гр = 1 По 7 Цикл
		...
		Области["П0100010" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П0100020" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П0100030" + ГрСтр].Значение);
		
		Области["П0100040" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П0100050" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П0100060" + ГрСтр].Значение);
		
		Области["П0100080" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П0100090" + ГрСтр].Значение)
		...
		Области["П01000140" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П01000150" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П01000160" + ГрСтр].Значение);
		
		Области["П01000180" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П01000190" + ГрСтр].Значение)
		...
		Области["П01000250" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П01000260" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П01000270" + ГрСтр].Значение);
			
		Области["П01000290" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П01000300" + ГрСтр].Значение)
		...
		Области["П01000325" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П01000326" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П01000328" + ГрСтр].Значение);
		
		Области["П01000330" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П01000340" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П01000350" + ГрСтр].Значение);
		
		Области["П01000370" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П01000380" + ГрСтр].Значение)
	...
	Для Гр = 1 По 6 Цикл
		...
		//620= (стр. 630 + стр. 640 + стр. 650 + стр. 660+ стр. 670 + стр. 680 + стр. 690)
		Области["П02000620" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П02000630" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П02000640" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П02000650" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П02000660" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П02000670" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П02000680" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П02000690" + ГрСтр].Значение);
			
		//600 = (стр. 610 + стр. 620)
		Области["П02000600" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П02000610" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П02000620" + ГрСтр].Значение);
		
		//520 = (стр. 530 + стр. 540 + стр. 550 + стр. 560 + стр. 570 + стр. 580 + стр. 590)
		Области["П02000520" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П02000530" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П02000540" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П02000550" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П02000560" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П02000570" + ГрСтр].Значение)
		...
		//500 = (стр. 510 + стр. 520)
		Области["П02000500" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П02000510" + ГрСтр].Значение)
			+ ОкруглитьЧислоПоФормату(Форма, Области["П02000520" + ГрСтр].Значение);
	...
	Для Гр = 1 По 2 Цикл
		...
		Области["П0300730" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П0300740" + ГрСтр].Значение)
		...
		Области["П0300710" + ГрСтр].Значение
			= ОкруглитьЧислоПоФормату(Форма, Области["П0300720" + ГрСтр].Значение)
...
Функция ОкруглитьЧислоПоФормату(Форма, ИсходноеЧисло)
	...
	ОкругленноеЧисло =
		Окр(ИсходноеЧисло / Форма.СтруктураРеквизитовФормы.мДелитель, 1) * Форма.СтруктураРеквизитовФормы.мДелитель;
	...
	Иначе
		...
		Иначе
			...
			Если НЕ НайденнаяОбласть = Неопределено Тогда
				Элементы[ИмяПоляТабличногоДокумента].ТекущаяОбласть = НайденнаяОбласть;
			Иначе
				Ячейка.ИмяЯчейки = ?(СтрНачинаетсяС(Ячейка.ИмяЯчейки, "ПД"), "П0" + Сред(Ячейка.ИмяЯчейки, 3), Ячейка.ИмяЯчейки);
...
Процедура ПроверитьТочность()
	Если СтруктураРеквизитовФормы.ЕдиницаИзмерения = ПорядкиОкругленияОтчетности.ПеречислениеПорядкиОкругленияОтчетностиОкр1 Тогда
		Если СтруктураРеквизитовФормы.ТочностьЕдиницыИзмерения > 2 Тогда
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru = 'Баланс: при выводе сумм в рублях точность не может превышать 2 знака';
															|en = 'Баланс: при выводе сумм в рублях точность не может превышать 2 знака'"));
			СтруктураРеквизитовФормы.ТочностьЕдиницыИзмерения = 2;
		КонецЕсли;
	ИначеЕсли СтруктураРеквизитовФормы.ЕдиницаИзмерения = ПорядкиОкругленияОтчетности.ПеречислениеПорядкиОкругленияОтчетностиОкр1000 Тогда
		Если СтруктураРеквизитовФормы.ТочностьЕдиницыИзмерения > 3 Тогда
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru = 'Баланс: при выводе сумм в тысячах рублей точность не может превышать 3 знака';
	...
	ИначеЕсли СтруктураРеквизитовФормы.ЕдиницаИзмерения = ПорядкиОкругленияОтчетности.ПеречислениеПорядкиОкругленияОтчетностиОкр1000000 Тогда
		Если СтруктураРеквизитовФормы.ТочностьЕдиницыИзмерения > 6 Тогда
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru = 'Баланс: при выводе сумм в миллионах рублей точность не может превышать 6 знаков';
...
Функция СформироватьСтруктуруПараметров() Экспорт 
	...
	Если ТабДокумент.Свойство("ЧНП030080003") И Найти(ТабДокумент.ЧНП030080003, "ЧН=0") > 0 Тогда
		ПараметрыВыгрузки.Вставить("ЧНПД30080003", "ЧН=0");
	КонецЕсли;
	ПараметрыВыгрузки.Вставить("ПД30080003", (ТабДокумент.П030080003));
	
	Если ТабДокумент.Свойство("ЧНП030080004") И Найти(ТабДокумент.ЧНП030080004, "ЧН=0") > 0 Тогда
		ПараметрыВыгрузки.Вставить("ЧНПД30080004", "ЧН=0");
	КонецЕсли;
	ПараметрыВыгрузки.Вставить("ПД30080004", (ТабДокумент.П030080004));
...
Функция СформироватьПараметрыВыбораОтчетаПредыдущегоПериода() Экспорт 
	...
	Парам.Вставить("ИсточникОтчета", "РегламентированныйОтчетСтатистикаФормаП6");
	Парам.Вставить("ВидОтправляемогоДокумента",
				   ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.СтатистикаФормаП6"));
