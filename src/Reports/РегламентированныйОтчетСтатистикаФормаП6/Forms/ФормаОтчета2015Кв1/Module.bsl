...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "03/03/2015";
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	Для Гр = 1 По 7 Цикл
		...
		ТекстФормулы = "стр. 010 >= стр. 040 по гр. " + Гр;
		Описание     = "стр. 010 < стр. 040 по гр. " + Гр;
		ЛеваяЧасть  = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П01000100" + (Гр+2)]);
		ПраваяЧасть = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П01000400" + (Гр+2)]);
	...
	Для Гр = 1 По 7 Цикл
		...
		ТекстФормулы = "стр. 040 >= стр. 070 по гр. " + Гр;
		Описание     = "стр. 040 < стр. 070 по гр. " + Гр;
		ЛеваяЧасть  = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П01000400" + (Гр+2)]);
		ПраваяЧасть = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П01000700" + (Гр+2)]);
		Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " " + Строка(ПраваяЧасть);
	...
	Для Гр = 1 По 7 Цикл
		...
		ТекстФормулы = "стр. 140 >= стр. 170 по гр. " + Гр;
		Описание     = "стр. 140 < стр. 170 по гр. " + Гр;
		ЛеваяЧасть  = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010001400" + (Гр+2)]);
		ПраваяЧасть = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010001700" + (Гр+2)]);
		Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " " + Строка(ПраваяЧасть);
	...
	Для Гр = 1 По 7 Цикл
		...
		ТекстФормулы = "стр. 250 >= стр. 280 по гр. " + Гр;
		Описание     = "стр. 250 < стр. 280 по гр. " + Гр;
		ЛеваяЧасть  = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010002500" + (Гр+2)]);
		ПраваяЧасть = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010002800" + (Гр+2)]);
		Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " " + Строка(ПраваяЧасть);
	...
	Для Гр = 1 По 7 Цикл
		...
		ТекстФормулы = "стр. 326 >= стр. 327 по гр. " + Гр;
		Описание     = "стр. 326 < стр. 327 по гр. " + Гр;
		ЛеваяЧасть  = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010003260" + (Гр+2)]);
		ПраваяЧасть = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010003270" + (Гр+2)]);
		Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " " + Строка(ПраваяЧасть);
	...
	Для Гр = 1 По 7 Цикл
		...
		ТекстФормулы = "стр. 328 >= стр. 329 по гр. " + Гр;
		Описание     = "стр. 328 < стр. 329 по гр. " + Гр;
		ЛеваяЧасть  = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010003280" + (Гр+2)]);
		ПраваяЧасть = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010003290" + (Гр+2)]);
		Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " " + Строка(ПраваяЧасть);
	...
	Для Гр = 1 По 7 Цикл
		...
		ТекстФормулы = "стр. 330 >= стр. 360 по гр. " + Гр;
		Описание     = "стр. 330 < стр. 360 по гр. " + Гр;
		ЛеваяЧасть  = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010003300" + (Гр+2)]);
		ПраваяЧасть = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010003600" + (Гр+2)]);
		Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " " + Строка(ПраваяЧасть);
	...
	Для Гр = 1 По 7 Цикл
		...
		ТекстФормулы = "стр. 330 >= стр. 370 по гр. " + Гр;
		Описание     = "стр. 330 < стр. 370 по гр. " + Гр;
		ЛеваяЧасть  = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010003300" + (Гр+2)]);
		ПраваяЧасть = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010003700" + (Гр+2)]);
		Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " " + Строка(ПраваяЧасть);
	...
	Для Гр = 1 По 6 Цикл
		...
		ТекстФормулы = "стр. 440 >= стр. 441 по гр. " + Гр;
		Описание     = "стр. 440 < стр. 441 по гр. " + Гр;
		ЛеваяЧасть  = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010004400" + (Гр+2)]);
		ПраваяЧасть = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010004410" + (Гр+2)]);
		Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " " + Строка(ПраваяЧасть);
	...
	Для Гр = 1 По 6 Цикл
		...
		ТекстФормулы = "стр. 460 >= стр. 461 по гр. " + Гр;
		Описание     = "стр. 460 < стр. 461 по гр. " + Гр;
		ЛеваяЧасть  = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010004600" + (Гр+2)]);
		ПраваяЧасть = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П010004610" + (Гр+2)]);
		Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " " + Строка(ПраваяЧасть);
	...
	Для Гр = 1 По 6 Цикл
		...
		ТекстФормулы = "стр. 510 >= стр. 520 по гр. " + Гр;
		Описание     = "стр. 510 < стр. 520 по гр. " + Гр;
		ЛеваяЧасть  = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П020005100" + (Гр+2)]);
		ПраваяЧасть = ОкруглитьЧислоПоФормату(ЭтаФорма, Показатели["П020005200" + (Гр+2)]);
		Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " " + Строка(ПраваяЧасть);
