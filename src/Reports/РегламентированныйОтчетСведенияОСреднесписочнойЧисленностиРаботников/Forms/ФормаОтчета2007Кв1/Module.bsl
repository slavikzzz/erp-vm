...
Процедура ЗаполнитьДатуПериода()
	...
	Если Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) < 2020 Тогда
		СтруктураРеквизитовФормы.ДатаПериод.Добавить(1, НСтр("ru = ' 1 января ';
															|en = ' 1 января '") + ТекущийГод);
	Конецесли;
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(12, НСтр("ru = ' 1 декабря ';
															|en = ' 1 декабря '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(11, НСтр("ru = ' 1 ноября ';
															|en = ' 1 ноября '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(10, НСтр("ru = ' 1 октября ';
															|en = ' 1 октября '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(9, НСтр("ru = ' 1 сентября ';
														|en = ' 1 сентября '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(8, НСтр("ru = ' 1 августа ';
														|en = ' 1 августа '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(7, НСтр("ru = ' 1 июля ';
														|en = ' 1 июля '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(6, НСтр("ru = ' 1 июня ';
														|en = ' 1 июня '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(5, НСтр("ru = ' 1 мая ';
														|en = ' 1 мая '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(4, НСтр("ru = ' 1 апреля ';
														|en = ' 1 апреля '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(3, НСтр("ru = ' 1 марта ';
														|en = ' 1 марта '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(2, НСтр("ru = ' 1 февраля ';
														|en = ' 1 февраля '") + ОтчетныйГод);
