...
Процедура ПриОткрытии(Отказ)
	...
	Заголовок = "Оборот спиртосодержащих лекарственных препаратов / медицинских изделий";
...
Процедура ДоступностьПолейНаСервере()
	...
	Элементы.П000010000305.ТолькоПросмотр = НЕ ФлажокОтклАвтоРасчет;
	...
	Элементы.П000010000305.ПропускатьПриВводе = НЕ ФлажокОтклАвтоРасчет;
