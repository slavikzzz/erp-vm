...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	Если Не РезультатЗапроса.Пустой() Тогда
		...
		Исключение
			...
			ЭлектронноеВзаимодействие.ОбработатьОшибку(НСтр("ru = 'Обновление настроек отправки';
															|en = 'Update dispatch settings'"), ОбработкаОшибок.ПодробноеПредставлениеОшибки(Информация),
				НСтр("ru = 'Не удалось обновить настройки отправки электронных документов';
					|en = 'Cannot update electronic document dispatch settings'"));
