...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Попытка
		ДатаПоследнегоИзменения = СинхронизацияЭДО.ДатаПоследнегоИзмененияДанныхСервисаНастроек(
			Перечисления.ТипыСинхронизацииСервисаНастроекЭДО.СинхронизацияФорматовЭД);
	...
	Исключение		
		...
		ТекстСообщения = НСтр("ru = 'Не удалось заполнить кеши форматов электронных документов по причине:';
								|en = 'Cannot fill caches of electronic document formats due to:'") + Символы.ПС 
