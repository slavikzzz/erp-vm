...
Процедура ДобавитьСкидкуТорговогоПредложения(ТорговоеПредложение, Скидка, Отказ, Удалить) Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Добавление скидки торгового предложения';
				|en = 'Add a selling proposition discount'", ОбщегоНазначения.КодОсновногоЯзыка()), 
