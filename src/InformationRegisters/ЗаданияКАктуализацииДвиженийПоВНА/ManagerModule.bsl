...
Функция УвеличитьНомерЗадания() Экспорт
	...
	Возврат ЗакрытиеМесяцаСервер.УвеличитьНомерЗадания(Метаданные.Константы.НомерЗаданияКАктуализацииДвиженийПоВНА.Имя);
...
Функция ЗаданияКРасчету(НачалоПериода, ОкончаниеПериода, НомерЗаданияДоРасчета, Организации) Экспорт
	...
	|
	|ИЗ
	|	РегистрСведений.ЗаданияКАктуализацииДвиженийПоВНА КАК Задания
	|
	|ГДЕ
...
Функция ТекущийНомерЗадания()
	...
	УстановитьПривилегированныйРежим(Истина);
	ТекущийНомерЗадания = Константы.НомерЗаданияКАктуализацииДвиженийПоВНА.Получить();
...
Процедура СоздатьЗаписьРегистра(ПериодЗадания, ДокументЗадания, Организация, ОбъектУчета, НомерЗадания)
	...
	Попытка
		...
		НаборЗаписей = РегистрыСведений.ЗаданияКАктуализацииДвиженийПоВНА.СоздатьМенеджерЗаписи();
