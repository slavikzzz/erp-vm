...
Процедура ПриОткрытии(Отказ)
	...
	Если СтрНайти(ИмяФормыВладельца, "РегламентированныйОтчетАлкоПриложение25") = 0 Тогда
	
		Элементы.ГруппаВидПродажи.Видимость = Ложь;
		
	Иначе
		
		ГодОтчета = Год(УправляемаяФормаВладелец.СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета);
