...
Процедура ЗаполнитьЗначенияРегистраЕМРЦ() Экспорт
	...
	Исключение
		...
		ОбщегоНазначенияБПО.ЗаписатьОшибкуВЖурналРегистрации(
			НСтр("ru = 'Ошибка заполнения предопределенных элементов ЕМРЦ.';
				|en = 'An error occurred when filling predefined items of the unified minimum retail price.'", ОбщегоНазначенияБПО.КодОсновногоЯзыка()));
		ВызватьИсключение;
