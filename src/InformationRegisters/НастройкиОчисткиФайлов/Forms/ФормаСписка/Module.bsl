...
Процедура НастроитьРежимыОчисткиФайлов()
	...
	Элементы.АвтоматическиОчищатьНенужныеФайлы.Заголовок = ?(ИспользоватьТома, 
		НСтр("ru = 'Автоматически очищать:';
			|en = 'Clean up automatically:'"), НСтр("ru = 'Автоматически очищать ненужные файлы:';
													|en = 'Clean up obsolete files automatically:'"));
