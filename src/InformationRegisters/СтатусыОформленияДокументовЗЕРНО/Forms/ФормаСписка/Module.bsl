...
Функция ПолучитьДанныеДляРасчетаСтатуса()
	...
	МенеджерЗаписи = РегистрыСведений.СтатусыОформленияДокументовЗЕРНО.СоздатьМенеджерЗаписи();
	...
	Если Не МенеджерЗаписи.Выбран() Тогда
		ОбщегоНазначения.СообщитьПользователю(
			НСтр("ru = 'Невозможно получить данные, использованные при расчете статуса.';
				|en = 'Невозможно получить данные, использованные при расчете статуса.'"));
