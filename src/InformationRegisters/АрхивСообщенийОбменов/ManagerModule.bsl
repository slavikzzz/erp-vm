...
Процедура ПоместитьСообщениеВАрхив(УзелИнформационнойБазы, ПутьКИсходномуФайлу) Экспорт
	...
	Исключение
		...
		ТекстПричины = НСтр("ru = 'Файл не был помещен в архив.';
							|en = 'Файл не был помещен в архив.'") + Символы.ПС + СообщениеОбОшибке;
...
Функция СобытиеЖурналаРегистрацииПомещениеСообщенияВАрхив()
	...
	Возврат НСтр("ru = 'Обмен данными.Помещение сообщения в архив';
				|en = 'Data exchange.Place message to archive'", ОбщегоНазначения.КодОсновногоЯзыка());
