...
Процедура П000010000305ПриИзменении(Элемент)
	ТаблицаПоставщиковВыборНаСервере(Неопределено, Запись.П000010000305, "");
КонецПроцедуры
...
Процедура ПолеПриИзменении(Элемент)
	...
	Если Элемент.Имя = "П000010000305" ИЛИ Элемент.Имя = "П000010000306" Тогда
...
Процедура ФормированиеВнешнегоВида()
	...
	Если СтрДлина(СокрЛП(Запись.П000010000305)) = 10 Тогда
