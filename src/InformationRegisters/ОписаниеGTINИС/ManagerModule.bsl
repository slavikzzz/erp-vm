...
//
// Возвращаемое значение:
//   Соответствие из КлючИЗначение - найденные GTIN с их описанием:
	...
	Исключение
		...
		ТекстСообщения = СтрШаблон(
				НСтр("ru = 'Не удалось записать набор записей регистра сведений ОписаниеGTIN ИС по причине: %1';
					|en = 'Не удалось записать набор записей регистра сведений ОписаниеGTIN ИС по причине: %1'"),
			ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		
		ЗаписьЖурналаРегистрации(
				НСтр("ru = 'ГосИС: Запись планового количества вложенных потребительских упаковок';
					|en = 'ГосИС: Запись планового количества вложенных потребительских упаковок'", ОбщегоНазначения.КодОсновногоЯзыка()),
