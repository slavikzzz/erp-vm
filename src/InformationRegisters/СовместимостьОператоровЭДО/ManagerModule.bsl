...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Исключение
		ОтменитьТранзакцию();
		ТекстСообщения = НСтр("ru = 'Не удалось заполнить кеши совместимости операторов ЭДО по причине:';
								|en = 'Cannot fill the EDI service provider compatibility caches due to:'") + Символы.ПС 
