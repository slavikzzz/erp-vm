...
Процедура УдалитьПредупрежденияВДлительнойОперации()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru = 'Удаление предупреждений синхронизации';
															|en = 'Delete synchronization warnings'", ОбщегоНазначения.КодОсновногоЯзыка());
