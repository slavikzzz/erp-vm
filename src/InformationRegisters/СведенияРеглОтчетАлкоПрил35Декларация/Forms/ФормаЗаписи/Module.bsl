...
Процедура ПриОткрытии(Отказ)
	...
	Заголовок = "Оборот алкогольной продукции";
...
Процедура ДоступностьПолейНаСервере()
	...
	Элементы.П000010000324.ТолькоПросмотр = НЕ ФлажокОтклАвтоРасчет;
	...
	Элементы.П000010000324.ПропускатьПриВводе = НЕ ФлажокОтклАвтоРасчет;
...
Процедура ФормированиеЗаголовковСвернутогоОтображения()
	...
	Элементы.Остатки.ЗаголовокСвернутогоОтображения = "Остатки: на начало периода " 
					+ Формат(Запись.П000010000306, "ЧЦ = 15; ЧДЦ = 3; ЧН=; ЧВН;") + " | " 
					+ "на конец периода " + Формат(Запись.П000010000324, "ЧЦ = 15; ЧДЦ = 3; ЧН=; ЧВН;");
	
	// Поступление.
	Элементы.Поступление.ЗаголовокСвернутогоОтображения = "Поступление: всего " 
					+ Формат(Запись.П000010000314, "ЧЦ = 15; ЧДЦ = 3; ЧН=; ЧВН;") + " включая  закупки " 
					+ Формат(Запись.П000010000310, "ЧЦ = 15; ЧДЦ = 3; ЧН=; ЧВН;");
	
	// Расход.
	Элементы.Расход.ЗаголовокСвернутогоОтображения = "Расход: всего " 
					+ Формат(Запись.П000010000323, "ЧЦ = 15; ЧДЦ = 3; ЧН=; ЧВН;") + " включая  розничную продажу " 
					+ Формат(Запись.П000010000316, "ЧЦ = 15; ЧДЦ = 3; ЧН=; ЧВН;");
