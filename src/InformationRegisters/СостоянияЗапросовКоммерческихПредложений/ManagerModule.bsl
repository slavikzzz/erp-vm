...
Функция ЗаписатьСтатус(Документ, ПараметрыОбновления) Экспорт
	...
	Исключение
		...
		ЭлектронноеВзаимодействие.ОбработатьОшибку(НСтр("ru = 'Записать статус запроса коммерческих предложений';
														|en = 'Record the status of request for quotation'"), ПодробноеПредставлениеОшибки(Информация), 
			НСтр("ru = 'Не удалось записать статус запроса коммерческих предложений';
				|en = 'Cannot save the status of request for quotation'"), "БизнесСеть");
