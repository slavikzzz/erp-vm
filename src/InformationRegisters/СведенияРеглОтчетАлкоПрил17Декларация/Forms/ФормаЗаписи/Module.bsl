...
Процедура ПриОткрытии(Отказ)
	...
	Заголовок = "Сведения о расходе на собственные нужды фармсубстанции спирта этилового (этанола)";
...
Процедура ДоступностьПолейНаСервере()
	...
	Элементы.П000010000304.ТолькоПросмотр = НЕ ФлажокОтклАвтоРасчет;
	Элементы.П000010000308.ТолькоПросмотр = НЕ ФлажокОтклАвтоРасчет;
		
	Элементы.П000010000304.ПропускатьПриВводе = НЕ ФлажокОтклАвтоРасчет;
