	...
	Пока Выборка.Следующий() Цикл
			...
			Исключение
				...
				Попытка
					...
					ОбъектXDTO = РаботаСXMLЕГАИС.ПреобразоватьПроизвольныйОбъектXDTOВОбъектXDTO(
						РаботаСXMLИС.ПроизвольныйОбъектXDTOПоТекстуСообщенияXML(ИсходящееСообщениеТекстСообщенияXML),
		...
		Исключение
			...
			ТекстСообщения = НСтр("ru = 'Не удалось обработать запись регистра ""УдалитьПротоколОбменаЕГАИС"" с идентификатором сессии обмена %Идентификатор%
			                            |по причине %Причина%';
			                            |en = 'Не удалось обработать запись регистра ""УдалитьПротоколОбменаЕГАИС"" с идентификатором сессии обмена %Идентификатор%
			                            |по причине %Причина%'");
