		...
		Если ТребуетсяАктуализация
			...
			ПоказатьОповещениеПользователя(
				НСтр("ru = 'Напоминание отложено:';
					|en = 'Напоминание отложено:'"),,
				СтрШаблон(
				НСтр("ru = 'Напоминание отложено на %1';
					|en = 'Напоминание отложено на %1'"),
		...
		Если ПредупреждатьОЗакрытии = Истина Тогда
			...
			ПоказатьПредупреждение(
				...
				НСтр("ru = 'На текущий момент, все необходимые токены авторизации актуализированы.';
					|en = 'На текущий момент, все необходимые токены авторизации актуализированы.'"),
				10,
				НСтр("ru = 'Актуализация токенов авторизации.';
					|en = 'Актуализация токенов авторизации.'"));
		КонецЕсли;
	КонецЕсли;
...
Процедура НастроитьЭлементыФормыНаСервере()
	...
	Если Актуализация Тогда
		...
		Элементы.Актуализировать.Заголовок = НСтр("ru = 'Актуализировать все';
													|en = 'Актуализировать все'");
	Иначе
		Заголовок = НСтр("ru = 'Токены авторизации';
						|en = 'Токены авторизации'");
...
Функция ЗаменитьЕдиницуИзмеренияНаМножитель(Знач Единица)
	...
	ДопустимыеСимволы = НСтр("ru = 'абвгдеёжзийклмнопрстуфхцчшщъыьэюя';
							|en = 'абвгдеёжзийклмнопрстуфхцчшщъыьэюя'"); // АПК:163; АПК:1036 (см. 456:1.1) символы, которые может вводить пользователь.
	...
	СловоформыНедели = СтрРазделить(НСтр("ru = 'нед,н';
										|en = 'нед,н'"), ",", Ложь);
	СловоформыДня = СтрРазделить(НСтр("ru = 'ден,дне,дня,дн,д';
										|en = 'ден,дне,дня,дн,д'"), ",", Ложь);
	СловоформыЧаса = СтрРазделить(НСтр("ru = 'час,ч';
										|en = 'час,ч'"), ",", Ложь);
	СловоформыМинуты = СтрРазделить(НСтр("ru = 'мин,м';
										|en = 'мин,м'"), ",", Ложь);
	СловоформыСекунды = СтрРазделить(НСтр("ru = 'сек,с';
											|en = 'сек,с'"), ",", Ложь);
