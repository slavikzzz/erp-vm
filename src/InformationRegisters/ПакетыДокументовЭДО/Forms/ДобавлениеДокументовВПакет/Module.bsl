...
&НаКлиенте
Процедура ПодготовитьДанныеДляФормированияДокументовПоОбъектамУчетаЗавершение(ОбъектыУчета)
...
Процедура ОповещениеЗавершенияФормированияПоОбъектамУчета(Результат, ОбъектыУчета) Экспорт
	...
	Если Результат.Успех И ЗначениеЗаполнено(Результат.ДобавленныеДокументы) Тогда
		Оповестить(ПакетыДокументовЭДОКлиент.ИмяСобытияДобавленияДокументаВПакет(),
			Результат.ДобавленныеДокументы, ИдентификаторПакета);
		Если Открыта() Тогда
			Закрыть();
		КонецЕсли;	
	Иначе
...
Процедура ДобавитьДокументВПакет(ДобавленныеДокументы)
	...
	Если Успех И ЗначениеЗаполнено(ДобавленныеДокументы) Тогда
		Оповестить(ПакетыДокументовЭДОКлиент.ИмяСобытияДобавленияДокументаВПакет(), ДобавленныеДокументы, 
			ИдентификаторПакета);
		Закрыть();
	Иначе
...
Функция ДобавитьДокументыОбъектовУчетаВПакет(ОбъектыУчета)
	...
	Иначе
		Если ДобавленныеДокументы.Найти(ЭлектронныйДокумент) = Неопределено Тогда
			ДобавленныеДокументы.Добавить(ЭлектронныйДокумент);
		КонецЕсли;
