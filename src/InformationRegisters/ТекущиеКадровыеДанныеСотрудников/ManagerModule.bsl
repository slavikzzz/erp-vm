...
Процедура ПриОбъединенииДублей(ОставляемыйДубль) Экспорт
	
	НаборЗаписейТекущихКадровыхДанных = СоздатьНаборЗаписей();
	НаборЗаписейТекущихКадровыхДанных.Отбор.ФизическоеЛицо.Установить(ОставляемыйДубль);
	
	Блокировка = Новый БлокировкаДанных;
	ЭлементБлокировки = Блокировка.Добавить("РегистрСведений.ТекущиеКадровыеДанныеСотрудников");
	ЭлементБлокировки.УстановитьЗначение("ФизическоеЛицо", ОставляемыйДубль);
	...
	Попытка
		...
		НаборЗаписейТекущихКадровыхДанных.ДополнительныеСвойства.Вставить("ОтключитьПроверкуДатыЗапретаИзменения",
			Истина);
