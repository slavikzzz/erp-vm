...
Функция ОбновитьФайл(Знач ИдентификаторФайла, Знач АдресФайла, Знач ДатаИзмененияФайла, РаспаковатьИзАрхива = Ложь, ПреобразоватьДвоичныеДанныеВСтроку = Истина)
			...
			Если Данные = Неопределено Тогда
				...
				СообщениеОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Не удалось распаковать загруженный файл
						...
						|
						|%2';
						|en = 'Cannot unpack the imported file
						|%1
						|
						|%2'"),
					АдресФайла,
	...
	Если Не РезультатЗагрузки.Статус Тогда
		...
		Комментарий = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			...
			|%2';
			|en = 'Cannot update the %1 file due to:
			|%2'"),
			Строка(ИдентификаторФайла),
...
Функция ИмяСобытияЖурналаРегистрации()
	...
	Возврат НСтр("ru = 'Обновление классификаторов МЧД';
				|en = 'Update classifiers of machine-readable letters of authority'", ОбщегоНазначения.КодОсновногоЯзыка());
