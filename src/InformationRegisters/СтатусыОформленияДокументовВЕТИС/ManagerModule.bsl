...
//  СсылкаНаОформляемыйДокумент - ДокументСсылка - Ссылка на оформляемый документ
// 
// Возвращаемое значение:
//  Структура - Значения по умолчанию:
// * Документ - ДокументСсылка - 
// * Основание - ДокументСсылка - 
// * СтатусОформления - ПеречислениеСсылка.СтатусыОформленияДокументовГосИС - 
// * Архивный - Булево - 
// * Дата - Дата - 
// * Номер - Строка - 
// * Контрагент - ОпределяемыйТип.КонтрагентГосИС
// * ТорговыйОбъект - ОпределяемыйТип.ТорговыйОбъектВЕТИС
// * ПроизводственныйОбъект - ОпределяемыйТип.ПроизводственныйОбъектИС
// * Ответственный - ОпределяемыйТип.ПользователиИС
...
//  ПустаяСсылкаВЕТИС - см. ОбщегоНазначенияИС.ПустоеЗначениеОпределяемогоТипа
// 
// Возвращаемое значение:
...
// Возвращаемое значение:
// 	Массив из см. ИнтеграцияВЕТИСКлиентСервер.СтруктураИзменения - Выполненные изменения.
//
Функция АрхивироватьРаспоряженияКОформлению(Основания, Документ) Экспорт
	...
	Если Не ПравоДоступа("Изменение", Документ.Метаданные()) Тогда
		ВызватьИсключение НСтр("ru = 'Недостаточно прав доступа для обработки распоряжений к оформлению';
								|en = 'Недостаточно прав доступа для обработки распоряжений к оформлению'");
	КонецЕсли;
		...
		Исключение
			...
			ТекстСообщения = СтрШаблон(
				НСтр("ru = 'Не удалось архивировать распоряжение к оформлению %1 по причине: %2';
					|en = 'Не удалось архивировать распоряжение к оформлению %1 по причине: %2'"),
