...
Процедура УстановитьСвойстваЭлементов(Форма)
	...
	ДоступностьРаздельногоУчетаПостатейныхЗатрат = НЕ ПрименяетсяЛьготноеНалогообложениеНДСнаУСН 
		И Форма.ПартионныйУчетВерсии22
	...
	Элементы.РаздельныйУчетПостатейныхПроизводственныхЗатратПоНалогообложениюНДС.Доступность = 
		Запись.РаздельныйУчетТоваровПоНалогообложениюНДС
		И ДоступностьРаздельногоУчетаПостатейныхЗатрат;
		
	Элементы.ГруппаРаздельныйУчетПостатейныхПроизводственныхЗатратКомментарий.Видимость = НЕ ПрименяетсяЛьготноеНалогообложениеНДСнаУСН
		И Запись.РаздельныйУчетТоваровПоНалогообложениюНДС
		И НЕ ДоступностьРаздельногоУчетаПостатейныхЗатрат;
	
	Элементы.УчетНДСДлительногоЦиклаПроизводства.Доступность = НЕ ПрименяетсяЛьготноеНалогообложениеНДСнаУСН И Запись.РаздельныйУчетПостатейныхПроизводственныхЗатратПоНалогообложениюНДС;
	Элементы.ФормироватьНДСПредъявленныйПриВключенииВСтоимость.Видимость = НЕ ПрименяетсяЛьготноеНалогообложениеНДСнаУСН;
	Элементы.РаздельныйУчетПостатейныхПроизводственныхЗатратПоНалогообложениюНДС.Видимость = НЕ ПрименяетсяЛьготноеНалогообложениеНДСнаУСН;
	Элементы.УчетНДСДлительногоЦиклаПроизводства.Видимость = НЕ ПрименяетсяЛьготноеНалогообложениеНДСнаУСН;
	Элементы.РаспределятьНДСВМесяцеОсуществленияКапВложений.Видимость = НЕ ПрименяетсяЛьготноеНалогообложениеНДСнаУСН;
	Элементы.СписыватьНДСПоРасходамНеПринимаемымВНУ.Видимость = НЕ ПрименяетсяЛьготноеНалогообложениеНДСнаУСН;
	//-- НЕ УТ
