...
// 	Структура, Неопределено, Произвольный - исходный запрос:
...
//   * ПараметрыЗапроса - ФиксированноеСоответствие из Строка - параметры запроса.
...
Процедура УдалитьПросроченныеЗапросы() Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(НСтр("ru = 'ПередачаДанных';
										|en = 'DataTransfer'", ОбщегоНазначения.КодОсновногоЯзыка()),
