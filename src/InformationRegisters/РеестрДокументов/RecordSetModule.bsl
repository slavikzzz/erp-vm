...
Процедура ЗагрузитьСОбработкой(ТаблицаРеестрДокументов) Экспорт
	...
	ТаблицаКлючейРесстра = ТаблицаРеестрДокументов.Скопировать(, "Контрагент, МестоХранения");
	ТаблицаКлючейРесстра.Свернуть("Контрагент, МестоХранения");
	
	КлючиОтбора = Новый Массив;
	
	Для Каждого СтрокаКлючей Из ТаблицаКлючейРесстра Цикл
