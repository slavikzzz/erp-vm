...
Функция ФормаВыполненияЗадачи(ЗадачаСсылка, ТочкаМаршрутаБизнесПроцесса) Экспорт
	...
	Результат.Вставить("ИмяФормы", "БизнесПроцесс.ЗаявкаСотрудникаОтсутствие.Форма.ДействиеВыполнить");
	Возврат Результат;	
КонецФункции
...
Процедура ЗаполнитьДокументыПоЗаявке(Заявка, ДокументыПоЗаявке) Экспорт
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ДокументыЗаявки.Отсутствие КАК Ссылка
	|ИЗ
	|	БизнесПроцесс.ЗаявкаСотрудникаОтсутствие.Отсутствия КАК ДокументыЗаявки
	|ГДЕ
