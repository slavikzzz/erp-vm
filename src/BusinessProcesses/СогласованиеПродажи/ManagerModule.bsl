	...
	Если ТочкаМаршрутаБизнесПроцесса = БизнесПроцессы.СогласованиеПродажи.ТочкиМаршрута.СогласоватьЛогистическиеУсловия Или
		...
		Исключение
			...
			ТекстОшибки = НСтр("ru = 'При выполнении задачи не удалось заблокировать %Ссылка%. %ОписаниеОшибки%';
								|en = 'Cannot lock %Ссылка% when executing the task. %ОписаниеОшибки%'");
...
//
// Параметры:
//	БизнесПроцесс - БизнесПроцессСсылка.СогласованиеПродажи - текущий процесс согласования.
...
//
// Параметры:
//	БизнесПроцесс - БизнесПроцессСсылка.СогласованиеПродажи
//
// Возвращаемое значение:
...
//
// Параметры:
//   БизнесПроцесс - БизнесПроцессСсылка.СогласованиеПродажи - текущий бизнес-процесс согласования.
//
// Возвращаемое значение:
