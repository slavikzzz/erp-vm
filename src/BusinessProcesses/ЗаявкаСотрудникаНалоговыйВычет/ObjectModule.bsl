		...
		Если ТипЗнч(ДанныеЗаполнения) = Тип("Структура") Тогда
			...
			Если ДанныеЗаполнения.Свойство("ФизическоеЛицо") Тогда
				Если ЛичныйВычет Тогда 
					Наименование = СтрШаблон(НСтр("ru = 'Заявление на личный налоговый вычет %1';
													|en = 'Application for personal tax deduction %1'"), Строка(ДанныеЗаполнения.ФизическоеЛицо));
				ИначеЕсли ВычетНаДетей Тогда
					Наименование = СтрШаблон(НСтр("ru = 'Заявление на налоговый вычет на детей %1';
													|en = 'Application for child-related tax deduction %1'"), Строка(ДанныеЗаполнения.ФизическоеЛицо));
				ИначеЕсли ВычетНаНедвижимость Тогда
					Наименование = СтрШаблон(НСтр("ru = 'Заявление на налоговый вычет на недвижимость %1';
													|en = 'Application for real estate tax deduction %1'"), Строка(ДанныеЗаполнения.ФизическоеЛицо));
				ИначеЕсли ВычетНаЛечение Тогда
					Наименование = СтрШаблон(НСтр("ru = 'Заявление на налоговый вычет на лечение %1';
													|en = 'Application for healthcare tax deduction %1'"), Строка(ДанныеЗаполнения.ФизическоеЛицо));
				ИначеЕсли ВычетНаОбучение Тогда
					Наименование = СтрШаблон(НСтр("ru = 'Заявление на налоговый вычет на обучение %1';
													|en = 'Application for education tax deduction %1'"), Строка(ДанныеЗаполнения.ФизическоеЛицо));
				Иначе
					Наименование = СтрШаблон(НСтр("ru = 'Заявление на налоговый вычет %1';
													|en = 'Application for tax deduction %1'"), Строка(ДанныеЗаполнения.ФизическоеЛицо));
				КонецЕсли;
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
