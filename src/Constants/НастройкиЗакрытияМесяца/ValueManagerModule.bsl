...
Функция ОписаниеПараметровОперации(Операция) Экспорт
	...
	//++ НЕ УТ
	ИначеЕсли Операция = Перечисления.ОперацииЗакрытияМесяца.НачислениеАмортизацииОС Тогда
		
		ОписаниеПараметров = РасчетАмортизацииОС.ОписаниеПараметровОперацииЗакрытияМесяца();
		
	ИначеЕсли Операция = Перечисления.ОперацииЗакрытияМесяца.НачислениеАмортизацииНМА Тогда
		
		ОписаниеПараметров = РасчетАмортизацииНМА.ОписаниеПараметровОперацииЗакрытияМесяца();
		
	ИначеЕсли Операция = Перечисления.ОперацииЗакрытияМесяца.РасчетСтоимостиВнеоборотныхАктивов Тогда
		
		ОписаниеПараметров = РасчетСтоимостиВНА.ОписаниеПараметровОперацииЗакрытияМесяца();
		
	ИначеЕсли Операция = Перечисления.ОперацииЗакрытияМесяца.ФормированиеДвиженийПоВнеоборотнымАктивам Тогда
		
		ОписаниеПараметров = ОтложенноеФормированиеДвиженийВНА.ОписаниеПараметровОперацииЗакрытияМесяца();
	//-- НЕ УТ
