...
Процедура ПередЗаписью(Отказ)
	...
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		ВызватьИсключение НСтр("ru = 'Настройка варианта обновления внешних компонент недоступна при работе в модели сервиса.
...
Процедура ПриЗаписи(Отказ)
	...
	ПолучениеВнешнихКомпонент.УстановитьИспользованиеРегламентныхЗаданий(Значение <> 0);
