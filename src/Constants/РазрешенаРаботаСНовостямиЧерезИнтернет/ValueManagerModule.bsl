...
Процедура ПриЗаписи(Отказ)
	...
	Если ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации() Тогда
		...
		ТекстСообщения = НСтр("ru = 'Записана константа РазрешенаРаботаСНовостямиЧерезИнтернет
			...
			|en = 'Constant РазрешенаРаботаСНовостямиЧерезИнтернет is saved
			|Previous value: %ПредыдущееЗначение%
			|New value: %НовоеЗначение%'");
		...
		ОбработкаНовостейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ru = 'Новости. Изменение данных. Константы. РазрешенаРаботаСНовостямиЧерезИнтернет';
				|en = 'News. Data change. Constants. РазрешенаРаботаСНовостямиЧерезИнтернет'", ОбщегоНазначения.КодОсновногоЯзыка()), // ИдентификаторШага.
