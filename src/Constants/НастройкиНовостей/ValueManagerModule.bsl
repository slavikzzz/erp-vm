...
Процедура ПриЗаписи(Отказ)
	...
	Если ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации() Тогда
		...
		ТекстСообщения = НСтр("ru = 'Записана константа НастройкиНовостей
			...
			|Новое значение:
			|%НовоеЗначение%';
			|en = 'Constant НастройкиНовостей is saved
			|Previous value:
			|%ПредыдущееЗначение%
			|
			|New value:
		...
		ОбработкаНовостейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ru = 'Новости. Изменение данных. Константы. НастройкиНовостей';
				|en = 'News. Edit data. Constants. НастройкиНовостей'", ОбщегоНазначения.КодОсновногоЯзыка()), // ИдентификаторШага.
