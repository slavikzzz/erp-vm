	...
	Если Ответ.КодСостояния <> 200 Тогда
		...
		Если Ответ.КодСостояния = 401 Тогда
			...
			УточнениеОшибки = НСтр("ru = 'Ошибка 401: ошибка авторизации HTTP-сервиса exchange_dsl_1_0_0_1 (отказ в доступе).';
									|en = 'Ошибка 401: ошибка авторизации HTTP-сервиса exchange_dsl_1_0_0_1 (отказ в доступе).'");
		...
		ИначеЕсли Ответ.КодСостояния = 404 Тогда
			...
			УточнениеОшибки = НСтр("ru = 'Ошибка 404: HTTP-сервис exchange_dsl_1_0_0_1 не найден (на сервере отсутствует запрашиваемый ресурс.';
									|en = 'Ошибка 404: HTTP-сервис exchange_dsl_1_0_0_1 не найден (на сервере отсутствует запрашиваемый ресурс.'");
			СообщениеОбОшибке = УточнениеОшибки + Символы.ПС + Символы.ПС + СообщениеОбОшибке
