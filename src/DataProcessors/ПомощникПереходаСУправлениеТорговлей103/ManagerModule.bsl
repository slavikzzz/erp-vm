...
Функция СформироватьСписокЗарегистрированныхБаз(АдресФайлаСоСпискомИБ, ТолькоФайловыеБазы) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Помощник перехода с Управление торговлей.Удаление временных файлов';
										|en = 'Wizard of migration from 1C:Trade Management.Delete temporary files'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
