...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ЭтоСканирование") Тогда
		ЭтоСканирование = Параметры.Свойство("ЭтоСканирование"); 
	КонецЕсли;
	
	Если ЭтоСканирование И НЕ ИспользоватьСерии Тогда
		КоличествоУпаковок = Параметры.Количество;
	ИначеЕсли ЭтоСканирование И ИспользоватьСерии Тогда
...
Процедура УстановитьУсловноеОформление()
	...
	ИначеЕсли Режим = "Отгрузка" ИЛИ Режим = "РедактированиеОтгрузка" Тогда
		...
		Если Номенклатура.ВидНоменклатуры.ПолитикаУчетаСерий.УказыватьПоФактуОтбора 
			Или Номенклатура.ВидНоменклатуры.ПолитикаУчетаСерий.УказыватьПриПланированииОтбора 
			Или ЭтоСканирование Тогда
			Элементы.Серия.Доступность = Истина;
			Элементы.Серия.Видимость = Истина;
		ИначеЕсли Номенклатура.ВидНоменклатуры.ПолитикаУчетаСерий.УказыватьПриПланированииОтгрузки Тогда
			Элементы.Серия.Доступность = Ложь;
			Элементы.Серия.Видимость = Истина;
		Иначе
			Элементы.Серия.Доступность = Ложь;
