...
Процедура ЗакончитьОтбор(Команда)
	...
	Если ТоварыОтобрано.Количество() = 0 Тогда
		ТекстОшибки = НСтр("ru = 'Невозможно закончить отбор, пока не отобрано ни одного товара.';
							|en = 'Невозможно закончить отбор, пока не отобрано ни одного товара.'");
	...
	ПоказатьВопрос(Оповещение, НСтр("ru = 'Завершить отбор?';
									|en = 'Finish picking job?'"), СписокЗначений, 0);
