...
Процедура ОбновитьИтоги()
	...
	Элементы.ДекорацияМаркированныйТовар.Заголовок = СтрШаблон(НСтр("ru = 'Маркированный товар: %1';
																	|en = 'Marked goods: %1'"), Марк);
	Элементы.ДекорацияМонотоварнаяУпаковка.Заголовок = СтрШаблон(НСтр("ru = 'Монотоварная упаковка: %1';
																		|en = 'Single product packaging unit: %1'"), Моно);
	Элементы.ДекорацияМультитоварнаяУпаковка.Заголовок = СтрШаблон(НСтр("ru = 'Мультитоварная упаковка: %1';
																		|en = 'Multiproduct packaging unit: %1'"), Мульти);
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если НЕ Закрыть Тогда
		...
		ПоказатьВопрос(Оповещение, НСтр("ru = 'Сохранить изменения?';
										|en = 'Save changes?'"), СписокЗначений, 0);
	КонецЕсли;
