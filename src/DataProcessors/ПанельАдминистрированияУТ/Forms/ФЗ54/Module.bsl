...
Процедура ПолучитьТекстЗаголовкаИРасписанияРегламентнойНастройки(Задание, ТекстРасписания, РасписаниеАктивно)
	...
	Иначе
		...
		Если Задание.Использование Тогда
			...
			ТекстРасписания = СтрШаблон(НСтр("ru = 'Расписание отправки электронных чеков: %1';
											|en = 'Schedule of sending electronic receipts: %1'"), Строка(Задание.Расписание));
		Иначе
			ТекстРасписания = СтрШаблон(НСтр("ru = 'Расписание отправки электронных чеков (НЕ АКТИВНО): %1';
											|en = 'Schedule of sending electronic receipts (NOT ACTIVE): %1'"), Строка(Задание.Расписание));
		КонецЕсли;
