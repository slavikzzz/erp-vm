	...
	Если Модифицированность И НЕ ПеренестиВДокумент Тогда
		...
		Если ЕстьИзменения Тогда
			ТекстВопроса = НСтр("ru = 'Состав документов-оснований был изменен. Принять изменения?';
								|en = 'Content of base documents was changed. Accept changes?'");
...
Процедура ЗаполнитьСписокРаспоряжений()
	...
	|						И &ХозяйственнаяОперацияДокумента = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПоступлениеОтДавальца2_5)
	|						ТОГДА ВЫРАЗИТЬ(ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).Организация           = &Организация
	|							И ВЫРАЗИТЬ(ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).Контрагент            = &Контрагент
	|							И ВЫРАЗИТЬ(ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).Договор               = &Договор
	|							И ВЫРАЗИТЬ(ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).ВариантПриемкиТоваров = &ВариантПриемкиТоваров
	|							И ВЫРАЗИТЬ(ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).Партнер               = &Партнер
	|							И (ВЫРАЗИТЬ(ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).ЦенаВключаетНДС      = &ЦенаВключаетНДС ИЛИ &ЦенаВключаетНДС = НЕОПРЕДЕЛЕНО)
	|							И ((ВЫРАЗИТЬ(ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).Валюта               = &Валюта
	|								И ВЫРАЗИТЬ(ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).НалогообложениеНДС = &НалогообложениеНДС
	|								И (ВЫРАЗИТЬ(ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).НаправлениеДеятельности В (
	|																								&НаправлениеДеятельности,
	|																								ЗНАЧЕНИЕ(Справочник.НаправленияДеятельности.ПустаяСсылка))
	|									ИЛИ &БезОтбораПоНаправлениямДеятельности)
	|								) ИЛИ ВЫРАЗИТЬ(ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).ХозяйственнаяОперация =
	|																								ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПроизводствоИзДавальческогоСырья2_5))
	|							И (НЕ &ПроверятьГФУПодразделение
	|								ИЛИ (ВЫРАЗИТЬ(ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).ГруппаФинансовогоУчета В (
	|																								&ГруппаФинансовогоУчета,
	|																								ЗНАЧЕНИЕ(Справочник.ГруппыФинансовогоУчетаРасчетов.ПустаяСсылка))
	|									И ВЫРАЗИТЬ(ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).Подразделение В (
	|																								&Подразделение,
	...
	|							И ВЫРАЗИТЬ(ЗаказыДвижения.ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).Организация           = &Организация
	|							И ВЫРАЗИТЬ(ЗаказыДвижения.ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).Контрагент            = &Контрагент
	|							И ВЫРАЗИТЬ(ЗаказыДвижения.ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).Договор               = &Договор
	|							И ВЫРАЗИТЬ(ЗаказыДвижения.ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).ВариантПриемкиТоваров = &ВариантПриемкиТоваров
	|							И ВЫРАЗИТЬ(ЗаказыДвижения.ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).Партнер               = &Партнер
	|							И (ВЫРАЗИТЬ(ЗаказыДвижения.ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).ЦенаВключаетНДС      = &ЦенаВключаетНДС ИЛИ &ЦенаВключаетНДС = НЕОПРЕДЕЛЕНО)
	|							И ((ВЫРАЗИТЬ(ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).Валюта               = &Валюта
	|								И ВЫРАЗИТЬ(ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).НалогообложениеНДС = &НалогообложениеНДС
	|								И (ВЫРАЗИТЬ(ЗаказПоставщику КАК Документ.ЗаказДавальца2_5).НаправлениеДеятельности В (
	|																								&НаправлениеДеятельности,
	...
	|
	|ИЗ
	|	Документ.ЗаказДавальца2_5 КАК ЗаказыПоставщикам
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВтТаблицаЗаказы КАК ТаблицаЗаказы
	|		ПО ЗаказыПоставщикам.Ссылка = ТаблицаЗаказы.ЗаказПоставщику
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ ВыбранныеДокументы КАК ВыбранныеДокументы
	|	ПО ЗаказыПоставщикам.Ссылка = ВыбранныеДокументы.ДокументОснование
	...
	//++ НЕ УТКА
	ИначеЕсли ХозяйственнаяОперацияДокумента = Перечисления.ХозяйственныеОперации.ПоступлениеОтДавальца2_5 Тогда
		Запрос.УстановитьПараметр("Валюта",						Неопределено);
		Запрос.УстановитьПараметр("НалогообложениеНДС",			Неопределено);
		Запрос.УстановитьПараметр("НаправлениеДеятельности",	Неопределено);
		Запрос.УстановитьПараметр("ГруппаФинансовогоУчета",		Неопределено);
