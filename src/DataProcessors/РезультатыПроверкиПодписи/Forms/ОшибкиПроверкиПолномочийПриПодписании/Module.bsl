...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекстПредупреждения = НСтр("ru = 'Сертификатом <a href = ""%1"">%2</a> можно подписать только по доверенности.
		...
		|en = 'With the <a href = ""%1"">%2</a> certificate, you can only sign by an authorization letter.
		|Valid authorization letters are found (%3) but they do not match the authorities.'");
	...
	ТекстРекомендации = НСтр("ru = 'либо передайте документ на подпись руководителю.';
							|en = 'Submit the document to the manager to sign.'");
