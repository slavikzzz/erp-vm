...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для каждого ОбъектЗакупки Из ДанныеКонтракта.ОбъектыЗакупки Цикл
		Если ОбъектЗакупки.Идентификатор = Идентификатор Тогда
			...
			Если ОбъектЗакупки.Свойство("СтраныПроисхождения") Тогда
				Для каждого Страна Из ОбъектЗакупки.СтраныПроисхождения Цикл
					СтранаСтрока = СтраныПроисхождения.Добавить();
					СтранаСтрока.Код = Страна.Код;
					СтранаСтрока.Наименование = Страна.ПолноеНаименование;
				КонецЦикла;
			КонецЕсли;
