...
Процедура ДекорацияЖурналРегистрацииНажатие(Элемент)
	...
	ПараметрыФормы.Вставить("СобытиеЖурналаРегистрации", НСтр("ru = 'ПоискИУдалениеНеиспользуемыхЭлементовСправочников';
																|en = 'ПоискИУдалениеНеиспользуемыхЭлементовСправочников'"));
...
Процедура НастроитьУсловияОтбора(Команда)
	...
	Если ТекущиеДанныеСтроки = Неопределено Тогда
		...
		ТекстПредупреждения = НСтр("ru = 'Нет выделенной строки, поэтому открыть форму настройки отборов невозможно.';
									|en = 'Cannot open the filter setup form as no line is selected.'", ОбщегоНазначенияКлиент.КодОсновногоЯзыка());
...
Процедура НайтиИУдалитьНеиспользуемыеЭлементыСправочников(МассивПараметров, Отказ)
	...
	Исключение
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Не удалось снять монопольный режим';
																|en = 'Cannot remove the exclusive mode'"));
	КонецПопытки;
...
Процедура УдалитьЭлементСправочника(Ссылка, СчетчикУдаленныхОбъектов)
	...
	Исключение
		...
		ИмяСобытия = НСтр("ru = 'Не удалось удалить элемент справочника';
							|en = 'Cannot delete the catalog item'")+ПредставлениеОбъекта;
	...
	ИмяСобытия = НСтр("ru = 'Удален:';
						|en = 'Removed:'") + " " + ПредставлениеОбъекта;
...
Функция ПолучитьИсключаемыеСправочники()
	...
	//++ НЕ УТ
	МассивИсключений.Добавить(МетаСправочники.ВидыВычетовНДФЛ);
	МассивИсключений.Добавить(МетаСправочники.ВидыДоходовНДФЛ);
	МассивИсключений.Добавить(МетаСправочники.ВидыДоходовПоСтраховымВзносам);
	МассивИсключений.Добавить(МетаСправочники.ВидыОбразованияФизическихЛиц);
	МассивИсключений.Добавить(МетаСправочники.ВидыОбщественноПолезнойДеятельностиСЗВК);
	МассивИсключений.Добавить(МетаСправочники.ВидыТарифовСтраховыхВзносов);
	МассивИсключений.Добавить(МетаСправочники.ОснованияДосрочногоНазначенияПенсии);
	МассивИсключений.Добавить(МетаСправочники.ОснованияДосрочногоНазначенияПенсииДляСЗВК);
	МассивИсключений.Добавить(МетаСправочники.ОснованияИсчисляемогоСтраховогоСтажа);
	МассивИсключений.Добавить(МетаСправочники.ОснованияУвольнения);
	МассивИсключений.Добавить(МетаСправочники.ОсобыеУсловияТрудаДляСЗВКПФР);
	МассивИсключений.Добавить(МетаСправочники.ОсобыеУсловияТрудаПФР);
	МассивИсключений.Добавить(МетаСправочники.ПараметрыИсчисляемогоСтраховогоСтажа);
	МассивИсключений.Добавить(МетаСправочники.СтатусыНалогоплательщиковПоНДФЛ);
	...
	МассивИсключений.Добавить(МетаСправочники.СтрокиОтчетностиМониторингаРаботниковСоциальнойСферы);
	МассивИсключений.Добавить(МетаСправочники.ТерриториальныеУсловияПФР);
