...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ВариантИсполнения.СписокВыбора.Добавить("Параллельно", НСтр("ru = 'Всем сразу';
																		|en = 'To all at once'")); //@NON-NLS-1
	Элементы.ВариантИсполнения.СписокВыбора.Добавить("Последовательно", НСтр("ru = 'По очереди';
																			|en = 'In sequence'")); //@NON-NLS-1
	Элементы.ВариантИсполнения.СписокВыбора.Добавить("Смешанно", НСтр("ru = 'Смешанно';
																		|en = 'Mixed'")); //@NON-NLS-1
