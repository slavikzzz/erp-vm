...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипОбъектаВыбора = "DMIncomingDocument"
		...
		ДобавитьРеквизитПоиска("documentType", НСтр("ru = 'Вид документа';
													|en = 'Document kind'"), ТипОбъектаВыбора + "Type");
		ДобавитьРеквизитПоиска("summary", НСтр("ru = 'Содержание';
												|en = 'Content'"), "Строка");
		ДобавитьРеквизитПоиска("comment", НСтр("ru = 'Комментарий';
												|en = 'Comment'"), "Строка");
		ДобавитьРеквизитПоиска("regNumber", НСтр("ru = 'Рег. номер';
												|en = 'Reg. number'"), "Строка");
		ДобавитьРеквизитПоиска("regDate", НСтр("ru = 'Дата регистрации';
												|en = 'Registration date'"), "Дата");
		ДобавитьРеквизитПоиска("sum", НСтр("ru = 'Сумма';
											|en = 'Amount'"), "Число");
		ДобавитьРеквизитПоиска("currency", НСтр("ru = 'Валюта';
												|en = 'Currency'"), "DMCurrency");
		ДобавитьРеквизитПоиска("organization", НСтр("ru = 'Организация';
													|en = 'Company'"), "DMOrganization");
		ДобавитьРеквизитПоиска("subdivision", НСтр("ru = 'Подразделение';
													|en = 'Business unit'"), "DMSubdivision");
		ДобавитьРеквизитПоиска("accessLevel", НСтр("ru = 'Гриф доступа';
													|en = 'Access label'"), "DMAccessLevel");
		ДобавитьРеквизитПоиска("performanceDate", НСтр("ru = 'Срок исполнения';
														|en = 'Due date'"), "Дата");
		ДобавитьРеквизитПоиска("activityMatter", НСтр("ru = 'Вопрос деятельности';
														|en = 'Activity issue'"), "DMActivityMatter");
		ДобавитьРеквизитПоиска("responsible", НСтр("ru = 'Ответственный';
													|en = 'Responsible person'"), "DMUser");
		ДобавитьРеквизитПоиска("project", НСтр("ru = 'Проект';
		...
		Если ИнтеграцияС1СДокументооборотБазоваяФункциональностьПовтИсп.ДоступенФункционалВерсииСервиса("1.4.7.1") Тогда
			ДобавитьРеквизитПоиска("status", НСтр("ru = 'Состояние';
													|en = 'State'"), "DMDocumentStatus");
		КонецЕсли;
	КонецЕсли;
	
	Если ТипОбъектаВыбора = "DMIncomingDocument" Тогда
		ДобавитьРеквизитПоиска("externalNumber", НСтр("ru = 'Исходящий номер';
														|en = 'Outgoing number'"), "Строка");
		ДобавитьРеквизитПоиска("externalDate", НСтр("ru = 'Исходящая дата';
													|en = 'Outgoing date'"), "Дата");
		ДобавитьРеквизитПоиска("correspondent", НСтр("ru = 'Отправитель';
													|en = 'Sender'"), "DMCorrespondent");
		ДобавитьРеквизитПоиска("signer", НСтр("ru = 'Подписал';
												|en = 'Signed by'"), "DMContactPerson");
		ДобавитьРеквизитПоиска("addressee", НСтр("ru = 'Адресат';
												|en = 'Addressee'"), "DMUser");
		ДобавитьРеквизитПоиска("deliveryMethod", НСтр("ru = 'Способ получения';
														|en = 'Receipt method'"), "DMDeliveryMethod");
		
	ИначеЕсли ТипОбъектаВыбора = "DMInternalDocument" Тогда
		ДобавитьРеквизитПоиска("folder", НСтр("ru = 'Папка';
												|en = 'Folder'"), "DMInternalDocumentFolder");
		ДобавитьРеквизитПоиска("beginDate", НСтр("ru = 'Дата начала действия';
												|en = 'Effective date'"), "Дата");
		ДобавитьРеквизитПоиска("endDate", НСтр("ru = 'Дата окончания действия';
												|en = 'Expiration date'"), "Дата");
		ДобавитьРеквизитПоиска("openEnded", НСтр("ru = 'Бессрочный';
												|en = 'Unlimited'"), "Булево");
		Если ИнтеграцияС1СДокументооборотПовтИсп.ИспользоватьТерминКорреспонденты() Тогда
			ДобавитьРеквизитПоиска("correspondent", НСтр("ru = 'Корреспондент';
														|en = 'Correspondent'"), "DMCorrespondent");
		Иначе
			ДобавитьРеквизитПоиска("correspondent", НСтр("ru = 'Контрагент';
														|en = 'Counterparty'"), "DMCorrespondent");
		КонецЕсли;
		ДобавитьРеквизитПоиска("contactPerson", НСтр("ru = 'Контактное лицо';
													|en = 'Contact person'"), "DMContactPerson");
		ДобавитьРеквизитПоиска("signer", НСтр("ru = 'Утвердил';
												|en = 'Approved'"), "DMUser");
		ДобавитьРеквизитПоиска("author", НСтр("ru = 'Подготовил';
												|en = 'Prepared'"), "DMUser");
		ДобавитьРеквизитПоиска("prolongationProcedure", НСтр("ru = 'Порядок продления';
	...
	ИначеЕсли ТипОбъектаВыбора = "DMCorrespondent" Тогда
		ДобавитьРеквизитПоиска("inn", НСтр("ru = 'ИНН';
											|en = 'TIN'"), "Строка");
		ДобавитьРеквизитПоиска("kpp", НСтр("ru = 'КПП';
											|en = 'KPP'"), "Строка");
		ДобавитьРеквизитПоиска("okpo", НСтр("ru = 'Код по ОКПО';
											|en = 'OKPO code'"), "Строка");
		ДобавитьРеквизитПоиска("fullName", НСтр("ru = 'Полное наименование';
												|en = 'Full description'"), "Строка");
		ДобавитьРеквизитПоиска("comment", НСтр("ru = 'Комментарий';
												|en = 'Comment'"), "Строка");
		ДобавитьРеквизитПоиска("privatePerson", НСтр("ru = 'Физическое лицо';
													|en = 'Person'"), "DMPrivatePerson");
		ДобавитьРеквизитПоиска("legalPrivatePerson", НСтр("ru = 'Юр./физ. лицо';
															|en = 'Legal entity/person'"), "DMLegalPrivatePerson");
		ДобавитьРеквизитПоиска("responsible", НСтр("ru = 'Ответственный';
													|en = 'Responsible person'"), "DMUser");
	...
	Если ЗначениеЗаполнено(Оператор) Тогда
		Если Тип = "Строка" Тогда
			...
			ИначеЕсли Оператор = "LIKE" Тогда
				Если Лев(Значение, 1) = "%"	И Прав(Значение, 1) = "%" Тогда
					Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru = 'содержит ""%1""';
							|en = 'contains ""%1""'"), Сред(Значение, 2, СтрДлина(Значение) - 2));
				ИначеЕсли Лев(Значение, 1) = "%" Тогда
					Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru = 'заканчивается на ""%1""';
							|en = 'ends with ""%1""'"), Сред(Значение,2));
				ИначеЕсли Прав(Значение, 1) = "%" Тогда
					Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru = 'начинается с ""%1""';
							|en = 'starts with ""%1""'"), Лев(Значение, СтрДлина(Значение) - 1));
				КонецЕсли;
			КонецЕсли;
		ИначеЕсли Тип = "Число" Тогда
			...
			ИначеЕсли ЗначениеЗаполнено(Оператор2) Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'между %1 и %2';
						|en = 'between %1 and %2'"), Значение, Значение2);
		...
		ИначеЕсли Тип = "Дата" Тогда
			...
			ИначеЕсли ЗначениеЗаполнено(Оператор2) Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'между %1 и %2';
						|en = 'between %1 and %2'"), Формат(Значение, "ДЛФ=D"), Формат(Значение2, "ДЛФ=D"));
			ИначеЕсли Оператор = "<=" Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'по %1';
						|en = 'to %1'"), Формат(Значение, "ДЛФ=D"));
			ИначеЕсли Оператор = ">=" Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'с %1';
						|en = 'from %1'"), Формат(Значение, "ДЛФ=D"));
			КонецЕсли;
		Иначе // Это ссылочный тип или Булево.
