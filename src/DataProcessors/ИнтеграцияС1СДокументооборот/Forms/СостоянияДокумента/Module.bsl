...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.СостояниеСогласование.СписокВыбора.Добавить("НаСогласовании", НСтр("ru = 'На согласовании';
																				|en = 'Pending approval'")); //@NON-NLS-1
	Элементы.СостояниеСогласование.СписокВыбора.Добавить("Согласован", НСтр("ru = 'Согласован';
																			|en = 'Approved'")); //@NON-NLS-1
	Элементы.СостояниеСогласование.СписокВыбора.Добавить("НеСогласован", НСтр("ru = 'Не согласован';
																				|en = 'Not approved'")); //@NON-NLS-1
	
	Элементы.СостояниеУтверждение.СписокВыбора.Очистить();
	Элементы.СостояниеУтверждение.СписокВыбора.Добавить("НаУтверждении", НСтр("ru = 'На утверждении';
																				|en = 'Pending confirmation'")); //@NON-NLS-1
	Элементы.СостояниеУтверждение.СписокВыбора.Добавить("Утвержден", НСтр("ru = 'Утвержден';
																			|en = 'Confirmed'")); //@NON-NLS-1
	Элементы.СостояниеУтверждение.СписокВыбора.Добавить("НеУтвержден", НСтр("ru = 'Не утвержден';
																			|en = 'Not confirmed'")); //@NON-NLS-1
	
	Элементы.СостояниеПодписание.СписокВыбора.Очистить();
	Элементы.СостояниеПодписание.СписокВыбора.Добавить("НаПодписании", НСтр("ru = 'На подписании';
																			|en = 'On signing'")); //@NON-NLS-1
	Элементы.СостояниеПодписание.СписокВыбора.Добавить("Подписан", НСтр("ru = 'Подписан';
																		|en = 'Signed'")); //@NON-NLS-1
	Элементы.СостояниеПодписание.СписокВыбора.Добавить("Отклонен", НСтр("ru = 'Отклонен';
																		|en = 'Rejected'")); //@NON-NLS-1
	
	Элементы.СостояниеРегистрация.СписокВыбора.Очистить();
	Элементы.СостояниеРегистрация.СписокВыбора.Добавить("Проект", НСтр("ru = 'Проект';
																		|en = 'Project'")); //@NON-NLS-1
	Элементы.СостояниеРегистрация.СписокВыбора.Добавить("НаРегистрации", НСтр("ru = 'На регистрации';
																				|en = 'On registration'")); //@NON-NLS-1
	Элементы.СостояниеРегистрация.СписокВыбора.Добавить("Зарегистрирован", НСтр("ru = 'Зарегистрирован';
																				|en = 'Registered'")); //@NON-NLS-1
	Элементы.СостояниеРегистрация.СписокВыбора.Добавить("НеЗарегистрирован", НСтр("ru = 'Не зарегистрирован';
																					|en = 'Not registered'")); //@NON-NLS-1
	
	Элементы.СостояниеРассмотрение.СписокВыбора.Очистить();
	Элементы.СостояниеРассмотрение.СписокВыбора.Добавить("НаРассмотрении", НСтр("ru = 'На рассмотрении';
																				|en = 'On review'")); //@NON-NLS-1
	Элементы.СостояниеРассмотрение.СписокВыбора.Добавить("Рассмотрен", НСтр("ru = 'Рассмотрен';
																			|en = 'Reviewed'")); //@NON-NLS-1
	
	Элементы.СостояниеИсполнение.СписокВыбора.Очистить();
	Элементы.СостояниеИсполнение.СписокВыбора.Добавить("НаИсполнении", НСтр("ru = 'На исполнении';
																			|en = 'On execution'")); //@NON-NLS-1
	Элементы.СостояниеИсполнение.СписокВыбора.Добавить("Исполнен", НСтр("ru = 'Исполнен';
																		|en = 'Executed'")); //@NON-NLS-1
