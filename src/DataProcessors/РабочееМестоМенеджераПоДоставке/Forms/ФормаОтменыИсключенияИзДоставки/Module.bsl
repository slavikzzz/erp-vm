	...
	Для Каждого ИДСтроки Из Элементы.Список.ВыделенныеСтроки Цикл
		...
		Исключение
			...
			ТекстСообщения = НСтр("ru = 'Не удалось вернуть %Распоряжение% в список доставки.';
									|en = 'Cannot return %Распоряжение% to the delivery list.'");
			...
			ЗаписьЖурналаРегистрации(НСтр("ru = 'Не удалось вернуть распоряжение в список доставки.';
											|en = 'Cannot return the reference to the delivery list.'", КодОсновногоЯзыка),
