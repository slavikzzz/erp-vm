...
Процедура ЗаполнитьТабличныйДокументЗаявлениеНаВозвратТоваровОтКлиента(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати)
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		Если ТаблицаТовары.Количество() > 1 Тогда
			СтруктураДанныхШапки.Вставить("ОписаниеТоваров", НСтр("ru = 'товары';
																	|en = 'goods'", ОбщегоНазначения.КодОсновногоЯзыка()));
		Иначе
			СтруктураДанныхШапки.Вставить("ОписаниеТоваров", НСтр("ru = 'товар';
																	|en = 'good'", ОбщегоНазначения.КодОсновногоЯзыка()));
		КонецЕсли;
