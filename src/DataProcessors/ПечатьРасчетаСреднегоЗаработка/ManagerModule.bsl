...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "РасчетСреднегоЗаработкаВыходногоПособия") Тогда
		...
		Если НЕ ТабличныйДокумент = Неопределено Тогда
			УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "РасчетСреднегоЗаработкаВыходногоПособия", НСтр("ru = 'Расчет среднего заработка (для выходного пособия)';
																																		|en = 'Average earnings calculation (for severance pay)'"), ТабличныйДокумент);
		КонецЕсли;
	КонецЕсли;
...
Функция НазваниеЕдиницыИзмеренияВремени(ИспользоватьСреднеЧасовойЗаработок)
	Возврат ?(ИспользоватьСреднеЧасовойЗаработок, НСтр("ru = 'часов';
														|en = 'hours'"), НСтр("ru = 'дней';
																			|en = 'days'"));
КонецФункции

Функция НазваниеСреднегоЗаработка(ИспользоватьСреднеЧасовойЗаработок)
	Возврат ?(ИспользоватьСреднеЧасовойЗаработок, НСтр("ru = 'Среднечасовой';
														|en = 'Average hourly'"), НСтр("ru = 'Среднедневной';
																					|en = 'Average daily'"));
КонецФункции
