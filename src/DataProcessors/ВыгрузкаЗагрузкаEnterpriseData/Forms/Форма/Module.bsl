...
Процедура ЗаполнитьВерсиюФорматаПоУмолчанию(МассивДоступныхВерсий)
	...
	Если МассивДоступныхВерсий.Количество() = 0 Тогда
		...
		СтрокаПоддерживаемыеВерсииФормата = НСтр("ru = 'Не обнаружены поддерживаемые версии формата';
												|en = 'No supported format versions are found.'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	Иначе
		...
		СтрокаПоддерживаемыеВерсииФормата = СтрШаблон(НСтр("ru = 'Поддерживаемые версии формата: %1';
