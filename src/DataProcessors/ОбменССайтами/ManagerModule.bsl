...
Процедура СоздатьУзелОбменаССайтом(ВходящиеПараметры, АдресСайта, ИДСайта, Пароль="")
	...
	Попытка
		...
		ПланОбменаСайт.Наименование					= НСтр("ru = 'Обмен товарами и заказами с';
																|en = 'Exchange goods and orders with'") +" "+ АдресСайта;
...
Процедура ЗапуститьОбменССайтом(КодУзлаОбмена)
	...
	ОбменССайтомСобытия.ВыполнитьОбмен(УзелОбмена, НСтр("ru = 'Обмен полный при создании сайта';
														|en = 'Full exchange while creating website'"), Ложь);
