...
Процедура ЗафиксироватьОшибку(ПодробноеПредставлениеОшибки)
	ЗаписьЖурналаРегистрации(
		НСтр("ru = 'Помощник сопоставления объектов.Автоматическое сопоставление';
			|en = 'Object mapping wizard.Automatic object mapping'", ОбщегоНазначения.КодОсновногоЯзыка()),
