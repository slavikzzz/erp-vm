...
Процедура ВыполнитьABCXYZКлассификациюЧастоИспользуемыеВозможности(Команда)
	...
	ПоказатьОповещениеПользователя(НСтр("ru = 'Классификация клиентов';
										|en = 'Customer classification'"),, НСтр("ru = 'Выполняется ABC/XYZ классификация...';
																				|en = 'Executing ABC/XYZ classification ...'"), БиблиотекаКартинок.Информация32);
	
	ВыполнитьABCXYZКлассификациюНаСервере();
	
	ПоказатьОповещениеПользователя(НСтр("ru = 'Классификация клиентов';
										|en = 'Customer classification'"),, НСтр("ru = 'Выполнена ABC/XYZ классификация!';
																				|en = 'ABC/XYZ classification is complete.'"), БиблиотекаКартинок.Информация32);
...
Процедура ВыполнитьABCКлассификациюПолныеВозможности(Команда)
	...
	ПоказатьОповещениеПользователя(НСтр("ru = 'Классификация клиентов';
										|en = 'Customer classification'"),, НСтр("ru = 'Выполняется ABC классификация...';
																				|en = 'Executing ABC classification...'"), БиблиотекаКартинок.Информация32);
	
	ВыполнитьABCКлассификациюНаСервере();
	
	ПоказатьОповещениеПользователя(НСтр("ru = 'Классификация клиентов';
										|en = 'Customer classification'"),, НСтр("ru = 'Выполнена ABC классификация!';
																				|en = 'ABC classification is complete.'"), БиблиотекаКартинок.Информация32);
...
Процедура ВыполнитьXYZКлассификациюПолныеВозможности(Команда)
	...
	ПоказатьОповещениеПользователя(НСтр("ru = 'Классификация клиентов';
										|en = 'Customer classification'"),, НСтр("ru = 'Выполняется XYZ классификация...';
																				|en = 'Executing XYZ classification...'"), БиблиотекаКартинок.Информация32);
	
	ВыполнитьXYZКлассификациюНаСервере();
	
	ПоказатьОповещениеПользователя(НСтр("ru = 'Классификация клиетнов';
										|en = 'Customer classification'"),, НСтр("ru = 'Выполнена XYZ классификация!';
																				|en = 'XYZ classification is complete.'"), БиблиотекаКартинок.Информация32);
...
Процедура ОчиститьABCКлассификациюПолныеВозможности(Команда)
	...
	ПоказатьВопрос(Новый ОписаниеОповещения("ОчиститьABCКлассификациюПолныеВозможностиЗавершение", ЭтотОбъект), НСтр("ru = 'Вся информация об ABC классификации клиентов будет очищена. Продолжить?';
																													|en = 'Customer ABC classification will be cleared. Do you want to continue?'"), РежимДиалогаВопрос.ОКОтмена);
...
Процедура ОчиститьABCКлассификациюПолныеВозможностиЗавершение(РезультатВопроса, ДополнительныеПараметры) Экспорт
    ...
    Если КодВозврата = КодВозвратаДиалога.ОК Тогда
        ...
        ПоказатьОповещениеПользователя(НСтр("ru = 'Классификация клиентов';
											|en = 'Customer classification'"),, НСтр("ru = 'Выполняется очистка ABC классификации...';
																					|en = 'Clearing ABC classification...'"), БиблиотекаКартинок.Информация32);
        
        ОчиститьABCКлассификациюНаСервере();
        
        ПоказатьОповещениеПользователя(НСтр("ru = 'Классификация клиентов';
											|en = 'Customer classification'"),, НСтр("ru = 'Выполнена очистка ABC классификации!';
...
Процедура ОчиститьXYZКлассификациюПолныеВозможности(Команда)
	...
	ПоказатьВопрос(Новый ОписаниеОповещения("ОчиститьXYZКлассификациюПолныеВозможностиЗавершение", ЭтотОбъект), НСтр("ru = 'Вся информация об XYZ классификации клиентов будет очищена. Продолжить?';
																													|en = 'Customer XYZ classification will be cleared. Do you want to continue?'"), РежимДиалогаВопрос.ОКОтмена);
...
Процедура ОчиститьXYZКлассификациюПолныеВозможностиЗавершение(РезультатВопроса, ДополнительныеПараметры) Экспорт
    ...
    Если КодВозврата = КодВозвратаДиалога.ОК Тогда
        ...
        ПоказатьОповещениеПользователя(НСтр("ru = 'Классификация клиентов';
											|en = 'Customer classification'"),, НСтр("ru = 'Выполняется очистка XYZ классификации...';
																					|en = 'Clearing XYZ classification...'"), БиблиотекаКартинок.Информация32);
        
        ОчиститьXYZКлассификациюНаСервере();
        
        ПоказатьОповещениеПользователя(НСтр("ru = 'Классификация клиентов';
											|en = 'Customer classification'"),, НСтр("ru = 'Выполнена очистка XYZ классификации!';
...
Процедура ОбновитьОтображениеФормы()
	...
	Если ПолныеВозможности Тогда
		...
		Заголовок = НСтр("ru = 'Классификация клиентов - полные возможности';
						|en = 'Customer classification - full functions'");
	...
	Иначе
		...
		Заголовок = НСтр("ru = 'Классификация клиентов - часто используемые возможности';
						|en = 'Customer classification - frequently used functions'");
