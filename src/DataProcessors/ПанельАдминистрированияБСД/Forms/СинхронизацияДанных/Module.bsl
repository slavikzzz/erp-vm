...
Процедура ИзменитьПрефиксИБ(Команда)
	...
	ОбменДаннымиКлиент.ОткрытьФормуИзмененияПрефиксаИБ(НаборКонстант.ПрефиксУзлаРаспределеннойИнформационнойБазы);
...
Процедура УдалениеПредупрежденийСинхронизацииДанных(Команда)
	...
	ОбменДаннымиКлиент.ОткрытьФормуУдаленияПредупрежденийСинхронизации(ПараметрыОткрытия);
