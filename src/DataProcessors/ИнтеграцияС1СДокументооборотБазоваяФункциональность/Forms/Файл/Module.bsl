...
Асинх Процедура ЯвляетсяОригиналомПриИзменении(Знач Элемент)
	...
	Если ЗначениеЗаполнено(Шаблон) Тогда
		...
		ПоказатьПредупреждение(, НСтр("ru = 'Нельзя отметить как оригинал файл, созданный из шаблона.';
										|en = 'You cannot mark a file created from the template as an original.'"));
		Возврат;
	КонецЕсли;
...
Процедура ПолучитьОписаниеФайлаИЗаполнитьФорму()
	...
	Если ЗначениеЗаполнено(ID) Тогда
		Заголовок = СтрШаблон(НСтр("ru = '%1 (Файл)';
