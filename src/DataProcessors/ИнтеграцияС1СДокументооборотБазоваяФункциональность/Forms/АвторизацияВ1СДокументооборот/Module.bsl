...
Процедура ОК(Команда)
	...
	Если Не ЗначениеЗаполнено(ИмяПользователя)
		...
		ПоказатьПредупреждение(, НСтр("ru = 'Не заполнено имя пользователя 1С:Документооборота.';
										|en = '1C:Document Management username is required.'"));
		Возврат;
	КонецЕсли;
	...
	Если ДлительнаяОперация <> Неопределено Тогда
		...
		ИнтеграцияС1СДокументооборотБазоваяФункциональностьКлиент.ВыполнитьЗапросАсинхронно(
			...
			НСтр("ru = 'Установка соединения с 1С:Документооборот.';
				|en = 'Connecting to 1C:Document Management.'"));
	КонецЕсли;
	...
	Иначе
		...
		Ответ = Ждать ИнтеграцияС1СДокументооборотБазоваяФункциональностьКлиент.ПоказатьВопросДаНетАсинх(
			НСтр("ru = 'Не удалось подключиться к 1С:Документообороту с указанным
				...
				|en = 'Cannot connect to 1C:Document Management
				|with the specified login and password. Contact administrator.'"),
