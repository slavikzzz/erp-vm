...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Результат.Ошибка Тогда
		Элементы.ГруппаОшибкаПоиска.Видимость = Истина;
		Элементы.ТекстОшибки.Заголовок = СтроковыеФункции.ФорматированнаяСтрока(
			НСтр("ru = '<b>Ошибка в настройках сервиса</b>
		...
		Элементы.ПанельПоиска.Видимость = Ложь;
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыОбслуживающиеОрганизации
...
Функция ПроверитьРезультатЗапросаНаСервере(ИдентификаторЗадания, АдресХранилища)
	...
	ИначеЕсли ФоновоеЗадание <> Неопределено И ФоновоеЗадание.Состояние = СостояниеФоновогоЗадания.ЗавершеноАварийно Тогда
		ТекстОшибки = ТехнологияСервиса.ПодробныйТекстОшибки(ФоновоеЗадание.ИнформацияОбОшибке);
