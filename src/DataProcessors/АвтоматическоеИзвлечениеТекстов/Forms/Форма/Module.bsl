...
Процедура ИзвлечениеТекстовКлиент(РазмерПорции = Неопределено)
	...
	Попытка
		...
		Если МассивФайлов.Количество() = 0 Тогда
			ПоказатьОповещениеПользователя(НСтр("ru = 'Извлечение текстов';
												|en = 'Extract text'"),, НСтр("ru = 'Нет файлов для извлечения текста';
		...
		Для Индекс = 0 По МассивФайлов.Количество() - 1 Цикл
			...
			Попытка
				...
				Состояние(НСтр("ru = 'Идет извлечение текста файла';
								|en = 'Extracting text from files'"), Прогресс, ИмяСРасширением);
		...
		ПоказатьОповещениеПользователя(НСтр("ru = 'Извлечение текстов';
											|en = 'Extract text'"),, ТекстСообщения);
