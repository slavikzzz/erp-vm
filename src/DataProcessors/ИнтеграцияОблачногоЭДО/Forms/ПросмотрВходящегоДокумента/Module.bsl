...
Процедура НастроитьЭлементыОтраженияВУчете()
	...
	Элементы.НадписьДокументыУчета.Заголовок = ?(ДваОбъектаУчета, НСтр("ru = 'Документы учета:';
