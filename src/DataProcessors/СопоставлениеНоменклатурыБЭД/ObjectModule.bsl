...
Процедура ЗаполнитьТаблицуСопоставления(ТаблицаСопоставления, Знач ВариантСопоставления, СопоставленоАвтоматически,
	...
	Если КоличествоВариантовНоменклатуры > 0 Тогда
		Если МетаданныеСопоставления.ИспользуетсяНесколькоТиповВНоменклатуре Тогда
			ПодсказкаНайденныхВариантовНоменклатуры = 
				СтрШаблон(НСтр("ru = 'Найдено в моей базе (%1)';
								|en = 'Found in my base (%1)'"), Формат(КоличествоВариантовНоменклатуры, "ЧГ=0"));
		Иначе
	...
	Если КоличествоВариантовУпаковки > 0 Тогда
		ПодсказкаНайденныхВариантовУпаковки = НСтр("ru = 'Найдено в моей базе (';
													|en = 'Found in my base ('") + Формат(КоличествоВариантовУпаковки, "ЧГ=0") + ")";
