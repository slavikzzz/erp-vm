...
Процедура ЗаполнитьТабличныйДокументТТНСправкаРазделБ(ТабличныйДокумент, Запрос, ОбъектыПечати)
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		ОсновнаяОбласть.Параметры.СтрокаЛицензииПродавца =
			...
			?(ЗначениеЗаполнено(ДанныеПечати.ЛицензияПродавцаДатаНачала), ", " + НСтр("ru = 'срок действия лицензии с';
																						|en = 'срок действия лицензии с'") + " " + Формат(ДанныеПечати.ЛицензияПродавцаДатаНачала, "ДЛФ=D"), "") +
			?(ЗначениеЗаполнено(ДанныеПечати.ЛицензияПродавцаДатаОкончания), " по " + Формат(ДанныеПечати.ЛицензияПродавцаДатаОкончания, "ДЛФ=D"), "") +
			?(ЗначениеЗаполнено(ДанныеПечати.ЛицензияПродавцаВыдана), " " + НСтр("ru = 'выдана';
																				|en = 'выдана'") + " " + ДанныеПечати.ЛицензияПродавцаВыдана, "");
		ОсновнаяОбласть.Параметры.СтрокаЛицензииПокупателя =
			ДанныеПечати.ЛицензияПокупателяНаименование +
			?(ЗначениеЗаполнено(ДанныеПечати.ЛицензияПокупателяДатаНачала), ", " + НСтр("ru = 'срок действия лицензии с';
																						|en = 'срок действия лицензии с'") + " " + Формат(ДанныеПечати.ЛицензияПокупателяДатаНачала, "ДЛФ=D"), "") +
			...
			?(ЗначениеЗаполнено(ДанныеПечати.ЛицензияПокупателяВыдана), " " + НСтр("ru = 'выдана';
																					|en = 'выдана'") + " " + ДанныеПечати.ЛицензияПокупателяВыдана, "");
...
// 
// Параметры:
//  СписокСведений - Структура - Список сведений:
// * ПолноеНаименование - Строка - 
// * ФактическийАдрес - Строка - 
// * ИНН - Строка - 
// * КПП - Строка - 
//  Список - Строка - Список
//  СПрефиксом - Булево - С префиксом
// 
		...
		Если ПозЗапятой > 0  Тогда
			...
			Исключение
				...
				ТекстСообщения  = НСтр("ru = 'Не удалось определить значение параметра организации: %ИмяПараметра%';
										|en = 'Не удалось определить значение параметра организации: %ИмяПараметра%'");
