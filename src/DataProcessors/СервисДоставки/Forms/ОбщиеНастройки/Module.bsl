...
Процедура ОбновитьЗаголовокСоответствиеПунктовВыдачи()
	...
	Элементы.СоответствиеОбъектовОператоровДоставки.Заголовок = СтрШаблон(НСтр("ru = 'Пункты выдачи (%1 / %2)';
																				|en = 'Pickup points (%1/%2)'"), КоличествоЗаполненных, КоличествоЗаписей);
