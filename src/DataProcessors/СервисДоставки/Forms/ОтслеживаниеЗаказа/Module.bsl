	...
	Если ЗначениеЗаполнено(ТрекНомер) Тогда
		...
		Иначе
			...
			ТекстОшибки = НСтр("ru = 'Трек-номер должен быть больше 5 символов.';
								|en = 'Track number must contain more than 5 characters.'");
...
Функция ТабличныйДокументКарточкаЗаказа()
	...
	ПараметрыОбласти.ТарифНаименование = ?(ТарифНаименование = "",НСтр("ru = '<не указан>';
																		|en = '<not specified>'"),ТарифНаименование);
