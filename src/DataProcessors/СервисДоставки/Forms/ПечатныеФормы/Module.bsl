								...
								ОбщегоНазначенияКлиент.СообщитьПользователю(
									СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
										НСтр("ru = 'Ошибка извлечения данных файла: %1';
											|en = 'Error of file data extraction: %1'"),
										ИмяФайла));
...
Процедура ВыбратьКаталогЗагрузки(ВыполнитьЗагрузкуПослеВыбора = Ложь)
	...
	ФайловаяСистемаКлиент.ВыбратьКаталог(ОписаниеОповещения, НСтр("ru = 'Выберите каталог';
																	|en = 'Select directory'"), КаталогЗагрузкиПечатныхФорм);
