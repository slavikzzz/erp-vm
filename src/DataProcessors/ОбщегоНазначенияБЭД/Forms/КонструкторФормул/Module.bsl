	...
	Если Не ЗначениеЗаполнено(Операнд) Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю(
			НСтр("ru = 'Имя реквизита не должно содержать ""."". Переименуйте реквизит.';
				|en = 'Attribute name cannot contain ""."". Rename the attribute. '"));
		Возврат;
	КонецЕсли;
...
Процедура КомпоновщикНастроекПриАктивизацииСтроки(Элемент)
	...
	МассивСтрок.Добавить(НСтр("ru = 'Значение реквизита недоступно для источников:';
								|en = 'Attribute value is not available for sources:'"));
...
Процедура ПостроитьДеревоОператоров()
	...
	ДобавитьОператор(Дерево, ",",                 ГруппаОператоров, " + "", "" + ");
	ДобавитьОператор(Дерево, ".",                 ГруппаОператоров, " + "". "" + ");
	ДобавитьОператор(Дерево, НСтр("ru = 'Пробел';
									|en = 'Whitespace'"), ГруппаОператоров, " + "" "" + ");
	ДобавитьОператор(Дерево, "(",                 ГруппаОператоров, " + "" ("" + ");
	ДобавитьОператор(Дерево, ")",                 ГруппаОператоров, " + "") "" + ");
	ДобавитьОператор(Дерево, """",                ГруппаОператоров, " + """""""" + ");
	...
	ДобавитьОператор(Дерево, "=",                 ГруппаОператоров, " = ");
	ДобавитьОператор(Дерево, "<>",                ГруппаОператоров, " <> ");
	ДобавитьОператор(Дерево, НСтр("ru = 'И';
									|en = 'AND'"),      ГруппаОператоров, " " + НСтр("ru = 'И';
																				|en = 'AND'")      + " ");
	ДобавитьОператор(Дерево, НСтр("ru = 'Или';
									|en = 'Or'"),    ГруппаОператоров, " " + НСтр("ru = 'Или';
																				|en = 'Or'")    + " ");
	ДобавитьОператор(Дерево, НСтр("ru = 'Не';
									|en = 'Not'"),     ГруппаОператоров, " " + НСтр("ru = 'Не';
																				|en = 'Not'")     + " ");
	ДобавитьОператор(Дерево, НСтр("ru = 'ИСТИНА';
									|en = 'TRUE'"), ГруппаОператоров, " " + НСтр("ru = 'ИСТИНА';
																				|en = 'TRUE'") + " ");
	ДобавитьОператор(Дерево, НСтр("ru = 'ЛОЖЬ';
									|en = 'FALSE'"),   ГруппаОператоров, " " + НСтр("ru = 'ЛОЖЬ';
																				|en = 'FALSE'")   + " ");
	
	ГруппаОператоров = ДобавитьГруппуОператоров(Дерево, НСтр("ru = 'Числовые функции';
															|en = 'Numeric functions'"));
	
	ДобавитьОператор(Дерево, НСтр("ru = 'Максимум';
									|en = 'Max'"),    ГруппаОператоров, НСтр("ru = 'Макс(,)';
																				|en = 'Max(,)'"), 2);
	ДобавитьОператор(Дерево, НСтр("ru = 'Минимум';
									|en = 'Min'"),     ГруппаОператоров, НСтр("ru = 'Мин(,)';
																				|en = 'Min(,)'"),  2);
	ДобавитьОператор(Дерево, НСтр("ru = 'Округление';
									|en = 'Rounding'"),  ГруппаОператоров, НСтр("ru = 'Окр(,)';
																				|en = 'Round(,)'"),  2);
	ДобавитьОператор(Дерево, НСтр("ru = 'Целая часть';
									|en = 'Integral part'"), ГруппаОператоров, НСтр("ru = 'Цел()';
																				|en = 'Int()'"),   1);
	
	ГруппаОператоров = ДобавитьГруппуОператоров(Дерево, НСтр("ru = 'Строковые функции';
															|en = 'String functions'"));
	
	ДобавитьОператор(Дерево, НСтр("ru = 'Строка';
									|en = 'Row'"),      ГруппаОператоров, НСтр("ru = 'Строка()';
																				|en = 'String()'"));
	ДобавитьОператор(Дерево, НСтр("ru = 'ВРег';
									|en = 'Upper'"),        ГруппаОператоров, НСтр("ru = 'ВРег()';
																				|en = 'Upper()'"));
	ДобавитьОператор(Дерево, НСтр("ru = 'Лев';
									|en = 'Left'"),         ГруппаОператоров, НСтр("ru = 'Лев()';
																				|en = 'Left()'"));
	ДобавитьОператор(Дерево, НСтр("ru = 'НРег';
									|en = 'Lower'"),        ГруппаОператоров, НСтр("ru = 'НРег()';
																				|en = 'Lower()'"));
	ДобавитьОператор(Дерево, НСтр("ru = 'Прав';
									|en = 'Right'"),        ГруппаОператоров, НСтр("ru = 'Прав()';
																				|en = 'Right()'"));
	ДобавитьОператор(Дерево, НСтр("ru = 'СокрЛ';
									|en = 'TrimL'"),       ГруппаОператоров, НСтр("ru = 'СокрЛ()';
																				|en = 'TrimL()'"));
	ДобавитьОператор(Дерево, НСтр("ru = 'СокрЛП';
									|en = 'TrimAll'"),      ГруппаОператоров, НСтр("ru = 'СокрЛП()';
																				|en = 'TrimAll()'"));
	ДобавитьОператор(Дерево, НСтр("ru = 'СокрП';
									|en = 'TrimR'"),       ГруппаОператоров, НСтр("ru = 'СокрП()';
																				|en = 'TrimR()'"));
	ДобавитьОператор(Дерево, НСтр("ru = 'ТРег';
									|en = 'Title'"),        ГруппаОператоров, НСтр("ru = 'ТРег()';
																				|en = 'Title()'"));
	ДобавитьОператор(Дерево, НСтр("ru = 'СтрЗаменить';
									|en = 'StrReplace'"), ГруппаОператоров, НСтр("ru = 'СтрЗаменить(,,)';
																				|en = 'StrReplace(,,)'"));
	ДобавитьОператор(Дерево, НСтр("ru = 'СтрДлина';
									|en = 'StrLen'"),    ГруппаОператоров, НСтр("ru = 'СтрДлина()';
																				|en = 'StrLen()'"));
	
	ГруппаОператоров = ДобавитьГруппуОператоров(Дерево, НСтр("ru = 'Прочие функции';
															|en = 'Other functions'"));
	
	ДобавитьОператор(Дерево, НСтр("ru = 'Условие';
									|en = 'Condition'"),                   ГруппаОператоров, "?(,,)", 3);
	ДобавитьОператор(Дерево, НСтр("ru = 'Предопределенное значение';
									|en = 'Predefined value'"), ГруппаОператоров, НСтр("ru = 'ПредопределенноеЗначение()';
																							|en = 'PredefinedValue()'"));
	ДобавитьОператор(Дерево, НСтр("ru = 'Значение заполнено';
									|en = 'Value filled'"),        ГруппаОператоров, НСтр("ru = 'ЗначениеЗаполнено()';
																							|en = 'ValueIsFilled()'"));
	ДобавитьОператор(Дерево, НСтр("ru = 'Формат';
									|en = 'Format'"),                    ГруппаОператоров, НСтр("ru = 'Формат(,)';
																							|en = 'Format(,)'"));
...
Процедура ПроверитьФормулуИнтерактивно(Формула)
	...
	Если ЗначениеЗаполнено(Формула) Тогда
		Если ПроверитьФормулу(Формула) Тогда
			ПоказатьОповещениеПользователя(НСтр("ru = 'В формуле ошибок не обнаружено';
												|en = 'No errors detected in the formula'"),,,БиблиотекаКартинок.Информация32);
		КонецЕсли;
	КонецЕсли;
...
Процедура ЗаполнитьОграниченияОперандов(ТекстЗапроса)
	...
	Для Каждого ОператорСхемы Из СхемаЗапроса.ПакетЗапросов[0].Операторы Цикл
		...
		Если СтрЧислоВхождений(ИмяТаблицы, ".") > 1 Тогда
			ЧастиПути = СтрРазделить(ИмяТаблицы, ".");
			ИмяТаблицы = ЧастиПути[0] + "." + ЧастиПути[1];
			ПредставлениеТЧ = СтрШаблон("(%1)", ЧастиПути[2]);
		КонецЕсли;

		МетаданныеОбъекта = Метаданные.НайтиПоПолномуИмени(ИмяТаблицы);
		ПредставлениеИсточника = СтрШаблон("%1%2", МетаданныеОбъекта.Представление(), ПредставлениеТЧ);
		Источники.Добавить(ПредставлениеИсточника);
	КонецЦикла;
