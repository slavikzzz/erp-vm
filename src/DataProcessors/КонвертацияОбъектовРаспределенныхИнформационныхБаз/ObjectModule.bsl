...
Процедура ПрочитатьПриоритетныеИзмененияИзСообщенияОбмена(Знач ЧтениеСообщения, УзелОбщихДанных)
	...
	Если ЧтениеСообщения.Отправитель = ПланыОбмена.ГлавныйУзел() Тогда
		...
		Исключение
			...
			СообщениеОбОшибке = НСтр("ru = 'Ошибка при загрузке приоритетных данных: ""%1"" (тип %2)';
									|en = 'An error occurred when importing priority data: ""%1"" (type %2)'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция ОшибкаОткрытияФайлаСообщенияОбмена()
	...
	Возврат НСтр("ru = 'Ошибка открытия файла сообщения обмена';
				|en = 'Cannot open the exchange message file.'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция ОшибкаНачалаЧтенияФайлаСообщенияОбмена()
	...
	Возврат НСтр("ru = 'Ошибка при начале чтения файла сообщения обмена';
				|en = 'Cannot start reading the exchange message file.'", ОбщегоНазначения.КодОсновногоЯзыка());
	
КонецФункции

Функция ОшибкаНачалаЗаписиФайлаСообщенияОбмена()
	
	Возврат НСтр("ru = 'Ошибка при начале записи файла сообщения обмена';
				|en = 'Cannot start saving the exchange message file'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция ОшибкаЧтенияФайлаСообщенияОбмена()
	...
	Возврат НСтр("ru = 'Ошибка чтения файла сообщения обмена';
				|en = 'Cannot read the exchange message file.'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция ОшибкаВидаОбменаДанными()
	...
	Возврат НСтр("ru = 'Обмен не по правилам конвертации не поддерживается';
				|en = 'The exchange must follow the conversion rules.'", ОбщегоНазначения.КодОсновногоЯзыка());
