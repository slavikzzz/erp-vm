...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры.Свойство("РедактированиеРазрешено", РедактированиеРазрешено);
	Элементы.РазрешитьРедактирование.Пометка = РедактированиеРазрешено;
...
Процедура РазрешитьРедактирование(Команда)
	...
	Закрыть(Не РедактированиеРазрешено);
