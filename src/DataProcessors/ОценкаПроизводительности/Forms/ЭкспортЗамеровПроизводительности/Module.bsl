...
Процедура ВыполнитьЭкспорт(Команда)
    ...
    Иначе
        СообщениеПользователю = Новый СообщениеПользователю;
        СообщениеПользователю.Текст = НСтр("ru = 'За указанный период нет замеров. Файл архива не сформирован.';
											|en = 'There are no samples for the period. The archive was not generated.'") + Символы.ПС;
        СообщениеПользователю.Сообщить();
    КонецЕсли;
