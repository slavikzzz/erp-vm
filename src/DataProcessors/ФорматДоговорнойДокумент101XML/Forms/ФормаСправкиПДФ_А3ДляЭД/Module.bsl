...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("РежимСправкаПоШаблону") Тогда
		Заголовок = НСтр("ru = 'Формат шаблона договора для ЭДО';
						|en = 'Contract template format for EDI'");
		Элементы.ДекорацияПредупреждение.Заголовок = 
			...
			|внешнего редактора и, прикрепив файл к договору или выбрав с диска, отправить по ЭДО.';
			|en = 'The ""%1"" contract template cannot be automatically converted into PDF to send via EDI. This template is generated in the external editor.
			|
			|You can save the print form generated from the template, 
			|convert it into PDF using 
			|the external editor tools, and send the form via EDI. To do it, attach the print form file to the contract or select it from the hard drive.'"),Параметры.ИмяШаблона);
