...
Процедура ВнешнееСобытие(Источник, Событие, Данные)
	...
	Если Результат <> Неопределено
		...
		ОбработатьДанныеСканераШтрихкодов(ШтрихкодированиеОбщегоНазначенияИСКлиент.ПреобразоватьДанныеСоСканераВСтруктуру(Результат.Параметр));
	...
	Если Элементы.СтраницыФормы.ТекущаяСтраница = Элементы.СтраницаНеТребуетсяУказаниеДополнительныхДанных Тогда
		...
		Если Не ЗначениеЗаполнено(Штрихкодноменклатуры) Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				НСтр("ru = 'Не заполнено поле ""Штрихкод""';
					|en = 'Не заполнено поле ""Штрихкод""'"),,"ШтрихкодНоменклатуры");
			Возврат;
		КонецЕсли;
...
Процедура ОбработатьДанныеСканераШтрихкодов(ДанныеШтрихкода)
	...
	Иначе
		...
		Иначе
			...
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				СтрШаблон(НСтр("ru = 'Номенклатура со штрихкодом %1 не найдена';
								|en = 'Номенклатура со штрихкодом %1 не найдена'"), Штрихкод));
	...
	МассивСтрок.Добавить(
		Новый ФорматированнаяСтрока(
			НСтр("ru = 'не сопоставлена с номенклатурой предприятия.
			           ...
			           |en = 'не сопоставлена с номенклатурой предприятия.
			           |Отсканируйте штрихкод товара EAN-13.'"),,
			ЦветаСтиля.ПоясняющийТекст));
...
Процедура ПоказатьНеоднозначноеСоответствиеНетВДанныхОснования()
	...
	ТекстОшибки = НСтр("ru = 'Сопоставление с номенклатурой не однозначное, при этом данные сопоставления не соответствуют документу основанию';
						|en = 'Сопоставление с номенклатурой не однозначное, при этом данные сопоставления не соответствуют документу основанию'");
	
	Префикс = СтрШаблон(
		НСтр("ru = 'Невозможно добавить алкогольную продукцию ""%1"" с кодом акцизной марки';
			|en = 'Невозможно добавить алкогольную продукцию ""%1"" с кодом акцизной марки'"),
	...
	МассивСтрок.Добавить(
		Новый ФорматированнаяСтрока(
			НСтр("ru = 'не однозначно сопоставлена с номенклатурой предприятия.';
				|en = 'не однозначно сопоставлена с номенклатурой предприятия.'"),,
			ЦветаСтиля.ПоясняющийТекст));
...
Процедура ВывестиТекстСохранениеВыбораPDF417()
	...
	ТекстЗаголовка = НСтр("ru = 'При последовательном сканировании такой же алкогольной продукции не будет показываться эта форма. Будут использованы указанные данные.';
							|en = 'При последовательном сканировании такой же алкогольной продукции не будет показываться эта форма. Будут использованы указанные данные.'");
		...
		МассивСтрок.Добавить(
			Новый ФорматированнаяСтрока(
				НСтр("ru = 'Алкогольная продукция c кодом';
					|en = 'Алкогольная продукция c кодом'"),,
				ЦветаСтиля.ПоясняющийТекст));
		МассивСтрок.Добавить(" ");
		МассивСтрок.Добавить(
			Новый ФорматированнаяСтрока(
		...
		МассивСтрок.Добавить(
			Новый ФорматированнаяСтрока(
				НСтр("ru = 'не найдена в информационной базе.';
					|en = 'не найдена в информационной базе.'"),,
				ЦветаСтиля.ПоясняющийТекст));
		МассивСтрок.Добавить(" ");
		МассивСтрок.Добавить(
			Новый ФорматированнаяСтрока(
				НСтр("ru = 'Запросить из ЕГАИС';
					|en = 'Запросить из ЕГАИС'"),
				Новый Шрифт(,,,,Истина),
				ЦветаСтиля.ЦветГиперссылкиГосИС,,
				"КомандаЗапроситьАлкогольнуюПродукциюЕГАИС"));
	Иначе
		МассивСтрок.Добавить(
			Новый ФорматированнаяСтрока(
				НСтр("ru = 'Алкогольная продукция не найдена в информационной базе.
					       ...
					       |en = 'Алкогольная продукция не найдена в информационной базе.
					       |Отложите ее в сторону.'"),,
				ЦветаСтиля.ПоясняющийТекст));
	КонецЕсли;
	...
	МассивСтрок.Добавить(
		Новый ФорматированнаяСтрока(
			НСтр("ru = 'не идентифицирована. Укажите информацию о бутылке.';
				|en = 'не идентифицирована. Укажите информацию о бутылке.'"),,
			ЦветаСтиля.ПоясняющийТекст));
...
Процедура ВывестиТекстСохранениеВыбораDataMatrix()
	...
	ТекстЗаголовка = НСтр("ru = 'При последовательном сканировании акцизных марок, не содержащих информацию об алкогольной продукции, не будет показываться эта форма. Будут использованы указанные данные.';
							|en = 'При последовательном сканировании акцизных марок, не содержащих информацию об алкогольной продукции, не будет показываться эта форма. Будут использованы указанные данные.'");
...
Процедура ПоказатьНетМаркированнойПродукцииВОснованииDataMatrix()
	...
	ТекстОшибки = НСтр("ru = 'Отсканирована неизвестная акцизная марка, при этом в документе-распоряжении нет маркируемой алкогольной продукции.';
						|en = 'Отсканирована неизвестная акцизная марка, при этом в документе-распоряжении нет маркируемой алкогольной продукции.'");
	
	Префикс = НСтр("ru = 'Невозможно добавить алкогольную продукцию с кодом акцизной марки';
					|en = 'Невозможно добавить алкогольную продукцию с кодом акцизной марки'");
...
Процедура ПоказатьНетПартионнойАлкогольнойПродукцииВОсновании()
	...
	ТекстОшибки = СтрШаблон(
		НСтр("ru = 'Отсканирован штрихкод партионной алкогольной продукции %, при этом в документе-распоряжении
		           |нет такой алкогольной продукции.';
		           |en = 'Отсканирован штрихкод партионной алкогольной продукции %, при этом в документе-распоряжении
		           |нет такой алкогольной продукции.'"), ТипШтрихкода);
	
	Префикс = НСтр("ru = 'Невозможно добавить алкогольную продукцию со штрихкодом';
					|en = 'Невозможно добавить алкогольную продукцию со штрихкодом'");
		...
		Новый ФорматированнаяСтрока(
			СтрШаблон(
				НСтр("ru = 'Партионная алкогольная продукция %1';
					|en = 'Партионная алкогольная продукция %1'"),
				Строка(ТипШтрихкода)),,
			ЦветаСтиля.ПоясняющийТекст));
	МассивСтрок.Добавить(" ");
	МассивСтрок.Добавить(
...
Процедура ВывестиИнформациюОВыбореАлкогольнойПродукции()
	...
	ТекстУкажитеДополнительныеДанные = Новый ФорматированнаяСтрока(
			НСтр("ru = 'Укажите данные алкогольной продукции вручную.';
				|en = 'Укажите данные алкогольной продукции вручную.'"),,
...
Процедура ВывестиИнформациюСканированииШтрихкода()
	...
	ТекстУкажитеДополнительныеДанные = Новый ФорматированнаяСтрока(
			НСтр("ru = 'Отсканируйте штрихкод товара EAN-13 или укажите данные вручную.';
				|en = 'Отсканируйте штрихкод товара EAN-13 или укажите данные вручную.'"),,
			ЦветаСтиля.ТекстИнформационнойНадписиИС);
...
Функция РезультатИзмененияНоменклатурыПоДаннымСканирования(ДанныеСопоставления)
	...
	Если Не АкцизныеМаркиЕГАИС.НоменклатураЯвляетсяАлкогольнойМаркируемойПродукцией(ДанныеСопоставления.Номенклатура) Тогда
		...
		ТекстОшибки = СтрШаблон(НСтр("ru = 'Считан штриход номенклатуры ""%1"", но она не является маркируемой алкогольной продукцией.';
									|en = 'Считан штриход номенклатуры ""%1"", но она не является маркируемой алкогольной продукцией.'"), ДанныеСопоставления.Номенклатура);
		Возврат ТекстОшибки;
	...
	Если ТипШтрихкода = Перечисления.ТипыШтрихкодов.PDF417 Тогда
		...
		Если Элементы.Номенклатура.СписокВыбора.НайтиПоЗначению(ДанныеСопоставления.Номенклатура) = Неопределено Тогда
			...
			Если ДанныеДокументаОснования.Количество() = 0 Тогда
				...
				ТекстОшибки = СтрШаблон(НСтр("ru = 'Считан штриход номенклатуры ""%1"", но она не соответствует алкогольной продукции.';
											|en = 'Считан штриход номенклатуры ""%1"", но она не соответствует алкогольной продукции.'"), ДанныеСопоставления.Номенклатура);
				
			Иначе
				
				ТекстОшибки = СтрШаблон(НСтр("ru = 'Считан штриход номенклатуры ""%1"", но она не соответствует данным документа - основания.';
											|en = 'Считан штриход номенклатуры ""%1"", но она не соответствует данным документа - основания.'"), ДанныеСопоставления.Номенклатура);
		...
		Иначе
			...
			Если ДанныеДокументаОснования.Количество() > 0 Тогда
				...
				Если НайденныеСтроки.Количество() = 0 Тогда
					...
					Если ЗначениеЗаполнено(ДанныеСопоставления.Характеристика) Тогда
						ТекстОшибки = СтрШаблон(НСтр("ru = 'Считан штриход номенклатуры ""%1"", но она не соответствует данным документа - основания.';
													|en = 'Считан штриход номенклатуры ""%1"", но она не соответствует данным документа - основания.'"),
					...
					Иначе
						ТекстОшибки = СтрШаблон(НСтр("ru = 'Считан штриход номенклатуры ""%1"" с характеристикой ""%2"",  но она не соответствует данным документа - основания.';
													|en = 'Считан штриход номенклатуры ""%1"" с характеристикой ""%2"",  но она не соответствует данным документа - основания.'"),
						                        ДанныеСопоставления.Номенклатура,
		...
		Если Элементы.Характеристика.СписокВыбора.НайтиПоЗначению(ДанныеСопоставления.Характеристика) = Неопределено Тогда
			...
			Если КонтролироватьПоДокументуОснованию Тогда
				...
				ТекстОшибки = СтрШаблон(НСтр("ru = 'Считаный штриход соответствует характеристике ""%1"", но она не соответствует данным документа - основания.';
											|en = 'Считаный штриход соответствует характеристике ""%1"", но она не соответствует данным документа - основания.'"),
				                        ДанныеСопоставления.Характеристика);
			...
			Иначе
				...
				ТекстОшибки = СтрШаблон(НСтр("ru = 'Считаный штриход соответствует характеристике ""%1"", но она не сопоставлена алкогольной продукции.';
											|en = 'Считаный штриход соответствует характеристике ""%1"", но она не сопоставлена алкогольной продукции.'"),
				                        ДанныеСопоставления.Характеристика);
	...
	Если ЗначениеЗаполнено(АлкогольнаяПродукция)
		...
		Если СопоставленнаяНоменклатура.Количество() = 0 Тогда
			...
			ТекстПредупреждения = НСтр("ru = 'Выбранная алкогольная продукция не сопоставлена с номенклатурой. Выполнить сопоставление можно в табличной части формы документа.';
										|en = 'Выбранная алкогольная продукция не сопоставлена с номенклатурой. Выполнить сопоставление можно в табличной части формы документа.'");
	...
	Если ЗначениеЗаполнено(Номенклатура) Тогда
		...
		Если Не ЗначениеЗаполнено(АлкогольнаяПродукция) 
			...
			ТекстПредупреждения = НСтр("ru = 'Выбранная номенклатура не сопоставлена с алкогольной продукцией. Выполнить сопоставление можно в табличной части формы документа.';
										|en = 'Выбранная номенклатура не сопоставлена с алкогольной продукцией. Выполнить сопоставление можно в табличной части формы документа.'");
