...
Функция ТаблицаНачислений() Экспорт
	...
	Начисления.Колонки.Добавить("СуммаДоходаНеОблагаемаяНДФЛ", ОписаниеТиповСуммаРезультат());
...
Функция ТаблицаТерриторийУсловийТруда() Экспорт
	...
	Таблица.Колонки.Добавить("СуммаДоходаНеОблагаемаяНДФЛ", ОписаниеТиповСуммаРезультат());
...
Функция ВидыНДФЛДополненияРасчетнойБазыУдержаний() Экспорт 
	...
	ВидыНачислений = Перечисления.ВидыОсобыхНачисленийИУдержаний.СтрокиИсчисленныхНалогов();
