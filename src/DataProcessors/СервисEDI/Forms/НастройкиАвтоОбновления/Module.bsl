...
Процедура ПроверитьЗаполнениеДанных(Отказ)
	...
	Если АвтоматическиОбновлять
		...
		ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru = 'Не указан период автоматического обновления';
														|en = 'Automatic update period is not specified'"),, "ПериодАвтообновления",, Отказ);
