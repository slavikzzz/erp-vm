...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ДанныеТорговойПлощадки Тогда
		...
		Заголовок = ?(Параметры.АнализироватьОтгрузки, НСтр("ru = 'Остатки и заказы товаров на складах Ozon';
															|en = 'Stock balance and goods orders in Ozon warehouses'"), НСтр("ru = 'Остатки товаров на складах Ozon';
																													|en = 'Ozon warehouse balance'"));
		
		Элементы.ТаблицаОстатков.Видимость      = Ложь;
		Элементы.ГруппаПодвалСтатус.Видимость   = Ложь;
		Элементы.ИтогоКПоставке.Заголовок       = ?(Параметры.АнализироватьОтгрузки, НСтр("ru = 'Плановая потребность';
																							|en = 'Planned demand'"), НСтр("ru = 'Итого в наличии';
																																|en = 'Total in stock'"));
