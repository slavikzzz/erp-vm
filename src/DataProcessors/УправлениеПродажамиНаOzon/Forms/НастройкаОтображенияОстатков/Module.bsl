...
Процедура ИнициализироватьДеревоНастроек()
	...
	СтрокаНастройки = ДобавитьСтрокуВДерево(СтрокаРодитель, "ЦенаСУчетомАкцийПродавца", НСтр("ru = 'Цена с акциями продавца';
																							|en = 'Price with seller promotions'"),
