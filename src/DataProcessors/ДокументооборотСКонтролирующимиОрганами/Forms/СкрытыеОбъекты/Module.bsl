...
&НаКлиенте
Асинх Процедура Восстановить(Команда)
	...
	ТекстСообщения = НСтр("ru = 'Вы уверены, что хотите восстановить %1?';
							|en = 'Вы уверены, что хотите восстановить %1?'");
	Если Ждать ВопросАсинх(СтрШаблон(ТекстСообщения, ВидОбъекта), РежимДиалогаВопрос.ДаНет) = КодВозвратаДиалога.Да Тогда
