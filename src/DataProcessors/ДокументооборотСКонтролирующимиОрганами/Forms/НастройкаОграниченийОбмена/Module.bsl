	...
	Если Режим = 1 Тогда
		Если ОднаОрганизация Тогда
			ТекстЗаголовока = НСтр("ru = 'Выберите организацию, по которой производится обновление';
									|en = 'Выберите организацию, по которой производится обновление'");
		Иначе
			ТекстЗаголовока = НСтр("ru = 'Выберите организации, по которым производится обновление';
									|en = 'Выберите организации, по которым производится обновление'");
		КонецЕсли;
	...
	ИначеЕсли Режим = 2 Тогда
		Если ОднаОрганизация Тогда
			ТекстЗаголовока = НСтр("ru = 'Организация, по которой производится обновление';
									|en = 'Организация, по которой производится обновление'");
		Иначе
			ТекстЗаголовока = НСтр("ru = 'Организации, по которым производится обновление';
									|en = 'Организации, по которым производится обновление'");
		КонецЕсли;
		Если ДокументооборотСКОКлиентСервер.ПодсистемаЦБСуществует() Тогда
...
Процедура ПроверитьЗначениеИВидимостьНастройкиСЭДО(ИспользоватьЗначениеФормы = Истина)
	...
	Элементы.ДобавитьОтдельнуюКнопкуОбменаДляСЭДО.Видимость = ЕстьОрганизацииСФСС;
