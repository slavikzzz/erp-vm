...
Процедура КомандаБольшеНеНапоминать(Команда)
	...
	Текст = НСтр("ru = 'Вы сможете завершить настройку 1С-ЭДО по данному заявлению позже, нажав в форме заявления кнопку ""Обновить"" сверху.
                  ...
                  |en = 'Вы сможете завершить настройку 1С-ЭДО по данному заявлению позже, нажав в форме заявления кнопку ""Обновить"" сверху.
                  |Все заявления доступны по ссылке ""Список заявлений"" в разделе ""Настройки"" формы ""1С-Отчетность""'");
...
Процедура ОткрытьФормуПомощи()
	...
	ПараметрыОткрытия = ПараметрыОткрытияПомощи();
	
	ОбработкаЗаявленийАбонентаКлиент.ОткрытьФормуПомощи(
		ЭтотОбъект, 
		ПараметрыОткрытия.ФИО, 
		ПараметрыОткрытия.НомерТелефона,
		"https://its.1c.ru/db/elreps#content:56:hdoc");
