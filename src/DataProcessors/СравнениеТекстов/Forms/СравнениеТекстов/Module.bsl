...
Процедура ПриОткрытии(Отказ)
	...
	Если НЕ Файл.Существует() Тогда
		...
		НСтр("ru = 'Каталог <%1> не существует.';
			|en = 'The <%1> directory does not exist.'"),КаталогРедактора);
	КонецЕсли;
...
Процедура ИнициализироватьРедактор()
	...
	ЗакладкиРедактора.diff(
		...
		ОписаниеТекста2,
		"Файл2",
		СтрШаблон(НСтр("ru = 'Сравнивается <%1> с <%2>';
						|en = 'Comparing <%1> with <%2>'"), ОписаниеТекста1, ОписаниеТекста2),
		0,
		Истина, Истина); 
