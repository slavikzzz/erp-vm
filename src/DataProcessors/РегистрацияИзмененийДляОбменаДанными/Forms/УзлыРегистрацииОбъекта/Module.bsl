...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПустаяСтрока(Расшифровка) Тогда
		Заголовок = СтрЗаменить(НСтр("ru = 'Регистрация %1';
									|en = 'Registration %1'"), "%1", ТекущийОбъект.ПредставлениеСсылки(ОбъектСтрокой));
	Иначе
		Заголовок = СтрЗаменить(НСтр("ru = 'Регистрация %1 (%2)';
									|en = 'Registration %1 (%2)'"), "%1", ТекущийОбъект.ПредставлениеСсылки(ОбъектСтрокой));
...
Процедура ИзменитьРегистрациюЗавершение(Знач РезультатВопроса, Знач ДополнительныеПараметры) Экспорт
	...
	Если Количество > 0 Тогда
		Текст = НСтр("ru = 'Регистрация %1 была изменена на %2 узлах';
					|en = 'Registration of %1 changed at %2 nodes.'");
		ЗаголовокОповещения = НСтр("ru = 'Изменение регистрации:';
									|en = 'Registration changed:'");
