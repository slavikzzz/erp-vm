...
Процедура ОбновитьИндекс(Команда)
	...
	ПоказатьОповещениеПользователя(НСтр("ru = 'Полнотекстовый поиск';
										|en = 'Full-text search'"),, НСтр("ru = 'Индекс успешно обновлен';
...
Процедура ПроверитьИндекс(Команда)
	...
	ПоказатьОповещениеПользователя(НСтр("ru = 'Полнотекстовый поиск';
										|en = 'Full-text search'"),, НСтр("ru = 'Индекс содержит корректные данные';
...
Процедура ОчиститьИндексПослеОтветаНаВопрос(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат = КодВозвратаДиалога.Да Тогда
		...
		ПоказатьОповещениеПользователя(НСтр("ru = 'Полнотекстовый поиск';
											|en = 'Full-text search'"),, НСтр("ru = 'Индекс успешно очищен';
			...
			Исключение
				ЗаписьЖурналаРегистрации(
					НСтр("ru = 'Полнотекстовый поиск';
						|en = 'Full-text search'", ОбщегоНазначения.КодОсновногоЯзыка()),
