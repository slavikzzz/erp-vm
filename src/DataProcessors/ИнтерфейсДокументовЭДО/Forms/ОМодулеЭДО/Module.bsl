...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Исключение
		...
		ТекстОшибки = НСтр("ru = 'Не удалось получить список расширений конфигурации';
							|en = 'Cannot get the list of configuration extensions'", 
			КодЯзыка);
