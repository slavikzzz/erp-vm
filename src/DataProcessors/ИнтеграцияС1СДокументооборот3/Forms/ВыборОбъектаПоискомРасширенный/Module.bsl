...
&НаКлиенте
Асинх Процедура ОбработатьРезультатПоиска()
	...
	ИначеЕсли ПредельноеКоличествоРезультатов <> 0 Тогда
		...
		ПараметрыВопросаДаНет.ТекстКнопкиДа = СтрШаблон(
			НСтр("ru = 'Да, показать первые %1';
				|en = 'Yes, show first %1'"),
				Формат(ПредельноеКоличествоРезультатов, "ЧГ=0"));
		ПараметрыВопросаДаНет.ТекстКнопкиНет = НСтр("ru = 'Нет, уточнить условия';
...
Процедура СобратьПредставлениеУсловия(ТекущиеДанные)
	...
	Если ЗначениеЗаполнено(Оператор) Тогда
		Если Тип = "Строка" Тогда
			Если Оператор = "=" Тогда
				Представление = СтрШаблон(НСтр("ru = 'равно ""%1""';
												|en = 'is ""%1""'"), Значение);
			...
			ИначеЕсли Оператор = "LIKE" Тогда
				...
				ИначеЕсли Лев(Значение, 1) = "%" Тогда
					Представление = СтрШаблон(НСтр("ru = 'заканчивается на ""%1""';
		...
		ИначеЕсли Тип = "Число" Тогда
			...
			ИначеЕсли ЗначениеЗаполнено(Оператор2) Тогда
				Представление = СтрШаблон(НСтр("ru = 'между %1 и %2';
												|en = 'between %1 and %2'"), Значение, Значение2);
				
			ИначеЕсли Оператор = "<=" Тогда
				Представление = СтрШаблон(НСтр("ru = 'по %1';
												|en = 'to %1'"), Значение);
				
			ИначеЕсли Оператор = ">=" Тогда
				Представление = СтрШаблон(НСтр("ru = 'от %1';
												|en = ', %1'"), Значение);
