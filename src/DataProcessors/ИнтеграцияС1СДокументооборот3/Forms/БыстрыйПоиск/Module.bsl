...
Процедура БыстрыйПоискЗначениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПараметрыВыбораЗначенияДО.ТекстРедактирования = Элементы.БыстрыйПоискЗначение.ТекстРедактирования;
	ПараметрыВыбораЗначенияДО.Представление = ТекущиеДанные.ПредставлениеЗначения;
	ПараметрыВыбораЗначенияДО.ЗначениеРеквизита = ТекущиеДанные.Значение;
	ПараметрыВыбораЗначенияДО.ЗначениеРеквизитаID = ТекущиеДанные.ЗначениеID;
	ПараметрыВыбораЗначенияДО.ЗначениеРеквизитаТип = ТекущиеДанные.ЗначениеТип;
...
Процедура БыстрыйПоискЗначениеОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если ТекущиеДанные.Параметр = "Состояние" И ВыбранноеЗначение = НСтр("ru = 'Выбрать несколько...';
																		|en = 'Select several items...'") Тогда
