...
Функция ЭлементТаблицаПослеВыводаШапкиТаблицы(ДокументHTML)
	...
	ДобавитьЯчейкуВТаблицу(ДокументHTML, ЭлементСтрокаТаблицы, НСтр("ru = 'Код';
																	|en = 'Code'"),                   Истина, ЦветФонаЯчейкиШапки, ВысотаЯчейкиШапки);
	ДобавитьЯчейкуВТаблицу(ДокументHTML, ЭлементСтрокаТаблицы, НСтр("ru = 'Шаг процесса';
																	|en = 'Process step'"),          Истина, ЦветФонаЯчейкиШапки, ВысотаЯчейкиШапки);
	ДобавитьЯчейкуВТаблицу(ДокументHTML, ЭлементСтрокаТаблицы, НСтр("ru = 'Исполнитель';
																	|en = 'Assignee'"),           Истина, ЦветФонаЯчейкиШапки, ВысотаЯчейкиШапки);
	ДобавитьЯчейкуВТаблицу(ДокументHTML, ЭлементСтрокаТаблицы, НСтр("ru = 'Действия в программе';
																	|en = 'Actions in the application'"),  Истина, ЦветФонаЯчейкиШапки, ВысотаЯчейкиШапки);
	ДобавитьЯчейкуВТаблицу(ДокументHTML, ЭлементСтрокаТаблицы, НСтр("ru = 'НСИ, документы, формы';
																	|en = 'Master data, documents, forms'"), Истина, ЦветФонаЯчейкиШапки, ВысотаЯчейкиШапки);
