...
Процедура ВывестиИнформациюОУспешномРезультатеОбмена()
	...
	Строки.Добавить(
		Новый ФорматированнаяСтрока(
			СтрШаблон(НСтр("ru = 'На запрос о %1 организации %2 получен ответ.';
							|en = 'На запрос о %1 организации %2 получен ответ.'"), СтрокаТипОперации("Получение"), Наименование)));
			
	Строки.Добавить(" ");
	Строки.Добавить(
		Новый ФорматированнаяСтрока(
			СтрШаблон(НСтр("ru = '%1 организация';
							|en = '%1 организация'"), СтрокаТипОперации("Завершено"))));
	Строки.Добавить(" ");
		...
		Иначе
			...
			Если Не Статус = Перечисления.СтатусыОбъектовСАТУРН.Черновик Тогда
				...
				ШаблонИнформации = НСтр("ru = 'Редактирование организации возможно только в статусе Черновик.
					...
					|en = 'Редактирование организации возможно только в статусе Черновик.
					|Организация переведена в статус %1, редактирование невозможно.'");
...
Процедура УправлениеЭлементамиФормы(Форма)
	...
	Если Форма.РежимИзменения Тогда
		...
		Форма.Заголовок = НСтр("ru = 'Изменение организации';
								|en = 'Изменение организации'");
		
	Иначе
		
		Форма.Заголовок = НСтр("ru = 'Создание организации';
								|en = 'Создание организации'");
