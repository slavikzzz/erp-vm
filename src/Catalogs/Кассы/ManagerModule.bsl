...
// Заполняет реквизиты параметров настройки счетов учета денежных средств, которые влияют на настройку,
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет реквизит ""Кассир"" из кассира указанного в лицах с правом подписи';
									|en = 'Fills the ""Cashier"" attribute from the cashier specified in authorized signatories'" );
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Если ОбъектовОбработано = 0 И ПроблемныхОбъектов <> 0 Тогда
		...
		ШаблонСообщения = НСтр("ru = 'Не удалось заполнить кассиров (пропущены): %1';
								|en = 'Cannot fill the cashiers (skipped): %1'");
	...
	Иначе
		...
		ШаблонСообщения = НСтр("ru = 'Обработана порция касс: %1';
								|en = 'A batch of cash accounts is processed: %1'");
