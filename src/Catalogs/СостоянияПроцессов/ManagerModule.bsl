...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Элемент.Наименование = НСтр("ru = 'Процессы продаж';
								|en = 'Sales processes'", КодОсновногоЯзыка);
	...
	Элемент.Наименование = НСтр("ru = 'Выполнение обязательств';
								|en = 'Fulfill contract'", КодОсновногоЯзыка);
	Элемент.Описание = НСтр("ru = 'На данном этапе должны быть оплачены и отгружены все товары по сделке.';
							|en = 'During this stage, all sold goods are paid and shipped.'", КодОсновногоЯзыка);
	...
	Элемент.Родитель = Справочники.СостоянияПроцессов.ПроцессыПродаж;
	Элемент.Наименование = НСтр("ru = 'Доработка предложения';
								|en = 'Offer revision'", КодОсновногоЯзыка);
	Элемент.Описание = НСтр("ru = 'Данный этап посвящен доработке коммерческого предложения, если таковая необходима.';
							|en = 'This step is about a sales quotation revision, if required.'", КодОсновногоЯзыка);
	...
	Элемент.Родитель = Справочники.СостоянияПроцессов.ПроцессыПродаж;
	Элемент.Наименование = НСтр("ru = 'Квалификация клиента';
								|en = 'Qualify lead'", КодОсновногоЯзыка);
	Элемент.Описание = НСтр("ru = 'На данном этапе клиент должен быть определен и зарегистрирован в качестве партнера.';
							|en = 'On this step, the customer should be defined and registered as a partner.'", КодОсновногоЯзыка);
	...
	Элемент.Родитель = Справочники.СостоянияПроцессов.ПроцессыПродаж;
	Элемент.Наименование = НСтр("ru = 'Новая сделка';
								|en = 'New sales opportunity'", КодОсновногоЯзыка);
	Элемент.Описание = НСтр("ru = 'Данный этап отражает факт того, что сделка была зарегистрирована, но никаких других работ по не не проводилось';
							|en = 'This stage shows that the sales opportunity was registered but no other actions were taken'", КодОсновногоЯзыка);
	...
	Элемент.Родитель = Справочники.СостоянияПроцессов.ПроцессыПродаж;
	Элемент.Наименование = НСтр("ru = 'Первичный контакт';
								|en = 'Register opportunity'", КодОсновногоЯзыка);
	Элемент.Описание = НСтр("ru = 'На данном этапе необходимо зарегистрировать первичное взаимодействие с клиентом.';
							|en = 'On this step, it is required to register initial interaction with a customer.'", КодОсновногоЯзыка);
	...
	Элемент.Родитель = Справочники.СостоянияПроцессов.ПроцессыПродаж;
	Элемент.Наименование = НСтр("ru = 'Подготовка к выполнению обязательств';
								|en = 'Sign contract'", КодОсновногоЯзыка);
	Элемент.Описание = НСтр("ru = 'Данный этап посвящен подготовке к выполнению обязательств по сделке.';
							|en = 'This stage is about preparation for fulfilling liabilities under the sales opportunity.'", КодОсновногоЯзыка);
	...
	Элемент.Родитель = Справочники.СостоянияПроцессов.ПроцессыПродаж;
	Элемент.Наименование = НСтр("ru = 'Презентация';
								|en = 'Demonstrate product'", КодОсновногоЯзыка);
	Элемент.Описание= НСтр("ru = 'Данный этап посвящен презентации, если таковая необходима.';
							|en = 'This step is about a presentation if it is required.'", КодОсновногоЯзыка);
	...
	Элемент.Родитель = Справочники.СостоянияПроцессов.ПроцессыПродаж;
	Элемент.Наименование = НСтр("ru = 'Согласование условий';
								|en = 'Negotiate terms of sales'", КодОсновногоЯзыка);
	Элемент.Описание = НСтр("ru = 'На данном этапе должно быть определено соглашение с клиентом, определяющее условия продаж.';
							|en = 'On this step, determine an agreement with customer that specifies sales terms and conditions.'", КодОсновногоЯзыка);
	...
	Элемент.Родитель = Справочники.СостоянияПроцессов.ПроцессыПродаж;
	Элемент.Наименование = НСтр("ru = 'Формирование предложения';
								|en = 'Prepare proposal'", КодОсновногоЯзыка);
	Элемент.Описание = НСтр("ru = 'Данный этап посвящен формированию коммерческого предложения.';
							|en = 'This step is about a sales quotation creation.'", КодОсновногоЯзыка);
...
Функция ОписаниеПредопределенногоСостоянияПроцесса(ЭтапПроцесса);
	...
	Если ЭтапПроцесса = Справочники.СостоянияПроцессов.НоваяСделка Тогда
		...
		Возврат НСтр("ru = 'Данный этап отражает факт того, что сделка была зарегистрирована, но никаких других работ по не не проводилось';
					|en = 'This stage shows that the sales opportunity was registered but no other actions were taken'");
	...
	ИначеЕсли ЭтапПроцесса = Справочники.СостоянияПроцессов.ФормированиеПредложения Тогда
		...
		Возврат НСтр("ru = 'Данный этап посвящен формированию коммерческого предложения.';
					|en = 'This step is about a sales quotation creation.'");
	...
	ИначеЕсли ЭтапПроцесса = Справочники.СостоянияПроцессов.ДоработкаПредложения Тогда
		...
		Возврат НСтр("ru = 'Данный этап посвящен доработке коммерческого предложения, если таковая необходима.';
					|en = 'This step is about a sales quotation revision, if required.'");
	...
	ИначеЕсли ЭтапПроцесса = Справочники.СостоянияПроцессов.СогласованиеУсловий Тогда
		...
		Возврат НСтр("ru = 'На данном этапе должно быть определено соглашение с клиентом, определяющее условия продаж.';
					|en = 'On this step, determine an agreement with customer that specifies sales terms and conditions.'");
	...
	ИначеЕсли ЭтапПроцесса = Справочники.СостоянияПроцессов.ПодготовкаКВыполнениюОбязательств Тогда
		...
		Возврат НСтр("ru = 'Данный этап посвящен подготовке к выполнению обязательств по сделке.';
					|en = 'This stage is about preparation for fulfilling liabilities under the sales opportunity.'");
	...
	ИначеЕсли ЭтапПроцесса = Справочники.СостоянияПроцессов.ВыполнениеОбязательств Тогда
		...
		Возврат НСтр("ru = 'На данном этапе должны быть оплачены и отгружены все товары по сделке.';
					|en = 'During this stage, all sold goods are paid and shipped.'");
