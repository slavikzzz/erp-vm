...
Процедура ОткрытьЧерезБраузер(Команда)
	...
	Иначе 
		ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru = 'Идентификатор документа не заполнен!';
														|en = 'Идентификатор документа не заполнен!'"),,,"Объект.Идентификатор");
	КонецЕсли;
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
		...
		Для каждого ВидПериода Из СтрРазделить("ДатаПроизводства,СрокГодности",",") Цикл
			...
			ПредставлениеПериода = ИнтеграцияВЕТИСКлиентСервер.ПредставлениеПериодаВЕТИС(
				...
				Если ПустаяСтрока(ПредставлениеПериода) Тогда
					Форма["Надпись"+ВидПериода] = Новый ФорматированнаяСтрока(НСтр("ru = 'указать';
	...
	Если СтруктураРеквизитов.Свойство("Производители")
		...
		Если ПустаяСтрока(ПредставлениеПроизводители) Тогда
			Форма.НадписьПроизводители = Новый ФорматированнаяСтрока(НСтр("ru = 'указать';
																			|en = 'указать'"),,Форма.ЦветГиперссылкиОсобыйТекст,,"Производители");
		Иначе
			...
			Если Форма.Электронный Тогда
				...
				МассивСтрок.Добавить(
					Новый ФорматированнаяСтрока(
						НСтр("ru = 'Сведения о ветеринарных мероприятиях';
							|en = 'Сведения о ветеринарных мероприятиях'"),,Форма.ЦветГиперссылкиОбычный,,"ВетеринарныеМероприятия"));
