...
Процедура УстановитьЗаголовокФормы()
	...
	Если РежимВыбора Тогда
		ТекстЗаголовка = НСтр("ru = 'Выбор классификатора ПАТ САТУРН';
								|en = 'Выбор классификатора ПАТ САТУРН'");
	Иначе
		ТекстЗаголовка = НСтр("ru = 'Классификатор ПАТ САТУРН';
								|en = 'Классификатор ПАТ САТУРН'");
	КонецЕсли;
...
Процедура СформироватьПредставлениеПараметровПоиска(ПараметрыОтбора, ПриСоздании = Ложь)
	...
	Если ПараметрыОтбора <> Неопределено Тогда
		...
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'GUID';
																	|en = 'GUID'"),                  "GUID",                 КоличествоПараметровОтбора);
		...
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'Вид продукции';
																	|en = 'Вид продукции'"),         "ВидПродукции",         КоличествоПараметровОтбора);
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'Статус';
																	|en = 'Статус'"),                "Статус",               КоличествоПараметровОтбора);
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'Группа';
																	|en = 'Группа'"),                "Группа",               КоличествоПараметровОтбора);
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'Регистрант';
																	|en = 'Регистрант'"),            "Регистрант",           КоличествоПараметровОтбора);
