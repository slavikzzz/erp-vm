...
Функция СтандартнаяГруппаПользователей(ИмяГруппы) Экспорт
	...
	Если ИмяГруппы = "ВсеВнешниеПользователи" Тогда
		...
		НаименованиеГруппы = НСтр("ru = 'Все внешние пользователи';
									|en = 'All external users'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	ИначеЕсли ИмяГруппы = "ВсеПользователи" Тогда
		...
		НаименованиеГруппы = НСтр("ru = 'Все пользователи';
									|en = 'All users'", ОбщегоНазначения.КодОсновногоЯзыка());
	Иначе
		ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Неизвестное имя стандартной группы ""%1"".';
				|en = 'The standard group has unknown name ""%1"".'"), ИмяГруппы);
...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Элемент.Наименование = НСтр("ru = 'Все пользователи';
								|en = 'All users'", ОбщегоНазначения.КодОсновногоЯзыка());
