...
Функция РеквизитыОбъектаДО(ТипОбъектаДО, ВидДокументаДОID, ПолучитьВсе, НастройкиВида = Неопределено,
	...
	Если ИнтеграцияС1СДокументооборот3.ЭтоДокументДО3(ТипОбъектаДО) Тогда
		...
		Если ПолучитьВсе Или НастройкиВида.performanceDateEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "performanceDate", НСтр("ru = 'Срок исполнения';
																|en = 'Due date'"), "Дата",, "СрокИсполнения");
		КонецЕсли;
		Если ПолучитьВсе Или НастройкиТипа.accessLevelEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "accessLevel", НСтр("ru = 'Гриф доступа';
															|en = 'Access label '"), "DMAccessLevel", Истина, "ГрифДоступа");
		КонецЕсли;
			...
			Если ИнтеграцияС1СДокументооборотБазоваяФункциональность.СвойствоУстановлено(НастройкиВида, "actionTypes") Тогда
				Для Каждого ВидДействияXDTO Из НастройкиВида.actionTypes Цикл
					ДобавитьРеквизит(
						...
						СтрШаблон(НСтр("ru = 'Состояние действия ""%1""';
										|en = 'State of the %1 action'"), ВидДействияXDTO.name),
						"DMDocumentStatus");
				КонецЦикла;
			Иначе
				...
				Если ИнтеграцияС1СДокументооборотБазоваяФункциональность.СвойствоСуществует(
					...
					ДобавитьРеквизит(Реквизиты, "statusAcquaintance", НСтр("ru = 'Состояние ознакомления';
																			|en = 'Preview state'"), "DMDocumentStatus");
				ИначеЕсли ИнтеграцияС1СДокументооборотБазоваяФункциональность.СвойствоСуществует(
						НастройкиТипа, "statusExamination") Тогда
					ДобавитьРеквизит(Реквизиты, "statusExamination", НСтр("ru = 'Состояние ознакомления';
																			|en = 'Preview state'"), "DMDocumentStatus");
				КонецЕсли;
			КонецЕсли;
		КонецЕсли;
		...
		Если ПолучитьВсе Или НастройкиВида.sumEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "sum", НСтр("ru = 'Сумма';
													|en = 'Amount'"), "Число",, "Сумма");
			ДобавитьРеквизит(Реквизиты, "VAT", НСтр("ru = 'В т.ч. НДС';
													|en = 'Including VAT'"), "Число",, "СуммаНДС");
			ДобавитьРеквизит(Реквизиты, "currency", НСтр("ru = 'Валюта';
														|en = 'Currency'"), "DMCurrency",, "Валюта");
		КонецЕсли;
		
		// Подписал от контрагента.
		Если ПолучитьВсе Или НастройкиВида.isIncoming = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "signerFromTheCorrespondent", НСтр("ru = 'Подписал';
																			|en = 'Signed by'"), "DMContactPerson",, "ПодписалОтКонтрагента");
		КонецЕсли;
		...
		Если Показывать Тогда
			ДобавитьРеквизит(Реквизиты, "addressee", НСтр("ru = 'Адресат';
															|en = 'Recipient'"), ТипЗначения, Обязательный, "Адресат");
		КонецЕсли;
		...
		Если ПолучитьВсе Или НастройкиВида.durationEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты,
				"beginDate", НСтр("ru = 'Дата начала действия';
									|en = 'Certificate start date'"), "Дата",, "ДатаНачалаДействия");
			ДобавитьРеквизит(Реквизиты,
				"endDate", НСтр("ru = 'Дата окончания действия';
								|en = 'Certificate end date'"), "Дата",, "ДатаОкончанияДействия");
			ДобавитьРеквизит(Реквизиты,
				"openEnded", НСтр("ru = 'Бессрочный';
									|en = 'Permanent'"), "Булево",, "Бессрочный");
			ДобавитьРеквизит(Реквизиты,
				"prolongationProcedure", НСтр("ru = 'Порядок продления';
												|en = 'Extension procedure'"), "DMProlongationProcedure",, "ПорядокПродления");
		КонецЕсли;
		...
		Если ПолучитьВсе Или (НастройкиВида.partiesEnabled = Истина И НастройкиВида.isAPaymentRequest <> Истина) Тогда
			...
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "signedBy", НСтр("ru = 'Подписал';
													|en = 'Signed by'"), ТипКонтактноеЛицоСтороны);
		КонецЕсли;
	...
	ИначеЕсли ТипОбъектаДО = "DMCorrespondent" Тогда
		...
		ДобавитьРеквизит(Реквизиты, "name", НСтр("ru = 'Наименование';
												|en = 'Name'"), "Строка", Истина, "Наименование");
		ДобавитьРеквизит(Реквизиты, "legalPrivatePerson", НСтр("ru = 'Вид контрагента';
																|en = 'Counterparty type'"), "DMLegalPrivatePerson", Истина, "ЮрФизЛицо");
	...
	ИначеЕсли ТипОбъектаДО = "DMMeeting" Тогда
		...
		ДобавитьРеквизит(Реквизиты, "name", НСтр("ru = 'Наименование';
												|en = 'Name'"), "Строка", Истина, "Наименование");
		ДобавитьРеквизит(Реквизиты, "type", НСтр("ru = 'Вид мероприятия';
												|en = 'Event type'"), "DMMeetingType", Истина, "ВидМероприятия");
		...
		Если ПолучитьВсе Или НастройкиТипа.foldersEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "folder", НСтр("ru = 'Папка';
														|en = 'Folder'"), "DMMeetingFolder", Истина, "Папка");
		КонецЕсли;
		...
		ТипОрганизатор.Добавить("DMCorrespondent", НСтр("ru = 'Контрагенты';
														|en = 'Counterparties'"));
		ДобавитьРеквизит(Реквизиты, "calledBy", НСтр("ru = 'Организатор';
													|en = 'Organizer'"), ТипОрганизатор, Истина, "Организатор");
		...
		ТипПредседатель.Добавить("DMContactPerson", НСтр("ru = 'Контактные лица';
														|en = 'Contact persons'"));
		ДобавитьРеквизит(Реквизиты, "chairPerson", НСтр("ru = 'Председатель';
														|en = 'Chairperson'"), ТипПредседатель,, "Председатель");
		...
		ТипСекретарь.Добавить("DMContactPerson", НСтр("ru = 'Контактные лица';
														|en = 'Contact persons'"));
		ДобавитьРеквизит(Реквизиты, "secretary", НСтр("ru = 'Секретарь';
														|en = 'Secretary'"), ТипСекретарь,, "Секретарь");
		
		ДобавитьРеквизит(Реквизиты, "comment", НСтр("ru = 'Комментарий';
													|en = 'Comment'"), "Строка",, "Комментарий");
		ДобавитьРеквизит(Реквизиты, "description", НСтр("ru = 'Описание мероприятия';
														|en = 'Event description'"), "Строка",, "Описание");
		
		ДобавитьРеквизит(Реквизиты, "startDate", НСтр("ru = 'Дата и время начала';
														|en = 'Date and time of beginning'"), "Дата",, "ДатаНачала");
		ДобавитьРеквизит(Реквизиты, "endDate", НСтр("ru = 'Дата и время окончания';
													|en = 'Date and time of completion'"), "Дата",, "ДатаОкончания");
		
		ДобавитьРеквизит(Реквизиты, "organization", НСтр("ru = 'Организация';
														|en = 'Company'"), "DMOrganization",, "Организация");
		ДобавитьРеквизит(Реквизиты, "place", НСтр("ru = 'Место проведения';
													|en = 'Location'"), "Строка",, "МестоПроведения");
		ДобавитьРеквизит(Реквизиты, "project", НСтр("ru = 'Проект';
													|en = 'Project'"), "DMProject",, "Проект");
		...
		ДобавитьТаблицу(Реквизиты, "agenda", НСтр("ru = 'Программа';
													|en = 'Application'"));
		ДобавитьРеквизитТаблицы(Реквизиты, "agenda", "employee", НСтр("ru = 'Исполнитель';
																		|en = 'Assignee'"), "DMEmployee");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "role", НСтр("ru = 'Роль исполнителя';
									|en = 'Assignee''s role'"), "DMBusinessProcessExecutorRole");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "mainAddressingItem", НСтр("ru = 'Основной объект адресации исполнителя';
												|en = 'Main addressing object of the assignee'"), "DMMainAddressingObject");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "secondaryAddressingItem", НСтр("ru = 'Дополнительный объект адресации исполнителя';
														|en = 'Additional addressing object of the assignee'"), "DMSecondaryAddressingObject");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "number", НСтр("ru = 'Номер пункта';
									|en = 'Point number'"), "Число");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "description", НСтр("ru = 'Содержание';
											|en = 'Content'"), "Строка");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "comment", НСтр("ru = 'Комментарий';
										|en = 'Comment'"), "Строка");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "decisionIsNecessary", НСтр("ru = 'Требует принятия решения';
													|en = 'Requires a decision'"), "Булево");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "estimatedDuration", НСтр("ru = 'Время план (секунд)';
												|en = 'Planned time (seconds)'"), "Число");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "duration", НСтр("ru = 'Время факт (секунд)';
										|en = 'Actual time (seconds)'"), "Число");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "startDate", НСтр("ru = 'Дата и время начала';
										|en = 'Date and time of beginning'"), "Дата");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "endDate", НСтр("ru = 'Дата и время окончания';
										|en = 'Date and time of completion'"), "Дата");
		
		// Табличная часть Участники
		ДобавитьТаблицу(Реквизиты, "attendees", НСтр("ru = 'Участники';
													|en = 'Participants'"));
		ДобавитьРеквизитТаблицы(Реквизиты,
			"attendees", "absent", НСтр("ru = 'Отсутствовал';
										|en = 'Absent'"), "Булево");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"attendees", "invitationStatus", НСтр("ru = 'Состояние приглашения';
													|en = 'Invitation state'"), "DMInvitationStatus");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"attendees", "mainAddressingObject", НСтр("ru = 'Основной объект адресации участника';
														|en = 'The main addressing object of the participant'"), "DMMainAddressingObject");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"attendees", "obligatory", НСтр("ru = 'Явка обязательна';
											|en = 'Attendance is compulsory'"), "Булево");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"attendees", "role", НСтр("ru = 'Роль исполнителя';
										|en = 'Assignee''s role'"), "DMBusinessProcessExecutorRole");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"attendees", "secondaryAddressingObject", НСтр("ru = 'Дополнительный объект адресации участника';
															|en = 'Additional object of addressing of the participant'"), "DMSecondaryAddressingObject");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"attendees", "employee", НСтр("ru = 'Пользователь';
											|en = 'User'"), "DMEmployee");
		...
		ДобавитьТаблицу(Реквизиты, "statuses", НСтр("ru = 'Состояния';
													|en = 'State'"));
		ДобавитьРеквизитТаблицы(Реквизиты,
			"statuses", "objectID.ID", НСтр("ru = 'Состояние';
											|en = 'State'"), "Строка");
		...
		Если ЭтоТаблица И ТипЗнч(Результат) <> Тип("ТаблицаЗначений") Тогда
			ВызватьИсключение СтрШаблон(
				НСтр("ru = 'Для заполнения таблицы результат должен иметь тип %1';
					|en = 'To fill the table, the result must have the %1 type'"),
				"ТаблицаЗначений");
		КонецЕсли;
...
Процедура ПроверитьПравило(ПравилоИнтеграции) Экспорт
	...
	Если Не ЗначениеЗаполнено(ПравилоИнтеграции.ТипОбъектаДО) Тогда
		ВызватьИсключение НСтр("ru = 'Не задан тип объекта 1С:Документооборот';
								|en = '1C:Document Management object type is not specified'");
	КонецЕсли;
	...
	Исключение
		...
		Ответ = ИнтеграцияС1СДокументооборот3.ОписаниеОшибкиXDTO(
			НСтр("ru = 'Ошибка при поиске связанных правил интеграции';
				|en = 'An error occurred when looking for related integration rules'"),
	...
	Исключение
		...
		Ответ = ИнтеграцияС1СДокументооборот3.ОписаниеОшибкиXDTO(
			НСтр("ru = 'Ошибка при создании правила интеграции';
				|en = 'An error occurred when creating an integration rule'"),
			ИнтеграцияС1СДокументооборот3.ПолучитьОписаниеОшибки(ИнформацияОбОшибке()));
		...
		Если ИмяТаблицыОбъектаИС = "" Тогда
			ВызватьИсключение СтрШаблон(
				НСтр("ru = 'В метаданных объекта ""%1"" не удалось найти реквизит с именем ""%2""';
					|en = 'Cannot find an attribute with the ""%2"" name in the ""%1"" object metadata'"),
				ЗаполняемыйОбъектИС,
				ИмяРеквизитаОбъектаИС);
		Иначе
			ВызватьИсключение СтрШаблон(
				НСтр("ru = 'В метаданных объекта ""%1"" не удалось найти реквизит таблицы ""%2"" с именем ""%3""';
					|en = 'Cannot find the ""%2"" table attribute with the ""%3"" name in the ""%1"" object metadata'"),
				ЗаполняемыйОбъектИС,
				ИмяТаблицыОбъектаИС,
				ИмяРеквизитаОбъектаИС);
		КонецЕсли;
	...
	ИначеЕсли ПравилоРеквизита.Вариант = ВариантВыражение() Тогда
		...
		Иначе
			ВызватьИсключение НСтр("ru = 'Не задано место выполнения выражения на встроенном языке.';
									|en = 'Location of executing the expression in 1C:Enterprise language is not specified.'");
		...
		Иначе
			...
			ТекстОшибки = СтрШаблон(
				НСтр("ru = 'Тип результата выражения на встроенном языке не соответствует типу реквизита.
					...
					|%3';
					|en = 'The expression result type in 1C:Enterprise language does not match the attribute type.
					|Attribute type: %1.
					|Expression result type: %2.
					|Expression result in 1C:Enterprise language:
					|%3'"),
					...
					СписокОшибок.Добавить(
						СтрШаблон(
							НСтр("ru = 'Ошибка в правиле заполнения %1 (Закладка ""Получение из 1С:Документооборота""):
								...
								|en = 'Filling rule error %1 (Tab ""Receive from 1C:Document Management""):
								|filling option is selected from non-existing addit. attribute ""%2""'"),
									ПредставлениеРеквизитаИС,
									Правило.ДополнительныйРеквизитДОID));
				КонецЕсли;
