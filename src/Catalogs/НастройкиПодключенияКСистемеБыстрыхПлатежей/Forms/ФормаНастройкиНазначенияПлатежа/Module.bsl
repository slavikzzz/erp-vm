		...
		ОбщегоНазначенияКлиент.СообщитьПользователю(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'В назначении платежа присутствуют запрещенные символы: %1';
					|en = 'The purpose of payment contains characters that are not allowed: %1'"),
			...
			ОбщегоНазначенияКлиент.СообщитьПользователю(
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'В назначении платежа шаблона %1 присутствуют запрещенные символы: %2';
						|en = 'The purpose of payment of the %1 template contains characters that are not allowed: %2'"),
