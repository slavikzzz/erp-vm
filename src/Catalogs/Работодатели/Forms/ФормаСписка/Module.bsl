...
Процедура ДобавитьНашуОрганизацию(Команда)
	...
	ПоказатьВводЗначения(Оповещение, ВыбраннаяОрганизация, НСтр("ru = 'Организация по данным которой создается работодатель';
																|en = 'Company whose data is used the employer is created'"), Тип("СправочникСсылка.Организации"));
