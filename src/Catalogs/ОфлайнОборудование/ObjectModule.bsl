...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ПустаяСтрока(Наименование) Тогда
		...
		Если Не Запрос.Выполнить().Пустой() Тогда
			ОбщегоНазначенияБПО.СообщитьПользователю(НСтр("ru = 'Указано неуникальное наименование элемента. Укажите уникальное наименование.';
															|en = 'Non-unique item name specified. Specify a unique name.'"), ЭтотОбъект, , , Отказ);
		КонецЕсли;
	КонецЕсли;
