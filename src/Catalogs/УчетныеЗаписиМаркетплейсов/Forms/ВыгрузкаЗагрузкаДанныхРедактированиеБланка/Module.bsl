...
Процедура СброситьНастройки(Команда)
	...
	ПоказатьВопрос(Оповещение, НСтр("ru = 'Установить настройки колонок в первоначальное состояние?';
									|en = 'Do you want to revert to the default column settings?'"), РежимДиалогаВопрос.ДаНет);
