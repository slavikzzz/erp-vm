...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	Если ВычетКДоходу = Истина И КодДохода <> Неопределено И НалоговыйПериод <> Неопределено Тогда 
		...
		Если ДанныеВыбора.Количество() = 0 Тогда
			ДанныеВыбора.Добавить(НСтр("ru = 'Нет вычетов к доходу';
										|en = 'No deductions for income'") + " " + СокрЛП(КодДохода));
		КонецЕсли; 
...
Процедура ЗаполнитьКодыВычетовНДФЛ() Экспорт
	...
	ОписатьКодВычетаНДФЛ("Код319", "330/327", НСтр("ru = 'Сумма уплаченных налогоплательщиком в налоговом периоде пенсионных взносов по договору (договорам) негосударственного пенсионного обеспечения, заключенному (заключенным) налогоплательщиком с негосударственным пенсионным фондом в свою пользу и (или) в пользу членов семьи и (или) близких родственников в соответствии с Семейным кодексом Российской Федерации (супругов, родителей и детей, в том числе усыновителей и усыновленных, дедушки, бабушки и внуков, полнородных и неполнородных (имеющих общих отца или мать) братьев и сестер), детей-инвалидов, находящихся под опекой (попечительством), и (или) в сумме уплаченных налогоплательщиком в налоговом периоде страховых взносов по договору (договорам) добровольного пенсионного страхования, заключенному (заключенным) со страховой организацией в свою пользу и (или) в пользу супруга (в том числе вдовы, вдовца), родителей (в том числе усыновителей), детей-инвалидов (в том числе усыновленных, находящихся под опекой (попечительством), - в размере фактически произведенных расходов с учетом ограничения, установленного пунктом 2 статьи 219 Налогового кодекса Российской Федерации';
													|en = 'The amount of pension contributions paid by a taxpayer in the fiscal period under non-state pension provision contract(s) concluded by the taxpayer with a non-state pension fund in their own favor and (or) in favor of their family members and (or) close relatives in accordance with the Family Code of the Russian Federation (spouses, parents, and children, including adoptive parents and adopted children, grandparents and grandchildren, siblings and half-siblings (who have the same father or mother), disabled children under guardianship) and (or) in the amount of insurance contributions paid by the taxpayer in the fiscal period under the voluntary pension insurance contract(s) concluded with an insurance company in their own favor and (or) in favor of their spouse (including widow or widower), parents (including adoptive parents), disabled children (including adopted children who are under guardianship) in the amount of actually incurred expenses considering the restriction established by clause 2 of article 219 of the Tax Code of the Russian Federation'"), 
	...
	ОписатьКодВычетаНДФЛ("Код329", "332/327", НСтр("ru = 'Сумма страховых взносов по договору (договорам) добровольного страхования жизни, если такие договоры заключаются на срок не менее пяти лет, заключенному (заключенным) со страховой организацией в свою пользу и (или) в пользу супруга (в том числе вдовы, вдовца), родителей (в том числе усыновителей), детей (в том числе усыновленных, находящихся под опекой (попечительством))';
													|en = 'The amount of insurance contributions under the contracts of voluntary life insurance concluded for a period of at least five years with an insurance company in a taxpayer''s favor and (or) in favor of their spouse (including widow, widower), parents (including adoptive parents), children (including adopted children who are under guardianship or trusteeship)'"), 
	Ложь, ГруппыВычетов.СоциальныеПоУведомлениюНО,
	"-", "-", "-", "327", , 29, "332");
	...
	ОписатьКодВычетаНДФЛ("Код403", "403", "Сумма фактически произведенных и документально подтвержденных расходов (за исключением страховых взносов, исчисленных в соответствии со статьей 430 Налогового кодекса Российской Федерации), непосредственно связанных с выполнением работ (оказанием услуг) по договорам гражданско-правового характера",
	,,
...
Процедура ОписатьВычеты2022() Экспорт 
	...
	ОписатьКодВычетаНДФЛ("Код324", "324", НСтр("ru = 'Сумма, уплаченная налогоплательщиком в налоговом периоде за медицинские услуги, оказанные медицинскими организациями, индивидуальными предпринимателями, осуществляющими медицинскую деятельность, ему, его супругу (супруге), родителям, детям (в том числе усыновленным) в возрасте до 18 лет, подопечным в возрасте до 18 лет (в соответствии с перечнем медицинских услуг, утвержденным Правительством Российской Федерации) с учетом ограничения, установленного пунктом 2 статьи 219 Налогового кодекса Российской Федерации';
												|en = 'The amount paid by a taxpayer in the fiscal period for medical services provided by healthcare providers, individual entrepreneurs engaged in medical activities to the taxpayer, their spouse, parents, children (including adopted children) under the age of 18, wards under the age of 18 (in accordance with the list of medical services approved by the Government of the Russian Federation) considering the restriction established by clause 2 of article 219 of the Tax Code of the Russian Federation'"), 
	Ложь, ГруппыВычетов.СоциальныеПоУведомлениюНО, 
	"-", "-", "324", "324", , 30);	
	...
	ОписатьКодВычетаНДФЛ("Код323", "323", НСтр("ru = 'Стоимость приобретенных налогоплательщиком, за счет собственных средств, лекарственных препаратов для медицинского применения, назначенных лечащим врачом ему, его супругу (супруге), родителям, детям (в том числе усыновленным) в возрасте до 18 лет, подопечным в возрасте до 18 лет - в размере фактически произведенных расходов, но с учетом ограничения, установленного пунктом 2 статьи 219 Налогового кодекса Российской Федерации';
												|en = 'The cost of medicine purchased by a taxpayer at their own expense for medical use prescribed by the physician to the taxpayer, their spouse, parents, children (including adopted children) under the age of 18, wards under the age of 18 in the amount of actually incurred expenses considering the restriction established by clause 2 of article 219 of the Tax Code of the Russian Federation'"), 
	Ложь, ГруппыВычетов.СоциальныеПоУведомлениюНО, 
	"-", "-", "-", "323", , 36);	
	...
	ОписатьКодВычетаНДФЛ("Код329Спорт", "329", НСтр("ru = 'Сумма уплаченных налогоплательщиком в налоговом периоде за счет собственных средств за физкультурно-оздоровительные услуги, оказанные ему, его детям (в том числе усыновленным) в возрасте до 18 лет, подопечным в возрасте до 18 лет физкультурно-спортивными организациями, индивидуальными предпринимателями, осуществляющими деятельность в области физической культуры и спорта в качестве основного вида деятельности, - в размере фактически произведенных расходов с учетом ограничения, установленного пунктом 2 статьи 219 Налогового кодекса Российской Федерации';
													|en = 'The amount paid by a taxpayer in the fiscal period at their expense for sport and recreation services provided to the taxpayer, their children (including adopted children) under the age of 18, and wards under the age of 18 by sport organizations and individual entrepreneurs who provide sport services as their main activity type in the amount of actually incurred expenses considering the restriction established by clause 2 of article 219 of the Tax Code of the Russian Federation'"), 
	Ложь, ГруппыВычетов.СоциальныеПоУведомлениюНО, 
	"-", "-", "-", "329", , 37);	
...
Процедура ОписатьВычеты2024() Экспорт 

	// АПК:1297-выкл Не локализуется, т.к. является частью регламентированной формы, применяемой в РФ.
	
	ОписатьКодВычетаНДФЛ("Код253", "253", "Сумма накопленного процентного (купонного) дохода",
	,,
	"-","-","-","-",,,"253");
...
Процедура ОписатьВычет619() Экспорт 

	// АПК:1297-выкл Не локализуется, т.к. является частью регламентированной формы, применяемой в РФ.
	
	ОписатьКодВычетаНДФЛ("Код619", "619", "Вычет в сумме положительного финансового результата, полученного по операциям, учитываемым на индивидуальном инвестиционном счете",
	,,
	"-","-","-","-",,,"619");
...
Процедура ОписатьВычеты2025() Экспорт 

	ГруппыВычетов = Перечисления.ГруппыВычетовПоНДФЛ;
	// АПК:1297-выкл Не локализуется, т.к. является частью регламентированной формы, применяемой в РФ.
	
	ОписатьКодВычетаНДФЛ("Код150", "150", "Сдавшему нормы ГТО и награжденного знаком отличия или подтвердившего полученный знак отличия",
	Ложь, ГруппыВычетов.Стандартные,
	"-","-","-","-",,26,"150");
	...
	ОписатьКодВычетаНДФЛ("Код406", "406", "Сумма фактически произведенных и документально подтвержденных расходов по уплате страховых взносов, исчисленных в соответствии со статьей 430 Налогового кодекса Российской Федерации",
	,,
	"-","-","-","-", Истина,,"406");

	ОписатьКодВычетаНДФЛ("Код513", "513", "Вычет из дохода от реализации (погашения) долей участия в уставном капитале российских организаций, а также акций, указанных в пункте 2 статьи 284.2 Налогового кодекса Российской Федерации, которые на дату реализации (погашения) непрерывно принадлежали налогоплательщику на праве собственности или ином вещном праве более пяти лет",
	, ,
	"-","-","-","-",,,"513");

	ОписатьКодВычетаНДФЛ("Код514", "514", "Вычет из дохода от реализации (погашения) акций, облигаций российских организаций, инвестиционных паев, которые на дату их реализации (погашения) непрерывно принадлежали налогоплательщику на праве собственности или ином вещном праве более одного года и в отношении их соблюдается одно из условий, указанных в пункте 17.2-1 статьи 217 Налогового кодекса Российской Федерации",
	, ,
	"-","-","-","-",,,"514");

	ОписатьКодВычетаНДФЛ("Код290", "290", "Расходы в виде стоимости приобретения цифровых финансовых активов и (или) цифровых прав, включающих одновременно цифровые финансовые активы и утилитарные цифровые права, в том числе денежные суммы, иное имущество (имущественные права) в сумме расходов на их приобретение, уплачиваемые (передаваемые) в оплату выпускаемых цифровых финансовых активов и (или) цифровых прав, включающих одновременно цифровые финансовые активы и утилитарные цифровые права",
	, ,
	"-","-","-","-",,,"290");

	ОписатьКодВычетаНДФЛ("Код291", "291", "Расходы в виде стоимости приобретения цифровых финансовых активов и (или) цифровых прав, включающих одновременно цифровые финансовые активы и утилитарные цифровые права, в том числе денежные суммы, иное имущество (имущественные права) в сумме расходов на их приобретение, уплачиваемые (передаваемые) по сделкам с цифровыми финансовыми активами и (или) цифровыми правами, включающими одновременно цифровые финансовые активы и утилитарные цифровые права",
	, ,
	"-","-","-","-",,,"291");

	ОписатьКодВычетаНДФЛ("Код292", "292", "Оплата услуг, оказываемых оператором информационной системы, оператором обмена цифровых финансовых активов или оператором инвестиционной платформы",
	, ,
	"-","-","-","-",,,"292");

	ОписатьКодВычетаНДФЛ("Код293", "293", "Расходы наследодателя (дарителя) на приобретение цифрового финансового актива и (или) цифрового права, включающего одновременно цифровой финансовый актив и утилитарное цифровое право, если такие расходы не учитывались наследодателем (дарителем) в целях налогообложения, в случае, если цифровой финансовый актив и (или) цифровое право, включающее одновременно цифровой финансовый актив и утилитарное цифровое право, получены налогоплательщиком в порядке наследования (дарения)",
	, ,
	"-","-","-","-",,,"293");

	ОписатьКодВычетаНДФЛ("Код294", "294", "Суммы, с которых был исчислен и уплачен налог на доходы физических лиц при приобретении (получении) цифрового финансового актива и (или) цифрового права, включающего одновременно цифровой финансовый актив и утилитарное цифровое право",
	, ,
	"-","-","-","-",,,"294");

	ОписатьКодВычетаНДФЛ("Код295", "295", "Расходы, непосредственно связанные с приобретением, хранением, отчуждением и выкупом цифровых финансовых активов и (или) цифровых прав, включающих одновременно цифровые финансовые активы и утилитарные цифровые права, в частности суммы оплаты услуг кредитных организаций (банковские комиссии), расходы на оплату услуг номинальных держателей цифровых финансовых активов и (или) цифровых прав, включающих одновременно цифровые финансовые активы и утилитарные цифровые права",
	, ,
	"-","-","-","-",,,"295");

	ОписатьКодВычетаНДФЛ("Код296", "296", "Суммы, уплаченные налогоплательщиком за приобретение цифровых финансовых активов и (или) цифровых прав, включающих одновременно цифровые финансовые активы и утилитарные цифровые права, решением о выпуске которых предусмотрен их выкуп и определен срок выкупа",
	, ,
	"-","-","-","-",,,"296");

	ОписатьКодВычетаНДФЛ("Код297", "297", "Суммы, уплаченные налогоплательщиком за приобретение цифровых финансовых активов, решением о выпуске которых не предусмотрен их выкуп, но определен срок, по истечении которого права, удостоверенные цифровыми финансовыми активами, прекращаются",
	, ,
	"-","-","-","-",,,"297");

	ОписатьКодВычетаНДФЛ("Код298", "298", "Суммы, уплаченные налогоплательщиком за приобретение цифровых финансовых активов, решением о выпуске которых не предусмотрен их выкуп и не определен срок, по истечении которого права, удостоверенные цифровыми финансовыми активами, прекращаются",
	, ,
	"-","-","-","-",,,"298");

	ОписатьКодВычетаНДФЛ("Код331", "331", "Сумма уплаченных налогоплательщиком в налоговом периоде страховых взносов по договору (договорам) добровольного пенсионного страхования, заключенному (заключенным) со страховой организацией в свою пользу и (или) в пользу супруга (в том числе вдовы, вдовца), родителей (в том числе усыновителей), детей-инвалидов (в том числе усыновленных, находящихся под опекой (попечительством), - в размере фактически произведенных расходов с учетом ограничения, установленного пунктом 2 статьи 219 Налогового кодекса Российской Федерации",
	Ложь, ГруппыВычетов.Социальные,
	"-","-","-","-",,,"331");

	ОписатьКодВычетаНДФЛ("Код515", "515", "Сумма уплаченных налогоплательщиком в налоговом пенсионных взносов по договору (договорам) негосударственного пенсионного обеспечения, предусматривающему (предусматривающим) выплату негосударственной пенсии, заключенному (заключенным) налогоплательщиком с негосударственным пенсионным фондом в свою пользу и (или) в пользу членов семьи и (или) близких родственников в соответствии с Семейным кодексом Российской Федерации (супруга (супруги), родителей и детей, в том числе усыновителей и усыновленных, дедушек, бабушек и внуков, полнородных и неполнородных (имеющих общих отца или мать) братьев и сестер), детей-инвалидов, находящихся под опекой (попечительством)",
	Ложь, ГруппыВычетов.Социальные,
	"-","-","-","-",,,"515");

	ОписатьКодВычетаНДФЛ("Код516", "516", "Сумма уплаченных налогоплательщиком в налоговом периоде сберегательных взносов по договору (договорам) долгосрочных сбережений, заключенному (заключенным) налогоплательщиком с негосударственным пенсионным фондом в свою пользу и (или) в пользу членов семьи и (или) близких родственников в соответствии с Семейным кодексом Российской Федерации (супруга (супруги), родителей и детей, в том числе усыновителей и усыновленных, дедушек, бабушек и внуков, полнородных и неполнородных (имеющих общих отца или мать) братьев и сестер), детей-инвалидов, находящихся под опекой (попечительством), если основания для назначения выплат по такому договору (таким договорам) наступают не ранее чем через десять лет с даты его (их) заключения",
	Ложь, ГруппыВычетов.Социальные,
	"-","-","-","-",,,"516");
