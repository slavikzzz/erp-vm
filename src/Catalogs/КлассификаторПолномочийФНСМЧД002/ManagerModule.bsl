...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Исключение
		...
		ТекстСообщения = НСтр("ru = 'Не удалось заполнить классификатор полномочий ФНС (МЧД 002) по причине:';
								|en = 'Cannot fill the FTS authority classifier (machine-readable authorization letter 002). Reason:'") + Символы.ПС 
