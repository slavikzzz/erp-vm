...
Процедура ДиалогВыбораФайлаПоказать(Результат, ДополнительныеПараметры) Экспорт
	...
	Иначе
		СообщитьПользователю(НСтр("ru = 'Без расширения для работы с 1С:Предприятием невозможно работать с файлами.';
									|en = 'To manage files, install 1C:Enterprise Extension.'"), "Объект");
	КонецЕсли;
КонецПроцедуры
