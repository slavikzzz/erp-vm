...
Процедура УстановитьЗаголовокФормы()
	...
	Если РежимВыбора Тогда
		...
		ТекстЗаголовка = НСтр("ru = 'Выбор хозяйствующего субъекта';
								|en = 'Выбор хозяйствующего субъекта'");
...
Процедура СформироватьПредставлениеПараметровПоиска(ПараметрыОтбора, ПриСоздании = Ложь)
	...
	Если ПараметрыОтбора <> Неопределено Тогда
		...
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'Тип';
																	|en = 'Тип'"),                  "Тип",                 КоличествоПараметровОтбора);
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'ИНН';
																	|en = 'ИНН'"),                  "ИНН",                 КоличествоПараметровОтбора);
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'КПП';
																	|en = 'КПП'"),                  "КПП",                 КоличествоПараметровОтбора);
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'ОГРН';
																	|en = 'ОГРН'"),                 "ОГРН",                КоличествоПараметровОтбора);
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'GLN';
																	|en = 'GLN'"),                  "GLN",                 КоличествоПараметровОтбора);
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'Наименование полное';
																	|en = 'Наименование полное'"),  "НаименованиеПолное",  КоличествоПараметровОтбора);
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'ФИО';
																	|en = 'ФИО'"),                  "ФИО",                 КоличествоПараметровОтбора);
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'Адрес';
																	|en = 'Адрес'"),                "ДанныеАдреса",        КоличествоПараметровОтбора);
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'Идентификатор';
																	|en = 'Идентификатор'"),        "Идентификатор",       КоличествоПараметровОтбора);
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'Идентификатор версии';
																	|en = 'Идентификатор версии'"), "ИдентификаторВерсии", КоличествоПараметровОтбора);
		...
		Если КоличествоСтраницНесколько Тогда
			...
			Элементы.ПоискНеНастроен.ОтображениеСостояния.Текст  =
				НСтр("ru = 'Заданные условия поиска дали слишком много результатов. Уточните реквизиты отбора и выполните поиск.';
					|en = 'Заданные условия поиска дали слишком много результатов. Уточните реквизиты отбора и выполните поиск.'");
		КонецЕсли;
...
Процедура ДобавитьВПредставление(Представление, ПараметрыОтбора, ПредставлениеПоля, ИмяПоля, КоличествоПараметров)
	...
	Если ЗначениеЗаполнено(Представление) Тогда
		Представление = Представление + " " + НСтр("ru = 'и';
													|en = 'и'") + " " + ПредставлениеПоля + Разделитель + """" + Значение + """";
	Иначе
...
Функция ПредставлениеПустогоОтбора(Форма, ПриСоздании = Ложь)
	...
	Если ПриСоздании Тогда
		...
		Строки.Добавить(НСтр("ru = 'Для вывода хозяйствующих субъектов';
							|en = 'Для вывода хозяйствующих субъектов'"));
		Строки.Добавить(" ");
		Строки.Добавить(
...
Функция ПредставлениеНеПустогоОтбора(СтрокаОтбор, Форма, ПриСоздании = Ложь)
	...
	СтрокаПредставлениеОтбора = СтрШаблон(НСтр("ru = 'Установлен отбор по %1';
												|en = 'Установлен отбор по %1'"), СтрокаОтбор);
