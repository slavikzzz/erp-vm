...
Процедура НастроитьОформлениеФормы()
	...
	Элементы.ОтображатьТолькоДоступныеПользователюВЕТИС.Заголовок = СтрШаблон(
		НСтр("ru = 'Доступные для пользователя ВЕТИС: %1';
			|en = 'Доступные для пользователя ВЕТИС: %1'"),
		ТекущийПользовательВЕТИС);
