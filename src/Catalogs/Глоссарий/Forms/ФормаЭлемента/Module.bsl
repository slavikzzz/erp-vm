...
Процедура ПриИзмененииЯзыкаГлоссария(КодЯзыка)
	...
	Если Модифицированность Тогда
		...
		ПоказатьВопрос(ОписаниеОповещения, НСтр("ru = 'Текст глоссария не сохранен. Записать?';
												|en = 'The glossary text is not saved. Do you want to save it?'"), РежимДиалогаВопрос.ОКОтмена);
	Иначе
