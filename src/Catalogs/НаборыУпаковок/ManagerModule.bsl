...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Элемент.Наименование = НСтр("ru = 'Базовые единицы измерения';
								|en = 'Basic units of measure'", КодОсновногоЯзыка);
	#КонецОбласти

	#Область ИндивидуальныйДляНоменклатуры
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ИндивидуальныйДляНоменклатуры";
	Элемент.Наименование = НСтр("ru = 'Индивидуальный набор для номенклатуры';
								|en = 'Individual set for products'", КодОсновногоЯзыка);
	#КонецОбласти
