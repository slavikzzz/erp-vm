...
Процедура ВидПользователейНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПользователиСлужебныйКлиент.ВыбратьНазначение(ЭтотОбъект, НСтр("ru = 'Выбор вида пользователей';
																	|en = 'Select users type'"), Ложь, Истина, ОписаниеОповещения);
			...
			Если ВыборГруппВнешнихПользователей Тогда
				Заголовок = ?(ХранимыеПараметры.РасширенныйПодбор, ХранимыеПараметры.ЗаголовокФормыПодбора,
					НСтр("ru = 'Подбор внешних пользователей и групп';
						|en = 'Select external users and groups'"));
				ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
