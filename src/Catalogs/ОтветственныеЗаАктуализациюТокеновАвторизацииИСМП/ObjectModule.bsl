...
Процедура ПередЗаписью(Отказ)
	...
	Если ТипТокенаАвторизации = Перечисления.ТипыТокеновАвторизации.ИСМП
		И ЗначениеЗаполнено(ПроизводственныйОбъект) Тогда
	...
	Если МассивВремени.Количество() > 0 Тогда
		МассивВремени[0] = СтрШаблон(НСтр("ru = 'за %1';
											|en = 'за %1'"), МассивВремени[0]);
	КонецЕсли;
