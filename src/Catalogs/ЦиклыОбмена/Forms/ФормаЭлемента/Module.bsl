...
Процедура ИнициализироватьСоответствия()
	...
	ИначеЕсли Объект.Тип = Перечисления.ТипыЦикловОбмена.ОтчетностьЦБ Тогда
		...
		СоответствиеТипаТранспортногоСообщенияТекстуНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.ПервичноеСообщениеСодержащееОтчетностьЦБ,	НСтр("ru = 'Первичное сообщение, содержащее файл отчетности, отсутствует';
																																								|en = 'Первичное сообщение, содержащее файл отчетности, отсутствует'"));
		СоответствиеТипаТранспортногоСообщенияТекстуНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.РезультатЗагрузкиЦБ,						НСтр("ru = 'Подтверждение загрузки отсутствует';
																																							|en = 'Подтверждение загрузки отсутствует'"));
		СоответствиеТипаТранспортногоСообщенияТекстуНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.РезультатПриемаДокументЦБ,					НСтр("ru = 'Результат приема отчета отсутствует';
																																								|en = 'Результат приема отчета отсутствует'"));
		СоответствиеТипаТранспортногоСообщенияТекстуНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.РезультатОбработкиДокументЦБ,				НСтр("ru = 'Результат обработки отчета отсутствует';
																																								|en = 'Результат обработки отчета отсутствует'"));
