	...
	Если Задание = Неопределено Тогда
		...
		ПараметрыЗадания.Вставить("Наименование", СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Автоматическое начисление и списание бонусных баллов: %1';
				|en = 'Automatic accumulation and write-off of bonus points: %1'"), 
...
Процедура ПриЗаписи(Отказ)
	...
	НаименованиеЗадания = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Автоматическое начисление и списание бонусных баллов: %1';
																						|en = 'Automatic accumulation and write-off of bonus points: %1'"), СокрЛП(Объект.Наименование));
