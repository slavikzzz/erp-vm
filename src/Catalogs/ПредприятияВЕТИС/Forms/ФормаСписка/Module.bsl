	...
	ИначеЕсли ОтборСвязано = "Наши" Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
			...
			НСтр("ru = 'Условие по связи предприятий';
				|en = 'Условие по связи предприятий'"),
			Истина,
...
Процедура ОтобразитьОтборПоИдентификаторуХозяйствующегоСубъекта()
	...
	Если ЗначениеЗаполнено(ХозяйствующийСубъектПредставление) Тогда
		ПредставлениеОтбора = СтрШаблон(НСтр("ru = 'Только предприятия XC %1';
											|en = 'Только предприятия XC %1'"), ХозяйствующийСубъектПредставление);
	Иначе
		ПредставлениеОтбора = СтрШаблон(НСтр("ru = 'Только предприятия XC с идентификатором %1';
											|en = 'Только предприятия XC с идентификатором %1'"), ХозяйствующийСубъектИдентификатор);
	КонецЕсли;
...
Процедура СформироватьПредставлениеПараметровПоиска(ПараметрыОтбора, ПриСоздании = Ложь)
	...
	Если ПараметрыОтбора <> Неопределено Тогда
		...
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'Наименование';
																	|en = 'Наименование'"),         "Наименование",         КоличествоПараметровОтбора);
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'Номер предприятия';
																	|en = 'Номер предприятия'"),    "Номер",                КоличествоПараметровОтбора);
		...
		ДобавитьВПредставление(СтрокаОтбор, ПараметрыОтбора, НСтр("ru = 'ИдентификаторХС';
																	|en = 'ИдентификаторХС'"),      "ИдентификаторХС",      КоличествоПараметровОтбора);
	...
	Иначе
		...
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
			...
			НСтр("ru = 'Предприятия хозяйствующего субъекта';
				|en = 'Предприятия хозяйствующего субъекта'"),
			Истина,
			РежимОтображенияЭлементаНастройкиКомпоновкиДанных.Недоступный);
