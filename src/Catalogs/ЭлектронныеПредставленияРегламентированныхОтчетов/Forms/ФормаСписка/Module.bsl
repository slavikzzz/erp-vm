...
Процедура ОбработатьАктивизациюСтрокиОсновнойТаблицы()
	...
	Если ТекДанные = Неопределено
		...
		И ТекДанные_ВидОтчета <> ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.ДвижениеСредствНерезидентаЗаПределамиРФ")
		...
		И ТекДанные_ВидОтчета <> ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.СведенияОДоходахСотрудникаДляСоцВыплат")
	...
	ИначеЕсли ТекДанные_ВидОтчета_ТипДокумента = ПредопределенноеЗначение("Перечисление.ТипыОтправляемыхДокументов.ИсходящееУведомлениеФНС")
		...
		ИЛИ ТекДанные_ВидОтчета = ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.СведенияОДоходахСотрудникаДляСоцВыплат")
