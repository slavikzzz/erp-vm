...
Процедура ПроверитьИзменениеПредопределенногоЭлемента()
	...
	Если СтрСравнить(ПредыдущиеЗначения.Наименование, Наименование) <> 0 Тогда
		...
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не допускается изменение наименования для страны %1';
				|en = 'Description cannot be changed for country %1'"), ПредыдущиеЗначения.Наименование);
	...
	Если СтрСравнить(ПредыдущиеЗначения.Код, Код) <> 0 Тогда
		...
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не допускается изменение кода для страны %1';
				|en = 'Code cannot be changed for country %1'"), ПредыдущиеЗначения.Наименование);
		ВызватьИсключение ТекстСообщения;
