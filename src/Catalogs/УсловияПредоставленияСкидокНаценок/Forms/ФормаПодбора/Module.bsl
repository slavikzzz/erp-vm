...
Процедура ПеренестиВДокумент(Команда)
	...
	Если УсловияПредоставления.Количество() = 0 Тогда
		ПоказатьВопрос(Новый ОписаниеОповещения("ПеренестиВДокументЗавершение", ЭтотОбъект), НСтр("ru = 'Не подобрано ни одного условия. Закрыть?';
																									|en = 'No condition is selected. Close?'"), РежимДиалогаВопрос.ДаНет);
        Возврат;
	КонецЕсли;
