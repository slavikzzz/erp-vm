	...
	Иначе
		...
		Иначе
			Элементы.ПоясняющийТекст.Заголовок = НСтр("ru = 'Элемент не найден в классификаторе, автоматическое обновление элемента отключено';
														|en = 'Item is not found in the classifier. Automatic update is disabled for this item'");
			ТолькоПросмотр = Ложь;
		КонецЕсли;
	КонецЕсли;
