...
Функция СформироватьРеквизитыОрганизации()
	...
	НаименованиеТабличногоДокумента = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Реквизиты организации %1';
																									|en = 'Bank details of the %1 company'"), СведенияОбОрганизации.СокращенноеНаименование);
