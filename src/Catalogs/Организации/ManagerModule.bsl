...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Элемент.Наименование = НСтр("ru = 'Управленческая организация';
								|en = 'Management company'", ОбщегоНазначения.КодОсновногоЯзыка());
...
#Область ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет статус организации и первоначальную историю наименований';
									|en = 'Fills the company status and the initial name history'");
