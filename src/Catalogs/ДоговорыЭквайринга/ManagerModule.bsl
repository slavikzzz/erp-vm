...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Версия = "11.5.17.144";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("2fad6d50-3c1d-4348-e2d4-84c7538277bd");
	...
	ШаблонКомментарияОбработчика = НСтр("ru = 'Заполнение в справочнике ""%1"" нового реквизита шапки ""%2"". Если ""%3"" в значении ""%4"", реквизит принимает значение ""%5""';
										|en = 'Fill the new ""%2"" header attribute in the ""%1"" catalog. If ""%3"" is set to ""%4"", the attribute value is ""%5""'");
