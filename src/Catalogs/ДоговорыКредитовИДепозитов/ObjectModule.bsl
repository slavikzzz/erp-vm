...
Процедура ПроверитьВозможностьВводаНаОснованииПартнера(Партнер)
	...
	Если Не ПрочиеОтношения Тогда
		...
		|en = 'Other relations with the ""%Партнер%"" partner are not allowed. 
		|Generation from base documents is available only for partners with whom other relations are allowed.'");
