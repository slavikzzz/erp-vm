...
Процедура ДобавлениеЭлементов(СтрокаТЧ, РеквизитыСообщений)
	...
	СтраницаТекстSOAP = ДобавитьСтраницу("СтраницаТекстSOAP", НСтр("ru = 'Текст SOAP';
																	|en = 'Текст SOAP'"), ВложенныеСтраницы, Идентификатор);
	...
	ДобавитьНадпись("Подпись", НСтр("ru = 'Подпись';
									|en = 'Подпись'"), Подпись, Страница, Идентификатор);
