...
Процедура ДобавитьОбработчикПереходНаАлгоритмС2020(Обработчики)
	...
	|en = 'Updates the ""Relief basis for property taxes"" catalog:
	|- Fills the ""Tax"" and ""Established in"" fields.'");
		...
		Исключение
			...
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Ошибка при выполнении обработчика ОснованияЛьготПоИмущественнымНалогам.ЗаполнитьНалог для льготы ""%1"" по причине:
					|%2';
					|en = 'An error occurred while executing the ОснованияЛьготПоИмущественнымНалогам.ЗаполнитьНалог handler for the %1 relief. Reason:
					|%2'"),
				ВыборкаЛьгот.Ссылка,
