		...
		Исключение
			...
			ТекстОшибки = СтрШаблон(
				НСтр("ru = 'Ошибка при создании Места хранения с идентификатором %1:
				           |%2';
				           |en = 'Ошибка при создании Места хранения с идентификатором %1:
				           |%2'"),
				Идентификатор,
			...
			ОбщегоНазначенияИСВызовСервера.ЗаписатьОшибкуВЖурналРегистрации(
				ТекстОшибкиПодробно,
				НСтр("ru = 'Работа с Местами хранения';
					|en = 'Работа с Местами хранения'", ОбщегоНазначения.КодОсновногоЯзыка()));
