...
Процедура ОрганизацияОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "ЗагрузитьОрганизацию" Тогда
		...
		ТекстВопроса = НСтр("ru = 'Загрузить владельца места хранения?';
							|en = 'Загрузить владельца места хранения?'");
...
Процедура Загрузить(Команда)
	...
	Если ЗначениеЗаполнено(МестоХранения) Тогда
		...
		ТекстСообщения = СтрШаблон(НСтр("ru = 'Выполнена загрузка места хранения %1.';
										|en = 'Выполнена загрузка места хранения %1.'"), МестоХранения);
...
Процедура ОбработатьПереданныеПараметры(Отказ)
	...
	Если Не ЗначениеЗаполнено(Параметры.Идентификатор) Тогда
		ВызватьИсключение НСтр("ru = 'Форма не предназначена для открытия без передачи в неё идентификатора места хранения.';
								|en = 'Форма не предназначена для открытия без передачи в неё идентификатора места хранения.'");
	Иначе
...
Процедура ОпределитьНаличиеВИБ()
	...
	Если Выборка.Следующий() Тогда
		...
		Строки.Добавить(НСтр("ru = 'Место хранения уже загружено';
							|en = 'Место хранения уже загружено'"));
		Строки.Добавить(" (");
		Строки.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'открыть';
														|en = 'открыть'"),, ЦветаСтиля.ЦветГиперссылкиГосИС,, "ОткрытьМестоХранения"));
		Строки.Добавить(").");
