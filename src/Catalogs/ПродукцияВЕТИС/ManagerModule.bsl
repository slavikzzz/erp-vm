...
//Возвращает производителей продукции
//
//Параметры:
//   Продукция - СправочникСсылка.ПродукцияВЕТИС - продукция ВетИС
//
// Возвращаемое значение:
//   Массив Из СправочникСсылка.ПредприятияВЕТИС - производители продукции (значения табличной части)
//
Функция Производители(Знач Продукция) Экспорт
...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Если Данные.ТребуетсяЗагрузка = Истина Тогда
		...
		Представление = НСтр("ru = '<не загружено>';
							|en = '<не загружено>'");
	ИначеЕсли ЗначениеЗаполнено(Данные.ПолноеНаименование) Тогда
		СтандартнаяОбработка = Ложь;
