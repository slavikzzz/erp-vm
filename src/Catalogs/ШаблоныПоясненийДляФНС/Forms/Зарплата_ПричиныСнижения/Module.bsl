...
Процедура ДобавитьВПояснение(Команда)
	...
	ДобавитьЗначениеПараметраИзТаблицы(Результат, "ДетализацияПричинПоСотрудникам", НСтр("ru = '- %ФИО (СНИЛС %СНИЛС, оклад %Оклад руб., ставка %Ставка): %Причина';
																						|en = '- %ФИО (СНИЛС %СНИЛС, оклад %Оклад руб., ставка %Ставка): %Причина'"));
