...
Процедура ПриЗаписи(Отказ)
	...
	|	И ПравилаПолученияФактаПоПоказателямБюджетов.ПоказательБюджетов = &ПоказательБюджетов";
	Запрос.УстановитьПараметр("ПоказательБюджетов", Ссылка);
	
	Выборка = Запрос.Выполнить().Выбрать();
	
	Блокировка = Новый БлокировкаДанных;
	ЭлементБлокировки = Блокировка.Добавить("Справочник.ПравилаПолученияФактаПоПоказателямБюджетов");
	ЭлементБлокировки.УстановитьЗначение("ПоказательБюджетов", Ссылка);
