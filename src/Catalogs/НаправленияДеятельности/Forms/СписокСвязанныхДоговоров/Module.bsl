...
Процедура СформироватьВыборкуДанныхСписка()
	...
	|	ДоговорыАренды.НаименованиеДляПечати,
	...
	|ГДЕ
	|	ДоговорыАренды.НаправлениеДеятельности = &НаправлениеДеятельностиОтбор
	//-- НЕ УТ
	|";
	...
	//++ НЕ УТ
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "ТекстДоговорАренды", НСтр("ru = 'Договор аренды';
																											|en = 'Rental contract'"));
	//-- НЕ УТ
