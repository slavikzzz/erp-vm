...
Процедура ПриЧтенииСозданииНаСервере()
	...
	ИспользоватьДоговорыАренды = ВнеоборотныеАктивы.ИспользуетсяУправлениеВНА();
	//-- НЕ УТ

	//++ НЕ УТКА
	ИспользоватьДавальцев2_5                      = ПолучитьФункциональнуюОпцию("ИспользоватьПроизводствоИзДавальческогоСырья2_5");
	//-- НЕ УТКА
	...
	Если ИспользоватьДоговорыКредитовИДепозитов ИЛИ Объект.РасчетыСДебиторами Тогда
		СписокВыбора.Добавить(6, НСтр("ru = 'дебиторами по депозитам, займам';
										|en = 'debtors by deposits or loans'"));
	КонецЕсли;
	Если ИспользоватьДоговорыКредитовИДепозитов ИЛИ Объект.РасчетыСКредиторами Тогда
		СписокВыбора.Добавить(5, НСтр("ru = 'кредиторами по кредитам, займам';
										|en = 'creditors by credits or loans'"));
	КонецЕсли;
	
	//++ НЕ УТ
	Если ИспользоватьДоговорыАренды ИЛИ Объект.РасчетыСАрендодателями Тогда
		СписокВыбора.Добавить(7, НСтр("ru = 'арендодателями';
										|en = 'lessors'"));
	КонецЕсли;
	Если ИспользоватьПроизводствоНаСтороне2_5 ИЛИ Объект.РасчетыСПереработчиками Тогда
		СписокВыбора.Добавить(9, НСтр("ru = 'переработчиками';
										|en = 'subcontractors'"));
	КонецЕсли;
	//-- НЕ УТ

	//++ НЕ УТКА
	Если ИспользоватьДавальцев2_5
		ИЛИ Объект.РасчетыСДавальцами Тогда
		СписокВыбора.Добавить(11, НСтр("ru = 'давальцами';
										|en = 'providers'"));
	КонецЕсли;
	//-- НЕ УТКА
	
	СписокВыбора.Добавить(10, НСтр("ru = 'перевозчиками по бронированию';
									|en = 'carriers by booking'"));
