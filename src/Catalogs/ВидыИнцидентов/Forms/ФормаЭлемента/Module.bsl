...
Процедура ЗаписатьДопРеквизитыСведенияНабора(Отказ, ТекущийОбъект, ТипЭлемента)
	...
	Исключение
		...
		ИмяСобытия = СтрШаблон("%1.%2",
								НСтр("ru = 'Дополнительные реквизиты инцидентов';
									|en = 'Additional incident attributes'", КодЯзыка),
								НСтр("ru = 'Не удалось обновить состав дополнительных реквизитов набора.';
									|en = 'Cannot update additional attributes of the kit.'", КодЯзыка));
		...
		ВыражениеИсключения = НСтр("ru = 'При записи дополнительных реквизитов инцидента произошла ошибка (см. журнал регистрации).';
									|en = 'An error occurred when saving additional incident attributes (see the event log).'");
