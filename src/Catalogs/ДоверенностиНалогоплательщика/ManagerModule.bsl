...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Для каждого СтрокаМассиваОбъектов Из МассивОбъектов Цикл
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "ДоверенностьНалогоплательщика", НСтр("ru = 'Доверенность налогоплательщика';
																															|en = 'Taxpayer authorization letter'"), СформироватьДоверенность(СтрокаМассиваОбъектов));
	КонецЦикла; 	
