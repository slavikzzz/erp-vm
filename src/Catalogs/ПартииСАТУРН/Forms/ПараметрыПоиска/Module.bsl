...
&НаКлиенте
Процедура ПАТПриИзменении(Элемент)
...
Процедура ВыполнитьПоиск(Команда)
	...
	Если ЗначениеЗаполнено(ПАТ) Тогда
		ПараметрыПоиска.Вставить("ПАТ", ПАТ);
	КонецЕсли;
...
Процедура УправлениеДоступностьюЭлементовФормы()
	...
	Элементы.ПАТ.Доступность              = Не УказанРеквизитНеТочногоСоответствия;
