...
//   ПравилоЗаполнения - см. Справочники.ПравилаИнтеграцииС1СДокументооборотом.НовоеПравилоЗаполненияРеквизита
//
Процедура ДобавитьПарноеПравило(Правило, ИмяРеквизитаОбъектаИС, ИмяРеквизитаОбъектаДО, ПравилоЗаполнения) Экспорт
	
	ПравилоЗаполнения.ЗначениеЗаполнения =
		?(ПравилоЗаполнения.ТаблицаИС = "", "", ПравилоЗаполнения.ТаблицаИС + ".") + ИмяРеквизитаОбъектаИС;
	...
	ПравилоЗаполнения.ЗначениеЗаполнения =
		?(ПравилоЗаполнения.ТаблицаДО = "", "", ПравилоЗаполнения.ТаблицаДО + ".") + ИмяРеквизитаОбъектаДО;
...
//   ПравилоЗаполнения - см. Справочники.ПравилаИнтеграцииС1СДокументооборотом.НовоеПравилоЗаполненияРеквизита
//
Процедура ДобавитьПравилоЗаполненияРеквизитаДО(Правило, Вариант, ИмяРеквизитаОбъектаДО, ПравилоЗаполнения) Экспорт
	...
	Реквизит.Ключевой = ПравилоЗаполнения.Ключевой;
	Реквизит.Обновлять = ПравилоЗаполнения.ОбновлятьДО;
	Реквизит.Таблица = ПравилоЗаполнения.ТаблицаДО;
	...
	Если Вариант = Перечисления.ВариантыПравилЗаполненияРеквизитов.ВыражениеНаВстроенномЯзыке Тогда
		Реквизит.ВычисляемоеВыражение = ПравилоЗаполнения.ЗначениеЗаполнения;
		
	ИначеЕсли Вариант = Перечисления.ВариантыПравилЗаполненияРеквизитов.РеквизитОбъекта Тогда
		Реквизит.ИмяРеквизитаОбъектаИС = ПравилоЗаполнения.ЗначениеЗаполнения;
		
	ИначеЕсли Вариант = Перечисления.ВариантыПравилЗаполненияРеквизитов.УказанноеЗначение Тогда
		Реквизит.ЗначениеРеквизитаДО = ПравилоЗаполнения.ЗначениеЗаполнения.name;
		Реквизит.ЗначениеРеквизитаДОID = ПравилоЗаполнения.ЗначениеЗаполнения.objectID.ID;
		Реквизит.ЗначениеРеквизитаДОТип = ПравилоЗаполнения.ЗначениеЗаполнения.objectID.type;
	...
	Иначе
		ВызватьИсключение СтрШаблон(
			НСтр("ru = 'Добавление правила заполнения реквизита с вариантом %1 в автоматическом режиме не поддерживается';
				|en = 'Adding the rule of filling the account with the option %1 in automatic mode is not supported'"),
			Вариант);
...
//   ПравилоЗаполнения - см. Справочники.ПравилаИнтеграцииС1СДокументооборотом.НовоеПравилоЗаполненияРеквизита
//
Процедура ДобавитьПравилоЗаполненияРеквизитаИС(Правило, Вариант, ИмяРеквизитаОбъектаИС, ПравилоЗаполнения) Экспорт
	
	Реквизит = Правило.ПравилаЗаполненияРеквизитовИС.Добавить();
	Реквизит.ИмяРеквизитаОбъектаИС = ИмяРеквизитаОбъектаИС;
	Реквизит.Вариант = Вариант;
	Реквизит.Ключевой = ПравилоЗаполнения.Ключевой;
	Реквизит.Обновлять = ПравилоЗаполнения.ОбновлятьИС;
	Реквизит.РежимИзмененияДанныхПроведенногоДокумента = ПравилоЗаполнения.РежимИзменения;
	Реквизит.Таблица = ПравилоЗаполнения.ТаблицаИС;
	...
	ИначеЕсли Вариант = Перечисления.ВариантыПравилЗаполненияРеквизитов.РеквизитОбъекта Тогда
		Реквизит.ИмяРеквизитаОбъектаДО = ПравилоЗаполнения.ЗначениеЗаполнения;
		
	ИначеЕсли Вариант = Перечисления.ВариантыПравилЗаполненияРеквизитов.УказанноеЗначение Тогда
		Реквизит.ЗначениеРеквизитаИС = ПравилоЗаполнения.ЗначениеЗаполнения;
...
// Конструктор структуры, описывающей правило ЗаполненияРеквизита.
//
// Параметры:
//   ЗначениеЗаполнения - Строка, ОбъектXDTO, ЛюбаяСсылка, Неопределено - значение правила.
//
...
//     * РежимИзменения - ПеречислениеСсылка.РежимИзмененияПроведенногоДокументаДанными1СДокументооборота - режим
//         изменения данных проведенного документа в правиле заполнения реквизита ИС.
//     * ТаблицаИС - Строка - имя таблицы ИС, к которой относится реквизит.
//     * ТаблицаДО - Строка - имя таблицы ДО, к которой относится реквизит.
//
Функция НовоеПравилоЗаполненияРеквизита(ЗначениеЗаполнения = Неопределено) Экспорт
	
	ПравилоЗаполнения = Новый Структура;
	ПравилоЗаполнения.Вставить("ЗначениеЗаполнения", ЗначениеЗаполнения);
	ПравилоЗаполнения.Вставить("ОбновлятьИС", Истина);
	ПравилоЗаполнения.Вставить("ОбновлятьДО", Истина);
	ПравилоЗаполнения.Вставить("Ключевой", Ложь);
	ПравилоЗаполнения.Вставить("РежимИзменения",
		Перечисления.РежимИзмененияПроведенногоДокументаДанными1СДокументооборота.РазрешеноСПерепроведением);
	ПравилоЗаполнения.Вставить("ТаблицаИС", "");
	ПравилоЗаполнения.Вставить("ТаблицаДО", "");
...
Функция ВозможныеСостоянияОбъектаДокументооборота() Экспорт
	...
	ДобавитьРеквизит(Реквизиты, "statusRegistration", НСтр("ru = 'Состояние регистрации';
															|en = 'Registration state'"), "DMDocumentStatus");
	ДобавитьРеквизит(Реквизиты, "statusConsideration", НСтр("ru = 'Состояние рассмотрения';
															|en = 'Review state'"), "DMDocumentStatus");
	ДобавитьРеквизит(Реквизиты, "statusApproval", НСтр("ru = 'Состояние согласования';
														|en = 'Approval state '"), "DMDocumentStatus");
	ДобавитьРеквизит(Реквизиты, "statusConfirmation", НСтр("ru = 'Состояние утверждения';
															|en = 'Confirmation state'"), "DMDocumentStatus");
	Если ИнтеграцияС1СДокументооборотБазоваяФункциональностьПовтИсп.ДоступенФункционалВерсииСервиса("2.1.18.1.CORP") Тогда
		ДобавитьРеквизит(Реквизиты, "statusSigning", НСтр("ru = 'Состояние подписания';
															|en = 'Signature state'"), "DMDocumentStatus");
	КонецЕсли;
	ДобавитьРеквизит(Реквизиты, "statusPerformance", НСтр("ru = 'Состояние исполнения';
															|en = 'Execution state'"), "DMDocumentStatus");
	...
	Для Каждого Реквизит Из Реквизиты Цикл
			...
			Если ПравилоРеквизита.Вариант = ВариантРеквизит() Тогда
					...
					Иначе
						ВызватьИсключение СтрШаблон(
							НСтр("ru = 'В правилах интеграции указано недопустимое имя реквизита-источника данных заполнения: %1';
								|en = 'Integration rules specify an invalid data source attribute name: %1'"),
				...
				Для НомерЗначения = 0 По ЗначенияСвойства.Количество() - 1 Цикл
					...
					ИначеЕсли ЗначениеСвойства <> Неопределено И ЭтоОбъектноеЗначение Тогда
						...
						Контекст.ЗаполняемыйОбъектИС = Объект;
						Контекст.ИмяРеквизитаОбъектаИС = Реквизит.Имя;
						...
						ЗначениеРеквизита =
							ИнтеграцияС1СДокументооборотБазоваяФункциональность.ЗначениеРеквизитаОбъектаИСПоЗначениюДляЗаполнения(
								ТипРеквизита,
								ИнтеграцияС1СДокументооборотБазоваяФункциональность.ЗначениеДляЗаполненияРеквизитаОбъектаИС(ЗначениеСвойства),
								Контекст);
		...
		Иначе // Дополнительный реквизит объекта ИС.
			...
			Если ПравилоРеквизита.Вариант = ВариантРеквизит() Тогда
				...
				ЭтоОбъектноеЗначение = ИнтеграцияС1СДокументооборотБазоваяФункциональность.ЭтоОбъектноеЗначение(
					Прокси,
					ЗначениеСвойства);
				...
				ИначеЕсли ЗначениеСвойства <> Неопределено И ЭтоОбъектноеЗначение Тогда
					...
					Контекст.ЗаполняемыйОбъектИС = Объект;
					Контекст.ИмяРеквизитаОбъектаИС = Реквизит.Имя;
					Контекст.ЭтоДополнительныйРеквизитИС = Истина;
					Контекст.ДополнительныйРеквизитИС = СтрокаРеквизита.Свойство;
					ЗначениеРеквизита =
						ИнтеграцияС1СДокументооборотБазоваяФункциональность.ЗначениеРеквизитаОбъектаИСПоЗначениюДляЗаполнения(
							ТипРеквизита,
								...
								Если Не Найден Тогда
									ТекстСообщения = СтрШаблон(
										НСтр("ru = 'Не найден реквизит %1, указанный в правиле интеграции с 1С:Документооборотом.
											...
											|en = 'The %1 attribute specified in the rule of integration with 1C:Document Management is not found.
											|Check the integration rule or contact the administrator.'",
...
Процедура ЗаполнитьФормуОбъектаДОПоПравилу(Источник, Форма, Правило) Экспорт
	...
	Для Каждого РеквизитОбъектаДО Из РеквизитыОбъектаДО Цикл
		...
		Иначе // Дополнительный реквизит на стороне ДО.
			...
			Иначе
				// Дополнительный реквизит принадлежит конкретному виду документа.
				...
				Если Не ПравилоРеквизита.ЭтоДополнительныйРеквизитДО Тогда
					ТекстСообщения = СтрШаблон(
						НСтр("ru = 'Очищено правило заполнения реквизита %1, отсутствующего в документе';
							|en = 'Filling rule of attribute %1 not present in the document is cleared'",
							ОбщегоНазначения.КодОсновногоЯзыка()),
						ИмяРеквизита);
				Иначе
					ТекстСообщения = НСтр("ru = 'Очищено правило заполнения дополнительного реквизита, отсутствующего в документе';
											|en = 'Filling rule of the additional attribute missing in the document is cleared'",
						ОбщегоНазначения.КодОсновногоЯзыка());
				КонецЕсли;
				ЗаписьЖурналаРегистрации(
					ИнтеграцияС1СДокументооборотБазоваяФункциональность.ИмяСобытияЖурналаРегистрации(),
				...
				Если Не ПравилоРеквизита.ЭтоДополнительныйРеквизитДО Тогда
					ТекстСообщения = СтрШаблон(
						НСтр("ru = 'Очищено правило заполнения реквизита %1, отсутствующего в шаблоне';
							|en = 'Filling rule of attribute %1 missing in the template is cleared'",
							ОбщегоНазначения.КодОсновногоЯзыка()),
						ИмяРеквизита);
				Иначе
					ТекстСообщения = НСтр("ru = 'Очищено правило заполнения дополнительного реквизита, отсутствующего в шаблоне';
											|en = 'Filling rule of the additional attribute missing in the template is cleared'",
						ОбщегоНазначения.КодОсновногоЯзыка());
				КонецЕсли;
				ЗаписьЖурналаРегистрации(
					ИнтеграцияС1СДокументооборотБазоваяФункциональность.ИмяСобытияЖурналаРегистрации(),
				...
				Если Не ПравилоРеквизита.ЭтоДополнительныйРеквизитДО Тогда
					ТекстСообщения = СтрШаблон(
						НСтр("ru = 'Очищен признак ""Ключевой"" у реквизита %1, отсутствующего в шаблоне';
							|en = 'The ""Key"" check box of attribute %1 not present in the template is cleared'",
							ОбщегоНазначения.КодОсновногоЯзыка()),
						ИмяРеквизита);
				Иначе
					ТекстСообщения = НСтр("ru = 'Очищен признак ""Ключевой"" у дополнительного реквизита, отсутствующего в шаблоне';
											|en = 'The ""Key"" check box of the additional attribute missing in the template is cleared'",
						ОбщегоНазначения.КодОсновногоЯзыка());
				КонецЕсли;
				ЗаписьЖурналаРегистрации(
					ИнтеграцияС1СДокументооборотБазоваяФункциональность.ИмяСобытияЖурналаРегистрации(),
			...
			Если ШаблонЗапрещаетИзменение И ЗаполненВШаблоне И ПравилоРеквизита.Вариант <> ВариантШаблон() Тогда
				...
				Если Не ПравилоРеквизита.ЭтоДополнительныйРеквизитДО Тогда
					ТекстСообщения = СтрШаблон(НСтр("ru = 'Установлен вариант заполнения ""Из шаблона"" для реквизита %1, поскольку шаблон запрещает изменение';
													|en = 'Population option ""From template"" is set for attribute %1 as the template prevents change '"),
						ИмяРеквизита);
				Иначе
					ТекстСообщения = НСтр("ru = 'Установлен вариант заполнения ""Из шаблона"" для дополнительного реквизита, поскольку шаблон запрещает изменение';
											|en = 'Population option ""From template"" is set for the additional attribute as the template prevents change'");
				КонецЕсли;
				ЗаписьЖурналаРегистрации(
					ИнтеграцияС1СДокументооборотБазоваяФункциональность.ИмяСобытияЖурналаРегистрации(),
					УровеньЖурналаРегистрации.Предупреждение,,
...
Функция РеквизитыОбъектаДО(ТипОбъектаДО, Параметры = Неопределено, НастройкиВида = Неопределено,
			...
			Исключение // Возможно, этого вида документа уже нет в ДО.
				...
				ИнтеграцияС1СДокументооборотБазоваяФункциональность.ЗаписатьПредупреждение(
					СтрШаблон(НСтр("ru = 'Не найден в 1С:Документообороте ранее существовавший вид документа %1';
									|en = 'The earlier existing %1 document kind was not found in 1C:Document Management'"),
	...
	Если ТипОбъектаДО = "DMIncomingDocument" Тогда
		...
		Если ПолучитьВсе Или НастройкиТипа.documentTypeEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "documentType", НСтр("ru = 'Вид документа';
															|en = 'Document kind'"), "DMIncomingDocumentType", Истина);
		КонецЕсли;
		
		ДобавитьРеквизит(Реквизиты, "correspondent", НСтр("ru = 'Отправитель';
															|en = 'Sender'"), "DMCorrespondent", Истина);
		ДобавитьРеквизит(Реквизиты, "externalNumber", НСтр("ru = '№ отправителя';
															|en = 'Sender No.'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "externalDate", НСтр("ru = 'Дата отправителя';
														|en = 'Sender date'"), "Дата");
		
		Если ПолучитьВсе Или НастройкиТипа.organizationEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "organization", НСтр("ru = 'Организация';
															|en = 'Company'"), "DMOrganization", Истина);
		КонецЕсли;
		
		Если ПолучитьВсе Или НастройкиВида = Неопределено Или НастройкиВида.sumEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "sum", НСтр("ru = 'Сумма';
													|en = 'Amount'"), "Число");
			ДобавитьРеквизит(Реквизиты, "currency", НСтр("ru = 'Валюта';
														|en = 'Currency'"), "DMCurrency");
		КонецЕсли;
		
		ДобавитьРеквизит(Реквизиты, "title", НСтр("ru = 'Наименование';
													|en = 'Description'"), "Строка", Истина);
		ДобавитьРеквизит(Реквизиты, "summary", НСтр("ru = 'Содержание';
													|en = 'Content'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "regNumber", НСтр("ru = 'Регистрационный номер';
														|en = 'Registration number'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "regDate", НСтр("ru = 'Дата регистрации';
													|en = 'Registration date'"), "Дата");
		
		ДобавитьРеквизит(Реквизиты, "signer", НСтр("ru = 'Подписал';
													|en = 'Signed by'"), "DMContactPerson");
		ДобавитьРеквизит(Реквизиты, "addressee", НСтр("ru = 'Адресат';
														|en = 'Addressee'"), "DMUser");
		ДобавитьРеквизит(Реквизиты, "subdivision", НСтр("ru = 'Подразделение';
														|en = 'Business unit'"), "DMSubdivision");
		
		Если ПолучитьВсе Или НастройкиВида = Неопределено Или НастройкиВида.performanceDateEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "performanceDate", НСтр("ru = 'Срок исполнения';
																|en = 'Due date'"), "Дата");
		КонецЕсли;
		
		Если ПолучитьВсе Или НастройкиТипа.accessLevelEnabled  = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "accessLevel", НСтр("ru = 'Гриф доступа';
															|en = 'Access label '"), "DMAccessLevel", Истина);
		КонецЕсли;
		
		Если ПолучитьВсе Или НастройкиТипа.activityMatterEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "activityMatter", НСтр("ru = 'Вопрос деятельности';
																|en = 'Activity issue'"), "DMActivityMatter", Истина);
		КонецЕсли;
		...
		Если ПолучитьВсе Или (ИнтеграцияС1СДокументооборотБазоваяФункциональностьПовтИсп.ДоступенФункционалВерсииСервиса("1.3.2.3.CORP")
			...
			ДобавитьРеквизит(Реквизиты, "project", НСтр("ru = 'Проект';
														|en = 'Project'"), "DMProject");
		КонецЕсли;
		
		ДобавитьРеквизит(Реквизиты, "deliveryMethod",  НСтр("ru = 'Способ получения';
															|en = 'Receipt method'"), "DMDeliveryMethod");
		
		ДобавитьРеквизит(Реквизиты, "comment", НСтр("ru = 'Комментарий';
													|en = 'Comment'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "responsible", НСтр("ru = 'Ответственный';
														|en = 'Responsible person'"), "DMUser");
	...
	ИначеЕсли ТипОбъектаДО = "DMOutgoingDocument" Тогда
		...
		Если ПолучитьВсе Или НастройкиТипа.documentTypeEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "documentType", НСтр("ru = 'Вид документа';
															|en = 'Document kind'"), "DMOutgoingDocumentType", Истина);
		КонецЕсли;
			
		ДобавитьРеквизит(Реквизиты, "correspondent", НСтр("ru = 'Получатель';
															|en = 'Recipient'"), "DMCorrespondent", Истина);
		
		Если ПолучитьВсе Или НастройкиВида = Неопределено Или НастройкиВида.externalNumberEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "externalNumber", НСтр("ru = '№ получателя';
																|en = 'Recipient No.'"), "Строка");
			ДобавитьРеквизит(Реквизиты, "externalDate", НСтр("ru = 'Дата получателя';
															|en = 'Recipient date '"), "Дата");
		КонецЕсли;
		...
		ДобавитьРеквизит(Реквизиты, "title", НСтр("ru = 'Заголовок';
													|en = 'Title'"), "Строка", Истина);
		ДобавитьРеквизит(Реквизиты, "summary", НСтр("ru = 'Содержание';
													|en = 'Content'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "regNumber", НСтр("ru = 'Регистрационный номер';
														|en = 'Registration number'"), "Строка");
		...
		ДобавитьРеквизит(Реквизиты, "addressee", НСтр("ru = 'Адресат';
														|en = 'Addressee'"), "DMContactPerson");
		ДобавитьРеквизит(Реквизиты, "sent", НСтр("ru = 'Отправлен';
												|en = 'Sent'"), "Булево");
		ДобавитьРеквизит(Реквизиты, "sendDate", НСтр("ru = 'Дата отправки';
													|en = 'Date sent'"), "Дата");
		
		ДобавитьРеквизит(Реквизиты, "signer", НСтр("ru = 'Подписал';
													|en = 'Signed by'"), "DMUser");
		ДобавитьРеквизит(Реквизиты, "author", НСтр("ru = 'Подготовил';
													|en = 'Prepared by'"), "DMUser");
		ДобавитьРеквизит(Реквизиты, "subdivision", НСтр("ru = 'Подразделение';
														|en = 'Business unit'"), "DMSubdivision");
		...
		ДобавитьРеквизит(Реквизиты, "deliveryMethod", НСтр("ru = 'Способ отправки';
															|en = 'Sending method'"), "DMDeliveryMethod");
		ДобавитьРеквизит(Реквизиты, "comment", НСтр("ru = 'Комментарий';
													|en = 'Comment'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "responsible", НСтр("ru = 'Ответственный';
														|en = 'Responsible person'"), "DMUser");
	...
	ИначеЕсли ТипОбъектаДО = "DMInternalDocument" Тогда
		...
		Если ПолучитьВсе Или НастройкиТипа.documentTypeEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "documentType", НСтр("ru = 'Вид документа';
															|en = 'Document kind'"), "DMInternalDocumentType", Истина);
		КонецЕсли;
		
		ДобавитьРеквизит(Реквизиты, "folder", НСтр("ru = 'Папка';
													|en = 'Folder'"), "DMInternalDocumentFolder", Истина);
		...
		Если ПолучитьВсе Или ЯвляетсяЗаявкойНаОплату Тогда
			ДобавитьРеквизит(Реквизиты, "recipient", НСтр("ru = 'Получатель';
															|en = 'Recipient'"), "DMParty", Истина);
		КонецЕсли;
		...
		Если ПолучитьВсе Или НастройкиВида = Неопределено Или НастройкиВида.sumEnabled = Истина Тогда
			...
			Если ПолучитьВсе
				...
				ДобавитьРеквизит(Реквизиты, "VAT", НСтр("ru = 'В т.ч. НДС';
														|en = 'Including VAT'"), "Число");
			КонецЕсли;
			ДобавитьРеквизит(Реквизиты, "currency", НСтр("ru = 'Валюта';
														|en = 'Currency'"), "DMCurrency");
		КонецЕсли;
		...
		ДобавитьРеквизит(Реквизиты, "signer", НСтр("ru = 'Утвердил';
													|en = 'Approved'"), "DMUser");
		ДобавитьРеквизит(Реквизиты, "author", НСтр("ru = 'Подготовил';
													|en = 'Prepared by'"), "DMUser");
		ДобавитьРеквизит(Реквизиты, "subdivision", НСтр("ru = 'Подразделение';
		...
		Если ПолучитьВсе Или (ВестиУчетСторон И Не ЯвляетсяЗаявкойНаОплату)
			...
			ДобавитьРеквизит(Реквизиты, "contactPerson", НСтр("ru = 'Контактное лицо';
																|en = 'Contact person'"), "DMContactPerson");
		...
		Если ПолучитьВсе
			...
			ДобавитьРеквизитТаблицы(Реквизиты,
				"correspondentRows.rows", "correspondent", НСтр("ru = 'Контрагент';
																|en = 'Counterparty'"), "DMCorrespondent", Истина);
			ДобавитьРеквизитТаблицы(Реквизиты,
				"correspondentRows.rows", "contact", НСтр("ru = 'Контактное лицо';
															|en = 'Contact person'"), "DMContactPerson");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"correspondentRows.rows",
				"signedFromTheCorrespondent", НСтр("ru = 'Подписал от контрагента';
													|en = 'Signed on behalf of a counterparty'"), "DMContactPerson");
			
		КонецЕсли;
		
		Если ПолучитьВсе Или НастройкиВида = Неопределено Или НастройкиВида.durationEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты,
				"beginDate", НСтр("ru = 'Дата начала действия';
									|en = 'Effective date'"), "Дата");
			ДобавитьРеквизит(Реквизиты,
				"endDate", НСтр("ru = 'Дата окончания действия';
								|en = 'Expiration date'"), "Дата");
			ДобавитьРеквизит(Реквизиты,
				"openEnded", НСтр("ru = 'Бессрочный';
									|en = 'Permanent'"), "Булево");
			ДобавитьРеквизит(Реквизиты,
				"prolongationProcedure", НСтр("ru = 'Порядок продления';
												|en = 'Extension procedure'"), "DMProlongationProcedure");
		КонецЕсли;
		...
		Если ПолучитьВсе Или (НастройкиВида <> Неопределено
			...
			ДобавитьТаблицу(Реквизиты, "cashFlowRows.rows", НСтр("ru = 'Статьи движения денежных средств';
																|en = 'Cash flow items'"));
			ДобавитьРеквизитТаблицы(Реквизиты, "cashFlowRows.rows", "item", НСтр("ru = 'Статья';
																				|en = 'Item'"), "DMCashFlowItem", Истина);
			ДобавитьРеквизитТаблицы(Реквизиты, "cashFlowRows.rows", "total", НСтр("ru = 'Сумма';
																					|en = 'Amount'"), "Число");
			ДобавитьРеквизитТаблицы(Реквизиты, "cashFlowRows.rows", "VAT", НСтр("ru = 'Сумма НДС';
																				|en = 'VAT amount'"), "Число");
		...
		Если ПолучитьВсе Или (НастройкиВида <> Неопределено
			...
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "product", НСтр("ru = 'Товар, услуга';
													|en = 'Good, service'"), "DMProduct");
			
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "price", НСтр("ru = 'Цена';
													|en = 'Price'"), "Число");
			
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "quantity", НСтр("ru = 'Количество';
													|en = 'Quantity'"), "Число");
			
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "measurementUnit", НСтр("ru = 'Единица измерения';
															|en = 'Unit of measure'"), "DMMeasurementUnit");
			
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "VATRate", НСтр("ru = 'Ставка НДС';
													|en = 'VAT rate'"), "DMVATRate");
			
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "VAT", НСтр("ru = 'Сумма НДС';
												|en = 'VAT amount'"), "Число");
			
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "total", НСтр("ru = 'Сумма';
													|en = 'Amount'"), "Число");
		...
		Если ПолучитьВсе Или (ЯвляетсяЗаявкойНаОплату = Ложь И ВестиУчетСторон) Тогда
			...
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "comment", НСтр("ru = 'Комментарий';
													|en = 'Comment'"), "Строка");
			
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "contact", НСтр("ru = 'Контактное лицо';
													|en = 'Contact person'"), "DMPartyRowContact");
			
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "description", НСтр("ru = 'Наименование стороны';
														|en = 'Party name'"), "DMPartyName");
			
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "party", НСтр("ru = 'Сторона';
												|en = 'Party'"), "DMParty", Истина);
			
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "setBy", НСтр("ru = 'Установил';
												|en = 'Installed by'"), "DMUser");
			
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "signatureDate", НСтр("ru = 'Дата подписи';
														|en = 'Date signed'"), "Дата");
			
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "signed", НСтр("ru = 'Подписан';
												|en = 'Signed'"), "Булево");
			
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "signedBy", НСтр("ru = 'Подписал';
													|en = 'Signed by'"), "DMPartyRowContact");
	...
	ИначеЕсли ТипОбъектаДО = "DMCorrespondent" Тогда
		...
		ДобавитьРеквизит(Реквизиты, "name", НСтр("ru = 'Наименование';
												|en = 'Description'"), "Строка", Истина);
		Если ИнтеграцияС1СДокументооборотПовтИсп.ИспользоватьТерминКорреспонденты() Тогда
			ДобавитьРеквизит(Реквизиты,
				"legalPrivatePerson",
		...
		Иначе
			ДобавитьРеквизит(Реквизиты,
				...
				Истина);
		КонецЕсли;
		ДобавитьРеквизит(Реквизиты, "inn", НСтр("ru = 'ИНН';
												|en = 'TIN'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "kpp", НСтр("ru = 'КПП';
												|en = 'KPP'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "okpo", НСтр("ru = 'Код по ОКПО';
												|en = 'OKPO code'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "comment", НСтр("ru = 'Комментарий';
													|en = 'Comment'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "fullName", НСтр("ru = 'Полное наименование';
													|en = 'Full name'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "privatePerson", НСтр("ru = 'Физическое лицо';
															|en = 'Person'"), "DMPrivatePerson");
		ДобавитьРеквизит(Реквизиты, "responsible", НСтр("ru = 'Ответственный';
														|en = 'Responsible person'"), "DMUser");
...
Процедура ПроверитьВыражениеПравилаВыгрузки(ВычисляемоеВыражение, ОбъектИС) Экспорт
	...
	ИнтеграцияС1СДокументооборотБазоваяФункциональность.ВыполнитьВБезопасномРежиме(ВычисляемоеВыражение, Параметры);
...
Процедура ПроверитьВыражениеУсловияПрименимостиПриВыгрузке(УсловиеПрименимостиПриВыгрузке, ОбъектИС) Экспорт
	...
	ИнтеграцияС1СДокументооборотБазоваяФункциональность.ВыполнитьВБезопасномРежиме(УсловиеПрименимостиПриВыгрузке, Параметры);
...
Процедура ПроверитьВыражениеУсловияПрименимостиПриЗагрузке(УсловиеПрименимостиПриЗагрузке, ОбъектXDTO) Экспорт
	...
	ИнтеграцияС1СДокументооборотБазоваяФункциональность.ВыполнитьВБезопасномРежиме(УсловиеПрименимостиПриЗагрузке, Параметры);
	
КонецПроцедуры

// Выполняет проверку правила интеграции с 1С:Документооборотом.
//
// Параметры:
//   ПравилоИнтеграции - СправочникОбъект.ПравилаИнтеграцииС1СДокументооборотом
//
Процедура ПроверитьПравило(ПравилоИнтеграции) Экспорт
	...
	РеквизитыТекущегоВидаДокументаДО = РеквизитыОбъектаДО(
		...
		Новый Структура("documentType", ВидДокументаИзПравила(ПравилоИнтеграции)));
	
	ВсеРеквизитыОбъектаДО = РеквизитыОбъектаДО(ПравилоИнтеграции.ТипОбъектаДО,,, Истина);
	
	РеквизитыОбъектаИС = ИнтеграцияС1СДокументооборотБазоваяФункциональность.РеквизитыОбъектаИС(ПравилоИнтеграции.ТипОбъектаИС);
	...
	Прокси = ИнтеграцияС1СДокументооборотБазоваяФункциональностьПовтИсп.ПолучитьПрокси();
	ОбъектXDTO = ИнтеграцияС1СДокументооборотБазоваяФункциональность.НовыйОбъектДО(Прокси, ПравилоИнтеграции.ТипОбъектаДО);
	...
	Попытка
		ПроверитьВыражениеУсловияПрименимостиПриВыгрузке(
			ПравилоИнтеграции.УсловиеПрименимостиПриВыгрузке,
			ОбъектИС);
	Исключение
		...
		СписокОшибок.Добавить(
			СтрШаблон(
				НСтр("ru = 'Ошибка в условии применимости правила для передачи данных в 1С:Документооборот:
					...
					|""%1""';
					|en = 'An error in the rule applicability condition for transferring data to 1C:Document Management:
					|Cannot execute the expression in 1C:Enterprise language due to:
					|""%1""'"),
						ТекстИсключения));
	КонецПопытки;
	Попытка
		ПроверитьВыражениеУсловияПрименимостиПриЗагрузке(
			ПравилоИнтеграции.УсловиеПрименимостиПриЗагрузке,
			ОбъектXDTO);
	Исключение
		ТекстИсключения = ОбработкаОшибок.КраткоеПредставлениеОшибки(ИнформацияОбОшибке());
		СписокОшибок.Добавить(
			СтрШаблон(
				НСтр("ru = 'Ошибка в условии применимости правила для получения данных из 1С:Документооборота:
					|Не удалось выполнить выражение на встроенном языке по причине:
					|""%1""';
					|en = 'Error in the rule applicability condition for receiving data from 1C:Document Management:
					|Cannot execute the expression in 1C:Enterprise language due to:
					|""%1""'"),
						ТекстИсключения));
	КонецПопытки;
...
Процедура ПроверитьПравилаЗаполненияРеквизитовДО(ПравилоИнтеграции, ОбъектИС, МетаданныеОбъектаИС, РеквизитыОбъектаИС,
		ВсеРеквизитыОбъектаДО, СписокОшибок)
	
	Для Каждого Правило Из ПравилоИнтеграции.ПравилаЗаполненияРеквизитовДО Цикл
		...
		Если ЗначениеЗаполнено(Правило.Таблица) Тогда
			ПараметрыПроверки.ПредставлениеРеквизитаДО = СтрШаблон(НСтр("ru = 'реквизита ""%1"" таблицы ДО ""%2""';
																		|en = '""%1"" attribute of the ""%2"" EDI table'"),
		...
		Попытка
				...
				Если ЗначениеЗаполнено(Правило.Таблица) Тогда // Это реквизит табличной части.
					...
					ИначеЕсли РазделеннаяСтрока.Количество() = 2 Тогда
						ПараметрыПроверки.ТекстОшибки = СтрШаблон(
							НСтр("ru = 'Выбран вариант заполнения из реквизита ""%1"" несуществующей таблицы ""%2""';
								|en = 'Filling option is selected from the ""%1"" attribute of the non-existing table ""%2""'"),
								РазделеннаяСтрока[1],
								РазделеннаяСтрока[0]);
					...
					Иначе
						ПараметрыПроверки.ТекстОшибки = НСтр("ru = 'Механизм заполнения реквизитов таблиц
							...
							|en = 'Table attribute filling mechanism
							|does not support access to IS attribute using dot syntax'");
					...
					Если Правило.ЭтоДополнительныйРеквизитИС Тогда
						ПараметрыПроверки.ТекстОшибки = НСтр("ru = 'Механизм заполнения реквизитов таблиц
							...
							|en = 'Table attribute filling mechanism
							|does not support filling from additional attributes'");
						
					Иначе
						ПараметрыПроверки.ТекстОшибки = СтрШаблон(
							НСтр("ru = 'Выбран вариант заполнения из несуществующего реквизита ""%1""';
								|en = 'Filling option from the ""%1"" non-existing attribute is selected'"), ИмяРеквизита);
						...
						Если РеквизитыОбъектаИС.Найти(
							...
							ПараметрыПроверки.ТекстОшибки = СтрШаблон(
								НСтр("ru = 'Выбран вариант заполнения из несуществующего доп. реквизита ""%1""';
									|en = 'Filling option is selected from non-existing additional attribute ""%1""'"),
									ОбщегоНазначения.ЗначениеРеквизитаОбъекта(
										Правило.ДополнительныйРеквизитИС, "Наименование"));
							ВызватьИсключение ПараметрыПроверки.ТекстОшибки;
						КонецЕсли;
						
					ИначеЕсли СтрНайти(Правило.ИмяРеквизитаОбъектаИС, ".") > 0 Тогда
						...
						ПараметрыПроверки.ТекстОшибки = СтрШаблон(
							НСтр("ru = 'Выбран вариант заполнения из несуществующего реквизита ""%1""';
								|en = 'Filling option from the ""%1"" non-existing attribute is selected'"),
						...
						Если Правило.ЭтоТаблица Тогда
							ПараметрыПроверки.ТекстОшибки = СтрШаблон(
								НСтр("ru = 'Выбран вариант заполнения из несуществующей таблицы ""%1""';
									|en = 'Filling option is selected from non-existing table ""%1""'"),
									Правило.ИмяРеквизитаОбъектаИС);
						Иначе
							ПараметрыПроверки.ТекстОшибки = СтрШаблон(
								НСтр("ru = 'Выбран вариант заполнения из несуществующего реквизита ""%1""';
			...
			ИначеЕсли Правило.Вариант = Перечисления.ВариантыПравилЗаполненияРеквизитов.ВыражениеНаВстроенномЯзыке Тогда
				...
				Попытка
					ПроверитьВыражениеПравилаВыгрузки(Правило.ВычисляемоеВыражение, ОбъектИС);
				Исключение
					ТекстИсключения = ОбработкаОшибок.КраткоеПредставлениеОшибки(ИнформацияОбОшибке());
					ПараметрыПроверки.ТекстОшибки = СтрШаблон(
						НСтр("ru = 'Не удалось выполнить выражение на встроенном языке по причине:
							|""%1""';
							|en = 'Cannot execute the expression in 1C:Enterprise language due to:
							|""%1""'"), ТекстИсключения);
					ВызватьИсключение;
				КонецПопытки;
			...
			СписокОшибок.Добавить(
				СтрШаблон(
					НСтр("ru = 'Ошибка в правиле заполнения %1 (Закладка ""Передача в 1С:Документооборот""):
						|%2';
						|en = 'Filling rule error %1 (Tab ""Transfer to 1C:Document Management""):
						|%2'"),
	...
	Для Каждого Правило Из ПравилоИнтеграции.ПравилаЗаполненияРеквизитовИС Цикл
		...
		Если ЗначениеЗаполнено(Правило.Таблица) Тогда
			ПредставлениеРеквизитаИС = СтрШаблон(НСтр("ru = 'реквизита ""%1"" таблицы ИС ""%2""';
														|en = 'attribute ""%1"" of the ""%2"" IS table'"),
					...
					СписокОшибок.Добавить(
						СтрШаблон(
							НСтр("ru = 'Ошибка в правиле заполнения %1 (Закладка ""Получение из 1С:Документооборота""):
								...
								|en = 'Filling rule error %1 (Tab ""Receive from 1C:Document Management""):
								|Invalid filling data attribute name is specified: %2'"),
									ПредставлениеРеквизитаИС,
						...
						СписокОшибок.Добавить(
							СтрШаблон(
								НСтр("ru = 'Ошибка в правиле заполнения %1 (Закладка ""Получение из 1С:Документооборота""):
									...
									|en = 'Filling rule error %1 (Tab ""Receive from 1C:Document Management""):
									|filling option is selected from non-existing table ""%2""'"),
										ПредставлениеРеквизитаИС,
							...
							СписокОшибок.Добавить(
								СтрШаблон(
									НСтр("ru = 'Ошибка в правиле заполнения %1 (Закладка ""Получение из 1С:Документооборота""):
										...
										|en = 'Filling rule error %1 (Tab ""Receive from 1C:Document Management""):
										|filling option is selected from the ""%2"" attribute of non-existing table ""%3""'"),
											ПредставлениеРеквизитаИС,
											?(ВсеРеквизитыДОРеквизит.Количество() = 0,
												Правило.ИмяРеквизитаОбъектаДО,
												ВсеРеквизитыДОРеквизит[0].Представление),
							...
							СписокОшибок.Добавить(
								СтрШаблон(
									НСтр("ru = 'Ошибка в правиле заполнения %1 (Закладка ""Получение из 1С:Документооборота""):
										...
										|en = 'Filling rule error %1 (Tab ""Receive from 1C:Document Management""):
										|filling option is selected from non-existing attribute ""%2""'"),
											ПредставлениеРеквизитаИС,
											?(ВсеРеквизитыДОРеквизит.Количество() = 0,
												Правило.ИмяРеквизитаОбъектаДО,
												ВсеРеквизитыДОРеквизит[0].Представление)));
					...
					СписокОшибок.Добавить(
						СтрШаблон(
							НСтр("ru = 'Ошибка в правиле заполнения %1 (Закладка ""Получение из 1С:Документооборота""):
								...
								|en = 'Filling rule error %1 (Tab ""Receive from 1C:Document Management""):
								|filling option is selected from non-existing additional attribute ""%2""'"),
									ПредставлениеРеквизитаИС,
									Правило.ДополнительныйРеквизитДОID));
				КонецЕсли;
		...
		ИначеЕсли Правило.Вариант = Перечисления.ВариантыПравилЗаполненияРеквизитов.ВыражениеНаВстроенномЯзыке Тогда
			...
			Попытка
				ПроверитьВыражениеПравилаЗагрузки(Правило.ВычисляемоеВыражение, ОбъектXDTO, ОбъектИС);
			Исключение
				ТекстИсключения = ОбработкаОшибок.КраткоеПредставлениеОшибки(ИнформацияОбОшибке());
				СписокОшибок.Добавить(
					СтрШаблон(
