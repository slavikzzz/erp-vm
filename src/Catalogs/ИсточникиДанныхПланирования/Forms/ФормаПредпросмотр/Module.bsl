...
Процедура НастроитьЗависимыеЭлементыФормы(СписокРеквизитов = "")
	...
	Если Инициализация Тогда
		...
		Элементы.НачалоПериода.Заголовок = ?(ЭтоОстатки, НСтр("ru = 'Плановая дата остатков';
																|en = 'Planned balance date'"), НСтр("ru = 'Период с';
																									|en = 'Period from'"));
