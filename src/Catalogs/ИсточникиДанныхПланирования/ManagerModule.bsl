...
Функция ВыбратьДанные(ПараметрыИсточникаДанных, ПользовательскиеНастройки, ДополнительныеПараметры, КомпоновщикНастроекКомпоновкиДанных = Неопределено) Экспорт
	...
	Исключение
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'В источнике заполнения данных ""%1"" имеются ошибки в настройках. Для корректной работы правила заполнения необходимо создать новый источник аналогичный текущему.';
				|en = 'There are errors in the settings in the ""%1"" data filling source. Create a new source similar to the current one for the correct operation of the filling rule.'"), ПараметрыИсточникаДанных.ИсточникДанныхПланирования);
	КонецПопытки;
