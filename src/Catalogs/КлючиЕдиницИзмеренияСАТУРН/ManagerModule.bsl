		...
		Исключение
			...
			ТекстОшибки = СтрШаблон(
				НСтр("ru = 'Ошибка при создании Ключа единицы измерения с идентификатором %1:
				           |%2';
				           |en = 'Ошибка при создании Ключа единицы измерения с идентификатором %1:
				           |%2'"),
				Идентификатор,
			...
			ОбщегоНазначенияИСВызовСервера.ЗаписатьОшибкуВЖурналРегистрации(
				ТекстОшибкиПодробно,
				НСтр("ru = 'Работа с Ключами единиц измерения';
					|en = 'Работа с Ключами единиц измерения'", ОбщегоНазначения.КодОсновногоЯзыка()));
