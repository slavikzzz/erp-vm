...
//	ИмяСхемыВыгрузки - Строка - Имя макета.
//
...
//		* Ссылка 					- Справочник.ПоляФормСтатистики - Ссылка на элемент справочника;
// 		* Наименование 				- Строка - Описание;
// 		* СтатистическийПоказатель 	- Справочник.СтатистическиеПоказатели - Статистический показатель;
// 		* Период 					- Перечисление.ОтносительныеПериодыОтчетности - Период отчетности;
// 		* ИмяПоля					- Строка - Имя поля формы;
// 		* НомерСтрокиОтчета	 		- Строка - Номер строки отчета;
// 		* СНачалаГода 				- Булево - Признак формирования данных с начала года накопительно;
// 		* ПоказательИзXML			- Строка - Показатель из XML;
// 		* НомерСтрокиИзXML			- Строка - Номер строки из XML;
// 		* ИмяПоляИзXML				- Строка - Имя поля из XML;
// 		* ПериодИзXML 				- Перечисление.ОтносительныеПериодыОтчетности - Период отчетности из XML;
// 		* СНачалаГодаИзXML			- Булево - Признак формирования данных с начала года накопительно из XML;
...
// Возвращаемое значение:
//	СправочникСсылка.ФормыСтатистики - Форма статистики соответствующая редакции регламентированного отчета.
