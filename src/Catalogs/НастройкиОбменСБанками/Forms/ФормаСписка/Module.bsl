...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.СоздатьВручную.Видимость = ПравоВыполненияОбмена;
	Элементы.СписокЗагрузитьНастройкиИзФайла.Видимость = ПравоВыполненияОбмена;
	Элементы.ФормаОткрытьСообщенияОбменаСБанками.Видимость = ПравоВыполненияОбмена;
	Элементы.ОткрытьПакетыЭДОСБанками.Видимость = ПравоВыполненияОбмена;
