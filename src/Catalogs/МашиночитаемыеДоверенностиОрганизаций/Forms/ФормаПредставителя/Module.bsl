...
Процедура ОрганизацияПриИзмененииНаСервере()
	...
	Если Не СвойстваОрганизации.ЭтоЮридическоеЛицо Тогда
		ОбщегоНазначения.СообщитьПользователю(
			НСтр("ru = 'Необходимо выбрать юридическое лицо.';
				|en = 'Select a legal entity.'"), , "РеквизитПредставительОрганизация");
...
Функция ПолучитьПредставлениеУдостоверение(СтруктураДанныхФизЛица)
	...
	Если ЗначениеЗаполнено(СтруктураДанныхФизЛица.ДокументДатаВыдачи) Тогда
		Представление =
			Представление + " " + НСтр("ru = 'выдан';
										|en = 'issued'") + " " + Формат(СтруктураДанныхФизЛица.ДокументДатаВыдачи, "ДЛФ=ДД");
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(СтруктураДанныхФизЛица.ДокументКодПодразделения) Тогда
		Представление = Представление + ", " + НСтр("ru = 'код подразделения';
													|en = 'department code'") + ":" + СтруктураДанныхФизЛица.ДокументКодПодразделения;
	КонецЕсли;
