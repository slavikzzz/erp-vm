...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИмяСправочника = "КлассификаторДОПОГЭПД";
...
Функция ПолучитьЗначенияКлассификатораИзМакета()
	...
	ТаблицаПоказателей = Справочники.КлассификаторДОПОГЭПД.ТаблицаКлассификатораДОПОГ();
...
Процедура ЗаполнитьКлассификатор()
	...
	РанееДобавленныеЭлементыКлассификатора.Индексы.Добавить("Класс");
	...
	Для Каждого Элемент Из ЭлементыКлассификатора Цикл
		...
		КонецЕсли;	
		Если ЗначениеЗаполнено(НоваяСтрока.КодОграниченияПроездаЧерезТуннели) = Ложь Тогда
			НоваяСтрока.КодОграниченияПроездаЧерезТуннели = "-";
		КонецЕсли;
