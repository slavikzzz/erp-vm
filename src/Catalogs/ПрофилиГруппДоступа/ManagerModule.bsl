	...
	Попытка
		...
		Иначе
			ПрофильПоНаименованию = ПрофильПоНаименованию(
				НСтр("ru = 'Администратор';
					|en = 'Administrator'", ОбщегоНазначения.КодОсновногоЯзыка()));
...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Элемент.Наименование = НСтр("ru = 'Администратор';
								|en = 'Administrator'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ЗаполнитьПапкуПрофилейДополнительныеПрофили(ОписаниеПапки)
	...
	ОписаниеПапки.Наименование  = НСтр("ru = 'Дополнительные профили';
										|en = 'Additional profiles'", ОбщегоНазначения.КодОсновногоЯзыка());
