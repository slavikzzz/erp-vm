...
Процедура НастроитьФормуПоРеквизитам()
	...
	Элементы.Партнер.Заголовок = ?(Объект.ЭтоПретензияПоставщику, НСтр("ru = 'Поставщик';
...
Процедура УстановитьПараметрыВыбораДоговора()
	...
	Иначе
		...
		//-- Устарело_Переработка24
		ТипДоговора.Добавить(Перечисления.ТипыДоговоров.СДавальцем2_5);
		//-- НЕ УТКА
...
Процедура УстановитьПараметрыВыбораГФУ()
	...
	//++ НЕ УТ
	ИначеЕсли ТекущийТипДоговора = Перечисления.ТипыДоговоров.СПереработчиком2_5 Тогда
		МассивПараметров.Добавить(Новый ПараметрВыбора("Отбор.РасчетыСПереработчиками", Истина));
	//-- НЕ УТ
	...
	//++ НЕ УТКА
	ИначеЕсли ТекущийТипДоговора = Перечисления.ТипыДоговоров.СДавальцем2_5 Тогда
		МассивПараметров.Добавить(Новый ПараметрВыбора("Отбор.РасчетыСДавальцами", Истина));
	//-- НЕ УТКА
