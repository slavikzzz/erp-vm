	...
	Если Не ЗначениеЗаполнено(Код) Тогда
		...
		Иначе
			...
			Если Отказ Тогда
				...
				|en = 'For user ""%Пользователь%"", there is a setting
				|that has not yet been used for data synchronization with the mobile application.
				|Use it, to configure data exchange.'");
	...
	Если НЕ ЭтотУзел Тогда
		...
		Если ПрефиксИспользуется Тогда
			Сообщение = НСтр("ru = 'Префикс ""%Префикс%"" уже используется !';
							|en = 'Prefix ""%Префикс%"" is already used.'");
