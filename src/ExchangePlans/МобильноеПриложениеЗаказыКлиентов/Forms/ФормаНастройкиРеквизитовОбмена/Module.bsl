...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок =
		Нстр("ru = 'Настройка синхронизации реквизитов объектов для обмена с мобильным приложением ""1С:Заказы""';
			|en = 'Set up object attribute synchronization for exchange with 1C:Orders mobile application'");
...
Процедура ЗаписатьНастройки(Отказ)
	...
	Исключение
		ОтменитьТранзакцию();
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Запись настроек';
										|en = 'Save settings'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Процедура ЗаполнитьДеревоОбъектовОбмена()
	...
	СтрокаСправочники.Представление = НСтр("ru = 'Справочники';
											|en = 'Catalogs'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	...
	СтрокаОбъекты.Представление = НСтр("ru = 'Номенклатура';
										|en = 'Items'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	
	СтрокаОбъекты = КоллекцияОбъектовСправочников.Добавить();
	СтрокаОбъекты.ОбъектОбмена = "Справочник.Партнеры";
	СтрокаОбъекты.Представление = НСтр("ru = 'Партнеры';
										|en = 'Partners'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	
	СтрокаОбъекты = КоллекцияОбъектовСправочников.Добавить();
	СтрокаОбъекты.ОбъектОбмена = "Справочник.Организации";
	СтрокаОбъекты.Представление = НСтр("ru = 'Организации';
										|en = 'Companies'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	
	СтрокаДокументы = КоллекцияОбъектовОбмена.Добавить();
	СтрокаДокументы.ОбъектОбмена = "Документы";
	СтрокаДокументы.Представление = НСтр("ru = 'Документы';
										|en = 'Documents'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	...
	СтрокаОбъекты.Представление = НСтр("ru = 'Заказ клиента';
										|en = 'Sales order'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
