...
Процедура ПриПолученииНастроек(Настройки) Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("КомплекснаяАвтоматизация") Тогда
		Настройки.ИмяКонфигурацииИсточника = "КомплекснаяАвтоматизация";
	Иначе
...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ОписаниеВарианта.КраткаяИнформацияПоОбмену = 
		...
		|""1С:ERP Управление предприятием, редакция 2"", и ""1С:Документооборот, редакция 2"".';
		|en = 'With this setting, you can synchronize data between 
		|1C:ERP 2 (Enterprise Resource Management) and 1C:Document Management 2.'");
	ОписаниеВарианта.ПодробнаяИнформацияПоОбмену =
		"ПланОбмена.ОбменУправлениеПредприятиемДокументооборот20.Форма.ПодробнаяИнформация";
	ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена =
		НСтр("ru = 'Настройка синхронизации с 1С:Документооборотом, ред. 2';
			|en = 'Setting of synchronization with 1C:Documnet Management 2'");
	ОписаниеВарианта.ЗаголовокУзлаПланаОбмена = НСтр("ru = 'Синхронизация с 1С:Документооборотом, ред. 2';
													|en = 'Synchronization with 1C:Document Management 2'");
...
Процедура ПриПолученииВариантовНастроекОбмена(ВариантыНастроекОбмена, ПараметрыКонтекста) Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("КомплекснаяАвтоматизация") Тогда
		ВариантНастройки.ИдентификаторНастройки = "КА";
	Иначе
		ВариантНастройки.ИдентификаторНастройки = "УП";
	КонецЕсли;
...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат НСтр("ru = '1С:Документооборот КОРП, ред. 2';
				|en = '1C:Document Management 8 CORP, ver. 2'");
