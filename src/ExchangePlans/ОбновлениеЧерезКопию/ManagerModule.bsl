...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	КраткаяИнформацияПоОбмену = НСтр("ru = 'Настройка обновления через копию информационной базы.';
									|en = 'Configuring updates via infobase copy.'");
	ПодробнаяИнформацияПоОбмену = "ПланОбмена.ОбновлениеЧерезКопию.Форма.ПодробнаяИнформация";
	...
	ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента = Метаданные.Синоним;
	ОписаниеВарианта.ИмяФайлаНастроекДляПриемника = "CorrespondentExchangeRules.xml";
	ОписаниеВарианта.ИспользоватьПомощникСозданияОбменаДанными = Ложь;
	ОписаниеВарианта.ИмяФормыПомощникаНастройкиСинхронизацииДанных = "Обработки.ОбновлениеЧерезКопию.ФормаПодсказкаУказательНаПомощник";
	ОписаниеВарианта.ИспользуемыеТранспортыСообщенийОбмена.Добавить(Обработки.ТранспортСообщенийОбменаFILE);
	...
	ОписаниеВарианта.Вставить("ЗаголовокКомандыДляСозданияНовогоОбменаДанными", НСтр("ru = 'Обновление через копию';
																					|en = 'Update via copy'"));
	ОписаниеВарианта.Вставить("ЗаголовокПомощникаСозданияОбмена",               НСтр("ru = 'Обновление через копию информационной базы';
																					|en = 'Update via infobase copy'"));
	ОписаниеВарианта.Вставить("ЗаголовокУзлаПланаОбмена",                       НСтр("ru = 'Узел обновления через копию информационной базы';
																					|en = 'Update node via infobase copy'"));
...
//  СписокЗначений - список расписаний обмена данными.
//
