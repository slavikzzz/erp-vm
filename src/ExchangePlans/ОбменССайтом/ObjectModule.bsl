...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если НЕ ОбменТоварами
		...
		Сообщение = НСтр("ru = 'Режим обмена не выбран.';
						|en = 'Exchange mode is not selected.'");
		Поле = "ОбменТоварами";
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Наименование				= НСтр("ru = 'Обмен с';
										|en = 'Exchange with'") + " " + ДанныеЗаполнения.АдресСайта;
...
Процедура СформироватьНаименование()
	...
	Если ОбменТоварами И ОбменЗаказами Тогда
		...
		Префикс = НСтр("ru = 'Обмен товарами и заказами';
						|en = 'Products and orders exchange'");
