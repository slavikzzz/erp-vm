...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Отбор") Тогда
		...
		Если Параметры.Отбор.Свойство("ВидДеятельностиДляНалоговогоУчетаЗатрат", ВидДеятельностиДляНалоговогоУчетаЗатрат) Тогда
			//++ НЕ УТ
			Если ЗначениеЗаполнено(ВидДеятельностиДляНалоговогоУчетаЗатрат) Тогда
				ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
					Список,
	...
	Если Параметры.Отбор.Свойство("РасходыНаРемонт") Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(
			ГруппаОтбора,
			"РасходыНаЗаказыНаРемонт",
			Истина, 
			ВидСравненияКомпоновкиДанных.Равно,
			"РасходыНаЗаказыНаРемонт",
			Истина);
			
		Параметры.Отбор.Удалить("РасходыНаРемонт");
